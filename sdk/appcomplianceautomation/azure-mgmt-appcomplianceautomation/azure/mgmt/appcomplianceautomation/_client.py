...
class AppComplianceAutomationClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype webhook_resources:
     azure.mgmt.appcomplianceautomation.operations.WebhookResourcesOperations
    ...
    :vartype scoping_configuration_resources:
     azure.mgmt.appcomplianceautomation.operations.ScopingConfigurationResourcesOperations
    :ivar evidence_resources: EvidenceResourcesOperations operations
    :vartype evidence_resources:
     azure.mgmt.appcomplianceautomation.operations.EvidenceResourcesOperations
    ...
    def __enter__(self) -> "AppComplianceAutomationClient":
