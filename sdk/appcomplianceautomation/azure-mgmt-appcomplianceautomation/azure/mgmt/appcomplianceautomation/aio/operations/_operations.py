...
from ...operations._operations import (
    build_evidence_resources_create_or_update_request,
    build_evidence_resources_delete_request,
    build_evidence_resources_download_request,
    build_evidence_resources_get_request,
    build_evidence_resources_list_by_report_resource_request,
    ...
    build_report_resources_check_name_availability_request,
    build_report_resources_create_or_update_request,
    build_report_resources_delete_request,
    build_report_resources_fix_request,
    build_report_resources_get_request,
    build_report_resources_get_scoping_questions_request,
    build_report_resources_list_by_tenant_request,
    build_report_resources_sync_cert_record_request,
    build_report_resources_update_request,
    build_report_resources_verify_request,
    build_scoping_configuration_resources_create_or_update_request,
    build_scoping_configuration_resources_delete_request,
    build_scoping_configuration_resources_get_request,
    build_scoping_configuration_resources_list_by_report_resource_request,
    build_snapshot_resources_download_request,
    build_snapshot_resources_get_request,
    build_snapshot_resources_list_by_report_resource_request,
    build_webhook_resources_create_or_update_request,
    build_webhook_resources_delete_request,
    build_webhook_resources_get_request,
    build_webhook_resources_list_by_report_resource_request,
    build_webhook_resources_update_request,
)
...
class ReportResourcesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.appcomplianceautomation.aio.AppComplianceAutomationClient`'s
    ...
    async def _fix_initial(self, report_name: str, **kwargs: Any) -> Optional[JSON]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    async def _verify_initial(self, report_name: str, **kwargs: Any) -> Optional[JSON]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
...
class ScopingConfigurationResourcesOperations:
    ...
    def list_by_report_resource(
        self, report_name: str, **kwargs: Any
    ) -> AsyncIterable["_models.ScopingConfigurationResource"]:
        # pylint: disable=line-too-long
...
class ProviderActionsOperations:
    ...
    async def begin_onboard(
    ...
    ) -> AsyncLROPoller[_models.OnboardResponse]:
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns OnboardResponse. The OnboardResponse is
         compatible with MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appcomplianceautomation.models.OnboardResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def begin_onboard(
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.OnboardResponse].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.OnboardResponse](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
    ...
    async def begin_trigger_evaluation(
    ...
    ) -> AsyncLROPoller[_models.TriggerEvaluationResponse]:
        # pylint: disable=line-too-long
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns TriggerEvaluationResponse. The
         TriggerEvaluationResponse is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appcomplianceautomation.models.TriggerEvaluationResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def begin_trigger_evaluation(
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.TriggerEvaluationResponse].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.TriggerEvaluationResponse](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
