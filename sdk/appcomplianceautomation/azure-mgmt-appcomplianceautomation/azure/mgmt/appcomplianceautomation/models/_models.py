...
class CertSyncRecord(_model_base.Model):
    ...
    offer_guid: Optional[str] = rest_field(name="offerGuid")
    """The offerGuid which mapping to the reports."""
    certification_status: Optional[str] = rest_field(name="certificationStatus")
    """Indicates the status of certification process."""
    ingestion_status: Optional[str] = rest_field(name="ingestionStatus")
...
class ComplianceReportItem(_model_base.Model):  # pylint: disable=too-many-instance-attributes
...
class ControlSyncRecord(_model_base.Model):
    ...
    control_id: Optional[str] = rest_field(name="controlId")
    """The Id of the control. e.g. \"Operational_Security_10\"."""
    control_status: Optional[str] = rest_field(name="controlStatus")
...
class EvidenceFileDownloadRequest(_model_base.Model):
    ...
    report_creator_tenant_id: Optional[str] = rest_field(name="reportCreatorTenantId")
    """Tenant id."""
    offer_guid: Optional[str] = rest_field(name="offerGuid")
    """The offerGuid which mapping to the reports."""
...
class EvidenceProperties(_model_base.Model):
    ...
    evidence_type: Optional[Union[str, "_models.EvidenceType"]] = rest_field(name="evidenceType")
    """Evidence type. Known values are: \"File\", \"AutoCollectedEvidence\", and \"Data\"."""
    file_path: str = rest_field(name="filePath")
    """The path of the file in storage. Required."""
    extra_data: Optional[str] = rest_field(name="extraData")
    """Extra data considered as evidence."""
    control_id: Optional[str] = rest_field(name="controlId")
    """Control id."""
    responsibility_id: Optional[str] = rest_field(name="responsibilityId")
    """Responsibility id."""
...
class EvidenceResource(ProxyResource):
    ...
    properties: "_models.EvidenceProperties" = rest_field()
...
class GetOverviewStatusResponse(_model_base.Model):
    ...
    status_list: Optional[List["_models.StatusItem"]] = rest_field(name="statusList")
...
class ListInUseStorageAccountsRequest(_model_base.Model):
    ...
    subscription_ids: Optional[List[str]] = rest_field(name="subscriptionIds")
...
class ListInUseStorageAccountsResponse(_model_base.Model):
    ...
    storage_account_list: Optional[List["_models.StorageInfo"]] = rest_field(name="storageAccountList")
...
class OnboardResponse(_model_base.Model):
...
class QuickAssessment(_model_base.Model):
    ...
    """Quick assessment status. Known values are: \"Healthy\" and \"Unhealthy\"."""
    display_name: Optional[str] = rest_field(name="displayName", visibility=["read"])
    """Quick assessment display name."""
    description: Optional[str] = rest_field(visibility=["read"])
    """Quick assessment display name."""
    remediation_link: Optional[str] = rest_field(name="remediationLink", visibility=["read"])
...
class ReportPatchProperties(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    trigger_time: Optional[datetime.datetime] = rest_field(name="triggerTime", format="rfc3339")
    ...
    storage_info: Optional["_models.StorageInfo"] = rest_field(name="storageInfo")
...
class ReportProperties(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    trigger_time: datetime.datetime = rest_field(name="triggerTime", format="rfc3339")
    """Report collection trigger time. Required."""
    time_zone: str = rest_field(name="timeZone")
    """Report collection trigger time's time zone, the available list can be obtained by executing
     \"Get-TimeZone -ListAvailable\" in PowerShell.
     An example of valid timezone id is \"Pacific Standard Time\". Required."""
    resources: List["_models.ResourceMetadata"] = rest_field()
...
class ReportResource(ProxyResource):
    ...
    properties: "_models.ReportProperties" = rest_field()
...
class ResourceMetadata(_model_base.Model):
    ...
    resource_kind: Optional[str] = rest_field(name="resourceKind")
    """Resource kind."""
    resource_origin: Optional[Union[str, "_models.ResourceOrigin"]] = rest_field(name="resourceOrigin")
    """Resource Origin. Known values are: \"Azure\", \"AWS\", and \"GCP\"."""
    account_id: Optional[str] = rest_field(name="accountId")
...
class Responsibility(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    """The supported cloud environment of this customer responsibility. Known values are: \"Azure\",
     \"AWS\", \"GCP\", and \"General\"."""
    failed_resource_count: Optional[int] = rest_field(name="failedResourceCount")
    """The count of all failed resources."""
    total_resource_count: Optional[int] = rest_field(name="totalResourceCount")
    ...
    evidence_files: Optional[List[str]] = rest_field(name="evidenceFiles")
...
class ResponsibilityResource(_model_base.Model):
    ...
    """The status change date for the resource."""
    recommendation_ids: Optional[List[str]] = rest_field(name="recommendationIds")
...
class ScopingAnswer(_model_base.Model):
    ...
    question_id: str = rest_field(name="questionId")
    """Question id. Required."""
    answers: List[str] = rest_field()
...
class SnapshotDownloadRequest(_model_base.Model):
    ...
    report_creator_tenant_id: Optional[str] = rest_field(name="reportCreatorTenantId")
    """Tenant id."""
    download_type: Union[str, "_models.DownloadType"] = rest_field(name="downloadType")
...
class StatusItem(_model_base.Model):
    ...
    status_name: Optional[str] = rest_field(name="statusName")
    """Status name - e.g. \"Active\", \"Failed\"."""
    status_value: Optional[str] = rest_field(name="statusValue")
...
class SyncCertRecordRequest(_model_base.Model):
    ...
    cert_record: "_models.CertSyncRecord" = rest_field(name="certRecord")
...
class SyncCertRecordResponse(_model_base.Model):
    ...
    cert_record: Optional["_models.CertSyncRecord"] = rest_field(name="certRecord")
...
class TriggerEvaluationProperty(_model_base.Model):
    ...
    trigger_time: Optional[datetime.datetime] = rest_field(name="triggerTime", visibility=["read"], format="rfc3339")
    """The time when the evaluation is triggered."""
    evaluation_end_time: Optional[datetime.datetime] = rest_field(
        name="evaluationEndTime", visibility=["read"], format="rfc3339"
    )
    """The time when the evaluation is end."""
    resource_ids: Optional[List[str]] = rest_field(name="resourceIds")
    """List of resource ids to be evaluated."""
    quick_assessments: Optional[List["_models.QuickAssessment"]] = rest_field(name="quickAssessments")
...
class TriggerEvaluationResponse(_model_base.Model):
    """Trigger evaluation response.
    ...
    properties: Optional["_models.TriggerEvaluationProperty"] = rest_field()
    ...
    def __init__(
        self,
        *,
        properties: Optional["_models.TriggerEvaluationProperty"] = None,
    ): ...
...
class WebhookProperties(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    """Webhook properties.
    ...
    tenant_id: Optional[str] = rest_field(name="tenantId", visibility=["read"])
    """Tenant id."""
    send_all_events: Optional[Union[str, "_models.SendAllEvents"]] = rest_field(name="sendAllEvents")
    ...
    payload_url: Optional[str] = rest_field(name="payloadUrl")
    """webhook payload url."""
    content_type: Optional[Union[str, "_models.ContentType"]] = rest_field(name="contentType")
    """content type. \"application/json\""""
    webhook_key: Optional[str] = rest_field(name="webhookKey")
    """webhook secret token. If not set, this field value is null; otherwise, please set a string
     value."""
    update_webhook_key: Optional[Union[str, "_models.UpdateWebhookKey"]] = rest_field(name="updateWebhookKey")
...
class WebhookResource(ProxyResource):
    ...
    properties: "_models.WebhookProperties" = rest_field()
