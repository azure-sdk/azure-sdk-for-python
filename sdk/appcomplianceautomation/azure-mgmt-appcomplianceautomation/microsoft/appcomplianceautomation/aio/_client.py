...
class AppComplianceAutomationMgmtClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype report: microsoft.appcomplianceautomation.aio.operations.ReportOperations
    :ivar webhook: WebhookOperations operations
    :vartype webhook: microsoft.appcomplianceautomation.aio.operations.WebhookOperations
    :ivar snapshot: SnapshotOperations operations
    :vartype snapshot: microsoft.appcomplianceautomation.aio.operations.SnapshotOperations
    :ivar scoping_configuration: ScopingConfigurationOperations operations
    :vartype scoping_configuration:
     microsoft.appcomplianceautomation.aio.operations.ScopingConfigurationOperations
    :ivar evidence: EvidenceOperations operations
    :vartype evidence: microsoft.appcomplianceautomation.aio.operations.EvidenceOperations
    :ivar operations: Operations operations
    :vartype operations: microsoft.appcomplianceautomation.aio.operations.Operations
    :ivar provider_actions: ProviderActionsOperations operations
    :vartype provider_actions:
     microsoft.appcomplianceautomation.aio.operations.ProviderActionsOperations
