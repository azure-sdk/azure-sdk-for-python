...
class AppComplianceAutomationMgmtClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype report: microsoft.appcomplianceautomation.operations.ReportOperations
    :ivar webhook: WebhookOperations operations
    :vartype webhook: microsoft.appcomplianceautomation.operations.WebhookOperations
    :ivar snapshot: SnapshotOperations operations
    :vartype snapshot: microsoft.appcomplianceautomation.operations.SnapshotOperations
    :ivar scoping_configuration: ScopingConfigurationOperations operations
    :vartype scoping_configuration:
     microsoft.appcomplianceautomation.operations.ScopingConfigurationOperations
    :ivar evidence: EvidenceOperations operations
    :vartype evidence: microsoft.appcomplianceautomation.operations.EvidenceOperations
    :ivar operations: Operations operations
    :vartype operations: microsoft.appcomplianceautomation.operations.Operations
    :ivar provider_actions: ProviderActionsOperations operations
    :vartype provider_actions:
     microsoft.appcomplianceautomation.operations.ProviderActionsOperations
