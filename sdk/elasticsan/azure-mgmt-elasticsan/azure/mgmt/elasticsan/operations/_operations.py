...
def build_elastic_sans_list_by_elastic_san_request(  # pylint: disable=name-too-long
    resource_group_name: str, elastic_san_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_volume_groups_pre_backup_request(
    resource_group_name: str, elastic_san_name: str, volume_group_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_volume_groups_pre_restore_request(
    resource_group_name: str, elastic_san_name: str, volume_group_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_volumes_restore_volume_request(
    resource_group_name: str,
    elastic_san_name: str,
    volume_group_name: str,
    volume_name: str,
...
def build_snapshots_list_by_volume_group_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    elastic_san_name: str,
    volume_group_name: str,
    subscription_id: str,
...
def build_skus_operation_group_list_request(
...
class Operations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.elasticsan.ElasticSanClient`'s
...
class ElasticSansOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.ElasticSan"]:
    ...
    def list_by_elastic_san(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.elasticsan.models.PrivateLinkResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
