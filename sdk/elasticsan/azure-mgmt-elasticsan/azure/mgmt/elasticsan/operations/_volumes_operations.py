...
class VolumesOperations:
    ...
    def begin_pre_restore(
        ...
        **kwargs: Any
        ...
        :param parameters: Disk Snapshot List (currently only one Disk Snapshot in the list is
         supported. Server would return error if list is bigger). Required.
    ...
    def begin_pre_restore(
        ...
        **kwargs: Any
        ...
        :type volume_group_name: str
        :param parameters: Disk Snapshot List (currently only one Disk Snapshot in the list is
         supported. Server would return error if list is bigger). Is either a DiskSnapshotList type or a
