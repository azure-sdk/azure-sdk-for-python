    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "volumeName": _SERIALIZER.url(
            "volume_name", volume_name, "str", max_length=63, min_length=3, pattern=r"^[a-z0-9]+((-|_)[a-z0-9A-Z]+)*$"
        ),
    }
...
class VolumesOperations:
    ...
    def begin_delete(
        ...
        **kwargs: Any
        ...
        :param purge: Optional, used to purge soft deleted volumes if set to true. Known values are:
