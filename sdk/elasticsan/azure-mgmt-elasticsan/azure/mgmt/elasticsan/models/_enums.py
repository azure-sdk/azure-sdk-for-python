...
class X_ms_access_soft_deleted_resources(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Type of x-ms-access-soft-deleted-resources."""

    TRUE = "true"
    FALSE = "false"


class X_ms_delete_snapshots(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Type of x-ms-delete-snapshots."""

    TRUE = "true"
    FALSE = "false"


class X_ms_force_delete(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Type of x-ms-force-delete."""
