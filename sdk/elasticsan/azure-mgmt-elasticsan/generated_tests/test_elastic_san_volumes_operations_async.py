...
class TestElasticSanVolumesOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_volumes_begin_restore_volume(self, resource_group):
        response = await (
            await self.client.volumes.begin_restore_volume(
                resource_group_name=resource_group.name,
                elastic_san_name="str",
                volume_group_name="str",
                volume_name="str",
