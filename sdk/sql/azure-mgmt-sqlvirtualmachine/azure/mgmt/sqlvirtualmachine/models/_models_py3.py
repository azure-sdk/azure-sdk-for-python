...
class SqlVirtualMachine(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        additional_vm_patch: Optional[Union[str, "_models.AdditionalOsPatch"]] = None,
        ...
        **kwargs: Any
        ...
        :keyword additional_vm_patch: Additional VM Patching solution enabled on the Virtual Machine.
         Known values are: "WU", "WUMU", and "WSUS".
        :paramtype additional_vm_patch: str or ~azure.mgmt.sqlvirtualmachine.models.AdditionalOsPatch
...
class SqlVirtualMachineUpdate(_serialization.Model):  # pylint: disable=too-many-instance-attributes
