...
def build_fetch_dc_assessment_request(
    resource_group_name: str, sql_virtual_machine_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SqlVirtualMachine/sqlVirtualMachines/{sqlVirtualMachineName}/fetchDCAssessment",
    )  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "sqlVirtualMachineName": _SERIALIZER.url(
...
class SqlVirtualMachinesOperations:
    ...
    def list_by_sql_vm_group(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_sql_vm_group_request(
    ...
    def _start_assessment_initial(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_start_assessment_request(
            resource_group_name=resource_group_name,
    ...
    def _fetch_dc_assessment_initial(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        sql_virtual_machine_name: str,
        parameters: Union[_models.DiskConfigAssessmentRequest, IO[bytes]],
        **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "DiskConfigAssessmentRequest")

        _request = build_fetch_dc_assessment_request(
            resource_group_name=resource_group_name,
            sql_virtual_machine_name=sql_virtual_machine_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def begin_fetch_dc_assessment(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.sqlvirtualmachine.models.DiskConfigAssessmentRequest or IO[bytes]
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._fetch_dc_assessment_initial(  # type: ignore
                resource_group_name=resource_group_name,
                sql_virtual_machine_name=sql_virtual_machine_name,
    ...
    def _create_or_update_initial(
        ...
        resource_group_name: str,
        sql_virtual_machine_name: str,
        parameters: Union[_models.SqlVirtualMachine, IO[bytes]],
        **kwargs: Any
    ) -> _models.SqlVirtualMachine:
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The SQL virtual machine. Is either a SqlVirtualMachine type or a IO[bytes]
         type. Required.
        :type parameters: ~azure.mgmt.sqlvirtualmachine.models.SqlVirtualMachine or IO[bytes]
        :return: An instance of LROPoller that returns either SqlVirtualMachine or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.sqlvirtualmachine.models.SqlVirtualMachine]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        sql_virtual_machine_name: str,
        parameters: Union[_models.SqlVirtualMachineUpdate, IO[bytes]],
        **kwargs: Any
    ) -> _models.SqlVirtualMachine:
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.sqlvirtualmachine.models.SqlVirtualMachineUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either SqlVirtualMachine or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.sqlvirtualmachine.models.SqlVirtualMachine]
        :raises ~azure.core.exceptions.HttpResponseError:
