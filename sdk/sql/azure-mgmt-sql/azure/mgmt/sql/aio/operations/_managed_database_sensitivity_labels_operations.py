...
class ManagedDatabaseSensitivityLabelsOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        request = build_get_request(
            ...
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            sensitivity_label_source=self._config.sensitivity_label_source,
    ...
    async def get_recommended(
        ...
        **kwargs: Any
        ...
        request = build_get_recommended_request(
            resource_group_name=resource_group_name,
            managed_instance_name=managed_instance_name,
            database_name=database_name,
            schema_name=schema_name,
            ...
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self.get_recommended.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    get_recommended.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/schemas/{schemaName}/tables/{tableName}/columns/{columnName}/sensitivityLabels/recommended"
    }
    ...
    list_by_database.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/sensitivityLabels"
    }
