...
class ServiceObjectivesOperations:
    ...
    async def get(
        self, resource_group_name: str, server_name: str, service_objective_name: str, **kwargs: Any
        ...
        cls: ClsType[_models.ServiceObjective] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("ServiceObjective", pipeline_response.http_response)
    ...
    def list_by_server(
    ...
    ) -> AsyncIterable["_models.ServiceObjective"]:
        ...
        :param server_name: The name of the server. Required.
        :type server_name: str
        :return: An iterator like instance of either ServiceObjective or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ServiceObjective]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
