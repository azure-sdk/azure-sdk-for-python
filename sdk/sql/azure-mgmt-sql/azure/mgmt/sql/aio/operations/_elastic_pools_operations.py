...
from ...operations._elastic_pools_operations import (
...
class ElasticPoolsOperations:
    ...
    @distributed_trace
    def list_metrics(
        self, resource_group_name: str, server_name: str, elastic_pool_name: str, filter: str, **kwargs: Any
    ...
    @distributed_trace
    def list_by_server(
        self, resource_group_name: str, server_name: str, skip: Optional[int] = None, **kwargs: Any
    ) -> AsyncIterable["_models.ElasticPool"]:
        ...
        :type skip: int
        :return: An iterator like instance of either ElasticPool or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ElasticPool]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def get(
        ...
        deserialized = self._deserialize("ElasticPool", pipeline_response.http_response)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either ElasticPool or the result of
         cls(response)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The elastic pool parameters. Is either a ElasticPool type or a IO[bytes]
         type. Required.
        :type parameters: ~azure.mgmt.sql.models.ElasticPool or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ElasticPool or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sql.models.ElasticPool]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return AsyncLROPoller[_models.ElasticPool].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ElasticPool](
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.sql.models.ElasticPoolUpdate or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ElasticPool or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sql.models.ElasticPool]
        :raises ~azure.core.exceptions.HttpResponseError:
