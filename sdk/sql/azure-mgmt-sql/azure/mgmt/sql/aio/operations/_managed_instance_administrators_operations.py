...
from ...operations._managed_instance_administrators_operations import (
...
class ManagedInstanceAdministratorsOperations:
    ...
    def list_by_instance(
    ...
    ) -> AsyncIterable["_models.ManagedInstanceAdministrator"]:
        ...
        :return: An iterator like instance of either ManagedInstanceAdministrator or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ManagedInstanceAdministrator]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either ManagedInstanceAdministrator or the
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.ManagedInstanceAdministrator].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ManagedInstanceAdministrator](
