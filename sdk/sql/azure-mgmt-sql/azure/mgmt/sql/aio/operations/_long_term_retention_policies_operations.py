...
from ...operations._long_term_retention_policies_operations import (
...
class LongTermRetentionPoliciesOperations:
    ...
    def list_by_database(
    ...
    ) -> AsyncIterable["_models.LongTermRetentionPolicy"]:
        ...
        :return: An iterator like instance of either LongTermRetentionPolicy or the result of
         cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.LongTermRetentionPolicy]
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("LongTermRetentionPolicy", pipeline_response.http_response)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.sql.models.LongTermRetentionPolicy or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either LongTermRetentionPolicy or the
         result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sql.models.LongTermRetentionPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return AsyncLROPoller[_models.LongTermRetentionPolicy].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.LongTermRetentionPolicy](
