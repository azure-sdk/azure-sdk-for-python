...
class ManagedInstanceAdvancedThreatProtectionSettingsOperations:  # pylint: disable=name-too-long
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.sql.models.ManagedInstanceAdvancedThreatProtection or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either
         ManagedInstanceAdvancedThreatProtection or the result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sql.models.ManagedInstanceAdvancedThreatProtection]
        ...
        if cont_token:
            return AsyncLROPoller[_models.ManagedInstanceAdvancedThreatProtection].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ManagedInstanceAdvancedThreatProtection](
