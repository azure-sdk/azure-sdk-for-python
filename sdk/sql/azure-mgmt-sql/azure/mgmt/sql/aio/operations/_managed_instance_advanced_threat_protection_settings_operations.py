...
from ...operations._managed_instance_advanced_threat_protection_settings_operations import (
...
class ManagedInstanceAdvancedThreatProtectionSettingsOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`managed_instance_advanced_threat_protection_settings` attribute.
    """
    ...
    def list_by_instance(
    ...
    ) -> AsyncIterable["_models.ManagedInstanceAdvancedThreatProtection"]:
        ...
        :return: An iterator like instance of either ManagedInstanceAdvancedThreatProtection or the
         result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ManagedInstanceAdvancedThreatProtection]
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("ManagedInstanceAdvancedThreatProtectionListResult", pipeline_response)
    ...
    list_by_instance.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/advancedThreatProtectionSettings"
    }
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ManagedInstanceAdvancedThreatProtection or the result of cls(response)
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2023-02-01-preview"))
        cls: ClsType[_models.ManagedInstanceAdvancedThreatProtection] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("ManagedInstanceAdvancedThreatProtection", pipeline_response)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/advancedThreatProtectionSettings/{advancedThreatProtectionName}"
    }
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        cls: ClsType[Optional[_models.ManagedInstanceAdvancedThreatProtection]] = kwargs.pop("cls", None)
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "ManagedInstanceAdvancedThreatProtection")
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.sql.models.ManagedInstanceAdvancedThreatProtection
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sql.models.ManagedInstanceAdvancedThreatProtection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
