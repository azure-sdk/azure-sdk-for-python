...
from ...operations._database_recommended_actions_operations import (
    build_get_request,
    build_list_by_database_advisor_request,
...
class DatabaseRecommendedActionsOperations:
    ...
    async def list_by_database_advisor(
        ...
        deserialized = self._deserialize("[RecommendedActionAutoGenerated]", pipeline_response)
    ...
    async def update(
        ...
        advisor_name: str,
        recommended_action_name: str,
        parameters: Union[_models.RecommendedActionAutoGenerated, IO],
        **kwargs: Any
    ) -> _models.RecommendedActionAutoGenerated:
        """Updates a database recommended action.
        ...
        :param parameters: The requested recommended action resource state. Is either a
         RecommendedActionAutoGenerated type or a IO type. Required.
        :type parameters: ~azure.mgmt.sql.models.RecommendedActionAutoGenerated or IO
