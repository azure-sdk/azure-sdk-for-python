...
from ...operations._elastic_pool_database_activities_operations import build_list_by_elastic_pool_request
...
class ElasticPoolDatabaseActivitiesOperations:
    ...
    def list_by_elastic_pool(
    ...
    ) -> AsyncIterable["_models.ElasticPoolDatabaseActivity"]:
        ...
        :return: An iterator like instance of either ElasticPoolDatabaseActivity or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ElasticPoolDatabaseActivity]
