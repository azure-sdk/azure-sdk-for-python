...
def build_get_request(
    deleted_server_name: str, resource_group_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class DeletedServersOperations:
    ...
    list.metadata = {"url": "/subscriptions/{subscriptionId}/providers/Microsoft.Sql/deletedServers"}

    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.DeletedServer"]:
        """Gets a list of all deleted servers in the specified resource group that can be restored.
    ...
    list_by_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/deletedServers"
    }

    @distributed_trace
    def get(self, deleted_server_name: str, resource_group_name: str, **kwargs: Any) -> _models.DeletedServer:
        """Gets information about an Azure SQL server that has been deleted and can be restored. To
        restore a deleted server, create a server with the same name and a create mode of ``Restore``.
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/deletedServers/{deletedServerName}"
    }
