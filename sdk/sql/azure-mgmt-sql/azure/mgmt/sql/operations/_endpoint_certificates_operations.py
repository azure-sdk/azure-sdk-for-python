...
def build_get_request(
    resource_group_name: str, managed_instance_name: str, endpoint_type: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class EndpointCertificatesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`endpoint_certificates` attribute.
    """
    ...
    def list_by_instance(
    ...
    ) -> Iterable["_models.EndpointCertificate"]:
        ...
        :return: An iterator like instance of either EndpointCertificate or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.EndpointCertificate]
    ...
    list_by_instance.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/endpointCertificates"
    }

    @distributed_trace
    def get(
        self, resource_group_name: str, managed_instance_name: str, endpoint_type: str, **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.EndpointCertificate] = kwargs.pop("cls", None)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/endpointCertificates/{endpointType}"
    }
