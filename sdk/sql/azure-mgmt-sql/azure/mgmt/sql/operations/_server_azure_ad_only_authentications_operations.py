...
class ServerAzureADOnlyAuthenticationsOperations:  # pylint: disable=name-too-long
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either ServerAzureADOnlyAuthentication or the
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.ServerAzureADOnlyAuthentication].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ServerAzureADOnlyAuthentication](
    ...
    def list_by_server(
    ...
    ) -> Iterable["_models.ServerAzureADOnlyAuthentication"]:
        ...
        :return: An iterator like instance of either ServerAzureADOnlyAuthentication or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.ServerAzureADOnlyAuthentication]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
