...
class DeletedServer(ProxyResource):
    ...
    :ivar fully_qualified_domain_name: The fully qualified domain name of the server before
     deletion.
    :vartype fully_qualified_domain_name: str
    :ivar scheduled_purge_date: Time at which the server data will be purged, after which server
     restore will no longer be possible. If this is ``null``\ , then default behavior will be used.
