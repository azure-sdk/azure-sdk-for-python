...
class Server(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar external_governance_status: Status of external governance. Known values are: "Enabled"
     and "Disabled".
    :vartype external_governance_status: str or ~azure.mgmt.sql.models.ExternalGovernanceStatus
    :ivar retention_days: Number of days that a server will stay soft-deleted when dropped.
    :vartype retention_days: int
    :ivar create_mode: Create mode for the server. Value is optional but if passed in, must be
     'Normal' or 'Restore'. Known values are: "Normal" and "Restore".
    ...
    _validation = {
        ...
        "external_governance_status": {"readonly": True},
        "retention_days": {"maximum": 7, "minimum": 0},
    }
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :keyword retention_days: Number of days that a server will stay soft-deleted when dropped.
        :paramtype retention_days: int
        :keyword create_mode: Create mode for the server. Value is optional but if passed in, must be
         'Normal' or 'Restore'. Known values are: "Normal" and "Restore".
