...
class RecommendedAction(_serialization.Model):  # pylint: disable=too-many-instance-attributes
...
class RecommendedActionAutoGenerated(ProxyResource):  # pylint: disable=too-many-instance-attributes
    """Database, Server or Elastic Pool Recommended Action.
...
class UpsertManagedServerOperationStepWithEstimatesAndDuration(_serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        name: Optional[str] = None,
        status: Optional[Union[str, "_models.UpsertManagedServerOperationStepWithEstimatesAndDurationStatus"]] = None,
        **kwargs: Any
    ) -> None:
        """
