...
class CertificateInfo(_serialization.Model):
    ...
    :ivar certificate_id: The certificate ID.
...
class DatabaseVulnerabilityAssessmentRuleBaselineAutoGenerated(ProxyResource):
    """A database vulnerability assessment rule baseline.
...
class DistributedAvailabilityGroup(ProxyResource):  # pylint: disable=too-many-instance-attributes
    ...
    _validation = {
        ...
        "partner_availability_group_name": {"readonly": True},
        "partner_endpoint": {"readonly": True},
        "instance_link_role": {"readonly": True},
        "instance_availability_group_name": {"readonly": True},
    ...
    def __init__(
        self, *, replication_mode: Optional[Union[str, "_models.ReplicationModeType"]] = None, **kwargs: Any
    ) -> None:
        """
        ...
        self.partner_availability_group_name = None
        self.partner_endpoint = None
        self.instance_link_role = None
        self.instance_availability_group_name = None
        self.databases = None
...
class DistributedAvailabilityGroupsCreateOrUpdateRequestBody(_serialization.Model):
...
class ImportNewDatabaseDefinition(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype authentication_type: str
    :ivar network_isolation: Optional resource information to enable network isolation for request.
    :vartype network_isolation: ~azure.mgmt.sql.models.NetworkIsolationSettingsAutoGenerated2
    """
    ...
    _attribute_map = {
        ...
        "administrator_login_password": {"key": "administratorLoginPassword", "type": "str"},
        "authentication_type": {"key": "authenticationType", "type": "str"},
        "network_isolation": {"key": "networkIsolation", "type": "NetworkIsolationSettingsAutoGenerated2"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        max_size_bytes: Optional[str] = None,
        authentication_type: Optional[str] = None,
        network_isolation: Optional["_models.NetworkIsolationSettingsAutoGenerated2"] = None,
        **kwargs: Any
    ) -> None:
        """
        ...
        :keyword network_isolation: Optional resource information to enable network isolation for
         request.
        :paramtype network_isolation: ~azure.mgmt.sql.models.NetworkIsolationSettingsAutoGenerated2
        """
        super().__init__(**kwargs)
...
class NetworkIsolationSettingsAutoGenerated2(_serialization.Model):
    """Contains the ARM resources for which to create private endpoint connection.
