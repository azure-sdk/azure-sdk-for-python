...
class MaintenancePolicy(_serialization.Model):
    ...
    :ivar type: Type of customer maintenance schedule. Known values are: "SystemDefined" and
     "CustomerDefined".
    :vartype type: str or ~azure.mgmt.sql.models.Type
    :ivar maintenance_configuration_id: Maintenance configuration id for system defined maintenance
     policy.
    :vartype maintenance_configuration_id: str
    :ivar start_hour: Start hour for customer defined maintenance policy.
    :vartype start_hour: int
    :ivar day_of_week: Day of week for customer defined maintenance policy.
    :vartype day_of_week: str
    """

    _attribute_map = {
        "type": {"key": "type", "type": "str"},
        "maintenance_configuration_id": {"key": "maintenanceConfigurationId", "type": "str"},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword type: Type of customer maintenance schedule. Known values are: "SystemDefined" and
         "CustomerDefined".
        :paramtype type: str or ~azure.mgmt.sql.models.Type
        :keyword maintenance_configuration_id: Maintenance configuration id for system defined
         maintenance policy.
        :paramtype maintenance_configuration_id: str
        :keyword start_hour: Start hour for customer defined maintenance policy.
        :paramtype start_hour: int
        :keyword day_of_week: Day of week for customer defined maintenance policy.
        :paramtype day_of_week: str
        """
        super().__init__(**kwargs)
        self.type = type
        self.maintenance_configuration_id = maintenance_configuration_id
...
class ManagedInstance(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar maintenance_configuration_id: Specifies maintenance configuration id to apply to this
     managed instance.
    :vartype maintenance_configuration_id: str
    :ivar maintenance_policy: This managed instance value is used to determine schedule for custom
     maintenance.
    :vartype maintenance_policy: ~azure.mgmt.sql.models.MaintenancePolicy
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :keyword maintenance_configuration_id: Specifies maintenance configuration id to apply to this
         managed instance.
        :paramtype maintenance_configuration_id: str
        :keyword maintenance_policy: This managed instance value is used to determine schedule for
         custom maintenance.
        :paramtype maintenance_policy: ~azure.mgmt.sql.models.MaintenancePolicy
