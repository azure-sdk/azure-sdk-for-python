...
from .._vendor import AppClientMixinABC, FileType, prepare_multipart_form_data
...
def build_session_resource_files_list_files_metadata_request(  # pylint: disable=name-too-long
...
def build_session_resource_files_get_file_metadata_request(  # pylint: disable=name-too-long
    file_name: str, *, identifier: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_session_resource_files_download_file_request(  # pylint: disable=name-too-long
    file_name: str, *, identifier: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_session_resource_files_upload_file_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/files/{fileName}:uploadFile"
    path_format_arguments = {
        "fileName": _SERIALIZER.url("file_name", file_name, "str"),
    }
...
def build_app_execute_code_request(*, identifier: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_app_get_code_execution_result_request(  # pylint: disable=name-too-long
    *, identifier: str, execution_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/codeExecutionResult"

    # Construct parameters
    _params["api-version"] = _SERIALIZER.query("api_version", api_version, "str")
    _params["identifier"] = _SERIALIZER.query("identifier", identifier, "str")
    _params["executionId"] = _SERIALIZER.query("execution_id", execution_id, "str")
...
class SessionResourceFilesOperations:
    ...
    @distributed_trace
    def list_files_metadata(self, *, identifier: str, **kwargs: Any) -> Iterable["_models.SessionResourceFile"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~microsoft.app.models.SessionResourceFile]
    ...
    @distributed_trace
    def get_file_metadata(self, file_name: str, *, identifier: str, **kwargs: Any) -> _models.SessionResourceFile:
        ...
        :rtype: ~microsoft.app.models.SessionResourceFile
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def delete_file(  # pylint: disable=inconsistent-return-statements
        self, file_name: str, *, identifier: str, **kwargs: Any
    ) -> None:
        """Delete the file.
    ...
    @distributed_trace
    def download_file(self, file_name: str, *, identifier: str, **kwargs: Any) -> bytes:
        """Download the file.
        ...
        _request = build_session_resource_files_download_file_request(
            file_name=file_name,
            identifier=identifier,
            api_version=self._config.api_version,
            headers=_headers,
    ...
    @overload
    def upload_file(self, file_name: str, body: JSON, *, identifier: str, **kwargs: Any) -> _models.SessionResourceFile:
    ...
    @overload
    def upload_file(
        self, file_name: str, *, identifier: str, file: FileType, **kwargs: Any
    ...
    @distributed_trace
    def upload_file(
        self, file_name: str, body: JSON = _Unset, *, identifier: str, file: FileType = _Unset, **kwargs: Any
    ) -> _models.SessionResourceFile:
        """Upload a file to a session.
...
class AppClientOperationsMixin(AppClientMixinABC):
    ...
    def execute_code(
        ...
        **kwargs: Any
    ) -> _models.SessionCodeExecutionResult:
        ...
        :return: SessionCodeExecutionResult. The SessionCodeExecutionResult is compatible with
         MutableMapping
        :rtype: ~microsoft.app.models.SessionCodeExecutionResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """

    @overload
    def execute_code(
        self, code_execution_request: JSON, *, identifier: str, content_type: str = "application/json", **kwargs: Any
    ) -> _models.SessionCodeExecutionResult:
        """Execute code in a session.
    ...
    def execute_code(
        ...
        **kwargs: Any
        ...
        _request = build_app_execute_code_request(
            identifier=identifier,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.SessionCodeExecutionResult, response.json())
    ...
    def get_code_execution_result(
        self, *, identifier: str, execution_id: str, **kwargs: Any
    ) -> _models.SessionCodeExecutionResult:
        """Get the code execution result.

        :keyword identifier: The identifier of the session. Required.
        :paramtype identifier: str
        :keyword execution_id: The identifier of code execution. Required.
        ...
        _request = build_app_get_code_execution_result_request(
            identifier=identifier,
