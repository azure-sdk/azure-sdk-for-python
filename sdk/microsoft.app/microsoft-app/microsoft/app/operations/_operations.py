...
def build_code_execution_files_list_file_metadata_request(  # pylint: disable=name-too-long
    subscription_id: str, resource_group_name: str, session_pool_name: str, *, identifier: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/sessionPools/{sessionPoolName}/files"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "sessionPoolName": _SERIALIZER.url("session_pool_name", session_pool_name, "str"),
...
def build_code_execution_files_get_file_metadata_request(  # pylint: disable=name-too-long
    subscription_id: str,
...
def build_code_execution_files_delete_file_request(  # pylint: disable=name-too-long
    subscription_id: str,
    resource_group_name: str,
    session_pool_name: str,
    filename: str,
...
def build_code_execution_files_get_file_content_request(  # pylint: disable=name-too-long
    subscription_id: str,
    resource_group_name: str,
    session_pool_name: str,
    filename: str,
...
def build_code_execution_files_upload_file_request(  # pylint: disable=name-too-long
    subscription_id: str,
    resource_group_name: str,
    session_pool_name: str,
    filename: str,
...
class CodeExecutionFilesOperations:
    ...
    def list_file_metadata(
    ...
    ) -> Iterable["_models.CodeExecutionFile"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~microsoft.app.models.CodeExecutionFile]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
