...
from ...operations._operations import (
    build_app_execute_code_request,
    build_app_get_code_execution_result_request,
    build_session_resource_files_delete_file_request,
    build_session_resource_files_download_file_request,
...
from .._vendor import AppClientMixinABC
...
class SessionResourceFilesOperations:
    ...
    @distributed_trace
    def list_files_metadata(self, *, identifier: str, **kwargs: Any) -> AsyncIterable["_models.SessionResourceFile"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~microsoft.app.models.SessionResourceFile]
    ...
    async def get_file_metadata(self, file_name: str, *, identifier: str, **kwargs: Any) -> _models.SessionResourceFile:
    ...
    @distributed_trace_async
    async def download_file(self, file_name: str, *, identifier: str, **kwargs: Any) -> bytes:
        """Download the file.
    ...
    async def upload_file(
        self, file_name: str, body: JSON, *, identifier: str, **kwargs: Any
