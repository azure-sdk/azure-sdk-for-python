...
class AppClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype code_execution: microsoft.app.aio.operations.CodeExecutionOperations
    :ivar code_execution_files: CodeExecutionFilesOperations operations
    :vartype code_execution_files: microsoft.app.aio.operations.CodeExecutionFilesOperations
