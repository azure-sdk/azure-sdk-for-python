...
class AppClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype session_code_execution: microsoft.app.operations.SessionCodeExecutionOperations
    :ivar session_resource_files: SessionResourceFilesOperations operations
    :vartype session_resource_files: microsoft.app.operations.SessionResourceFilesOperations
