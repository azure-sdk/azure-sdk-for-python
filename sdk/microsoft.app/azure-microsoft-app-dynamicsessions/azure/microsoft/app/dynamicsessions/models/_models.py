...
class SessionCodeExecutionRequest(_model_base.Model):
    ...
    :vartype code_input_type: str or ~azure.microsoft.app.dynamicsessions.models.CodeInputType
    ...
    :vartype execution_type: str or ~azure.microsoft.app.dynamicsessions.models.ExecutionType
...
class SessionCodeExecutionResource(_model_base.Model):
    ...
    :vartype status: str or ~azure.microsoft.app.dynamicsessions.models.OperationState
    ...
    :vartype result: ~azure.microsoft.app.dynamicsessions.models.SessionCodeExecutionResult
    """
