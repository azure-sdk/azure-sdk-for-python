...
from .operations import CodeExecutionOperations, SessionResourceFilesOperations
...
class DynamicSessionsClient:
    ...
    :vartype code_execution:
     azure.microsoft.app.dynamicsessions.aio.operations.CodeExecutionOperations
    :ivar session_resource_files: SessionResourceFilesOperations operations
    :vartype session_resource_files:
     azure.microsoft.app.dynamicsessions.aio.operations.SessionResourceFilesOperations
