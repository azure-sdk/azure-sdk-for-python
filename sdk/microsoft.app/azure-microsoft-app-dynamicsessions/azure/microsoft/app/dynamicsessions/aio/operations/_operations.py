...
class CodeExecutionOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.microsoft.app.dynamicsessions.aio.DynamicSessionsClient`'s
    ...
    async def begin_execute(
        ...
        **kwargs: Any
        ...
        :type code_execution_request:
         ~azure.microsoft.app.dynamicsessions.models.SessionCodeExecutionRequest
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.microsoft.app.dynamicsessions.models.SessionCodeExecutionResult]
    ...
    async def begin_execute(
        ...
        **kwargs: Any
        ...
        :type code_execution_request:
         ~azure.microsoft.app.dynamicsessions.models.SessionCodeExecutionRequest or JSON or IO[bytes]
        :keyword identifier: The user-assigned identifier of the session. Required.
        :paramtype identifier: str
        :keyword operation_id: The id of this execution operation. Default value is None.
        :paramtype operation_id: str
    ...
    async def get(self, execution_id: str, *, identifier: str, **kwargs: Any) -> _models.SessionCodeExecutionResource:
        ...
        :return: SessionCodeExecutionResource. The SessionCodeExecutionResource is compatible with
         MutableMapping
        :rtype: ~azure.microsoft.app.dynamicsessions.models.SessionCodeExecutionResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
...
class SessionResourceFilesOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.microsoft.app.dynamicsessions.models.SessionResourceFile]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def get(
        ...
        :rtype: ~azure.microsoft.app.dynamicsessions.models.SessionResourceFile
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def upload(
        ...
        :paramtype file: ~azure.microsoft.app.dynamicsessions._vendor.FileType
        :keyword path: The path of the file after uploaded. Default value is None.
        :paramtype path: str
        :return: SessionResourceFile. The SessionResourceFile is compatible with MutableMapping
        :rtype: ~azure.microsoft.app.dynamicsessions.models.SessionResourceFile
