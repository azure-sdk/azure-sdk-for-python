...
class DynamicSessionsClient:
    ...
    :vartype code_execution: azure.microsoft.app.dynamicsessions.operations.CodeExecutionOperations
    :ivar session_resource_files: SessionResourceFilesOperations operations
    :vartype session_resource_files:
     azure.microsoft.app.dynamicsessions.operations.SessionResourceFilesOperations
