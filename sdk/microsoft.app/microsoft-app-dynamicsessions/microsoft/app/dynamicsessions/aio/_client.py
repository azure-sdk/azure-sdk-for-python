...
class DynamicSessionsClient:
    ...
    :vartype code_execution: microsoft.app.dynamicsessions.aio.operations.CodeExecutionOperations
    :ivar session_resource_files: SessionResourceFilesOperations operations
    :vartype session_resource_files:
     microsoft.app.dynamicsessions.aio.operations.SessionResourceFilesOperations
    :ivar session_management: SessionManagementOperations operations
    :vartype session_management:
     microsoft.app.dynamicsessions.aio.operations.SessionManagementOperations
    :ivar list_sessions: ListSessionsOperations operations
    :vartype list_sessions: microsoft.app.dynamicsessions.aio.operations.ListSessionsOperations
    :ivar session_pool_metadata: SessionPoolMetadataOperations operations
    :vartype session_pool_metadata:
     microsoft.app.dynamicsessions.aio.operations.SessionPoolMetadataOperations
