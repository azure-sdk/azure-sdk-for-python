...
class CodeExecutionOperations:
    ...
    async def get_result(
        self, execution_id: str, *, identifier: str, **kwargs: Any
...
class SessionResourceFilesOperations:
    ...
    @distributed_trace_async
    async def delete_file(self, name: str, *, identifier: str, path: Optional[str] = None, **kwargs: Any) -> None:
        """Delete the file.
    ...
    @distributed_trace_async
    async def get_file_content(self, name: str, *, identifier: str, path: Optional[str] = None, **kwargs: Any) -> bytes:
