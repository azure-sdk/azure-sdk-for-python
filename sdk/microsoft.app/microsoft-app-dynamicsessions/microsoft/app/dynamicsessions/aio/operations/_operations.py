...
from ...operations._operations import (
    ...
    build_list_sessions_get_request,
    build_session_management_delete_request,
    build_session_management_get_request,
    build_session_pool_metadata_get_request,
...
class SessionResourceFilesOperations:
    ...
    @distributed_trace_async
    async def get_content(self, name: str, *, identifier: str, path: Optional[str] = None, **kwargs: Any) -> bytes:
...
class SessionManagementOperations:
    ...
    @distributed_trace_async
    async def get(self, *, identifier: str, **kwargs: Any) -> _models.Session:
        """Get the session.
    ...
    @distributed_trace_async
    async def delete(self, *, identifier: str, **kwargs: Any) -> None:
        """Delete the session.
...
class ListSessionsOperations:
    ...
    @distributed_trace_async
    async def get(self, *, skip: Optional[int] = None, **kwargs: Any) -> _models.SessionsListResponse:
        """List the sessions.
...
class SessionPoolMetadataOperations:
    ...
    @distributed_trace_async
    async def get(self, **kwargs: Any) -> _models.SessionPoolMetadataResponse:
