...
def build_code_execution_get_result_request(execution_id: str, *, identifier: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class CodeExecutionOperations:
    ...
    @distributed_trace
    def get_result(self, execution_id: str, *, identifier: str, **kwargs: Any) -> _models.SessionCodeExecutionResponse:
...
class SessionResourceFilesOperations:
    ...
    @distributed_trace
    def get_file_content(self, name: str, *, identifier: str, path: Optional[str] = None, **kwargs: Any) -> bytes:
