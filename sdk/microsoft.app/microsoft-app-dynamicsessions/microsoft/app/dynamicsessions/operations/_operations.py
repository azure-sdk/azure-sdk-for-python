...
def build_code_execution_execute_code_request(  # pylint: disable=name-too-long
    *, session_id: str, execution_id: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    ...
    if execution_id is not None:
        _headers["execution-id"] = _SERIALIZER.header("execution_id", execution_id, "str")
...
def build_code_execution_get_result_request(execution_id: str, *, session_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_session_resource_files_list_files_metadata_request(  # pylint: disable=name-too-long
    *, session_id: str, path: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_session_resource_files_get_file_metadata_request(  # pylint: disable=name-too-long
    name: str, *, session_id: str, path: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class CodeExecutionOperations:
    ...
    def begin_execute_code(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = self._execute_code_initial(
    ...
    @distributed_trace
    def get_result(self, execution_id: str, *, session_id: str, **kwargs: Any) -> _models.SessionCodeExecutionResponse:
...
class SessionResourceFilesOperations:
    ...
    @distributed_trace
    def get_file_content(self, name: str, *, session_id: str, path: Optional[str] = None, **kwargs: Any) -> bytes:
        """Upload a file to a session.
