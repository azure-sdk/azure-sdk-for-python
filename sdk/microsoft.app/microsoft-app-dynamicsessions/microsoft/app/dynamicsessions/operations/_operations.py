...
def build_session_management_get_request(*, identifier: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_session_management_delete_request(*, identifier: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_sessions_get_request(*, skip: Optional[int] = None, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_session_pool_metadata_get_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class SessionResourceFilesOperations:
    ...
    @distributed_trace
    def get_content(self, name: str, *, identifier: str, path: Optional[str] = None, **kwargs: Any) -> Iterator[bytes]:
...
class SessionManagementOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through
        :class:`~microsoft.app.dynamicsessions.DynamicSessionsClient`'s
        :attr:`session_management` attribute.
    """
    ...
    @distributed_trace
    def get(self, *, identifier: str, **kwargs: Any) -> _models.Session:
        """Get the session.

        :keyword identifier: The user-assigned identifier of the session. Required.
        :paramtype identifier: str
        :return: Session. The Session is compatible with MutableMapping
        :rtype: ~microsoft.app.dynamicsessions.models.Session
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        _request = build_session_management_get_request(
            identifier=identifier,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    @distributed_trace
    def delete(self, *, identifier: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        """Delete the session.
        ...
        _request = build_session_management_delete_request(
            identifier=identifier,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
...
class ListSessionsOperations:
    ...
    @distributed_trace
    def get(self, *, skip: Optional[int] = None, **kwargs: Any) -> _models.SessionsListResponse:
        """List the sessions.

        :keyword skip: The offset for pagination purpose. Default value is None.
        :paramtype skip: int
        :return: SessionsListResponse. The SessionsListResponse is compatible with MutableMapping
        :rtype: ~microsoft.app.dynamicsessions.models.SessionsListResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models.SessionsListResponse] = kwargs.pop("cls", None)

        _request = build_list_sessions_get_request(
            skip=skip,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.SessionsListResponse, response.json())
...
class SessionPoolMetadataOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through
        :class:`~microsoft.app.dynamicsessions.DynamicSessionsClient`'s
        :attr:`session_pool_metadata` attribute.
    """
    ...
    @distributed_trace
    def get(self, **kwargs: Any) -> _models.SessionPoolMetadataResponse:
        """Get the metadata information.

        :return: SessionPoolMetadataResponse. The SessionPoolMetadataResponse is compatible with
         MutableMapping
        :rtype: ~microsoft.app.dynamicsessions.models.SessionPoolMetadataResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models.SessionPoolMetadataResponse] = kwargs.pop("cls", None)

        _request = build_session_pool_metadata_get_request(
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
        )
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.SessionPoolMetadataResponse, response.json())
