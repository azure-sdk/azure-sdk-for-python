...
class DynamicSessionsClientConfiguration:  # pylint: disable=too-many-instance-attributes
    """Configuration for DynamicSessionsClient.
    ...
    def __init__(self, endpoint: str, credential: "TokenCredential", **kwargs: Any) -> None:
        ...
        kwargs.setdefault("sdk_moniker", "microsoft-app-dynamicsessions/{}".format(VERSION))
