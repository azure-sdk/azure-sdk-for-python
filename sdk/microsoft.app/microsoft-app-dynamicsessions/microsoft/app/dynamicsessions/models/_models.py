...
class JupyterKernel(_model_base.Model):
    ...
    project_url: str = rest_field(name="projectUrl")
...
class Session(_model_base.Model):
    ...
    last_accessed_at: datetime.datetime = rest_field(name="lastAccessedAt", format="rfc3339")
    """The date and time when the session was last accessed. Required."""
    expire_at: datetime.datetime = rest_field(name="expireAt", format="rfc3339")
...
class SessionPoolMetadataResponse(_model_base.Model):
    ...
    runtimes: List["_models.Runtime"] = rest_field()
    """List of runtimes. Required."""
    pre_installed_packages: List["_models.Package"] = rest_field(name="preInstalledPackages")
    """List of pre-installed packages. Required."""
    created_at: datetime.datetime = rest_field(name="createdAt", format="rfc3339")
    """Creation date in RFC3339 format. Required."""
    last_updated_at: datetime.datetime = rest_field(name="lastUpdatedAt", format="rfc3339")
    """Last updated date in RFC3339 format. Required."""
    jupyter_kernel: "_models.JupyterKernel" = rest_field(name="jupyterKernel")
...
class SessionsListResponse(_model_base.Model):
    ...
    sessions: List["_models.Session"] = rest_field()
