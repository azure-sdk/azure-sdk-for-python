...
class OracleDatabaseMgmtClientConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, credential: "AsyncTokenCredential", subscription_id: str, **kwargs: Any) -> None:
        super(OracleDatabaseMgmtClientConfiguration, self).__init__(**kwargs)
