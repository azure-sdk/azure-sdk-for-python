...
class TestAzureSphereMgmtDevicesOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_devices_begin_update(self, resource_group):
        response = self.client.devices.begin_update(
            resource_group_name=resource_group.name,
            catalog_name="str",
            product_name="str",
            device_group_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_devices_list_by_device_group(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_devices_begin_generate_capability_image(self, resource_group):
