...
class TestAzureSphereMgmtDeploymentsOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(AzureSphereMgmtClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_deployments_list_by_device_group(self, resource_group):
        response = self.client.deployments.list_by_device_group(
