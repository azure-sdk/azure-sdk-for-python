...
class CertificatesOperations:
    ...
    def retrieve_cert_chain(
        ...
        deserialized = self._deserialize("CertificateChainResponse", pipeline_response.http_response)
    ...
    def retrieve_proof_of_possession_nonce(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("ProofOfPossessionNonceResponse", pipeline_response.http_response)
