...
class CatalogsOperations:
    ...
    async def _upload_image_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, catalog_name: str, upload_image_request: Union[_models.Image, IO], **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
        ...
        request = build_upload_image_request(
            resource_group_name=resource_group_name,
            catalog_name=catalog_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            ...
            json=_json,
            content=_content,
            template_url=self._upload_image_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    _upload_image_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureSphere/catalogs/{catalogName}/uploadImage"
    }
    ...
    async def begin_upload_image(
        ...
        :param catalog_name: Name of catalog. Required.
        :type catalog_name: str
        :param upload_image_request: Image upload request body. Is either a Image type or a IO type.
         Required.
        :type upload_image_request: ~azure.mgmt.sphere.models.Image or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
