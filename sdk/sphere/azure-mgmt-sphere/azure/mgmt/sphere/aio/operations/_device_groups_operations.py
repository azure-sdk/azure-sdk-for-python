...
from ...operations._device_groups_operations import (
    build_claim_devices_request,
...
class DeviceGroupsOperations:
    ...
    async def get(
        ...
        deserialized = self._deserialize("DeviceGroup", pipeline_response.http_response)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either DeviceGroup or the result of
         cls(response)
    ...
    async def count_devices(
        ...
        deserialized = self._deserialize("CountDevicesResponse", pipeline_response.http_response)
