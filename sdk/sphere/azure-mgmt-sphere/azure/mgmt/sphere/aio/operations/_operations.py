...
class CatalogsOperations:
    ...
    def list_device_groups(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.sphere.models.ListDeviceGroupsRequest or JSON or IO[bytes]
        :keyword filter: Filter the result list using the given expression. Default value is None.
        :paramtype filter: str
        :keyword top: The number of result items to return. Default value is None.
        :paramtype top: int
    ...
    async def begin_upload_image(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.sphere.models.Image
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns None
    ...
    async def begin_upload_image(
        ...
        :param body: Image upload request body. Is one of the following types: Image, JSON, IO[bytes]
         Required.
        :type body: ~azure.mgmt.sphere.models.Image or JSON or IO[bytes]
        :return: An instance of AsyncLROPoller that returns None
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
...
class CertificatesOperations:
    ...
    async def retrieve_proof_of_possession_nonce(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.sphere.models.ProofOfPossessionNonceRequest or JSON or IO[bytes]
        :return: ProofOfPossessionNonceResponse. The ProofOfPossessionNonceResponse is compatible with
         MutableMapping
        :rtype: ~azure.mgmt.sphere.models.ProofOfPossessionNonceResponse
        :raises ~azure.core.exceptions.HttpResponseError:
...
class DeviceGroupsOperations:
    ...
    async def begin_claim_devices(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.sphere.models.ClaimDevicesRequest or JSON or IO[bytes]
        :return: An instance of AsyncLROPoller that returns None
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
...
class DevicesOperations:
    ...
    async def begin_generate_capability_image(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.sphere.models.GenerateCapabilityImageRequest or JSON or IO[bytes]
        :return: An instance of AsyncLROPoller that returns SignedCapabilityImageResponse. The
         SignedCapabilityImageResponse is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sphere.models.SignedCapabilityImageResponse]
