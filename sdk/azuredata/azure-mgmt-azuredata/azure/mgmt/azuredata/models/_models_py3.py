...
class ResourceModelWithAllowedPropertySet(_serialization.Model):
...
class SqlServerListResult(_serialization.Model):
    ...
    def __init__(self, **kwargs: Any) -> None:
        """ """
        super().__init__(**kwargs)
        self.value: Optional[List["_models.SqlServer"]] = None
        self.next_link: Optional[str] = None
...
class SqlServerRegistrationListResult(_serialization.Model):
    ...
    def __init__(self, **kwargs: Any) -> None:
        """ """
        super().__init__(**kwargs)
        self.value: Optional[List["_models.SqlServerRegistration"]] = None
        self.next_link: Optional[str] = None
