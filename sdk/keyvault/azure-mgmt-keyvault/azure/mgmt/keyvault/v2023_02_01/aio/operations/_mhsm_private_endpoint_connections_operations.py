...
class MHSMPrivateEndpointConnectionsOperations:
    ...
    def list_by_resource(
        ...
        :return: An iterator like instance of either MHSMPrivateEndpointConnection or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.keyvault.v2023_02_01.models.MHSMPrivateEndpointConnection]
    ...
    async def begin_delete(
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.keyvault.v2023_02_01.models.MHSMPrivateEndpointConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
