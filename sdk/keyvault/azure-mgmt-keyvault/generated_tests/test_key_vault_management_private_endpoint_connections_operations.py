...
# --------------------------------------------------------------------------
import pytest
from azure.mgmt.keyvault.v2024_11_01 import KeyVaultManagementClient
...
class TestKeyVaultManagementPrivateEndpointConnectionsOperations(AzureMgmtRecordedTestCase):
