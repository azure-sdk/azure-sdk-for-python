...
from ..._operations._operations import (
    build_key_vault_create_or_update_request,
    build_key_vault_create_request,
    build_key_vault_delete_request,
    ...
    build_key_vault_get_request,
    build_key_vault_get_setting_request,
    build_key_vault_get_settings_request,
    build_key_vault_list_for_scope_request,
    build_key_vault_list_request,
...
class KeyVaultClientOperationsMixin(KeyVaultClientMixinABC):  # pylint: disable=too-many-public-methods
    ...
    async def delete(self, scope: str, role_definition_name: str, **kwargs: Any) -> _models.RoleDefinition:
        ...
        _request = build_key_vault_delete_request(
            scope=scope,
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        _request = build_key_vault_create_or_update_request(
            scope=scope,
            role_definition_name=role_definition_name,
            api_version=self._config.api_version,
            content_type=content_type,
    ...
    async def get(self, scope: str, role_definition_name: str, **kwargs: Any) -> _models.RoleDefinition:
        ...
        _request = build_key_vault_get_request(
            scope=scope,
            role_definition_name=role_definition_name,
            api_version=self._config.api_version,
            headers=_headers,
    ...
    def list(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_key_vault_list_request(
                    scope=scope,
                    api_version=self._config.api_version,
                    filter=filter,
                    headers=_headers,
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        _request = build_key_vault_create_request(
            scope=scope,
            role_assignment_name=role_assignment_name,
            api_version=self._config.api_version,
            content_type=content_type,
    ...
    def list_for_scope(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_key_vault_list_for_scope_request(
                    scope=scope,
                    api_version=self._config.api_version,
                    filter=filter,
                    headers=_headers,
