...
class AliasesOperationsOperations:
    ...
    @overload
    def create(self, alias: JSON, *, content_type: str = "application/json", **kwargs: Any) -> _models.SearchAlias:
        """Creates a new search alias.
    ...
    @overload
    def create(self, alias: IO[bytes], *, content_type: str = "application/json", **kwargs: Any) -> _models.SearchAlias:
        """Creates a new search alias.
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.SearchAlias"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.search.documents.models.SearchAlias]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
