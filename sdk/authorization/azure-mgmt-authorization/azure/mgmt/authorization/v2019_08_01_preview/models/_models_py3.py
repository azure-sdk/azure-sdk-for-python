...
class RoleAssignmentMetricsResult(_serialization.Model):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.role_assignments_limit: Optional[int] = None
        self.role_assignments_current_count: Optional[int] = None
        self.role_assignments_remaining_count: Optional[int] = None
