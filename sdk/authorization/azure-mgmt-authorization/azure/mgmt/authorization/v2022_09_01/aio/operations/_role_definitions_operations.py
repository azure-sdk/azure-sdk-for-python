...
class RoleDefinitionsOperations:
    ...
    async def delete(self, scope: str, role_definition_id: str, **kwargs: Any) -> Optional[_models.RoleDefinition]:
        ...
        :rtype: ~azure.mgmt.authorization.v2022_09_01.models.RoleDefinition or None
    ...
    async def get(self, scope: str, role_definition_id: str, **kwargs: Any) -> _models.RoleDefinition:
        ...
        :rtype: ~azure.mgmt.authorization.v2022_09_01.models.RoleDefinition
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type role_definition: ~azure.mgmt.authorization.v2022_09_01.models.RoleDefinition
    ...
    async def create_or_update(
        ...
        :param role_definition: The values for the role definition. Is either a RoleDefinition type or
         a IO type. Required.
        :type role_definition: ~azure.mgmt.authorization.v2022_09_01.models.RoleDefinition or IO
    ...
    def list(self, scope: str, filter: Optional[str] = None, **kwargs: Any) -> AsyncIterable["_models.RoleDefinition"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.authorization.v2022_09_01.models.RoleDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
