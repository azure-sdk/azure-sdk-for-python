...
class ApprovalSettings(_serialization.Model):
    ...
    :ivar approval_mode: The type of rule. Known values are: "SingleStage", "Serial", "Parallel",
     and "NoApproval".
    :vartype approval_mode: str or ~azure.mgmt.authorization.v2022_09_01.models.ApprovalMode
    :ivar approval_stages: The approval stages of the request.
    :vartype approval_stages: list[~azure.mgmt.authorization.v2022_09_01.models.ApprovalStage]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype approval_mode: str or ~azure.mgmt.authorization.v2022_09_01.models.ApprovalMode
        :keyword approval_stages: The approval stages of the request.
        :paramtype approval_stages: list[~azure.mgmt.authorization.v2022_09_01.models.ApprovalStage]
        """
...
class ApprovalStage(_serialization.Model):
    ...
    :vartype primary_approvers: list[~azure.mgmt.authorization.v2022_09_01.models.UserSet]
    ...
    :vartype escalation_approvers: list[~azure.mgmt.authorization.v2022_09_01.models.UserSet]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype primary_approvers: list[~azure.mgmt.authorization.v2022_09_01.models.UserSet]
        ...
        :paramtype escalation_approvers: list[~azure.mgmt.authorization.v2022_09_01.models.UserSet]
        """
        super().__init__(**kwargs)
...
class DenyAssignment(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype permissions:
     list[~azure.mgmt.authorization.v2022_09_01.models.DenyAssignmentPermission]
    ...
    :vartype principals: list[~azure.mgmt.authorization.v2022_09_01.models.Principal]
    :ivar exclude_principals: Array of principals to which the deny assignment does not apply.
    :vartype exclude_principals: list[~azure.mgmt.authorization.v2022_09_01.models.Principal]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype principals: list[~azure.mgmt.authorization.v2022_09_01.models.Principal]
        :keyword exclude_principals: Array of principals to which the deny assignment does not apply.
        :paramtype exclude_principals: list[~azure.mgmt.authorization.v2022_09_01.models.Principal]
...
class DenyAssignmentListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.authorization.v2022_09_01.models.DenyAssignment]
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.authorization.v2022_09_01.models.DenyAssignment]
...
class ErrorDetail(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.authorization.v2022_09_01.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info:
     list[~azure.mgmt.authorization.v2022_09_01.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(_serialization.Model):
    ...
    :vartype error: ~azure.mgmt.authorization.v2022_09_01.models.ErrorDetail
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetail"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~azure.mgmt.authorization.v2022_09_01.models.ErrorDetail
        """
        super().__init__(**kwargs)
        self.error = error
...
class PermissionGetResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.authorization.v2022_09_01.models.Permission]
    :ivar next_link: The URL to use for getting the next set of results.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.authorization.v2022_09_01.models.Permission]
        :keyword next_link: The URL to use for getting the next set of results.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class ProviderOperationsMetadata(_serialization.Model):
    ...
    :vartype resource_types: list[~azure.mgmt.authorization.v2022_09_01.models.ResourceType]
    :ivar operations: The provider operations.
    :vartype operations: list[~azure.mgmt.authorization.v2022_09_01.models.ProviderOperation]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype resource_types: list[~azure.mgmt.authorization.v2022_09_01.models.ResourceType]
        :keyword operations: The provider operations.
        :paramtype operations: list[~azure.mgmt.authorization.v2022_09_01.models.ProviderOperation]
        """
        super().__init__(**kwargs)
        self.id = id
        self.name = name
...
class ProviderOperationsMetadataListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.authorization.v2022_09_01.models.ProviderOperationsMetadata]
    :ivar next_link: The URL to use for getting the next set of results.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype value: list[~azure.mgmt.authorization.v2022_09_01.models.ProviderOperationsMetadata]
        :keyword next_link: The URL to use for getting the next set of results.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class RoleAssignment(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype principal_type: str or ~azure.mgmt.authorization.v2022_09_01.models.PrincipalType
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword principal_type: The principal type of the assigned principal ID. Known values are:
         "User", "Group", "ServicePrincipal", "ForeignGroup", and "Device".
        :paramtype principal_type: str or ~azure.mgmt.authorization.v2022_09_01.models.PrincipalType
...
class RoleAssignmentListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.authorization.v2022_09_01.models.RoleAssignment]
    ...
    def __init__(self, *, value: Optional[List["_models.RoleAssignment"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.authorization.v2022_09_01.models.RoleAssignment]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class RoleDefinition(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype permissions: list[~azure.mgmt.authorization.v2022_09_01.models.Permission]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype permissions: list[~azure.mgmt.authorization.v2022_09_01.models.Permission]
...
class RoleDefinitionListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.authorization.v2022_09_01.models.RoleDefinition]
    :ivar next_link: The URL to use for getting the next set of results.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.authorization.v2022_09_01.models.RoleDefinition]
        :keyword next_link: The URL to use for getting the next set of results.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class RoleManagementPolicyRule(_serialization.Model):
    ...
    :vartype rule_type: str or
     ~azure.mgmt.authorization.v2022_09_01.models.RoleManagementPolicyRuleType
    :ivar target: The target of the current rule.
    :vartype target: ~azure.mgmt.authorization.v2022_09_01.models.RoleManagementPolicyRuleTarget
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype target: ~azure.mgmt.authorization.v2022_09_01.models.RoleManagementPolicyRuleTarget
        """
        super().__init__(**kwargs)
        self.id = id
...
class RoleManagementPolicyApprovalRule(RoleManagementPolicyRule):
    ...
    :vartype setting: ~azure.mgmt.authorization.v2022_09_01.models.ApprovalSettings
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype setting: ~azure.mgmt.authorization.v2022_09_01.models.ApprovalSettings
        """
...
class RoleManagementPolicyEnablementRule(RoleManagementPolicyRule):
    ...
    :vartype enabled_rules: list[str or
     ~azure.mgmt.authorization.v2022_09_01.models.EnablementRules]
    """
...
class RoleManagementPolicyNotificationRule(RoleManagementPolicyRule):
    ...
    :vartype notification_type: str or
     ~azure.mgmt.authorization.v2022_09_01.models.NotificationDeliveryMechanism
    :ivar notification_level: The notification level. Known values are: "None", "Critical", and
     "All".
    :vartype notification_level: str or
     ~azure.mgmt.authorization.v2022_09_01.models.NotificationLevel
    :ivar recipient_type: The recipient type. Known values are: "Requestor", "Approver", and
     "Admin".
    :vartype recipient_type: str or ~azure.mgmt.authorization.v2022_09_01.models.RecipientType
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword recipient_type: The recipient type. Known values are: "Requestor", "Approver", and
         "Admin".
        :paramtype recipient_type: str or ~azure.mgmt.authorization.v2022_09_01.models.RecipientType
...
class UserSet(_serialization.Model):
    ...
    :vartype user_type: str or ~azure.mgmt.authorization.v2022_09_01.models.UserType
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype user_type: str or ~azure.mgmt.authorization.v2022_09_01.models.UserType
...
class ValidationResponse(_serialization.Model):
    ...
    :vartype error_info: ~azure.mgmt.authorization.v2022_09_01.models.ValidationResponseErrorInfo
    """
    ...
    def __init__(self, *, error_info: Optional["_models.ValidationResponseErrorInfo"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error_info: ~azure.mgmt.authorization.v2022_09_01.models.ValidationResponseErrorInfo
        """
        super().__init__(**kwargs)
        self.is_valid = None
