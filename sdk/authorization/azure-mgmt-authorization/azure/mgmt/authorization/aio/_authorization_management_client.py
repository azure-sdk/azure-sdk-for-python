...
class AuthorizationManagementClient(MultiApiClientMixin, _SDKClient):
    ...
    def deny_assignments(self):
        """Instance depends on the API version:
           ...
           * 2022-09-01: :class:`DenyAssignmentsOperations<azure.mgmt.authorization.v2022_09_01.aio.operations.DenyAssignmentsOperations>`
        """
        ...
        if api_version == '2018-07-01-preview':
            ...
            from ..v2022_09_01.aio.operations import DenyAssignmentsOperations as OperationClass
        else:
    ...
    def permissions(self):
        """Instance depends on the API version:
           ...
           * 2022-09-01: :class:`PermissionsOperations<azure.mgmt.authorization.v2022_09_01.aio.operations.PermissionsOperations>`
        """
        ...
        if api_version == '2015-07-01':
            ...
            from ..v2022_09_01.aio.operations import PermissionsOperations as OperationClass
        else:
    ...
    def provider_operations_metadata(self):
        """Instance depends on the API version:
           ...
           * 2022-09-01: :class:`ProviderOperationsMetadataOperations<azure.mgmt.authorization.v2022_09_01.aio.operations.ProviderOperationsMetadataOperations>`
        """
        ...
        if api_version == '2015-07-01':
            ...
            from ..v2022_09_01.aio.operations import ProviderOperationsMetadataOperations as OperationClass
        else:
    ...
    def role_assignments(self):
        """Instance depends on the API version:
           ...
           * 2022-09-01: :class:`RoleAssignmentsOperations<azure.mgmt.authorization.v2022_09_01.aio.operations.RoleAssignmentsOperations>`
        """
        ...
        if api_version == '2015-07-01':
            ...
            from ..v2022_09_01.aio.operations import RoleAssignmentsOperations as OperationClass
        else:
    ...
    def role_definitions(self):
        """Instance depends on the API version:
           ...
           * 2022-09-01: :class:`RoleDefinitionsOperations<azure.mgmt.authorization.v2022_09_01.aio.operations.RoleDefinitionsOperations>`
        """
        ...
        if api_version == '2015-07-01':
            ...
            from ..v2022_09_01.aio.operations import RoleDefinitionsOperations as OperationClass
        else:
