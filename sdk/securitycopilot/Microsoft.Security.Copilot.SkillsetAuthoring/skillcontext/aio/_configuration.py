...
class SkillContextClientConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long
    """Configuration for SkillContextClient.
    ...
    def __init__(self, endpoint: str, credential: AzureKeyCredential, **kwargs: Any) -> None:
        ...
        kwargs.setdefault("sdk_moniker", "skillcontext/{}".format(VERSION))
