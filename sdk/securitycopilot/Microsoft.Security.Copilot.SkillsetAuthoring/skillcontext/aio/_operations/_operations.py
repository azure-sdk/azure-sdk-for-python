...
class SkillContextClientOperationsMixin(SkillContextClientMixinABC):
    ...
    ) -> Optional[_models.SkillContextResponse]:
    ...
    async def get_prompt_history(
        self, *, evaluation_token: str, **kwargs: Any
    ) -> Optional[_models.PromptHistoryResponse]:
        """Get prompt history.
    ...
    @distributed_trace_async
    async def get_skillset_settings(self, *, evaluation_token: str, **kwargs: Any) -> Optional[Dict[str, str]]:
