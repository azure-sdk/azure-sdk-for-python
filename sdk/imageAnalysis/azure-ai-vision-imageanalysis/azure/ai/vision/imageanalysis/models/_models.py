...
class AdultMatch(_model_base.Model):
    ...
    :ivar confidence: Gets the confidence score of whether the image contains adult content.
     Required.
    :vartype confidence: float
    :ivar is_match: A value indicating if the image is matched adult content. Required.
    :vartype is_match: bool
    """

    confidence: float = rest_field(visibility=["read"])
    """Gets the confidence score of whether the image contains adult content. Required."""
    is_match: bool = rest_field(name="isMatch", visibility=["read"])
    """A value indicating if the image is matched adult content. Required."""


class AdultResult(_model_base.Model):
    ...
    :ivar adult: Gets a value indicating if the image is adult-oriented content. Required.
    :vartype adult: ~azure.ai.vision.imageanalysis.models.AdultMatch
    :ivar gore: Gets a value indicating if the image is gorey content. Required.
    :vartype gore: ~azure.ai.vision.imageanalysis.models.AdultMatch
    :ivar racy: Gets a value indicating if the image is racy content. Required.
    :vartype racy: ~azure.ai.vision.imageanalysis.models.AdultMatch
    """

    adult: "_models.AdultMatch" = rest_field(visibility=["read"])
    """Gets a value indicating if the image is adult-oriented content. Required."""
    gore: "_models.AdultMatch" = rest_field(visibility=["read"])
    """Gets a value indicating if the image is gorey content. Required."""
    racy: "_models.AdultMatch" = rest_field(visibility=["read"])
    """Gets a value indicating if the image is racy content. Required."""
...
class DetectedObject(_model_base.Model):
    ...
    :vartype bounding_box: ~azure.ai.vision.imageanalysis.models.BoundingBox
    :ivar id: Id of the detected objet. Required.
    :vartype id: str
    ...
    id: str = rest_field()
    """Id of the detected objet. Required."""
...
class ImageAnalysisResult(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    """Describe the combined results of different types of image analysis.

    All required parameters must be populated in order to send to Azure.

    :ivar adult_result: An AdultResult for the immage.
    :vartype adult_result: ~azure.ai.vision.imageanalysis.models.AdultResult
    ...
    :vartype metadata: ~azure.ai.vision.imageanalysis.models.ImageMetadataApiModel
    ...
    adult_result: Optional["_models.AdultResult"] = rest_field(name="adultResult")
    ...
    metadata: "_models.ImageMetadataApiModel" = rest_field()
    ...
    def __init__(
        self,
        *,
        metadata: "_models.ImageMetadataApiModel",
        model_version: str,
        adult_result: Optional["_models.AdultResult"] = None,
...
class ImageMetadataApiModel(_model_base.Model):
