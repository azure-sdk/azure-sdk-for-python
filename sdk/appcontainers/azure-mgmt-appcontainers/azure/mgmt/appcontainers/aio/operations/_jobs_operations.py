...
class JobsOperations:
    ...
    async def get(self, resource_group_name: str, **kwargs: Any) -> _models.Job:
    ...
    @distributed_trace_async
    async def begin_stop_execution(self, resource_group_name: str, **kwargs: Any) -> AsyncLROPoller[None]:
    ...
    @distributed_trace_async
    async def list_secrets(self, resource_group_name: str, **kwargs: Any) -> _models.JobSecretsCollection:
