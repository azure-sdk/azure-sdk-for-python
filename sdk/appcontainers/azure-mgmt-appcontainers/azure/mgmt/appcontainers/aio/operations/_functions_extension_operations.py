...
class FunctionsExtensionOperations:
    ...
    async def invoke_functions_host(
        ...
        **kwargs: Any
        ...
        request = build_invoke_functions_host_request(
            ...
            template_url=self.invoke_functions_host.metadata["url"],
            headers=_headers,
            params=_params,
        )
    ...
    invoke_functions_host.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/containerApps/{containerAppName}/revisions/{revisionName}/providers/Microsoft.App/functions/{functionAppName}/invoke"
    }
