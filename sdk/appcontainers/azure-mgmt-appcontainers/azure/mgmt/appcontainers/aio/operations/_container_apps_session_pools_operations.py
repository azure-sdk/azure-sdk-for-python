...
class ContainerAppsSessionPoolsOperations:
    ...
    async def _create_or_update_initial(
        ...
        session_pool_envelope: Union[_models.SessionPool, IO],
        **kwargs: Any
    ) -> _models.SessionPool:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type session_pool_envelope: ~azure.mgmt.appcontainers.models.SessionPool or IO
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        session_pool_name: str,
        session_pool_envelope: Union[_models.SessionPoolPatchProperties, IO],
        **kwargs: Any
        ...
        if isinstance(session_pool_envelope, (IOBase, bytes)):
            ...
            _json = self._serialize.body(session_pool_envelope, "SessionPoolPatchProperties")
    ...
    async def begin_update(
        ...
        resource_group_name: str,
        session_pool_name: str,
        session_pool_envelope: _models.SessionPoolPatchProperties,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.SessionPool]:
        ...
        :type session_pool_name: str
        :param session_pool_envelope: Properties used to create a session pool. Required.
        :type session_pool_envelope: ~azure.mgmt.appcontainers.models.SessionPoolPatchProperties
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param session_pool_envelope: Properties used to create a session pool. Is either a
         SessionPoolPatchProperties type or a IO type. Required.
        :type session_pool_envelope: ~azure.mgmt.appcontainers.models.SessionPoolPatchProperties or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
