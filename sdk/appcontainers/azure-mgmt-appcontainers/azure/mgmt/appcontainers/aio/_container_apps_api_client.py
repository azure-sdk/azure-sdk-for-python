...
class ContainerAppsAPIClient(
    ...
    :ivar jobs_diagnostics: JobsDiagnosticsOperations operations
    :vartype jobs_diagnostics: azure.mgmt.appcontainers.aio.operations.JobsDiagnosticsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.jobs_diagnostics = JobsDiagnosticsOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
