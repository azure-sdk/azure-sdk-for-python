...
from .operations import (
    ...
    ManagedEnvironmentSecretsOperations,
...
class ContainerAppsAPIClient(
    ...
    :ivar managed_environment_secrets: ManagedEnvironmentSecretsOperations operations
    :vartype managed_environment_secrets:
     azure.mgmt.appcontainers.aio.operations.ManagedEnvironmentSecretsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.managed_environment_secrets = ManagedEnvironmentSecretsOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
