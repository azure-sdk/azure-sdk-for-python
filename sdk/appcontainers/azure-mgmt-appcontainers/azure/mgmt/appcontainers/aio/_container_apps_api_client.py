...
class ContainerAppsAPIClient(
    ...
    :ivar container_apps_labels: ContainerAppsLabelsOperations operations
    :vartype container_apps_labels:
     azure.mgmt.appcontainers.aio.operations.ContainerAppsLabelsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.container_apps_labels = ContainerAppsLabelsOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
