...
from .operations import (
    ...
    ContainerAppsSessionPoolSessionsOperations,
...
class ContainerAppsAPIClient(
    ...
    :ivar container_apps_session_pool_sessions: ContainerAppsSessionPoolSessionsOperations
     operations
    :vartype container_apps_session_pool_sessions:
     azure.mgmt.appcontainers.aio.operations.ContainerAppsSessionPoolSessionsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.container_apps_session_pool_sessions = ContainerAppsSessionPoolSessionsOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
