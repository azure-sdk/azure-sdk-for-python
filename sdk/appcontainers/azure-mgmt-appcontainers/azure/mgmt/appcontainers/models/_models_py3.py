...
class SessionNetworkConfiguration(_serialization.Model):
    ...
    :ivar subnet: The subnet to which the Session Pool will be connected.
    :vartype subnet: ~azure.mgmt.appcontainers.models.SessionPoolSubnetReference
    """

    _attribute_map = {
        "status": {"key": "status", "type": "str"},
        "subnet": {"key": "subnet", "type": "SessionPoolSubnetReference"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        subnet: Optional["_models.SessionPoolSubnetReference"] = None,
        **kwargs: Any
    ) -> None:
        """
        ...
        :keyword subnet: The subnet to which the Session Pool will be connected.
        :paramtype subnet: ~azure.mgmt.appcontainers.models.SessionPoolSubnetReference
        """
        super().__init__(**kwargs)
        self.status = status
        self.subnet = subnet
...
class SessionPoolSubnetReference(_serialization.Model):
    """Reference to a virtual network subnet to which a Session Pool will be connected.

    :ivar subnet_id: Resource ID of the subnet to which a Session Pool will be connected.
    ...
    def __init__(self, *, subnet_id: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword subnet_id: Resource ID of the subnet to which a Session Pool will be connected.
...
class SessionPoolUpdatableProperties(_serialization.Model):
    ...
    :ivar identity: Managed identities needed by a session pool to interact with other Azure
     services to not maintain any secrets or credentials in code.
    :vartype identity: ~azure.mgmt.appcontainers.models.ManagedServiceIdentityUpdate
    :ivar scale_configuration: The scale configuration of the session pool.
    :vartype scale_configuration: ~azure.mgmt.appcontainers.models.ScaleConfiguration
    :ivar secrets: The secrets of the session pool.
    :vartype secrets: list[~azure.mgmt.appcontainers.models.SessionPoolSecret]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword identity: Managed identities needed by a session pool to interact with other Azure
         services to not maintain any secrets or credentials in code.
        :paramtype identity: ~azure.mgmt.appcontainers.models.ManagedServiceIdentityUpdate
        :keyword scale_configuration: The scale configuration of the session pool.
        :paramtype scale_configuration: ~azure.mgmt.appcontainers.models.ScaleConfiguration
        :keyword secrets: The secrets of the session pool.
        :paramtype secrets: list[~azure.mgmt.appcontainers.models.SessionPoolSecret]
