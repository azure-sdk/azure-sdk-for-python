...
class Label(_serialization.Model):
    ...
    def __init__(
        self, *, revision_name: Optional[str] = None, traffic_weight: Optional[int] = None, **kwargs: Any
    ) -> None:
        """
...
class Labels(ProxyResource):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.appcontainers.models.SystemData
    :ivar properties: Labels specific properties.
    :vartype properties: ~azure.mgmt.appcontainers.models.LabelsProperties
    """
    ...
    _attribute_map = {
        ...
        "type": {"key": "type", "type": "str"},
        "system_data": {"key": "systemData", "type": "SystemData"},
        "properties": {"key": "properties", "type": "LabelsProperties"},
    }

    def __init__(self, *, properties: Optional["_models.LabelsProperties"] = None, **kwargs: Any) -> None:
        """
        :keyword properties: Labels specific properties.
        :paramtype properties: ~azure.mgmt.appcontainers.models.LabelsProperties
        """
        super().__init__(**kwargs)
        self.properties = properties
...
class LabelsProperties(_serialization.Model):
    ...
    :vartype labels: dict[str, ~azure.mgmt.appcontainers.models.Label]
    """
    ...
    def __init__(self, *, labels: Optional[Dict[str, "_models.Label"]] = None, **kwargs: Any) -> None:
        """
        :keyword labels: Labels for the Container App.
        :paramtype labels: dict[str, ~azure.mgmt.appcontainers.models.Label]
        """
        super().__init__(**kwargs)
        self.provisioning_state = None
        self.labels = labels
