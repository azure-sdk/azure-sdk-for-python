...
class CodeExecutionConfiguration(_serialization.Model):
    """Code execution configuration of the Session.

    :ivar token: The token used for code execution.
    :vartype token: str
    :ivar environment: The environment used for code execution.
    ...
    def __init__(self, *, token: Optional[str] = None, environment: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword token: The token used for code execution.
        :paramtype token: str
        :keyword environment: The environment used for code execution.
...
class CustomContainerConfiguration(_serialization.Model):
    ...
    :ivar ingress: SessionPool Ingress configuration.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword ingress: SessionPool Ingress configuration.
...
class DynamicPoolConfiguration(_serialization.Model):
    ...
    :ivar cool_down_period_in_second: The cool down period of a Session in seconds.
    :vartype cool_down_period_in_second: int
    """

    _attribute_map = {
        "execution_type": {"key": "executionType", "type": "str"},
        "cool_down_period_in_second": {"key": "coolDownPeriodInSecond", "type": "int"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        cool_down_period_in_second: Optional[int] = None,
        **kwargs: Any
    ) -> None:
        """
        ...
        :keyword cool_down_period_in_second: The cool down period of a Session in seconds.
        :paramtype cool_down_period_in_second: int
        """
        super().__init__(**kwargs)
        self.execution_type = execution_type
        self.cool_down_period_in_second = cool_down_period_in_second
...
class ErrorDetailAutoGenerated(_serialization.Model):
    ...
    :vartype target: str
    :ivar details: The error details.
    :vartype details: list[~azure.mgmt.appcontainers.models.ErrorDetailAutoGenerated]
    :ivar additional_info: The error additional info.
    :vartype additional_info: list[~azure.mgmt.appcontainers.models.ErrorAdditionalInfo]
    """
...
class ErrorResponseAutoGenerated(_serialization.Model):
    ...
    :ivar error: The error object.
    :vartype error: ~azure.mgmt.appcontainers.models.ErrorDetailAutoGenerated
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetailAutoGenerated"] = None, **kwargs: Any) -> None:
        """
        :keyword error: The error object.
        :paramtype error: ~azure.mgmt.appcontainers.models.ErrorDetailAutoGenerated
        """
        super().__init__(**kwargs)
        self.error = error
...
class Session(ProxyResource):  # pylint: disable=too-many-instance-attributes
    """Session resource.
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.appcontainers.models.SystemData
    :ivar name_properties_name: The name of the Session.
    :vartype name_properties_name: str
    :ivar requested_duration_in_seconds: The requested duration of the Session in seconds.
    :vartype requested_duration_in_seconds: int
    :ivar time_elapsed_in_seconds: The time elapsed in seconds since the Session was created.
    :vartype time_elapsed_in_seconds: int
    :ivar expiry_time: The time when the Session will expire.
    :vartype expiry_time: ~datetime.datetime
    :ivar generated_time: The time when the Session was generated.
    :vartype generated_time: ~datetime.datetime
    :ivar connection_string: The connection string of the Session.
    :vartype connection_string: str
    :ivar endpoint: The endpoint of the Session.
    :vartype endpoint: str
    :ivar session_kind: The kind of the Session. Known values are: "JupyterPython",
     "FunctionsPython", "CustomContainer", "SSH", and "CustomImage".
    :vartype session_kind: str or ~azure.mgmt.appcontainers.models.ContainerType
    :ivar status: The status of the Session.
    :vartype status: str
    :ivar ssh_configuration: SSH configuration of the Session.
    :vartype ssh_configuration: ~azure.mgmt.appcontainers.models.SSHConfiguration
    :ivar code_execution_configuration: Code execution configuration of the Session.
    :vartype code_execution_configuration:
     ~azure.mgmt.appcontainers.models.CodeExecutionConfiguration
    :ivar session_auth_configuration: Session auth configuration.
    :vartype session_auth_configuration: ~azure.mgmt.appcontainers.models.SessionAuthConfiguration
    """
    ...
    _attribute_map = {
        ...
        "requested_duration_in_seconds": {"key": "properties.requestedDurationInSeconds", "type": "int"},
        "time_elapsed_in_seconds": {"key": "properties.timeElapsedInSeconds", "type": "int"},
        "expiry_time": {"key": "properties.expiryTime", "type": "iso-8601"},
        "generated_time": {"key": "properties.generatedTime", "type": "iso-8601"},
        "connection_string": {"key": "properties.connectionString", "type": "str"},
        "endpoint": {"key": "properties.endpoint", "type": "str"},
        "session_kind": {"key": "properties.sessionKind", "type": "str"},
        "status": {"key": "properties.status", "type": "str"},
        "ssh_configuration": {"key": "properties.sshConfiguration", "type": "SSHConfiguration"},
        "code_execution_configuration": {
            "key": "properties.codeExecutionConfiguration",
            "type": "CodeExecutionConfiguration",
        },
        "session_auth_configuration": {
            "key": "properties.sessionAuthConfiguration",
            "type": "SessionAuthConfiguration",
        },
    }
    ...
    def __init__(
        ...
        *,
        ...
        requested_duration_in_seconds: Optional[int] = None,
        time_elapsed_in_seconds: Optional[int] = None,
        expiry_time: Optional[datetime.datetime] = None,
        generated_time: Optional[datetime.datetime] = None,
        connection_string: Optional[str] = None,
        endpoint: Optional[str] = None,
        session_kind: Optional[Union[str, "_models.ContainerType"]] = None,
        status: Optional[str] = None,
        ssh_configuration: Optional["_models.SSHConfiguration"] = None,
        code_execution_configuration: Optional["_models.CodeExecutionConfiguration"] = None,
        session_auth_configuration: Optional["_models.SessionAuthConfiguration"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword name_properties_name: The name of the Session.
        :paramtype name_properties_name: str
        :keyword requested_duration_in_seconds: The requested duration of the Session in seconds.
        :paramtype requested_duration_in_seconds: int
        :keyword time_elapsed_in_seconds: The time elapsed in seconds since the Session was created.
        :paramtype time_elapsed_in_seconds: int
        :keyword expiry_time: The time when the Session will expire.
        :paramtype expiry_time: ~datetime.datetime
        :keyword generated_time: The time when the Session was generated.
        :paramtype generated_time: ~datetime.datetime
        :keyword connection_string: The connection string of the Session.
        :paramtype connection_string: str
        :keyword endpoint: The endpoint of the Session.
        :paramtype endpoint: str
        :keyword session_kind: The kind of the Session. Known values are: "JupyterPython",
         "FunctionsPython", "CustomContainer", "SSH", and "CustomImage".
        :paramtype session_kind: str or ~azure.mgmt.appcontainers.models.ContainerType
        :keyword status: The status of the Session.
        :paramtype status: str
        :keyword ssh_configuration: SSH configuration of the Session.
        :paramtype ssh_configuration: ~azure.mgmt.appcontainers.models.SSHConfiguration
        :keyword code_execution_configuration: Code execution configuration of the Session.
        :paramtype code_execution_configuration:
         ~azure.mgmt.appcontainers.models.CodeExecutionConfiguration
        :keyword session_auth_configuration: Session auth configuration.
        :paramtype session_auth_configuration:
         ~azure.mgmt.appcontainers.models.SessionAuthConfiguration
        """
        super().__init__(**kwargs)
        self.name_properties_name = name_properties_name
        self.requested_duration_in_seconds = requested_duration_in_seconds
        self.time_elapsed_in_seconds = time_elapsed_in_seconds
        ...
        self.code_execution_configuration = code_execution_configuration
        self.session_auth_configuration = session_auth_configuration


class SessionAuthConfiguration(_serialization.Model):
    """Session auth configuration.

    :ivar jwt_token: JWT token for the session.
    :vartype jwt_token: str
    :ivar auth_enabled: Is auth enabled for the session.
    :vartype auth_enabled: bool
    """

    _attribute_map = {
        "jwt_token": {"key": "jwtToken", "type": "str"},
        "auth_enabled": {"key": "authEnabled", "type": "bool"},
    }

    def __init__(self, *, jwt_token: Optional[str] = None, auth_enabled: Optional[bool] = None, **kwargs: Any) -> None:
        """
        :keyword jwt_token: JWT token for the session.
        :paramtype jwt_token: str
        :keyword auth_enabled: Is auth enabled for the session.
...
class SessionCollection(_serialization.Model):
    ...
    :ivar value: Collection of resources. Required.
    :vartype value: list[~azure.mgmt.appcontainers.models.Session]
    :ivar next_link: Link to next page of resources.
    :vartype next_link: str
    """
    ...
    _attribute_map = {
        "value": {"key": "value", "type": "[Session]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }

    def __init__(self, *, value: List["_models.Session"], **kwargs: Any) -> None:
        """
        :keyword value: Collection of resources. Required.
        :paramtype value: list[~azure.mgmt.appcontainers.models.Session]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class SessionPool(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype environment_id: str
    :ivar max_concurrent_sessions: The max count of Sessions at the same time.
    :vartype max_concurrent_sessions: int
    :ivar container_type: The container type of the Sessions. Known values are: "JupyterPython",
     "FunctionsPython", "CustomContainer", "SSH", and "CustomImage".
    ...
    :ivar custom_container_configuration: The custom container configuration if the containerType
     is CustomContainer.
    :vartype custom_container_configuration:
     ~azure.mgmt.appcontainers.models.CustomContainerConfiguration
    ...
    _attribute_map = {
        ...
        "location": {"key": "location", "type": "str"},
        "environment_id": {"key": "properties.environmentId", "type": "str"},
        "max_concurrent_sessions": {"key": "properties.maxConcurrentSessions", "type": "int"},
        ...
        "custom_container_configuration": {
            "key": "properties.customContainerConfiguration",
            "type": "CustomContainerConfiguration",
        },
    ...
    def __init__(
        ...
        *,
        ...
        custom_container_configuration: Optional["_models.CustomContainerConfiguration"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword tags: Resource tags.
        ...
        :paramtype environment_id: str
        :keyword max_concurrent_sessions: The max count of Sessions at the same time.
        :paramtype max_concurrent_sessions: int
        :keyword container_type: The container type of the Sessions. Known values are: "JupyterPython",
         "FunctionsPython", "CustomContainer", "SSH", and "CustomImage".
        ...
        :keyword custom_container_configuration: The custom container configuration if the
         containerType is CustomContainer.
        :paramtype custom_container_configuration:
         ~azure.mgmt.appcontainers.models.CustomContainerConfiguration
        """
        super().__init__(tags=tags, location=location, **kwargs)
        self.environment_id = environment_id
        ...
        self.custom_container_configuration = custom_container_configuration
...
class SessionPoolPatchProperties(_serialization.Model):
...
class SSHConfiguration(_serialization.Model):
    ...
    :vartype password: str
    :ivar authorized_public_key: The authorized public key.
    :vartype authorized_public_key: str
    """

    _attribute_map = {
        "username": {"key": "username", "type": "str"},
        "password": {"key": "password", "type": "str"},
        "authorized_public_key": {"key": "authorizedPublicKey", "type": "str"},
    }
    ...
    def __init__(
        ...
        *,
        username: Optional[str] = None,
        password: Optional[str] = None,
        authorized_public_key: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        ...
        :paramtype password: str
        :keyword authorized_public_key: The authorized public key.
        :paramtype authorized_public_key: str
        """
        super().__init__(**kwargs)
        self.username = username
        self.password = password
