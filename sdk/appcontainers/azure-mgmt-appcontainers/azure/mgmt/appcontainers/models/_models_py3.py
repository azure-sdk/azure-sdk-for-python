...
class JavaComponentProperties(_serialization.Model):
    ...
    :ivar component_type: Type of the Java Component. Required. Known values are:
     "SpringBootAdmin", "SpringCloudEureka", "SpringCloudConfig", "Nacos", and "SpringCloudGateway".
...
class ScgCloud(_serialization.Model):
    """Spring Cloud Gateway cloud level properties.

    :ivar gateway: Spring Cloud Gateway properties.
    :vartype gateway: ~azure.mgmt.appcontainers.models.SpringCloudGateway
    """

    _attribute_map = {
        "gateway": {"key": "gateway", "type": "SpringCloudGateway"},
    }

    def __init__(self, *, gateway: Optional["_models.SpringCloudGateway"] = None, **kwargs: Any) -> None:
        """
        :keyword gateway: Spring Cloud Gateway properties.
        :paramtype gateway: ~azure.mgmt.appcontainers.models.SpringCloudGateway
        """
        super().__init__(**kwargs)
...
class ScgRoute(_serialization.Model):
    ...
    :ivar id: Id of the route.
    :vartype id: str
    :ivar uri: Uri of the route.
    :vartype uri: str
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword id: Id of the route.
        :paramtype id: str
        :keyword uri: Uri of the route.
        :paramtype uri: str
...
class ScgSpring(_serialization.Model):
    """Spring Cloud Gateway spring level properties.

    :ivar cloud: Spring Cloud Gateway cloud level properties.
    :vartype cloud: ~azure.mgmt.appcontainers.models.ScgCloud
    """

    _attribute_map = {
        "cloud": {"key": "cloud", "type": "ScgCloud"},
    }

    def __init__(self, *, cloud: Optional["_models.ScgCloud"] = None, **kwargs: Any) -> None:
        """
        :keyword cloud: Spring Cloud Gateway cloud level properties.
        :paramtype cloud: ~azure.mgmt.appcontainers.models.ScgCloud
        """
        super().__init__(**kwargs)
        self.cloud = cloud
...
class SpringCloudGateway(_serialization.Model):
    """Spring Cloud Gateway properties.

    :ivar route: Gateway route definition.
    :vartype route: list[~azure.mgmt.appcontainers.models.ScgRoute]
    """

    _attribute_map = {
        "route": {"key": "route", "type": "[ScgRoute]"},
    }

    def __init__(self, *, route: Optional[List["_models.ScgRoute"]] = None, **kwargs: Any) -> None:
        """
        :keyword route: Gateway route definition.
        :paramtype route: list[~azure.mgmt.appcontainers.models.ScgRoute]
        """
        super().__init__(**kwargs)
        self.route = route
...
class SpringCloudGatewayComponent(JavaComponentProperties):
    ...
    :ivar ingress: Java Component Ingress configurations.
    :vartype ingress: ~azure.mgmt.appcontainers.models.JavaComponentIngress
    :ivar spring: Spring Cloud Gateway spring level properties.
    :vartype spring: ~azure.mgmt.appcontainers.models.ScgSpring
    """
    ...
    _attribute_map = {
        ...
        "service_binds": {"key": "serviceBinds", "type": "[JavaComponentServiceBind]"},
        "ingress": {"key": "ingress", "type": "JavaComponentIngress"},
        "spring": {"key": "spring", "type": "ScgSpring"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        service_binds: Optional[List["_models.JavaComponentServiceBind"]] = None,
        ingress: Optional["_models.JavaComponentIngress"] = None,
        spring: Optional["_models.ScgSpring"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword configurations: List of Java Components configuration properties.
        ...
        :keyword ingress: Java Component Ingress configurations.
        :paramtype ingress: ~azure.mgmt.appcontainers.models.JavaComponentIngress
        :keyword spring: Spring Cloud Gateway spring level properties.
        :paramtype spring: ~azure.mgmt.appcontainers.models.ScgSpring
        """
        super().__init__(configurations=configurations, service_binds=service_binds, **kwargs)
