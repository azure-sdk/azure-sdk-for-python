...
class JobConfiguration(_serialization.Model):
    ...
    :ivar event_trigger_config: Manual trigger configuration for a single execution job. Properties
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype schedule_trigger_config:
         ~azure.mgmt.appcontainers.models.JobConfigurationScheduleTriggerConfig
        :keyword event_trigger_config: Manual trigger configuration for a single execution job.
         Properties replicaCompletionCount and parallelism would be set to 1 by default.
...
class JobConfigurationEventTriggerConfig(_serialization.Model):
    ...
    :ivar scale: Container App scaling configurations.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword scale: Container App scaling configurations.
