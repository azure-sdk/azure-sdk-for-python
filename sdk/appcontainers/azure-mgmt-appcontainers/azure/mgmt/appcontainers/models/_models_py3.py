...
class JavaComponentProperties(_serialization.Model):
    ...
    :ivar component_type: Type of the Java Component. Required. Known values are:
     "SpringBootAdmin", "SpringCloudEureka", "SpringCloudConfig", and "SpringCloudGateway".
...
class SpringCloudGatewayComponent(JavaComponentProperties):
    ...
    :ivar service_binds: List of Java Components that are bound to the Java component.
    :vartype service_binds: list[~azure.mgmt.appcontainers.models.JavaComponentServiceBind]
    :ivar routes: The route definitions of Spring Cloud Gateway.
    :vartype routes: list[~azure.mgmt.appcontainers.models.SpringCloudGatewayRoute]
    """
    ...
    _attribute_map = {
        ...
        "configurations": {"key": "configurations", "type": "[JavaComponentConfigurationProperty]"},
        "service_binds": {"key": "serviceBinds", "type": "[JavaComponentServiceBind]"},
        "routes": {"key": "routes", "type": "[SpringCloudGatewayRoute]"},
    }
    ...
    def __init__(
        ...
        *,
        configurations: Optional[List["_models.JavaComponentConfigurationProperty"]] = None,
        service_binds: Optional[List["_models.JavaComponentServiceBind"]] = None,
        routes: Optional[List["_models.SpringCloudGatewayRoute"]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword configurations: List of Java Components configuration properties.
        ...
        :keyword service_binds: List of Java Components that are bound to the Java component.
        :paramtype service_binds: list[~azure.mgmt.appcontainers.models.JavaComponentServiceBind]
        :keyword routes: The route definitions of Spring Cloud Gateway.
        :paramtype routes: list[~azure.mgmt.appcontainers.models.SpringCloudGatewayRoute]
        """
        super().__init__(configurations=configurations, service_binds=service_binds, **kwargs)
...
class SpringCloudGatewayRoute(_serialization.Model):
    """Spring Cloud Gateway route definitions.

    :ivar id: The route id of Spring Cloud Gateway.
    :vartype id: str
    :ivar uri: The uri of Spring Cloud Gateway.
    :vartype uri: str
    :ivar predicates: The predicates of Spring Cloud Gateway.
    :vartype predicates: list[str]
    :ivar filters: The filters of Spring Cloud Gateway.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword id: The route id of Spring Cloud Gateway.
        :paramtype id: str
        :keyword uri: The uri of Spring Cloud Gateway.
        :paramtype uri: str
        :keyword predicates: The predicates of Spring Cloud Gateway.
        :paramtype predicates: list[str]
        :keyword filters: The filters of Spring Cloud Gateway.
