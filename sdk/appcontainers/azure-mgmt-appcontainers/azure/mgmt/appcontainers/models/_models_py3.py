...
class DaprMetadata(_serialization.Model):
    ...
    :ivar secret_id: Resource id of the environment secret from which to pull the metadata property
     value.
    ...
    _attribute_map = {
        ...
        "secret_id": {"key": "secretId", "type": "str"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword secret_id: Resource id of the environment secret from which to pull the metadata
         property value.
...
class EnvironmentVar(_serialization.Model):
    ...
    :ivar secret_ref: Name of the Container App secret from which to pull the environment variable
     value.
    :vartype secret_ref: str
    :ivar secret_id: Resource id of the environment secret from which to pull the environment
     variable value.
    :vartype secret_id: str
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword secret_ref: Name of the Container App secret from which to pull the environment
         variable value.
        :paramtype secret_ref: str
        :keyword secret_id: Resource id of the environment secret from which to pull the environment
         variable value.
        :paramtype secret_id: str
        """
        super().__init__(**kwargs)
...
class ManagedEnvironmentSecret(ProxyResource):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.appcontainers.models.SystemData
    :ivar properties: Secret properties.
    :vartype properties: ~azure.mgmt.appcontainers.models.ManagedEnvironmentSecretProperties
    """
    ...
    _attribute_map = {
        ...
        "type": {"key": "type", "type": "str"},
        "system_data": {"key": "systemData", "type": "SystemData"},
        "properties": {"key": "properties", "type": "ManagedEnvironmentSecretProperties"},
    }

    def __init__(
        self, *, properties: Optional["_models.ManagedEnvironmentSecretProperties"] = None, **kwargs: Any
    ) -> None:
        """
        :keyword properties: Secret properties.
        :paramtype properties: ~azure.mgmt.appcontainers.models.ManagedEnvironmentSecretProperties
        """
        super().__init__(**kwargs)
        self.properties = properties
...
class ManagedEnvironmentSecretProperties(Secret):
    """Secret properties.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype key_vault_url: str
        """
        super().__init__(name=name, value=value, identity=identity, key_vault_url=key_vault_url, **kwargs)


class ManagedEnvironmentSecretsCollection(_serialization.Model):
    ...
    :ivar value: Collection of secret resources. Required.
    :vartype value: list[~azure.mgmt.appcontainers.models.ManagedEnvironmentSecret]
    :ivar next_link: Link to next page of resources.
    :vartype next_link: str
    """
    ...
    _attribute_map = {
        "value": {"key": "value", "type": "[ManagedEnvironmentSecret]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }

    def __init__(self, *, value: List["_models.ManagedEnvironmentSecret"], **kwargs: Any) -> None:
        """
        :keyword value: Collection of secret resources. Required.
        :paramtype value: list[~azure.mgmt.appcontainers.models.ManagedEnvironmentSecret]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class RegistryCredentials(_serialization.Model):
    ...
    :ivar password_secret_id: Resource id of the referenced environment secret that contains the
    ...
    _attribute_map = {
        ...
        "password_secret_id": {"key": "passwordSecretId", "type": "str"},
        "identity": {"key": "identity", "type": "str"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword password_secret_id: Resource id of the referenced environment secret that contains the
         registry login password.
        :paramtype password_secret_id: str
...
class ScaleRuleAuth(_serialization.Model):
    ...
    :vartype secret_ref: str
    :ivar secret_id: Resource id of the environment secret from which to pull the auth params.
    :vartype secret_id: str
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype secret_ref: str
        :keyword secret_id: Resource id of the environment secret from which to pull the auth params.
        :paramtype secret_id: str
...
class SecretVolumeItem(_serialization.Model):
    ...
    :vartype secret_ref: str
    :ivar secret_id: Resource id of the referenced environment secret from which to pull the secret
     value.
    :vartype secret_id: str
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype secret_ref: str
        :keyword secret_id: Resource id of the referenced environment secret from which to pull the
         secret value.
        :paramtype secret_id: str
