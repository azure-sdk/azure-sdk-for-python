...
class PatchProperties(_serialization.Model):
    ...
    :ivar secrets: Collection of secrets used by a Session Pool.
    :vartype secrets: list[~azure.mgmt.appcontainers.models.Secret]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword secrets: Collection of secrets used by a Session Pool.
        :paramtype secrets: list[~azure.mgmt.appcontainers.models.Secret]
        """
        super().__init__(**kwargs)
...
class SessionPool(TrackedResource):
    ...
    :ivar location: The geo-location where the resource lives. Required.
    :vartype location: str
    :ivar managed_environment_id: Resource ID of the Session Pool's environment.
    :vartype managed_environment_id: str
    :ivar max_concurrent_sessions: The max count of sessions at the same time.
    :vartype max_concurrent_sessions: int
    :ivar secrets: Collection of secrets used by a Session Pool.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword location: The geo-location where the resource lives. Required.
        :paramtype location: str
        :keyword managed_environment_id: Resource ID of the Session Pool's environment.
        :paramtype managed_environment_id: str
        :keyword max_concurrent_sessions: The max count of sessions at the same time.
        :paramtype max_concurrent_sessions: int
        :keyword secrets: Collection of secrets used by a Session Pool.
