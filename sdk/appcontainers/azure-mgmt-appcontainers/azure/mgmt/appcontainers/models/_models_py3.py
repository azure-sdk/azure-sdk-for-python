...
class ScheduledEntry(_serialization.Model):
    ...
    :ivar duration_hours: Length of maintenance window range from 8 to 24 hours.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword duration_hours: Length of maintenance window range from 8 to 24 hours.
