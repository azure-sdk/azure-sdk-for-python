...
class ContainerRegistryWithCustomImage(_serialization.Model):
    ...
    :ivar server: Login server of the container registry that the final image should be uploaded
     to. Required.
    :vartype server: str
    :ivar identity: Full user-assigned identity Resource ID for the managed identity that should be
     used to connect to the container registry. Required.
    :vartype identity: str
    ...
    def __init__(self, *, server: str, identity: str, image: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword server: Login server of the container registry that the final image should be uploaded
         to. Required.
        :paramtype server: str
        :keyword identity: Full user-assigned identity Resource ID for the managed identity that should
         be used to connect to the container registry. Required.
