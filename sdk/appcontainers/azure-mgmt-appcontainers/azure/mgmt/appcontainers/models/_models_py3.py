...
class DaprComponent(ProxyResource):
    ...
    _attribute_map = {
        ...
        "type": {"key": "type", "type": "str"},
        "system_data": {"key": "systemData", "type": "SystemData"},
        "properties": {"key": "properties", "type": "DaprComponentProperties"},
    }

    def __init__(self, *, properties: Optional["_models.DaprComponentProperties"] = None, **kwargs: Any) -> None:
        """
        :keyword properties: Dapr Component resource specific properties.
        :paramtype properties: ~azure.mgmt.appcontainers.models.DaprComponentProperties
        """
        super().__init__(**kwargs)
        self.properties = properties
