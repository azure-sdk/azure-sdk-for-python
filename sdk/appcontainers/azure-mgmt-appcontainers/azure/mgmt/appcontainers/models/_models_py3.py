...
class DaprAppHealth(_serialization.Model):
    ...
    :vartype path: str
    :ivar probe_interval: Interval for the health probe in seconds.
    :vartype probe_interval: int
    :ivar probe_timeout: Timeout for the health probe in milliseconds.
    :vartype probe_timeout: int
    :ivar threshold: Threshold for the health probe.
    :vartype threshold: int
    """

    _validation = {
        "probe_interval": {"minimum": 1},
        "probe_timeout": {"minimum": 1},
        "threshold": {"minimum": 1},
    }
    ...
    _attribute_map = {
        ...
        "probe_timeout": {"key": "probeTimeout", "type": "int"},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype path: str
        :keyword probe_interval: Interval for the health probe in seconds.
        :paramtype probe_interval: int
        :keyword probe_timeout: Timeout for the health probe in milliseconds.
        :paramtype probe_timeout: int
