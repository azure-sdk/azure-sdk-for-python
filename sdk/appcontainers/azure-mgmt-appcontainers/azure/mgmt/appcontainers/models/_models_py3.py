...
class HttpRouteConfig(TrackedResource):
...
class HttpRouteConfigPatch(_serialization.Model):
    """Advanced Ingress routing for path/header based routing for a Container App Environment.

    :ivar tags: Resource tags.
    :vartype tags: dict[str, str]
    :ivar properties: Http Route Config properties.
    :vartype properties: ~azure.mgmt.appcontainers.models.HttpRouteConfigPatchProperties
    """

    _attribute_map = {
        "tags": {"key": "tags", "type": "{str}"},
        "properties": {"key": "properties", "type": "HttpRouteConfigPatchProperties"},
    }
    ...
    def __init__(
        ...
        *,
        tags: Optional[Dict[str, str]] = None,
        properties: Optional["_models.HttpRouteConfigPatchProperties"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword tags: Resource tags.
        :paramtype tags: dict[str, str]
        :keyword properties: Http Route Config properties.
        :paramtype properties: ~azure.mgmt.appcontainers.models.HttpRouteConfigPatchProperties
        """
        super().__init__(**kwargs)
        self.tags = tags
        self.properties = properties
...
class HttpRouteConfigPatchProperties(_serialization.Model):
...
class HttpRouteTarget(_serialization.Model):
    ...
    :ivar container_app_name: Container App Name to route requests to. Required.
    :vartype container_app_name: str
    :ivar revision_name: Revision to route requests to.
    :vartype revision_name: str
    :ivar label_name: Label/Revision to route requests to.
    ...
    _validation = {
        "container_app_name": {"required": True},
        "weight": {"maximum": 100, "minimum": 0},
    }

    _attribute_map = {
        "container_app_name": {"key": "containerAppName", "type": "str"},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword container_app_name: Container App Name to route requests to. Required.
        :paramtype container_app_name: str
        :keyword revision_name: Revision to route requests to.
        :paramtype revision_name: str
        :keyword label_name: Label/Revision to route requests to.
...
class ManagedHttpRouteConfigCollection(_serialization.Model):
...
class ManagedHttpRoutePatch(_serialization.Model):
