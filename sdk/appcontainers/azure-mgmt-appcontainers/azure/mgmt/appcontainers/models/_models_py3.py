...
class ManagedEnvironment(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype kind: str
    :ivar zones: The list of availability zones to use for dedicated workloadProfiles.
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :paramtype kind: str
        :keyword zones: The list of availability zones to use for dedicated workloadProfiles.
