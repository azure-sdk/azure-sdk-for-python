...
class LabelHistoryRecordItem(_serialization.Model):
    ...
    :ivar status: Status of the label history record. Known values are: "Starting", "Succeeded",
     and "Failed".
    :vartype status: str or ~azure.mgmt.appcontainers.models.LabelHistoryRecordItemStatus
    """
