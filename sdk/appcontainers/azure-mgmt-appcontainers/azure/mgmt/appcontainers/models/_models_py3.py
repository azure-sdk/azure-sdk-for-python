...
class Ingress(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar target_port_scheme: Whether an http app listens on http or https. Known values are:
     "http" and "https".
    :vartype target_port_scheme: str or ~azure.mgmt.appcontainers.models.IngressTargetPortScheme
    """
    ...
    _attribute_map = {
        ...
        "target_port_scheme": {"key": "targetPortScheme", "type": "str"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        target_port_scheme: Optional[Union[str, "_models.IngressTargetPortScheme"]] = None,
        **kwargs: Any
    ) -> None:
        """
        ...
        :keyword target_port_scheme: Whether an http app listens on http or https. Known values are:
         "http" and "https".
        :paramtype target_port_scheme: str or ~azure.mgmt.appcontainers.models.IngressTargetPortScheme
        """
        super().__init__(**kwargs)
        self.fqdn = None
        ...
        self.target_port_scheme = target_port_scheme
