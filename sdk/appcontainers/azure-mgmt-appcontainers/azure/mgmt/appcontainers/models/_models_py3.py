...
class DaprComponentResiliencyPolicyCircuitBreakerPolicyConfiguration(_serialization.Model):
    ...
    :vartype consecutive_errors: int
    :ivar timeout_in_seconds: The interval in seconds until a retry attempt is made afer the circut
     is opened.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype consecutive_errors: int
        :keyword timeout_in_seconds: The interval in seconds until a retry attempt is made afer the
         circut is opened.
