...
class CustomDomainAutoGenerated(_serialization.Model):
...
class HttpRouteConfigProperties(_serialization.Model):
    ...
    :vartype custom_domains: list[~azure.mgmt.appcontainers.models.CustomDomainAutoGenerated]
    ...
    _attribute_map = {
        ...
        "custom_domains": {"key": "customDomains", "type": "[CustomDomainAutoGenerated]"},
    ...
    def __init__(
        self,
        *,
        custom_domains: Optional[List["_models.CustomDomainAutoGenerated"]] = None,
        rules: Optional[List["_models.HttpRouteRule"]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword custom_domains: Custom domain bindings for http Routes' hostnames.
        :paramtype custom_domains: list[~azure.mgmt.appcontainers.models.CustomDomainAutoGenerated]
...
class HttpRouteTarget(_serialization.Model):
    ...
    :ivar container_app_name: Container App Name to route requests to.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword container_app_name: Container App Name to route requests to.
