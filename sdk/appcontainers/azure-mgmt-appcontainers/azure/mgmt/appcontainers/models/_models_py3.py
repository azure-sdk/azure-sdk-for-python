...
class Configuration(_serialization.Model):
    ...
    :ivar active_revisions_mode: ActiveRevisionsMode controls how active revisions are handled for
     ...
     provided, this is the default.</item><item>Labeled: Only the revisions that have labels
     attached to them are active.</item></list>. Known values are: "Multiple", "Single", and
     "Labeled".
...
class GithubActionConfiguration(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar label: The label that will be assigned to the new revision created by the deployment.
     Only applicable if 'labeled' activeRevisionMode is used.
    :vartype label: str
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype build_environment_variables:
         list[~azure.mgmt.appcontainers.models.EnvironmentVariable]
        :keyword label: The label that will be assigned to the new revision created by the deployment.
         Only applicable if 'labeled' activeRevisionMode is used.
        :paramtype label: str
        """
        super().__init__(**kwargs)
...
class Label(_serialization.Model):
    ...
    :ivar label_name: Name of the label.
    :vartype label_name: str
    :ivar revision_name: Name of the revision associated with the label.
    :vartype revision_name: str
    :ivar traffic_weight: Percent of the traffic that will be routed to the revision in this label.
    ...
    _attribute_map = {
        ...
        "traffic_weight": {"key": "trafficWeight", "type": "int"},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword label_name: Name of the label.
        :paramtype label_name: str
        :keyword revision_name: Name of the revision associated with the label.
        :paramtype revision_name: str
        :keyword traffic_weight: Percent of the traffic that will be routed to the revision in this
         label.
        :paramtype traffic_weight: int
        """
        super().__init__(**kwargs)
...
class Labels(ProxyResource):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.appcontainers.models.SystemData
    :ivar provisioning_state: Current provisioning State of the operation. Known values are:
     "InProgress", "Succeeded", "Failed", and "Canceled".
    :vartype provisioning_state: str or ~azure.mgmt.appcontainers.models.LabelsProvisioningState
    :ivar labels: Labels for the Container App.
    :vartype labels: list[~azure.mgmt.appcontainers.models.Label]
    """
    ...
    _attribute_map = {
        ...
        "system_data": {"key": "systemData", "type": "SystemData"},
        "provisioning_state": {"key": "properties.provisioningState", "type": "str"},
        "labels": {"key": "properties.labels", "type": "[Label]"},
    }

    def __init__(self, *, labels: Optional[List["_models.Label"]] = None, **kwargs: Any) -> None:
        """
        :keyword labels: Labels for the Container App.
        :paramtype labels: list[~azure.mgmt.appcontainers.models.Label]
        """
        super().__init__(**kwargs)
        self.provisioning_state = None
        self.labels = labels
...
class LabelsCollection(_serialization.Model):
    """Labels collection ARM resource.

    All required parameters must be populated in order to send to server.

    :ivar value: Collection of resources. Required.
    :vartype value: list[~azure.mgmt.appcontainers.models.Labels]
    ...
    _attribute_map = {
        "value": {"key": "value", "type": "[Labels]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }

    def __init__(self, *, value: List["_models.Labels"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword value: Collection of resources. Required.
        :paramtype value: list[~azure.mgmt.appcontainers.models.Labels]
...
class LogLevelSetting(_serialization.Model):
    ...
    :vartype logger: str
    :ivar level: The specified logger's log level. Required.
    :vartype level: str
    """
    ...
    def __init__(self, *, logger: str, level: str, **kwargs: Any) -> None:
        """
        :keyword logger: Logger name. Required.
        :paramtype logger: str
        :keyword level: The specified logger's log level. Required.
        :paramtype level: str
        """
        super().__init__(**kwargs)
        self.logger = logger
...
class RuntimeJavaAgent(_serialization.Model):
    ...
    :vartype enabled: bool
    :ivar log_level_settings: Settings of the log level for the java app.
    :vartype log_level_settings: list[~azure.mgmt.appcontainers.models.LogLevelSetting]
    """

    _attribute_map = {
        "enabled": {"key": "enabled", "type": "bool"},
        "log_level_settings": {"key": "logLevelSettings", "type": "[LogLevelSetting]"},
    }
    ...
    def __init__(
        ...
        *,
        enabled: Optional[bool] = None,
        log_level_settings: Optional[List["_models.LogLevelSetting"]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword enabled: Enable java agent injection for the java app.
        :paramtype enabled: bool
        :keyword log_level_settings: Settings of the log level for the java app.
        :paramtype log_level_settings: list[~azure.mgmt.appcontainers.models.LogLevelSetting]
        """
        super().__init__(**kwargs)
        self.enabled = enabled
        self.log_level_settings = log_level_settings
