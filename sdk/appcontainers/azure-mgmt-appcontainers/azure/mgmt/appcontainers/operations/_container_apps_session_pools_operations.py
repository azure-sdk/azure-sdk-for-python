...
class ContainerAppsSessionPoolsOperations:
    ...
    list_by_subscription.metadata = {"url": "/subscriptions/{subscriptionId}/providers/Microsoft.App/sessionPools"}
    ...
    list_by_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/sessionPools"
    }
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/sessionPools/{sessionPoolName}"
    }
    ...
    def create_or_update(
        ...
        session_pool_name_envelope: _models.SessionPool,
        *,
        ...
        **kwargs: Any
        ...
        :param session_pool_name: Name of the Session Pool. Required.
        :type session_pool_name: str
        :param session_pool_name_envelope: Properties used to create a session pool. Required.
        :type session_pool_name_envelope: ~azure.mgmt.appcontainers.models.SessionPool
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type session_pool_name: str
        :param session_pool_name_envelope: Properties used to create a session pool. Required.
        :type session_pool_name_envelope: IO
    ...
    def create_or_update(
        ...
        resource_group_name: str,
        session_pool_name: str,
        session_pool_name_envelope: Union[_models.SessionPool, IO],
        **kwargs: Any
    ) -> _models.SessionPool:
        """Create or update a Session Pool.
        ...
        :param session_pool_name: Name of the Session Pool. Required.
        :type session_pool_name: str
        :param session_pool_name_envelope: Properties used to create a session pool. Is either a
         SessionPool type or a IO type. Required.
        :type session_pool_name_envelope: ~azure.mgmt.appcontainers.models.SessionPool or IO
        ...
        _json = None
        _content = None
        if isinstance(session_pool_name_envelope, (IOBase, bytes)):
            _content = session_pool_name_envelope
        else:
            _json = self._serialize.body(session_pool_name_envelope, "SessionPool")
    ...
    def update(
        ...
        resource_group_name: str,
        session_pool_name: str,
        session_pool_name_envelope: _models.PatchProperties,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.SessionPool:
        ...
        :type session_pool_name: str
        :param session_pool_name_envelope: Properties used to create a session pool. Required.
        :type session_pool_name_envelope: ~azure.mgmt.appcontainers.models.PatchProperties
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def update(
        ...
        resource_group_name: str,
        session_pool_name: str,
        session_pool_name_envelope: Union[_models.PatchProperties, IO],
        **kwargs: Any
    ) -> _models.SessionPool:
        """Update properties of a Session Pool.
        ...
        :type session_pool_name: str
        :param session_pool_name_envelope: Properties used to create a session pool. Is either a
         PatchProperties type or a IO type. Required.
        :type session_pool_name_envelope: ~azure.mgmt.appcontainers.models.PatchProperties or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        if isinstance(session_pool_name_envelope, (IOBase, bytes)):
            ...
            _json = self._serialize.body(session_pool_name_envelope, "PatchProperties")
