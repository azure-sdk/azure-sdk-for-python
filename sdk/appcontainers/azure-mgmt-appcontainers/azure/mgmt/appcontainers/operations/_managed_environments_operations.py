...
class ManagedEnvironmentsOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.ManagedEnvironment"]:
    ...
    def get_auth_token(
        ...
        deserialized = self._deserialize("EnvironmentAuthToken", pipeline_response.http_response)
