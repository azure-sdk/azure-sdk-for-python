...
def build_list_by_managed_environment_resource_request(  # pylint: disable=name-too-long
...
class MaintenanceConfigurationsOperations:
    ...
    @distributed_trace
    def list_by_managed_environment_resource(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_managed_environment_resource_request(
