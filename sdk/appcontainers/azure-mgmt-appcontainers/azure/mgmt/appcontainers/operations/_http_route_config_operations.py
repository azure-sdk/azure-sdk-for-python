...
class HttpRouteConfigOperations:
    ...
    def update(
        ...
        environment_name: str,
        http_route_name: str,
        http_route_config_envelope: _models.HttpRouteConfigPatch,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.HttpRouteConfig:
        ...
        :param http_route_config_envelope: Properties of http route config that need to be updated.
         Required.
        :type http_route_config_envelope: ~azure.mgmt.appcontainers.models.HttpRouteConfigPatch
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: HttpRouteConfig or the result of cls(response)
    ...
    def update(
        ...
        environment_name: str,
        http_route_name: str,
        http_route_config_envelope: Union[_models.HttpRouteConfigPatch, IO[bytes]],
        **kwargs: Any
    ) -> _models.HttpRouteConfig:
        """Update tags of a manged http route object.
        ...
        :param http_route_config_envelope: Properties of http route config that need to be updated. Is
         either a HttpRouteConfigPatch type or a IO[bytes] type. Required.
        :type http_route_config_envelope: ~azure.mgmt.appcontainers.models.HttpRouteConfigPatch or
         IO[bytes]
        :return: HttpRouteConfig or the result of cls(response)
        :rtype: ~azure.mgmt.appcontainers.models.HttpRouteConfig
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if isinstance(http_route_config_envelope, (IOBase, bytes)):
            ...
            _json = self._serialize.body(http_route_config_envelope, "HttpRouteConfigPatch")
