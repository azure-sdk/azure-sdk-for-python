...
def build_get_verification_id_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.App/getVerificationId")
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
    }
...
class ContainerAppsAPIClientOperationsMixin(ContainerAppsAPIClientMixinABC):
    ...
    @distributed_trace
    def get_verification_id(self, **kwargs: Any) -> str:
        ...
        request = build_get_verification_id_request(
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self.get_verification_id.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    get_verification_id.metadata = {"url": "/subscriptions/{subscriptionId}/providers/Microsoft.App/getVerificationId"}
