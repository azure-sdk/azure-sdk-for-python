...
class ContainerAppsOperations:
    ...
    @distributed_trace
    def begin_start(self, resource_group_name: str, container_app_name: str, **kwargs: Any) -> LROPoller[None]:
    ...
    @distributed_trace
    def begin_stop(self, resource_group_name: str, container_app_name: str, **kwargs: Any) -> LROPoller[None]:
