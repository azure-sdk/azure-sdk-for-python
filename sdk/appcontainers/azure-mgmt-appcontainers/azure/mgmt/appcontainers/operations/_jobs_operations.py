...
def build_get_request(resource_group_name: str, subscription_id: str, job_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_create_or_update_request(
    resource_group_name: str, subscription_id: str, job_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_delete_request(resource_group_name: str, subscription_id: str, job_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_update_request(resource_group_name: str, subscription_id: str, job_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_start_request(resource_group_name: str, subscription_id: str, job_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class JobsOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, **kwargs: Any) -> _models.Job:
    ...
    def _create_or_update_initial(
        self, resource_group_name: str, job_envelope: Union[_models.Job, IO], **kwargs: Any
    ) -> _models.Job:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    @overload
    def begin_create_or_update(
        self, resource_group_name: str, job_envelope: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> LROPoller[_models.Job]:
        """Create or Update a Container Apps Job.
    ...
    def _update_initial(
        self, resource_group_name: str, job_envelope: Union[_models.JobPatchProperties, IO], **kwargs: Any
    ...
    def _start_initial(
        self, resource_group_name: str, template: Union[_models.JobExecutionTemplate, IO], **kwargs: Any
    ...
    @overload
    def begin_start(
        self, resource_group_name: str, template: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> LROPoller[_models.JobExecutionBase]:
        """Start a Container Apps Job.
    ...
    @distributed_trace
    def begin_stop_execution(self, resource_group_name: str, **kwargs: Any) -> LROPoller[None]:
    ...
    @distributed_trace
    def list_secrets(self, resource_group_name: str, **kwargs: Any) -> _models.JobSecretsCollection:
