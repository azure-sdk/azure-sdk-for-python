...
class TestContainerAppsAPIMaintenanceConfigurationsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_list_by_managed_environment_resource(self, resource_group):
        response = self.client.maintenance_configurations.list_by_managed_environment_resource(
    ...
    async def test_create_or_update(self, resource_group):
        response = await self.client.maintenance_configurations.create_or_update(
            ...
            maintenance_configuration_envelope={
                "id": "str",
                "name": "str",
                "scheduledEntries": [{"startHourUtc": 0, "weekDay": "str", "durationHours": 0}],
                "systemData": {
