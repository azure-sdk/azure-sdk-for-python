...
class DynamicSessionsClient:
    ...
    :vartype code_execution: azure.appcontainers.dynamicsessions.operations.CodeExecutionOperations
    :ivar session_resource_files: SessionResourceFilesOperations operations
    :vartype session_resource_files:
     azure.appcontainers.dynamicsessions.operations.SessionResourceFilesOperations
