...
class SessionCodeExecutionRequest(_model_base.Model):
    ...
    :vartype code_input_type: str or ~azure.appcontainers.dynamicsessions.models.CodeInputType
    ...
    :vartype execution_type: str or ~azure.appcontainers.dynamicsessions.models.ExecutionType
...
class SessionCodeExecutionResource(_model_base.Model):
    ...
    :vartype status: str or ~azure.appcontainers.dynamicsessions.models.OperationState
    ...
    :vartype result: ~azure.appcontainers.dynamicsessions.models.SessionCodeExecutionResult
    """
