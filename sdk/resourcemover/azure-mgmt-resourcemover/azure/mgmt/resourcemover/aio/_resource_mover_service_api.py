...
class ResourceMoverServiceAPI:
    ...
    :vartype move_collections: azure.mgmt.resourcemover.aio.operations.MoveCollectionsOperations
    :ivar move_resources: MoveResourcesOperations operations
    :vartype move_resources: azure.mgmt.resourcemover.aio.operations.MoveResourcesOperations
    :ivar unresolved_dependencies: UnresolvedDependenciesOperations operations
    :vartype unresolved_dependencies:
     azure.mgmt.resourcemover.aio.operations.UnresolvedDependenciesOperations
    :ivar operations_discovery: OperationsDiscoveryOperations operations
    :vartype operations_discovery:
     azure.mgmt.resourcemover.aio.operations.OperationsDiscoveryOperations
    ...
    :type base_url: str
    :keyword api_version: Api Version. Default value is "2025-01-01-privatepreview". Note that
