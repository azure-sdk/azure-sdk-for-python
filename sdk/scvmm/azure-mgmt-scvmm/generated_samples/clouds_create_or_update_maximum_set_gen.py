...
# USAGE
    python clouds_create_or_update_maximum_set_gen.py
...
def main():
    ...
    response = client.clouds.begin_create_or_update(
        resource_group_name="rgscvmm",
        cloud_resource_name="2",
        resource={
            "extendedLocation": {
...
# x-ms-original-file: specification/scvmm/resource-manager/Microsoft.ScVmm/stable/2025-03-13/examples/Clouds_CreateOrUpdate_MaximumSet_Gen.json
