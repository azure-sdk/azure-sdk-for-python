...
def main():
    ...
    response = client.availability_sets.begin_update(
        ...
        properties={"tags": {"key1460": "vcbwibkvr"}},
    ).result()
    print(response)


# x-ms-original-file: specification/scvmm/resource-manager/Microsoft.ScVmm/stable/2025-03-13/examples/AvailabilitySets_Update_MaximumSet_Gen.json
