...
class TestScVmmMgmtVirtualNetworksOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(ScVmmMgmtClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_virtual_networks_list_by_subscription(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_virtual_networks_begin_update(self, resource_group):
        response = self.client.virtual_networks.begin_update(
            resource_group_name=resource_group.name,
            virtual_network_name="str",
