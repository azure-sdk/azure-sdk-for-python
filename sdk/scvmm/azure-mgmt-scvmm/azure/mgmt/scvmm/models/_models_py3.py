...
class StopVirtualMachineOptions(_serialization.Model):
    ...
    def __init__(self, *, skip_shutdown: Optional[Union[str, "_models.SkipShutdown"]] = None, **kwargs: Any) -> None:
        """
...
class VirtualMachineInstanceUpdate(_serialization.Model):
    ...
    :ivar properties: The updatable properties of the VirtualMachineInstance.
    ...
    def __init__(
        ...
        """
        :keyword properties: The updatable properties of the VirtualMachineInstance.
...
class VmInstanceHybridIdentityMetadataListResult(_serialization.Model):
