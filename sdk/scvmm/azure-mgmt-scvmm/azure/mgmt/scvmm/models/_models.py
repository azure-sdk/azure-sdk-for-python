...
class CloudInventoryItem(InventoryItemProperties, discriminator="Cloud"):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, inventory_type=InventoryType.CLOUD, **kwargs)
...
class GuestAgentProperties(_model_base.Model):
    ...
    """Provisioning state of the resource. Known values are: \"Succeeded\", \"Failed\", \"Canceled\",
     \"Provisioning\", \"Updating\", \"Deleting\", \"Accepted\", and \"Created\"."""
    private_link_scope_resource_id: Optional[str] = rest_field(name="privateLinkScopeResourceId")
...
class HardwareProfile(_model_base.Model):
    ...
    memory_mb: Optional[int] = rest_field(name="memoryMB")
    ...
    """Gets or sets a value indicating whether to enable dynamic memory or not. Known values are:
     \"true\" and \"false\"."""
    dynamic_memory_max_mb: Optional[int] = rest_field(name="dynamicMemoryMaxMB")
    """Gets or sets the max dynamic memory for the vm."""
    dynamic_memory_min_mb: Optional[int] = rest_field(name="dynamicMemoryMinMB")
...
class InfrastructureProfile(_model_base.Model):
...
class NetworkInterface(_model_base.Model):
...
class OsProfileForVmInstance(_model_base.Model):
    ...
    domain_username: Optional[str] = rest_field(name="domainUsername")
    ...
    workgroup: Optional[str] = rest_field()
    ...
    timezone: Optional[int] = rest_field()
    """Gets or sets the index value of the timezone."""
    run_once_commands: Optional[str] = rest_field(name="runOnceCommands")
...
class VirtualDisk(_model_base.Model):
    """Virtual disk model.
...
class VirtualMachineInventoryItem(InventoryItemProperties, discriminator="VirtualMachine"):
...
class VirtualMachineTemplateInventoryItem(InventoryItemProperties, discriminator="VirtualMachineTemplate"):
    ...
    os_name: Optional[str] = rest_field(name="osName", visibility=["read"])
    """Gets os name."""
    inventory_type: Literal[InventoryType.VIRTUAL_MACHINE_TEMPLATE] = rest_discriminator(name="inventoryType")  # type: ignore # pylint: disable=line-too-long
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, inventory_type=InventoryType.VIRTUAL_MACHINE_TEMPLATE, **kwargs)


class VirtualMachineTemplateProperties(_model_base.Model):
    """Defines the resource properties.
...
class VirtualNetworkInventoryItem(InventoryItemProperties, discriminator="VirtualNetwork"):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, inventory_type=InventoryType.VIRTUAL_NETWORK, **kwargs)
