...
class VmmServersOperations:
    ...
    def _create_or_update_initial(
        self, resource_group_name: str, vmm_server_name: str, resource: Union[_models.VmmServer, IO], **kwargs: Any
    ) -> _models.VmmServer:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def begin_create_or_update(
        ...
        :param vmm_server_name: Name of the VmmServer. Required.
        :type vmm_server_name: str
        :param resource: Resource create parameters. Is either a VmmServer type or a IO type. Required.
        :type resource: ~azure.mgmt.scvmm.models.VmmServer or IO
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        vmm_server_name: str,
        properties: Union[_models.VmmServerTagsUpdate, IO],
        **kwargs: Any
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.scvmm.models.VmmServerTagsUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
