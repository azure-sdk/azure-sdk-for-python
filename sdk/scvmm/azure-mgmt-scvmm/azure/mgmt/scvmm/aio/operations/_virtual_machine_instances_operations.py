...
class VirtualMachineInstancesOperations:
    ...
    async def begin_create_or_update(
        ...
        :type resource: ~azure.mgmt.scvmm.models.VirtualMachineInstance or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either VirtualMachineInstance or the result
         of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.scvmm.models.VirtualMachineInstance]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def _update_initial(
        self, resource_uri: str, properties: Union[_models.VirtualMachineInstanceUpdate, IO[bytes]], **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    async def begin_update(
        ...
        :type properties: ~azure.mgmt.scvmm.models.VirtualMachineInstanceUpdate or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either VirtualMachineInstance or the result
         of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.scvmm.models.VirtualMachineInstance]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def _create_checkpoint_initial(
        self, resource_uri: str, body: Union[_models.VirtualMachineCreateCheckpoint, IO[bytes]], **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    async def begin_create_checkpoint(
        ...
        :type body: ~azure.mgmt.scvmm.models.VirtualMachineCreateCheckpoint or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def _delete_checkpoint_initial(
        self, resource_uri: str, body: Union[_models.VirtualMachineDeleteCheckpoint, IO[bytes]], **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
        ...
        _request = build_delete_checkpoint_request(
            resource_uri=resource_uri,
            api_version=api_version,
            content_type=content_type,
            json=_json,
    ...
    async def begin_delete_checkpoint(
        ...
        :param body: The content of the action request. Is either a VirtualMachineDeleteCheckpoint type
         or a IO[bytes] type. Required.
        :type body: ~azure.mgmt.scvmm.models.VirtualMachineDeleteCheckpoint or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def _restore_checkpoint_initial(
        self, resource_uri: str, body: Union[_models.VirtualMachineRestoreCheckpoint, IO[bytes]], **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
        ...
        _request = build_restore_checkpoint_request(
            resource_uri=resource_uri,
            api_version=api_version,
            content_type=content_type,
            json=_json,
    ...
    async def begin_restore_checkpoint(
        ...
        :type body: ~azure.mgmt.scvmm.models.VirtualMachineRestoreCheckpoint or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def _stop_initial(
        self, resource_uri: str, body: Union[_models.StopVirtualMachineOptions, IO[bytes]], **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    async def begin_stop(
        ...
        :param body: The content of the action request. Is either a StopVirtualMachineOptions type or a
         IO[bytes] type. Required.
        :type body: ~azure.mgmt.scvmm.models.StopVirtualMachineOptions or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
