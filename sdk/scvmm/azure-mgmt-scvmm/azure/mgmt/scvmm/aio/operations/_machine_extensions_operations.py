...
class MachineExtensionsOperations:
    ...
    _create_or_update_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ScVmm/virtualMachines/{virtualMachineName}/extensions/{extensionName}"
    }
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param extension_parameters: Parameters supplied to the Create Machine Extension operation.
         Required.
        :type extension_parameters: ~azure.mgmt.scvmm.models.MachineExtension
        ...
        :return: An instance of AsyncLROPoller that returns either MachineExtension or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.scvmm.models.MachineExtension]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type extension_parameters: ~azure.mgmt.scvmm.models.MachineExtension or IO
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param extension_parameters: Parameters supplied to the Create Machine Extension operation.
         Required.
        :type extension_parameters: ~azure.mgmt.scvmm.models.MachineExtensionUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type extension_parameters: ~azure.mgmt.scvmm.models.MachineExtensionUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.scvmm.models.MachineExtension
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def list(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.scvmm.models.MachineExtension]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ScVmm/virtualMachines/{virtualMachineName}/extensions"
    }
