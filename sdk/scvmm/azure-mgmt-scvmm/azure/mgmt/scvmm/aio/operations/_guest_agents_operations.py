...
class GuestAgentsOperations:
    ...
    list_by_virtual_machine_instance.metadata = {
        "url": "/{resourceUri}/providers/Microsoft.ScVmm/virtualMachineInstances/default/guestAgents"
    }
    ...
    get.metadata = {
        "url": "/{resourceUri}/providers/Microsoft.ScVmm/virtualMachineInstances/default/guestAgents/default"
    }

    async def _create_initial(
        self, resource_uri: str, resource: Union[_models.GuestAgent, IO], **kwargs: Any
    ) -> _models.GuestAgent:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    async def begin_create(
        ...
        :param resource_uri: The fully qualified Azure Resource manager identifier of the resource.
         Required.
        :type resource_uri: str
        :param resource: Resource create parameters. Is either a GuestAgent type or a IO type.
         Required.
        :type resource: ~azure.mgmt.scvmm.models.GuestAgent or IO
