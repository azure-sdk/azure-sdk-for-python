...
class GuestAgentsOperations:
    ...
    _create_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ScVmm/virtualMachines/{virtualMachineName}/guestAgents/{guestAgentName}"
    }
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param guest_agent_name: Name of the guestAgents. Required.
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.scvmm.models.GuestAgent or IO
    ...
    @distributed_trace_async
    async def get(
        self, resource_group_name: str, virtual_machine_name: str, guest_agent_name: str, **kwargs: Any
    ) -> _models.GuestAgent:
        """Gets GuestAgent.
        ...
        :param virtual_machine_name: Name of the vm. Required.
        :type virtual_machine_name: str
        :param guest_agent_name: Name of the GuestAgent. Required.
        :type guest_agent_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    list_by_vm.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ScVmm/virtualMachines/{virtualMachineName}/guestAgents"
    }
