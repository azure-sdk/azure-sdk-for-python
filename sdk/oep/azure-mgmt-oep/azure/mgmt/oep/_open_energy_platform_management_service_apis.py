...
class OpenEnergyPlatformManagementServiceAPIs:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype private_endpoint_connections:
     azure.mgmt.oep.operations.PrivateEndpointConnectionsOperations
    :ivar private_link_resources: PrivateLinkResourcesOperations operations
    :vartype private_link_resources: azure.mgmt.oep.operations.PrivateLinkResourcesOperations
    ...
    :vartype private_endpoint_connection_proxies:
     azure.mgmt.oep.operations.PrivateEndpointConnectionProxiesOperations
    ...
    def __enter__(self) -> "OpenEnergyPlatformManagementServiceAPIs":
