...
# USAGE
    python private_endpoint_connection_proxies_list_by_oak_instance_maximum_set_gen.py
...
def main():
    ...
    response = client.private_endpoint_connection_proxies.list_by_oak_instance(
