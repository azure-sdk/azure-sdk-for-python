...
# USAGE
    python private_link_resources_list_by_oak_instance_minimum_set_gen.py
...
def main():
    ...
    response = client.private_link_resources.list_by_oak_instance(
        resource_group_name="SampleResourceGroupName",
        resource_name="lusicrgwozrvb",
    )
