...
class DocumentIntelligenceClientOperationsMixin(DocumentIntelligenceClientMixinABC):  # pylint: disable=name-too-long
    ...
    async def begin_analyze_document(
        ...
        **kwargs: Any
        ...
        :type body: ~documentintelligence.models.AnalyzeDocumentRequest
        ...
        :paramtype string_index_type: str or ~documentintelligence.models.StringIndexType
        :keyword features: List of optional analysis features. Default value is None.
        :paramtype features: list[str or ~documentintelligence.models.DocumentAnalysisFeature]
        ...
        :paramtype output_content_format: str or ~documentintelligence.models.DocumentContentFormat
        :keyword output: Additional outputs to generate during analysis. Default value is None.
        :paramtype output: list[str or ~documentintelligence.models.AnalyzeOutputOption]
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns AnalyzeResult. The AnalyzeResult is
         compatible with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~documentintelligence.models.AnalyzeResult]
    ...
    async def begin_analyze_document(
        ...
        **kwargs: Any
        ...
        :type body: ~documentintelligence.models.AnalyzeDocumentRequest or JSON or IO[bytes]
        :keyword pages: 1-based page numbers to analyze.  Ex. "1-3,5,7-9". Default value is None.
        :paramtype pages: str
        :keyword locale: Locale hint for text recognition and document analysis.  Value may contain
         only
    ...
    async def begin_analyze_batch_documents(
        ...
        **kwargs: Any
        ...
        :type body: ~documentintelligence.models.AnalyzeBatchDocumentsRequest
        :keyword pages: 1-based page numbers to analyze.  Ex. "1-3,5,7-9". Default value is None.
        :paramtype pages: str
        :keyword locale: Locale hint for text recognition and document analysis.  Value may contain
         only
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~documentintelligence.models.AnalyzeBatchResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_analyze_batch_documents(
        ...
        **kwargs: Any
        ...
        :type body: ~documentintelligence.models.AnalyzeBatchDocumentsRequest or JSON or IO[bytes]
        :keyword pages: 1-based page numbers to analyze.  Ex. "1-3,5,7-9". Default value is None.
        :paramtype pages: str
        :keyword locale: Locale hint for text recognition and document analysis.  Value may contain
         only
    ...
    def list_analyze_batch_results(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~documentintelligence.models.AnalyzeBatchOperation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def get_analyze_batch_result(
        ...
        :rtype: ~documentintelligence.models.AnalyzeBatchOperation
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_classify_document(
        ...
        **kwargs: Any
        ...
        :type body: ~documentintelligence.models.ClassifyDocumentRequest
        :keyword string_index_type: Method used to compute string offset and length. Known values are:
         "textElements", "unicodeCodePoint", and "utf16CodeUnit". Default value is None.
        :paramtype string_index_type: str or ~documentintelligence.models.StringIndexType
        :keyword split: Document splitting mode. Known values are: "auto", "none", and "perPage".
         Default value is None.
        :paramtype split: str or ~documentintelligence.models.SplitMode
        :keyword pages: 1-based page numbers to analyze.  Ex. "1-3,5,7-9". Default value is None.
        :paramtype pages: str
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
    ...
    async def begin_classify_document(
        ...
        **kwargs: Any
        ...
        :type body: ~documentintelligence.models.ClassifyDocumentRequest or JSON or IO[bytes]
        :keyword string_index_type: Method used to compute string offset and length. Known values are:
         "textElements", "unicodeCodePoint", and "utf16CodeUnit". Default value is None.
        :paramtype string_index_type: str or ~documentintelligence.models.StringIndexType
        :keyword split: Document splitting mode. Known values are: "auto", "none", and "perPage".
...
class DocumentIntelligenceAdministrationClientOperationsMixin(  # pylint: disable=too-many-public-methods,name-too-long
    ...
    async def begin_build_document_model(
        ...
        :type body: ~documentintelligence.models.BuildDocumentModelRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~documentintelligence.models.DocumentModelDetails]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_build_document_model(
        ...
        :type body: ~documentintelligence.models.BuildDocumentModelRequest or JSON or IO[bytes]
        :return: An instance of AsyncLROPoller that returns DocumentModelDetails. The
         DocumentModelDetails is compatible with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~documentintelligence.models.DocumentModelDetails]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def begin_compose_model(
        ...
        :type body: ~documentintelligence.models.ComposeDocumentModelRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns DocumentModelDetails. The
    ...
    async def begin_compose_model(
        ...
        :type body: ~documentintelligence.models.ComposeDocumentModelRequest or JSON or IO[bytes]
        :return: An instance of AsyncLROPoller that returns DocumentModelDetails. The
         DocumentModelDetails is compatible with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~documentintelligence.models.DocumentModelDetails]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def authorize_model_copy(
        ...
        :type body: ~documentintelligence.models.AuthorizeCopyRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ModelCopyAuthorization. The ModelCopyAuthorization is compatible with MutableMapping
        :rtype: ~documentintelligence.models.ModelCopyAuthorization
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def authorize_model_copy(
        ...
        :type body: ~documentintelligence.models.AuthorizeCopyRequest or JSON or IO[bytes]
        :return: ModelCopyAuthorization. The ModelCopyAuthorization is compatible with MutableMapping
        :rtype: ~documentintelligence.models.ModelCopyAuthorization
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_copy_model_to(
        ...
        **kwargs: Any
        ...
        :type body: ~documentintelligence.models.ModelCopyAuthorization
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns DocumentModelDetails. The
    ...
    async def begin_copy_model_to(
        ...
        :param body: Copy to request parameters. Is one of the following types: ModelCopyAuthorization,
         JSON, IO[bytes] Required.
        :type body: ~documentintelligence.models.ModelCopyAuthorization or JSON or IO[bytes]
        :return: An instance of AsyncLROPoller that returns DocumentModelDetails. The
         DocumentModelDetails is compatible with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~documentintelligence.models.DocumentModelDetails]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def get_model(self, model_id: str, **kwargs: Any) -> _models.DocumentModelDetails:
        ...
        :rtype: ~documentintelligence.models.DocumentModelDetails
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_models(self, **kwargs: Any) -> AsyncIterable["_models.DocumentModelDetails"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~documentintelligence.models.DocumentModelDetails]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def get_resource_details(self, **kwargs: Any) -> _models.DocumentIntelligenceResourceDetails:
        ...
        :return: DocumentIntelligenceResourceDetails. The DocumentIntelligenceResourceDetails is
         compatible with MutableMapping
        :rtype: ~documentintelligence.models.DocumentIntelligenceResourceDetails
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_operation(self, operation_id: str, **kwargs: Any) -> _models.DocumentIntelligenceOperationDetails:
        ...
        :return: DocumentIntelligenceOperationDetails. The DocumentIntelligenceOperationDetails is
         compatible with MutableMapping
        :rtype: ~documentintelligence.models.DocumentIntelligenceOperationDetails
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_operations(self, **kwargs: Any) -> AsyncIterable["_models.DocumentIntelligenceOperationDetails"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~documentintelligence.models.DocumentIntelligenceOperationDetails]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def begin_build_classifier(
        ...
        :param body: Build request parameters. Required.
        :type body: ~documentintelligence.models.BuildDocumentClassifierRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~documentintelligence.models.DocumentClassifierDetails]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_build_classifier(
        ...
        :type body: ~documentintelligence.models.BuildDocumentClassifierRequest or JSON or IO[bytes]
        :return: An instance of AsyncLROPoller that returns DocumentClassifierDetails. The
         DocumentClassifierDetails is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~documentintelligence.models.DocumentClassifierDetails]
    ...
    async def authorize_classifier_copy(
        ...
        :param body: Authorize copy request parameters. Required.
        :type body: ~documentintelligence.models.AuthorizeClassifierCopyRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ClassifierCopyAuthorization. The ClassifierCopyAuthorization is compatible with
         MutableMapping
        :rtype: ~documentintelligence.models.ClassifierCopyAuthorization
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def authorize_classifier_copy(
        ...
        :type body: ~documentintelligence.models.AuthorizeClassifierCopyRequest or JSON or IO[bytes]
        :return: ClassifierCopyAuthorization. The ClassifierCopyAuthorization is compatible with
         MutableMapping
        :rtype: ~documentintelligence.models.ClassifierCopyAuthorization
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def begin_copy_classifier_to(
        ...
        **kwargs: Any
        ...
        :type classifier_id: str
        :param body: Copy to request parameters. Required.
        :type body: ~documentintelligence.models.ClassifierCopyAuthorization
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns DocumentClassifierDetails. The
    ...
    async def begin_copy_classifier_to(
        ...
        :type body: ~documentintelligence.models.ClassifierCopyAuthorization or JSON or IO[bytes]
        :return: An instance of AsyncLROPoller that returns DocumentClassifierDetails. The
         DocumentClassifierDetails is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~documentintelligence.models.DocumentClassifierDetails]
    ...
    async def get_classifier(self, classifier_id: str, **kwargs: Any) -> _models.DocumentClassifierDetails:
        ...
        :return: DocumentClassifierDetails. The DocumentClassifierDetails is compatible with
         MutableMapping
        :rtype: ~documentintelligence.models.DocumentClassifierDetails
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_classifiers(self, **kwargs: Any) -> AsyncIterable["_models.DocumentClassifierDetails"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~documentintelligence.models.DocumentClassifierDetails]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
