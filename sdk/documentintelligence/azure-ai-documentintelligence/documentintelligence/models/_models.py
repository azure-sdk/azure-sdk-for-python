...
class AnalyzeBatchDocumentsRequest(_model_base.Model):
    ...
    :vartype azure_blob_source: ~documentintelligence.models.AzureBlobContentSource
    ...
    :vartype azure_blob_file_list_source:
     ~documentintelligence.models.AzureBlobFileListContentSource
...
class AnalyzeBatchOperation(_model_base.Model):
    ...
    :vartype status: str or ~documentintelligence.models.DocumentIntelligenceOperationStatus
    ...
    :vartype error: ~documentintelligence.models.DocumentIntelligenceError
    :ivar result: Batch document analysis result.
    :vartype result: ~documentintelligence.models.AnalyzeBatchResult
    """
...
class AnalyzeBatchResult(_model_base.Model):
    ...
    :vartype details: list[~documentintelligence.models.AnalyzeBatchOperationDetail]
    """
...
class AnalyzedDocument(_model_base.Model):
    ...
    :vartype bounding_regions: list[~documentintelligence.models.BoundingRegion]
    :ivar spans: Location of the document in the reading order concatenated content. Required.
    :vartype spans: list[~documentintelligence.models.DocumentSpan]
    :ivar fields: Dictionary of named field values.
    :vartype fields: dict[str, ~documentintelligence.models.DocumentField]
...
class AnalyzeResult(_model_base.Model):
    ...
    :vartype string_index_type: str or ~documentintelligence.models.StringIndexType
    :ivar content_format: Format of the analyze result top-level content. Known values are: "text"
     and "markdown".
    :vartype content_format: str or ~documentintelligence.models.DocumentContentFormat
    ...
    :vartype pages: list[~documentintelligence.models.DocumentPage]
    :ivar paragraphs: Extracted paragraphs.
    :vartype paragraphs: list[~documentintelligence.models.DocumentParagraph]
    :ivar tables: Extracted tables.
    :vartype tables: list[~documentintelligence.models.DocumentTable]
    :ivar figures: Extracted figures.
    :vartype figures: list[~documentintelligence.models.DocumentFigure]
    :ivar sections: Extracted sections.
    :vartype sections: list[~documentintelligence.models.DocumentSection]
    :ivar key_value_pairs: Extracted key-value pairs.
    :vartype key_value_pairs: list[~documentintelligence.models.DocumentKeyValuePair]
    :ivar styles: Extracted font styles.
    :vartype styles: list[~documentintelligence.models.DocumentStyle]
    :ivar languages: Detected languages.
    :vartype languages: list[~documentintelligence.models.DocumentLanguage]
    :ivar documents: Extracted documents.
    :vartype documents: list[~documentintelligence.models.AnalyzedDocument]
    :ivar warnings: List of warnings encountered.
    :vartype warnings: list[~documentintelligence.models.DocumentIntelligenceWarning]
    """
...
class BuildDocumentClassifierRequest(_model_base.Model):
    ...
    :vartype doc_types: dict[str, ~documentintelligence.models.ClassifierDocumentTypeDetails]
...
class BuildDocumentModelRequest(_model_base.Model):
    ...
    :ivar build_mode: Custom document model build mode. Required. Known values are: "template" and
     "neural".
    :vartype build_mode: str or ~documentintelligence.models.DocumentBuildMode
...
class ClassifierDocumentTypeDetails(_model_base.Model):
    ...
    :vartype source_kind: str or ~documentintelligence.models.ContentSourceKind
...
class ComposeDocumentModelRequest(_model_base.Model):
    ...
    :vartype split: str or ~documentintelligence.models.SplitMode
    :ivar doc_types: Dictionary mapping supported docTypes to the corresponding document models.
     Required.
    :vartype doc_types: dict[str, ~documentintelligence.models.DocumentTypeDetails]
    :ivar tags: List of key-value tag attributes associated with the document model.
    :vartype tags: dict[str, str]
    """
...
class DocumentBarcode(_model_base.Model):
    ...
    :vartype kind: str or ~documentintelligence.models.DocumentBarcodeKind
    ...
    :vartype span: ~documentintelligence.models.DocumentSpan
...
class DocumentIntelligenceOperationDetails(_model_base.Model):
    ...
    :vartype kind: str or ~documentintelligence.models.OperationKind
...
class DocumentClassifierBuildOperationDetails(
    ...
    :vartype result: ~documentintelligence.models.DocumentClassifierDetails
    :ivar kind: Type of operation. Required. Build a new custom classifier model.
    :vartype kind: str or ~documentintelligence.models.DOCUMENT_CLASSIFIER_BUILD
    """
...
class DocumentClassifierCopyToOperationDetails(
    ...
    :ivar kind: Type of operation. Required. Copy an existing document classifier to potentially a
     ...
     subscription.
    :vartype kind: str or ~documentintelligence.models.DOCUMENT_CLASSIFIER_COPY_TO
    """
...
class DocumentField(_model_base.Model):
    ...
    :vartype type: str or ~documentintelligence.models.DocumentFieldType
    ...
    :ivar value_selection_mark: Selection mark value. Known values are: "selected" and
     "unselected".
    :vartype value_selection_mark: str or ~documentintelligence.models.DocumentSelectionMarkState
    :ivar value_signature: Presence of signature. Known values are: "signed" and "unsigned".
    :vartype value_signature: str or ~documentintelligence.models.DocumentSignatureType
    ...
    :vartype value_array: list[~documentintelligence.models.DocumentField]
    :ivar value_object: Dictionary of named field values.
    :vartype value_object: dict[str, ~documentintelligence.models.DocumentField]
    :ivar value_currency: Currency value.
    :vartype value_currency: ~documentintelligence.models.CurrencyValue
    :ivar value_address: Address value.
    :vartype value_address: ~documentintelligence.models.AddressValue
...
class DocumentFieldSchema(_model_base.Model):
    ...
    :vartype items_schema: ~documentintelligence.models.DocumentFieldSchema
    :ivar properties: Named sub-fields of the object field.
    :vartype properties: dict[str, ~documentintelligence.models.DocumentFieldSchema]
    """
...
class DocumentFigure(_model_base.Model):
    ...
    :vartype caption: ~documentintelligence.models.DocumentCaption
    :ivar footnotes: List of footnotes associated with the figure.
    :vartype footnotes: list[~documentintelligence.models.DocumentFootnote]
    :ivar id: Figure ID.
    :vartype id: str
    """
...
class DocumentFormula(_model_base.Model):
    ...
    :vartype kind: str or ~documentintelligence.models.DocumentFormulaKind
...
class DocumentIntelligenceError(_model_base.Model):
    ...
    :vartype details: list[~documentintelligence.models.DocumentIntelligenceError]
    :ivar innererror: An object containing more specific information than the current object about
     the error.
    :vartype innererror: ~documentintelligence.models.DocumentIntelligenceInnerError
    """
...
class DocumentIntelligenceResourceDetails(_model_base.Model):
    ...
    :vartype custom_document_models: ~documentintelligence.models.CustomDocumentModelsDetails
    """
...
class DocumentKeyValuePair(_model_base.Model):
    ...
    :vartype key: ~documentintelligence.models.DocumentKeyValueElement
    :ivar value: Field value of the key-value pair.
    :vartype value: ~documentintelligence.models.DocumentKeyValueElement
...
class DocumentModelBuildOperationDetails(DocumentIntelligenceOperationDetails, discriminator="documentModelBuild"):
    ...
    :vartype error: ~documentintelligence.models.DocumentIntelligenceError
    :ivar result: Operation result upon success.
    :vartype result: ~documentintelligence.models.DocumentModelDetails
    :ivar kind: Type of operation. Required. Build a new custom document model.
    :vartype kind: str or ~documentintelligence.models.DOCUMENT_MODEL_BUILD
    """
...
class DocumentModelComposeOperationDetails(DocumentIntelligenceOperationDetails, discriminator="documentModelCompose"):
    ...
    :ivar kind: Type of operation. Required. Compose a new custom document model from existing
     models.
    :vartype kind: str or ~documentintelligence.models.DOCUMENT_MODEL_COMPOSE
    """
...
class DocumentModelCopyToOperationDetails(DocumentIntelligenceOperationDetails, discriminator="documentModelCopyTo"):
    ...
    :ivar kind: Type of operation. Required. Copy an existing document model to potentially a
     different resource, region, or
     subscription.
    :vartype kind: str or ~documentintelligence.models.DOCUMENT_MODEL_COPY_TO
    """
...
class DocumentPage(_model_base.Model):
    ...
    :vartype unit: str or ~documentintelligence.models.LengthUnit
    ...
    :vartype words: list[~documentintelligence.models.DocumentWord]
    :ivar selection_marks: Extracted selection marks from the page.
    :vartype selection_marks: list[~documentintelligence.models.DocumentSelectionMark]
    :ivar lines: Extracted lines from the page, potentially containing both textual and visual
     elements.
    :vartype lines: list[~documentintelligence.models.DocumentLine]
    :ivar barcodes: Extracted barcodes from the page.
    :vartype barcodes: list[~documentintelligence.models.DocumentBarcode]
    :ivar formulas: Extracted formulas from the page.
    :vartype formulas: list[~documentintelligence.models.DocumentFormula]
    """
...
class DocumentParagraph(_model_base.Model):
    ...
    :vartype role: str or ~documentintelligence.models.ParagraphRole
...
class DocumentSelectionMark(_model_base.Model):
    ...
    :ivar state: State of the selection mark. Required. Known values are: "selected" and
     "unselected".
    :vartype state: str or ~documentintelligence.models.DocumentSelectionMarkState
...
class DocumentStyle(_model_base.Model):
    ...
    :vartype font_style: str or ~documentintelligence.models.DocumentFontStyle
    :ivar font_weight: Font weight. Known values are: "normal" and "bold".
    :vartype font_weight: str or ~documentintelligence.models.DocumentFontWeight
...
class DocumentTable(_model_base.Model):
    ...
    :vartype cells: list[~documentintelligence.models.DocumentTableCell]
...
class DocumentTableCell(_model_base.Model):
    ...
    :vartype kind: str or ~documentintelligence.models.DocumentTableCellKind
...
class DocumentTypeDetails(_model_base.Model):
    ...
    :ivar field_schema: Description of the document semantic schema using a JSON Schema style
     syntax.
    :vartype field_schema: dict[str, ~documentintelligence.models.DocumentFieldSchema]
    ...
    :vartype features: list[str or ~documentintelligence.models.DocumentAnalysisFeature]
