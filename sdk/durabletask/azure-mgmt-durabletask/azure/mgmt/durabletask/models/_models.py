...
class SchedulerProperties(_model_base.Model):
    ...
    ip_allowlist: List[str] = rest_field(name="ipAllowlist")
    """IP allow list for durable task scheduler. Values can be IPv4, IPv6 or CIDR. Required."""
    sku: "_models.SchedulerSku" = rest_field()
...
class SchedulerSku(_model_base.Model):
    ...
    redundancy_state: Optional[Union[str, "_models.RedundancyState"]] = rest_field(name="redundancyState")
    ...
    def __init__(
        ...
        *,
        ...
        redundancy_state: Optional[Union[str, "_models.RedundancyState"]] = None,
    ) -> None: ...
