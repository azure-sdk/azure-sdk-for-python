...
class DurableTaskMgmtClient:
    ...
    :vartype operations: microsoft.durabletask.aio.operations.Operations
    :ivar schedulers: SchedulersOperations operations
    :vartype schedulers: microsoft.durabletask.aio.operations.SchedulersOperations
    :ivar task_hubs: TaskHubsOperations operations
    :vartype task_hubs: microsoft.durabletask.aio.operations.TaskHubsOperations
