...
class Operations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~microsoft.durabletask.aio.DurableTaskMgmtClient`'s
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.Operation"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~microsoft.durabletask.models.Operation]
...
class SchedulersOperations:
    ...
    async def get(self, resource_group_name: str, scheduler_name: str, **kwargs: Any) -> _models.Scheduler:
        ...
        :rtype: ~microsoft.durabletask.models.Scheduler
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~microsoft.durabletask.models.Scheduler
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns Scheduler. The Scheduler is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~microsoft.durabletask.models.Scheduler]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is one of the following types: Scheduler, JSON,
         IO[bytes] Required.
        :type resource: ~microsoft.durabletask.models.Scheduler or JSON or IO[bytes]
        :return: An instance of AsyncLROPoller that returns Scheduler. The Scheduler is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~microsoft.durabletask.models.Scheduler]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~microsoft.durabletask.models.SchedulerUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns Scheduler. The Scheduler is compatible with
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~microsoft.durabletask.models.SchedulerUpdate or JSON or IO[bytes]
        :return: An instance of AsyncLROPoller that returns Scheduler. The Scheduler is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~microsoft.durabletask.models.Scheduler]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.Scheduler"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~microsoft.durabletask.models.Scheduler]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class TaskHubsOperations:
    ...
    async def get(
        ...
        :rtype: ~microsoft.durabletask.models.TaskHub
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type task_hub_name: str
        :param resource: Resource create parameters. Required.
        :type resource: ~microsoft.durabletask.models.TaskHub
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns TaskHub. The TaskHub is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~microsoft.durabletask.models.TaskHub]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is one of the following types: TaskHub, JSON,
         IO[bytes] Required.
        :type resource: ~microsoft.durabletask.models.TaskHub or JSON or IO[bytes]
        :return: An instance of AsyncLROPoller that returns TaskHub. The TaskHub is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~microsoft.durabletask.models.TaskHub]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_by_scheduler(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~microsoft.durabletask.models.TaskHub]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
