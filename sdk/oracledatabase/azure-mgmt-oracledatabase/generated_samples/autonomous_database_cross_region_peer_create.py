...
# USAGE
    python autonomous_database_cross_region_peer_create.py
...
# x-ms-original-file: specification/oracle/resource-manager/Oracle.Database/preview/2024-10-01-preview/examples/autonomousDatabaseCrossRegionPeer_create.json
