...
class TestOracleDatabaseMgmtOracleSubscriptionsOperations(AzureMgmtRecordedTestCase):
    ...
    def test_begin_delete(self, resource_group):
        response = self.client.oracle_subscriptions.begin_delete(
            api_version="2024-06-01",
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_begin_add_azure_subscriptions(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_begin_list_activation_links(self, resource_group):
        response = self.client.oracle_subscriptions.begin_list_activation_links(
            api_version="2024-06-01",
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_begin_list_cloud_account_details(self, resource_group):
        response = self.client.oracle_subscriptions.begin_list_cloud_account_details(
            api_version="2024-06-01",
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_begin_list_saas_subscription_details(self, resource_group):
        response = self.client.oracle_subscriptions.begin_list_saas_subscription_details(
            api_version="2024-06-01",
        ).result()  # call '.result()' to poll until service return final result
