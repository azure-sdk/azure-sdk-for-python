...
from ...operations._oracle_subscriptions_operations import (
    build_add_azure_subscriptions_request,
    build_create_or_update_request,
    build_delete_request,
    build_get_request,
    build_list_activation_links_request,
...
class OracleSubscriptionsOperations:
    ...
    async def _add_azure_subscriptions_initial(  # pylint: disable=inconsistent-return-statements
    ...
    async def begin_add_azure_subscriptions(
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._add_azure_subscriptions_initial(  # type: ignore
                body=body,
                api_version=api_version,
                content_type=content_type,
                cls=lambda x, y, z: x,
    ...
    async def _list_activation_links_initial(self, **kwargs: Any) -> Optional[_models.ActivationLinks]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    async def begin_list_activation_links(self, **kwargs: Any) -> AsyncLROPoller[_models.ActivationLinks]:
        ...
        :return: An instance of AsyncLROPoller that returns either ActivationLinks or the result of
         cls(response)
