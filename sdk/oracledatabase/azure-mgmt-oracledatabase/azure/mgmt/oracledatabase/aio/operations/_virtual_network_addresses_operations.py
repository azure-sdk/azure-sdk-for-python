...
from ...operations._virtual_network_addresses_operations import (
...
class VirtualNetworkAddressesOperations:
    ...
    def list_by_parent(
        ...
        :return: An iterator like instance of either VirtualNetworkAddress or the result of
         cls(response)
        :rtype:
        ...
        cls: ClsType[_models.VirtualNetworkAddressListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("VirtualNetworkAddressListResult", pipeline_response)
    ...
    async def get(
        ...
        :return: VirtualNetworkAddress or the result of cls(response)
        ...
        deserialized = self._deserialize("VirtualNetworkAddress", pipeline_response.http_response)
    ...
    async def _create_or_update_initial(
        ...
        resource: Union[_models.VirtualNetworkAddress, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "VirtualNetworkAddress")
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either VirtualNetworkAddress or the result
         of cls(response)
        :rtype:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.oracledatabase.models.VirtualNetworkAddress or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either VirtualNetworkAddress or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.oracledatabase.models.VirtualNetworkAddress]
