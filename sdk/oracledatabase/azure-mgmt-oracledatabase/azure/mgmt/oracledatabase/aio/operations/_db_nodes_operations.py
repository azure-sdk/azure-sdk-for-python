...
from ...operations._db_nodes_operations import build_action_request, build_get_request, build_list_by_parent_request
...
class DbNodesOperations:
    ...
    async def get(
        ...
        deserialized = self._deserialize("DbNode", pipeline_response.http_response)
