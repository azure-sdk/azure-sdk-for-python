...
from ...operations._exascale_db_storage_vaults_operations import (
...
class ExascaleDbStorageVaultsOperations:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either ExascaleDbStorageVault or the result
         of cls(response)
        :rtype:
