...
class CloudExadataInfrastructuresOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.CloudExadataInfrastructure"]:
    ...
    ) -> AsyncIterable["_models.CloudExadataInfrastructure"]:
...
class VirtualNetworkAddressesOperations:
    ...
    def list_by_parent(
        self, resource_group_name: str, cloudvmclustername: str, **kwargs: Any
    ) -> AsyncIterable["_models.VirtualNetworkAddress"]:
...
class SystemVersionsOperations:
    ...
    @distributed_trace
    def list_by_location(self, location: str, **kwargs: Any) -> AsyncIterable["_models.SystemVersion"]:
...
class OracleSubscriptionsOperations:
    ...
    @distributed_trace_async
    async def begin_list_cloud_account_details(self, **kwargs: Any) -> AsyncLROPoller[None]:
    ...
    @distributed_trace_async
    async def begin_list_saas_subscription_details(self, **kwargs: Any) -> AsyncLROPoller[None]:
    ...
    @distributed_trace_async
    async def begin_list_activation_links(self, **kwargs: Any) -> AsyncLROPoller[None]:
...
class GiVersionsOperations:
    ...
    def list_by_location(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.GiVersion"]:
...
class GiMinorVersionsOperations:
    ...
    def list_by_parent(
        ...
        *,
        ...
        zone: Optional[str] = None,
        **kwargs: Any
    ) -> AsyncIterable["_models.GiMinorVersion"]:
...
class DbSystemShapesOperations:
    ...
    ) -> AsyncIterable["_models.DbSystemShape"]:
...
class DnsPrivateZonesOperations:
    ...
    @distributed_trace
    def list_by_location(self, location: str, **kwargs: Any) -> AsyncIterable["_models.DnsPrivateZone"]:
...
class FlexComponentsOperations:
    ...
    ) -> AsyncIterable["_models.FlexComponent"]:
...
class AutonomousDatabaseBackupsOperations:
    ...
    async def _update_initial(
        ...
        autonomousdatabasename: str,
        adbbackupid: str,
        properties: Union[_models.AutonomousDatabaseBackup, JSON, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_update(
        ...
        autonomousdatabasename: str,
        adbbackupid: str,
        properties: _models.AutonomousDatabaseBackup,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.AutonomousDatabaseBackup]:
        ...
        :type adbbackupid: str
        :param properties: The resource properties to be updated. Required.
        :type properties: ~azure.mgmt.oracledatabase.models.AutonomousDatabaseBackup
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns AutonomousDatabaseBackup. The
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param properties: The resource properties to be updated. Is one of the following types:
         AutonomousDatabaseBackup, JSON, IO[bytes] Required.
        :type properties: ~azure.mgmt.oracledatabase.models.AutonomousDatabaseBackup or JSON or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns AutonomousDatabaseBackup. The
         AutonomousDatabaseBackup is compatible with MutableMapping
        :rtype:
...
class AutonomousDatabaseCharacterSetsOperations:  # pylint: disable=name-too-long
    ...
    @distributed_trace
    def list_by_location(self, location: str, **kwargs: Any) -> AsyncIterable["_models.AutonomousDatabaseCharacterSet"]:
...
class AutonomousDatabaseNationalCharacterSetsOperations:  # pylint: disable=name-too-long
    ...
    ) -> AsyncIterable["_models.AutonomousDatabaseNationalCharacterSet"]:
...
class ExadbVmClustersOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.ExadbVmCluster"]:
    ...
    def list_by_resource_group(
        self, resource_group_name: str, **kwargs: Any
    ) -> AsyncIterable["_models.ExadbVmCluster"]:
...
class ExascaleDbNodesOperations:
    ...
    def list_by_parent(
        self, resource_group_name: str, exadb_vm_cluster_name: str, **kwargs: Any
    ) -> AsyncIterable["_models.ExascaleDbNode"]:
...
class ExascaleDbStorageVaultsOperations:
    ...
    def list_by_resource_group(
        self, resource_group_name: str, **kwargs: Any
    ) -> AsyncIterable["_models.ExascaleDbStorageVault"]:
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.ExascaleDbStorageVault"]:
