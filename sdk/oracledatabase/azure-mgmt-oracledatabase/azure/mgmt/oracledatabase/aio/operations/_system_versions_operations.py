...
from ...operations._system_versions_operations import build_get_request, build_list_by_location_request
...
class SystemVersionsOperations:
    ...
    async def get(self, location: str, systemversionname: str, **kwargs: Any) -> _models.SystemVersion:
        ...
        deserialized = self._deserialize("SystemVersion", pipeline_response.http_response)
