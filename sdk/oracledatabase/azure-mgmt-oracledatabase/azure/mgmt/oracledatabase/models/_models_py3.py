...
class AutonomousDatabaseBaseProperties(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar peer_db_ids: The list of Azure IDs of standby databases located in Autonomous Data Guard
     remote regions that are associated with the source database. Note that for Autonomous Database
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        self.time_disaster_recovery_role_changed = None
        self.remote_disaster_recovery_configuration = None
...
class PeerDbDetails(_serialization.Model):
    ...
    :ivar peer_db_id: The Azure ID of the Disaster Recovery peer database, which is located in a
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword peer_db_id: The Azure ID of the Disaster Recovery peer database, which is located in a
         different region from the current peer database.
        :paramtype peer_db_id: str
