...
class AddRemoveDbNode(_model_base.Model):
...
class AllConnectionStringType(_model_base.Model):
...
class ApexDetailsType(_model_base.Model):
...
class AutonomousDatabaseBackupProperties(_model_base.Model):
...
class AutonomousDatabaseBaseProperties(_model_base.Model):
...
class AutonomousDatabaseCharacterSetProperties(_model_base.Model):
...
class AutonomousDatabaseNationalCharacterSetProperties(_model_base.Model):  # pylint: disable=name-too-long
...
class AutonomousDatabaseStandbySummary(_model_base.Model):
...
class AutonomousDatabaseUpdate(_model_base.Model):
...
class AutonomousDatabaseUpdateProperties(_model_base.Model):
...
class AutonomousDatabaseWalletFile(_model_base.Model):
...
class AutonomousDbVersionProperties(_model_base.Model):
...
class AzureSubscriptions(_model_base.Model):
...
class CloudExadataInfrastructureProperties(_model_base.Model):
...
class CloudExadataInfrastructureUpdate(_model_base.Model):
...
class CloudExadataInfrastructureUpdateProperties(_model_base.Model):  # pylint: disable=name-too-long
...
class CloudVmClusterProperties(_model_base.Model):
...
class CloudVmClusterUpdate(_model_base.Model):
...
class CloudVmClusterUpdateProperties(_model_base.Model):
...
class ConnectionStringType(_model_base.Model):
...
class ConnectionUrlType(_model_base.Model):
    """The URLs for accessing Oracle Application Express (APEX) and SQL Developer Web with a browser
    from a Compute instance within your VCN or that has a direct connection to your VCN.
...
class CustomerContact(_model_base.Model):
...
class DataCollectionOptions(_model_base.Model):
...
class DayOfWeek(_model_base.Model):
...
class DbActionResponse(_model_base.Model):
...
class DbIormConfig(_model_base.Model):
...
class DbNodeAction(_model_base.Model):
...
class DbNodeDetails(_model_base.Model):
...
class DbNodeProperties(_model_base.Model):
...
class DbServerPatchingDetails(_model_base.Model):
...
class DbServerProperties(_model_base.Model):
...
class DbSystemShapeProperties(_model_base.Model):
...
class DefinedFileSystemConfiguration(_model_base.Model):
...
class DisasterRecoveryConfigurationDetails(_model_base.Model):
...
class DnsPrivateViewProperties(_model_base.Model):
...
class DnsPrivateZoneProperties(_model_base.Model):
...
class EstimatedPatchingTime(_model_base.Model):
    """The estimated total time required in minutes for all patching operations (database server,
    storage server, and network switch patching).
...
class ExadataIormConfig(_model_base.Model):
...
class ExadbVmClusterProperties(_model_base.Model):
...
class ExadbVmClusterStorageDetails(_model_base.Model):
...
class ExadbVmClusterUpdate(_model_base.Model):
...
class ExadbVmClusterUpdateProperties(_model_base.Model):
...
class ExascaleDbNodeProperties(_model_base.Model):
    """The properties of DbNodeResource.
...
class ExascaleDbStorageDetails(_model_base.Model):
...
class ExascaleDbStorageInputDetails(_model_base.Model):
...
class ExascaleDbStorageVaultProperties(_model_base.Model):
...
class ExascaleDbStorageVaultTagsUpdate(_model_base.Model):
...
class FileSystemConfigurationDetails(_model_base.Model):
...
class FlexComponentProperties(_model_base.Model):
...
class GenerateAutonomousDatabaseWalletDetails(_model_base.Model):
...
class GiMinorVersionProperties(_model_base.Model):
...
class GiVersionProperties(_model_base.Model):
...
class LongTermBackUpScheduleDetails(_model_base.Model):
    """Details for the long-term backup schedule.
...
class MaintenanceWindow(_model_base.Model):
...
class NsgCidr(_model_base.Model):
...
class OracleSubscriptionProperties(_model_base.Model):
...
class OracleSubscriptionUpdate(_model_base.Model):
...
class OracleSubscriptionUpdateProperties(_model_base.Model):
...
class PeerDbDetails(_model_base.Model):
    """PeerDb Details.
...
class PlanUpdate(_model_base.Model):
...
class PortRange(_model_base.Model):
...
class PrivateIpAddressesFilter(_model_base.Model):
...
class PrivateIpAddressProperties(_model_base.Model):
...
class ProfileType(_model_base.Model):
    """The connection string profile to allow clients to group, filter and select connection string
    values based on structured metadata.
...
class RemoveVirtualMachineFromExadbVmClusterDetails(_model_base.Model):  # pylint: disable=name-too-long
...
class RestoreAutonomousDatabaseDetails(_model_base.Model):
...
class ScheduledOperationsType(_model_base.Model):
    """The list of scheduled operations.
...
class SystemVersionProperties(_model_base.Model):
...
class VirtualNetworkAddressProperties(_model_base.Model):
