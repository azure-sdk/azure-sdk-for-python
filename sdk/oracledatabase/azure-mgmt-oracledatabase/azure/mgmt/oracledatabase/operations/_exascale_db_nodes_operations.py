...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "exadbVmClusterName": _SERIALIZER.url("exadb_vm_cluster_name", exadb_vm_cluster_name, "str", pattern=r".*"),
        "exascaleDbNodeName": _SERIALIZER.url("exascale_db_node_name", exascale_db_node_name, "str", pattern=r".*"),
    }
...
class ExascaleDbNodesOperations:
    ...
    def list_by_parent(
    ...
    ) -> Iterable["_models.ExascaleDbNode"]:
        ...
        :return: An iterator like instance of either ExascaleDbNode or the result of cls(response)
        ...
        cls: ClsType[_models.ExascaleDbNodeListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("ExascaleDbNodeListResult", pipeline_response)
    ...
    def get(
        ...
        :return: ExascaleDbNode or the result of cls(response)
        ...
        deserialized = self._deserialize("ExascaleDbNode", pipeline_response.http_response)
    ...
    def begin_action(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either DbActionResponse or the result of
         cls(response)
    ...
    def begin_action(
        ...
        **kwargs: Any
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("DbActionResponse", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
