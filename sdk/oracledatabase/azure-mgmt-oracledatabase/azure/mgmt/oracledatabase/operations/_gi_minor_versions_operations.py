...
def build_list_by_parent_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "giversionname": _SERIALIZER.url("giversionname", giversionname, "str", pattern=r".*"),
    }
...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "location": _SERIALIZER.url("location", location, "str", min_length=1),
        "giversionname": _SERIALIZER.url("giversionname", giversionname, "str", pattern=r".*"),
        "giMinorVersionName": _SERIALIZER.url(
            "gi_minor_version_name", gi_minor_version_name, "str", pattern=r"^[a-zA-Z0-9-]{3,24}$"
        ),
    }
...
class GiMinorVersionsOperations:
    ...
    def list_by_parent(
        ...
        zone: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.GiMinorVersion"]:
        ...
        :param shape_family: If provided, filters the results to the set of database versions which are
         supported for the given shape family. Known values are: "EXADATA" and "EXADB_XS". Default value
         is None.
        :type shape_family: str or ~azure.mgmt.oracledatabase.models.ShapeFamily
        :param zone: Filters the result for the given Azure Availability Zone. Default value is None.
        :type zone: str
        :return: An iterator like instance of either GiMinorVersion or the result of cls(response)
        ...
        cls: ClsType[_models.GiMinorVersionListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("GiMinorVersionListResult", pipeline_response)
    ...
    def get(
        ...
        :return: GiMinorVersion or the result of cls(response)
        ...
        deserialized = self._deserialize("GiMinorVersion", pipeline_response.http_response)
