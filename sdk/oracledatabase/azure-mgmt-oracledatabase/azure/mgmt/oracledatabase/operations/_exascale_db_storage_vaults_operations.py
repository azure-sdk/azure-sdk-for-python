...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Oracle.Database/exascaleDbStorageVaults"
    )
...
def build_list_by_resource_group_request(resource_group_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Oracle.Database/exascaleDbStorageVaults",
    )
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "exascaleDbStorageVaultName": _SERIALIZER.url(
            "exascale_db_storage_vault_name", exascale_db_storage_vault_name, "str", pattern=r".*"
        ),
    }
...
class ExascaleDbStorageVaultsOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.ExascaleDbStorageVault"]:
        """List ExascaleDbStorageVault resources by subscription ID.

        :return: An iterator like instance of either ExascaleDbStorageVault or the result of
         cls(response)
        ...
        cls: ClsType[_models.ExascaleDbStorageVaultListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("ExascaleDbStorageVaultListResult", pipeline_response)
    ...
    ) -> Iterable["_models.ExascaleDbStorageVault"]:
    ...
    def get(
        ...
        :return: ExascaleDbStorageVault or the result of cls(response)
        ...
        deserialized = self._deserialize("ExascaleDbStorageVault", pipeline_response.http_response)
    ...
    def _create_initial(
        ...
        resource: Union[_models.ExascaleDbStorageVault, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "ExascaleDbStorageVault")
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either ExascaleDbStorageVault or the result of
         cls(response)
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.oracledatabase.models.ExascaleDbStorageVault or IO[bytes]
        :return: An instance of LROPoller that returns either ExascaleDbStorageVault or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.oracledatabase.models.ExascaleDbStorageVault]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        exascale_db_storage_vault_name: str,
        properties: Union[_models.ExascaleDbStorageVaultTagsUpdate, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "ExascaleDbStorageVaultTagsUpdate")
