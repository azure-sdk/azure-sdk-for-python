...
def build_list_by_parent_request(
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Oracle.Database/locations/{location}/flexComponents"
    )
...
def build_get_request(location: str, flex_component_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "location": _SERIALIZER.url("location", location, "str", min_length=1),
        "flexComponentName": _SERIALIZER.url(
            "flex_component_name", flex_component_name, "str", pattern=r"^[a-zA-Z0-9-]{3,24}$"
        ),
    }
...
class FlexComponentsOperations:
    ...
    def list_by_parent(
    ...
    ) -> Iterable["_models.FlexComponent"]:
        ...
        :return: An iterator like instance of either FlexComponent or the result of cls(response)
        ...
        cls: ClsType[_models.FlexComponentListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("FlexComponentListResult", pipeline_response)
    ...
    def get(self, location: str, flex_component_name: str, **kwargs: Any) -> _models.FlexComponent:
        ...
        :return: FlexComponent or the result of cls(response)
        ...
        deserialized = self._deserialize("FlexComponent", pipeline_response.http_response)
