...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Oracle.Database/cloudVmClusters")
...
def build_list_private_ip_addresses_request(
    resource_group_name: str, cloudvmclustername: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class CloudVmClustersOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.CloudVmCluster"]:
        """List CloudVmCluster resources by subscription ID.

        :return: An iterator like instance of either CloudVmCluster or the result of cls(response)
        ...
        cls: ClsType[_models.CloudVmClusterListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("CloudVmClusterListResult", pipeline_response)
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.CloudVmCluster"]:
    ...
    def get(self, resource_group_name: str, cloudvmclustername: str, **kwargs: Any) -> _models.CloudVmCluster:
        ...
        :return: CloudVmCluster or the result of cls(response)
        ...
        deserialized = self._deserialize("CloudVmCluster", pipeline_response)
    ...
    def _create_or_update_initial(
        ...
        resource: Union[_models.CloudVmCluster, IO[bytes]],
        **kwargs: Any
    ) -> _models.CloudVmCluster:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "CloudVmCluster")
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either CloudVmCluster or the result of
         cls(response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a CloudVmCluster type or a IO[bytes]
         type. Required.
        :type resource: ~azure.mgmt.oracledatabase.models.CloudVmCluster or IO[bytes]
        :return: An instance of LROPoller that returns either CloudVmCluster or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.oracledatabase.models.CloudVmCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        cloudvmclustername: str,
        properties: Union[_models.CloudVmClusterUpdate, IO[bytes]],
        **kwargs: Any
    ) -> Optional[_models.CloudVmCluster]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.CloudVmCluster]] = kwargs.pop("cls", None)
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "CloudVmClusterUpdate")
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.oracledatabase.models.CloudVmClusterUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either CloudVmCluster or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.oracledatabase.models.CloudVmCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _add_vms_initial(
        ...
        resource_group_name: str,
        cloudvmclustername: str,
        body: Union[_models.AddRemoveDbNode, IO[bytes]],
        **kwargs: Any
    ) -> Optional[_models.CloudVmCluster]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "AddRemoveDbNode")

        _request = build_add_vms_request(
            resource_group_name=resource_group_name,
            cloudvmclustername=cloudvmclustername,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def begin_add_vms(
        ...
        **kwargs: Any
        ...
        :param body: The content of the action request. Is either a AddRemoveDbNode type or a IO[bytes]
         type. Required.
        :type body: ~azure.mgmt.oracledatabase.models.AddRemoveDbNode or IO[bytes]
        :return: An instance of LROPoller that returns either CloudVmCluster or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.oracledatabase.models.CloudVmCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_private_ip_addresses(
        ...
        **kwargs: Any
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: list of PrivateIpAddressProperties or the result of cls(response)
    ...
    def list_private_ip_addresses(
        ...
        resource_group_name: str,
        cloudvmclustername: str,
        body: Union[_models.PrivateIpAddressesFilter, IO[bytes]],
        **kwargs: Any
    ) -> List[_models.PrivateIpAddressProperties]:
        """List Private IP Addresses by the provided filter.
        ...
        :type body: ~azure.mgmt.oracledatabase.models.PrivateIpAddressesFilter or IO[bytes]
        :return: list of PrivateIpAddressProperties or the result of cls(response)
        :rtype: list[~azure.mgmt.oracledatabase.models.PrivateIpAddressProperties]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "PrivateIpAddressesFilter")

        _request = build_list_private_ip_addresses_request(
            resource_group_name=resource_group_name,
            cloudvmclustername=cloudvmclustername,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
        ...
        deserialized = self._deserialize("[PrivateIpAddressProperties]", pipeline_response)
    ...
    def _remove_vms_initial(
        ...
        **kwargs: Any
        ...
        _request = build_remove_vms_request(
            resource_group_name=resource_group_name,
            cloudvmclustername=cloudvmclustername,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
