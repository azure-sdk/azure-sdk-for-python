...
class CloudVmClustersOperations:
    ...
    def get(self, resource_group_name: str, cloudvmclustername: str, **kwargs: Any) -> _models.CloudVmCluster:
        ...
        deserialized = self._deserialize("CloudVmCluster", pipeline_response.http_response)
    ...
    def list_private_ip_addresses(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("[PrivateIpAddressProperties]", pipeline_response.http_response)
