...
def build_list_by_location_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Oracle.Database/locations/{location}/giVersions"
    )
...
def build_get_request(location: str, giversionname: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class GiVersionsOperations:
    ...
    def list_by_location(
        ...
        **kwargs: Any
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("GiVersionListResult", pipeline_response)
    ...
    def get(self, location: str, giversionname: str, **kwargs: Any) -> _models.GiVersion:
        ...
        :return: GiVersion or the result of cls(response)
