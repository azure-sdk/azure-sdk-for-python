...
class OracleSubscriptionsOperations:
    ...
    def get(self, **kwargs: Any) -> _models.OracleSubscription:
        ...
        deserialized = self._deserialize("OracleSubscription", pipeline_response.http_response)
    ...
    def begin_list_activation_links(self, **kwargs: Any) -> LROPoller[_models.ActivationLinks]:
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("ActivationLinks", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
    ...
    def begin_list_cloud_account_details(self, **kwargs: Any) -> LROPoller[_models.CloudAccountDetails]:
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("CloudAccountDetails", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
    ...
    def begin_list_saas_subscription_details(self, **kwargs: Any) -> LROPoller[_models.SaasSubscriptionDetails]:
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("SaasSubscriptionDetails", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
