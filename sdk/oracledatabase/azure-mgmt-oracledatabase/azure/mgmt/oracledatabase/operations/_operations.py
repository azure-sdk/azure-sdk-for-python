...
class OracleSubscriptionsOperations:
    ...
    @distributed_trace
    def begin_list_cloud_account_details(self, **kwargs: Any) -> LROPoller[None]:
    ...
    @distributed_trace
    def begin_list_saas_subscription_details(self, **kwargs: Any) -> LROPoller[None]:
    ...
    @distributed_trace
    def begin_list_activation_links(self, **kwargs: Any) -> LROPoller[None]:
