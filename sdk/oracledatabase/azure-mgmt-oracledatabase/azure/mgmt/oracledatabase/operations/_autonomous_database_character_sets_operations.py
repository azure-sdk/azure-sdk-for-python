...
def build_get_request(location: str, adbscharsetname: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "location": _SERIALIZER.url("location", location, "str", min_length=1),
        "adbscharsetname": _SERIALIZER.url("adbscharsetname", adbscharsetname, "str", pattern=r".*"),
    }
...
class AutonomousDatabaseCharacterSetsOperations:  # pylint: disable=name-too-long
    ...
    @distributed_trace
    def list_by_location(self, location: str, **kwargs: Any) -> Iterable["_models.AutonomousDatabaseCharacterSet"]:
        """List AutonomousDatabaseCharacterSet resources by SubscriptionLocationResource.

        :param location: The name of the Azure region. Required.
        :type location: str
        :return: An iterator like instance of either AutonomousDatabaseCharacterSet or the result of
         cls(response)
        :rtype:
        ...
        cls: ClsType[_models.AutonomousDatabaseCharacterSetListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("AutonomousDatabaseCharacterSetListResult", pipeline_response)
    ...
    def get(self, location: str, adbscharsetname: str, **kwargs: Any) -> _models.AutonomousDatabaseCharacterSet:
        ...
        :return: AutonomousDatabaseCharacterSet or the result of cls(response)
        ...
        deserialized = self._deserialize("AutonomousDatabaseCharacterSet", pipeline_response.http_response)
