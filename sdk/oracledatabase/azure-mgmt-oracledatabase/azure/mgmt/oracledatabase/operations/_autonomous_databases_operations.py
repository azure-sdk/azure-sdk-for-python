...
def build_change_disaster_recovery_configuration_request(  # pylint: disable=name-too-long
    resource_group_name: str, autonomousdatabasename: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class AutonomousDatabasesOperations:
    ...
    def get(self, resource_group_name: str, autonomousdatabasename: str, **kwargs: Any) -> _models.AutonomousDatabase:
        ...
        deserialized = self._deserialize("AutonomousDatabase", pipeline_response.http_response)
    ...
    def _change_disaster_recovery_configuration_initial(  # pylint: disable=name-too-long
        ...
        resource_group_name: str,
        autonomousdatabasename: str,
        body: Union[_models.DisasterRecoveryConfigurationDetails, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "DisasterRecoveryConfigurationDetails")

        _request = build_change_disaster_recovery_configuration_request(
            resource_group_name=resource_group_name,
            autonomousdatabasename=autonomousdatabasename,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def begin_change_disaster_recovery_configuration(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.oracledatabase.models.DisasterRecoveryConfigurationDetails or IO[bytes]
        :return: An instance of LROPoller that returns either AutonomousDatabase or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.oracledatabase.models.AutonomousDatabase]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def generate_wallet(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("AutonomousDatabaseWalletFile", pipeline_response.http_response)
