...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Oracle.Database/exadbVmClusters")
...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "exadbVmClusterName": _SERIALIZER.url("exadb_vm_cluster_name", exadb_vm_cluster_name, "str", pattern=r".*"),
    }
...
class ExadbVmClustersOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.ExadbVmCluster"]:
        """List ExadbVmCluster resources by subscription ID.

        :return: An iterator like instance of either ExadbVmCluster or the result of cls(response)
        ...
        cls: ClsType[_models.ExadbVmClusterListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("ExadbVmClusterListResult", pipeline_response)
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.ExadbVmCluster"]:
    ...
    def get(self, resource_group_name: str, exadb_vm_cluster_name: str, **kwargs: Any) -> _models.ExadbVmCluster:
        ...
        :return: ExadbVmCluster or the result of cls(response)
        ...
        deserialized = self._deserialize("ExadbVmCluster", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        resource: Union[_models.ExadbVmCluster, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "ExadbVmCluster")
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either ExadbVmCluster or the result of
         cls(response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a ExadbVmCluster type or a IO[bytes]
         type. Required.
        :type resource: ~azure.mgmt.oracledatabase.models.ExadbVmCluster or IO[bytes]
        :return: An instance of LROPoller that returns either ExadbVmCluster or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.oracledatabase.models.ExadbVmCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        exadb_vm_cluster_name: str,
        properties: Union[_models.ExadbVmClusterUpdate, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "ExadbVmClusterUpdate")
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.oracledatabase.models.ExadbVmClusterUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either ExadbVmCluster or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.oracledatabase.models.ExadbVmCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _remove_vms_initial(
        ...
        resource_group_name: str,
        exadb_vm_cluster_name: str,
        body: Union[_models.RemoveVirtualMachineFromExadbVmClusterDetails, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "RemoveVirtualMachineFromExadbVmClusterDetails")
