...
def build_list_by_cloud_exadata_infrastructure_request(  # pylint: disable=name-too-long
...
class DbServersOperations:
    ...
    def get(
        ...
        deserialized = self._deserialize("DbServer", pipeline_response.http_response)
