...
class AzureLargeStorageInstancesOperations:
    ...
    async def create(
        ...
        resource_group_name: str,
        azure_large_storage_instance_name: str,
        request_body_parameters: _models.AzureLargeStorageInstance,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.AzureLargeStorageInstance:
        ...
        :type request_body_parameters: ~azure.mgmt.azurelargeinstance.models.AzureLargeStorageInstance
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def create(
        ...
        resource_group_name: str,
        azure_large_storage_instance_name: str,
        request_body_parameters: Union[_models.AzureLargeStorageInstance, IO],
        **kwargs: Any
    ) -> _models.AzureLargeStorageInstance:
        """Create an azure large storage resource.
        ...
        :param request_body_parameters: request body for put call. Is either a
         AzureLargeStorageInstance type or a IO type. Required.
        :type request_body_parameters: ~azure.mgmt.azurelargeinstance.models.AzureLargeStorageInstance
         or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        ...
        if isinstance(request_body_parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(request_body_parameters, "AzureLargeStorageInstance")
