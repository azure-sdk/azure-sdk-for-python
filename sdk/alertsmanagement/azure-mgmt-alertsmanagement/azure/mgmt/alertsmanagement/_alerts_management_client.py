...
class AlertsManagementClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :ivar cross: CROSSOperations operations
    :vartype cross: azure.mgmt.alertsmanagement.operations.CROSSOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.cross = CROSSOperations(self._client, self._config, self._serialize, self._deserialize)
