...
class PreviewAlertRuleRequest(_serialization.Model):
    ...
    :ivar rule_type: The query parameter that specifies rule type to be previewed. Required.
    :vartype rule_type: str
    :ivar lookback_period: The query parameter that specifies the lookback of the preview.
     Required.
    :vartype lookback_period: str
    :ivar alert_rule: The alert rule to preview. Required.
    :vartype alert_rule: ~azure.mgmt.alertsmanagement.models.LogAlertRuleResource
    """

    _validation = {
        "rule_type": {"required": True},
        "lookback_period": {"required": True},
        "alert_rule": {"required": True},
    }

    _attribute_map = {
        "rule_type": {"key": "ruleType", "type": "str"},
        "lookback_period": {"key": "lookbackPeriod", "type": "str"},
        "alert_rule": {"key": "alertRule", "type": "LogAlertRuleResource"},
    }

    def __init__(
        self, *, rule_type: str, lookback_period: str, alert_rule: "_models.LogAlertRuleResource", **kwargs: Any
    ) -> None:
        """
        :keyword rule_type: The query parameter that specifies rule type to be previewed. Required.
        :paramtype rule_type: str
        :keyword lookback_period: The query parameter that specifies the lookback of the preview.
         Required.
        :paramtype lookback_period: str
        :keyword alert_rule: The alert rule to preview. Required.
        :paramtype alert_rule: ~azure.mgmt.alertsmanagement.models.LogAlertRuleResource
        """
        super().__init__(**kwargs)
