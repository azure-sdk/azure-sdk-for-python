...
class AlertEnrichmentItem(_serialization.Model):
    ...
    :ivar status: The status of the evaluation of the enrichment. Required. Known values are:
     "Succeeded", "Failed", "New", "InProgress", "Mitigated", "Resolved", "Closed", "Canceled", and
     "OnHold".
...
class InvestigationExecution(_serialization.Model):
    ...
    :ivar completed_at: The time at which the investigation execution completed. Required.
    ...
    def __init__(self, *, completed_at: datetime.datetime, **kwargs: Any) -> None:
        """
        :keyword completed_at: The time at which the investigation execution completed. Required.
...
class InvestigationMetadata(_serialization.Model):
    ...
    :ivar created_at: The creation time of the investigation. Required.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword created_at: The creation time of the investigation. Required.
...
class InvestigationResult(_serialization.Model):
    ...
    :vartype id: str
    :ivar entity_type: The type of this investigation entity. Required. Default value is
     "Investigation".
    ...
    :ivar created_at: The creation time of the investigation. Required.
    :vartype created_at: ~datetime.datetime
    :ivar last_modified_at: The last update time of the investigation. Required.
    ...
    :vartype children: list[JSON]
    """

    _validation = {
        "id": {"required": True},
        "entity_type": {"required": True, "constant": True},
    ...
    _attribute_map = {
        ...
        "execution": {"key": "execution", "type": "InvestigationExecution"},
        "run_parameters": {"key": "runParameters", "type": "RunParameters"},
        "children": {"key": "children", "type": "[object]"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword created_at: The creation time of the investigation. Required.
        :paramtype created_at: ~datetime.datetime
        :keyword last_modified_at: The last update time of the investigation. Required.
...
class InvestigationScope(_serialization.Model):
    ...
    :vartype origin: ~azure.mgmt.alertsmanagement.models.Origin
    :ivar relevance: The relevance of the scope. Known values are: "Relevant" and "Irrelevant".
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype origin: ~azure.mgmt.alertsmanagement.models.Origin
        :keyword relevance: The relevance of the scope. Known values are: "Relevant" and "Irrelevant".
...
class IssueProperties(_serialization.Model):
    ...
    :ivar status: The issue status. Required. Known values are: "Succeeded", "Failed", "New",
     "InProgress", "Mitigated", "Resolved", "Closed", "Canceled", and "OnHold".
    :vartype status: str or ~azure.mgmt.alertsmanagement.models.Status
    ...
    :ivar impact_time: The issue impact time. Required.
    :vartype impact_time: ~datetime.datetime
    :ivar alerts_count: The number of alerts related to the issue. Required.
    :vartype alerts_count: int
    :ivar resources_count: The number of resources related to the issue. Required.
    :vartype resources_count: int
    ...
    _validation = {
        ...
        "alerts_count": {"required": True, "readonly": True},
        "resources_count": {"required": True, "readonly": True},
    ...
    _attribute_map = {
        ...
        "resources_count": {"key": "resourcesCount", "type": "int"},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword impact_time: The issue impact time. Required.
        ...
        self.investigations_count = None
...
class IssuePropertiesUpdate(_serialization.Model):
    ...
    :ivar status: The issue status. Known values are: "Succeeded", "Failed", "New", "InProgress",
     "Mitigated", "Resolved", "Closed", "Canceled", and "OnHold".
    :vartype status: str or ~azure.mgmt.alertsmanagement.models.Status
    :ivar severity: The issue severity.
    :vartype severity: str
    :ivar impact_time: The issue impact time.
    :vartype impact_time: ~datetime.datetime
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype severity: str
        :keyword impact_time: The issue impact time.
        :paramtype impact_time: ~datetime.datetime
        """
        super().__init__(**kwargs)
        self.title = title
...
class RelatedAlert(_serialization.Model):
    ...
    :vartype id: str
    :ivar relevance: The alerts's relevance status. Required. Known values are: "Relevant" and
     "Irrelevant".
    :vartype relevance: str or ~azure.mgmt.alertsmanagement.models.Relevance
    :ivar origin: The source that related the alert to the issue. Required.
    :vartype origin: ~azure.mgmt.alertsmanagement.models.Origin
    :ivar added_at: The time this relation was added to the issue. Required.
    :vartype added_at: ~datetime.datetime
    :ivar last_modified_at: The last update time of this relation. Required.
    :vartype last_modified_at: ~datetime.datetime
    """
    ...
    def __init__(
        ...
        :paramtype id: str
        :keyword relevance: The alerts's relevance status. Required. Known values are: "Relevant" and
         "Irrelevant".
        :paramtype relevance: str or ~azure.mgmt.alertsmanagement.models.Relevance
        """
        super().__init__(**kwargs)
...
class RelatedResource(_serialization.Model):
    ...
    :vartype id: str
    :ivar relevance: The resource's relevance status. Required. Known values are: "Relevant" and
     "Irrelevant".
    :vartype relevance: str or ~azure.mgmt.alertsmanagement.models.Relevance
    ...
    def __init__(
        ...
        :paramtype id: str
        :keyword relevance: The resource's relevance status. Required. Known values are: "Relevant" and
         "Irrelevant".
        :paramtype relevance: str or ~azure.mgmt.alertsmanagement.models.Relevance
        """
        super().__init__(**kwargs)
...
class RunParameters(_serialization.Model):
    ...
    :ivar impact_time: The impact time to investigate. Required.
    :vartype impact_time: ~datetime.datetime
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword impact_time: The impact time to investigate. Required.
        :paramtype impact_time: ~datetime.datetime
