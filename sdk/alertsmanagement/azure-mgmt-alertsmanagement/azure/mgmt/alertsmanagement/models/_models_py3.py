...
class CorrelateAlerts(Action):
    ...
    :ivar correlation_updates: Defines the updates to be applied for correlation.
    :vartype correlation_updates: ~azure.mgmt.alertsmanagement.models.CorrelationUpdates
    """
    ...
    _attribute_map = {
        ...
        "correlation_updates": {"key": "correlationUpdates", "type": "CorrelationUpdates"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        correlation_updates: Optional["_models.CorrelationUpdates"] = None,
        **kwargs: Any
    ) -> None:
        """
        ...
        :paramtype notifications_for_correlated_alerts: str or
         ~azure.mgmt.alertsmanagement.models.NotificationsForCorrelatedAlerts
        :keyword correlation_updates: Defines the updates to be applied for correlation.
        :paramtype correlation_updates: ~azure.mgmt.alertsmanagement.models.CorrelationUpdates
        """
        super().__init__(**kwargs)
        ...
        self.correlation_updates = correlation_updates
...
class CorrelationUpdates(_serialization.Model):
    """Defines the updates to be applied for correlation.

    All required parameters must be populated in order to send to server.

    :ivar update_type: The type of update that needs to be performed. "timeBased"
    :vartype update_type: str or ~azure.mgmt.alertsmanagement.models.UpdateType
    :ivar update_interval: The update interval for notification updates in ISO8601 format.
     Required.
    :vartype update_interval: str
    :ivar action_groups: The action group ids. Required.
    ...
    _attribute_map = {
        ...
        "update_interval": {"key": "updateInterval", "type": "str"},
    ...
    def __init__(
        self,
        *,
        update_type: Union[str, "_models.UpdateType"] = "timeBased",
        update_interval: str,
        action_groups: List[str],
        **kwargs: Any
    ) -> None:
        """
        :keyword update_type: The type of update that needs to be performed. "timeBased"
        :paramtype update_type: str or ~azure.mgmt.alertsmanagement.models.UpdateType
        :keyword update_interval: The update interval for notification updates in ISO8601 format.
         Required.
        :paramtype update_interval: str
        :keyword action_groups: The action group ids. Required.
