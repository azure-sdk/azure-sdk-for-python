...
def build_list_test_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.AlertsManagement/operations")
...
class Operations:
    ...
    @distributed_trace
    def list_test(self, **kwargs: Any) -> Iterable["_models.Operation"]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_test_request(
