...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2021-08-08-preview"))
...
class AlertProcessingRulesOperations:
    ...
    def get_by_name(
        ...
        deserialized = self._deserialize("AlertProcessingRule", pipeline_response.http_response)
    ...
    def create_or_update(
        ...
        resource_group_name: str,
        alert_processing_rule_name: str,
        alert_processing_rule: Union[_models.AlertProcessingRule, IO[bytes]],
        **kwargs: Any
    ) -> _models.AlertProcessingRule:
        """Create or update an alert processing rule.
        ...
        :type alert_processing_rule: ~azure.mgmt.alertsmanagement.models.AlertProcessingRule or
         IO[bytes]
        :return: AlertProcessingRule or the result of cls(response)
        :rtype: ~azure.mgmt.alertsmanagement.models.AlertProcessingRule
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def update(
        ...
        resource_group_name: str,
        alert_processing_rule_name: str,
        alert_processing_rule_patch: Union[_models.PatchObject, IO[bytes]],
        **kwargs: Any
    ) -> _models.AlertProcessingRule:
        """Enable, disable, or update tags for an alert processing rule.
        ...
        :type alert_processing_rule_patch: ~azure.mgmt.alertsmanagement.models.PatchObject or IO[bytes]
        :return: AlertProcessingRule or the result of cls(response)
        :rtype: ~azure.mgmt.alertsmanagement.models.AlertProcessingRule
        :raises ~azure.core.exceptions.HttpResponseError:
        """
