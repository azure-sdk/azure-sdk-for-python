...
def build_list_by_subscription_test_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
...
class PrometheusRuleGroupsOperations:
    ...
    @distributed_trace
    def list_by_subscription_test(self, **kwargs: Any) -> Iterable["_models.PrometheusRuleGroupResource"]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_subscription_test_request(
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.alertsmanagement.models.PrometheusRuleGroupResource or IO[bytes]
        :return: PrometheusRuleGroupResource or the result of cls(response)
        :rtype: ~azure.mgmt.alertsmanagement.models.PrometheusRuleGroupResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.alertsmanagement.models.PrometheusRuleGroupResourcePatchParameters or IO[bytes]
        :return: PrometheusRuleGroupResource or the result of cls(response)
        :rtype: ~azure.mgmt.alertsmanagement.models.PrometheusRuleGroupResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
