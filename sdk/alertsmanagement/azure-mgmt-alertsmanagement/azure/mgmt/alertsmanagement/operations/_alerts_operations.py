...
def build_meta_data_request(*, identifier: Union[str, _models.Identifier], **kwargs: Any) -> HttpRequest:
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2023-07-12-preview"))
...
class AlertsOperations:
    ...
    def change_state(
        ...
        **kwargs: Any
        ...
        :param new_state: New state of the alert. Known values are: "New", "Acknowledged", and
         "Closed". Required.
        :type new_state: str or ~azure.mgmt.alertsmanagement.models.AlertState
        :param comment: reason of change alert state. Is either a Comments type or a IO type. Default
         value is None.
    ...
    def list_enrichments(self, scope: str, alert_id: str, **kwargs: Any) -> Iterable["_models.AlertEnrichmentResponse"]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_enrichments_request(
                    scope=scope,
                    alert_id=alert_id,
                    api_version=api_version,
                    template_url=self.list_enrichments.metadata["url"],
                    headers=_headers,
                    params=_params,
                )
                request = _convert_request(request)
    ...
    list_enrichments.metadata = {"url": "/{scope}/providers/Microsoft.AlertsManagement/alerts/{alertId}/enrichments"}
    ...
    def get_enrichments(self, scope: str, alert_id: str, **kwargs: Any) -> _models.AlertEnrichmentResponse:
        ...
        request = build_get_enrichments_request(
            scope=scope,
            alert_id=alert_id,
            api_version=api_version,
            template_url=self.get_enrichments.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
        ...
        deserialized = self._deserialize("AlertEnrichmentResponse", pipeline_response)
    ...
    get_enrichments.metadata = {
        "url": "/{scope}/providers/Microsoft.AlertsManagement/alerts/{alertId}/enrichments/default"
    }
