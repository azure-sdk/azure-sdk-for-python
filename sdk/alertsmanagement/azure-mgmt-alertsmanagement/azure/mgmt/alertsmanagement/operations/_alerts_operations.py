...
def build_get_all_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/{scope}/providers/Microsoft.AlertsManagement/alerts")
...
def build_get_by_id_request(scope: str, alert_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/{scope}/providers/Microsoft.AlertsManagement/alerts/{alertId}")
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, "str", skip_quote=True),
...
def build_change_state_request(
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/{scope}/providers/Microsoft.AlertsManagement/alerts/{alertId}/changestate")
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, "str", skip_quote=True),
        "alertId": _SERIALIZER.url("alert_id", alert_id, "str"),
    }
...
def build_get_history_request(scope: str, alert_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/{scope}/providers/Microsoft.AlertsManagement/alerts/{alertId}/history")
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, "str", skip_quote=True),
        "alertId": _SERIALIZER.url("alert_id", alert_id, "str"),
    }
...
def build_get_summary_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/{scope}/providers/Microsoft.AlertsManagement/alertsSummary")
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, "str", skip_quote=True),
    }
...
def build_list_enrichments_request(scope: str, alert_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/{scope}/providers/Microsoft.AlertsManagement/alerts/{alertId}/enrichments")
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, "str", skip_quote=True),
        "alertId": _SERIALIZER.url("alert_id", alert_id, "str"),
    }
...
def build_get_enrichments_request(scope: str, alert_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/{scope}/providers/Microsoft.AlertsManagement/alerts/{alertId}/enrichments/default"
    )
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, "str", skip_quote=True),
        "alertId": _SERIALIZER.url("alert_id", alert_id, "str"),
...
class AlertsOperations:
    ...
    def meta_data(self, identifier: Union[str, _models.Identifier], **kwargs: Any) -> _models.AlertsMetaData:
        ...
        _request = build_meta_data_request(
        ...
        deserialized = self._deserialize("AlertsMetaData", pipeline_response.http_response)
    ...
    def get_all(
        ...
        **kwargs: Any
        ...
        :param alert_state: Filter by state of the alert instance. Default value is to select all.
         Known values are: "New", "Acknowledged", "Closed", "NoAlert", "Fired", "Firing", "Resolving",
         and "Resolved". Default value is None.
        ...
        :param custom_time_range: Filter by custom time range in the format :code:`<start-time>`/\\
         :code:`<end-time>`  where time is in (ISO-8601 format)'. Permissible values is within 30 days
         from  query time. Either timeRange or customTimeRange could be used but not both. Default is
    ...
    def change_state(
        ...
        **kwargs: Any
        ...
        :param alert_id: Unique ID of an alert instance. Required.
        :type alert_id: str
        :param new_state: New state of the alert. Known values are: "New", "Acknowledged", "Closed",
         "NoAlert", "Fired", "Firing", "Resolving", and "Resolved". Required.
    ...
    def change_state(
        ...
        alert_id: str,
        new_state: Union[str, _models.AlertState],
        comment: Optional[Union[_models.Comments, IO[bytes]]] = None,
        **kwargs: Any
    ) -> _models.Alert:
        """Change the state of an alert.
        ...
        :param new_state: New state of the alert. Known values are: "New", "Acknowledged", "Closed",
         "NoAlert", "Fired", "Firing", "Resolving", and "Resolved". Required.
        :type new_state: str or ~azure.mgmt.alertsmanagement.models.AlertState
        :param comment: reason of change alert state. Is either a Comments type or a IO[bytes] type.
         Default value is None.
        :type comment: ~azure.mgmt.alertsmanagement.models.Comments or IO[bytes]
        :return: Alert or the result of cls(response)
        :rtype: ~azure.mgmt.alertsmanagement.models.Alert
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def get_history(self, scope: str, alert_id: str, **kwargs: Any) -> _models.AlertModification:
        ...
        deserialized = self._deserialize("AlertModification", pipeline_response.http_response)
    ...
    def get_summary(
        ...
        **kwargs: Any
        ...
        _request = build_get_summary_request(
            scope=scope,
            groupby=groupby,
        ...
        deserialized = self._deserialize("AlertsSummary", pipeline_response.http_response)
    ...
    @distributed_trace
    def list_enrichments(self, scope: str, alert_id: str, **kwargs: Any) -> Iterable["_models.AlertEnrichmentResponse"]:
        ...
        :param alert_id: Unique ID of an alert instance. Required.
        :type alert_id: str
        :return: An iterator like instance of either AlertEnrichmentResponse or the result of
         cls(response)
        :rtype:
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2024-01-01-preview"))
        cls: ClsType[_models.AlertEnrichmentsList] = kwargs.pop("cls", None)
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_enrichments_request(
                    scope=scope,
                    alert_id=alert_id,
                    api_version=api_version,
                    headers=_headers,
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("AlertEnrichmentsList", pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
    ...
    @distributed_trace
    def get_enrichments(self, scope: str, alert_id: str, **kwargs: Any) -> _models.AlertEnrichmentResponse:
        ...
        :param alert_id: Unique ID of an alert instance. Required.
        :type alert_id: str
        :return: AlertEnrichmentResponse or the result of cls(response)
        :rtype: ~azure.mgmt.alertsmanagement.models.AlertEnrichmentResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2024-01-01-preview"))
        cls: ClsType[_models.AlertEnrichmentResponse] = kwargs.pop("cls", None)

        _request = build_get_enrichments_request(
            scope=scope,
            alert_id=alert_id,
            api_version=api_version,
            headers=_headers,
        ...
        deserialized = self._deserialize("AlertEnrichmentResponse", pipeline_response.http_response)
