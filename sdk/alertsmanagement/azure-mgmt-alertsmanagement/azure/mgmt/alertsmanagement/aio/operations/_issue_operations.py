...
from ...operations._issue_operations import (
    build_add_or_update_alerts_request,
    build_add_or_update_resources_request,
    build_create_request,
    build_delete_request,
    build_fetch_investigation_result_request,
    build_get_request,
    build_list_alerts_request,
    build_list_request,
    build_list_resources_request,
    build_start_investigation_request,
...
class IssueOperations:
    ...
    @distributed_trace
    def list(self, resource_uri: str, **kwargs: Any) -> AsyncIterable["_models.IssueResource"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.alertsmanagement.models.IssueResource]
    ...
    async def get(self, resource_uri: str, **kwargs: Any) -> _models.IssueResource:
    ...
    async def add_or_update_alerts(
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: RelatedAlerts or the result of cls(response)
        :rtype: ~azure.mgmt.alertsmanagement.models.RelatedAlerts
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def add_or_update_alerts(
        ...
        deserialized = self._deserialize("RelatedAlerts", pipeline_response.http_response)
    ...
    async def add_or_update_resources(
        ...
        **kwargs: Any
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: RelatedResources or the result of cls(response)
        :rtype: ~azure.mgmt.alertsmanagement.models.RelatedResources
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def add_or_update_resources(
        ...
        deserialized = self._deserialize("RelatedResources", pipeline_response.http_response)
    ...
    def list_alerts(
    ...
    ) -> AsyncIterable["_models.RelatedAlert"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.alertsmanagement.models.RelatedAlert]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_resources(
        self, resource_uri: str, body: _models.ListParameter, *, content_type: str = "application/json", **kwargs: Any
    ) -> AsyncIterable["_models.RelatedResource"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.alertsmanagement.models.RelatedResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
