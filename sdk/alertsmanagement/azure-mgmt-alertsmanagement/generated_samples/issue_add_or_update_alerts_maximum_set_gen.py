...
def main():
    ...
    client.issue.add_or_update_alerts(
...
# x-ms-original-file: specification/alertsmanagement/resource-manager/Microsoft.AlertsManagement/preview/2025-03-01-preview/examples/Issue_AddOrUpdateAlerts_MaximumSet_Gen.json
