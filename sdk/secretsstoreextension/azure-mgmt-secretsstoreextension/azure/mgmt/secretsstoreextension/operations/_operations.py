...
def build_azure_key_vault_secret_provider_classes_get_request(  # pylint: disable=name-too-long
    ...
    path_format_arguments = {
        ...
        "azureKeyVaultSecretProviderClassName": _SERIALIZER.url(
            "azure_key_vault_secret_provider_class_name", azure_key_vault_secret_provider_class_name, "str"
        ),
    }
...
def build_azure_key_vault_secret_provider_classes_create_or_update_request(  # pylint: disable=name-too-long
    resource_group_name: str, azure_key_vault_secret_provider_class_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_azure_key_vault_secret_provider_classes_update_request(  # pylint: disable=name-too-long
    resource_group_name: str, azure_key_vault_secret_provider_class_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_azure_key_vault_secret_provider_classes_list_by_resource_group_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SecretSyncController/azureKeyVaultSecretProviderClasses"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
    }
...
def build_azure_key_vault_secret_provider_classes_list_by_subscription_request(  # pylint: disable=name-too-long
...
def build_secret_syncs_get_request(
    ...
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "secretSyncName": _SERIALIZER.url("secret_sync_name", secret_sync_name, "str"),
    }
...
def build_secret_syncs_create_or_update_request(  # pylint: disable=name-too-long
    resource_group_name: str, secret_sync_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_secret_syncs_list_by_resource_group_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SecretSyncController/secretSyncs"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
    }
...
def build_secret_syncs_list_by_subscription_request(  # pylint: disable=name-too-long
    subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class Operations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.secretsstoreextension.SecretsStoreExtensionMgmtClient`'s
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.Operation"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.secretsstoreextension.models.Operation]
...
class AzureKeyVaultSecretProviderClassesOperations:  # pylint: disable=name-too-long
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.secretsstoreextension.models.AzureKeyVaultSecretProviderClass]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.AzureKeyVaultSecretProviderClass].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.AzureKeyVaultSecretProviderClass](
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.secretsstoreextension.models.AzureKeyVaultSecretProviderClass]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class SecretSyncsOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, secret_sync_name: str, **kwargs: Any) -> _models.SecretSync:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.SecretSync].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.SecretSync](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
    ...
    def _delete_initial(self, resource_group_name: str, secret_sync_name: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.SecretSync"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.secretsstoreextension.models.SecretSync]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
