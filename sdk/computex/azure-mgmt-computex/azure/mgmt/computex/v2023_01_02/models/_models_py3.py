...
class ApiError(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.computex.v2023_01_02.models.ApiErrorBase]
    :ivar innererror: The Api inner error.
    :vartype innererror: ~azure.mgmt.computex.v2023_01_02.models.InnerError
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype details: list[~azure.mgmt.computex.v2023_01_02.models.ApiErrorBase]
        :keyword innererror: The Api inner error.
        :paramtype innererror: ~azure.mgmt.computex.v2023_01_02.models.InnerError
...
class CopyCompletionError(_serialization.Model):
    ...
    :vartype error_code: str or ~azure.mgmt.computex.v2023_01_02.models.CopyCompletionErrorReason
    ...
    def __init__(
        ...
        :paramtype error_code: str or ~azure.mgmt.computex.v2023_01_02.models.CopyCompletionErrorReason
...
class CreationData(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype create_option: str or ~azure.mgmt.computex.v2023_01_02.models.DiskCreateOption
    ...
    :vartype image_reference: ~azure.mgmt.computex.v2023_01_02.models.ImageDiskReference
    ...
    :vartype gallery_image_reference: ~azure.mgmt.computex.v2023_01_02.models.ImageDiskReference
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype create_option: str or ~azure.mgmt.computex.v2023_01_02.models.DiskCreateOption
        ...
        :paramtype image_reference: ~azure.mgmt.computex.v2023_01_02.models.ImageDiskReference
        :keyword gallery_image_reference: Required if creating from a Gallery Image. The
         id/sharedGalleryImageId/communityGalleryImageId of the ImageDiskReference will be the ARM id of
         the shared galley image version from which to create a disk.
        :paramtype gallery_image_reference: ~azure.mgmt.computex.v2023_01_02.models.ImageDiskReference
...
class Disk(Resource):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype sku: ~azure.mgmt.computex.v2023_01_02.models.DiskSku
    ...
    :vartype extended_location: ~azure.mgmt.computex.v2023_01_02.models.ExtendedLocation
    ...
    :vartype os_type: str or ~azure.mgmt.computex.v2023_01_02.models.OperatingSystemTypes
    ...
    :vartype hyper_v_generation: str or ~azure.mgmt.computex.v2023_01_02.models.HyperVGeneration
    :ivar purchase_plan: Purchase plan information for the the image from which the OS disk was
     ...
     WindowsServer}.
    :vartype purchase_plan: ~azure.mgmt.computex.v2023_01_02.models.PurchasePlan
    :ivar supported_capabilities: List of supported capabilities for the image from which the OS
     disk was created.
    :vartype supported_capabilities: ~azure.mgmt.computex.v2023_01_02.models.SupportedCapabilities
    :ivar creation_data: Disk source information. CreationData information cannot be changed after
     the disk has been created.
    :vartype creation_data: ~azure.mgmt.computex.v2023_01_02.models.CreationData
    ...
    :vartype encryption_settings_collection:
     ~azure.mgmt.computex.v2023_01_02.models.EncryptionSettingsCollection
    ...
    :vartype disk_state: str or ~azure.mgmt.computex.v2023_01_02.models.DiskState
    ...
    :vartype encryption: ~azure.mgmt.computex.v2023_01_02.models.Encryption
    ...
    :vartype share_info: list[~azure.mgmt.computex.v2023_01_02.models.ShareInfoElement]
    ...
    :vartype network_access_policy: str or
     ~azure.mgmt.computex.v2023_01_02.models.NetworkAccessPolicy
    ...
    :vartype property_updates_in_progress:
     ~azure.mgmt.computex.v2023_01_02.models.PropertyUpdatesInProgress
    ...
    :vartype security_profile: ~azure.mgmt.computex.v2023_01_02.models.DiskSecurityProfile
    ...
    :vartype public_network_access: str or
     ~azure.mgmt.computex.v2023_01_02.models.PublicNetworkAccess
    ...
    :vartype data_access_auth_mode: str or
     ~azure.mgmt.computex.v2023_01_02.models.DataAccessAuthMode
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :paramtype sku: ~azure.mgmt.computex.v2023_01_02.models.DiskSku
        ...
        :keyword extended_location: The extended location where the disk will be created. Extended
         location cannot be changed.
        :paramtype extended_location: ~azure.mgmt.computex.v2023_01_02.models.ExtendedLocation
        :keyword os_type: The Operating System type. Known values are: "Windows" and "Linux".
        :paramtype os_type: str or ~azure.mgmt.computex.v2023_01_02.models.OperatingSystemTypes
        :keyword hyper_v_generation: The hypervisor generation of the Virtual Machine. Applicable to OS
         disks only. Known values are: "V1" and "V2".
        :paramtype hyper_v_generation: str or ~azure.mgmt.computex.v2023_01_02.models.HyperVGeneration
        :keyword purchase_plan: Purchase plan information for the the image from which the OS disk was
         created. E.g. - {name: 2019-Datacenter, publisher: MicrosoftWindowsServer, product:
         WindowsServer}.
        :paramtype purchase_plan: ~azure.mgmt.computex.v2023_01_02.models.PurchasePlan
        :keyword supported_capabilities: List of supported capabilities for the image from which the OS
         disk was created.
        :paramtype supported_capabilities:
         ~azure.mgmt.computex.v2023_01_02.models.SupportedCapabilities
        :keyword creation_data: Disk source information. CreationData information cannot be changed
         after the disk has been created.
        :paramtype creation_data: ~azure.mgmt.computex.v2023_01_02.models.CreationData
        ...
        :paramtype encryption: ~azure.mgmt.computex.v2023_01_02.models.Encryption
        ...
        :paramtype security_profile: ~azure.mgmt.computex.v2023_01_02.models.DiskSecurityProfile
...
class DiskList(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.computex.v2023_01_02.models.Disk]
    ...
    def __init__(self, *, value: List["_models.Disk"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.computex.v2023_01_02.models.Disk]
...
class DiskSecurityProfile(_serialization.Model):
    ...
    :vartype security_type: str or ~azure.mgmt.computex.v2023_01_02.models.DiskSecurityTypes
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword security_type: Specifies the SecurityType of the VM. Applicable for OS disks only.
         ...
         "ConfidentialVM_DiskEncryptedWithPlatformKey", and
         "ConfidentialVM_DiskEncryptedWithCustomerKey".
        :paramtype security_type: str or ~azure.mgmt.computex.v2023_01_02.models.DiskSecurityTypes
...
class DiskSku(_serialization.Model):
    ...
    :vartype name: str or ~azure.mgmt.computex.v2023_01_02.models.DiskStorageAccountTypes
    ...
    def __init__(self, *, name: Optional[Union[str, "_models.DiskStorageAccountTypes"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype name: str or ~azure.mgmt.computex.v2023_01_02.models.DiskStorageAccountTypes
        """
        super().__init__(**kwargs)
        self.name = name
        self.tier = None
...
class Encryption(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.computex.v2023_01_02.models.EncryptionType
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: The type of key used to encrypt the data of the disk. Known values are:
         "EncryptionAtRestWithPlatformKey", "EncryptionAtRestWithCustomerKey", and
         "EncryptionAtRestWithPlatformAndCustomerKeys".
        :paramtype type: str or ~azure.mgmt.computex.v2023_01_02.models.EncryptionType
        """
        super().__init__(**kwargs)
...
class EncryptionSettingsCollection(_serialization.Model):
    ...
    :vartype encryption_settings:
     list[~azure.mgmt.computex.v2023_01_02.models.EncryptionSettingsElement]
...
class EncryptionSettingsElement(_serialization.Model):
    ...
    :vartype disk_encryption_key:
     ~azure.mgmt.computex.v2023_01_02.models.KeyVaultAndSecretReference
    ...
    :vartype key_encryption_key: ~azure.mgmt.computex.v2023_01_02.models.KeyVaultAndKeyReference
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword key_encryption_key: Key Vault Key Url and vault id of the key encryption key.
         KeyEncryptionKey is optional and when provided is used to unwrap the disk encryption key.
        :paramtype key_encryption_key: ~azure.mgmt.computex.v2023_01_02.models.KeyVaultAndKeyReference
        """
        super().__init__(**kwargs)
...
class ExtendedLocation(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.computex.v2023_01_02.models.ExtendedLocationTypes
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype type: str or ~azure.mgmt.computex.v2023_01_02.models.ExtendedLocationTypes
        """
        super().__init__(**kwargs)
        self.name = name
        self.type = type
...
class GrantAccessData(_serialization.Model):
    ...
    :vartype access: str or ~azure.mgmt.computex.v2023_01_02.models.AccessLevel
    ...
    :vartype file_format: str or ~azure.mgmt.computex.v2023_01_02.models.FileFormat
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype access: str or ~azure.mgmt.computex.v2023_01_02.models.AccessLevel
        ...
        :paramtype file_format: str or ~azure.mgmt.computex.v2023_01_02.models.FileFormat
        """
        super().__init__(**kwargs)
        self.access = access
...
class KeyVaultAndKeyReference(_serialization.Model):
    ...
    :vartype source_vault: ~azure.mgmt.computex.v2023_01_02.models.SourceVault
    ...
    def __init__(self, *, source_vault: "_models.SourceVault", key_url: str, **kwargs: Any) -> None:
        ...
        :paramtype source_vault: ~azure.mgmt.computex.v2023_01_02.models.SourceVault
...
class SupportedCapabilities(_serialization.Model):
    ...
    :ivar architecture: CPU architecture supported by an OS disk. Known values are: "x64" and
     "Arm64".
    :vartype architecture: str or ~azure.mgmt.computex.v2023_01_02.models.Architecture
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword architecture: CPU architecture supported by an OS disk. Known values are: "x64" and
         "Arm64".
        :paramtype architecture: str or ~azure.mgmt.computex.v2023_01_02.models.Architecture
        """
        super().__init__(**kwargs)
