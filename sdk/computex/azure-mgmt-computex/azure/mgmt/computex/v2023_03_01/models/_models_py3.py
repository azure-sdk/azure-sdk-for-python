...
class AdditionalUnattendContent(_serialization.Model):
    ...
    :ivar setting_name: Specifies the name of the setting to which the content applies. Possible
     ...
     "FirstLogonCommands".
    :vartype setting_name: str or ~azure.mgmt.computex.v2023_03_01.models.SettingNames
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword setting_name: Specifies the name of the setting to which the content applies. Possible
         values are: FirstLogonCommands and AutoLogon. Known values are: "AutoLogon" and
         "FirstLogonCommands".
        :paramtype setting_name: str or ~azure.mgmt.computex.v2023_03_01.models.SettingNames
...
class ApiError(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.computex.v2023_03_01.models.ApiErrorBase]
    :ivar innererror: The Api inner error.
    :vartype innererror: ~azure.mgmt.computex.v2023_03_01.models.InnerError
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype details: list[~azure.mgmt.computex.v2023_03_01.models.ApiErrorBase]
        :keyword innererror: The Api inner error.
        :paramtype innererror: ~azure.mgmt.computex.v2023_03_01.models.InnerError
...
class ApplicationProfile(_serialization.Model):
    ...
    :vartype gallery_applications:
     list[~azure.mgmt.computex.v2023_03_01.models.VMGalleryApplication]
    """
...
class BootDiagnosticsInstanceView(_serialization.Model):
    ...
    :vartype status: ~azure.mgmt.computex.v2023_03_01.models.InstanceViewStatus
    """
...
class CapacityReservationProfile(_serialization.Model):
    ...
    :ivar capacity_reservation_group: Specifies the capacity reservation group resource id that
     ...
     details.
    :vartype capacity_reservation_group: ~azure.mgmt.computex.v2023_03_01.models.SubResource
    """
    ...
    def __init__(self, *, capacity_reservation_group: Optional["_models.SubResource"] = None, **kwargs: Any) -> None:
        ...
        :keyword capacity_reservation_group: Specifies the capacity reservation group resource id that
         ...
         capacity has been reserved. Please refer to https://aka.ms/CapacityReservation for more
         details.
        :paramtype capacity_reservation_group: ~azure.mgmt.computex.v2023_03_01.models.SubResource
        """
        super().__init__(**kwargs)
...
class ComputeOperationListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.computex.v2023_03_01.models.ComputeOperationValue]
    """
...
class DataDisk(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype vhd: ~azure.mgmt.computex.v2023_03_01.models.VirtualHardDisk
    ...
    :vartype image: ~azure.mgmt.computex.v2023_03_01.models.VirtualHardDisk
    ...
    :vartype caching: str or ~azure.mgmt.computex.v2023_03_01.models.CachingTypes
    ...
    :vartype create_option: str or ~azure.mgmt.computex.v2023_03_01.models.DiskCreateOptionTypes
    ...
    :vartype managed_disk: ~azure.mgmt.computex.v2023_03_01.models.ManagedDiskParameters
    ...
    :vartype detach_option: str or ~azure.mgmt.computex.v2023_03_01.models.DiskDetachOptionTypes
    ...
    :vartype delete_option: str or ~azure.mgmt.computex.v2023_03_01.models.DiskDeleteOptionTypes
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype vhd: ~azure.mgmt.computex.v2023_03_01.models.VirtualHardDisk
        :keyword image: The source user image virtual hard disk. The virtual hard disk will be copied
         before being attached to the virtual machine. If SourceImage is provided, the destination
         virtual hard drive must not exist.
        :paramtype image: ~azure.mgmt.computex.v2023_03_01.models.VirtualHardDisk
        ...
        :paramtype caching: str or ~azure.mgmt.computex.v2023_03_01.models.CachingTypes
        ...
        :keyword create_option: Specifies how the virtual machine should be created. Possible values
         ...
         described above. If you are using a marketplace image, you should also use the plan element
         previously described. Required. Known values are: "FromImage", "Empty", and "Attach".
        :paramtype create_option: str or ~azure.mgmt.computex.v2023_03_01.models.DiskCreateOptionTypes
        ...
        :paramtype managed_disk: ~azure.mgmt.computex.v2023_03_01.models.ManagedDiskParameters
         ...
         **ForceDetach.** detachOption: **ForceDetach** is applicable only for managed data disks. If a
         ...
         VirtualMachineScaleSet. To force-detach a data disk update toBeDetached to 'true' along with
         setting detachOption: 'ForceDetach'. "ForceDetach"
        :paramtype detach_option: str or ~azure.mgmt.computex.v2023_03_01.models.DiskDetachOptionTypes
        :keyword delete_option: Specifies whether data disk should be deleted or detached upon VM
         deletion. Possible values are: **Delete.** If this value is used, the data disk is deleted when
         VM is deleted. **Detach.** If this value is used, the data disk is retained after VM is
         deleted. The default value is set to **Detach**. Known values are: "Delete" and "Detach".
        :paramtype delete_option: str or ~azure.mgmt.computex.v2023_03_01.models.DiskDeleteOptionTypes
        """
        super().__init__(**kwargs)
        self.lun = lun
        self.name = name
...
class DiagnosticsProfile(_serialization.Model):
    ...
    :vartype boot_diagnostics: ~azure.mgmt.computex.v2023_03_01.models.BootDiagnostics
    """
    ...
    def __init__(self, *, boot_diagnostics: Optional["_models.BootDiagnostics"] = None, **kwargs: Any) -> None:
        ...
        :keyword boot_diagnostics: Boot Diagnostics is a debugging feature which allows you to view
         ...
         VM. You can easily view the output of your console log. Azure also enables you to see a
         screenshot of the VM from the hypervisor.
        :paramtype boot_diagnostics: ~azure.mgmt.computex.v2023_03_01.models.BootDiagnostics
        """
        super().__init__(**kwargs)
...
class DiffDiskSettings(_serialization.Model):
    ...
    :vartype option: str or ~azure.mgmt.computex.v2023_03_01.models.DiffDiskOptions
    ...
    :vartype placement: str or ~azure.mgmt.computex.v2023_03_01.models.DiffDiskPlacement
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype option: str or ~azure.mgmt.computex.v2023_03_01.models.DiffDiskOptions
        :keyword placement: Specifies the ephemeral disk placement for operating system disk. Possible
         ...
         and Linux VM at https://docs.microsoft.com/azure/virtual-machines/linux/sizes to check which VM
         sizes exposes a cache disk. Known values are: "CacheDisk" and "ResourceDisk".
        :paramtype placement: str or ~azure.mgmt.computex.v2023_03_01.models.DiffDiskPlacement
        """
        super().__init__(**kwargs)
        self.option = option
...
class DiskEncryptionSettings(_serialization.Model):
    ...
    :ivar disk_encryption_key: Specifies the location of the disk encryption key, which is a Key
     Vault Secret.
    :vartype disk_encryption_key: ~azure.mgmt.computex.v2023_03_01.models.KeyVaultSecretReference
    :ivar key_encryption_key: Specifies the location of the key encryption key in Key Vault.
    :vartype key_encryption_key: ~azure.mgmt.computex.v2023_03_01.models.KeyVaultKeyReference
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword disk_encryption_key: Specifies the location of the disk encryption key, which is a Key
         Vault Secret.
        :paramtype disk_encryption_key: ~azure.mgmt.computex.v2023_03_01.models.KeyVaultSecretReference
        :keyword key_encryption_key: Specifies the location of the key encryption key in Key Vault.
        :paramtype key_encryption_key: ~azure.mgmt.computex.v2023_03_01.models.KeyVaultKeyReference
...
class DiskInstanceView(_serialization.Model):
    ...
    :vartype encryption_settings:
     list[~azure.mgmt.computex.v2023_03_01.models.DiskEncryptionSettings]
    :ivar statuses: The resource status information.
    :vartype statuses: list[~azure.mgmt.computex.v2023_03_01.models.InstanceViewStatus]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype statuses: list[~azure.mgmt.computex.v2023_03_01.models.InstanceViewStatus]
        """
        super().__init__(**kwargs)
        self.name = name
...
class ExtendedLocation(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.computex.v2023_03_01.models.ExtendedLocationTypes
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype type: str or ~azure.mgmt.computex.v2023_03_01.models.ExtendedLocationTypes
        """
        super().__init__(**kwargs)
        self.name = name
        self.type = type
...
class HardwareProfile(_serialization.Model):
    ...
    :ivar vm_size: Specifies the size of the virtual machine. The enum data type is currently
     ...
     "Standard_NV24".
    :vartype vm_size: str or ~azure.mgmt.computex.v2023_03_01.models.VirtualMachineSizeTypes
    ...
    :vartype vm_size_properties: ~azure.mgmt.computex.v2023_03_01.models.VMSizeProperties
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword vm_size: Specifies the size of the virtual machine. The enum data type is currently
         ...
         "Standard_ND12s", "Standard_ND24s", "Standard_ND24rs", "Standard_NV6", "Standard_NV12", and
         "Standard_NV24".
        :paramtype vm_size: str or ~azure.mgmt.computex.v2023_03_01.models.VirtualMachineSizeTypes
        :keyword vm_size_properties: Specifies the properties for customizing the size of the virtual
         machine. Minimum api-version: 2021-07-01. This feature is still in preview mode and is not
         supported for VirtualMachineScaleSet. Please follow the instructions in `VM Customization
         <https://aka.ms/vmcustomization>`_ for more details.
        :paramtype vm_size_properties: ~azure.mgmt.computex.v2023_03_01.models.VMSizeProperties
        """
        super().__init__(**kwargs)
...
class InstanceViewStatus(_serialization.Model):
    ...
    :vartype level: str or ~azure.mgmt.computex.v2023_03_01.models.StatusLevelTypes
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype level: str or ~azure.mgmt.computex.v2023_03_01.models.StatusLevelTypes
...
class KeyVaultKeyReference(_serialization.Model):
    ...
    :vartype source_vault: ~azure.mgmt.computex.v2023_03_01.models.SubResource
    """
    ...
    def __init__(self, *, key_url: str, source_vault: "_models.SubResource", **kwargs: Any) -> None:
        ...
        :paramtype source_vault: ~azure.mgmt.computex.v2023_03_01.models.SubResource
        """
        super().__init__(**kwargs)
...
class LinuxConfiguration(_serialization.Model):
    ...
    :vartype ssh: ~azure.mgmt.computex.v2023_03_01.models.SshConfiguration
    ...
    :ivar patch_settings: [Preview Feature] Specifies settings related to VM Guest Patching on
     Linux.
    :vartype patch_settings: ~azure.mgmt.computex.v2023_03_01.models.LinuxPatchSettings
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype ssh: ~azure.mgmt.computex.v2023_03_01.models.SshConfiguration
        ...
        :keyword patch_settings: [Preview Feature] Specifies settings related to VM Guest Patching on
         Linux.
        :paramtype patch_settings: ~azure.mgmt.computex.v2023_03_01.models.LinuxPatchSettings
...
class LinuxPatchSettings(_serialization.Model):
     ...
     **AutomaticByPlatform** - The virtual machine will be automatically updated by the platform.
     ...
     "AutomaticByPlatform".
    :vartype patch_mode: str or ~azure.mgmt.computex.v2023_03_01.models.LinuxVMGuestPatchMode
    ...
    :vartype assessment_mode: str or
     ~azure.mgmt.computex.v2023_03_01.models.LinuxPatchAssessmentMode
    ...
    :vartype automatic_by_platform_settings:
     ~azure.mgmt.computex.v2023_03_01.models.LinuxVMGuestPatchAutomaticByPlatformSettings
    """
    ...
    def __init__(
        ...
        **kwargs: Any
         ...
         **AutomaticByPlatform** - The virtual machine will be automatically updated by the platform.
         The property provisionVMAgent must be true. Known values are: "ImageDefault" and
         "AutomaticByPlatform".
        :paramtype patch_mode: str or ~azure.mgmt.computex.v2023_03_01.models.LinuxVMGuestPatchMode
...
class LinuxVMGuestPatchAutomaticByPlatformSettings(_serialization.Model):
    ...
    :vartype reboot_setting: str or
     ~azure.mgmt.computex.v2023_03_01.models.LinuxVMGuestPatchAutomaticByPlatformRebootSetting
...
class ListUsagesResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.computex.v2023_03_01.models.Usage]
    ...
    def __init__(self, *, value: List["_models.Usage"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.computex.v2023_03_01.models.Usage]
...
class MaintenanceRedeployStatus(_serialization.Model):
    ...
    :vartype last_operation_result_code: str or
     ~azure.mgmt.computex.v2023_03_01.models.MaintenanceOperationResultCodeTypes
...
class ManagedDiskParameters(SubResource):
    ...
    :vartype storage_account_type: str or
     ~azure.mgmt.computex.v2023_03_01.models.StorageAccountTypes
    :ivar disk_encryption_set: Specifies the customer managed disk encryption set resource id for
     the managed disk.
    :vartype disk_encryption_set:
     ~azure.mgmt.computex.v2023_03_01.models.DiskEncryptionSetParameters
    :ivar security_profile: Specifies the security profile for the managed disk.
    :vartype security_profile: ~azure.mgmt.computex.v2023_03_01.models.VMDiskSecurityProfile
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype security_profile: ~azure.mgmt.computex.v2023_03_01.models.VMDiskSecurityProfile
        """
        super().__init__(id=id, **kwargs)
...
class NetworkInterfaceReference(SubResource):
    ...
    :vartype delete_option: str or ~azure.mgmt.computex.v2023_03_01.models.DeleteOptions
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword delete_option: Specify what happens to the network interface when the VM is deleted.
         Known values are: "Delete" and "Detach".
        :paramtype delete_option: str or ~azure.mgmt.computex.v2023_03_01.models.DeleteOptions
        """
        super().__init__(id=id, **kwargs)
...
class NetworkProfile(_serialization.Model):
    ...
    :vartype network_interfaces:
     list[~azure.mgmt.computex.v2023_03_01.models.NetworkInterfaceReference]
    ...
    :vartype network_api_version: str or ~azure.mgmt.computex.v2023_03_01.models.NetworkApiVersion
    ...
    :vartype network_interface_configurations:
     list[~azure.mgmt.computex.v2023_03_01.models.VirtualMachineNetworkInterfaceConfiguration]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype network_api_version: str or
         ~azure.mgmt.computex.v2023_03_01.models.NetworkApiVersion
...
class OSDisk(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype os_type: str or ~azure.mgmt.computex.v2023_03_01.models.OperatingSystemTypes
    :ivar encryption_settings: Specifies the encryption settings for the OS Disk. Minimum
     api-version: 2015-06-15.
    :vartype encryption_settings: ~azure.mgmt.computex.v2023_03_01.models.DiskEncryptionSettings
    :ivar name: The disk name.
    :vartype name: str
    :ivar vhd: The virtual hard disk.
    :vartype vhd: ~azure.mgmt.computex.v2023_03_01.models.VirtualHardDisk
    ...
    :vartype diff_disk_settings: ~azure.mgmt.computex.v2023_03_01.models.DiffDiskSettings
    :ivar create_option: Specifies how the virtual machine should be created. Possible values are:
     **Attach.** This value is used when you are using a specialized disk to create the virtual
     machine. **FromImage.** This value is used when you are using an image to create the virtual
     machine. If you are using a platform image, you should also use the imageReference element
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype os_type: str or ~azure.mgmt.computex.v2023_03_01.models.OperatingSystemTypes
        :keyword encryption_settings: Specifies the encryption settings for the OS Disk. Minimum
         api-version: 2015-06-15.
        :paramtype encryption_settings: ~azure.mgmt.computex.v2023_03_01.models.DiskEncryptionSettings
        :keyword name: The disk name.
        :paramtype name: str
        :keyword vhd: The virtual hard disk.
        :paramtype vhd: ~azure.mgmt.computex.v2023_03_01.models.VirtualHardDisk
        ...
        :paramtype diff_disk_settings: ~azure.mgmt.computex.v2023_03_01.models.DiffDiskSettings
        :keyword create_option: Specifies how the virtual machine should be created. Possible values
         are: **Attach.** This value is used when you are using a specialized disk to create the virtual
         machine. **FromImage.** This value is used when you are using an image to create the virtual
         machine. If you are using a platform image, you should also use the imageReference element
...
class OSProfile(_serialization.Model):
    ...
    :ivar windows_configuration: Specifies Windows operating system settings on the virtual
     machine.
    :vartype windows_configuration: ~azure.mgmt.computex.v2023_03_01.models.WindowsConfiguration
    ...
    :vartype linux_configuration: ~azure.mgmt.computex.v2023_03_01.models.LinuxConfiguration
    ...
    :vartype secrets: list[~azure.mgmt.computex.v2023_03_01.models.VaultSecretGroup]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword windows_configuration: Specifies Windows operating system settings on the virtual
         machine.
        :paramtype windows_configuration: ~azure.mgmt.computex.v2023_03_01.models.WindowsConfiguration
        :keyword linux_configuration: Specifies the Linux operating system settings on the virtual
         machine. For a list of supported Linux distributions, see `Linux on Azure-Endorsed
         Distributions <https://docs.microsoft.com/azure/virtual-machines/linux/endorsed-distros>`_.
        :paramtype linux_configuration: ~azure.mgmt.computex.v2023_03_01.models.LinuxConfiguration
        :keyword secrets: Specifies set of certificates that should be installed onto the virtual
         ...
         Key Vault virtual machine extension for Windows
         <https://docs.microsoft.com/azure/virtual-machines/extensions/key-vault-windows>`_.
        :paramtype secrets: list[~azure.mgmt.computex.v2023_03_01.models.VaultSecretGroup]
...
class PatchSettings(_serialization.Model):
    ...
    :vartype patch_mode: str or ~azure.mgmt.computex.v2023_03_01.models.WindowsVMGuestPatchMode
     ...
     **ImageDefault** - You control the timing of patch assessments on a virtual machine.:code:`<br
     ...
     "AutomaticByPlatform".
    :vartype assessment_mode: str or
     ~azure.mgmt.computex.v2023_03_01.models.WindowsPatchAssessmentMode
    :ivar automatic_by_platform_settings: Specifies additional settings for patch mode
     AutomaticByPlatform in VM Guest Patching on Windows.
    :vartype automatic_by_platform_settings:
     ~azure.mgmt.computex.v2023_03_01.models.WindowsVMGuestPatchAutomaticByPlatformSettings
    """
    ...
    def __init__(
        ...
        **kwargs: Any
         ...
         **AutomaticByPlatform** - the virtual machine will automatically updated by the platform. The
         properties provisionVMAgent and WindowsConfiguration.enableAutomaticUpdates must be true. Known
         values are: "Manual", "AutomaticByOS", and "AutomaticByPlatform".
        :paramtype patch_mode: str or ~azure.mgmt.computex.v2023_03_01.models.WindowsVMGuestPatchMode
...
class PublicIPAddressSku(_serialization.Model):
    ...
    :vartype name: str or ~azure.mgmt.computex.v2023_03_01.models.PublicIPAddressSkuName
    :ivar tier: Specify public IP sku tier. Known values are: "Regional", "Global", and "Global".
    :vartype tier: str or ~azure.mgmt.computex.v2023_03_01.models.PublicIPAddressSkuTier
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype name: str or ~azure.mgmt.computex.v2023_03_01.models.PublicIPAddressSkuName
        :keyword tier: Specify public IP sku tier. Known values are: "Regional", "Global", and
         "Global".
        :paramtype tier: str or ~azure.mgmt.computex.v2023_03_01.models.PublicIPAddressSkuTier
        """
        super().__init__(**kwargs)
        self.name = name
        self.tier = tier
...
class RollbackStatusInfo(_serialization.Model):
    ...
    :vartype rollback_error: ~azure.mgmt.computex.v2023_03_01.models.ApiError
    """
...
class RunCommandDocument(RunCommandDocumentBase):
    ...
    :vartype parameters:
     list[~azure.mgmt.computex.v2023_03_01.models.RunCommandParameterDefinition]
    """
...
class RunCommandInput(_serialization.Model):
    ...
    :vartype parameters: list[~azure.mgmt.computex.v2023_03_01.models.RunCommandInputParameter]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype parameters: list[~azure.mgmt.computex.v2023_03_01.models.RunCommandInputParameter]
        """
        super().__init__(**kwargs)
...
class RunCommandListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.computex.v2023_03_01.models.RunCommandDocumentBase]
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.computex.v2023_03_01.models.RunCommandDocumentBase]
...
class RunCommandResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.computex.v2023_03_01.models.InstanceViewStatus]
    """
    ...
    def __init__(self, *, value: Optional[List["_models.InstanceViewStatus"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.computex.v2023_03_01.models.InstanceViewStatus]
        """
        super().__init__(**kwargs)
        self.value = value
...
class ScheduledEventsProfile(_serialization.Model):
    ...
    :vartype terminate_notification_profile:
     ~azure.mgmt.computex.v2023_03_01.models.TerminateNotificationProfile
    ...
    :vartype os_image_notification_profile:
     ~azure.mgmt.computex.v2023_03_01.models.OSImageNotificationProfile
    """
...
class SecurityProfile(_serialization.Model):
    ...
    :vartype uefi_settings: ~azure.mgmt.computex.v2023_03_01.models.UefiSettings
    ...
    :vartype security_type: str or ~azure.mgmt.computex.v2023_03_01.models.SecurityTypes
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword uefi_settings: Specifies the security settings like secure boot and vTPM used while
         creating the virtual machine. Minimum api-version: 2020-12-01.
        :paramtype uefi_settings: ~azure.mgmt.computex.v2023_03_01.models.UefiSettings
        ...
        :keyword security_type: Specifies the SecurityType of the virtual machine. It has to be set to
         ...
         enabled unless this property is set. Known values are: "TrustedLaunch" and "ConfidentialVM".
        :paramtype security_type: str or ~azure.mgmt.computex.v2023_03_01.models.SecurityTypes
        """
        super().__init__(**kwargs)
...
class SshConfiguration(_serialization.Model):
    ...
    :vartype public_keys: list[~azure.mgmt.computex.v2023_03_01.models.SshPublicKey]
    """
    ...
    def __init__(self, *, public_keys: Optional[List["_models.SshPublicKey"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype public_keys: list[~azure.mgmt.computex.v2023_03_01.models.SshPublicKey]
        """
        super().__init__(**kwargs)
...
class StorageProfile(_serialization.Model):
    ...
    :vartype image_reference: ~azure.mgmt.computex.v2023_03_01.models.ImageReference
    :ivar os_disk: Specifies information about the operating system disk used by the virtual
     ...
     <https://docs.microsoft.com/azure/virtual-machines/managed-disks-overview>`_.
    :vartype os_disk: ~azure.mgmt.computex.v2023_03_01.models.OSDisk
    :ivar data_disks: Specifies the parameters that are used to add a data disk to a virtual
     machine. For more information about disks, see `About disks and VHDs for Azure virtual machines
     <https://docs.microsoft.com/azure/virtual-machines/managed-disks-overview>`_.
    :vartype data_disks: list[~azure.mgmt.computex.v2023_03_01.models.DataDisk]
    ...
    :vartype disk_controller_type: str or
     ~azure.mgmt.computex.v2023_03_01.models.DiskControllerTypes
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword image_reference: Specifies information about the image to use. You can specify
         ...
         is required when you want to use a platform image, marketplace image, or virtual machine image,
         but is not used in other creation operations.
        :paramtype image_reference: ~azure.mgmt.computex.v2023_03_01.models.ImageReference
        :keyword os_disk: Specifies information about the operating system disk used by the virtual
         machine. For more information about disks, see `About disks and VHDs for Azure virtual machines
         <https://docs.microsoft.com/azure/virtual-machines/managed-disks-overview>`_.
        :paramtype os_disk: ~azure.mgmt.computex.v2023_03_01.models.OSDisk
        :keyword data_disks: Specifies the parameters that are used to add a data disk to a virtual
         machine. For more information about disks, see `About disks and VHDs for Azure virtual machines
         <https://docs.microsoft.com/azure/virtual-machines/managed-disks-overview>`_.
        :paramtype data_disks: list[~azure.mgmt.computex.v2023_03_01.models.DataDisk]
...
class SubResourceWithColocationStatus(SubResource):
    ...
    :ivar colocation_status: Describes colocation status of a resource in the Proximity Placement
     Group.
    :vartype colocation_status: ~azure.mgmt.computex.v2023_03_01.models.InstanceViewStatus
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword colocation_status: Describes colocation status of a resource in the Proximity
         Placement Group.
        :paramtype colocation_status: ~azure.mgmt.computex.v2023_03_01.models.InstanceViewStatus
        """
        super().__init__(id=id, **kwargs)
...
class Usage(_serialization.Model):
    ...
    :vartype name: ~azure.mgmt.computex.v2023_03_01.models.UsageName
    """
    ...
    def __init__(self, *, current_value: int, limit: int, name: "_models.UsageName", **kwargs: Any) -> None:
        ...
        :paramtype name: ~azure.mgmt.computex.v2023_03_01.models.UsageName
        """
        super().__init__(**kwargs)
...
class VaultSecretGroup(_serialization.Model):
    ...
    :ivar vault_certificates: The list of key vault references in SourceVault which contain
     certificates.
    :vartype vault_certificates: list[~azure.mgmt.computex.v2023_03_01.models.VaultCertificate]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword vault_certificates: The list of key vault references in SourceVault which contain
         certificates.
        :paramtype vault_certificates: list[~azure.mgmt.computex.v2023_03_01.models.VaultCertificate]
        """
        super().__init__(**kwargs)
        self.source_vault = source_vault
...
class VirtualMachineNetworkInterfaceConfiguration(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype network_security_group: ~azure.mgmt.computex.v2023_03_01.models.SubResource
    :ivar dns_settings: The dns settings to be applied on the network interfaces.
    :vartype dns_settings:
     ~azure.mgmt.computex.v2023_03_01.models.VirtualMachineNetworkInterfaceDnsSettingsConfiguration
    :ivar ip_configurations: Specifies the IP configurations of the network interface.
    :vartype ip_configurations:
     list[~azure.mgmt.computex.v2023_03_01.models.VirtualMachineNetworkInterfaceIPConfiguration]
    :ivar dscp_configuration:
    :vartype dscp_configuration: ~azure.mgmt.computex.v2023_03_01.models.SubResource
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype network_security_group: ~azure.mgmt.computex.v2023_03_01.models.SubResource
        ...
        :paramtype dscp_configuration: ~azure.mgmt.computex.v2023_03_01.models.SubResource
        """
        super().__init__(**kwargs)
        self.name = name
        self.primary = primary
...
class VirtualMachineNetworkInterfaceIPConfiguration(_serialization.Model):
    ...
    :vartype subnet: ~azure.mgmt.computex.v2023_03_01.models.SubResource
    :ivar primary: Specifies the primary network interface in case the virtual machine has more
     than 1 network interface.
    :vartype primary: bool
    :ivar public_ip_address_configuration: The publicIPAddressConfiguration.
    :vartype public_ip_address_configuration:
     ~azure.mgmt.computex.v2023_03_01.models.VirtualMachinePublicIPAddressConfiguration
    ...
    :vartype private_ip_address_version: str or ~azure.mgmt.computex.v2023_03_01.models.IPVersions
    :ivar application_security_groups: Specifies an array of references to application security
     group.
    :vartype application_security_groups: list[~azure.mgmt.computex.v2023_03_01.models.SubResource]
    ...
    :vartype application_gateway_backend_address_pools:
     list[~azure.mgmt.computex.v2023_03_01.models.SubResource]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype subnet: ~azure.mgmt.computex.v2023_03_01.models.SubResource
        :keyword primary: Specifies the primary network interface in case the virtual machine has more
         than 1 network interface.
        :paramtype primary: bool
        ...
        :paramtype private_ip_address_version: str or
         ~azure.mgmt.computex.v2023_03_01.models.IPVersions
...
class VirtualMachinePublicIPAddressConfiguration(_serialization.Model):
    ...
    :vartype sku: ~azure.mgmt.computex.v2023_03_01.models.PublicIPAddressSku
    ...
    :vartype dns_settings:
     ~azure.mgmt.computex.v2023_03_01.models.VirtualMachinePublicIPAddressDnsSettingsConfiguration
    :ivar ip_tags: The list of IP tags associated with the public IP address.
    :vartype ip_tags: list[~azure.mgmt.computex.v2023_03_01.models.VirtualMachineIpTag]
    :ivar public_ip_prefix: The PublicIPPrefix from which to allocate publicIP addresses.
    :vartype public_ip_prefix: ~azure.mgmt.computex.v2023_03_01.models.SubResource
    ...
    :vartype public_ip_address_version: str or ~azure.mgmt.computex.v2023_03_01.models.IPVersions
    ...
    :vartype public_ip_allocation_method: str or
     ~azure.mgmt.computex.v2023_03_01.models.PublicIPAllocationMethod
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword sku: Describes the public IP Sku. It can only be set with OrchestrationMode as
         Flexible.
        :paramtype sku: ~azure.mgmt.computex.v2023_03_01.models.PublicIPAddressSku
        ...
        :paramtype ip_tags: list[~azure.mgmt.computex.v2023_03_01.models.VirtualMachineIpTag]
        :keyword public_ip_prefix: The PublicIPPrefix from which to allocate publicIP addresses.
        :paramtype public_ip_prefix: ~azure.mgmt.computex.v2023_03_01.models.SubResource
        :keyword public_ip_address_version: Available from Api-Version 2019-07-01 onwards, it
         represents whether the specific ipconfiguration is IPv4 or IPv6. Default is taken as IPv4.
         Possible values are: 'IPv4' and 'IPv6'. Known values are: "IPv4" and "IPv6".
        :paramtype public_ip_address_version: str or ~azure.mgmt.computex.v2023_03_01.models.IPVersions
...
class VirtualMachineRunCommand(Resource):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype source: ~azure.mgmt.computex.v2023_03_01.models.VirtualMachineRunCommandScriptSource
    :ivar parameters: The parameters used by the script.
    :vartype parameters: list[~azure.mgmt.computex.v2023_03_01.models.RunCommandInputParameter]
    :ivar protected_parameters: The parameters used by the script.
    :vartype protected_parameters:
     list[~azure.mgmt.computex.v2023_03_01.models.RunCommandInputParameter]
    ...
    :vartype output_blob_managed_identity:
     ~azure.mgmt.computex.v2023_03_01.models.RunCommandManagedIdentity
    ...
    :vartype instance_view:
     ~azure.mgmt.computex.v2023_03_01.models.VirtualMachineRunCommandInstanceView
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype source: ~azure.mgmt.computex.v2023_03_01.models.VirtualMachineRunCommandScriptSource
        :keyword parameters: The parameters used by the script.
        :paramtype parameters: list[~azure.mgmt.computex.v2023_03_01.models.RunCommandInputParameter]
...
class VirtualMachineRunCommandInstanceView(_serialization.Model):
    ...
    :vartype execution_state: str or ~azure.mgmt.computex.v2023_03_01.models.ExecutionState
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword execution_state: Script execution status. Known values are: "Unknown", "Pending",
         "Running", "Failed", "Succeeded", "TimedOut", and "Canceled".
        :paramtype execution_state: str or ~azure.mgmt.computex.v2023_03_01.models.ExecutionState
...
class VirtualMachineRunCommandsListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.computex.v2023_03_01.models.VirtualMachineRunCommand]
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.computex.v2023_03_01.models.VirtualMachineRunCommand]
...
class VirtualMachineSizeListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.computex.v2023_03_01.models.VirtualMachineSize]
    """
    ...
    def __init__(self, *, value: Optional[List["_models.VirtualMachineSize"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.computex.v2023_03_01.models.VirtualMachineSize]
        """
        super().__init__(**kwargs)
        self.value = value
...
class VMDiskSecurityProfile(_serialization.Model):
    ...
    :vartype security_encryption_type: str or
     ~azure.mgmt.computex.v2023_03_01.models.SecurityEncryptionTypes
    :ivar disk_encryption_set: Specifies the customer managed disk encryption set resource id for
...
class WindowsConfiguration(_serialization.Model):
    ...
    :vartype additional_unattend_content:
     list[~azure.mgmt.computex.v2023_03_01.models.AdditionalUnattendContent]
    :ivar patch_settings: [Preview Feature] Specifies settings related to VM Guest Patching on
     Windows.
    :vartype patch_settings: ~azure.mgmt.computex.v2023_03_01.models.PatchSettings
    :ivar win_rm: Specifies the Windows Remote Management listeners. This enables remote Windows
     PowerShell.
    :vartype win_rm: ~azure.mgmt.computex.v2023_03_01.models.WinRMConfiguration
    :ivar enable_vm_agent_platform_updates: Indicates whether VMAgent Platform Updates is enabled
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword patch_settings: [Preview Feature] Specifies settings related to VM Guest Patching on
         Windows.
        :paramtype patch_settings: ~azure.mgmt.computex.v2023_03_01.models.PatchSettings
        :keyword win_rm: Specifies the Windows Remote Management listeners. This enables remote Windows
         PowerShell.
        :paramtype win_rm: ~azure.mgmt.computex.v2023_03_01.models.WinRMConfiguration
        :keyword enable_vm_agent_platform_updates: Indicates whether VMAgent Platform Updates is
...
class WindowsVMGuestPatchAutomaticByPlatformSettings(_serialization.Model):
    ...
    :ivar reboot_setting: Specifies the reboot setting for all AutomaticByPlatform patch
     installation operations. Known values are: "Unknown", "IfRequired", "Never", and "Always".
    :vartype reboot_setting: str or
     ~azure.mgmt.computex.v2023_03_01.models.WindowsVMGuestPatchAutomaticByPlatformRebootSetting
    :ivar bypass_platform_safety_checks_on_user_schedule: Enables customer to schedule patching
     without accidental upgrades.
    :vartype bypass_platform_safety_checks_on_user_schedule: bool
    """
...
class WinRMConfiguration(_serialization.Model):
    ...
    :vartype listeners: list[~azure.mgmt.computex.v2023_03_01.models.WinRMListener]
    """
    ...
    def __init__(self, *, listeners: Optional[List["_models.WinRMListener"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype listeners: list[~azure.mgmt.computex.v2023_03_01.models.WinRMListener]
        """
        super().__init__(**kwargs)
...
class WinRMListener(_serialization.Model):
    ...
    :vartype protocol: str or ~azure.mgmt.computex.v2023_03_01.models.ProtocolTypes
    :ivar certificate_url: This is the URL of a certificate that has been uploaded to Key Vault as
     a secret. For adding a secret to the Key Vault, see `Add a key or secret to the key vault
     <https://docs.microsoft.com/azure/key-vault/key-vault-get-started/#add>`_. In this case, your
    ...
    def __init__(
        ...
        **kwargs: Any
         ...
         **https.**. Known values are: "Http" and "Https".
        :paramtype protocol: str or ~azure.mgmt.computex.v2023_03_01.models.ProtocolTypes
        :keyword certificate_url: This is the URL of a certificate that has been uploaded to Key Vault
         as a secret. For adding a secret to the Key Vault, see `Add a key or secret to the key vault
         <https://docs.microsoft.com/azure/key-vault/key-vault-get-started/#add>`_. In this case, your
         certificate needs to be the Base64 encoding of the following JSON Object which is encoded in
