...
def build_list_by_lab_request(
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2023-06-07"))
...
def build_get_request(
    resource_group_name: str, lab_name: str, schedule_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "scheduleName": _SERIALIZER.url(
            "schedule_name", schedule_name, "str", max_length=100, min_length=1, pattern=r"^[-\w\\._\\(\\)]+$"
        ),
    }
...
class SchedulesOperations:
    ...
    def list_by_lab(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.labservices.models.Schedule]
    ...
    @distributed_trace
    def get(self, resource_group_name: str, lab_name: str, schedule_name: str, **kwargs: Any) -> _models.Schedule:
        """Get a lab Schedule.
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :param schedule_name: The name of the schedule that uniquely identifies it within containing
         lab. Used in resource URIs. Required.
        :type schedule_name: str
        :param body: The request body. Is either a Schedule type or a IO type. Required.
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :param schedule_name: The name of the schedule that uniquely identifies it within containing
         lab. Used in resource URIs. Required.
        :type schedule_name: str
        :param body: The request body. Is either a ScheduleUpdate type or a IO type. Required.
