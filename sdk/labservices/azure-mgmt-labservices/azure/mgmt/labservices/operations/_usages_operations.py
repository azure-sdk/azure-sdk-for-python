...
def build_list_by_location_request(
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.LabServices/locations/{location}/usages"
...
class UsagesOperations:
    ...
    @distributed_trace
    def list_by_location(self, location: str, filter: Optional[str] = None, **kwargs: Any) -> Iterable["_models.Usage"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.labservices.models.Usage]
