...
from ...operations._fleet_databases_operations import (
    build_change_tier_request,
    build_create_or_update_request,
    build_delete_request,
    build_get_request,
    build_list_by_fleetspace_request,
...
class FleetDatabasesOperations:
    ...
    def list_by_fleetspace(
        ...
        **kwargs: Any
        ...
        :param skiptoken: An opaque token that identifies a starting point in the collection. Default
         value is None.
        :type skiptoken: str
        :return: An iterator like instance of either FleetDatabase or the result of cls(response)
        :rtype:
        ...
        cls: ClsType[_models.FleetDatabaseListResult] = kwargs.pop("cls", None)
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_fleetspace_request(
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("FleetDatabaseListResult", pipeline_response)
    ...
    async def get(
        ...
        :return: FleetDatabase or the result of cls(response)
        ...
        deserialized = self._deserialize("FleetDatabase", pipeline_response.http_response)
    ...
    async def _create_or_update_initial(
        ...
        fleetspace_name: str,
        database_name: str,
        resource: Union[_models.FleetDatabase, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "FleetDatabase")
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either FleetDatabase or the result of
         cls(response)
        :rtype:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param database_name: Name of the database. Required.
        :type database_name: str
        :param resource: The database object to create or update. Is either a FleetDatabase type or a
         IO[bytes] type. Required.
        :type resource: ~azure.mgmt.databasefleetmanager.models.FleetDatabase or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either FleetDatabase or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databasefleetmanager.models.FleetDatabase]
    ...
    async def _update_initial(
        ...
        fleetspace_name: str,
        database_name: str,
        properties: Union[_models.FleetDatabase, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "FleetDatabase")
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param database_name: Name of the database. Required.
        :type database_name: str
        :param properties: The database object to patch. Is either a FleetDatabase type or a IO[bytes]
         type. Required.
        :type properties: ~azure.mgmt.databasefleetmanager.models.FleetDatabase or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either FleetDatabase or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databasefleetmanager.models.FleetDatabase]
    ...
    async def _change_tier_initial(
        ...
        fleetspace_name: str,
        database_name: str,
        body: Union[_models.DatabaseChangeTierProperties, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "DatabaseChangeTierProperties")

        _request = build_change_tier_request(
            resource_group_name=resource_group_name,
            fleet_name=fleet_name,
            fleetspace_name=fleetspace_name,
            database_name=database_name,
    ...
    async def begin_change_tier(
        ...
        **kwargs: Any
        ...
        :param database_name: Name of the database. Required.
        :type database_name: str
        :param body: The details of the change tier operation. Is either a DatabaseChangeTierProperties
         type or a IO[bytes] type. Required.
        :type body: ~azure.mgmt.databasefleetmanager.models.DatabaseChangeTierProperties or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def _rename_initial(
        ...
        fleetspace_name: str,
        database_name: str,
        body: Union[_models.DatabaseRenameProperties, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "DatabaseRenameProperties")
    ...
    async def begin_rename(
        ...
        **kwargs: Any
        ...
        :param database_name: Name of the database. Required.
        :type database_name: str
        :param body: The details of the rename operation. Is either a DatabaseRenameProperties type or
         a IO[bytes] type. Required.
        :type body: ~azure.mgmt.databasefleetmanager.models.DatabaseRenameProperties or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
