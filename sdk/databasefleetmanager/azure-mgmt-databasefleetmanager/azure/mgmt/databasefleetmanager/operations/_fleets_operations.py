...
def build_list_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.DatabaseFleetManager/fleets")
...
class FleetsOperations:
    ...
    def _create_or_update_initial(
        self, resource_group_name: str, fleet_name: str, resource: Union[_models.Fleet, IO[bytes]], **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def begin_create_or_update(
        ...
        :param fleet_name: Name of the database fleet. Required.
        :type fleet_name: str
        :param resource: The fleet object to create or update. Is either a Fleet type or a IO[bytes]
         type. Required.
        :type resource: ~azure.mgmt.databasefleetmanager.models.Fleet or IO[bytes]
        :return: An instance of LROPoller that returns either Fleet or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.databasefleetmanager.models.Fleet]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        fleet_name: str,
        properties: Union[_models.FleetUpdate, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "FleetUpdate")
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param fleet_name: Name of the database fleet. Required.
        :type fleet_name: str
        :param properties: The fleet object to patch. Is either a FleetUpdate type or a IO[bytes] type.
         Required.
        :type properties: ~azure.mgmt.databasefleetmanager.models.FleetUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either Fleet or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.databasefleetmanager.models.Fleet]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
