...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "fleetName": _SERIALIZER.url("fleet_name", fleet_name, "str", pattern=r"^.+$"),
        "fleetspaceName": _SERIALIZER.url("fleetspace_name", fleetspace_name, "str", pattern=r"^.+$"),
        "firewallRuleName": _SERIALIZER.url("firewall_rule_name", firewall_rule_name, "str", pattern=r"^.+$"),
    }
...
class FirewallRulesOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param firewall_rule_name: Name of the firewall rule. Required.
        :type firewall_rule_name: str
        :param resource: The firewall rule object to create or update. Is either a FirewallRule type or
         a IO[bytes] type. Required.
        :type resource: ~azure.mgmt.databasefleetmanager.models.FirewallRule or IO[bytes]
        :return: An instance of LROPoller that returns either FirewallRule or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.databasefleetmanager.models.FirewallRule]
        :raises ~azure.core.exceptions.HttpResponseError:
