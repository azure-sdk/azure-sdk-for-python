...
class TestDatabaseFleetManagerFirewallRulesOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_firewall_rules_list_by_fleetspace(self, resource_group):
