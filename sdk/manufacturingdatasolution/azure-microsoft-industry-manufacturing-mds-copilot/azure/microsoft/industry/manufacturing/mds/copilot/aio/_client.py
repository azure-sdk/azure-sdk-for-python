...
class CopilotServiceClient(CopilotServiceClientOperationsMixin):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype operation_api:
     azure.microsoft.industry.manufacturing.mds.copilot.aio.operations.OperationApiOperations
    :ivar example_query_operations: ExampleQueryOperationsOperations operations
    :vartype example_query_operations:
     azure.microsoft.industry.manufacturing.mds.copilot.aio.operations.ExampleQueryOperationsOperations
    :ivar aliases: AliasesOperations operations
    :vartype aliases:
     azure.microsoft.industry.manufacturing.mds.copilot.aio.operations.AliasesOperations
    ...
    :vartype validate_query_api:
     azure.microsoft.industry.manufacturing.mds.copilot.aio.operations.ValidateQueryApiOperations
