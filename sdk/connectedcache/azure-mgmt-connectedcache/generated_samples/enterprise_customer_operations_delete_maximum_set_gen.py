...
# USAGE
    python enterprise_customer_operations_delete_maximum_set_gen.py
...
def main():
    ...
    client.enterprise_customer_operations.delete(
        resource_group_name="rgConnectedCache",
        customer_resource_name="jeubxmhiaihcusgnahblvvckbdcetacvqgwbohlrqucodtlwuyefpejskvamgrdnwgucziodcfpjhqy",
    )
