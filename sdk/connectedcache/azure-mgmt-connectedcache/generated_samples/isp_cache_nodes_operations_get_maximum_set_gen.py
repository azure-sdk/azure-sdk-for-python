...
# USAGE
    python isp_cache_nodes_operations_get_maximum_set_gen.py
...
def main():
    ...
    response = client.isp_cache_nodes_operations.get(
        resource_group_name="rgConnectedCache",
        customer_resource_name="sgtqjsitdrskmgyrrkntszwrrjjkretscpjgaezraucvcwececlelcsorfunrnvxyxcsrg",
        cache_node_resource_name="lbsziwmudcjnwnwy",
    )
    print(response)
