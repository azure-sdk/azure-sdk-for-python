...
class TestHealthcareApisManagementPrivateLinkResourcesOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(HealthcareApisManagementClient, is_async=True)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_private_link_resources_list_by_service(self, resource_group):
        response = await self.client.private_link_resources.list_by_service(
