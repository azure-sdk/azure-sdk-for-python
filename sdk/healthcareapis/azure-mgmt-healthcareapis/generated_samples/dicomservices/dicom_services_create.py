...
# USAGE
    python dicom_services_create.py
...
def main():
    ...
    response = client.dicom_services.begin_create_or_update(
...
# x-ms-original-file: specification/healthcareapis/resource-manager/Microsoft.HealthcareApis/preview/2025-04-01-preview/examples/dicomservices/DicomServices_Create.json
