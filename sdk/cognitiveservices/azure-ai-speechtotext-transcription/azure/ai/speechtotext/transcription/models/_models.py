...
class LanguageIdentificationProperties(_model_base.Model):
    ...
    :ivar mode: The mode used for language identification. Known values are: "Continuous" and
     "Single".
    :vartype mode: str or ~azure.ai.speechtotext.transcription.models.LanguageIdentificationMode
    ...
    :vartype speech_model_mapping: dict[str,
     ~azure.ai.speechtotext.transcription.models.EntityReference]
    """
...
class TranscribeConfig(_model_base.Model):
    ...
    :vartype profanity_filter_mode: str or
     ~azure.ai.speechtotext.transcription.models.ProfanityFilterMode
    :ivar diarization_properties: Mode of diarization.
    :vartype diarization_properties:
     ~azure.ai.speechtotext.transcription.models.TranscribeDiarizationProperties
    ...
    diarization_properties: Optional["_models.TranscribeDiarizationProperties"] = rest_field(
    ...
    def __init__(
        ...
        *,
        ...
        diarization_properties: Optional["_models.TranscribeDiarizationProperties"] = None,
...
class TranscribedPhrase(_model_base.Model):
    ...
    :ivar words: The words that make up the phrase. Only present if word-level timestamps are
     enabled.
    :vartype words: list[~azure.ai.speechtotext.transcription.models.TranscribedWord]
...
class TranscribeResult(_model_base.Model):
    ...
    :vartype combined_phrases:
     list[~azure.ai.speechtotext.transcription.models.ChannelCombinedPhrases]
    :ivar phrases: The transcription results segmented into phrases. Required.
    :vartype phrases: list[~azure.ai.speechtotext.transcription.models.TranscribedPhrase]
    """
...
class TranscriptionFile(_model_base.Model):
    ...
    :ivar kind: FileKind. Required. Known values are: "AcousticDataArchive",
     ...
     "TranscriptionReport".
    :vartype kind: str or ~azure.ai.speechtotext.transcription.models.FileKind
    :ivar links: FileLinks. Required.
    :vartype links: ~azure.ai.speechtotext.transcription.models.FileLinks
    :ivar display_name: The name of this file. Required.
    :vartype display_name: str
    :ivar properties: FileProperties. Required.
    :vartype properties: ~azure.ai.speechtotext.transcription.models.FileProperties
...
class TranscriptionJob(_model_base.Model):
    ...
    :vartype links: ~azure.ai.speechtotext.transcription.models.TranscriptionLinks
    :ivar properties: TranscriptionProperties. Required.
    :vartype properties: ~azure.ai.speechtotext.transcription.models.TranscriptionProperties
    :ivar id: The id of this entity. Required.
    :vartype id: str
    :ivar self_property: The location of this entity. Required.
    :vartype self_property: str
    :ivar model: EntityReference.
    :vartype model: ~azure.ai.speechtotext.transcription.models.EntityReference
    :ivar dataset: EntityReference.
    :vartype dataset: ~azure.ai.speechtotext.transcription.models.EntityReference
    ...
    :vartype status: str or ~azure.ai.speechtotext.transcription.models.JobStatus
    ...
    """A list of content urls to get audio files to transcribe. Up to 1000 urls are allowed.
     This property will not be returned in a response."""
    content_container_url: Optional[str] = rest_field(
...
class TranscriptionProperties(_model_base.Model):
    ...
    :vartype punctuation_mode: str or ~azure.ai.speechtotext.transcription.models.PunctuationMode
    :ivar profanity_filter_mode: Mode of profanity filtering. Known values are: "None", "Removed",
     "Tags", and "Masked".
    :vartype profanity_filter_mode: str or
     ~azure.ai.speechtotext.transcription.models.ProfanityFilterMode
    ...
    :vartype error: ~azure.ai.speechtotext.transcription.models.EntityError
    :ivar diarization: Speaker Identification.
    :vartype diarization: ~azure.ai.speechtotext.transcription.models.DiarizationProperties
    :ivar language_identification_properties: LanguageIdentificationProperties.
    :vartype language_identification_properties:
     ~azure.ai.speechtotext.transcription.models.LanguageIdentificationProperties
    """
