...
class Phrase(_model_base.Model):
    ...
    :ivar words: The words that make up the phrase. Only present if word-level timestamps are
     enabled.
    :vartype words: list[~azure.ai.speechtotext.fasttranscription.models.Word]
...
class TranscribeDefinition(_model_base.Model):
    ...
    :vartype profanity_filter_mode: str or
     ~azure.ai.speechtotext.fasttranscription.models.ProfanityFilterMode
    :ivar diarization: Mode of diarization.
    :vartype diarization:
     ~azure.ai.speechtotext.fasttranscription.models.TranscribeDiarizationProperties
...
class TranscribeResult(_model_base.Model):
    ...
    :vartype combined_phrases:
     list[~azure.ai.speechtotext.fasttranscription.models.ChannelCombinedPhrases]
    :ivar phrases: The transcription results segmented into phrases. Required.
    :vartype phrases: list[~azure.ai.speechtotext.fasttranscription.models.Phrase]
    """
