...
from ..._operations._operations import (
    build_image_analysis_analyze_from_stream_request,
    build_image_analysis_analyze_from_url_request,
    build_image_analysis_segment_from_stream_request,
    build_image_analysis_segment_from_url_request,
)
...
class ImageAnalysisClientOperationsMixin(ImageAnalysisClientMixinABC):
    ...
    async def analyze_from_stream(
        ...
        **kwargs: Any
        ...
        :keyword visual_features: A string indicating what visual feature types to return. Multiple
         ...
         DenseCaptions, Objects, Read, SmartCrops, People. If VisualFeatures is not specified, then
         Categories, Tags, and Description are included in the response by default. Default value is
         None.
        ...
        request = build_image_analysis_analyze_from_stream_request(
    ...
    async def analyze_from_url(
        ...
        **kwargs: Any
        ...
        request = build_image_analysis_analyze_from_url_request(
            visual_features=visual_features,
            model_name=model_name,
            language=language,
            smart_crops_aspect_ratios=smart_crops_aspect_ratios,
    ...
    async def segment_from_url(
        ...
        **kwargs: Any
        ...
        request = build_image_analysis_segment_from_url_request(
            mode=mode,
            content_type=content_type,
            api_version=self._config.api_version,
            content=_content,
    ...
    async def segment_from_stream(
        ...
        request = build_image_analysis_segment_from_stream_request(
            mode=mode,
            content_type=content_type,
            api_version=self._config.api_version,
            content=_content,
