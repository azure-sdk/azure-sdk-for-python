...
class BatchTranscriptionClientConfiguration:  # pylint: disable=too-many-instance-attributes
    """Configuration for BatchTranscriptionClient.
    ...
    def __init__(self, endpoint: str, credential: AzureKeyCredential, **kwargs: Any) -> None:
        ...
        kwargs.setdefault("sdk_moniker", "ai-batchtranscription/{}".format(VERSION))
