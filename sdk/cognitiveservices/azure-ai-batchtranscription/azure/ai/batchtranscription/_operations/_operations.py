...
def build_batch_transcription_start_transcription_request(  # pylint: disable=name-too-long
    **kwargs: Any,
) -> HttpRequest:
...
def build_batch_transcription_list_transcriptions_request(  # pylint: disable=name-too-long
...
def build_batch_transcription_list_transcription_files_request(  # pylint: disable=name-too-long
...
class BatchTranscriptionClientOperationsMixin(BatchTranscriptionClientMixinABC):
    ...
    def list_transcriptions(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.batchtranscription.models.TranscriptionJob]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_transcription_files(
        ...
        **kwargs: Any,
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.batchtranscription.models.TranscriptionFile]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
