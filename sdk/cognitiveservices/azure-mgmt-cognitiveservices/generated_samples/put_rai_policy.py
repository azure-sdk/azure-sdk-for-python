    ...
    response = client.rai_policies.create_or_update(
        ...
        rai_policy={
            "properties": {
                "basePolicyName": "112",
                "contentFilters": [
                    {"allowedContentLevel": "Low", "blocking": True, "name": "hate"},
                    {"allowedContentLevel": "Low", "name": "sexual"},
                    {"enabled": False, "name": "violence"},
                    {"enabled": False, "name": "DefaultHateSpeechBlockList"},
                ],
            }
        },
    )
