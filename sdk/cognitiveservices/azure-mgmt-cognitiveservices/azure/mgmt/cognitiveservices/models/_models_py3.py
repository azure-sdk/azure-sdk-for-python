...
class DeploymentProperties(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar capacity_settings: The maps to reserved Capacity for fungible deployments (MSS).
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword capacity_settings: The maps to reserved Capacity for fungible deployments (MSS).
