...
class AccountProperties(_serialization.Model):
    ...
    :ivar allow_project_management: Specifies whether projects are managed as child resources, as
     containers for access management, data isolation and cost.
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :keyword allow_project_management: Specifies whether projects are managed as child resources,
         as containers for access management, data isolation and cost.
...
class NetworkInjections(_serialization.Model):
    ...
    :ivar scenario: Specifies what features in AI Foundry network injection applies to. Currently
     only supports 'agent'. "agent"
    :vartype scenario: str or ~azure.mgmt.cognitiveservices.models.Scenario
    :ivar subnet_arm_id: Specify the subnet for which you Agent Client is injected into.
    ...
    def __init__(
        self,
        *,
        scenario: Optional[Union[str, "_models.Scenario"]] = None,
        subnet_arm_id: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword scenario: Specifies what features in AI Foundry network injection applies to.
         Currently only supports 'agent'. "agent"
        :paramtype scenario: str or ~azure.mgmt.cognitiveservices.models.Scenario
        :keyword subnet_arm_id: Specify the subnet for which you Agent Client is injected into.
