...
class ProjectsOperations:
    ...
    def _create_initial(
        ...
        account_name: str,
        project_name: str,
        project: Union[_models.Account, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        ...
        if isinstance(project, (IOBase, bytes)):
            ...
            _json = self._serialize.body(project, "Account")
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type project: ~azure.mgmt.cognitiveservices.models.Account
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param project_name: The name of Cognitive Services account's project. Required.
        :type project_name: str
        :param project: The parameters to provide for the created project. Is either a Account type or
         a IO[bytes] type. Required.
        :type project: ~azure.mgmt.cognitiveservices.models.Account or IO[bytes]
        :return: An instance of LROPoller that returns either Account or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.cognitiveservices.models.Account]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace
    def get(self, resource_group_name: str, account_name: str, project_name: str, **kwargs: Any) -> _models.Account:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, account_name: str, **kwargs: Any) -> Iterable["_models.Account"]:
