...
class ImageAnalysisClientConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes,name-too-long
    ...
    def __init__(self, endpoint: str, credential: AzureKeyCredential, **kwargs: Any) -> None:
        super(ImageAnalysisClientConfiguration, self).__init__(**kwargs)
