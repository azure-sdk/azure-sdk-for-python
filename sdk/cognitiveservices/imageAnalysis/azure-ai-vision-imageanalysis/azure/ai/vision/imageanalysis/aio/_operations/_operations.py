...
class ImageAnalysisClientOperationsMixin(ImageAnalysisClientMixinABC):
    ...
    async def analyze_from_stream(
        ...
        **kwargs: Any
        ...
        :keyword content_type: The format of the image stream. Default value is
    ...
    async def segment_from_url(
        self, image_contents: _models.ImageUrl, *, mode: Union[str, _models.SegmentationMode], **kwargs: Any
    ) -> bytes:
    ...
    async def segment_from_stream(
        self, image_contents: bytes, *, mode: Union[str, _models.SegmentationMode], **kwargs: Any
    ) -> bytes:
        """Segment the input image. An image stream of content type 'image/png' is returned, where the
        pixel values depend on the analysis mode. The returned image has the same dimensions as the
        input image for modes: foregroundMatting. The returned image has the same aspect ratio and same
