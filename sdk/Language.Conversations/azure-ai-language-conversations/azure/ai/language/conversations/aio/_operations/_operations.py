...
class WidgetManagerClientOperationsMixin(WidgetManagerClientMixinABC):
    ...
    async def _get_widget_operation_status_initial(  # pylint: disable=inconsistent-return-statements
    ...
    @distributed_trace_async
    async def begin_get_widget_operation_status(
        self, widget_name: str, operation_id: str, **kwargs: Any
    ) -> AsyncLROPoller[None]:
        ...
        if cont_token is None:
            raw_result = await self._get_widget_operation_status_initial(  # type: ignore
                widget_name=widget_name,
                operation_id=operation_id,
                cls=lambda x, y, z: x,
                headers=_headers,
    ...
    async def begin_create_or_update_widget(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns Widget. The Widget is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.ai.language.conversations.models.Widget]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_widgets(self, **kwargs: Any) -> AsyncIterable["_models.Widget"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.ai.language.conversations.models.Widget]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
