...
class AzureContainerStorageRPForTestingConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long
    """Configuration for AzureContainerStorageRPForTesting.
