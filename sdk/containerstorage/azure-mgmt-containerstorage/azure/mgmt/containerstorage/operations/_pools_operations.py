...
class PoolsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.containerstorage.AzureContainerStorageRPForTesting`'s
    ...
    def _create_or_update_initial(
        self, resource_group_name: str, pool_name: str, resource: Union[_models.Pool, IO[bytes]], **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def begin_create_or_update(
        ...
        :param resource: Resource create parameters. Is either a Pool type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.containerstorage.models.Pool or IO[bytes]
        :return: An instance of LROPoller that returns either Pool or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.containerstorage.models.Pool]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _update_initial(
        self, resource_group_name: str, pool_name: str, properties: Union[_models.PoolUpdate, IO[bytes]], **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def begin_update(
        ...
        :param pool_name: Pool Object. Required.
        :type pool_name: str
        :param properties: The resource properties to be updated. Is either a PoolUpdate type or a
         IO[bytes] type. Required.
        :type properties: ~azure.mgmt.containerstorage.models.PoolUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either Pool or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.containerstorage.models.Pool]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
