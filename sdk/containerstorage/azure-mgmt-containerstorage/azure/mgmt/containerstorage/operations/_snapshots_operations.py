...
class SnapshotsOperations:
    ...
    def _create_or_update_initial(
        ...
        pool_name: str,
        snapshot_name: str,
        resource: Union[_models.Snapshot, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param snapshot_name: Volume Snapshot Resource. Required.
        :type snapshot_name: str
        :param resource: Resource create parameters. Is either a Snapshot type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.containerstorage.models.Snapshot or IO[bytes]
        :return: An instance of LROPoller that returns either Snapshot or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.containerstorage.models.Snapshot]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
