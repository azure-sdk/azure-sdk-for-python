...
class StorageLifecyclePolicyCompletedEventData(_model_base.Model):
    ...
    policy_run_summary: "_models.StorageLifecyclePolicyRunSummary" = rest_field(name="policyRunSummary")
...
class StorageLifecyclePolicyRunSummary(_model_base.Model):
    ...
    completion_status: Union[str, "_models.StorageLifecycleCompletionStatus"] = rest_field(name="completionStatus")
