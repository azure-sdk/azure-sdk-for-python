...
class AcsChatMessageEditedEventData(AcsChatMessageEventBaseProperties):
    ...
    message_body: Optional[str] = rest_field(
        name="messageBody", visibility=["read", "create", "update", "delete", "query"]
    )
...
class AcsEmailEngagementTrackingReportReceivedEventData(_model_base.Model):  # pylint: disable=name-too-long
    ...
    engagement_type: Union[str, "_models.AcsUserEngagement"] = rest_field(
...
class AcsIncomingCallEventData(_model_base.Model):
    ...
    to: "_models.CommunicationIdentifierModel" = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """The communication identifier of the target user. Required."""
    from_property: "_models.CommunicationIdentifierModel" = rest_field(
...
class AcsMessageDeliveryStatusUpdatedEventData(AcsMessageEventData):
    ...
    channel_type: Union[str, "_models.AcsMessageChannelKind"] = rest_field(
...
class AcsRecordingFileStatusUpdatedEventData(_model_base.Model):
    ...
    recording_content_type: Union[str, "_models.RecordingContentType"] = rest_field(
    ...
    """The recording content type- AudioVideo, or Audio. Required. Known values are: \"AudioVideo\"
     and \"Audio\"."""
    recording_channel_type: Union[str, "_models.RecordingChannelType"] = rest_field(
    ...
    """The recording  channel type - Mixed, Unmixed. Required. Known values are: \"Mixed\" and
     \"Unmixed\"."""
    recording_format_type: Union[str, "_models.RecordingFormatType"] = rest_field(
...
class AcsRecordingStorageInfoProperties(_model_base.Model):
    ...
    recording_chunks: List["_models.AcsRecordingChunkInfoProperties"] = rest_field(
        name="recordingChunks", visibility=["read", "create", "update", "delete", "query"]
    )
...
class AcsRouterJobClassifiedEventData(AcsRouterJobEventData):
    ...
    attached_worker_selectors: List["_models.AcsRouterWorkerSelector"] = rest_field(
        name="attachedWorkerSelectors", visibility=["read", "create", "update", "delete", "query"]
    )
...
class AcsRouterJobSchedulingFailedEventData(AcsRouterJobEventData):
    ...
    expired_attached_worker_selectors: List["_models.AcsRouterWorkerSelector"] = rest_field(
        name="expiredAttachedWorkerSelectors", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    expired_requested_worker_selectors: List["_models.AcsRouterWorkerSelector"] = rest_field(
        name="expiredRequestedWorkerSelectors", visibility=["read", "create", "update", "delete", "query"]
    )
...
class AcsRouterWorkerRegisteredEventData(_model_base.Model):
    ...
    queue_assignments: List["_models.AcsRouterQueueDetails"] = rest_field(
        name="queueAssignments", visibility=["read", "create", "update", "delete", "query"]
    )
    """Router Worker Registered Queue Info. Required."""
    channel_configurations: List["_models.AcsRouterChannelConfiguration"] = rest_field(
        name="channelConfigurations", visibility=["read", "create", "update", "delete", "query"]
    )
...
class AcsRouterWorkerUpdatedEventData(_model_base.Model):
    ...
    updated_worker_properties: List[Union[str, "_models.AcsRouterUpdatedWorkerProperty"]] = rest_field(
        name="updatedWorkerProperties", visibility=["read", "create", "update", "delete", "query"]
    )
...
class AcsSmsDeliveryAttemptProperties(_model_base.Model):
    ...
    segments_succeeded: Optional[int] = rest_field(
        name="segmentsSucceeded", visibility=["read", "create", "update", "delete", "query"]
    )
    """Number of segments that were successfully delivered."""
    segments_failed: Optional[int] = rest_field(
        name="segmentsFailed", visibility=["read", "create", "update", "delete", "query"]
    )
...
class AcsSmsDeliveryReportReceivedEventData(AcsSmsEventBaseProperties):
    ...
    delivery_status: Optional[str] = rest_field(
        name="deliveryStatus", visibility=["read", "create", "update", "delete", "query"]
    )
    """Status of Delivery."""
    delivery_status_details: Optional[str] = rest_field(
        name="deliveryStatusDetails", visibility=["read", "create", "update", "delete", "query"]
    )
    """Details about Delivery Status."""
    delivery_attempts: List["_models.AcsSmsDeliveryAttemptProperties"] = rest_field(
        name="deliveryAttempts", visibility=["read", "create", "update", "delete", "query"]
    )
...
class AppConfigurationKeyValueDeletedEventData(_model_base.Model):
    ...
    sync_token: Optional[str] = rest_field(name="syncToken", visibility=["read", "create", "update", "delete", "query"])
...
class AppEventTypeDetail(_model_base.Model):
    ...
    action: Union[str, "_models.AppAction"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
...
class AppServicePlanEventTypeDetail(_model_base.Model):
    ...
    stamp_kind: Union[str, "_models.StampKind"] = rest_field(
    ...
    status: Union[str, "_models.AsyncStatus"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
...
class AvsClusterEventData(_model_base.Model):
    ...
    added_host_names: Optional[List[str]] = rest_field(
        name="addedHostNames", visibility=["read", "create", "update", "delete", "query"]
    )
    """Hosts added to the cluster in this event, if any."""
    removed_host_names: Optional[List[str]] = rest_field(
        name="removedHostNames", visibility=["read", "create", "update", "delete", "query"]
    )
    """Hosts removed from the cluster in this event, if any."""
    in_maintenance_host_names: Optional[List[str]] = rest_field(
        name="inMaintenanceHostNames", visibility=["read", "create", "update", "delete", "query"]
    )
...
class CommunicationIdentifierModel(_model_base.Model):
    ...
    raw_id: Optional[str] = rest_field(name="rawId", visibility=["read", "create", "update", "delete", "query"])
    ...
    phone_number: "_models.PhoneNumberIdentifierModel" = rest_field(
        name="phoneNumber", visibility=["read", "create", "update", "delete", "query"]
    )
    """The phone number. Required."""
    microsoft_teams_user: "_models.MicrosoftTeamsUserIdentifierModel" = rest_field(
        name="microsoftTeamsUser", visibility=["read", "create", "update", "delete", "query"]
    )
    """The Microsoft Teams user. Required."""
    microsoft_teams_app: "_models.MicrosoftTeamsAppIdentifierModel" = rest_field(
...
class ContainerServiceNewKubernetesVersionAvailableEventData(_model_base.Model):  # pylint: disable=name-too-long
    ...
    latest_supported_kubernetes_version: Optional[str] = rest_field(
    ...
    """The highest PATCH Kubernetes version for the highest MINOR version supported by ManagedCluster
     resource."""
    latest_stable_kubernetes_version: Optional[str] = rest_field(
    ...
    lowest_minor_kubernetes_version: Optional[str] = rest_field(
...
class ContainerServiceNodePoolRollingEventData(_model_base.Model):
    ...
    node_pool_name: Optional[str] = rest_field(
        name="nodePoolName", visibility=["read", "create", "update", "delete", "query"]
    )
...
class EventGridMQTTClientEventData(_model_base.Model):
    ...
    """Unique identifier for the MQTT client that the client presents to the service
     for authentication. This case-sensitive string can be up to 128 characters
     long, and supports UTF-8 characters. Required."""
    client_name: str = rest_field(name="clientName", visibility=["read", "create", "update", "delete", "query"])
...
class EventHubCaptureFileCreatedEventData(_model_base.Model):
    ...
    file_url: Optional[str] = rest_field(name="fileUrl", visibility=["read", "create", "update", "delete", "query"])
    ...
    partition_id: Optional[str] = rest_field(
        name="partitionId", visibility=["read", "create", "update", "delete", "query"]
    )
    """The shard ID."""
    ...
    """The file size."""
    event_count: Optional[int] = rest_field(
        name="eventCount", visibility=["read", "create", "update", "delete", "query"]
    )
    """The number of events in the file."""
    first_sequence_number: Optional[int] = rest_field(
        name="firstSequenceNumber", visibility=["read", "create", "update", "delete", "query"]
    )
    """The smallest sequence number from the queue."""
    last_sequence_number: Optional[int] = rest_field(
...
class HealthcareFhirResourceCreatedEventData(_model_base.Model):
    ...
    resource_type: Union[str, "_models.HealthcareFhirResourceType"] = rest_field(
    ...
    """Type of HL7 FHIR resource. Required. Known values are: \"Account\", \"ActivityDefinition\",
     ...
     \"SupplyDelivery\", \"SupplyRequest\", \"Task\", \"TerminologyCapabilities\", \"TestReport\",
     \"TestScript\", \"ValueSet\", \"VerificationResult\", and \"VisionPrescription\"."""
    resource_fhir_account: str = rest_field(
...
class MachineLearningServicesDatasetDriftDetectedEventData(_model_base.Model):  # pylint: disable=name-too-long
    ...
    data_drift_id: Optional[str] = rest_field(
        name="dataDriftId", visibility=["read", "create", "update", "delete", "query"]
    )
    """The ID of the data drift monitor that triggered the event."""
    data_drift_name: Optional[str] = rest_field(
        name="dataDriftName", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    base_dataset_id: Optional[str] = rest_field(
        name="baseDatasetId", visibility=["read", "create", "update", "delete", "query"]
    )
    """The ID of the base Dataset used to detect drift."""
    target_dataset_id: Optional[str] = rest_field(
        name="targetDatasetId", visibility=["read", "create", "update", "delete", "query"]
    )
    """The ID of the target Dataset used to detect drift."""
    drift_coefficient: Optional[float] = rest_field(
...
class MachineLearningServicesRunCompletedEventData(_model_base.Model):  # pylint: disable=name-too-long
    ...
    run_tags: Dict[str, Any] = rest_field(name="runTags", visibility=["read", "create", "update", "delete", "query"])
    """The tags of the completed Run. Required."""
    run_properties: Dict[str, Any] = rest_field(
...
class MachineLearningServicesRunStatusChangedEventData(_model_base.Model):  # pylint: disable=name-too-long
    ...
    run_status: Optional[str] = rest_field(name="runStatus", visibility=["read", "create", "update", "delete", "query"])
...
class MapsGeofenceEventProperties(_model_base.Model):
    ...
    expired_geofence_geometry_id: List[str] = rest_field(
        name="expiredGeofenceGeometryId", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    invalid_period_geofence_geometry_id: List[str] = rest_field(
        name="invalidPeriodGeofenceGeometryId", visibility=["read", "create", "update", "delete", "query"]
    )
...
class ResourceNotificationsResourceUpdatedEventData(_model_base.Model):  # pylint: disable=name-too-long
    ...
    resource_info: "_models.ResourceNotificationsResourceUpdatedDetails" = rest_field(
        name="resourceInfo", visibility=["read", "create", "update", "delete", "query"]
    )
    """resourceInfo details for update event. Required."""
    operational_info: "_models.ResourceNotificationsOperationalDetails" = rest_field(
...
class ResourceNotificationsResourceDeletedEventData(_model_base.Model):  # pylint: disable=name-too-long
    ...
    resource_info: "_models.ResourceNotificationsResourceDeletedDetails" = rest_field(
        name="resourceInfo", visibility=["read", "create", "update", "delete", "query"]
    )
...
class WebAppUpdatedEventData(_model_base.Model):
    ...
    app_event_type_detail: "_models.AppEventTypeDetail" = rest_field(
