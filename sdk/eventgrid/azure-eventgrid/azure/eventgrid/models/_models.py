...
class AcsChatAzureBotCommandEventData(AcsChatMessageEventInThreadBaseProperties):
    """Schema of the Data property of an EventGridEvent for a
    Microsoft.Communication.ChatAzureBotCommand event.
...
class CommunicationIdentifierModel(_model_base.Model):
    ...
    microsoft_teams_app: Optional["_models.MicrosoftTeamsAppIdentifierModel"] = rest_field(name="microsoftTeamsApp")
