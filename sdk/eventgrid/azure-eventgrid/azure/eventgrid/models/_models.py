...
class AcsMessageMediaContent(_model_base.Model):
    ...
    :vartype caption: str
    :ivar animated: Set to  true if the sticker is animated;  false otherwise.
    ...
    animated: Optional[bool] = rest_field()
...
class AcsMessageReactionContent(_model_base.Model):
    """Message Reaction Content.

    :ivar message_id: WhatsApp message ID of message you want to apply the emoji to.
    :vartype message_id: str
    :ivar emoji: Unicode escape sequence of the emoji.
    :vartype emoji: str
    """

    message_id: Optional[str] = rest_field(name="messageId")
    """WhatsApp message ID of message you want to apply the emoji to."""
    emoji: Optional[str] = rest_field()
...
class AcsMessageReceivedEventData(AcsMessageEventData):
    ...
    :vartype content: str
    :ivar message_type: WhatsApp message type.
    ...
    :ivar reaction: The received message reaction content. Required.
    ...
    """The message content."""
    message_type: Optional[str] = rest_field(name="messageType")
    ...
    reaction: "_models.AcsMessageReactionContent" = rest_field()
    """The received message reaction content. Required."""
    ...
    def __init__(
        ...
        *,
        ...
        reaction: "_models.AcsMessageReactionContent",
