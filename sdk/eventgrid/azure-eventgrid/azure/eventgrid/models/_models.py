...
class StorageBlobTierChangedEventData(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar blob_type: The type of blob.
    :vartype blob_type: str
    :ivar access_tier: The current tier of the blob.
    :vartype access_tier: str
    :ivar previous_tier: The previous tier of the blob.
    :vartype previous_tier: str
    :ivar url: The path to the blob.
    :vartype url: str
    :ivar sequencer: An opaque string value representing the logical sequence of events for any
     particular blob name. Users can use standard string comparison to understand the relative
    ...
    blob_type: Optional[str] = rest_field(name="blobType")
    """The type of blob."""
    access_tier: Optional[str] = rest_field(name="accessTier")
    """The current tier of the blob."""
    previous_tier: Optional[str] = rest_field(name="previousTier")
