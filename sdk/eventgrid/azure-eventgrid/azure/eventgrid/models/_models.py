...
class AcsEmailDeliveryReportReceivedEventData(_model_base.Model):
    ...
    internet_message_id: str = rest_field(name="internetMessageId")
...
class AcsEmailDeliveryReportStatusDetails(_model_base.Model):
    ...
    recipient_mail_server_host_name: Optional[str] = rest_field(name="recipientMailServerHostName")
...
class AcsMessageInteractiveContent(_model_base.Model):
    ...
    """The Message interactive reply type. Required. Known values are: \"buttonReply\", \"listReply\",
     and \"unknown\"."""
    button_reply: Optional["_models.AcsMessageInteractiveButtonReplyContent"] = rest_field(name="buttonReply")
    """The Message Sent when a customer clicks a button."""
    list_reply: Optional["_models.AcsMessageInteractiveListReplyContent"] = rest_field(name="listReply")
...
class AcsMessageMediaContent(_model_base.Model):
    ...
    :ivar id: Required. The media identifier. Required.
    :vartype id: str
...
class AcsMessageReceivedEventData(AcsMessageEventData):
    ...
    :vartype message_id: str
    :ivar channel_type: Required. The message channel type. Required. "whatsapp"
    :vartype channel_type: str or ~azure.eventgrid.models.AcsMessageChannelKind
    :ivar message_type: Required. Whatsapp message type. Required.
    :vartype message_type: str
    :ivar media: Optional. The received message media content.
    ...
    :ivar interactive: Optional. The received message interactive content.
    ...
    message_type: str = rest_field(name="messageType")
    """Required. Whatsapp message type. Required."""
    media: Optional["_models.AcsMessageMediaContent"] = rest_field()
    ...
    interactive: Optional["_models.AcsMessageInteractiveContent"] = rest_field()
    ...
    def __init__(
        ...
        *,
        ...
        message_id: Optional[str] = None,
        media: Optional["_models.AcsMessageMediaContent"] = None,
        ...
        interactive: Optional["_models.AcsMessageInteractiveContent"] = None,
    ) -> None: ...
...
class AcsSmsReceivedEventData(AcsSmsEventBaseProperties):
    ...
    segment_count: int = rest_field(name="segmentCount")
