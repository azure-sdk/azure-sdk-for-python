...
class AcsCallEndedByProperties(_model_base.Model):
    ...
    :ivar type: The type of call ended by. Required. Known values are: "Participant" and
     "MicrosoftInternal".
    :vartype type: str or ~azure.eventgrid.models.AcsCallEndedByKind
    ...
    type: Union[str, "_models.AcsCallEndedByKind"] = rest_field(
    ...
    def __init__(
        ...
        *,
        ...
        type: Union[str, "_models.AcsCallEndedByKind"],
        name: str,
    ) -> None: ...
...
class AcsCallingEventProperties(_model_base.Model):
...
class AcsCallEndReasonProperties(_model_base.Model):
...
class AcsCallGroupProperties(_model_base.Model):
...
class AcsCallParticipantEventProperties(AcsCallingEventProperties):
...
class AcsCallParticipantAddedEventData(AcsCallParticipantEventProperties):
...
class AcsCallParticipantProperties(_model_base.Model):
    ...
    :vartype communication_identifier: ~azure.eventgrid.models.CommunicationIdentifierModel
    :ivar role: The role of the participant.
    :vartype role: str
    """
...
class AcsCallParticipantRemovedEventData(AcsCallParticipantEventProperties):
    """Schema of the Data property of an EventGridEvent for a
...
class AcsCallRoomProperties(_model_base.Model):
