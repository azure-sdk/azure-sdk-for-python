...
class AcsMessageInteractiveContent(_model_base.Model):
    ...
    """The Message interactive reply type. Required. Known values are: \"buttonReply\", \"listReply\",
     and \"unknown\"."""
    button_reply: "_models.AcsMessageInteractiveButtonReplyContent" = rest_field(
        name="buttonReply", visibility=["read", "create", "update", "delete", "query"]
    )
    """The Message Sent when a customer clicks a button. Required."""
    list_reply: "_models.AcsMessageInteractiveListReplyContent" = rest_field(
...
class AcsMessageReceivedEventData(AcsMessageEventData):
    ...
    media: "_models.AcsMessageMediaContent" = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """The received message media content. Required."""
    context: "_models.AcsMessageContext" = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """The received message context. Required."""
    button: "_models.AcsMessageButtonContent" = rest_field(visibility=["read", "create", "update", "delete", "query"])
...
class CommunicationIdentifierModel(_model_base.Model):
    ...
    :ivar kind: The identifier kind. Only required in responses. Required. Known values are:
     "unknown", "communicationUser", "phoneNumber", "microsoftTeamsUser", and "microsoftTeamsApp".
