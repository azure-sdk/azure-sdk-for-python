...
class AcsIncomingCallEventData(_model_base.Model):
    ...
    on_behalf_of_callee: Optional["_models.CommunicationIdentifierModel"] = rest_field(name="onBehalfOfCallee")
...
class AcsRouterJobReceivedEventData(AcsRouterJobEventData):
    ...
    :vartype requested_worker_selectors: list[~azure.eventgrid.models.AcsRouterWorkerSelector]
    :ivar scheduled_on: Router Job Received Scheduled Time in UTC, will be given in following
     format: '3/28/2007 7:13:50 PM +00:00'. Required.
    :vartype scheduled_on: str
    ...
    scheduled_on: str = rest_field(name="scheduledOn")
    """Router Job Received Scheduled Time in UTC, will be given in following format: '3/28/2007
     7:13:50 PM +00:00'. Required."""
...
class ContainerRegistryEventSource(_model_base.Model):
    ...
    instance_id: Optional[str] = rest_field(name="instanceID")
...
class DeviceTwinInfo(_model_base.Model):
    """Information about the device twin, which is the cloud representation of application device
    metadata.
...
class KeyVaultAccessPolicyChangedEventData(_model_base.Model):
    ...
    :vartype version: str
    :ivar nbf: Not before date of the object that triggered this event.
    :vartype nbf: float
    :ivar exp: The expiration date of the object that triggered this event.
    :vartype exp: float
    """
    ...
    nbf: Optional[float] = rest_field(name="NBF")
    """Not before date of the object that triggered this event."""
    exp: Optional[float] = rest_field(name="EXP")
...
class MediaLiveEventIngestHeartbeatEventData(_model_base.Model):
...
class ResourceActionCancelEventData(_model_base.Model):
...
class ResourceActionFailureEventData(_model_base.Model):
    """Schema of the Data property of an EventGridEvent for a
...
class ResourceActionSuccessEventData(_model_base.Model):
    """Schema of the Data property of an EventGridEvent for a
...
class ResourceDeleteCancelEventData(_model_base.Model):
...
class ResourceDeleteFailureEventData(_model_base.Model):
    """Schema of the Data property of an EventGridEvent for a
...
class ResourceDeleteSuccessEventData(_model_base.Model):
    """Schema of the Data property of an EventGridEvent for a
...
class ResourceWriteCancelEventData(_model_base.Model):
...
class ResourceWriteFailureEventData(_model_base.Model):
...
class ResourceWriteSuccessEventData(_model_base.Model):
...
class StorageBlobCreatedEventData(_model_base.Model):
    ...
    blob_type: Optional[str] = rest_field(name="blobType")
    """The type of blob."""
    access_tier: Union[str, "_models.StorageBlobAccessTier"] = rest_field(name="accessTier")
...
class StorageBlobTierChangedEventData(_model_base.Model):
    ...
    """The current tier of the blob. Required. Known values are: \"Hot\", \"Cool\", \"Cold\",
     \"Archive\", and \"Default\"."""
    previous_tier: Union[str, "_models.StorageBlobAccessTier"] = rest_field(name="previousTier")
...
class StorageLifecyclePolicyCompletedEventData(_model_base.Model):
    ...
    """Execution statistics of a specific policy action in a Blob Management cycle. Required."""
    tier_to_cold_summary: "_models.StorageLifecyclePolicyActionSummaryDetail" = rest_field(name="tierToColdSummary")
    """Execution statistics of a specific policy action in a Blob Management cycle. Required."""
