...
class AcsRecordingFileStatusUpdatedEventData(_model_base.Model):
    ...
    recording_content_type: Union[str, "_models.AcsRecordingContentType"] = rest_field(name="recordingContentType")
    """The recording content type- AudioVideo, or Audio. Required. Known values are: \"AudioVideo\"
     and \"Audio\"."""
    recording_channel_type: Union[str, "_models.AcsRecordingChannelType"] = rest_field(name="recordingChannelType")
    """The recording  channel type - Mixed, Unmixed. Required. Known values are: \"Mixed\" and
     \"Unmixed\"."""
    recording_format_type: Union[str, "_models.AcsRecordingFormatType"] = rest_field(name="recordingFormatType")
