...
class AcsMessageAnalysisCompletedEventData(AcsMessageEventData):
    ...
    :ivar extracted_key_phrases: List of key phrases extracted. Required.
    :vartype extracted_key_phrases: list[str]
    ...
    extracted_key_phrases: List[str] = rest_field(name="extractedKeyPhrases")
