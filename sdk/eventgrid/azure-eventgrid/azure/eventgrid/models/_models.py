...
class AcsMessageAnalysisCompletedEventData(AcsMessageEventData):
    """Schema of the Data property of an EventGridEvent for a
    ...
    :ivar error: The channel event error. Required.
    :vartype error: ~azure.eventgrid.models.AcsMessageChannelEventError
    :ivar original_message: The original message received. Required.
    :vartype original_message: str
    :ivar channel_kind: The analysed message channel kind. Required. "whatsapp"
    :vartype channel_kind: str or ~azure.eventgrid.models.AcsMessageChannelKind
    :ivar intent_analysis: The intent of the analysed message. Required.
    :vartype intent_analysis: str
    :ivar key_phrase_extraction: List of key phrases extracted. Required.
    :vartype key_phrase_extraction: list[str]
    :ivar language_detection: The analysed message language detection. Required.
    :vartype language_detection: ~azure.eventgrid.models.AcsMessageLanguageDetection
    """

    original_message: str = rest_field(name="originalMessage")
    """The original message received. Required."""
    channel_kind: Union[str, "_models.AcsMessageChannelKind"] = rest_field(name="channelKind")
    """The analysed message channel kind. Required. \"whatsapp\""""
    intent_analysis: str = rest_field(name="intentAnalysis")
    """The intent of the analysed message. Required."""
    key_phrase_extraction: List[str] = rest_field(name="keyPhraseExtraction")
    """List of key phrases extracted. Required."""
    language_detection: "_models.AcsMessageLanguageDetection" = rest_field(name="languageDetection")
    """The analysed message language detection. Required."""
    ...
    def __init__(
        ...
        *,
        ...
        intent_analysis: str,
        key_phrase_extraction: List[str],
        language_detection: "_models.AcsMessageLanguageDetection",
        from_property: Optional[str] = None,
        to: Optional[str] = None,
    ): ...
...
class AcsMessageLanguageDetection(_model_base.Model):
    """Message Analysis Language Detection.

    All required parameters must be populated in order to send to server.

    :ivar language: The language of the message. Required.
    :vartype language: str
    :ivar confidence_score: The confidence score of the language detected. Required.
    :vartype confidence_score: float
    :ivar translation: The translation of the message. Required.
    :vartype translation: str
    """

    language: str = rest_field()
    """The language of the message. Required."""
    confidence_score: float = rest_field(name="confidenceScore")
    """The confidence score of the language detected. Required."""
    translation: str = rest_field()
    """The translation of the message. Required."""
