...
class EventGridClientOperationsMixin(EventGridClientMixinABC):
    ...
    async def release_cloud_events(
        ...
        *,
        release_delay_in_seconds: Optional[Union[int, _models.Delay]] = None,
        content_type: str = "application/json",
        **kwargs: Any
        ...
        :paramtype release_delay_in_seconds: int or ~azure.eventgrid.models.Delay
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
    ...
    async def renew_cloud_event_locks(
        ...
        **kwargs: Any
        ...
        request = build_event_grid_renew_cloud_event_locks_request(
            topic_name=topic_name,
            event_subscription_name=event_subscription_name,
            content_type=content_type,
            api_version=self._config.api_version,
