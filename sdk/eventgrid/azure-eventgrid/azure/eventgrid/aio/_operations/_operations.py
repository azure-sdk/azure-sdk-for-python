...
class EventGridPublisherClientOperationsMixin(
    ClientMixinABC[AsyncPipelineClient, EventGridPublisherClientConfiguration]
):
...
class EventGridConsumerClientOperationsMixin(ClientMixinABC[AsyncPipelineClient, EventGridConsumerClientConfiguration]):
