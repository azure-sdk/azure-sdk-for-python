...
class EventGridClientOperationsMixin(EventGridClientMixinABC):
    ...
    async def publish_cloud_event(self, topic_name: str, event: _models.CloudEvent, **kwargs: Any) -> Any:
    ...
    @distributed_trace_async
    async def publish_cloud_events(self, topic_name: str, events: List[_models.CloudEvent], **kwargs: Any) -> Any:
