...
def build_event_grid_publish_cloud_event_request(*, channel_name: Optional[str] = None, **kwargs: Any) -> HttpRequest:
...
class EventGridClientOperationsMixin(EventGridClientMixinABC):
    ...
    def publish_cloud_event(  # pylint: disable=inconsistent-return-statements
        self, events: List[_models.CloudEventEvent], *, channel_name: Optional[str] = None, **kwargs: Any
    ) -> None:
        """Publish CloudEvents.
