...
class EventGridClientOperationsMixin(EventGridClientMixinABC):
    @distributed_trace
    def publish_cloud_event(self, topic_name: str, body: _models.CloudEvent, **kwargs: Any) -> _models.PublishResult:
        ...
        :type topic_name: str
        :param body: Required.
        :type body: ~azure.eventgrid.models.CloudEvent
    ...
    def acknowledge_cloud_events(
        ...
        topic_name: str,
        event_subscription_name: str,
        body: _models.AcknowledgeOptions,
        *,
        ...
        **kwargs: Any
        ...
        :type event_subscription_name: str
        :param body: Required.
        :type body: ~azure.eventgrid.models.AcknowledgeOptions
    ...
    def acknowledge_cloud_events(
        ...
        topic_name: str,
        event_subscription_name: str,
        body: Union[_models.AcknowledgeOptions, JSON, IO],
        **kwargs: Any
    ) -> _models.AcknowledgeResult:
        """Acknowledge batch of Cloud Events. The server responds with an HTTP 200 status code if at least
        one event is successfully acknowledged. The response body will include the set of successfully
        ...
        :param event_subscription_name: Event Subscription Name. Required.
        :type event_subscription_name: str
        :param body: Is one of the following types: AcknowledgeOptions, JSON, IO Required.
        :type body: ~azure.eventgrid.models.AcknowledgeOptions or JSON or IO
    ...
    def release_cloud_events(
        ...
        **kwargs: Any
        ...
        :type event_subscription_name: str
        :param body: Required.
        :type body: ~azure.eventgrid.models.ReleaseOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
    ...
    def release_cloud_events(
        ...
        topic_name: str,
        event_subscription_name: str,
        body: Union[_models.ReleaseOptions, JSON, IO],
        **kwargs: Any
    ) -> _models.ReleaseResult:
        """Release batch of Cloud Events. The server responds with an HTTP 200 status code if at least one
        event is successfully released. The response body will include the set of successfully released
        ...
        :param event_subscription_name: Event Subscription Name. Required.
        :type event_subscription_name: str
        :param body: Is one of the following types: ReleaseOptions, JSON, IO Required.
        :type body: ~azure.eventgrid.models.ReleaseOptions or JSON or IO
        :keyword content_type: content type. Default value is None.
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
         will have to context manage the returned stream.
    ...
    def reject_cloud_events(
        ...
        **kwargs: Any
        ...
        :type event_subscription_name: str
        :param body: Required.
        :type body: ~azure.eventgrid.models.RejectOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
    ...
    @distributed_trace
    def reject_cloud_events(
        self, topic_name: str, event_subscription_name: str, body: Union[_models.RejectOptions, JSON, IO], **kwargs: Any
    ) -> _models.RejectResult:
        """Reject batch of Cloud Events.
        ...
        :param event_subscription_name: Event Subscription Name. Required.
        :type event_subscription_name: str
        :param body: Is one of the following types: RejectOptions, JSON, IO Required.
        :type body: ~azure.eventgrid.models.RejectOptions or JSON or IO
        :keyword content_type: content type. Default value is None.
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
         will have to context manage the returned stream.
