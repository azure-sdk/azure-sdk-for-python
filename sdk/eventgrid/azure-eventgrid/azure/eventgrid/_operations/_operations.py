...
class EventGridPublisherClientOperationsMixin(ClientMixinABC[PipelineClient, EventGridPublisherClientConfiguration]):
...
class EventGridConsumerClientOperationsMixin(ClientMixinABC[PipelineClient, EventGridConsumerClientConfiguration]):
