...
# USAGE
    python topic_event_subscriptions_create_or_update.py
...
# x-ms-original-file: specification/eventgrid/resource-manager/Microsoft.EventGrid/preview/2025-04-15-preview/examples/TopicEventSubscriptions_CreateOrUpdate.json
