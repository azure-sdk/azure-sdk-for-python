...
def build_get_request(
    resource_group_name: str, namespace_name: str, client_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    ...
    path_format_arguments = {
        ...
        "clientName": _SERIALIZER.url(
            "client_name", client_name, "str", max_length=128, min_length=1, pattern=r"^[-a-zA-Z0-9:\._]*$"
        ),
    }
...
class ClientsOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, namespace_name: str, client_name: str, **kwargs: Any) -> _models.Client:
        """Get a client.
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either Client or the result of cls(response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.Client].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.Client](
    ...
    def list_by_namespace(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.eventgrid.models.Client]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
