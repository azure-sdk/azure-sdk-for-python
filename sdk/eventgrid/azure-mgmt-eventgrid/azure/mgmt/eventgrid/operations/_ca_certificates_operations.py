...
def build_get_request(
    resource_group_name: str, namespace_name: str, ca_certificate_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    ...
    path_format_arguments = {
        ...
        "caCertificateName": _SERIALIZER.url(
            "ca_certificate_name", ca_certificate_name, "str", max_length=50, min_length=3, pattern=r"^[a-zA-Z0-9-]*$"
        ),
    }
...
class CaCertificatesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`ca_certificates` attribute.
    """
    ...
    def get(
        ...
        :return: CaCertificate or the result of cls(response)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/namespaces/{namespaceName}/caCertificates/{caCertificateName}"
    }
    ...
    def _create_or_update_initial(
        ...
        ca_certificate_info: Union[_models.CaCertificate, IO],
        **kwargs: Any
    ) -> _models.CaCertificate:
        error_map = {
            401: ClientAuthenticationError,
        ...
        _json = None
        _content = None
        if isinstance(ca_certificate_info, (IOBase, bytes)):
            _content = ca_certificate_info
        else:
            _json = self._serialize.body(ca_certificate_info, "CaCertificate")
    ...
    def begin_create_or_update(
        ...
        namespace_name: str,
        ca_certificate_name: str,
        ca_certificate_info: _models.CaCertificate,
        *,
        ...
        **kwargs: Any
        ...
        :param namespace_name: Name of the namespace. Required.
        :type namespace_name: str
        :param ca_certificate_name: The CA certificate name. Required.
        :type ca_certificate_name: str
        :param ca_certificate_info: CA certificate information. Required.
        :type ca_certificate_info: ~azure.mgmt.eventgrid.models.CaCertificate
        ...
        :return: An instance of LROPoller that returns either CaCertificate or the result of
         cls(response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param ca_certificate_name: The CA certificate name. Required.
        :type ca_certificate_name: str
        :param ca_certificate_info: CA certificate information. Is either a CaCertificate type or a IO
         type. Required.
        :type ca_certificate_info: ~azure.mgmt.eventgrid.models.CaCertificate or IO
        ...
        if cont_token is None:
            raw_result = self._create_or_update_initial(
                ...
                namespace_name=namespace_name,
                ca_certificate_name=ca_certificate_name,
                ca_certificate_info=ca_certificate_info,
                api_version=api_version,
                content_type=content_type,
                cls=lambda x, y, z: x,
                headers=_headers,
    ...
    def list_by_namespace(
        ...
        top: Optional[int] = None,
        **kwargs: Any
    ) -> Iterable["_models.CaCertificate"]:
        ...
        :type top: int
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CaCertificate or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.eventgrid.models.CaCertificate]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("CaCertificatesListResult", pipeline_response)
    ...
    list_by_namespace.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/namespaces/{namespaceName}/caCertificates"
    }
