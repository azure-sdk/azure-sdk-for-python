...
class CaCertificatesOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type ca_certificate_name: str
        :param ca_certificate_info: CA certificate information. Required.
        :type ca_certificate_info: IO[bytes]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type ca_certificate_info: ~azure.mgmt.eventgrid.models.CaCertificate or IO[bytes]
        :return: An instance of LROPoller that returns either CaCertificate or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.eventgrid.models.CaCertificate]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return LROPoller[_models.CaCertificate].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.CaCertificate](
