...
def build_list_by_subscription_request(
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.EventGrid/namespaces")
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
def build_validate_custom_domain_ownership_request(  # pylint: disable=name-too-long
    resource_group_name: str, namespace_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class NamespacesOperations:
    ...
    def list_by_subscription(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.eventgrid.models.Namespace]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_regenerate_key(
        ...
        **kwargs: Any
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either NamespaceSharedAccessKeys or the result
         of cls(response)
    ...
    def begin_regenerate_key(
        ...
        **kwargs: Any
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.NamespaceSharedAccessKeys].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.NamespaceSharedAccessKeys](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
    ...
    def begin_validate_custom_domain_ownership(
        self, resource_group_name: str, namespace_name: str, **kwargs: Any
    ) -> LROPoller[_models.CustomDomainOwnershipValidationResult]:
        ...
        :param namespace_name: Name of the Namespace. Required.
        :type namespace_name: str
        :return: An instance of LROPoller that returns either CustomDomainOwnershipValidationResult or
         the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.eventgrid.models.CustomDomainOwnershipValidationResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.CustomDomainOwnershipValidationResult].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.CustomDomainOwnershipValidationResult](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
