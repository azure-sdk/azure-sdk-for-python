...
class PartnerDestinationsOperations:
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/partnerDestinations/{partnerDestinationName}"
    }
    ...
    def _create_or_update_initial(
        ...
        partner_destination: Union[_models.PartnerDestination, IO],
        **kwargs: Any
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param partner_destination: Partner destination create information. Is either a
         PartnerDestination type or a IO type. Required.
        :type partner_destination: ~azure.mgmt.eventgrid.models.PartnerDestination or IO
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        partner_destination_name: str,
        partner_destination_update_parameters: Union[_models.PartnerDestinationUpdateParameters, IO],
        **kwargs: Any
    ) -> _models.PartnerDestination:
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_update(
        ...
        resource_group_name: str,
        partner_destination_name: str,
        partner_destination_update_parameters: IO,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.PartnerDestination]:
        ...
        :type partner_destination_name: str
        :param partner_destination_update_parameters: Partner destination update information. Required.
        :type partner_destination_update_parameters: IO
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param partner_destination_update_parameters: Partner destination update information. Is either
         a PartnerDestinationUpdateParameters type or a IO type. Required.
        :type partner_destination_update_parameters:
         ~azure.mgmt.eventgrid.models.PartnerDestinationUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    list_by_subscription.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.EventGrid/partnerDestinations"
    }
    ...
    list_by_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/partnerDestinations"
    }
    ...
    activate.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/partnerDestinations/{partnerDestinationName}/activate"
    }
