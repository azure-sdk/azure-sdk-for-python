...
from ...operations._partner_configurations_operations import (
    ...
    build_unauthorize_partner_request,
...
class PartnerConfigurationsOperations:
    ...
    async def get(self, resource_group_name: str, **kwargs: Any) -> _models.PartnerConfiguration:
    ...
    def list_by_resource_group(
    ...
    ) -> AsyncIterable["_models.PartnerConfiguration"]:
        ...
        :return: An iterator like instance of either PartnerConfiguration or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.eventgrid.models.PartnerConfiguration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
