...
class NetworkDevicesOperations:
    ...
    def begin_run_ro_command(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.CommonPostActionResponseForDeviceROCommands]:
        """Implements the operation to the underlying resources.
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.CommonPostActionResponseForDeviceROCommands]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
