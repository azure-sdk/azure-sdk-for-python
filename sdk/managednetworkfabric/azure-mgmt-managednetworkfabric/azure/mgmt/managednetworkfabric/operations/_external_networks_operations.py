...
class ExternalNetworksOperations:
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.ExternalNetwork].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ExternalNetwork](
    ...
    def begin_update_static_route_bfd_administrative_state(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._update_static_route_bfd_administrative_state_initial(
                resource_group_name=resource_group_name,
                l3_isolation_domain_name=l3_isolation_domain_name,
                external_network_name=external_network_name,
                body=body,
