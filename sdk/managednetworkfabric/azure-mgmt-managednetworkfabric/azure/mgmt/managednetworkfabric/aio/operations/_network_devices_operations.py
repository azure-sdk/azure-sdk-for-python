...
class NetworkDevicesOperations:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either NetworkDevice or the result of
         cls(response)
        :rtype:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.NetworkDevice"]:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.NetworkDevice"]:
    ...
    async def _run_ro_command_initial(
        ...
        resource_group_name: str,
        network_device_name: str,
        body: Union[_models.DeviceRoCommand, IO],
        **kwargs: Any
    ) -> _models.CommonPostActionResponseForDeviceROCommands:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.CommonPostActionResponseForDeviceROCommands] = kwargs.pop("cls", None)
        ...
        request = build_run_ro_command_request(
            resource_group_name=resource_group_name,
            network_device_name=network_device_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            ...
            json=_json,
            content=_content,
            template_url=self._run_ro_command_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
        ...
        response_headers = {}
        if response.status_code == 200:
            deserialized = self._deserialize("CommonPostActionResponseForDeviceROCommands", pipeline_response)
    ...
    _run_ro_command_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetworkFabric/networkDevices/{networkDeviceName}/runRoCommand"
    }
    ...
    async def begin_run_ro_command(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.CommonPostActionResponseForDeviceROCommands]:
        """Implements the operation to the underlying resources.
        ...
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no
         Retry-After header is present.
        :return: An instance of AsyncLROPoller that returns either
         CommonPostActionResponseForDeviceROCommands or the result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.CommonPostActionResponseForDeviceROCommands]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_run_ro_command(
        ...
        **kwargs: Any
        ...
        :param network_device_name: Name of the Network Device. Required.
        :type network_device_name: str
        :param body: Request the command. Is either a DeviceRoCommand type or a IO type. Required.
        :type body: ~azure.mgmt.managednetworkfabric.models.DeviceRoCommand or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
