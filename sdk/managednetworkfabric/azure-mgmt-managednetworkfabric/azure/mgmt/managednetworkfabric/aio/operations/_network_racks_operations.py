...
class NetworkRacksOperations:
    ...
    async def _create_initial(
        ...
        body: Union[_models.NetworkRack, IO[bytes]],
        **kwargs: Any
    ) -> _models.NetworkRack:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param network_rack_name: Name of the Network Rack. Required.
        :type network_rack_name: str
        :param body: Request payload. Is either a NetworkRack type or a IO[bytes] type. Required.
        :type body: ~azure.mgmt.managednetworkfabric.models.NetworkRack or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either NetworkRack or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.NetworkRack]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        network_rack_name: str,
        body: Union[_models.TagsUpdate, IO[bytes]],
        **kwargs: Any
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param network_rack_name: Name of the Network Rack. Required.
        :type network_rack_name: str
        :param body: Network Rack properties to update. Is either a TagsUpdate type or a IO[bytes]
         type. Required.
        :type body: ~azure.mgmt.managednetworkfabric.models.TagsUpdate or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either NetworkRack or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.NetworkRack]
        :raises ~azure.core.exceptions.HttpResponseError:
