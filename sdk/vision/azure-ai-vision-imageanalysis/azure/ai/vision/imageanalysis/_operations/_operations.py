...
def build_image_analysis_analyze_from_stream_request(  # pylint: disable=name-too-long
    *,
...
def build_image_analysis_segment_from_url_request(  # pylint: disable=name-too-long
    *, mode: Union[str, _models.SegmentationMode], **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_image_analysis_segment_from_stream_request(  # pylint: disable=name-too-long
    *, mode: Union[str, _models.SegmentationMode], **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ImageAnalysisClientOperationsMixin(ImageAnalysisClientMixinABC):
    ...
    def analyze_from_stream(
        ...
        **kwargs: Any
        ...
        :keyword visual_features: A string indicating what visual feature types to return. Multiple
         values should be comma-separated. Valid visual feature types include: Tags, Caption,
         DenseCaptions, Objects, Read, SmartCrops, People. At least one visual feature must be specified
         for Image Analysis. Default value is None.
        ...
        _request = build_image_analysis_analyze_from_stream_request(
    ...
    def analyze_from_url(
        self,
        image_content: _models.ImageUrl,
        *,
    ...
    def analyze_from_url(
        self,
        image_content: Union[_models.ImageUrl, JSON, IO],
        *,
        visual_features: Optional[List[Union[str, _models.VisualFeatures]]] = None,
        language: Optional[str] = None,
        gender_neutral_caption: Optional[bool] = None,
        ...
        **kwargs: Any
        ...
        :param image_content: The image to be analyzed. Is one of the following types: ImageUrl, JSON,
         IO Required.
        :type image_content: ~azure.ai.vision.imageanalysis.models.ImageUrl or JSON or IO
        :keyword visual_features: A string indicating what visual feature types to return. Multiple
         values should be comma-separated. Valid visual feature types include: Tags, Caption,
         DenseCaptions, Objects, Read, SmartCrops, People. At least one visual feature must be specified
         for Image Analysis. Default value is None.
        ...
        if isinstance(image_content, (IOBase, bytes)):
            ...
            _content = json.dumps(image_content, cls=AzureJSONEncoder, exclude_readonly=True)  # type: ignore
    ...
    def segment_from_url(
        ...
        image_content: _models.ImageUrl,
        *,
        mode: Union[str, _models.SegmentationMode],
        content_type: str = "application/json",
        **kwargs: Any
    ) -> bytes:
        """Segment the input image. An image stream of content type 'image/png' is returned, where the
        pixel values depend on the analysis mode. The returned image has the same dimensions as the
        input image for modes: foregroundMatting. The returned image has the same aspect ratio and same
        dimensions as the input image up to a limit of 16 megapixels for modes: backgroundRemoval.

        :param image_content: The image to be analyzed. Required.
        :type image_content: ~azure.ai.vision.imageanalysis.models.ImageUrl
        :keyword mode: The type of segmentation to perform. Known values are: "backgroundRemoval" and
         "foregroundMatting". Required.
        :paramtype mode: str or ~azure.ai.vision.imageanalysis.models.SegmentationMode
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
    ...
    def segment_from_url(
        ...
        **kwargs: Any
        ...
        _request = build_image_analysis_segment_from_url_request(
            mode=mode,
            content_type=content_type,
            api_version=self._config.api_version,
            content=_content,
    ...
    @distributed_trace
    def segment_from_stream(
        self, image_content: bytes, *, mode: Union[str, _models.SegmentationMode], **kwargs: Any
    ) -> bytes:
        """Segment the input image. An image stream of content type 'image/png' is returned, where the
        pixel values depend on the analysis mode. The returned image has the same dimensions as the
        input image for modes: foregroundMatting. The returned image has the same aspect ratio and same
        ...
        _request = build_image_analysis_segment_from_stream_request(
            mode=mode,
            content_type=content_type,
            api_version=self._config.api_version,
            content=_content,
