...
class CustomModelResult(_model_base.Model):
...
class ImageAnalysisResult(_model_base.Model):
    ...
    :vartype custom_model_result: ~azure.ai.vision.imageanalysis.models.CustomModelResult
    ...
    custom_model_result: Optional["_models.CustomModelResult"] = rest_field(name="customModelResult")
    ...
    def __init__(
        ...
        *,
        ...
        custom_model_result: Optional["_models.CustomModelResult"] = None,
...
class ReadResult(_model_base.Model):
    ...
    :ivar model_version: The model used to generate the Read result. Required.
    :vartype model_version: str
    """
    ...
    model_version: str = rest_field(name="modelVersion")
    """The model used to generate the Read result. Required."""
