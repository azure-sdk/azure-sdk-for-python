...
class ComputeBulkActionsMgmtClient:
    ...
    :ivar bulk_actions: BulkActionsOperations operations
    :vartype bulk_actions: azure.mgmt.computebulkactions.operations.BulkActionsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.bulk_actions = BulkActionsOperations(self._client, self._config, self._serialize, self._deserialize)
