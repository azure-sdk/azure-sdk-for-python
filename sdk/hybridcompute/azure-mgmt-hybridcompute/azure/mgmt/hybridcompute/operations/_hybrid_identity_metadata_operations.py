...
def build_get_request(
    resource_group_name: str, machine_name: str, metadata_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    ...
    path_format_arguments = {
        ...
        "metadataName": _SERIALIZER.url("metadata_name", metadata_name, "str", pattern=r"[a-zA-Z0-9-_\.]"),
    }
...
def build_list_by_machines_request(
...
class HybridIdentityMetadataOperations:
    ...
    def list_by_machines(
        ...
        :return: An iterator like instance of either HybridIdentityMetadata or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.hybridcompute.models.HybridIdentityMetadata]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
