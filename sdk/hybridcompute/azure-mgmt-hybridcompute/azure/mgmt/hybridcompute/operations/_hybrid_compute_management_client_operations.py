...
def build_upgrade_extensions_request(
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2024-09-10-preview"))
...
def build_setup_extensions_request(
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridCompute/machines/{machineName}/setupExtensions",
    )  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
        "resourceGroupName": _SERIALIZER.url(
...
class HybridComputeManagementClientOperationsMixin(  # pylint: disable=name-too-long
    ...
    def _setup_extensions_initial(
        ...
        resource_group_name: str,
        machine_name: str,
        extension_setup_body: Union[_models.MachineExtensionSetup, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
        ...
        _json = None
        _content = None
        if isinstance(extension_setup_body, (IOBase, bytes)):
            _content = extension_setup_body
        else:
            _json = self._serialize.body(extension_setup_body, "MachineExtensionSetup")
    ...
    def begin_setup_extensions(
        ...
        resource_group_name: str,
        machine_name: str,
        extension_setup_body: _models.MachineExtensionSetup,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.MachineExtensionSetup]:
        ...
        :param machine_name: The name of the hybrid machine. Required.
        :type machine_name: str
        :param extension_setup_body: Parameters supplied to the Setup Extensions operation. Required.
        :type extension_setup_body: ~azure.mgmt.hybridcompute.models.MachineExtensionSetup
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either MachineExtensionSetup or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.hybridcompute.models.MachineExtensionSetup]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_setup_extensions(
        ...
        **kwargs: Any
        ...
        :type machine_name: str
        :param extension_setup_body: Parameters supplied to the Setup Extensions operation. Required.
        :type extension_setup_body: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either MachineExtensionSetup or the result of
    ...
    def begin_setup_extensions(
        ...
        **kwargs: Any
        ...
        :param machine_name: The name of the hybrid machine. Required.
        :type machine_name: str
        :param extension_setup_body: Parameters supplied to the Setup Extensions operation. Is either a
         MachineExtensionSetup type or a IO[bytes] type. Required.
        :type extension_setup_body: ~azure.mgmt.hybridcompute.models.MachineExtensionSetup or IO[bytes]
        :return: An instance of LROPoller that returns either MachineExtensionSetup or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.hybridcompute.models.MachineExtensionSetup]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.MachineExtensionSetup] = kwargs.pop("cls", None)
        polling: Union[bool, PollingMethod] = kwargs.pop("polling", True)
        lro_delay = kwargs.pop("polling_interval", self._config.polling_interval)
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._setup_extensions_initial(
                resource_group_name=resource_group_name,
                machine_name=machine_name,
                extension_setup_body=extension_setup_body,
                api_version=api_version,
                content_type=content_type,
                cls=lambda x, y, z: x,
                headers=_headers,
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("MachineExtensionSetup", pipeline_response.http_response)
            if cls:
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.MachineExtensionSetup].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.MachineExtensionSetup](
