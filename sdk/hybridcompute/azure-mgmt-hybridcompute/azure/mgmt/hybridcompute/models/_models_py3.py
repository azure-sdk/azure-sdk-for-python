...
class ExtensionValueV2(ProxyResourceAutoGenerated):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.extension_type = None
        self.publisher = None
        self.extension_uris = None
        self.extension_signature_uri = None
...
class Gateway(TrackedResource):  # pylint: disable=too-many-instance-attributes
...
class MachineExtensionSetup(_serialization.Model):
    """MachineExtensionSetup.

    :ivar extension_setup_list: The list of extensions.
    :vartype extension_setup_list:
     list[~azure.mgmt.hybridcompute.models.MachineExtensionProperties]
    """

    _attribute_map = {
        "extension_setup_list": {"key": "extensionSetupList", "type": "[MachineExtensionProperties]"},
    }

    def __init__(
        self, *, extension_setup_list: Optional[List["_models.MachineExtensionProperties"]] = None, **kwargs: Any
    ) -> None:
        """
        :keyword extension_setup_list: The list of extensions.
        :paramtype extension_setup_list:
         list[~azure.mgmt.hybridcompute.models.MachineExtensionProperties]
        """
        super().__init__(**kwargs)
