...
class Disk(_serialization.Model):
    ...
    :vartype path: str
    :ivar type: The type of the disk.
    :vartype type: str
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype path: str
        :keyword type: The type of the disk.
        :paramtype type: str
...
class FirmwareProfile(_serialization.Model):
    ...
    def __init__(self, *, serial_number: Optional[str] = None, type: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword serial_number: The serial number of the firmware.
        :paramtype serial_number: str
        :keyword type: The type of the firmware.
        :paramtype type: str
        """
        super().__init__(**kwargs)
...
class HardwareProfile(_serialization.Model):
    ...
    def __init__(
        self,
        *,
        total_physical_memory_in_bytes: Optional[int] = None,
        number_of_cpu_sockets: Optional[int] = None,
        processors: Optional[List["_models.Processor"]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword total_physical_memory_in_bytes: The total physical memory on the machine.
        :paramtype total_physical_memory_in_bytes: int
        :keyword number_of_cpu_sockets: The total number of CPU sockets available on the machine.
        :paramtype number_of_cpu_sockets: int
        :keyword processors: The physical processors of the machine.
        :paramtype processors: list[~azure.mgmt.hybridcompute.models.Processor]
        """
        super().__init__(**kwargs)
        self.total_physical_memory_in_bytes = total_physical_memory_in_bytes
        self.number_of_cpu_sockets = number_of_cpu_sockets
...
class Machine(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        firmware_profile: Optional["_models.FirmwareProfile"] = None,
        ...
        **kwargs: Any
        ...
        :keyword hardware_profile: Information about the machine's hardware.
        :paramtype hardware_profile: ~azure.mgmt.hybridcompute.models.HardwareProfile
        :keyword storage_profile: Information about the machine's storage.
        :paramtype storage_profile: ~azure.mgmt.hybridcompute.models.StorageProfile
        :keyword firmware_profile: Information about the machine's firmware.
        :paramtype firmware_profile: ~azure.mgmt.hybridcompute.models.FirmwareProfile
...
class Processor(_serialization.Model):
    ...
    def __init__(self, *, name: Optional[str] = None, number_of_cores: Optional[int] = None, **kwargs: Any) -> None:
        """
        :keyword name: The name of the processor.
        :paramtype name: str
        :keyword number_of_cores: The total number of physical cores on the processor.
