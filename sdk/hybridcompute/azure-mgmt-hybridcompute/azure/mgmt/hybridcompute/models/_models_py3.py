...
class Machine(TrackedResource):
    ...
    :ivar identity_key_store: Specifies if machine is enabled to use the Trusted Platform Module
     (TPM). Known values are: "TPM", "Default", "Year 1", "Year 2", and "Year 3".
    :vartype identity_key_store: str or ~azure.mgmt.hybridcompute.models.ProgramYear
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        identity_key_store: Optional[Union[str, "_models.ProgramYear"]] = None,
        ...
        **kwargs: Any
        ...
        :keyword identity_key_store: Specifies if machine is enabled to use the Trusted Platform Module
         (TPM). Known values are: "TPM", "Default", "Year 1", "Year 2", and "Year 3".
        :paramtype identity_key_store: str or ~azure.mgmt.hybridcompute.models.ProgramYear
...
class VolumeLicenseDetails(_serialization.Model):
    ...
    :ivar program_year: Describes the program year the volume license is for. Known values are:
     "TPM", "Default", "Year 1", "Year 2", and "Year 3".
