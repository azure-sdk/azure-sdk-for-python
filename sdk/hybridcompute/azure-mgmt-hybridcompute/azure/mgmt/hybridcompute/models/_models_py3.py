...
class Gateway(TrackedResourceAutoGenerated):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar gateway_type: The type of the Gateway resource. Known values are: "Public" and "Private".
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword location: The geo-location where the resource lives. Required.
        :paramtype location: str
        :keyword gateway_type: The type of the Gateway resource. Known values are: "Public" and
         "Private".
