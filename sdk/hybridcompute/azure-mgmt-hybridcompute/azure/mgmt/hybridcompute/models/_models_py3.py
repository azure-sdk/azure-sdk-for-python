...
class MachineExtensionSetup(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.hybridcompute.models.MachineExtensionProperties]
    """

    _attribute_map = {
        "value": {"key": "value", "type": "[MachineExtensionProperties]"},
    }

    def __init__(self, *, value: Optional[List["_models.MachineExtensionProperties"]] = None, **kwargs: Any) -> None:
        """
        :keyword value: The list of extensions.
        :paramtype value: list[~azure.mgmt.hybridcompute.models.MachineExtensionProperties]
        """
        super().__init__(**kwargs)
        self.value = value
