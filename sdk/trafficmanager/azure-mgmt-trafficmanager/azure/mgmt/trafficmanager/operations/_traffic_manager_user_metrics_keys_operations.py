...
def build_get_no_default_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Network/trafficManagerUserMetricsKeys"
    )  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
    }
...
def build_create_or_update_no_default_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_delete_no_default_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class TrafficManagerUserMetricsKeysOperations:
    ...
    @distributed_trace
    def get_no_default(self, **kwargs: Any) -> _models.UserMetricsModel:
        """Get the subscription-level key used for Real User Metrics collection.
    ...
    @distributed_trace
    def create_or_update_no_default(self, **kwargs: Any) -> _models.UserMetricsModel:
        """Create or update a subscription-level key used for Real User Metrics collection.
    ...
    @distributed_trace
    def delete_no_default(self, **kwargs: Any) -> _models.DeleteOperationResult:
        """Delete a subscription-level key used for Real User Metrics collection.
