...
class CapacityAdministration(_Model):
...
class FabricCapacityProperties(_Model):
...
class FabricCapacityUpdate(_Model):
...
class FabricCapacityUpdateProperties(_Model):
...
class RpSkuDetailsForExistingResource(_Model):
...
class RpSkuDetailsForNewResource(_Model):
    """The SKU details.
