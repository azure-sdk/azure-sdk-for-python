...
class CapacityAdministrationUpdate(_serialization.Model):
    """The administration properties of the Fabric capacity resource.
...
class FabricCapacity(TrackedResource):
    ...
    _attribute_map = {
        ...
        "administration": {"key": "properties.administration", "type": "CapacityAdministration"},
    }
...
class FabricCapacityUpdate(_serialization.Model):
    ...
    :vartype sku: ~azure.mgmt.fabric.models.RpSkuUpdate
    :ivar tags: Resource tags.
    :vartype tags: dict[str, str]
    :ivar administration: The capacity administration.
    :vartype administration: ~azure.mgmt.fabric.models.CapacityAdministrationUpdate
    """

    _attribute_map = {
        "sku": {"key": "sku", "type": "RpSkuUpdate"},
        "tags": {"key": "tags", "type": "{str}"},
        "administration": {"key": "properties.administration", "type": "CapacityAdministrationUpdate"},
    }

    def __init__(
        self,
        *,
        sku: Optional["_models.RpSkuUpdate"] = None,
        tags: Optional[Dict[str, str]] = None,
        administration: Optional["_models.CapacityAdministrationUpdate"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword sku: The SKU details.
        :paramtype sku: ~azure.mgmt.fabric.models.RpSkuUpdate
        :keyword tags: Resource tags.
        :paramtype tags: dict[str, str]
        :keyword administration: The capacity administration.
        :paramtype administration: ~azure.mgmt.fabric.models.CapacityAdministrationUpdate
        """
        super().__init__(**kwargs)
        self.sku = sku
        self.tags = tags
...
class RpSkuUpdate(_serialization.Model):
    """Represents the SKU name and Azure pricing tier for Microsoft Fabric capacity resource.

    :ivar name: The name of the SKU level.
    :vartype name: str
    :ivar tier: The name of the Azure pricing tier to which the SKU applies. "Fabric"
    :vartype tier: str or ~azure.mgmt.fabric.models.RpSkuTier
    """
    ...
    def __init__(
        self, *, name: Optional[str] = None, tier: Optional[Union[str, "_models.RpSkuTier"]] = None, **kwargs: Any
    ) -> None:
        """
        :keyword name: The name of the SKU level.
        :paramtype name: str
        :keyword tier: The name of the Azure pricing tier to which the SKU applies. "Fabric"
        :paramtype tier: str or ~azure.mgmt.fabric.models.RpSkuTier
        """
        super().__init__(**kwargs)
        self.name = name
