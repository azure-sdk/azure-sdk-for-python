...
class RpUsageAndQuotaDetailsForExistingResource(_serialization.Model):  # pylint: disable=name-too-long
    """An object that represents usage and quota details for existing resources.

    All required parameters must be populated in order to send to server.

    :ivar current_value: The current consumption value. Required.
    :vartype current_value: int
    :ivar limit: The quota limit. Required.
    :vartype limit: int
    """
    ...
    def __init__(self, *, current_value: int, limit: int, **kwargs: Any) -> None:
        """
        :keyword current_value: The current consumption value. Required.
        :paramtype current_value: int
        :keyword limit: The quota limit. Required.
        :paramtype limit: int
        """
        super().__init__(**kwargs)
...
class RpUsageAndQuotaEnumerationForExistingResourceResult(_serialization.Model):  # pylint: disable=name-too-long
    """An object that represents enumerating usage and quota details for existing resources.

    All required parameters must be populated in order to send to server.

    :ivar value: The usage and quota details. Required.
    :vartype value: list[~azure.mgmt.fabric.models.RpUsageAndQuotaDetailsForExistingResource]
    :ivar next_link: Url for the next page.  Null if no more pages available.
    :vartype next_link: str
    """
    ...
    _attribute_map = {
        "value": {"key": "value", "type": "[RpUsageAndQuotaDetailsForExistingResource]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }
    ...
    def __init__(
        self,
        *,
        value: List["_models.RpUsageAndQuotaDetailsForExistingResource"],
        next_link: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword value: The usage and quota details. Required.
        :paramtype value: list[~azure.mgmt.fabric.models.RpUsageAndQuotaDetailsForExistingResource]
        :keyword next_link: Url for the next page.  Null if no more pages available.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
