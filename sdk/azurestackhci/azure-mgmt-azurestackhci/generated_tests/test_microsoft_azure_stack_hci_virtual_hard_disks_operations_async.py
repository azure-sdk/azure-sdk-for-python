...
# --------------------------------------------------------------------------
import pytest
from azure.mgmt.stackhcivm.aio import MicrosoftAzureStackHCI
...
class TestMicrosoftAzureStackHCIVirtualHardDisksOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(MicrosoftAzureStackHCI, is_async=True)
        ...
        response = await (
            await self.client.virtual_hard_disks.begin_create_or_update(
                ...
                resource={
                    ...
                    "status": {
                        "downloadStatus": {"downloadedSizeInMB": 0},
                        "errorCode": "str",
                        "errorMessage": "str",
                        "provisioningStatus": {"operationId": "str", "status": "str"},
                        "uploadStatus": {"status": "str", "uploadedSizeInMB": 0},
                    },
                    "systemData": {
