...
,
    ...
    async def test_begin_create_or_update(self, resource_group):
        response = await (await self.client.virtual_hard_disks.begin_create_or_update(
            resource_group_name=resource_group.name,
            virtual_hard_disk_name="str"
,
            virtual_hard_disks={
...
,
    ...
    async def test_begin_delete(self, resource_group):
        response = await (await self.client.virtual_hard_disks.begin_delete(
            resource_group_name=resource_group.name,
            virtual_hard_disk_name="str"
,
            api_version="2024-01-01"
,
    ...
    async def test_begin_update(self, resource_group):
        response = await (await self.client.virtual_hard_disks.begin_update(
            resource_group_name=resource_group.name,
            virtual_hard_disk_name="str"
,
            virtual_hard_disks={
