...
,
    ...
    async def test_begin_create_or_update(self, resource_group):
        response = await (await self.client.network_interfaces.begin_create_or_update(
            resource_group_name=resource_group.name,
            network_interface_name="str"
,
            network_interfaces={
...
,
    ...
    async def test_begin_delete(self, resource_group):
        response = await (await self.client.network_interfaces.begin_delete(
            resource_group_name=resource_group.name,
            network_interface_name="str"
,
            api_version="2024-01-01"
,
    ...
    async def test_begin_update(self, resource_group):
        response = await (await self.client.network_interfaces.begin_update(
            resource_group_name=resource_group.name,
            network_interface_name="str"
,
            network_interfaces={
