...
class TestAzureStackHCIExtensionsOperationsAsync(AzureMgmtRecordedTestCase):
...
,
    ...
    async def test_begin_create(self, resource_group):
        response = await (await self.client.extensions.begin_create(
            resource_group_name=resource_group.name,
            cluster_name="str"
,
            arc_setting_name="str"
...
,
    ...
    async def test_begin_update(self, resource_group):
        response = await (await self.client.extensions.begin_update(
            resource_group_name=resource_group.name,
            cluster_name="str"
,
            arc_setting_name="str"
...
,
    ...
    async def test_begin_delete(self, resource_group):
        response = await (await self.client.extensions.begin_delete(
            resource_group_name=resource_group.name,
            cluster_name="str"
,
            arc_setting_name="str"
...
,
    ...
    async def test_begin_upgrade(self, resource_group):
        response = await (await self.client.extensions.begin_upgrade(
            resource_group_name=resource_group.name,
            cluster_name="str"
,
            arc_setting_name="str"
