...
class TestMicrosoftAzureStackHCIGalleryImagesOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(MicrosoftAzureStackHCI)
    ...
    def test_list_by_resource_group(self, resource_group):
        response = self.client.gallery_images.list_by_resource_group(
