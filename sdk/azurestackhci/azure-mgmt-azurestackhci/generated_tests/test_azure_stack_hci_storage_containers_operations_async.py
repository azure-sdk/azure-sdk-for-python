...
,
    ...
    async def test_begin_create_or_update(self, resource_group):
        response = await (await self.client.storage_containers.begin_create_or_update(
            resource_group_name=resource_group.name,
            storage_container_name="str"
,
            storage_containers={
...
,
    ...
    async def test_begin_delete(self, resource_group):
        response = await (await self.client.storage_containers.begin_delete(
            resource_group_name=resource_group.name,
            storage_container_name="str"
,
            api_version="2024-01-01"
,
    ...
    async def test_begin_update(self, resource_group):
        response = await (await self.client.storage_containers.begin_update(
            resource_group_name=resource_group.name,
            storage_container_name="str"
,
            storage_containers={
