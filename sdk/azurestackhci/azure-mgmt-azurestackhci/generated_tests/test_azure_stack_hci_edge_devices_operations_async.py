...
,
    ...
    async def test_begin_create_or_update(self, resource_group):
        response = await (await self.client.edge_devices.begin_create_or_update(
            resource_uri="str"
,
            resource={
                "deviceConfiguration": {
...
,
    ...
    async def test_begin_delete(self, resource_group):
        response = await (await self.client.edge_devices.begin_delete(
            resource_uri="str"
,
            edge_device_name="default"
,
...
,
    ...
    async def test_begin_validate(self, resource_group):
        response = await (await self.client.edge_devices.begin_validate(
            resource_uri="str"
,
            validate_request={
                "edgeDeviceIds": [
