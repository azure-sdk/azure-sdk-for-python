...
def main():
    ...
    response = client.clusters.update(
        ...
        cluster={'identity': {'type': 'SystemAssigned'}, 'properties': {'cloudManagementEndpoint': 'https://98294836-31be-4668-aeae-698667faf99b.waconazure.com', 'desiredProperties': {'diagnosticLevel': 'Basic', 'windowsServerSubscription': 'Enabled'}}, 'tags': {'tag1': 'value1', 'tag2': 'value2'}},
    )
    print(response)
