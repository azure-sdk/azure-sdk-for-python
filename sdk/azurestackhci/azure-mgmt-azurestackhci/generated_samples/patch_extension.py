...
def main():
    ...
    response = client.extensions.begin_update(
        ...
        extension={'properties': {'extensionParameters': {'enableAutomaticUpgrade': False, 'protectedSettings': {'workspaceKey': 'xx'}, 'settings': {'workspaceId': 'xx'}, 'typeHandlerVersion': '1.10'}}},
    ).result()
    print(response)
