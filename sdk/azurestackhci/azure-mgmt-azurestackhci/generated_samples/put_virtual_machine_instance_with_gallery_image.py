...
def main():
    ...
    response = client.virtual_machine_instances.begin_create_or_update(
        ...
        virtual_machine_instance={'extendedLocation': {'name': '/subscriptions/a95612cb-f1fa-4daa-a4fd-272844fa512c/resourceGroups/dogfoodarc/providers/Microsoft.ExtendedLocation/customLocations/dogfood-location', 'type': 'CustomLocation'}, 'properties': {'hardwareProfile': {'vmSize': 'Default'}, 'networkProfile': {'networkInterfaces': [{'id': 'test-nic'}]}, 'osProfile': {'adminPassword': 'password', 'adminUsername': 'localadmin', 'computerName': 'luamaster'}, 'securityProfile': {'enableTPM': True, 'uefiSettings': {'secureBootEnabled': True}}, 'storageProfile': {'imageReference': {'id': '/subscriptions/a95612cb-f1fa-4daa-a4fd-272844fa512c/resourceGroups/dogfoodarc/providers/Microsoft.AzureStackHCI/galleryImages/test-gallery-image'}, 'vmConfigStoragePathId': '/subscriptions/a95612cb-f1fa-4daa-a4fd-272844fa512c/resourceGroups/dogfoodarc/providers/Microsoft.AzureStackHCI/storageContainers/test-container'}}},
    ).result()
    print(response)
