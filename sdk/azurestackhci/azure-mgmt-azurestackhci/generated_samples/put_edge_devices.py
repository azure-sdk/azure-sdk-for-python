...
def main():
    ...
    response = client.edge_devices.begin_create_or_update(
        ...
        resource={'properties': {'deviceConfiguration': {'deviceMetadata': '', 'nicDetails': [{'adapterName': 'ethernet', 'componentId': 'VMBUS{f8615163-df3e-46c5-913f-f2d2f965ed0g} ', 'defaultGateway': '10.10.10.1', 'defaultIsolationId': '0', 'dnsServers': ['100.10.10.1'], 'driverVersion': '10.0.20348.1547 ', 'interfaceDescription': 'NDIS 6.70 ', 'ip4Address': '10.10.10.10', 'subnetMask': '255.255.255.0'}]}}},
    ).result()
    print(response)
