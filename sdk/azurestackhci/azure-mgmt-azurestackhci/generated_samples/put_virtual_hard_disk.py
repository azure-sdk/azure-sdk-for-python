...
def main():
    ...
    response = client.virtual_hard_disks.begin_create_or_update(
        ...
        virtual_hard_disks={'extendedLocation': {'name': '/subscriptions/a95612cb-f1fa-4daa-a4fd-272844fa512c/resourceGroups/dogfoodarc/providers/Microsoft.ExtendedLocation/customLocations/dogfood-location', 'type': 'CustomLocation'}, 'location': 'West US2', 'properties': {'diskSizeGB': 32}},
    ).result()
    print(response)
