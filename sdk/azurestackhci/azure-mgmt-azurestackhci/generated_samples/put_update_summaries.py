...
def main():
    ...
    response = client.update_summaries.put(
        ...
        update_location_properties={'properties': {'currentVersion': '4.2203.2.32', 'hardwareModel': 'PowerEdge R730xd', 'lastChecked': '2022-04-07T18:04:07Z', 'lastUpdated': '2022-04-06T14:08:18.254Z', 'oemFamily': 'DellEMC', 'state': 'AppliedSuccessfully'}},
    )
    print(response)
