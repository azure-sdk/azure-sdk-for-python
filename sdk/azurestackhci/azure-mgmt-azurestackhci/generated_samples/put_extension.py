...
def main():
    ...
    response = client.extensions.begin_create(
        ...
        extension={'properties': {'extensionParameters': {'enableAutomaticUpgrade': False, 'protectedSettings': {'workspaceKey': 'xx'}, 'publisher': 'Microsoft.Compute', 'settings': {'workspaceId': 'xx'}, 'type': 'MicrosoftMonitoringAgent', 'typeHandlerVersion': '1.10'}}},
    ).result()
    print(response)
