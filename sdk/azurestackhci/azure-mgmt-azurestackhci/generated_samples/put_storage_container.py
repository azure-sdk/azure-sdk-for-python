...
def main():
    ...
    response = client.storage_containers.begin_create_or_update(
        ...
        storage_containers={'extendedLocation': {'name': '/subscriptions/a95612cb-f1fa-4daa-a4fd-272844fa512c/resourceGroups/dogfoodarc/providers/Microsoft.ExtendedLocation/customLocations/dogfood-location', 'type': 'CustomLocation'}, 'location': 'West US2', 'properties': {'path': 'C:\\container_storage'}},
    ).result()
    print(response)
