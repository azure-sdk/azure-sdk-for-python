...
class MicrosoftAzureStackHCI:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype attestation_statuses:
     azure.mgmt.azurestackhci.aio.operations.AttestationStatusesOperations
    ...
    :vartype network_security_groups:
     azure.mgmt.azurestackhci.aio.operations.NetworkSecurityGroupsOperations
    ...
    :vartype security_rules: azure.mgmt.azurestackhci.aio.operations.SecurityRulesOperations
