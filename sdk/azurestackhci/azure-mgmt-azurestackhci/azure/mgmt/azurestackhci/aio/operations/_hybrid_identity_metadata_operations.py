...
class HybridIdentityMetadataOperations:
    ...
    def list_by_virtual_machine_instance(
        ...
        cls: ClsType[_models.HybridIdentityMetadataListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("HybridIdentityMetadataListResult", pipeline_response)
