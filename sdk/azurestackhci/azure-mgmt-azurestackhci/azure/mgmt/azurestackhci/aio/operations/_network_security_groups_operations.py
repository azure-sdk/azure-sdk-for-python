...
class NetworkSecurityGroupsOperations:
    ...
    def list_all(self, **kwargs: Any) -> AsyncIterable["_models.NetworkSecurityGroup"]:
        ...
        :return: An iterator like instance of either NetworkSecurityGroup or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.azurestackhci.models.NetworkSecurityGroup]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.azurestackhci.models.NetworkSecurityGroup
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.azurestackhci.models.NetworkSecurityGroup
        ...
        :return: An instance of AsyncLROPoller that returns either NetworkSecurityGroup or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhci.models.NetworkSecurityGroup]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.azurestackhci.models.NetworkSecurityGroup or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either NetworkSecurityGroup or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhci.models.NetworkSecurityGroup]
    ...
    async def begin_update_tags(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.azurestackhci.models.NetworkSecurityGroupTagsUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either NetworkSecurityGroup or the result
    ...
    async def begin_update_tags(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.azurestackhci.models.NetworkSecurityGroupTagsUpdate or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either NetworkSecurityGroup or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhci.models.NetworkSecurityGroup]
