...
class NetworkInterfacesOperations:
    ...
    def list_all(self, **kwargs: Any) -> AsyncIterable["_models.NetworkInterface"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.azurestackhci.models.NetworkInterface]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either NetworkInterface or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhci.models.NetworkInterface]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
