...
class ExtensionsOperations:
    ...
    def list_by_arc_setting(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_arc_setting_request(
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type extension: ~azure.mgmt.azurestackhci.models.Extension or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Extension or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhci.models.Extension]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def _update_initial(
        ...
        **kwargs: Any
        ...
        if isinstance(extension, (IOBase, bytes)):
            ...
            _json = self._serialize.body(extension, "ExtensionPatch")
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type extension: ~azure.mgmt.azurestackhci.models.ExtensionPatch or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Extension or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhci.models.Extension]
        :raises ~azure.core.exceptions.HttpResponseError:
