...
from ...operations._arc_settings_operations import (
    build_consent_and_install_default_extensions_request,
    build_create_identity_request,
    build_create_request,
    build_delete_request,
    build_generate_password_request,
    build_get_request,
    build_initialize_disable_process_request,
...
class ArcSettingsOperations:
    ...
    async def consent_and_install_default_extensions(
        ...
        request = build_consent_and_install_default_extensions_request(
            resource_group_name=resource_group_name,
            cluster_name=cluster_name,
            arc_setting_name=arc_setting_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self.consent_and_install_default_extensions.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    consent_and_install_default_extensions.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/clusters/{clusterName}/arcSettings/{arcSettingName}/consentAndInstallDefaultExtensions"
    }

    async def _initialize_disable_process_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, cluster_name: str, arc_setting_name: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
        ...
        request = build_initialize_disable_process_request(
            resource_group_name=resource_group_name,
            cluster_name=cluster_name,
            arc_setting_name=arc_setting_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self._initialize_disable_process_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    _initialize_disable_process_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/clusters/{clusterName}/arcSettings/{arcSettingName}/initializeDisableProcess"
    }
    ...
    async def begin_initialize_disable_process(
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._initialize_disable_process_initial(  # type: ignore
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                arc_setting_name=arc_setting_name,
                api_version=api_version,
    ...
    begin_initialize_disable_process.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/clusters/{clusterName}/arcSettings/{arcSettingName}/initializeDisableProcess"
    }
