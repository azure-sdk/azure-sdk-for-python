...
class StorageContainersOperations:
    ...
    def list_all(self, **kwargs: Any) -> AsyncIterable["_models.StorageContainer"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.azurestackhci.models.StorageContainer]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.azurestackhci.models.StorageContainer
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.azurestackhci.models.StorageContainer
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either StorageContainer or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhci.models.StorageContainer]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a StorageContainer type or a IO[bytes]
         type. Required.
        :type resource: ~azure.mgmt.azurestackhci.models.StorageContainer or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either StorageContainer or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhci.models.StorageContainer]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.azurestackhci.models.StorageContainerTagsUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either StorageContainer or the result of
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.azurestackhci.models.StorageContainerTagsUpdate or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either StorageContainer or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhci.models.StorageContainer]
        :raises ~azure.core.exceptions.HttpResponseError:
