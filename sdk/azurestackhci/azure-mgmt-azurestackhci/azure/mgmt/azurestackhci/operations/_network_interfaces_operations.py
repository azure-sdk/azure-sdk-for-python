...
class NetworkInterfacesOperations:
    ...
    def list_all(self, **kwargs: Any) -> Iterable["_models.NetworkInterface"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.azurestackhci.models.NetworkInterface]
    ...
    def get(self, resource_group_name: str, network_interface_name: str, **kwargs: Any) -> _models.NetworkInterface:
        ...
        :rtype: ~azure.mgmt.azurestackhci.models.NetworkInterface
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.azurestackhci.models.NetworkInterface
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either NetworkInterface or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.azurestackhci.models.NetworkInterface]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a NetworkInterface type or a IO[bytes]
         type. Required.
        :type resource: ~azure.mgmt.azurestackhci.models.NetworkInterface or IO[bytes]
        :return: An instance of LROPoller that returns either NetworkInterface or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.azurestackhci.models.NetworkInterface]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.azurestackhci.models.NetworkInterfaceTagsUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either NetworkInterface or the result of
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.azurestackhci.models.NetworkInterfaceTagsUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either NetworkInterface or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.azurestackhci.models.NetworkInterface]
        :raises ~azure.core.exceptions.HttpResponseError:
