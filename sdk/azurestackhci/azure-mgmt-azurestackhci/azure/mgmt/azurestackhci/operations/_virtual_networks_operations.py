...
class VirtualNetworksOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, virtual_network_name: str, **kwargs: Any) -> _models.VirtualNetworks:
        """get.
    ...
    @distributed_trace
    def list(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.VirtualNetworks"]:
    ...
    @distributed_trace
    def list_all(self, **kwargs: Any) -> Iterable["_models.VirtualNetworks"]:
