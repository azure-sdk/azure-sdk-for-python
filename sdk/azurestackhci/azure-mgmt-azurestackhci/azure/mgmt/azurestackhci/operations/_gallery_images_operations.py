...
class GalleryImagesOperations:
    ...
    def list_all(self, **kwargs: Any) -> Iterable["_models.GalleryImage"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.azurestackhci.models.GalleryImage]
        ...
        cls: ClsType[_models.GalleryImageListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("GalleryImageListResult", pipeline_response)
    ...
    def get(self, resource_group_name: str, gallery_image_name: str, **kwargs: Any) -> _models.GalleryImage:
        ...
        :rtype: ~azure.mgmt.azurestackhci.models.GalleryImage
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.azurestackhci.models.GalleryImage
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either GalleryImage or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.azurestackhci.models.GalleryImage]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a GalleryImage type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.azurestackhci.models.GalleryImage or IO[bytes]
        :return: An instance of LROPoller that returns either GalleryImage or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.azurestackhci.models.GalleryImage]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.azurestackhci.models.GalleryImageTagsUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either GalleryImage or the result of
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.azurestackhci.models.GalleryImageTagsUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either GalleryImage or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.azurestackhci.models.GalleryImage]
        :raises ~azure.core.exceptions.HttpResponseError:
