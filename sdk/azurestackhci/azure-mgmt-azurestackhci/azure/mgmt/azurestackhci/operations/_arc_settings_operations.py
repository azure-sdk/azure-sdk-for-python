...
def build_consent_and_install_default_extensions_request(
    resource_group_name: str, cluster_name: str, arc_setting_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ArcSettingsOperations:
    ...
    def _initialize_disable_process_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, cluster_name: str, arc_setting_name: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_initialize_disable_process(
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._initialize_disable_process_initial(  # type: ignore
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                arc_setting_name=arc_setting_name,
                api_version=api_version,
