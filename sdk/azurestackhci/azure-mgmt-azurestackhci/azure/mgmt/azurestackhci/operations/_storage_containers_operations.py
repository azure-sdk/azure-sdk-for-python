...
class StorageContainersOperations:
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/storageContainers/{storageContainerName}"
    }
    ...
    def _create_or_update_initial(
        ...
        storage_containers: Union[_models.StorageContainers, IO],
        **kwargs: Any
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        storage_container_name: str,
        storage_containers: Union[_models.StorageContainersUpdateRequest, IO],
        **kwargs: Any
    ) -> Optional[_models.StorageContainers]:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
