...
from ._configuration import MicrosoftAzureStackHCIConfiguration
...
class MicrosoftAzureStackHCI:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype attestation_statuses:
     azure.mgmt.azurestackhci.operations.AttestationStatusesOperations
    ...
    :vartype network_security_groups:
     azure.mgmt.azurestackhci.operations.NetworkSecurityGroupsOperations
    ...
    :vartype security_rules: azure.mgmt.azurestackhci.operations.SecurityRulesOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = MicrosoftAzureStackHCIConfiguration(
