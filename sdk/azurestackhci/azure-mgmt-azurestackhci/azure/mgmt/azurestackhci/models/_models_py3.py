...
class ComponentsCr63WSchemasVirtualnetworkpropertiesPropertiesSubnetsItemsPropertiesIpconfigurationreferencesItems(
...
class ComponentsI4F0MhSchemasVirtualnetworkpropertiesPropertiesSubnetsItemsPropertiesRoutetable(_serialization.Model):
    ...
    :vartype routes:
     list[~azure.mgmt.azurestackhci.models.VirtualNetworkPropertiesSubnetsPropertiesItemsItem]
    """
    ...
    _attribute_map = {
        ...
        "routes": {"key": "properties.routes", "type": "[VirtualNetworkPropertiesSubnetsPropertiesItemsItem]"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        routes: Optional[List["_models.VirtualNetworkPropertiesSubnetsPropertiesItemsItem"]] = None,
        **kwargs: Any
    ) -> None:
        """
...
class VirtualMachineInstanceView(_serialization.Model):
    ...
    :vartype vm_agent: ~azure.mgmt.azurestackhci.models.VirtualMachineVMConfigAgentInstanceView
    """

    _attribute_map = {
        "vm_agent": {"key": "vmAgent", "type": "VirtualMachineVMConfigAgentInstanceView"},
    }

    def __init__(
        self, *, vm_agent: Optional["_models.VirtualMachineVMConfigAgentInstanceView"] = None, **kwargs: Any
    ) -> None:
        """
        :keyword vm_agent: The VM Config Agent running on the virtual machine.
        :paramtype vm_agent: ~azure.mgmt.azurestackhci.models.VirtualMachineVMConfigAgentInstanceView
        """
        super().__init__(**kwargs)
        self.vm_agent = vm_agent


class VirtualMachineVMConfigAgentInstanceView(_serialization.Model):
    ...
    _attribute_map = {
        "vm_config_agent_version": {"key": "vmVMConfigAgentVersion", "type": "str"},
...
class VirtualNetworkPropertiesDhcpOptions(_serialization.Model):
...
class VirtualNetworkPropertiesSubnetsItem(_serialization.Model):
    ...
    :vartype ip_configuration_references:
     list[~azure.mgmt.azurestackhci.models.ComponentsCr63WSchemasVirtualnetworkpropertiesPropertiesSubnetsItemsPropertiesIpconfigurationreferencesItems]
    :ivar route_table: RouteTable for the subnet.
    :vartype route_table:
     ~azure.mgmt.azurestackhci.models.ComponentsI4F0MhSchemasVirtualnetworkpropertiesPropertiesSubnetsItemsPropertiesRoutetable
    ...
    _attribute_map = {
        ...
        "ip_configuration_references": {
            ...
            "type": "[ComponentsCr63WSchemasVirtualnetworkpropertiesPropertiesSubnetsItemsPropertiesIpconfigurationreferencesItems]",
        },
        "route_table": {
            "key": "properties.routeTable",
            "type": "ComponentsI4F0MhSchemasVirtualnetworkpropertiesPropertiesSubnetsItemsPropertiesRoutetable",
        },
    ...
    def __init__(
        ...
        *,
        ...
        ip_configuration_references: Optional[
            List[
                "_models.ComponentsCr63WSchemasVirtualnetworkpropertiesPropertiesSubnetsItemsPropertiesIpconfigurationreferencesItems"
            ]
        ] = None,
        route_table: Optional[
            "_models.ComponentsI4F0MhSchemasVirtualnetworkpropertiesPropertiesSubnetsItemsPropertiesRoutetable"
        ] = None,
...
class VirtualNetworkPropertiesSubnetsPropertiesItemsItem(_serialization.Model):
...
class VirtualNetworks(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar dhcp_options: DhcpOptions contains an array of DNS servers available to VMs deployed in
     the virtual network. Standard DHCP option for a subnet overrides VNET DHCP options.
    :vartype dhcp_options: ~azure.mgmt.azurestackhci.models.VirtualNetworkPropertiesDhcpOptions
    ...
    :vartype subnets: list[~azure.mgmt.azurestackhci.models.VirtualNetworkPropertiesSubnetsItem]
    :ivar provisioning_state: Provisioning state of the virtual network. Known values are:
     "Succeeded", "Failed", "InProgress", "Accepted", "Deleting", and "Canceled".
    :vartype provisioning_state: str or ~azure.mgmt.azurestackhci.models.ProvisioningStateEnum
    :ivar vm_switch_name: name of the network switch to be used for VMs.
    :vartype vm_switch_name: str
    :ivar status: The observed state of virtual networks.
    ...
    _attribute_map = {
        ...
        "location": {"key": "location", "type": "str"},
        "extended_location": {"key": "extendedLocation", "type": "ExtendedLocation"},
        "dhcp_options": {"key": "properties.dhcpOptions", "type": "VirtualNetworkPropertiesDhcpOptions"},
        "network_type": {"key": "properties.networkType", "type": "str"},
        "subnets": {"key": "properties.subnets", "type": "[VirtualNetworkPropertiesSubnetsItem]"},
        "provisioning_state": {"key": "properties.provisioningState", "type": "str"},
    ...
    def __init__(
        ...
        *,
        ...
        tags: Optional[Dict[str, str]] = None,
        extended_location: Optional["_models.ExtendedLocation"] = None,
        dhcp_options: Optional["_models.VirtualNetworkPropertiesDhcpOptions"] = None,
        network_type: Optional[Union[str, "_models.NetworkTypeEnum"]] = None,
        subnets: Optional[List["_models.VirtualNetworkPropertiesSubnetsItem"]] = None,
        ...
        **kwargs: Any
        ...
        :keyword dhcp_options: DhcpOptions contains an array of DNS servers available to VMs deployed
         in the virtual network. Standard DHCP option for a subnet overrides VNET DHCP options.
        :paramtype dhcp_options: ~azure.mgmt.azurestackhci.models.VirtualNetworkPropertiesDhcpOptions
        ...
        :paramtype subnets: list[~azure.mgmt.azurestackhci.models.VirtualNetworkPropertiesSubnetsItem]
...
class VirtualNetworksUpdateRequest(_serialization.Model):
