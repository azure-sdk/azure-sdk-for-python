...
class Cluster(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :keyword location: The geo-location where the resource lives. Required.
        :paramtype location: str
        :keyword identity: Identity of Cluster resource.
...
class ClusterIdentityResponse(_serialization.Model):
    ...
    _attribute_map = {
        "properties": {"key": "properties", "type": "ClusterIdentityResponseProperties"},
    }
...
class ClusterIdentityResponseProperties(_serialization.Model):
    ...
    _attribute_map = {
        ...
        "aad_service_principal_object_id": {"key": "aadServicePrincipalObjectId", "type": "str"},
        "aad_application_object_id": {"key": "aadApplicationObjectId", "type": "str"},
    }
...
class Extension(ProxyResource):
    ...
    _attribute_map = {
        ...
        "system_data": {"key": "systemData", "type": "SystemData"},
        "provisioning_state": {"key": "properties.provisioningState", "type": "str"},
        "extension_parameters": {"key": "properties.extensionParameters", "type": "ExtensionParameters"},
        "aggregate_state": {"key": "properties.aggregateState", "type": "str"},
    ...
    def __init__(self, *, extension_parameters: Optional["_models.ExtensionParameters"] = None, **kwargs: Any) -> None:
        """
        :keyword extension_parameters: Parameters specific to this extension type.
        :paramtype extension_parameters: ~azure.mgmt.azurestackhci.models.ExtensionParameters
        """
        super().__init__(**kwargs)
        self.provisioning_state = None
...
class ExtensionParameters(_serialization.Model):
    ...
    :vartype settings: ~azure.mgmt.azurestackhci.models.ExtensionParametersSettings
    :ivar protected_settings: Protected settings (may contain secrets).
    :vartype protected_settings:
     ~azure.mgmt.azurestackhci.models.ExtensionParametersProtectedSettings
    ...
    _attribute_map = {
        ...
        "settings": {"key": "settings", "type": "ExtensionParametersSettings"},
        "protected_settings": {"key": "protectedSettings", "type": "ExtensionParametersProtectedSettings"},
    ...
    def __init__(
        ...
        *,
        ...
        settings: Optional["_models.ExtensionParametersSettings"] = None,
        protected_settings: Optional["_models.ExtensionParametersProtectedSettings"] = None,
        ...
        **kwargs: Any
        ...
        :paramtype settings: ~azure.mgmt.azurestackhci.models.ExtensionParametersSettings
        :keyword protected_settings: Protected settings (may contain secrets).
        :paramtype protected_settings:
         ~azure.mgmt.azurestackhci.models.ExtensionParametersProtectedSettings
...
class ExtensionParametersProtectedSettings(_serialization.Model):
    """Protected settings (may contain secrets).

    :ivar workspace_key: Workspace Key.
    ...
    def __init__(self, *, workspace_key: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword workspace_key: Workspace Key.
...
class ExtensionParametersSettings(_serialization.Model):
    """Json formatted public settings for the extension.

    :ivar workspace_id: Workspace Id.
    ...
    def __init__(self, *, workspace_id: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword workspace_id: Workspace Id.
...
class UpdateRun(ProxyResource):  # pylint: disable=too-many-instance-attributes
    ...
    _attribute_map = {
        ...
        "state": {"key": "properties.state", "type": "str"},
        "progress": {"key": "properties.progress", "type": "Step"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword progress: Progress representation of the update run steps.
        :paramtype progress: ~azure.mgmt.azurestackhci.models.Step
        """
        super().__init__(**kwargs)
        self.location = location
        self.provisioning_state = None
