...
class AzureBareMetalStorageInstancesOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.AzureBareMetalStorageInstance"]:
        ...
        cls: ClsType[_models.AzureBareMetalStorageInstanceListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("AzureBareMetalStorageInstanceListResult", pipeline_response)
