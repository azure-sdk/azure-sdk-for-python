...
class AzureBareMetalInstancesOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.AzureBareMetalInstance"]:
        ...
        cls: ClsType[_models.AzureBareMetalInstanceListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("AzureBareMetalInstanceListResult", pipeline_response)
