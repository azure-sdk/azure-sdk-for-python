...
class OperationStatusSignResultError(_model_base.Model):
    ...
    :vartype status: str or ~azure.developer.signing.models.OperationState
    ...
    :vartype result: ~azure.developer.signing.models.SignResult
    """
    ...
    result: Optional["_models.SignResult"] = rest_field()
