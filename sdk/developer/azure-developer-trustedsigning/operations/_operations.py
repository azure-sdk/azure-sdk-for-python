...
class CertificateProfileOperationsOperations: 
    ...
    def get_signing_status(
        ...
        **kwargs: Any
        ...
        :return: OperationStatusSignResultError. The OperationStatusSignResultError is compatible with
         MutableMapping
        :rtype: ~.models.OperationStatusSignResultError
        ...
        cls: ClsType[_models.OperationStatusSignResultError] = kwargs.pop(
            'cls', None
        )
    ...
    def list_extended_key_usages(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~.models.ExtendedKeyUsage]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

        cls: ClsType[List[_models.ExtendedKeyUsage]] = kwargs.pop(
            'cls', None
        )
        ...
        def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(List[_models.ExtendedKeyUsage], deserialized.get("value", []))
            if cls:
    ...
    def begin_sign(
        ...
        **kwargs: Any
        ...
        :type body: ~.models.SigningPayloadOptions
        ...
        :return: An instance of LROPoller that returns SignResult. The SignResult is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~.models.SignResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_sign(
        ...
        **kwargs: Any
        ...
        :param body: Body parameter. Is one of the following types: SigningPayloadOptions, JSON,
         IO[bytes] Required.
        :type body: ~.models.SigningPayloadOptions or JSON or IO[bytes]
        :keyword client_version: An optional client version. Default value is None.
        :paramtype client_version: str
        :keyword x_correlation_id: An identifier used to batch multiple requests. Default value is
         None.
        ...
        content_type: Optional[str] = kwargs.pop('content_type', _headers.pop('Content-Type', None))
        cls: ClsType[_models.SignResult] = kwargs.pop(
            'cls', None
        )
