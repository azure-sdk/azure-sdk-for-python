...
class CertificateProfileOperationsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~.aio.TrustedSigningClient`'s
    ...
    def list_extended_key_usages(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~.models.ExtendedKeyUsage]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def begin_sign(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns SignResult. The SignResult is compatible
         with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~.models.SignResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
