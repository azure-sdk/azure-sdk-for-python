...
class ConfigurationsOperations:
    ...
    def _create_or_update_initial(
        ...
        body: Union[_models.NginxConfigurationResponse, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "NginxConfigurationResponse")
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param configuration_name: The name of configuration, only 'default' is supported value due to
         the singleton of NGINX conf. Required.
        :type configuration_name: str
        :param body: The NGINX configuration. Required.
        :type body: ~azure.mgmt.nginx.models.NginxConfigurationResponse
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param configuration_name: The name of configuration, only 'default' is supported value due to
         the singleton of NGINX conf. Required.
        :type configuration_name: str
        :param body: The NGINX configuration. Is either a NginxConfigurationResponse type or a
         IO[bytes] type. Required.
        :type body: ~azure.mgmt.nginx.models.NginxConfigurationResponse or IO[bytes]
        :return: An instance of LROPoller that returns either NginxConfigurationResponse or the result
         of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.nginx.models.NginxConfigurationResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
