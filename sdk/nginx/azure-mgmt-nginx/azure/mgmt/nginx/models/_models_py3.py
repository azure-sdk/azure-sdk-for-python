...
class DiagnosticItem(_serialization.Model):
    """A config diagnostic object found during the analysis of an NGINX configuration that can be a
    ...
    :ivar category: category of warning.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword category: category of warning.
