...
class TestContentUnderstandingContentAnalyzersOperationsAsync(ContentUnderstandingClientTestBaseAsync):
    ...
    @ContentUnderstandingPreparer()
    @recorded_by_proxy_async
    async def test_content_analyzers_create_classifier(self, azure_content_understanding_endpoint: str) -> None:
        """
        Test Summary:
        ...
        """
        client: ContentUnderstandingClient = self.create_async_client(endpoint=azure_content_understanding_endpoint)
        analyzer_id = generate_analyzer_id(client, "create_classifier", is_async=True)
        created_analyzer = False
        ...
        try:
            ...
            retrieved_analyzer = await client.get_analyzer(analyzer_id)
    ...
    @ContentUnderstandingPreparer()
    @recorded_by_proxy_async
    async def test_content_analyzers_delete_result(self, azure_content_understanding_endpoint: str) -> None:
        """
        Test Summary:
        - Create simple analyzer for URL analysis
        - Begin analysis operation with URL input
        ...
        """
        client: ContentUnderstandingClient = self.create_async_client(endpoint=azure_content_understanding_endpoint)
        analyzer_id = generate_analyzer_id(client, "delete_result", is_async=True)
        created_analyzer = False
        ...
        try:
            ...
            # Begin analysis operation with URL
            analysis_poller = await client.begin_analyze(analyzer_id=analyzer_id, inputs=[AnalyzeInput(url=invoice_url)])
            assert_poller_properties(analysis_poller, "Analysis poller")
            ...
            result_before = await client._get_result(operation_id=operation_id)  # type: ignore[attr-defined]
            ...
            with pytest.raises(ResourceNotFoundError):
                await client._get_result(operation_id=operation_id)  # type: ignore[attr-defined]
    ...
    @ContentUnderstandingPreparer()
    @recorded_by_proxy_async
    async def test_content_analyzers_get_defaults(self, azure_content_understanding_endpoint: str) -> None:
        """
        Test Summary:
    ...
    @ContentUnderstandingPreparer()
    @recorded_by_proxy_async
    async def test_content_analyzers_update_defaults(self, azure_content_understanding_endpoint: str) -> None:
        """
        Test Summary:
        ...
        if defaults.model_deployments:
            ...
            updated_defaults = await client.update_defaults(model_deployments=defaults.model_deployments)
