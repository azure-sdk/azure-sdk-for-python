...
class FluidRelayManagementClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype fluid_relay_operations:
     azure.mgmt.fluidrelay.aio.operations.FluidRelayOperationsOperations
    :ivar fluid_relay_servers: FluidRelayServersOperations operations
    :vartype fluid_relay_servers: azure.mgmt.fluidrelay.aio.operations.FluidRelayServersOperations
    :ivar fluid_relay_containers: FluidRelayContainersOperations operations
    :vartype fluid_relay_containers:
     azure.mgmt.fluidrelay.aio.operations.FluidRelayContainersOperations
    ...
    async def __aenter__(self) -> "FluidRelayManagementClient":
