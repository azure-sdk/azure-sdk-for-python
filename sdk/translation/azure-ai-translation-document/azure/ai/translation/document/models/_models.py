...
class DocumentStatus(_model_base.Model):
    ...
    :ivar total_image_scans_charged: Total image scans charged by the API.
    :vartype total_image_scans_charged: int
    ...
    total_image_scans_charged: Optional[int] = rest_field(name="totalImageScansCharged")
    ...
    def __init__(
        ...
        *,
        ...
        total_image_scans_charged: Optional[int] = None,
...
class TranslationStatusSummary(_model_base.Model):
    """Status Summary.
