...
from ..._operations._operations import build_document_translation_document_translate_request
from ..._vendor import handle_multipart_form_data_model, multipart_form_data_file
from .._vendor import DocumentTranslationClientMixinABC
...
class DocumentTranslationClientOperationsMixin(DocumentTranslationClientMixinABC):
    ...
    async def document_translate(
        ...
        **kwargs: Any
        ...
        :param body: Required.
        :type body: ~azure.ai.documenttranslation.models.DocumentTranslateContent
    ...
    async def document_translate(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.ai.documenttranslation.models.DocumentTranslateContent or JSON
        :keyword target_language: Specifies the language of the output document.
         The target language must be one of the supported languages included in the translation scope.
         For example if you want to translate the document in German language, then use
         targetLanguage=de. Required.
