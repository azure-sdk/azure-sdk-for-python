...
def build_text_translation_translate2_request(  # pylint: disable=name-too-long
    *, client_trace_id: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class TextTranslationClientOperationsMixin(
    ...
    def translate2(
        self,
        body: List[_models.TranslateBodyDetails],
        *,
        client_trace_id: Optional[str] = None,
        ...
        **kwargs: Any
        ...
        :type body: list[~azure.ai.translation.text.models.TranslateBodyDetails]
        :keyword client_trace_id: A client-generated GUID to uniquely identify the request. Default
         value is None.
        :paramtype client_trace_id: str
    ...
    @api_version_validation(
        method_added_on="2025-05-01-preview",
        params_added_on={"2025-05-01-preview": ["client_trace_id", "api_version", "content_type", "accept"]},
    )
    def translate2(
        self,
        body: Union[List[_models.TranslateBodyDetails], IO[bytes]],
        *,
        client_trace_id: Optional[str] = None,
        **kwargs: Any
    ) -> List[_models.TranslatedTextItem]:
        ...
        :param body: Defines the content of the request. Is either a [TranslateBodyDetails] type or a
         IO[bytes] type. Required.
        :type body: list[~azure.ai.translation.text.models.TranslateBodyDetails] or IO[bytes]
        :keyword client_trace_id: A client-generated GUID to uniquely identify the request. Default
         value is None.
        :paramtype client_trace_id: str
        :return: list of TranslatedTextItem
        ...
        _request = build_text_translation_translate2_request(
            client_trace_id=client_trace_id,
