...
def build_text_translation_translate_request(
    ...
    **kwargs: Any
    ...
    if from_language is not None:
        _params["suggestedFrom"] = _SERIALIZER.query("from_language", from_language, "str")
...
class TextTranslationClientOperationsMixin(TextTranslationClientMixinABC):
    ...
    def translate(
        ...
        **kwargs: Any
        ...
        :keyword from_language: Specifies a fallback language if the language of the input text can't
         be identified.
