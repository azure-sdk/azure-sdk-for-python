...
class TextTranslationClientOperationsMixin(TextTranslationClientMixinABC):
    ...
    def translate(
        self,
        body: _models.TranslateBodyDetails,
        *,
        to_language: List[str],
        client_trace_id: Optional[str] = None,
        from_language: Optional[str] = None,
        ...
        **kwargs: Any
        ...
        :param body: Details of the translate request. Required.
        :type body: ~azure.ai.translation.text.models.TranslateBodyDetails
        ...
        :keyword allow_fallback: In the case where a custom system is being used, specifies that the
    ...
    def translate(
        self,
        body: Union[_models.TranslateBodyDetails, JSON, IO[bytes]],
        *,
        to_language: List[str],
        client_trace_id: Optional[str] = None,
        from_language: Optional[str] = None,
        ...
        **kwargs: Any
        ...
        :param body: Details of the translate request. Is one of the following types:
         TranslateBodyDetails, JSON, IO[bytes] Required.
        :type body: ~azure.ai.translation.text.models.TranslateBodyDetails or JSON or IO[bytes]
        :keyword to_language: Specifies the language of the output text. The target language must be
         one of the supported languages included
         in the translation scope. For example, use to=de to translate to German.
         It's possible to translate to multiple languages simultaneously by repeating the parameter in
