...
class ReferenceSentencePair(_model_base.Model):
...
class TranslateBodyDetails(_model_base.Model):
    ...
    :vartype targets: ~azure.ai.translation.text.models.TranslateTarget
    """
    ...
    """Defines whether the text being translated is plain text or HTML text. Any HTML needs to be a
     ...
     complete element. Possible values are: plain (default) or html. Known values are: \"Plain\" and
     \"Html\"."""
    targets: "_models.TranslateTarget" = rest_field(visibility=["read", "create", "update", "delete", "query"])
    ...
    def __init__(
        ...
        *,
        text: str,
        targets: "_models.TranslateTarget",
...
class TranslateTarget(_model_base.Model):
    ...
    :vartype grade: str
    :ivar tone: Desired tone of target translation. Default is 'informal'.
    :vartype tone: str
    :ivar gender: Desired gender of target translation.
    :vartype gender: str
    :ivar adaptive_dataset_ids: Reference dataset ID having sentence pair to generate adaptive
     customized translation.
    :vartype adaptive_dataset_ids: list[str]
    ...
    adaptive_dataset_ids: Optional[List[str]] = rest_field(
        name="adaptiveDatasetIds", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        ...
        *,
        ...
        adaptive_dataset_ids: Optional[List[str]] = None,
