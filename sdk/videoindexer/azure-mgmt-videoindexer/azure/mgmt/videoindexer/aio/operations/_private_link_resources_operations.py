...
class PrivateLinkResourcesOperations:
    ...
    def list_by_account(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.videoindexer.models.PrivateLinkResource]
    ...
    async def get(
        ...
        """Get the private link resource with the specified group Id associated with the Video Indexer
        account.
        ...
        :rtype: ~azure.mgmt.videoindexer.models.PrivateLinkResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
