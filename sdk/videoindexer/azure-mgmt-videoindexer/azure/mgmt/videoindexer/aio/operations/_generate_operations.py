...
from ...operations._generate_operations import (
    build_access_token_request,
    build_extension_access_token_request,
    build_extension_restricted_viewer_access_token_request,
    build_restricted_viewer_access_token_request,
)
...
class GenerateOperations:
    ...
    @distributed_trace_async
    async def extension_restricted_viewer_access_token(
        self,
        resource_group_name: str,
        account_name: str,
        scope: Union[str, _models.Scope],
