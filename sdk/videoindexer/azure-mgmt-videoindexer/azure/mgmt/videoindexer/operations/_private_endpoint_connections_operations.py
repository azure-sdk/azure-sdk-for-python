...
class PrivateEndpointConnectionsOperations:
    ...
    def list_by_account(
        ...
        :return: An iterator like instance of either PrivateEndpointConnection or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.videoindexer.models.PrivateEndpointConnection]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.videoindexer.models.PrivateEndpointConnection
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        """Update the state of specified private endpoint connection associated with the Video Indexer
        account.
        ...
        :type private_endpoint_connection_name: str
        :param body: Required.
        :type body: ~azure.mgmt.videoindexer.models.PrivateEndpointConnection
        ...
        :return: An instance of LROPoller that returns either PrivateEndpointConnection or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.videoindexer.models.PrivateEndpointConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param private_endpoint_connection_name: The name of the private endpoint connection associated
         with the Azure resource. Required.
        :type private_endpoint_connection_name: str
        :param body: Is either a PrivateEndpointConnection type or a IO[bytes] type. Required.
        :type body: ~azure.mgmt.videoindexer.models.PrivateEndpointConnection or IO[bytes]
        :return: An instance of LROPoller that returns either PrivateEndpointConnection or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.videoindexer.models.PrivateEndpointConnection]
