...
class ApplicationsOperations:
    ...
    @overload
    async def delete_business_process_development_artifact(  # pylint: disable=inconsistent-return-statements,name-too-long
        self,
        resource_group_name: str,
        space_name: str,
        application_name: str,
    ...
    @overload
    async def validate_business_process_development_artifact(  # pylint: disable=inconsistent-return-statements,name-too-long
        self,
        resource_group_name: str,
        space_name: str,
        application_name: str,
