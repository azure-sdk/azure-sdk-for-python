...
class ApplicationsOperations:
    ...
    @distributed_trace_async
    async def delete(self, resource_group_name: str, space_name: str, application_name: str, **kwargs: Any) -> None:
    ...
    @overload
    async def delete_business_process_development_artifact(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        space_name: str,
        application_name: str,
    ...
    @overload
    async def get_business_process_development_artifact(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        space_name: str,
        application_name: str,
    ...
    @distributed_trace_async
    async def list_business_process_development_artifacts(  # pylint: disable=name-too-long
        self, resource_group_name: str, space_name: str, application_name: str, **kwargs: Any
    ...
    @overload
    async def save_business_process_development_artifact(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        space_name: str,
        application_name: str,
    ...
    @overload
    async def validate_business_process_development_artifact(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        space_name: str,
        application_name: str,
