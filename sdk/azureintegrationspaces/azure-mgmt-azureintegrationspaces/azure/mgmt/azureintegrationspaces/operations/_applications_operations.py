...
def build_delete_business_process_development_artifact_request(  # pylint: disable=name-too-long
    resource_group_name: str, space_name: str, application_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_get_business_process_development_artifact_request(  # pylint: disable=name-too-long
    resource_group_name: str, space_name: str, application_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_business_process_development_artifacts_request(  # pylint: disable=name-too-long
    resource_group_name: str, space_name: str, application_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_save_business_process_development_artifact_request(  # pylint: disable=name-too-long
    resource_group_name: str, space_name: str, application_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_validate_business_process_development_artifact_request(  # pylint: disable=name-too-long
    resource_group_name: str, space_name: str, application_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ApplicationsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.azureintegrationspaces.IntegrationSpacesMgmtClient`'s
        ...
        **kwargs: Any
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_space_request(
    ...
    def create_or_update(
        ...
        space_name: str,
        application_name: str,
        resource: Union[_models.Application, IO[bytes]],
        **kwargs: Any
    ) -> _models.Application:
        """Create a Application.
        ...
        :param application_name: The name of the Application. Required.
        :type application_name: str
        :param resource: Resource create parameters. Is either a Application type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.azureintegrationspaces.models.Application or IO[bytes]
        :return: Application or the result of cls(response)
        :rtype: ~azure.mgmt.azureintegrationspaces.models.Application
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def patch(
        ...
        space_name: str,
        application_name: str,
        properties: Union[_models.ApplicationUpdate, IO[bytes]],
        **kwargs: Any
    ) -> _models.Application:
        """Update a Application.
        ...
        :type properties: ~azure.mgmt.azureintegrationspaces.models.ApplicationUpdate or IO[bytes]
        :return: Application or the result of cls(response)
        :rtype: ~azure.mgmt.azureintegrationspaces.models.Application
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @overload
    def delete_business_process_development_artifact(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        space_name: str,
        application_name: str,
    ...
    @distributed_trace
    def delete_business_process_development_artifact(  # pylint: disable=inconsistent-return-statements,name-too-long
        self,
        resource_group_name: str,
        space_name: str,
        application_name: str,
        body: Union[_models.GetOrDeleteBusinessProcessDevelopmentArtifactRequest, IO[bytes]],
        **kwargs: Any
    ) -> None:
        """The delete business process development artifact action.
        ...
        :param body: The content of the action request. Is either a
         GetOrDeleteBusinessProcessDevelopmentArtifactRequest type or a IO[bytes] type. Required.
        :type body:
         ~azure.mgmt.azureintegrationspaces.models.GetOrDeleteBusinessProcessDevelopmentArtifactRequest
         or IO[bytes]
        :return: None or the result of cls(response)
        ...
        _request = build_delete_business_process_development_artifact_request(
            resource_group_name=resource_group_name,
            space_name=space_name,
            application_name=application_name,
            subscription_id=self._config.subscription_id,
    ...
    @overload
    def get_business_process_development_artifact(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        space_name: str,
        application_name: str,
    ...
    def get_business_process_development_artifact(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        _request = build_get_business_process_development_artifact_request(
            resource_group_name=resource_group_name,
            space_name=space_name,
            application_name=application_name,
            subscription_id=self._config.subscription_id,
        ...
        deserialized = self._deserialize(
            "SaveOrGetBusinessProcessDevelopmentArtifactResponse", pipeline_response.http_response
        )
    ...
    @distributed_trace
    def list_business_process_development_artifacts(  # pylint: disable=name-too-long
        self, resource_group_name: str, space_name: str, application_name: str, **kwargs: Any
        ...
        _request = build_list_business_process_development_artifacts_request(
            resource_group_name=resource_group_name,
            space_name=space_name,
            application_name=application_name,
            subscription_id=self._config.subscription_id,
        ...
        deserialized = self._deserialize(
            "ListBusinessProcessDevelopmentArtifactsResponse", pipeline_response.http_response
        )
    ...
    @overload
    def save_business_process_development_artifact(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        space_name: str,
        application_name: str,
    ...
    def save_business_process_development_artifact(  # pylint: disable=name-too-long
        ...
        space_name: str,
        application_name: str,
        body: Union[_models.SaveOrValidateBusinessProcessDevelopmentArtifactRequest, IO[bytes]],
        **kwargs: Any
    ) -> _models.SaveOrGetBusinessProcessDevelopmentArtifactResponse:
        """The save business process development artifact action.
        ...
        :type application_name: str
        :param body: The content of the action request. Is either a
         SaveOrValidateBusinessProcessDevelopmentArtifactRequest type or a IO[bytes] type. Required.
        :type body:
         ~azure.mgmt.azureintegrationspaces.models.SaveOrValidateBusinessProcessDevelopmentArtifactRequest
         or IO[bytes]
        :return: SaveOrGetBusinessProcessDevelopmentArtifactResponse or the result of cls(response)
        ...
        _request = build_save_business_process_development_artifact_request(
            resource_group_name=resource_group_name,
            space_name=space_name,
            application_name=application_name,
            subscription_id=self._config.subscription_id,
    ...
    @overload
    def validate_business_process_development_artifact(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        space_name: str,
        application_name: str,
    ...
    @distributed_trace
    def validate_business_process_development_artifact(  # pylint: disable=inconsistent-return-statements,name-too-long
        self,
        resource_group_name: str,
        space_name: str,
        application_name: str,
        ...
        **kwargs: Any
        ...
        _request = build_validate_business_process_development_artifact_request(
            resource_group_name=resource_group_name,
            space_name=space_name,
            application_name=application_name,
            subscription_id=self._config.subscription_id,
