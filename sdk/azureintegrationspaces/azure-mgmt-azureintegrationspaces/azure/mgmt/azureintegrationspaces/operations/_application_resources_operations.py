...
class ApplicationResourcesOperations:
    ...
    def create_or_update(
        ...
        application_name: str,
        resource_name: str,
        resource: Union[_models.ApplicationResource, IO[bytes]],
        **kwargs: Any
    ) -> _models.ApplicationResource:
        """Create a ApplicationResource.
        ...
        :param resource_name: The name of the application resource. Required.
        :type resource_name: str
        :param resource: Resource create parameters. Is either a ApplicationResource type or a
         IO[bytes] type. Required.
        :type resource: ~azure.mgmt.azureintegrationspaces.models.ApplicationResource or IO[bytes]
        :return: ApplicationResource or the result of cls(response)
        :rtype: ~azure.mgmt.azureintegrationspaces.models.ApplicationResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def patch(
        ...
        application_name: str,
        resource_name: str,
        properties: Union[_models.ApplicationResourceUpdate, IO[bytes]],
        **kwargs: Any
    ) -> _models.ApplicationResource:
        """Update a ApplicationResource.
        ...
        :type properties: ~azure.mgmt.azureintegrationspaces.models.ApplicationResourceUpdate or
         IO[bytes]
        :return: ApplicationResource or the result of cls(response)
        :rtype: ~azure.mgmt.azureintegrationspaces.models.ApplicationResource
        :raises ~azure.core.exceptions.HttpResponseError:
