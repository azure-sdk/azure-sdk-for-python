...
class BusinessProcess(ProxyResource):
...
class BusinessProcessDevelopmentArtifactProperties(_serialization.Model):  # pylint: disable=name-too-long
...
class BusinessProcessVersion(ProxyResource):
...
class GetOrDeleteBusinessProcessDevelopmentArtifactRequest(_serialization.Model):  # pylint: disable=name-too-long
...
class ListBusinessProcessDevelopmentArtifactsResponse(_serialization.Model):  # pylint: disable=name-too-long
...
class SaveOrGetBusinessProcessDevelopmentArtifactResponse(_serialization.Model):  # pylint: disable=name-too-long
...
class SaveOrValidateBusinessProcessDevelopmentArtifactRequest(_serialization.Model):  # pylint: disable=name-too-long
...
class TrackingDataStore(_serialization.Model):
    ...
    :ivar data_store_resource_id: The data store resource id.
    :vartype data_store_resource_id: str
    :ivar data_store_uri: The data store URI.
    :vartype data_store_uri: str
    :ivar data_store_ingestion_uri: The data store ingestion URI.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword data_store_resource_id: The data store resource id.
        :paramtype data_store_resource_id: str
        :keyword data_store_uri: The data store URI.
        :paramtype data_store_uri: str
        :keyword data_store_ingestion_uri: The data store ingestion URI.
