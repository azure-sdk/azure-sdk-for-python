...
# USAGE
    python applications_save_business_process_development_artifact.py
...
def main():
    client = IntegrationSpacesMgmtClient(
        credential=DefaultAzureCredential(),
        subscription_id="00000000-0000-0000-0000-000000000000",
    )

    response = client.applications.save_business_process_development_artifact(
