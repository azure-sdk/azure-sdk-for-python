...
class Action(_serialization.Model):
    ...
    :ivar action_type: Type of action to be executed. Required. "Internal"
    :vartype action_type: str or ~azure.mgmt.azuredatatransfer.models.ActionType
    :ivar target_type: Type of target to execute the action on. Required. Known values are:
     "Pipeline", "Connection", and "FlowType".
    :vartype target_type: str or ~azure.mgmt.azuredatatransfer.models.TargetType
    :ivar targets: Targets for the action. Required.
    :vartype targets: list[str]
    :ivar justification: Business justification for the action.
    ...
    def __init__(
        ...
        *,
        ...
        target_type: Union[str, "_models.TargetType"],
        targets: List[str],
        justification: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword action_type: Type of action to be executed. Required. "Internal"
        :paramtype action_type: str or ~azure.mgmt.azuredatatransfer.models.ActionType
        :keyword target_type: Type of target to execute the action on. Required. Known values are:
         "Pipeline", "Connection", and "FlowType".
        :paramtype target_type: str or ~azure.mgmt.azuredatatransfer.models.TargetType
        :keyword targets: Targets for the action. Required.
        :paramtype targets: list[str]
        :keyword justification: Business justification for the action.
...
class ApiFlowOptions(_serialization.Model):
    """Properties specific to API Flow Type.

    :ivar remote_endpoint: Remote host to which communication needs to be made.
    :vartype remote_endpoint: str
    :ivar cname: Unique CNAME to represent the Azure Data Transfer API Flow instance.
    :vartype cname: str
    :ivar api_mode: Remote Calling Mode in the Azure Data Transfer API Flow, which describes how
     the API Flow will be invoked. Known values are: "SDK" and "Endpoint".
    :vartype api_mode: str or ~azure.mgmt.azuredatatransfer.models.ApiMode
    :ivar identity_translation: Flag for if Azure Data Transfer API Flow should extract the user
     token. Known values are: "UserIdentity" and "ServiceIdentity".
    :vartype identity_translation: str or ~azure.mgmt.azuredatatransfer.models.IdentityTranslation
    :ivar sender_client_id: Sender's app user assigned Manage Identity client ID.
    :vartype sender_client_id: str
    :ivar remote_calling_mode_client_id: Remote stub app registration Client ID.
    :vartype remote_calling_mode_client_id: str
    :ivar audience_override: Optional field to override the audience of the remote endpoint.
    :vartype audience_override: str
    """

    _attribute_map = {
        "remote_endpoint": {"key": "remoteEndpoint", "type": "str"},
        "cname": {"key": "cname", "type": "str"},
        "api_mode": {"key": "apiMode", "type": "str"},
        "identity_translation": {"key": "identityTranslation", "type": "str"},
        "sender_client_id": {"key": "senderClientId", "type": "str"},
        "remote_calling_mode_client_id": {"key": "remoteCallingModeClientId", "type": "str"},
        "audience_override": {"key": "audienceOverride", "type": "str"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        api_mode: Optional[Union[str, "_models.ApiMode"]] = None,
        identity_translation: Optional[Union[str, "_models.IdentityTranslation"]] = None,
        sender_client_id: Optional[str] = None,
        remote_calling_mode_client_id: Optional[str] = None,
        audience_override: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword remote_endpoint: Remote host to which communication needs to be made.
        :paramtype remote_endpoint: str
        :keyword cname: Unique CNAME to represent the Azure Data Transfer API Flow instance.
        :paramtype cname: str
        :keyword api_mode: Remote Calling Mode in the Azure Data Transfer API Flow, which describes how
         the API Flow will be invoked. Known values are: "SDK" and "Endpoint".
        :paramtype api_mode: str or ~azure.mgmt.azuredatatransfer.models.ApiMode
        :keyword identity_translation: Flag for if Azure Data Transfer API Flow should extract the user
         token. Known values are: "UserIdentity" and "ServiceIdentity".
        :paramtype identity_translation: str or
         ~azure.mgmt.azuredatatransfer.models.IdentityTranslation
        :keyword sender_client_id: Sender's app user assigned Manage Identity client ID.
        :paramtype sender_client_id: str
        :keyword remote_calling_mode_client_id: Remote stub app registration Client ID.
        :paramtype remote_calling_mode_client_id: str
        :keyword audience_override: Optional field to override the audience of the remote endpoint.
        :paramtype audience_override: str
        """
        super().__init__(**kwargs)
        self.remote_endpoint = remote_endpoint
        self.cname = cname
        self.api_mode = api_mode
        self.identity_translation = identity_translation
        self.sender_client_id = sender_client_id
        self.remote_calling_mode_client_id = remote_calling_mode_client_id
        self.audience_override = audience_override


class AzureResourceManagerArmResponseConnection(_serialization.Model):  # pylint: disable=name-too-long
    """Azure operation completed successfully.

    All required parameters must be populated in order to send to server.

    :ivar body: The body type of the operation request or response. Required.
    :vartype body: ~azure.mgmt.azuredatatransfer.models.Connection
    """
    ...
    _attribute_map = {
        "body": {"key": "body", "type": "Connection"},
    }

    def __init__(self, *, body: "_models.Connection", **kwargs: Any) -> None:
        """
        :keyword body: The body type of the operation request or response. Required.
        :paramtype body: ~azure.mgmt.azuredatatransfer.models.Connection
        """
        super().__init__(**kwargs)
        self.body = body


class AzureResourceManagerArmResponseFlow(_serialization.Model):
    """Azure operation completed successfully.

    All required parameters must be populated in order to send to server.

    :ivar body: The body type of the operation request or response. Required.
    :vartype body: ~azure.mgmt.azuredatatransfer.models.Flow
    """
    ...
    _attribute_map = {
        "body": {"key": "body", "type": "Flow"},
    }

    def __init__(self, *, body: "_models.Flow", **kwargs: Any) -> None:
        """
        :keyword body: The body type of the operation request or response. Required.
        :paramtype body: ~azure.mgmt.azuredatatransfer.models.Flow
        """
        super().__init__(**kwargs)
        self.body = body


class AzureResourceManagerArmResponsePipeline(_serialization.Model):
    """Azure operation completed successfully.

    All required parameters must be populated in order to send to server.

    :ivar body: The body type of the operation request or response. Required.
    :vartype body: ~azure.mgmt.azuredatatransfer.models.Pipeline
    """
    ...
    _attribute_map = {
        "body": {"key": "body", "type": "Pipeline"},
    }

    def __init__(self, *, body: "_models.Pipeline", **kwargs: Any) -> None:
        """
        :keyword body: The body type of the operation request or response. Required.
        :paramtype body: ~azure.mgmt.azuredatatransfer.models.Pipeline
        """
        super().__init__(**kwargs)
        self.body = body
...
class ConnectionIdList(_serialization.Model):
    """An array of connection id resources.

    :ivar value: Connection ID to target.
    ...
    def __init__(self, *, value: Optional[List[str]] = None, **kwargs: Any) -> None:
        """
        :keyword value: Connection ID to target.
...
class ConnectionListResult(_serialization.Model):
    ...
    :ivar value: The Connection items on this page. Required.
    ...
    def __init__(self, *, value: List["_models.Connection"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword value: The Connection items on this page. Required.
...
class ConnectionProperties(_serialization.Model):
    ...
    :ivar status: Status of the connection. Known values are: "InReview", "Approved", "Rejected",
     and "Accepted".
    :vartype status: str or ~azure.mgmt.azuredatatransfer.models.ConnectionStatus
    :ivar force_disabled_status: Force disablement status of the current connection.
    :vartype force_disabled_status: list[str or
     ~azure.mgmt.azuredatatransfer.models.ForceDisabledStatus]
    ...
    :ivar provisioning_state: Provisioning state of the connection. Known values are: "Succeeded",
    ...
    _validation = {
        ...
        "force_disabled_status": {"readonly": True},
    ...
    _attribute_map = {
        ...
        "force_disabled_status": {"key": "forceDisabledStatus", "type": "[str]"},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.force_disabled_status: Optional[List[Union[str, "_models.ForceDisabledStatus"]]] = None
...
class FlowListResult(_serialization.Model):
    """The response of a Flow list operation.

    All required parameters must be populated in order to send to server.

    :ivar value: The Flow items on this page. Required.
    ...
    def __init__(self, *, value: List["_models.Flow"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword value: The Flow items on this page. Required.
...
class FlowProperties(_serialization.Model):
    ...
    :ivar force_disabled_status: Force disablement status of the current flow.
    :vartype force_disabled_status: list[str or
     ~azure.mgmt.azuredatatransfer.models.ForceDisabledStatus]
    ...
    :ivar storage_table_name: Storage Table Name.
    :vartype storage_table_name: str
    ...
    :ivar flow_type: The flow type for this flow. Known values are: "Unknown", "Complex",
     ...
     "StreamingVideo", "Opaque", "MissionOpaqueXML", "DiskImages", and "API".
    ...
    :ivar provisioning_state: Provisioning state of the flow. Known values are: "Succeeded",
     "Failed", "Canceled", and "Accepted".
    :vartype provisioning_state: str or ~azure.mgmt.azuredatatransfer.models.ProvisioningState
    ...
    :ivar api_flow_options: The API Flow configuration options for Azure Data Transfer API Flow
     type.
    :vartype api_flow_options: ~azure.mgmt.azuredatatransfer.models.ApiFlowOptions
    ...
    :ivar event_hub_id: Event Hub ID.
    :vartype event_hub_id: str
    :ivar consumer_group: Event Hub Consumer Group.
    ...
    _attribute_map = {
        ...
        "storage_table_name": {"key": "storageTableName", "type": "str"},
        ...
        "api_flow_options": {"key": "apiFlowOptions", "type": "ApiFlowOptions"},
        ...
        "event_hub_id": {"key": "eventHubId", "type": "str"},
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        api_flow_options: Optional["_models.ApiFlowOptions"] = None,
        ...
        **kwargs: Any
        ...
        :keyword storage_table_name: Storage Table Name.
        :paramtype storage_table_name: str
        ...
        :keyword api_flow_options: The API Flow configuration options for Azure Data Transfer API Flow
         type.
        :paramtype api_flow_options: ~azure.mgmt.azuredatatransfer.models.ApiFlowOptions
        ...
        :keyword event_hub_id: Event Hub ID.
        :paramtype event_hub_id: str
        :keyword consumer_group: Event Hub Consumer Group.
        ...
        self.api_flow_options = api_flow_options
        ...
        self.event_hub_id = event_hub_id
...
class ListFlowsByPipelineConnection(_serialization.Model):
    """A connection resource id in addition to all child flow resources under this connection.

    :ivar id: ID of the connection.
    :vartype id: str
    :ivar flows: List of flows associated with the connection.
    :vartype flows: list[~azure.mgmt.azuredatatransfer.models.Flow]
    """

    _attribute_map = {
        "id": {"key": "id", "type": "str"},
        "flows": {"key": "flows", "type": "[Flow]"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        flows: Optional[List["_models.Flow"]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword id: ID of the connection.
        :paramtype id: str
        :keyword flows: List of flows associated with the connection.
        :paramtype flows: list[~azure.mgmt.azuredatatransfer.models.Flow]
        """
        super().__init__(**kwargs)
        self.id = id
        self.flows = flows
...
class ListFlowsByPipelineResult(_serialization.Model):
    """An array of flow resources.

    :ivar value: List flows by pipeline result by connection.
    :vartype value: list[~azure.mgmt.azuredatatransfer.models.ListFlowsByPipelineConnection]
    """

    _attribute_map = {
        "value": {"key": "value", "type": "[ListFlowsByPipelineConnection]"},
    }

    def __init__(self, *, value: Optional[List["_models.ListFlowsByPipelineConnection"]] = None, **kwargs: Any) -> None:
        """
        :keyword value: List flows by pipeline result by connection.
        :paramtype value: list[~azure.mgmt.azuredatatransfer.models.ListFlowsByPipelineConnection]
        """
        super().__init__(**kwargs)
        self.value = value
...
class PendingConnection(_serialization.Model):
    ...
    :vartype properties: ~azure.mgmt.azuredatatransfer.models.Connection
    :ivar tags: Resource tags.
    :vartype tags: dict[str, str]
    :ivar location: The geo-location where the resource lives. Required.
    :vartype location: str
    ...
    _attribute_map = {
        ...
        "schemas": {"key": "schemas", "type": "[Schema]"},
        "schema_uris": {"key": "schemaUris", "type": "[str]"},
        "properties": {"key": "properties", "type": "Connection"},
        "tags": {"key": "tags", "type": "{str}"},
        "location": {"key": "location", "type": "str"},
        "id": {"key": "id", "type": "str"},
        "name": {"key": "name", "type": "str"},
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        schemas: Optional[List["_models.Schema"]] = None,
        schema_uris: Optional[List[str]] = None,
        properties: Optional["_models.Connection"] = None,
        tags: Optional[Dict[str, str]] = None,
        **kwargs: Any
    ) -> None:
        """
        ...
        :paramtype properties: ~azure.mgmt.azuredatatransfer.models.Connection
        :keyword tags: Resource tags.
        :paramtype tags: dict[str, str]
        :keyword location: The geo-location where the resource lives. Required.
        :paramtype location: str
...
class PendingConnectionListResult(_serialization.Model):
    """The response of a PendingConnection list operation.

    All required parameters must be populated in order to send to server.

    :ivar value: The PendingConnection items on this page. Required.
    ...
    def __init__(
        self, *, value: List["_models.PendingConnection"], next_link: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: The PendingConnection items on this page. Required.
...
class PendingFlow(_serialization.Model):
    """Pending flow object.
    ...
    :vartype consumer_group: str
    :ivar properties: The resource-specific properties for this resource.
    :vartype properties: ~azure.mgmt.azuredatatransfer.models.Flow
    :ivar tags: Resource tags.
    :vartype tags: dict[str, str]
    :ivar location: The geo-location where the resource lives. Required.
    :vartype location: str
    ...
    _attribute_map = {
        ...
        "event_hub_id": {"key": "eventHubId", "type": "str"},
        "consumer_group": {"key": "consumerGroup", "type": "str"},
        "properties": {"key": "properties", "type": "Flow"},
        "tags": {"key": "tags", "type": "{str}"},
        "location": {"key": "location", "type": "str"},
        "id": {"key": "id", "type": "str"},
        "name": {"key": "name", "type": "str"},
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        event_hub_id: Optional[str] = None,
        consumer_group: Optional[str] = None,
        properties: Optional["_models.Flow"] = None,
        tags: Optional[Dict[str, str]] = None,
        **kwargs: Any
    ) -> None:
        """
        ...
        :paramtype consumer_group: str
        :keyword properties: The resource-specific properties for this resource.
        :paramtype properties: ~azure.mgmt.azuredatatransfer.models.Flow
        :keyword tags: Resource tags.
        :paramtype tags: dict[str, str]
        :keyword location: The geo-location where the resource lives. Required.
        :paramtype location: str
...
class PendingFlowListResult(_serialization.Model):
    """The response of a PendingFlow list operation.

    All required parameters must be populated in order to send to server.

    :ivar value: The PendingFlow items on this page. Required.
    ...
    def __init__(self, *, value: List["_models.PendingFlow"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword value: The PendingFlow items on this page. Required.
...
class PipelineListResult(_serialization.Model):
    ...
    :ivar value: The Pipeline items on this page. Required.
    ...
    def __init__(self, *, value: List["_models.Pipeline"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword value: The Pipeline items on this page. Required.
...
class PipelineProperties(_serialization.Model):
    ...
    :vartype flow_types: list[str or ~azure.mgmt.azuredatatransfer.models.FlowType]
    :ivar disabled_flow_types: The flow types that are disabled for this pipeline.
    :vartype disabled_flow_types: list[str or ~azure.mgmt.azuredatatransfer.models.FlowType]
    :ivar quarantine_download_storage_account: Quarantine Download Storage Account.
    :vartype quarantine_download_storage_account: str
    :ivar quarantine_download_storage_container: Quarantine Download Storage Container.
    :vartype quarantine_download_storage_container: str
    :ivar status: Status of the current pipeline. Known values are: "Enabled" and "Disabled".
    :vartype status: str or ~azure.mgmt.azuredatatransfer.models.PipelineStatus
    """
    ...
    _attribute_map = {
        ...
        "policies": {"key": "policies", "type": "[str]"},
        "flow_types": {"key": "flowTypes", "type": "[str]"},
        "disabled_flow_types": {"key": "disabledFlowTypes", "type": "[str]"},
        "quarantine_download_storage_account": {"key": "quarantineDownloadStorageAccount", "type": "str"},
        "quarantine_download_storage_container": {"key": "quarantineDownloadStorageContainer", "type": "str"},
        "status": {"key": "status", "type": "str"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        policies: Optional[List[str]] = None,
        flow_types: Optional[List[Union[str, "_models.FlowType"]]] = None,
        disabled_flow_types: Optional[List[Union[str, "_models.FlowType"]]] = None,
        quarantine_download_storage_account: Optional[str] = None,
        quarantine_download_storage_container: Optional[str] = None,
        status: Optional[Union[str, "_models.PipelineStatus"]] = None,
        **kwargs: Any
    ) -> None:
        """
        ...
        :paramtype flow_types: list[str or ~azure.mgmt.azuredatatransfer.models.FlowType]
        :keyword disabled_flow_types: The flow types that are disabled for this pipeline.
        :paramtype disabled_flow_types: list[str or ~azure.mgmt.azuredatatransfer.models.FlowType]
        :keyword quarantine_download_storage_account: Quarantine Download Storage Account.
        :paramtype quarantine_download_storage_account: str
        :keyword quarantine_download_storage_container: Quarantine Download Storage Container.
        :paramtype quarantine_download_storage_container: str
        :keyword status: Status of the current pipeline. Known values are: "Enabled" and "Disabled".
        :paramtype status: str or ~azure.mgmt.azuredatatransfer.models.PipelineStatus
        """
        super().__init__(**kwargs)
        ...
        self.policies = policies
        self.flow_types = flow_types
        self.disabled_flow_types = disabled_flow_types
        self.quarantine_download_storage_account = quarantine_download_storage_account
        self.quarantine_download_storage_container = quarantine_download_storage_container
        self.status = status
