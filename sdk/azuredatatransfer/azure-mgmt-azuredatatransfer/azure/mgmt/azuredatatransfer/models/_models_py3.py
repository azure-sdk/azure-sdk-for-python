...
class ActionRequest(_serialization.Model):
    """An action request.

    :ivar name: Name of the action.
    :vartype name: str
    :ivar payload: Action request payload.
    ...
    def __init__(self, *, name: Optional[str] = None, payload: Optional[Dict[str, Any]] = None, **kwargs: Any) -> None:
        """
        :keyword name: Name of the action.
        :paramtype name: str
        :keyword payload: Action request payload.
...
class ActionResult(_serialization.Model):
    ...
    :ivar result: Action request result.
    ...
    def __init__(self, *, result: Optional[Dict[str, Any]] = None, **kwargs: Any) -> None:
        """
        :keyword result: Action request result.
        :paramtype result: dict[str, any]
        """
        super().__init__(**kwargs)
        self.result = result
...
class FlowProperties(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar flow_type: The flow type for this flow. Known values are: "Unknown", "Complex",
     "DevSecOps", "Messaging", "Mission", "MicrosoftInternal", and "BasicFiles".
