...
class Action(_serialization.Model):
    ...
    :ivar action_type: Type of action to be executed. Required. Known values are: "Internal",
     "AllowUpdates", and "ForceDisable".
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword action_type: Type of action to be executed. Required. Known values are: "Internal",
         "AllowUpdates", and "ForceDisable".
...
class Connection(TrackedResource):
    ...
    :ivar identity: The managed identity of the connection resource, if configured.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword identity: The managed identity of the connection resource, if configured.
...
class Operation(_serialization.Model):
    ...
    :ivar action_type: Enum. Indicates the action type. "Internal" refers to actions that are for
     internal only APIs. Known values are: "Internal", "AllowUpdates", and "ForceDisable".
    :vartype action_type: str or ~azure.mgmt.azuredatatransfer.models.ActionType
    """
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        super().__init__(
            ...
            api_flow_options=api_flow_options,
...
class Pipeline(TrackedResource):
    ...
    :ivar identity: The managed identity of the pipeline resource, if configured.
    :vartype identity: ~azure.mgmt.azuredatatransfer.models.ManagedServiceIdentity
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword identity: The managed identity of the pipeline resource, if configured.
        :paramtype identity: ~azure.mgmt.azuredatatransfer.models.ManagedServiceIdentity
        """
        super().__init__(tags=tags, location=location, **kwargs)
        self.properties = properties
