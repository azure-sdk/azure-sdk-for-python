...
class Azuredatatransferrp:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype azure_data_transfer:
     azure.mgmt.azuredatatransfer.operations.AzureDataTransferOperations
    :ivar flows: FlowsOperations operations
    :vartype flows: azure.mgmt.azuredatatransfer.operations.FlowsOperations
    :ivar connections: ConnectionsOperations operations
    :vartype connections: azure.mgmt.azuredatatransfer.operations.ConnectionsOperations
    :ivar list_pending_connections: ListPendingConnectionsOperations operations
    :vartype list_pending_connections:
     azure.mgmt.azuredatatransfer.operations.ListPendingConnectionsOperations
    :ivar list_pending_flows: ListPendingFlowsOperations operations
    :vartype list_pending_flows: azure.mgmt.azuredatatransfer.operations.ListPendingFlowsOperations
    :ivar pipelines: PipelinesOperations operations
    :vartype pipelines: azure.mgmt.azuredatatransfer.operations.PipelinesOperations
    :ivar list_schemas: ListSchemasOperations operations
    :vartype list_schemas: azure.mgmt.azuredatatransfer.operations.ListSchemasOperations
    :ivar list_flows_by_pipeline: ListFlowsByPipelineOperations operations
    :vartype list_flows_by_pipeline:
     azure.mgmt.azuredatatransfer.operations.ListFlowsByPipelineOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.azuredatatransfer.operations.Operations
    ...
    :type base_url: str
    :keyword api_version: Api Version. Default value is "2025-04-11-preview". Note that overriding
    ...
    def __init__(
        ...
        self.list_flows_by_pipeline = ListFlowsByPipelineOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
