...
class FlowsOperations:  # pylint: disable=too-many-public-methods
    ...
    async def get(self, resource_group_name: str, connection_name: str, flow_name: str, **kwargs: Any) -> _models.Flow:
        ...
        :param connection_name: The name for the connection to perform the operation on. Required.
        :type connection_name: str
        :param flow_name: The name for the flow to perform the operation on. Required.
        :type flow_name: str
    ...
    async def begin_set_destination_endpoints(
        ...
        **kwargs: Any
        ...
        :param flow_name: The name for the flow to perform the operation on. Required.
        :type flow_name: str
        :param stream_destination_endpoints: Destination endpoints wanted. Required.
    ...
    async def begin_set_destination_endpoints(
        ...
        **kwargs: Any
        ...
        :param flow_name: The name for the flow to perform the operation on. Required.
        :type flow_name: str
        :param stream_destination_endpoints: Destination endpoints wanted. Is either a
    ...
    async def begin_set_destination_endpoint_ports(
        ...
        **kwargs: Any
        ...
        :param flow_name: The name for the flow to perform the operation on. Required.
        :type flow_name: str
        :param stream_destination_endpoint_ports: The destination endpoint ports wanted. Required.
    ...
    async def begin_set_destination_endpoint_ports(
        ...
        **kwargs: Any
        ...
        :param flow_name: The name for the flow to perform the operation on. Required.
        :type flow_name: str
        :param stream_destination_endpoint_ports: The destination endpoint ports wanted. Is either a
