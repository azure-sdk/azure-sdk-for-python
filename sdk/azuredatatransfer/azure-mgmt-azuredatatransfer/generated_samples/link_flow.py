...
def main():
    ...
    response = client.flows.begin_link(
...
# x-ms-original-file: specification/azuredatatransfer/resource-manager/Microsoft.AzureDataTransfer/preview/2025-03-01-preview/examples/linkFlow.json
