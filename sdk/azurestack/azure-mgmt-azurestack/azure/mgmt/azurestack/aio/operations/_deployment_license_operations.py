...
class DeploymentLicenseOperations:
    ...
    @overload
    async def create(
        self, deployment_license_request: IO[bytes], *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.DeploymentLicenseResponse:
        """Creates a license that can be used to deploy an Azure Stack device.

        :param deployment_license_request: Request body for creating a deployment license. Required.
        :type deployment_license_request: IO[bytes]
    ...
    async def create(
        self, deployment_license_request: Union[_models.DeploymentLicenseRequest, IO[bytes]], **kwargs: Any
    ) -> _models.DeploymentLicenseResponse:
        """Creates a license that can be used to deploy an Azure Stack device.

        :param deployment_license_request: Request body for creating a deployment license. Is either a
         DeploymentLicenseRequest type or a IO[bytes] type. Required.
        :type deployment_license_request: ~azure.mgmt.azurestack.models.DeploymentLicenseRequest or
         IO[bytes]
        :return: DeploymentLicenseResponse or the result of cls(response)
        :rtype: ~azure.mgmt.azurestack.models.DeploymentLicenseResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        _json = None
        _content = None
        if isinstance(deployment_license_request, (IOBase, bytes)):
        ...
        deserialized = self._deserialize("DeploymentLicenseResponse", pipeline_response.http_response)
