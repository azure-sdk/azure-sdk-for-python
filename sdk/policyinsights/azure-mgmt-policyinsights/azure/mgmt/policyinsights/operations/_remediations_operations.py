...
def build_list_deployments_at_management_group_request(  # pylint: disable=name-too-long
...
def build_list_deployments_at_subscription_request(  # pylint: disable=name-too-long
...
def build_list_deployments_at_resource_group_request(  # pylint: disable=name-too-long
...
def build_list_deployments_at_resource_request(  # pylint: disable=name-too-long
