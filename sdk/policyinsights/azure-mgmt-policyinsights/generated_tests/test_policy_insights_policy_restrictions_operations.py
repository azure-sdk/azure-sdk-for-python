...
class TestPolicyInsightsPolicyRestrictionsOperations(AzureMgmtRecordedTestCase):
    ...
    @recorded_by_proxy
    def test_check_at_subscription_scope(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_check_at_resource_group_scope(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_check_at_management_group_scope(self, resource_group):
