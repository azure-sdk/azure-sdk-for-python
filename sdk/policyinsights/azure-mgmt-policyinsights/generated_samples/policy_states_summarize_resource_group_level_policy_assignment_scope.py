...
# USAGE
    python policy_states_summarize_resource_group_level_policy_assignment_scope.py
...
def main():
    ...
    response = client.policy_states.summarize_for_resource_group_level_policy_assignment(
        policy_states_summary_resource="latest",
        subscription_id="fffedd8f-ffff-fffd-fffd-fffed2f84852",
        resource_group_name="myResourceGroup",
        policy_assignment_name="b7a1ca2596524e3ab19597f2",
    )
    print(response)
