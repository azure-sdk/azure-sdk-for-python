...
# USAGE
    python component_policy_states_query_subscription_level_policy_assignment_scope.py
...
def main():
    ...
    response = client.component_policy_states.list_query_results_for_subscription_level_policy_assignment(
        subscription_id="fffedd8f-ffff-fffd-fffd-fffed2f84852",
