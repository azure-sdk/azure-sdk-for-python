...
class ComputeClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype community_gallery_image_versions:
     azure.mgmt.compute.gallery.aio.operations.CommunityGalleryImageVersionsOperations
