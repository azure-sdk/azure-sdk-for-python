...
class DisksOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.computetest.v2023_01_02.aio.ComputeManagementClient`'s
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type disk: ~azure.mgmt.computetest.v2023_01_02.models.Disk
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.computetest.v2023_01_02.models.Disk]
    ...
    async def begin_create_or_update(
        ...
        :type disk: ~azure.mgmt.computetest.v2023_01_02.models.Disk or IO
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type disk: ~azure.mgmt.computetest.v2023_01_02.models.DiskUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_update(
        ...
        :type disk: ~azure.mgmt.computetest.v2023_01_02.models.DiskUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def get(self, resource_group_name: str, disk_name: str, **kwargs: Any) -> _models.Disk:
        ...
        :rtype: ~azure.mgmt.computetest.v2023_01_02.models.Disk
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.Disk"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.computetest.v2023_01_02.models.Disk]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def begin_grant_access(
        ...
        **kwargs: Any
        ...
        :param grant_access_data: Access data object supplied in the body of the get disk access
         operation. Required.
        :type grant_access_data: ~azure.mgmt.computetest.v2023_01_02.models.GrantAccessData
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of AsyncLROPoller that returns either AccessUri or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.computetest.v2023_01_02.models.AccessUri]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_grant_access(
        ...
        **kwargs: Any
        ...
        :type grant_access_data: ~azure.mgmt.computetest.v2023_01_02.models.GrantAccessData or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
