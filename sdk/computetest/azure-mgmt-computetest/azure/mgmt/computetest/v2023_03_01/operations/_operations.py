...
class Operations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.computetest.v2023_03_01.ComputeManagementClient`'s
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.ComputeOperationValue"]:
        ...
        :return: An iterator like instance of either ComputeOperationValue or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.computetest.v2023_03_01.models.ComputeOperationValue]
...
class UsageOperations:
    ...
    def list(self, location: str, **kwargs: Any) -> Iterable["_models.Usage"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.computetest.v2023_03_01.models.Usage]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class VirtualMachineSizesOperations:
    ...
    def list(self, location: str, **kwargs: Any) -> Iterable["_models.VirtualMachineSize"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.computetest.v2023_03_01.models.VirtualMachineSize]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class VirtualMachineRunCommandsOperations:
    ...
    def list(self, location: str, **kwargs: Any) -> Iterable["_models.RunCommandDocumentBase"]:
        ...
        :return: An iterator like instance of either RunCommandDocumentBase or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.computetest.v2023_03_01.models.RunCommandDocumentBase]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either VirtualMachineRunCommand or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.computetest.v2023_03_01.models.VirtualMachineRunCommand]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_virtual_machine(
        ...
        :return: An iterator like instance of either VirtualMachineRunCommand or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.computetest.v2023_03_01.models.VirtualMachineRunCommand]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_run_command(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either RunCommandResult or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.computetest.v2023_03_01.models.RunCommandResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
