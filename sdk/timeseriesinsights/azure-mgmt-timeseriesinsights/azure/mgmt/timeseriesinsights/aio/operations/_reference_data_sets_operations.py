...
class ReferenceDataSetsOperations:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :param reference_data_set_name: Name of the reference data set. Required.
        :type reference_data_set_name: str
        :param parameters: Parameters for creating a reference data set. Is either a
         ReferenceDataSetCreateOrUpdateParameters type or a IO type. Required.
        :type parameters:
        ...
        cls: ClsType[_models.ReferenceDataSetResource] = kwargs.pop("cls", None)
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type reference_data_set_name: str
        :param reference_data_set_update_parameters: Request object that contains the updated
         information for the reference data set. Is either a ReferenceDataSetUpdateParameters type or a
         IO type. Required.
        :type reference_data_set_update_parameters:
        ...
        _json = None
        _content = None
        if isinstance(reference_data_set_update_parameters, (IOBase, bytes)):
    ...
    async def list_by_environment(
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.ReferenceDataSetListResponse] = kwargs.pop("cls", None)
    ...
    list_by_environment.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.TimeSeriesInsights/environments/{environmentName}/referenceDataSets"
    }
