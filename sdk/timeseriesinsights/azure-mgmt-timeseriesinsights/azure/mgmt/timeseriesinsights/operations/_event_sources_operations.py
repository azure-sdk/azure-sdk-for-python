...
class EventSourcesOperations:
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :param event_source_name: Name of the event source. Required.
        :type event_source_name: str
        :param parameters: Parameters for creating an event source resource. Is either a
         EventSourceCreateOrUpdateParameters type or a IO type. Required.
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.EventSourceResource] = kwargs.pop("cls", None)
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type event_source_name: str
        :param event_source_update_parameters: Request object that contains the updated information for
         the event source. Is either a EventSourceUpdateParameters type or a IO type. Required.
        :type event_source_update_parameters:
        ...
        _json = None
        _content = None
        if isinstance(event_source_update_parameters, (IOBase, bytes)):
    ...
    def list_by_environment(
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.EventSourceListResponse] = kwargs.pop("cls", None)
    ...
    list_by_environment.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.TimeSeriesInsights/environments/{environmentName}/eventSources"
    }
