...
def build_create_or_update_request(
    resource_group_name: str, environment_name: str, access_policy_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})

    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2021-03-31-preview"))
    ...
    path_format_arguments = {
        ...
        "accessPolicyName": _SERIALIZER.url(
            "access_policy_name", access_policy_name, "str", max_length=90, min_length=1, pattern=r"^[-\w\._\(\)]+$"
        ),
    }
...
class AccessPoliciesOperations:
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :param access_policy_name: Name of the access policy. Required.
    ...
    def create_or_update(
        ...
        environment_name: str,
        access_policy_name: str,
        parameters: Union[_models.AccessPolicyCreateOrUpdateParameters, IO],
        **kwargs: Any
    ) -> _models.AccessPolicyResource:
        """Create or update an access policy in the specified environment.
        ...
        :param access_policy_name: Name of the access policy. Required.
        :type access_policy_name: str
        :param parameters: Parameters for creating an access policy. Is either a
         AccessPolicyCreateOrUpdateParameters type or a IO type. Required.
        :type parameters: ~azure.mgmt.timeseriesinsights.models.AccessPolicyCreateOrUpdateParameters or
         IO
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.AccessPolicyResource] = kwargs.pop("cls", None)
    ...
    @distributed_trace
    def get(
        self, resource_group_name: str, environment_name: str, access_policy_name: str, **kwargs: Any
    ) -> _models.AccessPolicyResource:
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :param access_policy_update_parameters: Request object that contains the updated information
         for the access policy. Required.
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :param access_policy_update_parameters: Request object that contains the updated information
         for the access policy. Required.
        :type access_policy_update_parameters: IO
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def update(
        ...
        environment_name: str,
        access_policy_name: str,
        access_policy_update_parameters: Union[_models.AccessPolicyUpdateParameters, IO],
        **kwargs: Any
    ) -> _models.AccessPolicyResource:
        """Updates the access policy with the specified name in the specified subscription, resource
        group, and environment.
        ...
        :type access_policy_name: str
        :param access_policy_update_parameters: Request object that contains the updated information
         for the access policy. Is either a AccessPolicyUpdateParameters type or a IO type. Required.
        :type access_policy_update_parameters:
         ~azure.mgmt.timeseriesinsights.models.AccessPolicyUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        _json = None
        _content = None
        if isinstance(access_policy_update_parameters, (IOBase, bytes)):
            _content = access_policy_update_parameters
        else:
    ...
    def list_by_environment(
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.AccessPolicyListResponse] = kwargs.pop("cls", None)
    ...
    list_by_environment.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.TimeSeriesInsights/environments/{environmentName}/accessPolicies"
    }
