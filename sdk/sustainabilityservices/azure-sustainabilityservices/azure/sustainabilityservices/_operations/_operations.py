...
class SustainabilityServiceClientOperationsMixin(SustainabilityServiceClientMixinABC):  # pylint: disable=name-too-long
    ...
    def list_factor_libraries(self, **kwargs: Any) -> Iterable["_models.FactorLibrary"]:
        ...
        def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(List[_models.FactorLibrary], deserialized["value"])
            if cls:
    ...
    def list_estimation_factors_by_factor_library(  # pylint: disable=name-too-long
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.EstimationFactor], deserialized["value"])
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, iter(list_of_elem)
    ...
    def list_emission_factors_by_factor_library(
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.EmissionFactor], deserialized["value"])
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, iter(list_of_elem)
    ...
    def list_factor_mappings(self, factor_library_id: str, **kwargs: Any) -> Iterable["_models.FactorMapping"]:
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.FactorMapping], deserialized["value"])
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, iter(list_of_elem)
    ...
    def list_calculation_models(self, **kwargs: Any) -> Iterable["_models.CalculationModel"]:
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.CalculationModel], deserialized["value"])
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, iter(list_of_elem)
    ...
    def list_reference_entities(self, **kwargs: Any) -> Iterable["_models.ReferenceDataEntities"]:
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.ReferenceDataEntities], deserialized["value"])
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, iter(list_of_elem)
    ...
    def list_reference_entity_data(self, entity_name: str, **kwargs: Any) -> Iterable["_models.EntityRecord"]:
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.EntityRecord], deserialized["value"])
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, iter(list_of_elem)
