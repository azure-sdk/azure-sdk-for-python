...
class InfaRuntimeResourceFetchMetaData(_model_base.Model):
...
class InfaServerlessFetchConfigProperties(_model_base.Model):
...
class InformaticaServerlessRuntimeProperties(_model_base.Model):
...
class ServerlessRuntimePropertiesCustomUpdate(_model_base.Model):
