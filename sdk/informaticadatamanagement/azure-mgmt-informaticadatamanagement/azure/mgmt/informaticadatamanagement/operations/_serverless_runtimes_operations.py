...
def build_list_by_informatica_organization_resource_request(  # pylint: disable=name-too-long
    resource_group_name: str, organization_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})

    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2024-07-22"))
...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "organizationName": _SERIALIZER.url("organization_name", organization_name, "str", pattern=r"^[a-zA-Z0-9_-]*$"),
        "serverlessRuntimeName": _SERIALIZER.url(
            "serverless_runtime_name", serverless_runtime_name, "str", pattern=r"^[a-zA-Z0-9_-]*$"
        ),
    }
...
def build_check_dependencies_request(
    resource_group_name: str, organization_name: str, serverless_runtime_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_serverless_resource_by_id_request(
    resource_group_name: str, organization_name: str, serverless_runtime_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_start_failed_serverless_runtime_request(  # pylint: disable=name-too-long
    resource_group_name: str, organization_name: str, serverless_runtime_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ServerlessRuntimesOperations:
    ...
    def list_by_informatica_organization_resource(  # pylint: disable=name-too-long
        ...
        :return: An iterator like instance of either InformaticaServerlessRuntimeResource or the result
         of cls(response)
        :rtype:
        ...
        cls: ClsType[_models.InformaticaServerlessRuntimeResourceListResult] = kwargs.pop("cls", None)
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_informatica_organization_resource_request(
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("InformaticaServerlessRuntimeResourceListResult", pipeline_response)
    ...
    def get(
        ...
        :return: InformaticaServerlessRuntimeResource or the result of cls(response)
        ...
        deserialized = self._deserialize("InformaticaServerlessRuntimeResource", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        resource: Union[_models.InformaticaServerlessRuntimeResource, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "InformaticaServerlessRuntimeResource")
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either InformaticaServerlessRuntimeResource or
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource:
         ~azure.mgmt.informaticadatamanagement.models.InformaticaServerlessRuntimeResource or IO[bytes]
        :return: An instance of LROPoller that returns either InformaticaServerlessRuntimeResource or
         the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.informaticadatamanagement.models.InformaticaServerlessRuntimeResource]
    ...
    def update(
        ...
        organization_name: str,
        serverless_runtime_name: str,
        properties: Union[_models.InformaticaServerlessRuntimeResourceUpdate, IO[bytes]],
        **kwargs: Any
    ) -> _models.InformaticaServerlessRuntimeResource:
        """Update a InformaticaServerlessRuntimeResource.
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "InformaticaServerlessRuntimeResourceUpdate")
    ...
    def check_dependencies(
        ...
        :param serverless_runtime_name: Name of the Serverless Runtime resource. Required.
        :type serverless_runtime_name: str
        :return: CheckDependenciesResponse or the result of cls(response)
        ...
        _request = build_check_dependencies_request(
            resource_group_name=resource_group_name,
            organization_name=organization_name,
            serverless_runtime_name=serverless_runtime_name,
            subscription_id=self._config.subscription_id,
        ...
        deserialized = self._deserialize("CheckDependenciesResponse", pipeline_response.http_response)
    ...
    def serverless_resource_by_id(
        ...
        _request = build_serverless_resource_by_id_request(
            resource_group_name=resource_group_name,
            organization_name=organization_name,
            serverless_runtime_name=serverless_runtime_name,
            subscription_id=self._config.subscription_id,
    ...
    def start_failed_serverless_runtime(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_start_failed_serverless_runtime_request(
            resource_group_name=resource_group_name,
            organization_name=organization_name,
            serverless_runtime_name=serverless_runtime_name,
            subscription_id=self._config.subscription_id,
