...
# USAGE
    python serverless_runtimes_check_dependencies_maximum_set_gen.py
...
# x-ms-original-file: specification/informatica/resource-manager/Informatica.DataManagement/preview/2024-07-22/examples/ServerlessRuntimes_CheckDependencies_MaximumSet_Gen.json
