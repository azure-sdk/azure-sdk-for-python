...
# USAGE
    python serverless_runtimes_delete_maximum_set_gen.py
...
def main():
    ...
    client.serverless_runtimes.begin_delete(
...
# x-ms-original-file: specification/informatica/resource-manager/Informatica.DataManagement/preview/2024-07-22/examples/ServerlessRuntimes_Delete_MaximumSet_Gen.json
