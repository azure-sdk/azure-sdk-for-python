...
from ...operations._signal_rreplica_shared_private_link_resources_operations import (
...
class SignalRReplicaSharedPrivateLinkResourcesOperations:  # pylint: disable=name-too-long
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.signalr.models.SharedPrivateLinkResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either SharedPrivateLinkResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.signalr.models.SharedPrivateLinkResource]
