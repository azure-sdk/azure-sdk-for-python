...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.SignalRService/signalR")
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
class SignalROperations:
    ...
    @distributed_trace
    def check_name_availability(
        self, location: str, parameters: Union[_models.NameAvailabilityParameters, IO[bytes]], **kwargs: Any
    ) -> _models.NameAvailability:
        """Checks that the resource name is valid and is not already in use.
        ...
        :type parameters: ~azure.mgmt.signalr.models.NameAvailabilityParameters or IO[bytes]
        :return: NameAvailability or the result of cls(response)
        :rtype: ~azure.mgmt.signalr.models.NameAvailability
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.SignalRResource"]:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.SignalRResource"]:
    ...
    def get(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> _models.SignalRResource:
        ...
        deserialized = self._deserialize("SignalRResource", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        resource_name: str,
        parameters: Union[_models.SignalRResource, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters for the create or update operation. Is either a SignalRResource
         type or a IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.signalr.models.SignalRResource or IO[bytes]
        :return: An instance of LROPoller that returns either SignalRResource or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.signalr.models.SignalRResource]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_keys(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> _models.SignalRKeys:
        ...
        deserialized = self._deserialize("SignalRKeys", pipeline_response.http_response)
    ...
    def begin_regenerate_key(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.signalr.models.RegenerateKeyParameters or IO[bytes]
        :return: An instance of LROPoller that returns either SignalRKeys or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.signalr.models.SignalRKeys]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_replica_skus(
        ...
        _request = build_list_replica_skus_request(
            resource_group_name=resource_group_name,
            resource_name=resource_name,
        ...
        deserialized = self._deserialize("SkuList", pipeline_response.http_response)
