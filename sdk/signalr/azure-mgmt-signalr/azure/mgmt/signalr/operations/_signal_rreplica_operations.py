...
def build_shared_private_link_resources_list_request(
...
def build_shared_private_link_resources_get_request(
...
def build_shared_private_link_resources_create_or_update_request(
    resource_group_name: str,
    resource_name: str,
    replica_name: str,
    shared_private_link_resource_name: str,
...
class SignalRReplicaOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`signal_rreplica` attribute.
    """
    ...
    @distributed_trace
    def shared_private_link_resources_list(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_shared_private_link_resources_list_request(
                    resource_group_name=resource_group_name,
                    resource_name=resource_name,
                    replica_name=replica_name,
                    subscription_id=self._config.subscription_id,
                    api_version=api_version,
                    template_url=self.shared_private_link_resources_list.metadata["url"],
                    headers=_headers,
                    params=_params,
                )
    ...
    shared_private_link_resources_list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SignalRService/signalR/{resourceName}/replicas/{replicaName}/sharedPrivateLinkResources"
    }

    @distributed_trace
    def shared_private_link_resources_get(
        self,
        resource_group_name: str,
        resource_name: str,
        replica_name: str,
        ...
        **kwargs: Any
        ...
        request = build_shared_private_link_resources_get_request(
            resource_group_name=resource_group_name,
            resource_name=resource_name,
            replica_name=replica_name,
            ...
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self.shared_private_link_resources_get.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    shared_private_link_resources_get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SignalRService/signalR/{resourceName}/replicas/{replicaName}/sharedPrivateLinkResources/{sharedPrivateLinkResourceName}"
    }

    def _shared_private_link_resources_create_or_update_initial(
        self,
        resource_group_name: str,
        resource_name: str,
        replica_name: str,
        ...
        **kwargs: Any
        ...
        request = build_shared_private_link_resources_create_or_update_request(
            resource_group_name=resource_group_name,
            resource_name=resource_name,
            replica_name=replica_name,
            shared_private_link_resource_name=shared_private_link_resource_name,
            ...
            json=_json,
            content=_content,
            template_url=self._shared_private_link_resources_create_or_update_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    _shared_private_link_resources_create_or_update_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SignalRService/signalR/{resourceName}/replicas/{replicaName}/sharedPrivateLinkResources/{sharedPrivateLinkResourceName}"
    }

    @overload
    def begin_shared_private_link_resources_create_or_update(
        self,
        resource_group_name: str,
        resource_name: str,
        replica_name: str,
    ...
    def begin_shared_private_link_resources_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = self._shared_private_link_resources_create_or_update_initial(
                resource_group_name=resource_group_name,
                resource_name=resource_name,
                replica_name=replica_name,
                shared_private_link_resource_name=shared_private_link_resource_name,
    ...
    begin_shared_private_link_resources_create_or_update.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SignalRService/signalR/{resourceName}/replicas/{replicaName}/sharedPrivateLinkResources/{sharedPrivateLinkResourceName}"
    }
