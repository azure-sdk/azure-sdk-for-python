...
# USAGE
    python signal_rprivate_endpoint_connections_delete.py
...
# x-ms-original-file: specification/signalr/resource-manager/Microsoft.SignalRService/preview/2025-01-01-preview/examples/SignalRPrivateEndpointConnections_Delete.json
