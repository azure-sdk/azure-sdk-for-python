...
def main():
    ...
    response = client.signal_rreplica.begin_shared_private_link_resources_create_or_update(
...
# x-ms-original-file: specification/signalr/resource-manager/Microsoft.SignalRService/preview/2024-01-01-preview/examples/SignalRReplica_SharedPrivateLinkResources_CreateOrUpdate.json
