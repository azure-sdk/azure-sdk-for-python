...
class RecommendationsOperations:
    ...
    def list(
        ...
        :param filter: The filter to apply to the recommendations.\\ :code:`<br>`Filter can be applied
         ...
         <#category>`_\\ ', '\\ `Control <#control>`_\\ ', 'RetirementDate'] with operators ['eq',
         'and', 'or', 'lt', 'gt', 'le', 'ge'].\\ :code:`<br>`Example:\\ :code:`<br>`- $filter=Category
         eq 'Cost' and ResourceGroup eq 'MyResourceGroup'\\ :code:`<br>`-$filter=Control eq
         'ServiceUpgradeAndRetirement' and RetirementDate le '2024-01-01' and RetirementDate ge
