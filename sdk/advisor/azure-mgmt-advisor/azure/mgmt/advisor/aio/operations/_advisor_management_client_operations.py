...
class AdvisorManagementClientOperationsMixin(ClientMixinABC[AsyncPipelineClient, AdvisorManagementClientConfiguration]):
    ...
    async def predict(
        self, body: Union[_models.PredictionRequest, IO[bytes]], **kwargs: Any
    ) -> _models.PredictionResponse:
        """Predicts a recommendation.
