...
from ...operations._configurations_operations import (
    build_create_in_resource_group_duration_request,
    build_create_in_resource_group_request,
    build_create_in_subscription_duration_request,
...
class ConfigurationsOperations:
    ...
    @overload
    async def create_in_subscription_duration(
        self,
    ...
    @overload
    async def create_in_resource_group_duration(
        self,
        resource_group: str,
        configuration_name: Union[str, _models.ConfigurationName],
        config_contract: _models.ConfigData,
