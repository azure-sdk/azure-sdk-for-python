...
class AdvisorManagementClient(AdvisorManagementClientOperationsMixin):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype triage_recommendations:
     azure.mgmt.advisor.aio.operations.TriageRecommendationsOperations
    :ivar triage_resources: TriageResourcesOperations operations
    :vartype triage_resources: azure.mgmt.advisor.aio.operations.TriageResourcesOperations
