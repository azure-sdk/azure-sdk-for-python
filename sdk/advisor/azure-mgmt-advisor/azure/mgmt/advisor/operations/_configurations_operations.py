...
def build_create_in_resource_group_duration_request(
    resource_group: str, configuration_name: Union[str, _models.ConfigurationName], subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ConfigurationsOperations:
    ...
    create_in_subscription_duration.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.Advisor/configurations/v2/{configurationName}"
    }
    ...
    create_in_resource_group_duration.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.Advisor/configurations/v2/{configurationName}"
    }
