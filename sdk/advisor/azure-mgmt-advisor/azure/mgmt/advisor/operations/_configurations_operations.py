...
def build_create_in_subscription_duration_request(
    configuration_name: Union[str, _models.ConfigurationName],
    configuration_type: Union[str, _models.ConfigurationNameAutoGenerated],
    subscription_id: str,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    path_format_arguments = {
        ...
        "configurationType": _SERIALIZER.url("configuration_type", configuration_type, "str"),
    }
...
def build_create_in_subscription_request(
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Advisor/configurations/{configurationName}"
    )  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "configurationName": _SERIALIZER.url("configuration_name", configuration_name, "str"),
...
def build_create_in_resource_group_duration_request(
    resource_group: str,
    configuration_name: Union[str, _models.ConfigurationName],
    configuration_type: Union[str, _models.ConfigurationNameAutoGenerated],
    subscription_id: str,
...
class ConfigurationsOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.ConfigData"]:
    ...
    @overload
    def create_in_subscription_duration(
        self,
        configuration_name: Union[str, _models.ConfigurationName],
        configuration_type: Union[str, _models.ConfigurationNameAutoGenerated],
        ...
        **kwargs: Any
        ...
        :param configuration_type: Advisor configuration name. Value must be 'duration'. "duration"
         Required.
        :type configuration_type: str or ~azure.mgmt.advisor.models.ConfigurationNameAutoGenerated
    ...
    def create_in_subscription_duration(
        ...
        **kwargs: Any
        ...
        request = build_create_in_subscription_duration_request(
            ...
            json=_json,
            content=_content,
            template_url=self.create_in_subscription_duration.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    create_in_subscription_duration.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.Advisor/configurations/{configurationName}/v2/{configurationType}"
    }
    ...
    create_in_subscription.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.Advisor/configurations/{configurationName}"
    }
    ...
    @overload
    def create_in_resource_group_duration(
        self,
        resource_group: str,
        configuration_name: Union[str, _models.ConfigurationName],
        configuration_type: Union[str, _models.ConfigurationNameAutoGenerated],
    ...
    def create_in_resource_group_duration(
        ...
        **kwargs: Any
        ...
        request = build_create_in_resource_group_duration_request(
            resource_group=resource_group,
            configuration_name=configuration_name,
            configuration_type=configuration_type,
            subscription_id=self._config.subscription_id,
            ...
            json=_json,
            content=_content,
            template_url=self.create_in_resource_group_duration.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    create_in_resource_group_duration.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.Advisor/configurations/{configurationName}/v2/{configurationType}"
    }
    ...
    create_in_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.Advisor/configurations/{configurationName}"
    }
