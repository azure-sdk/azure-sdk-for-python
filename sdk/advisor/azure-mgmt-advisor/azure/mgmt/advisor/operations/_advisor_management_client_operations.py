...
class AdvisorManagementClientOperationsMixin(ClientMixinABC[PipelineClient, AdvisorManagementClientConfiguration]):

    @overload
    def predict(
        self, body: _models.PredictionRequest, *, content_type: str = "application/json", **kwargs: Any
        ...
        :type body: ~azure.mgmt.advisor.models.PredictionRequest
    ...
    @distributed_trace
    def predict(self, body: Union[_models.PredictionRequest, IO[bytes]], **kwargs: Any) -> _models.PredictionResponse:
        """Predicts a recommendation.

        Predicts a recommendation.

        :param body: The request body. Is either a PredictionRequest type or a IO[bytes] type.
         Required.
        :type body: ~azure.mgmt.advisor.models.PredictionRequest or IO[bytes]
        :return: PredictionResponse or the result of cls(response)
        :rtype: ~azure.mgmt.advisor.models.PredictionResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "PredictionRequest")
