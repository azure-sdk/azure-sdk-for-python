...
class RecommendationMetadataOperations:
    ...
    def get(self, name: str, **kwargs: Any) -> _models.MetadataEntity:
        ...
        if response.status_code not in [200]:
            ...
            if response.status_code == 404:
                error = self._deserialize.failsafe_deserialize(_models.ARMErrorResponseBody, pipeline_response)
    ...
    @distributed_trace
    def list(self, filter: Optional[str] = None, **kwargs: Any) -> Iterable["_models.MetadataEntity"]:
        """Gets the list of metadata entities.

        Gets the list of metadata entities.

        :param filter: The filter to apply to the recommendation metadata.\\ :code:`<br>`Filter can be
         applied to properties ['\\ `Category <#category>`_\\ ', '\\ `Control <#control>`_\\ ',
         'RetirementDate'] with operators ['eq', 'and', 'le', 'ge'].\\ :code:`<br>`Example:\\
         :code:`<br>`- $filter=recommendationCategory eq 'HighAvailability' and recommendationControl eq
         'ServiceUpgradeAndRetirement' and retirementDate ge '2024-01-01' and retirementDate le
         '2028-01-01'. Default value is None.
        :type filter: str
