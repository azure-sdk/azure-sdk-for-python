...
class AdvisorScoresOperations:
    ...
    def list(self, **kwargs: Any) -> _models.AdvisorScoreResponse:
        ...
        deserialized = self._deserialize("AdvisorScoreResponse", pipeline_response)
    ...
    list.metadata = {"url": "/subscriptions/{subscriptionId}/providers/Microsoft.Advisor/advisorScore"}
    ...
    get.metadata = {"url": "/subscriptions/{subscriptionId}/providers/Microsoft.Advisor/advisorScore/{name}"}
