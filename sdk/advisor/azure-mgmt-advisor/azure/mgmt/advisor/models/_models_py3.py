...
class AdvisorScoreEntity(ProxyResource):
    ...
    _attribute_map = {
        ...
        "type": {"key": "type", "type": "str"},
        "system_data": {"key": "systemData", "type": "SystemData"},
        "last_refreshed_score": {"key": "properties.lastRefreshedScore", "type": "ScoreEntity"},
        "time_series": {"key": "properties.timeSeries", "type": "[TimeSeriesEntityItem]"},
    }
...
class AssessmentListResult(_serialization.Model):
    ...
    :ivar value: The AssessmentResult items on this page. Required.
    ...
    def __init__(
        self, *, value: List["_models.AssessmentResult"], next_link: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: The AssessmentResult items on this page. Required.
...
class AssessmentTypeListResult(_serialization.Model):
    ...
    :ivar value: The AssessmentTypeResult items on this page. Required.
    ...
    def __init__(
        self, *, value: List["_models.AssessmentTypeResult"], next_link: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: The AssessmentTypeResult items on this page. Required.
...
class ConfigDataListResult(_serialization.Model):
    """The response of a ConfigData list operation.

    All required parameters must be populated in order to send to server.

    :ivar value: The ConfigData items on this page. Required.
    ...
    def __init__(self, *, value: List["_models.ConfigData"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword value: The ConfigData items on this page. Required.
...
class MetadataEntityListResult(_serialization.Model):
    ...
    :ivar value: The MetadataEntity items on this page. Required.
    ...
    def __init__(
        self, *, value: List["_models.MetadataEntity"], next_link: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: The MetadataEntity items on this page. Required.
...
class Operation(_serialization.Model):
    ...
    :vartype display: ~azure.mgmt.advisor.models.OperationDisplay
    :ivar origin: The intended executor of the operation; as in Resource Based Access Control
     (RBAC) and audit logs UX. Default value is "user,system". Known values are: "user", "system",
     and "user,system".
    :vartype origin: str or ~azure.mgmt.advisor.models.Origin
    :ivar action_type: Enum. Indicates the action type. "Internal" refers to actions that are for
     internal only APIs. "Internal"
    :vartype action_type: str or ~azure.mgmt.advisor.models.ActionType
    """
    ...
    def __init__(self, *, display: Optional["_models.OperationDisplay"] = None, **kwargs: Any) -> None:
        ...
        :paramtype display: ~azure.mgmt.advisor.models.OperationDisplay
        """
        super().__init__(**kwargs)
        self.name: Optional[str] = None
...
class OperationListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.advisor.models.Operation]
...
class ResiliencyReviewCollection(_serialization.Model):
    ...
    :ivar value: The ResiliencyReview items on this page. Required.
    ...
    def __init__(
        ...
        """
        :keyword value: The ResiliencyReview items on this page. Required.
...
class ResourceMetadata(_serialization.Model):
    ...
    :vartype action: dict[str, dict[str, any]]
    ...
    def __init__(
        ...
        *,
        ...
        action: Optional[Dict[str, Dict[str, Any]]] = None,
        ...
        **kwargs: Any
        ...
        :paramtype action: dict[str, dict[str, any]]
...
class ResourceRecommendationBase(ProxyResource):
    ...
    :vartype metadata: dict[str, dict[str, any]]
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        actions: Optional[List[Dict[str, Dict[str, Any]]]] = None,
        remediation: Optional[Dict[str, Dict[str, Any]]] = None,
        exposed_metadata_properties: Optional[Dict[str, Dict[str, Any]]] = None,
        ...
        **kwargs: Any
        ...
        :paramtype metadata: dict[str, dict[str, any]]
        ...
        :paramtype actions: list[dict[str, dict[str, any]]]
        :keyword remediation: The automated way to apply recommendation.
        :paramtype remediation: dict[str, dict[str, any]]
        ...
        :paramtype exposed_metadata_properties: dict[str, dict[str, any]]
...
class ResourceRecommendationBaseListResult(_serialization.Model):
    ...
    :ivar value: The ResourceRecommendationBase items on this page. Required.
    ...
    def __init__(
        self, *, value: List["_models.ResourceRecommendationBase"], next_link: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: The ResourceRecommendationBase items on this page. Required.
...
class SuppressionContract(ProxyResource):
...
class SuppressionContractListResult(_serialization.Model):
    ...
    :ivar value: The SuppressionContract items on this page. Required.
    ...
    def __init__(
        self, *, value: List["_models.SuppressionContract"], next_link: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: The SuppressionContract items on this page. Required.
...
class TriageRecommendation(ProxyResource):
...
class TriageRecommendationCollection(_serialization.Model):
    ...
    :ivar value: The TriageRecommendation items on this page. Required.
    ...
    def __init__(
        ...
        """
        :keyword value: The TriageRecommendation items on this page. Required.
...
class TriageResourceCollection(_serialization.Model):
    ...
    :ivar value: The TriageResource items on this page. Required.
    ...
    def __init__(
        ...
        """
        :keyword value: The TriageResource items on this page. Required.
...
class WorkloadListResult(_serialization.Model):
    ...
    :ivar value: The WorkloadResult items on this page. Required.
    ...
    def __init__(
        self, *, value: List["_models.WorkloadResult"], next_link: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: The WorkloadResult items on this page. Required.
