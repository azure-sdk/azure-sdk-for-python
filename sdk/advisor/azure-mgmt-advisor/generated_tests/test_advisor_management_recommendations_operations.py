...
class TestAdvisorManagementRecommendationsOperations(AzureMgmtRecordedTestCase):
    ...
    @recorded_by_proxy
    def test_recommendations_generate(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_recommendations_get_generate_status(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_recommendations_get(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_recommendations_patch(self, resource_group):
        response = self.client.recommendations.patch(
            resource_uri="str",
            recommendation_id="str",
            tracked_properties={
                "properties": {
