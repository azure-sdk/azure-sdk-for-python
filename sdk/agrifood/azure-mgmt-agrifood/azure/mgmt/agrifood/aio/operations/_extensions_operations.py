...
from ...operations._extensions_operations import (
    build_create_or_update2_request,
...
class ExtensionsOperations:
    ...
    async def create_or_update2(
        ...
        **kwargs: Any
        ...
        request = build_create_or_update2_request(
            ...
            json=_json,
            content=_content,
            template_url=self.create_or_update2.metadata["url"],
            headers=_headers,
            params=_params,
        )
