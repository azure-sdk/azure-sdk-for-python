...
class DataManagerForAgricultureExtensionListResponse(_serialization.Model):
    """Paged response contains list of requested objects and a URL link to get the next set of
    results.
...
class DataManagerForAgricultureExtensionProperties(_serialization.Model):
...
class DataManagerForAgricultureSolutionListResponse(_serialization.Model):
    """Paged response contains list of requested objects and a URL link to get the next set of
    results.
...
class DataManagerForAgricultureSolutionProperties(_serialization.Model):  # pylint: disable=too-many-instance-attributes
...
class DataManagerForAgricultureUpdateProperties(_serialization.Model):
...
class DataManagerForAgricultureUpdateRequestModel(_serialization.Model):
