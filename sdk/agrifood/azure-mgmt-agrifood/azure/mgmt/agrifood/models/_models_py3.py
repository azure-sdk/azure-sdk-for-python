...
class DataManagerForAgricultureExtensionProperties(_serialization.Model):  # pylint: disable=name-too-long
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.farm_beats_extension_id: Optional[str] = None
        self.farm_beats_extension_name: Optional[str] = None
        self.farm_beats_extension_version: Optional[str] = None
        self.publisher_id: Optional[str] = None
        self.description: Optional[str] = None
        self.extension_category: Optional[str] = None
        self.extension_auth_link: Optional[str] = None
        self.extension_api_docs_link: Optional[str] = None
        self.detailed_information: Optional[List["_models.DetailedInformation"]] = None
...
class DataManagerForAgricultureSolutionProperties(_serialization.Model):  # pylint: disable=name-too-long
    ...
    def __init__(
        ...
        self.data_access_scopes: Optional[List[str]] = None
        self.marketplace_offer_details = marketplace_offer_details
        self.open_api_specs_dictionary: Optional[Dict[str, Any]] = None
        self.access_fb_application_id: Optional[str] = None
        self.saa_s_application_id: Optional[str] = None
        self.action_ids: Optional[List[str]] = None
        self.role_id: Optional[str] = None
        self.role_name: Optional[str] = None
        self.access_fb_application_name: Optional[str] = None
...
class Extension(ProxyResource):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.extension_category: Optional[str] = None
        self.installed_extension_version: Optional[str] = None
        self.extension_auth_link: Optional[str] = None
        self.extension_api_docs_link: Optional[str] = None
        self.additional_api_properties: Optional[Dict[str, "_models.ApiProperties"]] = None
