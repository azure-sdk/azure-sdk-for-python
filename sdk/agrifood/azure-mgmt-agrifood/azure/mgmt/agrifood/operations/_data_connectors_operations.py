...
class DataConnectorsOperations:
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AgFoodPlatform/farmBeats/{dataManagerForAgricultureResourceName}/dataConnectors/{dataConnectorName}"
    }
    ...
    def create_or_update(
        ...
        data_manager_for_agriculture_resource_name: str,
        data_connector_name: str,
        body: Union[_models.DataConnector, IO],
        **kwargs: Any
    ) -> _models.DataConnector:
        """Create or update Data Connector For MADMA resource.
        ...
        :param data_connector_name: Connector name. Required.
        :type data_connector_name: str
        :param body: Body must be valid DataConnector request. Is either a DataConnector type or a IO
         type. Required.
        :type body: ~azure.mgmt.agrifood.models.DataConnector or IO
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AgFoodPlatform/farmBeats/{dataManagerForAgricultureResourceName}/dataConnectors"
    }
