...
class TestProviderHubDefaultRolloutsOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(ProviderHub)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_default_rollouts_get(self, resource_group):
        response = self.client.default_rollouts.get(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_default_rollouts_delete(self, resource_group):
        response = self.client.default_rollouts.delete(
            provider_namespace="str",
            rollout_name="str",
            api_version="2020-11-20",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_default_rollouts_begin_create_or_update(self, resource_group):
        response = self.client.default_rollouts.begin_create_or_update(
            provider_namespace="str",
            rollout_name="str",
            properties={
                "id": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_default_rollouts_list_by_provider_registration(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_default_rollouts_stop(self, resource_group):
        response = self.client.default_rollouts.stop(
            provider_namespace="str",
            rollout_name="str",
            api_version="2020-11-20",
        )
