...
class TestProviderHubCustomRolloutsOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_custom_rollouts_create_or_update(self, resource_group):
        response = self.client.custom_rollouts.create_or_update(
            provider_namespace="str",
            rollout_name="str",
            properties={
                "properties": {
