...
def build_add_update_policy_for_tenant_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
...
class SubscriptionPolicyOperations:
    ...
    @distributed_trace
    def add_update_policy_for_tenant(
        self, body: Union[_models.PutTenantPolicyRequestProperties, IO[bytes]], **kwargs: Any
    ) -> _models.GetTenantPolicyResponse:
        """Create or Update Subscription tenant policy for user's tenant.

        :param body: Is either a PutTenantPolicyRequestProperties type or a IO[bytes] type. Required.
        :type body: ~azure.mgmt.subscription.models.PutTenantPolicyRequestProperties or IO[bytes]
        :return: GetTenantPolicyResponse or the result of cls(response)
        :rtype: ~azure.mgmt.subscription.models.GetTenantPolicyResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        _request = build_add_update_policy_for_tenant_request(
        ...
        deserialized = self._deserialize("GetTenantPolicyResponse", pipeline_response.http_response)
    ...
    def list_policy_for_tenant(self, **kwargs: Any) -> Iterable["_models.GetTenantPolicyResponse"]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_policy_for_tenant_request(
                    api_version=api_version,
                    headers=_headers,
                    params=_params,
                )
