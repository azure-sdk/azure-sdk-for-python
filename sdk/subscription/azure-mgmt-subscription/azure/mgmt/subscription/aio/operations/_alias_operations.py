...
class AliasOperations:
    ...
    async def _create_initial(
        self, alias_name: str, body: Union[_models.PutAliasRequest, IO[bytes]], **kwargs: Any
    ) -> AsyncIterator[bytes]:
    ...
    async def begin_create(
        ...
        :param alias_name: AliasName is the name for the subscription creation request. Note that this
         ...
         request for subscription creation. Required.
        :type alias_name: str
        :param body: Is either a PutAliasRequest type or a IO[bytes] type. Required.
        :type body: ~azure.mgmt.subscription.models.PutAliasRequest or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either SubscriptionAliasResponse or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.subscription.models.SubscriptionAliasResponse]
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("SubscriptionAliasResponse", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
        ...
        if cont_token:
            return AsyncLROPoller[_models.SubscriptionAliasResponse].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.SubscriptionAliasResponse](
    ...
    @distributed_trace_async
    async def delete(self, alias_name: str, **kwargs: Any) -> None:
        """Delete Alias.
    ...
    async def list(self, **kwargs: Any) -> _models.SubscriptionAliasListResult:
        ...
        deserialized = self._deserialize("SubscriptionAliasListResult", pipeline_response.http_response)
