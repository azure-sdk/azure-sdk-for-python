...
class CloudManagerTenant(_serialization.Model):
    """Cloud Manager Tenant.

    All required parameters must be populated in order to send to Azure.

    :ivar name: Name of Cloud Manager Tenant. Required.
    :vartype name: str
    :ivar tenant_id: Cloud Manager Tenant ID.
    :vartype tenant_id: str
    """
    ...
    def __init__(self, *, name: str, tenant_id: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword name: Name of Cloud Manager Tenant. Required.
        :paramtype name: str
        :keyword tenant_id: Cloud Manager Tenant ID.
