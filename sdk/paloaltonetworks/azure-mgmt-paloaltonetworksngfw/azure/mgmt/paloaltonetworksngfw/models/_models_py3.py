...
class FirewallStatusResource(ProxyResource):
    ...
    :vartype health_status: str or ~azure.mgmt.paloaltonetworks.models.HealthStatus
    ...
    :vartype panorama_status: ~azure.mgmt.paloaltonetworks.models.PanoramaStatus
    :ivar provisioning_state: Provisioning state of the resource. Known values are: "Succeeded",
     "Failed", and "Deleted".
    :vartype provisioning_state: str or
     ~azure.mgmt.paloaltonetworks.models.ReadOnlyProvisioningState
    """
...
class FirewallStatusResourceListResult(_serialization.Model):
    ...
    :ivar value: The items on this page. Required.
    :vartype value: list[~azure.mgmt.paloaltonetworks.models.FirewallStatusResource]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        """
        :keyword value: The items on this page. Required.
        :paramtype value: list[~azure.mgmt.paloaltonetworks.models.FirewallStatusResource]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class PanoramaStatus(_serialization.Model):
    ...
    :ivar panorama_server_status: Primary Panorama connection status. Known values are: "UP" and
     "DOWN".
    :vartype panorama_server_status: str or ~azure.mgmt.paloaltonetworks.models.ServerStatus
    :ivar panorama_server2_status: Secondary Panorama connection status. Known values are: "UP" and
     "DOWN".
    :vartype panorama_server2_status: str or ~azure.mgmt.paloaltonetworks.models.ServerStatus
    """
