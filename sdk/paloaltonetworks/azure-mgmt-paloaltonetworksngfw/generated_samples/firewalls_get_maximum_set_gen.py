...
# USAGE
    python firewalls_get_maximum_set_gen.py
...
# x-ms-original-file: specification/paloaltonetworks/resource-manager/PaloAltoNetworks.Cloudngfw/preview/2025-02-06-preview/examples/Firewalls_Get_MaximumSet_Gen.json
