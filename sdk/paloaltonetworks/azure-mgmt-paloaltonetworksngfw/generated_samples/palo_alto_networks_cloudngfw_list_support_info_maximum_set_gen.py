...
# USAGE
    python palo_alto_networks_cloudngfw_list_support_info_maximum_set_gen.py
...
# x-ms-original-file: specification/paloaltonetworks/resource-manager/PaloAltoNetworks.Cloudngfw/preview/2025-02-06-preview/examples/PaloAltoNetworksCloudngfw_listSupportInfo_MaximumSet_Gen.json
