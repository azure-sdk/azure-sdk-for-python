...
class TestSecurityCenterDevOpsConfigurationsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_begin_create_or_update(self, resource_group):
        response = await (
            await self.client.dev_ops_configurations.begin_create_or_update(
                resource_group_name=resource_group.name,
                security_connector_name="str",
    ...
    async def test_begin_update(self, resource_group):
        response = await (
            await self.client.dev_ops_configurations.begin_update(
                resource_group_name=resource_group.name,
                security_connector_name="str",
                dev_ops_configuration={
                    "id": "str",
