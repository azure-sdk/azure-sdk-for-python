...
class TestSecurityCenterAzureDevOpsReposOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_get(self, resource_group):
        response = await self.client.azure_dev_ops_repos.get(
            resource_group_name=resource_group.name,
            security_connector_name="str",
            org_name="str",
            project_name="str",
    ...
    async def test_begin_create_or_update(self, resource_group):
        response = await (
            await self.client.azure_dev_ops_repos.begin_create_or_update(
                resource_group_name=resource_group.name,
                security_connector_name="str",
                org_name="str",
                project_name="str",
    ...
    async def test_begin_update(self, resource_group):
        response = await (
            await self.client.azure_dev_ops_repos.begin_update(
                resource_group_name=resource_group.name,
                security_connector_name="str",
                org_name="str",
                project_name="str",
