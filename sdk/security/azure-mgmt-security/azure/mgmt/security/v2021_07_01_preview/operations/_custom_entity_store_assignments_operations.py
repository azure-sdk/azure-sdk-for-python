...
class CustomEntityStoreAssignmentsOperations:
    ...
    def list_by_resource_group(
    ...
    ) -> Iterable["_models.CustomEntityStoreAssignment"]:
        ...
        :return: An iterator like instance of either CustomEntityStoreAssignment or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.security.v2021_07_01_preview.models.CustomEntityStoreAssignment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.CustomEntityStoreAssignment"]:
