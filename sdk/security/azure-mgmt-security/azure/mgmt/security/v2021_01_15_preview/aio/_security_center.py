...
class SecurityCenter:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype ingestion_settings:
     azure.mgmt.security.v2021_01_15_preview.aio.operations.IngestionSettingsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.ingestion_settings = IngestionSettingsOperations(
            self._client, self._config, self._serialize, self._deserialize, "2021-01-15-preview"
        )
