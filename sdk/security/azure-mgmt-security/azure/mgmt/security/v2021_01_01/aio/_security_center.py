...
class SecurityCenter:
    ...
    :vartype alerts: azure.mgmt.security.v2021_01_01.aio.operations.AlertsOperations
    ...
    def __init__(
        ...
        self.alerts = AlertsOperations(self._client, self._config, self._serialize, self._deserialize, "2021-01-01")
