...
class CustomRecommendationsOperations:
    ...
    @distributed_trace
    def list(self, scope: str, **kwargs: Any) -> Iterable["_models.CustomRecommendation"]:
        # pylint: disable=line-too-long
        ...
        :return: An iterator like instance of either CustomRecommendation or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.security.v2024_08_01.models.CustomRecommendation]
