...
class CustomRecommendation(Resource):  # pylint: disable=too-many-instance-attributes
...
class StandardAssignment(Resource):  # pylint: disable=too-many-instance-attributes
