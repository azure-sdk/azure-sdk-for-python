...
from ...operations._custom_recommendations_operations import (
...
class CustomRecommendationsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.security.v2024_08_01.aio.SecurityCenter`'s
    ...
    @distributed_trace
    def list(self, scope: str, **kwargs: Any) -> AsyncIterable["_models.CustomRecommendation"]:
        ...
        :return: An iterator like instance of either CustomRecommendation or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.v2024_08_01.models.CustomRecommendation]
    ...
    async def get(self, scope: str, custom_recommendation_name: str, **kwargs: Any) -> _models.CustomRecommendation:
        # pylint: disable=line-too-long
        ...
        :rtype: ~azure.mgmt.security.v2024_08_01.models.CustomRecommendation
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type custom_recommendation_body: ~azure.mgmt.security.v2024_08_01.models.CustomRecommendation
    ...
    @distributed_trace_async
    async def delete(self, scope: str, custom_recommendation_name: str, **kwargs: Any) -> None:
        # pylint: disable=line-too-long
