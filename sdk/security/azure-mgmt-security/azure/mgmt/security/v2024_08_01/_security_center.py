...
from .operations import CustomRecommendationsOperations, SecurityStandardsOperations, StandardAssignmentsOperations
...
class SecurityCenter:
    ...
    :vartype security_standards:
     azure.mgmt.security.v2024_08_01.operations.SecurityStandardsOperations
    :ivar standard_assignments: StandardAssignmentsOperations operations
    :vartype standard_assignments:
     azure.mgmt.security.v2024_08_01.operations.StandardAssignmentsOperations
    :ivar custom_recommendations: CustomRecommendationsOperations operations
    :vartype custom_recommendations:
     azure.mgmt.security.v2024_08_01.operations.CustomRecommendationsOperations
    ...
    def __init__(self, credential: "TokenCredential", base_url: Optional[str] = None, **kwargs: Any) -> None:
        ...
        self._config = SecurityCenterConfiguration(credential=credential, credential_scopes=credential_scopes, **kwargs)
