...
class AdaptiveApplicationControlsOperations:
    ...
    async def list(
        ...
        deserialized = self._deserialize("AdaptiveApplicationControlGroups", pipeline_response.http_response)
    ...
    async def get(self, asc_location: str, group_name: str, **kwargs: Any) -> _models.AdaptiveApplicationControlGroup:
        ...
        deserialized = self._deserialize("AdaptiveApplicationControlGroup", pipeline_response.http_response)
