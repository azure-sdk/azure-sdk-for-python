...
class RegulatoryComplianceControlsOperations:
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.RegulatoryComplianceControl"]:
        ...
        :return: An iterator like instance of either RegulatoryComplianceControl or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.v2019_01_01_preview.models.RegulatoryComplianceControl]
