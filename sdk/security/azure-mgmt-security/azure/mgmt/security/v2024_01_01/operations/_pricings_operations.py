...
class PricingsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.security.v2024_01_01.SecurityCenter`'s
    ...
    get.metadata = {"url": "/{scopeId}/providers/Microsoft.Security/pricings/{pricingName}"}
    ...
    @overload
    def update(
        self, scope_id: str, pricing_name: str, pricing: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.Pricing:
        """Updates a provided Microsoft Defender for Cloud pricing configuration in the scope. Valid
        scopes are: subscription id or a specific resource id (Supported resources are:
        'VirtualMachines, VMSS and ARC Machines' and only for plan='VirtualMachines' and subPlan='P1').
    ...
    @distributed_trace
    def update(
        self, scope_id: str, pricing_name: str, pricing: Union[_models.Pricing, IO], **kwargs: Any
    ) -> _models.Pricing:
        """Updates a provided Microsoft Defender for Cloud pricing configuration in the scope. Valid
        scopes are: subscription id or a specific resource id (Supported resources are:
        'VirtualMachines, VMSS and ARC Machines' and only for plan='VirtualMachines' and subPlan='P1').
        ...
        :type pricing: ~azure.mgmt.security.v2024_01_01.models.Pricing or IO
    ...
    update.metadata = {"url": "/{scopeId}/providers/Microsoft.Security/pricings/{pricingName}"}
    ...
    delete.metadata = {"url": "/{scopeId}/providers/Microsoft.Security/pricings/{pricingName}"}
    ...
    list.metadata = {"url": "/{scopeId}/providers/Microsoft.Security/pricings"}
