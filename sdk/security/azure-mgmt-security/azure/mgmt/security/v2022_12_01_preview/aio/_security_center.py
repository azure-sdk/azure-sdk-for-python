...
from .operations import DefenderForStorageOperations
...
class SecurityCenter:
    ...
    :vartype defender_for_storage:
     azure.mgmt.security.v2022_12_01_preview.aio.operations.DefenderForStorageOperations
    ...
    def __init__(self, credential: "AsyncTokenCredential", base_url: Optional[str] = None, **kwargs: Any) -> None:
        ...
        self.defender_for_storage = DefenderForStorageOperations(
            self._client, self._config, self._serialize, self._deserialize, "2022-12-01-preview"
        )
