...
class Extension(_serialization.Model):
     ...
     **AgentlessDiscoveryForKubernetes** - Provides zero footprint, API-based discovery of
     ...
     visualize risks and threats to  Kubernetes environments and workloads.:code:`<br>`Available for
     CloudPosture plan and Containers plan.:code:`<br>`:code:`<br>`\\ **OnUploadMalwareScanning** -
     ...
     month.:code:`<br>`Available for StorageAccounts plan (DefenderForStorageV2 sub
     plans).:code:`<br>`:code:`<br>`\\ **SensitiveDataDiscovery** - Sensitive data discovery
     identifies Blob storage container with sensitive data such as credentials, credit cards, and
     more, to help prioritize and investigate security events.:code:`<br>`Available for
     StorageAccounts plan (DefenderForStorageV2 sub plan) and CloudPosture
     plan.:code:`<br>`:code:`<br>`\\ **ContainerRegistriesVulnerabilityAssessments** - Provides
     vulnerability management for images stored in your container registries.:code:`<br>`Available
     for CloudPosture plan and Containers plan.:code:`<br>`:code:`<br>`\\
     **MdeDesignatedSubscription** - Direct onboarding is a seamless integration between Defender
     for Endpoint and Defender for Cloud that doesn’t require extra software deployment on your
     servers. The onboarded resources will be presented under a designated Azure Subscription you
     configure:code:`<br>`Available for VirtualMachines plan (P1 and P2 sub
     plans).:code:`<br>`:code:`<br>`\\ **AgentlessVmScanning** - Scans your machines for installed
     software, vulnerabilities, malware and secret scanning without relying on agents or impacting
     machine performance. Learn more here
     https://learn.microsoft.com/en-us/azure/defender-for-cloud/concept-agentless-data-collection.:code:`<br>`Available
     ...
     https://learn.microsoft.com/en-us/azure/defender-for-cloud/permissions-management.:code:`<br>`Available
     for CloudPosture plan. :code:`<br>`:code:`<br>`\\ **FileIntegrityMonitoring** - File integrity
     monitoring (FIM), examines operating system files.:code:`<br>`Windows registries, Linux system
     files, in real time, for changes that might indicate an attack.:code:`<br>`Available for
     VirtualMachines plan (P2 sub plan). :code:`<br>`:code:`<br>`\\ **ContainerSensor** - The sensor
     is based on IG and provides a rich threat detection suite for Kubernetes clusters, nodes, and
     workloads, powered by Microsoft leading threat intelligence, provides mapping to MITRE ATT&CK
     framework.:code:`<br>`Available for Containers plan. :code:`<br>`:code:`<br>`\\
     **AIPromptEvidence** - Exposes the prompts passed between the user and the AI model as alert
     evidence. This helps classify and triage the alerts with relevant user context. The prompt
     snippets will include only segments of the user prompt or model response that were deemed
     suspicious and relevant for security classifications. The prompt evidence will be available
     through Defender portal as part of each alert.:code:`<br>`Available for AI plan.
     :code:`<br>`:code:`<br>`. Required.
    :vartype name: str
    ...
    def __init__(
        ...
        **kwargs: Any
         ...
         **MdeDesignatedSubscription** - Direct onboarding is a seamless integration between Defender
         ...
         software, vulnerabilities, malware and secret scanning without relying on agents or impacting
         machine performance. Learn more here
         https://learn.microsoft.com/en-us/azure/defender-for-cloud/concept-agentless-data-collection.:code:`<br>`Available  # pylint: disable=line-too-long
         for CloudPosture plan, VirtualMachines plan (P2 sub plan) and Containers
         plan.:code:`<br>`:code:`<br>`\\ **EntraPermissionsManagement** - Permissions Management
         provides Cloud Infrastructure Entitlement Management (CIEM) capabilities that helps
         organizations to manage and control user access and entitlements in their cloud infrastructure
