...
from ...operations._azure_dev_ops_repos_operations import (
...
class AzureDevOpsReposOperations:
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.AzureDevOpsRepository"]:
        ...
        :return: An iterator like instance of either AzureDevOpsRepository or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.v2023_09_01_preview.models.AzureDevOpsRepository]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
    ) -> AsyncLROPoller[_models.AzureDevOpsRepository]:
        ...
        :return: An instance of AsyncLROPoller that returns either AzureDevOpsRepository or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.security.v2023_09_01_preview.models.AzureDevOpsRepository]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.AzureDevOpsRepository].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.AzureDevOpsRepository](
