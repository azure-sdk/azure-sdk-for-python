...
class ClientIPPreservationState(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Preserves the client side source IP allowing the back-end to see the IP address of the client.
    This can then be used by applications for applying any rules. Valid options are 'Enabled' or
    'Disabled'.
    """
...
class FrontendProtocol(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class RouteType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """The type of L7 or L4 route to use for this origin group. Valid options are 'L7Route' or
...
class RoutingMethod(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Routing method for TCP/UDP routes based on SNI or Ports division, if it is SNI based then the
    we can read SNI header to get the origin name or if its based on the ports then we can have
    port division to connect to specific origin for example port range 2000-2050 belongs to origin
    group 1 and port range 3000-3050 belongs to origin group 2.
    """

    SNI_BASED = "SNIBased"
    PORT_BASED = "PortBased"
...
class SessionAffinityType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """The type of L4 session affinity to use for this origin group. Valid options are 'SourceIP' or
    'None'.
    """
