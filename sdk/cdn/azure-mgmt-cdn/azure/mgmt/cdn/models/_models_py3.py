...
class SecurityPolicyWebApplicationFirewallAssociation(_serialization.Model):
    ...
    :ivar is_profile_level: Flag to signal whether the WAF policy association is at the default
     Profile level. Known values are: "True" and "False".
    :vartype is_profile_level: str or
     ~azure.mgmt.cdn.models.SecurityPolicyWebApplicationFirewallAssociationIsProfileLevel
    :ivar domains: List of domains.
    ...
    _attribute_map = {
        "is_profile_level": {"key": "IsProfileLevel", "type": "str"},
        "domains": {"key": "domains", "type": "[ActivatedResourceReference]"},
        "routes": {"key": "routes", "type": "[ResourceReference]"},
        "patterns_to_match": {"key": "patternsToMatch", "type": "[str]"},
    }
    ...
    def __init__(
        self,
        *,
        is_profile_level: Optional[
            Union[str, "_models.SecurityPolicyWebApplicationFirewallAssociationIsProfileLevel"]
        ] = None,
        ...
        **kwargs: Any
        ...
        """
        :keyword is_profile_level: Flag to signal whether the WAF policy association is at the default
         Profile level. Known values are: "True" and "False".
        :paramtype is_profile_level: str or
         ~azure.mgmt.cdn.models.SecurityPolicyWebApplicationFirewallAssociationIsProfileLevel
        :keyword domains: List of domains.
        :paramtype domains: list[~azure.mgmt.cdn.models.ActivatedResourceReference]
        :keyword routes: List of routes.
        :paramtype routes: list[~azure.mgmt.cdn.models.ResourceReference]
        :keyword patterns_to_match: List of paths.
        :paramtype patterns_to_match: list[str]
        """
        super().__init__(**kwargs)
        self.is_profile_level = is_profile_level
        self.domains = domains
        self.routes = routes
        self.patterns_to_match = patterns_to_match
