...
class AFDEndpoint(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar dedicated_vip: A reference to the origin group. The dedicated vip is created as a
     separate resource. The dedicated vip will be linked to an endpoint for L4 profiles.
    :vartype dedicated_vip: ~azure.mgmt.cdn.models.ResourceReference
    :ivar provisioning_state: Provisioning status. Known values are: "Succeeded", "Failed",
     "Updating", "Deleting", and "Creating".
    :vartype provisioning_state: str or ~azure.mgmt.cdn.models.AfdProvisioningState
    :ivar deployment_status: Known values are: "NotStarted", "InProgress", "Succeeded", and
    ...
    _attribute_map = {
        ...
        "dedicated_vip": {"key": "properties.DedicatedVIP", "type": "ResourceReference"},
        "provisioning_state": {"key": "properties.provisioningState", "type": "str"},
        "deployment_status": {"key": "properties.deploymentStatus", "type": "str"},
        "host_name": {"key": "properties.hostName", "type": "str"},
    ...
    def __init__(
        ...
        *,
        ...
        dedicated_vip: Optional["_models.ResourceReference"] = None,
        ...
        **kwargs: Any
        ...
        :keyword dedicated_vip: A reference to the origin group. The dedicated vip is created as a
         separate resource. The dedicated vip will be linked to an endpoint for L4 profiles.
        :paramtype dedicated_vip: ~azure.mgmt.cdn.models.ResourceReference
        ...
        self.dedicated_vip = dedicated_vip
        self.provisioning_state = None
        self.deployment_status = None
        self.host_name = None
...
class AFDEndpointPropertiesUpdateParameters(_serialization.Model):
    ...
    _attribute_map = {
        ...
        "dedicated_vip": {"key": "DedicatedVIP", "type": "ResourceReference"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype auto_generated_domain_name_label_scope: str or
         ~azure.mgmt.cdn.models.AutoGeneratedDomainNameLabelScope
        """
        super().__init__(enabled_state=enabled_state, dedicated_vip=dedicated_vip, **kwargs)
        self.provisioning_state = None
        self.deployment_status = None
        self.host_name = None
        self.auto_generated_domain_name_label_scope = auto_generated_domain_name_label_scope
...
class AFDOrigin(ProxyResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar origin_ports: The ports used for the TCP/UDP connection to the customer's backend. Must
     be between 1024 and 65535 excluding reserved ports. The ports can be a comma separated list or
     a valid range like 5050-5090.
    :vartype origin_ports: str
    :ivar client_ip_preservation_state: Preserves the client side source IP allowing the back-end
     to see the IP address of the client. This can then be used by applications for applying any
     rules. Valid options are 'Enabled' or 'Disabled'. Known values are: "Enabled" and "Disabled".
    :vartype client_ip_preservation_state: str or ~azure.mgmt.cdn.models.ClientIPPreservationState
    ...
    _attribute_map = {
        ...
        "origin_ports": {"key": "properties.OriginPorts", "type": "str"},
        "client_ip_preservation_state": {"key": "properties.ClientIPPreservationState", "type": "str"},
    ...
    def __init__(
        ...
        *,
        ...
        client_ip_preservation_state: Optional[Union[str, "_models.ClientIPPreservationState"]] = None,
        ...
        **kwargs: Any
        ...
        :keyword origin_ports: The ports used for the TCP/UDP connection to the customer's backend.
         Must be between 1024 and 65535 excluding reserved ports. The ports can be a comma separated
         list or a valid range like 5050-5090.
        :paramtype origin_ports: str
        :keyword client_ip_preservation_state: Preserves the client side source IP allowing the
         back-end to see the IP address of the client. This can then be used by applications for
         applying any rules. Valid options are 'Enabled' or 'Disabled'. Known values are: "Enabled" and
         "Disabled".
        :paramtype client_ip_preservation_state: str or
         ~azure.mgmt.cdn.models.ClientIPPreservationState
        ...
        self.client_ip_preservation_state = client_ip_preservation_state
...
class AFDOriginGroup(ProxyResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar session_affinity_type: The type of L4 session affinity to use for this origin group.
     Valid options are 'SourceIP' or 'None'. Known values are: "SourceIP" and "None".
    :vartype session_affinity_type: str or ~azure.mgmt.cdn.models.SessionAffinityType
    :ivar route_type: The type of L7 or L4 route to use for this origin group. Valid options are
     'L7Route' or 'L4Route'. This will help validate L4 origin groups with L4 routes. Known values
     are: "L7Route" and "L4Route".
    :vartype route_type: str or ~azure.mgmt.cdn.models.RouteType
    :ivar provisioning_state: Provisioning status. Known values are: "Succeeded", "Failed",
     "Updating", "Deleting", and "Creating".
    :vartype provisioning_state: str or ~azure.mgmt.cdn.models.AfdProvisioningState
    :ivar deployment_status: Known values are: "NotStarted", "InProgress", "Succeeded", and
    ...
    _attribute_map = {
        ...
        "session_affinity_type": {"key": "properties.SessionAffinityType", "type": "str"},
    ...
    def __init__(
        ...
        *,
        ...
        session_affinity_type: Optional[Union[str, "_models.SessionAffinityType"]] = None,
        ...
        **kwargs: Any
        ...
        :keyword session_affinity_type: The type of L4 session affinity to use for this origin group.
         Valid options are 'SourceIP' or 'None'. Known values are: "SourceIP" and "None".
        :paramtype session_affinity_type: str or ~azure.mgmt.cdn.models.SessionAffinityType
        :keyword route_type: The type of L7 or L4 route to use for this origin group. Valid options are
         'L7Route' or 'L4Route'. This will help validate L4 origin groups with L4 routes. Known values
         are: "L7Route" and "L4Route".
        :paramtype route_type: str or ~azure.mgmt.cdn.models.RouteType
        """
        super().__init__(**kwargs)
        self.profile_name = None
...
class AFDOriginGroupUpdatePropertiesParameters(_serialization.Model):
    ...
    _attribute_map = {
        ...
        "session_affinity_type": {"key": "SessionAffinityType", "type": "str"},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        super().__init__(
            ...
            session_affinity_type=session_affinity_type,
...
class AFDOriginUpdatePropertiesParameters(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    _attribute_map = {
        ...
        "origin_ports": {"key": "OriginPorts", "type": "str"},
        "client_ip_preservation_state": {"key": "ClientIPPreservationState", "type": "str"},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        super().__init__(
            ...
            client_ip_preservation_state=client_ip_preservation_state,
            priority=priority,
            weight=weight,
...
class HealthProbeParameters(_serialization.Model):
    ...
    :ivar probe_port: The valid range of ports for health probes for TCP/UDP would typically be
     from 1024-65535. This range excludes the reserved ports and allows for a wide range of
     available ports to use for health probes.
    ...
    _validation = {
        "probe_port": {"maximum": 65535, "minimum": 1024},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword probe_port: The valid range of ports for health probes for TCP/UDP would typically be
         from 1024-65535. This range excludes the reserved ports and allows for a wide range of
         available ports to use for health probes.
...
class L4Route(ProxyResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar system_data: Read only system data.
    :vartype system_data: ~azure.mgmt.cdn.models.SystemData
    :ivar routing_method: Routing method for TCP/UDP routes based on SNI or Ports division, if it
     is SNI based then the we can read SNI header to get the origin name or if its based on the
     ports then we can have port division to connect to specific origin for example port range
     2000-2050 belongs to origin group 1 and port range 3000-3050 belongs to origin group 2. Known
     values are: "SNIBased" and "PortBased".
    :vartype routing_method: str or ~azure.mgmt.cdn.models.RoutingMethod
    ...
    :ivar l4_route_base_settings: L4 Route base settings.
    :vartype l4_route_base_settings: ~azure.mgmt.cdn.models.L4RouteBaseSettings
    :ivar enabled_state: Whether to enable the route. Permitted values are 'Enabled' or 'Disabled'.
    ...
    _attribute_map = {
        ...
        "type": {"key": "type", "type": "str"},
        "system_data": {"key": "systemData", "type": "SystemData"},
        "routing_method": {"key": "properties.RoutingMethod", "type": "str"},
        ...
        "l4_route_base_settings": {"key": "properties.L4RouteBaseSettings", "type": "L4RouteBaseSettings"},
        "enabled_state": {"key": "properties.enabledState", "type": "str"},
        "provisioning_state": {"key": "properties.provisioningState", "type": "str"},
        "deployment_status": {"key": "properties.deploymentStatus", "type": "str"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        l4_route_base_settings: Optional["_models.L4RouteBaseSettings"] = None,
        enabled_state: Optional[Union[str, "_models.EnabledState"]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword routing_method: Routing method for TCP/UDP routes based on SNI or Ports division, if
         it is SNI based then the we can read SNI header to get the origin name or if its based on the
         ports then we can have port division to connect to specific origin for example port range
         2000-2050 belongs to origin group 1 and port range 3000-3050 belongs to origin group 2. Known
         values are: "SNIBased" and "PortBased".
        :paramtype routing_method: str or ~azure.mgmt.cdn.models.RoutingMethod
        ...
        :keyword l4_route_base_settings: L4 Route base settings.
        :paramtype l4_route_base_settings: ~azure.mgmt.cdn.models.L4RouteBaseSettings
        :keyword enabled_state: Whether to enable the route. Permitted values are 'Enabled' or
         'Disabled'. Known values are: "Enabled" and "Disabled".
        :paramtype enabled_state: str or ~azure.mgmt.cdn.models.EnabledState
        """
        super().__init__(**kwargs)
        ...
        self.l4_route_base_settings = l4_route_base_settings
        self.enabled_state = enabled_state
        self.provisioning_state = None
        self.deployment_status = None


class L4RouteBaseSettings(_serialization.Model):
    """Base class for all L4 route settings.

    :ivar frontend_protocol: Frontend protocol for TCP/UDP routes. Known values are: "TCP" and
     "UDP".
    :vartype frontend_protocol: str or ~azure.mgmt.cdn.models.FrontendProtocol
    :ivar backend_protocol: Backend protocol used to establish connection with customer's backend.
     Known values are: "TCP" and "UDP".
    :vartype backend_protocol: str or ~azure.mgmt.cdn.models.BackendProtocol
    :ivar ports: The ports used for the TCP/UDP connection. Must be between 1024 and 65535
     excluding reserved ports. The ports can be a comma separated list or a valid range like
     5050-5090.
    :vartype ports: str
    """

    _attribute_map = {
        "frontend_protocol": {"key": "FrontendProtocol", "type": "str"},
    ...
    def __init__(
        self,
        *,
        frontend_protocol: Optional[Union[str, "_models.FrontendProtocol"]] = None,
        backend_protocol: Optional[Union[str, "_models.BackendProtocol"]] = None,
        ports: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword frontend_protocol: Frontend protocol for TCP/UDP routes. Known values are: "TCP" and
         "UDP".
        :paramtype frontend_protocol: str or ~azure.mgmt.cdn.models.FrontendProtocol
        :keyword backend_protocol: Backend protocol used to establish connection with customer's
         backend. Known values are: "TCP" and "UDP".
        :paramtype backend_protocol: str or ~azure.mgmt.cdn.models.BackendProtocol
        :keyword ports: The ports used for the TCP/UDP connection. Must be between 1024 and 65535
         excluding reserved ports. The ports can be a comma separated list or a valid range like
         5050-5090.
        :paramtype ports: str
        """
...
class L4RouteListResult(_serialization.Model):
    """Result of the request to list L4 routes. It contains a list of L4 route objects and a URL link
    to get the next set of results.

    Variables are only populated by the server, and will be ignored when sending a request.

    :ivar value: List of AzureFrontDoor L4 routes within a profile.
    :vartype value: list[~azure.mgmt.cdn.models.L4Route]
...
class L4RouteUpdatePropertiesParameters(_serialization.Model):
    """L4 Route.
    ...
    _attribute_map = {
        ...
        "l4_route_base_settings": {"key": "L4RouteBaseSettings", "type": "L4RouteBaseSettings"},
        "enabled_state": {"key": "enabledState", "type": "str"},
    }
...
class L4RouteProperties(L4RouteUpdatePropertiesParameters, AFDStateProperties):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        super().__init__(
            ...
            l4_route_base_settings=l4_route_base_settings,
            enabled_state=enabled_state,
            **kwargs
        )
        self.provisioning_state = None
