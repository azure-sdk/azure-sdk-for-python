...
from ._cdn_management_client_enums import SecurityPolicyWebApplicationFirewallAssociationIsProfileLevel
...
__all__ = [
    ...
    "SecretType",
    "SecurityPolicyType",
    "SecurityPolicyWebApplicationFirewallAssociationIsProfileLevel",
