...
def build_load_test_mgmt_list_by_subscription_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/providers/Microsoft.LoadTestService/loadTests"
...
def build_load_test_mgmt_list_by_resource_group_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.LoadTestService/loadTests"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
...
def build_load_test_mgmt_get_loadtest_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.LoadTestService/loadTests/{loadTestName}"  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
...
def build_load_test_mgmt_create_or_update_loadtest_request(  # pylint: disable=name-too-long
    resource_group_name: str, load_test_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_load_test_mgmt_update_loadtest_request(  # pylint: disable=name-too-long
    resource_group_name: str, load_test_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_load_test_mgmt_delete_loadtest_request(  # pylint: disable=name-too-long
    resource_group_name: str, load_test_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_load_test_mgmt_outbound_network_dependencies_endpoints_request(  # pylint: disable=name-too-long
    resource_group_name: str, load_test_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.LoadTestService/loadTests/{loadTestName}/outboundNetworkDependenciesEndpoints"  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "loadTestName": _SERIALIZER.url("load_test_name", load_test_name, "str"),
...
def build_load_test_mgmt_get_quota_request(
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/providers/Microsoft.LoadTestService/locations/{location}/quotas/{quotaBucketName}"  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
...
def build_load_test_mgmt_list_quota_request(location: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/providers/Microsoft.LoadTestService/locations/{location}/quotas"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "location": _SERIALIZER.url("location", location, "str"),
    }
...
def build_load_test_mgmt_check_availability_quota_request(  # pylint: disable=name-too-long
    location: str, quota_bucket_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/providers/Microsoft.LoadTestService/locations/{location}/quotas/{quotaBucketName}/checkAvailabilityQuota"  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "location": _SERIALIZER.url("location", location, "str"),
        "quotaBucketName": _SERIALIZER.url("quota_bucket_name", quota_bucket_name, "str"),
...
class LoadTestMgmtClientOperationsMixin(LoadTestMgmtClientMixinABC):
    ...
    @distributed_trace
    def get_loadtest(self, resource_group_name: str, load_test_name: str, **kwargs: Any) -> _models.LoadTestResource:
    ...
    def _create_or_update_loadtest_initial(
        self,
    ...
    @overload
    def begin_create_or_update_loadtest(
        self,
        resource_group_name: str,
        load_test_name: str,
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns LoadTestResource. The LoadTestResource is
    ...
    def begin_create_or_update_loadtest(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = self._create_or_update_loadtest_initial(
                resource_group_name=resource_group_name,
                load_test_name=load_test_name,
    ...
    def begin_update_loadtest(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._update_loadtest_initial(
                resource_group_name=resource_group_name,
                load_test_name=load_test_name,
    ...
    def _delete_loadtest_initial(self, resource_group_name: str, load_test_name: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    @distributed_trace
    def begin_delete_loadtest(self, resource_group_name: str, load_test_name: str, **kwargs: Any) -> LROPoller[None]:
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._delete_loadtest_initial(
                resource_group_name=resource_group_name,
                load_test_name=load_test_name,
                cls=lambda x, y, z: x,
                headers=_headers,
    ...
    @distributed_trace
    def get_quota(self, location: str, quota_bucket_name: str, **kwargs: Any) -> _models.QuotaResource:
    ...
    @distributed_trace
    def list_quota(self, location: str, **kwargs: Any) -> Iterable["_models.QuotaResource"]:
