...
class QuotasOperations:
    ...
    def get(self, location: str, quota_bucket_name: str, **kwargs: Any) -> _models.QuotaResource:
        ...
        deserialized = self._deserialize("QuotaResource", pipeline_response.http_response)
    ...
    def check_availability(
        ...
        deserialized = self._deserialize("CheckQuotaAvailabilityResponse", pipeline_response.http_response)
