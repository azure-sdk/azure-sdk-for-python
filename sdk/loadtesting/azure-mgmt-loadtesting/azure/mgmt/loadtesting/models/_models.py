...
class CheckQuotaAvailabilityResponse(_Model):
...
class CheckQuotaAvailabilityResponseProperties(_Model):
    """Check quota availability response properties.
...
class LoadTestProperties(_Model):
...
class LoadTestResourceUpdate(_Model):
...
class LoadTestResourceUpdateProperties(_Model):
...
class QuotaBucketRequest(_Model):
...
class QuotaBucketRequestProperties(_Model):
...
class QuotaBucketRequestPropertiesDimensions(_Model):
    """Dimensions for new quota request.
...
class QuotaResourceProperties(_Model):
