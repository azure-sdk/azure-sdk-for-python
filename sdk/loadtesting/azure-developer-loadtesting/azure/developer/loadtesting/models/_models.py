...
class PassFailMetric(_model_base.Model):
    ...
    def __init__(
        ...
        *,
        ...
        result: Optional[Union[str, "_models.PFResult"]] = None,
    ):
        ...
...
class Test(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        *,
        ...
        input_artifacts: Optional["_models.TestInputArtifacts"] = None,
...
class TestInputArtifacts(_model_base.Model):
    ...
    def __init__(
        ...
        *,
        ...
        additional_file_info: Optional[List["_models.FileInfo"]] = None,
    ):
        ...
...
class TestRun(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        *,
        ...
        certificate: Optional["_models.CertificateMetadata"] = None,
        environment_variables: Optional[Dict[str, str]] = None,
        error_details: Optional[List["_models.ErrorDetails"]] = None,
        test_run_statistics: Optional[Dict[str, "_models.TestRunStatistics"]] = None,
        load_test_configuration: Optional["_models.LoadTestConfiguration"] = None,
        test_artifacts: Optional["_models.TestRunArtifacts"] = None,
        test_result: Optional[Union[str, "_models.PFTestResult"]] = None,
        virtual_users: Optional[int] = None,
        display_name: Optional[str] = None,
        test_id: Optional[str] = None,
        description: Optional[str] = None,
        ...
        executed_date_time: Optional[datetime.datetime] = None,
...
class TestRunArtifacts(_model_base.Model):
    ...
    def __init__(
        self,
        *,
        input_artifacts: Optional["_models.TestRunInputArtifacts"] = None,
...
class TestRunStatistics(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        *,
        ...
        mean_res_time: Optional[float] = None,
        median_res_time: Optional[float] = None,
        max_res_time: Optional[float] = None,
        min_res_time: Optional[float] = None,
        pct1_res_time: Optional[float] = None,
        pct2_res_time: Optional[float] = None,
        pct3_res_time: Optional[float] = None,
        throughput: Optional[float] = None,
        received_k_bytes_per_sec: Optional[float] = None,
        sent_k_bytes_per_sec: Optional[float] = None,
    ):
        ...
