...
class Test(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    created_date_time: Optional[datetime.datetime] = rest_field(name="createdDateTime", visibility=["read"])
    """The creation datetime(ISO 8601 literal format)."""
    created_by: Optional[str] = rest_field(name="createdBy", visibility=["read"])
    """The user that created."""
    last_modified_date_time: Optional[datetime.datetime] = rest_field(name="lastModifiedDateTime", visibility=["read"])
...
class TestInputArtifacts(_model_base.Model):
    ...
    """File info."""
    additional_file_info: Optional[List["_models.FileInfo"]] = rest_field(
...
class TestRun(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    start_date_time: Optional[datetime.datetime] = rest_field(name="startDateTime", visibility=["read"])
    """The test run start DateTime(ISO 8601 literal format)."""
    end_date_time: Optional[datetime.datetime] = rest_field(name="endDateTime", visibility=["read"])
    """The test run end DateTime(ISO 8601 literal format)."""
    executed_date_time: Optional[datetime.datetime] = rest_field(name="executedDateTime", visibility=["read"])
