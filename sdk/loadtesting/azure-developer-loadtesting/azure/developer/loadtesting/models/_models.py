...
class AppComponent(_model_base.Model):
    ...
    :ivar display_name: Azure resource display name. Required.
    ...
    """Azure resource display name. Required."""
...
class AutoStopCriteria(_model_base.Model):
    ...
    :ivar auto_stop_enabled: Whether auto-stop should be enabled.
    :vartype auto_stop_enabled: bool
    :ivar error_rate: Threshold percentage of errors on which test run should be automatically
     stopped.
    :vartype error_rate: float
    :ivar error_rate_time_window: Time window during which the error percentage should be
     evaluated.
    :vartype error_rate_time_window: int
    """

    auto_stop_enabled: Optional[bool] = rest_field(name="autoStopEnabled")
    """Whether auto-stop should be enabled."""
    error_rate: Optional[float] = rest_field(name="errorRate")
    """Threshold percentage of errors on which test run should be automatically stopped."""
    error_rate_time_window: Optional[int] = rest_field(name="errorRateTimeWindow")
    """Time window during which the error percentage should be evaluated."""
    ...
    def __init__(
        ...
        *,
        ...
        error_rate_time_window: Optional[int] = None,
    ):
        ...
...
class ContainerInfo(_model_base.Model):
    """Container info.

    :ivar url: Container URL.
    :vartype url: str
    :ivar expire_date_time: Expiry time of the container (ISO 8601 literal format).
...
class FileInfo(_model_base.Model):
    ...
    :ivar file_type: File type. Known values are: "JMX_FILE", "USER_PROPERTIES",
     "ADDITIONAL_ARTIFACTS", "ZIPPED_ARTIFACTS", and "URL_TEST_CONFIG".
    ...
    """File type. Known values are: \"JMX_FILE\", \"USER_PROPERTIES\", \"ADDITIONAL_ARTIFACTS\",
     \"ZIPPED_ARTIFACTS\", and \"URL_TEST_CONFIG\"."""
...
class LoadTestConfiguration(_model_base.Model):
    ...
    :ivar test_type: Type of test. e.g. Url or JMX. Known values are: "URL" and "JMX".
    :vartype test_type: str or ~azure.developer.loadtesting.models.TestType
    """
    ...
    test_type: Optional[Union[str, "_models.TestType"]] = rest_field(name="testType")
    """Type of test. e.g. Url or JMX. Known values are: \"URL\" and \"JMX\"."""
...
class OptionalLoadTestConfig(_model_base.Model):
    ...
    :ivar rps: Throughput required (requests per second).
    :vartype rps: int
    :ivar max_response_time: Maximum response time in milliseconds of the API/endpoint.
    :vartype max_response_time: int
    ...
    """Test URL. Provide the complete HTTP URL. For example,
     https://contoso-app.azurewebsites.net/login."""
    rps: Optional[int] = rest_field()
    """Throughput required (requests per second)."""
    max_response_time: Optional[int] = rest_field(name="maxResponseTime")
...
class TestInputArtifacts(_model_base.Model):
    ...
    :ivar url_tests_config_file_info: The config json file for url based test.
    :vartype url_tests_config_file_info: ~azure.developer.loadtesting.models.TestFileInfo
    ...
    """File info."""
    url_tests_config_file_info: Optional["_models.TestFileInfo"] = rest_field(name="urlTestsConfigFileInfo")
    ...
    def __init__(
        ...
        *,
        ...
        url_tests_config_file_info: Optional["_models.TestFileInfo"] = None,
    ):
        ...
...
class TestRunFileInfo(FileInfo):
    """Test run file info.
...
class TestRunInputArtifacts(_model_base.Model):
    ...
    :ivar url_tests_config_file_info: The config json file for url based test.
    :vartype url_tests_config_file_info: ~azure.developer.loadtesting.models.TestRunFileInfo
    :ivar additional_file_info: Additional supported files for the test run.
    ...
    """File info."""
    url_tests_config_file_info: Optional["_models.TestRunFileInfo"] = rest_field(name="urlTestsConfigFileInfo")
    """The config json file for url based test."""
    ...
    def __init__(
        ...
        *,
        ...
        url_tests_config_file_info: Optional["_models.TestRunFileInfo"] = None,
    ):
        ...
...
class TestRunOutputArtifacts(_model_base.Model):
    ...
    :vartype artifacts_container_info: ~azure.developer.loadtesting.models.ContainerInfo
    """
    ...
    """File info."""
    artifacts_container_info: Optional["_models.ContainerInfo"] = rest_field(name="artifactsContainerInfo")
    ...
    def __init__(
        ...
        *,
        ...
        artifacts_container_info: Optional["_models.ContainerInfo"] = None,
    ):
        ...
