...
class LoadTestConfiguration(_model_base.Model):
    ...
    :ivar region_configuration: Configure engine instances to be split into multiple regions.
    :vartype region_configuration: list[~azure.developer.loadtesting.models.RegionConfig]
    """
    ...
    region_configuration: Optional[List["_models.RegionConfig"]] = rest_field(name="regionConfiguration")
    ...
    def __init__(
        ...
        *,
        ...
        region_configuration: Optional[List["_models.RegionConfig"]] = None,
    ):
        ...
...
class RegionConfig(_model_base.Model):
    """Region configuration for load test.

    :ivar region_name: Region to apply this configuration.
    :vartype region_name: str
    :ivar engine_instances: The number of engine instances to execute load test in this region.
    ...
    engine_instances: Optional[int] = rest_field(name="engineInstances")
    """The number of engine instances to execute load test in this region. Supported values are in
     range of 1-400."""
...
class Test(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar kind: Kind of test. Known values are: "URL" and "JMX".
    ...
    """Kind of test. Known values are: \"URL\" and \"JMX\"."""
...
class TestFileInfo(_model_base.Model):
    ...
    :ivar file_type: File type. Known values are: "JMX_FILE", "USER_PROPERTIES",
     "ADDITIONAL_ARTIFACTS", "ZIPPED_ARTIFACTS", and "URL_TEST_CONFIG_JSON".
...
class TestRun(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar load_test_configuration: The load test configuration.
    :vartype load_test_configuration: ~azure.developer.loadtesting.models.LoadTestConfiguration
    :ivar region_configuration: Region configuration applied of load test run.
    :vartype region_configuration: list[~azure.developer.loadtesting.models.RegionConfig]
    ...
    :ivar subnet_id: Subnet ID on which the load test instances should run.
    :vartype subnet_id: str
    :ivar kind: Type of test. Known values are: "URL" and "JMX".
    :vartype kind: str or ~azure.developer.loadtesting.models.TestKind
    :ivar public_i_p_disabled: Inject load test engines without deploying public IP for outbound
     access.
    :vartype public_i_p_disabled: bool
    ...
    load_test_configuration: Optional["_models.LoadTestConfiguration"] = rest_field(name="loadTestConfiguration")
    """The load test configuration."""
    region_configuration: Optional[List["_models.RegionConfig"]] = rest_field(
        name="regionConfiguration", visibility=["read"]
    )
    ...
    """Type of test. Known values are: \"URL\" and \"JMX\"."""
