...
class AutoStopCriteria(_model_base.Model):
    ...
    :ivar auto_stop_enabled: Auto stop is enabled or not.
    :vartype auto_stop_enabled: bool
    :ivar error_rate: Value of auto stop criteria metric.
    :vartype error_rate: float
    :ivar error_rate_time_window: Time window in seconds for auto stop metric.
...
class OptionalLoadTestConfig(_model_base.Model):
    ...
    :vartype rps: int
    :ivar max_response_time: Maximum response time of the API/endpoint.
...
class Test(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar auto_stop_criteria: Auto stop criteria for a test.
    ...
    :ivar baseline_test_run_id: Id of the test run to be used as the baseline reference for results
     trends.
    ...
    :ivar test_id: Unique test name as identifier. Required.
    :vartype test_id: str
    ...
    """Unique test name as identifier. Required."""
    description: Optional[str] = rest_field()
...
class TestRun(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar test_run_id: Unique test run identifier. Required.
    ...
    """Unique test run identifier. Required."""
    pass_fail_criteria: Optional["_models.PassFailCriteria"] = rest_field(name="passFailCriteria")
    """Pass fail criteria for a test."""
    auto_stop_criteria: Optional["_models.AutoStopCriteria"] = rest_field(name="autoStopCriteria")
    """Auto stop criteria for a test."""
