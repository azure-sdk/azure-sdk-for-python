...
class RegionalConfiguration(_model_base.Model):
    ...
    :vartype engine_instances: int
    :ivar load_percentage: The percentage of load to be distributed in specified region. Supported
     values are in range of 1-100.
    ...
    """The number of engine instances to execute load test in specified region. Supported values are
     in range of 1-400."""
    load_percentage: Optional[int] = rest_field(name="loadPercentage")
    """The percentage of load to be distributed in specified region. Supported values are in range of
     1-100."""
