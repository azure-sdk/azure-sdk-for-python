            ...
            .. code-block:: python
                ...
                body = {
                        ...
                        "additionalFileInfo": [
                            {
                                ...
                                "fileType": "str",  # Optional. File type. Known
                                  ...
                                  "ZIPPED_ARTIFACTS", and "URL_TEST_CONFIG_JSON".
                    ...
                    "keyvaultReferenceIdentityType": "str",  # Optional. Type of the managed
                      identity referencing the Key vault.
                    "kind": "str",  # Optional. Kind of test. Known values are: "URL" and "JMX".
                        ...
                        "regionConfiguration": [
                            {
                                "engineInstances": 0,  # Optional. The number of
                                  engine instances to execute load test in this region. Supported
                                  values are in range of 1-400.
                                "regionName": "str"  # Optional. Region to apply this
                                  configuration.
                            }
                        ],
            ...
            .. code-block:: python
                ...
                response == {
                    ...
                    "fileType": "str",  # Optional. File type. Known values are: "JMX_FILE",
                      "USER_PROPERTIES", "ADDITIONAL_ARTIFACTS", "ZIPPED_ARTIFACTS", and
    ...
    def begin_upload_test_file(
        ...
        **kwargs: Any
        ...
        :keyword file_type: File type. Known values are: "JMX_FILE", "USER_PROPERTIES",
         "ADDITIONAL_ARTIFACTS", "ZIPPED_ARTIFACTS", and "URL_TEST_CONFIG_JSON". Default value is None.
            ...
            .. code-block:: python
                ...
                body = {
                    ...
                    "executedDateTime": "2020-02-20 00:00:00",  # Optional. Test run initiated
                      time.
                    "kind": "str",  # Optional. Type of test. Known values are: "URL" and "JMX".
                    "lastModifiedBy": "str",  # Optional. The user that last modified.
                    "lastModifiedDateTime": "2020-02-20 00:00:00",  # Optional. The last Modified
                      datetime(RFC 3339 literal format).
                    "loadTestConfiguration": {
                    ...
                    "regionConfiguration": [
                        {
                            "engineInstances": 0,  # Optional. The number of engine
                              instances to execute load test in this region. Supported values are in
                              range of 1-400.
                            "regionName": "str"  # Optional. Region to apply this
                              configuration.
                        }
                            ...
                            "additionalFileInfo": [
                                {
                                    ...
                                    "fileType": "str",  # Optional. File type.
                                      ...
                                      "ADDITIONAL_ARTIFACTS", "ZIPPED_ARTIFACTS", and
                                      "URL_TEST_CONFIG_JSON".
                                    "url": "str",  # Optional. File URL.
