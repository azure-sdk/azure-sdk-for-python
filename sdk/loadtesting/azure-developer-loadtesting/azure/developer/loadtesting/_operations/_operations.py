...
def build_load_test_administration_begin_upload_test_file_request(
...
def build_load_test_run_begin_test_run_request(
...
def build_load_test_run_get_metric_definitions_request(
...
def build_load_test_run_get_metric_namespaces_request(test_run_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class LoadTestRunClientOperationsMixin(LoadTestRunClientMixinABC):
    ...
    def list_metric_dimension_values(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.developer.loadtesting.models.DimensionValueList]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_metrics(
        ...
        **kwargs: Any
        ...
        :keyword aggregation: The aggregation. Required.
