...
def build_test_profile_run_stop_request(test_profile_run_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class TestProfileRunClientOperationsMixin(TestProfileRunClientMixinABC):
    ...
    def stop(self, test_profile_run_id: str, **kwargs: Any) -> _models.TestProfileRun:
        ...
        _request = build_test_profile_run_stop_request(
            test_profile_run_id=test_profile_run_id,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
