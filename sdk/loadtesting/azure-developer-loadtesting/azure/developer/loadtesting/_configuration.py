...
class LoadTestAdministrationClientConfiguration(  # pylint: disable=too-many-instance-attributes,name-too-long
    ...
    :keyword api_version: The API version to use for this operation. Default value is
     "2023-04-01-preview". Note that overriding this default value may result in unsupported
     behavior.
...
class LoadTestRunClientConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes,name-too-long
