...
# USAGE
    python create_or_update_test_locust.py
        ...
        body={
            ...
            "loadTestConfiguration": {
                ...
                "regionalLoadTestConfig": [
                    {"loadPercentage": 40, "region": "northeurope"},
                    {"loadPercentage": 60, "region": "westeurope"},
                ],
                "splitAllCSVs": False,
            },
...
# x-ms-original-file: 2025-03-01-preview/CreateOrUpdateTest_Locust.json
