...
# USAGE
    python monitors_get_metric_rules_minimum_set_gen.py
...
def main():
    ...
    response = client.monitors.get_metric_rules(
...
# x-ms-original-file: specification/newrelic/resource-manager/NewRelic.Observability/stable/2024-03-01/examples/Monitors_GetMetricRules_MinimumSet_Gen.json
