...
# USAGE
    python monitors_get_metric_rules_maximum_set_gen.py
...
# x-ms-original-file: specification/newrelic/resource-manager/NewRelic.Observability/stable/2024-03-01/examples/Monitors_GetMetricRules_MaximumSet_Gen.json
