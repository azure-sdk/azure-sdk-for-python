...
class TestLogicManagementIntegrationServiceEnvironmentsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_integration_service_environments_integration_service_environment_network_health_get(
        self, resource_group
    ):
        response = (
            await self.client.integration_service_environments.integration_service_environment_network_health_get(
                integration_service_environment_name="str",
                api_version="2019-05-01",
            )
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_integration_service_environments_list(self, resource_group):
