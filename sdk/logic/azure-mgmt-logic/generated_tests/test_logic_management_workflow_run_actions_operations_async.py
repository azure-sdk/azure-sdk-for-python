...
class TestLogicManagementWorkflowRunActionsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_workflow_run_actions_list_expression_traces(self, resource_group):
        response = await self.client.workflow_run_actions.list_expression_traces(
            resource_group_name=resource_group.name,
            workflow_name="str",
            run_name="str",
            action_name="str",
