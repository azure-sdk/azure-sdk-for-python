...
class TestLogicManagementWorkflowTriggerHistoriesOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_workflow_trigger_histories_resubmit(self, resource_group):
        response = self.client.workflow_trigger_histories.resubmit(
            resource_group_name=resource_group.name,
            workflow_name="str",
            trigger_name="str",
            history_name="str",
