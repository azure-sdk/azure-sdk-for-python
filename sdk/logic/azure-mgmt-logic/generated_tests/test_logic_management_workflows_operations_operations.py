...
class TestLogicManagementWorkflowsOperationsOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(LogicManagementClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_workflows_operations_validate_by_location(self, resource_group):
        response = self.client.workflows_operations.validate_by_location(
