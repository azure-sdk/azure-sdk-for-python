...
class TestLogicManagementWorkflowVersionsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_workflow_versions_list_callback_url(self, resource_group):
        response = await self.client.workflow_versions.list_callback_url(
            resource_group_name=resource_group.name,
            workflow_name="str",
            version_id="str",
            trigger_name="str",
