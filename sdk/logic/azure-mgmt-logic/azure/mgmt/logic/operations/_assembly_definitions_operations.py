...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "assemblyArtifactName": _SERIALIZER.url(
            "assembly_artifact_name", assembly_artifact_name, "str", pattern=r"[a-zA-Z0-9_.()-]{0,79}$"
        ),
    }
...
class AssemblyDefinitionsOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`assembly_definitions` attribute.
    """
    ...
    def list(
        ...
        deserialized = self._deserialize("AssemblyCollection", pipeline_response.http_response)
    ...
    def get(
        ...
        deserialized = self._deserialize("AssemblyDefinition", pipeline_response.http_response)
    ...
    def create_or_update(
        ...
        integration_account_name: str,
        assembly_artifact_name: str,
        resource: _models.AssemblyDefinition,
        *,
        ...
        **kwargs: Any
        ...
        :param assembly_artifact_name: The assembly artifact name. Required.
        :type assembly_artifact_name: str
        :param resource: The assembly artifact. Required.
        :type resource: ~azure.mgmt.logic.models.AssemblyDefinition
    ...
    def create_or_update(
        ...
        integration_account_name: str,
        assembly_artifact_name: str,
        resource: Union[_models.AssemblyDefinition, IO[bytes]],
        **kwargs: Any
    ) -> _models.AssemblyDefinition:
        """Create or update an assembly for an integration account.
        ...
        :param assembly_artifact_name: The assembly artifact name. Required.
        :type assembly_artifact_name: str
        :param resource: The assembly artifact. Is either a AssemblyDefinition type or a IO[bytes]
         type. Required.
        :type resource: ~azure.mgmt.logic.models.AssemblyDefinition or IO[bytes]
        :return: AssemblyDefinition or the result of cls(response)
        :rtype: ~azure.mgmt.logic.models.AssemblyDefinition
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "AssemblyDefinition")
