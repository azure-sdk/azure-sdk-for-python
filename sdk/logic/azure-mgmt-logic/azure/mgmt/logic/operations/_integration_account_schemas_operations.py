...
class IntegrationAccountSchemasOperations:
    ...
    def create_or_update(
        ...
        integration_account_name: str,
        schema_name: str,
        schema: Union[_models.IntegrationAccountSchema, IO],
        **kwargs: Any
    ) -> _models.IntegrationAccountSchema:
        """Creates or updates an integration account schema.
        ...
        :param schema: The integration account schema. Is either a IntegrationAccountSchema type or a
         IO type. Required.
        :type schema: ~azure.mgmt.logic.models.IntegrationAccountSchema or IO
    ...
    list_content_callback_url.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/integrationAccounts/{integrationAccountName}/schemas/{schemaName}/listContentCallbackUrl"
    }
