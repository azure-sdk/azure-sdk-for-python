...
def build_get_request(
    resource_group_name: str, workflow_name: str, run_name: str, operation_id: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
...
class WorkflowRunOperationsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`workflow_run_operations` attribute.
    """
    ...
    @distributed_trace
    def get(
        self, resource_group_name: str, workflow_name: str, run_name: str, operation_id: str, **kwargs: Any
    ) -> _models.WorkflowRun:
        ...
        :type run_name: str
        :param operation_id: The name of the WorkflowRun. Required.
