...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "batchConfigurationName": _SERIALIZER.url(
            "batch_configuration_name", batch_configuration_name, "str", pattern=r"[a-zA-Z0-9_.()-]{0,79}$"
        ),
    }
...
class BatchConfigurationsOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`batch_configurations` attribute.
    """
    ...
    def list(
    ...
    ) -> _models.BatchConfigurationCollection:
        ...
        deserialized = self._deserialize("BatchConfigurationCollection", pipeline_response.http_response)
    ...
    def get(
        ...
        deserialized = self._deserialize("BatchConfiguration", pipeline_response.http_response)
    ...
    def create_or_update(
        ...
        integration_account_name: str,
        batch_configuration_name: str,
        resource: _models.BatchConfiguration,
        *,
        ...
        **kwargs: Any
        ...
        :param batch_configuration_name: The batch configuration name. Required.
        :type batch_configuration_name: str
        :param resource: The batch configuration. Required.
        :type resource: ~azure.mgmt.logic.models.BatchConfiguration
    ...
    def create_or_update(
        ...
        integration_account_name: str,
        batch_configuration_name: str,
        resource: Union[_models.BatchConfiguration, IO[bytes]],
        **kwargs: Any
    ) -> _models.BatchConfiguration:
        """Create or update a batch configuration for an integration account.
        ...
        :param batch_configuration_name: The batch configuration name. Required.
        :type batch_configuration_name: str
        :param resource: The batch configuration. Is either a BatchConfiguration type or a IO[bytes]
         type. Required.
        :type resource: ~azure.mgmt.logic.models.BatchConfiguration or IO[bytes]
        :return: BatchConfiguration or the result of cls(response)
        :rtype: ~azure.mgmt.logic.models.BatchConfiguration
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "BatchConfiguration")
