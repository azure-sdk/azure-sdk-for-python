...
class WorkflowsOperations:
    ...
    @distributed_trace_async
    async def create_or_update(
        self, resource_group_name: str, workflow_name: str, workflow: Union[_models.Workflow, IO[bytes]], **kwargs: Any
    ) -> _models.Workflow:
        """Creates or updates a workflow.
        ...
        :param workflow_name: The workflow name. Required.
        :type workflow_name: str
        :param workflow: The workflow. Is either a Workflow type or a IO[bytes] type. Required.
        :type workflow: ~azure.mgmt.logic.models.Workflow or IO[bytes]
        :return: Workflow or the result of cls(response)
        :rtype: ~azure.mgmt.logic.models.Workflow
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace_async
    async def update(self, resource_group_name: str, workflow_name: str, **kwargs: Any) -> _models.Workflow:
        """Updates a workflow.
    ...
    async def generate_upgraded_definition(
        ...
        resource_group_name: str,
        workflow_name: str,
        parameters: Union[_models.GenerateUpgradedDefinitionParameters, IO[bytes]],
        **kwargs: Any
    ) -> JSON:
        """Generates the upgraded definition for a workflow.
        ...
        :type parameters: ~azure.mgmt.logic.models.GenerateUpgradedDefinitionParameters or IO[bytes]
        :return: JSON or the result of cls(response)
        :rtype: JSON
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def list_callback_url(
        ...
        **kwargs: Any
        ...
        :type workflow_name: str
        :param list_callback_url: Which callback url to list. Required.
        :type list_callback_url: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: WorkflowTriggerCallbackUrl or the result of cls(response)
    ...
    async def list_callback_url(
        ...
        resource_group_name: str,
        workflow_name: str,
        list_callback_url: Union[_models.GetCallbackUrlParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.WorkflowTriggerCallbackUrl:
        """Get the workflow callback Url.
        ...
        :type list_callback_url: ~azure.mgmt.logic.models.GetCallbackUrlParameters or IO[bytes]
        :return: WorkflowTriggerCallbackUrl or the result of cls(response)
        :rtype: ~azure.mgmt.logic.models.WorkflowTriggerCallbackUrl
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace_async
    async def list_swagger(self, resource_group_name: str, workflow_name: str, **kwargs: Any) -> JSON:
    ...
    async def _move_initial(
        ...
        resource_group_name: str,
        workflow_name: str,
        move: Union[_models.WorkflowReference, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_move(
        ...
        **kwargs: Any
        ...
        :param workflow_name: The workflow name. Required.
        :type workflow_name: str
        :param move: The workflow to move. Is either a WorkflowReference type or a IO[bytes] type.
         Required.
        :type move: ~azure.mgmt.logic.models.WorkflowReference or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def regenerate_access_key(
        ...
        **kwargs: Any
        ...
        :param key_type: The access key type. Is either a RegenerateActionParameter type or a IO[bytes]
         type. Required.
        :type key_type: ~azure.mgmt.logic.models.RegenerateActionParameter or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace_async
    async def validate_by_resource_group(
        self, resource_group_name: str, workflow_name: str, validate: Union[_models.Workflow, IO[bytes]], **kwargs: Any
    ) -> None:
        """Validates the workflow.
