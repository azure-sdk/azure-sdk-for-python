...
class IntegrationAccountsOperations:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type integration_account_name: str
        :param integration_account: The integration account. Required.
        :type integration_account: IO[bytes]
    ...
    async def create_or_update(
        ...
        resource_group_name: str,
        integration_account_name: str,
        integration_account: Union[_models.IntegrationAccount, IO[bytes]],
        **kwargs: Any
    ) -> _models.IntegrationAccount:
        """Creates or updates an integration account.
        ...
        :type integration_account: ~azure.mgmt.logic.models.IntegrationAccount or IO[bytes]
        :return: IntegrationAccount or the result of cls(response)
        :rtype: ~azure.mgmt.logic.models.IntegrationAccount
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def list_callback_url(
        ...
        resource_group_name: str,
        integration_account_name: str,
        parameters: Union[_models.GetCallbackUrlParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.CallbackUrl:
        """Gets the integration account callback URL.
        ...
        :param parameters: The callback URL parameters. Is either a GetCallbackUrlParameters type or a
         IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.logic.models.GetCallbackUrlParameters or IO[bytes]
        :return: CallbackUrl or the result of cls(response)
        :rtype: ~azure.mgmt.logic.models.CallbackUrl
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_key_vault_keys(
        ...
        **kwargs: Any
        ...
        :type integration_account_name: str
        :param list_key_vault_keys: The key vault parameters. Required.
        :type list_key_vault_keys: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An iterator like instance of either KeyVaultKey or the result of cls(response)
    ...
    def list_key_vault_keys(
        ...
        resource_group_name: str,
        integration_account_name: str,
        list_key_vault_keys: Union[_models.ListKeyVaultKeysDefinition, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterable["_models.KeyVaultKey"]:
        """Gets the integration account's Key Vault keys.
        ...
        :type list_key_vault_keys: ~azure.mgmt.logic.models.ListKeyVaultKeysDefinition or IO[bytes]
        :return: An iterator like instance of either KeyVaultKey or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.logic.models.KeyVaultKey]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def log_tracking_events(
        ...
        **kwargs: Any
        ...
        :type integration_account_name: str
        :param log_tracking_events: The callback URL parameters. Required.
        :type log_tracking_events: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None or the result of cls(response)
    ...
    async def log_tracking_events(
        ...
        resource_group_name: str,
        integration_account_name: str,
        log_tracking_events: Union[_models.TrackingEventsDefinition, IO[bytes]],
        **kwargs: Any
    ) -> None:
        """Logs the integration account's tracking events.
        ...
        :param log_tracking_events: The callback URL parameters. Is either a TrackingEventsDefinition
         type or a IO[bytes] type. Required.
        :type log_tracking_events: ~azure.mgmt.logic.models.TrackingEventsDefinition or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def regenerate_access_key(
        ...
        resource_group_name: str,
        integration_account_name: str,
        regenerate_access_key: IO[bytes],
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.IntegrationAccount:
        ...
        :type integration_account_name: str
        :param regenerate_access_key: The access key type. Required.
        :type regenerate_access_key: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: IntegrationAccount or the result of cls(response)
    ...
    async def regenerate_access_key(
        ...
        resource_group_name: str,
        integration_account_name: str,
        regenerate_access_key: Union[_models.RegenerateActionParameter, IO[bytes]],
        **kwargs: Any
    ) -> _models.IntegrationAccount:
        """Regenerates the integration account access key.
        ...
        :type regenerate_access_key: ~azure.mgmt.logic.models.RegenerateActionParameter or IO[bytes]
        :return: IntegrationAccount or the result of cls(response)
        :rtype: ~azure.mgmt.logic.models.IntegrationAccount
        :raises ~azure.core.exceptions.HttpResponseError:
        """
