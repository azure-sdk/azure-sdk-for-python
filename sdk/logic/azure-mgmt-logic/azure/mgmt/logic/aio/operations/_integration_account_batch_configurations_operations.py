...
class IntegrationAccountBatchConfigurationsOperations:  # pylint: disable=name-too-long
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type batch_configuration_name: str
        :param batch_configuration: The batch configuration. Required.
        :type batch_configuration: IO[bytes]
    ...
    async def create_or_update(
        ...
        integration_account_name: str,
        batch_configuration_name: str,
        batch_configuration: Union[_models.BatchConfiguration, IO[bytes]],
        **kwargs: Any
    ) -> _models.BatchConfiguration:
        """Create or update a batch configuration for an integration account.
        ...
        :type batch_configuration: ~azure.mgmt.logic.models.BatchConfiguration or IO[bytes]
        :return: BatchConfiguration or the result of cls(response)
        :rtype: ~azure.mgmt.logic.models.BatchConfiguration
        :raises ~azure.core.exceptions.HttpResponseError:
        """
