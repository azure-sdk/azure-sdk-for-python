...
from ...operations._integration_account_maps_operations import (
...
class IntegrationAccountMapsOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.IntegrationAccountMap"]:
        ...
        :return: An iterator like instance of either IntegrationAccountMap or the result of
         cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.logic.models.IntegrationAccountMap]
    ...
    async def get(
        ...
        deserialized = self._deserialize("IntegrationAccountMap", pipeline_response.http_response)
    ...
    async def create_or_update(
        ...
        integration_account_name: str,
        map_name: str,
        map: Union[_models.IntegrationAccountMap, IO[bytes]],
        **kwargs: Any
    ) -> _models.IntegrationAccountMap:
        """Creates or updates an integration account map. If the map is larger than 4 MB, you need to
        store the map in an Azure blob and use the blob's Shared Access Signature (SAS) URL as the
        ...
        :param map_name: The integration account map name. Required.
        :type map_name: str
        :param map: The integration account map. Is either a IntegrationAccountMap type or a IO[bytes]
         type. Required.
        :type map: ~azure.mgmt.logic.models.IntegrationAccountMap or IO[bytes]
        :return: IntegrationAccountMap or the result of cls(response)
        :rtype: ~azure.mgmt.logic.models.IntegrationAccountMap
        :raises ~azure.core.exceptions.HttpResponseError:
        """
