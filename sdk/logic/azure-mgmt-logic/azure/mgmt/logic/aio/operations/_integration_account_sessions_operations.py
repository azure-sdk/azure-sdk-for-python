...
from ...operations._integration_account_sessions_operations import (
...
class IntegrationAccountSessionsOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.IntegrationAccountSession"]:
        ...
        :return: An iterator like instance of either IntegrationAccountSession or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.logic.models.IntegrationAccountSession]
        ...
        cls: ClsType[_models.IntegrationAccountSessionListResult] = kwargs.pop("cls", None)
    ...
    async def get(
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.IntegrationAccountSession] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("IntegrationAccountSession", pipeline_response.http_response)
    ...
    async def create_or_update(
        ...
        integration_account_name: str,
        session_name: str,
        resource: _models.IntegrationAccountSession,
        *,
        ...
        **kwargs: Any
        ...
        :param session_name: The integration account session name. Required.
        :type session_name: str
        :param resource: The integration account session. Required.
        :type resource: ~azure.mgmt.logic.models.IntegrationAccountSession
    ...
    async def create_or_update(
        ...
        integration_account_name: str,
        session_name: str,
        resource: Union[_models.IntegrationAccountSession, IO[bytes]],
        **kwargs: Any
    ) -> _models.IntegrationAccountSession:
        """Creates or updates an integration account session.
        ...
        :param session_name: The integration account session name. Required.
        :type session_name: str
        :param resource: The integration account session. Is either a IntegrationAccountSession type or
         a IO[bytes] type. Required.
        :type resource: ~azure.mgmt.logic.models.IntegrationAccountSession or IO[bytes]
        :return: IntegrationAccountSession or the result of cls(response)
        :rtype: ~azure.mgmt.logic.models.IntegrationAccountSession
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "IntegrationAccountSession")
