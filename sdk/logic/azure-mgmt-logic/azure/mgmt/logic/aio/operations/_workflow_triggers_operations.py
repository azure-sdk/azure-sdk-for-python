...
class WorkflowTriggersOperations:
    ...
    @distributed_trace_async
    async def reset(self, resource_group_name: str, workflow_name: str, trigger_name: str, **kwargs: Any) -> None:
    ...
    async def set_state(
        ...
        workflow_name: str,
        trigger_name: str,
        body: _models.SetTriggerStateActionDefinition,
        *,
        ...
        **kwargs: Any
        ...
        :param trigger_name: The workflow trigger name. Required.
        :type trigger_name: str
        :param body: The workflow trigger state. Required.
        :type body: ~azure.mgmt.logic.models.SetTriggerStateActionDefinition
    ...
    async def set_state(
        ...
        workflow_name: str,
        trigger_name: str,
        body: Union[_models.SetTriggerStateActionDefinition, IO[bytes]],
        **kwargs: Any
    ) -> None:
        """Sets the state of a workflow trigger.
        ...
        :param trigger_name: The workflow trigger name. Required.
        :type trigger_name: str
        :param body: The workflow trigger state. Is either a SetTriggerStateActionDefinition type or a
         IO[bytes] type. Required.
        :type body: ~azure.mgmt.logic.models.SetTriggerStateActionDefinition or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "SetTriggerStateActionDefinition")

        _request = build_set_state_request(
            resource_group_name=resource_group_name,
            workflow_name=workflow_name,
            trigger_name=trigger_name,
            subscription_id=self._config.subscription_id,
