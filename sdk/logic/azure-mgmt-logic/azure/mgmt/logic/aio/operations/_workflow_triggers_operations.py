...
class WorkflowTriggersOperations:
    ...
    @distributed_trace_async
    async def run(self, resource_group_name: str, workflow_name: str, trigger_name: str, **kwargs: Any) -> None:
    ...
    async def set_state(
        ...
        workflow_name: str,
        trigger_name: str,
        set_state: Union[_models.SetTriggerStateActionDefinition, IO[bytes]],
        **kwargs: Any
    ) -> None:
        """Sets the state of a workflow trigger.
        ...
        :type set_state: ~azure.mgmt.logic.models.SetTriggerStateActionDefinition or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
