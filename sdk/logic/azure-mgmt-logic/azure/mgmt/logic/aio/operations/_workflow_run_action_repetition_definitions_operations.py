...
from ...operations._workflow_run_action_repetition_definitions_operations import (
    build_get_request,
...
class WorkflowRunActionRepetitionDefinitionsOperations:  # pylint: disable=name-too-long
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`workflow_run_action_repetition_definitions` attribute.
    """
    ...
    @distributed_trace_async
    async def list_expression_traces(
        self,
        resource_group_name: str,
        workflow_name: str,
        run_name: str,
