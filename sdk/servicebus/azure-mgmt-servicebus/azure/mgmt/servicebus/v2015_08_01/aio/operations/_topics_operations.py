...
class TopicsOperations:
    ...
    async def create_or_update(
        ...
        namespace_name: str,
        topic_name: str,
        parameters: Union[_models.TopicCreateOrUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.TopicResource:
        """Creates a topic in the specified namespace.
        ...
        :type parameters: ~azure.mgmt.servicebus.v2015_08_01.models.TopicCreateOrUpdateParameters or
         IO[bytes]
        :return: TopicResource or the result of cls(response)
        :rtype: ~azure.mgmt.servicebus.v2015_08_01.models.TopicResource
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        deserialized = self._deserialize("TopicResource", pipeline_response.http_response)
    ...
    @distributed_trace_async
    async def delete(self, resource_group_name: str, namespace_name: str, topic_name: str, **kwargs: Any) -> None:
