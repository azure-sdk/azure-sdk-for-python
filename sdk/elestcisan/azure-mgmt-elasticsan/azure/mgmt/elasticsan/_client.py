...
class ElasticSanClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype snapshots: azure.mgmt.elasticsan.operations.SnapshotsOperations
    :ivar skus_operation_group: SkusOperationGroupOperations operations
    :vartype skus_operation_group: azure.mgmt.elasticsan.operations.SkusOperationGroupOperations
    ...
    def __init__(
        ...
        self.skus_operation_group = SkusOperationGroupOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
