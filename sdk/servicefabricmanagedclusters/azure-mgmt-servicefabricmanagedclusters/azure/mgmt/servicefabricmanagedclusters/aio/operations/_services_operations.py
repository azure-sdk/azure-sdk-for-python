...
from ...operations._services_operations import (
    ...
    build_read_list_partition_info_request,
    build_read_list_replica_info_request,
...
class ServicesOperations:
    ...
    async def _read_list_partition_info_initial(  # pylint: disable=inconsistent-return-statements
        self,
    ...
    async def begin_read_list_partition_info(
        self,
        resource_group_name: str,
        cluster_name: str,
        application_name: str,
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = await self._read_list_partition_info_initial(  # type: ignore
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                application_name=application_name,
                service_name=service_name,
    ...
    async def _read_list_replica_info_initial(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        cluster_name: str,
        application_name: str,
    ...
    @distributed_trace_async
    async def begin_read_list_replica_info(
        self,
        resource_group_name: str,
        cluster_name: str,
        application_name: str,
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._read_list_replica_info_initial(  # type: ignore
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                application_name=application_name,
                service_name=service_name,
