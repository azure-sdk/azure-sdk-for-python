...
class Operations:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.OperationResult"]:
        ...
        async def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(List[_models.OperationResult], deserialized["value"])
            if cls:
...
class ManagedClustersOperations:
    ...
    async def _start_fault_simulation_initial(
        ...
        resource_group_name: str,
        cluster_name: str,
        parameters: Union[_models.FaultSimulationContent, JSON, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_start_fault_simulation(
        ...
        **kwargs: Any
        ...
        :param parameters: parameters describing the fault simulation. Is one of the following types:
         FaultSimulationContent, JSON, IO[bytes] Required.
