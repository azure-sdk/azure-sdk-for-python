...
class ApplicationsOperations:
    ...
    async def _read_upgrade_initial(  # pylint: disable=inconsistent-return-statements
    ...
    async def begin_read_upgrade(
        ...
        if cont_token is None:
            raw_result = await self._read_upgrade_initial(  # type: ignore
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                application_name=application_name,
                api_version=api_version,
    ...
    async def _start_rollback_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, cluster_name: str, application_name: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_start_rollback(
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._start_rollback_initial(  # type: ignore
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                application_name=application_name,
                api_version=api_version,
    ...
    async def _resume_upgrade_initial(  # pylint: disable=inconsistent-return-statements
        self,
    ...
    async def begin_resume_upgrade(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._resume_upgrade_initial(  # type: ignore
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                application_name=application_name,
    ...
    async def _update_upgrade_initial(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        cluster_name: str,
        application_name: str,
    ...
    async def begin_update_upgrade(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._update_upgrade_initial(  # type: ignore
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                application_name=application_name,
                parameters=parameters,
