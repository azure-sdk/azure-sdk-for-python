...
class AdditionalNetworkInterfaceConfiguration(_model_base.Model):
...
class ScalingMechanism(_model_base.Model):
...
class ApplicationHealthPolicy(_model_base.Model):
...
class ApplicationResource(ProxyResource):
    ...
    __flattened_items = ["provisioning_state", "version", "parameters", "upgrade_policy", "managed_identities"]
...
class ApplicationResourceProperties(_model_base.Model):
    """The application resource properties.
...
class ApplicationTypeResourceProperties(_model_base.Model):
    """The application type name properties.
...
class ApplicationTypeUpdateParameters(_model_base.Model):
...
class ApplicationTypeVersionResourceProperties(_model_base.Model):
    """The properties of the application type version resource.
...
class ApplicationTypeVersionsCleanupPolicy(_model_base.Model):
...
class ApplicationTypeVersionUpdateParameters(_model_base.Model):
...
class ApplicationUpdateParameters(_model_base.Model):
...
class ApplicationUpgradePolicy(_model_base.Model):
    """Describes the policy for a monitored application upgrade.
...
class ApplicationUserAssignedIdentity(_model_base.Model):
...
class ScalingTrigger(_model_base.Model):
...
class AzureActiveDirectory(_model_base.Model):
...
class ClientCertificate(_model_base.Model):
...
class ClusterHealthPolicy(_model_base.Model):
...
class ClusterMonitoringPolicy(_model_base.Model):
...
class ClusterUpgradeDeltaHealthPolicy(_model_base.Model):
...
class ClusterUpgradePolicy(_model_base.Model):
...
class EndpointRangeDescription(_model_base.Model):
    """Port range details.
...
class ErrorModel(_model_base.Model):
...
class ErrorModelError(_model_base.Model):
    """The error details.
...
class FaultSimulation(_model_base.Model):
...
class FaultSimulationConstraints(_model_base.Model):
...
class FaultSimulationDetails(_model_base.Model):
    ...
    parameters: Optional["_models.FaultSimulationParameters"] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
...
class FaultSimulationIdParameters(_model_base.Model):
...
class FaultSimulationParameters(_model_base.Model):
...
class FrontendConfiguration(_model_base.Model):
    ...
    :ivar application_gateway_backend_address_pool_id: The resource Id of application gateway
     ...
     :code:`<subscriptionId>`/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationGateways/{applicationGatewayName}/backendAddressPools/{backendAddressPoolName}'.
...
class IpConfiguration(_model_base.Model):
...
class IpConfigurationPublicIPAddressConfiguration(_model_base.Model):  # pylint: disable=name-too-long
    """The public IP address configuration of the network interface.
...
class LoadBalancingRule(_model_base.Model):
...
class LongRunningOperationResult(_model_base.Model):
...
class ManagedAzResiliencyStatus(_model_base.Model):
...
class ManagedClusterCodeVersionResult(_model_base.Model):
...
class ManagedClusterProperties(_model_base.Model):
...
class ManagedClusterUpdateParameters(_model_base.Model):
...
class ManagedClusterVersionDetails(_model_base.Model):
    """The detail of the Service Fabric runtime version result.
...
class ManagedIdentity(_model_base.Model):
    """Describes the managed identities for an Azure resource.
...
class ManagedMaintenanceWindowStatus(_model_base.Model):
...
class ManagedVMSize(_model_base.Model):
...
class Partition(_model_base.Model):
...
class NetworkSecurityRule(_model_base.Model):
...
class NodeTypeActionParameters(_model_base.Model):
...
class NodeTypeAvailableSku(_model_base.Model):
...
class NodeTypeFaultSimulation(_model_base.Model):
...
class NodeTypeNatConfig(_model_base.Model):
...
class NodeTypeProperties(_model_base.Model):
    """Describes a node type in the cluster, each node type represents sub set of nodes in the
    cluster.
    ...
    """Specifies the security type of the nodeType. Only Standard and TrustedLaunch are currently
     supported. Known values are: \"TrustedLaunch\" and \"Standard\"."""
...
class NodeTypeSku(_model_base.Model):
...
class NodeTypeSkuCapacity(_model_base.Model):
...
class NodeTypeSupportedSku(_model_base.Model):
...
class NodeTypeUpdateParameters(_model_base.Model):
...
class ResourceAzStatus(_model_base.Model):
...
class RollingUpgradeMonitoringPolicy(_model_base.Model):
    """The policy used for monitoring the application upgrade.
...
class RuntimeResumeApplicationUpgradeParameters(_model_base.Model):  # pylint: disable=name-too-long
...
class ScalingPolicy(_model_base.Model):
...
class ServiceCorrelation(_model_base.Model):
...
class ServiceEndpoint(_model_base.Model):
...
class ServiceLoadMetric(_model_base.Model):
    """Specifies a metric to load balance a service during runtime.
...
class ServicePlacementPolicy(_model_base.Model):
...
class ServiceResourcePropertiesBase(_model_base.Model):
...
class ServiceTypeHealthPolicy(_model_base.Model):
...
class ServiceUpdateParameters(_model_base.Model):
...
class SettingsParameterDescription(_model_base.Model):
...
class SettingsSectionDescription(_model_base.Model):
...
class VmApplication(_model_base.Model):
...
class VmImagePlan(_model_base.Model):
    """Specifies information about the marketplace image used to create the virtual machine. This
    element is only used for marketplace images. Before you can use a marketplace image from an
    API, you must enable the image for programmatic use. In the Azure portal, find the marketplace
...
class VmManagedIdentity(_model_base.Model):
...
class VMSize(_model_base.Model):
    """VM Sizes properties.
...
class VmssDataDisk(_model_base.Model):
...
class VmssExtension(_model_base.Model):
...
class VmssExtensionProperties(_model_base.Model):
...
class ZoneFaultSimulationParameters(FaultSimulationParameters, discriminator="Zone"):
