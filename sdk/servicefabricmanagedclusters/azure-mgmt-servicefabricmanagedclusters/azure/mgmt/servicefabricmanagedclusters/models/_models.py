...
class AvailableOperationDisplay(_model_base.Model):
...
class FaultSimulationContent(_model_base.Model):
...
class FaultSimulationIdContent(_model_base.Model):
...
class IpConfiguration(_model_base.Model):
    ...
    :vartype public_ip_address_configuration:
     ~azure.mgmt.servicefabricmanagedclusters.models.PublicIPAddressConfiguration
    """
