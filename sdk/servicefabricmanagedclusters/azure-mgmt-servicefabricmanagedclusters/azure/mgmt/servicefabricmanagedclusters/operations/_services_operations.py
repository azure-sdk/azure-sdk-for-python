...
def build_read_list_partition_info_request(
    ...
    **kwargs: Any
    ...
    if continuation_token_parameter is not None:
        _params["ContinuationToken"] = _SERIALIZER.query(
            "continuation_token_parameter", continuation_token_parameter, "str", skip_quote=True
        )
    if timeout is not None:
        _params["timeout"] = _SERIALIZER.query("timeout", timeout, "int", maximum=4294967295, minimum=1)
...
def build_read_list_replica_info_request(
    resource_group_name: str,
    cluster_name: str,
    application_name: str,
    service_name: str,
    ...
    **kwargs: Any
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedclusters/{clusterName}/applications/{applicationName}/services/{serviceName}/partitions/{partitionId}/replicas/readList",
    )  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        ...
        "applicationName": _SERIALIZER.url("application_name", application_name, "str"),
        "serviceName": _SERIALIZER.url("service_name", service_name, "str"),
        "partitionId": _SERIALIZER.url("partition_id", partition_id, "str"),
    }
...
class ServicesOperations:
    ...
    def _read_list_partition_info_initial(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        cluster_name: str,
        application_name: str,
        ...
        **kwargs: Any
        ...
        request = build_read_list_partition_info_request(
            ...
            template_url=self._read_list_partition_info_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
    ...
    _read_list_partition_info_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedclusters/{clusterName}/applications/{applicationName}/services/{serviceName}/partitions/readList"
    }

    @distributed_trace
    def begin_read_list_partition_info(
        self,
        resource_group_name: str,
        cluster_name: str,
        application_name: str,
        ...
        **kwargs: Any
        ...
        """Gets the information about partitions of a Service Fabric service.

        Get Partition Info List returns information about the partitions of the specified service. The
        response includes the ID, status, health, and other details about the partition.
        ...
        if cont_token is None:
            raw_result = self._read_list_partition_info_initial(  # type: ignore
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                application_name=application_name,
                service_name=service_name,
    ...
    begin_read_list_partition_info.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedclusters/{clusterName}/applications/{applicationName}/services/{serviceName}/partitions/readList"
    }

    def _read_list_replica_info_initial(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        cluster_name: str,
        application_name: str,
        ...
        **kwargs: Any
        ...
        request = build_read_list_replica_info_request(
            resource_group_name=resource_group_name,
            cluster_name=cluster_name,
            application_name=application_name,
            service_name=service_name,
            ...
            timeout=timeout,
            api_version=api_version,
            template_url=self._read_list_replica_info_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    _read_list_replica_info_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedclusters/{clusterName}/applications/{applicationName}/services/{serviceName}/partitions/{partitionId}/replicas/readList"
    }

    @distributed_trace
    def begin_read_list_replica_info(
        self,
        resource_group_name: str,
        cluster_name: str,
        application_name: str,
        ...
        **kwargs: Any
        ...
        Get Replica Info List returns information about the replicas of the specified partition. The
        ...
        :param service_name: The name of the service resource in the format of
         {applicationName}~{serviceName}. Required.
        :type service_name: str
        :param partition_id: The id of the partition resource. Required.
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._read_list_replica_info_initial(  # type: ignore
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                application_name=application_name,
                service_name=service_name,
    ...
    begin_read_list_replica_info.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedclusters/{clusterName}/applications/{applicationName}/services/{serviceName}/partitions/{partitionId}/replicas/readList"
    }
