...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.ServiceFabric/managedClusters"
    )
...
class ManagedClustersOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.ManagedCluster"]:
    ...
    def get_fault_simulation(
        ...
        resource_group_name: str,
        cluster_name: str,
        parameters: Union[_models.FaultSimulationIdContent, IO[bytes]],
        **kwargs: Any
    ) -> _models.FaultSimulation:
        """Gets a fault simulation by the simulationId.
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "FaultSimulationIdContent")
    ...
    def _start_fault_simulation_initial(
        ...
        resource_group_name: str,
        cluster_name: str,
        parameters: Union[_models.FaultSimulationContent, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "FaultSimulationContent")
    ...
    def begin_start_fault_simulation(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.servicefabricmanagedclusters.models.FaultSimulationContent
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    def begin_start_fault_simulation(
        ...
        **kwargs: Any
        ...
        :param parameters: parameters describing the fault simulation. Is either a
         FaultSimulationContent type or a IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.servicefabricmanagedclusters.models.FaultSimulationContent or
         IO[bytes]
        :return: An instance of LROPoller that returns either FaultSimulation or the result of
         cls(response)
        :rtype:
