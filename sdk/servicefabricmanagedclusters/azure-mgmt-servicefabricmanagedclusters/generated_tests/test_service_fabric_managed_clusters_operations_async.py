...
class TestServiceFabricManagedClustersOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_managed_clusters_post(self, resource_group):
        response = await self.client.managed_clusters.post(
            resource_group_name=resource_group.name,
            cluster_name="str",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_managed_clusters_managed_maintenance_window_status_get(self, resource_group):
        response = await self.client.managed_clusters.managed_maintenance_window_status_get(
            resource_group_name=resource_group.name,
            cluster_name="str",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_managed_clusters_managed_az_resiliency_status_get(self, resource_group):
        response = await self.client.managed_clusters.managed_az_resiliency_status_get(
            resource_group_name=resource_group.name,
            cluster_name="str",
        )
