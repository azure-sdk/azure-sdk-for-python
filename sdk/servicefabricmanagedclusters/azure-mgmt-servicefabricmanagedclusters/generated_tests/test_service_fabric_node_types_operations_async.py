...
class TestServiceFabricNodeTypesOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_node_types_list(self, resource_group):
        response = self.client.node_types.list(
            resource_group_name=resource_group.name,
            cluster_name="str",
            node_type_name="str",
        )
