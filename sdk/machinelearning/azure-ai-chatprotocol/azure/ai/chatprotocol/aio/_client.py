...
class ChatProtocolClient:  # pylint: disable=client-accepts-api-version-keyword
    """Azure APIs for the Azure Chat protocol.

    :ivar chat: ChatOperations operations
    :vartype chat: azure.ai.chatprotocol.aio.operations.ChatOperations
    :param endpoint: Azure Chat Protocol APIs. Required.
    :type endpoint: str
