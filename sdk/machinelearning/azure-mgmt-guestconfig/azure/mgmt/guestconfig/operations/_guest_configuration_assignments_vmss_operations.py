...
def build_list_request(resource_group_name: str, vmss_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.GuestConfiguration/virtualMachineScaleSets/{vmssName}/guestConfigurationAssignments",
    )
...
def build_get_request(
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.GuestConfiguration/virtualMachineScaleSets/{vmssName}/guestConfigurationAssignments/{name}",
    )
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
        "resourceGroupName": _SERIALIZER.url(
...
class GuestConfigurationAssignmentsVMSSOperations:  # pylint: disable=name-too-long
    ...
    @distributed_trace
    def list(self, resource_group_name: str, vmss_name: str, **kwargs: Any) -> _models.GuestConfigurationAssignmentList:
        """List all guest configuration assignments for VMSS.

        :param resource_group_name: The name of the resource group. The name is case insensitive.
         Required.
        :type resource_group_name: str
        :param vmss_name: virtualMachineScaleSets. Required.
        :type vmss_name: str
    ...
    def get(
        ...
        :param vmss_name: virtualMachineScaleSets. Required.
        :type vmss_name: str
        :param name: The name of the GuestConfigurationAssignment. Required.
        :type name: str
