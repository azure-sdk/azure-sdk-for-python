...
def build_get_request(
    ...
    **kwargs: Any
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.GuestConfiguration/virtualmachines/{vmName}/guestConfigurationAssignments/{guestConfigurationAssignmentName}/{reportId}/{reportId}",
    )
...
def build_list_request(
    ...
    **kwargs: Any
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.GuestConfiguration/virtualmachines/{vmName}/guestConfigurationAssignments/{guestConfigurationAssignmentName}/reports",
    )
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
        "resourceGroupName": _SERIALIZER.url(
...
class GuestConfigurationConnectedVMwarevSphereAssignmentsReportsOperations:  # pylint: disable=name-too-long
    ...
    def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("GuestConfigurationAssignmentReport", pipeline_response.http_response)
    ...
    def list(
        ...
        deserialized = self._deserialize("GuestConfigurationAssignmentReportList", pipeline_response.http_response)
