...
def build_rg_list_request(resource_group_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
...
def build_list_request(resource_group_name: str, vm_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.GuestConfiguration/virtualMachines/{vmName}/guestConfigurationAssignments",
    )
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
        "resourceGroupName": _SERIALIZER.url(
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.GuestConfiguration/virtualMachines/{vmName}/guestConfigurationAssignments/{guestConfigurationAssignmentName}",
    )
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
        "resourceGroupName": _SERIALIZER.url(
...
class GuestConfigurationAssignmentsOperations:
    ...
    @distributed_trace
    def rg_list(self, resource_group_name: str, **kwargs: Any) -> _models.GuestConfigurationAssignmentList:
        ...
        _request = build_rg_list_request(
        ...
        deserialized = self._deserialize("GuestConfigurationAssignmentList", pipeline_response.http_response)
    ...
    @distributed_trace
    def list(self, resource_group_name: str, vm_name: str, **kwargs: Any) -> _models.GuestConfigurationAssignmentList:
        """List all guest configuration assignments for a virtual machine.

        :param resource_group_name: The name of the resource group. The name is case insensitive.
         Required.
        :type resource_group_name: str
        :param vm_name: virtualMachines. Required.
        :type vm_name: str
        :return: GuestConfigurationAssignmentList or the result of cls(response)
        :rtype: ~azure.mgmt.guestconfig.models.GuestConfigurationAssignmentList
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def get(
        ...
        :param vm_name: virtualMachines. Required.
        :type vm_name: str
        :param guest_configuration_assignment_name: The name of the GuestConfigurationAssignment.
         Required.
        ...
        deserialized = self._deserialize("GuestConfigurationAssignment", pipeline_response.http_response)
