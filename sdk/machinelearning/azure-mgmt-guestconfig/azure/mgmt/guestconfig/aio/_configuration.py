...
class GuestConfigurationClientConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long
    ...
    def __init__(self, credential: "AsyncTokenCredential", subscription_id: str, **kwargs: Any) -> None:
        api_version: str = kwargs.pop("api_version", "2022-01-25")
