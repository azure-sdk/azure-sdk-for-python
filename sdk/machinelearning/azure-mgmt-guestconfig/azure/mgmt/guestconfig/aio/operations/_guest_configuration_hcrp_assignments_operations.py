...
from ...operations._guest_configuration_hcrp_assignments_operations import (
...
class GuestConfigurationHCRPAssignmentsOperations:  # pylint: disable=name-too-long
    ...
    @distributed_trace_async
    async def get(
        self, resource_group_name: str, machine_name: str, guest_configuration_assignment_name: str, **kwargs: Any
