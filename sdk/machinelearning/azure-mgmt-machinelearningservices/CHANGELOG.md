...
### Features Added
  ...
  - Added model `ManagedNetworkSettingsDto`
  - Added model `ManagedNetworkSettingsDtoBasicResource`
  ...
  - Method `ManagedNetworkSettingsOperations.begin_patch` has a new overload `def begin_patch(self: None, resource_group_name: str, workspace_name: str, managed_network_name: str, body: ManagedNetworkSettingsDtoBasicResource, content_type: str)`
  - Method `ManagedNetworkSettingsOperations.begin_patch` has a new overload `def begin_patch(self: None, resource_group_name: str, workspace_name: str, managed_network_name: str, body: IO[bytes], content_type: str)`
  - Method `ManagedNetworkSettingsOperations.begin_put` has a new overload `def begin_put(self: None, resource_group_name: str, workspace_name: str, managed_network_name: str, body: ManagedNetworkSettingsDtoBasicResource, content_type: str)`
  - Method `ManagedNetworkSettingsOperations.begin_put` has a new overload `def begin_put(self: None, resource_group_name: str, workspace_name: str, managed_network_name: str, body: IO[bytes], content_type: str)`
  ...
  - Method `OutboundRuleOperations.begin_create_or_update` has a new overload `def begin_create_or_update(self: None, resource_group_name: str, workspace_name: str, managed_network_name: str, rule_name: str, body: OutboundRuleBasicResource, content_type: str)`
  - Method `OutboundRuleOperations.begin_create_or_update` has a new overload `def begin_create_or_update(self: None, resource_group_name: str, workspace_name: str, managed_network_name: str, rule_name: str, body: IO[bytes], content_type: str)`
  - Method `OutboundRulesOperations.begin_post` has a new overload `def begin_post(self: None, resource_group_name: str, workspace_name: str, managed_network_name: str, body: ManagedNetworkSettingsDtoBasicResource, content_type: str)`
  - Method `OutboundRulesOperations.begin_post` has a new overload `def begin_post(self: None, resource_group_name: str, workspace_name: str, managed_network_name: str, body: IO[bytes], content_type: str)`
