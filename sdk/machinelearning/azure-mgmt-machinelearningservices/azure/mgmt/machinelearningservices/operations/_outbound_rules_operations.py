...
class OutboundRulesOperations:
    ...
    def begin_post(
        ...
        **kwargs: Any
    ) -> LROPoller[Iterable["_models.OutboundRuleBasicResource"]]:
        # pylint: disable=line-too-long
    ...
    def begin_post(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[Iterable["_models.OutboundRuleBasicResource"]].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[Iterable["_models.OutboundRuleBasicResource"]](
