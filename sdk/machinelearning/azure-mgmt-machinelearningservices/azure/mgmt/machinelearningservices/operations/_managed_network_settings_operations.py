...
class ManagedNetworkSettingsOperations:
    ...
    def begin_patch(
        ...
        **kwargs: Any
    ) -> LROPoller[_models.ManagedNetworkSettingsDtoBasicResource]:
        # pylint: disable=line-too-long
        ...
        :return: An instance of LROPoller that returns either ManagedNetworkSettingsDtoBasicResource or
         the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.machinelearningservices.models.ManagedNetworkSettingsDtoBasicResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_patch(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.ManagedNetworkSettingsDtoBasicResource].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ManagedNetworkSettingsDtoBasicResource](
