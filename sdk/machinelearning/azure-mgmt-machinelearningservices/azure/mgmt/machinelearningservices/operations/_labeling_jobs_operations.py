...
class LabelingJobsOperations:
    ...
    def _create_or_update_initial(
        ...
        workspace_name: str,
        id: str,
        body: Union[_models.LabelingJob, IO[bytes]],
        **kwargs: Any
    ) -> _models.LabelingJob:
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param id: The name and identifier for the LabelingJob. Required.
        :type id: str
        :param body: LabelingJob definition object. Is either a LabelingJob type or a IO[bytes] type.
         Required.
        :type body: ~azure.mgmt.machinelearningservices.models.LabelingJob or IO[bytes]
        :return: An instance of LROPoller that returns either LabelingJob or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.machinelearningservices.models.LabelingJob]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return LROPoller[_models.LabelingJob].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.LabelingJob](
    ...
    def _export_labels_initial(
        ...
        workspace_name: str,
        id: str,
        body: Union[_models.ExportSummary, IO[bytes]],
        **kwargs: Any
        ...
        _request = build_export_labels_request(
            resource_group_name=resource_group_name,
            workspace_name=workspace_name,
            id=id,
            subscription_id=self._config.subscription_id,
    ...
    def begin_export_labels(
        ...
        **kwargs: Any
        ...
        :param id: The name and identifier for the LabelingJob. Required.
        :type id: str
        :param body: The export summary. Is either a ExportSummary type or a IO[bytes] type. Required.
        :type body: ~azure.mgmt.machinelearningservices.models.ExportSummary or IO[bytes]
        :return: An instance of LROPoller that returns either ExportSummary or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.machinelearningservices.models.ExportSummary]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.ExportSummary].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ExportSummary](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
    ...
    def begin_resume(
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.LabelingJobProperties].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.LabelingJobProperties](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
