...
class SchedulesOperations:
    ...
    def trigger(
        ...
        **kwargs: Any
        ...
        :param name: Schedule name. Required.
        :type name: str
        :param body: Request body for trigger once. Required.
    ...
    def trigger(
        ...
        workspace_name: str,
        name: str,
        body: Union[_models.TriggerOnceRequest, IO],
        **kwargs: Any
    ) -> _models.TriggerRunSubmissionDto:
        """Trigger run.
        ...
        :param name: Schedule name. Required.
        :type name: str
        :param body: Request body for trigger once. Is either a TriggerOnceRequest type or a IO type.
         Required.
        :type body: ~azure.mgmt.machinelearningservices.models.TriggerOnceRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.TriggerRunSubmissionDto] = kwargs.pop("cls", None)
    ...
    trigger.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/schedules/{name}/trigger"
    }
