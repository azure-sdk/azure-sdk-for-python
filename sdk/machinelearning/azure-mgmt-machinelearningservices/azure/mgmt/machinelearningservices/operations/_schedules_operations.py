...
class SchedulesOperations:
    ...
    def trigger(
        ...
        workspace_name: str,
        name: str,
        body: Union[_models.TriggerOnceRequest, IO[bytes]],
        **kwargs: Any
    ) -> _models.TriggerRunSubmissionDto:
        """Trigger run.
        ...
        :param name: Schedule name. Required.
        :type name: str
        :param body: Request body for trigger once. Is either a TriggerOnceRequest type or a IO[bytes]
         type. Required.
        :type body: ~azure.mgmt.machinelearningservices.models.TriggerOnceRequest or IO[bytes]
        :return: TriggerRunSubmissionDto or the result of cls(response)
        :rtype: ~azure.mgmt.machinelearningservices.models.TriggerRunSubmissionDto
        :raises ~azure.core.exceptions.HttpResponseError:
        """
