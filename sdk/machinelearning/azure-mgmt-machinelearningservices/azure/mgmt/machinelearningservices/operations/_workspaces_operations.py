...
def build_list_by_subscription_request(
    subscription_id: str, *, kind: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
...
def build_list_by_resource_group_request(
    resource_group_name: str, subscription_id: str, *, kind: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class WorkspacesOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, kind: Optional[str] = None, **kwargs: Any) -> Iterable["_models.Workspace"]:
