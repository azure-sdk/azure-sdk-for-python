...
from .._vendor import MachineLearningServicesMgmtClientMixinABC, _convert_request, _format_url_section
...
class WorkspaceConnectionsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :param target: Default value is None.
        :type target: str
        :param category: Default value is None.
        :type category: str
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :param connection_name: Required.
        :type connection_name: str
        :param body: Is either a WorkspaceConnectionUpdateParameter type or a IO type. Default value is
         None.
    ...
    def create(
        ...
        **kwargs: Any
        ...
        :param connection_name: Required.
        :type connection_name: str
        :param body: Is either a WorkspaceConnectionPropertiesV2BasicResource type or a IO type.
         Default value is None.
        :type body:
