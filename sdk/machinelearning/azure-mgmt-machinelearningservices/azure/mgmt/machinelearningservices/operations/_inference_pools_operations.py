...
class InferencePoolsOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, workspace_name: str, name: str, **kwargs: Any) -> _models.InferencePool:
        """Get InferencePool.
    ...
    @distributed_trace
    def get_status(self, resource_group_name: str, workspace_name: str, name: str, **kwargs: Any) -> _models.PoolStatus:
