...
class InferenceEndpointsOperations:
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/inferencePools/{poolName}/endpoints"
    }
    ...
    _delete_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/inferencePools/{poolName}/endpoints/{endpointName}"
    }
    ...
    def _update_initial(
        ...
        **kwargs: Any
        ...
        cls: ClsType[Optional[_models.InferenceEndpoint]] = kwargs.pop("cls", None)
    ...
    def _create_or_update_initial(
        ...
        pool_name: str,
        endpoint_name: str,
        body: Union[_models.InferenceEndpoint, IO],
        **kwargs: Any
    ) -> _models.InferenceEndpoint:
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.machinelearningservices.models.InferenceEndpoint or IO
