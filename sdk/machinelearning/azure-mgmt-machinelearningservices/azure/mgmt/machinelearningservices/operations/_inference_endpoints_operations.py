...
class InferenceEndpointsOperations:
    ...
    def list(
        ...
        order_by: Optional[Union[str, _models.OrderString]] = None,
        **kwargs: Any
    ) -> Iterable["_models.InferenceEndpointMinimalTrackedResource"]:
        ...
        :return: An iterator like instance of either InferenceEndpointMinimalTrackedResource or the
         result of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.machinelearningservices.models.InferenceEndpointMinimalTrackedResource]
        ...
        cls: ClsType[_models.InferenceEndpointMinimalTrackedResourceArmPaginatedResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize(
                "InferenceEndpointMinimalTrackedResourceArmPaginatedResult", pipeline_response
            )
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/inferencePools/{poolName}/groups/{groupName}/endpoints"
    }

    def _delete_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, workspace_name: str, pool_name: str, group_name: str, name: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    _delete_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/inferencePools/{poolName}/groups/{groupName}/endpoints/{name}"
    }
    ...
    def begin_delete(
        ...
        :param group_name: InferenceGroup name. Required.
        :type group_name: str
        :param name: InferenceEndpoint name. Required.
        :type name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get(
        self, resource_group_name: str, workspace_name: str, pool_name: str, group_name: str, name: str, **kwargs: Any
    ) -> _models.InferenceEndpointMinimalTrackedResource:
        ...
        :type name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: InferenceEndpointMinimalTrackedResource or the result of cls(response)
        :rtype: ~azure.mgmt.machinelearningservices.models.InferenceEndpointMinimalTrackedResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.InferenceEndpointMinimalTrackedResource] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("InferenceEndpointMinimalTrackedResource", pipeline_response)
    ...
    def _update_initial(
        ...
        body: Any,
        **kwargs: Any
    ) -> Optional[_models.InferenceEndpointMinimalTrackedResource]:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        cls: ClsType[Optional[_models.InferenceEndpointMinimalTrackedResource]] = kwargs.pop("cls", None)
    ...
    def begin_update(
        ...
        body: Any,
        **kwargs: Any
    ) -> LROPoller[_models.InferenceEndpointMinimalTrackedResource]:
        ...
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no
         Retry-After header is present.
        :return: An instance of LROPoller that returns either InferenceEndpointMinimalTrackedResource
         or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.machinelearningservices.models.InferenceEndpointMinimalTrackedResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def _create_or_update_initial(
        ...
        group_name: str,
        name: str,
        body: Union[_models.InferenceEndpointMinimalTrackedResource, IO],
        **kwargs: Any
    ) -> _models.InferenceEndpointMinimalTrackedResource:
        error_map = {
            401: ClientAuthenticationError,
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "InferenceEndpointMinimalTrackedResource")
    ...
    def begin_create_or_update(
        ...
        group_name: str,
        name: str,
        body: _models.InferenceEndpointMinimalTrackedResource,
        *,
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.machinelearningservices.models.InferenceEndpointMinimalTrackedResource
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param name: InferenceEndpoint name. Required.
        :type name: str
        :param body: InferenceEndpoint entity to apply during operation. Is either a
         InferenceEndpointMinimalTrackedResource type or a IO type. Required.
        :type body: ~azure.mgmt.machinelearningservices.models.InferenceEndpointMinimalTrackedResource
         or IO
