...
def build_delete_request(
    resource_group_name: str, workspace_name: str, pool_name: str, name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class InferenceGroupsOperations:
    ...
    def list(
        ...
        order_by: Optional[Union[str, _models.OrderString]] = None,
        **kwargs: Any
    ) -> Iterable["_models.InferenceGroupMinimalTrackedResourceWithSku"]:
        ...
        :return: An iterator like instance of either InferenceGroupMinimalTrackedResourceWithSku or the
         result of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.machinelearningservices.models.InferenceGroupMinimalTrackedResourceWithSku]
        ...
        cls: ClsType[_models.InferenceGroupMinimalTrackedResourceWithSkuArmPaginatedResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize(
                "InferenceGroupMinimalTrackedResourceWithSkuArmPaginatedResult", pipeline_response
            )
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/inferencePools/{poolName}/groups"
    }

    def _delete_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, workspace_name: str, pool_name: str, name: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    _delete_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/inferencePools/{poolName}/groups/{name}"
    }
    ...
    def begin_delete(
        ...
        :type pool_name: str
        :param name: InferenceGroup name. Required.
        :type name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get(
        self, resource_group_name: str, workspace_name: str, pool_name: str, name: str, **kwargs: Any
    ) -> _models.InferenceGroupMinimalTrackedResourceWithSku:
        """Get InferenceGroup.
        ...
        :type name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: InferenceGroupMinimalTrackedResourceWithSku or the result of cls(response)
        :rtype: ~azure.mgmt.machinelearningservices.models.InferenceGroupMinimalTrackedResourceWithSku
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.InferenceGroupMinimalTrackedResourceWithSku] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("InferenceGroupMinimalTrackedResourceWithSku", pipeline_response)
    ...
    def _update_initial(
        ...
        **kwargs: Any
    ) -> Optional[_models.InferenceGroupMinimalTrackedResourceWithSku]:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.InferenceGroupMinimalTrackedResourceWithSku]] = kwargs.pop("cls", None)
    ...
    def begin_update(
        ...
        **kwargs: Any
    ) -> LROPoller[_models.InferenceGroupMinimalTrackedResourceWithSku]:
        ...
        :return: An instance of LROPoller that returns either
         InferenceGroupMinimalTrackedResourceWithSku or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.machinelearningservices.models.InferenceGroupMinimalTrackedResourceWithSku]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _create_or_update_initial(
        ...
        pool_name: str,
        name: str,
        body: Union[_models.InferenceGroupMinimalTrackedResourceWithSku, IO],
        **kwargs: Any
    ) -> _models.InferenceGroupMinimalTrackedResourceWithSku:
        error_map = {
            401: ClientAuthenticationError,
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "InferenceGroupMinimalTrackedResourceWithSku")
    ...
    def begin_create_or_update(
        ...
        pool_name: str,
        name: str,
        body: _models.InferenceGroupMinimalTrackedResourceWithSku,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.InferenceGroupMinimalTrackedResourceWithSku]:
        ...
        :type body:
         ~azure.mgmt.machinelearningservices.models.InferenceGroupMinimalTrackedResourceWithSku
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param name: InferenceGroup name. Required.
        :type name: str
        :param body: InferenceGroup entity to apply during operation. Is either a
         InferenceGroupMinimalTrackedResourceWithSku type or a IO type. Required.
        :type body:
         ~azure.mgmt.machinelearningservices.models.InferenceGroupMinimalTrackedResourceWithSku or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_skus(
        ...
        **kwargs: Any
        ...
        :type pool_name: str
        :param name: Inference Group name. Required.
        :type name: str
    ...
    list_skus.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/inferencePools/{poolName}/groups/{name}/skus"
    }
    ...
    get_status.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/inferencePools/{poolName}/groups/{name}/status"
    }
