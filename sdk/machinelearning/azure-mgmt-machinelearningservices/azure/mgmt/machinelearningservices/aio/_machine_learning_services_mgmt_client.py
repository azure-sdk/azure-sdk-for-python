...
class MachineLearningServicesMgmtClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :ivar standby_pool: StandbyPoolOperations operations
    :vartype standby_pool: azure.mgmt.machinelearningservices.aio.operations.StandbyPoolOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.standby_pool = StandbyPoolOperations(self._client, self._config, self._serialize, self._deserialize)
