...
class MachineLearningServicesMgmtClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :ivar indexes_versions: IndexesVersionsOperations operations
    :vartype indexes_versions:
     azure.mgmt.machinelearningservices.aio.operations.IndexesVersionsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.indexes_versions = IndexesVersionsOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
