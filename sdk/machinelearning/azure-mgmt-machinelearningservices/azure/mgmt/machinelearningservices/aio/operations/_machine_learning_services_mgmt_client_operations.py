...
from ...operations._machine_learning_services_mgmt_client_operations import (
    build_outbound_network_dependencies_endpoints_request,
)
...
class MachineLearningServicesMgmtClientOperationsMixin(MachineLearningServicesMgmtClientMixinABC):
    ...
    outbound_network_dependencies_endpoints.metadata = {
