...
class OutboundRulesOperations:
    ...
    async def begin_post(
        ...
        **kwargs: Any
    ) -> AsyncLROPoller[AsyncIterable["_models.OutboundRuleBasicResource"]]:
    ...
    async def begin_post(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[AsyncIterable["_models.OutboundRuleBasicResource"]].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[AsyncIterable["_models.OutboundRuleBasicResource"]](
