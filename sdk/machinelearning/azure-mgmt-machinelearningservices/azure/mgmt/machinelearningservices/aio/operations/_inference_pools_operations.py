...
class InferencePoolsOperations:
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/inferencePools"
    }
    ...
    _delete_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/inferencePools/{name}"
    }
    ...
    async def begin_delete(
        ...
        :param workspace_name: Name of Azure Machine Learning workspace. Required.
        :type workspace_name: str
        :param name: InferencePool name. Required.
        :type name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def _update_initial(
        ...
        **kwargs: Any
        ...
        cls: ClsType[Optional[_models.InferencePool]] = kwargs.pop("cls", None)
    ...
    async def _create_or_update_initial(
        ...
        workspace_name: str,
        name: str,
        body: Union[_models.InferencePool, IO],
        **kwargs: Any
    ) -> _models.InferencePool:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param body: InferencePool entity to apply during operation. Is either a InferencePool type or
         a IO type. Required.
        :type body: ~azure.mgmt.machinelearningservices.models.InferencePool or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    list_skus.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/inferencePools/{name}/skus"
    }
    ...
    async def get_status(
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.PoolStatus] = kwargs.pop("cls", None)
    ...
    get_status.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/inferencePools/{name}/status"
    }
