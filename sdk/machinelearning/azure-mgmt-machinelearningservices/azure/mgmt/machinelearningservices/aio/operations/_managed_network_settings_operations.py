...
from ...operations._managed_network_settings_operations import (
    build_get_request,
    build_list_request,
    build_patch_request,
    build_put_request,
...
class ManagedNetworkSettingsOperations:
    ...
    async def begin_patch(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.ManagedNetworkSettingsPropertiesBasicResource].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ManagedNetworkSettingsPropertiesBasicResource](
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.ManagedNetworkSettingsPropertiesBasicResource"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.machinelearningservices.models.ManagedNetworkSettingsPropertiesBasicResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
