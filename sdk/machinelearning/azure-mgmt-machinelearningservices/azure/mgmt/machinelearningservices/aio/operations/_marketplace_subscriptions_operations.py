...
class MarketplaceSubscriptionsOperations:
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/marketplaceSubscriptions"
    }
    ...
    _delete_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/marketplaceSubscriptions/{name}"
    }
    ...
    async def _create_or_update_initial(
        ...
        workspace_name: str,
        name: str,
        body: Union[_models.MarketplaceSubscription, IO],
        **kwargs: Any
    ) -> _models.MarketplaceSubscription:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param body: Marketplace Subscription entity to apply during operation. Is either a
         MarketplaceSubscription type or a IO type. Required.
        :type body: ~azure.mgmt.machinelearningservices.models.MarketplaceSubscription or IO
