...
class WorkspacesOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, kind: Optional[str] = None, **kwargs: Any) -> AsyncIterable["_models.Workspace"]:
    ...
    def list_by_resource_group(
        self, resource_group_name: str, kind: Optional[str] = None, **kwargs: Any
    ...
    async def begin_delete(
        ...
        :param force_to_purge: Default value is False.
    ...
    async def _update_initial(
        ...
        workspace_name: str,
        body: Optional[Union[_models.WorkspaceUpdateParameters, IO]] = None,
        **kwargs: Any
    ...
    async def begin_update(
        ...
        resource_group_name: str,
        workspace_name: str,
        body: Optional[_models.WorkspaceUpdateParameters] = None,
        *,
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param workspace_name: Azure Machine Learning Workspace Name. Required.
        :type workspace_name: str
        :param body: Is either a WorkspaceUpdateParameters type or a IO type. Default value is None.
    ...
    async def begin_create_or_update(
        ...
        :param workspace_name: Azure Machine Learning Workspace Name. Required.
        :type workspace_name: str
        :param body: Is either a Workspace type or a IO type. Required.
