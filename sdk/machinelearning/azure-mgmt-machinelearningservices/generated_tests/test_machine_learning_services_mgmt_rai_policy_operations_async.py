...
class TestMachineLearningServicesMgmtRaiPolicyOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_rai_policy_begin_delete(self, resource_group):
        response = await (
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_rai_policy_get(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_rai_policy_begin_create(self, resource_group):
        response = await (
