...
class TestMachineLearningServicesMgmtCapabilityHostsOperations(AzureMgmtRecordedTestCase):
    ...
    @recorded_by_proxy
    def test_capability_hosts_begin_delete(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_capability_hosts_get(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_capability_hosts_begin_create_or_update(self, resource_group):
