...
class TestMachineLearningServicesMgmtConnectionRaiBlocklistOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_connection_rai_blocklist_begin_delete(self, resource_group):
        response = await (
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_connection_rai_blocklist_get(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_connection_rai_blocklist_begin_create(self, resource_group):
        response = await (
