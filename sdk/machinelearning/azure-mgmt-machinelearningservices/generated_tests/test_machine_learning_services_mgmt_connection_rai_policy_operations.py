...
class TestMachineLearningServicesMgmtConnectionRaiPolicyOperations(AzureMgmtRecordedTestCase):
    ...
    @recorded_by_proxy
    def test_connection_rai_policy_begin_delete(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_connection_rai_policy_get(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_connection_rai_policy_begin_create(self, resource_group):
