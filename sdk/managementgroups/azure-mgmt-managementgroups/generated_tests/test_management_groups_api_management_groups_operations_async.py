...
class TestManagementGroupsAPIManagementGroupsOperationsAsync(AzureMgmtRecordedTestCase):
        ...
        response = await (
            await self.client.management_groups.begin_create_or_update(
                ...
                resource={
                    ...
                    "properties": {
                        "children": [
                            {"children": [...], "displayName": "str", "id": "str", "name": "str", "type": "str"}
                        ],
                        "details": {
                            "managementGroupAncestors": ["str"],
                            "managementGroupAncestorsChain": [{"displayName": "str", "name": "str"}],
                            "parent": {"displayName": "str", "id": "str", "name": "str"},
                            "path": [{"displayName": "str", "name": "str"}],
                            "updatedBy": "str",
    ...
    async def test_update(self, resource_group):
        response = await self.client.management_groups.update(
            group_id="str",
            properties={"displayName": "str", "parentGroupId": "str"},
            api_version="2023-04-01",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_list_settings(self, resource_group):
        response = self.client.management_groups.list_settings(
            group_id="str",
            api_version="2023-04-01",
        )
        result = [r async for r in response]
