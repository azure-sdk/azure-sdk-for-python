...
class ManagementGroupsAPIOperationsMixin(ManagementGroupsAPIMixinABC):
    ...
    async def check_name_availability(
        self,
        body: _models.PathsItdwrvProvidersMicrosoftManagementChecknameavailabilityPostRequestbodyContentApplicationJsonSchema,
        *,
        ...
        **kwargs: Any
        ...
        :param body: Required.
        :type body:
         ~azure.mgmt.managementgroups.models.PathsItdwrvProvidersMicrosoftManagementChecknameavailabilityPostRequestbodyContentApplicationJsonSchema
    ...
    async def check_name_availability(
        self,
        body: Union[
            _models.PathsItdwrvProvidersMicrosoftManagementChecknameavailabilityPostRequestbodyContentApplicationJsonSchema,
            IO[bytes],
        ],
        **kwargs: Any
    ) -> _models.CheckNameAvailabilityResult:
