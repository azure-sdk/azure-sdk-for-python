...
class ManagementGroupsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either ManagementGroup or An instance of
         AsyncLROPoller that returns either ManagementGroupOperationAcceptance or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managementgroups.models.ManagementGroup]
         or
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managementgroups.models.ManagementGroupOperationAcceptance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_delete(
        self, group_id: str, cache_control: str = "no-cache", **kwargs: Any
    ) -> AsyncLROPoller[_models.ManagementGroupOperationAcceptance]:
        ...
        :param cache_control: Indicates whether the request should utilize any caches. Populate the
         header with 'no-cache' value to bypass existing caches. Default value is "no-cache".
        :type cache_control: str
        :return: An instance of AsyncLROPoller that returns either ManagementGroupOperationAcceptance
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.ManagementGroupOperationAcceptance].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ManagementGroupOperationAcceptance](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
    ...
    @distributed_trace
    def list_settings(self, group_id: str, **kwargs: Any) -> AsyncIterable["_models.HierarchySettings"]:
