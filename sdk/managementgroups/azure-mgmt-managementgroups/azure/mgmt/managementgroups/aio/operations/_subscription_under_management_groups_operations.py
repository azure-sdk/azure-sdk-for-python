...
from ...operations._subscription_under_management_groups_operations import (
...
class SubscriptionUnderManagementGroupsOperations:  # pylint: disable=name-too-long
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`subscription_under_management_groups` attribute.
    """
    ...
    def get_subscriptions_under_management_group(
        ...
        cls: ClsType[_models.SubscriptionUnderManagementGroupListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("SubscriptionUnderManagementGroupListResult", pipeline_response)
    ...
    async def create(
        ...
        resource: Optional[_models.SubscriptionUnderManagementGroup] = None,
        *,
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.managementgroups.models.SubscriptionUnderManagementGroup
    ...
    async def create(
        ...
        subscription_id: str,
        cache_control: str = "no-cache",
        resource: Optional[Union[_models.SubscriptionUnderManagementGroup, IO[bytes]]] = None,
        **kwargs: Any
    ) -> _models.SubscriptionUnderManagementGroup:
        """Associates existing subscription with the management group.
        ...
        :param cache_control: Indicates whether the request should utilize any caches. Populate the
         header with 'no-cache' value to bypass existing caches. Default value is "no-cache".
        :type cache_control: str
        :param resource: Resource create parameters. Is either a SubscriptionUnderManagementGroup type
         or a IO[bytes] type. Default value is None.
        :type resource: ~azure.mgmt.managementgroups.models.SubscriptionUnderManagementGroup or
         IO[bytes]
        :return: SubscriptionUnderManagementGroup or the result of cls(response)
        :rtype: ~azure.mgmt.managementgroups.models.SubscriptionUnderManagementGroup
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            if resource is not None:
                _json = self._serialize.body(resource, "SubscriptionUnderManagementGroup")
            else:
                _json = None
