...
class ManagementGroupsAPI(ManagementGroupsAPIOperationsMixin):  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype entities_operations:
     azure.mgmt.managementgroups.operations.EntitiesOperationsOperations
    ...
    :vartype hierarchy_settings_operation_group:
     azure.mgmt.managementgroups.operations.HierarchySettingsOperationGroupOperations
    ...
    :vartype subscription_under_management_groups:
     azure.mgmt.managementgroups.operations.SubscriptionUnderManagementGroupsOperations
