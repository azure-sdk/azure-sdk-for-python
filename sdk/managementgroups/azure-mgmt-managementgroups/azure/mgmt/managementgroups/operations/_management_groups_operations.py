...
def build_get_descendants_request(
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/providers/Microsoft.Management/managementGroups/{groupId}/descendants/{groupId}"
    )
    path_format_arguments = {
        "groupId": _SERIALIZER.url("group_id", group_id, "str"),
    }
...
def build_list_settings_request(group_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Management/managementGroups/{groupId}/settings/{groupId}")
    path_format_arguments = {
        "groupId": _SERIALIZER.url("group_id", group_id, "str"),
    }
...
class ManagementGroupsOperations:
    ...
    def _create_or_update_initial(
        self,
        group_id: str,
        resource: Union[_models.ManagementGroup, IO[bytes]],
        cache_control: str = "no-cache",
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "ManagementGroup")
    ...
    def begin_create_or_update(
        self,
        group_id: str,
        resource: _models.ManagementGroup,
        cache_control: str = "no-cache",
        *,
        ...
        **kwargs: Any
        ...
        :param group_id: Management Group ID. Required.
        :type group_id: str
        :param resource: Management group creation parameters. Required.
        :type resource: ~azure.mgmt.managementgroups.models.ManagementGroup
        :param cache_control: Indicates whether the request should utilize any caches. Populate the
         header with 'no-cache' value to bypass existing caches. Default value is "no-cache".
        :type cache_control: str
        ...
        :return: An instance of LROPoller that returns either ManagementGroup or An instance of
         LROPoller that returns either ManagementGroupOperationAcceptance or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.managementgroups.models.ManagementGroup] or
         ~azure.core.polling.LROPoller[~azure.mgmt.managementgroups.models.ManagementGroupOperationAcceptance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param group_id: Management Group ID. Required.
        :type group_id: str
        :param resource: Management group creation parameters. Is either a ManagementGroup type or a
         IO[bytes] type. Required.
        :type resource: ~azure.mgmt.managementgroups.models.ManagementGroup or IO[bytes]
        :param cache_control: Indicates whether the request should utilize any caches. Populate the
         header with 'no-cache' value to bypass existing caches. Default value is "no-cache".
        :type cache_control: str
        :return: An instance of LROPoller that returns either ManagementGroup or An instance of
    ...
    def update(
        self,
        group_id: str,
        properties: _models.PatchManagementGroupRequest,
        cache_control: str = "no-cache",
        *,
        content_type: str = "application/json",
        **kwargs: Any
        ...
        :param group_id: Management Group ID. Required.
        :type group_id: str
        :param properties: Management group patch parameters. Required.
        :type properties: ~azure.mgmt.managementgroups.models.PatchManagementGroupRequest
        :param cache_control: Indicates whether the request should utilize any caches. Populate the
         header with 'no-cache' value to bypass existing caches. Default value is "no-cache".
        :type cache_control: str
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
    ...
    def update(
        self,
        group_id: str,
        properties: Union[_models.PatchManagementGroupRequest, IO[bytes]],
        cache_control: str = "no-cache",
        **kwargs: Any
    ) -> _models.ManagementGroup:
        """Update a management group.
        ...
        :param group_id: Management Group ID. Required.
        :type group_id: str
        :param properties: Management group patch parameters. Is either a PatchManagementGroupRequest
         type or a IO[bytes] type. Required.
        :type properties: ~azure.mgmt.managementgroups.models.PatchManagementGroupRequest or IO[bytes]
        :param cache_control: Indicates whether the request should utilize any caches. Populate the
         header with 'no-cache' value to bypass existing caches. Default value is "no-cache".
        :type cache_control: str
        :return: ManagementGroup or the result of cls(response)
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "PatchManagementGroupRequest")
    ...
    def begin_delete(
    ...
    ) -> LROPoller[_models.ManagementGroupOperationAcceptance]:
        ...
        :param cache_control: Indicates whether the request should utilize any caches. Populate the
         header with 'no-cache' value to bypass existing caches. Default value is "no-cache".
        :type cache_control: str
        :return: An instance of LROPoller that returns either ManagementGroupOperationAcceptance or the
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.ManagementGroupOperationAcceptance] = kwargs.pop("cls", None)
        polling: Union[bool, PollingMethod] = kwargs.pop("polling", True)
        lro_delay = kwargs.pop("polling_interval", self._config.polling_interval)
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
        ...
        def get_long_running_output(pipeline_response):
            ...
            deserialized = self._deserialize("ManagementGroupOperationAcceptance", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, response_headers)  # type: ignore
            return deserialized
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.ManagementGroupOperationAcceptance].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ManagementGroupOperationAcceptance](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
    ...
    @distributed_trace
    def list_settings(self, group_id: str, **kwargs: Any) -> Iterable["_models.HierarchySettings"]:
        ...
        :param group_id: Management Group ID. Required.
        :type group_id: str
        :return: An iterator like instance of either HierarchySettings or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.managementgroups.models.HierarchySettings]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.HierarchySettingsListResult] = kwargs.pop("cls", None)
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_settings_request(
                    group_id=group_id,
                    api_version=api_version,
                    headers=_headers,
                    params=_params,
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("HierarchySettingsListResult", pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.next_link or None, iter(list_of_elem)
