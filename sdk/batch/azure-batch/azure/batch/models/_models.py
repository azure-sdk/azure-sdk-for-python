...
class BatchJobScheduleStatistics(_model_base.Model):
    ...
    """The total wall clock time of all the Tasks in all the Jobs created under the schedule. The wall
     ...
     Required."""
    read_i_ops: int = rest_field(name="readIOps", format="str")
    """The total number of disk read operations made by all Tasks in all Jobs created under the
     schedule. Required."""
    write_i_ops: int = rest_field(name="writeIOps", format="str")
    ...
    """The total gibibytes written to disk by all Tasks in all Jobs created under the schedule.
     Required."""
    num_succeeded_tasks: int = rest_field(name="numSucceededTasks", format="str")
    ...
    num_failed_tasks: int = rest_field(name="numFailedTasks", format="str")
    """The total number of Tasks that failed during the given time range in Jobs created under the
     ...
     Required."""
    num_task_retries: int = rest_field(name="numTaskRetries", format="str")
...
class BatchPoolResourceStatistics(_model_base.Model):
    ...
    disk_read_i_ops: int = rest_field(name="diskReadIOps", format="str")
    """The total number of disk read operations across all Compute Nodes in the Pool. Required."""
    disk_write_i_ops: int = rest_field(name="diskWriteIOps", format="str")
...
class FileProperties(_model_base.Model):
    ...
    content_length: int = rest_field(name="contentLength", format="str")
