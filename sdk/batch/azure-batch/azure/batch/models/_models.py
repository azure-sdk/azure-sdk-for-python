...
class BatchCertificateListResult(_model_base.Model):
    """The result of listing the Certificates in the Account.

    :ivar value: The list of Certificates.
    :vartype value: list[~azure.batch.models.BatchCertificate]
    :ivar odata_next_link: The URL to get the next set of results.
    :vartype odata_next_link: str
    """

    value: Optional[List["_models.BatchCertificate"]] = rest_field()
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.BatchCertificate"]] = None,
        odata_next_link: Optional[str] = None,
    ):
        ...
