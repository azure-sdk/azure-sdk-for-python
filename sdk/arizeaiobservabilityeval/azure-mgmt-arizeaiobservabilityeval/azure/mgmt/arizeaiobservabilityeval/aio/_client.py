...
class ArizeAIObservabilityEvalMgmtClient:
    ...
    :vartype operations: azure.mgmt.arizeaiobservabilityeval.aio.operations.Operations
    :ivar organizations: OrganizationsOperations operations
    :vartype organizations:
     azure.mgmt.arizeaiobservabilityeval.aio.operations.OrganizationsOperations
