...
class TestWidgetManagerWidgetsOperationsAsync(WidgetManagerClientTestBaseAsync):
    ...
    async def test_get_widget(self, widgetmanager_endpoint):
    ...
    @WidgetManagerPreparer()
    @recorded_by_proxy_async
    async def test_get_widget_operation_status(self, widgetmanager_endpoint):
        client = self.create_async_client(endpoint=widgetmanager_endpoint)
    ...
    @WidgetManagerPreparer()
    @recorded_by_proxy_async
    async def test_begin_create_or_update_widget(self, widgetmanager_endpoint):
        client = self.create_async_client(endpoint=widgetmanager_endpoint)
        response = await (
    ...
    @WidgetManagerPreparer()
    @recorded_by_proxy_async
    async def test_begin_delete_widget(self, widgetmanager_endpoint):
        client = self.create_async_client(endpoint=widgetmanager_endpoint)
        response = await (
    ...
    @WidgetManagerPreparer()
    @recorded_by_proxy_async
    async def test_list_widgets(self, widgetmanager_endpoint):
        client = self.create_async_client(endpoint=widgetmanager_endpoint)
