...
class FakedSharedModel(_model_base.Model):
    ...
    :ivar tag: The tag. test. Required.
    :vartype tag: str
...
class ResourceOperationStatusWidgetSuiteWidgetSuiteError(_model_base.Model):  # pylint: disable=name-too-long
...
class WidgetSuite(_model_base.Model):
    """A widget. test.
