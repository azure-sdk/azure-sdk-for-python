...
from ..._operations._operations import (
    ...
    build_widget_manager_delete_widget2_request,
...
class WidgetManagerClientOperationsMixin(WidgetManagerClientMixinABC):
    ...
    async def _delete_widget2_initial(  # pylint: disable=inconsistent-return-statements
    ...
    @distributed_trace_async
    async def begin_delete_widget2(self, widget_name: str, **kwargs: Any) -> AsyncLROPoller[None]:
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._delete_widget2_initial(  # type: ignore
