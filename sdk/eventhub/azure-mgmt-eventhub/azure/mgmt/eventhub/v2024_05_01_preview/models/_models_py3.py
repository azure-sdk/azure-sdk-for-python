...
class ApplicationGroup(ProxyResource):
    ...
    :vartype system_data: ~azure.mgmt.eventhub.v2024_05_01_preview.models.SystemData
    ...
    :vartype policies: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.ApplicationGroupPolicy]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword policies: List of group policies that define the behavior of application group. The
         policies can support resource governance scenarios such as limiting ingress or egress traffic.
        :paramtype policies:
         list[~azure.mgmt.eventhub.v2024_05_01_preview.models.ApplicationGroupPolicy]
        """
        super().__init__(**kwargs)
...
class ApplicationGroupListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.ApplicationGroup]
    ...
    def __init__(self, *, value: Optional[List["_models.ApplicationGroup"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.ApplicationGroup]
        """
        super().__init__(**kwargs)
        self.value = value
...
class ApplicationGroupPolicy(_serialization.Model):
    ...
    :vartype type: str or
     ~azure.mgmt.eventhub.v2024_05_01_preview.models.ApplicationGroupPolicyType
    """
...
class ArmDisasterRecovery(ProxyResource):
    ...
    :vartype provisioning_state: str or
     ~azure.mgmt.eventhub.v2024_05_01_preview.models.ProvisioningStateDR
    ...
    :vartype role: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.RoleDisasterRecovery
...
class ArmDisasterRecoveryListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.ArmDisasterRecovery]
    ...
    def __init__(self, *, value: Optional[List["_models.ArmDisasterRecovery"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.ArmDisasterRecovery]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link: Optional[str] = None
...
class AuthorizationRule(ProxyResource):
    ...
    :vartype rights: list[str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.AccessRights]
    """
    ...
    def __init__(self, *, rights: Optional[List[Union[str, "_models.AccessRights"]]] = None, **kwargs: Any) -> None:
        ...
        :paramtype rights: list[str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.AccessRights]
        """
        super().__init__(**kwargs)
        self.system_data: Optional["_models.SystemData"] = None
        self.rights = rights
...
class AuthorizationRuleListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.AuthorizationRule]
    :ivar next_link: Link to the next set of results. Not empty if Value contains an incomplete
     list of Authorization Rules.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype value: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.AuthorizationRule]
...
class AvailableClustersList(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.AvailableCluster]
    """
    ...
    def __init__(self, *, value: Optional[List["_models.AvailableCluster"]] = None, **kwargs: Any) -> None:
        ...
        :keyword value: The count of readily available and pre-provisioned Event Hubs Clusters per
         region.
        :paramtype value: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.AvailableCluster]
        """
        super().__init__(**kwargs)
        self.value = value
...
class CaptureDescription(_serialization.Model):
    ...
    :vartype encoding: str or
     ~azure.mgmt.eventhub.v2024_05_01_preview.models.EncodingCaptureDescription
    ...
    :ivar destination: Properties of Destination where capture will be stored. (Storage Account,
     Blob Names).
    :vartype destination: ~azure.mgmt.eventhub.v2024_05_01_preview.models.Destination
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword destination: Properties of Destination where capture will be stored. (Storage Account,
         Blob Names).
        :paramtype destination: ~azure.mgmt.eventhub.v2024_05_01_preview.models.Destination
...
class CaptureIdentity(_serialization.Model):
    """A value that indicates whether capture description is enabled.

    :ivar type: Type of Azure Active Directory Managed Identity. Known values are: "SystemAssigned"
     and "UserAssigned".
    :vartype type: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.CaptureIdentityType
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword type: Type of Azure Active Directory Managed Identity. Known values are:
         "SystemAssigned" and "UserAssigned".
        :paramtype type: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.CaptureIdentityType
        :keyword user_assigned_identity: ARM ID of Managed User Identity. This property is required is
         the type is UserAssignedIdentity. If type is SystemAssigned, then the System Assigned Identity
         Associated with the namespace will be used.
...
class CheckNameAvailabilityResult(_serialization.Model):
    ...
    :vartype reason: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.UnavailableReason
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword reason: The reason for unavailability of a Namespace. Known values are: "None",
         "InvalidName", "SubscriptionIsDisabled", "NameInUse", "NameInLockdown", and
         "TooManyNamespaceInCurrentSubscription".
        :paramtype reason: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.UnavailableReason
        """
        super().__init__(**kwargs)
...
class Cluster(TrackedResource):
    ...
    :vartype sku: ~azure.mgmt.eventhub.v2024_05_01_preview.models.ClusterSku
    :ivar system_data: The system meta data relating to this resource.
    :vartype system_data: ~azure.mgmt.eventhub.v2024_05_01_preview.models.SystemData
    ...
    :vartype provisioning_state: str or
     ~azure.mgmt.eventhub.v2024_05_01_preview.models.ProvisioningState
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype sku: ~azure.mgmt.eventhub.v2024_05_01_preview.models.ClusterSku
...
class ClusterListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.Cluster]
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.Cluster]
...
class ClusterSku(_serialization.Model):
    ...
    :vartype name: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.ClusterSkuName
    ...
    def __init__(
        ...
        :paramtype name: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.ClusterSkuName
...
class ConnectionState(_serialization.Model):
    ...
    :vartype status: str or
     ~azure.mgmt.eventhub.v2024_05_01_preview.models.PrivateLinkConnectionStatus
...
class ConsumerGroupListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.ConsumerGroup]
    :ivar next_link: Link to the next set of results. Not empty if Value contains incomplete list
     of Consumer Group.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.ConsumerGroup]
...
class Destination(_serialization.Model):
    ...
    :vartype identity: ~azure.mgmt.eventhub.v2024_05_01_preview.models.CaptureIdentity
    ...
    _attribute_map = {
        "name": {"key": "name", "type": "str"},
        "identity": {"key": "identity", "type": "CaptureIdentity"},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype name: str
        :keyword identity: A value that indicates whether capture description is enabled.
        :paramtype identity: ~azure.mgmt.eventhub.v2024_05_01_preview.models.CaptureIdentity
...
class EHNamespace(TrackedResource):
    ...
    :vartype sku: ~azure.mgmt.eventhub.v2024_05_01_preview.models.Sku
    :ivar identity: Properties of BYOK Identity description.
    :vartype identity: ~azure.mgmt.eventhub.v2024_05_01_preview.models.Identity
    :ivar system_data: The system meta data relating to this resource.
    :vartype system_data: ~azure.mgmt.eventhub.v2024_05_01_preview.models.SystemData
    :ivar minimum_tls_version: The minimum TLS version for the cluster to support, e.g. '1.2'.
     Known values are: "1.0", "1.1", and "1.2".
    :vartype minimum_tls_version: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.TlsVersion
    ...
    :vartype public_network_access: str or
     ~azure.mgmt.eventhub.v2024_05_01_preview.models.PublicNetworkAccess
    ...
    :vartype encryption: ~azure.mgmt.eventhub.v2024_05_01_preview.models.Encryption
    :ivar private_endpoint_connections: List of private endpoint connections.
    :vartype private_endpoint_connections:
     list[~azure.mgmt.eventhub.v2024_05_01_preview.models.PrivateEndpointConnection]
    ...
    :vartype geo_data_replication:
     ~azure.mgmt.eventhub.v2024_05_01_preview.models.GeoDataReplicationProperties
    """
    ...
    _validation = {
        ...
        "metric_id": {"readonly": True},
        "maximum_throughput_units": {"minimum": 0},
    }
    ...
    _attribute_map = {
        ...
        "alternate_name": {"key": "properties.alternateName", "type": "str"},
        "geo_data_replication": {"key": "properties.geoDataReplication", "type": "GeoDataReplicationProperties"},
    }
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :paramtype sku: ~azure.mgmt.eventhub.v2024_05_01_preview.models.Sku
        :keyword identity: Properties of BYOK Identity description.
        :paramtype identity: ~azure.mgmt.eventhub.v2024_05_01_preview.models.Identity
        ...
        :paramtype minimum_tls_version: str or
         ~azure.mgmt.eventhub.v2024_05_01_preview.models.TlsVersion
        ...
        :paramtype encryption: ~azure.mgmt.eventhub.v2024_05_01_preview.models.Encryption
        ...
        :keyword alternate_name: Alternate name specified when alias and namespace names are same.
        :paramtype alternate_name: str
        :keyword geo_data_replication: Geo Data Replication settings for the namespace.
        :paramtype geo_data_replication:
         ~azure.mgmt.eventhub.v2024_05_01_preview.models.GeoDataReplicationProperties
        """
        super().__init__(location=location, tags=tags, **kwargs)
        self.sku = sku
        ...
        self.alternate_name = alternate_name
        self.geo_data_replication = geo_data_replication
...
class EHNamespaceIdListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.EHNamespaceIdContainer]
    """
    ...
    def __init__(self, *, value: Optional[List["_models.EHNamespaceIdContainer"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.EHNamespaceIdContainer]
        """
        super().__init__(**kwargs)
        self.value = value
...
class EHNamespaceListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.EHNamespace]
    :ivar next_link: Link to the next set of results. Not empty if Value contains incomplete list
     of namespaces.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.EHNamespace]
        :keyword next_link: Link to the next set of results. Not empty if Value contains incomplete
         list of namespaces.
        :paramtype next_link: str
        """
...
class Encryption(_serialization.Model):
    ...
    :vartype key_vault_properties:
     list[~azure.mgmt.eventhub.v2024_05_01_preview.models.KeyVaultProperties]
...
class ErrorDetail(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info:
     list[~azure.mgmt.eventhub.v2024_05_01_preview.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(_serialization.Model):
    ...
    :vartype error: ~azure.mgmt.eventhub.v2024_05_01_preview.models.ErrorDetail
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetail"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~azure.mgmt.eventhub.v2024_05_01_preview.models.ErrorDetail
        """
        super().__init__(**kwargs)
        self.error = error
...
class Eventhub(ProxyResource):
    ...
    :vartype status: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.EntityStatus
    :ivar capture_description: Properties of capture description.
    :vartype capture_description:
     ~azure.mgmt.eventhub.v2024_05_01_preview.models.CaptureDescription
    :ivar retention_description: Event Hub retention settings.
    :vartype retention_description:
     ~azure.mgmt.eventhub.v2024_05_01_preview.models.RetentionDescription
    :ivar message_timestamp_description: Properties of MessageTimestamp Description.
    :vartype message_timestamp_description:
     ~azure.mgmt.eventhub.v2024_05_01_preview.models.MessageTimestampDescription
    ...
    _attribute_map = {
        ...
        "message_timestamp_description": {
            "key": "properties.messageTimestampDescription",
            "type": "MessageTimestampDescription",
        },
        "identifier": {"key": "properties.identifier", "type": "str"},
        "user_metadata": {"key": "properties.userMetadata", "type": "str"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype status: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.EntityStatus
        ...
        :paramtype retention_description:
         ~azure.mgmt.eventhub.v2024_05_01_preview.models.RetentionDescription
        :keyword message_timestamp_description: Properties of MessageTimestamp Description.
        :paramtype message_timestamp_description:
         ~azure.mgmt.eventhub.v2024_05_01_preview.models.MessageTimestampDescription
        :keyword user_metadata: Gets and Sets Metadata of User.
        :paramtype user_metadata: str
        """
        super().__init__(**kwargs)
        self.system_data: Optional["_models.SystemData"] = None
        ...
        self.message_timestamp_description = message_timestamp_description
...
class EventHubListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.Eventhub]
    :ivar next_link: Link to the next set of results. Not empty if Value contains incomplete list
     of EventHubs.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.Eventhub]
        :keyword next_link: Link to the next set of results. Not empty if Value contains incomplete
         list of EventHubs.
        :paramtype next_link: str
        """
...
class FailOver(_serialization.Model):
    """FailOver.
    ...
    def __init__(self, *, primary_location: Optional[str] = None, force: Optional[bool] = None, **kwargs: Any) -> None:
        """
        :keyword primary_location: Query parameter for the new primary location after failover.
        :paramtype primary_location: str
        :keyword force: If Force is false then graceful failover is attempted after ensuring no data
         loss. If Force flag is set to true, Forced failover is attempted with possible data loss.
...
class GeoDataReplicationProperties(_serialization.Model):
    ...
    :vartype locations:
     list[~azure.mgmt.eventhub.v2024_05_01_preview.models.NamespaceReplicaLocation]
    """

    _attribute_map = {
        "max_replication_lag_duration_in_seconds": {"key": "maxReplicationLagDurationInSeconds", "type": "int"},
        "locations": {"key": "locations", "type": "[NamespaceReplicaLocation]"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword max_replication_lag_duration_in_seconds: The maximum acceptable lag for data
         replication operations from the primary replica to a quorum of secondary replicas.  When the
         lag exceeds the configured amount, operations on the primary replica will be failed. The
         allowed values are 0 and 5 minutes to 1 day.
        :paramtype max_replication_lag_duration_in_seconds: int
        :keyword locations: A list of regions where replicas of the namespace are maintained.
        :paramtype locations:
         list[~azure.mgmt.eventhub.v2024_05_01_preview.models.NamespaceReplicaLocation]
        """
        super().__init__(**kwargs)
        self.max_replication_lag_duration_in_seconds = max_replication_lag_duration_in_seconds
...
class Identity(_serialization.Model):
    ...
    :vartype type: str or
     ~azure.mgmt.eventhub.v2024_05_01_preview.models.ManagedServiceIdentityType
    :ivar user_assigned_identities: Properties for User Assigned Identities.
    :vartype user_assigned_identities: dict[str,
     ~azure.mgmt.eventhub.v2024_05_01_preview.models.UserAssignedIdentity]
    """
...
class KeyVaultProperties(_serialization.Model):
    ...
    :ivar identity:
    :vartype identity:
     ~azure.mgmt.eventhub.v2024_05_01_preview.models.UserAssignedIdentityProperties
    """
...
class MessageTimestampDescription(_serialization.Model):
    ...
    :vartype timestamp_type: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.TimestampType
    """

    _attribute_map = {
        "timestamp_type": {"key": "timestampType", "type": "str"},
    }

    def __init__(self, *, timestamp_type: Optional[Union[str, "_models.TimestampType"]] = None, **kwargs: Any) -> None:
        """
        :keyword timestamp_type: Denotes the type of timestamp the message will hold.Two types of
         timestamp types - "AppendTime" and "CreateTime". AppendTime refers the time in which message
         got appended inside broker log. CreateTime refers to the time in which the message was
         generated on source side and producers can set this timestamp while sending the message.
         Default value is AppendTime. If you are using AMQP protocol, CreateTime equals AppendTime and
         its behavior remains the same. Known values are: "LogAppend" and "Create".
        :paramtype timestamp_type: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.TimestampType
        """
        super().__init__(**kwargs)
        self.timestamp_type = timestamp_type


class NamespaceReplicaLocation(_serialization.Model):
    ...
    :vartype role_type: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.GeoDRRoleType
    ...
    _attribute_map = {
        ...
        "cluster_arm_id": {"key": "clusterArmId", "type": "str"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword location_name: Azure regions where a replica of the namespace is maintained.
        :paramtype location_name: str
        :keyword role_type: GeoDR Role Types. Known values are: "Primary" and "Secondary".
        :paramtype role_type: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.GeoDRRoleType
        :keyword cluster_arm_id: Optional property that denotes the ARM ID of the Cluster. This is
         required, if a namespace replica should be placed in a Dedicated Event Hub Cluster.
        :paramtype cluster_arm_id: str
        """
        super().__init__(**kwargs)
...
class NetworkRuleSet(ProxyResource):
    ...
    :ivar default_action: Default Action for Network Rule Set. Known values are: "Allow" and
     "Deny".
    :vartype default_action: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.DefaultAction
    :ivar virtual_network_rules: List VirtualNetwork Rules.
    :vartype virtual_network_rules:
     list[~azure.mgmt.eventhub.v2024_05_01_preview.models.NWRuleSetVirtualNetworkRules]
    :ivar ip_rules: List of IpRules.
    :vartype ip_rules: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.NWRuleSetIpRules]
    :ivar public_network_access: This determines if traffic is allowed over public network. By
    ...
    :vartype public_network_access: str or
     ~azure.mgmt.eventhub.v2024_05_01_preview.models.PublicNetworkAccessFlag
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword default_action: Default Action for Network Rule Set. Known values are: "Allow" and
         "Deny".
        :paramtype default_action: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.DefaultAction
        :keyword virtual_network_rules: List VirtualNetwork Rules.
        :paramtype virtual_network_rules:
         list[~azure.mgmt.eventhub.v2024_05_01_preview.models.NWRuleSetVirtualNetworkRules]
        :keyword ip_rules: List of IpRules.
        :paramtype ip_rules: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.NWRuleSetIpRules]
        :keyword public_network_access: This determines if traffic is allowed over public network. By
         default it is enabled. If value is SecuredByPerimeter then Inbound and Outbound communication
         is controlled by the network security perimeter and profile's access rules. Known values are:
         "Enabled", "Disabled", and "SecuredByPerimeter".
...
class NetworkRuleSetListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.NetworkRuleSet]
    :ivar next_link: Link to the next set of results. Not empty if Value contains incomplete list
     of NetworkRuleSet.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.NetworkRuleSet]
        :keyword next_link: Link to the next set of results. Not empty if Value contains incomplete
...
class NetworkSecurityPerimeterConfiguration(ProxyResource):
    ...
    :ivar provisioning_state: Provisioning state of NetworkSecurityPerimeter configuration
     ...
     "Canceled".
    :vartype provisioning_state: str or
     ~azure.mgmt.eventhub.v2024_05_01_preview.models.NetworkSecurityPerimeterConfigurationProvisioningState
    ...
    :vartype network_security_perimeter:
     ~azure.mgmt.eventhub.v2024_05_01_preview.models.NetworkSecurityPerimeter
    ...
    :vartype profile:
     ~azure.mgmt.eventhub.v2024_05_01_preview.models.NetworkSecurityPerimeterConfigurationPropertiesProfile
    ...
    _validation = {
        ...
        "is_backing_resource": {"readonly": True},
        "applicable_features": {"readonly": True},
        "parent_association_name": {"readonly": True},
    ...
    _attribute_map = {
        ...
        "is_backing_resource": {"key": "properties.isBackingResource", "type": "bool"},
        "applicable_features": {"key": "properties.applicableFeatures", "type": "[str]"},
        "parent_association_name": {"key": "properties.parentAssociationName", "type": "str"},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.is_backing_resource: Optional[bool] = None
        self.applicable_features: Optional[List[str]] = None
        self.parent_association_name: Optional[str] = None
...
class NetworkSecurityPerimeterConfigurationList(_serialization.Model):  # pylint: disable=name-too-long
    ...
    :vartype value:
     list[~azure.mgmt.eventhub.v2024_05_01_preview.models.NetworkSecurityPerimeterConfiguration]
    """
...
class NetworkSecurityPerimeterConfigurationPropertiesProfile(_serialization.Model):  # pylint: disable=name-too-long
    ...
    :vartype access_rules: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.NspAccessRule]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype access_rules: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.NspAccessRule]
        """
        super().__init__(**kwargs)
        self.name = name
...
class NetworkSecurityPerimeterConfigurationPropertiesResourceAssociation(
    ...
    :vartype access_mode: str or
     ~azure.mgmt.eventhub.v2024_05_01_preview.models.ResourceAssociationAccessMode
    """
...
class NspAccessRule(_serialization.Model):
    ...
    :vartype properties: ~azure.mgmt.eventhub.v2024_05_01_preview.models.NspAccessRuleProperties
    """
...
class NspAccessRuleProperties(_serialization.Model):
    ...
    :vartype direction: str or
     ~azure.mgmt.eventhub.v2024_05_01_preview.models.NspAccessRuleDirection
    ...
    :vartype subscriptions:
     list[~azure.mgmt.eventhub.v2024_05_01_preview.models.NspAccessRulePropertiesSubscriptionsItem]
    :ivar network_security_perimeters: NetworkSecurityPerimeters for inbound rules.
    :vartype network_security_perimeters:
     list[~azure.mgmt.eventhub.v2024_05_01_preview.models.NetworkSecurityPerimeter]
...
class NWRuleSetIpRules(_serialization.Model):
    ...
    :vartype action: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.NetworkRuleIPAction
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype action: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.NetworkRuleIPAction
        """
        super().__init__(**kwargs)
...
class NWRuleSetVirtualNetworkRules(_serialization.Model):
    ...
    :vartype subnet: ~azure.mgmt.eventhub.v2024_05_01_preview.models.Subnet
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype subnet: ~azure.mgmt.eventhub.v2024_05_01_preview.models.Subnet
...
class Operation(_serialization.Model):
    ...
    :vartype display: ~azure.mgmt.eventhub.v2024_05_01_preview.models.OperationDisplay
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype display: ~azure.mgmt.eventhub.v2024_05_01_preview.models.OperationDisplay
...
class OperationListResult(_serialization.Model):
    ...
    :ivar value: List of Event Hub operations supported by the Microsoft.EventHub resource
     provider.
    :vartype value: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.Operation]
...
class PrivateEndpointConnection(ProxyResource):
    ...
    :vartype private_endpoint: ~azure.mgmt.eventhub.v2024_05_01_preview.models.PrivateEndpoint
    :ivar private_link_service_connection_state: Details about the state of the connection.
    :vartype private_link_service_connection_state:
     ~azure.mgmt.eventhub.v2024_05_01_preview.models.ConnectionState
    ...
    :vartype provisioning_state: str or
     ~azure.mgmt.eventhub.v2024_05_01_preview.models.EndPointProvisioningState
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype private_endpoint: ~azure.mgmt.eventhub.v2024_05_01_preview.models.PrivateEndpoint
...
class PrivateEndpointConnectionListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.PrivateEndpointConnection]
...
class PrivateLinkResourcesListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.PrivateLinkResource]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype value: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.PrivateLinkResource]
...
class ProvisioningIssue(_serialization.Model):
    ...
    :vartype properties:
     ~azure.mgmt.eventhub.v2024_05_01_preview.models.ProvisioningIssueProperties
    """
...
class RegenerateAccessKeyParameters(_serialization.Model):
    ...
    :ivar key_type: The access key to regenerate. Required. Known values are: "PrimaryKey" and
     "SecondaryKey".
    :vartype key_type: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.KeyType
    ...
    def __init__(self, *, key_type: Union[str, "_models.KeyType"], key: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :keyword key_type: The access key to regenerate. Required. Known values are: "PrimaryKey" and
         "SecondaryKey".
        :paramtype key_type: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.KeyType
...
class RetentionDescription(_serialization.Model):
    ...
    :vartype cleanup_policy: str or
     ~azure.mgmt.eventhub.v2024_05_01_preview.models.CleanupPolicyRetentionDescription
    ...
    :ivar min_compaction_lag_in_mins: The minimum time a message will remain ineligible for
     compaction in the log. This value is used when cleanupPolicy is Compact or DeleteOrCompact.
    :vartype min_compaction_lag_in_mins: int
    ...
    _attribute_map = {
        ...
        "min_compaction_lag_in_mins": {"key": "minCompactionLagInMins", "type": "int"},
    ...
    def __init__(
        ...
        *,
        ...
        min_compaction_lag_in_mins: Optional[int] = None,
        ...
        **kwargs: Any
        ...
        :keyword min_compaction_lag_in_mins: The minimum time a message will remain ineligible for
         compaction in the log. This value is used when cleanupPolicy is Compact or DeleteOrCompact.
        :paramtype min_compaction_lag_in_mins: int
        ...
        self.min_compaction_lag_in_mins = min_compaction_lag_in_mins
...
class SchemaGroup(ProxyResource):
    ...
    :vartype schema_compatibility: str or
     ~azure.mgmt.eventhub.v2024_05_01_preview.models.SchemaCompatibility
    :ivar schema_type: Known values are: "Unknown", "Avro", "ProtoBuf", and "Json".
    :vartype schema_type: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.SchemaType
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype schema_compatibility: str or
         ~azure.mgmt.eventhub.v2024_05_01_preview.models.SchemaCompatibility
        :keyword schema_type: Known values are: "Unknown", "Avro", "ProtoBuf", and "Json".
        :paramtype schema_type: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.SchemaType
        """
        super().__init__(**kwargs)
        self.system_data: Optional["_models.SystemData"] = None
...
class SchemaGroupListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.SchemaGroup]
    :ivar next_link: Link to the next set of results. Not empty if Value contains incomplete list
     of Schema Groups.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.eventhub.v2024_05_01_preview.models.SchemaGroup]
        :keyword next_link: Link to the next set of results. Not empty if Value contains incomplete
...
class Sku(_serialization.Model):
    ...
    :vartype name: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.SkuName
    :ivar tier: The billing tier of this particular SKU. Known values are: "Basic", "Standard", and
     "Premium".
    :vartype tier: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.SkuTier
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword name: Name of this SKU. Required. Known values are: "Basic", "Standard", and
         "Premium".
        :paramtype name: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.SkuName
        :keyword tier: The billing tier of this particular SKU. Known values are: "Basic", "Standard",
         and "Premium".
        :paramtype tier: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.SkuTier
...
class SystemData(_serialization.Model):
    ...
    :vartype created_by_type: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.CreatedByType
    ...
    :vartype last_modified_by_type: str or
     ~azure.mgmt.eventhub.v2024_05_01_preview.models.CreatedByType
...
class ThrottlingPolicy(ApplicationGroupPolicy):
    ...
    :ivar metric_id: Metric Id on which the throttle limit should be set, MetricId can be
     ...
     "OutgoingMessages".
    :vartype metric_id: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.MetricId
    """
    ...
    def __init__(
        ...
        :keyword metric_id: Metric Id on which the throttle limit should be set, MetricId can be
         ...
         Portal. Required. Known values are: "IncomingBytes", "OutgoingBytes", "IncomingMessages", and
         "OutgoingMessages".
        :paramtype metric_id: str or ~azure.mgmt.eventhub.v2024_05_01_preview.models.MetricId
        """
