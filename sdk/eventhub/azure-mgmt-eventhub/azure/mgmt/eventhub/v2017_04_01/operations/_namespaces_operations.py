...
class NamespacesOperations:
    ...
    def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.eventhub.v2017_04_01.models.EHNamespace or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get_messaging_plan(self, resource_group_name: str, namespace_name: str, **kwargs: Any) -> _models.MessagingPlan:
        ...
        request = build_get_messaging_plan_request(
            resource_group_name=resource_group_name,
            namespace_name=namespace_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self.get_messaging_plan.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    def create_or_update_network_rule_set(
        ...
        **kwargs: Any
        ...
        :param parameters: The Namespace IpFilterRule. Is either a NetworkRuleSet type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.eventhub.v2017_04_01.models.NetworkRuleSet or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
