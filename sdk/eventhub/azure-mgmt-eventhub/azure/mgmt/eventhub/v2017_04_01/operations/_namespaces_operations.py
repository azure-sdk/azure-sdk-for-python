...
def build_get_messaging_plan_request(
    resource_group_name: str, namespace_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class NamespacesOperations:
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.EHNamespace"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.eventhub.v2017_04_01.models.EHNamespace]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.eventhub.v2017_04_01.models.EHNamespace or IO[bytes]
        :return: An instance of LROPoller that returns either EHNamespace or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.eventhub.v2017_04_01.models.EHNamespace]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    @distributed_trace
    def get_messaging_plan(self, resource_group_name: str, namespace_name: str, **kwargs: Any) -> _models.MessagingPlan:
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._api_version or "2017-04-01"))
        cls: ClsType[_models.MessagingPlan] = kwargs.pop("cls", None)

        _request = build_get_messaging_plan_request(
            resource_group_name=resource_group_name,
            namespace_name=namespace_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
        ...
        deserialized = self._deserialize("MessagingPlan", pipeline_response.http_response)
    ...
    def create_or_update_network_rule_set(
        ...
        **kwargs: Any
        ...
        :param parameters: The Namespace IpFilterRule. Is either a NetworkRuleSet type or a IO[bytes]
         type. Required.
        :type parameters: ~azure.mgmt.eventhub.v2017_04_01.models.NetworkRuleSet or IO[bytes]
        :return: NetworkRuleSet or the result of cls(response)
        :rtype: ~azure.mgmt.eventhub.v2017_04_01.models.NetworkRuleSet
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_network_rule_sets(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.eventhub.v2017_04_01.models.NetworkRuleSet]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
