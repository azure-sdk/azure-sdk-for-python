...
from ...operations._network_security_perimeter_configurations_operations import (
    ...
    build_resource_association_name_request,
)
...
class NetworkSecurityPerimeterConfigurationsOperations:  # pylint: disable=name-too-long
    ...
    @distributed_trace_async
    async def resource_association_name(
        self, resource_group_name: str, namespace_name: str, resource_association_name: str, **kwargs: Any
        ...
        :rtype: ~azure.mgmt.eventhub.v2024_01_01.models.NetworkSecurityPerimeterConfiguration
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        _request = build_resource_association_name_request(
            resource_group_name=resource_group_name,
            namespace_name=namespace_name,
            resource_association_name=resource_association_name,
            subscription_id=self._config.subscription_id,
