...
class EventHubsOperations:
    ...
    def list_all(
    ...
    ) -> AsyncIterable["_models.EventHubResource"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.eventhub.v2015_08_01.models.EventHubResource]
    ...
    async def create_or_update(
        ...
        namespace_name: str,
        event_hub_name: str,
        parameters: Union[_models.EventHubCreateOrUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.EventHubResource:
        """Creates or updates a new Event Hub as a nested resource within a Namespace.
        ...
        deserialized = self._deserialize("EventHubResource", pipeline_response.http_response)
    ...
    async def regenerate_keys(
        ...
        **kwargs: Any
        ...
        :type authorization_rule_name: str
        :param parameters: Parameters supplied to regenerate the AuthorizationRule Keys
         (PrimaryKey/SecondaryKey). Is either a RegenerateKeysParameters type or a IO[bytes] type.
         Required.
