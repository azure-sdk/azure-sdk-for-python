...
# --------------------------------------------------------------------------
import pytest
from azure.mgmt.eventhub.v2024_01_01 import EventHubManagementClient
...
class TestEventHubManagementConsumerGroupsOperations(AzureMgmtRecordedTestCase):
    ...
    @recorded_by_proxy
    def test_consumer_groups_create_or_update(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_consumer_groups_delete(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_consumer_groups_get(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_consumer_groups_list_by_event_hub(self, resource_group):
