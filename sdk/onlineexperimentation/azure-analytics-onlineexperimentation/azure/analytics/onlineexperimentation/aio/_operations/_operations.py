...
class OnlineExperimentationClientOperationsMixin(OnlineExperimentationClientMixinABC):  # pylint: disable=name-too-long
    ...
    @overload
    async def validate_metric(
        self, experiment_metric_id: str, body: JSON, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.ExperimentMetricValidationResult:
        """Validates an experiment metric definition.
    ...
    @overload
    async def validate_metric(
        self, experiment_metric_id: str, body: IO[bytes], *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.ExperimentMetricValidationResult:
        """Validates an experiment metric definition.
    ...
    @distributed_trace_async
    async def validate_metric(
        self, experiment_metric_id: str, body: Union[_models.ExperimentMetric, JSON, IO[bytes]], **kwargs: Any
    ) -> _models.ExperimentMetricValidationResult:
        """Validates an experiment metric definition.
