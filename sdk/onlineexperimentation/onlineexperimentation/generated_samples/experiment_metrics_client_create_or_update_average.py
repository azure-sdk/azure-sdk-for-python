...
# USAGE
    python experiment_metrics_client_create_or_update_average.py
...
def main():
    ...
    response = client.experiment_metrics_client.create_or_update(
        experiment_metric_id="avg_purchase_revenue",
        resource={
            "categories": ["Monetization"],
            "definition": {
                "type": "Average",
                "value": {"eventName": "Transaction", "eventProperty": "Revenue", "filter": "Revenue > 0"},
            },
...
# x-ms-original-file: 2025-05-31-preview/ExperimentMetricsClient_CreateOrUpdate_Average.json
