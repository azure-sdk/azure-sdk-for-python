...
class SpringbootappsOperations:
    ...
    def list_by_subscription(self, site_name: str, **kwargs: Any) -> AsyncIterable["_models.SpringbootappsModel"]:
        ...
        cls: ClsType[_models.SpringbootappsModelListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("SpringbootappsModelListResult", pipeline_response)
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either SpringbootappsModel or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.springappdiscovery.models.SpringbootappsModel]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
