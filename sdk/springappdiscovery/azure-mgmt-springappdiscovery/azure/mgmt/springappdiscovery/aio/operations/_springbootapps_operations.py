...
class SpringbootappsOperations:
    ...
    async def get(
        self, site_name: str, resource_group_name: str, springbootapps_name: str, **kwargs: Any
    ...
    async def delete(
        self, site_name: str, resource_group_name: str, springbootapps_name: str, **kwargs: Any
    ) -> Optional[_models.SpringbootappsModel]:
        ...
        :rtype: ~azure.mgmt.springappdiscovery.models.SpringbootappsModel or None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def list_by_resource_group(
        self, site_name: str, resource_group_name: str, **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.springappdiscovery.models.SpringbootappsModel]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace
    def list_by_subscription(self, site_name: str, **kwargs: Any) -> AsyncIterable["_models.SpringbootappsModel"]:
