...
class ResourceProviderOperation(_serialization.Model):
    ...
    :vartype display: ~azure.mgmt.springappdiscovery.models.ResourceProviderOperationDisplay
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype display: ~azure.mgmt.springappdiscovery.models.ResourceProviderOperationDisplay
        """
        super().__init__(**kwargs)
...
class ResourceProviderOperationList(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.springappdiscovery.models.ResourceProviderOperation]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype value: list[~azure.mgmt.springappdiscovery.models.ResourceProviderOperation]
