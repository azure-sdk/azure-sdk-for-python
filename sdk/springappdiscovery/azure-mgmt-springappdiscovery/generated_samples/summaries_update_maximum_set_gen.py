...
# USAGE
    python summaries_update_maximum_set_gen.py
...
def main():
    ...
    response = client.summaries.update(
        resource_group_name="rgspringbootdiscovery",
        site_name="xxkzlvbihwxunadjcpjpjmghmhxrqyvghtpfps",
        summary_name="vjB",
        body={
            "properties": {"discoveredApps": 24, "discoveredServers": 22},
            "tags": {"key2503": "fyiyrgoydaqnlenngcgobyj"},
        },
    )
    print(response)
