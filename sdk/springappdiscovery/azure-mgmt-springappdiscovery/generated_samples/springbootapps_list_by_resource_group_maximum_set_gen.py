...
# USAGE
    python springbootapps_list_by_resource_group_maximum_set_gen.py
...
# x-ms-original-file: specification/offazurespringboot/resource-manager/Microsoft.OffAzureSpringBoot/preview/2024-04-01-preview/examples/springbootapps_ListByResourceGroup_MaximumSet_Gen.json
