...
from ...operations._shared_keys_operations import build_get_request, build_list_request, build_regenerate_request
...
class SharedKeysOperations:
    ...
    async def list(self, resource_group_name: str, workspace_name: str, **kwargs: Any) -> _models.SharedKeys:
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, workspace_name: str, **kwargs: Any) -> _models.SharedKeys:
        """Gets the shared keys for a workspace.
