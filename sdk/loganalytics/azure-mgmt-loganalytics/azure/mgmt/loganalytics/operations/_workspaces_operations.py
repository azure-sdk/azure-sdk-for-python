...
def build_reconcile_nsp_request(
    resource_group_name: str,
    workspace_name: str,
    network_security_perimeter_configuration_name: str,
    subscription_id: str,
...
def build_list_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.OperationalInsights/workspaces"
    )
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
    }
...
class WorkspacesOperations:
    ...
    def _reconcile_nsp_initial(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        workspace_name: str,
        network_security_perimeter_configuration_name: str,
    ...
    def begin_reconcile_nsp(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = self._reconcile_nsp_initial(  # type: ignore
                resource_group_name=resource_group_name,
                workspace_name=workspace_name,
                network_security_perimeter_configuration_name=network_security_perimeter_configuration_name,
                api_version=api_version,
