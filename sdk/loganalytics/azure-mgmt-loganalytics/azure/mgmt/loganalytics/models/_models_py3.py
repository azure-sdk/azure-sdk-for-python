...
class Cluster(TrackedResourceAutoGenerated):  # pylint: disable=too-many-instance-attributes
...
class DataExport(ProxyResourceAutoGenerated):  # pylint: disable=too-many-instance-attributes
...
class DataSource(ProxyResourceAutoGenerated):
...
class LinkedService(ProxyResourceAutoGenerated):
...
class LinkedStorageAccountsResource(ProxyResourceAutoGenerated):
...
class LogAnalyticsQueryPackQuery(ProxyResource):  # pylint: disable=too-many-instance-attributes
...
class SavedSearch(ProxyResourceAutoGenerated):  # pylint: disable=too-many-instance-attributes
...
class StorageInsight(ProxyResourceAutoGenerated):
...
class Table(ProxyResourceAutoGenerated):  # pylint: disable=too-many-instance-attributes
...
class Workspace(TrackedResourceAutoGenerated):  # pylint: disable=too-many-instance-attributes
