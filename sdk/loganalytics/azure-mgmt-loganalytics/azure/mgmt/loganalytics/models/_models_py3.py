...
class ClusterSku(_serialization.Model):
    ...
    :ivar capacity: The capacity value. Known values are: 100, 200, 300, 400, 500, 1000, 2000, and
     5000.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword capacity: The capacity value. Known values are: 100, 200, 300, 400, 500, 1000, 2000,
         and 5000.
