...
class Cluster(TrackedResourceAutoGenerated):
...
class DataExport(ProxyResourceAutoGenerated):
...
class SavedSearch(ProxyResourceAutoGenerated):
...
class Workspace(TrackedResourceAutoGenerated):
