...
class AdvancedThreatProtectionSettingsOperations:  # pylint: disable=name-too-long
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either AdvancedThreatProtection or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.mysql_flexibleservers.models.AdvancedThreatProtection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(
    ...
    ) -> Iterable["_models.AdvancedThreatProtection"]:
        ...
        :return: An iterator like instance of either AdvancedThreatProtection or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.mysql_flexibleservers.models.AdvancedThreatProtection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
