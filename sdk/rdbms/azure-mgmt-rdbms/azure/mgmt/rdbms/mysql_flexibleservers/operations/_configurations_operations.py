...
class ConfigurationsOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.mysql_flexibleservers.models.Configuration or IO[bytes]
        :return: An instance of LROPoller that returns either Configuration or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.mysql_flexibleservers.models.Configuration]
    ...
    def begin_batch_update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.rdbms.mysql_flexibleservers.models.ConfigurationListForBatchUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either ConfigurationListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.mysql_flexibleservers.models.ConfigurationListResult]
