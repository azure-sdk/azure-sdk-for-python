...
class AdministratorsOperations:
    ...
    def _create_initial(
        ...
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.ActiveDirectoryAdministrator]] = kwargs.pop("cls", None)
    ...
    def begin_create(
        ...
        **kwargs: Any
    ) -> LROPoller[_models.ActiveDirectoryAdministrator]:
        ...
        :return: An instance of LROPoller that returns either ActiveDirectoryAdministrator or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.postgresql_flexibleservers.models.ActiveDirectoryAdministrator]
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.rdbms.postgresql_flexibleservers.models.ActiveDirectoryAdministratorAdd or
         IO[bytes]
        :return: An instance of LROPoller that returns either ActiveDirectoryAdministrator or the
         result of cls(response)
        :rtype:
        ...
        if cont_token:
            return LROPoller[_models.ActiveDirectoryAdministrator].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ActiveDirectoryAdministrator](
    ...
    def list_by_server(
    ...
    ) -> Iterable["_models.ActiveDirectoryAdministrator"]:
        ...
        :return: An iterator like instance of either ActiveDirectoryAdministrator or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.postgresql_flexibleservers.models.ActiveDirectoryAdministrator]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
