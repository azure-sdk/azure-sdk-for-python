...
def build_create_or_update_request(
    ...
    path_format_arguments = {
        ...
        "firewallRuleName": _SERIALIZER.url(
            "firewall_rule_name", firewall_rule_name, "str", min_length=1, pattern=r"^[-\w\._]+$"
        ),
    }
...
class FirewallRulesOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either FirewallRule or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.postgresql_flexibleservers.models.FirewallRule]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresql_flexibleservers.models.FirewallRule or IO[bytes]
        :return: An instance of LROPoller that returns either FirewallRule or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.postgresql_flexibleservers.models.FirewallRule]
    ...
    def list_by_server(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.postgresql_flexibleservers.models.FirewallRule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
