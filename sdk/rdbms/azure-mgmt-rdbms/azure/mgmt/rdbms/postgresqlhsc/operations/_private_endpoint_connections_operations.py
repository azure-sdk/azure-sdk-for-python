    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "privateEndpointConnectionName": _SERIALIZER.url(
            "private_endpoint_connection_name", private_endpoint_connection_name, "str", pattern=r"^[-\w\._]+$"
        ),
    }
...
class PrivateEndpointConnectionsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.rdbms.postgresqlhsc.CosmosDBForPostgreSQL`'s
    ...
    def list_by_cluster(
        ...
        :return: An iterator like instance of either PrivateEndpointConnection or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.postgresqlhsc.models.PrivateEndpointConnection]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.rdbms.postgresqlhsc.models.PrivateEndpointConnection
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The required parameters for approving a private endpoint connection.
         Required.
        :type parameters: ~azure.mgmt.rdbms.postgresqlhsc.models.PrivateEndpointConnection
        ...
        :return: An instance of LROPoller that returns either PrivateEndpointConnection or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.postgresqlhsc.models.PrivateEndpointConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresqlhsc.models.PrivateEndpointConnection or IO
