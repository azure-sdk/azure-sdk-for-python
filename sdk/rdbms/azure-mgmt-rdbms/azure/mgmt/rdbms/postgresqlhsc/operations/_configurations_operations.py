...
class ConfigurationsOperations:
    ...
    def list_by_cluster(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.postgresqlhsc.models.Configuration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.rdbms.postgresqlhsc.models.Configuration
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def get_coordinator(
        ...
        :rtype: ~azure.mgmt.rdbms.postgresqlhsc.models.ServerConfiguration
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_update_on_coordinator(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresqlhsc.models.ServerConfiguration
        ...
        :return: An instance of LROPoller that returns either ServerConfiguration or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.postgresqlhsc.models.ServerConfiguration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update_on_coordinator(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresqlhsc.models.ServerConfiguration or IO
