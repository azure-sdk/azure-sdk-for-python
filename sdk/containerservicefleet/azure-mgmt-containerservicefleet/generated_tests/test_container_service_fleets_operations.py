...
class TestContainerServiceFleetsOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_fleets_begin_create(self, resource_group):
        response = self.client.fleets.begin_create(
            resource_group_name=resource_group.name,
            fleet_name="str",
            resource={
                "location": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_fleets_begin_update_async(self, resource_group):
        response = self.client.fleets.begin_update_async(
            resource_group_name=resource_group.name,
            fleet_name="str",
            properties={
                "identity": {
