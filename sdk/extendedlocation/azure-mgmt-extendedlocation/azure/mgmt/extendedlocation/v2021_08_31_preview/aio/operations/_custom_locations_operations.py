...
class CustomLocationsOperations:
    ...
    def list_operations(self, **kwargs: Any) -> AsyncIterable["_models.CustomLocationOperation"]:
        ...
        :return: An iterator like instance of either CustomLocationOperation or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.extendedlocation.v2021_08_31_preview.models.CustomLocationOperation]
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version or "2021-08-31-preview")
        )
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.CustomLocation"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.extendedlocation.v2021_08_31_preview.models.CustomLocation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either CustomLocation or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.extendedlocation.v2021_08_31_preview.models.CustomLocation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.extendedlocation.v2021_08_31_preview.models.CustomLocation or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either CustomLocation or the result of
         cls(response)
        :rtype:
    ...
    def list_enabled_resource_types(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.extendedlocation.v2021_08_31_preview.models.EnabledResourceType]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
