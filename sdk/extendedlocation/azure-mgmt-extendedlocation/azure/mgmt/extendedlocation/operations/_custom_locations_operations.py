...
def build_list_enabled_resource_types_request(  # pylint: disable=name-too-long
    resource_group_name: str, resource_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class CustomLocationsOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.CustomLocation"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.extendedlocation.models.CustomLocation]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either CustomLocation or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.extendedlocation.models.CustomLocation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.CustomLocation].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.CustomLocation](
    ...
    def list_enabled_resource_types(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.extendedlocation.models.EnabledResourceType]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.EnabledResourceTypeListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("EnabledResourceTypeListResult", pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.next_link or None, iter(list_of_elem)
