...
def main():
    ...
    response = client.iac_profiles.quick_template(
        ...
        parameters={"quickStartTemplateType": "HCI", "templateName": "base"},
    )
    print(response)


# x-ms-original-file: specification/developerhub/resource-manager/Microsoft.DevHub/preview/2024-07-01-preview/examples/IacProfile_QuickTemplate.json
