...
class IacTemplateProperties(_serialization.Model):
    ...
    :ivar quick_start_template_type: Determines the authorization status of requests. Known values
     are: "None", "HCI", "HCIAKS", "HCIARCVM", and "ALL".
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword quick_start_template_type: Determines the authorization status of requests. Known
         values are: "None", "HCI", "HCIAKS", "HCIARCVM", and "ALL".
...
class ScaleProperty(_serialization.Model):
    ...
    :vartype stage: str
    :ivar number_of_stores: Number of the store.
    :vartype number_of_stores: int
    """

    _attribute_map = {
        "region": {"key": "region", "type": "str"},
        "stage": {"key": "stage", "type": "str"},
        "number_of_stores": {"key": "numberOfStores", "type": "int"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        number_of_stores: Optional[int] = None,
        **kwargs: Any
    ) -> None:
        """
        ...
        :paramtype stage: str
        :keyword number_of_stores: Number of the store.
        :paramtype number_of_stores: int
        """
        super().__init__(**kwargs)
        self.region = region
        self.stage = stage
...
class ScaleTemplateRequest(_serialization.Model):
    ...
    :ivar template_name: Template Name.
    :vartype template_name: str
    :ivar scale_properties:
    :vartype scale_properties: list[~azure.mgmt.devhub.models.ScaleProperty]
    """

    _attribute_map = {
        "template_name": {"key": "templateName", "type": "str"},
        "scale_properties": {"key": "scaleProperties", "type": "[ScaleProperty]"},
    }
    ...
    def __init__(
        ...
        *,
        template_name: Optional[str] = None,
        scale_properties: Optional[List["_models.ScaleProperty"]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword template_name: Template Name.
        :paramtype template_name: str
        :keyword scale_properties:
        :paramtype scale_properties: list[~azure.mgmt.devhub.models.ScaleProperty]
        """
        super().__init__(**kwargs)
        self.template_name = template_name
