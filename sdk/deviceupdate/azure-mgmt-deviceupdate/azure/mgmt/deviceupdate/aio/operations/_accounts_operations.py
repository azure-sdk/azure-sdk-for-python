...
class AccountsOperations:
    ...
    async def begin_create(
        ...
        :param account_name: Account name. Required.
        :type account_name: str
        :param account: Account details. Is either a Account type or a IO[bytes] type. Required.
        :type account: ~azure.mgmt.deviceupdate.models.Account or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Account or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.deviceupdate.models.Account]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        account_name: str,
        account_update_payload: Union[_models.AccountUpdate, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def begin_update(
        ...
        resource_group_name: str,
        account_name: str,
        account_update_payload: IO[bytes],
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.Account]:
        ...
        :type account_name: str
        :param account_update_payload: Updated Account. Required.
        :type account_update_payload: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either Account or the result of
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param account_name: Account name. Required.
        :type account_name: str
        :param account_update_payload: Updated Account. Is either a AccountUpdate type or a IO[bytes]
         type. Required.
        :type account_update_payload: ~azure.mgmt.deviceupdate.models.AccountUpdate or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Account or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.deviceupdate.models.Account]
        :raises ~azure.core.exceptions.HttpResponseError:
