...
class PrivateLinkResourcesOperations:
    ...
    def list_by_account(
    ...
    ) -> AsyncIterable["_models.GroupInformation"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.deviceupdate.models.GroupInformation]
    ...
    async def get(
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.GroupInformation] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("GroupInformation", pipeline_response.http_response)
