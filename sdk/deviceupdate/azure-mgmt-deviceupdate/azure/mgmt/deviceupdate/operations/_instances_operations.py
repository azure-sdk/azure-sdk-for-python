...
class InstancesOperations:
    ...
    def get(self, resource_group_name: str, account_name: str, instance_name: str, **kwargs: Any) -> _models.Instance:
        ...
        deserialized = self._deserialize("Instance", pipeline_response.http_response)
    ...
    def _create_initial(
        ...
        account_name: str,
        instance_name: str,
        instance: Union[_models.Instance, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param instance_name: Instance name. Required.
        :type instance_name: str
        :param instance: Instance details. Is either a Instance type or a IO[bytes] type. Required.
        :type instance: ~azure.mgmt.deviceupdate.models.Instance or IO[bytes]
        :return: An instance of LROPoller that returns either Instance or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.deviceupdate.models.Instance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type instance_name: str
        :param tag_update_payload: Updated tags. Required.
        :type tag_update_payload: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: Instance or the result of cls(response)
    ...
    def update(
        ...
        account_name: str,
        instance_name: str,
        tag_update_payload: Union[_models.TagUpdate, IO[bytes]],
        **kwargs: Any
    ) -> _models.Instance:
        """Updates instance's tags.
        ...
        :param instance_name: Instance name. Required.
        :type instance_name: str
        :param tag_update_payload: Updated tags. Is either a TagUpdate type or a IO[bytes] type.
         Required.
        :type tag_update_payload: ~azure.mgmt.deviceupdate.models.TagUpdate or IO[bytes]
        :return: Instance or the result of cls(response)
        :rtype: ~azure.mgmt.deviceupdate.models.Instance
        :raises ~azure.core.exceptions.HttpResponseError:
        """
