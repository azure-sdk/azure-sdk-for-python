...
class TestDeviceUpdateMgmtAccountsOperations(AzureMgmtRecordedTestCase):
    ...
    def test_head(self, resource_group):
        response = self.client.accounts.head(
            resource_group_name=resource_group.name,
            account_name="str",
            api_version="2023-07-01",
        )
    ...
    def test_begin_create(self, resource_group):
        response = self.client.accounts.begin_create(
            ...
            account={
                "location": "str",
                "encryption": {"keyVaultKeyUri": "str", "userAssignedIdentity": "str"},
                "hostName": "str",
                "id": "str",
                "identity": {
                    "type": "str",
                ...
                "locations": [{"name": "str", "role": "Primary"}],
                "name": "str",
