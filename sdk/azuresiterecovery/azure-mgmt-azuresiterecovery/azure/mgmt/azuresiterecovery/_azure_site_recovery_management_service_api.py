...
class AzureSiteRecoveryManagementServiceAPI(
    ...
    :vartype dra: azure.mgmt.azuresiterecovery.operations.DraOperations
    :ivar dra_operation_status: DraOperationStatusOperations operations
    :vartype dra_operation_status:
     azure.mgmt.azuresiterecovery.operations.DraOperationStatusOperations
    :ivar email_configuration: EmailConfigurationOperations operations
    :vartype email_configuration:
     azure.mgmt.azuresiterecovery.operations.EmailConfigurationOperations
    :ivar event: EventOperations operations
    :vartype event: azure.mgmt.azuresiterecovery.operations.EventOperations
    :ivar fabric: FabricOperations operations
    :vartype fabric: azure.mgmt.azuresiterecovery.operations.FabricOperations
    :ivar fabric_operations_status: FabricOperationsStatusOperations operations
    :vartype fabric_operations_status:
     azure.mgmt.azuresiterecovery.operations.FabricOperationsStatusOperations
    :ivar policy: PolicyOperations operations
    :vartype policy: azure.mgmt.azuresiterecovery.operations.PolicyOperations
    :ivar policy_operation_status: PolicyOperationStatusOperations operations
    :vartype policy_operation_status:
     azure.mgmt.azuresiterecovery.operations.PolicyOperationStatusOperations
    :ivar protected_item: ProtectedItemOperations operations
    :vartype protected_item: azure.mgmt.azuresiterecovery.operations.ProtectedItemOperations
    ...
    :vartype protected_item_operation_status:
     azure.mgmt.azuresiterecovery.operations.ProtectedItemOperationStatusOperations
    :ivar recovery_points: RecoveryPointsOperations operations
    :vartype recovery_points: azure.mgmt.azuresiterecovery.operations.RecoveryPointsOperations
    :ivar replication_extension: ReplicationExtensionOperations operations
    :vartype replication_extension:
     azure.mgmt.azuresiterecovery.operations.ReplicationExtensionOperations
    ...
    :vartype replication_extension_operation_status:
     azure.mgmt.azuresiterecovery.operations.ReplicationExtensionOperationStatusOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.azuresiterecovery.operations.Operations
    :ivar vault: VaultOperations operations
    :vartype vault: azure.mgmt.azuresiterecovery.operations.VaultOperations
    :ivar vault_operation_status: VaultOperationStatusOperations operations
    :vartype vault_operation_status:
     azure.mgmt.azuresiterecovery.operations.VaultOperationStatusOperations
    :ivar workflow: WorkflowOperations operations
    :vartype workflow: azure.mgmt.azuresiterecovery.operations.WorkflowOperations
    :ivar workflow_operation_status: WorkflowOperationStatusOperations operations
    :vartype workflow_operation_status:
     azure.mgmt.azuresiterecovery.operations.WorkflowOperationStatusOperations
