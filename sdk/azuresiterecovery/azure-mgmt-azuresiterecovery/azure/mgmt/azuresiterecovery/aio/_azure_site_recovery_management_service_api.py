...
class AzureSiteRecoveryManagementServiceAPI(
    ...
    :vartype dra: azure.mgmt.azuresiterecovery.aio.operations.DraOperations
    :ivar dra_operation_status: DraOperationStatusOperations operations
    :vartype dra_operation_status:
     azure.mgmt.azuresiterecovery.aio.operations.DraOperationStatusOperations
    :ivar email_configuration: EmailConfigurationOperations operations
    :vartype email_configuration:
     azure.mgmt.azuresiterecovery.aio.operations.EmailConfigurationOperations
    :ivar event: EventOperations operations
    :vartype event: azure.mgmt.azuresiterecovery.aio.operations.EventOperations
    :ivar fabric: FabricOperations operations
    :vartype fabric: azure.mgmt.azuresiterecovery.aio.operations.FabricOperations
    :ivar fabric_operations_status: FabricOperationsStatusOperations operations
    :vartype fabric_operations_status:
     azure.mgmt.azuresiterecovery.aio.operations.FabricOperationsStatusOperations
    :ivar policy: PolicyOperations operations
    :vartype policy: azure.mgmt.azuresiterecovery.aio.operations.PolicyOperations
    :ivar policy_operation_status: PolicyOperationStatusOperations operations
    :vartype policy_operation_status:
     azure.mgmt.azuresiterecovery.aio.operations.PolicyOperationStatusOperations
    :ivar protected_item: ProtectedItemOperations operations
    :vartype protected_item: azure.mgmt.azuresiterecovery.aio.operations.ProtectedItemOperations
    ...
    :vartype protected_item_operation_status:
     azure.mgmt.azuresiterecovery.aio.operations.ProtectedItemOperationStatusOperations
    :ivar recovery_points: RecoveryPointsOperations operations
    :vartype recovery_points: azure.mgmt.azuresiterecovery.aio.operations.RecoveryPointsOperations
    :ivar replication_extension: ReplicationExtensionOperations operations
    :vartype replication_extension:
     azure.mgmt.azuresiterecovery.aio.operations.ReplicationExtensionOperations
    ...
    :vartype replication_extension_operation_status:
     azure.mgmt.azuresiterecovery.aio.operations.ReplicationExtensionOperationStatusOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.azuresiterecovery.aio.operations.Operations
    :ivar vault: VaultOperations operations
    :vartype vault: azure.mgmt.azuresiterecovery.aio.operations.VaultOperations
    :ivar vault_operation_status: VaultOperationStatusOperations operations
    :vartype vault_operation_status:
     azure.mgmt.azuresiterecovery.aio.operations.VaultOperationStatusOperations
    :ivar workflow: WorkflowOperations operations
    :vartype workflow: azure.mgmt.azuresiterecovery.aio.operations.WorkflowOperations
    :ivar workflow_operation_status: WorkflowOperationStatusOperations operations
    :vartype workflow_operation_status:
     azure.mgmt.azuresiterecovery.aio.operations.WorkflowOperationStatusOperations
    ...
    def __init__(
        ...
        self._config = AzureSiteRecoveryManagementServiceAPIConfiguration(credential=credential, **kwargs)
