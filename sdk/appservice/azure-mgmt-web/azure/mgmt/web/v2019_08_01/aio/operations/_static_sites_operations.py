...
class StaticSitesOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace_async
    async def delete_static_site(self, resource_group_name: str, name: str, **kwargs: Any) -> None:
    ...
    @distributed_trace_async
    async def delete_static_site_build(self, resource_group_name: str, name: str, pr_id: str, **kwargs: Any) -> None:
    ...
    @distributed_trace_async
    async def validate_custom_domain_can_be_added_to_static_site(  # pylint: disable=name-too-long
        self, resource_group_name: str, name: str, domain_name: str, **kwargs: Any
    ) -> None:
    ...
    @distributed_trace_async
    async def detach_static_site(self, resource_group_name: str, name: str, **kwargs: Any) -> None:
