...
class WebSiteManagementClient(WebSiteManagementClientOperationsMixin, MultiApiClientMixin, _SDKClient):
    ...
    def connection_gateway_installations(self):
        """Instance depends on the API version:
           ...
           * 2016-06-01: :class:`ConnectionGatewayInstallationsOperations<azure.mgmt.web.v2016_06_01.aio.operations.ConnectionGatewayInstallationsOperations>`
        """
        api_version = self._get_api_version('connection_gateway_installations')
        if api_version == '2016-06-01':
            from ..v2016_06_01.aio.operations import ConnectionGatewayInstallationsOperations as OperationClass
        else:
    ...
    def connection_gateways(self):
        """Instance depends on the API version:
           ...
           * 2016-06-01: :class:`ConnectionGatewaysOperations<azure.mgmt.web.v2016_06_01.aio.operations.ConnectionGatewaysOperations>`
        """
        api_version = self._get_api_version('connection_gateways')
        if api_version == '2016-06-01':
            from ..v2016_06_01.aio.operations import ConnectionGatewaysOperations as OperationClass
        else:
    ...
    def connections(self):
        """Instance depends on the API version:
           ...
           * 2016-06-01: :class:`ConnectionsOperations<azure.mgmt.web.v2016_06_01.aio.operations.ConnectionsOperations>`
        """
        api_version = self._get_api_version('connections')
        if api_version == '2016-06-01':
            from ..v2016_06_01.aio.operations import ConnectionsOperations as OperationClass
        else:
    ...
    def custom_apis(self):
        """Instance depends on the API version:
           ...
           * 2016-06-01: :class:`CustomApisOperations<azure.mgmt.web.v2016_06_01.aio.operations.CustomApisOperations>`
        """
        api_version = self._get_api_version('custom_apis')
        if api_version == '2016-06-01':
            from ..v2016_06_01.aio.operations import CustomApisOperations as OperationClass
        else:
    ...
    def managed_apis(self):
        """Instance depends on the API version:
           ...
           * 2016-06-01: :class:`ManagedApisOperations<azure.mgmt.web.v2016_06_01.aio.operations.ManagedApisOperations>`
        """
        api_version = self._get_api_version('managed_apis')
        if api_version == '2016-06-01':
            from ..v2016_06_01.aio.operations import ManagedApisOperations as OperationClass
        else:
