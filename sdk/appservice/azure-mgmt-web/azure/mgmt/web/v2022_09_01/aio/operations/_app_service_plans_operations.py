...
class AppServicePlansOperations:  # pylint: disable=too-many-public-methods
    ...
    async def update(
        ...
        resource_group_name: str,
        name: str,
        app_service_plan_patch: _models.AppServicePlanPatchResource,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.AppServicePlan:
        ...
        :param name: Name of the App Service plan. Required.
        :type name: str
        :param app_service_plan_patch: Details of the App Service plan. Required.
        :type app_service_plan_patch: ~azure.mgmt.web.v2022_09_01.models.AppServicePlanPatchResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type name: str
        :param app_service_plan_patch: Details of the App Service plan. Required.
        :type app_service_plan_patch: IO
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def update(
        ...
        resource_group_name: str,
        name: str,
        app_service_plan_patch: Union[_models.AppServicePlanPatchResource, IO],
        **kwargs: Any
    ) -> _models.AppServicePlan:
        """Creates or updates an App Service Plan.
        ...
        :param name: Name of the App Service plan. Required.
        :type name: str
        :param app_service_plan_patch: Details of the App Service plan. Is either a
         AppServicePlanPatchResource type or a IO type. Required.
        :type app_service_plan_patch: ~azure.mgmt.web.v2022_09_01.models.AppServicePlanPatchResource or
         IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        ...
        _json = None
        _content = None
        if isinstance(app_service_plan_patch, (IO, bytes)):
            _content = app_service_plan_patch
        else:
            _json = self._serialize.body(app_service_plan_patch, "AppServicePlanPatchResource")
