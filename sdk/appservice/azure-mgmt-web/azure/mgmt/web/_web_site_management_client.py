...
class WebSiteManagementClient(WebSiteManagementClientOperationsMixin, MultiApiClientMixin, _SDKClient):
    ...
    LATEST_PROFILE = ProfileDefinition({
        _PROFILE_TAG: {
            ...
            'connection_gateway_installations': '2016-06-01',
            'connection_gateways': '2016-06-01',
            'connections': '2016-06-01',
            'container_apps': '2023-01-01',
            'container_apps_revisions': '2023-01-01',
            'custom_apis': '2016-06-01',
            'managed_apis': '2016-06-01',
    ...
    def models(cls, api_version=DEFAULT_API_VERSION):
        """Module depends on the API version:
           ...
           * 2016-06-01: :mod:`v2016_06_01.models<azure.mgmt.web.v2016_06_01.models>`
    ...
    @property
    def connection_gateway_installations(self):
        """Instance depends on the API version:

           * 2016-06-01: :class:`ConnectionGatewayInstallationsOperations<azure.mgmt.web.v2016_06_01.operations.ConnectionGatewayInstallationsOperations>`
        """
        api_version = self._get_api_version('connection_gateway_installations')
        if api_version == '2016-06-01':
            from .v2016_06_01.operations import ConnectionGatewayInstallationsOperations as OperationClass
        else:
            raise ValueError("API version {} does not have operation group 'connection_gateway_installations'".format(api_version))
        self._config.api_version = api_version
        return OperationClass(self._client, self._config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)), api_version)

    @property
    def connection_gateways(self):
        """Instance depends on the API version:

           * 2016-06-01: :class:`ConnectionGatewaysOperations<azure.mgmt.web.v2016_06_01.operations.ConnectionGatewaysOperations>`
        """
        api_version = self._get_api_version('connection_gateways')
        if api_version == '2016-06-01':
            from .v2016_06_01.operations import ConnectionGatewaysOperations as OperationClass
        else:
            raise ValueError("API version {} does not have operation group 'connection_gateways'".format(api_version))
        self._config.api_version = api_version
        return OperationClass(self._client, self._config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)), api_version)
    ...
    def connections(self):
        """Instance depends on the API version:
           ...
           * 2016-06-01: :class:`ConnectionsOperations<azure.mgmt.web.v2016_06_01.operations.ConnectionsOperations>`
        """
        api_version = self._get_api_version('connections')
        if api_version == '2016-06-01':
            from .v2016_06_01.operations import ConnectionsOperations as OperationClass
        else:
            raise ValueError("API version {} does not have operation group 'connections'".format(api_version))
        self._config.api_version = api_version
        return OperationClass(self._client, self._config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)), api_version)
    ...
    @property
    def custom_apis(self):
        """Instance depends on the API version:

           * 2016-06-01: :class:`CustomApisOperations<azure.mgmt.web.v2016_06_01.operations.CustomApisOperations>`
        """
        api_version = self._get_api_version('custom_apis')
        if api_version == '2016-06-01':
            from .v2016_06_01.operations import CustomApisOperations as OperationClass
        else:
            raise ValueError("API version {} does not have operation group 'custom_apis'".format(api_version))
        self._config.api_version = api_version
        return OperationClass(self._client, self._config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)), api_version)
    ...
    @property
    def managed_apis(self):
        """Instance depends on the API version:

           * 2016-06-01: :class:`ManagedApisOperations<azure.mgmt.web.v2016_06_01.operations.ManagedApisOperations>`
        """
        api_version = self._get_api_version('managed_apis')
        if api_version == '2016-06-01':
            from .v2016_06_01.operations import ManagedApisOperations as OperationClass
        else:
            raise ValueError("API version {} does not have operation group 'managed_apis'".format(api_version))
        self._config.api_version = api_version
        return OperationClass(self._client, self._config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)), api_version)
