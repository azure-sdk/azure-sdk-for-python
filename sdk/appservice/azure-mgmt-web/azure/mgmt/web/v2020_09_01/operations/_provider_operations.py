...
def build_get_available_stacks_request(
    *, os_type_selected: Optional[Union[str, _models.Enum4]] = None, **kwargs: Any
) -> HttpRequest:
...
def build_get_available_stacks_on_prem_request(  # pylint: disable=name-too-long
    subscription_id: str, *, os_type_selected: Optional[Union[str, _models.Enum5]] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ProviderOperations:
    ...
    def get_available_stacks(
        ...
        :type os_type_selected: str or ~azure.mgmt.web.v2020_09_01.models.Enum4
        :return: An iterator like instance of either ApplicationStackResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2020_09_01.models.ApplicationStackResource]
    ...
    def get_available_stacks_on_prem(
        self, os_type_selected: Optional[Union[str, _models.Enum5]] = None, **kwargs: Any
    ) -> Iterable["_models.ApplicationStackResource"]:
        """Get available application frameworks and their versions.
