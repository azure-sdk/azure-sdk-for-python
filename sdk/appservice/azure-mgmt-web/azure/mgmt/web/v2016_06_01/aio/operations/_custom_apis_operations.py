...
from ...operations._custom_apis_operations import (
    build_create_or_update_request,
    build_delete_request,
    build_extract_api_definition_from_wsdl_request,
    build_get_request,
    build_list_by_resource_group_request,
    build_list_request,
    build_list_wsdl_interfaces_request,
    build_move_request,
...
class CustomApisOperations:
    ...
    @distributed_trace_async
    async def delete(self, subscription_id: str, resource_group_name: str, api_name: str, **kwargs: Any) -> None:
        """Delete a custom API.
    ...
    @overload
    async def list_wsdl_interfaces(
        self,
        subscription_id: str,
        location: str,
    ...
    @overload
    async def extract_api_definition_from_wsdl(
        self,
        subscription_id: str,
        location: str,
        wsdl_definition: _models.WsdlDefinition,
