...
def build_list_request(subscription_id: str, location: str, **kwargs: Any) -> HttpRequest:
...
def build_get_request(subscription_id: str, location: str, gateway_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
