...
class ProviderOperations:
    ...
    def get_available_stacks(
        ...
        :type os_type_selected: str or ~azure.mgmt.web.v2023_12_01.models.ProviderOsTypeSelected
        :return: An iterator like instance of either ApplicationStackResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2023_12_01.models.ApplicationStackResource]
    ...
    def get_function_app_stacks(
        ...
        :param stack_os_type: Stack OS Type. Known values are: "Windows", "Linux", and "All". Default
         value is None.
        :type stack_os_type: str or ~azure.mgmt.web.v2023_12_01.models.ProviderStackOsType
        :return: An iterator like instance of either FunctionAppStack or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2023_12_01.models.FunctionAppStack]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def get_web_app_stacks_for_location(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2023_12_01.models.WebAppStack]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
