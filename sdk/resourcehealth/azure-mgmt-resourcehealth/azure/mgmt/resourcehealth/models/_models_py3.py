...
class AvailabilityStatus(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype properties: ~azure.mgmt.resourcehealth.models.AvailabilityStatusProperties
        """
...
class AvailabilityStatusListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.resourcehealth.models.AvailabilityStatus]
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.resourcehealth.models.AvailabilityStatus]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword reason_chronicity: Chronicity of the availability transition. Known values are:
         "Transient" and "Persistent".
        :paramtype reason_chronicity: str or ~azure.mgmt.resourcehealth.models.ReasonChronicityTypes
        ...
        :keyword recommended_actions: Lists actions the user can take based on the current
         availabilityState of the resource.
        :paramtype recommended_actions: list[~azure.mgmt.resourcehealth.models.RecommendedAction]
...
class EmergingIssueImpact(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype regions: list[~azure.mgmt.resourcehealth.models.ImpactedRegion]
        """
        super().__init__(**kwargs)
        self.id = id
        self.name = name
...
class EmergingIssueListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.resourcehealth.models.EmergingIssuesGetResult]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype value: list[~azure.mgmt.resourcehealth.models.EmergingIssuesGetResult]
...
class EmergingIssuesGetResult(ProxyResource):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype status_banners: list[~azure.mgmt.resourcehealth.models.StatusBanner]
        :keyword status_active_events: The list of emerging issues of active event type.
        :paramtype status_active_events: list[~azure.mgmt.resourcehealth.models.StatusActiveEvent]
        """
        super().__init__(**kwargs)
...
class Event(ProxyResource):
     ...
     * False Positive: After investigation, we've determined your service is healthy and service
     issues did not impact your services as originally communicated.
     * Preliminary PIR: For our largest, most impactful service issues a Preliminary Post Incident
     Review (PIR) is published generally within 72 hours of mitigation, to summarize what we have
     learned so far from the still-in-progress investigation.
     * Final PIR: For service issues, a Final Post Incident Review (PIR) may be published to provide
     additional details or learnings. Sometimes this requires us to complete an internal
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :paramtype level: str or ~azure.mgmt.resourcehealth.models.LevelValues
        ...
        :paramtype article: ~azure.mgmt.resourcehealth.models.EventPropertiesArticle
        :keyword links: Useful links of event.
        :paramtype links: list[~azure.mgmt.resourcehealth.models.Link]
        ...
        :paramtype impact: list[~azure.mgmt.resourcehealth.models.Impact]
        ...
        :paramtype faqs: list[~azure.mgmt.resourcehealth.models.Faq]
...
class EventImpactedResourceListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.resourcehealth.models.EventImpactedResource]
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.resourcehealth.models.EventImpactedResource]
...
class EventPropertiesRecommendedActions(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype actions:
         list[~azure.mgmt.resourcehealth.models.EventPropertiesRecommendedActionsItem]
...
class ImpactedResourceStatus(ProxyResource):
    ...
    :ivar reason_type: When the resource's availabilityState is Unavailable, it describes where the
     ...
     "UserInitiated".
    :vartype reason_type: str or ~azure.mgmt.resourcehealth.models.ReasonTypeValues
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword reason_type: When the resource's availabilityState is Unavailable, it describes where
         ...
         "UserInitiated".
        :paramtype reason_type: str or ~azure.mgmt.resourcehealth.models.ReasonTypeValues
...
class Link(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype type: str or ~azure.mgmt.resourcehealth.models.LinkTypeValues
        :keyword display_text: Display text of link.
        :paramtype display_text: ~azure.mgmt.resourcehealth.models.LinkDisplayText
...
class MetadataEntity(ProxyResource):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype applicable_scenarios: list[str or ~azure.mgmt.resourcehealth.models.Scenario]
        :keyword supported_values: The list of supported values.
        :paramtype supported_values:
         list[~azure.mgmt.resourcehealth.models.MetadataSupportedValueDetail]
        """
        super().__init__(**kwargs)
...
class MetadataEntityListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.resourcehealth.models.MetadataEntity]
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.resourcehealth.models.MetadataEntity]
...
class Operation(_serialization.Model):
    ...
    def __init__(
        ...
        :paramtype display: ~azure.mgmt.resourcehealth.models.OperationDisplay
        """
        super().__init__(**kwargs)
        self.name = name
...
class OperationListResult(_serialization.Model):
    ...
    def __init__(self, *, value: List["_models.Operation"], **kwargs: Any) -> None:
        ...
        :keyword value: List of operations available in the Microsoft.ResourceHealth resource provider.
         Required.
        :paramtype value: list[~azure.mgmt.resourcehealth.models.Operation]
        """
        super().__init__(**kwargs)
        self.value = value
...
class ServiceImpactingEvent(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype status: ~azure.mgmt.resourcehealth.models.ServiceImpactingEventStatus
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword severity: The severity level of this active event. Known values are: "Information",
         "Warning", and "Error".
        :paramtype severity: str or ~azure.mgmt.resourcehealth.models.SeverityValues
        :keyword stage: The stage of this active event. Known values are: "Active", "Resolve", and
         "Archived".
        :paramtype stage: str or ~azure.mgmt.resourcehealth.models.StageValues
        ...
        :paramtype impacts: list[~azure.mgmt.resourcehealth.models.EmergingIssueImpact]
        """
        super().__init__(**kwargs)
        self.title = title
        self.description = description
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword created_by_type: The type of identity that created the resource. Known values are:
         "User", "Application", "ManagedIdentity", and "Key".
        :paramtype created_by_type: str or ~azure.mgmt.resourcehealth.models.CreatedByType
        ...
        :paramtype last_modified_by_type: str or ~azure.mgmt.resourcehealth.models.CreatedByType
