...
class ImpactedResourcesOperations:
    ...
    def list_by_subscription_id_and_event_id(
        ...
        :return: An iterator like instance of either EventImpactedResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resourcehealth.v2023_10_01_preview.models.EventImpactedResource]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.resourcehealth.v2023_10_01_preview.models.EventImpactedResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
