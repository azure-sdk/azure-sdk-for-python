...
class MetadataOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.MetadataEntity"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resourcehealth.v2023_10_01_preview.models.MetadataEntity]
    ...
    async def get_entity(self, name: str, **kwargs: Any) -> _models.MetadataEntity:
        ...
        :rtype: ~azure.mgmt.resourcehealth.v2023_10_01_preview.models.MetadataEntity
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
