...
def build_update_request(
    ...
    **kwargs: Any
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2024-10-15-preview"))
...
class GroupQuotaSubscriptionAllocationRequestOperations:  # pylint: disable=name-too-long
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either SubscriptionQuotaAllocationsList or the
