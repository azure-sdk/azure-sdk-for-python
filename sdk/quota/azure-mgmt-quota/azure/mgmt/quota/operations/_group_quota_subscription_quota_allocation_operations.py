...
def build_create_or_update_request(
    management_group_id: str, group_quota_name: str, resource_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class GroupQuotaSubscriptionQuotaAllocationOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either SubscriptionQuotaAllocations or An
         instance of LROPoller that returns either LROResponse or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.quota.models.SubscriptionQuotaAllocations] or
