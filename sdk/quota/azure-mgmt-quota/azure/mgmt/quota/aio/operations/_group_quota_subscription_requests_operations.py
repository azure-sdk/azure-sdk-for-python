...
from ...operations._group_quota_subscription_requests_operations import build_get_request, build_list_request
...
class GroupQuotaSubscriptionRequestsOperations:
    ...
    async def get(
        ...
        deserialized = self._deserialize("GroupQuotaSubscriptionRequestStatus", pipeline_response.http_response)
