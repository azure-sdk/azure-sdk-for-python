...
class QuotaMgmtClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :ivar group_quota_enforcement: GroupQuotaEnforcementOperations operations
    :vartype group_quota_enforcement:
     azure.mgmt.quota.aio.operations.GroupQuotaEnforcementOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.group_quota_enforcement = GroupQuotaEnforcementOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
