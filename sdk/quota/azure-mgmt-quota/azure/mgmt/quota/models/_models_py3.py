...
class GroupQuotaDetails(_serialization.Model):
    ...
    :ivar resource_provider_scope: ResourceProviderScope  for the quota request. Format:
     /providers/{ResourceProviderName}/locations/{Azure region} Example:
     /providers/{Microsoft.Compute}/locations/{eastus}. Please replace the ResourceProviderName,
     Azure region as per the requested resource.
    :vartype resource_provider_scope: str
    ...
    :ivar allocated_to_subscriptions: Allocated Group Quota to subscriptions.
    :vartype allocated_to_subscriptions: list[~azure.mgmt.quota.models.AllocatedToSubscription]
    ...
    _attribute_map = {
        "resource_provider_scope": {"key": "resourceProviderScope", "type": "str"},
        "limit": {"key": "limit", "type": "int"},
        "comment": {"key": "comment", "type": "str"},
        "name": {"key": "name", "type": "GroupQuotaDetailsName"},
        "unit": {"key": "unit", "type": "str"},
        "available_limit": {"key": "availableLimit", "type": "int"},
        "allocated_to_subscriptions": {"key": "allocatedToSubscriptions", "type": "[AllocatedToSubscription]"},
    ...
    def __init__(
        self,
        *,
        resource_provider_scope: Optional[str] = None,
        limit: Optional[int] = None,
        comment: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword resource_provider_scope: ResourceProviderScope  for the quota request. Format:
         /providers/{ResourceProviderName}/locations/{Azure region} Example:
         /providers/{Microsoft.Compute}/locations/{eastus}. Please replace the ResourceProviderName,
         Azure region as per the requested resource.
        :paramtype resource_provider_scope: str
        ...
        """
        super().__init__(**kwargs)
        self.resource_provider_scope = resource_provider_scope
        self.limit = limit
...
class GroupQuotaSubscriptionRequestStatusProperties(_serialization.Model):
...
class QuotaAllocationRequestBaseProperties(_serialization.Model):
    ...
    def __init__(
        self, *, limit: Optional[int] = None, resource_provider_scope: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
...
class QuotaAllocationRequestStatusProperties(_serialization.Model):
    ...
    :ivar requested_resource: The new quota limit requested.
    ...
    def __init__(
        ...
        """
        :keyword requested_resource: The new quota limit requested.
...
class ResourceBaseRequest(_serialization.Model):
    ...
    def __init__(self, *, limits: Optional[int] = None, **kwargs: Any) -> None:
        """
...
class SubscriptionQuotaDetails(_serialization.Model):
    ...
    def __init__(
        self, *, resource_provider_scope: Optional[str] = None, limit: Optional[int] = None, **kwargs: Any
    ) -> None:
        """
        :keyword resource_provider_scope: ResourceProviderScope  for the quota request. Format:
         /providers/{ResourceProviderName}/locations/{Azure region} Example:
