...
class DataBoxEdgeManagementClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.devices = DevicesOperations(self._client, self._config, self._serialize, self._deserialize, "2019-07-01")
        self.alerts = AlertsOperations(self._client, self._config, self._serialize, self._deserialize, "2019-07-01")
        ...
        self.jobs = JobsOperations(self._client, self._config, self._serialize, self._deserialize, "2019-07-01")
        self.nodes = NodesOperations(self._client, self._config, self._serialize, self._deserialize, "2019-07-01")
        self.operations_status = OperationsStatusOperations(
            self._client, self._config, self._serialize, self._deserialize, "2019-07-01"
        )
        self.orders = OrdersOperations(self._client, self._config, self._serialize, self._deserialize, "2019-07-01")
        self.roles = RolesOperations(self._client, self._config, self._serialize, self._deserialize, "2019-07-01")
        self.shares = SharesOperations(self._client, self._config, self._serialize, self._deserialize, "2019-07-01")
        self.storage_account_credentials = StorageAccountCredentialsOperations(
            self._client, self._config, self._serialize, self._deserialize, "2019-07-01"
        )
        self.triggers = TriggersOperations(self._client, self._config, self._serialize, self._deserialize, "2019-07-01")
        self.users = UsersOperations(self._client, self._config, self._serialize, self._deserialize, "2019-07-01")
