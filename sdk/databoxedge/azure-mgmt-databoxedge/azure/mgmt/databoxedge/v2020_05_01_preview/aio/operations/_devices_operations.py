...
class DevicesOperations:
    ...
    def list_by_subscription(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.databoxedge.v2020_05_01_preview.models.DataBoxEdgeDevice]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type data_box_edge_device:
         ~azure.mgmt.databoxedge.v2020_05_01_preview.models.DataBoxEdgeDevice or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either DataBoxEdgeDevice or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databoxedge.v2020_05_01_preview.models.DataBoxEdgeDevice]
