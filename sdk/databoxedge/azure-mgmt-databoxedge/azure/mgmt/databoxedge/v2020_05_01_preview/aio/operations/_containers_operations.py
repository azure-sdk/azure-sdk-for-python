...
class ContainersOperations:
    ...
    def list_by_storage_account(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.databoxedge.v2020_05_01_preview.models.Container]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.databoxedge.v2020_05_01_preview.models.Container
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type container: ~azure.mgmt.databoxedge.v2020_05_01_preview.models.Container
        ...
        :return: An instance of AsyncLROPoller that returns either Container or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databoxedge.v2020_05_01_preview.models.Container]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param container: The container properties. Is either a Container type or a IO[bytes] type.
         Required.
        :type container: ~azure.mgmt.databoxedge.v2020_05_01_preview.models.Container or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Container or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databoxedge.v2020_05_01_preview.models.Container]
