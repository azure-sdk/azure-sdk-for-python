...
def build_check_resource_creation_feasibility_request(  # pylint: disable=name-too-long
...
class DeviceCapacityCheckOperations:
    ...
    def _check_resource_creation_feasibility_initial(  # pylint: disable=inconsistent-return-statements,name-too-long
        self,
        resource_group_name: str,
        device_name: str,
