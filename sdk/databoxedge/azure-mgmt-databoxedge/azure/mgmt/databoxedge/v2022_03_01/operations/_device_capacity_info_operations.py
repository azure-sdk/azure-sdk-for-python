...
def build_get_device_capacity_info_request(
...
class DeviceCapacityInfoOperations:
    ...
    def get_device_capacity_info(
        ...
        request = build_get_device_capacity_info_request(
            resource_group_name=resource_group_name,
            device_name=device_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self.get_device_capacity_info.metadata["url"],
            headers=_headers,
            params=_params,
        )
    ...
    get_device_capacity_info.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/deviceCapacityInfo/default"
    }
