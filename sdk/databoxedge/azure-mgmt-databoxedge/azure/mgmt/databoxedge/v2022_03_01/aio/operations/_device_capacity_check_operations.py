...
class DeviceCapacityCheckOperations:
    ...
    async def _check_resource_creation_feasibility_initial(  # pylint: disable=inconsistent-return-statements,name-too-long
        self,
    ...
    async def begin_check_resource_creation_feasibility(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        :type device_capacity_request_info:
         ~azure.mgmt.databoxedge.v2022_03_01.models.DeviceCapacityRequestInfo or IO[bytes]
        :param capacity_name: The capacity name. Default value is None.
        :type capacity_name: str
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
