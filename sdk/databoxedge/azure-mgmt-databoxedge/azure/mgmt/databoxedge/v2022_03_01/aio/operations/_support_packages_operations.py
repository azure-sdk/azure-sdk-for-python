...
class SupportPackagesOperations:
    ...
    async def _trigger_support_package_initial(  # pylint: disable=inconsistent-return-statements
        ...
        trigger_support_package_request: Union[_models.TriggerSupportPackageRequest, IO[bytes]],
        **kwargs: Any
    ) -> None:
        error_map = {
        ...
        _request = build_trigger_support_package_request(
    ...
    async def begin_trigger_support_package(
        ...
        **kwargs: Any
        ...
        :type trigger_support_package_request:
         ~azure.mgmt.databoxedge.v2022_03_01.models.TriggerSupportPackageRequest or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
