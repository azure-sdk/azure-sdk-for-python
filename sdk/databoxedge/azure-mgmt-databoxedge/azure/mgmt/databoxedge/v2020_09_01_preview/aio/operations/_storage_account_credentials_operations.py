...
class StorageAccountCredentialsOperations:
    ...
    def list_by_data_box_edge_device(
        ...
        :return: An iterator like instance of either StorageAccountCredential or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.databoxedge.v2020_09_01_preview.models.StorageAccountCredential]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databoxedge.v2020_09_01_preview.models.StorageAccountCredential]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type storage_account_credential:
         ~azure.mgmt.databoxedge.v2020_09_01_preview.models.StorageAccountCredential or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either StorageAccountCredential or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databoxedge.v2020_09_01_preview.models.StorageAccountCredential]
