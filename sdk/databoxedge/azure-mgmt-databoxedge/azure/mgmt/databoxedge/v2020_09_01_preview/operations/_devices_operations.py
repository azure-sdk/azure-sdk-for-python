...
def build_create_or_update_security_settings_request(  # pylint: disable=name-too-long
    device_name: str, resource_group_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_update_extended_information_request(  # pylint: disable=name-too-long
    device_name: str, resource_group_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class DevicesOperations:  # pylint: disable=too-many-public-methods
    ...
    def list_by_subscription(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.databoxedge.v2020_09_01_preview.models.DataBoxEdgeDevice]
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version or "2020-09-01-preview")
        )
    ...
    def get(self, device_name: str, resource_group_name: str, **kwargs: Any) -> _models.DataBoxEdgeDevice:
        ...
        :rtype: ~azure.mgmt.databoxedge.v2020_09_01_preview.models.DataBoxEdgeDevice
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type data_box_edge_device:
         ~azure.mgmt.databoxedge.v2020_09_01_preview.models.DataBoxEdgeDevice
        ...
        :return: An instance of LROPoller that returns either DataBoxEdgeDevice or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.databoxedge.v2020_09_01_preview.models.DataBoxEdgeDevice]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type data_box_edge_device:
         ~azure.mgmt.databoxedge.v2020_09_01_preview.models.DataBoxEdgeDevice or IO[bytes]
        :return: An instance of LROPoller that returns either DataBoxEdgeDevice or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.databoxedge.v2020_09_01_preview.models.DataBoxEdgeDevice]
        ...
        if cont_token:
            return LROPoller[_models.DataBoxEdgeDevice].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.DataBoxEdgeDevice](
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.databoxedge.v2020_09_01_preview.models.DataBoxEdgeDevicePatch
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: DataBoxEdgeDevice or the result of cls(response)
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :param parameters: The resource parameters. Is either a DataBoxEdgeDevicePatch type or a
         IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.databoxedge.v2020_09_01_preview.models.DataBoxEdgeDevicePatch or
         IO[bytes]
        :return: DataBoxEdgeDevice or the result of cls(response)
        :rtype: ~azure.mgmt.databoxedge.v2020_09_01_preview.models.DataBoxEdgeDevice
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def generate_certificate(
        ...
        :rtype: ~azure.mgmt.databoxedge.v2020_09_01_preview.models.GenerateCertResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def get_extended_information(
        ...
        :rtype: ~azure.mgmt.databoxedge.v2020_09_01_preview.models.DataBoxEdgeDeviceExtendedInfo
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def get_network_settings(
        ...
        :rtype: ~azure.mgmt.databoxedge.v2020_09_01_preview.models.NetworkSettings
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def _create_or_update_security_settings_initial(  # pylint: disable=inconsistent-return-statements,name-too-long
        self,
        device_name: str,
        resource_group_name: str,
    ...
    def begin_create_or_update_security_settings(
        ...
        **kwargs: Any
        ...
        :type security_settings: ~azure.mgmt.databoxedge.v2020_09_01_preview.models.SecuritySettings
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either None or the result of cls(response)
    ...
    def begin_create_or_update_security_settings(
        ...
        **kwargs: Any
        ...
        :param security_settings: The security settings. Is either a SecuritySettings type or a
         IO[bytes] type. Required.
        :type security_settings: ~azure.mgmt.databoxedge.v2020_09_01_preview.models.SecuritySettings or
         IO[bytes]
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def update_extended_information(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.databoxedge.v2020_09_01_preview.models.DataBoxEdgeDeviceExtendedInfoPatch
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: DataBoxEdgeDeviceExtendedInfo or the result of cls(response)
    ...
    def update_extended_information(
        ...
        **kwargs: Any
        ...
        :param parameters: The patch object. Is either a DataBoxEdgeDeviceExtendedInfoPatch type or a
         IO[bytes] type. Required.
        :type parameters:
         ~azure.mgmt.databoxedge.v2020_09_01_preview.models.DataBoxEdgeDeviceExtendedInfoPatch or
         IO[bytes]
        :return: DataBoxEdgeDeviceExtendedInfo or the result of cls(response)
        :rtype: ~azure.mgmt.databoxedge.v2020_09_01_preview.models.DataBoxEdgeDeviceExtendedInfo
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def get_update_summary(self, device_name: str, resource_group_name: str, **kwargs: Any) -> _models.UpdateSummary:
        ...
        :rtype: ~azure.mgmt.databoxedge.v2020_09_01_preview.models.UpdateSummary
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def upload_certificate(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.databoxedge.v2020_09_01_preview.models.UploadCertificateRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: UploadCertificateResponse or the result of cls(response)
        :rtype: ~azure.mgmt.databoxedge.v2020_09_01_preview.models.UploadCertificateResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
