...
class OrdersOperations:
    ...
    def list_by_data_box_edge_device(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.databoxedge.v2020_09_01.models.Order]
    ...
    async def get(self, device_name: str, resource_group_name: str, **kwargs: Any) -> _models.Order:
        ...
        :rtype: ~azure.mgmt.databoxedge.v2020_09_01.models.Order
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type order: ~azure.mgmt.databoxedge.v2020_09_01.models.Order
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either Order or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databoxedge.v2020_09_01.models.Order]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        :param order: The order to be created or updated. Is either a Order type or a IO[bytes] type.
         Required.
        :type order: ~azure.mgmt.databoxedge.v2020_09_01.models.Order or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Order or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databoxedge.v2020_09_01.models.Order]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def list_dc_access_code(
        ...
        :rtype: ~azure.mgmt.databoxedge.v2020_09_01.models.DCAccessCode
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
