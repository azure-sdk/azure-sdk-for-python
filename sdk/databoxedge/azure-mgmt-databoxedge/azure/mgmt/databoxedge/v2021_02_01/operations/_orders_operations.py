...
class OrdersOperations:
    ...
    def list_by_data_box_edge_device(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.databoxedge.v2021_02_01.models.Order]
    ...
    def get(self, device_name: str, resource_group_name: str, **kwargs: Any) -> _models.Order:
        ...
        :rtype: ~azure.mgmt.databoxedge.v2021_02_01.models.Order
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type order: ~azure.mgmt.databoxedge.v2021_02_01.models.Order
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either Order or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.databoxedge.v2021_02_01.models.Order]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        :param order: The order to be created or updated. Is either a Order type or a IO[bytes] type.
         Required.
        :type order: ~azure.mgmt.databoxedge.v2021_02_01.models.Order or IO[bytes]
        :return: An instance of LROPoller that returns either Order or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.databoxedge.v2021_02_01.models.Order]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_dc_access_code(self, device_name: str, resource_group_name: str, **kwargs: Any) -> _models.DCAccessCode:
        ...
        :rtype: ~azure.mgmt.databoxedge.v2021_02_01.models.DCAccessCode
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
