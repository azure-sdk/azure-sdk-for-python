...
class DiagnosticSettingsOperations:
    ...
    def _update_diagnostic_proactive_log_collection_settings_initial(  # pylint: disable=inconsistent-return-statements,name-too-long
        self,
        device_name: str,
    ...
    def _update_diagnostic_remote_support_settings_initial(  # pylint: disable=inconsistent-return-statements,name-too-long
        self,
        device_name: str,
        resource_group_name: str,
