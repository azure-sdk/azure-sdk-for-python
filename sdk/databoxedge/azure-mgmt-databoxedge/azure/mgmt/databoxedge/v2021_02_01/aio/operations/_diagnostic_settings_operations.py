...
class DiagnosticSettingsOperations:
    ...
    async def get_diagnostic_proactive_log_collection_settings(  # pylint: disable=name-too-long
        ...
        _request = build_get_diagnostic_proactive_log_collection_settings_request(
    ...
    async def _update_diagnostic_proactive_log_collection_settings_initial(  # pylint: disable=inconsistent-return-statements,name-too-long
        self,
        device_name: str,
        resource_group_name: str,
        proactive_log_collection_settings: Union[_models.DiagnosticProactiveLogCollectionSettings, IO[bytes]],
        **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
        ...
        _request = build_update_diagnostic_proactive_log_collection_settings_request(
            device_name=device_name,
            resource_group_name=resource_group_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    async def begin_update_diagnostic_proactive_log_collection_settings(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        :type proactive_log_collection_settings:
         ~azure.mgmt.databoxedge.v2021_02_01.models.DiagnosticProactiveLogCollectionSettings or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def get_diagnostic_remote_support_settings(
        ...
        _request = build_get_diagnostic_remote_support_settings_request(
            device_name=device_name,
            resource_group_name=resource_group_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    async def _update_diagnostic_remote_support_settings_initial(  # pylint: disable=inconsistent-return-statements,name-too-long
        self,
        device_name: str,
        resource_group_name: str,
        diagnostic_remote_support_settings: Union[_models.DiagnosticRemoteSupportSettings, IO[bytes]],
        **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
        ...
        _request = build_update_diagnostic_remote_support_settings_request(
            device_name=device_name,
            resource_group_name=resource_group_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    async def begin_update_diagnostic_remote_support_settings(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        :type diagnostic_remote_support_settings:
         ~azure.mgmt.databoxedge.v2021_02_01.models.DiagnosticRemoteSupportSettings or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
