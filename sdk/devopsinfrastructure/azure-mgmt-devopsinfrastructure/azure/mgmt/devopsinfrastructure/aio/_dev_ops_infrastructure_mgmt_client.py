...
class DevOpsInfrastructureMgmtClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype subscription_usages:
     azure.mgmt.devopsinfrastructure.aio.operations.SubscriptionUsagesOperations
    ...
    :type base_url: str
    :keyword api_version: Api Version. Default value is "2024-04-04-preview". Note that overriding
