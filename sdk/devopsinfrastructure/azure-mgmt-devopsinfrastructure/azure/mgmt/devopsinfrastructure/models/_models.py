...
class ArmOperationStatus(_model_base.Model):
    ...
    :ivar status: The operation status. Required. Known values are: "Succeeded", "Failed", and
     "Canceled".
    :vartype status: str or ~azure.mgmt.devopsinfrastructure.models.ResourceProvisioningState
...
class AutomaticResourcePredictionsProfile(ResourcePredictionsProfile, discriminator="Automatic"):
    ...
    :ivar kind: The stand-by agent scheme is determined based on historical demand. Required.
    ...
    kind: Literal["Automatic"] = rest_discriminator(name="kind")  # type: ignore
    """The stand-by agent scheme is determined based on historical demand. Required. Default value is
     \"Automatic\"."""
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:  # pylint: disable=useless-super-delegation
        super().__init__(*args, kind="Automatic", **kwargs)
...
class ManualResourcePredictionsProfile(ResourcePredictionsProfile, discriminator="Manual"):
    ...
    :ivar kind: Customer provides the stand-by agent scheme. Required. Default value is "Manual".
    :vartype kind: str
    """

    kind: Literal["Manual"] = rest_discriminator(name="kind")  # type: ignore
    """Customer provides the stand-by agent scheme. Required. Default value is \"Manual\"."""
