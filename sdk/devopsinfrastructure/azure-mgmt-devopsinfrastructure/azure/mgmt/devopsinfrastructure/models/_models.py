...
class PoolProperties(_model_base.Model):
    ...
    :ivar provisioning_state: The status of the curasdsadrent operation. Known values are:
    ...
    """The status of the curasdsadrent operation. Known values are: \"Succeeded\", \"Failed\",
