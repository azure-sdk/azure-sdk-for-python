...
class AzureDevOpsOrganizationProfile(OrganizationProfile):
    ...
    :ivar permission_profile: The type of permission which determines which accounts are adming on
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword permission_profile: The type of permission which determines which accounts are adming
...
class AzureDevOpsPermissionProfile(_serialization.Model):
    ...
    You probably want to use the sub-classes and not this class directly. Known sub-classes are:
    CreatorOnly, InheritPermissions, SpecificAccounts

    All required parameters must be populated in order to send to Azure.

    :ivar kind: Discriminator property for AzureDevOpsPermissionProfile. Required.
    :vartype kind: str
    """
    ...
    _subtype_map = {
        "kind": {"CreatorOnly": "CreatorOnly", "Inherit": "InheritPermissions", "SpecificAccounts": "SpecificAccounts"}
    }
...
class CreatorOnly(AzureDevOpsPermissionProfile):
...
class InheritPermissions(AzureDevOpsPermissionProfile):
    ...
    def __init__(self, **kwargs: Any) -> None:
        """ """
        super().__init__(**kwargs)
        self.kind: str = "Inherit"


class LogonType(_serialization.Model):
    ...
    :ivar kind: Discriminator property for LogonType. Required.
    :vartype kind: str
    """
    ...
    _subtype_map = {"kind": {"Interactive": "Interactive", "Service": "Service"}}
...
class OsProfile(_serialization.Model):
    ...
    :ivar logon_type: Determines how the service should be run. By default, this will be set to
     Service.
    :vartype logon_type: ~azure.mgmt.devopsinfrastructure.models.LogonType
    """
    ...
    _attribute_map = {
        ...
        "logon_type": {"key": "logonType", "type": "LogonType"},
    }

    def __init__(
        self,
        *,
        secrets_management_settings: "_models.SecretsManagementSettings",
        logon_type: Optional["_models.LogonType"] = None,
        **kwargs: Any
    ) -> None:
        """
        ...
        :keyword logon_type: Determines how the service should be run. By default, this will be set to
         Service.
        :paramtype logon_type: ~azure.mgmt.devopsinfrastructure.models.LogonType
        """
        super().__init__(**kwargs)
...
class Service(LogonType):
    ...
    def __init__(self, **kwargs: Any) -> None:
        """ """
        super().__init__(**kwargs)
        self.kind: str = "Service"


class SpecificAccounts(AzureDevOpsPermissionProfile):
    ...
    :ivar kind: Discriminator property for AzureDevOpsPermissionProfile. Required.
    :vartype kind: str
    :ivar users: User email adresses.
    :vartype users: list[str]
    :ivar groups: Group email adresses.
    ...
    def __init__(self, *, users: Optional[List[str]] = None, groups: Optional[List[str]] = None, **kwargs: Any) -> None:
        """
        :keyword users: User email adresses.
        :paramtype users: list[str]
        :keyword groups: Group email adresses.
        :paramtype groups: list[str]
        """
        super().__init__(**kwargs)
        self.kind: str = "SpecificAccounts"
        self.users = users
        self.groups = groups
