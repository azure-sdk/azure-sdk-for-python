...
class AzureResourceManagerCommonTypesManagedServiceIdentity(_serialization.Model):  # pylint: disable=name-too-long
...
class PoolUpdate(_serialization.Model):
    ...
    :ivar identity: The managed service identities assigned to this resource.
    :vartype identity:
     ~azure.mgmt.devopsinfrastructure.models.AzureResourceManagerCommonTypesManagedServiceIdentity
    :ivar tags: Resource tags.
    :vartype tags: dict[str, str]
    :ivar properties: The updatable properties of the Pool.
    :vartype properties: ~azure.mgmt.devopsinfrastructure.models.PoolUpdateProperties
    """

    _attribute_map = {
        "identity": {"key": "identity", "type": "AzureResourceManagerCommonTypesManagedServiceIdentity"},
        "tags": {"key": "tags", "type": "{str}"},
    ...
    def __init__(
        self,
        *,
        identity: Optional["_models.AzureResourceManagerCommonTypesManagedServiceIdentity"] = None,
        tags: Optional[Dict[str, str]] = None,
        ...
        **kwargs: Any
        ...
        :keyword tags: Resource tags.
        :paramtype tags: dict[str, str]
        :keyword properties: The updatable properties of the Pool.
...
class PoolUpdateProperties(_serialization.Model):
    ...
    _attribute_map = {
        ...
        "maximum_concurrency": {"key": "maximumConcurrency", "type": "int"},
        "organization_profile": {"key": "organizationProfile", "type": "OrganizationProfile"},
        "agent_profile": {"key": "agentProfile", "type": "AgentProfileUpdate"},
        "fabric_profile": {"key": "fabricProfile", "type": "FabricProfile"},
        "dev_center_project_resource_id": {"key": "devCenterProjectResourceId", "type": "str"},
    }
...
class Quota(ProxyResource):
    ...
    def __init__(self, *, properties: Optional["_models.QuotaProperties"] = None, **kwargs: Any) -> None:
        """
        :keyword properties: The resource-specific properties for this resource.
        :paramtype properties: ~azure.mgmt.devopsinfrastructure.models.QuotaProperties
        """
        super().__init__(**kwargs)
        self.properties = properties
...
class QuotaProperties(_serialization.Model):
    ...
    def __init__(self, *, unit: str, current_value: int, limit: int, name: "_models.QuotaName", **kwargs: Any) -> None:
        """
        ...
        :paramtype limit: int
        :keyword name: The details of the quota. Required.
        :paramtype name: ~azure.mgmt.devopsinfrastructure.models.QuotaName
        """
        super().__init__(**kwargs)
        self.unit = unit
