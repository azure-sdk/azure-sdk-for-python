...
class AgentProfileUpdate(_serialization.Model):
    """The agent profile of the machines in the pool.

    You probably want to use the sub-classes and not this class directly. Known sub-classes are:
    StatefulUpdate, StatelessAgentProfileUpdate
    ...
    :ivar resource_predictions_profile: Defines how the pool buffer/stand-by agents is provided.
    :vartype resource_predictions_profile:
     ~azure.mgmt.devopsinfrastructure.models.ResourcePredictionsProfileUpdate
    """
    ...
    _attribute_map = {
        ...
        "resource_predictions_profile": {
            "key": "resourcePredictionsProfile",
            "type": "ResourcePredictionsProfileUpdate",
        },
    }

    _subtype_map = {"kind": {"Stateful": "StatefulUpdate", "Stateless": "StatelessAgentProfileUpdate"}}

    def __init__(
        self,
        *,
        resource_predictions: Optional[JSON] = None,
        resource_predictions_profile: Optional["_models.ResourcePredictionsProfileUpdate"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword resource_predictions: Defines pool buffer/stand-by agents.
...
class ResourcePredictionsProfileUpdate(_serialization.Model):
    """Determines how the stand-by scheme should be provided.

    You probably want to use the sub-classes and not this class directly. Known sub-classes are:
    AutomaticResourcePredictionsProfileUpdate, ManualResourcePredictionsProfileUpdate
    ...
    _subtype_map = {
        "kind": {
            "Automatic": "AutomaticResourcePredictionsProfileUpdate",
            "Manual": "ManualResourcePredictionsProfileUpdate",
        }
    }
...
class AutomaticResourcePredictionsProfileUpdate(ResourcePredictionsProfileUpdate):  # pylint: disable=name-too-long
    """The stand-by agent scheme is determined based on historical demand.
...
class ImageVersion(ProxyResource):
    ...
    def __init__(self, *, version: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword version: Version of the image.
...
class ManualResourcePredictionsProfileUpdate(ResourcePredictionsProfileUpdate):
    """Customer provides the stand-by agent scheme.
...
class PoolUpdate(_serialization.Model):
    ...
    :vartype organization_profile: ~azure.mgmt.devopsinfrastructure.models.OrganizationProfile
    :ivar agent_profile: Defines how the machine will be handled once it executed a job.
    :vartype agent_profile: ~azure.mgmt.devopsinfrastructure.models.AgentProfileUpdate
    :ivar fabric_profile: Defines the type of fabric the agent will run on.
    :vartype fabric_profile: ~azure.mgmt.devopsinfrastructure.models.FabricProfile
    :ivar dev_center_project_resource_id: The resource id of the DevCenter Project the pool belongs
     to.
    ...
    _attribute_map = {
        ...
        "maximum_concurrency": {"key": "properties.maximumConcurrency", "type": "int"},
        "organization_profile": {"key": "properties.organizationProfile", "type": "OrganizationProfile"},
        "agent_profile": {"key": "properties.agentProfile", "type": "AgentProfileUpdate"},
        "fabric_profile": {"key": "properties.fabricProfile", "type": "FabricProfile"},
        "dev_center_project_resource_id": {"key": "properties.devCenterProjectResourceId", "type": "str"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        maximum_concurrency: Optional[int] = None,
        organization_profile: Optional["_models.OrganizationProfile"] = None,
        agent_profile: Optional["_models.AgentProfileUpdate"] = None,
        fabric_profile: Optional["_models.FabricProfile"] = None,
        dev_center_project_resource_id: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        ...
        :paramtype organization_profile: ~azure.mgmt.devopsinfrastructure.models.OrganizationProfile
        :keyword agent_profile: Defines how the machine will be handled once it executed a job.
        :paramtype agent_profile: ~azure.mgmt.devopsinfrastructure.models.AgentProfileUpdate
        :keyword fabric_profile: Defines the type of fabric the agent will run on.
        :paramtype fabric_profile: ~azure.mgmt.devopsinfrastructure.models.FabricProfile
        :keyword dev_center_project_resource_id: The resource id of the DevCenter Project the pool
         belongs to.
...
class Quota(ProxyResource):
    ...
    :vartype limit: int
    :ivar name_properties_name: The details of the quota.
    :vartype name_properties_name: ~azure.mgmt.devopsinfrastructure.models.QuotaName
    """
    ...
    _attribute_map = {
        ...
        "name_properties_name": {"key": "properties.name", "type": "QuotaName"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        name_properties_name: Optional["_models.QuotaName"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword unit: The unit of usage measurement.
        :paramtype unit: str
        :keyword current_value: The current usage of the resource.
        :paramtype current_value: int
        :keyword limit: The maximum permitted usage of the resource.
        :paramtype limit: int
        :keyword name_properties_name: The details of the quota.
        :paramtype name_properties_name: ~azure.mgmt.devopsinfrastructure.models.QuotaName
        """
        super().__init__(**kwargs)
        self.unit = unit
...
class ResourceDetailsObject(ProxyResource):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.devopsinfrastructure.models.SystemData
    :ivar status: The status of the resource. Known values are: "Ready", "NotReady", "Allocated",
    ...
    :ivar image: The image name of the resource.
    :vartype image: str
    :ivar image_version: The version of the image running on the resource.
    ...
    _attribute_map = {
        ...
        "image_version": {"key": "properties.imageVersion", "type": "str"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword status: The status of the resource. Known values are: "Ready", "NotReady",
        ...
        :keyword image: The image name of the resource.
        :paramtype image: str
        :keyword image_version: The version of the image running on the resource.
...
class ResourceSku(ProxyResource):  # pylint: disable=too-many-instance-attributes
    """A ResourceSku.
    ...
    :ivar restrictions: The restrictions of the SKU.
    ...
    _attribute_map = {
        ...
        "location_info": {"key": "properties.locationInfo", "type": "[ResourceSkuLocationInfo]"},
        "capabilities": {"key": "properties.capabilities", "type": "[ResourceSkuCapabilities]"},
        "restrictions": {"key": "properties.restrictions", "type": "[ResourceSkuRestrictions]"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword restrictions: The restrictions of the SKU.
...
class StatefulUpdate(AgentProfileUpdate):
    """Stateful profile meaning that the machines will be returned to the pool after running a job.
...
class StatelessAgentProfileUpdate(AgentProfileUpdate):
    """Stateless profile meaning that the machines will be cleaned up after running a job.
