...
def build_list_by_location_request(location_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2024-03-26-preview"))
    ...
    path_format_arguments = {
        ...
        "locationName": _SERIALIZER.url("location_name", location_name, "str", pattern=r"^[a-zA-Z0-9][a-zA-Z0-9-.]*$"),
    }
