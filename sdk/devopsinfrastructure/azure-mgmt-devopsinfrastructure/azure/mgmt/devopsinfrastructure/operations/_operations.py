...
def build_operations_list_request(**kwargs: Any) -> HttpRequest:
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2024-07-03-preview"))
...
def build_pools_get_usage_request(
    resource_group_name: str, pool_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevOpsInfrastructure/pools/{poolName}/usage"  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "poolName": _SERIALIZER.url("pool_name", pool_name, "str"),
...
class PoolsOperations:
    ...
    @distributed_trace
    def get_usage(self, resource_group_name: str, pool_name: str, **kwargs: Any) -> List[Dict[str, int]]:
        ...
        :param pool_name: Name of the pool. It needs to be globally unique. Required.
        :type pool_name: str
        :return: list of dict mapping str to int
        ...
        cls: ClsType[List[Dict[str, int]]] = kwargs.pop("cls", None)

        _request = build_pools_get_usage_request(
            resource_group_name=resource_group_name,
            pool_name=pool_name,
            subscription_id=self._config.subscription_id,
            api_version=self._config.api_version,
        ...
        if _stream:
            ...
            deserialized = _deserialize(List[Dict[str, int]], response.json())
