...
def build_subscription_usages_list_by_location_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class SubscriptionUsagesOperations:
    ...
    @distributed_trace
    def list_by_location(self, **kwargs: Any) -> Iterable["_models.Quota"]:
