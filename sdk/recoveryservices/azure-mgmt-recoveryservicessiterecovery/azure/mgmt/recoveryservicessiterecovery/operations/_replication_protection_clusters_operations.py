...
class ReplicationProtectionClustersOperations:
    ...
    def _repair_replication_initial(self, **kwargs: Any) -> Optional[_models.ReplicationProtectionCluster]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    @distributed_trace
    def begin_repair_replication(self, **kwargs: Any) -> LROPoller[_models.ReplicationProtectionCluster]:
