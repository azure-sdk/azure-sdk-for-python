...
class ReplicationProtectionClustersOperations:
    ...
    @distributed_trace
    def get(self, **kwargs: Any) -> _models.ReplicationProtectionCluster:
    ...
    def _create_initial(
        self, replication_protection_cluster: Union[_models.ReplicationProtectionCluster, IO], **kwargs: Any
    ...
    @overload
    def begin_create(
        self, replication_protection_cluster: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> LROPoller[_models.ReplicationProtectionCluster]:
        """Create Replication protection Cluster.
    ...
    def _purge_initial(self, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    @distributed_trace
    def begin_purge(self, **kwargs: Any) -> LROPoller[None]:
    ...
    def _apply_recovery_point_initial(
        self, apply_cluster_recovery_point_input: Union[_models.ApplyClusterRecoveryPointInput, IO], **kwargs: Any
    ...
    _apply_recovery_point_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationProtectionClusters/{replicationProtectionClusterName}/applyRecoveryPoint"
    }
    ...
    @overload
    def begin_apply_recovery_point(
        self, apply_cluster_recovery_point_input: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> LROPoller[_models.ReplicationProtectionCluster]:
        """Execute the change recovery point operation for cluster.
        ...
        :param apply_cluster_recovery_point_input: Apply recovery point input. Required.
        :type apply_cluster_recovery_point_input: IO
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_apply_recovery_point(
        ...
        :param apply_cluster_recovery_point_input: Apply recovery point input. Is either a
         ApplyClusterRecoveryPointInput type or a IO type. Required.
        :type apply_cluster_recovery_point_input:
         ~azure.mgmt.recoveryservicessiterecovery.models.ApplyClusterRecoveryPointInput or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def _failover_commit_initial(self, **kwargs: Any) -> Optional[_models.ReplicationProtectionCluster]:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    _failover_commit_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationProtectionClusters/{replicationProtectionClusterName}/failoverCommit"
    }

    @distributed_trace
    def begin_failover_commit(self, **kwargs: Any) -> LROPoller[_models.ReplicationProtectionCluster]:
    ...
    @distributed_trace
    def get_operation_results(self, job_id: str, **kwargs: Any) -> _models.ReplicationProtectionCluster:
    ...
    def _repair_replication_initial(self, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    @distributed_trace
    def begin_repair_replication(self, **kwargs: Any) -> LROPoller[None]:
    ...
    def _test_failover_initial(
        self, failover_input: Union[_models.ClusterTestFailoverInput, IO], **kwargs: Any
    ) -> Optional[_models.ReplicationProtectionCluster]:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    _test_failover_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationProtectionClusters/{replicationProtectionClusterName}/testFailover"
    }

    @overload
    def begin_test_failover(
        self, failover_input: _models.ClusterTestFailoverInput, *, content_type: str = "application/json", **kwargs: Any
    ) -> LROPoller[_models.ReplicationProtectionCluster]:
    ...
    @overload
    def begin_test_failover(
        self, failover_input: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> LROPoller[_models.ReplicationProtectionCluster]:
        """Execute test failover for cluster.
    ...
    def begin_test_failover(
        ...
        :param failover_input: Failover input. Is either a ClusterTestFailoverInput type or a IO type.
         Required.
        :type failover_input: ~azure.mgmt.recoveryservicessiterecovery.models.ClusterTestFailoverInput
         or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
    ...
    def _test_failover_cleanup_initial(
        self, cleanup_input: Union[_models.ClusterTestFailoverCleanupInput, IO], **kwargs: Any
    ) -> Optional[_models.ReplicationProtectionCluster]:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    _test_failover_cleanup_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationProtectionClusters/{replicationProtectionClusterName}/testFailoverCleanup"
    }
    ...
    @overload
    def begin_test_failover_cleanup(
        self, cleanup_input: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> LROPoller[_models.ReplicationProtectionCluster]:
        """Execute test failover cleanup for cluster.
    ...
    def begin_test_failover_cleanup(
        ...
        :type cleanup_input:
         ~azure.mgmt.recoveryservicessiterecovery.models.ClusterTestFailoverCleanupInput or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def _unplanned_failover_initial(
        self, failover_input: Union[_models.ClusterUnplannedFailoverInput, IO], **kwargs: Any
    ) -> Optional[_models.ReplicationProtectionCluster]:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
