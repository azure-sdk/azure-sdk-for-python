...
def build_list_by_replication_protection_cluster_request(
    resource_name: str,
...
class ClusterRecoveryPointsOperations:
    ...
    @distributed_trace
    def list_by_replication_protection_cluster(self, **kwargs: Any) -> Iterable["_models.ClusterRecoveryPoint"]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_by_replication_protection_cluster_request(
                    resource_name=self._config.resource_name,
                    resource_group_name=self._config.resource_group_name,
                    subscription_id=self._config.subscription_id,
                    fabric_name=self._config.fabric_name,
                    protection_container_name=self._config.protection_container_name,
                    replication_protection_cluster_name=self._config.replication_protection_cluster_name,
                    api_version=api_version,
                    template_url=self.list_by_replication_protection_cluster.metadata["url"],
                    headers=_headers,
                    params=_params,
                )
    ...
    list_by_replication_protection_cluster.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationProtectionClusters/{replicationProtectionClusterName}/recoveryPoints"
    }
