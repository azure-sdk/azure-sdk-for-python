...
from ...operations._replication_infrastructure_operations import build_delete_request
...
class ReplicationInfrastructureOperations:
    ...
    async def begin_delete(self, resource_name: str, fabric_name: str, **kwargs: Any) -> AsyncLROPoller[None]:
