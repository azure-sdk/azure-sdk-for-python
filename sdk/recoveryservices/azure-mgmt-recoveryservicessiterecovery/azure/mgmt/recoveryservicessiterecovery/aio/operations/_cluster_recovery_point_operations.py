...
class ClusterRecoveryPointOperations:
    ...
    async def get(self, recovery_point_name: str, **kwargs: Any) -> _models.ClusterRecoveryPoint:
        ...
        deserialized = self._deserialize("ClusterRecoveryPoint", pipeline_response)
