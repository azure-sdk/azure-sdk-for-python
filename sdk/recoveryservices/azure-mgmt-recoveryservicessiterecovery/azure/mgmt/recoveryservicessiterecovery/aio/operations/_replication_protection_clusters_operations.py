...
class ReplicationProtectionClustersOperations:
    ...
    async def get(self, **kwargs: Any) -> _models.ReplicationProtectionCluster:
    ...
    async def _purge_initial(self, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    @distributed_trace_async
    async def begin_purge(self, **kwargs: Any) -> AsyncLROPoller[None]:
    ...
    async def _failover_commit_initial(self, **kwargs: Any) -> Optional[_models.ReplicationProtectionCluster]:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    @distributed_trace_async
    async def begin_failover_commit(self, **kwargs: Any) -> AsyncLROPoller[_models.ReplicationProtectionCluster]:
    ...
    @distributed_trace_async
    async def get_operation_results(self, job_id: str, **kwargs: Any) -> _models.ReplicationProtectionCluster:
    ...
    @distributed_trace_async
    async def begin_repair_replication(self, **kwargs: Any) -> AsyncLROPoller[None]:
