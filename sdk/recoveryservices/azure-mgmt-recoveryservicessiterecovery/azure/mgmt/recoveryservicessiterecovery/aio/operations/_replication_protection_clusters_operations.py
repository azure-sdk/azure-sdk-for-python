...
class ReplicationProtectionClustersOperations:
    ...
    async def _create_initial(
        self, replication_protection_cluster: Union[_models.ReplicationProtectionCluster, IO[bytes]], **kwargs: Any
    ...
    @overload
    async def begin_create(
        self, replication_protection_cluster: IO[bytes], *, content_type: str = "application/json", **kwargs: Any
    ) -> AsyncLROPoller[_models.ReplicationProtectionCluster]:
        """Create Replication protection Cluster.
    ...
    @overload
    async def begin_apply_recovery_point(
        self, apply_cluster_recovery_point_input: IO[bytes], *, content_type: str = "application/json", **kwargs: Any
    ) -> AsyncLROPoller[_models.ReplicationProtectionCluster]:
        """Execute the change recovery point operation for cluster.
    ...
    async def _repair_replication_initial(self, **kwargs: Any) -> Optional[_models.ReplicationProtectionCluster]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    @distributed_trace_async
    async def begin_repair_replication(self, **kwargs: Any) -> AsyncLROPoller[_models.ReplicationProtectionCluster]:
    ...
    async def _test_failover_initial(
        self, failover_input: Union[_models.ClusterTestFailoverInput, IO[bytes]], **kwargs: Any
    ) -> Optional[_models.ReplicationProtectionCluster]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    @overload
    async def begin_test_failover(
        self, failover_input: IO[bytes], *, content_type: str = "application/json", **kwargs: Any
    ) -> AsyncLROPoller[_models.ReplicationProtectionCluster]:
        """Execute test failover for cluster.
    ...
    async def _test_failover_cleanup_initial(
        self, cleanup_input: Union[_models.ClusterTestFailoverCleanupInput, IO[bytes]], **kwargs: Any
    ) -> Optional[_models.ReplicationProtectionCluster]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    @overload
    async def begin_test_failover_cleanup(
        self, cleanup_input: IO[bytes], *, content_type: str = "application/json", **kwargs: Any
    ) -> AsyncLROPoller[_models.ReplicationProtectionCluster]:
        """Execute test failover cleanup for cluster.
    ...
    async def _unplanned_failover_initial(
        self, failover_input: Union[_models.ClusterUnplannedFailoverInput, IO[bytes]], **kwargs: Any
    ) -> Optional[_models.ReplicationProtectionCluster]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
