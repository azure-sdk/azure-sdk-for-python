...
# USAGE
    python replication_protected_items_reprotect.py
...
def main():
    ...
    response = client.replication_protected_items.begin_reprotect(
        fabric_name="cloud1",
...
# x-ms-original-file: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/stable/2025-03-01/examples/ReplicationProtectedItems_Reprotect.json
