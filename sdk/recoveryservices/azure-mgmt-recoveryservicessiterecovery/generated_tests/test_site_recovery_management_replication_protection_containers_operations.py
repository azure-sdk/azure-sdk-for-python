...
class TestSiteRecoveryManagementReplicationProtectionContainersOperations(AzureMgmtRecordedTestCase):
    ...
    @recorded_by_proxy
    def test_list_by_replication_fabrics(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_begin_discover_protectable_item(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_begin_switch_cluster_protection(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_begin_switch_protection(self, resource_group):
