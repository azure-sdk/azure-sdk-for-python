...
def main():
    ...
    response = client.recovery_points_crr.list(
        vault_name="rshvault",
...
# x-ms-original-file: specification/recoveryservicesbackup/resource-manager/Microsoft.RecoveryServices/stable/2021-11-15/examples/AzureIaasVm/RecoveryPoints_List.json
