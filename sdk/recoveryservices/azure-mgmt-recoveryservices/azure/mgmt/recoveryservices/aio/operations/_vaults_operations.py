...
class VaultsOperations:
    ...
    async def _create_or_update_initial(
        self, resource_group_name: str, vault_name: str, vault: Union[_models.Vault, IO[bytes]], **kwargs: Any
    ) -> _models.Vault:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    async def _update_initial(
        self, resource_group_name: str, vault_name: str, vault: Union[_models.PatchVault, IO[bytes]], **kwargs: Any
