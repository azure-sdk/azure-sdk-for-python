...
def main():
    ...
    response = client.vaults.begin_update(
        ...
        vault={"tags": {"PatchKey": "PatchKeyUpdated"}},
    ).result()
    print(response)


# x-ms-original-file: specification/recoveryservices/resource-manager/Microsoft.RecoveryServices/stable/2025-01-01/examples/PATCHVault.json
