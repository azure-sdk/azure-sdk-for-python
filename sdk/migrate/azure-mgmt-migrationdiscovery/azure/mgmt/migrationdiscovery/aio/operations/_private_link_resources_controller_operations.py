...
from ...operations._private_link_resources_controller_operations import (
    build_get_request,
...
class PrivateLinkResourcesControllerOperations:
    ...
    def list_by_master_site(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.migrationdiscovery.models.PrivateLinkResource]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.migrationdiscovery.models.PrivateLinkResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
