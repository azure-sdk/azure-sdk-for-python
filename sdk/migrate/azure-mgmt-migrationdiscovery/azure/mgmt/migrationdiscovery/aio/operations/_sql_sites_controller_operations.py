...
class SqlSitesControllerOperations:
    ...
    def list_by_master_site(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.migrationdiscovery.models.SqlSite]
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either SqlSite or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.migrationdiscovery.models.SqlSite]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
