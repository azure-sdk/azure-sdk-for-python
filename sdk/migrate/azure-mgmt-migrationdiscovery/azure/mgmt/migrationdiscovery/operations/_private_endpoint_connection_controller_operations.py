...
def build_get_request(
    resource_group_name: str, site_name: str, pe_connection_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "peConnectionName": _SERIALIZER.url(
            "pe_connection_name", pe_connection_name, "str", pattern=r"^[a-zA-Z0-9-]{3,24}$"
        ),
    }
...
class PrivateEndpointConnectionControllerOperations:  # pylint: disable=name-too-long
    ...
    def list_by_master_site(
        ...
        :return: An iterator like instance of either PrivateEndpointConnection or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.migrationdiscovery.models.PrivateEndpointConnection]
    ...
    @distributed_trace
    def get(
        self, resource_group_name: str, site_name: str, pe_connection_name: str, **kwargs: Any
        ...
        :param site_name: Site name. Required.
        :type site_name: str
        :param pe_connection_name: Private link resource name. Required.
        :type pe_connection_name: str
        :return: PrivateEndpointConnection or the result of cls(response)
        :rtype: ~azure.mgmt.migrationdiscovery.models.PrivateEndpointConnection
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def create(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.migrationdiscovery.models.PrivateEndpointConnection
    ...
    def create(
        ...
        **kwargs: Any
        ...
        :param pe_connection_name: Private link resource name. Required.
        :type pe_connection_name: str
        :param body: Resource create parameters. Is either a PrivateEndpointConnection type or a
         IO[bytes] type. Required.
        :type body: ~azure.mgmt.migrationdiscovery.models.PrivateEndpointConnection or IO[bytes]
        :return: PrivateEndpointConnection or the result of cls(response)
        :rtype: ~azure.mgmt.migrationdiscovery.models.PrivateEndpointConnection
        :raises ~azure.core.exceptions.HttpResponseError:
        """
