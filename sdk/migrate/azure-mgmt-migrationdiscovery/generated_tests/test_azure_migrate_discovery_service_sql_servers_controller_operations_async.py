...
class TestAzureMigrateDiscoveryServiceSqlServersControllerOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_sql_servers_controller_list_by_sql_site(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_sql_servers_controller_get(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_sql_servers_controller_update(self, resource_group):
