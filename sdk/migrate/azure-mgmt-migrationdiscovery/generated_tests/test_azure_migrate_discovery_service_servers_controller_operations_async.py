...
class TestAzureMigrateDiscoveryServiceServersControllerOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_servers_controller_list_by_server_site_resource(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_servers_controller_get_machine(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_servers_controller_update_machine(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_servers_controller_delete_machine(self, resource_group):
