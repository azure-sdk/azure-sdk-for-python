...
def build_export_imported_sql_inventory_async_request(  # pylint: disable=name-too-long
    resource_group_name: str, site_name: str, sql_site_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{siteName}/sqlSites/{sqlSiteName}/exportImportedSqlInventoryAsync",
    )  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
        "resourceGroupName": _SERIALIZER.url(
...
def build_trigger_import_inventory_request(
    resource_group_name: str, site_name: str, sql_site_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{siteName}/sqlSites/{sqlSiteName}/triggerImportInventory",
    )  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
        "resourceGroupName": _SERIALIZER.url(
...
def build_validate_and_import_inventory_request(  # pylint: disable=name-too-long
    resource_group_name: str, site_name: str, sql_site_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{siteName}/sqlSites/{sqlSiteName}/validateAndImportInventory",
    )  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
        "resourceGroupName": _SERIALIZER.url(
...
class SqlSitesControllerOperations:
    ...
    def list_by_master_site(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.migrate.models.SqlSite]
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.migrate.models.SqlSite]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @overload
    def export_imported_sql_inventory_async(
        self,
        resource_group_name: str,
        site_name: str,
        sql_site_name: str,
    ...
    def _trigger_import_inventory_initial(
        self,
        resource_group_name: str,
        site_name: str,
        sql_site_name: str,
    ...
    @overload
    def begin_trigger_import_inventory(
        self,
        resource_group_name: str,
        site_name: str,
        sql_site_name: str,
    ...
    def begin_trigger_import_inventory(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._trigger_import_inventory_initial(
                resource_group_name=resource_group_name,
                site_name=site_name,
                sql_site_name=sql_site_name,
                body=body,
