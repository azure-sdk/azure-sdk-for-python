...
def build_get_request(
    resource_group_name: str, site_name: str, private_link_resource_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "privateLinkResourceName": _SERIALIZER.url(
            "private_link_resource_name", private_link_resource_name, "str", pattern=r"^[a-zA-Z0-9-]{3,24}$"
        ),
    }
...
class PrivateLinkResourcesControllerOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`private_link_resources_controller` attribute.
    """
    ...
    def list_by_master_site(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.migrate.models.PrivateLinkResource]
    ...
    @distributed_trace
    def get(
        self, resource_group_name: str, site_name: str, private_link_resource_name: str, **kwargs: Any
        ...
        :param site_name: Site name. Required.
        :type site_name: str
        :param private_link_resource_name: Private link resource name. Required.
        :type private_link_resource_name: str
        :return: PrivateLinkResource or the result of cls(response)
        :rtype: ~azure.mgmt.migrate.models.PrivateLinkResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
