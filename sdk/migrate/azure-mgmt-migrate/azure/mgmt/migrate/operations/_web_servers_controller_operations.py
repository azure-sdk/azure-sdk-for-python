...
class WebServersControllerOperations:
    ...
    def list_by_web_app_site(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.migrate.models.WebServer]
        ...
        cls: ClsType[_models.WebServerListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("WebServerListResult", pipeline_response)
