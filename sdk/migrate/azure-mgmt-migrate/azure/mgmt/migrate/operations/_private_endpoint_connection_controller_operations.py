...
class PrivateEndpointConnectionControllerOperations:  # pylint: disable=name-too-long
    ...
    def list_by_master_site(
        ...
        :return: An iterator like instance of either PrivateEndpointConnection or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.migrate.models.PrivateEndpointConnection]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.migrate.models.PrivateEndpointConnection
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def create(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.migrate.models.PrivateEndpointConnection
    ...
    def create(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.migrate.models.PrivateEndpointConnection or IO[bytes]
        :return: PrivateEndpointConnection or the result of cls(response)
        :rtype: ~azure.mgmt.migrate.models.PrivateEndpointConnection
        :raises ~azure.core.exceptions.HttpResponseError:
        """
