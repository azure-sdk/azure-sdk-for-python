...
class ArcDiscovery(_serialization.Model):
    ...
    def __init__(self, **kwargs: Any) -> None:
        """ """
        super().__init__(**kwargs)
        self.status: Optional[Union[str, "_models.AzureArcStatus"]] = None
        self.machine_resource_id: Optional[str] = None


class ArcScopeProperties(_serialization.Model):
    """Properties for defining Arc scope.

    All required parameters must be populated in order to send to server.

    :ivar locations: Locations to discover Arc resources from.
    :vartype locations: list[str]
    :ivar scope_type: The type of scope, currently supporting SubscriptionOrResourceGroupIds only.
     Required. "SubscriptionOrResourceGroupIds"
    :vartype scope_type: str or ~azure.mgmt.migrate.models.ArcScopeType
    :ivar subscription_or_resource_group_ids: List of subscription or resource group ARM IDs.
     Allowed only if scopeType is SubscriptionOrResourceGroupIds.
    :vartype subscription_or_resource_group_ids: list[str]
    """
    ...
    _attribute_map = {
        ...
        "subscription_or_resource_group_ids": {"key": "subscriptionOrResourceGroupIds", "type": "[str]"},
    }

    def __init__(
        self,
        *,
        scope_type: Union[str, "_models.ArcScopeType"],
        locations: Optional[List[str]] = None,
        subscription_or_resource_group_ids: Optional[List[str]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword locations: Locations to discover Arc resources from.
        :paramtype locations: list[str]
        :keyword scope_type: The type of scope, currently supporting SubscriptionOrResourceGroupIds
         only. Required. "SubscriptionOrResourceGroupIds"
        :paramtype scope_type: str or ~azure.mgmt.migrate.models.ArcScopeType
        :keyword subscription_or_resource_group_ids: List of subscription or resource group ARM IDs.
         Allowed only if scopeType is SubscriptionOrResourceGroupIds.
        :paramtype subscription_or_resource_group_ids: list[str]
        """
        super().__init__(**kwargs)
        self.locations = locations
        self.scope_type = scope_type
        self.subscription_or_resource_group_ids = subscription_or_resource_group_ids


class ArcScopePropertiesUpdate(_serialization.Model):
    """Properties for defining Arc scope.
    ...
    def __init__(
        ...
        *,
        locations: Optional[List[str]] = None,
        scope_type: Optional[Union[str, "_models.ArcScopeType"]] = None,
        subscription_or_resource_group_ids: Optional[List[str]] = None,
        **kwargs: Any
    ) -> None:
        """
        ...
        :paramtype locations: list[str]
        :keyword scope_type: The type of scope, currently supporting SubscriptionOrResourceGroupIds
         only. "SubscriptionOrResourceGroupIds"
        :paramtype scope_type: str or ~azure.mgmt.migrate.models.ArcScopeType
        :keyword subscription_or_resource_group_ids: List of subscription or resource group ARM IDs.
         Allowed only if scopeType is SubscriptionOrResourceGroupIds.
        :paramtype subscription_or_resource_group_ids: list[str]
...
class HypervMachineProperties(_serialization.Model):
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        self.updated_timestamp: Optional[str] = None
        self.provisioning_state: Optional[Union[str, "_models.ProvisioningState"]] = None
        self.arc_discovery: Optional["_models.ArcDiscovery"] = None
...
class ImportSqlInventoryJob(_serialization.Model):
    """Import SQL inventory job REST Resource.

    Variables are only populated by the server, and will be ignored when sending a request.

    :ivar type: Handled by resource provider.
    :vartype type: str
    :ivar properties: Gets or sets the import job properties.
    :vartype properties: ~azure.mgmt.migrate.models.ImportSqlInventoryJobProperties
    """
    ...
    _attribute_map = {
        "type": {"key": "type", "type": "str"},
        "properties": {"key": "properties", "type": "ImportSqlInventoryJobProperties"},
    }

    def __init__(
        self, *, properties: Optional["_models.ImportSqlInventoryJobProperties"] = None, **kwargs: Any
    ) -> None:
        """
        :keyword properties: Gets or sets the import job properties.
        :paramtype properties: ~azure.mgmt.migrate.models.ImportSqlInventoryJobProperties
        """
        super().__init__(**kwargs)
        self.type: Optional[str] = None
        self.properties = properties
...
class ImportSqlInventoryJobProperties(_serialization.Model):
    """Import SQL inventory job properties web model.

    :ivar blob_name: Gets the Blob name for the blob to fetch Import file from.
    :vartype blob_name: str
    :ivar blob_sas_uri: Gets the blob SAS Uri of the input import file.
    :vartype blob_sas_uri: str
    :ivar job_result: Gets the Job Result status. Known values are: "Unknown", "Completed",
     "CompletedWithWarnings", "CompletedWithErrors", "Failed", "WaitingForBlobUpload", and
     "InProgress".
    :vartype job_result: str or ~azure.mgmt.migrate.models.ImportSqlInventoryJobResult
    :ivar number_of_servers_imported: Gets the Number of servers imported.
    :vartype number_of_servers_imported: int
    :ivar number_of_databases_imported: Gets the Number of databases imported.
    :vartype number_of_databases_imported: int
    :ivar number_of_availability_groups_imported: Gets the Number of availability groups imported.
    :vartype number_of_availability_groups_imported: int
    :ivar blob_creation_time_stamp: Gets the Blob creation time stamp.
    :vartype blob_creation_time_stamp: ~datetime.datetime
    :ivar error_summary: Gets the Job Error Summary.
    :vartype error_summary: ~azure.mgmt.migrate.models.SqlImportJobErrorSummary
    """
    ...
    _attribute_map = {
        ...
        "blob_sas_uri": {"key": "blobSasUri", "type": "str"},
        "job_result": {"key": "jobResult", "type": "str"},
        "number_of_servers_imported": {"key": "numberOfServersImported", "type": "int"},
        "number_of_databases_imported": {"key": "numberOfDatabasesImported", "type": "int"},
        "number_of_availability_groups_imported": {"key": "numberOfAvailabilityGroupsImported", "type": "int"},
        "blob_creation_time_stamp": {"key": "blobCreationTimeStamp", "type": "iso-8601"},
        "error_summary": {"key": "errorSummary", "type": "SqlImportJobErrorSummary"},
    }
    ...
    def __init__(
        ...
        *,
        blob_name: Optional[str] = None,
        blob_sas_uri: Optional[str] = None,
        job_result: Optional[Union[str, "_models.ImportSqlInventoryJobResult"]] = None,
        number_of_servers_imported: Optional[int] = None,
        number_of_databases_imported: Optional[int] = None,
        number_of_availability_groups_imported: Optional[int] = None,
        blob_creation_time_stamp: Optional[datetime.datetime] = None,
        error_summary: Optional["_models.SqlImportJobErrorSummary"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword blob_name: Gets the Blob name for the blob to fetch Import file from.
        :paramtype blob_name: str
        :keyword blob_sas_uri: Gets the blob SAS Uri of the input import file.
        :paramtype blob_sas_uri: str
        :keyword job_result: Gets the Job Result status. Known values are: "Unknown", "Completed",
         "CompletedWithWarnings", "CompletedWithErrors", "Failed", "WaitingForBlobUpload", and
         "InProgress".
        :paramtype job_result: str or ~azure.mgmt.migrate.models.ImportSqlInventoryJobResult
        :keyword number_of_servers_imported: Gets the Number of servers imported.
        :paramtype number_of_servers_imported: int
        :keyword number_of_databases_imported: Gets the Number of databases imported.
        :paramtype number_of_databases_imported: int
        :keyword number_of_availability_groups_imported: Gets the Number of availability groups
         imported.
        :paramtype number_of_availability_groups_imported: int
        :keyword blob_creation_time_stamp: Gets the Blob creation time stamp.
        :paramtype blob_creation_time_stamp: ~datetime.datetime
        :keyword error_summary: Gets the Job Error Summary.
        :paramtype error_summary: ~azure.mgmt.migrate.models.SqlImportJobErrorSummary
        """
        super().__init__(**kwargs)
        self.blob_name = blob_name
        self.blob_sas_uri = blob_sas_uri
        self.job_result = job_result
        self.number_of_servers_imported = number_of_servers_imported
        self.number_of_databases_imported = number_of_databases_imported
        self.number_of_availability_groups_imported = number_of_availability_groups_imported
        self.blob_creation_time_stamp = blob_creation_time_stamp
        self.error_summary = error_summary
...
class MasterSiteProperties(_serialization.Model):
    ...
    :ivar provisioning_state: provisioning state enum. Known values are: "Created", "Updated",
     "Running", "Completed", "Failed", "Succeeded", and "Canceled".
    :vartype provisioning_state: str or ~azure.mgmt.migrate.models.ProvisioningState
    :ivar last_refresh_arc_status_time: Gets the last refresh time of arc status in UTC.
    :vartype last_refresh_arc_status_time: ~datetime.datetime
    """
    ...
    _validation = {
        ...
        "provisioning_state": {"readonly": True},
        "last_refresh_arc_status_time": {"readonly": True},
    }
    ...
    _attribute_map = {
        ...
        "provisioning_state": {"key": "provisioningState", "type": "str"},
        "last_refresh_arc_status_time": {"key": "lastRefreshArcStatusTime", "type": "iso-8601"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.provisioning_state: Optional[Union[str, "_models.ProvisioningState"]] = None
        self.last_refresh_arc_status_time: Optional[datetime.datetime] = None
...
class PagedImportSqlInventoryJob(_serialization.Model):
    """Paged collection of ImportSqlInventoryJob items.

    Variables are only populated by the server, and will be ignored when sending a request.

    :ivar value: The ImportSqlInventoryJob items on this page.
    :vartype value: list[~azure.mgmt.migrate.models.ImportSqlInventoryJob]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    _attribute_map = {
        "value": {"key": "value", "type": "[ImportSqlInventoryJob]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }
    ...
    def __init__(self, **kwargs: Any) -> None:
        """ """
        super().__init__(**kwargs)
        self.value: Optional[List["_models.ImportSqlInventoryJob"]] = None
        self.next_link: Optional[str] = None
...
class ServerProperties(_serialization.Model):
    ...
    :ivar arc_discovery: Gets the data related to Azure arc discovery.
    :vartype arc_discovery: ~azure.mgmt.migrate.models.ArcDiscovery
    :ivar discovery_source: Gets or sets the discovery source of the server. Default value is
     "Arc".
    :vartype discovery_source: str
    :ivar hypervisor: Gets or sets the hypervisor type of the server.
    :vartype hypervisor: str
    """
    ...
    _validation = {
        ...
        "updated_timestamp": {"readonly": True},
        "arc_discovery": {"readonly": True},
        "discovery_source": {"readonly": True},
        "hypervisor": {"readonly": True},
    }
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        self.provisioning_state = provisioning_state
        self.arc_discovery: Optional["_models.ArcDiscovery"] = None
        self.discovery_source: Optional[Literal["Arc"]] = None
        self.hypervisor: Optional[str] = None
...
class ServerSiteResource(TrackedResource):
    ...
    :vartype location: str
    :ivar properties: The resource-specific properties for this resource.
    :vartype properties: ~azure.mgmt.migrate.models.ServerSitesProperties
    """
    ...
    _attribute_map = {
        ...
        "tags": {"key": "tags", "type": "{str}"},
        "location": {"key": "location", "type": "str"},
        "properties": {"key": "properties", "type": "ServerSitesProperties"},
    }
    ...
    def __init__(
        ...
        *,
        location: str,
        tags: Optional[Dict[str, str]] = None,
        properties: Optional["_models.ServerSitesProperties"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword tags: Resource tags.
        ...
        :paramtype location: str
        :keyword properties: The resource-specific properties for this resource.
        :paramtype properties: ~azure.mgmt.migrate.models.ServerSitesProperties
        """
        super().__init__(tags=tags, location=location, **kwargs)
        self.properties = properties
...
class ServerSiteResourceUpdateProperties(_serialization.Model):
    ...
    :ivar discovery_solution_id: Gets or sets the ARM ID of migration hub solution for SDS.
    :vartype discovery_solution_id: str
    :ivar arc_scope: Gets or sets the Arc scope properties for the server site.
    :vartype arc_scope: ~azure.mgmt.migrate.models.ArcScopePropertiesUpdate
    """
    ...
    _attribute_map = {
        ...
        "appliance_name": {"key": "applianceName", "type": "str"},
        "discovery_solution_id": {"key": "discoverySolutionId", "type": "str"},
        "arc_scope": {"key": "arcScope", "type": "ArcScopePropertiesUpdate"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        appliance_name: Optional[str] = None,
        discovery_solution_id: Optional[str] = None,
        arc_scope: Optional["_models.ArcScopePropertiesUpdate"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword service_principal_identity_details: Gets or sets the service principal identity
        ...
        :keyword discovery_solution_id: Gets or sets the ARM ID of migration hub solution for SDS.
        :paramtype discovery_solution_id: str
        :keyword arc_scope: Gets or sets the Arc scope properties for the server site.
        :paramtype arc_scope: ~azure.mgmt.migrate.models.ArcScopePropertiesUpdate
        """
        super().__init__(**kwargs)
        self.service_principal_identity_details = service_principal_identity_details
        self.agent_details = agent_details
        self.appliance_name = appliance_name
        self.discovery_solution_id = discovery_solution_id
        self.arc_scope = arc_scope


class ServerSitesProperties(_serialization.Model):
    ...
    :vartype provisioning_state: str or ~azure.mgmt.migrate.models.ProvisioningState
    :ivar arc_scope: Gets or sets the Arc scope properties for the server site.
    :vartype arc_scope: ~azure.mgmt.migrate.models.ArcScopeProperties
    """
    ...
    _attribute_map = {
        ...
        "service_endpoint": {"key": "serviceEndpoint", "type": "str"},
        "provisioning_state": {"key": "provisioningState", "type": "str"},
        "arc_scope": {"key": "arcScope", "type": "ArcScopeProperties"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        appliance_name: Optional[str] = None,
        discovery_solution_id: Optional[str] = None,
        arc_scope: Optional["_models.ArcScopeProperties"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword service_principal_identity_details: Gets or sets the service principal identity
        ...
        :paramtype discovery_solution_id: str
        :keyword arc_scope: Gets or sets the Arc scope properties for the server site.
        :paramtype arc_scope: ~azure.mgmt.migrate.models.ArcScopeProperties
        """
        super().__init__(**kwargs)
        self.master_site_id: Optional[str] = None
        self.service_principal_identity_details = service_principal_identity_details
...
class SqlImportJobErrorSummary(_serialization.Model):
    """Job Error Summary.

    :ivar errors: Collection of errors encountered during the SQL import operation.
    :vartype errors: list[~azure.mgmt.migrate.models.ErrorResponse]
    :ivar error_count: Gets or sets the Number of errors while trying to import SQL Inventory from
     CSV.
    :vartype error_count: int
    :ivar warning_count: Gets or sets the Number of warnings while trying to import SQL Inventory
     from CSV. Warnings are included in the 'errors' array.
    :vartype warning_count: int
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword errors: Collection of errors encountered during the SQL import operation.
        :paramtype errors: list[~azure.mgmt.migrate.models.ErrorResponse]
        :keyword error_count: Gets or sets the Number of errors while trying to import SQL Inventory
         from CSV.
        :paramtype error_count: int
        :keyword warning_count: Gets or sets the Number of warnings while trying to import SQL
         Inventory from CSV. Warnings are included in the 'errors' array.
        :paramtype warning_count: int
        """
        super().__init__(**kwargs)
        self.errors = errors
...
class SQLInventoryImportBody(_serialization.Model):
    ...
    :ivar uri: Gets or sets the SAS URI.
    :vartype uri: str
    :ivar import_type: Gets or sets the import type. Known values are: "Unknown" and
     "AzureMigrateCsv".
    :vartype import_type: str or ~azure.mgmt.migrate.models.SqlImportType
    """
    ...
    def __init__(
        ...
        *,
        job_arm_id: Optional[str] = None,
        uri: Optional[str] = None,
        import_type: Optional[Union[str, "_models.SqlImportType"]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword job_arm_id: Gets or sets the job ARM ID.
        ...
        :keyword uri: Gets or sets the SAS URI.
        :paramtype uri: str
        :keyword import_type: Gets or sets the import type. Known values are: "Unknown" and
         "AzureMigrateCsv".
        :paramtype import_type: str or ~azure.mgmt.migrate.models.SqlImportType
        """
        super().__init__(**kwargs)
        self.job_arm_id = job_arm_id
        self.uri = uri
...
class SqlSiteProperties(_serialization.Model):
    ...
    :ivar provisioning_state: provisioning state enum. Known values are: "Created", "Updated",
     "Running", "Completed", "Failed", "Succeeded", and "Canceled".
    :vartype provisioning_state: str or ~azure.mgmt.migrate.models.ProvisioningState
    :ivar arc_scope: Gets or sets the Arc scope properties for the sql site.
    :vartype arc_scope: ~azure.mgmt.migrate.models.ArcScopeProperties
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype discovery_scenario: str or
         ~azure.mgmt.migrate.models.SqlSitePropertiesDiscoveryScenario
        :keyword arc_scope: Gets or sets the Arc scope properties for the sql site.
        :paramtype arc_scope: ~azure.mgmt.migrate.models.ArcScopeProperties
        """
        super().__init__(**kwargs)
