...
class AzureMigrateDiscoveryService:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype hyperv_software_inventories_controller:
     azure.mgmt.migrate.aio.operations.HypervSoftwareInventoriesControllerOperations
    ...
    :vartype hyperv_operations_status_controller:
     azure.mgmt.migrate.aio.operations.HypervOperationsStatusControllerOperations
    ...
    :vartype master_sites_operations_status_controller:
     azure.mgmt.migrate.aio.operations.MasterSitesOperationsStatusControllerOperations
    ...
    :vartype private_endpoint_connection_controller:
     azure.mgmt.migrate.aio.operations.PrivateEndpointConnectionControllerOperations
    ...
    :vartype private_link_resources_controller:
     azure.mgmt.migrate.aio.operations.PrivateLinkResourcesControllerOperations
    :ivar sql_sites_controller: SqlSitesControllerOperations operations
    :vartype sql_sites_controller: azure.mgmt.migrate.aio.operations.SqlSitesControllerOperations
    ...
    :vartype sql_discovery_site_data_source_controller:
     azure.mgmt.migrate.aio.operations.SqlDiscoverySiteDataSourceControllerOperations
    :ivar sql_import_jobs_controller: SqlImportJobsControllerOperations operations
    :vartype sql_import_jobs_controller:
     azure.mgmt.migrate.aio.operations.SqlImportJobsControllerOperations
    :ivar sql_jobs_controller: SqlJobsControllerOperations operations
    :vartype sql_jobs_controller: azure.mgmt.migrate.aio.operations.SqlJobsControllerOperations
    ...
    :vartype sql_operations_status_controller:
     azure.mgmt.migrate.aio.operations.SqlOperationsStatusControllerOperations
    ...
    :vartype sql_run_as_accounts_controller:
     azure.mgmt.migrate.aio.operations.SqlRunAsAccountsControllerOperations
    ...
    :vartype web_app_discovery_site_data_sources_controller:
     azure.mgmt.migrate.aio.operations.WebAppDiscoverySiteDataSourcesControllerOperations
    ...
    :vartype web_app_extended_machines_controller:
     azure.mgmt.migrate.aio.operations.WebAppExtendedMachinesControllerOperations
    ...
    :vartype iis_web_applications_controller:
     azure.mgmt.migrate.aio.operations.IisWebApplicationsControllerOperations
    :ivar iis_web_servers_controller: IisWebServersControllerOperations operations
    :vartype iis_web_servers_controller:
     azure.mgmt.migrate.aio.operations.IisWebServersControllerOperations
    ...
    :vartype web_app_run_as_accounts_controller:
     azure.mgmt.migrate.aio.operations.WebAppRunAsAccountsControllerOperations
    ...
    :vartype server_dependency_map_controller:
     azure.mgmt.migrate.aio.operations.ServerDependencyMapControllerOperations
    :ivar server_jobs_controller: ServerJobsControllerOperations operations
    :vartype server_jobs_controller:
     azure.mgmt.migrate.aio.operations.ServerJobsControllerOperations
    :ivar servers_controller: ServersControllerOperations operations
    :vartype servers_controller: azure.mgmt.migrate.aio.operations.ServersControllerOperations
    ...
    :vartype server_software_inventories_controller:
     azure.mgmt.migrate.aio.operations.ServerSoftwareInventoriesControllerOperations
    ...
    :vartype server_operations_status_controller:
     azure.mgmt.migrate.aio.operations.ServerOperationsStatusControllerOperations
    ...
    def __init__(
        ...
        self.sql_import_jobs_controller = SqlImportJobsControllerOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
