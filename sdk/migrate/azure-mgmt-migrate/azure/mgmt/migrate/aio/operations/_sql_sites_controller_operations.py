...
from ...operations._sql_sites_controller_operations import (
    ...
    build_get_request,
    build_import_inventory_request,
...
class SqlSitesControllerOperations:
    ...
    async def _import_inventory_initial(
        self,
        resource_group_name: str,
        site_name: str,
        sql_site_name: str,
        ...
        **kwargs: Any
        ...
        _request = build_import_inventory_request(
            resource_group_name=resource_group_name,
            site_name=site_name,
            sql_site_name=sql_site_name,
            subscription_id=self._config.subscription_id,
    ...
    @overload
    async def begin_import_inventory(
        self,
        resource_group_name: str,
        site_name: str,
        sql_site_name: str,
    ...
    async def begin_import_inventory(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._import_inventory_initial(
                resource_group_name=resource_group_name,
                site_name=site_name,
                sql_site_name=sql_site_name,
                body=body,
