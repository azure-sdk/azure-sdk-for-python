...
from ...operations._sql_sites_controller_operations import (
    ...
    build_error_detailed_summary_request,
...
class SqlSitesControllerOperations:
    ...
    @overload
    async def error_detailed_summary(
        self,
        resource_group_name: str,
        site_name: str,
        sql_site_name: str,
        ...
        **kwargs: Any
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: SqlSiteErrorDetails or the result of cls(response)
        :rtype: ~azure.mgmt.migrate.models.SqlSiteErrorDetails
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def error_detailed_summary(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.SqlSiteErrorDetails] = kwargs.pop("cls", None)
        ...
        _request = build_error_detailed_summary_request(
            resource_group_name=resource_group_name,
            site_name=site_name,
            sql_site_name=sql_site_name,
            subscription_id=self._config.subscription_id,
        ...
        deserialized = self._deserialize("SqlSiteErrorDetails", pipeline_response)
