...
from ...operations._operations import (
    build_compound_assessment_operations_create_request,
    build_compound_assessment_operations_delete_request,
    build_compound_assessment_operations_download_url_request,
    build_compound_assessment_operations_get_request,
    build_compound_assessment_operations_list_by_parent_request,
    build_compound_assessment_summary_operations_get_request,
    build_compound_assessment_summary_operations_list_by_parent_request,
)
...
class CompoundAssessmentOperationsOperations:
    ...
    def list_by_parent(
    ...
    ) -> AsyncIterable["_models.CompoundAssessment"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.migrate.models.CompoundAssessment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def begin_create(
        ...
        **kwargs: Any
    ) -> AsyncLROPoller[_models.CompoundAssessment]:
        ...
        :return: An instance of AsyncLROPoller that returns CompoundAssessment. The CompoundAssessment
         is compatible with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.migrate.models.CompoundAssessment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.CompoundAssessment].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.CompoundAssessment](
    ...
    async def begin_download_url(
        ...
        :return: An instance of AsyncLROPoller that returns DownloadUrl. The DownloadUrl is compatible
         with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.migrate.models.DownloadUrl]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = kwargs.pop("params", {}) or {}
...
class CompoundAssessmentSummaryOperationsOperations:  # pylint: disable=name-too-long
    ...
    def list_by_parent(
        self, resource_group_name: str, project_name: str, compound_assessment_name: str, **kwargs: Any
    ) -> AsyncIterable["_models.WebAppCompoundAssessmentSummary"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.migrate.models.WebAppCompoundAssessmentSummary]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
