...
class ApacheTomcatAKSWorkloadDeployment(_serialization.Model):
...
class ApacheTomcatWebApplication(_serialization.Model):
    """ApacheTomcat web application.
...
class DeployedResourceModelProperties(_serialization.Model):
...
class WorkloadInstanceModelProperties(_serialization.Model):
...
class GmsaAuthenticationProperties(_serialization.Model):
...
class IISAKSWorkloadDeployment(_serialization.Model):
...
class IISWebApplication(_serialization.Model):
    """IISWeb application.
...
class IISWebServer(_serialization.Model):
    """IISWeb server.
...
class WebApplicationConfiguration(_serialization.Model):
...
class WorkflowModelProperties(_serialization.Model):
...
class WorkloadDeploymentModelProperties(_serialization.Model):
