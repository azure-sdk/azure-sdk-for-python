...
# USAGE
    python migrate_projects_controller_create_maximum_set_gen.py
...
def main():
    ...
    response = client.migrate_projects_controller.put_migrate_project(
...
# x-ms-original-file: specification/migrate/resource-manager/Microsoft.Migrate/MigrateProjects/stable/2023-01-01/examples/MigrateProjectsController_Create_MaximumSet_Gen.json
