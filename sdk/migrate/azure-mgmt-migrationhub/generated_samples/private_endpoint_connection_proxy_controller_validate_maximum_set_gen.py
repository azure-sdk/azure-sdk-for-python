...
# USAGE
    python private_endpoint_connection_proxy_controller_validate_maximum_set_gen.py
...
def main():
    ...
    response = client.private_endpoint_connection_proxy_controller.validate(
        resource_group_name="rghubmigrate",
        migrate_project_name="1GQwlI-",
        pec_proxy_name="0wjb2Y-4i-",
        body={
...
# x-ms-original-file: specification/migrate/resource-manager/Microsoft.Migrate/MigrateProjects/stable/2023-01-01/examples/PrivateEndpointConnectionProxyController_Validate_MaximumSet_Gen.json
