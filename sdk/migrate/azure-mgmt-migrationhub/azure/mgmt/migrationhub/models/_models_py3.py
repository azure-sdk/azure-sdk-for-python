...
class DatabaseAssessmentDetails(_serialization.Model):
    """Assessment properties that can be shared by various publishers.
...
class DatabaseInstanceDiscoveryDetails(_serialization.Model):
...
class DiscoveryDetails(_serialization.Model):
...
class MigrationDetails(_serialization.Model):
...
class ODataRawQueryOptions(_serialization.Model):
...
class VirtualDesktopUserAssessmentDetails(_serialization.Model):
...
class WebServerDiscoveryDetails(_serialization.Model):
...
class WebSiteAssessmentDetails(_serialization.Model):
...
class WebSiteMigrationDetails(_serialization.Model):
