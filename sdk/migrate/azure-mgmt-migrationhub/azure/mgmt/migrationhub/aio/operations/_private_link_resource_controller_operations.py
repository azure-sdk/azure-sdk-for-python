...
from ...operations._private_link_resource_controller_operations import (
...
class PrivateLinkResourceControllerOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`private_link_resource_controller` attribute.
    """
    ...
    async def get_private_link_resource(
        self, resource_group_name: str, migrate_project_name: str, private_link_resource_name: str, **kwargs: Any
        ...
        :rtype: ~azure.mgmt.migrationhub.models.PrivateLinkResource
    ...
    def get_private_link_resources(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.migrationhub.models.PrivateLinkResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.PrivateLinkResourceCollection] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("PrivateLinkResourceCollection", pipeline_response)
