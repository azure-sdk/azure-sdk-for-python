...
from ...operations._private_endpoint_connections_controller_operations import (
    build_get_private_endpoint_connections_request,
)
...
class PrivateEndpointConnectionsControllerOperations:  # pylint: disable=name-too-long
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`private_endpoint_connections_controller` attribute.
    """
    ...
    @distributed_trace
    def get_private_endpoint_connections(
        ...
        :return: An iterator like instance of either PrivateEndpointConnection or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.migrationhub.models.PrivateEndpointConnection]
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_get_private_endpoint_connections_request(
