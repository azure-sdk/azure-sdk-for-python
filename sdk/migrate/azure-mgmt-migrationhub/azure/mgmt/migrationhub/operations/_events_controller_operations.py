...
def build_get_event_request(
    resource_group_name: str, migrate_project_name: str, event_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "eventName": _SERIALIZER.url("event_name", event_name, "str", pattern=r"^[a-zA-Z0-9-]{3,24}$"),
    }
...
class EventsControllerOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`events_controller` attribute.
    """
    ...
    def list_events(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either MigrateEvent or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.migrationhub.models.MigrateEvent]
    ...
    @distributed_trace
    def get_event(
        self, resource_group_name: str, migrate_project_name: str, event_name: str, **kwargs: Any
    ) -> _models.MigrateEvent:
        ...
        :rtype: ~azure.mgmt.migrationhub.models.MigrateEvent
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.MigrateEvent] = kwargs.pop("cls", None)

        _request = build_get_event_request(
            resource_group_name=resource_group_name,
            migrate_project_name=migrate_project_name,
        ...
        deserialized = self._deserialize("MigrateEvent", pipeline_response.http_response)
    ...
    @distributed_trace
    def delete(self, resource_group_name: str, migrate_project_name: str, event_name: str, **kwargs: Any) -> JSON:
