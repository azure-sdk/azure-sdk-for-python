...
def build_list_private_endpoint_connection_proxies_request(  # pylint: disable=name-too-long
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/migrateProjects/{migrateProjectName}/privateEndpointConnectionProxies",
...
def build_get_request(
    resource_group_name: str, migrate_project_name: str, pec_proxy_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/migrateProjects/{migrateProjectName}/privateEndpointConnectionProxies/{pecProxyName}",
    )  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
        "resourceGroupName": _SERIALIZER.url(
        ...
        "pecProxyName": _SERIALIZER.url("pec_proxy_name", pec_proxy_name, "str", pattern=r"^[a-zA-Z0-9-]{3,24}$"),
    }
...
def build_validate_request(
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/migrateProjects/{migrateProjectName}/privateEndpointConnectionProxies/{pecProxyName}/validate",
    )  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
        "resourceGroupName": _SERIALIZER.url(
...
class PrivateEndpointConnectionProxyControllerOperations:  # pylint: disable=name-too-long
    ...
    def list_private_endpoint_connection_proxies(
        ...
        :return: An iterator like instance of either PrivateEndpointConnectionProxy or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.migrationhub.models.PrivateEndpointConnectionProxy]
    ...
    @distributed_trace
    def delete(self, resource_group_name: str, migrate_project_name: str, pec_proxy_name: str, **kwargs: Any) -> JSON:
