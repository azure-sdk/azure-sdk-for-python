...
def build_get_database_request(
    resource_group_name: str, migrate_project_name: str, database_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "databaseName": _SERIALIZER.url("database_name", database_name, "str", pattern=r"^[a-zA-Z0-9-]{3,24}$"),
    }
...
class DatabasesControllerOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`databases_controller` attribute.
    """
    ...
    def list_databases(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.migrationhub.models.Database]
        ...
        cls: ClsType[_models.DatabaseCollection] = kwargs.pop("cls", None)
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_databases_request(
    ...
    @distributed_trace
    def get_database(
        self, resource_group_name: str, migrate_project_name: str, database_name: str, **kwargs: Any
    ) -> _models.Database:
        ...
        :rtype: ~azure.mgmt.migrationhub.models.Database
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
        ...
        _request = build_get_database_request(
            resource_group_name=resource_group_name,
            migrate_project_name=migrate_project_name,
