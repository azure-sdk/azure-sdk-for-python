...
def build_get_private_endpoint_connection_request(  # pylint: disable=name-too-long
    resource_group_name: str, migrate_project_name: str, pe_connection_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
...
def build_put_private_endpoint_connection_request(  # pylint: disable=name-too-long
    resource_group_name: str, migrate_project_name: str, pe_connection_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PrivateEndpointConnectionControllerOperations:  # pylint: disable=name-too-long
    ...
    @overload
    def put_private_endpoint_connection(
        self,
