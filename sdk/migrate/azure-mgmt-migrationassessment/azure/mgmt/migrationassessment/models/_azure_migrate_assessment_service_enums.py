...
class ApiVersions(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    V2023_09_09_PREVIEW = "2023-09-09-preview"
...
class AvsAssessmentScenario(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class AzureArcState(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class AzureAvsSuitabilityExplanation(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    INTERNAL_ERROR_IN_RECOMMENDATION = "InternalErrorInRecommendation"
    UNSUPPORTED_LOCATION_FOR_SELECTED_EXTERNAL_STORAGE_TYPES = "UnsupportedLocationForSelectedExternalStorageTypes"
...
class AzureEnvironmentType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class AzureVmCategory(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Azure VM Category."""
...
class AzureWebAppSuitabilityIssueCategory(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class AzureWebAppTargetType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class AzureWebAppTier(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """AzureWebAppTier."""

    UNKNOWN = "Unknown"
    FREE = "Free"
    PREMIUM_V2 = "Premium_V2"
    PREMIUM_V3 = "Premium_V3"
    ISOLATED = "Isolated"


class BusinessCaseCurrency(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class BusinessCaseState(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class CheckResult(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class ConsolidationType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Consolidation Type."""
...
class ExternalStorageType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class HyperVLicenseType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class LicensingProgram(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class ManagementCostComponentName(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Management Cost Component Names."""

    UNKNOWN = "Unknown"
    """Unknown Management Cost Component."""
    SYSTEM_CENTER_LICENSE_COST = "SystemCenterLicenseCost"
    """System Center License Cost."""
    V_SPHERE_MANAGEMENT_COST = "VSphereManagementCost"
    """VSphere eManagement Cost."""
    THIRD_PARTY_MANAGEMENT_COST = "ThirdPartyManagementCost"
    """Third Party Management Cost."""
    OTHER_MONITORING_COST = "OtherMonitoringCost"
    """Other Monitoring Cost."""
    OTHER_DATA_PROTECTION_COST = "OtherDataProtectionCost"
    """Other Data Protection Cost."""
    OTHER_PATCHING_COST = "OtherPatchingCost"
    """Other Patching Cost."""
    AZURE_MONITORING_COST = "AzureMonitoringCost"
    """Azure Monitoring Cost."""
    AZURE_PATCHING_COST = "AzurePatchingCost"
    """Azure Patching Cost."""
    AZURE_DATA_PROTECTION_COST = "AzureDataProtectionCost"
    """Azure Data Protection Cost."""
    AZURE_ARC_MONITORING_COST = "AzureArcMonitoringCost"
    """Azure Arc Monitoring Cost."""
    AZURE_ARC_PATCHING_COST = "AzureArcPatchingCost"
    """Azure Arc Patching Cost."""


class MigrationStrategy(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class NetworkSkuType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    EXPRESS_ROUTE_ULTRA = "ExpressRouteUltra"
    """Express Route network type with Ultra SKU."""


class NodePoolMode(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Node Pool Mode."""
...
class POSAzurePricingTier(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class ProvisioningState2(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """The status of the current operation."""
...
class SavingsOption(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class SuggestedMigrationTool(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Suggested Migration Tool for Azure."""

    NONE = "None"
    """No Migration Tool is suggested."""
    WEB_APP_MIGRATION = "WebAppMigration"
    """Web App Migration."""
    SERVER_MIGRATION = "ServerMigration"
    """Server Migration."""


class Suitability(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class SupportabilityStatus(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class VsphereManagementLicenseType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class WebAppTypes(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class Year(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Year values."""
