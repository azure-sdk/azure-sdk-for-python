...
class AKSAssessmentSettings(AssessmentSettings):
...
class AssessedWebAppV2Properties(_serialization.Model):
...
class AssessmentOptionsProperties(_serialization.Model):
    ...
    :ivar premium_v2_disk_supported_locations: List of Azure locations that support Premium SSD V2
     disks for assessments.
    :vartype premium_v2_disk_supported_locations: list[str or
    ...
    _validation = {
        ...
        "premium_v2_disk_supported_locations": {"readonly": True},
    }
    ...
    _attribute_map = {
        ...
        "premium_v2_disk_supported_locations": {"key": "premiumV2DiskSupportedLocations", "type": "[str]"},
    }
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.premium_v2_disk_supported_locations = None
...
class AvsEstimatedNode(_serialization.Model):
...
class AvsNodeSummary(_serialization.Model):
...
class AzurePaasSummary(_serialization.Model):
...
class AzureSettings(_serialization.Model):
...
class CompareSummary(_serialization.Model):
...
class OnPremisesIaasSummary(_serialization.Model):
...
class OnPremisesPaasSummary(_serialization.Model):
...
class OverviewSummaryProperties(_serialization.Model):
...
class WebAppAssessmentV2Properties(AzureResourceProperties2):
...
class WebAppServicePlanV2Properties(_serialization.Model):
    """Assessed Web app database properties web model.
...
class YearOnYearEstimates(_serialization.Model):
