...
from ...operations._private_link_resource_operations_operations import (
    build_get_request,
...
class PrivateLinkResourceOperationsOperations:
    ...
    def list_by_assessment_project(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.migrationassessment.models.PrivateLinkResource]
