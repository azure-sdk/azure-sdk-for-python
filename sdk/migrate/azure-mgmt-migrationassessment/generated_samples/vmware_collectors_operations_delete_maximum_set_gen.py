...
# USAGE
    python vmware_collectors_operations_delete_maximum_set_gen.py
...
def main():
    ...
    client.vmware_collectors_operations.delete(
...
# x-ms-original-file: specification/migrate/resource-manager/Microsoft.Migrate/AssessmentProjects/preview/2024-01-01-preview/examples/VmwareCollectorsOperations_Delete_MaximumSet_Gen.json
