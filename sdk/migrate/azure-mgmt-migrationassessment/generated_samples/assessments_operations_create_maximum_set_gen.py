    ...
    response = client.assessments_operations.begin_create(
        ...
        resource={
            "properties": {
                ...
                "azureDiskTypes": ["Premium", "PremiumV2", "StandardSSD"],
...
# x-ms-original-file: specification/migrate/resource-manager/Microsoft.Migrate/AssessmentProjects/preview/2024-01-01-preview/examples/AssessmentsOperations_Create_MaximumSet_Gen.json
