...
# USAGE
    python assessment_projects_operations_create_maximum_set_gen.py
...
def main():
    ...
    response = client.assessment_projects_operations.begin_create(
...
# x-ms-original-file: specification/migrate/resource-manager/Microsoft.Migrate/AssessmentProjects/preview/2024-01-01-preview/examples/AssessmentProjectsOperations_Create_MaximumSet_Gen.json
