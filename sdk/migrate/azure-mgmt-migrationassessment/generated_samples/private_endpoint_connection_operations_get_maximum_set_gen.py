...
# USAGE
    python private_endpoint_connection_operations_get_maximum_set_gen.py
...
def main():
    ...
    response = client.private_endpoint_connection_operations.get(
...
# x-ms-original-file: specification/migrate/resource-manager/Microsoft.Migrate/AssessmentProjects/preview/2023-09-09-preview/examples/PrivateEndpointConnectionOperations_Get_MaximumSet_Gen.json
