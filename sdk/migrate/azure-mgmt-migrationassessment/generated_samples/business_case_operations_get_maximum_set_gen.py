...
# USAGE
    python business_case_operations_get_maximum_set_gen.py
...
def main():
    ...
    response = client.business_case_operations.get(
...
# x-ms-original-file: specification/migrate/resource-manager/Microsoft.Migrate/AssessmentProjects/preview/2024-01-01-preview/examples/BusinessCaseOperations_Get_MaximumSet_Gen.json
