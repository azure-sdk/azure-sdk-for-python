...
# USAGE
    python assessments_operations_delete_maximum_set_gen.py
...
def main():
    ...
    client.assessments_operations.delete(
...
# x-ms-original-file: specification/migrate/resource-manager/Microsoft.Migrate/AssessmentProjects/preview/2023-09-09-preview/examples/AssessmentsOperations_Delete_MaximumSet_Gen.json
