...
class TestAzureMigrateAssessmentServiceBusinessCaseOperationsOperations(AzureMgmtRecordedTestCase):
    ...
    @recorded_by_proxy
    def test_business_case_operations_list_by_assessment_project(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_business_case_operations_get(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_business_case_operations_begin_create(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_business_case_operations_delete(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_business_case_operations_begin_compare_summary(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_business_case_operations_begin_get_report_download_url(self, resource_group):
