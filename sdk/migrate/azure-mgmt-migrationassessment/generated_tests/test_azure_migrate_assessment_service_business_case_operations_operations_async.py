...
class TestAzureMigrateAssessmentServiceBusinessCaseOperationsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_list_by_assessment_project(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_begin_compare_summary(self, resource_group):
        response = await (
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_begin_get_report_download_url(self, resource_group):
        response = await (
