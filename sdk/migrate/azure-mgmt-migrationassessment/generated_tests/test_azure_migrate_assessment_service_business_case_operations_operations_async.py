...
class TestAzureMigrateAssessmentServiceBusinessCaseOperationsOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(AzureMigrateAssessmentService, is_async=True)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_business_case_operations_list_by_assessment_project(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_business_case_operations_get(self, resource_group):
        response = await self.client.business_case_operations.get(
            resource_group_name=resource_group.name,
            project_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_business_case_operations_begin_create(self, resource_group):
        response = await (
            await self.client.business_case_operations.begin_create(
                resource_group_name=resource_group.name,
                project_name="str",
                business_case_name="str",
                resource={
                    ...
                    "properties": {
                        ...
                        "settings": {
                            ...
                            "azureArcSettings": {
                                ...
                                "managementSettings": {
                                    "monitoringSettings": {"alertRulesCount": 0, "logsVolumeInGB": 0.0}
                                },
                            },
                            "onPremiseSettings": {
                                "computeSettings": {
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_business_case_operations_delete(self, resource_group):
        response = await self.client.business_case_operations.delete(
            resource_group_name=resource_group.name,
            project_name="str",
            business_case_name="str",
            api_version="2024-01-01-preview",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_business_case_operations_begin_compare_summary(self, resource_group):
        response = await (
            await self.client.business_case_operations.begin_compare_summary(
                resource_group_name=resource_group.name,
                project_name="str",
                business_case_name="str",
                body={},
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_business_case_operations_begin_get_report_download_url(self, resource_group):
        response = await (
            await self.client.business_case_operations.begin_get_report_download_url(
                resource_group_name=resource_group.name,
                project_name="str",
                business_case_name="str",
                body={},
