...
class LambdaTestHyperExecuteMgmtClient:
    ...
    :vartype operations: azure.mgmt.lambdatesthyperexecute.aio.operations.Operations
    :ivar organizations: OrganizationsOperations operations
    :vartype organizations:
     azure.mgmt.lambdatesthyperexecute.aio.operations.OrganizationsOperations
