...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Easm/workspaces")
...
class WorkspacesOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.WorkspaceResource"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.defendereasm.models.WorkspaceResource]
    ...
    def _create_and_update_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(workspace_resource, (IOBase, bytes)):
    ...
    def begin_create_and_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either WorkspaceResource or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.defendereasm.models.WorkspaceResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
