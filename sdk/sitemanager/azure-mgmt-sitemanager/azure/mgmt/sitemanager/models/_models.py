...
class ArmResourceUpdatedResponseSite(_model_base.Model):
    """Resource 'Site' update operation succeeded.

    :ivar body: The body type of the operation request or response. Required.
    :vartype body: ~azure.mgmt.sitemanager.models.Site
    """

    body: "_models.Site" = rest_field(visibility=["read", "create", "update", "delete", "query"])
...
class SiteAddressProperties(_model_base.Model):
...
class SiteProperties(_model_base.Model):
    """Site properties.
...
class SiteUpdate(_model_base.Model):
...
class SiteUpdateProperties(_model_base.Model):
    """The updatable properties of the Site.
