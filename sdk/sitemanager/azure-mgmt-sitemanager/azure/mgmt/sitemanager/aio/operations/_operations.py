...
from ...operations._operations import (
    build_sites_by_service_group_create_or_update_request,
    build_sites_by_service_group_delete_request,
    build_sites_by_service_group_get_request,
    build_sites_by_service_group_list_by_service_group_request,
    build_sites_by_service_group_update_request,
    build_sites_by_subscription_create_or_update_request,
    build_sites_by_subscription_delete_request,
    build_sites_by_subscription_get_request,
    build_sites_by_subscription_list_request,
    build_sites_by_subscription_update_request,
...
class SitesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.sitemanager.aio.EdgeClient`'s
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns Site. The Site is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sitemanager.models.Site]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.Site"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sitemanager.models.Site]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class SitesBySubscriptionOperations:
    ...
    @distributed_trace_async
    async def get(self, site_name: str, **kwargs: Any) -> _models.Site:
        """Get a Site.
    ...
    @distributed_trace_async
    async def delete(self, site_name: str, **kwargs: Any) -> None:
        """Delete a Site.
...
class SitesByServiceGroupOperations:
    ...
    async def begin_create_or_update(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.ArmResourceUpdatedResponseSite]:
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns ArmResourceUpdatedResponseSite. The
         ArmResourceUpdatedResponseSite is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sitemanager.models.ArmResourceUpdatedResponseSite]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.ArmResourceUpdatedResponseSite] = kwargs.pop("cls", None)
        polling: Union[bool, AsyncPollingMethod] = kwargs.pop("polling", True)
        lro_delay = kwargs.pop("polling_interval", self._config.polling_interval)
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
        ...
        def get_long_running_output(pipeline_response):
            response = pipeline_response.http_response
            deserialized = _deserialize(_models.ArmResourceUpdatedResponseSite, response.json())
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.ArmResourceUpdatedResponseSite].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ArmResourceUpdatedResponseSite](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
