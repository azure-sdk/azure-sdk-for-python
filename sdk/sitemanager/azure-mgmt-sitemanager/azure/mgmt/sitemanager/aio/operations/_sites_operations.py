...
class SitesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.sitemanager.aio.EdgeSites`'s
    ...
    async def _create_or_update_initial(
        self, resource_group_name: str, site_name: str, resource: Union[_models.Site, IO[bytes]], **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    @distributed_trace_async
    async def update(
        self, resource_group_name: str, site_name: str, properties: Union[_models.SiteUpdate, IO[bytes]], **kwargs: Any
    ) -> _models.Site:
        """Update a Site.
