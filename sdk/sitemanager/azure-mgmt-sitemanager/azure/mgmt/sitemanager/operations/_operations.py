...
class SitesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.sitemanager.EdgeClient`'s
...
class SitesByServiceGroupOperations:
    ...
    def begin_create_or_update(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.ArmResourceUpdatedResponseSite]:
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns ArmResourceUpdatedResponseSite. The
         ArmResourceUpdatedResponseSite is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.sitemanager.models.ArmResourceUpdatedResponseSite]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.ArmResourceUpdatedResponseSite].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ArmResourceUpdatedResponseSite](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
