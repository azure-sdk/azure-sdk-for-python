...
def build_list_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Edge/sites")
...
def build_get_request(site_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "siteName": _SERIALIZER.url(
            "site_name", site_name, "str", pattern=r"^[a-zA-Z0-9][a-zA-Z0-9-_]{2,22}[a-zA-Z0-9]$"
        ),
    }
...
def build_create_or_update_request(site_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_update_request(site_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_delete_request(site_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class SitesBySubscriptionOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.sitemanager.EdgeSites`'s
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._config: EdgeSitesConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
    ...
    def _create_or_update_initial(
        self, site_name: str, resource: Union[_models.Site, IO[bytes]], **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "Site")
    ...
    def begin_create_or_update(
        ...
        :param site_name: Name of Site resource. Required.
        :type site_name: str
        :param resource: Resource create parameters. Is either a Site type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.sitemanager.models.Site or IO[bytes]
        :return: An instance of LROPoller that returns either Site or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.sitemanager.models.Site]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace
    def update(self, site_name: str, properties: Union[_models.SiteUpdate, IO[bytes]], **kwargs: Any) -> _models.Site:
        """Update a Site.

        :param site_name: Name of Site resource. Required.
        :type site_name: str
        :param properties: The resource properties to be updated. Is either a SiteUpdate type or a
         IO[bytes] type. Required.
        :type properties: ~azure.mgmt.sitemanager.models.SiteUpdate or IO[bytes]
        :return: Site or the result of cls(response)
        :rtype: ~azure.mgmt.sitemanager.models.Site
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "SiteUpdate")
