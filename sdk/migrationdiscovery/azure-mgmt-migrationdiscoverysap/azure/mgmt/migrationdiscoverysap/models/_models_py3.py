...
class SAPDiscoverySite(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    _attribute_map = {
        ...
        "master_site_id": {"key": "properties.masterSiteId", "type": "str"},
        "migrate_project_id": {"key": "properties.migrateProjectId", "type": "str"},
        "provisioning_state": {"key": "properties.provisioningState", "type": "str"},
        "errors": {"key": "properties.errors", "type": "SAPMigrateError"},
    }
...
class SAPDiscoverySiteListResult(_serialization.Model):
    ...
    def __init__(self, *, value: List["_models.SAPDiscoverySite"], **kwargs: Any) -> None:
        """
...
class SAPInstance(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    _attribute_map = {
        ...
        "tags": {"key": "tags", "type": "{str}"},
        "location": {"key": "location", "type": "str"},
        "system_sid": {"key": "properties.systemSid", "type": "str"},
        "environment": {"key": "properties.environment", "type": "str"},
        "landscape_sid": {"key": "properties.landscapeSid", "type": "str"},
        "application": {"key": "properties.application", "type": "str"},
        "provisioning_state": {"key": "properties.provisioningState", "type": "str"},
        "errors": {"key": "properties.errors", "type": "SAPMigrateError"},
    }
...
class SAPInstanceListResult(_serialization.Model):
    ...
    def __init__(self, *, value: List["_models.SAPInstance"], **kwargs: Any) -> None:
        """
...
class SAPMigrateError(_serialization.Model):
    ...
    _attribute_map = {
        ...
        "details": {"key": "properties.details", "type": "[ErrorDefinition]"},
    }
...
class ServerInstance(ProxyResource):  # pylint: disable=too-many-instance-attributes
    ...
    _attribute_map = {
        ...
        "sap_instance_type": {"key": "properties.sapInstanceType", "type": "str"},
        "instance_sid": {"key": "properties.instanceSid", "type": "str"},
        "sap_product": {"key": "properties.sapProduct", "type": "str"},
        "sap_product_version": {"key": "properties.sapProductVersion", "type": "str"},
        "operating_system": {"key": "properties.operatingSystem", "type": "str"},
        "configuration_data": {"key": "properties.configurationData", "type": "ConfigurationData"},
        "performance_data": {"key": "properties.performanceData", "type": "PerformanceData"},
        "provisioning_state": {"key": "properties.provisioningState", "type": "str"},
        "errors": {"key": "properties.errors", "type": "SAPMigrateError"},
    }
...
class ServerInstanceListResult(_serialization.Model):
    ...
    def __init__(self, *, value: List["_models.ServerInstance"], **kwargs: Any) -> None:
        """
