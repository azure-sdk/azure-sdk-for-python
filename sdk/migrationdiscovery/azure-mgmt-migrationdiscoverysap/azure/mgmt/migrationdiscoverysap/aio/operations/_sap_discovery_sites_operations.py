...
class SapDiscoverySitesOperations:
    ...
    async def get(
        ...
        deserialized = self._deserialize("SAPDiscoverySite", pipeline_response.http_response)
    ...
    async def _create_initial(
        ...
        resource: Union[_models.SAPDiscoverySite, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param sap_discovery_site_name: The name of the discovery site resource for SAP Migration.
         Required.
        :type sap_discovery_site_name: str
        :param resource: Resource create parameters. Is either a SAPDiscoverySite type or a IO[bytes]
         type. Required.
        :type resource: ~azure.mgmt.migrationdiscoverysap.models.SAPDiscoverySite or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either SAPDiscoverySite or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.migrationdiscoverysap.models.SAPDiscoverySite]
    ...
    async def update(
        ...
        resource_group_name: str,
        sap_discovery_site_name: str,
        properties: Union[_models.SAPDiscoverySiteTagsUpdate, IO[bytes]],
        **kwargs: Any
    ) -> _models.SAPDiscoverySite:
        """Updates a SAP Migration discovery site resource.
        ...
        :param properties: The resource properties to be updated. Is either a
         SAPDiscoverySiteTagsUpdate type or a IO[bytes] type. Required.
        :type properties: ~azure.mgmt.migrationdiscoverysap.models.SAPDiscoverySiteTagsUpdate or
         IO[bytes]
        :return: SAPDiscoverySite or the result of cls(response)
        :rtype: ~azure.mgmt.migrationdiscoverysap.models.SAPDiscoverySite
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def _import_entities_initial(
        ...
        _request = build_import_entities_request(
            resource_group_name=resource_group_name,
            sap_discovery_site_name=sap_discovery_site_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
