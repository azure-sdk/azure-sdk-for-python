...
class CassandraClustersOperations:  # pylint: disable=too-many-public-methods
    ...
    async def _list_command_initial(
        self, resource_group_name: str, cluster_name: str, **kwargs: Any
    ...
    @distributed_trace_async
    async def begin_list_command(
        self, resource_group_name: str, cluster_name: str, **kwargs: Any
    ) -> AsyncLROPoller[_models.ListCommands]:
        ...
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no
         Retry-After header is present.
        :return: An instance of AsyncLROPoller that returns either ListCommands or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.cosmosdb.models.ListCommands]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._list_command_initial(
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                api_version=api_version,
                cls=lambda x, y, z: x,
    ...
    async def _get_command_async_initial(
    ...
    @distributed_trace_async
    async def begin_get_command_async(
        self, resource_group_name: str, cluster_name: str, command_id: str, **kwargs: Any
    ) -> AsyncLROPoller[_models.ListCommands]:
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._get_command_async_initial(
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                command_id=command_id,
                api_version=api_version,
