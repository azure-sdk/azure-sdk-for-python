...
class ClusterResourceProperties(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar azure_connection_method: Which connection method Managed Cassandra should use to conenct
     to Azure resources it needs. 'None' is the deafukt which means conenct directly, 'Vpn' will
     connect through a VPN endpoint for added security and simplicity. Known values are: "None" and
     "Vpn".
    :vartype azure_connection_method: str or ~azure.mgmt.cosmosdb.models.AzureConnectionMethod
    :ivar private_link_resource_id: If AzureConnectionMethod is VPN, the resource id of the private
     link resource that is used establish a private link to the Azure services used by the cluster.
    :vartype private_link_resource_id: str
    :ivar private_link_auto_approve_subscriptions: If AzureConnectionMethod is VPN, the list of
     subscriptions that are automatically approved to connect to the private link resource that is
     used establish a private link to the Azure services used by the cluster.
    :vartype private_link_auto_approve_subscriptions: list[str]
    ...
    _attribute_map = {
        ...
        "private_link_auto_approve_subscriptions": {"key": "privateLinkAutoApproveSubscriptions", "type": "[str]"},
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        azure_connection_method: Optional[Union[str, "_models.AzureConnectionMethod"]] = None,
        private_link_auto_approve_subscriptions: Optional[List[str]] = None,
        ...
        **kwargs: Any
        ...
        :keyword azure_connection_method: Which connection method Managed Cassandra should use to
         conenct to Azure resources it needs. 'None' is the deafukt which means conenct directly, 'Vpn'
         will connect through a VPN endpoint for added security and simplicity. Known values are: "None"
         and "Vpn".
        :paramtype azure_connection_method: str or ~azure.mgmt.cosmosdb.models.AzureConnectionMethod
        :keyword private_link_auto_approve_subscriptions: If AzureConnectionMethod is VPN, the list of
         subscriptions that are automatically approved to connect to the private link resource that is
         used establish a private link to the Azure services used by the cluster.
        :paramtype private_link_auto_approve_subscriptions: list[str]
        ...
        self.private_link_auto_approve_subscriptions = private_link_auto_approve_subscriptions
...
class DataCenterResourceProperties(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar private_endpoint_ip_address: If AzureConnectionMethod is VPN, IP address of the private
     endpoint connected to the clusters private link to access Azure Services.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype authentication_method_ldap_properties:
         ~azure.mgmt.cosmosdb.models.AuthenticationMethodLdapProperties
        :keyword private_endpoint_ip_address: If AzureConnectionMethod is VPN, IP address of the
         private endpoint connected to the clusters private link to access Azure Services.
