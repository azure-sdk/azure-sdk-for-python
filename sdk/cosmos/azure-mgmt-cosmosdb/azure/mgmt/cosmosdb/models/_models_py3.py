...
class ProvisioningIssue(_serialization.Model):
    ...
    :vartype name: str
    :ivar properties: Properties of a provisioning issue.
...
class ProvisioningIssueProperties(_serialization.Model):
    ...
    :vartype description: str
    :ivar suggested_resource_ids: Fully qualified resource IDs of resources that can be associated
     to the same perimeter to remediate the issue.
