...
class VectorEmbedding(_serialization.Model):
    ...
    :ivar path: The path for which the indexing behavior applies to. Index paths typically start
     with root and end with wildcard (/path/*).
    :vartype path: str
    :ivar data_type: Indicates the type of Embedding. Known values are: "float32", "uint8", and
     "int8".
    :vartype data_type: str or ~azure.mgmt.cosmosdb.models.VectorDataType
    :ivar distance_function: Indicates the type of distance function of the Embedding. Known values
     are: "euclidean", "cosine", and "dotproduct".
    :vartype distance_function: str or ~azure.mgmt.cosmosdb.models.DistanceFunction
    :ivar dimensions: Value of dimension of the distance function.
    ...
    def __init__(
        ...
        *,
        path: Optional[str] = None,
        data_type: Optional[Union[str, "_models.VectorDataType"]] = None,
        distance_function: Optional[Union[str, "_models.DistanceFunction"]] = None,
        ...
        **kwargs: Any
        ...
        :keyword path: The path for which the indexing behavior applies to. Index paths typically start
         with root and end with wildcard (/path/*).
        :paramtype path: str
        :keyword data_type: Indicates the type of Embedding. Known values are: "float32", "uint8", and
         "int8".
        :paramtype data_type: str or ~azure.mgmt.cosmosdb.models.VectorDataType
        :keyword distance_function: Indicates the type of distance function of the Embedding. Known
         values are: "euclidean", "cosine", and "dotproduct".
        :paramtype distance_function: str or ~azure.mgmt.cosmosdb.models.DistanceFunction
        :keyword dimensions: Value of dimension of the distance function.
...
class VectorIndex(_serialization.Model):
    ...
    :ivar path: The path for which the indexing behavior applies to. Index paths typically start
     with root and end with wildcard (/path/*).
    :vartype path: str
    :ivar type: Vector Indexing Type to be applied on the path. Known values are: "flat",
     "quantizedFlat", and "diskANN".
    ...
    def __init__(
        self, *, path: Optional[str] = None, type: Union[str, "_models.VectorIndexType"] = "flat", **kwargs: Any
    ) -> None:
        """
        :keyword path: The path for which the indexing behavior applies to. Index paths typically start
         with root and end with wildcard (/path/*).
        :paramtype path: str
        :keyword type: Vector Indexing Type to be applied on the path. Known values are: "flat",
         "quantizedFlat", and "diskANN".
