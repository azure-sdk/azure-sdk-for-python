...
class CassandraClusterNodeRestoreResult(_serialization.Model):
    """CassandraClusterNodeRestoreResult.

    :ivar address: Address of the node.
    :vartype address: str
    :ivar state: The status of the command.
    :vartype state: str
    :ivar start_timestamp: Time restore started on node.
    :vartype start_timestamp: str
    :ivar end_timestamp: Time restore ended on node.
    :vartype end_timestamp: str
    """
    ...
    _attribute_map = {
        ...
        "end_timestamp": {"key": "endTimestamp", "type": "str"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword address: Address of the node.
        :paramtype address: str
        :keyword state: The status of the command.
        :paramtype state: str
        :keyword start_timestamp: Time restore started on node.
        :paramtype start_timestamp: str
        :keyword end_timestamp: Time restore ended on node.
        :paramtype end_timestamp: str
        """
        super().__init__(**kwargs)
        self.address = address
        self.state = state
...
class CassandraClusterRestoreInfo(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype start_timestamp: str
        :keyword restore_id: Restore Id.
        :paramtype restore_id: str
        """
        super().__init__(**kwargs)
        self.backup_id = backup_id
        self.start_timestamp = start_timestamp
...
class CassandraClusterRestoreResult(_serialization.Model):
    ...
    :ivar restore_id: The id of the restore job.
    :vartype restore_id: str
    :ivar state: The status of the command.
    :vartype state: str
    :ivar backup_id: Backup Id to restore.
    :vartype backup_id: str
    :ivar nodes: Info on each node's restore.
    :vartype nodes: list[~azure.mgmt.cosmosdb.models.CassandraClusterNodeRestoreResult]
    """
    ...
    _attribute_map = {
        ...
        "state": {"key": "state", "type": "str"},
        "backup_id": {"key": "backupId", "type": "str"},
        "nodes": {"key": "nodes", "type": "[CassandraClusterNodeRestoreResult]"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        state: Optional[str] = None,
        backup_id: Optional[str] = None,
        nodes: Optional[List["_models.CassandraClusterNodeRestoreResult"]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword restore_id: The id of the restore job.
        :paramtype restore_id: str
        :keyword state: The status of the command.
        :paramtype state: str
        :keyword backup_id: Backup Id to restore.
        :paramtype backup_id: str
        :keyword nodes: Info on each node's restore.
        :paramtype nodes: list[~azure.mgmt.cosmosdb.models.CassandraClusterNodeRestoreResult]
        """
        super().__init__(**kwargs)
        self.restore_id = restore_id
        self.state = state
