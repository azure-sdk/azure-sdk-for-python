...
def build_invoke_async_command_request(
    resource_group_name: str, cluster_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/cassandraClusters/{clusterName}/invokeAsyncCommand",
    )  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url(
...
def build_get_async_command_request(
...
class CassandraClustersOperations:  # pylint: disable=too-many-public-methods
    ...
    def _invoke_async_command_initial(
        self,
        resource_group_name: str,
        cluster_name: str,
        body: Union[_models.CommandPostBody, IO[bytes]],
        **kwargs: Any
        ...
        _request = build_invoke_async_command_request(
            resource_group_name=resource_group_name,
            cluster_name=cluster_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    @overload
    def begin_invoke_async_command(
        self,
        resource_group_name: str,
        cluster_name: str,
        body: _models.CommandPostBody,
    ...
    def begin_invoke_async_command(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._invoke_async_command_initial(
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                body=body,
                api_version=api_version,
    ...
    def get_async_command(
        ...
        :param cluster_name: Managed Cassandra cluster name. Required.
        :type cluster_name: str
        :param command_id: The command id (GUID identifier) for Managed Cassandra cluster command.
         Required.
        :type command_id: str
        ...
        _request = build_get_async_command_request(
            resource_group_name=resource_group_name,
            cluster_name=cluster_name,
