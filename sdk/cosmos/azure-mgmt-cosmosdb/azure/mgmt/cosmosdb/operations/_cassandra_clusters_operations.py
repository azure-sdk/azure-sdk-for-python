...
def build_get_command_async_request(
    ...
    path_format_arguments = {
        ...
        "commandId": _SERIALIZER.url("command_id", command_id, "str", max_length=100, min_length=1),
    }
...
class CassandraClustersOperations:  # pylint: disable=too-many-public-methods
    ...
    def _list_command_initial(self, resource_group_name: str, cluster_name: str, **kwargs: Any) -> _models.ListCommands:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        request = build_list_command_request(
            ...
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self._list_command_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    _list_command_initial.metadata = {
    ...
    @distributed_trace
    def begin_list_command(
        self, resource_group_name: str, cluster_name: str, **kwargs: Any
    ) -> LROPoller[_models.ListCommands]:
        ...
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no
         Retry-After header is present.
        :return: An instance of LROPoller that returns either ListCommands or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.cosmosdb.models.ListCommands]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._list_command_initial(
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                api_version=api_version,
                cls=lambda x, y, z: x,
    ...
    begin_list_command.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/cassandraClusters/{clusterName}/commands"
    }

    def _get_command_async_initial(
        ...
        request = build_get_command_async_request(
            ...
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self._get_command_async_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    _get_command_async_initial.metadata = {
    ...
    @distributed_trace
    def begin_get_command_async(
        self, resource_group_name: str, cluster_name: str, command_id: str, **kwargs: Any
    ) -> LROPoller[_models.ListCommands]:
        """Get list of details about commands that were run asynchronously. Use "all" as commandId to list
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._get_command_async_initial(
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                command_id=command_id,
                api_version=api_version,
    ...
    begin_get_command_async.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/cassandraClusters/{clusterName}/commands/{commandId}"
    }
