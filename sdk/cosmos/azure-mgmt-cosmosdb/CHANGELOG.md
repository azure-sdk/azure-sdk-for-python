...
### Features Added
  ...
  - Model `DatabaseAccountCreateUpdateParameters` added property `enable_all_versions_and_deletes_change_feed`
  - Model `DatabaseAccountGetResults` added property `enable_all_versions_and_deletes_change_feed`
  - Model `DatabaseAccountUpdateParameters` added property `enable_all_versions_and_deletes_change_feed`
  ...
  - Added model `CassandraRoleAssignmentListResult`
  - Added model `CassandraRoleAssignmentResource`
  - Added model `CassandraRoleDefinitionListResult`
  - Added model `CassandraRoleDefinitionResource`
  - Added model `CopyJobFeedResults`
  ...
  - Added model `FleetAnalyticsListResult`
  ...
  - Added model `PermissionAutoGenerated2`
  - Added model `PermissionAutoGenerated3`
  - Added model `PermissionAutoGenerated4`
  ...
  - Method `CassandraResourcesOperations.begin_create_update_cassandra_role_assignment` has a new overload `def begin_create_update_cassandra_role_assignment(self: None, resource_group_name: str, account_name: str, role_assignment_id: str, create_update_cassandra_role_assignment_parameters: CassandraRoleAssignmentResource, content_type: str)`
  - Method `CassandraResourcesOperations.begin_create_update_cassandra_role_assignment` has a new overload `def begin_create_update_cassandra_role_assignment(self: None, resource_group_name: str, account_name: str, role_assignment_id: str, create_update_cassandra_role_assignment_parameters: IO[bytes], content_type: str)`
  - Method `CassandraResourcesOperations.begin_create_update_cassandra_role_definition` has a new overload `def begin_create_update_cassandra_role_definition(self: None, resource_group_name: str, account_name: str, role_definition_id: str, create_update_cassandra_role_definition_parameters: CassandraRoleDefinitionResource, content_type: str)`
  - Method `CassandraResourcesOperations.begin_create_update_cassandra_role_definition` has a new overload `def begin_create_update_cassandra_role_definition(self: None, resource_group_name: str, account_name: str, role_definition_id: str, create_update_cassandra_role_definition_parameters: IO[bytes], content_type: str)`
  - Method `GremlinResourcesOperations.begin_create_update_gremlin_role_assignment` has a new overload `def begin_create_update_gremlin_role_assignment(self: None, resource_group_name: str, account_name: str, role_assignment_id: str, create_update_gremlin_role_assignment_parameters: GremlinRoleAssignmentResource, content_type: str)`
  - Method `GremlinResourcesOperations.begin_create_update_gremlin_role_assignment` has a new overload `def begin_create_update_gremlin_role_assignment(self: None, resource_group_name: str, account_name: str, role_assignment_id: str, create_update_gremlin_role_assignment_parameters: IO[bytes], content_type: str)`
  - Method `GremlinResourcesOperations.begin_create_update_gremlin_role_definition` has a new overload `def begin_create_update_gremlin_role_definition(self: None, resource_group_name: str, account_name: str, role_definition_id: str, create_update_gremlin_role_definition_parameters: GremlinRoleDefinitionResource, content_type: str)`
  - Method `GremlinResourcesOperations.begin_create_update_gremlin_role_definition` has a new overload `def begin_create_update_gremlin_role_definition(self: None, resource_group_name: str, account_name: str, role_definition_id: str, create_update_gremlin_role_definition_parameters: IO[bytes], content_type: str)`
  - Method `CopyJobsOperations.create` has a new overload `def create(self: None, resource_group_name: str, account_name: str, job_name: str, job_create_parameters: CopyJobGetResults, content_type: str)`
  - Method `CopyJobsOperations.create` has a new overload `def create(self: None, resource_group_name: str, account_name: str, job_name: str, job_create_parameters: IO[bytes], content_type: str)`
  - Method `FleetAnalyticsOperations.create` has a new overload `def create(self: None, resource_group_name: str, fleet_name: str, fleet_analytics_name: str, body: FleetAnalyticsResource, content_type: str)`
  - Method `FleetAnalyticsOperations.create` has a new overload `def create(self: None, resource_group_name: str, fleet_name: str, fleet_analytics_name: str, body: IO[bytes], content_type: str)`
  - Method `FleetOperations.create` has a new overload `def create(self: None, resource_group_name: str, fleet_name: str, body: FleetResource, content_type: str)`
  - Method `FleetOperations.create` has a new overload `def create(self: None, resource_group_name: str, fleet_name: str, body: IO[bytes], content_type: str)`
  - Method `FleetOperations.update` has a new overload `def update(self: None, resource_group_name: str, fleet_name: str, body: Optional[FleetResourceUpdate], content_type: str)`
  - Method `FleetOperations.update` has a new overload `def update(self: None, resource_group_name: str, fleet_name: str, body: Optional[IO[bytes]], content_type: str)`
  - Method `FleetspaceAccountOperations.begin_create` has a new overload `def begin_create(self: None, resource_group_name: str, fleet_name: str, fleetspace_name: str, fleetspace_account_name: str, body: FleetspaceAccountResource, content_type: str)`
  - Method `FleetspaceAccountOperations.begin_create` has a new overload `def begin_create(self: None, resource_group_name: str, fleet_name: str, fleetspace_name: str, fleetspace_account_name: str, body: IO[bytes], content_type: str)`
  - Method `FleetspaceOperations.begin_create` has a new overload `def begin_create(self: None, resource_group_name: str, fleet_name: str, fleetspace_name: str, body: FleetspaceResource, content_type: str)`
  - Method `FleetspaceOperations.begin_create` has a new overload `def begin_create(self: None, resource_group_name: str, fleet_name: str, fleetspace_name: str, body: IO[bytes], content_type: str)`
  - Method `FleetspaceOperations.begin_update` has a new overload `def begin_update(self: None, resource_group_name: str, fleet_name: str, fleetspace_name: str, body: Optional[FleetspaceUpdate], content_type: str)`
  - Method `FleetspaceOperations.begin_update` has a new overload `def begin_update(self: None, resource_group_name: str, fleet_name: str, fleetspace_name: str, body: Optional[IO[bytes]], content_type: str)`
  - Method `MongoMIResourcesOperations.begin_create_update_mongo_mi_role_assignment` has a new overload `def begin_create_update_mongo_mi_role_assignment(self: None, resource_group_name: str, account_name: str, role_assignment_id: str, create_update_mongo_mi_role_assignment_parameters: MongoMIRoleAssignmentResource, content_type: str)`
  - Method `MongoMIResourcesOperations.begin_create_update_mongo_mi_role_assignment` has a new overload `def begin_create_update_mongo_mi_role_assignment(self: None, resource_group_name: str, account_name: str, role_assignment_id: str, create_update_mongo_mi_role_assignment_parameters: IO[bytes], content_type: str)`
  - Method `MongoMIResourcesOperations.begin_create_update_mongo_mi_role_definition` has a new overload `def begin_create_update_mongo_mi_role_definition(self: None, resource_group_name: str, account_name: str, role_definition_id: str, create_update_mongo_mi_role_definition_parameters: MongoMIRoleDefinitionResource, content_type: str)`
  - Method `MongoMIResourcesOperations.begin_create_update_mongo_mi_role_definition` has a new overload `def begin_create_update_mongo_mi_role_definition(self: None, resource_group_name: str, account_name: str, role_definition_id: str, create_update_mongo_mi_role_definition_parameters: IO[bytes], content_type: str)`
