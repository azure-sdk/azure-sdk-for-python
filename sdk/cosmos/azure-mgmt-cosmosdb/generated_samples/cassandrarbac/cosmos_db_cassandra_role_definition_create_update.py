...
# USAGE
    python cosmos_db_cassandra_role_definition_create_update.py
...
def main():
    ...
    response = client.cassandra_resources.begin_create_update_cassandra_role_definition(
...
# x-ms-original-file: specification/cosmos-db/resource-manager/Microsoft.DocumentDB/preview/2025-05-01-preview/examples/cassandrarbac/CosmosDBCassandraRoleDefinitionCreateUpdate.json
