...
,
    ...
    async def test_begin_delete(self, resource_group):
        response = await (await self.client.cassandra_clusters.begin_delete(
            resource_group_name=resource_group.name,
            cluster_name="str"
,
            api_version="2024-09-01-preview"
,
    ...
    async def test_begin_create_update(self, resource_group):
        response = await (await self.client.cassandra_clusters.begin_create_update(
            resource_group_name=resource_group.name,
            cluster_name="str"
,
            body={
...
,
    ...
    async def test_begin_update(self, resource_group):
        response = await (await self.client.cassandra_clusters.begin_update(
            resource_group_name=resource_group.name,
            cluster_name="str"
,
            body={
...
,
    ...
    async def test_begin_invoke_command(self, resource_group):
        response = await (await self.client.cassandra_clusters.begin_invoke_command(
            resource_group_name=resource_group.name,
            cluster_name="str"
,
            body={
...
,
    ...
    async def test_begin_invoke_command_async(self, resource_group):
        response = await (await self.client.cassandra_clusters.begin_invoke_command_async(
            resource_group_name=resource_group.name,
            cluster_name="str"
,
            body={
...
,
    ...
    async def test_begin_deallocate(self, resource_group):
        response = await (await self.client.cassandra_clusters.begin_deallocate(
            resource_group_name=resource_group.name,
            cluster_name="str"
,
            api_version="2024-09-01-preview"
,
    ...
    async def test_begin_start(self, resource_group):
        response = await (await self.client.cassandra_clusters.begin_start(
            resource_group_name=resource_group.name,
            cluster_name="str"
,
            api_version="2024-09-01-preview"
