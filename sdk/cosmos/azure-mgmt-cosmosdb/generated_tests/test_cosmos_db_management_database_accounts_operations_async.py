...
,
    ...
    async def test_begin_update(self, resource_group):
        response = await (await self.client.database_accounts.begin_update(
            resource_group_name=resource_group.name,
            account_name="str"
,
            update_parameters={
...
,
    ...
    async def test_begin_create_or_update(self, resource_group):
        response = await (await self.client.database_accounts.begin_create_or_update(
            resource_group_name=resource_group.name,
            account_name="str"
,
...
,
    ...
    async def test_begin_delete(self, resource_group):
        response = await (await self.client.database_accounts.begin_delete(
            resource_group_name=resource_group.name,
            account_name="str"
,
            api_version="2024-09-01-preview"
,
    ...
    async def test_begin_failover_priority_change(self, resource_group):
        response = await (await self.client.database_accounts.begin_failover_priority_change(
            resource_group_name=resource_group.name,
            account_name="str"
,
            failover_parameters={
...
,
    ...
    async def test_begin_offline_region(self, resource_group):
        response = await (await self.client.database_accounts.begin_offline_region(
            resource_group_name=resource_group.name,
            account_name="str"
,
...
,
    ...
    async def test_begin_online_region(self, resource_group):
        response = await (await self.client.database_accounts.begin_online_region(
            resource_group_name=resource_group.name,
            account_name="str"
,
...
,
    ...
    async def test_begin_regenerate_key(self, resource_group):
        response = await (await self.client.database_accounts.begin_regenerate_key(
            resource_group_name=resource_group.name,
            account_name="str"
,
            key_to_regenerate={
