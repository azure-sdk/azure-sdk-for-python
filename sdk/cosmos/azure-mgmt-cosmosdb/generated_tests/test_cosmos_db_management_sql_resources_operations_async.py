...
,
    ...
    async def test_begin_create_update_sql_database(self, resource_group):
        response = await (await self.client.sql_resources.begin_create_update_sql_database(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_delete_sql_database(self, resource_group):
        response = await (await self.client.sql_resources.begin_delete_sql_database(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_update_sql_database_throughput(self, resource_group):
        response = await (await self.client.sql_resources.begin_update_sql_database_throughput(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_migrate_sql_database_to_autoscale(self, resource_group):
        response = await (await self.client.sql_resources.begin_migrate_sql_database_to_autoscale(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_migrate_sql_database_to_manual_throughput(self, resource_group):
        response = await (await self.client.sql_resources.begin_migrate_sql_database_to_manual_throughput(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_create_update_client_encryption_key(self, resource_group):
        response = await (await self.client.sql_resources.begin_create_update_client_encryption_key(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_create_update_sql_container(self, resource_group):
        response = await (await self.client.sql_resources.begin_create_update_sql_container(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_delete_sql_container(self, resource_group):
        response = await (await self.client.sql_resources.begin_delete_sql_container(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_sql_database_partition_merge(self, resource_group):
        response = await (await self.client.sql_resources.begin_sql_database_partition_merge(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_list_sql_container_partition_merge(self, resource_group):
        response = await (await self.client.sql_resources.begin_list_sql_container_partition_merge(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_update_sql_container_throughput(self, resource_group):
        response = await (await self.client.sql_resources.begin_update_sql_container_throughput(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_migrate_sql_container_to_autoscale(self, resource_group):
        response = await (await self.client.sql_resources.begin_migrate_sql_container_to_autoscale(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_migrate_sql_container_to_manual_throughput(self, resource_group):
        response = await (await self.client.sql_resources.begin_migrate_sql_container_to_manual_throughput(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_sql_database_retrieve_throughput_distribution(self, resource_group):
        response = await (await self.client.sql_resources.begin_sql_database_retrieve_throughput_distribution(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_sql_database_redistribute_throughput(self, resource_group):
        response = await (await self.client.sql_resources.begin_sql_database_redistribute_throughput(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_sql_container_retrieve_throughput_distribution(self, resource_group):
        response = await (await self.client.sql_resources.begin_sql_container_retrieve_throughput_distribution(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_sql_container_redistribute_throughput(self, resource_group):
        response = await (await self.client.sql_resources.begin_sql_container_redistribute_throughput(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_create_update_sql_stored_procedure(self, resource_group):
        response = await (await self.client.sql_resources.begin_create_update_sql_stored_procedure(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_delete_sql_stored_procedure(self, resource_group):
        response = await (await self.client.sql_resources.begin_delete_sql_stored_procedure(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_create_update_sql_user_defined_function(self, resource_group):
        response = await (await self.client.sql_resources.begin_create_update_sql_user_defined_function(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_delete_sql_user_defined_function(self, resource_group):
        response = await (await self.client.sql_resources.begin_delete_sql_user_defined_function(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_create_update_sql_trigger(self, resource_group):
        response = await (await self.client.sql_resources.begin_create_update_sql_trigger(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_delete_sql_trigger(self, resource_group):
        response = await (await self.client.sql_resources.begin_delete_sql_trigger(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_create_update_sql_role_definition(self, resource_group):
        response = await (await self.client.sql_resources.begin_create_update_sql_role_definition(
            role_definition_id="str"
,
            resource_group_name=resource_group.name,
            account_name="str"
...
,
    ...
    async def test_begin_delete_sql_role_definition(self, resource_group):
        response = await (await self.client.sql_resources.begin_delete_sql_role_definition(
            role_definition_id="str"
,
            resource_group_name=resource_group.name,
            account_name="str"
...
,
    ...
    async def test_begin_create_update_sql_role_assignment(self, resource_group):
        response = await (await self.client.sql_resources.begin_create_update_sql_role_assignment(
            role_assignment_id="str"
,
            resource_group_name=resource_group.name,
            account_name="str"
...
,
    ...
    async def test_begin_delete_sql_role_assignment(self, resource_group):
        response = await (await self.client.sql_resources.begin_delete_sql_role_assignment(
            role_assignment_id="str"
,
            resource_group_name=resource_group.name,
            account_name="str"
...
,
    ...
    async def test_begin_retrieve_continuous_backup_information(self, resource_group):
        response = await (await self.client.sql_resources.begin_retrieve_continuous_backup_information(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
