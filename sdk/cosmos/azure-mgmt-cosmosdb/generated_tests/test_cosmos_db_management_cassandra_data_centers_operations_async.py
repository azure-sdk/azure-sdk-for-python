...
,
    ...
    async def test_begin_delete(self, resource_group):
        response = await (await self.client.cassandra_data_centers.begin_delete(
            resource_group_name=resource_group.name,
            cluster_name="str"
,
            data_center_name="str"
...
,
    ...
    async def test_begin_create_update(self, resource_group):
        response = await (await self.client.cassandra_data_centers.begin_create_update(
            resource_group_name=resource_group.name,
            cluster_name="str"
,
            data_center_name="str"
...
,
    ...
    async def test_begin_update(self, resource_group):
        response = await (await self.client.cassandra_data_centers.begin_update(
            resource_group_name=resource_group.name,
            cluster_name="str"
,
            data_center_name="str"
