...
,
    ...
    async def test_begin_create_or_update(self, resource_group):
        response = await (await self.client.notebook_workspaces.begin_create_or_update(
            resource_group_name=resource_group.name,
            account_name="str"
,
            notebook_workspace_name="str"
...
,
    ...
    async def test_begin_delete(self, resource_group):
        response = await (await self.client.notebook_workspaces.begin_delete(
            resource_group_name=resource_group.name,
            account_name="str"
,
            notebook_workspace_name="str"
...
,
    ...
    async def test_begin_regenerate_auth_token(self, resource_group):
        response = await (await self.client.notebook_workspaces.begin_regenerate_auth_token(
            resource_group_name=resource_group.name,
            account_name="str"
,
            notebook_workspace_name="str"
...
,
    ...
    async def test_begin_start(self, resource_group):
        response = await (await self.client.notebook_workspaces.begin_start(
            resource_group_name=resource_group.name,
            account_name="str"
,
            notebook_workspace_name="str"
