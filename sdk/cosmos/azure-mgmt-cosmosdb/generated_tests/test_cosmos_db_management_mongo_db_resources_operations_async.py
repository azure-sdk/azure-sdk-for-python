...
,
    ...
    async def test_begin_create_update_mongo_db_database(self, resource_group):
        response = await (await self.client.mongo_db_resources.begin_create_update_mongo_db_database(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_delete_mongo_db_database(self, resource_group):
        response = await (await self.client.mongo_db_resources.begin_delete_mongo_db_database(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_update_mongo_db_database_throughput(self, resource_group):
        response = await (await self.client.mongo_db_resources.begin_update_mongo_db_database_throughput(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_migrate_mongo_db_database_to_autoscale(self, resource_group):
        response = await (await self.client.mongo_db_resources.begin_migrate_mongo_db_database_to_autoscale(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_migrate_mongo_db_database_to_manual_throughput(self, resource_group):
        response = await (await self.client.mongo_db_resources.begin_migrate_mongo_db_database_to_manual_throughput(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_mongo_db_database_retrieve_throughput_distribution(self, resource_group):
        response = await (await self.client.mongo_db_resources.begin_mongo_db_database_retrieve_throughput_distribution(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_mongo_db_database_redistribute_throughput(self, resource_group):
        response = await (await self.client.mongo_db_resources.begin_mongo_db_database_redistribute_throughput(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_mongo_db_container_retrieve_throughput_distribution(self, resource_group):
        response = await (await self.client.mongo_db_resources.begin_mongo_db_container_retrieve_throughput_distribution(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_mongo_db_container_redistribute_throughput(self, resource_group):
        response = await (await self.client.mongo_db_resources.begin_mongo_db_container_redistribute_throughput(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_create_update_mongo_db_collection(self, resource_group):
        response = await (await self.client.mongo_db_resources.begin_create_update_mongo_db_collection(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_delete_mongo_db_collection(self, resource_group):
        response = await (await self.client.mongo_db_resources.begin_delete_mongo_db_collection(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_mongo_db_database_partition_merge(self, resource_group):
        response = await (await self.client.mongo_db_resources.begin_mongo_db_database_partition_merge(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_list_mongo_db_collection_partition_merge(self, resource_group):
        response = await (await self.client.mongo_db_resources.begin_list_mongo_db_collection_partition_merge(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_update_mongo_db_collection_throughput(self, resource_group):
        response = await (await self.client.mongo_db_resources.begin_update_mongo_db_collection_throughput(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_migrate_mongo_db_collection_to_autoscale(self, resource_group):
        response = await (await self.client.mongo_db_resources.begin_migrate_mongo_db_collection_to_autoscale(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_migrate_mongo_db_collection_to_manual_throughput(self, resource_group):
        response = await (await self.client.mongo_db_resources.begin_migrate_mongo_db_collection_to_manual_throughput(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
...
,
    ...
    async def test_begin_create_update_mongo_role_definition(self, resource_group):
        response = await (await self.client.mongo_db_resources.begin_create_update_mongo_role_definition(
            mongo_role_definition_id="str"
,
            resource_group_name=resource_group.name,
            account_name="str"
...
,
    ...
    async def test_begin_delete_mongo_role_definition(self, resource_group):
        response = await (await self.client.mongo_db_resources.begin_delete_mongo_role_definition(
            mongo_role_definition_id="str"
,
            resource_group_name=resource_group.name,
            account_name="str"
...
,
    ...
    async def test_begin_create_update_mongo_user_definition(self, resource_group):
        response = await (await self.client.mongo_db_resources.begin_create_update_mongo_user_definition(
            mongo_user_definition_id="str"
,
            resource_group_name=resource_group.name,
            account_name="str"
...
,
    ...
    async def test_begin_delete_mongo_user_definition(self, resource_group):
        response = await (await self.client.mongo_db_resources.begin_delete_mongo_user_definition(
            mongo_user_definition_id="str"
,
            resource_group_name=resource_group.name,
            account_name="str"
...
,
    ...
    async def test_begin_retrieve_continuous_backup_information(self, resource_group):
        response = await (await self.client.mongo_db_resources.begin_retrieve_continuous_backup_information(
            resource_group_name=resource_group.name,
            account_name="str"
,
            database_name="str"
