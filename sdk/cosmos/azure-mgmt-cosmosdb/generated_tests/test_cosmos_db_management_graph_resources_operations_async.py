...
,
    ...
    async def test_begin_create_update_graph(self, resource_group):
        response = await (await self.client.graph_resources.begin_create_update_graph(
            resource_group_name=resource_group.name,
            account_name="str"
,
            graph_name="str"
...
,
    ...
    async def test_begin_delete_graph_resource(self, resource_group):
        response = await (await self.client.graph_resources.begin_delete_graph_resource(
            resource_group_name=resource_group.name,
            account_name="str"
,
            graph_name="str"
