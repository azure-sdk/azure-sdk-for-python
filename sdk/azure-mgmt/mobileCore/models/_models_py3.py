...
class AmfDeploymentResource(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype operational_status: ~Microsoft.MobilePacketCore.models.OperationalStatus
    """
...
class AmfDeploymentResourceListResult(_serialization.Model):
    ...
    :vartype value: list[~Microsoft.MobilePacketCore.models.AmfDeploymentResource]
    ...
    def __init__(self, *, value: List["_models.AmfDeploymentResource"], **kwargs: Any) -> None:
        """
        :keyword value: The AmfDeploymentResource items on this page. Required.
        :paramtype value: list[~Microsoft.MobilePacketCore.models.AmfDeploymentResource]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class ClusterServiceClusterTypeSpecificData(_serialization.Model):
    ...
    :vartype type: str or ~Microsoft.MobilePacketCore.models.ClusterType
...
class ClusterServiceResource(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar deployment_type: Cluster type (Lab or Production). Known values are: "Production" and
     "Lab".
    :vartype deployment_type: str or ~Microsoft.MobilePacketCore.models.SkuDeploymentType
    ...
    :vartype cluster_type_specific_data:
     ~Microsoft.MobilePacketCore.models.ClusterServiceClusterTypeSpecificData
    ...
    :vartype component_parameters:
     list[~Microsoft.MobilePacketCore.models.QualifiedComponentDeploymentParameters]
    :ivar operational_status: Operational status.
    :vartype operational_status: ~Microsoft.MobilePacketCore.models.OperationalStatus
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword deployment_type: Cluster type (Lab or Production). Known values are: "Production" and
         "Lab".
        :paramtype deployment_type: str or ~Microsoft.MobilePacketCore.models.SkuDeploymentType
...
class ClusterServiceResourceListResult(_serialization.Model):
    ...
    :vartype value: list[~Microsoft.MobilePacketCore.models.ClusterServiceResource]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: List["_models.ClusterServiceResource"], **kwargs: Any) -> None:
        """
        :keyword value: The ClusterServiceResource items on this page. Required.
        :paramtype value: list[~Microsoft.MobilePacketCore.models.ClusterServiceResource]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class NrfDeploymentResourceListResult(_serialization.Model):
    ...
    :vartype value: list[~Microsoft.MobilePacketCore.models.NrfDeploymentResource]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: List["_models.NrfDeploymentResource"], **kwargs: Any) -> None:
        """
        :keyword value: The NrfDeploymentResource items on this page. Required.
        :paramtype value: list[~Microsoft.MobilePacketCore.models.NrfDeploymentResource]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class NssfDeploymentResourceListResult(_serialization.Model):
    ...
    :vartype value: list[~Microsoft.MobilePacketCore.models.NssfDeploymentResource]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: List["_models.NssfDeploymentResource"], **kwargs: Any) -> None:
        """
        :keyword value: The NssfDeploymentResource items on this page. Required.
        :paramtype value: list[~Microsoft.MobilePacketCore.models.NssfDeploymentResource]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class ObservabilityServiceResourceListResult(_serialization.Model):
    ...
    :vartype value: list[~Microsoft.MobilePacketCore.models.ObservabilityServiceResource]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: List["_models.ObservabilityServiceResource"], **kwargs: Any) -> None:
        """
        :keyword value: The ObservabilityServiceResource items on this page. Required.
        :paramtype value: list[~Microsoft.MobilePacketCore.models.ObservabilityServiceResource]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class SmfDeploymentResourceListResult(_serialization.Model):
    ...
    :vartype value: list[~Microsoft.MobilePacketCore.models.SmfDeploymentResource]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: List["_models.SmfDeploymentResource"], **kwargs: Any) -> None:
        """
        :keyword value: The SmfDeploymentResource items on this page. Required.
        :paramtype value: list[~Microsoft.MobilePacketCore.models.SmfDeploymentResource]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class UpfDeploymentResourceListResult(_serialization.Model):
    ...
    :vartype value: list[~Microsoft.MobilePacketCore.models.UpfDeploymentResource]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: List["_models.UpfDeploymentResource"], **kwargs: Any) -> None:
        """
        :keyword value: The UpfDeploymentResource items on this page. Required.
        :paramtype value: list[~Microsoft.MobilePacketCore.models.UpfDeploymentResource]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
