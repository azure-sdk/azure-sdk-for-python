...
class TestContainerInstanceManagementContainerGroupProfileOperations(AzureMgmtRecordedTestCase):
    ...
    def test_create_or_update(self, resource_group):
        response = self.client.container_group_profile.create_or_update(
            resource_group_name=resource_group.name,
    ...
    def test_update(self, resource_group):
        response = self.client.container_group_profile.update(
            resource_group_name=resource_group.name,
            container_group_profile_name="str",
            api_version="2024-11-01-preview",
        )
    ...
    def test_get(self, resource_group):
        response = self.client.container_group_profile.get(
            resource_group_name=resource_group.name,
            container_group_profile_name="str",
            api_version="2024-11-01-preview",
        )
    ...
    def test_begin_delete(self, resource_group):
        response = self.client.container_group_profile.begin_delete(
            resource_group_name=resource_group.name,
            container_group_profile_name="str",
            api_version="2024-11-01-preview",
