...
from ...operations._ngroups_skus_operations import build_get_request
...
class NGroupsSkusOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, ngroups_name: str, **kwargs: Any) -> AsyncIterable["_models.NGroupSkus"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerinstance.models.NGroupSkus]
