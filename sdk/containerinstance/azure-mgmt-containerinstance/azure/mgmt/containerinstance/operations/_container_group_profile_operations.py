...
class ContainerGroupProfileOperations:
    ...
    def update(
        ...
        resource_group_name: str,
        container_group_profile_name: str,
        container_group_profile: Optional[_models.Resource] = None,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.ContainerGroupProfile:
        ...
        :param container_group_profile_name: ContainerGroupProfile name. Required.
        :type container_group_profile_name: str
        :param container_group_profile: Update a specified container group profile that will also
         update the revision. Default value is None.
        :type container_group_profile: ~azure.mgmt.containerinstance.models.Resource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ContainerGroupProfile or the result of cls(response)
    ...
    def update(
        ...
        resource_group_name: str,
        container_group_profile_name: str,
        container_group_profile: Optional[IO[bytes]] = None,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.ContainerGroupProfile:
    ...
    def update(
        ...
        resource_group_name: str,
        container_group_profile_name: str,
        container_group_profile: Optional[Union[_models.Resource, IO[bytes]]] = None,
        **kwargs: Any
    ) -> _models.ContainerGroupProfile:
        """Update a specified ContainerGroupProfile.
        ...
        :type container_group_profile_name: str
        :param container_group_profile: Update a specified container group profile that will also
         update the revision. Is either a Resource type or a IO[bytes] type. Default value is None.
        :type container_group_profile: ~azure.mgmt.containerinstance.models.Resource or IO[bytes]
        :return: ContainerGroupProfile or the result of cls(response)
        :rtype: ~azure.mgmt.containerinstance.models.ContainerGroupProfile
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(container_group_profile, (IOBase, bytes)):
            ...
            if container_group_profile is not None:
                _json = self._serialize.body(container_group_profile, "Resource")
            else:
                _json = None
    ...
    def _delete_initial(
        ...
        if response.status_code == 202:
            response_headers["Ax-ms-correlation-request-id"] = self._deserialize(
                "str", response.headers.get("Ax-ms-correlation-request-id")
            )
