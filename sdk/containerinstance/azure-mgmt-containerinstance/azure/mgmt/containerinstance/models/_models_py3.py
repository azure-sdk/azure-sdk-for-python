...
class ContainerGroupProfile(Resource):
    ...
    _attribute_map = {
        ...
        "zones": {"key": "zones", "type": "[str]"},
        "location": {"key": "location", "type": "str"},
        "properties": {"key": "properties", "type": "ContainerGroupProfileProperties"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype location: str
        :keyword properties: The container group profile properties.
        :paramtype properties: ~azure.mgmt.containerinstance.models.ContainerGroupProfileProperties
        """
        super().__init__(tags=tags, zones=zones, **kwargs)
        self.location = location
...
class FileShareProperties(_serialization.Model):
    ...
    :ivar share_access_tier: learn more at:
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype share_access_type: str or
         ~azure.mgmt.containerinstance.models.AzureFileShareAccessType
        :keyword share_access_tier: learn more at:
         https://learn.microsoft.com/en-us/rest/api/storagerp/file-shares/create?tabs=HTTP#shareaccesstier.
         Known values are: "cool", "hot", "premium", and "transactionoptimized".
...
class NGroup(Resource):  # pylint: disable=too-many-instance-attributes
