...
class TestMicrosoftSerialConsoleAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_list_operations(self, resource_group):
        response = await self.client.list_operations(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_get_console_status(self, resource_group):
        response = await self.client.get_console_status(
            default="str",
            api_version="2024-07-01",
        )
