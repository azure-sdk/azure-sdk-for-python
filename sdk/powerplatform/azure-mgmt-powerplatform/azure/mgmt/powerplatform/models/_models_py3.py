...
class PropertiesNetworkInjection(_serialization.Model):
    ...
    _attribute_map = {
        "virtual_networks": {"key": "virtualNetworks", "type": "[VirtualNetworkProperties]"},
    }

    def __init__(
        self, *, virtual_networks: Optional[List["_models.VirtualNetworkProperties"]] = None, **kwargs: Any
    ) -> None:
        """
        :keyword virtual_networks: Network injection configuration.
        :paramtype virtual_networks: list[~azure.mgmt.powerplatform.models.VirtualNetworkProperties]
        """
        super().__init__(**kwargs)
