...
### Features Added
  ...
  - Added enum `DiagnosticsRemoteSupportAccessLevels`
  - Added enum `DiagnosticsRemoteSupportActivationState`
  - Added model `DiagnosticsRemoteSupportProperties`
  ...
  - Method `AkriConnectorResource.__init__` has a new overload `def __init__(self: None, extended_location: _models.ExtendedLocation, properties: Optional[_models.AkriConnectorProperties])`
  ...
  - Method `AkriConnectorTemplateResource.__init__` has a new overload `def __init__(self: None, extended_location: _models.ExtendedLocation, properties: Optional[_models.AkriConnectorTemplateProperties])`
  ...
  - Method `AkriConnectorTemplateRuntimeStatefulSetConfiguration.__init__` has a new overload `def __init__(self: None, mapping: Mapping[str, Any])`
  - Method `AkriConnectorTemplateTrustList.__init__` has a new overload `def __init__(self: None, secret_ref: str)`
  ...
  - Method `AkriDiscoveryHandlerResource.__init__` has a new overload `def __init__(self: None, extended_location: _models.ExtendedLocation, properties: Optional[_models.AkriDiscoveryHandlerProperties])`
  ...
  - Method `DatafloGraphDestinationNode.__init__` has a new overload `def __init__(self: None, mapping: Mapping[str, Any])`
  - Method `DataflowEndpointOpenTelemetry.__init__` has a new overload `def __init__(self: None, host: str, metric_interval_sec: Optional[int], batching: Optional[_models.BatchingConfiguration], tls: Optional[_models.TlsProperties])`
  ...
  - Method `DataflowGraphResource.__init__` has a new overload `def __init__(self: None, extended_location: _models.ExtendedLocation, properties: Optional[_models.DataflowGraphProperties])`
  ...
  - Method `DiagnosticProperties.__init__` has a new overload `def __init__(self: None, remote_support: Optional[_models.DiagnosticsRemoteSupportProperties])`
  ...
  - Method `DiagnosticsRemoteSupportProperties.__init__` has a new overload `def __init__(self: None, state: Optional[Union[str, _models.DiagnosticsRemoteSupportActivationState]], access_level: Optional[Union[str, _models.DiagnosticsRemoteSupportAccessLevels]], expiration_timestamp: Optional[str])`
  - Method `DiagnosticsRemoteSupportProperties.__init__` has a new overload `def __init__(self: None, mapping: Mapping[str, Any])`
  ...
  - Method `RegistryEndpointProperties.__init__` has a new overload `def __init__(self: None, host: str, authentication: _models.RegistryEndpointAuthentication)`
  - Method `RegistryEndpointProperties.__init__` has a new overload `def __init__(self: None, mapping: Mapping[str, Any])`
  - Method `RegistryEndpointResource.__init__` has a new overload `def __init__(self: None, extended_location: _models.ExtendedLocation, properties: Optional[_models.RegistryEndpointProperties])`
