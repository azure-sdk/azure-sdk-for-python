...
class TestIoTOperationsMgmtAkriDiscoveryHandlerOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(IoTOperationsMgmtClient, is_async=True)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_akri_discovery_handler_get(self, resource_group):
        response = await self.client.akri_discovery_handler.get(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_akri_discovery_handler_begin_create_or_update(self, resource_group):
        response = await (
            await self.client.akri_discovery_handler.begin_create_or_update(
                resource_group_name=resource_group.name,
                instance_name="str",
                akri_discovery_handler_name="str",
                resource={
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_akri_discovery_handler_begin_delete(self, resource_group):
        response = await (
            await self.client.akri_discovery_handler.begin_delete(
                resource_group_name=resource_group.name,
                instance_name="str",
                akri_discovery_handler_name="str",
            )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_akri_discovery_handler_list_by_instance_resource(self, resource_group):
