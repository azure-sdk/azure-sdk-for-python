...
class DiagnosticsRemoteSupportAccessLevels(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class DiagnosticsRemoteSupportActivationState(str, Enum, metaclass=CaseInsensitiveEnumMeta):
