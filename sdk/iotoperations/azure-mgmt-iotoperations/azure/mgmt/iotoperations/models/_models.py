...
class AkriConnectorTemplateTrustList(_Model):
    ...
    :ivar secret_ref: The secret reference for certificates to trust. Required.
    :vartype secret_ref: str
    """
...
class DataflowEndpointOpenTelemetry(_Model):
    ...
    :ivar metric_interval_sec: The number of seconds to wait before sending metrics to the Open
     telemetry collector.
...
class DataflowEndpointProperties(_Model):
    ...
    :ivar host_type: The type of the Kafka host. E.g FabricRT, EventGrid. Known values are:
     "FabricRT", "EventGrid", "LocalMq", "Eventhub", "CustomMq", and "CustomKafka".
    ...
    """The type of the Kafka host. E.g FabricRT, EventGrid. Known values are: \"FabricRT\",
     \"EventGrid\", \"LocalMq\", \"Eventhub\", \"CustomMq\", and \"CustomKafka\"."""
...
class DiagnosticProperties(_Model):
    ...
    :vartype remote_support: ~azure.mgmt.iotoperations.models.DiagnosticsRemoteSupportProperties
    :ivar provisioning_state: The status of the last operation. Known values are: "Succeeded",
     "Failed", "Canceled", "Provisioning", "Updating", "Deleting", and "Accepted".
    :vartype provisioning_state: str or ~azure.mgmt.iotoperations.models.ProvisioningState
    """

    remote_support: Optional["_models.DiagnosticsRemoteSupportProperties"] = rest_field(
    ...
    def __init__(
        self,
        *,
        remote_support: Optional["_models.DiagnosticsRemoteSupportProperties"] = None,
    ) -> None: ...
...
class DiagnosticsRemoteSupportProperties(_Model):
    """RemoteSupport properties.

    :ivar state: Activation state of Diagnostic. Known values are: "Enabled" and "Disabled".
    :vartype state: str or ~azure.mgmt.iotoperations.models.DiagnosticsRemoteSupportActivationState
    :ivar access_level: Access level for Diagnostic. Known values are: "Diagnose" and
     "DiagnoseAndRepair".
    :vartype access_level: str or
     ~azure.mgmt.iotoperations.models.DiagnosticsRemoteSupportAccessLevels
    :ivar expiration_timestamp: Expiration timestamp for Diagnostic.
    :vartype expiration_timestamp: str
    """

    state: Optional[Union[str, "_models.DiagnosticsRemoteSupportActivationState"]] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    """Activation state of Diagnostic. Known values are: \"Enabled\" and \"Disabled\"."""
    access_level: Optional[Union[str, "_models.DiagnosticsRemoteSupportAccessLevels"]] = rest_field(
    ...
    def __init__(
        self,
        *,
        state: Optional[Union[str, "_models.DiagnosticsRemoteSupportActivationState"]] = None,
        access_level: Optional[Union[str, "_models.DiagnosticsRemoteSupportAccessLevels"]] = None,
