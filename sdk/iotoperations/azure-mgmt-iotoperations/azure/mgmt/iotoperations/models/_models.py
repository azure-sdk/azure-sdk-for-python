...
class InstanceProperties(_model_base.Model):
    ...
    :vartype features: dict[str, str or ~azure.mgmt.iotoperations.models.OperationalMode]
    """
    ...
    features: Optional[Dict[str, Union[str, "_models.OperationalMode"]]] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        ...
        *,
        ...
        description: Optional[str] = None,
        features: Optional[Dict[str, Union[str, "_models.OperationalMode"]]] = None,
    ) -> None: ...
