...
class IoTOperationsMgmtClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype diagnostics: azure.mgmt.iotoperations.aio.operations.DiagnosticsOperations
    ...
    :vartype diagnostic: azure.mgmt.iotoperations.aio.operations.DiagnosticOperations
