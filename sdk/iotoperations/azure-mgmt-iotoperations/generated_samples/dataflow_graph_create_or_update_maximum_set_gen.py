                ...
                "nodeConnections": [
                    {
                        "from": {
                            "name": "wsqbccd",
                            "schema": {"schemaRef": "gkyqreiunkvdgggy", "serializationFormat": "Delta"},
                        },
                        "to": {"name": "dqvkpqshglptwrjfeblfzbofmkfktzbjhidsvqctmbzocbtgtkbgrayg"},
                    }
                ],
                "nodes": [{"name": "gjbjgii", "type": "DataflowGraphNode"}],
