...
# USAGE
    python diagnostic_create_or_update_maximum_set_gen.py
...
def main():
    ...
    response = client.diagnostic.begin_create_or_update(
        resource_group_name="rgiotoperations",
        instance_name="resource-123",
        diagnostic_name="resource-123",
        resource={
            "extendedLocation": {"name": "qmbrfwcpwwhggszhrdjv", "type": "CustomLocation"},
            "properties": {
                "remoteSupport": {"accessLevel": "Diagnose", "expirationTimestamp": "tkaq", "state": "Enabled"}
            },
        },
    ).result()
    print(response)
