...
# USAGE
    python registry_endpoint_create_or_update_maximum_set_gen.py
...
def main():
    ...
    response = client.registry_endpoint.begin_create_or_update(
        ...
        resource={
            ...
            "properties": {
                "authentication": {"method": "RegistryEndpointAuthentication"},
