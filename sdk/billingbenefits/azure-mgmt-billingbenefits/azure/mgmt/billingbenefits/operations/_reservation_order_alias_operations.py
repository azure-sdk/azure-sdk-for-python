...
def build_create_request(reservation_order_alias_name: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/providers/Microsoft.BillingBenefits/reservationOrderAliases/{reservationOrderAliasName}"
    )  # pylint: disable=line-too-long
    path_format_arguments = {
        "reservationOrderAliasName": _SERIALIZER.url(
            "reservation_order_alias_name", reservation_order_alias_name, "str", pattern=r"^[a-zA-Z0-9_\-\.]+$"
        ),
    }
...
def build_get_request(reservation_order_alias_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ReservationOrderAliasOperations:
    ...
    def begin_create(
        ...
        :param body: Request body for creating a reservation order alias. Is either a
         ReservationOrderAliasRequest type or a IO type. Required.
