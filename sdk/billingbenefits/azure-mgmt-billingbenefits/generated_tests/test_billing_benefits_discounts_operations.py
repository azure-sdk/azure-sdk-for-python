...
class TestBillingBenefitsDiscountsOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(BillingBenefitsClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_discounts_get(self, resource_group):
        response = self.client.discounts.get(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_discounts_begin_update(self, resource_group):
        response = self.client.discounts.begin_update(
            resource_group_name=resource_group.name,
            discount_name="str",
