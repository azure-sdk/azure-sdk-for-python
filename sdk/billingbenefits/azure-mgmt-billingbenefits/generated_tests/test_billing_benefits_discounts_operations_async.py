...
class TestBillingBenefitsDiscountsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_discounts_get(self, resource_group):
        response = await self.client.discounts.get(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_discounts_begin_update(self, resource_group):
        response = await (
            await self.client.discounts.begin_update(
                resource_group_name=resource_group.name,
                discount_name="str",
