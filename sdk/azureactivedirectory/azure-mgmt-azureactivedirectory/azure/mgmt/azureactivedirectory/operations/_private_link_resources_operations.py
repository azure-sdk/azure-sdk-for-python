...
def build_list_by_private_link_policy_request(  # pylint: disable=name-too-long
...
def build_get_request(
    resource_group_name: str, policy_name: str, group_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PrivateLinkResourcesOperations:
    ...
    def list_by_private_link_policy(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.azureactivedirectory.models.PrivateLinkResource]
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_private_link_policy_request(
    ...
    @distributed_trace
    def get(
        self, resource_group_name: str, policy_name: str, group_name: str, **kwargs: Any
