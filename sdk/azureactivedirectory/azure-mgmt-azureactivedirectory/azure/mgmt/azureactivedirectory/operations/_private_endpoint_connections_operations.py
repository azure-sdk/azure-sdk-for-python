    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "privateEndpointConnectionName": _SERIALIZER.url(
            "private_endpoint_connection_name", private_endpoint_connection_name, "str", min_length=1
        ),
    }
...
class PrivateEndpointConnectionsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.azureactivedirectory.Azureactivedirectory`'s
    ...
    def list_by_policy_name(
        ...
        :return: An iterator like instance of either PrivateEndpointConnection or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.azureactivedirectory.models.PrivateEndpointConnection]
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_policy_name_request(
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param parameters: The intended state of private endpoint connection. Required.
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param private_endpoint_connection_name: The PrivateEndpointConnection name. Required.
        :type private_endpoint_connection_name: str
        :param parameters: The intended state of private endpoint connection. Is either a
         PrivateEndpointConnection type or a IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.azureactivedirectory.models.PrivateEndpointConnection or
         IO[bytes]
        :return: An instance of LROPoller that returns either PrivateEndpointConnection or the result
         of cls(response)
        :rtype:
    ...
    def _delete_initial(
        self, resource_group_name: str, policy_name: str, private_endpoint_connection_name: str, **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
