...
class PrivateEndpointConnection(ProxyResource):
    ...
    :ivar provisioning_state: Provisioning state of the private endpoint connection. Known values
     are: "Succeeded", "Provisioning", and "Failed".
    ...
    def __init__(
        ...
        *,
        ...
        private_link_connection_tags: Optional["_models.TagsResource"] = None,
        **kwargs: Any
    ) -> None:
        """
...
class PrivateLinkPolicyListResult(_serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.PrivateLinkPolicy"]] = None,
        next_link: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
...
class PrivateLinkPolicyUpdateParameter(_serialization.Model):
...
class PrivateLinkServiceConnectionState(_serialization.Model):
    ...
    :ivar status: Indicates whether the connection has been approved, rejected or removed by the
     given policy owner. Known values are: "Approved", "Pending", "Rejected", and "Disconnected".
