...
def build_maintenance_configuration_operation_group_get_request(  # pylint: disable=name-too-long
...
def build_maintenance_configuration_operation_group_create_or_update_request(  # pylint: disable=name-too-long
    resource_group_name: str, resource_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_maintenance_configuration_operation_group_update_request(  # pylint: disable=name-too-long
    resource_group_name: str, resource_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_maintenance_configuration_operation_group_delete_request(  # pylint: disable=name-too-long
    resource_group_name: str, resource_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_maintenance_configuration_operation_group_list_request(  # pylint: disable=name-too-long
...
def build_maintenance_configuration_operation_group_maintenance_configurations_list_request(  # pylint: disable=name-too-long
    subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_apply_update_operation_group_get_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    provider_name: str,
    resource_type: str,
    resource_name: str,
...
def build_apply_update_operation_group_create_or_update_or_cancel_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    provider_name: str,
    resource_type: str,
    resource_name: str,
...
def build_apply_update_operation_group_list_request(  # pylint: disable=name-too-long
    subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_configuration_assignment_operation_group_get_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    provider_name: str,
    resource_type: str,
    resource_name: str,
...
def build_configuration_assignment_operation_group_create_or_update_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    provider_name: str,
    resource_type: str,
    resource_name: str,
...
def build_configuration_assignment_operation_group_delete_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    provider_name: str,
    resource_type: str,
    resource_name: str,
...
def build_configuration_assignments_for_subscriptions_list_request(  # pylint: disable=name-too-long
    subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_scheduled_event_operation_group_acknowledge_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    resource_type: str,
    resource_name: str,
...
def build_apply_updates_operation_group_create_or_update_parent_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    provider_name: str,
    resource_parent_type: str,
    resource_parent_name: str,
...
def build_apply_updates_operation_group_create_or_update_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    provider_name: str,
    resource_type: str,
    resource_name: str,
...
def build_apply_update_for_resource_group_operation_group_list_request(  # pylint: disable=name-too-long
    resource_group_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_configuration_assignment_for_resource_group_operation_group_list_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    provider_name: str,
    resource_type: str,
    resource_name: str,
...
def build_updates_operation_group_list_parent_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    provider_name: str,
    resource_parent_type: str,
    resource_parent_name: str,
...
def build_updates_operation_group_list_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    provider_name: str,
    resource_type: str,
    resource_name: str,
...
class MaintenanceConfigurationOperationGroupOperations:  # pylint: disable=name-too-long
    ...
    @distributed_trace
    def maintenance_configurations_list(self, **kwargs: Any) -> Iterable["_models.MaintenanceConfiguration"]:
