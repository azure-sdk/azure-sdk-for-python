...
def main():
    ...
    response = client.apply_updates.get(
...
# x-ms-original-file: specification/maintenance/resource-manager/Microsoft.Maintenance/preview/2023-11-01-preview/examples/ApplyUpdates_Get.json
