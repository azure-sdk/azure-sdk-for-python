...
# USAGE
    python configuration_assignments_list_parent.py
...
def main():
    ...
    response = client.configuration_assignments.list_parent(
...
# x-ms-original-file: specification/maintenance/resource-manager/Microsoft.Maintenance/preview/2023-11-01-preview/examples/ConfigurationAssignments_ListParent.json
