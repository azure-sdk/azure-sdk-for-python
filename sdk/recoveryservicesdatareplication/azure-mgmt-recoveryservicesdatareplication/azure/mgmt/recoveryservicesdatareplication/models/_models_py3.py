...
class HyperVToAzStackHCIProtectedDiskProperties(_serialization.Model):  # pylint: disable=name-too-long
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.disk_type = None
        self.disk_block_size = None
        self.disk_logical_sector_size = None
        self.disk_physical_sector_size = None
...
class ProtectedItemModelProperties(_serialization.Model):
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        self.fabric_agent_id = None
        self.target_fabric_agent_id = None
