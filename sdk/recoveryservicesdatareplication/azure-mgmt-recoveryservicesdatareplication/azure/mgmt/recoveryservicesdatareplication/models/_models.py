...
class AzStackHCIClusterProperties(_model_base.Model):
...
class FabricModelCustomProperties(_model_base.Model):
...
class CheckNameAvailabilityModel(_model_base.Model):
...
class CheckNameAvailabilityResponseModel(_model_base.Model):
...
class DeploymentPreflightModel(_model_base.Model):
...
class DeploymentPreflightResource(_model_base.Model):
...
class DiskControllerInputs(_model_base.Model):
    """Disk controller.
...
class EmailConfigurationModelProperties(_model_base.Model):
...
class EventModelCustomProperties(_model_base.Model):
...
class EventModelProperties(_model_base.Model):
...
class FabricAgentModelCustomProperties(_model_base.Model):
...
class FabricAgentModelProperties(_model_base.Model):
...
class FabricModelProperties(_model_base.Model):
...
class FabricModelUpdate(_model_base.Model):
    """Fabric model update.
...
class JobModelCustomProperties(_model_base.Model):
...
class FailoverProtectedItemProperties(_model_base.Model):
...
class GroupConnectivityInformation(_model_base.Model):
...
class HealthErrorModel(_model_base.Model):
    """Health error model.
...
class HyperVToAzStackHCIDiskInput(_model_base.Model):
...
class HyperVToAzStackHCINicInput(_model_base.Model):
...
class PlannedFailoverModelCustomProperties(_model_base.Model):
...
class PolicyModelCustomProperties(_model_base.Model):
...
class HyperVToAzStackHCIProtectedDiskProperties(_model_base.Model):  # pylint: disable=name-too-long
...
class ProtectedItemModelCustomProperties(_model_base.Model):
...
class ProtectedItemModelCustomPropertiesUpdate(_model_base.Model):
    """Protected item model custom properties.
...
class HyperVToAzStackHCIProtectedNicProperties(_model_base.Model):
    """HyperVToAzStackHCI NIC properties.
...
class RecoveryPointModelCustomProperties(_model_base.Model):
...
class ReplicationExtensionModelCustomProperties(_model_base.Model):  # pylint: disable=name-too-long
...
class IdentityModel(_model_base.Model):
    """Identity model.
...
class InnerHealthErrorModel(_model_base.Model):
...
class JobModelCustomPropertiesAffectedObjectDetails(_model_base.Model):  # pylint: disable=name-too-long
...
class JobModelProperties(_model_base.Model):
...
class PlannedFailoverModel(_model_base.Model):
...
class PlannedFailoverModelProperties(_model_base.Model):
...
class PolicyModelProperties(_model_base.Model):
...
class PrivateEndpointConnectionProxyProperties(_model_base.Model):
    """Represents private endpoint connection proxy request.
...
class PrivateEndpointConnectionResponseProperties(_model_base.Model):  # pylint: disable=name-too-long
...
class PrivateLinkServiceConnection(_model_base.Model):
...
class PrivateLinkServiceProxy(_model_base.Model):
...
class ProtectedItemDynamicMemoryConfig(_model_base.Model):
    """Protected item dynamic memory config.
...
class ProtectedItemJobProperties(_model_base.Model):
...
class ProtectedItemModelProperties(_model_base.Model):
...
class ProtectedItemModelPropertiesUpdate(_model_base.Model):
...
class ProtectedItemModelUpdate(_model_base.Model):
...
class RecoveryPointModelProperties(_model_base.Model):
...
class RemotePrivateEndpoint(_model_base.Model):
    """Represent remote private endpoint information for the private endpoint connection proxy.
...
class RemotePrivateEndpointConnection(_model_base.Model):
    """Represent remote private endpoint connection.
...
class ReplicationExtensionModelProperties(_model_base.Model):
...
class StorageContainerProperties(_model_base.Model):
...
class TaskModel(_model_base.Model):
    """Task model.
...
class TaskModelCustomProperties(_model_base.Model):
    """Task model custom properties.
...
class VaultIdentityModel(_model_base.Model):
    """Vault model.
...
class VaultModelProperties(_model_base.Model):
    """Vault properties.
...
class VaultModelUpdate(_model_base.Model):
    """Vault model update.
...
class VMwareToAzStackHCIDiskInput(_model_base.Model):
...
class VMwareToAzStackHCINicInput(_model_base.Model):
...
class VMwareToAzStackHCIProtectedDiskProperties(_model_base.Model):  # pylint: disable=name-too-long
...
class VMwareToAzStackHCIProtectedNicProperties(_model_base.Model):
    """VMwareToAzStackHCI NIC properties.
