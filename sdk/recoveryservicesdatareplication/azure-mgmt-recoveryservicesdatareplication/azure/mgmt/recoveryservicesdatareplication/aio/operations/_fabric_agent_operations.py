...
from ...operations._fabric_agent_operations import (
...
class FabricAgentOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either FabricAgentModel or the result of cls(response)
        :rtype:
        ...
        cls: ClsType[_models.FabricAgentModelListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("FabricAgentModelListResult", pipeline_response)
    ...
    async def get(
        ...
        :return: FabricAgentModel or the result of cls(response)
        ...
        deserialized = self._deserialize("FabricAgentModel", pipeline_response.http_response)
    ...
    async def _create_initial(
        ...
        body: Union[_models.FabricAgentModel, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "FabricAgentModel")
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param fabric_agent_name: The fabric agent name. Required.
        :type fabric_agent_name: str
        :param body: Fabric agent model. Required.
        :type body: ~azure.mgmt.recoveryservicesdatareplication.models.FabricAgentModel
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either FabricAgentModel or the result of
         cls(response)
        :rtype:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param fabric_agent_name: The fabric agent name. Required.
        :type fabric_agent_name: str
        :param body: Fabric agent model. Is either a FabricAgentModel type or a IO[bytes] type.
         Required.
        :type body: ~azure.mgmt.recoveryservicesdatareplication.models.FabricAgentModel or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either FabricAgentModel or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.recoveryservicesdatareplication.models.FabricAgentModel]
