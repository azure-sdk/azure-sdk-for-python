...
from ...operations._recovery_point_operations import build_get_request, build_list_request
...
class RecoveryPointOperations:
    ...
    def list(
        ...
        cls: ClsType[_models.RecoveryPointModelListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("RecoveryPointModelListResult", pipeline_response)
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("RecoveryPointModel", pipeline_response.http_response)
