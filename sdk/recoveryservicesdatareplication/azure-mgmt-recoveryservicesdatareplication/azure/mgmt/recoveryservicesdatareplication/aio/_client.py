...
from ._configuration import DataReplicationClientConfiguration
...
class DataReplicationClient:  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        self._config = DataReplicationClientConfiguration(
