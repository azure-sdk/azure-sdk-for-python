...
def build_post_request(location: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
...
class CheckNameAvailabilityOperations:
    ...
    @distributed_trace
    def post(
        self, location: str, body: Optional[Union[_models.CheckNameAvailabilityModel, IO[bytes]]] = None, **kwargs: Any
    ) -> _models.CheckNameAvailabilityResponseModel:
        """Performs the resource name availability check.
        ...
        :param location: The name of the Azure region. Required.
        :type location: str
        :param body: Resource details. Is either a CheckNameAvailabilityModel type or a IO[bytes] type.
        ...
        deserialized = self._deserialize("CheckNameAvailabilityResponseModel", pipeline_response.http_response)
