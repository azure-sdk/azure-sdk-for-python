    ...
    def create(
        ...
        **kwargs: Any
        ...
        :param private_endpoint_connection_proxy_name: The private endpoint connection proxy name.
         Required.
        :type private_endpoint_connection_proxy_name: str
        :param body: Private endpoint connection creation input. Required.
    ...
    def create(
        ...
        **kwargs: Any
        ...
        :param private_endpoint_connection_proxy_name: The private endpoint connection proxy name.
         Required.
        :type private_endpoint_connection_proxy_name: str
        :param body: Private endpoint connection creation input. Is either a
    ...
    def validate(
        ...
        **kwargs: Any
        ...
        :param private_endpoint_connection_proxy_name: The private endpoint connection proxy name.
         Required.
        :type private_endpoint_connection_proxy_name: str
        :param body: The private endpoint connection proxy input. Is either a
         PrivateEndpointConnectionProxy type or a IO[bytes] type. Required.
        :type body: ~azure.mgmt.recoveryservicesdatareplication.models.PrivateEndpointConnectionProxy
         or IO[bytes]
        :return: PrivateEndpointConnectionProxy or the result of cls(response)
