...
# USAGE
    python replication_extension_delete.py
...
def main():
    ...
    client.replication_extension.begin_delete(
...
# x-ms-original-file: specification/recoveryservicesdatareplication/resource-manager/Microsoft.DataReplication/stable/2024-09-01/examples/ReplicationExtension_Delete.json
