...
# USAGE
    python private_endpoint_connection_proxy_create.py
...
def main():
    ...
    response = client.private_endpoint_connection_proxies.create(
...
# x-ms-original-file: specification/recoveryservicesdatareplication/resource-manager/Microsoft.DataReplication/stable/2024-09-01/examples/PrivateEndpointConnectionProxy_Create.json
