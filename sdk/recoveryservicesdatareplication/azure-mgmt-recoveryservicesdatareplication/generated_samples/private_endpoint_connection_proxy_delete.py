...
# USAGE
    python private_endpoint_connection_proxy_delete.py
...
def main():
    ...
    client.private_endpoint_connection_proxies.begin_delete(
...
# x-ms-original-file: specification/recoveryservicesdatareplication/resource-manager/Microsoft.DataReplication/stable/2024-09-01/examples/PrivateEndpointConnectionProxy_Delete.json
