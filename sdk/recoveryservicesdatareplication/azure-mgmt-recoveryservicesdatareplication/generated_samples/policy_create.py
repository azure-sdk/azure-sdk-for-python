...
def main():
    ...
    response = client.policy.begin_create(
        ...
        vault_name="4",
        policy_name="fafqwc",
        body={"properties": {"customProperties": {"instanceType": "PolicyModelCustomProperties"}}},
    ).result()
    print(response)


# x-ms-original-file: specification/recoveryservicesdatareplication/resource-manager/Microsoft.DataReplication/stable/2024-09-01/examples/Policy_Create.json
