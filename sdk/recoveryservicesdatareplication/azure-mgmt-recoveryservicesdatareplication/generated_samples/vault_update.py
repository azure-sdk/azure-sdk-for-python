...
def main():
    ...
    response = client.vault.begin_update(
        resource_group_name="rgrecoveryservicesdatareplication",
        vault_name="4",
        body={"properties": {"vaultType": "DisasterRecovery"}, "tags": {"key8872": "pvtc"}},
    ).result()
    print(response)


# x-ms-original-file: specification/recoveryservicesdatareplication/resource-manager/Microsoft.DataReplication/stable/2024-09-01/examples/Vault_Update.json
