...
### Features Added
  ...
  - Added model `AzureAiServicesConfiguration`
  - Added enum `AzureAiServicesEnableStatus`
  - Added model `CatalogImageDefinitionMetadataProperties`
  - Added model `CatalogImageDefinitionProperties`
  ...
  - Added model `ImageDefinitionMetadataProperties`
  - Added model `ImageDefinitionProperties`
  - Added model `ImageDefinitionReference`
  - Added model `ImageDefinitionUserContentProperties`
