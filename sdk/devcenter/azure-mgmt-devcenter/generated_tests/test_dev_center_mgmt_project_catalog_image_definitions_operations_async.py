...
class TestDevCenterMgmtProjectCatalogImageDefinitionsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_list_by_project_catalog(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_get_by_project_catalog(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_begin_build_image(self, resource_group):
        response = await (
