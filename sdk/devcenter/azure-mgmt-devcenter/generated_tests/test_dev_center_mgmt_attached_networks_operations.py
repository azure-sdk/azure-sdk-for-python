...
class TestDevCenterMgmtAttachedNetworksOperations(AzureMgmtRecordedTestCase):
    ...
    @recorded_by_proxy
    def test_list_by_project(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_get_by_project(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_list_by_dev_center(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_get_by_dev_center(self, resource_group):
