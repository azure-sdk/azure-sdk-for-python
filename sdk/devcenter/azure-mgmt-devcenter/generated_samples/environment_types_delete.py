...
# USAGE
    python environment_types_delete.py
...
def main():
    ...
    client.environment_types.delete(
...
# x-ms-original-file: specification/devcenter/resource-manager/Microsoft.DevCenter/preview/2024-08-01-preview/examples/EnvironmentTypes_Delete.json
