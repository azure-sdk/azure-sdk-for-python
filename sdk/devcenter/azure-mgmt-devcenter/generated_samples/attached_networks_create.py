...
# USAGE
    python attached_networks_create.py
...
def main():
    ...
    response = client.attached_networks.begin_create_or_update(
...
# x-ms-original-file: specification/devcenter/resource-manager/Microsoft.DevCenter/preview/2024-07-01-preview/examples/AttachedNetworks_Create.json
