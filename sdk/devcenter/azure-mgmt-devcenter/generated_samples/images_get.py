...
def main():
    ...
    response = client.images.get(
        ...
        image_name="ContosoBaseImage",
    )
    print(response)


# x-ms-original-file: specification/devcenter/resource-manager/Microsoft.DevCenter/preview/2024-06-01-preview/examples/Images_Get.json
