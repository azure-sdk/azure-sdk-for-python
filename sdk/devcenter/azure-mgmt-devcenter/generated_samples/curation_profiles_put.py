...
# USAGE
    python curation_profiles_put.py
...
def main():
    ...
    response = client.curation_profiles.begin_create_or_update(
...
# x-ms-original-file: specification/devcenter/resource-manager/Microsoft.DevCenter/preview/2024-10-01-preview/examples/CurationProfiles_Put.json
