...
# USAGE
    python dev_centers_create_with_restricted_resource_usage.py
    ...
    response = client.dev_centers.begin_create_or_update(
        ...
        body={
            ...
            "properties": {
                ...
                "restrictedResourceTypes": ["DevboxDefinitions", "AttachedNetworks"],
            },
            "tags": {"CostCode": "12345"},
        },
    ).result()
...
# x-ms-original-file: specification/devcenter/resource-manager/Microsoft.DevCenter/preview/2024-10-01-preview/examples/DevCenters_CreateWithRestrictedResourceUsage.json
