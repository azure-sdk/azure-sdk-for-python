...
# USAGE
    python curation_profiles_delete.py
...
def main():
    ...
    client.curation_profiles.begin_delete(
...
# x-ms-original-file: specification/devcenter/resource-manager/Microsoft.DevCenter/preview/2024-10-01-preview/examples/CurationProfiles_Delete.json
