...
def main():
    ...
    response = client.plan_members.get(
...
# x-ms-original-file: specification/devcenter/resource-manager/Microsoft.DevCenter/preview/2024-08-01-preview/examples/PlanMembers_Get.json
