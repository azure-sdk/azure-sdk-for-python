...
# USAGE
    python project_catalogs_patch.py
...
def main():
    ...
    response = client.project_catalogs.begin_patch(
...
# x-ms-original-file: specification/devcenter/resource-manager/Microsoft.DevCenter/preview/2024-07-01-preview/examples/ProjectCatalogs_Patch.json
