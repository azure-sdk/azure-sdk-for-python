...
# USAGE
    python attached_networks_delete.py
...
def main():
    ...
    client.attached_networks.begin_delete(
...
# x-ms-original-file: specification/devcenter/resource-manager/Microsoft.DevCenter/preview/2024-07-01-preview/examples/AttachedNetworks_Delete.json
