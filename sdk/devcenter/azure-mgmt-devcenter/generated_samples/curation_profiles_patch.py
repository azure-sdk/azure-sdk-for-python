...
# USAGE
    python curation_profiles_patch.py
...
def main():
    ...
    response = client.curation_profiles.begin_update(
...
# x-ms-original-file: specification/devcenter/resource-manager/Microsoft.DevCenter/preview/2024-10-01-preview/examples/CurationProfiles_Patch.json
