...
class DevCenterCatalogImageDefinitionsOperations:  # pylint: disable=name-too-long
    ...
    def get_by_dev_center_catalog(
        ...
        image_definition_name: str,
        **kwargs: Any
    ) -> _models.DevCenterCatalogImageDefinition:
        ...
        :return: DevCenterCatalogImageDefinition or the result of cls(response)
        :rtype: ~azure.mgmt.devcenter.models.DevCenterCatalogImageDefinition
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.DevCenterCatalogImageDefinition] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("DevCenterCatalogImageDefinition", pipeline_response.http_response)
