...
class DevCenter(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar restricted_resource_types: Indicates the resource types that are restricted from being
     accessed by a project unless allowed by a curation profile.
...
class ResourcePolicy(_serialization.Model):
    ...
    :ivar resources: Resources that are included and shared as a part of a curation profile.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword resources: Resources that are included and shared as a part of a curation profile.
