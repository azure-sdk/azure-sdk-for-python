...
class AzureAiServicesConfiguration(_serialization.Model):
...
class ImageDefinitionMetadataProperties(_serialization.Model):
    ...
    _attribute_map = {
        ...
        "latest_build": {"key": "latestBuild", "type": "LatestImageBuild"},
        ...
        "auto_image_build": {"key": "autoImageBuild", "type": "str"},
    }
...
class CatalogImageDefinitionMetadataProperties(ImageDefinitionMetadataProperties):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype latest_build: ~azure.mgmt.devcenter.models.LatestImageBuild
        """
        super().__init__(image_reference=image_reference, latest_build=latest_build, **kwargs)
        self.file_url = None


class ImageDefinitionUserContentProperties(_serialization.Model):
    """Properties of an Image Definition.
    ...
    _attribute_map = {
        "tasks": {"key": "tasks", "type": "[CustomizationTaskInstance]"},
        "user_tasks": {"key": "userTasks", "type": "[CustomizationTaskInstance]"},
        "extends": {"key": "extends", "type": "ImageDefinitionReference"},
    }
...
class CatalogImageDefinitionProperties(CatalogImageDefinitionMetadataProperties, ImageDefinitionUserContentProperties):
    """Properties of an Image Definition that is sourced from a Catalog.
...
class ConfigurationPolicies(_serialization.Model):
    """Represents policies to enforce configuration settings on a project.

    :ivar user_customizations_enable_status: The property indicates whether user customizations are
     enabled. Known values are: "Enabled" and "Disabled".
    :vartype user_customizations_enable_status: str or
     ~azure.mgmt.devcenter.models.UserCustomizationsEnableStatus
    :ivar dev_box_auto_delete_configuration: A property containing the configuration for auto
     delete of Dev Boxes for a project.
    :vartype dev_box_auto_delete_configuration:
     ~azure.mgmt.devcenter.models.DevBoxAutoDeleteConfiguration
    :ivar azure_ai_services_configuration: The property indicates the Azure AI services settings on
     a project.
    :vartype azure_ai_services_configuration:
     ~azure.mgmt.devcenter.models.AzureAiServicesConfiguration
    :ivar dev_box_tunnel_enable_status: The property indicates whether DevBox tunnel is enabled.
    ...
    _attribute_map = {
        ...
        "dev_box_auto_delete_configuration": {
            "key": "devBoxAutoDeleteConfiguration",
            "type": "DevBoxAutoDeleteConfiguration",
        },
        "azure_ai_services_configuration": {
            "key": "azureAiServicesConfiguration",
            "type": "AzureAiServicesConfiguration",
        },
    ...
    def __init__(
        ...
        *,
        ...
        dev_box_auto_delete_configuration: Optional["_models.DevBoxAutoDeleteConfiguration"] = None,
        azure_ai_services_configuration: Optional["_models.AzureAiServicesConfiguration"] = None,
        dev_box_tunnel_enable_status: Optional[Union[str, "_models.DevBoxTunnelEnableStatus"]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword user_customizations_enable_status: The property indicates whether user customizations
         are enabled. Known values are: "Enabled" and "Disabled".
        :paramtype user_customizations_enable_status: str or
         ~azure.mgmt.devcenter.models.UserCustomizationsEnableStatus
        :keyword dev_box_auto_delete_configuration: A property containing the configuration for auto
         delete of Dev Boxes for a project.
        :paramtype dev_box_auto_delete_configuration:
         ~azure.mgmt.devcenter.models.DevBoxAutoDeleteConfiguration
        :keyword azure_ai_services_configuration: The property indicates the Azure AI services settings
         on a project.
        :paramtype azure_ai_services_configuration:
         ~azure.mgmt.devcenter.models.AzureAiServicesConfiguration
        :keyword dev_box_tunnel_enable_status: The property indicates whether DevBox tunnel is enabled.
         Known values are: "Enabled" and "Disabled".
        ...
        self.dev_box_auto_delete_configuration = dev_box_auto_delete_configuration
        self.azure_ai_services_configuration = azure_ai_services_configuration
...
class DevBoxAutoDeleteConfiguration(_serialization.Model):
    """Represents policy to auto delete inactive dev boxes.

    :ivar enable_status: The property indicates whether the projects have auto delete enabled.
     Known values are: "Enabled" and "Disabled".
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword enable_status: The property indicates whether the projects have auto delete enabled.
         Known values are: "Enabled" and "Disabled".
...
class DevCenterCatalogImageDefinition(ProxyResource):
...
class ImageDefinitionProperties(ImageDefinitionMetadataProperties, ImageDefinitionUserContentProperties):
    """Properties of an Image Definition.
...
class ImageDefinitionReference(_serialization.Model):
    ...
    def __init__(self, *, image_definition: str, parameters: Optional[Dict[str, str]] = None, **kwargs: Any) -> None:
        """
...
class ProjectCustomizationSettings(_serialization.Model):
    ...
    def __init__(
        self, *, identities: Optional[List["_models.ProjectCustomizationManagedIdentity"]] = None, **kwargs: Any
    ) -> None:
        """
...
class ProjectPolicy(Resource):
    ...
    _attribute_map = {
        ...
        "configuration_policies": {"key": "properties.configurationPolicies", "type": "ConfigurationPolicies"},
        "provisioning_state": {"key": "properties.provisioningState", "type": "str"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword configuration_policies: Configuration Policies part of this project policy.
        :paramtype configuration_policies: ~azure.mgmt.devcenter.models.ConfigurationPolicies
        """
        super().__init__(**kwargs)
        self.resource_policies = resource_policies
        self.scopes = scopes
        self.configuration_policies = configuration_policies
        self.provisioning_state = None
...
class ProjectPolicyUpdateProperties(_serialization.Model):
    ...
    _attribute_map = {
        ...
        "configuration_policies": {"key": "configurationPolicies", "type": "ConfigurationPolicies"},
    }
...
class ProjectPolicyProperties(ProjectPolicyUpdateProperties):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        super().__init__(
            resource_policies=resource_policies, scopes=scopes, configuration_policies=configuration_policies, **kwargs
        )
        self.provisioning_state = None
