...
class DevCenterMgmtClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype plans: azure.mgmt.devcenter.aio.operations.PlansOperations
    :ivar plan_members: PlanMembersOperations operations
    :vartype plan_members: azure.mgmt.devcenter.aio.operations.PlanMembersOperations
    ...
    :ivar curation_profiles: CurationProfilesOperations operations
    :vartype curation_profiles: azure.mgmt.devcenter.aio.operations.CurationProfilesOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.curation_profiles = CurationProfilesOperations(
