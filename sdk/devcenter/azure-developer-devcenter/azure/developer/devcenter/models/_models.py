...
class DevBox(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar uri: The unique URI of the dev box. Required.
    :vartype uri: str
    ...
    """The unique URI of the dev box. Required."""
    name: str = rest_field(visibility=["read"])
...
class DevBoxAction(_model_base.Model):
    ...
    :ivar uri: The unique URI for the Dev Box action. Required.
    :vartype uri: str
    ...
    uri: str = rest_field()
    """The unique URI for the Dev Box action. Required."""
    name: str = rest_field(visibility=["read"])
...
class DevBoxActionDelayResult(_model_base.Model):
    ...
    :ivar uri: The unique URI of the action. Required.
    :vartype uri: str
    :ivar name: The name of the action. Required.
    :vartype name: str
    ...
    uri: str = rest_field()
    """The unique URI of the action. Required."""
    name: str = rest_field()
    """The name of the action. Required."""
...
class PagedSchedule(_model_base.Model):
    ...
    :vartype value: list[~azure.developer.devcenter.models.Schedule]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """

    value: List["_models.Schedule"] = rest_field()
