...
class DevCenterClientOperationsMixin(ClientMixinABC[PipelineClient, DevCenterClientConfiguration]):
...
class DevBoxesClientOperationsMixin(  # pylint: disable=too-many-public-methods
    ClientMixinABC[PipelineClient, DevBoxesClientConfiguration]
):
...
class DeploymentEnvironmentsClientOperationsMixin(  # pylint: disable=name-too-long
    ClientMixinABC[PipelineClient, DeploymentEnvironmentsClientConfiguration]
):
