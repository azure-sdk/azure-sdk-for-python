...
class DevBox(_model_base.Model):
    ...
    :vartype hibernate_support: str or ~devcenterservice.models.HibernateSupport
    ...
    :vartype provisioning_state: str or ~devcenterservice.models.DevBoxProvisioningState
    ...
    :vartype power_state: str or ~devcenterservice.models.PowerState
    ...
    :vartype os_type: str or ~devcenterservice.models.OsType
    ...
    :vartype hardware_profile: ~devcenterservice.models.HardwareProfile
    :ivar storage_profile: Storage settings for this Dev Box.
    :vartype storage_profile: ~devcenterservice.models.StorageProfile
    :ivar image_reference: Information about the image used for this Dev Box.
    :vartype image_reference: ~devcenterservice.models.ImageReference
    ...
    :vartype local_administrator: str or ~devcenterservice.models.LocalAdministratorStatus
    """
...
class DevBoxAction(_model_base.Model):
    ...
    :vartype action_type: str or ~devcenterservice.models.DevBoxActionType
    ...
    :vartype next: ~devcenterservice.models.DevBoxNextAction
    """
...
class DevBoxActionDelayResult(_model_base.Model):
    ...
    :vartype delay_status: str or ~devcenterservice.models.DevBoxActionDelayStatus
    :ivar action: The delayed action.
    :vartype action: ~devcenterservice.models.DevBoxAction
...
class Environment(_model_base.Model):
    ...
    :vartype provisioning_state: str or ~devcenterservice.models.EnvironmentProvisioningState
...
class EnvironmentDefinition(_model_base.Model):
    ...
    :vartype parameters: list[~devcenterservice.models.EnvironmentDefinitionParameter]
...
class EnvironmentDefinitionParameter(_model_base.Model):
    ...
    :ivar type: A string of one of the basic JSON types (number, integer, array, object,
     ...
     "object", and "string".
    :vartype type: str or ~devcenterservice.models.ParameterType
...
class EnvironmentType(_model_base.Model):
    ...
    :vartype status: str or ~devcenterservice.models.EnvironmentTypeStatus
    """
...
class HardwareProfile(_model_base.Model):
    ...
    :vartype sku_name: str or ~devcenterservice.models.SkuName
...
class Pool(_model_base.Model):
    ...
    :ivar stop_on_disconnect: Stop on disconnect configuration settings for Dev Boxes created in
     this pool.
    :vartype stop_on_disconnect: ~devcenterservice.models.StopOnDisconnectConfiguration
    ...
    :vartype health_status: str or ~devcenterservice.models.PoolHealthStatus
    """
...
class Schedule(_model_base.Model):
    ...
    :vartype type: str or ~devcenterservice.models.ScheduledType
    :ivar frequency: The frequency of this scheduled task. Required. "Daily"
    :vartype frequency: str or ~devcenterservice.models.ScheduledFrequency
...
class StopOnDisconnectConfiguration(_model_base.Model):
    ...
    :vartype status: str or ~devcenterservice.models.StopOnDisconnectStatus
...
class StorageProfile(_model_base.Model):
    ...
    :vartype os_disk: ~devcenterservice.models.OsDisk
    """
