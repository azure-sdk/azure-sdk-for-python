...
class DevCenterClientOperationsMixin(DevCenterClientMixinABC):
    ...
    def list_projects(self, **kwargs: Any) -> Iterable["_models.Project"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~devcenterservice.models.Project]
    ...
    def get_project(self, project_name: str, **kwargs: Any) -> _models.Project:
        ...
        :rtype: ~devcenterservice.models.Project
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
...
class DevBoxesClientOperationsMixin(DevBoxesClientMixinABC):  # pylint: disable=too-many-public-methods
    ...
    def list_pools(self, project_name: str, **kwargs: Any) -> Iterable["_models.Pool"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~devcenterservice.models.Pool]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def get_pool(self, project_name: str, pool_name: str, **kwargs: Any) -> _models.Pool:
        ...
        :rtype: ~devcenterservice.models.Pool
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_schedules(self, project_name: str, pool_name: str, **kwargs: Any) -> Iterable["_models.Schedule"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~devcenterservice.models.Schedule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def get_schedule(self, project_name: str, pool_name: str, schedule_name: str, **kwargs: Any) -> _models.Schedule:
        ...
        :rtype: ~devcenterservice.models.Schedule
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_all_dev_boxes(self, **kwargs: Any) -> Iterable["_models.DevBox"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~devcenterservice.models.DevBox]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def get_dev_box(self, project_name: str, user_id: str, dev_box_name: str, **kwargs: Any) -> _models.DevBox:
        ...
        :rtype: ~devcenterservice.models.DevBox
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_dev_box(
        ...
        **kwargs: Any
        ...
        :type body: ~devcenterservice.models.DevBox or JSON or IO[bytes]
        :return: An instance of LROPoller that returns DevBox. The DevBox is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~devcenterservice.models.DevBox]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def get_remote_connection(
        ...
        :rtype: ~devcenterservice.models.RemoteConnection
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_dev_box_actions(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~devcenterservice.models.DevBoxAction]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def get_dev_box_action(
        ...
        :rtype: ~devcenterservice.models.DevBoxAction
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def delay_all_actions(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~devcenterservice.models.DevBoxActionDelayResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class DeploymentEnvironmentsClientOperationsMixin(  # pylint: disable=name-too-long
    ...
    def list_all_environments(self, project_name: str, **kwargs: Any) -> Iterable["_models.Environment"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~devcenterservice.models.Environment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def get_environment(
        ...
        :rtype: ~devcenterservice.models.Environment
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update_environment(
        ...
        **kwargs: Any
        ...
        :type body: ~devcenterservice.models.Environment
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns Environment. The Environment is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~devcenterservice.models.Environment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update_environment(
        ...
        **kwargs: Any
        ...
        :param body: Represents an environment. Is one of the following types: Environment, JSON,
         IO[bytes] Required.
        :type body: ~devcenterservice.models.Environment or JSON or IO[bytes]
        :return: An instance of LROPoller that returns Environment. The Environment is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~devcenterservice.models.Environment]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_catalogs(self, project_name: str, **kwargs: Any) -> Iterable["_models.Catalog"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~devcenterservice.models.Catalog]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def get_catalog(self, project_name: str, catalog_name: str, **kwargs: Any) -> _models.Catalog:
        ...
        :rtype: ~devcenterservice.models.Catalog
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_environment_definitions(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~devcenterservice.models.EnvironmentDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def get_environment_definition(
        ...
        :rtype: ~devcenterservice.models.EnvironmentDefinition
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_environment_types(self, project_name: str, **kwargs: Any) -> Iterable["_models.EnvironmentType"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~devcenterservice.models.EnvironmentType]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
