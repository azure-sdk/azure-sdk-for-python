...
class BgpPeerProperties(_Model):
    ...
    my_asn: int = rest_field(name="myAsn", visibility=["read", "create", "update", "delete", "query"])
    """My ASN. Required."""
    peer_asn: int = rest_field(name="peerAsn", visibility=["read", "create", "update", "delete", "query"])
    """Peer ASN. Required."""
    peer_address: str = rest_field(name="peerAddress", visibility=["read", "create", "update", "delete", "query"])
...
class StorageClassTypeProperties(_Model):
...
class BlobStorageClassTypeProperties(StorageClassTypeProperties, discriminator="Blob"):
    ...
    azure_storage_account_name: str = rest_field(
        name="azureStorageAccountName", visibility=["read", "create", "update", "delete", "query"]
    )
    """Azure Storage Account Name. Required."""
    azure_storage_account_key: str = rest_field(
        name="azureStorageAccountKey", visibility=["read", "create", "update", "delete", "query"]
    )
...
class LoadBalancerProperties(_Model):
    ...
    addresses: List[str] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """IP Range. Required."""
    service_selector: Optional[Dict[str, str]] = rest_field(
        name="serviceSelector", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    advertise_mode: Union[str, "_models.AdvertiseMode"] = rest_field(
        name="advertiseMode", visibility=["read", "create", "update", "delete", "query"]
    )
    """Advertise Mode. Required. Known values are: \"ARP\", \"BGP\", and \"Both\"."""
    bgp_peers: Optional[List[str]] = rest_field(
        name="bgpPeers", visibility=["read", "create", "update", "delete", "query"]
    )
...
class NativeStorageClassTypeProperties(StorageClassTypeProperties, discriminator="Native"):
    ...
    type: Literal[SCType.NATIVE] = rest_discriminator(name="type", visibility=["read", "create", "update", "delete", "query"])  # type: ignore
...
class NfsStorageClassTypeProperties(StorageClassTypeProperties, discriminator="NFS"):
    ...
    """NFS Server. Required."""
    share: str = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """NFS share. Required."""
    sub_dir: Optional[str] = rest_field(name="subDir", visibility=["read", "create", "update", "delete", "query"])
    """Sub directory under share. If the sub directory doesn't exist, driver will create it."""
    mount_permissions: Optional[str] = rest_field(
        name="mountPermissions", visibility=["read", "create", "update", "delete", "query"]
    )
    """Mounted folder permissions. Default is 0. If set as non-zero, driver will perform ``chmod``
     after mount."""
    on_delete: Optional[Union[str, "_models.NfsDirectoryActionOnVolumeDeletion"]] = rest_field(
        name="onDelete", visibility=["read", "create", "update", "delete", "query"]
    )
...
class RwxStorageClassTypeProperties(StorageClassTypeProperties, discriminator="RWX"):
    ...
    backing_storage_class_name: str = rest_field(
        name="backingStorageClassName", visibility=["read", "create", "update", "delete", "query"]
    )
...
class SmbStorageClassTypeProperties(StorageClassTypeProperties, discriminator="SMB"):
    ...
    type: Literal[SCType.SMB] = rest_discriminator(name="type", visibility=["read", "create", "update", "delete", "query"])  # type: ignore
...
class StorageClassProperties(_Model):
    ...
    allow_volume_expansion: Optional[Union[str, "_models.VolumeExpansion"]] = rest_field(
        name="allowVolumeExpansion", visibility=["read", "create", "update", "delete", "query"]
    )
    """Volume can be expanded or not. Known values are: \"Allow\" and \"Disallow\"."""
    mount_options: Optional[List[str]] = rest_field(
    ...
    access_modes: Optional[List[Union[str, "_models.AccessMode"]]] = rest_field(
        name="accessModes", visibility=["read", "create", "update", "delete", "query"]
    )
    """The access mode: [ReadWriteOnce, ReadWriteMany] or [ReadWriteOnce]."""
    data_resilience: Optional[Union[str, "_models.DataResilienceTier"]] = rest_field(
        name="dataResilience", visibility=["read", "create", "update", "delete", "query"]
    )
    """Allow single data node failure. Known values are: \"NotDataResilient\" and \"DataResilient\"."""
    failover_speed: Optional[Union[str, "_models.FailoverTier"]] = rest_field(
        name="failoverSpeed", visibility=["read", "create", "update", "delete", "query"]
    )
    """Failover speed: NA, Slow, Fast. Known values are: \"NotAvailable\", \"Slow\", \"Fast\", and
     \"Super\"."""
    limitations: Optional[List[str]] = rest_field(visibility=["read", "create", "update", "delete", "query"])
...
class StorageClassPropertiesUpdate(_Model):
    ...
    priority: Optional[int] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Selection priority when multiple storage classes meet the criteria. 0: Highest, -1: Never use."""
    type_properties: Optional["_models.StorageClassTypePropertiesUpdate"] = rest_field(
...
class StorageClassResourceUpdate(_Model):
...
class StorageClassTypePropertiesUpdate(_Model):
    ...
    backing_storage_class_name: Optional[str] = rest_field(
        name="backingStorageClassName", visibility=["read", "create", "update", "delete", "query"]
    )
    """The backing storageclass used to create new storageclass."""
    azure_storage_account_name: Optional[str] = rest_field(
        name="azureStorageAccountName", visibility=["read", "create", "update", "delete", "query"]
    )
    """Azure Storage Account Name."""
    azure_storage_account_key: Optional[str] = rest_field(
        name="azureStorageAccountKey", visibility=["read", "create", "update", "delete", "query"]
    )
    """Azure Storage Account Key."""
    server: Optional[str] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """NFS Server."""
    share: Optional[str] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """NFS share."""
    sub_dir: Optional[str] = rest_field(name="subDir", visibility=["read", "create", "update", "delete", "query"])
    """Sub directory under share. If the sub directory doesn't exist, driver will create it."""
    mount_permissions: Optional[str] = rest_field(
