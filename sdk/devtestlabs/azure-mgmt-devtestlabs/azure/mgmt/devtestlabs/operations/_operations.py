...
def build_get_request(location_name: str, name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
...
class Operations:
    ...
    @distributed_trace
    def get(self, location_name: str, name: str, **kwargs: Any) -> _models.OperationResult:
        """Get operation.
