...
class VirtualMachinesOperations:  # pylint: disable=too-many-public-methods
    ...
    def _add_data_disk_initial(  # pylint: disable=inconsistent-return-statements
        ...
        lab_name: str,
        name: str,
        data_disk_properties: Union[_models.DataDiskProperties, IO],
        **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
        ...
        request = build_add_data_disk_request(
            resource_group_name=resource_group_name,
            lab_name=lab_name,
            name=name,
            subscription_id=self._config.subscription_id,
            ...
            json=_json,
            content=_content,
            template_url=self._add_data_disk_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    def _apply_artifacts_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_apply_artifacts_request(
            resource_group_name=resource_group_name,
            lab_name=lab_name,
            name=name,
            subscription_id=self._config.subscription_id,
            ...
            content_type=content_type,
            json=_json,
            template_url=self._apply_artifacts_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    def _claim_initial(  # pylint: disable=inconsistent-return-statements
        ...
        request = build_claim_request(
            ...
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self._claim_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    def _detach_data_disk_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_detach_data_disk_request(
            resource_group_name=resource_group_name,
            lab_name=lab_name,
            name=name,
            subscription_id=self._config.subscription_id,
            ...
            content_type=content_type,
            json=_json,
            template_url=self._detach_data_disk_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    def _transfer_disks_initial(  # pylint: disable=inconsistent-return-statements
        ...
        request = build_transfer_disks_request(
            ...
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self._transfer_disks_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    def _un_claim_initial(  # pylint: disable=inconsistent-return-statements
        ...
        request = build_un_claim_request(
            ...
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self._un_claim_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
