...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.DeviceRegistry/schemaRegistries"
    )
...
class SchemaRegistriesOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.SchemaRegistry"]:
        ...
        cls: ClsType[_models.SchemaRegistryListResult] = kwargs.pop("cls", None)
    ...
    def get(self, resource_group_name: str, schema_registry_name: str, **kwargs: Any) -> _models.SchemaRegistry:
        ...
        deserialized = self._deserialize("SchemaRegistry", pipeline_response.http_response)
    ...
    def _create_or_replace_initial(
        ...
        resource: Union[_models.SchemaRegistry, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_replace(
        ...
        **kwargs: Any
        ...
        :param schema_registry_name: Schema registry name parameter. Required.
        :type schema_registry_name: str
        :param resource: Resource create parameters. Is either a SchemaRegistry type or a IO[bytes]
         type. Required.
        :type resource: ~azure.mgmt.deviceregistry.models.SchemaRegistry or IO[bytes]
        :return: An instance of LROPoller that returns either SchemaRegistry or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.deviceregistry.models.SchemaRegistry]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        schema_registry_name: str,
        properties: Union[_models.SchemaRegistryUpdate, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param schema_registry_name: Schema registry name parameter. Required.
        :type schema_registry_name: str
        :param properties: The resource properties to be updated. Is either a SchemaRegistryUpdate type
         or a IO[bytes] type. Required.
        :type properties: ~azure.mgmt.deviceregistry.models.SchemaRegistryUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either SchemaRegistry or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.deviceregistry.models.SchemaRegistry]
        :raises ~azure.core.exceptions.HttpResponseError:
