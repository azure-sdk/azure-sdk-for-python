...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.DeviceRegistry/discoveredAssets"
    )
...
class DiscoveredAssetsOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.DiscoveredAsset"]:
        ...
        :return: An iterator like instance of either DiscoveredAsset or the result of cls(response)
        ...
        cls: ClsType[_models.DiscoveredAssetListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("DiscoveredAssetListResult", pipeline_response)
    ...
    def get(self, resource_group_name: str, discovered_asset_name: str, **kwargs: Any) -> _models.DiscoveredAsset:
        ...
        :return: DiscoveredAsset or the result of cls(response)
        ...
        deserialized = self._deserialize("DiscoveredAsset", pipeline_response.http_response)
    ...
    def _create_or_replace_initial(
        ...
        resource: Union[_models.DiscoveredAsset, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "DiscoveredAsset")
    ...
    def begin_create_or_replace(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either DiscoveredAsset or the result of
         cls(response)
    ...
    def begin_create_or_replace(
        ...
        **kwargs: Any
        ...
        :param discovered_asset_name: Discovered Asset name parameter. Required.
        :type discovered_asset_name: str
        :param resource: Resource create parameters. Is either a DiscoveredAsset type or a IO[bytes]
         type. Required.
        :type resource: ~azure.mgmt.deviceregistry.models.DiscoveredAsset or IO[bytes]
        :return: An instance of LROPoller that returns either DiscoveredAsset or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.deviceregistry.models.DiscoveredAsset]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        discovered_asset_name: str,
        properties: Union[_models.DiscoveredAssetUpdate, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "DiscoveredAssetUpdate")
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param discovered_asset_name: Discovered Asset name parameter. Required.
        :type discovered_asset_name: str
        :param properties: The resource properties to be updated. Is either a DiscoveredAssetUpdate
         type or a IO[bytes] type. Required.
        :type properties: ~azure.mgmt.deviceregistry.models.DiscoveredAssetUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either DiscoveredAsset or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.deviceregistry.models.DiscoveredAsset]
        :raises ~azure.core.exceptions.HttpResponseError:
