...
from ...operations._schemas_operations import (
    build_create_or_replace_request,
    build_delete_request,
    build_get_request,
    build_list_by_schema_registry_request,
)
...
class SchemasOperations:
    ...
    def list_by_schema_registry(
        ...
        cls: ClsType[_models.SchemaListResult] = kwargs.pop("cls", None)
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_schema_registry_request(
    ...
    async def get(
        ...
        deserialized = self._deserialize("Schema", pipeline_response.http_response)
    ...
    async def create_or_replace(
        ...
        schema_registry_name: str,
        schema_name: str,
        resource: Union[_models.Schema, IO[bytes]],
        **kwargs: Any
    ) -> _models.Schema:
        """Create a Schema.
        ...
        :param resource: Resource create parameters. Is either a Schema type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.deviceregistry.models.Schema or IO[bytes]
        :return: Schema or the result of cls(response)
        :rtype: ~azure.mgmt.deviceregistry.models.Schema
        :raises ~azure.core.exceptions.HttpResponseError:
        """
