...
from ...operations._schema_versions_operations import (
    build_create_or_replace_request,
    build_delete_request,
    build_get_request,
    build_list_by_schema_request,
)
...
class SchemaVersionsOperations:
    ...
    def list_by_schema(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.deviceregistry.models.SchemaVersion]
        ...
        cls: ClsType[_models.SchemaVersionListResult] = kwargs.pop("cls", None)
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("SchemaVersion", pipeline_response.http_response)
    ...
    async def create_or_replace(
        ...
        schema_name: str,
        schema_version_name: str,
        resource: Union[_models.SchemaVersion, IO[bytes]],
        **kwargs: Any
    ) -> _models.SchemaVersion:
        """Create a SchemaVersion.
        ...
        :param resource: Resource create parameters. Is either a SchemaVersion type or a IO[bytes]
         type. Required.
        :type resource: ~azure.mgmt.deviceregistry.models.SchemaVersion or IO[bytes]
        :return: SchemaVersion or the result of cls(response)
        :rtype: ~azure.mgmt.deviceregistry.models.SchemaVersion
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "SchemaVersion")
