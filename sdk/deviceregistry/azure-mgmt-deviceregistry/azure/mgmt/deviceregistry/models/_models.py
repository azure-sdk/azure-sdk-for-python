...
class DiscoveredAssetProperties(_model_base.Model):  # pylint: disable=too-many-instance-attributes
...
class DiscoveredAssetUpdateProperties(_model_base.Model):  # pylint: disable=too-many-instance-attributes
