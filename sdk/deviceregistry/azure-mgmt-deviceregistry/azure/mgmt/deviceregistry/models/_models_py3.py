...
class DiscoveredAsset(TrackedResource):
    ...
    _attribute_map = {
        ...
        "tags": {"key": "tags", "type": "{str}"},
        "location": {"key": "location", "type": "str"},
        "properties": {"key": "properties", "type": "DiscoveredAssetProperties"},
        "extended_location": {"key": "extendedLocation", "type": "ExtendedLocation"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype location: str
        :keyword properties: The resource-specific properties for this resource.
        :paramtype properties: ~azure.mgmt.deviceregistry.models.DiscoveredAssetProperties
        :keyword extended_location: The extended location. Required.
        :paramtype extended_location: ~azure.mgmt.deviceregistry.models.ExtendedLocation
        """
        super().__init__(tags=tags, location=location, **kwargs)
...
class DiscoveredAssetEndpointProfile(TrackedResource):
    ...
    _attribute_map = {
        ...
        "tags": {"key": "tags", "type": "{str}"},
        "location": {"key": "location", "type": "str"},
        "properties": {"key": "properties", "type": "DiscoveredAssetEndpointProfileProperties"},
        "extended_location": {"key": "extendedLocation", "type": "ExtendedLocation"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype properties:
         ~azure.mgmt.deviceregistry.models.DiscoveredAssetEndpointProfileProperties
        :keyword extended_location: The extended location. Required.
        :paramtype extended_location: ~azure.mgmt.deviceregistry.models.ExtendedLocation
        """
        super().__init__(tags=tags, location=location, **kwargs)
...
class DiscoveredAssetEndpointProfileListResult(_serialization.Model):
    """The response of a DiscoveredAssetEndpointProfile list operation.

    All required parameters must be populated in order to send to server.

    :ivar value: The DiscoveredAssetEndpointProfile items on this page. Required.
    :vartype value: list[~azure.mgmt.deviceregistry.models.DiscoveredAssetEndpointProfile]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    _attribute_map = {
        "value": {"key": "value", "type": "[DiscoveredAssetEndpointProfile]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }

    def __init__(
        self, *, value: List["_models.DiscoveredAssetEndpointProfile"], next_link: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: The DiscoveredAssetEndpointProfile items on this page. Required.
        :paramtype value: list[~azure.mgmt.deviceregistry.models.DiscoveredAssetEndpointProfile]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class DiscoveredAssetEndpointProfileProperties(_serialization.Model):
    ...
    _attribute_map = {
        ...
        "endpoint_profile_type": {"key": "endpointProfileType", "type": "str"},
        "discovery_id": {"key": "discoveryId", "type": "str"},
        "version": {"key": "version", "type": "int"},
        "provisioning_state": {"key": "provisioningState", "type": "str"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword endpoint_profile_type: Defines the configuration for the connector type that is being
         used with the endpoint profile. Required.
        :paramtype endpoint_profile_type: str
        :keyword discovery_id: Identifier used to detect changes in the asset endpoint profile.
         Required.
        :paramtype discovery_id: str
        :keyword version: An integer that is incremented each time the resource is modified. Required.
...
class DiscoveredAssetEndpointProfileUpdate(_serialization.Model):
    ...
    _attribute_map = {
        "tags": {"key": "tags", "type": "{str}"},
        "properties": {"key": "properties", "type": "DiscoveredAssetEndpointProfileUpdateProperties"},
    }
...
class DiscoveredAssetEndpointProfileUpdateProperties(_serialization.Model):  # pylint: disable=name-too-long
...
class DiscoveredAssetListResult(_serialization.Model):
    """The response of a DiscoveredAsset list operation.

    All required parameters must be populated in order to send to server.

    :ivar value: The DiscoveredAsset items on this page. Required.
    :vartype value: list[~azure.mgmt.deviceregistry.models.DiscoveredAsset]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    _attribute_map = {
        "value": {"key": "value", "type": "[DiscoveredAsset]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }

    def __init__(
        self, *, value: List["_models.DiscoveredAsset"], next_link: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: The DiscoveredAsset items on this page. Required.
        :paramtype value: list[~azure.mgmt.deviceregistry.models.DiscoveredAsset]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class DiscoveredAssetProperties(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    _attribute_map = {
        ...
        "default_events_configuration": {"key": "defaultEventsConfiguration", "type": "str"},
        "default_topic": {"key": "defaultTopic", "type": "Topic"},
        "datasets": {"key": "datasets", "type": "[DiscoveredDataset]"},
        "events": {"key": "events", "type": "[DiscoveredEvent]"},
        "provisioning_state": {"key": "provisioningState", "type": "str"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword asset_endpoint_profile_ref: A reference to the asset endpoint profile (connection
         ...
         asset. Must provide asset endpoint profile name. Required.
        :paramtype asset_endpoint_profile_ref: str
        :keyword discovery_id: Identifier used to detect changes in the asset. Required.
        :paramtype discovery_id: str
        :keyword version: An integer that is incremented each time the resource is modified. Required.
        :paramtype version: int
        :keyword manufacturer: Asset manufacturer name.
        ...
        :paramtype datasets: list[~azure.mgmt.deviceregistry.models.DiscoveredDataset]
        :keyword events: Array of events that are part of the asset. Each event can have per-event
         configuration.
        :paramtype events: list[~azure.mgmt.deviceregistry.models.DiscoveredEvent]
        """
        super().__init__(**kwargs)
        self.asset_endpoint_profile_ref = asset_endpoint_profile_ref
        self.discovery_id = discovery_id
...
class DiscoveredAssetUpdate(_serialization.Model):
    ...
    _attribute_map = {
        "tags": {"key": "tags", "type": "{str}"},
        "properties": {"key": "properties", "type": "DiscoveredAssetUpdateProperties"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype tags: dict[str, str]
        :keyword properties: The resource-specific properties for this resource.
        :paramtype properties: ~azure.mgmt.deviceregistry.models.DiscoveredAssetUpdateProperties
        """
        super().__init__(**kwargs)
        self.tags = tags
        self.properties = properties
...
class DiscoveredAssetUpdateProperties(_serialization.Model):  # pylint: disable=too-many-instance-attributes
...
class DiscoveredDataPoint(_serialization.Model):
    """Defines the data point properties.
...
class DiscoveredDataset(_serialization.Model):
    """Defines the dataset properties.
    ...
    _attribute_map = {
        ...
        "dataset_configuration": {"key": "datasetConfiguration", "type": "str"},
        "topic": {"key": "topic", "type": "Topic"},
        "data_points": {"key": "dataPoints", "type": "[DiscoveredDataPoint]"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword data_points: Array of data points that are part of the dataset. Each data point can
         have per-data point configuration.
        :paramtype data_points: list[~azure.mgmt.deviceregistry.models.DiscoveredDataPoint]
        """
        super().__init__(**kwargs)
        self.name = name
        self.dataset_configuration = dataset_configuration
...
class DiscoveredEvent(_serialization.Model):
...
class Schema(ProxyResource):
    ...
    def __init__(self, *, properties: Optional["_models.SchemaProperties"] = None, **kwargs: Any) -> None:
        """
        :keyword properties: The resource-specific properties for this resource.
        :paramtype properties: ~azure.mgmt.deviceregistry.models.SchemaProperties
        """
        super().__init__(**kwargs)
        self.properties = properties
...
class SchemaListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.deviceregistry.models.Schema]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: List["_models.Schema"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword value: The Schema items on this page. Required.
        :paramtype value: list[~azure.mgmt.deviceregistry.models.Schema]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class SchemaProperties(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype description: str
        :keyword format: Format of the schema. Required. Known values are: "JsonSchema/draft-07" and
         "Delta/1.0".
        :paramtype format: str or ~azure.mgmt.deviceregistry.models.Format
        :keyword schema_type: Type of the schema. Required. "MessageSchema"
        :paramtype schema_type: str or ~azure.mgmt.deviceregistry.models.SchemaType
...
class SchemaRegistry(TrackedResource):
    ...
    _attribute_map = {
        ...
        "tags": {"key": "tags", "type": "{str}"},
        "location": {"key": "location", "type": "str"},
        "properties": {"key": "properties", "type": "SchemaRegistryProperties"},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype location: str
        :keyword properties: The resource-specific properties for this resource.
        :paramtype properties: ~azure.mgmt.deviceregistry.models.SchemaRegistryProperties
        :keyword identity: The managed service identities assigned to this resource.
        :paramtype identity: ~azure.mgmt.deviceregistry.models.SystemAssignedServiceIdentity
        """
        super().__init__(tags=tags, location=location, **kwargs)
        self.properties = properties
...
class SchemaRegistryListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.deviceregistry.models.SchemaRegistry]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(
        self, *, value: List["_models.SchemaRegistry"], next_link: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: The SchemaRegistry items on this page. Required.
        :paramtype value: list[~azure.mgmt.deviceregistry.models.SchemaRegistry]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class SchemaRegistryProperties(_serialization.Model):
    ...
    _validation = {
        "uuid": {"readonly": True},
        "namespace": {"required": True, "max_length": 32, "pattern": r"^[a-z0-9][a-z0-9-]*[a-z0-9]$"},
...
class SchemaRegistryUpdate(_serialization.Model):
    ...
    _attribute_map = {
        "identity": {"key": "identity", "type": "SystemAssignedServiceIdentity"},
        "tags": {"key": "tags", "type": "{str}"},
        "properties": {"key": "properties", "type": "SchemaRegistryUpdateProperties"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype tags: dict[str, str]
        :keyword properties: The resource-specific properties for this resource.
        :paramtype properties: ~azure.mgmt.deviceregistry.models.SchemaRegistryUpdateProperties
        """
        super().__init__(**kwargs)
        self.identity = identity
        self.tags = tags
...
class SchemaRegistryUpdateProperties(_serialization.Model):
...
class SchemaVersion(ProxyResource):
    ...
    _attribute_map = {
        ...
        "type": {"key": "type", "type": "str"},
        "system_data": {"key": "systemData", "type": "SystemData"},
        "properties": {"key": "properties", "type": "SchemaVersionProperties"},
    }

    def __init__(self, *, properties: Optional["_models.SchemaVersionProperties"] = None, **kwargs: Any) -> None:
        """
        :keyword properties: The resource-specific properties for this resource.
        :paramtype properties: ~azure.mgmt.deviceregistry.models.SchemaVersionProperties
        """
        super().__init__(**kwargs)
        self.properties = properties
...
class SchemaVersionListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.deviceregistry.models.SchemaVersion]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: List["_models.SchemaVersion"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword value: The SchemaVersion items on this page. Required.
        :paramtype value: list[~azure.mgmt.deviceregistry.models.SchemaVersion]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class SchemaVersionProperties(_serialization.Model):
    ...
    _attribute_map = {
        "uuid": {"key": "uuid", "type": "str"},
        "description": {"key": "description", "type": "str"},
        "schema_content": {"key": "schemaContent", "type": "str"},
        "hash": {"key": "hash", "type": "str"},
        "provisioning_state": {"key": "provisioningState", "type": "str"},
    }

    def __init__(self, *, schema_content: str, description: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword description: Human-readable description of the schema.
        :paramtype description: str
        :keyword schema_content: Schema content. Required.
...
class SystemAssignedServiceIdentity(_serialization.Model):
    ...
    def __init__(self, *, type: Union[str, "_models.SystemAssignedServiceIdentityType"], **kwargs: Any) -> None:
        ...
        :paramtype type: str or ~azure.mgmt.deviceregistry.models.SystemAssignedServiceIdentityType
        """
        super().__init__(**kwargs)
