...
from ._configuration import DeviceRegistryMgmtTestClientConfiguration
...
class DeviceRegistryMgmtTestClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = DeviceRegistryMgmtTestClientConfiguration(
    ...
    def __enter__(self) -> "DeviceRegistryMgmtTestClient":
