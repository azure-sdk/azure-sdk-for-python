...
# USAGE
    python update_discovered_asset.py
...
def main():
    ...
    response = client.discovered_assets.begin_update(
...
# x-ms-original-file: specification/deviceregistry/resource-manager/Microsoft.DeviceRegistry/preview/2024-09-01-preview/examples/Update_DiscoveredAsset.json
