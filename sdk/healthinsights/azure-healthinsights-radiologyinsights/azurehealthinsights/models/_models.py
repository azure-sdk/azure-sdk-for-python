...
class RadiologyInsightsInference(_model_base.Model):
    ...
    * FollowupCommunication.
    ...
    :ivar kind: Discriminator property for RadiologyInsightsInference. Required. Known values are:
     ...
     "qualityMeasure".
    :vartype kind: str or ~azurehealthinsights.models.RadiologyInsightsInferenceType
    :ivar extension: Additional Content defined by implementations.
    :vartype extension: list[~azurehealthinsights.models.Extension]
    """
...
class AgeMismatchInference(RadiologyInsightsInference, discriminator="ageMismatch"):
    ...
    :vartype kind: str or ~azurehealthinsights.models.AGE_MISMATCH
    """
...
class CodeableConcept(Element):
    ...
    :vartype coding: list[~azurehealthinsights.models.Coding]
...
class CompleteOrderDiscrepancyInference(RadiologyInsightsInference, discriminator="completeOrderDiscrepancy"):
    ...
    :vartype kind: str or ~azurehealthinsights.models.COMPLETE_ORDER_DISCREPANCY
    :ivar order_type: Order type : CPT ultrasound complete code for abdomen, retroperitoneal,
     pelvis or breast. Required.
    :vartype order_type: ~azurehealthinsights.models.CodeableConcept
    :ivar missing_body_parts: List of missing body parts required by a complete order : SNOMED CT
     codes.
    :vartype missing_body_parts: list[~azurehealthinsights.models.CodeableConcept]
    ...
    :vartype missing_body_part_measurements: list[~azurehealthinsights.models.CodeableConcept]
    """
...
class CriticalResult(_model_base.Model):
    ...
    :vartype finding: ~azurehealthinsights.models.Observation
    """
...
class CriticalResultInference(RadiologyInsightsInference, discriminator="criticalResult"):
    ...
    :vartype kind: str or ~azurehealthinsights.models.CRITICAL_RESULT
    :ivar result: The complete Critical Result, as outlined below, will be reused for the
     recommendation. Required.
    :vartype result: ~azurehealthinsights.models.CriticalResult
    """
...
class DocumentAdministrativeMetadata(_model_base.Model):
    ...
    :vartype ordered_procedures: list[~azurehealthinsights.models.OrderedProcedure]
...
class DocumentContent(_model_base.Model):
    ...
    :vartype source_type: str or ~azurehealthinsights.models.DocumentContentSourceType
...
class Resource(_model_base.Model):
    ...
    :vartype meta: ~azurehealthinsights.models.Meta
...
class DomainResource(Resource):
    ...
    :vartype text: ~azurehealthinsights.models.Narrative
    :ivar contained: Contained, inline Resources.
    :vartype contained: list[~azurehealthinsights.models.Resource]
    :ivar extension: Additional Content defined by implementations.
    :vartype extension: list[~azurehealthinsights.models.Extension]
    :ivar modifier_extension: Extensions that cannot be ignored.
    :vartype modifier_extension: list[~azurehealthinsights.models.Extension]
    """
...
class Extension(Element):
    ...
    :vartype value_quantity: ~azurehealthinsights.models.Quantity
    :ivar value_codeable_concept: Value as CodeableConcept.
    :vartype value_codeable_concept: ~azurehealthinsights.models.CodeableConcept
    ...
    :vartype value_range: ~azurehealthinsights.models.Range
    :ivar value_ratio: Value as Ratio.
    :vartype value_ratio: ~azurehealthinsights.models.Ratio
    :ivar value_sampled_data: Value as SampledData.
    :vartype value_sampled_data: ~azurehealthinsights.models.SampledData
    ...
    :vartype value_period: ~azurehealthinsights.models.Period
    :ivar value_reference: Value as reference.
    :vartype value_reference: ~azurehealthinsights.models.Reference
    """
...
class FindingInference(RadiologyInsightsInference, discriminator="finding"):
    ...
    :vartype kind: str or ~azurehealthinsights.models.FINDING
...
class FollowupCommunicationInference(RadiologyInsightsInference, discriminator="followupCommunication"):
    ...
    :vartype kind: str or ~azurehealthinsights.models.FOLLOWUP_COMMUNICATION
    ...
    :vartype recipient: list[str or ~azurehealthinsights.models.MedicalProfessionalType]
...
class FollowupRecommendationInference(RadiologyInsightsInference, discriminator="followupRecommendation"):
    ...
    :vartype kind: str or ~azurehealthinsights.models.FOLLOWUP_RECOMMENDATION
    ...
    :vartype effective_period: ~azurehealthinsights.models.Period
    :ivar findings: Findings related to the recommendation.
    :vartype findings: list[~azurehealthinsights.models.RecommendationFinding]
    ...
    :vartype recommended_procedure: ~azurehealthinsights.models.ProcedureRecommendation
    """
...
class GenericProcedureRecommendation(ProcedureRecommendation, discriminator="genericProcedureRecommendation"):
    ...
    :vartype code: ~azurehealthinsights.models.CodeableConcept
...
class GuidanceInference(RadiologyInsightsInference, discriminator="guidance"):
    ...
    :vartype kind: str or ~azurehealthinsights.models.GUIDANCE
    :ivar finding: The finding associated with the guidance. Required.
    :vartype finding: ~azurehealthinsights.models.FindingInference
    :ivar identifier: The guidance identifier, as a concept. Required.
    :vartype identifier: ~azurehealthinsights.models.CodeableConcept
    ...
    :vartype present_guidance_information:
     list[~azurehealthinsights.models.PresentGuidanceInformation]
    :ivar ranking: See doc of GuidanceRankingType. Required. Known values are: "high" and "low".
    :vartype ranking: str or ~azurehealthinsights.models.GuidanceRankingType
    ...
    :vartype recommendation_proposals:
     list[~azurehealthinsights.models.FollowupRecommendationInference]
...
class Identifier(Element):
    ...
    :vartype type: ~azurehealthinsights.models.CodeableConcept
    ...
    :vartype period: ~azurehealthinsights.models.Period
    :ivar assigner: Organization that issued id (may be just text).
    :vartype assigner: ~azurehealthinsights.models.Reference
    """
...
class ImagingProcedure(_model_base.Model):
    ...
    :vartype modality: ~azurehealthinsights.models.CodeableConcept
    :ivar anatomy: Anatomy : SNOMED CT code. Required.
    :vartype anatomy: ~azurehealthinsights.models.CodeableConcept
    :ivar laterality: Laterality : SNOMED CT code.
    :vartype laterality: ~azurehealthinsights.models.CodeableConcept
    :ivar contrast: Contrast : see RadiologyCodeWithTypes (below).
    :vartype contrast: ~azurehealthinsights.models.RadiologyCodeWithTypes
    :ivar view: View : see RadiologyCodeWithTypes (below).
    :vartype view: ~azurehealthinsights.models.RadiologyCodeWithTypes
    """
...
class ImagingProcedureRecommendation(ProcedureRecommendation, discriminator="imagingProcedureRecommendation"):
    ...
    :vartype procedure_codes: list[~azurehealthinsights.models.CodeableConcept]
    :ivar imaging_procedures: Imaging procedures. Required.
    :vartype imaging_procedures: list[~azurehealthinsights.models.ImagingProcedure]
    """
...
class LateralityDiscrepancyInference(RadiologyInsightsInference, discriminator="lateralityDiscrepancy"):
    ...
    :vartype kind: str or ~azurehealthinsights.models.LATERALITY_DISCREPANCY
    :ivar laterality_indication: Laterality indication : SNOMED CT code for laterality qualifier
     value.
    :vartype laterality_indication: ~azurehealthinsights.models.CodeableConcept
    ...
    :vartype discrepancy_type: str or ~azurehealthinsights.models.LateralityDiscrepancyType
    """
...
class LimitedOrderDiscrepancyInference(RadiologyInsightsInference, discriminator="limitedOrderDiscrepancy"):
    ...
    :vartype kind: str or ~azurehealthinsights.models.LIMITED_ORDER_DISCREPANCY
    :ivar order_type: Order type : CPT ultrasound complete code for abdomen, retroperitoneal,
     pelvis or breast. Required.
    :vartype order_type: ~azurehealthinsights.models.CodeableConcept
    :ivar present_body_parts: List of body parts found in the document : SNOMED CT codes.
    :vartype present_body_parts: list[~azurehealthinsights.models.CodeableConcept]
    :ivar present_body_part_measurements: List of body parts that are measured according to the
     document : SNOMED CT codes.
    :vartype present_body_part_measurements: list[~azurehealthinsights.models.CodeableConcept]
    """
...
class Meta(_model_base.Model):
    ...
    :vartype security: list[~azurehealthinsights.models.Coding]
    ...
    :vartype tag: list[~azurehealthinsights.models.Coding]
    """
...
class Observation(DomainResource, discriminator="Observation"):
    ...
    :vartype identifier: list[~azurehealthinsights.models.Identifier]
    :ivar status: registered | preliminary | final | amended +. Required. Known values are:
     ...
     and "unknown".
    :vartype status: str or ~azurehealthinsights.models.ObservationStatusCodeType
    :ivar category: Classification of  type of observation.
    :vartype category: list[~azurehealthinsights.models.CodeableConcept]
    :ivar code: Type of observation (code / type). Required.
    :vartype code: ~azurehealthinsights.models.CodeableConcept
    :ivar subject: Who and/or what the observation is about.
    :vartype subject: ~azurehealthinsights.models.Reference
    :ivar encounter: Healthcare event during which this observation is made.
    :vartype encounter: ~azurehealthinsights.models.Reference
    ...
    :vartype data_absent_reason: ~azurehealthinsights.models.CodeableConcept
    :ivar interpretation: High, low, normal, etc.
    :vartype interpretation: list[~azurehealthinsights.models.CodeableConcept]
    :ivar note: Comments about the observation.
    :vartype note: list[~azurehealthinsights.models.Annotation]
    :ivar body_site: Observed body part.
    :vartype body_site: ~azurehealthinsights.models.CodeableConcept
    :ivar method: How it was done.
    :vartype method: ~azurehealthinsights.models.CodeableConcept
    :ivar reference_range: Provides guide for interpretation.
    :vartype reference_range: list[~azurehealthinsights.models.ObservationReferenceRange]
    :ivar has_member: Related resource that belongs to the Observation group.
    :vartype has_member: list[~azurehealthinsights.models.Reference]
    :ivar derived_from: Related measurements the observation is made from.
    :vartype derived_from: list[~azurehealthinsights.models.Reference]
    :ivar component: Component results.
    :vartype component: list[~azurehealthinsights.models.ObservationComponent]
    """
...
class ObservationReferenceRange(_model_base.Model):
    ...
    :vartype low: ~azurehealthinsights.models.Quantity
    :ivar high: High Range, if relevant.
    :vartype high: ~azurehealthinsights.models.Quantity
    :ivar type: Reference range qualifier.
    :vartype type: ~azurehealthinsights.models.CodeableConcept
    :ivar applies_to: Reference range population.
    :vartype applies_to: list[~azurehealthinsights.models.CodeableConcept]
    :ivar age: Applicable age range, if relevant.
    :vartype age: ~azurehealthinsights.models.Range
...
class PatientDetails(_model_base.Model):
    ...
    :vartype sex: str or ~azurehealthinsights.models.PatientSex
    ...
    :vartype clinical_info: list[~azurehealthinsights.models.Resource]
    """
...
class PatientDocument(_model_base.Model):
    ...
    :ivar type: The type of the patient document, such as 'note' (text document) or 'fhirBundle'
     ...
     "genomicSequencing".
    :vartype type: str or ~azurehealthinsights.models.DocumentType
    ...
    :vartype clinical_type: str or ~azurehealthinsights.models.ClinicalDocumentType
    ...
    :vartype authors: list[~azurehealthinsights.models.DocumentAuthor]
    :ivar specialty_type: specialty type the document. Known values are: "pathology" and
     "radiology".
    :vartype specialty_type: str or ~azurehealthinsights.models.SpecialtyType
    :ivar administrative_metadata: Administrative metadata for the document.
    :vartype administrative_metadata: ~azurehealthinsights.models.DocumentAdministrativeMetadata
    :ivar content: The content of the patient document. Required.
    :vartype content: ~azurehealthinsights.models.DocumentContent
    """
...
class PatientEncounter(_model_base.Model):
    ...
    :vartype period: ~azurehealthinsights.models.TimePeriod
    ...
    :vartype class_property: str or ~azurehealthinsights.models.EncounterClass
    """
...
class PatientRecord(_model_base.Model):
    ...
    :vartype details: ~azurehealthinsights.models.PatientDetails
    :ivar encounters: Patient encounters/visits.
    :vartype encounters: list[~azurehealthinsights.models.PatientEncounter]
    :ivar patient_documents: Patient unstructured clinical data, given as documents.
    :vartype patient_documents: list[~azurehealthinsights.models.PatientDocument]
    """
...
class PresentGuidanceInformation(_model_base.Model):
    ...
    :vartype sizes: list[~azurehealthinsights.models.Observation]
    :ivar maximum_diameter_as_in_text: The maximum diameter value, if the item is about the maximum
     diameter.
    :vartype maximum_diameter_as_in_text: ~azurehealthinsights.models.Quantity
...
class QualityMeasureInference(RadiologyInsightsInference, discriminator="qualityMeasure"):
    ...
    :vartype kind: str or ~azurehealthinsights.models.QUALITY_MEASURE
    ...
    :vartype compliance_type: str or ~azurehealthinsights.models.QualityMeasureComplianceType
...
class QualityMeasureOptions(_model_base.Model):
    ...
    :ivar measure_types: Id(s) of the MIPS measures that need to be evaluated in the document.
     Required.
    :vartype measure_types: list[str or ~azurehealthinsights.models.QualityMeasureType]
    """
...
class RadiologyCodeWithTypes(_model_base.Model):
    ...
    :vartype types: list[~azurehealthinsights.models.CodeableConcept]
    """
...
class RadiologyInsightsData(_model_base.Model):
    ...
    :vartype patients: list[~azurehealthinsights.models.PatientRecord]
    :ivar configuration: Configuration affecting the Radiology Insights model's inference.
    :vartype configuration: ~azurehealthinsights.models.RadiologyInsightsModelConfiguration
    """
...
class RadiologyInsightsInferenceOptions(_model_base.Model):
    ...
    :vartype followup_recommendation_options:
     ~azurehealthinsights.models.FollowupRecommendationOptions
    :ivar finding_options: Finding options.
    :vartype finding_options: ~azurehealthinsights.models.FindingOptions
    :ivar guidance_options: Guidance options.
    :vartype guidance_options: ~azurehealthinsights.models.GuidanceOptions
    :ivar quality_measure_options: QualityMeasureOptions.
    :vartype quality_measure_options: ~azurehealthinsights.models.QualityMeasureOptions
    """
...
class RadiologyInsightsInferenceResult(_model_base.Model):
    ...
    :vartype patient_results: list[~azurehealthinsights.models.RadiologyInsightsPatientResult]
...
class RadiologyInsightsJob(_model_base.Model):
    ...
    :vartype job_data: ~azurehealthinsights.models.RadiologyInsightsData
    :ivar result: The result of the operation.
    :vartype result: ~azurehealthinsights.models.RadiologyInsightsInferenceResult
    ...
    :vartype status: str or ~azurehealthinsights.models.JobStatus
...
class RadiologyInsightsModelConfiguration(_model_base.Model):
    ...
    :vartype inference_types: list[str or
     ~azurehealthinsights.models.RadiologyInsightsInferenceType]
    :ivar inference_options: Options regarding follow up recommendation inferences and finding
     inferences.
    :vartype inference_options: ~azurehealthinsights.models.RadiologyInsightsInferenceOptions
...
class RadiologyInsightsPatientResult(_model_base.Model):
    ...
    :vartype inferences: list[~azurehealthinsights.models.RadiologyInsightsInference]
    """
...
class RadiologyProcedureInference(RadiologyInsightsInference, discriminator="radiologyProcedure"):
    ...
    :vartype kind: str or ~azurehealthinsights.models.RADIOLOGY_PROCEDURE
    :ivar procedure_codes: LOINC codes for the procedure.
    :vartype procedure_codes: list[~azurehealthinsights.models.CodeableConcept]
    :ivar imaging_procedures: Imaging procedures. Required.
    :vartype imaging_procedures: list[~azurehealthinsights.models.ImagingProcedure]
    :ivar ordered_procedure: Ordered procedure information from the document information or text.
     Required.
    :vartype ordered_procedure: ~azurehealthinsights.models.OrderedProcedure
    """
...
class Ratio(Element):
    ...
    :vartype numerator: ~azurehealthinsights.models.Quantity
    :ivar denominator: Denominator value.
    :vartype denominator: ~azurehealthinsights.models.Quantity
    """
...
class RecommendationFinding(_model_base.Model):
    ...
    :vartype critical_finding: ~azurehealthinsights.models.CriticalResult
    ...
    :vartype recommendation_finding_status: str or
     ~azurehealthinsights.models.RecommendationFindingStatusType
    :ivar extension: Additional Content defined by implementations.
    :vartype extension: list[~azurehealthinsights.models.Extension]
    """
...
class Reference(Element):
    ...
    :vartype identifier: ~azurehealthinsights.models.Identifier
...
class SampledData(Element):
    ...
    :vartype origin: ~azurehealthinsights.models.Quantity
...
class ScoringAndAssessmentInference(RadiologyInsightsInference, discriminator="scoringAndAssessment"):
    ...
    :vartype kind: str or ~azurehealthinsights.models.SCORING_AND_ASSESSMENT
    ...
    :vartype category: str or ~azurehealthinsights.models.ScoringAndAssessmentCategoryType
    ...
    :vartype range_value: ~azurehealthinsights.models.AssessmentValueRange
    """
...
class SexMismatchInference(RadiologyInsightsInference, discriminator="sexMismatch"):
    ...
    :vartype kind: str or ~azurehealthinsights.models.SEX_MISMATCH
    :ivar sex_indication: Sex indication : SNOMED CT code for gender finding. Required.
    :vartype sex_indication: ~azurehealthinsights.models.CodeableConcept
    """
