...
from ..._operations._operations import build_patient_timeline_infer_patient_timeline_request
...
class PatientTimelineClientOperationsMixin(PatientTimelineClientMixinABC):
    async def _infer_patient_timeline_initial(
        self, body: Union[_models.PatientTimelineData, JSON, IO[bytes]], **kwargs: Any
    ) -> JSON:
        error_map = {
        ...
        _request = build_patient_timeline_infer_patient_timeline_request(
    ...
    @overload
    async def begin_infer_patient_timeline(
        self, body: _models.PatientTimelineData, *, content_type: str = "application/json", **kwargs: Any
    ) -> AsyncLROPoller[_models.PatientTimelineInferenceResult]:
        ...
        :param body: Required.
        :type body: ~azure.healthinsights.patienttimeline.models.PatientTimelineData
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns PatientTimelineInferenceResult. The
         PatientTimelineInferenceResult is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.healthinsights.patienttimeline.models.PatientTimelineInferenceResult]
                    ...
                    "patientResults": [
                        {
                            "inferences": [
                                {
                                    "type": "str",  # The type of the Patient
                                      Timeline inference. Required. Known values are: "timelineEvent"
                                      and "summaryItem".
                                    "extension": [
                                        {
                                            "url": "str",  # Source of
    ...
    async def begin_infer_patient_timeline(
        ...
        :param body: Is one of the following types: PatientTimelineData, JSON, IO[bytes] Required.
        :type body: ~azure.healthinsights.patienttimeline.models.PatientTimelineData or JSON or
         IO[bytes]
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.PatientTimelineInferenceResult] = kwargs.pop("cls", None)
        polling: Union[bool, AsyncPollingMethod] = kwargs.pop("polling", True)
        lro_delay = kwargs.pop("polling_interval", self._config.polling_interval)
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._infer_patient_timeline_initial(
        ...
        def get_long_running_output(pipeline_response):
            ...
            deserialized = _deserialize(_models.PatientTimelineInferenceResult, response.json().get("result"))
            if cls:
                return cls(pipeline_response, deserialized, response_headers)  # type: ignore
            return deserialized
        ...
        if cont_token:
            return AsyncLROPoller[_models.PatientTimelineInferenceResult].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.PatientTimelineInferenceResult](
