...
class PatientTimelineClientConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long
    """Configuration for PatientTimelineClient.
    ...
    def __init__(self, endpoint: str, credential: AzureKeyCredential, **kwargs: Any) -> None:
        ...
        kwargs.setdefault("sdk_moniker", "healthinsights-patienttimeline/{}".format(VERSION))
