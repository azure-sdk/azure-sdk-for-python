...
class CancerProfilingClientOperationsMixin(CancerProfilingClientMixinABC):
    ...
    async def begin_infer_cancer_profile(
        ...
        :return: An instance of AsyncLROPoller that returns OncoPhenotypeResults or An instance of
         AsyncLROPoller that returns OncoPhenotypeResult. The OncoPhenotypeResults is compatible with
         MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.healthinsights.cancerprofiling.models.OncoPhenotypeResults]
         or
    ...
    async def begin_infer_cancer_profile(
        ...
        if cont_token:
            return AsyncLROPoller[_models.OncoPhenotypeResult].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.OncoPhenotypeResult](
