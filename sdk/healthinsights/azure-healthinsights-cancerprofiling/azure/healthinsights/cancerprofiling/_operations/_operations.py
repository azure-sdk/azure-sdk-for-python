...
class CancerProfilingClientOperationsMixin(CancerProfilingClientMixinABC):
    ...
    def begin_infer_cancer_profile(
    ...
    ) -> LROPoller[_models.OncoPhenotypeInferenceResult]:
        ...
        :return: An instance of LROPoller that returns OncoPhenotypeInferenceResult. The
         OncoPhenotypeInferenceResult is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.LROPoller[~azure.healthinsights.cancerprofiling.models.OncoPhenotypeInferenceResult]
                            ...
                            "inferences": [
                                {
                                    "type": "str",  # The type of the Onco
                                      ...
                                      "clinicalStageM", "pathologicStageT", "pathologicStageN",
                                      "pathologicStageM", and "diagnosisDate".
    ...
    def begin_infer_cancer_profile(
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.OncoPhenotypeInferenceResult] = kwargs.pop("cls", None)
        ...
        def get_long_running_output(pipeline_response):
            ...
            deserialized = _deserialize(_models.OncoPhenotypeInferenceResult, response.json().get("result"))
            if cls:
                return cls(pipeline_response, deserialized, response_headers)  # type: ignore
            return deserialized
        ...
        if cont_token:
            return LROPoller[_models.OncoPhenotypeInferenceResult].from_continuation_token(
