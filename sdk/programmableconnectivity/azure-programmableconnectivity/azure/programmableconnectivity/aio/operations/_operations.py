...
from ...operations._operations import (
    ...
    build_number_verification_retrieve_request,
    build_number_verification_verify_request,
...
class DeviceLocationOperations:
    ...
    async def verify(
        self,
        location: Union[str, _models.DeviceLocationEnum],
        ...
        **kwargs: Any
        ...
        :type location: str or ~azure.programmableconnectivity.models.DeviceLocationEnum
        :param body: Required.
    ...
    async def verify(
        ...
        **kwargs: Any
        ...
        if response.status_code not in [200]:
            ...
            error = _deserialize(_models.ApcError, response.json())
...
class DeviceNetworkOperations:
    ...
    async def retrieve(
        self,
        network: Union[str, _models.DeviceNetworkEnum],
        ...
        **kwargs: Any
        ...
        :type network: str or ~azure.programmableconnectivity.models.DeviceNetworkEnum
        :param body: Required.
...
class NumberVerificationOperations:
    ...
    async def verify(
        self,
        number: Union[str, _models.NumberVerificationEnum],
        body: _models.NumberVerificationContent,
        *,
        apc_gateway_id: str,
        content_type: str = "application/json",
        **kwargs: Any
        ...
        :type number: str or ~azure.programmableconnectivity.models.NumberVerificationEnum
        :param body: Required.
        :type body: ~azure.programmableconnectivity.models.NumberVerificationContent
        :keyword apc_gateway_id: The identifier of the APC Gateway resource which should handle this
         request. Required.
        :paramtype apc_gateway_id: str
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
    ...
    async def verify(
        self,
        number: Union[str, _models.NumberVerificationEnum],
        body: Union[_models.NumberVerificationContent, JSON, IO[bytes]],
        *,
        apc_gateway_id: str,
        **kwargs: Any
    ) -> _models.NumberVerificationResult:
        ...
        :param number: Static endpoint. "number" Required.
        :type number: str or ~azure.programmableconnectivity.models.NumberVerificationEnum
        :param body: Is one of the following types: NumberVerificationContent, JSON, IO[bytes]
         Required.
        :type body: ~azure.programmableconnectivity.models.NumberVerificationContent or JSON or
         IO[bytes]
        :keyword apc_gateway_id: The identifier of the APC Gateway resource which should handle this
         request. Required.
        :paramtype apc_gateway_id: str
        ...
        _request = build_number_verification_verify_request(
            number=number,
            apc_gateway_id=apc_gateway_id,
            content_type=content_type,
            api_version=self._config.api_version,
    ...
    async def retrieve(
        ...
        **kwargs: Any
        ...
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
         will have to context manage the returned stream.
        :return: NumberRetrievalResult. The NumberRetrievalResult is compatible with MutableMapping
        :rtype: ~azure.programmableconnectivity.models.NumberRetrievalResult
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def retrieve(
        ...
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.NumberRetrievalResult] = kwargs.pop("cls", None)
        ...
        _request = build_number_verification_retrieve_request(
            number=number,
            apc_gateway_id=apc_gateway_id,
            content_type=content_type,
            api_version=self._config.api_version,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.NumberRetrievalResult, response.json())
...
class SimSwapOperations:
    ...
    async def retrieve(
        ...
        **kwargs: Any
        ...
        :param sim_swap: Static endpoint. "sim-swap" Required.
    ...
    async def retrieve(
        self,
        sim_swap: Union[str, _models.SimSwapEnum],
        body: Union[_models.SimSwapRetrievalContent, JSON, IO[bytes]],
        *,
        apc_gateway_id: str,
        **kwargs: Any
    ) -> _models.SimSwapRetrievalResult:
    ...
    async def verify(
        self,
        sim_swap: Union[str, _models.SimSwapEnum],
        body: Union[_models.SimSwapVerificationContent, JSON, IO[bytes]],
        *,
        apc_gateway_id: str,
        **kwargs: Any
    ) -> _models.SimSwapVerificationResult:
