...
class ApcErrorResponse(_model_base.Model):
    """A custom error response for APC.

    :ivar error: Error returned by APC. Required.
    :vartype error: ~azure.programmableconnectivity.models.ApcError
    """

    error: "_models.ApcError" = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Error returned by APC. Required."""

    @overload
    def __init__(
        self,
        *,
        error: "_models.ApcError",
    ) -> None: ...
...
class InnerError(_model_base.Model):
    ...
    :vartype innererror: ~azure.programmableconnectivity.models.InnerError
    """
