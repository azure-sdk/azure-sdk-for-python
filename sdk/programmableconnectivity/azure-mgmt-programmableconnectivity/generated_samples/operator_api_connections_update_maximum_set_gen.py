...
# USAGE
    python operator_api_connections_update_maximum_set_gen.py
...
def main():
    ...
    response = client.operator_api_connections.begin_update(
        resource_group_name="rgopenapi",
        operator_api_connection_name="operatorApiConnectionName",
        properties={
            "properties": {
                "dataProcessingList": [
                    {
