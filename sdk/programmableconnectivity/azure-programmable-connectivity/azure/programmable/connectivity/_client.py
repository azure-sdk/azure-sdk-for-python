...
class ProgrammableConnectivityClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype location_interface:
     azure.programmable.connectivity.operations.LocationInterfaceOperations
    :ivar networks: NetworksOperations operations
    :vartype networks: azure.programmable.connectivity.operations.NetworksOperations
    :ivar number_interface: NumberInterfaceOperations operations
    :vartype number_interface: azure.programmable.connectivity.operations.NumberInterfaceOperations
    :ivar sim_swap_interface: SimSwapInterfaceOperations operations
    :vartype sim_swap_interface:
     azure.programmable.connectivity.operations.SimSwapInterfaceOperations
