...
from ._configuration import MicrosoftStandbyPoolConfiguration
...
class MicrosoftStandbyPool:  # pylint: disable=client-accepts-api-version-keyword
    """MicrosoftStandbyPool.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = MicrosoftStandbyPoolConfiguration(
    ...
    async def __aenter__(self) -> "MicrosoftStandbyPool":
