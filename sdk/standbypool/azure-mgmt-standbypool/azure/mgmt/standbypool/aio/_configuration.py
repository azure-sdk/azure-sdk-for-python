...
class MicrosoftStandbyPoolConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    """Configuration for MicrosoftStandbyPool.
    ...
    def __init__(self, credential: "AsyncTokenCredential", subscription_id: str, **kwargs: Any) -> None:
        super(MicrosoftStandbyPoolConfiguration, self).__init__(**kwargs)
