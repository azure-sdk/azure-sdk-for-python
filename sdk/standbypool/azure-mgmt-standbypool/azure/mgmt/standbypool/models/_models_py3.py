...
class StandbyContainerGroupPoolElasticityProfile(_serialization.Model):
...
class StandbyContainerGroupPoolElasticityProfileUpdate(_serialization.Model):
    """Specifies the elasticity profile of the standby container group pools.
...
class StandbyContainerGroupPoolResourceListResult(_serialization.Model):
...
class StandbyContainerGroupPoolResourceProperties(_serialization.Model):
...
class StandbyContainerGroupPoolResourceUpdateProperties(_serialization.Model):
...
class StandbyVirtualMachinePoolElasticityProfile(_serialization.Model):
    """Details of the elasticity profile.

    All required parameters must be populated in order to send to Azure.

    :ivar max_ready_capacity: Specifies maximum number of virtual machines in the standby virtual
    ...
    def __init__(self, *, max_ready_capacity: int, **kwargs: Any) -> None:
        """
        :keyword max_ready_capacity: Specifies maximum number of virtual machines in the standby
...
class StandbyVirtualMachinePoolElasticityProfileUpdate(_serialization.Model):
    """Details of the elasticity profile.
...
class StandbyVirtualMachinePoolResourceListResult(_serialization.Model):
...
class StandbyVirtualMachinePoolResourceProperties(_serialization.Model):
...
class StandbyVirtualMachinePoolResourceUpdateProperties(_serialization.Model):
