...
# USAGE
    python standby_container_group_pools_update_maximum_set_gen.py
...
# x-ms-original-file: specification/standbypool/resource-manager/Microsoft.StandbyPool/preview/2023-12-01-preview/examples/StandbyContainerGroupPools_Update_MaximumSet_Gen.json
