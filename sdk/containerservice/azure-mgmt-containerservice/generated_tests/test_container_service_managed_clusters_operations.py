...
class TestContainerServiceManagedClustersOperations(AzureMgmtRecordedTestCase):
    ...
    def test_begin_create_or_update(self, resource_group):
        response = self.client.managed_clusters.begin_create_or_update(
            ...
            parameters={
                ...
                "agentPoolProfiles": [
                    {
                        ...
                        "gpuProfile": {"installGPUDriver": bool},
                        "hostGroupID": "str",
                        "kubeletConfig": {
                ...
                "networkProfile": {
                    "advancedNetworking": {
                        "observability": {"enabled": bool, "tlsManagement": "str"},
                        "security": {"fqdnPolicy": {"enabled": bool}},
                    },
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_get_guardrails_versions(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_list_guardrails_versions(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_get_safeguards_versions(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_list_safeguards_versions(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_begin_rebalance_load_balancers(self, resource_group):
