...
def build_abort_latest_operation_request(
    resource_group_name: str, resource_name: str, subscription_id: str, agent_pool_name: str, **kwargs: Any
) -> HttpRequest:
...
class AgentPoolsOperations:
    ...
    def _abort_latest_operation_initial(  # pylint: disable=inconsistent-return-statements
        ...
        request = build_abort_latest_operation_request(
            ...
            agent_pool_name=self._config.agent_pool_name,
    ...
    @distributed_trace
    def get(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> _models.AgentPool:
    ...
    def _create_or_update_initial(
        self, resource_group_name: str, resource_name: str, parameters: Union[_models.AgentPool, IO], **kwargs: Any
    ) -> _models.AgentPool:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
