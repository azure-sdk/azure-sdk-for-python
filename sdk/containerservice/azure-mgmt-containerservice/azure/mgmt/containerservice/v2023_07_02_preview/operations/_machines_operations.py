...
class MachinesOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> Iterable["_models.Machine"]:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, resource_name: str, machine_name: str, **kwargs: Any) -> _models.Machine:
