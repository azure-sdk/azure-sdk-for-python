...
class ContainerServiceClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype machine: azure.mgmt.containerservice.v2023_07_02_preview.operations.MachineOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = ContainerServiceClientConfiguration(
            credential=credential, agent_pool_name=agent_pool_name, subscription_id=subscription_id, **kwargs
        )
