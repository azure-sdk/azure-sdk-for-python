...
class AgentPool(SubResource):
    ...
    :vartype os_type: str or ~azure.mgmt.containerservice.v2019_04_01.models.OSType
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype os_type: str or ~azure.mgmt.containerservice.v2019_04_01.models.OSType
...
class AgentPoolListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.containerservice.v2019_04_01.models.AgentPool]
    ...
    def __init__(self, *, value: Optional[List["_models.AgentPool"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.containerservice.v2019_04_01.models.AgentPool]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class CloudErrorBody(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.containerservice.v2019_04_01.models.CloudErrorBody]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype details: list[~azure.mgmt.containerservice.v2019_04_01.models.CloudErrorBody]
        """
        super().__init__(**kwargs)
        self.code = code
...
class ContainerServiceLinuxProfile(_serialization.Model):
    ...
    :vartype ssh: ~azure.mgmt.containerservice.v2019_04_01.models.ContainerServiceSshConfiguration
    """
...
class ContainerServiceMasterProfile(_serialization.Model):
    ...
    :vartype count: int or ~azure.mgmt.containerservice.v2019_04_01.models.Count
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype count: int or ~azure.mgmt.containerservice.v2019_04_01.models.Count
...
class ContainerServiceNetworkProfile(_serialization.Model):
    ...
    :ivar network_plugin: Network plugin used for building Kubernetes network. Known values are:
     "azure" and "kubenet".
    :vartype network_plugin: str or ~azure.mgmt.containerservice.v2019_04_01.models.NetworkPlugin
    :ivar network_policy: Network policy used for building Kubernetes network. Known values are:
     "calico" and "azure".
    :vartype network_policy: str or ~azure.mgmt.containerservice.v2019_04_01.models.NetworkPolicy
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword network_plugin: Network plugin used for building Kubernetes network. Known values are:
         "azure" and "kubenet".
        :paramtype network_plugin: str or ~azure.mgmt.containerservice.v2019_04_01.models.NetworkPlugin
        :keyword network_policy: Network policy used for building Kubernetes network. Known values are:
         "calico" and "azure".
        :paramtype network_policy: str or ~azure.mgmt.containerservice.v2019_04_01.models.NetworkPolicy
...
class ManagedCluster(Resource):
    ...
    :vartype identity: ~azure.mgmt.containerservice.v2019_04_01.models.ManagedClusterIdentity
    :ivar provisioning_state: The current deployment or provisioning state, which only appears in
     the response.
    :vartype provisioning_state: str
    ...
    :vartype aad_profile: ~azure.mgmt.containerservice.v2019_04_01.models.ManagedClusterAADProfile
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype identity: ~azure.mgmt.containerservice.v2019_04_01.models.ManagedClusterIdentity
...
class ManagedClusterAgentPoolProfileProperties(_serialization.Model):
    ...
    :ivar type: AgentPoolType represents types of an agent pool. Known values are:
     "VirtualMachineScaleSets" and "AvailabilitySet".
    :vartype type: str or ~azure.mgmt.containerservice.v2019_04_01.models.AgentPoolType
    :ivar orchestrator_version: Version of orchestrator specified when creating the managed
     cluster.
    :vartype orchestrator_version: str
    :ivar provisioning_state: The current deployment or provisioning state, which only appears in
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: AgentPoolType represents types of an agent pool. Known values are:
         "VirtualMachineScaleSets" and "AvailabilitySet".
        :paramtype type: str or ~azure.mgmt.containerservice.v2019_04_01.models.AgentPoolType
        :keyword orchestrator_version: Version of orchestrator specified when creating the managed
         cluster.
        :paramtype orchestrator_version: str
        :keyword availability_zones: (PREVIEW) Availability zones for nodes. Must use
...
class ManagedClusterIdentity(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.containerservice.v2019_04_01.models.ResourceIdentityType
    """
    ...
    def __init__(self, *, type: Optional[Union[str, "_models.ResourceIdentityType"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype type: str or ~azure.mgmt.containerservice.v2019_04_01.models.ResourceIdentityType
        """
        super().__init__(**kwargs)
...
class ManagedClusterListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.containerservice.v2019_04_01.models.ManagedCluster]
    ...
    def __init__(self, *, value: Optional[List["_models.ManagedCluster"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.containerservice.v2019_04_01.models.ManagedCluster]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class OrchestratorVersionProfile(_serialization.Model):
    ...
    :vartype upgrades: list[~azure.mgmt.containerservice.v2019_04_01.models.OrchestratorProfile]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype upgrades: list[~azure.mgmt.containerservice.v2019_04_01.models.OrchestratorProfile]
        """
        super().__init__(**kwargs)
        self.orchestrator_type = orchestrator_type
        self.orchestrator_version = orchestrator_version
