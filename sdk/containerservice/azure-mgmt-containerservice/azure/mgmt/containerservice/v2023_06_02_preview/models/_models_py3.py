...
class LinuxOSConfig(_serialization.Model):
    ...
    :ivar ulimits: Ulimit settings for Linux agent nodes.
    :vartype ulimits: ~azure.mgmt.containerservice.v2023_06_02_preview.models.UlimitConfig
    """
    ...
    _attribute_map = {
        ...
        "ulimits": {"key": "ulimits", "type": "UlimitConfig"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        ulimits: Optional["_models.UlimitConfig"] = None,
        **kwargs: Any
    ) -> None:
        """
        ...
        :keyword ulimits: Ulimit settings for Linux agent nodes.
        :paramtype ulimits: ~azure.mgmt.containerservice.v2023_06_02_preview.models.UlimitConfig
        """
        super().__init__(**kwargs)
...
class UlimitConfig(_serialization.Model):
    """Ulimit settings for Linux agent nodes.

    :ivar max_locked_memory: Maximum locked-in-memory address space (KB).
    :vartype max_locked_memory: str
    :ivar no_file: Maximum number of open files.
    :vartype no_file: str
    """

    _attribute_map = {
        "max_locked_memory": {"key": "maxLockedMemory", "type": "str"},
        "no_file": {"key": "noFile", "type": "str"},
    }

    def __init__(
        self, *, max_locked_memory: Optional[str] = None, no_file: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword max_locked_memory: Maximum locked-in-memory address space (KB).
        :paramtype max_locked_memory: str
        :keyword no_file: Maximum number of open files.
        :paramtype no_file: str
        """
        super().__init__(**kwargs)
        self.max_locked_memory = max_locked_memory
