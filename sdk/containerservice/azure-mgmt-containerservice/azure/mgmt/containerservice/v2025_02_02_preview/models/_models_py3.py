...
class AdvancedNetworkingSecurity(_serialization.Model):
    ...
    :ivar enabled: Configure Advanced Networking Security features on Cilium clusters. When the
     flag is set to true, FQDN policies will be enabled by default unless advancedNetworkPolicies is
     explicitly set to a different value. If not specified, the default is false.
    :vartype enabled: bool
    :ivar advanced_network_policies: This allows users to configure Layer 7 network policies (FQDN,
     ...
     otherwise it defaults to None. Known values are: "L7", "FQDN", and "None".
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword enabled: Configure Advanced Networking Security features on Cilium clusters. When the
         flag is set to true, FQDN policies will be enabled by default unless advancedNetworkPolicies is
         explicitly set to a different value. If not specified, the default is false.
        :paramtype enabled: bool
        :keyword advanced_network_policies: This allows users to configure Layer 7 network policies
         ...
         only on cilium-based clusters. If not specified, the default value is L7 if enabled is set to
         true otherwise it defaults to None. Known values are: "L7", "FQDN", and "None".
...
class AgentPoolAvailableVersions(_serialization.Model):
    ...
    :vartype agent_pool_versions:
     list[~azure.mgmt.containerservice.v2025_02_02_preview.models.AgentPoolAvailableVersionsPropertiesAgentPoolVersionsItem]  # pylint: disable=line-too-long
    """
...
class ManagedClusterAzureMonitorProfileAppMonitoring(_serialization.Model):  # pylint: disable=name-too-long
    ...
    :vartype auto_instrumentation:
     ~azure.mgmt.containerservice.v2025_02_02_preview.models.ManagedClusterAzureMonitorProfileAppMonitoringAutoInstrumentation  # pylint: disable=line-too-long
    ...
    :vartype open_telemetry_metrics:
     ~azure.mgmt.containerservice.v2025_02_02_preview.models.ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryMetrics  # pylint: disable=line-too-long
    ...
    :vartype open_telemetry_logs:
     ~azure.mgmt.containerservice.v2025_02_02_preview.models.ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryLogs  # pylint: disable=line-too-long
    """
...
class ManagedClusterSecurityProfileDefenderSecurityGating(_serialization.Model):  # pylint: disable=name-too-long
    ...
    :ivar identities: List of identities that the admission controller will make use of in order to
     ...
     attached to it.
    :vartype identities:
     list[~azure.mgmt.containerservice.v2025_02_02_preview.models.ManagedClusterSecurityProfileDefenderSecurityGatingIdentitiesItem]  # pylint: disable=line-too-long
...
class ManagedClusterWorkloadAutoScalerProfile(_serialization.Model):
    ...
    :vartype vertical_pod_autoscaler:
     ~azure.mgmt.containerservice.v2025_02_02_preview.models.ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscaler  # pylint: disable=line-too-long
    """
...
class ScaleProfile(_serialization.Model):
    ...
    :vartype autoscale:
     list[~azure.mgmt.containerservice.v2025_02_02_preview.models.AutoScaleProfile]
    """
