...
class ManagedClusterSnapshotsOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.ManagedClusterSnapshot"]:
        ...
        :return: An iterator like instance of either ManagedClusterSnapshot or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2024_02_02_preview.models.ManagedClusterSnapshot]
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2024_02_02_preview.models.ManagedClusterSnapshot or IO
