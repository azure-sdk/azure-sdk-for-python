...
class ContainerServiceClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype operations: azure.mgmt.containerservice.v2022_11_02_preview.operations.Operations
    :ivar managed_clusters: ManagedClustersOperations operations
    :vartype managed_clusters:
     azure.mgmt.containerservice.v2022_11_02_preview.operations.ManagedClustersOperations
    :ivar maintenance_configurations: MaintenanceConfigurationsOperations operations
    :vartype maintenance_configurations:
     azure.mgmt.containerservice.v2022_11_02_preview.operations.MaintenanceConfigurationsOperations
    :ivar agent_pools: AgentPoolsOperations operations
    :vartype agent_pools:
     azure.mgmt.containerservice.v2022_11_02_preview.operations.AgentPoolsOperations
    ...
    :vartype resolve_private_link_service_id:
     azure.mgmt.containerservice.v2022_11_02_preview.operations.ResolvePrivateLinkServiceIdOperations
    :ivar snapshots: SnapshotsOperations operations
    :vartype snapshots:
     azure.mgmt.containerservice.v2022_11_02_preview.operations.SnapshotsOperations
    :ivar managed_cluster_snapshots: ManagedClusterSnapshotsOperations operations
    :vartype managed_cluster_snapshots:
     azure.mgmt.containerservice.v2022_11_02_preview.operations.ManagedClusterSnapshotsOperations
    :ivar trusted_access_roles: TrustedAccessRolesOperations operations
    :vartype trusted_access_roles:
     azure.mgmt.containerservice.v2022_11_02_preview.operations.TrustedAccessRolesOperations
    :ivar trusted_access_role_bindings: TrustedAccessRoleBindingsOperations operations
    :vartype trusted_access_role_bindings:
     azure.mgmt.containerservice.v2022_11_02_preview.operations.TrustedAccessRoleBindingsOperations
    ...
    :type base_url: str
    :keyword api_version: Api Version. Default value is "2022-11-02-preview". Note that overriding
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.operations = Operations(
            self._client, self._config, self._serialize, self._deserialize, "2022-11-02-preview"
        )
