...
class AgentPoolUpgradeSettings(_serialization.Model):
    ...
    :ivar undrainable_node_behavior: Defines the behavior for undrainable nodes during upgrade.The
     most common cause of nodes being undrainable is Pod Disruption Budgets (PDBs) but other issues
     such as pod termination grade period is greater than remaining per node drain timeout or pod is
     still in running state can also cause undrainable nodes. Known values are: "Cordon" and
     "Schedule".
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword undrainable_node_behavior: Defines the behavior for undrainable nodes during
         upgrade.The most common cause of nodes being undrainable is Pod Disruption Budgets (PDBs) but
         other issues such as pod termination grade period is greater than remaining per node drain
         timeout or pod is still in running state can also cause undrainable nodes. Known values are:
         "Cordon" and "Schedule".
...
class ContainerServiceNetworkProfile(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype monitoring: ~azure.mgmt.containerservice.v2024_04_02_preview.models.NetworkMonitoring
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype monitoring:
         ~azure.mgmt.containerservice.v2024_04_02_preview.models.NetworkMonitoring
