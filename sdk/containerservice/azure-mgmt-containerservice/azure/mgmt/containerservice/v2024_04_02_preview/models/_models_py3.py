...
class ContainerServiceNetworkProfile(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar pod_link_local_access: Defines access to special link local addresses (IMDS and wire
     server) for pods with hostNetwork=false. if not specified, the default is 'IMDS'. Known values
     are: "IMDS" and "None".
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype ip_families: list[str or
         ~azure.mgmt.containerservice.v2024_04_02_preview.models.IpFamily]
        :keyword pod_link_local_access: Defines access to special link local addresses (IMDS and wire
         server) for pods with hostNetwork=false. if not specified, the default is 'IMDS'. Known values
         are: "IMDS" and "None".
