...
class PodLinkLocalAccess(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Defines access to special link local addresses (IMDS and wire server) for pods with
    hostNetwork=false. If not specified, the default is 'IMDS'.
    """

    IMDS = "IMDS"
    """Pods with hostNetwork=false can access IMDS without restriction."""
    NONE = "None"
    """Pods with hostNetwork=false cannot access IMDS and wire server."""
