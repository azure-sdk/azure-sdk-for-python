...
class ContainerServiceClient(MultiApiClientMixin, _SDKClient):
    ...
    def machine(self):
        """Instance depends on the API version:
           ...
           * 2023-07-02-preview: :class:`MachineOperations<azure.mgmt.containerservice.v2023_07_02_preview.operations.MachineOperations>`
        """
        api_version = self._get_api_version('machine')
        if api_version == '2023-07-02-preview':
            from .v2023_07_02_preview.operations import MachineOperations as OperationClass
        else:
            raise ValueError("API version {} does not have operation group 'machine'".format(api_version))
        self._config.api_version = api_version
        return OperationClass(self._client, self._config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)), api_version)
