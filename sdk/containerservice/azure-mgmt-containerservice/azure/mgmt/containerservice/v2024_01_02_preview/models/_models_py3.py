...
class ScheduledEvent(ProxyResource):
    """Scheduled event.
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.containerservice.v2024_01_02_preview.models.SystemData
    :ivar properties: Properties for the event.
    :vartype properties:
     ~azure.mgmt.containerservice.v2024_01_02_preview.models.ScheduledEventProperties
    """
    ...
    _attribute_map = {
        ...
        "type": {"key": "type", "type": "str"},
        "system_data": {"key": "systemData", "type": "SystemData"},
        "properties": {"key": "properties", "type": "ScheduledEventProperties"},
    }

    def __init__(self, *, properties: Optional["_models.ScheduledEventProperties"] = None, **kwargs: Any) -> None:
        """
        :keyword properties: Properties for the event.
        :paramtype properties:
         ~azure.mgmt.containerservice.v2024_01_02_preview.models.ScheduledEventProperties
        """
        super().__init__(**kwargs)
...
class ScheduledEventProperties(_serialization.Model):
    """Properties for a scheduled event.

    :ivar description: The description of the event.
    :vartype description: str
    :ivar event_id: The event id of the event.
    :vartype event_id: str
    :ivar event_source: The source of the event.
    :vartype event_source: str
    :ivar event_status: The status of the event. Known values are: "Scheduled", "Started",
     "Completed", "Cancelled", and "Failed".
    :vartype event_status: str or
     ~azure.mgmt.containerservice.v2024_01_02_preview.models.EventStatus
    :ivar event_details: The details of the event.
    :vartype event_details: str
    :ivar scheduled_time: The time of the event is scheduled to start.
    :vartype scheduled_time: ~datetime.datetime
    :ivar start_time: The time the event actually started.
    :vartype start_time: ~datetime.datetime
    :ivar last_update_time: The last time the state of the event was updated.
    :vartype last_update_time: ~datetime.datetime
    :ivar resources: The list of resources impacted by the event.
    :vartype resources: list[str]
    :ivar resource_type: The resource type of the event. Known values are: "ManagedCluster" and
     "AgentPool".
    :vartype resource_type: str or
     ~azure.mgmt.containerservice.v2024_01_02_preview.models.ResourceType
    """
    ...
    _attribute_map = {
        ...
        "event_details": {"key": "eventDetails", "type": "str"},
    ...
    def __init__(
        ...
        *,
        ...
        event_status: Optional[Union[str, "_models.EventStatus"]] = None,
        ...
        **kwargs: Any
        ...
        """
        :keyword description: The description of the event.
        :paramtype description: str
        :keyword event_id: The event id of the event.
        :paramtype event_id: str
        :keyword event_source: The source of the event.
        :paramtype event_source: str
        :keyword event_status: The status of the event. Known values are: "Scheduled", "Started",
         "Completed", "Cancelled", and "Failed".
        :paramtype event_status: str or
         ~azure.mgmt.containerservice.v2024_01_02_preview.models.EventStatus
        :keyword event_details: The details of the event.
        :paramtype event_details: str
        :keyword scheduled_time: The time of the event is scheduled to start.
        :paramtype scheduled_time: ~datetime.datetime
        :keyword start_time: The time the event actually started.
        :paramtype start_time: ~datetime.datetime
        :keyword last_update_time: The last time the state of the event was updated.
        :paramtype last_update_time: ~datetime.datetime
        :keyword resources: The list of resources impacted by the event.
        :paramtype resources: list[str]
        :keyword resource_type: The resource type of the event. Known values are: "ManagedCluster" and
         "AgentPool".
