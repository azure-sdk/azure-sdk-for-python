...
class AgentPool(SubResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar vm_identity_profile: Customers use this identity to grant AKS access permission to the
     Capacity Reservation Group and the reserved VMs inside.
    :vartype vm_identity_profile:
    ...
    _attribute_map = {
        ...
        "vm_identity_profile": {"key": "properties.vmIdentityProfile", "type": "UserAssignedIdentity"},
    }
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        vm_identity_profile: Optional["_models.UserAssignedIdentity"] = None,
        **kwargs: Any
    ) -> None:
        """
        ...
        :paramtype artifact_streaming_profile:
         ~azure.mgmt.containerservice.v2023_10_02_preview.models.AgentPoolArtifactStreamingProfile
        :keyword vm_identity_profile: Customers use this identity to grant AKS access permission to the
         Capacity Reservation Group and the reserved VMs inside.
        :paramtype vm_identity_profile:
         ~azure.mgmt.containerservice.v2023_10_02_preview.models.UserAssignedIdentity
        """
        super().__init__(**kwargs)
        self.count = count
        ...
        self.vm_identity_profile = vm_identity_profile
...
class ManagedClusterAgentPoolProfileProperties(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    _attribute_map = {
        ...
        "vm_identity_profile": {"key": "vmIdentityProfile", "type": "UserAssignedIdentity"},
    }
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        super().__init__(
            ...
            vm_identity_profile=vm_identity_profile,
            **kwargs
        )
        self.name = name
...
class ManagedClusterPropertiesAutoScalerProfile(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype expanders: list[str or
     ~azure.mgmt.containerservice.v2023_10_02_preview.models.Expander]
