...
class AgentPoolAvailableVersions(_serialization.Model):
    ...
    :vartype agent_pool_versions:
     list[~azure.mgmt.containerservice.v2023_11_02_preview.models.AgentPoolAvailableVersionsPropertiesAgentPoolVersionsItem]
    """
...
class ManagedCluster(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype guardrails_profile:
     ~azure.mgmt.containerservice.v2023_11_02_preview.models.GuardrailsProfile
...
class ManagedClusterAzureMonitorProfileMetrics(_serialization.Model):
    ...
    :vartype app_monitoring_open_telemetry_metrics:
     ~azure.mgmt.containerservice.v2023_11_02_preview.models.ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryMetrics
    """
...
class ManagedClusterPropertiesAutoScalerProfile(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar expander: Available values are: 'least-waste', 'most-pods', 'priority', 'random'. If
    ...
    :vartype expander: list[str or
     ~azure.mgmt.containerservice.v2023_11_02_preview.models.Expander]
    ...
    def __init__(
        ...
        *,
        ...
        expander: Optional[List[Union[str, "_models.Expander"]]] = None,
        ...
        **kwargs: Any
        ...
        :keyword expander: Available values are: 'least-waste', 'most-pods', 'priority', 'random'. If
         multiple expanders are configured, they will be considered in the order in which they are
         listed, with the first one being considered first.
        :paramtype expander: list[str or
         ~azure.mgmt.containerservice.v2023_11_02_preview.models.Expander]
...
class ManagedClusterWorkloadAutoScalerProfile(_serialization.Model):
    ...
    :vartype vertical_pod_autoscaler:
     ~azure.mgmt.containerservice.v2023_11_02_preview.models.ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscaler
    """
