...
class AllowServicePlacement(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    TRUE = "true"
    """Allow service placement on the load balancer."""
    FALSE = "false"
    """Do not allow service placement on the load balancer."""
