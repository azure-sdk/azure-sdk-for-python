...
class LoadBalancersOperations:
    ...
    async def _rebalance_initial(  # pylint: disable=inconsistent-return-statements
        self,
    ...
    async def begin_rebalance(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = await self._rebalance_initial(  # type: ignore
                resource_group_name=resource_group_name,
                resource_name=resource_name,
