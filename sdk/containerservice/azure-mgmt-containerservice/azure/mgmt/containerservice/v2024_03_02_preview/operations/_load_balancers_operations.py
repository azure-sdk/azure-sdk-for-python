...
class LoadBalancersOperations:
    ...
    def _rebalance_initial(  # pylint: disable=inconsistent-return-statements
        self,
        ...
        **kwargs: Any
        ...
        _request = build_rebalance_request(
            resource_group_name=resource_group_name,
            resource_name=resource_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def begin_rebalance(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = self._rebalance_initial(  # type: ignore
                resource_group_name=resource_group_name,
                resource_name=resource_name,
    ...
    def create_or_update(
        ...
        allow_service_placement: Optional[Union[str, _models.AllowServicePlacement]] = None,
        ...
        **kwargs: Any
        ...
        :type allow_service_placement: str or
         ~azure.mgmt.containerservice.v2024_03_02_preview.models.AllowServicePlacement
