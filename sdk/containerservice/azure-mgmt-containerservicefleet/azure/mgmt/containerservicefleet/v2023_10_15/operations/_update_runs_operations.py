...
class UpdateRunsOperations:
    ...
    def begin_skip(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.containerservicefleet.v2023_10_15.models.SkipProperties
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
    ...
    def begin_skip(
        ...
        **kwargs: Any
        ...
        :param body: The content of the action request. Is either a SkipProperties type or a IO type.
         Required.
        :type body: ~azure.mgmt.containerservicefleet.v2023_10_15.models.SkipProperties or IO
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
