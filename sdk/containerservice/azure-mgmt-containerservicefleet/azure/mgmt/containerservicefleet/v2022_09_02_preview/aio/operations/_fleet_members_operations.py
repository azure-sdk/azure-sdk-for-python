...
class FleetMembersOperations:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.containerservicefleet.v2022_09_02_preview.models.FleetMember
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a FleetMember type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.containerservicefleet.v2022_09_02_preview.models.FleetMember or
         IO[bytes]
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
