...
class FleetsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.containerservicefleet.v2025_03_01.ContainerServiceFleetMgmtClient`'s
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.Fleet"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservicefleet.v2025_03_01.models.Fleet]
    ...
    def get(self, resource_group_name: str, fleet_name: str, **kwargs: Any) -> _models.Fleet:
        ...
        :rtype: ~azure.mgmt.containerservicefleet.v2025_03_01.models.Fleet
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.containerservicefleet.v2025_03_01.models.Fleet
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerservicefleet.v2025_03_01.models.Fleet]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a Fleet type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.containerservicefleet.v2025_03_01.models.Fleet or IO[bytes]
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
        :param if_none_match: The request should only proceed if no entity matches this string. Default
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.containerservicefleet.v2025_03_01.models.FleetPatch
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.containerservicefleet.v2025_03_01.models.FleetPatch or IO[bytes]
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
        :return: An instance of LROPoller that returns either Fleet or the result of cls(response)
    ...
    def list_credentials(
        ...
        :rtype: ~azure.mgmt.containerservicefleet.v2025_03_01.models.FleetCredentialResults
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
