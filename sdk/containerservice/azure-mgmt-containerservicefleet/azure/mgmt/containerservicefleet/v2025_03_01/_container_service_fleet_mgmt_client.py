...
class ContainerServiceFleetMgmtClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype operations: azure.mgmt.containerservicefleet.v2025_03_01.operations.Operations
    :ivar fleets: FleetsOperations operations
    :vartype fleets: azure.mgmt.containerservicefleet.v2025_03_01.operations.FleetsOperations
    :ivar auto_upgrade_profiles: AutoUpgradeProfilesOperations operations
    :vartype auto_upgrade_profiles:
     azure.mgmt.containerservicefleet.v2025_03_01.operations.AutoUpgradeProfilesOperations
    ...
    :vartype auto_upgrade_profile_operations:
     azure.mgmt.containerservicefleet.v2025_03_01.operations.AutoUpgradeProfileOperationsOperations
    :ivar fleet_members: FleetMembersOperations operations
    :vartype fleet_members:
     azure.mgmt.containerservicefleet.v2025_03_01.operations.FleetMembersOperations
    :ivar update_runs: UpdateRunsOperations operations
    :vartype update_runs:
     azure.mgmt.containerservicefleet.v2025_03_01.operations.UpdateRunsOperations
    :ivar fleet_update_strategies: FleetUpdateStrategiesOperations operations
    :vartype fleet_update_strategies:
     azure.mgmt.containerservicefleet.v2025_03_01.operations.FleetUpdateStrategiesOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.fleets = FleetsOperations(self._client, self._config, self._serialize, self._deserialize, "2025-03-01")
