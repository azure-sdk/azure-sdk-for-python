...
class Gate(TrackedResource):
    ...
    :ivar state: The state of the Gate. Known values are: "Pending" and "Completed".
    ...
    _validation = {
        ...
        "e_tag": {"readonly": True},
        "provisioning_state": {"readonly": True},
        "display_name": {"max_length": 100, "min_length": 1, "pattern": r"^[A-Za-z0-9].*$"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword state: The state of the Gate. Known values are: "Pending" and "Completed".
...
class GateTarget(_serialization.Model):
    ...
    :vartype id: str
    :ivar type: The type of the resource being targeted by this Gate. Required. "UpdateRun"
    :vartype type: str or ~azure.mgmt.containerservicefleet.models.GateTargetType
    :ivar properties: Properties specific to the target of this Gate. Required.
    :vartype properties: ~azure.mgmt.containerservicefleet.models.GateTargetProperties
    """
    ...
    _attribute_map = {
        "id": {"key": "id", "type": "str"},
        "type": {"key": "type", "type": "str"},
        "properties": {"key": "properties", "type": "GateTargetProperties"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        type: Union[str, "_models.GateTargetType"],
        properties: "_models.GateTargetProperties",
        **kwargs: Any
    ) -> None:
        """
        :keyword id: The resource id that the Gate is controlling the rollout of. Required.
        :paramtype id: str
        :keyword type: The type of the resource being targeted by this Gate. Required. "UpdateRun"
        :paramtype type: str or ~azure.mgmt.containerservicefleet.models.GateTargetType
        :keyword properties: Properties specific to the target of this Gate. Required.
        :paramtype properties: ~azure.mgmt.containerservicefleet.models.GateTargetProperties
        """
        super().__init__(**kwargs)
        self.id = id
        self.type = type
...
class UpdateRunGateTargetProperties(_serialization.Model):
    ...
    :ivar update_run: Properties specific to the Update Run. Required.
    :vartype update_run: ~azure.mgmt.containerservicefleet.models.UpdateRunGateTarget
    """

    _validation = {
        "update_run": {"required": True},
    }

    _attribute_map = {
        "update_run": {"key": "updateRun", "type": "UpdateRunGateTarget"},
    }

    def __init__(self, *, update_run: "_models.UpdateRunGateTarget", **kwargs: Any) -> None:
        """
        :keyword update_run: Properties specific to the Update Run. Required.
        :paramtype update_run: ~azure.mgmt.containerservicefleet.models.UpdateRunGateTarget
        """
        super().__init__(**kwargs)
        self.update_run = update_run


class GateTargetProperties(UpdateRunGateTargetProperties):
...
class GateUpdate(TrackedResource):
    """A Gate controls the progression during a staged rollout, e.g. in an Update Run.
...
class UpdateGroupStatus(_serialization.Model):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.name = None
        self.members = None
        self.before_gates = None
        self.after_gates = None
...
class UpdateRunGateStatus(_serialization.Model):
    ...
    _validation = {
        "display_name": {"readonly": True, "max_length": 100, "min_length": 1, "pattern": r"^[A-Za-z0-9].*$"},
...
class UpdateRunGateTarget(_serialization.Model):
