...
class UpdateRunsOperations:
    ...
    def list_by_fleet(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservicefleet.v2024_04_01.models.UpdateRun]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either UpdateRun or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerservicefleet.v2024_04_01.models.UpdateRun]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.containerservicefleet.v2024_04_01.models.UpdateRun or IO
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
        :param if_none_match: The request should only proceed if no entity matches this string. Default
    ...
    async def _skip_initial(
        ...
        fleet_name: str,
        update_run_name: str,
        body: Union[_models.SkipProperties, IO],
        if_match: Optional[str] = None,
        **kwargs: Any
        ...
        request = build_skip_request(
            ...
            json=_json,
            content=_content,
            template_url=self._skip_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    _skip_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/fleets/{fleetName}/updateRuns/{updateRunName}/skip"
    }
    ...
    async def begin_skip(
        ...
        **kwargs: Any
        ...
        :param update_run_name: The name of the UpdateRun resource. Required.
        :type update_run_name: str
        :param body: The content of the action request. Is either a SkipProperties type or a IO type.
         Required.
        :type body: ~azure.mgmt.containerservicefleet.v2024_04_01.models.SkipProperties or IO
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
