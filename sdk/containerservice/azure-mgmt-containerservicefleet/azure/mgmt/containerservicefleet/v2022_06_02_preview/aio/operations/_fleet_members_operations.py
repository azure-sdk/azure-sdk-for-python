...
class FleetMembersOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservicefleet.v2022_06_02_preview.models.FleetMember
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservicefleet.v2022_06_02_preview.models.FleetMember or
         IO[bytes]
        :param if_match: Omit this value to always overwrite the current resource. Specify the
         last-seen ETag value to prevent accidentally overwriting concurrent changes. Default value is
         None.
