...
class TestContainerServiceFleetMgmtFleetMembersOperations(AzureMgmtRecordedTestCase):
    ...
    def test_fleet_members_begin_create(self, resource_group):
        response = self.client.fleet_members.begin_create(
            ...
            resource={
                ...
                "id": "str",
                "name": "str",
                "properties": {"clusterResourceId": "str", "group": "str", "provisioningState": "str"},
                "systemData": {
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_fleet_members_begin_update_async(self, resource_group):
        response = self.client.fleet_members.begin_update_async(
            resource_group_name=resource_group.name,
            fleet_name="str",
            fleet_member_name="str",
