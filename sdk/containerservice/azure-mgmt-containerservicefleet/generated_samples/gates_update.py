...
def main():
    ...
    response = client.gates.begin_update(
        ...
        properties={"location": "East US", "properties": {"state": "Completed"}},
    ).result()
    print(response)


# x-ms-original-file: specification/containerservice/resource-manager/Microsoft.ContainerService/fleet/preview/2025-04-01-preview/examples/Gates_Update.json
