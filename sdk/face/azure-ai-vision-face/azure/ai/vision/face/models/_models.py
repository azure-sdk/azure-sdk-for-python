...
class AddFaceResult(_model_base.Model):
    ...
    :ivar persisted_face_id: persistedFaceId of the added face, which is persisted and will not
     expire. Different from faceId which is created in Face - Detect and will expire in 24 hours
     after the detection call. Required.
    :vartype persisted_face_id: str
    """

    persisted_face_id: str = rest_field(name="persistedFaceId")
    """persistedFaceId of the added face, which is persisted and will not expire. Different from
     faceId which is created in Face - Detect and will expire in 24 hours after the detection call.
     Required."""
...
class FaceCollectionTrainingStatus(_model_base.Model):
    ...
    :vartype status: str or ~azure.ai.vision.face.models.FaceOperationState
    ...
    status: Union[str, "_models.FaceOperationState"] = rest_field()
    ...
    def __init__(
        self,
        *,
        status: Union[str, "_models.FaceOperationState"],
...
class FaceDetectionResult(_model_base.Model):
    ...
    """Unique faceId of the detected face, created by detection API and it will expire 24 hours after
     the detection call. To return this, it requires 'returnFaceId' parameter to be true. Required."""
...
class FaceFindSimilarResult(_model_base.Model):
    ...
    :vartype confidence: float
    :ivar face_id: faceId of candidate face when find by faceIds. faceId is created by Face -
...
class LivenessSessionCreationContent(_model_base.Model):
    ...
    :ivar liveness_operation_mode: The operation mode for the liveness modal. Required. "Passive"
    ...
    """The operation mode for the liveness modal. Required. \"Passive\""""
...
class PersonGroup(_model_base.Model):
    ...
    persons. To handle larger scale face identification problem, please consider using
    LargePersonGroup.
...
class SessionAuditEntryRequestInfo(_model_base.Model):
    ...
    :ivar url: The relative URL of the liveness request. Required.
    :vartype url: str
    ...
    url: str = rest_field()
    """The relative URL of the liveness request. Required."""
