...
class FaceAttributes(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    facial_hair: Optional["_models._models.FacialHair"] = rest_field(name="facialHair")
    ...
    head_pose: Optional["_models._models.HeadPose"] = rest_field(name="headPose")
    """3-D roll/yaw/pitch angles for face direction."""
    hair: Optional["_models._models.HairProperties"] = rest_field()
    """Properties describing hair attributes."""
    occlusion: Optional["_models._models.OcclusionProperties"] = rest_field()
    """Properties describing occlusions on a given face."""
    accessories: Optional[List["_models._models.AccessoryItem"]] = rest_field()
    """Properties describing any accessories on a given face."""
    blur: Optional["_models._models.BlurProperties"] = rest_field()
    """Properties describing any presence of blur within the image."""
    exposure: Optional["_models._models.ExposureProperties"] = rest_field()
    """Properties describing exposure level of the image."""
    noise: Optional["_models._models.NoiseProperties"] = rest_field()
    """Properties describing noise level of the image."""
    mask: Optional["_models._models.MaskProperties"] = rest_field()
...
class FaceCollectionTrainingResult(_model_base.Model):
...
class FaceDetectionResult(_model_base.Model):
    ...
    face_landmarks: Optional["_models._models.FaceLandmarks"] = rest_field(name="faceLandmarks")
    ...
    face_attributes: Optional["_models._models.FaceAttributes"] = rest_field(name="faceAttributes")
    ...
    def __init__(
        ...
        *,
        ...
        face_landmarks: Optional["_models._models.FaceLandmarks"] = None,
        face_attributes: Optional["_models._models.FaceAttributes"] = None,
    ): ...
...
class FaceLandmarks(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    pupil_left: "_models._models.LandmarkCoordinate" = rest_field(name="pupilLeft")
    """The coordinates of the left eye pupil. Required."""
    pupil_right: "_models._models.LandmarkCoordinate" = rest_field(name="pupilRight")
    """The coordinates of the right eye pupil. Required."""
    nose_tip: "_models._models.LandmarkCoordinate" = rest_field(name="noseTip")
    """The coordinates of the nose tip. Required."""
    mouth_left: "_models._models.LandmarkCoordinate" = rest_field(name="mouthLeft")
    """The coordinates of the mouth left. Required."""
    mouth_right: "_models._models.LandmarkCoordinate" = rest_field(name="mouthRight")
    """The coordinates of the mouth right. Required."""
    eyebrow_left_outer: "_models._models.LandmarkCoordinate" = rest_field(name="eyebrowLeftOuter")
    """The coordinates of the left eyebrow outer. Required."""
    eyebrow_left_inner: "_models._models.LandmarkCoordinate" = rest_field(name="eyebrowLeftInner")
    """The coordinates of the left eyebrow inner. Required."""
    eye_left_outer: "_models._models.LandmarkCoordinate" = rest_field(name="eyeLeftOuter")
    """The coordinates of the left eye outer. Required."""
    eye_left_top: "_models._models.LandmarkCoordinate" = rest_field(name="eyeLeftTop")
    """The coordinates of the left eye top. Required."""
    eye_left_bottom: "_models._models.LandmarkCoordinate" = rest_field(name="eyeLeftBottom")
    """The coordinates of the left eye bottom. Required."""
    eye_left_inner: "_models._models.LandmarkCoordinate" = rest_field(name="eyeLeftInner")
    """The coordinates of the left eye inner. Required."""
    eyebrow_right_inner: "_models._models.LandmarkCoordinate" = rest_field(name="eyebrowRightInner")
    """The coordinates of the right eyebrow inner. Required."""
    eyebrow_right_outer: "_models._models.LandmarkCoordinate" = rest_field(name="eyebrowRightOuter")
    """The coordinates of the right eyebrow outer. Required."""
    eye_right_inner: "_models._models.LandmarkCoordinate" = rest_field(name="eyeRightInner")
    """The coordinates of the right eye inner. Required."""
    eye_right_top: "_models._models.LandmarkCoordinate" = rest_field(name="eyeRightTop")
    """The coordinates of the right eye top. Required."""
    eye_right_bottom: "_models._models.LandmarkCoordinate" = rest_field(name="eyeRightBottom")
    """The coordinates of the right eye bottom. Required."""
    eye_right_outer: "_models._models.LandmarkCoordinate" = rest_field(name="eyeRightOuter")
    """The coordinates of the right eye outer. Required."""
    nose_root_left: "_models._models.LandmarkCoordinate" = rest_field(name="noseRootLeft")
    """The coordinates of the nose root left. Required."""
    nose_root_right: "_models._models.LandmarkCoordinate" = rest_field(name="noseRootRight")
    """The coordinates of the nose root right. Required."""
    nose_left_alar_top: "_models._models.LandmarkCoordinate" = rest_field(name="noseLeftAlarTop")
    """The coordinates of the nose left alar top. Required."""
    nose_right_alar_top: "_models._models.LandmarkCoordinate" = rest_field(name="noseRightAlarTop")
    """The coordinates of the nose right alar top. Required."""
    nose_left_alar_out_tip: "_models._models.LandmarkCoordinate" = rest_field(name="noseLeftAlarOutTip")
    """The coordinates of the nose left alar out tip. Required."""
    nose_right_alar_out_tip: "_models._models.LandmarkCoordinate" = rest_field(name="noseRightAlarOutTip")
    """The coordinates of the nose right alar out tip. Required."""
    upper_lip_top: "_models._models.LandmarkCoordinate" = rest_field(name="upperLipTop")
    """The coordinates of the upper lip top. Required."""
    upper_lip_bottom: "_models._models.LandmarkCoordinate" = rest_field(name="upperLipBottom")
    """The coordinates of the upper lip bottom. Required."""
    under_lip_top: "_models._models.LandmarkCoordinate" = rest_field(name="underLipTop")
    """The coordinates of the under lip top. Required."""
    under_lip_bottom: "_models._models.LandmarkCoordinate" = rest_field(name="underLipBottom")
...
class FaceOperationResult(_model_base.Model):
...
class HairProperties(_model_base.Model):
    ...
    hair_color: List["_models._models.HairColor"] = rest_field(name="hairColor")
...
class LivenessSessionWithVerifyCreationResult(_model_base.Model):
...
class LivenessSessionWithVerifyImageCreationContent(_model_base.Model):  # pylint: disable=name-too-long
    ...
    parameters: "_models._models.LivenessSessionCreationContentForMultipart" = rest_field(name="Parameters")
