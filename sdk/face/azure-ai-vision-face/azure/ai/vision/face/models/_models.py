...
class AddFaceFromUrlContent(_model_base.Model):
    """Model for add face by url.

    All required parameters must be populated in order to send to server.

    :ivar url: URL of input image. Required.
    :vartype url: str
    """

    url: str = rest_field()
    """URL of input image. Required."""
...
class AddFaceResult(_model_base.Model):
    ...
    :ivar persisted_face_id: The persisted face id. Required.
    :vartype persisted_face_id: str
    """

    persisted_face_id: str = rest_field(name="persistedFaceId")
    """The persisted face id. Required."""
...
class CreateDynamicPersonGroupContent(_model_base.Model):
    """Request of create dynamic person group.
    ...
    :vartype name: str
    :ivar user_data: Optional user defined data. Length should not exceed 16KB.
    :vartype user_data: str
    :ivar add_person_ids: Array of personIds created by PersonDirectory Person - Create to add.
    :vartype add_person_ids: list[str]
    """
    ...
    add_person_ids: Optional[List[str]] = rest_field(name="addPersonIds")
...
class FaceDetectionResult(_model_base.Model):
    ...
    :ivar face_id: Unique faceId of the detected face, created by detection API and it will expire
     24 hours after the detection call. Required.
    :vartype face_id: str
    :ivar recognition_model: The 'recognitionModel' associated with this faceId. This is only
     returned when 'returnRecognitionModel' is explicitly set as true.
    :vartype recognition_model: str
    :ivar face_rectangle: A rectangle area for the face location on image.
    ...
    :ivar face_attributes: Face attributes fore detected face.
    ...
    recognition_model: Optional[str] = rest_field(name="recognitionModel")
    ...
    face_rectangle: Optional["_models.FaceRectangle"] = rest_field(name="faceRectangle")
    ...
    def __init__(
        ...
        *,
        ...
        face_rectangle: Optional["_models.FaceRectangle"] = None,
...
class FaceFindSimilarResult(_model_base.Model):
    ...
    :vartype confidence: float
    :ivar face_id: faceId of candidate face when find by faceIds.
    :vartype face_id: str
    :ivar persisted_face_id: PersistedFaceId of candidate face when find by faceListId.
    :vartype persisted_face_id: str
    """
...
class FaceIdentificationCandidate(_model_base.Model):
    ...
    :ivar person_id: PersonId of the candidate. Required.
    :vartype person_id: str
    :ivar confidence: Confidence value of the candidate. The higher confidence, the more similar.
     Range between [0,1]. Required.
    :vartype confidence: float
    ...
    person_id: str = rest_field(name="personId")
    """PersonId of the candidate. Required."""
    confidence: float = rest_field()
    """Confidence value of the candidate. The higher confidence, the more similar. Range between
     [0,1]. Required."""
...
class FaceIdentificationResult(_model_base.Model):
    ...
    :ivar face_id: Face ID of the query face. Required.
    :vartype face_id: str
    :ivar candidates: The top candidate returned from the database. Required.
    :vartype candidates: list[~azure.ai.vision.face.models.FaceIdentificationCandidate]
    """

    face_id: str = rest_field(name="faceId")
    """Face ID of the query face. Required."""
    candidates: List["_models.FaceIdentificationCandidate"] = rest_field()
    """The top candidate returned from the database. Required."""
...
class FaceLandmarks(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    """Coordinates within an image. Required."""
...
class FaceList(_model_base.Model):
    ...
    :ivar recognition_model: Name of recognition model. Recognition model is used when the face
     features are extracted and associated with detected faceIds. The default value is
     'recognition_01', if latest model needed, please explicitly specify the model you need. Known
     values are: "recognition_01", "recognition_02", "recognition_03", and "recognition_04".
    :vartype recognition_model: str or ~azure.ai.vision.face.models.RecognitionModel
    :ivar face_list_id: ID of the container. Required.
    ...
    user_data: Optional[str] = rest_field(name="userData")
    """Optional user defined data. Length should not exceed 16KB."""
    recognition_model: Optional[Union[str, "_models.RecognitionModel"]] = rest_field(
        name="recognitionModel", visibility=["read"]
    )
    """Name of recognition model. Recognition model is used when the face features are extracted and
     associated with detected faceIds. The default value is 'recognition_01', if latest model
     needed, please explicitly specify the model you need. Known values are: \"recognition_01\",
    ...
    persisted_faces: Optional[List["_models.FaceListFace"]] = rest_field(name="persistedFaces", visibility=["read"])
...
class FaceListFace(_model_base.Model):
    ...
    :vartype persisted_face_id: str
    :ivar user_data: User-provided data attached to the face. The size limit is 1KB.
    :vartype user_data: str
    """
...
class FaceOperationStatus(_model_base.Model):
    ...
    :ivar created_date_time: Date and time the operation was created. Required.
    :vartype created_date_time: ~datetime.datetime
    :ivar finished_date_time: Date and time the operation was finished.
    ...
    finished_date_time: Optional[datetime.datetime] = rest_field(name="finishedDateTime", format="rfc3339")
...
class FaceVerificationResult(_model_base.Model):
    ...
    :ivar confidence: Confidence score of whether the two faces belong to the same person or
     whether the face belongs to the person. The range is [0, 1]. Required.
    :vartype confidence: float
    """
    ...
    """True if the two faces belong to the same person or the face belongs to the person, otherwise
     false. Required."""
    confidence: float = rest_field()
    """Confidence score of whether the two faces belong to the same person or whether the face belongs
     to the person. The range is [0, 1]. Required."""
...
class LargeFaceList(_model_base.Model):
    ...
    :ivar recognition_model: Name of recognition model. Recognition model is used when the face
     ...
     values are: "recognition_01", "recognition_02", "recognition_03", and "recognition_04".
    :vartype recognition_model: str or ~azure.ai.vision.face.models.RecognitionModel
    :ivar large_face_list_id: ID of the container. Required.
...
class LargePersonGroupPerson(_model_base.Model):
    """The person in a specified large person group. To add face to this person, please call
    LargePersonGroup PersonFace - Add.
    ...
    user_data: Optional[str] = rest_field(name="userData")
    """Optional user defined data. Length should not exceed 16KB."""
    persisted_face_ids: Optional[List[str]] = rest_field(name="persistedFaceIds", visibility=["read"])
...
class LivenessSession(_model_base.Model):
    ...
    :ivar id: Unique ID to reference this session. Required.
    :vartype id: str
    :ivar created_date_time: Session creation time in millisecond from epoch. Required.
    :vartype created_date_time: ~datetime.datetime
    :ivar session_start_date_time: Session started time from session auth token.
    ...
    :ivar device_correlation_id: Device Correlation Id to use for linking multiple sessions
     together. Required.
    :vartype device_correlation_id: str
    :ivar auth_token_time_to_live_in_seconds: Session length in seconds. Range is 60 to 86400
     seconds.
    :vartype auth_token_time_to_live_in_seconds: int
    :ivar status: The session status. Required. Known values are: "NotStarted", "Started", and
     "ResultAvailable".
    :vartype status: str or ~azure.ai.vision.face.models.FaceSessionStatus
    :ivar result: The last result of session.
    ...
    """Session creation time in millisecond from epoch. Required."""
    session_start_date_time: Optional[datetime.datetime] = rest_field(
        name="sessionStartDateTime", visibility=["read"], format="rfc3339"
    )
    """Session started time from session auth token."""
    session_expired: bool = rest_field(name="sessionExpired", visibility=["read"])
    """Whether or not the session is expired. Required."""
    device_correlation_id: str = rest_field(name="deviceCorrelationId")
    """Device Correlation Id to use for linking multiple sessions together. Required."""
    ...
    status: Union[str, "_models.FaceSessionStatus"] = rest_field(visibility=["read"])
    """The session status. Required. Known values are: \"NotStarted\", \"Started\", and
     \"ResultAvailable\"."""
    result: Optional["_models.LivenessSessionAuditEntry"] = rest_field(visibility=["read"])
...
class LivenessSessionAuditEntry(_model_base.Model):
    ...
    :ivar id: ID of this audit entry. Required.
    :vartype id: int
    :ivar session_id: Session ID of this audit entry. Required.
    :vartype session_id: str
    :ivar request_id: Request ID in the request header. Required.
    :vartype request_id: str
    :ivar client_request_id: Client request ID in the request header. Required.
    :vartype client_request_id: str
    :ivar received_date_time: The UTC date time of the request. Required.
    :vartype received_date_time: ~datetime.datetime
    :ivar request: The request of this entry. Required.
    :vartype request: ~azure.ai.vision.face.models.SessionAuditEntryRequestInfo
    :ivar response: The response of this entry. Required.
    :vartype response: ~azure.ai.vision.face.models.SessionAuditEntryResponseInfo
    :ivar digest: The digest of the request body. Required.
    :vartype digest: str
    """

    id: int = rest_field()
    """ID of this audit entry. Required."""
    session_id: str = rest_field(name="sessionId")
    """Session ID of this audit entry. Required."""
    request_id: str = rest_field(name="requestId")
    """Request ID in the request header. Required."""
    client_request_id: str = rest_field(name="clientRequestId")
    """Client request ID in the request header. Required."""
    received_date_time: datetime.datetime = rest_field(name="receivedDateTime", format="rfc3339")
    """The UTC date time of the request. Required."""
    request: "_models.SessionAuditEntryRequestInfo" = rest_field()
    """The request of this entry. Required."""
    response: "_models.SessionAuditEntryResponseInfo" = rest_field()
    """The response of this entry. Required."""
    digest: str = rest_field()
    """The digest of the request body. Required."""
    ...
    def __init__(
        ...
        *,
        ...
        request: "_models.SessionAuditEntryRequestInfo",
        response: "_models.SessionAuditEntryResponseInfo",
        digest: str,
    ):
        ...
...
class LivenessSessionCreationContent(_model_base.Model):
    """Request for creating liveness session.

    All required parameters must be populated in order to send to server.

    :ivar liveness_operation_mode: The operation mode for the liveness modal. Required.
    :vartype liveness_operation_mode: str
    :ivar send_results_to_client: Whether or not send back the operation response to client.
    :vartype send_results_to_client: bool
    :ivar device_correlation_id_set_in_client: Whether or not the device correlation id is set by
     the client.
    ...
    liveness_operation_mode: str = rest_field(name="livenessOperationMode")
    """The operation mode for the liveness modal. Required."""
...
class LivenessSessionCreationContentForMultipart(_model_base.Model):  # pylint: disable=name-too-long
...
class LivenessSessionCreationResult(_model_base.Model):
    """Response of liveness session creation.

    All required parameters must be populated in order to send to server.

    :ivar session_id: Unique ID to reference this session. Required.
    :vartype session_id: str
    :ivar auth_token: Authorization token for use by the client application. Required.
    ...
    """Authorization token for use by the client application. Required."""
...
class LivenessSessionWithVerifyImageCreationContent(_model_base.Model):  # pylint: disable=name-too-long
    """Request of liveness with verify session creation.

    All required parameters must be populated in order to send to server.

    :ivar parameters: The parameters for creating session. Required.
    :vartype parameters: ~azure.ai.vision.face.models.LivenessSessionCreationContentForMultipart
    :ivar verify_image: The image stream for verify. Required.
    :vartype verify_image: bytes
    """

    parameters: "_models.LivenessSessionCreationContentForMultipart" = rest_field(name="Parameters")
    ...
    """The image stream for verify. Required."""

    @overload
    def __init__(
        self,
        *,
        parameters: "_models.LivenessSessionCreationContentForMultipart",
...
class MaskProperties(_model_base.Model):
    ...
    :ivar type: Mask type if any of the face. Required. Known values are: "faceMask", "noMask",
    ...
    """Mask type if any of the face. Required. Known values are: \"faceMask\", \"noMask\",
     \"otherMaskOrOcclusion\", and \"uncertain\"."""
...
class PersonGroup(_model_base.Model):
    """Free-tier subscription quota: 1,000 person groups. Each holds up to 1,000 persons. S0-tier
    subscription quota: 1,000,000 person groups. Each holds up to 10,000 persons. To handle larger
    scale face identification problem, please consider using LargePersonGroup.
...
class PersonGroupPerson(_model_base.Model):
    """The person in a specified person group. To add face to this person, please call
    LargePersonGroup PersonFace - Add.
...
class SessionAuditEntryRequestInfo(_model_base.Model):
    """Audit entry for a request in the session.

    All required parameters must be populated in order to send to server.

    :ivar url: The URL of the request. Required.
    :vartype url: str
    :ivar method: The HTTP method of the request. Required.
    :vartype method: str
    ...
    :ivar user_agent: The user agent of the request.
    ...
    """The HTTP method of the request. Required."""
...
class SessionAuditEntryResponseInfo(_model_base.Model):
    """Audit entry for a response in the session.

    All required parameters must be populated in order to send to server.

    :ivar body: The response body. Required.
    :vartype body: dict[str, any]
    :ivar status_code: The HTTP status code of the request. Required.
    :vartype status_code: int
    :ivar latency_in_milliseconds: The latency of the request. Required.
    :vartype latency_in_milliseconds: int
    """

    body: Dict[str, Any] = rest_field()
    """The response body. Required."""
    status_code: int = rest_field(name="statusCode")
    """The HTTP status code of the request. Required."""
    latency_in_milliseconds: int = rest_field(name="latencyInMilliseconds")
    """The latency of the request. Required."""
...
class TrainingStatus(_model_base.Model):
...
class UpdateDynamicPersonGroupContent(_model_base.Model):
    """Request of update dynamic person group.
    ...
    :ivar add_person_ids: Array of personIds created by PersonDirectory Person - Create to add.
    :vartype add_person_ids: list[str]
    :ivar remove_person_ids: Array of personIds created by PersonDirectory Person - Create to
     remove.
    :vartype remove_person_ids: list[str]
    """
    ...
    add_person_ids: Optional[List[str]] = rest_field(name="addPersonIds")
    """Array of personIds created by PersonDirectory Person - Create to add."""
    remove_person_ids: Optional[List[str]] = rest_field(name="removePersonIds")
