...
class PersonDirectoryOperations:  # pylint: disable=too-many-public-methods
    ...
    def _delete_person_initial(self, person_id: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def begin_delete_person(self, person_id: str, **kwargs: Any) -> LROPoller[None]:
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._delete_person_initial(
    ...
    def begin_delete_face(
        ...
        **kwargs: Any,
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._delete_face_initial(
                person_id=person_id,
                recognition_model=recognition_model,
                persisted_face_id=persisted_face_id,
                cls=lambda x, y, z: x,
    ...
    def _create_dynamic_person_group_with_person_initial(  # pylint: disable=name-too-long
        self,
    ...
    def begin_create_dynamic_person_group_with_person(  # pylint: disable=name-too-long
        ...
        **kwargs: Any,
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._create_dynamic_person_group_with_person_initial(
                dynamic_person_group_id=dynamic_person_group_id,
                body=body,
                name=name,
    ...
    def _delete_dynamic_person_group_initial(self, dynamic_person_group_id: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def begin_delete_dynamic_person_group(self, dynamic_person_group_id: str, **kwargs: Any) -> LROPoller[None]:
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._delete_dynamic_person_group_initial(
                dynamic_person_group_id=dynamic_person_group_id,
                cls=lambda x, y, z: x,
                headers=_headers,
                params=_params,
    ...
    def _update_dynamic_person_group_with_person_changes_initial(  # pylint: disable=name-too-long
        self,
        dynamic_person_group_id: str,
        body: Union[JSON, IO[bytes]] = _Unset,
        *,
    ...
    def begin_update_dynamic_person_group_with_person_changes(  # pylint: disable=name-too-long
        ...
        **kwargs: Any,
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._update_dynamic_person_group_with_person_changes_initial(
                dynamic_person_group_id=dynamic_person_group_id,
                body=body,
                name=name,
                user_data=user_data,
