...
from .operations import FaceClientOperationsMixin, LivenessSessionsOperations
...
class FaceClient(FaceClientOperationsMixin):  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype liveness_sessions: azure.ai.vision.face.operations.LivenessSessionsOperations
