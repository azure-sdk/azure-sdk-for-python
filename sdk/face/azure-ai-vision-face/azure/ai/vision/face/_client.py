...
class FaceServiceClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :ivar person_directory: PersonDirectoryOperations operations
    :vartype person_directory: azure.ai.vision.face.operations.PersonDirectoryOperations
    ...
    def __init__(self, endpoint: str, credential: Union[AzureKeyCredential, "TokenCredential"], **kwargs: Any) -> None:
        ...
        self.person_directory = PersonDirectoryOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
    ...
    def __enter__(self) -> "FaceServiceClient":
