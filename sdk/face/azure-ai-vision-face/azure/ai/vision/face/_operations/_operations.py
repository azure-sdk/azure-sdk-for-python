...
class FaceSessionClientOperationsMixin(FaceSessionClientMixinABC):
    ...
    @overload
    def _create_liveness_with_verify_session(  # pylint: disable=protected-access
        self,
        body: _models._models.CreateLivenessWithVerifySessionJsonContent,
        *,
        content_type: str = "application/json",
        **kwargs: Any,
    ...
    @distributed_trace
    def _create_liveness_with_verify_session(
        self, body: Union[_models._models.CreateLivenessWithVerifySessionJsonContent, JSON, IO[bytes]], **kwargs: Any
    ) -> _models.CreateLivenessWithVerifySessionResult:
        ...
        * A token lifetime of 10 minutes.
        ...
        :type body: ~azure.ai.vision.face.models._models.CreateLivenessWithVerifySessionJsonContent or
         JSON or IO[bytes]
