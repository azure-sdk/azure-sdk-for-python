...
def build_face_detect_from_url_request(
    ...
    **kwargs: Any,
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "v1.1-preview.1"))
...
class FaceClientOperationsMixin(FaceClientMixinABC):
    ...
    def detect_from_url(
        ...
        **kwargs: Any,
        ...
        We will also retire the Snapshot API, which allowed biometric data transfer from one Face
        subscription to another. Existing customers have until 30 June 2023 to use the emotion, gender,
        age, smile, facial hair, hair, and makeup attributes and the Snapshot API through Face API
        ...
        * Different 'detectionModel' values can be provided. To use and compare different detection
        ...
        https://learn.microsoft.com/en-us/azure/ai-services/computer-vision/how-to/specify-detection-model
          ...
          * 'detection_01': The default detection model for Face - Detect. Recommend for near frontal
        face detection. For scenarios with exceptionally large angle (head-pose) faces, occluded faces
        ...
        small, side and blurry faces. Face attributes and landmarks are disabled if you choose this
        detection model.
          * 'detection_03': Detection model released in 2021 February with improved accuracy especially
        on small faces. Face attributes (mask and headPose only) and landmarks are supported if you
        ...
        * Different 'recognitionModel' values are provided. If follow-up operations like Verify,
        ...
        https://learn.microsoft.com/en-us/azure/ai-services/computer-vision/how-to/specify-recognition-model.
          ...
          * 'recognition_01': The default recognition model for Face - Detect. All those faceIds
        created before 2019 March are bonded with this recognition model.
          ...
          * 'recognition_04': Recognition model released in 2021 February. 'recognition_04' is
        recommended since its accuracy is improved on faces wearing masks compared with
                ...
                response == [
                    {
                        "faceId": "str",  # Unique faceId of the detected face, created by
                          detection API and it will expire 24 hours after the detection call. To return
                          this, it requires 'returnFaceId' parameter to be true. Required.
                        "faceAttributes": {
                            "accessories": [
                                {
    ...
    def find_similar(
        ...
        The 'recognitionModel' associated with the query face's faceId should be the same as the
        ...
        Example:
            .. code-block:: python
                ...
                # JSON input template you can fill out and use as your body input.
                body = {
                    "faceId": "str",  # faceId of the query face. User needs to call Face -
                      Detect first to get a valid faceId. Note that this faceId is not persisted and
                      will expire 24 hours after the detection call. Required.
                    "faceIds": [
                ...
                response == [
                    {
                        ...
                        "faceId": "str",  # Optional. faceId of candidate face when find by
                          faceIds. faceId is created by Face - Detect and will expire 24 hours after
                          the detection call.
    ...
    def find_similar(
        ...
        **kwargs: Any,
        ...
        :keyword face_id: faceId of the query face. User needs to call Face - Detect first to get a
         valid faceId. Note that this faceId is not persisted and will expire 24 hours after the
         detection call. Required.
    ...
    def identify_from_person_group(
        ...
        face and all the faces in the person group (given by personGroupId) or large person group
        (given by largePersonGroupId), and return candidate person(s) for that face ranked by
        similarity confidence. The person group/large person group should be trained to make it ready
        for identification. See more in PersonGroup - Train and LargePersonGroup - Train.
        ...
        request, but no more than 10 faces.
           * Each person in the person group/large person group could have more than one face, but no
        more than 248 faces.
        ...
        array.
           * Try Face - Find Similar when you need to find similar faces from a face list/large face
            ...
            .. code-block:: python
                ...
                body = {
                    ...
                    "personGroupId": "str",  # personGroupId of the target person group, created
                      by PersonGroup - Create. Parameter personGroupId and largePersonGroupId should
    ...
    def identify_from_person_group(
        ...
        **kwargs: Any,
        ...
        :paramtype face_ids: list[str]
        :keyword person_group_id: personGroupId of the target person group, created by PersonGroup -
            ...
            .. code-block:: python
                ...
                body = {
                    ...
                    "largePersonGroupId": "str",  # largePersonGroupId of the target large person
                      group, created by LargePersonGroup - Create. Parameter personGroupId and
    ...
    def verify_face_to_face(
        ...
        Example:
            .. code-block:: python
                ...
                # JSON input template you can fill out and use as your body input.
                body = {
                    "faceId1": "str",  # faceId of one face, comes from Face - Detect. Required.
                    "faceId2": "str"  # faceId of another face, comes from Face - Detect.
                      Required.
                }
    ...
    def verify_face_to_face(
        ...
        :keyword face_id1: faceId of one face, comes from Face - Detect. Required.
        :paramtype face_id1: str
        :keyword face_id2: faceId of another face, comes from Face - Detect. Required.
            ...
            .. code-block:: python
                ...
                body = {
                    ...
                    "personGroupId": "str",  # Using existing personGroupId and personId for fast
                      loading a specified person. personGroupId is created in PersonGroup - Create.
                      Required.
    ...
    def verify_from_person_group(
        ...
        **kwargs: Any,
        ...
        :keyword person_group_id: Using existing personGroupId and personId for fast loading a
         specified person. personGroupId is created in PersonGroup - Create. Required.
        :paramtype person_group_id: str
    ...
    def verify_from_large_person_group(
        ...
        **kwargs: Any,
        ...
        :keyword large_person_group_id: Using existing largePersonGroupId and personId for fast loading
         a specified person. largePersonGroupId is created in LargePersonGroup - Create. Required.
        :paramtype large_person_group_id: str
...
class FaceAdministrationClientOperationsMixin(  # pylint: disable=too-many-public-methods
    ...
    def create_face_list(  # pylint: disable=inconsistent-return-statements
        ...
        After creation, user should use FaceList - Add Face to import the faces. No image will be
        stored. Only the extracted face feature(s) will be stored on server until FaceList - Delete is
        called.
        Find Similar is used for scenario like finding celebrity-like faces, similar face filtering, or
        as a light way face identification. But if the actual use is to identify person, please use
        PersonGroup / LargePersonGroup and Face - Identify.
        Please consider LargeFaceList when the face number is large. It can support up to 1,000,000
        faces.
    ...
    def add_face_list_face_from_url(
        ...
        **kwargs: Any,
        ...
        be stored. Only the extracted face feature(s) will be stored on server until FaceList - Delete
        ...
        * Different 'detectionModel' values can be provided. To use and compare different detection
        ...
        https://learn.microsoft.com/en-us/azure/ai-services/computer-vision/how-to/specify-detection-model
          ...
          * 'detection_01': The default detection model for PersonDirectory Person - Add Face.
        Recommend for near frontal face detection. For scenarios with exceptionally large angle
        (head-pose) faces, occluded faces or wrong image orientation, the faces in such cases may not
        be detected.
          * 'detection_02': Detection model released in 2019 May with improved accuracy especially on
        ...
        Example:
            .. code-block:: python
                ...
                # response body for status code(s): 200
                response == {
                    "persistedFaceId": "str"  # persistedFaceId of the added face, which is
    ...
    def get_large_face_lists(
        ...
        * "start" parameter (string, optional) is a id value that returned entries have larger ids by
        string comparison. "start" set to empty to indicate return from the first item.
        * "top" parameter (int, optional) specifies the number of entries to return. A maximal of 1000
        ...
        returned entry's personId of the current call.
    ...
    def get_large_face_list_training_status(
        self, large_face_list_id: str, **kwargs: Any
    ) -> _models.FaceCollectionTrainingStatus:
        # pylint: disable=line-too-long
        """To check the large face list training status completed or still ongoing. LargeFaceList Training
        ...
        :param large_face_list_id: Valid character is letter in lower case or digit or '-' or '_',
         maximum length is 64. Required.
        :type large_face_list_id: str
        :return: FaceCollectionTrainingStatus. The FaceCollectionTrainingStatus is compatible with
         MutableMapping
        :rtype: ~azure.ai.vision.face.models.FaceCollectionTrainingStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        cls: ClsType[_models.FaceCollectionTrainingStatus] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.FaceCollectionTrainingStatus, response.json())
    ...
    @distributed_trace
    def begin_train_large_face_list(
        self, large_face_list_id: str, **kwargs: Any
    ) -> LROPoller[_models.FaceCollectionTrainingStatus]:
        # pylint: disable=line-too-long
        ...
        :param large_face_list_id: Valid character is letter in lower case or digit or '-' or '_',
         maximum length is 64. Required.
        :type large_face_list_id: str
        :return: An instance of LROPoller that returns FaceCollectionTrainingStatus. The
         FaceCollectionTrainingStatus is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.LROPoller[~azure.ai.vision.face.models.FaceCollectionTrainingStatus]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return LROPoller[_models.FaceCollectionTrainingStatus].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.FaceCollectionTrainingStatus](
    ...
    def add_large_face_list_face_from_url(
        ...
        **kwargs: Any,
        ...
        To deal with an image containing multiple faces, input face can be specified as an image with a
        targetFace rectangle. It returns a persistedFaceId representing the added face. No image will
        be stored. Only the extracted face feature(s) will be stored on server until LargeFaceList -
        Delete Face or LargeFaceList - Delete is called.
        Note persistedFaceId is different from faceId generated by Face - Detect.
    ...
    def create_person_group(  # pylint: disable=inconsistent-return-statements
        ...
        features.
        After creation, use PersonGroup Person - Create to add persons into the group, and then call
        PersonGroup - Train to get this group ready for Face - Identify.
        No image will be stored. Only the person's extracted face feature(s) and userData will be
        stored on server until PersonGroup Person - Delete or PersonGroup - Delete is called.
    ...
    def get_person_group_training_status(
        ...
        # pylint: disable=line-too-long
        """To check person group training status completed or still ongoing. PersonGroup Training is an
        asynchronous operation triggered by PersonGroup - Train API.
    ...
    def begin_train_person_group(
        ...
        training status, please use PersonGroup - Get Training Status.
    ...
    def create_person_group_person(
        ...
        """Create a new person in a specified person group. To add face to this person, please call
        PersonGroup PersonFace - Add.
    ...
    def add_person_group_person_face_from_url(
        ...
        **kwargs: Any,
        ...
        To deal with an image containing multiple faces, input face can be specified as an image with a
        targetFace rectangle. It returns a persistedFaceId representing the added face. No image will
        be stored. Only the extracted face feature(s) will be stored on server until PersonGroup
        PersonFace - Delete, PersonGroup Person - Delete or PersonGroup - Delete is called.
        Note persistedFaceId is different from faceId generated by Face - Detect.
    ...
    def create_large_person_group(  # pylint: disable=inconsistent-return-statements
        ...
        After creation, use LargePersonGroup Person - Create to add person into the group, and call
        LargePersonGroup - Train to get this group ready for Face - Identify.
        No image will be stored. Only the person's extracted face feature(s) and userData will be
        stored on server until LargePersonGroup Person - Delete or LargePersonGroup - Delete is called.
    ...
    def get_large_person_group(
        ...
        Person - List instead to retrieve person information under the large person group.
    ...
    def get_large_person_group_training_status(
        ...
        # pylint: disable=line-too-long
        """To check large person group training status completed or still ongoing. LargePersonGroup
        Training is an asynchronous operation triggered by LargePersonGroup - Train API.
    ...
    def begin_train_large_person_group(
        ...
        person group can be used by Face - Identify.

        The training task is an asynchronous task. Training time depends on the number of person
        entries, and their faces in a large person group. It could be in several seconds, or up to half
        a hour for 1,000,000 persons. To check training completion, please use LargePersonGroup - Get
        Training Status.
    ...
    def get_large_person_group_persons(
        ...
        * Persons are stored in alphabetical order of personId created in LargePersonGroup Person -
        Create.
        * "start" parameter (string, optional) is a id value that returned entries have larger ids by
        string comparison. "start" set to empty to indicate return from the first item.
        * "top" parameter (int, optional) specifies the number of entries to return. A maximal of 1000
    ...
    def add_large_person_group_person_face_from_url(  # pylint: disable=name-too-long
        ...
        **kwargs: Any,
        ...
        To deal with an image containing multiple faces, input face can be specified as an image with a
        targetFace rectangle. It returns a persistedFaceId representing the added face. No image will
        be stored. Only the extracted face feature(s) will be stored on server until LargePersonGroup
        PersonFace - Delete, LargePersonGroup Person - Delete or LargePersonGroup - Delete is called.
        Note persistedFaceId is different from faceId generated by Face - Detect.
    ...
    def get_persons(
        ...
        * Persons are stored in alphabetical order of personId created in PersonDirectory Person -
        Create.
        * "start" parameter (string, optional) is a id value that returned entries have larger ids by
        string comparison. "start" set to empty to indicate return from the first item.
        * "top" parameter (int, optional) specifies the number of entries to return. A maximal of 1000
    ...
    def get_dynamic_person_group_references(
        ...
        * Dynamic person groups are stored in alphabetical order of dynamic person group id created in
        PersonDirectory DynamicPersonGroup - Create.
        * "start" parameter (string, optional) is a id value that returned entries have larger ids by
        string comparison. "start" set to empty to indicate return from the first item.
        * "top" parameter (int, optional) specifies the number of entries to return. A maximal of 1000
        entries can be returned in one call. To fetch more, you can specify "start" with the last
    ...
    @overload
    def _create_dynamic_person_group(  # pylint: disable=inconsistent-return-statements
    ...
    def _create_dynamic_person_group(  # pylint: disable=inconsistent-return-statements
        self,
        dynamic_person_group_id: str,
        resource: Union[JSON, IO[bytes]] = _Unset,
        *,
        name: str = _Unset,
        add_person_ids: Optional[List[str]] = None,
        user_data: Optional[str] = None,
        **kwargs: Any,
        ...
        dynamic person group. DynamicPersonGroup and UserData will be stored on server until
        PersonDirectory DynamicPersonGroup - Delete is called. Use Face - Identify with the
        ...
        :param resource: The resource instance. Is either a JSON type or a IO[bytes] type. Required.
        :type resource: JSON or IO[bytes]
        :keyword name: User defined name, maximum length is 128. Required.
        :paramtype name: str
        :keyword add_person_ids: Array of personIds created by PersonDirectory Person - Create to add.
         Default value is None.
        ...
        if resource is _Unset:
            if name is _Unset:
                raise TypeError("missing required argument: name")
            resource = {"addpersonids": add_person_ids, "name": name, "userdata": user_data}
    ...
    def get_dynamic_person_group(self, dynamic_person_group_id: str, **kwargs: Any) -> _models.DynamicPersonGroup:
        ...
        This API returns dynamic person group information only, use PersonDirectory DynamicPersonGroup
        - List Persons instead to retrieve person information under the dynamic person group.
    ...
    @overload
    def _update_dynamic_person_group(  # pylint: disable=inconsistent-return-statements
        self, dynamic_person_group_id: str, resource: JSON, *, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        ...
    ...
    def _update_dynamic_person_group(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any,
        ...
        :keyword add_person_ids: Array of personIds created by PersonDirectory Person - Create to add.
         Default value is None.
        :paramtype add_person_ids: list[str]
        :keyword remove_person_ids: Array of personIds created by PersonDirectory Person - Create to
...
class FaceSessionClientOperationsMixin(FaceSessionClientMixinABC):
                ...
                response == {
                    ...
                    "result": {
                        ...
                        "request": {
                            ...
                            "url": "str",  # The relative URL of the liveness request.
                              Required.
    ...
    def create_liveness_with_verify_session(
        ...
        * A token lifetime of 10 minutes.
        ...
        Session operation. To retrieve a result, use the Get Liveness With Verify Session. To audit the
        individual requests that a client has made to your resource, use the List Liveness With Verify
                ...
                body = {
                    "Parameters": {
                        ...
                        "livenessOperationMode": "str",  # The operation mode for the
                          liveness modal. Required. "Passive"
                        "authTokenTimeToLiveInSeconds": 0,  # Optional. Session length in
                          seconds. Range is 60 to 86400 seconds.
