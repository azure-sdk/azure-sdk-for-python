...
class FaceClientOperationsMixin(FaceClientMixinABC):
    ...
    def _detect_from_url(
        ...
        * Different 'recognitionModel' values are provided. If follow-up operations like "Verify",
        ...
        :keyword face_id_time_to_live: The number of sasdaeconds for the face ID being cached.
         Supported range from 60 seconds up to 86400 seconds. The default value is 86400 (24 hours).
         Default value is None.
