...
class FaceClientOperationsMixin(ClientMixinABC[AsyncPipelineClient, FaceClientConfiguration]):
...
class FaceSessionClientOperationsMixin(ClientMixinABC[AsyncPipelineClient, FaceSessionClientConfiguration]):
