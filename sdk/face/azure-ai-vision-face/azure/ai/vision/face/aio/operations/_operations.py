...
from ...operations._operations import (
    ...
    build_person_directory_add_face_from_url_request,
    build_person_directory_add_face_request,
    build_person_directory_create_dynamic_person_group_request,
    build_person_directory_create_dynamic_person_group_with_person_request,
    build_person_directory_create_person_request,
    build_person_directory_delete_dynamic_person_group_request,
    build_person_directory_delete_face_request,
    build_person_directory_delete_person_request,
    build_person_directory_get_dynamic_person_group_persons_request,
    build_person_directory_get_dynamic_person_group_references_request,
    build_person_directory_get_dynamic_person_group_request,
    build_person_directory_get_dynamic_person_groups_request,
    build_person_directory_get_face_request,
    build_person_directory_get_faces_request,
    build_person_directory_get_person_request,
    build_person_directory_get_persons_request,
    build_person_directory_update_dynamic_person_group_request,
    build_person_directory_update_dynamic_person_group_with_person_changes_request,
    build_person_directory_update_face_request,
    build_person_directory_update_person_request,
...
class PersonDirectoryOperations:  # pylint: disable=too-many-public-methods
    ...
    async def begin_add_face(
        ...
        * This is a long running operation. Use Response Header "Operation-Location" to determine when
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._add_face_initial(
                person_id=person_id,
                recognition_model=recognition_model,
