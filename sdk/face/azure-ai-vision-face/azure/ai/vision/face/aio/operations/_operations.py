...
class PersonDirectoryOperations:  # pylint: disable=too-many-public-methods
    ...
    async def _delete_person_initial(self, person_id: str, **kwargs: Any) -> AsyncIterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    async def begin_delete_person(self, person_id: str, **kwargs: Any) -> AsyncLROPoller[None]:
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._delete_person_initial(
    ...
    async def _delete_face_initial(
        self,
        person_id: str,
        recognition_model: Union[str, _models.FaceRecognitionModel],
        persisted_face_id: str,
    ...
    async def begin_delete_face(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._delete_face_initial(
                person_id=person_id,
                recognition_model=recognition_model,
                persisted_face_id=persisted_face_id,
                cls=lambda x, y, z: x,
    ...
    async def _create_dynamic_person_group_with_person_initial(  # pylint: disable=name-too-long
        self,
    ...
    async def begin_create_dynamic_person_group_with_person(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._create_dynamic_person_group_with_person_initial(
                dynamic_person_group_id=dynamic_person_group_id,
                body=body,
                name=name,
    ...
    async def _delete_dynamic_person_group_initial(
    ...
    async def begin_delete_dynamic_person_group(
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._delete_dynamic_person_group_initial(
                dynamic_person_group_id=dynamic_person_group_id,
                cls=lambda x, y, z: x,
                headers=_headers,
                params=_params,
    ...
    async def _update_dynamic_person_group_with_person_changes_initial(  # pylint: disable=name-too-long
        self,
        dynamic_person_group_id: str,
        body: Union[JSON, IO[bytes]] = _Unset,
        *,
    ...
    async def begin_update_dynamic_person_group_with_person_changes(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._update_dynamic_person_group_with_person_changes_initial(
                dynamic_person_group_id=dynamic_person_group_id,
                body=body,
                name=name,
                user_data=user_data,
