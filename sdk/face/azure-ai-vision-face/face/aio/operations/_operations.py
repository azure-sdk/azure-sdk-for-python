...
from ...operations._operations import (
    ...
    build_large_face_list_add_face_from_url_request,
    build_large_face_list_add_face_request,
    build_large_face_list_create_request,
    build_large_face_list_delete_face_request,
    build_large_face_list_delete_request,
    build_large_face_list_get_face_request,
    build_large_face_list_get_faces_request,
    build_large_face_list_get_large_face_lists_request,
    build_large_face_list_get_request,
    build_large_face_list_get_training_status_request,
    build_large_face_list_train_request,
    build_large_face_list_update_face_request,
    build_large_face_list_update_request,
    build_large_person_group_add_face_from_url_request,
    build_large_person_group_add_face_request,
    build_large_person_group_create_person_request,
    build_large_person_group_create_request,
    build_large_person_group_delete_face_request,
    build_large_person_group_delete_person_request,
    build_large_person_group_delete_request,
    ...
    build_large_person_group_get_persons_request,
    build_large_person_group_get_request,
    build_large_person_group_get_training_status_request,
    build_large_person_group_train_request,
    build_large_person_group_update_face_request,
...
class FaceClientOperationsMixin(FaceClientMixinABC):
    ...
    async def _detect_from_url(
        ...
        **kwargs: Any
        ...
        :paramtype detection_model: str or ~face.models.FaceDetectionModel
        ...
        :paramtype recognition_model: str or ~face.models.FaceRecognitionModel
        ...
        :paramtype return_face_attributes: list[str or ~face.models.FaceAttributeType]
        ...
        :rtype: list[~face.models.FaceDetectionResult]
    ...
    async def find_similar(
        ...
        **kwargs: Any
        ...
        :paramtype mode: str or ~face.models.FindSimilarMatchMode
        :return: list of FaceFindSimilarResult
        :rtype: list[~face.models.FaceFindSimilarResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def verify_face_to_face(
        ...
        :rtype: ~face.models.FaceVerificationResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def group(
        ...
        :rtype: ~face.models.FaceGroupingResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def identify_from_large_person_group(
        ...
        **kwargs: Any
        ...
        :rtype: list[~face.models.FaceIdentificationResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
...
class FaceSessionClientOperationsMixin(FaceSessionClientMixinABC):
    ...
    async def create_liveness_session(
        ...
        :type body: ~face.models.CreateLivenessSessionContent
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: LivenessSession. The LivenessSession is compatible with MutableMapping
        :rtype: ~face.models.LivenessSession
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def create_liveness_session(
        ...
        :param body: Body parameter. Is one of the following types: CreateLivenessSessionContent, JSON,
         IO[bytes] Required.
        :type body: ~face.models.CreateLivenessSessionContent or JSON or IO[bytes]
        :return: LivenessSession. The LivenessSession is compatible with MutableMapping
        :rtype: ~face.models.LivenessSession
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def create_liveness_with_verify_session(
        ...
        :type body: ~face.models.CreateLivenessWithVerifySessionContent
        :return: LivenessWithVerifySession. The LivenessWithVerifySession is compatible with
         MutableMapping
        :rtype: ~face.models.LivenessWithVerifySession
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def create_liveness_with_verify_session(
        ...
        :type body: ~face.models.CreateLivenessWithVerifySessionContent or JSON
        :return: LivenessWithVerifySession. The LivenessWithVerifySession is compatible with
         MutableMapping
        :rtype: ~face.models.LivenessWithVerifySession
        :raises ~azure.core.exceptions.HttpResponseError:
...
class LargeFaceListOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~face.aio.FaceAdministrationClient`'s
    ...
    async def get(
        ...
        :rtype: ~face.models.LargeFaceList
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_large_face_lists(
        ...
        **kwargs: Any
        ...
        :rtype: list[~face.models.LargeFaceList]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_training_status(self, large_face_list_id: str, **kwargs: Any) -> _models.FaceTrainingResult:
        ...
        :rtype: ~face.models.FaceTrainingResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def add_face_from_url(
        ...
        **kwargs: Any
        ...
        :rtype: ~face.models.AddFaceResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get_face(
        ...
        :rtype: ~face.models.LargeFaceListFace
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_faces(
        ...
        :rtype: list[~face.models.LargeFaceListFace]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
...
class LargePersonGroupOperations:
    ...
    async def get(
        ...
        :rtype: ~face.models.LargePersonGroup
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_large_person_groups(
        ...
        **kwargs: Any
        ...
        :rtype: list[~face.models.LargePersonGroup]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def create_person(
        ...
        **kwargs: Any
        ...
        :rtype: ~face.models.CreatePersonResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get_person(
        ...
        :rtype: ~face.models.LargePersonGroupPerson
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_persons(
        ...
        :rtype: list[~face.models.LargePersonGroupPerson]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_face(
        ...
        :return: LargePersonGroupPersonFace. The LargePersonGroupPersonFace is compatible with
         MutableMapping
        :rtype: ~face.models.LargePersonGroupPersonFace
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
