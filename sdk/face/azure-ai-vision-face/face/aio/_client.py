...
class FaceClient(FaceClientOperationsMixin):
    ...
    :paramtype api_version: str or ~face.models.Versions
    """
...
class FaceAdministrationClient:
    ...
    :vartype large_face_list: face.aio.operations.LargeFaceListOperations
    :ivar large_person_group: LargePersonGroupOperations operations
    :vartype large_person_group: face.aio.operations.LargePersonGroupOperations
    :param endpoint: Supported Cognitive Services endpoints (protocol and hostname, for example:
     https://{resource-name}.cognitiveservices.azure.com). Required.
    :type endpoint: str
    :param credential: Credential used to authenticate requests to the service. Is either a key
