...
# --------------------------------------------------------------------------
from azure.ai.vision.face import FaceClient, FaceServiceClient, FaceSessionClient
from devtools_testutils import AzureRecordedTestCase, PowerShellPreparer
import functools


class FaceServiceClientTestBase(AzureRecordedTestCase):

    def create_client(self, endpoint):
        credential = self.get_credential(FaceServiceClient)
...
FaceServicePreparer = functools.partial(
    PowerShellPreparer, "faceservice", faceservice_endpoint="https://fake_faceservice_endpoint.com"
)
