...
class TestFaceServiceLargeFaceListOperations(FaceServiceClientTestBase):
    @FaceServicePreparer()
    @recorded_by_proxy
    ...
    @FaceServicePreparer()
    @recorded_by_proxy
    def test_get_large_face_lists(self, faceservice_endpoint):
        client = self.create_client(endpoint=faceservice_endpoint)
    ...
    @FaceServicePreparer()
    @recorded_by_proxy
    def test_get_faces(self, faceservice_endpoint):
        client = self.create_client(endpoint=faceservice_endpoint)
