...
class TestFaceAsync(FaceClientTestBaseAsync):
    ...
    @FacePreparer()
    @recorded_by_proxy_async
    async def test_find_similar_from_face_list(self, face_endpoint):
        client = self.create_async_client(endpoint=face_endpoint)
        response = await client.find_similar_from_face_list(
    ...
    @FacePreparer()
    @recorded_by_proxy_async
    async def test_identify_from_person_group(self, face_endpoint):
        client = self.create_async_client(endpoint=face_endpoint)
        response = await client.identify_from_person_group(
            body={
                "faceIds": ["str"],
                "personGroupId": "str",
    ...
    @FacePreparer()
    @recorded_by_proxy_async
    async def test_verify_from_person_group(self, face_endpoint):
        client = self.create_async_client(endpoint=face_endpoint)
        response = await client.verify_from_person_group(
