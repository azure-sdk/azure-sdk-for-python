...
class TestAVSPlacementPoliciesOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_placement_policies_update(self, resource_group):
        response = await self.client.placement_policies.update(
            resource_group_name=resource_group.name,
            private_cloud_name="str",
            cluster_name="str",
            placement_policy_name="str",
