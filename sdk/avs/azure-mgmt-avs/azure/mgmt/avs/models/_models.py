...
class AddonVrProperties(AddonProperties, discriminator="VR"):
    ...
    :ivar replication_network: VR replicationNetwork network.
    :vartype replication_network: str
    """
    ...
    """The type of private cloud addon. Required."""
    replication_network: Optional[str] = rest_field(
        name="replicationNetwork", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        ...
        *,
        vrs_count: int,
        replication_network: Optional[str] = None,
    ) -> None: ...
...
class RescheduleOperationConstraint(_model_base.Model):
...
class ScheduleOperationConstraint(_model_base.Model):
...
class AvailableWindowForMaintenanceWhileScheduleOperation(
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(
            *args,
            kind=ScheduleOperationConstraintKind.AVAILABLE_WINDOW_FOR_MAINTENANCE_WHILE_SCHEDULE_OPERATION,
            **kwargs,
        )


class BlockedDatesConstraintTimeRange(_model_base.Model):
...
class RescheduleConstraint(_model_base.Model):
    """Constraint for rescheduling maintenance.

    You probably want to use the sub-classes and not this class directly. Known sub-classes are:
    BlockedRescheduleConstraint, DeadlineRescheduleConstraint, FreezeDaysRescheduleConstraint

    Readonly variables are only populated by the server, and will be ignored when sending a request.


    :ivar kind: The kind of constraint. Required. Known values are: "Deadline", "FreezeDays", and
     "Blocked".
    :vartype kind: str or ~azure.mgmt.avs.models.RescheduleConstraintKind
    """

    __mapping__: Dict[str, _model_base.Model] = {}
    kind: str = rest_discriminator(name="kind", visibility=["read"])
    """The kind of constraint. Required. Known values are: \"Deadline\", \"FreezeDays\", and
     \"Blocked\"."""
...
class BlockedRescheduleConstraint(RescheduleConstraint, discriminator="Blocked"):
    ...
    :vartype kind: str or ~azure.mgmt.avs.models.BLOCKED
    :ivar category: Start date time. Required. Known values are: "HiPriorityEvent",
     "QuotaExhausted", and "Holiday".
    :vartype category: str or ~azure.mgmt.avs.models.BlockedDatesConstraintCategory
    :ivar time_ranges: Date ranges blocked for reschedule.
    :vartype time_ranges: list[~azure.mgmt.avs.models.BlockedRescheduleConstraintTimeRange]
    """

    kind: Literal[RescheduleConstraintKind.BLOCKED] = rest_discriminator(name="kind", visibility=["read", "create", "update", "delete", "query"])  # type: ignore
    ...
    """Start date time. Required. Known values are: \"HiPriorityEvent\", \"QuotaExhausted\", and
     \"Holiday\"."""
    time_ranges: Optional[List["_models.BlockedRescheduleConstraintTimeRange"]] = rest_field(
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, kind=RescheduleConstraintKind.BLOCKED, **kwargs)


class BlockedRescheduleConstraintTimeRange(_model_base.Model):
    """Blocked Time range Constraints for maintenance.

    Readonly variables are only populated by the server, and will be ignored when sending a request.


    :ivar start_at: Start date time. Required.
    :vartype start_at: ~datetime.datetime
    :ivar end_at: End date Time. Required.
    :vartype end_at: ~datetime.datetime
    :ivar reason: Reason category for blocking maintenance reschedule.
    :vartype reason: str
    """

    start_at: datetime.datetime = rest_field(name="startAt", visibility=["read"], format="rfc3339")
    """Start date time. Required."""
    end_at: datetime.datetime = rest_field(name="endAt", visibility=["read"], format="rfc3339")
    """End date Time. Required."""
    reason: Optional[str] = rest_field(visibility=["read"])
    """Reason category for blocking maintenance reschedule."""
...
class BlockedWhileRescheduleOperation(RescheduleOperationConstraint, discriminator="Blocked"):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, kind=RescheduleOperationConstraintKind.BLOCKED_WHILE_RESCHEDULE_OPERATION, **kwargs)
...
class BlockedWhileScheduleOperation(ScheduleOperationConstraint, discriminator="Blocked"):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, kind=ScheduleOperationConstraintKind.BLOCKED_WHILE_SCHEDULE_OPERATION, **kwargs)
...
class DeadlineRescheduleConstraint(RescheduleConstraint, discriminator="Deadline"):
    """The deadline constraint for rescheduling maintenance.

    Readonly variables are only populated by the server, and will be ignored when sending a request.


    :ivar kind: The kind of constraint. Required. Deadline constraint
    :vartype kind: str or ~azure.mgmt.avs.models.DEADLINE
    :ivar deadline: The deadline. Required.
    :vartype deadline: ~datetime.datetime
    """

    kind: Literal[RescheduleConstraintKind.DEADLINE] = rest_discriminator(name="kind", visibility=["read", "create", "update", "delete", "query"])  # type: ignore
    """The kind of constraint. Required. Deadline constraint"""
    deadline: datetime.datetime = rest_field(visibility=["read"], format="rfc3339")
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, kind=RescheduleConstraintKind.DEADLINE, **kwargs)
...
class FreezeDaysRescheduleConstraint(RescheduleConstraint, discriminator="FreezeDays"):
    """The deadline constraint for rescheduling maintenance.

    Readonly variables are only populated by the server, and will be ignored when sending a request.


    :ivar kind: The kind of constraint. Required. Freeze days constraint
    :vartype kind: str or ~azure.mgmt.avs.models.FREEZE_DAYS
    :ivar freeze_days: Freeze days. Required.
    :vartype freeze_days: list[~datetime.date]
    """

    kind: Literal[RescheduleConstraintKind.FREEZE_DAYS] = rest_discriminator(name="kind", visibility=["read", "create", "update", "delete", "query"])  # type: ignore
    """The kind of constraint. Required. Freeze days constraint"""
    freeze_days: List[datetime.date] = rest_field(name="freezeDays", visibility=["read"])
    """Freeze days. Required."""
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, kind=RescheduleConstraintKind.FREEZE_DAYS, **kwargs)


class HostProperties(_model_base.Model):
...
class GeneralHostProperties(HostProperties, discriminator="General"):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, kind=HostKind.GENERAL, **kwargs)
...
class ImpactedMaintenanceResource(_model_base.Model):
...
class ImpactedMaintenanceResourceError(_model_base.Model):
...
class MaintenanceFailedCheck(_model_base.Model):
...
class MaintenanceManagementOperation(_model_base.Model):
...
class MaintenanceProperties(_model_base.Model):
    ...
    :ivar reschedule: Constraints for rescheduling maintenance.
    :vartype reschedule: ~azure.mgmt.avs.models.Reschedule
    ...
    """The provisioning state. Known values are: \"Succeeded\", \"Failed\", \"Canceled\", and
     \"Updating\"."""
    reschedule: Optional["_models.Reschedule"] = rest_field(visibility=["read"])
...
class MaintenanceReadiness(_model_base.Model):
...
class MaintenanceReadinessRefreshOperation(MaintenanceManagementOperation, discriminator="MaintenanceReadinessRefresh"):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, kind=MaintenanceManagementOperationKind.MAINTENANCE_READINESS_REFRESH, **kwargs)


class MaintenanceReschedule(_model_base.Model):
...
class MaintenanceSchedule(_model_base.Model):
...
class MaintenanceState(_model_base.Model):
    ...
    """Customer presentable maintenance state. Known values are: \"NotScheduled\", \"Planned\",
...
class PlacementPolicyProperties(_model_base.Model):
    ...
    You probably want to use the sub-classes and not this class directly. Known sub-classes are:
    VmHostPlacementPolicyProperties, VmVmPlacementPolicyProperties
...
class ProvisionedNetworkProperties(_model_base.Model):
...
class PureStoragePolicyProperties(_model_base.Model):
...
class PureStorageVolume(_model_base.Model):
...
class Reschedule(_model_base.Model):
    """Constraints for rescheduling maintenance.
    ...
    :vartype constraints: list[~azure.mgmt.avs.models.RescheduleConstraint]
    """
    ...
    constraints: Optional[List["_models.RescheduleConstraint"]] = rest_field(visibility=["read"])
    """Constraints for rescheduling maintenance."""
...
class RescheduleOperation(MaintenanceManagementOperation, discriminator="Reschedule"):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, kind=MaintenanceManagementOperationKind.RESCHEDULE, **kwargs)
...
class ScheduleOperation(MaintenanceManagementOperation, discriminator="Schedule"):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, kind=MaintenanceManagementOperationKind.SCHEDULE, **kwargs)
...
class SchedulingWindow(ScheduleOperationConstraint, discriminator="SchedulingWindow"):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, kind=ScheduleOperationConstraintKind.SCHEDULING_WINDOW, **kwargs)
...
class SpecializedHostProperties(HostProperties, discriminator="Specialized"):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, kind=HostKind.SPECIALIZED, **kwargs)
...
class VmVmPlacementPolicyProperties(PlacementPolicyProperties, discriminator="VmVm"):
