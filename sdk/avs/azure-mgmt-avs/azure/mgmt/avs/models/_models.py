...
from ._enums import AddonType, DhcpTypeEnum, PlacementPolicyType, ScriptExecutionParameterType
...
class Addon(ProxyResource):
    ...
    properties: Optional["_models.AddonProperties"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""

    __flattened_items = ["addon_type", "provisioning_state"]
...
class AddonProperties(_model_base.Model):
    ...
    addon_type: str = rest_discriminator(name="addonType")
...
class AddonArcProperties(AddonProperties, discriminator="Arc"):
    ...
    v_center: Optional[str] = rest_field(name="vCenter")
    """The VMware vCenter resource ID."""
    addon_type: Literal[AddonType.ARC] = rest_discriminator(name="addonType")  # type: ignore
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:  # pylint: disable=useless-super-delegation
        super().__init__(*args, addon_type=AddonType.ARC, **kwargs)
...
class AddonHcxProperties(AddonProperties, discriminator="HCX"):
    ...
    addon_type: Literal[AddonType.HCX] = rest_discriminator(name="addonType")  # type: ignore
    """The type of private cloud addon. Required."""
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:  # pylint: disable=useless-super-delegation
        super().__init__(*args, addon_type=AddonType.HCX, **kwargs)
...
class AddonSrmProperties(AddonProperties, discriminator="SRM"):
    ...
    license_key: Optional[str] = rest_field(name="licenseKey")
    """The Site Recovery Manager (SRM) license."""
    addon_type: Literal[AddonType.SRM] = rest_discriminator(name="addonType")  # type: ignore
    """The type of private cloud addon. Required."""
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:  # pylint: disable=useless-super-delegation
        super().__init__(*args, addon_type=AddonType.SRM, **kwargs)
...
class AddonVrProperties(AddonProperties, discriminator="VR"):
    ...
    vrs_count: int = rest_field(name="vrsCount")
    """The vSphere Replication Server (VRS) count. Required."""
    addon_type: Literal[AddonType.VR] = rest_discriminator(name="addonType")  # type: ignore
    """The type of private cloud addon. Required."""
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:  # pylint: disable=useless-super-delegation
        super().__init__(*args, addon_type=AddonType.VR, **kwargs)


class AdminCredentials(_model_base.Model):
...
class AvailabilityProperties(_model_base.Model):
    ...
    secondary_zone: Optional[int] = rest_field(name="secondaryZone")
...
class Circuit(_model_base.Model):
...
class CloudLink(ProxyResource):
    ...
    properties: Optional["_models.CloudLinkProperties"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""
...
class CloudLinkProperties(_model_base.Model):
    ...
    """The state of the cloud link. Known values are: \"Active\", \"Building\", \"Deleting\",
     \"Failed\", and \"Disconnected\"."""
    linked_cloud: Optional[str] = rest_field(name="linkedCloud")
...
class Cluster(ProxyResource):
    ...
    properties: Optional["_models.ClusterProperties"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""
...
class ClusterProperties(_model_base.Model):
    ...
    cluster_size: Optional[int] = rest_field(name="clusterSize")
    """The cluster size."""
    ...
    """The identity."""
    hosts: Optional[List[str]] = rest_field()
    """The hosts."""
    vsan_datastore_name: Optional[str] = rest_field(name="vsanDatastoreName")
...
class ClusterUpdate(_model_base.Model):
...
class ClusterUpdateProperties(_model_base.Model):
...
class ClusterZone(_model_base.Model):
...
class ClusterZoneList(_model_base.Model):
...
class Datastore(ProxyResource):
    ...
    properties: Optional["_models.DatastoreProperties"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""

    __flattened_items = ["provisioning_state", "net_app_volume", "disk_pool_volume", "elastic_san_volume", "status"]
...
class DatastoreProperties(_model_base.Model):
    ...
    net_app_volume: Optional["_models.NetAppVolume"] = rest_field(name="netAppVolume")
    """An Azure NetApp Files volume."""
    disk_pool_volume: Optional["_models.DiskPoolVolume"] = rest_field(name="diskPoolVolume")
    """An iSCSI volume."""
    elastic_san_volume: Optional["_models.ElasticSanVolume"] = rest_field(name="elasticSanVolume")
...
class DiskPoolVolume(_model_base.Model):
    ...
    lun_name: str = rest_field(name="lunName")
    """Name of the LUN to be used for datastore. Required."""
    mount_option: Optional[Union[str, "_models.MountOptionEnum"]] = rest_field(name="mountOption")
...
class ElasticSanVolume(_model_base.Model):
...
class Encryption(_model_base.Model):
    ...
    key_vault_properties: Optional["_models.EncryptionKeyVaultProperties"] = rest_field(name="keyVaultProperties")
...
class EncryptionKeyVaultProperties(_model_base.Model):
    """An Encryption Key.
    ...
    key_name: Optional[str] = rest_field(name="keyName")
    """The name of the key."""
    key_version: Optional[str] = rest_field(name="keyVersion")
    """The version of the key."""
    auto_detected_key_version: Optional[str] = rest_field(name="autoDetectedKeyVersion", visibility=["read"])
    """The auto-detected version of the key if versionType is auto-detected."""
    key_vault_url: Optional[str] = rest_field(name="keyVaultUrl")
...
class Endpoints(_model_base.Model):
    """Endpoint addresses.
...
class ExpressRouteAuthorization(ProxyResource):
    ...
    properties: Optional["_models.ExpressRouteAuthorizationProperties"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""
...
class ExpressRouteAuthorizationProperties(_model_base.Model):
    ...
    express_route_id: Optional[str] = rest_field(name="expressRouteId")
...
class GlobalReachConnection(ProxyResource):
    ...
    properties: Optional["_models.GlobalReachConnectionProperties"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""
...
class GlobalReachConnectionProperties(_model_base.Model):
    ...
    """The network used for global reach carved out from the original network block
     provided for the private cloud."""
    authorization_key: Optional[str] = rest_field(name="authorizationKey")
    ...
    peer_express_route_circuit: Optional[str] = rest_field(name="peerExpressRouteCircuit")
...
class HcxEnterpriseSite(ProxyResource):
    ...
    properties: Optional["_models.HcxEnterpriseSiteProperties"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""
...
class HcxEnterpriseSiteProperties(_model_base.Model):
...
class IdentitySource(_model_base.Model):
    ...
    :vartype domain: str
    :ivar base_user_d_n: The base distinguished name for users.
    :vartype base_user_d_n: str
    :ivar base_group_d_n: The base distinguished name for groups.
    :vartype base_group_d_n: str
    ...
    alias: Optional[str] = rest_field()
    """The domain's NetBIOS name."""
    domain: Optional[str] = rest_field()
    """The domain's dns name."""
    base_user_d_n: Optional[str] = rest_field(name="baseUserDN")
    """The base distinguished name for users."""
    base_group_d_n: Optional[str] = rest_field(name="baseGroupDN")
    """The base distinguished name for groups."""
    primary_server: Optional[str] = rest_field(name="primaryServer")
    """Primary server URL."""
    secondary_server: Optional[str] = rest_field(name="secondaryServer")
    ...
    def __init__(
        ...
        *,
        ...
        base_user_d_n: Optional[str] = None,
        base_group_d_n: Optional[str] = None,
...
class IscsiPath(ProxyResource):
    ...
    properties: Optional["_models.IscsiPathProperties"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""
...
class IscsiPathProperties(_model_base.Model):
...
class ManagementCluster(_model_base.Model):
...
class NetAppVolume(_model_base.Model):
...
class PlacementPolicy(ProxyResource):
    ...
    properties: Optional["_models.PlacementPolicyProperties"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""

    __flattened_items = ["type", "state", "display_name", "provisioning_state"]
...
class PlacementPolicyProperties(_model_base.Model):
...
class PlacementPolicyUpdate(_model_base.Model):
...
class PlacementPolicyUpdateProperties(_model_base.Model):
    """The properties of a placement policy resource that may be updated.
    ...
    """Whether the placement policy is enabled or disabled. Known values are: \"Enabled\" and
     \"Disabled\"."""
    vm_members: Optional[List[str]] = rest_field(name="vmMembers")
    """Virtual machine members list."""
    host_members: Optional[List[str]] = rest_field(name="hostMembers")
    """Host members list."""
    affinity_strength: Optional[Union[str, "_models.AffinityStrength"]] = rest_field(name="affinityStrength")
...
class PrivateCloud(TrackedResource):
    ...
    properties: Optional["_models.PrivateCloudProperties"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""
    sku: "_models.Sku" = rest_field()
    """The SKU (Stock Keeping Unit) assigned to this resource. Required."""
...
class PrivateCloudIdentity(_model_base.Model):
...
class PrivateCloudProperties(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    management_cluster: "_models.ManagementCluster" = rest_field(name="managementCluster")
    ...
    """Connectivity to internet is enabled or disabled. Known values are: \"Enabled\" and
     \"Disabled\"."""
    identity_sources: Optional[List["_models.IdentitySource"]] = rest_field(name="identitySources")
    """vCenter Single Sign On Identity Sources."""
    availability: Optional["_models.AvailabilityProperties"] = rest_field(visibility=["read", "create"])
    """Properties describing how the cloud is distributed across availability zones."""
    encryption: Optional["_models.Encryption"] = rest_field()
    """Customer managed key encryption, can be enabled or disabled."""
    extended_network_blocks: Optional[List[str]] = rest_field(name="extendedNetworkBlocks")
    ...
    circuit: Optional["_models.Circuit"] = rest_field()
    """An ExpressRoute Circuit."""
    endpoints: Optional["_models.Endpoints"] = rest_field(visibility=["read"])
    """The endpoints."""
    network_block: str = rest_field(name="networkBlock")
    ...
    vcenter_password: Optional[str] = rest_field(name="vcenterPassword")
    """Optionally, set the vCenter admin password when the private cloud is created."""
    nsxt_password: Optional[str] = rest_field(name="nsxtPassword")
    ...
    secondary_circuit: Optional["_models.Circuit"] = rest_field(name="secondaryCircuit")
    ...
    dns_zone_type: Optional[Union[str, "_models.DnsZoneType"]] = rest_field(name="dnsZoneType")
...
class PrivateCloudUpdate(_model_base.Model):
...
class PrivateCloudUpdateProperties(_model_base.Model):
    ...
    management_cluster: Optional["_models.ManagementCluster"] = rest_field(name="managementCluster")
...
class ScriptExecutionParameter(_model_base.Model):
...
class PSCredentialExecutionParameter(ScriptExecutionParameter, discriminator="Credential"):
    ...
    password: Optional[str] = rest_field()
    """password for login."""
    type: Literal[ScriptExecutionParameterType.CREDENTIAL] = rest_discriminator(name="type")  # type: ignore
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:  # pylint: disable=useless-super-delegation
        super().__init__(*args, type=ScriptExecutionParameterType.CREDENTIAL, **kwargs)
...
class ScriptCmdlet(ProxyResource):
    ...
    properties: Optional["_models.ScriptCmdletProperties"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""
...
class ScriptCmdletProperties(_model_base.Model):
...
class ScriptExecution(ProxyResource):
    ...
    properties: Optional["_models.ScriptExecutionProperties"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""
...
class ScriptExecutionProperties(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    script_cmdlet_id: Optional[str] = rest_field(name="scriptCmdletId")
    """A reference to the script cmdlet resource if user is running a AVS script."""
    parameters: Optional[List["_models.ScriptExecutionParameter"]] = rest_field()
    """Parameters the script will accept."""
    hidden_parameters: Optional[List["_models.ScriptExecutionParameter"]] = rest_field(name="hiddenParameters")
    """Parameters that will be hidden/not visible to ARM, such as passwords and
     credentials."""
    failure_reason: Optional[str] = rest_field(name="failureReason")
    """Error message if the script was able to run, but if the script itself had
     errors or powershell threw an exception."""
    timeout: str = rest_field()
    """Time limit for execution. Required."""
    retention: Optional[str] = rest_field()
    ...
    named_outputs: Optional[Dict[str, Any]] = rest_field(name="namedOutputs")
...
class ScriptPackage(ProxyResource):
    ...
    properties: Optional["_models.ScriptPackageProperties"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""
...
class ScriptPackageProperties(_model_base.Model):
...
class ScriptParameter(_model_base.Model):
...
class ScriptSecureStringExecutionParameter(ScriptExecutionParameter, discriminator="SecureValue"):
    ...
    secure_value: Optional[str] = rest_field(name="secureValue")
    """A secure value for the passed parameter, not to be stored in logs."""
    type: Literal[ScriptExecutionParameterType.SECURE_VALUE] = rest_discriminator(name="type")  # type: ignore
    """The type of execution parameter. Required."""
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:  # pylint: disable=useless-super-delegation
        super().__init__(*args, type=ScriptExecutionParameterType.SECURE_VALUE, **kwargs)
...
class ScriptStringExecutionParameter(ScriptExecutionParameter, discriminator="Value"):
    ...
    type: Literal[ScriptExecutionParameterType.VALUE] = rest_discriminator(name="type")  # type: ignore
    """The type of execution parameter. Required."""
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:  # pylint: disable=useless-super-delegation
        super().__init__(*args, type=ScriptExecutionParameterType.VALUE, **kwargs)
...
class Sku(_model_base.Model):
    ...
    :ivar name: The name of the SKU, usually a combination of letters and numbers, for example,
     'P3'. Required.
    :vartype name: str
    ...
    name: str = rest_field()
    """The name of the SKU, usually a combination of letters and numbers, for example, 'P3'. Required."""
...
class VirtualMachine(ProxyResource):
    ...
    properties: Optional["_models.VirtualMachineProperties"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""
...
class VirtualMachineRestrictMovement(_model_base.Model):
...
class VmHostPlacementPolicyProperties(PlacementPolicyProperties, discriminator="VmHost"):
    ...
    vm_members: List[str] = rest_field(name="vmMembers")
    """Virtual machine members list. Required."""
    host_members: List[str] = rest_field(name="hostMembers")
    """Host members list. Required."""
    affinity_type: Union[str, "_models.AffinityType"] = rest_field(name="affinityType")
    ...
    """placement policy azure hybrid benefit opt-in type. Known values are: \"SqlHost\" and \"None\"."""
    type: Literal[PlacementPolicyType.VM_HOST] = rest_discriminator(name="type")  # type: ignore
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:  # pylint: disable=useless-super-delegation
        super().__init__(*args, type=PlacementPolicyType.VM_HOST, **kwargs)
...
class VmPlacementPolicyProperties(PlacementPolicyProperties, discriminator="VmVm"):
    ...
    affinity_type: Union[str, "_models.AffinityType"] = rest_field(name="affinityType")
    """placement policy affinity type. Required. Known values are: \"Affinity\" and \"AntiAffinity\"."""
    type: Literal[PlacementPolicyType.VM_VM] = rest_discriminator(name="type")  # type: ignore
    """placement policy type. Required."""
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:  # pylint: disable=useless-super-delegation
        super().__init__(*args, type=PlacementPolicyType.VM_VM, **kwargs)
...
class WorkloadNetwork(ProxyResource):
    ...
    properties: Optional["_models.WorkloadNetworkProperties"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""
...
class WorkloadNetworkDhcp(ProxyResource):
    ...
    properties: Optional["_models.WorkloadNetworkDhcpEntity"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""

    __flattened_items = ["dhcp_type", "display_name", "segments", "provisioning_state", "revision"]
...
class WorkloadNetworkDhcpEntity(_model_base.Model):
    ...
    __mapping__: Dict[str, _model_base.Model] = {}
    dhcp_type: str = rest_discriminator(name="dhcpType")
...
class WorkloadNetworkDhcpRelay(WorkloadNetworkDhcpEntity, discriminator="RELAY"):
    ...
    server_addresses: Optional[List[str]] = rest_field(name="serverAddresses")
    """DHCP Relay Addresses. Max 3."""
    dhcp_type: Literal[DhcpTypeEnum.RELAY] = rest_discriminator(name="dhcpType")  # type: ignore
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:  # pylint: disable=useless-super-delegation
        super().__init__(*args, dhcp_type=DhcpTypeEnum.RELAY, **kwargs)
...
class WorkloadNetworkDhcpServer(WorkloadNetworkDhcpEntity, discriminator="SERVER"):
    ...
    server_address: Optional[str] = rest_field(name="serverAddress")
    """DHCP Server Address."""
    lease_time: Optional[int] = rest_field(name="leaseTime")
    """DHCP Server Lease Time."""
    dhcp_type: Literal[DhcpTypeEnum.SERVER] = rest_discriminator(name="dhcpType")  # type: ignore
    """Type of DHCP: SERVER or RELAY. Required."""
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:  # pylint: disable=useless-super-delegation
        super().__init__(*args, dhcp_type=DhcpTypeEnum.SERVER, **kwargs)


class WorkloadNetworkDhcpUpdate(_model_base.Model):
    """NSX DHCP update.
...
class WorkloadNetworkDnsService(ProxyResource):
    ...
    properties: Optional["_models.WorkloadNetworkDnsServiceProperties"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""
...
class WorkloadNetworkDnsServiceProperties(_model_base.Model):
    ...
    dns_service_ip: Optional[str] = rest_field(name="dnsServiceIp")
    """DNS service IP of the DNS Service."""
    default_dns_zone: Optional[str] = rest_field(name="defaultDnsZone")
    """Default DNS zone of the DNS Service."""
    fqdn_zones: Optional[List[str]] = rest_field(name="fqdnZones")
    """FQDN zones of the DNS Service."""
    log_level: Optional[Union[str, "_models.DnsServiceLogLevelEnum"]] = rest_field(name="logLevel")
...
class WorkloadNetworkDnsServiceUpdate(_model_base.Model):
    """NSX DNS Service update.

    :ivar properties: The updatable properties of a DNS Service update.
    :vartype properties: ~azure.mgmt.avs.models.WorkloadNetworkDnsServiceProperties
    """
...
class WorkloadNetworkDnsZone(ProxyResource):
    ...
    properties: Optional["_models.WorkloadNetworkDnsZoneProperties"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""
...
class WorkloadNetworkDnsZoneProperties(_model_base.Model):
    ...
    domain: Optional[List[str]] = rest_field()
    """Domain names of the DNS Zone."""
    dns_server_ips: Optional[List[str]] = rest_field(name="dnsServerIps")
    """DNS Server IP array of the DNS Zone."""
    source_ip: Optional[str] = rest_field(name="sourceIp")
    """Source IP of the DNS Zone."""
    dns_services: Optional[int] = rest_field(name="dnsServices")
...
class WorkloadNetworkDnsZoneUpdate(_model_base.Model):
    """NSX DNS Zone update.

    :ivar properties: The updatable properties of a DNS Zone update.
    :vartype properties: ~azure.mgmt.avs.models.WorkloadNetworkDnsZoneProperties
    """
...
class WorkloadNetworkGateway(ProxyResource):
    ...
    properties: Optional["_models.WorkloadNetworkGatewayProperties"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""
...
class WorkloadNetworkGatewayProperties(_model_base.Model):
...
class WorkloadNetworkPortMirroring(ProxyResource):
    ...
    properties: Optional["_models.WorkloadNetworkPortMirroringProperties"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""
...
class WorkloadNetworkPortMirroringProperties(_model_base.Model):
    ...
    """Source VM Group."""
    destination: Optional[str] = rest_field()
...
class WorkloadNetworkPortMirroringUpdate(_model_base.Model):
    """NSX Port Mirroring update.

    :ivar properties: The updatable properties of a Port Mirroring update.
    :vartype properties: ~azure.mgmt.avs.models.WorkloadNetworkPortMirroringProperties
    """
...
class WorkloadNetworkProperties(_model_base.Model):
...
class WorkloadNetworkPublicIp(ProxyResource):
    ...
    properties: Optional["_models.WorkloadNetworkPublicIpProperties"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""
...
class WorkloadNetworkPublicIpProperties(_model_base.Model):
    ...
    number_of_public_i_ps: Optional[int] = rest_field(name="numberOfPublicIPs")
...
class WorkloadNetworkSegment(ProxyResource):
    ...
    properties: Optional["_models.WorkloadNetworkSegmentProperties"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""
...
class WorkloadNetworkSegmentPortVif(_model_base.Model):
    ...
    port_name: Optional[str] = rest_field(name="portName")
...
class WorkloadNetworkSegmentProperties(_model_base.Model):
    ...
    connected_gateway: Optional[str] = rest_field(name="connectedGateway")
...
class WorkloadNetworkSegmentSubnet(_model_base.Model):
    ...
    dhcp_ranges: Optional[List[str]] = rest_field(name="dhcpRanges")
    """DHCP Range assigned for subnet."""
    gateway_address: Optional[str] = rest_field(name="gatewayAddress")
    """Gateway address."""
...
class WorkloadNetworkSegmentUpdate(_model_base.Model):
    """NSX Segment update.

    :ivar properties: The updatable properties of a Segment update.
    :vartype properties: ~azure.mgmt.avs.models.WorkloadNetworkSegmentProperties
    """
...
class WorkloadNetworkVirtualMachine(ProxyResource):
    ...
    properties: Optional["_models.WorkloadNetworkVirtualMachineProperties"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""
...
class WorkloadNetworkVirtualMachineProperties(_model_base.Model):
...
class WorkloadNetworkVMGroup(ProxyResource):
    ...
    properties: Optional["_models.WorkloadNetworkVMGroupProperties"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""
...
class WorkloadNetworkVMGroupProperties(_model_base.Model):
    ...
    members: Optional[List[str]] = rest_field()
...
class WorkloadNetworkVMGroupUpdate(_model_base.Model):
    """NSX VM Group update.

    :ivar properties: The updatable properties of a VM Group update.
    :vartype properties: ~azure.mgmt.avs.models.WorkloadNetworkVMGroupProperties
    """
