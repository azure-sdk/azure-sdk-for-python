...
class IdentitySource(_model_base.Model):
    ...
    base_user_dn: Optional[str] = rest_field(name="baseUserDN")
    """The base distinguished name for users."""
    base_group_dn: Optional[str] = rest_field(name="baseGroupDN")
...
class PrivateCloudProperties(_model_base.Model):
...
class ScriptExecutionProperties(_model_base.Model):
