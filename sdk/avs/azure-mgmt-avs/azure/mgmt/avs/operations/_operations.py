    ...
    def list(
        ...
        **kwargs: Any
        ...
        :keyword state_name: Filter maintenances based on state. Known values are: "NotScheduled",
         "Scheduled", "Planned", "InProgress", "Success", "Failed", and "Canceled". Default value is
         None.
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.Maintenance], deserialized["value"])
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, iter(list_of_elem)
