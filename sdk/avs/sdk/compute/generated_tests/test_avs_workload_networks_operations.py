...
class TestAVSWorkloadNetworksOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_workload_networks_list_dns_service(self, resource_group):
        response = self.client.workload_networks.list_dns_service(
            resource_group_name=resource_group.name,
            private_cloud_name="str",
            workload_network_name="str",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_workload_networks_list_public_i_ps(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_workload_networks_begin_create_segment(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_workload_networks_begin_update_segment(self, resource_group):
