...
def build_operations_list_request(**kwargs: Any) -> HttpRequest:
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2024-08-27"))
...
def build_organizations_get_request(
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Astronomer.Astro/organizations/{organizationName}"
...
class Operations:
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._config: AstroMgmtClientConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
