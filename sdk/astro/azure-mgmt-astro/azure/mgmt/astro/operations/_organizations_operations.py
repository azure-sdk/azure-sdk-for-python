...
class OrganizationsOperations:
    ...
    def _create_or_update_initial(
        ...
        resource: Union[_models.OrganizationResource, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.astro.models.OrganizationResource or IO[bytes]
        :return: An instance of LROPoller that returns either OrganizationResource or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.astro.models.OrganizationResource]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        organization_name: str,
        properties: Union[_models.OrganizationResourceUpdate, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.astro.models.OrganizationResourceUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either OrganizationResource or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.astro.models.OrganizationResource]
        :raises ~azure.core.exceptions.HttpResponseError:
