...
class TestDesktopVirtualizationMgmtActiveSessionHostConfigurationsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_active_session_host_configurations_list_by_host_pool(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_active_session_host_configurations_get(self, resource_group):
