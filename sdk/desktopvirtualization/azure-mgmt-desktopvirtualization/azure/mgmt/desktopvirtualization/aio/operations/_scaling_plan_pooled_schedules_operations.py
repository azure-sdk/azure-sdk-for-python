...
class ScalingPlanPooledSchedulesOperations:
    ...
    async def get(
    ...
    ) -> _models.ScalingPlanPooledSchedulePut:
        ...
        :return: ScalingPlanPooledSchedulePut or the result of cls(response)
        :rtype: ~azure.mgmt.desktopvirtualization.models.ScalingPlanPooledSchedulePut
        ...
        cls: ClsType[_models.ScalingPlanPooledSchedulePut] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("ScalingPlanPooledSchedulePut", pipeline_response.http_response)
    ...
    async def create(
        ...
        scaling_plan_schedule: _models.ScalingPlanPooledSchedulePut,
        *,
        ...
        **kwargs: Any
        ...
        :type scaling_plan_schedule:
         ~azure.mgmt.desktopvirtualization.models.ScalingPlanPooledSchedulePut
    ...
    async def create(
        ...
        scaling_plan_name: str,
        scaling_plan_schedule_name: str,
        scaling_plan_schedule: Union[_models.ScalingPlanPooledSchedulePut, IO[bytes]],
        **kwargs: Any
    ) -> _models.ScalingPlanPooledSchedulePut:
        """Create or update a ScalingPlanPooledSchedule.
        ...
        :param scaling_plan_schedule: Object containing ScalingPlanPooledSchedule definitions. Is
         either a ScalingPlanPooledSchedulePut type or a IO[bytes] type. Required.
        :type scaling_plan_schedule:
         ~azure.mgmt.desktopvirtualization.models.ScalingPlanPooledSchedulePut or IO[bytes]
        :return: ScalingPlanPooledSchedulePut or the result of cls(response)
        :rtype: ~azure.mgmt.desktopvirtualization.models.ScalingPlanPooledSchedulePut
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(scaling_plan_schedule, (IOBase, bytes)):
            ...
            _json = self._serialize.body(scaling_plan_schedule, "ScalingPlanPooledSchedulePut")
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.ScalingPlanPooledSchedulePut"]:
        ...
        :return: An iterator like instance of either ScalingPlanPooledSchedulePut or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.desktopvirtualization.models.ScalingPlanPooledSchedulePut]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
