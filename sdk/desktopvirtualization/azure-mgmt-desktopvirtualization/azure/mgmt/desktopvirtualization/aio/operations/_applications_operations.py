    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :param application_name: The name of the application within the specified application group.
         Required.
        :type application_name: str
        :param application: The resource properties to be updated. Default value is None.
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :param application_name: The name of the application within the specified application group.
         Required.
        :type application_name: str
        :param application: The resource properties to be updated. Is either a ApplicationPatch type or
