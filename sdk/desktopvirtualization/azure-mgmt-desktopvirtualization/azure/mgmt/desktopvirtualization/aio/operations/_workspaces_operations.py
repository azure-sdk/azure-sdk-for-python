...
class WorkspacesOperations:
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :param workspace_name: The name of the workspace. Required.
        :type workspace_name: str
        :param workspace: The resource properties to be updated. Default value is None.
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :param workspace_name: The name of the workspace. Required.
        :type workspace_name: str
        :param workspace: The resource properties to be updated. Is either a WorkspacePatch type or a
