...
from .operations import (
    ...
    ValidateSessionHostUpdateOperations,
...
class DesktopVirtualizationMgmtClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :ivar validate_session_host_update: ValidateSessionHostUpdateOperations operations
    :vartype validate_session_host_update:
     azure.mgmt.desktopvirtualization.aio.operations.ValidateSessionHostUpdateOperations
    ...
    :vartype session_host_managements_operation_status:
     azure.mgmt.desktopvirtualization.aio.operations.SessionHostManagementsOperationStatusOperations
    ...
    :vartype session_host_configurations_operation_status:
     azure.mgmt.desktopvirtualization.aio.operations.SessionHostConfigurationsOperationStatusOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.validate_session_host_update = ValidateSessionHostUpdateOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
