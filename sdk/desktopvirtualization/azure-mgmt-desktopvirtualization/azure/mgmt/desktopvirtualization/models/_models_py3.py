...
class ScalingPlan(ResourceModelWithAllowedPropertySet):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar schedules: List of ScalingPlanPooled definitions.
    :vartype schedules:
     list[~azure.mgmt.desktopvirtualization.models.ScalingPlanPooledScheduleProperties]
    ...
    _attribute_map = {
        ...
        "schedules": {"key": "properties.schedules", "type": "[ScalingPlanPooledScheduleProperties]"},
    ...
    def __init__(
        ...
        *,
        ...
        schedules: Optional[List["_models.ScalingPlanPooledScheduleProperties"]] = None,
        ...
        **kwargs: Any
        ...
        :keyword schedules: List of ScalingPlanPooled definitions.
        :paramtype schedules:
         list[~azure.mgmt.desktopvirtualization.models.ScalingPlanPooledScheduleProperties]
...
class ScalingPlanPatch(_serialization.Model):
    ...
    :ivar exclusion_tag: Exclusion tag for scaling plan.
    :vartype exclusion_tag: str
    :ivar schedules: List of ScalingPlanPooledScheduleProperties definitions.
    :vartype schedules:
     list[~azure.mgmt.desktopvirtualization.models.ScalingPlanPooledScheduleProperties]
    :ivar host_pool_references: List of ScalingHostPoolReference definitions.
    :vartype host_pool_references:
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword exclusion_tag: Exclusion tag for scaling plan.
        :paramtype exclusion_tag: str
        :keyword schedules: List of ScalingPlanPooledScheduleProperties definitions.
        :paramtype schedules:
         list[~azure.mgmt.desktopvirtualization.models.ScalingPlanPooledScheduleProperties]
        :keyword host_pool_references: List of ScalingHostPoolReference definitions.
        :paramtype host_pool_references:
...
class ScalingPlanPooledSchedule(Resource):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword name_properties_name: Name of the ScalingPlanPooledSchedule.
...
class ScalingPlanPooledScheduleList(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.desktopvirtualization.models.ScalingPlanPooledSchedulePut]
    :ivar next_link: Link to the next page of results.
    :vartype next_link: str
    """
    ...
    _attribute_map = {
        "value": {"key": "value", "type": "[ScalingPlanPooledSchedulePut]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }

    def __init__(self, *, value: Optional[List["_models.ScalingPlanPooledSchedulePut"]] = None, **kwargs: Any) -> None:
        """
        :keyword value: List of ScalingPlanPooledSchedule definitions.
        :paramtype value: list[~azure.mgmt.desktopvirtualization.models.ScalingPlanPooledSchedulePut]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class ScalingPlanPooledScheduleProperties(_serialization.Model):  # pylint: disable=too-many-instance-attributes
...
class ScalingPlanPooledSchedulePut(Resource):  # pylint: disable=too-many-instance-attributes
