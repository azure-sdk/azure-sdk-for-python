...
class HostPoolUpdateConfigurationPatchProperties(_serialization.Model):
...
class SessionHostConfigurationOperationStatusList(_serialization.Model):
...
class ValidateSessionHostUpdateRequestBody(_serialization.Model):
    """Object containing the definition for properties to be used in the sessionHostUpdate validation.

    :ivar session_host_configuration: Object containing the definition for the
     SessionHostConfiguration to be validated.  If none is provided the update will use the
     SessionHostConfiguration settings associated with the HostPool.
    :vartype session_host_configuration:
     ~azure.mgmt.desktopvirtualization.models.SessionHostConfiguration
    :ivar session_host_management: Object containing the definition for the SessionHostManagement
     to be validated. If none is provided the update will use the settings saved in the
     sessionHostManagement object.
    :vartype session_host_management:
     ~azure.mgmt.desktopvirtualization.models.SessionHostManagement
    :ivar scheduled_date_time: The timestamp that the update validation is scheduled for. If none
     is provided, the update will be executed immediately.
    ...
    _attribute_map = {
        "session_host_configuration": {"key": "sessionHostConfiguration", "type": "SessionHostConfiguration"},
    ...
    def __init__(
        self,
        *,
        session_host_configuration: Optional["_models.SessionHostConfiguration"] = None,
        session_host_management: Optional["_models.SessionHostManagement"] = None,
        scheduled_date_time: Optional[datetime.datetime] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword session_host_configuration: Object containing the definition for the
         SessionHostConfiguration to be validated.  If none is provided the update will use the
         SessionHostConfiguration settings associated with the HostPool.
        :paramtype session_host_configuration:
         ~azure.mgmt.desktopvirtualization.models.SessionHostConfiguration
        :keyword session_host_management: Object containing the definition for the
         SessionHostManagement to be validated. If none is provided the update will use the settings
        ...
        """
        super().__init__(**kwargs)
        self.session_host_configuration = session_host_configuration
        self.session_host_management = session_host_management
        self.scheduled_date_time = scheduled_date_time
