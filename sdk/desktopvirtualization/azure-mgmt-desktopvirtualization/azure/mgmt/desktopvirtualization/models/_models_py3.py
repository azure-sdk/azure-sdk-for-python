...
class ActiveSessionHostConfiguration(Resource):
...
class DiffDiskProperties(_serialization.Model):
    ...
    :vartype option: str or ~azure.mgmt.desktopvirtualization.models.DiffDiskOption
    :ivar placement: Gets or sets specifies the ephemeral disk placement for operating system disk.
     The defaulting behavior is: CacheDisk if one is configured for the VM size otherwise
     ...
     cache disk. Possible values include: 'CacheDisk', 'ResourceDisk'. Known values are: "CacheDisk"
     and "ResourceDisk".
    :vartype placement: str or ~azure.mgmt.desktopvirtualization.models.DiffDiskPlacement
    """
    ...
    def __init__(
        self,
        *,
        option: Optional[Union[str, "_models.DiffDiskOption"]] = None,
        ...
        **kwargs: Any
        ...
        :paramtype option: str or ~azure.mgmt.desktopvirtualization.models.DiffDiskOption
        :keyword placement: Gets or sets specifies the ephemeral disk placement for operating system
         disk. The defaulting behavior is: CacheDisk if one is configured for the VM size otherwise
         ResourceDisk is used. Refer to the VM size documentation for Windows VM at
         https://docs.microsoft.com/azure/virtual-machines/windows/sizes and Linux VM at
         https://docs.microsoft.com/azure/virtual-machines/linux/sizes to check which VM sizes exposes a
         cache disk. Possible values include: 'CacheDisk', 'ResourceDisk'. Known values are: "CacheDisk"
         and "ResourceDisk".
        :paramtype placement: str or ~azure.mgmt.desktopvirtualization.models.DiffDiskPlacement
        """
        super().__init__(**kwargs)
        self.option = option
...
class DiskInfoProperties(_serialization.Model):
    ...
    :vartype managed_disk: ~azure.mgmt.desktopvirtualization.models.ManagedDiskProperties
    :ivar diff_disk_settings: Specifies the ephemeral Disk Settings for the operating system disk
     used by the virtual machine.
    :vartype diff_disk_settings: ~azure.mgmt.desktopvirtualization.models.DiffDiskProperties
    """

    _attribute_map = {
        "managed_disk": {"key": "managedDisk", "type": "ManagedDiskProperties"},
        "diff_disk_settings": {"key": "diffDiskSettings", "type": "DiffDiskProperties"},
    }

    def __init__(
        self,
        *,
        managed_disk: Optional["_models.ManagedDiskProperties"] = None,
        diff_disk_settings: Optional["_models.DiffDiskProperties"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword managed_disk: The managed disk parameters.
        :paramtype managed_disk: ~azure.mgmt.desktopvirtualization.models.ManagedDiskProperties
        ...
        :paramtype diff_disk_settings: ~azure.mgmt.desktopvirtualization.models.DiffDiskProperties
        """
        super().__init__(**kwargs)
...
class HostPoolProvisioningControlParameter(_serialization.Model):
    """Represents properties for a hostpool provisioning control request.

    All required parameters must be populated in order to send to server.

    :ivar action: Action types for controlling hostpool provisioning. Required. "Cancel"
    :vartype action: str or ~azure.mgmt.desktopvirtualization.models.HostPoolProvisioningAction
    :ivar cancel_message: The cancel message sent to the user on the session host.
    ...
    def __init__(
        self,
        *,
        action: Union[str, "_models.HostPoolProvisioningAction"],
        cancel_message: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword action: Action types for controlling hostpool provisioning. Required. "Cancel"
        :paramtype action: str or ~azure.mgmt.desktopvirtualization.models.HostPoolProvisioningAction
        :keyword cancel_message: The cancel message sent to the user on the session host.
...
class ManagedDiskProperties(_serialization.Model):
...
class ScalingPlanPooledSchedule(Resource):
    ...
    :vartype scaling_method: str or ~azure.mgmt.desktopvirtualization.models.ScalingMethod
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        off_peak_start_time: "_models.Time",
        scaling_method: Optional[Union[str, "_models.ScalingMethod"]] = None,
        ...
        **kwargs: Any
        ...
        :paramtype scaling_method: str or ~azure.mgmt.desktopvirtualization.models.ScalingMethod
...
class SessionHostConfiguration(Resource):
...
class SessionHostConfigurationPatch(_serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        disk_info: Optional["_models.DiskInfoProperties"] = None,
        custom_configuration_script_url: Optional[str] = None,
...
class SessionHostManagement(ProxyResource):
    ...
    :ivar provisioning: Parameters that apply when session hosts are provisioned.
    :vartype provisioning:
     ~azure.mgmt.desktopvirtualization.models.SessionHostProvisioningConfigurationProperties
    :ivar failed_session_host_cleanup_policy: The policy that should be applied when the Session
     Host provisioning operation fails. Known values are: "KeepAll", "KeepOne", and "KeepNone".
    :vartype failed_session_host_cleanup_policy: str or
     ~azure.mgmt.desktopvirtualization.models.FailedSessionHostCleanupPolicySHC
    """
    ...
    _attribute_map = {
        ...
        "provisioning": {"key": "properties.provisioning", "type": "SessionHostProvisioningConfigurationProperties"},
        "failed_session_host_cleanup_policy": {"key": "properties.failedSessionHostCleanupPolicy", "type": "str"},
    }

    def __init__(
        self,
        *,
        scheduled_date_time_zone: str,
        update: "_models.HostPoolUpdateConfigurationProperties",
        provisioning: Optional["_models.SessionHostProvisioningConfigurationProperties"] = None,
        failed_session_host_cleanup_policy: Optional[Union[str, "_models.FailedSessionHostCleanupPolicySHC"]] = None,
        **kwargs: Any
    ) -> None:
        """
        ...
        :keyword provisioning: Parameters that apply when session hosts are provisioned.
        :paramtype provisioning:
         ~azure.mgmt.desktopvirtualization.models.SessionHostProvisioningConfigurationProperties
        :keyword failed_session_host_cleanup_policy: The policy that should be applied when the Session
         Host provisioning operation fails. Known values are: "KeepAll", "KeepOne", and "KeepNone".
        :paramtype failed_session_host_cleanup_policy: str or
         ~azure.mgmt.desktopvirtualization.models.FailedSessionHostCleanupPolicySHC
        """
        super().__init__(**kwargs)
        ...
        self.failed_session_host_cleanup_policy = failed_session_host_cleanup_policy
...
class SessionHostManagementPatch(_serialization.Model):
    ...
    :ivar provisioning: Parameters that apply when session hosts are provisioned.
    :vartype provisioning:
     ~azure.mgmt.desktopvirtualization.models.SessionHostProvisioningConfigurationPatchProperties
    :ivar failed_session_host_cleanup_policy: The policy that should be applied when the Session
     Host provisioning operation fails. Known values are: "KeepAll", "KeepOne", and "KeepNone".
    :vartype failed_session_host_cleanup_policy: str or
     ~azure.mgmt.desktopvirtualization.models.FailedSessionHostCleanupPolicySHC
    ...
    _attribute_map = {
        ...
        "provisioning": {
            "key": "properties.provisioning",
            "type": "SessionHostProvisioningConfigurationPatchProperties",
        },
        "failed_session_host_cleanup_policy": {"key": "properties.failedSessionHostCleanupPolicy", "type": "str"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        provisioning: Optional["_models.SessionHostProvisioningConfigurationPatchProperties"] = None,
        failed_session_host_cleanup_policy: Optional[Union[str, "_models.FailedSessionHostCleanupPolicySHC"]] = None,
        **kwargs: Any
    ) -> None:
        """
...
class SessionHostManagementProvisioningOperationProgress(_serialization.Model):  # pylint: disable=name-too-long
    """SessionHostManagement Provisioning Operation Progress information.

    :ivar execution_start_time: Time that the sessionHostManagement operation was created.
    :vartype execution_start_time: ~datetime.datetime
    :ivar session_hosts_in_progress: The number of sessionHosts in progress in the
     sessionHostManagement provisioning operation.
    :vartype session_hosts_in_progress: int
    :ivar session_hosts_completed: The number of sessionHosts completed in the
     sessionHostManagement provisioning operation.
    :vartype session_hosts_completed: int
    :ivar final_session_hosts_count: The final instance count of the host pool for this
     provisioning operation.
    :vartype final_session_hosts_count: int
    :ivar initial_session_hosts_count: The initial instance count of the host pool for this
     provisioning operation.
    :vartype initial_session_hosts_count: int
    """
    ...
    _attribute_map = {
        ...
        "session_hosts_in_progress": {"key": "sessionHostsInProgress", "type": "int"},
        "session_hosts_completed": {"key": "sessionHostsCompleted", "type": "int"},
        "final_session_hosts_count": {"key": "finalSessionHostsCount", "type": "int"},
        "initial_session_hosts_count": {"key": "initialSessionHostsCount", "type": "int"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        session_hosts_in_progress: Optional[int] = None,
        session_hosts_completed: Optional[int] = None,
        final_session_hosts_count: Optional[int] = None,
        initial_session_hosts_count: Optional[int] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword execution_start_time: Time that the sessionHostManagement operation was created.
        ...
        :keyword session_hosts_completed: The number of sessionHosts completed in the
         sessionHostManagement provisioning operation.
        :paramtype session_hosts_completed: int
        :keyword final_session_hosts_count: The final instance count of the host pool for this
         provisioning operation.
        :paramtype final_session_hosts_count: int
        :keyword initial_session_hosts_count: The initial instance count of the host pool for this
         provisioning operation.
        :paramtype initial_session_hosts_count: int
        """
        super().__init__(**kwargs)
        self.execution_start_time = execution_start_time
        self.session_hosts_in_progress = session_hosts_in_progress
        self.session_hosts_completed = session_hosts_completed
        self.final_session_hosts_count = final_session_hosts_count
        self.initial_session_hosts_count = initial_session_hosts_count


class SessionHostManagementProvisioningStatus(_serialization.Model):
    ...
    :vartype name: str
    :ivar status: Operation status. Current defined values are < Scheduled |
     ValidatingSessionHostProvisioning | Cancelling | ProvisioningSessionHosts > | Succeeded |
    ...
    :vartype error: ~azure.mgmt.desktopvirtualization.models.ErrorDetail
    :ivar correlation_id: The correlation Id for Log Analytics.
    :vartype correlation_id: str
    :ivar progress: Progress information on the sessionHostManagement operation.
    :vartype progress:
     ~azure.mgmt.desktopvirtualization.models.SessionHostManagementProvisioningOperationProgress
    ...
    _attribute_map = {
        ...
        "progress": {"key": "properties.progress", "type": "SessionHostManagementProvisioningOperationProgress"},
    ...
    def __init__(
        ...
        *,
        ...
        progress: Optional["_models.SessionHostManagementProvisioningOperationProgress"] = None,
        ...
        **kwargs: Any
        ...
        :paramtype error: ~azure.mgmt.desktopvirtualization.models.ErrorDetail
        :keyword correlation_id: The correlation Id for Log Analytics.
...
class SessionHostProvisioningConfigurationPatchProperties(_serialization.Model):  # pylint: disable=name-too-long
    """The configuration for session host provisioning operations.

    :ivar set_drain_mode: Whether the session host should be set in drain mode following
     provisioning.
    :vartype set_drain_mode: bool
    :ivar instance_count: the number of session hosts to exist in the Host Pool.
    :vartype instance_count: int
    :ivar canary_policy: Policy on whether a Canary VM should be provisioned during a session host
     provisioning operation. Known values are: "Auto", "Never", and "Always".
    :vartype canary_policy: str or ~azure.mgmt.desktopvirtualization.models.CanaryPolicy
    """
    ...
    _attribute_map = {
        "set_drain_mode": {"key": "setDrainMode", "type": "bool"},
        "instance_count": {"key": "instanceCount", "type": "int"},
        "canary_policy": {"key": "canaryPolicy", "type": "str"},
    }

    def __init__(
        self,
        *,
        set_drain_mode: Optional[bool] = None,
        instance_count: Optional[int] = None,
        canary_policy: Optional[Union[str, "_models.CanaryPolicy"]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword set_drain_mode: Whether the session host should be set in drain mode following
         provisioning.
        :paramtype set_drain_mode: bool
        :keyword instance_count: the number of session hosts to exist in the Host Pool.
        :paramtype instance_count: int
        :keyword canary_policy: Policy on whether a Canary VM should be provisioned during a session
         host provisioning operation. Known values are: "Auto", "Never", and "Always".
        :paramtype canary_policy: str or ~azure.mgmt.desktopvirtualization.models.CanaryPolicy
        """
        super().__init__(**kwargs)
        self.set_drain_mode = set_drain_mode
        self.instance_count = instance_count
        self.canary_policy = canary_policy


class SessionHostProvisioningConfigurationProperties(_serialization.Model):  # pylint: disable=name-too-long
    """The configuration for session host provisioning operations.
