...
class ControlSessionHostUpdateOperations:
    ...
    def begin_post(
        ...
        **kwargs: Any
        ...
        :param host_pool_update_control_parameter: The content of the action request. Required.
    ...
    def begin_post(
        ...
        **kwargs: Any
        ...
        :param host_pool_name: The name of the host pool within the specified resource group. Required.
        :type host_pool_name: str
        :param host_pool_update_control_parameter: The content of the action request. Is either a
         HostPoolUpdateControlParameter type or a IO[bytes] type. Required.
        :type host_pool_update_control_parameter:
