    ...
    def send_message(
        ...
        **kwargs: Any
        ...
        :param user_session_id: The name of the user session within the specified session host.
         Required.
        :type user_session_id: str
        :param send_message: Represents message sent to a UserSession. Default value is None.
    ...
    def send_message(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param user_session_id: The name of the user session within the specified session host.
         Required.
        :type user_session_id: str
        :param send_message: Represents message sent to a UserSession. Is either a SendMessage type or
