...
class AppAttachPackageOperations:
    ...
    def get(self, resource_group_name: str, app_attach_package_name: str, **kwargs: Any) -> _models.AppAttachPackage:
        ...
        deserialized = self._deserialize("AppAttachPackage", pipeline_response)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/appAttachPackages/{appAttachPackageName}"
    }
    ...
    def create_or_update(
        ...
        resource_group_name: str,
        app_attach_package_name: str,
        app_attach_package: Union[_models.AppAttachPackage, IO],
        **kwargs: Any
    ) -> _models.AppAttachPackage:
        """Create or update an App Attach package.
        ...
        :param app_attach_package: Object containing App Attach Package definitions. Is either a
         AppAttachPackage type or a IO type. Required.
        :type app_attach_package: ~azure.mgmt.desktopvirtualization.models.AppAttachPackage or IO
    ...
    def update(
        ...
        resource_group_name: str,
        app_attach_package_name: str,
        app_attach_package_patch: Optional[IO] = None,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.AppAttachPackage:
        ...
        :param app_attach_package_patch: Object containing App Attach Package definition. Default value
         is None.
        :type app_attach_package_patch: IO
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def update(
        ...
        resource_group_name: str,
        app_attach_package_name: str,
        app_attach_package_patch: Optional[Union[_models.AppAttachPackagePatch, IO]] = None,
        **kwargs: Any
    ) -> _models.AppAttachPackage:
        """Update an App Attach Package.
        ...
        :param app_attach_package_patch: Object containing App Attach Package definition. Is either a
         AppAttachPackagePatch type or a IO type. Default value is None.
        :type app_attach_package_patch: ~azure.mgmt.desktopvirtualization.models.AppAttachPackagePatch
         or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
    ...
    list_by_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/appAttachPackages"
    }
    ...
    list_by_subscription.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.DesktopVirtualization/appAttachPackages"
    }
