...
class SessionHostConfigurationsOperations:
    ...
    def _create_or_update_initial(
        ...
        host_pool_name: str,
        session_host_configuration: Union[_models.SessionHostConfiguration, IO],
        **kwargs: Any
    ...
    _create_or_update_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/sessionHostConfigurations/default"
    }
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param session_host_configuration: Object containing SessionHostConfiguration definitions.
         Required.
        :type session_host_configuration: IO
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param session_host_configuration: Object containing SessionHostConfiguration definitions. Is
         either a SessionHostConfiguration type or a IO type. Required.
        :type session_host_configuration:
         ~azure.mgmt.desktopvirtualization.models.SessionHostConfiguration or IO
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        host_pool_name: str,
        session_host_configuration: Optional[Union[_models.SessionHostConfigurationPatch, IO]] = None,
        **kwargs: Any
    ...
    def begin_update(
        ...
        resource_group_name: str,
        host_pool_name: str,
        session_host_configuration: Optional[IO] = None,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.SessionHostConfiguration]:
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type host_pool_name: str
        :param session_host_configuration: Object containing SessionHostConfiguration definitions. Is
         either a SessionHostConfigurationPatch type or a IO type. Default value is None.
        :type session_host_configuration:
         ~azure.mgmt.desktopvirtualization.models.SessionHostConfigurationPatch or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    list_by_host_pool.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/sessionHostConfigurations"
    }
