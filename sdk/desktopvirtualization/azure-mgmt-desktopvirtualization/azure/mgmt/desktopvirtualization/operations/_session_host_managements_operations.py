...
class SessionHostManagementsOperations:
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/sessionHostManagements/default"
    }
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type host_pool_name: str
        :param session_host_management: Object containing SessionHostManagement definitions. Required.
        :type session_host_management: IO
    ...
    def create_or_update(
        ...
        resource_group_name: str,
        host_pool_name: str,
        session_host_management: Union[_models.SessionHostManagement, IO],
        **kwargs: Any
    ) -> _models.SessionHostManagement:
        """Create or update a SessionHostManagement.
        ...
        :param session_host_management: Object containing SessionHostManagement definitions. Is either
         a SessionHostManagement type or a IO type. Required.
        :type session_host_management: ~azure.mgmt.desktopvirtualization.models.SessionHostManagement
         or IO
    ...
    def update(
        ...
        resource_group_name: str,
        host_pool_name: str,
        session_host_management: Optional[IO] = None,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.SessionHostManagement:
    ...
    def update(
        ...
        resource_group_name: str,
        host_pool_name: str,
        session_host_management: Optional[Union[_models.SessionHostManagementPatch, IO]] = None,
        **kwargs: Any
    ) -> _models.SessionHostManagement:
        """Update a SessionHostManagement.
        ...
        :type host_pool_name: str
        :param session_host_management: Object containing SessionHostManagement definitions. Is either
         a SessionHostManagementPatch type or a IO type. Default value is None.
        :type session_host_management:
         ~azure.mgmt.desktopvirtualization.models.SessionHostManagementPatch or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    list_by_host_pool.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/sessionHostManagements"
    }
