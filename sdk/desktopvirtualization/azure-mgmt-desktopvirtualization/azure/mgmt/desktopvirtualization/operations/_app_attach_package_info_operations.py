...
class AppAttachPackageInfoOperations:
    ...
    def import_method(
        ...
        **kwargs: Any
        ...
        :param import_package_info_request: Information to import app attach package. Required.
    ...
    def import_method(
        ...
        **kwargs: Any
        ...
        :param host_pool_name: The name of the host pool within the specified resource group. Required.
        :type host_pool_name: str
        :param import_package_info_request: Information to import app attach package. Is either a
         ImportPackageInfoRequest type or a IO[bytes] type. Required.
        :type import_package_info_request:
