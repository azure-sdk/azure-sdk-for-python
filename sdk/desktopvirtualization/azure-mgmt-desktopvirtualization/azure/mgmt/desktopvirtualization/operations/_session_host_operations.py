...
class SessionHostOperations:
    ...
    def retry_provisioning(  # pylint: disable=inconsistent-return-statements
        ...
        request = build_retry_provisioning_request(
            resource_group_name=resource_group_name,
            host_pool_name=host_pool_name,
            session_host_name=session_host_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self.retry_provisioning.metadata["url"],
            headers=_headers,
            params=_params,
        )
    ...
    retry_provisioning.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/sessionHosts/{sessionHostName}/retryProvisioning"
    }
