...
class InitiateSessionHostUpdateOperations:
    ...
    def _post_initial(  # pylint: disable=inconsistent-return-statements
        ...
        host_pool_name: str,
        update_session_hosts_request_body: Optional[Union[_models.UpdateSessionHostsRequestBody, IO]] = None,
        **kwargs: Any
    ) -> None:
        error_map = {
    ...
    _post_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/sessionHostManagements/default/initiateSessionHostUpdate"
    }
    ...
    def begin_post(
        ...
        resource_group_name: str,
        host_pool_name: str,
        update_session_hosts_request_body: Optional[IO] = None,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[None]:
        ...
        :param update_session_hosts_request_body: Object containing the definition for properties to be
         used in the sessionHostUpdate validation. Default value is None.
        :type update_session_hosts_request_body: IO
    ...
    def begin_post(
        ...
        **kwargs: Any
        ...
        :type update_session_hosts_request_body:
         ~azure.mgmt.desktopvirtualization.models.UpdateSessionHostsRequestBody or IO
