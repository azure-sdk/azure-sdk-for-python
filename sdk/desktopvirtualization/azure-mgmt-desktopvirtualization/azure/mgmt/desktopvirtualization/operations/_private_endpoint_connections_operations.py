...
class PrivateEndpointConnectionsOperations:
    ...
    def get_by_host_pool(
        ...
        :param host_pool_name: The name of the host pool within the specified resource group. Required.
        :type host_pool_name: str
        :param private_endpoint_connection_name: The name parameter for private endpoint. Required.
    ...
    def update_by_host_pool(
        ...
        host_pool_name: str,
        private_endpoint_connection_name: str,
        connection: _models.PrivateEndpointConnectionWithSystemData,
        *,
        ...
        **kwargs: Any
        ...
        :param private_endpoint_connection_name: The name parameter for private endpoint. Required.
        :type private_endpoint_connection_name: str
        :param connection: Resource create parameters. Required.
        :type connection:
    ...
    def update_by_host_pool(
        ...
        host_pool_name: str,
        private_endpoint_connection_name: str,
        connection: Union[_models.PrivateEndpointConnectionWithSystemData, IO[bytes]],
        **kwargs: Any
    ) -> _models.PrivateEndpointConnectionWithSystemData:
        """Approve or reject a private endpoint connection.
        ...
        :param private_endpoint_connection_name: The name parameter for private endpoint. Required.
        :type private_endpoint_connection_name: str
        :param connection: Resource create parameters. Is either a
         PrivateEndpointConnectionWithSystemData type or a IO[bytes] type. Required.
        :type connection:
         ~azure.mgmt.desktopvirtualization.models.PrivateEndpointConnectionWithSystemData or IO[bytes]
        :return: PrivateEndpointConnectionWithSystemData or the result of cls(response)
        :rtype: ~azure.mgmt.desktopvirtualization.models.PrivateEndpointConnectionWithSystemData
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(connection, (IOBase, bytes)):
            ...
            _json = self._serialize.body(connection, "PrivateEndpointConnectionWithSystemData")
