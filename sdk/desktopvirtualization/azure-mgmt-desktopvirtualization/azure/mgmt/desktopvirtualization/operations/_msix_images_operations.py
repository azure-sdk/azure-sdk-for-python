...
class MsixImagesOperations:
    ...
    def expand(
        ...
        **kwargs: Any
        ...
        :param msix_image_uri: Represents URI referring to MSIX Image. Required.
    ...
    def expand(
        ...
        **kwargs: Any
        ...
        :param host_pool_name: The name of the host pool within the specified resource group. Required.
        :type host_pool_name: str
        :param msix_image_uri: Represents URI referring to MSIX Image. Is either a MSIXImageURI type or
