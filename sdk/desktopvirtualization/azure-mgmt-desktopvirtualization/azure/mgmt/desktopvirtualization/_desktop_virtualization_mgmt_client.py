...
class DesktopVirtualizationMgmtClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype control_session_host_provisioning:
     azure.mgmt.desktopvirtualization.operations.ControlSessionHostProvisioningOperations
    ...
    :vartype session_host_provisioning_statuses:
     azure.mgmt.desktopvirtualization.operations.SessionHostProvisioningStatusesOperations
