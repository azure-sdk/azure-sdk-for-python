...
# USAGE
    python msix_packages_create_or_update.py
...
# x-ms-original-file: specification/desktopvirtualization/resource-manager/Microsoft.DesktopVirtualization/preview/2024-08-08-preview/examples/MSIXPackages_CreateOrUpdate.json
