...
# USAGE
    python scaling_plan_pooled_schedule_create_using_create_delete.py
...
# x-ms-original-file: specification/desktopvirtualization/resource-manager/Microsoft.DesktopVirtualization/preview/2025-03-01-preview/examples/ScalingPlanPooledSchedule_CreateUsingCreateDelete.json
