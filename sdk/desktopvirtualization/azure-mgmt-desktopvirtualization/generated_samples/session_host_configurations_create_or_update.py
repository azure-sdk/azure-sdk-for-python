...
# USAGE
    python session_host_configurations_create_or_update.py
...
# x-ms-original-file: specification/desktopvirtualization/resource-manager/Microsoft.DesktopVirtualization/preview/2025-04-01-preview/examples/SessionHostConfigurations_CreateOrUpdate.json
