...
# USAGE
    python private_endpoint_connections_update_by_workspace.py
...
# x-ms-original-file: specification/desktopvirtualization/resource-manager/Microsoft.DesktopVirtualization/preview/2024-08-08-preview/examples/PrivateEndpointConnections_UpdateByWorkspace.json
