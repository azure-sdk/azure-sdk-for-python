...
# USAGE
    python scaling_plan_pooled_schedules_create_using_create_delete.py
...
# x-ms-original-file: specification/desktopvirtualization/resource-manager/Microsoft.DesktopVirtualization/preview/2025-04-01-preview/examples/ScalingPlanPooledSchedules_CreateUsingCreateDelete.json
