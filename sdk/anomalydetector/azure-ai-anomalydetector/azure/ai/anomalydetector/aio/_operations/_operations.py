...
from ..._operations._operations import (
    ...
    build_anomaly_detector_detect_univariate_last_anomaly_request,
...
class AnomalyDetectorClientOperationsMixin(AnomalyDetectorClientMixinABC):
    ...
    @overload
    async def detect_univariate_last_anomaly(
        self, options: _models.UnivariateDetectionOptions, *, content_type: str = "application/json", **kwargs: Any
    ...
    async def detect_univariate_last_anomaly(
        ...
        request = build_anomaly_detector_detect_univariate_last_anomaly_request(
            content_type=content_type,
            content=_content,
            headers=_headers,
            params=_params,
    ...
    async def train_multivariate_model(
        self, model_info: _models.MultivariateModelDetails, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.MultivariateModel:
        ...
        :type model_info: ~azure.ai.anomalydetector.models.MultivariateModelDetails
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
         will have to context manage the returned stream.
        :return: MultivariateModel. The MultivariateModel is compatible with MutableMapping
        :rtype: ~azure.ai.anomalydetector.models.MultivariateModel
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace_async
    async def train_multivariate_model(
        self, model_info: Union[_models.MultivariateModelDetails, JSON, IO], **kwargs: Any
    ) -> _models.MultivariateModel:
        """Train a Multivariate Anomaly Detection Model.
        ...
        :param model_info: Model information. Is one of the following types: MultivariateModelDetails,
         JSON, IO Required.
        :type model_info: ~azure.ai.anomalydetector.models.MultivariateModelDetails or JSON or IO
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.MultivariateModel] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.MultivariateModel, response.json())
    ...
    def list_multivariate_models(
    ...
    ) -> AsyncIterable["_models.MultivariateModel"]:
        ...
        :paramtype top: int
        :return: An iterator like instance of MultivariateModel
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.anomalydetector.models.MultivariateModel]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

        cls: ClsType[List[_models.MultivariateModel]] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(List[_models.MultivariateModel], deserialized["models"])
            if cls:
    ...
    @distributed_trace_async
    async def get_multivariate_model(self, model_id: str, **kwargs: Any) -> _models.MultivariateModel:
    ...
    async def detect_multivariate_batch_anomaly(
        self,
        model_id: str,
        options: _models.MultivariateBatchDetectionSettings,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.MultivariateDetectionResult:
        ...
        :type options: ~azure.ai.anomalydetector.models.MultivariateBatchDetectionSettings
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
    ...
    @distributed_trace_async
    async def detect_multivariate_batch_anomaly(
        self, model_id: str, options: Union[_models.MultivariateBatchDetectionSettings, JSON, IO], **kwargs: Any
    ) -> _models.MultivariateDetectionResult:
        """Detect Multivariate Anomaly.
        ...
        :param options: Request of multivariate anomaly detection. Is one of the following types:
         MultivariateBatchDetectionSettings, JSON, IO Required.
        :type options: ~azure.ai.anomalydetector.models.MultivariateBatchDetectionSettings or JSON or
         IO
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
        :paramtype content_type: str
    ...
    async def detect_multivariate_last_anomaly(
        self,
        model_id: str,
        options: _models.MultivariateLastDetectionSettings,
        *,
        content_type: str = "application/json",
        **kwargs: Any
        ...
        :type options: ~azure.ai.anomalydetector.models.MultivariateLastDetectionSettings
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
    ...
    @distributed_trace_async
    async def detect_multivariate_last_anomaly(
        self, model_id: str, options: Union[_models.MultivariateLastDetectionSettings, JSON, IO], **kwargs: Any
    ) -> _models.MultivariateLastDetectionResult:
        """Detect anomalies in the last point of the request body.
        ...
        :param options: Request of the last detection. Is one of the following types:
         MultivariateLastDetectionSettings, JSON, IO Required.
        :type options: ~azure.ai.anomalydetector.models.MultivariateLastDetectionSettings or JSON or IO
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
