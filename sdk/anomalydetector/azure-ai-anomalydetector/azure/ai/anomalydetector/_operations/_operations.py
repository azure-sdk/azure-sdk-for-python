...
def build_anomaly_detector_detect_univariate_last_anomaly_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class AnomalyDetectorClientOperationsMixin(AnomalyDetectorClientMixinABC):
    ...
    @overload
    def detect_univariate_last_anomaly(
        self, options: _models.UnivariateDetectionOptions, *, content_type: str = "application/json", **kwargs: Any
    ...
    def list_multivariate_models(
    ...
    ) -> Iterable["_models.MultivariateModel"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.anomalydetector.models.MultivariateModel]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    @distributed_trace
    def get_multivariate_model(self, model_id: str, **kwargs: Any) -> _models.MultivariateModel:
