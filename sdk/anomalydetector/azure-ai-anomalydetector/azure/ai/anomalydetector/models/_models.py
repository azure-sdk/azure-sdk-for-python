...
class AlignPolicy(_model_base.Model):
    ...
    :vartype align_mode: str or ~azure.ai.anomalydetector.models.MultivariateAlignMode
    ...
    :vartype fill_n_a_method: str or ~azure.ai.anomalydetector.models.MultivariateFillNaMethod
    :ivar padding_value: Field that's required when fillNAMethod is Fixed.
    :vartype padding_value: float
    """

    align_mode: Optional[Union[str, "_models.MultivariateAlignMode"]] = rest_field(name="alignMode")
    """Field that indicates how to align different variables to the same
     time range. Known values are: \"Inner\" and \"Outer\"."""
    fill_n_a_method: Optional[Union[str, "_models.MultivariateFillNaMethod"]] = rest_field(name="fillNAMethod")
    ...
    def __init__(
        self,
        *,
        align_mode: Optional[Union[str, "_models.MultivariateAlignMode"]] = None,
        fill_n_a_method: Optional[Union[str, "_models.MultivariateFillNaMethod"]] = None,
...
class AnomalyState(_model_base.Model):
    ...
    :vartype value: ~azure.ai.anomalydetector.models.DataPointDetails
    ...
    value: Optional["_models.DataPointDetails"] = rest_field()
    ...
    def __init__(
        ...
        *,
        ...
        value: Optional["_models.DataPointDetails"] = None,
...
class DataPointDetails(_model_base.Model):
...
class Error(_model_base.Model):
    ...
    :vartype details: list[~azure.ai.anomalydetector.models.Error]
    :ivar innererror: An object containing more specific information than the current object about
     the error.
    :vartype innererror: ~azure.ai.anomalydetector.models.InnerError
    """
...
class ErrorResponse(_model_base.Model):
    ...
    :vartype error: ~azure.ai.anomalydetector.models.Error
    """
...
class MultivariateBatchDetectionResultSummary(_model_base.Model):
    ...
    :vartype variable_states: list[~azure.ai.anomalydetector.models.MultivariateVariableState]
    ...
    :vartype setup_info: ~azure.ai.anomalydetector.models.MultivariateBatchDetectionSettings
    """
    ...
    variable_states: Optional[List["_models.MultivariateVariableState"]] = rest_field(name="variableStates")
    """Variable status."""
    setup_info: "_models.MultivariateBatchDetectionSettings" = rest_field(name="setupInfo")
    ...
    def __init__(
        ...
        *,
        ...
        setup_info: "_models.MultivariateBatchDetectionSettings",
        errors: Optional[List["_models.ErrorResponse"]] = None,
        variable_states: Optional[List["_models.MultivariateVariableState"]] = None,
    ):
        ...
...
class MultivariateBatchDetectionSettings(_model_base.Model):
    """Detection request for batch inference. This is an asynchronous inference that
    ...
    :ivar data_source: Source link to the input data to indicate an accessible Azure Storage URI.
     ...
     to be detected. Required.
    :vartype data_source: str
    :ivar top_contributor_count: Number of top contributed variables for one anomalous time stamp
     in the response.
    ...
    """Source link to the input data to indicate an accessible Azure Storage URI.
     ...
     contain at least slidingWindow entries preceding the start time of the data
     to be detected. Required."""
    top_contributor_count: Optional[int] = rest_field(name="topContributorCount")
    ...
    def __init__(
        ...
        *,
        ...
        top_contributor_count: Optional[int] = None,
    ):
        ...
...
class MultivariateDiagnosticDetails(_model_base.Model):
    """Diagnostics information to help inspect the states of a model or variable.

    :ivar model_state: Model status.
    :vartype model_state: ~azure.ai.anomalydetector.models.MultivariateModelState
    :ivar variable_states: Variable status.
    :vartype variable_states: list[~azure.ai.anomalydetector.models.MultivariateVariableState]
    """

    model_state: Optional["_models.MultivariateModelState"] = rest_field(name="modelState")
    """Model status."""
    variable_states: Optional[List["_models.MultivariateVariableState"]] = rest_field(name="variableStates")
    """Variable status."""
    ...
    def __init__(
        self,
        *,
        model_state: Optional["_models.MultivariateModelState"] = None,
        variable_states: Optional[List["_models.MultivariateVariableState"]] = None,
    ):
        ...
...
class MultivariateLastDetectionSettings(_model_base.Model):
    ...
    :vartype variables: list[~azure.ai.anomalydetector.models.MultivariateVariableValue]
    ...
    variables: List["_models.MultivariateVariableValue"] = rest_field()
    ...
    def __init__(
        self,
        *,
        variables: List["_models.MultivariateVariableValue"],
        top_contributor_count: Optional[int] = None,
    ):
        ...
...
class MultivariateModel(_model_base.Model):
    ...
    :ivar model_info: Training result of a model, including its status, errors, and diagnostics
     information.
    :vartype model_info: ~azure.ai.anomalydetector.models.MultivariateModelDetails
    """
    ...
    model_info: Optional["_models.MultivariateModelDetails"] = rest_field(name="modelInfo")
    ...
    def __init__(
        ...
        *,
        ...
        model_info: Optional["_models.MultivariateModelDetails"] = None,
    ):
        ...
...
class MultivariateModelDetails(_model_base.Model):
    """Training result of a model, including its status, errors, and diagnostics
    information.
    ...
    :vartype data_schema: str or ~azure.ai.anomalydetector.models.MultivariateDataSchema
    ...
    :vartype status: str or ~azure.ai.anomalydetector.models.MultivariateModelStatus
    ...
    :ivar diagnostics_info: Diagnostics information to help inspect the states of a model or
     variable.
    :vartype diagnostics_info: ~azure.ai.anomalydetector.models.MultivariateDiagnosticDetails
    """
    ...
    """Source link to the input data to indicate an accessible Azure Storage URI.
     It either points to an Azure Blob Storage folder or points to a CSV file in
     Azure Blob Storage, based on your data schema selection. Required."""
    data_schema: Optional[Union[str, "_models.MultivariateDataSchema"]] = rest_field(name="dataSchema")
    ...
    """Manner of aligning multiple variables."""
    status: Optional[Union[str, "_models.MultivariateModelStatus"]] = rest_field(readonly=True)
    ...
    diagnostics_info: Optional["_models.MultivariateDiagnosticDetails"] = rest_field(
        name="diagnosticsInfo", readonly=True
    )
    """Diagnostics information to help inspect the states of a model or variable."""
    ...
    def __init__(
        ...
        *,
        ...
        start_time: datetime.datetime,
        end_time: datetime.datetime,
        data_schema: Optional[Union[str, "_models.MultivariateDataSchema"]] = None,
...
class MultivariateModelState(_model_base.Model):
    """Model state.
...
class MultivariateVariableState(_model_base.Model):
    """Variable status.

    All required parameters must be populated in order to send to Azure.

    :ivar variable: Variable name in variable states. Required.
    :vartype variable: str
    ...
    """Variable name in variable states. Required."""
...
class MultivariateVariableValue(_model_base.Model):
    """Variable values.
...
class UnivariateChangePointDetectionOptions(_model_base.Model):
    ...
    :vartype series: list[~azure.ai.anomalydetector.models.UnivariateTimeSeriesPoint]
    ...
    :vartype granularity: str or ~azure.ai.anomalydetector.models.UnivariateTimeGranularity
    ...
    series: List["_models.UnivariateTimeSeriesPoint"] = rest_field()
    """Time series data points. Points should be sorted by time stamp in ascending
     order to match the change point detection result. Required."""
    granularity: Union[str, "_models.UnivariateTimeGranularity"] = rest_field()
    ...
    def __init__(
        self,
        *,
        series: List["_models.UnivariateTimeSeriesPoint"],
        granularity: Union[str, "_models.UnivariateTimeGranularity"],
...
class UnivariateDetectionOptions(_model_base.Model):
    ...
    """Time series data points. Points should be sorted by time stamp in ascending
     ...
     correctly or there's a duplicated time stamp, the API won't work. In such
     a case, an error message is returned. Required."""
    granularity: Optional[Union[str, "_models.UnivariateTimeGranularity"]] = rest_field()
    ...
    def __init__(
        ...
        *,
        series: List["_models.UnivariateTimeSeriesPoint"],
        granularity: Optional[Union[str, "_models.UnivariateTimeGranularity"]] = None,
        custom_interval: Optional[int] = None,
        period: Optional[int] = None,
...
class UnivariateEntireDetectionResult(_model_base.Model):
    ...
    :ivar is_anomaly_list: Anomaly properties for each input point. True means an
     anomaly (either negative or positive) has been detected. The index of the array
     is consistent with the input series. Required.
    :vartype is_anomaly_list: list[bool]
    :ivar is_negative_anomaly_list: Anomaly status in a negative direction for each input
     point. True means a negative anomaly has been detected. A negative anomaly
     means the point is detected as an anomaly and its real value is smaller than
     the expected one. The index of the array is consistent with the input series. Required.
    :vartype is_negative_anomaly_list: list[bool]
    :ivar is_positive_anomaly_list: Anomaly status in a positive direction for each input
     point. True means a positive anomaly has been detected. A positive anomaly
     means the point is detected as an anomaly and its real value is larger than the
     expected one. The index of the array is consistent with the input series. Required.
    :vartype is_positive_anomaly_list: list[bool]
    :ivar severities: Severity score for each input point. The larger the value is, the more
     severe the anomaly is. For normal points, the severity is always 0.
    :vartype severities: list[float]
    """
    ...
    """Lower margin of each input point. LowerMargin is used to
     ...
     ones on the client side. The index of the array is consistent with the input
     series. Required."""
    is_anomaly_list: List[bool] = rest_field(name="isAnomaly")
    """Anomaly properties for each input point. True means an
     anomaly (either negative or positive) has been detected. The index of the array
     is consistent with the input series. Required."""
    is_negative_anomaly_list: List[bool] = rest_field(name="isNegativeAnomaly")
    """Anomaly status in a negative direction for each input
     point. True means a negative anomaly has been detected. A negative anomaly
     means the point is detected as an anomaly and its real value is smaller than
     the expected one. The index of the array is consistent with the input series. Required."""
    is_positive_anomaly_list: List[bool] = rest_field(name="isPositiveAnomaly")
    """Anomaly status in a positive direction for each input
     point. True means a positive anomaly has been detected. A positive anomaly
     means the point is detected as an anomaly and its real value is larger than the
     expected one. The index of the array is consistent with the input series. Required."""
    severities: Optional[List[float]] = rest_field(name="severity")
    ...
    def __init__(
        ...
        *,
        ...
        is_negative_anomaly_list: List[bool],
        is_positive_anomaly_list: List[bool],
...
class UnivariateTimeSeriesPoint(_model_base.Model):
