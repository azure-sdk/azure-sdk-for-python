...
def build_operations_list_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = "/providers/Microsoft.Help/operations"
...
def build_diagnostic_resources_get_request(scope: str, diagnostics_resource_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/{scope}/providers/Microsoft.Help/diagnostics/{diagnosticsResourceName}"
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, "str", skip_quote=True),
        "diagnosticsResourceName": _SERIALIZER.url("diagnostics_resource_name", diagnostics_resource_name, "str"),
    }
...
def build_diagnostic_resources_create_request(  # pylint: disable=name-too-long
    scope: str, diagnostics_resource_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_solution_resources_get_request(scope: str, solution_resource_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/{scope}/providers/Microsoft.Help/solutions/{solutionResourceName}"
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, "str", skip_quote=True),
        "solutionResourceName": _SERIALIZER.url("solution_resource_name", solution_resource_name, "str"),
    }
...
def build_solution_resources_create_request(scope: str, solution_resource_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_solution_resources_update_request(scope: str, solution_resource_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_solution_resources_warm_up_request(scope: str, solution_resource_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/{scope}/providers/Microsoft.Help/solutions/{solutionResourceName}/warmup"
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, "str", skip_quote=True),
        "solutionResourceName": _SERIALIZER.url("solution_resource_name", solution_resource_name, "str"),
    }
...
def build_simplified_solutions_resources_get_request(  # pylint: disable=name-too-long
    scope: str, simplified_solutions_resource_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/{scope}/providers/Microsoft.Help/simplifiedSolutions/{simplifiedSolutionsResourceName}"
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, "str", skip_quote=True),
        "simplifiedSolutionsResourceName": _SERIALIZER.url(
            "simplified_solutions_resource_name", simplified_solutions_resource_name, "str"
        ),
    }
...
def build_simplified_solutions_resources_create_request(  # pylint: disable=name-too-long
    scope: str, simplified_solutions_resource_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_troubleshooter_resources_get_request(  # pylint: disable=name-too-long
    scope: str, troubleshooter_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/{scope}/providers/Microsoft.Help/troubleshooters/{troubleshooterName}"
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, "str", skip_quote=True),
        "troubleshooterName": _SERIALIZER.url("troubleshooter_name", troubleshooter_name, "str"),
    }
...
def build_troubleshooter_resources_create_request(  # pylint: disable=name-too-long
    scope: str, troubleshooter_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_troubleshooter_resources_continue_method_request(  # pylint: disable=name-too-long
    scope: str, troubleshooter_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/{scope}/providers/Microsoft.Help/troubleshooters/{troubleshooterName}/continue"
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, "str", skip_quote=True),
        "troubleshooterName": _SERIALIZER.url("troubleshooter_name", troubleshooter_name, "str"),
    }
...
def build_troubleshooter_resources_end_request(  # pylint: disable=name-too-long
    scope: str, troubleshooter_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/{scope}/providers/Microsoft.Help/troubleshooters/{troubleshooterName}/end"
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, "str", skip_quote=True),
        "troubleshooterName": _SERIALIZER.url("troubleshooter_name", troubleshooter_name, "str"),
    }
...
def build_troubleshooter_resources_restart_request(  # pylint: disable=name-too-long
    scope: str, troubleshooter_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/{scope}/providers/Microsoft.Help/troubleshooters/{troubleshooterName}/restart"
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, "str", skip_quote=True),
        "troubleshooterName": _SERIALIZER.url("troubleshooter_name", troubleshooter_name, "str"),
    }
...
def build_solution_resource_self_helps_get_request(  # pylint: disable=name-too-long
    solution_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/providers/Microsoft.Help/selfHelp/{solutionId}"
    path_format_arguments = {
        "solutionId": _SERIALIZER.url("solution_id", solution_id, "str"),
    }
...
def build_check_name_availability_operation_group_check_availability_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/{scope}/providers/Microsoft.Help/checkNameAvailability"
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, "str", skip_quote=True),
    }
...
def build_discovery_solution_operation_group_list_request(  # pylint: disable=name-too-long
    *, filter: Optional[str] = None, skiptoken: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/providers/Microsoft.Help/discoverySolutions"
...
def build_discovery_solution_nlp_operation_group_discover_solutions_request(  # pylint: disable=name-too-long
    **kwargs: Any,
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/providers/Microsoft.Help/discoverSolutions"
...
def build_discovery_solution_nlp_operation_group_discover_solutions_by_subscription_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/providers/Microsoft.Help/discoverSolutions"
    path_format_arguments = {
...
class Operations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.help.HelpClient`'s
    ...
    def begin_create(
        ...
        **kwargs: Any,
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns SolutionResource. The SolutionResource is
         compatible with MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.help.models.SolutionResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create(
        ...
        **kwargs: Any,
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns SimplifiedSolutionsResource. The
         SimplifiedSolutionsResource is compatible with MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.help.models.SimplifiedSolutionsResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
...
class DiscoverySolutionOperationGroupOperations:  # pylint: disable=name-too-long
    ...
    def list(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.help.models.SolutionMetadataResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
