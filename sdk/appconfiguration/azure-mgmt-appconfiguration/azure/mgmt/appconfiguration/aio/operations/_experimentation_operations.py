...
from ...operations._experimentation_operations import (
...
class ExperimentationOperations:
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.Experimentation"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appconfiguration.models.Experimentation]
    ...
    async def begin_create(
        ...
        **kwargs: Any
    ) -> AsyncLROPoller[_models.Experimentation]:
        ...
        :return: An instance of AsyncLROPoller that returns either Experimentation or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appconfiguration.models.Experimentation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.Experimentation].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.Experimentation](
