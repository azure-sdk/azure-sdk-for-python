...
class ConfigurationStoresOperations:
    ...
    def list(self, skip_token: Optional[str] = None, **kwargs: Any) -> Iterable["_models.ConfigurationStore"]:
        ...
        :param skip_token: A skip token is used to continue retrieving items after an operation returns
         ...
         subsequent calls. Test a trivial change. Default value is None.
        :type skip_token: str
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either ConfigurationStore or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appconfiguration.v2023_03_01.models.ConfigurationStore]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_deleted(self, **kwargs: Any) -> Iterable["_models.DeletedConfigurationStore"]:
        ...
        :return: An iterator like instance of either DeletedConfigurationStore or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appconfiguration.v2023_03_01.models.DeletedConfigurationStore]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
