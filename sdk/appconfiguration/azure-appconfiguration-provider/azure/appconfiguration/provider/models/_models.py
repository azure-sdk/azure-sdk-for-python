...
class KeyListResult(_model_base.Model):
    """The result of a list request.

    :ivar items_property: The collection value.
    :vartype items_property: list[~azure.appconfiguration.provider.models.Key]
    :ivar _next_link: The URI that can be used to request the next set of paged results.
    :vartype _next_link: str
    """

    items_property: Optional[List["_models.Key"]] = rest_field(name="items")
    """The collection value."""
    _next_link: Optional[str] = rest_field(name="@nextLink")
    ...
    def __init__(
        self,
        *,
        items_property: Optional[List["_models.Key"]] = None,
        _next_link: Optional[str] = None,
    ):
        ...
...
class KeyValueListResult(_model_base.Model):
    """The result of a list request.

    :ivar items_property: The collection value.
    :vartype items_property: list[~azure.appconfiguration.provider.models.KeyValue]
    ...
    items_property: Optional[List["_models.KeyValue"]] = rest_field(name="items")
    """The collection value."""
    etag: Optional[str] = rest_field()
    ...
    def __init__(
        self,
        *,
        items_property: Optional[List["_models.KeyValue"]] = None,
        etag: Optional[str] = None,
        _next_link: Optional[str] = None,
    ):
        ...
...
class LabelListResult(_model_base.Model):
    """The result of a list request.

    :ivar items_property: The collection value.
    :vartype items_property: list[~azure.appconfiguration.provider.models.Label]
    :ivar _next_link: The URI that can be used to request the next set of paged results.
    :vartype _next_link: str
    """

    items_property: Optional[List["_models.Label"]] = rest_field(name="items")
    """The collection value."""
    _next_link: Optional[str] = rest_field(name="@nextLink")
    """The URI that can be used to request the next set of paged results."""
    ...
    def __init__(
        self,
        *,
        items_property: Optional[List["_models.Label"]] = None,
        _next_link: Optional[str] = None,
    ):
        ...
...
class OperationDetails(_model_base.Model):
    ...
    :vartype status: str or ~azure.appconfiguration.provider.models.OperationState
    :ivar error: An error, available when the status is ``Failed``\ , describing why the operation
     failed.
    :vartype error: ~azure.appconfiguration.provider.models.Error
    """
...
class Snapshot(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar status: The current status of the snapshot. Known values are: "provisioning", "ready",
     "archived", and "failed".
    :vartype status: str or ~azure.appconfiguration.provider.models.SnapshotStatus
    :ivar filters: A list of filters used to filter the key-values included in the snapshot.
     Required.
    :vartype filters: list[~azure.appconfiguration.provider.models.KeyValueFilter]
    ...
    :vartype composition_type: str or ~azure.appconfiguration.provider.models.CompositionType
...
class SnapshotListResult(_model_base.Model):
    """The result of a snapshot list request.

    :ivar items_property: The collection value.
    :vartype items_property: list[~azure.appconfiguration.provider.models.Snapshot]
    :ivar _next_link: The URI that can be used to request the next set of paged results.
    :vartype _next_link: str
    """

    items_property: Optional[List["_models.Snapshot"]] = rest_field(name="items")
    """The collection value."""
    _next_link: Optional[str] = rest_field(name="@nextLink")
    """The URI that can be used to request the next set of paged results."""
    ...
    def __init__(
        self,
        *,
        items_property: Optional[List["_models.Snapshot"]] = None,
        _next_link: Optional[str] = None,
    ):
        ...
