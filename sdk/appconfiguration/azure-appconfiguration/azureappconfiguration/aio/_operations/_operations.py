...
class AzureAppConfigurationClientOperationsMixin(  # pylint: disable=too-many-public-methods,name-too-long
    ...
    def get_keys(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azureappconfiguration.models.Key]
    ...
    def get_key_values(
        ...
        **kwargs: Any
        ...
        :keyword select: Used to select what fields are present in the returned resource(s). Default
         value is None.
        :paramtype select: list[str or ~azureappconfiguration.models.ConfigurationSettingFields]
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azureappconfiguration.models.KeyValue]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def get_key_value(
        ...
        **kwargs: Any
        ...
        :rtype: ~azureappconfiguration.models.KeyValue
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def _put_key_value(
        ...
        **kwargs: Any
        ...
        :type entity: ~azureappconfiguration.models.KeyValue or JSON or IO[bytes]
    ...
    async def delete_key_value(
        ...
        **kwargs: Any
        ...
        :rtype: ~azureappconfiguration.models.KeyValue or None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def get_snapshots(
        ...
        **kwargs: Any
        ...
        :keyword select: Used to select what fields are present in the returned resource(s). Default
         value is None.
        :paramtype select: list[str or ~azureappconfiguration.models.SnapshotFields]
        :keyword status: Used to filter returned snapshots by their status property. Default value is
         None.
        :paramtype status: list[str or ~azureappconfiguration.models.SnapshotStatus]
        :keyword sync_token: Used to guarantee real-time consistency between requests. Default value is
         None.
        :paramtype sync_token: str
        :return: An iterator like instance of Snapshot
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azureappconfiguration.models.Snapshot]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def get_snapshot(
        ...
        **kwargs: Any
        ...
        :rtype: ~azureappconfiguration.models.Snapshot
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_operation_details(self, *, snapshot: str, **kwargs: Any) -> _models.OperationDetails:
        ...
        :rtype: ~azureappconfiguration.models.OperationDetails
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_snapshot(
        ...
        :type entity: ~azureappconfiguration.models.Snapshot
        ...
        :return: An instance of AsyncLROPoller that returns Snapshot. The Snapshot is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azureappconfiguration.models.Snapshot]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_snapshot(
        ...
        **kwargs: Any
        ...
        :param entity: The key-value snapshot to create. Is one of the following types: Snapshot, JSON,
         IO[bytes] Required.
        :type entity: ~azureappconfiguration.models.Snapshot or JSON or IO[bytes]
        :keyword sync_token: Used to guarantee real-time consistency between requests. Default value is
         None.
        :paramtype sync_token: str
        :return: An instance of AsyncLROPoller that returns Snapshot. The Snapshot is compatible with
    ...
    async def _update_snapshot(
        ...
        **kwargs: Any
        ...
        :type entity: ~azureappconfiguration.models.SnapshotUpdateParameters or JSON or IO[bytes]
        :keyword sync_token: Used to guarantee real-time consistency between requests. Default value is
         None.
        :paramtype sync_token: str
        :keyword etag: check if resource is changed. Set None to skip checking etag. Default value is
    ...
    def get_labels(
        ...
        **kwargs: Any
        ...
        :keyword select: Used to select what fields are present in the returned resource(s). Default
         value is None.
        :paramtype select: list[str or ~azureappconfiguration.models.LabelFields]
        :return: An iterator like instance of Label
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azureappconfiguration.models.Label]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
