...
class OperationDetails(_model_base.Model):
    ...
    :vartype status: str or ~azureappconfiguration.models.OperationState
...
class Snapshot(_model_base.Model):
    ...
    :ivar status: The current status of the snapshot. Known values are: "provisioning", "ready",
     "archived", and "failed".
    :vartype status: str or ~azureappconfiguration.models.SnapshotStatus
    :ivar filters: A list of filters used to filter the key-values included in the snapshot.
     Required.
    :vartype filters: list[~azureappconfiguration.models.KeyValueFilter]
    ...
    :vartype composition_type: str or ~azureappconfiguration.models.SnapshotComposition
