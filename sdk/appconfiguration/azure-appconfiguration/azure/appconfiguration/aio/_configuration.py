...
class AzureAppConfigurationClientConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long
    ...
    :param endpoint: App Configuration service endpoint. Required.
    :type endpoint: str
    ...
    def _infer_policy(self, **kwargs):
        if isinstance(self.credential, AzureKeyCredential):
            return policies.AzureKeyCredentialPolicy(self.credential, "Shared Access Signature Token", **kwargs)
        if isinstance(self.credential, AzureKeyCredential):
