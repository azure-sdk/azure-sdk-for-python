...
class Error(_model_base.Model):
    ...
    :vartype details: list[~azure.appconfiguration.models.Error]
...
class KeyListResult(_model_base.Model):
    ...
    :vartype items_property: list[~azure.appconfiguration.models.Key]
...
class KeyValueListResult(_model_base.Model):
    ...
    :ivar items_property: The collection value.
    :vartype items_property: list[~azure.appconfiguration.models.KeyValue]
...
class LabelListResult(_model_base.Model):
    ...
    :ivar items_property: The collection value.
    :vartype items_property: list[~azure.appconfiguration.models.Label]
    :ivar _next_link: The URI that can be used to request the next set of paged results.
    :vartype _next_link: str
    """
...
class SnapshotListResult(_model_base.Model):
    ...
    :ivar items_property: The collection value.
    :vartype items_property: list[~azure.appconfiguration.models.Snapshot]
    :ivar _next_link: The URI that can be used to request the next set of paged results.
    :vartype _next_link: str
    """
