...
class DataProduct(TrackedResource):
    ...
    :vartype identity: ~azure.mgmt.networkanalytics.models.ManagedServiceIdentityV4
    """

    properties: Optional["_models.DataProductProperties"] = rest_field()
...
class DataProductsCatalog(ProxyResource):
    ...
    properties: Optional["_models.DataProductsCatalogProperties"] = rest_field()
    """The resource-specific properties for this resource."""
...
class DataType(ProxyResource):
    ...
    properties: Optional["_models.DataTypeProperties"] = rest_field()
    """The resource-specific properties for this resource."""
