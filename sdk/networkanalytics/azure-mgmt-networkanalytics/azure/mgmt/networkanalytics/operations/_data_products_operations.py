...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.NetworkAnalytics/dataProducts"
    )
...
def build_add_user_role_request(
    resource_group_name: str, data_product_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_roles_assignments_request(
    resource_group_name: str, data_product_name: str, subscription_id: str, *, json: JSON, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_remove_user_role_request(
    resource_group_name: str, data_product_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class DataProductsOperations:
    ...
    def get(self, resource_group_name: str, data_product_name: str, **kwargs: Any) -> _models.DataProduct:
        ...
        deserialized = self._deserialize("DataProduct", pipeline_response.http_response)
    ...
    def add_user_role(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("RoleAssignmentDetail", pipeline_response.http_response)
    ...
    def generate_storage_account_sas_token(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("AccountSasToken", pipeline_response.http_response)
    ...
    def list_roles_assignments(
        ...
        deserialized = self._deserialize("ListRoleAssignments", pipeline_response.http_response)
