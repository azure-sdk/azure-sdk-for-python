...
# --------------------------------------------------------------------------
import pytest
from azure.mgmt.sapmonitors.aio import SapMonitorsMgmtClient
...
class TestSapMonitorsMgmtAlertTemplatesOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(SapMonitorsMgmtClient, is_async=True)
