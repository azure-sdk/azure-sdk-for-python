...
class SapMonitorsMgmtClient:
    """The workload SAP monitor Client.

    :ivar monitors: MonitorsOperations operations
    :vartype monitors: azure.mgmt.sapmonitors.operations.MonitorsOperations
    :ivar provider_instances: ProviderInstancesOperations operations
    :vartype provider_instances: azure.mgmt.sapmonitors.operations.ProviderInstancesOperations
    :ivar sap_landscape_monitor: SapLandscapeMonitorOperations operations
    :vartype sap_landscape_monitor: azure.mgmt.sapmonitors.operations.SapLandscapeMonitorOperations
    :ivar alerts: AlertsOperations operations
    :vartype alerts: azure.mgmt.sapmonitors.operations.AlertsOperations
    :ivar alert_templates: AlertTemplatesOperations operations
    :vartype alert_templates: azure.mgmt.sapmonitors.operations.AlertTemplatesOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        _endpoint = "{endpoint}"
        self._config = SapMonitorsMgmtClientConfiguration(
