    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "sapVirtualInstanceName": _SERIALIZER.url(
            "sap_virtual_instance_name", sap_virtual_instance_name, "str", pattern=r"^[A-Z][A-Z0-9]{2}$"
        ),
        "applicationInstanceName": _SERIALIZER.url(
            "application_instance_name", application_instance_name, "str", pattern=r"^.*"
        ),
    }
...
class SAPApplicationServerInstancesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.workloads.sapvirtualinstance.WorkloadsClient`'s
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.workloads.sapvirtualinstance.models.SAPApplicationServerInstance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(
        ...
        :return: An iterator like instance of either SAPApplicationServerInstance or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.workloads.sapvirtualinstance.models.SAPApplicationServerInstance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
