...
class MonitorsOperations:
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        monitor_name: str,
        properties: Union[_models.MonitorUpdateMonitorRequest, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "MonitorUpdateMonitorRequest")
    ...
    async def begin_update(
        ...
        resource_group_name: str,
        monitor_name: str,
        properties: _models.MonitorUpdateMonitorRequest,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.Monitor]:
        ...
        :type properties: ~azure.mgmt.workloads.sapmonitors.models.MonitorUpdateMonitorRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either Monitor or the result of
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param properties: The Update SAP workload monitor request body. Is either a
         MonitorUpdateMonitorRequest type or a IO[bytes] type. Required.
        :type properties: ~azure.mgmt.workloads.sapmonitors.models.MonitorUpdateMonitorRequest or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Monitor or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.workloads.sapmonitors.models.Monitor]
