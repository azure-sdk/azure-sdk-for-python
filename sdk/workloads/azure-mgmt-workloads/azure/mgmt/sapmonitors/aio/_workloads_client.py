...
from .operations import MonitorsOperations, Operations, ProviderInstancesOperations, SapLandscapeMonitorOperations
...
class WorkloadsClient:  # pylint: disable=client-accepts-api-version-keyword
