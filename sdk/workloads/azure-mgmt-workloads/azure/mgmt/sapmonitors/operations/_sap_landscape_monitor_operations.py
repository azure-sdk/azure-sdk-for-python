...
class SapLandscapeMonitorOperations:
    ...
    def list_by_monitor(
    ...
    ) -> Iterable["_models.SapLandscapeMonitorSapLandscapeMonitorResource"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.workloads.sapmonitors.models.SapLandscapeMonitorSapLandscapeMonitorResource]
