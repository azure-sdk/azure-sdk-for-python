...
from ._configuration import WorkloadsClientForTestingConfiguration
...
class WorkloadsClientForTesting:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = WorkloadsClientForTestingConfiguration(
