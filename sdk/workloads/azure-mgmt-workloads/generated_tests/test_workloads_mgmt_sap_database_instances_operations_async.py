...
,
    ...
    async def test_begin_update(self, resource_group):
        response = await (await self.client.sap_database_instances.begin_update(
            resource_group_name=resource_group.name,
            sap_virtual_instance_name="str"
,
            database_instance_name="str"
...
,
    ...
    async def test_begin_start_instance(self, resource_group):
        response = await (await self.client.sap_database_instances.begin_start_instance(
            resource_group_name=resource_group.name,
            sap_virtual_instance_name="str"
,
            database_instance_name="str"
...
,
    ...
    async def test_begin_stop_instance(self, resource_group):
        response = await (await self.client.sap_database_instances.begin_stop_instance(
            resource_group_name=resource_group.name,
            sap_virtual_instance_name="str"
,
            database_instance_name="str"
