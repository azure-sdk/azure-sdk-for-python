...
class TestWorkloadsMgmtSAPVirtualInstancesOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_begin_create(self, resource_group):
        response = await (await self.client.sap_virtual_instances.begin_create(
...
,
    ...
    async def test_begin_delete(self, resource_group):
        response = await (await self.client.sap_virtual_instances.begin_delete(
            resource_group_name=resource_group.name,
            sap_virtual_instance_name="str"
,
            api_version="2023-04-01"
...
,
    ...
    async def test_begin_start(self, resource_group):
        response = await (await self.client.sap_virtual_instances.begin_start(
            resource_group_name=resource_group.name,
            sap_virtual_instance_name="str"
,
            api_version="2023-04-01"
,
    ...
    async def test_begin_stop(self, resource_group):
        response = await (await self.client.sap_virtual_instances.begin_stop(
            resource_group_name=resource_group.name,
            sap_virtual_instance_name="str"
,
            api_version="2023-04-01"
