...
def main():
    ...
    response = client.provider_instances.begin_create(
        ...
        provider_instance_parameter={'properties': {'providerSettings': {'dbName': 'db', 'dbPassword': '****', 'dbPasswordUri': '', 'dbUsername': 'user', 'hostname': 'name', 'instanceNumber': '00', 'providerType': 'SapHana', 'sapSid': 'SID', 'sqlPort': '0000', 'sslCertificateUri': 'https://storageaccount.blob.core.windows.net/containername/filename', 'sslHostNameInCertificate': 'xyz.domain.com', 'sslPreference': 'ServerCertificate'}}},
    ).result()
    print(response)
