...
def main():
    ...
    response = client.sap_landscape_monitor.create(
        ...
        sap_landscape_monitor_parameter={'properties': {'grouping': {'landscape': [{'name': 'Prod', 'topSid': ['SID1', 'SID2']}], 'sapApplication': [{'name': 'ERP1', 'topSid': ['SID1', 'SID2']}]}, 'topMetricsThresholds': [{'green': 90, 'name': 'Instance Availability', 'red': 50, 'yellow': 75}]}},
    )
    print(response)
