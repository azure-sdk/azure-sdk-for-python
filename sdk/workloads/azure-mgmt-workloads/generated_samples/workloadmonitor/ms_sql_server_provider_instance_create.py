...
def main():
    ...
    response = client.provider_instances.begin_create(
        ...
        provider_instance_parameter={'properties': {'providerSettings': {'dbPassword': '****', 'dbPasswordUri': '', 'dbPort': '5912', 'dbUsername': 'user', 'hostname': 'hostname', 'providerType': 'MsSqlServer', 'sapSid': 'sid', 'sslCertificateUri': 'https://storageaccount.blob.core.windows.net/containername/filename', 'sslPreference': 'ServerCertificate'}}},
    ).result()
    print(response)
