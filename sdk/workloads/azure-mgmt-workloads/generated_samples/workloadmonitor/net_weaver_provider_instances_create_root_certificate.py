...
def main():
    ...
    response = client.provider_instances.begin_create(
        ...
        provider_instance_parameter={'properties': {'providerSettings': {'providerType': 'SapNetWeaver', 'sapClientId': '111', 'sapHostFileEntries': ['127.0.0.1 name fqdn'], 'sapHostname': 'name', 'sapInstanceNr': '00', 'sapPassword': '****', 'sapPasswordUri': '', 'sapPortNumber': '1234', 'sapSid': 'SID', 'sapUsername': 'username', 'sslPreference': 'RootCertificate'}}},
    ).result()
    print(response)
