...
def main():
    ...
    response = client.provider_instances.begin_create(
        ...
        provider_instance_parameter={'properties': {'providerSettings': {'clusterName': 'clusterName', 'hostname': 'hostname', 'prometheusUrl': 'http://192.168.0.0:9090/metrics', 'providerType': 'PrometheusHaCluster', 'sid': 'sid', 'sslPreference': 'RootCertificate'}}},
    ).result()
    print(response)
