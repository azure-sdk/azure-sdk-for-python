...
def main():
    ...
    response = client.provider_instances.begin_create(
        ...
        provider_instance_parameter={'properties': {'providerSettings': {'prometheusUrl': 'http://192.168.0.0:9090/metrics', 'providerType': 'PrometheusOS', 'sapSid': 'SID', 'sslCertificateUri': 'https://storageaccount.blob.core.windows.net/containername/filename', 'sslPreference': 'ServerCertificate'}}},
    ).result()
    print(response)
