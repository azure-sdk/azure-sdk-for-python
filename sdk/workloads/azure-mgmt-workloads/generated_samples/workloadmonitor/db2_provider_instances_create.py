...
def main():
    ...
    response = client.provider_instances.begin_create(
        ...
        provider_instance_parameter={'properties': {'providerSettings': {'dbName': 'dbName', 'dbPassword': 'password', 'dbPasswordUri': '', 'dbPort': 'dbPort', 'dbUsername': 'username', 'hostname': 'hostname', 'providerType': 'Db2', 'sapSid': 'SID', 'sslCertificateUri': 'https://storageaccount.blob.core.windows.net/containername/filename', 'sslPreference': 'ServerCertificate'}}},
    ).result()
    print(response)
