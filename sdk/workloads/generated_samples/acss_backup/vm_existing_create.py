...
from azure.mgmt.workloads.connector import ConnectorMgmtClient

"""
# PREREQUISITES
    pip install azure-identity
    pip install azure-mgmt-workloads-connector
# USAGE
    python vm_existing_create.py
...
def main():
    client = ConnectorMgmtClient(
        credential=DefaultAzureCredential(),
        subscription_id="8e17e36c-42e9-4cd5-a078-7b44883414e0",
    )

    response = client.acss_backup_connections.begin_create(
