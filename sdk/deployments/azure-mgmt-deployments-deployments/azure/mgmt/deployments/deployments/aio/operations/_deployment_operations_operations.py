...
class DeploymentOperationsOperations:
    ...
    async def get_at_scope(
        ...
        :rtype: ~azure.mgmt.deployments.deployments.models.DeploymentOperation
    ...
    def list_at_scope(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.deployments.deployments.models.DeploymentOperation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
