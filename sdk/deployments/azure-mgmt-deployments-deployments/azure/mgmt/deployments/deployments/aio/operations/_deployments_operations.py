...
from ...operations._deployments_operations import (
    build_calculate_template_hash_request,
    build_cancel_at_management_group_scope_request,
    build_cancel_at_scope_request,
    build_cancel_at_subscription_scope_request,
    build_cancel_at_tenant_scope_request,
    build_cancel_request,
    build_check_existence_at_management_group_scope_request,
    build_check_existence_at_scope_request,
    build_check_existence_at_subscription_scope_request,
    build_check_existence_at_tenant_scope_request,
    build_check_existence_request,
    build_create_or_update_at_management_group_scope_request,
    build_create_or_update_at_scope_request,
    build_create_or_update_at_subscription_scope_request,
    build_create_or_update_at_tenant_scope_request,
    build_create_or_update_request,
    build_delete_at_management_group_scope_request,
    build_delete_at_scope_request,
    build_delete_at_subscription_scope_request,
    build_delete_at_tenant_scope_request,
    build_delete_request,
    build_export_template_at_management_group_scope_request,
    build_export_template_at_scope_request,
    build_export_template_at_subscription_scope_request,
    build_export_template_at_tenant_scope_request,
    build_export_template_request,
    ...
    build_validate_at_management_group_scope_request,
    build_validate_at_scope_request,
    build_validate_at_subscription_scope_request,
    build_validate_at_tenant_scope_request,
    build_validate_request,
    build_what_if_at_management_group_scope_request,
    build_what_if_at_subscription_scope_request,
    build_what_if_at_tenant_scope_request,
    build_what_if_request,
)
...
class DeploymentsOperations:  # pylint: disable=too-many-public-methods
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.deployments.deployments.aio.DeploymentsClient`'s
    ...
    async def begin_create_or_update_at_scope(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.deployments.deployments.models.Deployment
        ...
        :return: An instance of AsyncLROPoller that returns either DeploymentExtended or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.deployments.deployments.models.DeploymentExtended]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update_at_scope(
        ...
        :type parameters: ~azure.mgmt.deployments.deployments.models.Deployment or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either DeploymentExtended or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.deployments.deployments.models.DeploymentExtended]
    ...
    async def get_at_scope(self, scope: str, deployment_name: str, **kwargs: Any) -> _models.DeploymentExtended:
        ...
        :rtype: ~azure.mgmt.deployments.deployments.models.DeploymentExtended
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_validate_at_scope(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.deployments.deployments.models.DeploymentValidateResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def export_template_at_scope(
        ...
        :rtype: ~azure.mgmt.deployments.deployments.models.DeploymentExportResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_at_scope(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.deployments.deployments.models.DeploymentExtended]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def begin_create_or_update_at_tenant_scope(
        ...
        **kwargs: Any
        ...
        :type deployment_name: str
        :param parameters: Additional parameters supplied to the operation. Required.
        :type parameters: ~azure.mgmt.deployments.deployments.models.ScopedDeployment
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either DeploymentExtended or the result of
    ...
    async def begin_create_or_update_at_tenant_scope(
        ...
        :type parameters: ~azure.mgmt.deployments.deployments.models.ScopedDeployment or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either DeploymentExtended or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.deployments.deployments.models.DeploymentExtended]
    ...
    async def begin_what_if_at_tenant_scope(
        ...
        **kwargs: Any
        ...
        :type deployment_name: str
        :param parameters: Parameters to validate. Required.
        :type parameters: ~azure.mgmt.deployments.deployments.models.ScopedDeploymentWhatIf
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either WhatIfOperationResult or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.deployments.deployments.models.WhatIfOperationResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_what_if_at_tenant_scope(
        ...
        :type parameters: ~azure.mgmt.deployments.deployments.models.ScopedDeploymentWhatIf or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either WhatIfOperationResult or the result
         of cls(response)
        :rtype:
    ...
    async def begin_what_if_at_subscription_scope(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.deployments.deployments.models.DeploymentWhatIf
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either WhatIfOperationResult or the result
    ...
    async def begin_what_if_at_subscription_scope(
        ...
        :param parameters: Parameters to What If. Is either a DeploymentWhatIf type or a IO[bytes]
         type. Required.
        :type parameters: ~azure.mgmt.deployments.deployments.models.DeploymentWhatIf or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either WhatIfOperationResult or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.deployments.deployments.models.WhatIfOperationResult]
    ...
    async def calculate_template_hash(self, template: JSON, **kwargs: Any) -> _models.TemplateHashResult:
        ...
        :rtype: ~azure.mgmt.deployments.deployments.models.TemplateHashResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
