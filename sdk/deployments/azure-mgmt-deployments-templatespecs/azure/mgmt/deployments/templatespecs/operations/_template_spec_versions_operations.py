...
def build_list_built_ins_request(template_spec_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_get_built_in_request(template_spec_name: str, template_spec_version: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class TemplateSpecVersionsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.deployments.templatespecs.TemplateSpecsClient`'s
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type template_spec_version_model:
         ~azure.mgmt.deployments.templatespecs.models.TemplateSpecVersion
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: TemplateSpecVersion or the result of cls(response)
        :rtype: ~azure.mgmt.deployments.templatespecs.models.TemplateSpecVersion
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type template_spec_version_model:
         ~azure.mgmt.deployments.templatespecs.models.TemplateSpecVersion or IO[bytes]
        :return: TemplateSpecVersion or the result of cls(response)
        :rtype: ~azure.mgmt.deployments.templatespecs.models.TemplateSpecVersion
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type template_spec_version_update_model:
         ~azure.mgmt.deployments.templatespecs.models.TemplateSpecVersionUpdateModel
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: TemplateSpecVersion or the result of cls(response)
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :param template_spec_version_update_model: Template Spec Version resource with the tags to be
         ...
         None.
        :type template_spec_version_update_model:
         ~azure.mgmt.deployments.templatespecs.models.TemplateSpecVersionUpdateModel or IO[bytes]
        :return: TemplateSpecVersion or the result of cls(response)
        :rtype: ~azure.mgmt.deployments.templatespecs.models.TemplateSpecVersion
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.deployments.templatespecs.models.TemplateSpecVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_built_ins(self, template_spec_name: str, **kwargs: Any) -> Iterable["_models.TemplateSpecVersion"]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_built_ins_request(
                    template_spec_name=template_spec_name,
                    api_version=api_version,
                    headers=_headers,
                    params=_params,
    ...
    def get_built_in(
        ...
        _request = build_get_built_in_request(
            template_spec_name=template_spec_name,
            template_spec_version=template_spec_version,
            api_version=api_version,
            headers=_headers,
