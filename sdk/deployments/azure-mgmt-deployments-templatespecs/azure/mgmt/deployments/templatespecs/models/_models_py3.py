...
class AzureResourceBase(_serialization.Model):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.deployments.templatespecs.models.SystemData
    """
...
class ErrorResponse(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.deployments.templatespecs.models.ErrorResponse]
    :ivar additional_info: The error additional info.
    :vartype additional_info:
     list[~azure.mgmt.deployments.templatespecs.models.ErrorAdditionalInfo]
    """
...
class SystemData(_serialization.Model):
    ...
    :vartype created_by_type: str or ~azure.mgmt.deployments.templatespecs.models.CreatedByType
    ...
    :vartype last_modified_by_type: str or
     ~azure.mgmt.deployments.templatespecs.models.CreatedByType
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword created_by_type: The type of identity that created the resource. Known values are:
         "User", "Application", "ManagedIdentity", and "Key".
        :paramtype created_by_type: str or ~azure.mgmt.deployments.templatespecs.models.CreatedByType
...
class TemplateSpec(AzureResourceBase):
    ...
    :vartype versions: dict[str,
     ~azure.mgmt.deployments.templatespecs.models.TemplateSpecVersionInfo]
    """
...
class TemplateSpecsError(_serialization.Model):
    ...
    :vartype error: ~azure.mgmt.deployments.templatespecs.models.ErrorResponse
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorResponse"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~azure.mgmt.deployments.templatespecs.models.ErrorResponse
        """
        super().__init__(**kwargs)
        self.error = error
...
class TemplateSpecsListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.deployments.templatespecs.models.TemplateSpec]
    ...
    def __init__(self, *, value: Optional[List["_models.TemplateSpec"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.deployments.templatespecs.models.TemplateSpec]
        """
        super().__init__(**kwargs)
        self.value = value
...
class TemplateSpecVersion(AzureResourceBase):
    ...
    :vartype linked_templates:
     list[~azure.mgmt.deployments.templatespecs.models.LinkedTemplateArtifact]
...
class TemplateSpecVersionsListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.deployments.templatespecs.models.TemplateSpecVersion]
    :ivar next_link: The URL to use for getting the next set of results.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: Optional[List["_models.TemplateSpecVersion"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.deployments.templatespecs.models.TemplateSpecVersion]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link: Optional[str] = None
