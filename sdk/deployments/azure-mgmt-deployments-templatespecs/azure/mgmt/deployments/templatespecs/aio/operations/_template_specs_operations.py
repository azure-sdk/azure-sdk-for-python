...
class TemplateSpecsOperations:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type template_spec: ~azure.mgmt.deployments.templatespecs.models.TemplateSpec
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: TemplateSpec or the result of cls(response)
        :rtype: ~azure.mgmt.deployments.templatespecs.models.TemplateSpec
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type template_spec: ~azure.mgmt.deployments.templatespecs.models.TemplateSpec or IO[bytes]
        :return: TemplateSpec or the result of cls(response)
        :rtype: ~azure.mgmt.deployments.templatespecs.models.TemplateSpec
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :param template_spec: Template Spec resource with the tags to be updated. Default value is
         None.
        :type template_spec: ~azure.mgmt.deployments.templatespecs.models.TemplateSpecUpdateModel
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: TemplateSpec or the result of cls(response)
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type template_spec: ~azure.mgmt.deployments.templatespecs.models.TemplateSpecUpdateModel or
         IO[bytes]
        :return: TemplateSpec or the result of cls(response)
        :rtype: ~azure.mgmt.deployments.templatespecs.models.TemplateSpec
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :type expand: str or ~azure.mgmt.deployments.templatespecs.models.TemplateSpecExpandKind
        :return: TemplateSpec or the result of cls(response)
        :rtype: ~azure.mgmt.deployments.templatespecs.models.TemplateSpec
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_subscription(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.deployments.templatespecs.models.TemplateSpec]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
