...
class TemplateSpecsClient:
    ...
    :vartype template_specs:
     azure.mgmt.deployments.templatespecs.aio.operations.TemplateSpecsOperations
    :ivar template_spec_versions: TemplateSpecVersionsOperations operations
    :vartype template_spec_versions:
     azure.mgmt.deployments.templatespecs.aio.operations.TemplateSpecVersionsOperations
