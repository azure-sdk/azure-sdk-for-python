...
from ...operations._template_spec_versions_operations import (
    ...
    build_get_built_in_request,
    build_get_request,
    build_list_built_ins_request,
    build_list_request,
...
class TemplateSpecVersionsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.deployments.templatespecs.aio.TemplateSpecsClient`'s
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.deployments.templatespecs.models.TemplateSpecVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
