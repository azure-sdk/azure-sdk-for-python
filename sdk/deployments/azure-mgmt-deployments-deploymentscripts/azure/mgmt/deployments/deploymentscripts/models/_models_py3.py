...
class DeploymentScript(AzureResourceBase):
    ...
    :vartype identity: ~azure.mgmt.deployments.deploymentscripts.models.ManagedServiceIdentity
    ...
    :vartype kind: str or ~azure.mgmt.deployments.deploymentscripts.models.ScriptType
    :ivar system_data: The system metadata related to this resource.
    :vartype system_data: ~azure.mgmt.deployments.deploymentscripts.models.SystemData
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword identity: Optional property. Managed identity to be used for this deployment script.
         Currently, only user-assigned MSI is supported.
        :paramtype identity: ~azure.mgmt.deployments.deploymentscripts.models.ManagedServiceIdentity
...
class AzureCliScript(DeploymentScript):
    ...
    :vartype container_settings:
     ~azure.mgmt.deployments.deploymentscripts.models.ContainerConfiguration
    :ivar storage_account_settings: Storage Account settings.
    :vartype storage_account_settings:
     ~azure.mgmt.deployments.deploymentscripts.models.StorageAccountConfiguration
    ...
    :vartype cleanup_preference: str or
     ~azure.mgmt.deployments.deploymentscripts.models.CleanupOptions
    ...
    :vartype provisioning_state: str or
     ~azure.mgmt.deployments.deploymentscripts.models.ScriptProvisioningState
    :ivar status: Contains the results of script execution.
    :vartype status: ~azure.mgmt.deployments.deploymentscripts.models.ScriptStatus
    ...
    :vartype environment_variables:
     list[~azure.mgmt.deployments.deploymentscripts.models.EnvironmentVariable]
...
class ContainerConfiguration(_serialization.Model):
    ...
    :vartype subnet_ids:
     list[~azure.mgmt.deployments.deploymentscripts.models.ContainerGroupSubnetId]
    """
...
class DeploymentScriptListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.deployments.deploymentscripts.models.DeploymentScript]
    ...
    def __init__(self, *, value: Optional[List["_models.DeploymentScript"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.deployments.deploymentscripts.models.DeploymentScript]
        """
        super().__init__(**kwargs)
        self.value = value
...
class DeploymentScriptsError(_serialization.Model):
    ...
    :vartype error: ~azure.mgmt.deployments.deploymentscripts.models.ErrorResponse
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorResponse"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~azure.mgmt.deployments.deploymentscripts.models.ErrorResponse
        """
        super().__init__(**kwargs)
        self.error = error
...
class ErrorResponse(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.deployments.deploymentscripts.models.ErrorResponse]
    :ivar additional_info: The error additional info.
    :vartype additional_info:
     list[~azure.mgmt.deployments.deploymentscripts.models.ErrorAdditionalInfo]
    """
...
class ManagedServiceIdentity(_serialization.Model):
    ...
    :vartype type: str or
     ~azure.mgmt.deployments.deploymentscripts.models.ManagedServiceIdentityType
    ...
    :vartype user_assigned_identities: dict[str,
     ~azure.mgmt.deployments.deploymentscripts.models.UserAssignedIdentity]
    """
...
class ScriptLogsList(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.deployments.deploymentscripts.models.ScriptLog]
    """
    ...
    def __init__(self, *, value: Optional[List["_models.ScriptLog"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.deployments.deploymentscripts.models.ScriptLog]
        """
        super().__init__(**kwargs)
        self.value = value
...
class SystemData(_serialization.Model):
    ...
    :vartype created_by_type: str or ~azure.mgmt.deployments.deploymentscripts.models.CreatedByType
    ...
    :vartype last_modified_by_type: str or
     ~azure.mgmt.deployments.deploymentscripts.models.CreatedByType
