...
def build_get_request(resource_group_name: str, script_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_get_logs_default_request(
...
class DeploymentScriptsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.deployments.deploymentscripts.DeploymentScriptsClient`'s
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type deployment_script: ~azure.mgmt.deployments.deploymentscripts.models.DeploymentScript
        ...
        :return: An instance of LROPoller that returns either DeploymentScript or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.deployments.deploymentscripts.models.DeploymentScript]
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type deployment_script: ~azure.mgmt.deployments.deploymentscripts.models.DeploymentScript or
         IO[bytes]
        :return: An instance of LROPoller that returns either DeploymentScript or the result of
         cls(response)
        :rtype:
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type deployment_script:
         ~azure.mgmt.deployments.deploymentscripts.models.DeploymentScriptUpdateParameter
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: DeploymentScript or the result of cls(response)
        :rtype: ~azure.mgmt.deployments.deploymentscripts.models.DeploymentScript
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type deployment_script:
         ~azure.mgmt.deployments.deploymentscripts.models.DeploymentScriptUpdateParameter or IO[bytes]
        :return: DeploymentScript or the result of cls(response)
        :rtype: ~azure.mgmt.deployments.deploymentscripts.models.DeploymentScript
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.DeploymentScript"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.deployments.deploymentscripts.models.DeploymentScript]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def get_logs(self, resource_group_name: str, script_name: str, **kwargs: Any) -> _models.ScriptLogsList:
        ...
        :rtype: ~azure.mgmt.deployments.deploymentscripts.models.ScriptLogsList
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def get_logs_default(
        ...
        :rtype: ~azure.mgmt.deployments.deploymentscripts.models.ScriptLog
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
