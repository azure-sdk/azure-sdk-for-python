...
def build_get_request(
    resource_group_name: str, account_name: str, streaming_policy_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "accountName": _SERIALIZER.url("account_name", account_name, "str"),
        "streamingPolicyName": _SERIALIZER.url("streaming_policy_name", streaming_policy_name, "str"),
    }
...
class StreamingPoliciesOperations:
    ...
    def list(
        ...
        orderby: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.StreamingPolicy"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.media.models.StreamingPolicy]
