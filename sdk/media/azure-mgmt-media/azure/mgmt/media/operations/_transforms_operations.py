...
def build_get_request(
    resource_group_name: str, account_name: str, transform_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class TransformsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either Transform or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.media.models.Transform]
    ...
    @distributed_trace
    def get(self, resource_group_name: str, account_name: str, transform_name: str, **kwargs: Any) -> _models.Transform:
        """Get Transform.
    ...
    def create_or_update(
        ...
        account_name: str,
        transform_name: str,
        parameters: Union[_models.Transform, IO],
        **kwargs: Any
    ) -> _models.Transform:
        """Create or Update Transform.
    ...
    def delete(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, account_name: str, transform_name: str, **kwargs: Any
    ) -> None:
        """Delete Transform.
