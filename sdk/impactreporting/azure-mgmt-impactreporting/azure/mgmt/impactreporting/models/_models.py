...
class ClientIncidentDetails(_model_base.Model):
    ...
    client_incident_id: Optional[str] = rest_field(name="clientIncidentId")
    """Client incident id. ex : id of the incident created to investigate and address the impact if
     any."""
    client_incident_source: Optional[Union[str, "_models.IncidentSource"]] = rest_field(name="clientIncidentSource")
...
class Connectivity(_model_base.Model):
    ...
    source: Optional["_models.SourceOrTarget"] = rest_field()
    """Source from which the connection was attempted."""
    target: Optional["_models.SourceOrTarget"] = rest_field()
...
class ConnectorProperties(_model_base.Model):
    ...
    connector_type: Union[str, "_models.Platform"] = rest_field(name="connectorType")
...
class ConnectorUpdateProperties(_model_base.Model):
    ...
    connector_type: Optional[Union[str, "_models.Platform"]] = rest_field(name="connectorType")
...
class ImpactCategoryProperties(_model_base.Model):
    ...
    """Resource provisioning state. Known values are: \"Succeeded\", \"Failed\", and \"Canceled\"."""
    category_id: str = rest_field(name="categoryId")
    """Unique ID of the category. Required."""
    parent_category_id: Optional[str] = rest_field(name="parentCategoryId")
...
class ImpactDetails(_model_base.Model):
    ...
    impacted_resource_id: str = rest_field(name="impactedResourceId")
    ...
    impact_id: str = rest_field(name="impactId")
...
class InsightProperties(_model_base.Model):
    ...
    event_id: Optional[str] = rest_field(name="eventId")
    ...
    content: "_models.Content" = rest_field()
    """Contains title & description for the insight. Required."""
    event_time: Optional[datetime.datetime] = rest_field(name="eventTime", format="rfc3339")
    """Time of the event, which has been correlated the impact."""
    insight_unique_id: str = rest_field(name="insightUniqueId")
    """unique id of the insight. Required."""
    impact: "_models.ImpactDetails" = rest_field()
    """details of of the impact for which insight has been generated. Required."""
    additional_details: Optional[Any] = rest_field(name="additionalDetails")
...
class Performance(_model_base.Model):
    ...
    metric_name: Optional[str] = rest_field(name="metricName")
    """Name of the Metric examples:  Disk, IOPs, CPU, GPU, Memory, details can be found from
     /impactCategories API."""
    expected: Optional[float] = rest_field()
    """Threshold value for the metric."""
    actual: Optional[float] = rest_field()
    """Observed value for the metric."""
    expected_value_range: Optional["_models.ExpectedValueRange"] = rest_field(name="expectedValueRange")
    """Max and Min Threshold values for the metric."""
...
class RequiredImpactProperties(_model_base.Model):
    ...
    allowed_values: Optional[List[str]] = rest_field(name="allowedValues")
...
class WorkloadImpactProperties(_model_base.Model):
    ...
    """Resource provisioning state. Known values are: \"Succeeded\", \"Failed\", and \"Canceled\"."""
    start_date_time: datetime.datetime = rest_field(name="startDateTime", format="rfc3339")
    ...
    impact_category: str = rest_field(name="impactCategory")
    """Category of the impact,  details can found from /impactCategories API. Required."""
    impact_description: Optional[str] = rest_field(name="impactDescription")
    """A detailed description of the impact."""
    arm_correlation_ids: Optional[List[str]] = rest_field(name="armCorrelationIds")
    ...
    additional_properties: Optional[Any] = rest_field(name="additionalProperties")
    """Additional fields related to impact, applicable fields per resource type are list under
     /impactCategories API."""
    error_details: Optional["_models.ErrorDetailProperties"] = rest_field(name="errorDetails")
    """ARM error code and error message associated with the impact."""
    workload: Optional["_models.Workload"] = rest_field()
    """Information about the impacted workload."""
    impact_group_id: Optional[str] = rest_field(name="impactGroupId")
    """Use this field to group impacts."""
    confidence_level: Optional[Union[str, "_models.ConfidenceLevel"]] = rest_field(name="confidenceLevel")
    """Degree of confidence on the impact being a platform issue. Known values are: \"Low\",
     \"Medium\", and \"High\"."""
    client_incident_details: Optional["_models.ClientIncidentDetails"] = rest_field(name="clientIncidentDetails")
    """Client incident details ex: incidentId , incident source."""
