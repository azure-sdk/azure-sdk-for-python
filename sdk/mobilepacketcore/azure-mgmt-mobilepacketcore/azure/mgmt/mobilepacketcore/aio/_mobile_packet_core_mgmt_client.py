...
from ._configuration import MobilePacketCoreMgmtClientConfiguration
...
class MobilePacketCoreMgmtClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = MobilePacketCoreMgmtClientConfiguration(
