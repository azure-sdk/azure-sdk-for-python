...
class DataLakeStoreAccountsOperations:
    ...
    def add(  # pylint: disable=inconsistent-return-statements
        ...
        account_name: str,
        data_lake_store_account_name: str,
        parameters: Optional[Union[_models.AddDataLakeStoreParameters, IO[bytes]]] = None,
        **kwargs: Any
    ) -> None:
        """Updates the specified Data Lake Analytics account to include the additional Data Lake Store
        account.
        ...
        :param data_lake_store_account_name: The name of the Data Lake Store account to add. Required.
        :type data_lake_store_account_name: str
        :param parameters: The details of the Data Lake Store account. Is either a
         AddDataLakeStoreParameters type or a IO[bytes] type. Default value is None.
    ...
    def get(
        ...
        deserialized = self._deserialize("DataLakeStoreAccountInformation", pipeline_response.http_response)
