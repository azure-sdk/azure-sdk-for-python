...
class ComputePoliciesOperations:
    ...
    def create_or_update(
        ...
        account_name: str,
        compute_policy_name: str,
        parameters: Union[_models.CreateOrUpdateComputePolicyParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.ComputePolicy:
        """Creates or updates the specified compute policy. During update, the compute policy with the
        specified name will be replaced with this new compute policy. An account supports, at most, 50
        ...
        :param parameters: Parameters supplied to create or update the compute policy. The max degree
         ...
         either a CreateOrUpdateComputePolicyParameters type or a IO[bytes] type. Required.
        :type parameters:
         ~azure.mgmt.datalake.analytics.account.models.CreateOrUpdateComputePolicyParameters or
         IO[bytes]
        :return: ComputePolicy or the result of cls(response)
        :rtype: ~azure.mgmt.datalake.analytics.account.models.ComputePolicy
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        deserialized = self._deserialize("ComputePolicy", pipeline_response.http_response)
    ...
    def update(
        ...
        account_name: str,
        compute_policy_name: str,
        parameters: Optional[Union[_models.UpdateComputePolicyParameters, IO[bytes]]] = None,
        **kwargs: Any
    ) -> _models.ComputePolicy:
        """Updates the specified compute policy.
        ...
        :param compute_policy_name: The name of the compute policy to update. Required.
        :type compute_policy_name: str
        :param parameters: Parameters supplied to update the compute policy. Is either a
         UpdateComputePolicyParameters type or a IO[bytes] type. Default value is None.
        :type parameters: ~azure.mgmt.datalake.analytics.account.models.UpdateComputePolicyParameters
         or IO[bytes]
        :return: ComputePolicy or the result of cls(response)
        :rtype: ~azure.mgmt.datalake.analytics.account.models.ComputePolicy
