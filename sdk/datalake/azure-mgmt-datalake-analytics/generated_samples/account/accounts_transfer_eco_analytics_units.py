...
# USAGE
    python accounts_transfer_eco_analytics_units.py
...
def main():
    ...
    client.accounts.transfer_eco_analytics_units(
...
# x-ms-original-file: specification/datalake-analytics/resource-manager/Microsoft.DataLakeAnalytics/preview/2019-11-01-preview/examples/Accounts_TransferEcoAnalyticsUnits.json
