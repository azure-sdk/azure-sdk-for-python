...
class TestDataLakeAnalyticsAccountManagementAccountsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_accounts_transfer_analytics_units(self, resource_group):
        response = await self.client.accounts.transfer_analytics_units(
            resource_group_name=resource_group.name,
            account_name="str",
            parameters={
                "newSystemMax": 0,
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_accounts_transfer_eco_analytics_units(self, resource_group):
        response = await self.client.accounts.transfer_eco_analytics_units(
            resource_group_name=resource_group.name,
            account_name="str",
            parameters={
                "newSystemMax": 0,
