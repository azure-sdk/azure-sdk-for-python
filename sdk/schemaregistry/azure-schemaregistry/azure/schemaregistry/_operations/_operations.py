...
class SchemaRegistryClientOperationsMixin(SchemaRegistryClientMixinABC):  # pylint: disable=abstract-class-instantiated
    ...
    @distributed_trace
    def list_schema_groups(self, **kwargs: Any) -> Iterable["_models._models.SchemaGroup"]:
    ...
    @distributed_trace
    def list_schema_versions(self, group_name: str, name: str, **kwargs: Any) -> Iterable["_models._models.Version"]:
