...
class SchemaRegistryClientOperationsMixin(SchemaRegistryClientMixinABC):  # pylint: disable=abstract-class-instantiated
    ...
    @distributed_trace
    def list_schema_groups(self, **kwargs: Any) -> AsyncIterable["_models._models.SchemaGroup"]:
        ...
        cls: ClsType[List[_models._models.SchemaGroup]] = kwargs.pop("cls", None)  # pylint: disable=protected-access
    ...
    async def get_schema_by_id(self, id: str, **kwargs: Any) -> bytes:
    ...
    def list_schema_versions(
        ...
        cls: ClsType[List[_models._models.Version]] = kwargs.pop("cls", None)  # pylint: disable=protected-access
    ...
    @distributed_trace_async
    async def get_schema_by_version(self, group_name: str, name: str, schema_version: int, **kwargs: Any) -> bytes:
