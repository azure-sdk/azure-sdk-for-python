...
def main():
    ...
    response = client.exposure_control.get_feature_value_by_factory(
        resource_group_name="exampleResourceGroup",
        factory_name="exampleFactoryName",
        exposure_control_request={"featureName": "ADFIntegrationRuntimeSharingRbac", "featureType": "Feature"},
    )
    print(response)
