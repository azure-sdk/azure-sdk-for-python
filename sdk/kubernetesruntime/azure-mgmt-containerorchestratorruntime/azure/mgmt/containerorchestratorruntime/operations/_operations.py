...
def build_storage_class_get_request(resource_uri: str, storage_class_name: str, **kwargs: Any) -> HttpRequest:
...
def build_storage_class_create_or_update_request(  # pylint: disable=name-too-long
    resource_uri: str, storage_class_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_storage_class_update_request(resource_uri: str, storage_class_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_storage_class_delete_request(resource_uri: str, storage_class_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_storage_class_list_request(resource_uri: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_operations_list_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = "/providers/Microsoft.KubernetesRuntime/operations"
...
def build_load_balancers_get_request(resource_uri: str, load_balancer_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_load_balancers_create_or_update_request(  # pylint: disable=name-too-long
    resource_uri: str, load_balancer_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_load_balancers_delete_request(resource_uri: str, load_balancer_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_load_balancers_list_request(resource_uri: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_bgp_peers_get_request(resource_uri: str, bgp_peer_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_bgp_peers_create_or_update_request(resource_uri: str, bgp_peer_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_bgp_peers_delete_request(resource_uri: str, bgp_peer_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_bgp_peers_list_request(resource_uri: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_services_get_request(resource_uri: str, service_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_services_create_or_update_request(resource_uri: str, service_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_services_delete_request(resource_uri: str, service_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_services_list_request(resource_uri: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class StorageClassOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.containerorchestratorruntime.ContainerOrchestratorRuntimeMgmtClient`'s
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
    ) -> LROPoller[_models.StorageClassResource]:
        ...
        :return: An instance of LROPoller that returns StorageClassResource. The StorageClassResource
         is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerorchestratorruntime.models.StorageClassResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.StorageClassResource].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.StorageClassResource](
    ...
    @distributed_trace
    def begin_delete(self, resource_uri: str, storage_class_name: str, **kwargs: Any) -> LROPoller[None]:
    ...
    @distributed_trace
    def list(self, resource_uri: str, **kwargs: Any) -> Iterable["_models.StorageClassResource"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerorchestratorruntime.models.StorageClassResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class Operations:
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.Operation"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.containerorchestratorruntime.models.Operation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class LoadBalancersOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns LoadBalancer. The LoadBalancer is compatible
         with MutableMapping
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerorchestratorruntime.models.LoadBalancer]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace
    def list(self, resource_uri: str, **kwargs: Any) -> Iterable["_models.LoadBalancer"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerorchestratorruntime.models.LoadBalancer]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class BgpPeersOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns BgpPeer. The BgpPeer is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.containerorchestratorruntime.models.BgpPeer]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.BgpPeer].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.BgpPeer](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
    ...
    @distributed_trace
    def list(self, resource_uri: str, **kwargs: Any) -> Iterable["_models.BgpPeer"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.containerorchestratorruntime.models.BgpPeer]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class ServicesOperations:
    ...
    @distributed_trace
    def list(self, resource_uri: str, **kwargs: Any) -> Iterable["_models.ServiceResource"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerorchestratorruntime.models.ServiceResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
