...
class ExperimentsOperations:
    ...
    def begin_cancel(
    ...
    ) -> LROPoller[_models.PostActionResult]:
        ...
        :param experiment_name: String that represents a Experiment resource name. Required.
        :type experiment_name: str
        :return: An instance of LROPoller that returns either PostActionResult or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.chaos.models.PostActionResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.PostActionResult].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.PostActionResult](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
