...
def build_list_request(
    location_name: str, subscription_id: str, *, continuation_token_parameter: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Chaos/locations/{locationName}/targetTypes"
...
def build_get_request(location_name: str, target_type_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class TargetTypesOperations:
    ...
    @distributed_trace
    def list(
        self, location_name: str, continuation_token_parameter: Optional[str] = None, **kwargs: Any
