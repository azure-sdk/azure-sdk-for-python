...
class PrivateAccessesOperations:
    ...
    def _create_or_update_initial(
        ...
        resource_group_name: str,
        private_access_name: str,
        resource: Union[_models.PrivateAccess, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "PrivateAccess")
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.chaos.models.PrivateAccess or IO[bytes]
        :return: An instance of LROPoller that returns either PrivateAccess or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.chaos.models.PrivateAccess]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        private_access_name: str,
        properties: Union[_models.PrivateAccessPatch, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "PrivateAccessPatch")
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param properties: private access resource's tags to be updated. Is either a PrivateAccessPatch
         type or a IO[bytes] type. Required.
        :type properties: ~azure.mgmt.chaos.models.PrivateAccessPatch or IO[bytes]
        :return: An instance of LROPoller that returns either PrivateAccess or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.chaos.models.PrivateAccess]
        :raises ~azure.core.exceptions.HttpResponseError:
