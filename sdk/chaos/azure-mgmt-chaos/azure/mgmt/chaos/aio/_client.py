...
class ChaosManagementClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype experiment_executions: azure.mgmt.chaos.aio.operations.ExperimentExecutionsOperations
    ...
    :vartype private_endpoint_connections:
     azure.mgmt.chaos.aio.operations.PrivateEndpointConnectionsOperations
