...
from ...operations._operations import (
    ...
    build_private_accesses_private_link_resources_request,
    build_private_accesses_update_request,
    build_private_endpoint_connections_delete_a_private_endpoint_connection_request,
    build_private_endpoint_connections_get_a_private_endpoint_connection_request,
    build_private_endpoint_connections_list_private_endpoint_connections_request,
...
class PrivateAccessesOperations:
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.PrivateAccess"]:
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.PrivateAccess], deserialized["value"])
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, AsyncList(list_of_elem)
    ...
    def private_link_resources(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.chaos.models.PrivateLinkResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_private_accesses_private_link_resources_request(
                    resource_group_name=resource_group_name,
                    private_access_name=private_access_name,
                    subscription_id=self._config.subscription_id,
                    api_version=self._config.api_version,
...
class PrivateEndpointConnectionsOperations:
    ...
    async def _delete_a_private_endpoint_connection_initial(  # pylint: disable=name-too-long
        ...
        _request = build_private_endpoint_connections_delete_a_private_endpoint_connection_request(
            resource_group_name=resource_group_name,
            private_access_name=private_access_name,
            private_endpoint_connection_name=private_endpoint_connection_name,
            subscription_id=self._config.subscription_id,
    ...
    def list_private_endpoint_connections(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_private_endpoint_connections_list_private_endpoint_connections_request(
                    resource_group_name=resource_group_name,
                    private_access_name=private_access_name,
                    subscription_id=self._config.subscription_id,
                    api_version=self._config.api_version,
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.PrivateEndpointConnection], deserialized["value"])
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, AsyncList(list_of_elem)
