...
### Features Added
  ...
  - Method `OperationStatus.__init__` has a new overload `def __init__(self: None, error: Optional[_models.ErrorDetail], id: Optional[str], name: Optional[str], status: Optional[str])`
  - Method `OperationStatus.__init__` has a new overload `def __init__(self: None, mapping: Mapping[str, Any])`
  - Method `OperationStatus.__init__` has a new overload `def __init__(self: None, error: Optional[_models.ErrorDetail])`
  - Method `OperationStatus.__init__` has a new overload `def __init__(self: None, mapping: Mapping[str, Any])`
  ...
  - Method `Target.__init__` has a new overload `def __init__(self: None, properties: Optional[Dict[str, Any]], location: Optional[str])`
