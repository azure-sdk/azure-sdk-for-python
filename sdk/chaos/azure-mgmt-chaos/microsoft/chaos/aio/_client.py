...
class ChaosManagementClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype capabilities: microsoft.chaos.aio.operations.CapabilitiesOperations
    :ivar operations: Operations operations
    :vartype operations: microsoft.chaos.aio.operations.Operations
    :ivar targets: TargetsOperations operations
    :vartype targets: microsoft.chaos.aio.operations.TargetsOperations
    :ivar capability_types: CapabilityTypesOperations operations
    :vartype capability_types: microsoft.chaos.aio.operations.CapabilityTypesOperations
    :ivar experiments: ExperimentsOperations operations
    :vartype experiments: microsoft.chaos.aio.operations.ExperimentsOperations
    :ivar experiment_executions: ExperimentExecutionsOperations operations
    :vartype experiment_executions: microsoft.chaos.aio.operations.ExperimentExecutionsOperations
    :ivar target_types: TargetTypesOperations operations
    :vartype target_types: microsoft.chaos.aio.operations.TargetTypesOperations
    :ivar operation_statuses: OperationStatusesOperations operations
    :vartype operation_statuses: microsoft.chaos.aio.operations.OperationStatusesOperations
