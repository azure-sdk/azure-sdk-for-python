...
class ContentSafetyClientOperationsMixin(ContentSafetyClientOperationsMixinGenerated):
    ...
    async def analyze_text(
        ...
        A asynchronous API for the analysis of potentially harmful text content. Currently, it supports
    ...
    async def analyze_text(self, body: str, **kwargs: Any) -> _models.AnalyzeTextResult:
    ...
    async def analyze_image(
        ...
        A asynchronous API for the analysis of potentially harmful image content. Currently, it supports
        four categories: Hate, SelfHarm, Sexual, and Violence.
    ...
    async def analyze_image(self, data: Union[str, bytes], **kwargs: Any) -> _models.AnalyzeImageResult:
        _image = None
