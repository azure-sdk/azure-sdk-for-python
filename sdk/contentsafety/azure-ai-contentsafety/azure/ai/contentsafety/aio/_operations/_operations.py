...
class ContentSafetyClientOperationsMixin(ClientMixinABC[AsyncPipelineClient, ContentSafetyClientConfiguration]):
...
class BlocklistClientOperationsMixin(ClientMixinABC[AsyncPipelineClient, BlocklistClientConfiguration]):
