...
class ContentSafetyClientOperationsMixin(ContentSafetyClientMixinABC):
    ...
    async def analyze_text(
        self, body: Union[_models.AnalyzeTextOptions, JSON, IO[bytes]], **kwargs: Any
    ) -> _models.AnalyzeTextResult:
        """Analyze Text.
        ...
        :type body: ~azure.ai.contentsafety.models.AnalyzeTextOptions or JSON or IO[bytes]
    ...
    @distributed_trace_async
    async def analyze_image(
        self, body: Union[_models.AnalyzeImageOptions, JSON, IO[bytes]], **kwargs: Any
    ) -> _models.AnalyzeImageResult:
        """Analyze Image.
        ...
        :param body: The image analysis request. Is one of the following types: AnalyzeImageOptions,
         JSON, IO[bytes] Required.
        :type body: ~azure.ai.contentsafety.models.AnalyzeImageOptions or JSON or IO[bytes]
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
    ...
    @distributed_trace_async
    async def create_or_update_text_blocklist(
        self, blocklist_name: str, resource: Union[_models.TextBlocklist, JSON, IO[bytes]], **kwargs: Any
    ) -> _models.TextBlocklist:
        """Create Or Update Text Blocklist.
        ...
        :param blocklist_name: Text blocklist name. Required.
        :type blocklist_name: str
        :param resource: The resource instance. Is one of the following types: TextBlocklist, JSON,
         IO[bytes] Required.
        :type resource: ~azure.ai.contentsafety.models.TextBlocklist or JSON or IO[bytes]
    ...
    @overload
    async def add_or_update_blocklist_items(
        self, blocklist_name: str, body: IO[bytes], *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.AddOrUpdateTextBlocklistItemsResult:
        """Add or update BlocklistItems To Text Blocklist.
    ...
    async def add_or_update_blocklist_items(
        self,
        blocklist_name: str,
        body: Union[_models.AddOrUpdateTextBlocklistItemsOptions, JSON, IO[bytes]],
        **kwargs: Any
    ) -> _models.AddOrUpdateTextBlocklistItemsResult:
        """Add or update BlocklistItems To Text Blocklist.
        ...
        :param blocklist_name: Text blocklist name. Required.
        :type blocklist_name: str
        :param body: Is one of the following types: AddOrUpdateTextBlocklistItemsOptions, JSON,
         IO[bytes] Required.
        :type body: ~azure.ai.contentsafety.models.AddOrUpdateTextBlocklistItemsOptions or JSON or
         IO[bytes]
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
        :paramtype content_type: str
    ...
    @distributed_trace_async
    async def remove_blocklist_items(  # pylint: disable=inconsistent-return-statements
        self, blocklist_name: str, body: Union[_models.RemoveTextBlocklistItemsOptions, JSON, IO[bytes]], **kwargs: Any
    ) -> None:
        """Remove BlocklistItems From Text Blocklist.
        ...
        :param blocklist_name: Text blocklist name. Required.
        :type blocklist_name: str
        :param body: Is one of the following types: RemoveTextBlocklistItemsOptions, JSON, IO[bytes]
         Required.
        :type body: ~azure.ai.contentsafety.models.RemoveTextBlocklistItemsOptions or JSON or IO[bytes]
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
        :paramtype content_type: str
        :return: None
