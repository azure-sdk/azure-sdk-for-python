...
class ContentSafetyClientOperationsMixin(ContentSafetyClientMixinABC):
    ...
    async def add_or_update_blocklist_items(
        ...
        request = build_content_safety_add_or_update_blocklist_items_request(
            blocklist_name=blocklist_name,
            content_type=content_type,
            api_version=self._config.api_version,
            content=_content,
    ...
    async def remove_blocklist_items(  # pylint: disable=inconsistent-return-statements
        ...
        request = build_content_safety_remove_blocklist_items_request(
            blocklist_name=blocklist_name,
            content_type=content_type,
            api_version=self._config.api_version,
            content=_content,
    ...
    async def create_or_update_project(
        ...
        **kwargs: Any
        ...
        Update a project if project does exist, create a new project if not. Note that modality cannot
        be updated.

        :param project_name: Project name. Required.
        :type project_name: str
        :param resource: The resource instance. Required.
        :type resource: ~azure.ai.contentsafety.models.Project
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/merge-patch+json".
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
        ...
        :rtype: ~azure.ai.contentsafety.models.Project
        :raises ~azure.core.exceptions.HttpResponseError:
        """

    @overload
    async def create_or_update_project(
        self, project_name: str, resource: JSON, *, content_type: str = "application/merge-patch+json", **kwargs: Any
    ) -> _models.Project:
        """Create Or Update A Project.
    ...
    @overload
    async def create_or_update_project(
        self, project_name: str, resource: IO, *, content_type: str = "application/merge-patch+json", **kwargs: Any
    ) -> _models.Project:
        """Create Or Update A Project.
    ...
    @distributed_trace_async
    async def create_or_update_project(
        self, project_name: str, resource: Union[_models.Project, JSON, IO], **kwargs: Any
    ) -> _models.Project:
        """Create Or Update A Project.
        ...
        :param project_name: Project name. Required.
        :type project_name: str
        :param resource: The resource instance. Is one of the following types: Project, JSON, IO
         Required.
        :type resource: ~azure.ai.contentsafety.models.Project or JSON or IO
        :keyword content_type: This request has a JSON Merge Patch body. Default value is None.
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
         will have to context manage the returned stream.
        ...
        request = build_content_safety_create_or_update_project_request(
    ...
    async def get_project(self, project_name: str, **kwargs: Any) -> _models.Project:
        ...
        request = build_content_safety_get_project_request(
            project_name=project_name,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    @distributed_trace_async
    async def delete_project(  # pylint: disable=inconsistent-return-statements
        ...
        request = build_content_safety_delete_project_request(
            project_name=project_name,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    def list_projects(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.ai.contentsafety.models.Project]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_content_safety_list_projects_request(
                    top=top,
                    skip=skip,
                    api_version=self._config.api_version,
                    headers=_headers,
