...
def build_content_safety_analyze_with_rai_policy_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_rai_policy_create_or_update_rai_policy_request(  # pylint: disable=name-too-long
    rai_policy_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/raiPolicies/{raiPolicyName}"
    path_format_arguments = {
...
def build_rai_policy_delete_rai_policy_request(  # pylint: disable=name-too-long
    rai_policy_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_rai_policy_get_rai_policy_request(rai_policy_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_rai_policy_list_rai_policies_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class RaiPolicyClientOperationsMixin(RaiPolicyClientMixinABC):
    ...
    @distributed_trace
    def delete_rai_policy(  # pylint: disable=inconsistent-return-statements
        self, rai_policy_name: str, **kwargs: Any
    ) -> None:
    ...
    @distributed_trace
    def get_rai_policy(self, rai_policy_name: str, **kwargs: Any) -> _models.RaiPolicy:
    ...
    @distributed_trace
    def list_rai_policies(self, **kwargs: Any) -> Iterable["_models.RaiPolicy"]:
        """Get All Rai Policies.

        Get all rai policies details.

        :return: An iterator like instance of RaiPolicy
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.contentsafety.models.RaiPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
