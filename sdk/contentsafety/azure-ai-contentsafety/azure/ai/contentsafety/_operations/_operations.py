...
class ContentSafetyClientOperationsMixin(ClientMixinABC[PipelineClient, ContentSafetyClientConfiguration]):
...
class BlocklistClientOperationsMixin(ClientMixinABC[PipelineClient, BlocklistClientConfiguration]):
