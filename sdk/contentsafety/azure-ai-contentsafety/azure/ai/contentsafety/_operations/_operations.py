...
def build_content_safety_create_or_update_project_request(  # pylint: disable=name-too-long
...
def build_content_safety_get_project_request(project_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_content_safety_delete_project_request(  # pylint: disable=name-too-long
    project_name: str, **kwargs: Any
) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_content_safety_list_projects_request(  # pylint: disable=name-too-long
...
class ContentSafetyClientOperationsMixin(ContentSafetyClientMixinABC):
    ...
    @distributed_trace
    def delete_project(  # pylint: disable=inconsistent-return-statements
    ...
    def list_projects(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.contentsafety.models.Project]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
