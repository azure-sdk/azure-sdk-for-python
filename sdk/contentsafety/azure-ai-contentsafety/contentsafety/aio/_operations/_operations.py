...
class ContentSafetyClientOperationsMixin(ContentSafetyClientMixinABC):
    ...
    async def analyze_image(
        ...
        :type options: ~contentsafety.models.AnalyzeImageOptions or JSON or IO[bytes]
        :return: AnalyzeImageResult. The AnalyzeImageResult is compatible with MutableMapping
        :rtype: ~contentsafety.models.AnalyzeImageResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def analyze_text(
        ...
        :type options: ~contentsafety.models.AnalyzeTextOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: AnalyzeTextResult. The AnalyzeTextResult is compatible with MutableMapping
        :rtype: ~contentsafety.models.AnalyzeTextResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def analyze_text(
        ...
        :param options: The text analysis request. Is one of the following types: AnalyzeTextOptions,
         JSON, IO[bytes] Required.
        :type options: ~contentsafety.models.AnalyzeTextOptions or JSON or IO[bytes]
        :return: AnalyzeTextResult. The AnalyzeTextResult is compatible with MutableMapping
        :rtype: ~contentsafety.models.AnalyzeTextResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def detect_text_protected_material(
        ...
        **kwargs: Any
        ...
        :param options: The request body to be detected, which may contain protected material.
         Required.
        :type options: ~contentsafety.models.DetectTextProtectedMaterialOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: DetectTextProtectedMaterialResult. The DetectTextProtectedMaterialResult is compatible
         with MutableMapping
        :rtype: ~contentsafety.models.DetectTextProtectedMaterialResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def detect_text_protected_material(
        ...
        :type options: ~contentsafety.models.DetectTextProtectedMaterialOptions or JSON or IO[bytes]
        :return: DetectTextProtectedMaterialResult. The DetectTextProtectedMaterialResult is compatible
         with MutableMapping
        :rtype: ~contentsafety.models.DetectTextProtectedMaterialResult
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def shield_prompt(
        ...
        :param options: The request body to be detected, which may contain direct or indirect injection
         attacks. Required.
        :type options: ~contentsafety.models.ShieldPromptOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ShieldPromptResult. The ShieldPromptResult is compatible with MutableMapping
        :rtype: ~contentsafety.models.ShieldPromptResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def shield_prompt(
        ...
        :type options: ~contentsafety.models.ShieldPromptOptions or JSON or IO[bytes]
        :return: ShieldPromptResult. The ShieldPromptResult is compatible with MutableMapping
        :rtype: ~contentsafety.models.ShieldPromptResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
...
class BlocklistClientOperationsMixin(BlocklistClientMixinABC):
    ...
    async def add_or_update_blocklist_items(
        ...
        **kwargs: Any
        ...
        :type options: ~contentsafety.models.AddOrUpdateTextBlocklistItemsOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: AddOrUpdateTextBlocklistItemsResult. The AddOrUpdateTextBlocklistItemsResult is
         compatible with MutableMapping
        :rtype: ~contentsafety.models.AddOrUpdateTextBlocklistItemsResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def add_or_update_blocklist_items(
        ...
        **kwargs: Any
        ...
        :type options: ~contentsafety.models.AddOrUpdateTextBlocklistItemsOptions or JSON or IO[bytes]
        :return: AddOrUpdateTextBlocklistItemsResult. The AddOrUpdateTextBlocklistItemsResult is
         compatible with MutableMapping
        :rtype: ~contentsafety.models.AddOrUpdateTextBlocklistItemsResult
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def create_or_update_text_blocklist(
        ...
        **kwargs: Any
        ...
        :type options: ~contentsafety.models.TextBlocklist
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/merge-patch+json".
        :paramtype content_type: str
        :return: TextBlocklist. The TextBlocklist is compatible with MutableMapping
        :rtype: ~contentsafety.models.TextBlocklist
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def create_or_update_text_blocklist(
        ...
        :param options: The resource instance. Is one of the following types: TextBlocklist, JSON,
         IO[bytes] Required.
        :type options: ~contentsafety.models.TextBlocklist or JSON or IO[bytes]
        :return: TextBlocklist. The TextBlocklist is compatible with MutableMapping
        :rtype: ~contentsafety.models.TextBlocklist
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get_text_blocklist_item(
        ...
        :rtype: ~contentsafety.models.TextBlocklistItem
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_text_blocklist_items(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~contentsafety.models.TextBlocklistItem]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_text_blocklists(self, **kwargs: Any) -> AsyncIterable["_models.TextBlocklist"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~contentsafety.models.TextBlocklist]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def remove_blocklist_items(
        ...
        **kwargs: Any
        ...
        :type options: ~contentsafety.models.RemoveTextBlocklistItemsOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None
    ...
    async def remove_blocklist_items(
        ...
        **kwargs: Any
        ...
        :type options: ~contentsafety.models.RemoveTextBlocklistItemsOptions or JSON or IO[bytes]
        :return: None
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
