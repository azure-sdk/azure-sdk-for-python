...
# --------------------------------------------------------------------------
from azure.ai.contentsafety import BlocklistClient, ContentSafetyClient, RaiPolicyClient
...
class RaiPolicyClientTestBase(AzureRecordedTestCase):

    def create_client(self, endpoint):
        credential = self.get_credential(RaiPolicyClient)
        return self.create_client_from_credential(
            RaiPolicyClient,
            credential=credential,
            endpoint=endpoint,
...
RaiPolicyPreparer = functools.partial(
    PowerShellPreparer, "raipolicy", raipolicy_endpoint="https://fake_raipolicy_endpoint.com"
)
