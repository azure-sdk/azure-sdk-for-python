...
# USAGE
    python create_or_update_sql_pool_workload_group_min.py
...
def main():
    ...
    response = client.sql_pool_workload_group.begin_create_or_update(
        resource_group_name="sqlcrudtest-6852",
        workspace_name="sqlcrudtest-2080",
        sql_pool_name="sqlcrudtest-9187",
        workload_group_name="smallrc",
        parameters={
            "properties": {"maxResourcePercent": 100, "minResourcePercent": 0, "minResourcePercentPerRequest": 3}
        },
    ).result()
    print(response)
