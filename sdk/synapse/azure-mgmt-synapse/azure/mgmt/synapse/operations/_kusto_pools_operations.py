...
class KustoPoolsOperations:  # pylint: disable=too-many-public-methods
    ...
    def _migrate_initial(  # pylint: disable=inconsistent-return-statements
        ...
        kusto_pool_name: str,
        resource_group_name: str,
        kusto_pool_migrate_request: Union[_models.KustoPoolMigrateRequest, IO],
        **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
        ...
        _json = None
        _content = None
        if isinstance(kusto_pool_migrate_request, (IO, bytes)):
            _content = kusto_pool_migrate_request
        else:
            _json = self._serialize.body(kusto_pool_migrate_request, "KustoPoolMigrateRequest")
    ...
    _migrate_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/kustoPools/{kustoPoolName}/migrate"
    }
    ...
    def begin_migrate(
        ...
        kusto_pool_name: str,
        resource_group_name: str,
        kusto_pool_migrate_request: _models.KustoPoolMigrateRequest,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[None]:
        ...
        :param resource_group_name: The name of the resource group. The name is case insensitive.
         Required.
        :type resource_group_name: str
        :param kusto_pool_migrate_request: The kusto pool migrate request parameters. Required.
        :type kusto_pool_migrate_request: ~azure.mgmt.synapse.models.KustoPoolMigrateRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_migrate(
        ...
        **kwargs: Any
        ...
        :type resource_group_name: str
        :param kusto_pool_migrate_request: The kusto pool migrate request parameters. Required.
        :type kusto_pool_migrate_request: IO
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_migrate(
        ...
        **kwargs: Any
        ...
        :param resource_group_name: The name of the resource group. The name is case insensitive.
         Required.
        :type resource_group_name: str
        :param kusto_pool_migrate_request: The kusto pool migrate request parameters. Is either a
         KustoPoolMigrateRequest type or a IO type. Required.
        :type kusto_pool_migrate_request: ~azure.mgmt.synapse.models.KustoPoolMigrateRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        if cont_token is None:
            raw_result = self._migrate_initial(  # type: ignore
                ...
                kusto_pool_name=kusto_pool_name,
                resource_group_name=resource_group_name,
                kusto_pool_migrate_request=kusto_pool_migrate_request,
                api_version=api_version,
                content_type=content_type,
                cls=lambda x, y, z: x,
                headers=_headers,
