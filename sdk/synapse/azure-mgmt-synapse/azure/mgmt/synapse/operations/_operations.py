...
def build_get_subscription_quota_and_usage_request(  # pylint: disable=name-too-long
...
def build_get_workspace_quota_and_usage_request(  # pylint: disable=name-too-long
...
def build_get_azure_async_header_result_request(  # pylint: disable=name-too-long
    resource_group_name: str, workspace_name: str, operation_id: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class Operations:
    ...
    @distributed_trace
    def get_subscription_quota_and_usage(self, location: str, **kwargs: Any) -> _models.ListUsagesResult:
        ...
        :rtype: ~azure.mgmt.synapse.models.ListUsagesResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        request = build_get_subscription_quota_and_usage_request(
            location=location,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self.get_subscription_quota_and_usage.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    def get_workspace_quota_and_usage(
        ...
        request = build_get_workspace_quota_and_usage_request(
            resource_group_name=resource_group_name,
            workspace_name=workspace_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self.get_workspace_quota_and_usage.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    get_workspace_quota_and_usage.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/usages"
    }
