...
def build_invite_follower_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "kustoPoolName": _SERIALIZER.url("kusto_pool_name", kusto_pool_name, "str", pattern=r"^[a-z][a-z0-9]{3,21}$"),
        "databaseName": _SERIALIZER.url("database_name", database_name, "str", pattern=r"^[a-zA-Z0-9_\-\. ]{1,260}$"),
    }
...
class KustoPoolDatabaseOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`kusto_pool_database` attribute.
    """
    ...
    def invite_follower(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.synapse.models.DatabaseInviteFollowerRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: DatabaseInviteFollowerResult or the result of cls(response)
        :rtype: ~azure.mgmt.synapse.models.DatabaseInviteFollowerResult
    ...
    def invite_follower(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.synapse.models.DatabaseInviteFollowerRequest or IO
    ...
    invite_follower.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/kustoPools/{kustoPoolName}/databases/{databaseName}/inviteFollower"
    }
