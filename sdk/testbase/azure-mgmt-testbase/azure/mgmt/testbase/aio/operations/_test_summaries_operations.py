...
class TestSummariesOperations:
    ...
    def list(
        ...
        cls: ClsType[_models.TestSummaryListResult] = kwargs.pop("cls", None)
    ...
    async def get(
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.TestSummaryResource] = kwargs.pop("cls", None)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.TestBase/testBaseAccounts/{testBaseAccountName}/testSummaries/{testSummaryName}"
    }
