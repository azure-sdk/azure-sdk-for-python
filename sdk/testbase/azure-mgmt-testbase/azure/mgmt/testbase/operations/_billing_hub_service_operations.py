...
class BillingHubServiceOperations:
    ...
    def get_free_hour_balance(
        ...
        cls: ClsType[_models.BillingHubGetFreeHourBalanceResponse] = kwargs.pop("cls", None)
    ...
    get_free_hour_balance.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.TestBase/testBaseAccounts/{testBaseAccountName}/getFreeHourBalance"
    }
    ...
    def get_usage(
        ...
        **kwargs: Any
        ...
        :param test_base_account_name: The resource name of the Test Base Account. Required.
        :type test_base_account_name: str
        :param get_usage_request: Is either a BillingHubGetUsageRequest type or a IO type. Default
         value is None.
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.BillingHubGetUsageResponse] = kwargs.pop("cls", None)

        content_type = content_type or "application/json"
        _json = None
        _content = None
        if isinstance(get_usage_request, (IOBase, bytes)):
    ...
    get_usage.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.TestBase/testBaseAccounts/{testBaseAccountName}/getUsage"
    }
