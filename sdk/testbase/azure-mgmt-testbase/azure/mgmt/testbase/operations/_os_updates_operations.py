...
class OSUpdatesOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        cls: ClsType[_models.OSUpdateListResult] = kwargs.pop("cls", None)
    ...
    def get(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.OSUpdateResource] = kwargs.pop("cls", None)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.TestBase/testBaseAccounts/{testBaseAccountName}/packages/{packageName}/osUpdates/{osUpdateResourceName}"
    }
