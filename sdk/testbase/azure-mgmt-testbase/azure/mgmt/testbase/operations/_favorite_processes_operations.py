...
class FavoriteProcessesOperations:
    ...
    def list(
        ...
        cls: ClsType[_models.FavoriteProcessListResult] = kwargs.pop("cls", None)
    ...
    def create(
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters supplied to create a favorite process in a package. Is either a
         FavoriteProcessResource type or a IO type. Required.
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.FavoriteProcessResource] = kwargs.pop("cls", None)
    ...
    create.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.TestBase/testBaseAccounts/{testBaseAccountName}/packages/{packageName}/favoriteProcesses/{favoriteProcessResourceName}"
    }
