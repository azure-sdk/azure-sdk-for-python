...
# USAGE
    python draft_package_extract_file.py
...
def main():
    ...
    client.draft_packages.begin_extract_file(
        resource_group_name="contoso-rg",
        test_base_account_name="contoso-testBaseAccount",
        draft_package_name="34070901-fc0b-4459-b6de-4295b7c7bf19",
        parameters={"fileType": "IntuneWinPackage", "sourceFile": "bin/contoso.intunewin"},
    ).result()
