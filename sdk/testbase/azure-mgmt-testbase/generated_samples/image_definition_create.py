...
# USAGE
    python image_definition_create.py
...
def main():
    ...
    response = client.image_definitions.create(
        resource_group_name="contoso-rg1",
        test_base_account_name="contoso-testBaseAccount1",
        image_definition_name="contoso-image-def",
        parameters={"properties": {"architecture": "x64", "osState": "Generalized", "securityType": "Standard"}},
    )
    print(response)
