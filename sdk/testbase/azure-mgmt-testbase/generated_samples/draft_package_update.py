...
# USAGE
    python draft_package_update.py
...
def main():
    ...
    response = client.draft_packages.update(
                ...
                "targetOSList": [
                    {
                        ...
                        "targetOSs": ["Windows 11 21H2", "Windows 10 21H2", "Windows 10 21H1"],
                    },
                    {"baselineOSs": None, "osUpdateType": "Feature updates", "targetOSs": ["Windows 10 21H2"]},
                ],
            }
        },
    )
