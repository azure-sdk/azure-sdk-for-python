...
class EdgeClient:
    ...
    :vartype operations: azure.mgmt.commonedgesitemanageroperations.aio.operations.Operations
    ...
    def __init__(
        ...
        _endpoint = "{endpoint}"
        self._config = EdgeClientConfiguration(credential=credential, base_url=base_url, **kwargs)
