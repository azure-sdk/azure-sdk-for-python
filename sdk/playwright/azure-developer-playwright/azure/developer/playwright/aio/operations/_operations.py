...
class AccessTokensOperations:
    ...
    @distributed_trace_async
    async def get(self, workspace_id: str, access_token_id: str, **kwargs: Any) -> _models.AccessToken:
    ...
    @distributed_trace_async
    async def delete(self, workspace_id: str, access_token_id: str, **kwargs: Any) -> None:
    ...
    @distributed_trace
    def list(self, workspace_id: str, **kwargs: Any) -> AsyncIterable["_models.AccessToken"]:
...
class WorkspacesOperations:
    ...
    @distributed_trace_async
    async def get(self, workspace_id: str, **kwargs: Any) -> _models.Workspace:
