...
def build_workspaces_get_request(workspace_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/playwrightworkspaces/{workspaceId}"
    path_format_arguments = {
        "workspaceId": _SERIALIZER.url("workspace_id", workspace_id, "str"),
    }
...
def build_workspaces_get_browsers_request(
    workspace_id: str, *, os: Optional[Union[str, _models.OS]] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class WorkspacesOperations:
    ...
    @distributed_trace
    def get(self, workspace_id: str, **kwargs: Any) -> _models.Workspace:
    ...
    def get_browsers(  # pylint: disable=inconsistent-return-statements
        self, workspace_id: str, *, os: Optional[Union[str, _models.OS]] = None, **kwargs: Any
    ) -> None:
