...
class AccessTokensOperations:
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        _request = build_access_tokens_create_request(
    ...
    def list(self, account_id: str, **kwargs: Any) -> AsyncIterable["_models.AccessToken"]:
        """Lists access-tokens for the given account id. Authorization required is Bearer JWT Access token
        provided by EntraID.
        ...
        async def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(List[_models.AccessToken], deserialized["value"])
            if cls:
    ...
    @distributed_trace_async
    async def validate(self, account_id: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        """Validates access-token provided in authorization header for the given account id. Authorization
        required is Bearer JWT Access token provided by MPT service.
        ...
        _request = build_access_tokens_validate_request(
            account_id=account_id,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
...
class AccountsOperations:
    ...
    async def get(self, account_id: str, **kwargs: Any) -> _models.Account:
        """Get details of the ARM resource mapped to an account for the given accountId. Authorization
    ...
    @distributed_trace_async
    async def get_browsers(  # pylint: disable=inconsistent-return-statements
        self,
        account_id: str,
        *,
        ...
        **kwargs: Any
        ...
        """Gets remote browsers corresponding to given accountId and redirects the client for running MPT
        tests. Authorization required is Bearer JWT Access token provided by EntraID or MPT Service.
