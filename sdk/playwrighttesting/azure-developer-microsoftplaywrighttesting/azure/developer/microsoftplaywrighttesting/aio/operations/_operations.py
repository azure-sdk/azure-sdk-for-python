...
from ...operations._operations import (
    build_test_results_compute_results_stats_request,
    build_test_results_list_request,
    build_test_results_upload_batch_request,
    build_test_runs_compute_account_run_stats_request,
    build_test_runs_compute_metadata_request,
    build_test_runs_create_artifacts_upload_base_url_request,
    build_test_runs_create_or_update_request,
    build_test_runs_get_request,
    build_test_runs_list_request,
    build_test_runs_update_shard_execution_status_request,
)
...
class TestRunsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.developer.microsoftplaywrighttesting.aio.ReportingClient`'s
    ...
    @distributed_trace_async
    async def get(self, account_id: str, test_run_id: str, **kwargs: Any) -> _models.TestRun:
        """Gets a test run.
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.developer.microsoftplaywrighttesting.models.TestRun]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    @distributed_trace_async
    async def create_artifacts_upload_base_url(
    ...
    @overload
    async def update_shard_execution_status(
        self,
        account_id: str,
        test_run_id: str,
        *,
    ...
    @distributed_trace_async
    async def compute_account_run_stats(
        self,
        account_id: str,
        *,
        top: Optional[int] = None,
    ...
    @distributed_trace_async
    async def compute_metadata(self, account_id: str, **kwargs: Any) -> _models.TestRunsMetadata:
...
class TestResultsOperations:
    ...
    def list(
        ...
        *,
        ...
        filter: Optional[str] = None,
        **kwargs: Any
    ) -> AsyncIterable["_models.TestResultDetails"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.developer.microsoftplaywrighttesting.models.TestResultDetails]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    @distributed_trace_async
    async def compute_results_stats(
        self,
        account_id: str,
        *,
        top: Optional[int] = None,
