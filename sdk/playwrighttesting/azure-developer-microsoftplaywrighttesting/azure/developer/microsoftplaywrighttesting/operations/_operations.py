...
def build_access_tokens_create_request(account_id: str, access_token_id: str, **kwargs: Any) -> HttpRequest:
...
def build_access_tokens_validate_request(account_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/accounts/{accountId}/access-tokens/validate"
    path_format_arguments = {
        "accountId": _SERIALIZER.url("account_id", account_id, "str"),
    }
...
class AccessTokensOperations:
    ...
    @distributed_trace
    def validate(self, account_id: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
