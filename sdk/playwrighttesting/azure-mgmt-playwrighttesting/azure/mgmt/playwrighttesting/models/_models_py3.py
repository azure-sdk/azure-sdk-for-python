...
class AccountFreeTrialProperties(_serialization.Model):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.expiry_at: Optional[datetime.datetime] = None
        self.allocated_value: Optional[int] = None
        self.used_value: Optional[int] = None
        self.percentage_used: Optional[float] = None
...
class AccountProperties(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        super().__init__(**kwargs)
        self.dashboard_uri: Optional[str] = None
...
class FreeTrialProperties(_serialization.Model):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.state: Optional[Union[str, "_models.FreeTrialState"]] = None
...
class QuotaProperties(_serialization.Model):
    ...
    def __init__(self, *, free_trial: Optional["_models.FreeTrialProperties"] = None, **kwargs: Any) -> None:
        ...
        super().__init__(**kwargs)
        self.free_trial = free_trial
        self.offering_type: Optional[Union[str, "_models.OfferingType"]] = None
        self.provisioning_state: Optional[Union[str, "_models.ProvisioningState"]] = None
