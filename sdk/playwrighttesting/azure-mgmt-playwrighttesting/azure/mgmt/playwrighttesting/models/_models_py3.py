...
class AccountListResult(_serialization.Model):
    ...
    def __init__(self, *, value: List["_models.Account"], **kwargs: Any) -> None:
        """
...
class AccountQuotaListResult(_serialization.Model):
    ...
    def __init__(self, *, value: List["_models.AccountQuota"], **kwargs: Any) -> None:
        """
...
class QuotaListResult(_serialization.Model):
    ...
    def __init__(self, *, value: List["_models.Quota"], **kwargs: Any) -> None:
        """
