...
class AgentPoolsOperations:
    ...
    def _create_or_update_initial(
        ...
        agent_pool_name: str,
        agent_pool_parameters: Union[_models.AgentPool, IO[bytes]],
        **kwargs: Any
    ) -> _models.AgentPool:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type agent_pool_name: str
        :param agent_pool_parameters: The request body. Required.
        :type agent_pool_parameters: IO[bytes]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param agent_pool_parameters: The request body. Is either a AgentPool type or a IO[bytes] type.
         Required.
        :type agent_pool_parameters: ~azure.mgmt.networkcloud.models.AgentPool or IO[bytes]
        :return: An instance of LROPoller that returns either AgentPool or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.networkcloud.models.AgentPool]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _update_initial(
        ...
        kubernetes_cluster_name: str,
        agent_pool_name: str,
        agent_pool_update_parameters: Optional[Union[_models.AgentPoolPatchParameters, IO[bytes]]] = None,
        **kwargs: Any
    ) -> _models.AgentPool:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type agent_pool_name: str
        :param agent_pool_update_parameters: The request body. Default value is None.
        :type agent_pool_update_parameters: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either AgentPool or the result of cls(response)
