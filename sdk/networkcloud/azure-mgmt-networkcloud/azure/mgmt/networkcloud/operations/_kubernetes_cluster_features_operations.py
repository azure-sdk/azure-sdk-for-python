...
def build_get_request(
    resource_group_name: str, kubernetes_cluster_name: str, feature_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "featureName": _SERIALIZER.url(
            "feature_name", feature_name, "str", pattern=r"^([a-zA-Z0-9][a-zA-Z0-9-]{0,61}[a-zA-Z0-9])$"
        ),
    }
...
class KubernetesClusterFeaturesOperations:
    ...
    def list_by_kubernetes_cluster(
    ...
    ) -> Iterable["_models.KubernetesClusterFeature"]:
        ...
        :return: An iterator like instance of either KubernetesClusterFeature or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.networkcloud.models.KubernetesClusterFeature]
    ...
    def get(
        ...
        deserialized = self._deserialize("KubernetesClusterFeature", pipeline_response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either KubernetesClusterFeature or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.networkcloud.models.KubernetesClusterFeature]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.KubernetesClusterFeature].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.KubernetesClusterFeature](
