...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.NetworkCloud/trunkedNetworks"
    )
...
def build_get_request(
    resource_group_name: str, trunked_network_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "trunkedNetworkName": _SERIALIZER.url(
...
class TrunkedNetworksOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.TrunkedNetwork"]:
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(trunked_network_parameters, (IOBase, bytes)):
            _content = trunked_network_parameters
        else:
    ...
    def begin_create_or_update(
        ...
        resource_group_name: str,
        trunked_network_name: str,
        trunked_network_parameters: _models.TrunkedNetwork,
        *,
        ...
        **kwargs: Any
        ...
        :type trunked_network_parameters: ~azure.mgmt.networkcloud.models.TrunkedNetwork
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = self._create_or_update_initial(
                resource_group_name=resource_group_name,
                trunked_network_name=trunked_network_name,
                trunked_network_parameters=trunked_network_parameters,
                api_version=api_version,
                content_type=content_type,
                cls=lambda x, y, z: x,
                headers=_headers,
    ...
    def update(
        ...
        resource_group_name: str,
        trunked_network_name: str,
        trunked_network_update_parameters: Optional[_models.TrunkedNetworkPatchParameters] = None,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.TrunkedNetwork:
        ...
        :type trunked_network_update_parameters:
         ~azure.mgmt.networkcloud.models.TrunkedNetworkPatchParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: TrunkedNetwork or the result of cls(response)
    ...
    def update(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(trunked_network_update_parameters, (IOBase, bytes)):
            _content = trunked_network_update_parameters
        else:
            if trunked_network_update_parameters is not None:
                _json = self._serialize.body(trunked_network_update_parameters, "TrunkedNetworkPatchParameters")
            else:
                _json = None
