...
def build_get_request(
    resource_group_name: str, cluster_name: str, metrics_configuration_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "metricsConfigurationName": _SERIALIZER.url(
            "metrics_configuration_name", metrics_configuration_name, "str", pattern=r"^default$"
        ),
    }
...
class MetricsConfigurationsOperations:
    ...
    def list_by_cluster(
    ...
    ) -> Iterable["_models.ClusterMetricsConfiguration"]:
        ...
        :return: An iterator like instance of either ClusterMetricsConfiguration or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.networkcloud.models.ClusterMetricsConfiguration]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
    ) -> LROPoller[_models.ClusterMetricsConfiguration]:
        ...
        :return: An instance of LROPoller that returns either ClusterMetricsConfiguration or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.networkcloud.models.ClusterMetricsConfiguration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.ClusterMetricsConfiguration].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ClusterMetricsConfiguration](
