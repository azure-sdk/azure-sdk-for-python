...
class CredentialResult(_serialization.Model):
    ...
    :vartype name: str
    :ivar value: The Base64-encoded Kubernetes configuration file.
    :vartype value: str
    """
...
class CredentialResults(_serialization.Model):
    ...
    :ivar hybrid_connection_config: Contains the REP (rendezvous endpoint) and “Sender” access
     token.
    :vartype hybrid_connection_config: ~azure.mgmt.networkcloud.models.HybridConnectionConfig
    :ivar kubeconfigs: List of base64-encoded Kubernetes configuration files.
    :vartype kubeconfigs: list[~azure.mgmt.networkcloud.models.CredentialResult]
    """
    ...
    def __init__(
        self, *, hybrid_connection_config: Optional["_models.HybridConnectionConfig"] = None, **kwargs: Any
    ) -> None:
        """
        :keyword hybrid_connection_config: Contains the REP (rendezvous endpoint) and “Sender” access
         token.
        :paramtype hybrid_connection_config: ~azure.mgmt.networkcloud.models.HybridConnectionConfig
        """
        super().__init__(**kwargs)
        self.hybrid_connection_config = hybrid_connection_config
        self.kubeconfigs = None


class EdgeCluster(TrackedResource):  # pylint: disable=too-many-instance-attributes
    """EdgeCluster represents a cluster that encompasses one or more nodes used to host network
    functions.
    ...
    :ivar location: The geo-location where the resource lives. Required.
    :vartype location: str
    :ivar identity: The identity of the edge cluster.
    :vartype identity: ~azure.mgmt.networkcloud.models.ManagedServiceIdentity
    :ivar available_upgrade_runtime_versions: The list of runtimes upgrades that are available for
     the Edge Cluster.
    :vartype available_upgrade_runtime_versions:
     list[~azure.mgmt.networkcloud.models.EdgeClusterAvailableUpgradeRuntimeVersion]
    :ivar cluster_extended_location: The extended location that represents the edge cluster's
     control plane location and is used to route the requests for workload infrastructure resources.
    :vartype cluster_extended_location: ~azure.mgmt.networkcloud.models.ExtendedLocation
    :ivar connected_cluster_id: The resource ID of the connected cluster set up when this edge
     cluster is created.
    :vartype connected_cluster_id: str
    :ivar description: User provided description information about the edge cluster.
    :vartype description: str
    :ivar edge_cluster_sku_id: The resource ID of the SKU of the edge cluster. Required.
    :vartype edge_cluster_sku_id: str
    :ivar entra_configuration: The attributes used for Entra (Azure Active Directory) integration.
    :vartype entra_configuration: ~azure.mgmt.networkcloud.models.EdgeClusterEntraConfiguration
    :ivar infrastructure_resource_ids: The list of system-controlled workload resource IDs that are
     dependent upon the edge cluster. The presence of resource IDs inform lifecycle events for the
     edge cluster.
    :vartype infrastructure_resource_ids: list[str]
    :ivar kubernetes_version: The Kubernetes version that is currently running on the edge cluster.
    :vartype kubernetes_version: str
    :ivar lifecycle_status: The status representing the lifecycle stage of the edge cluster. Known
     values are: "Defined", "ControlPlaneOnly", "Upgrading", "Ready", and "Deleting".
    :vartype lifecycle_status: str or ~azure.mgmt.networkcloud.models.EdgeClusterLifecycleStatus
    :ivar managed_resource_group_configuration: The configuration of the managed resource group
     associated with the resource.
    :vartype managed_resource_group_configuration:
     ~azure.mgmt.networkcloud.models.ManagedResourceGroupConfiguration
    :ivar management_services_version: The version of the running management services.
    :vartype management_services_version: str
    :ivar network_fabric_id: The resource ID of the network fabric that defines the network
     configuration for the edge cluster. Required.
    :vartype network_fabric_id: str
    :ivar provisioning_state: The provisioning state of the edge cluster. Known values are:
     "Succeeded", "Failed", "Canceled", and "Accepted".
    :vartype provisioning_state: str or
     ~azure.mgmt.networkcloud.models.EdgeClusterProvisioningState
    :ivar ptp_configuration: The PTP clock information for the edge cluster, if applicable.
    :vartype ptp_configuration: ~azure.mgmt.networkcloud.models.EdgeClusterPtpConfiguration
    :ivar registration_hub_id: The resource ID of the registration hub that the edge cluster will
     use to register machines for edge cluster nodes.
    :vartype registration_hub_id: str
    :ivar required_endpoint_allow_list: The list of endpoints that must be accessible to the edge
     cluster.
    :vartype required_endpoint_allow_list: list[~azure.mgmt.networkcloud.models.EndpointDependency]
    :ivar runtime_version_id: The resource ID of the edge cluster runtime version for the edge
     cluster. Required.
    :vartype runtime_version_id: str
    :ivar support_expiry_date: The date after which the Edge Cluster is no longer supported using
     the currently configured runtime version.
    :vartype support_expiry_date: str
    :ivar workload_resource_ids: The list of user-managed workload resource IDs that are dependent
     upon the edge cluster. The presence of workload resource IDs inform lifecycle events for the
     edge cluster.
    :vartype workload_resource_ids: list[str]
    """
    ...
    _validation = {
        ...
        "system_data": {"readonly": True},
        "location": {"required": True},
        "available_upgrade_runtime_versions": {"readonly": True},
        "cluster_extended_location": {"readonly": True},
        "connected_cluster_id": {"readonly": True},
        "description": {"max_length": 256},
        "edge_cluster_sku_id": {"required": True},
        "infrastructure_resource_ids": {"readonly": True},
        "kubernetes_version": {"readonly": True},
        "lifecycle_status": {"readonly": True},
        "management_services_version": {"readonly": True},
        "network_fabric_id": {"required": True},
        "provisioning_state": {"readonly": True},
        "ptp_configuration": {"readonly": True},
        "required_endpoint_allow_list": {"readonly": True},
        "runtime_version_id": {"required": True},
        "support_expiry_date": {"readonly": True},
    }
    ...
    _attribute_map = {
        ...
        "location": {"key": "location", "type": "str"},
        "identity": {"key": "identity", "type": "ManagedServiceIdentity"},
        "available_upgrade_runtime_versions": {
            "key": "properties.availableUpgradeRuntimeVersions",
            "type": "[EdgeClusterAvailableUpgradeRuntimeVersion]",
        },
        "cluster_extended_location": {"key": "properties.clusterExtendedLocation", "type": "ExtendedLocation"},
        "connected_cluster_id": {"key": "properties.connectedClusterId", "type": "str"},
        "description": {"key": "properties.description", "type": "str"},
        "edge_cluster_sku_id": {"key": "properties.edgeClusterSkuId", "type": "str"},
        "entra_configuration": {"key": "properties.entraConfiguration", "type": "EdgeClusterEntraConfiguration"},
        "infrastructure_resource_ids": {"key": "properties.infrastructureResourceIds", "type": "[str]"},
        "kubernetes_version": {"key": "properties.kubernetesVersion", "type": "str"},
        "lifecycle_status": {"key": "properties.lifecycleStatus", "type": "str"},
        "managed_resource_group_configuration": {
            "key": "properties.managedResourceGroupConfiguration",
            "type": "ManagedResourceGroupConfiguration",
        },
        "management_services_version": {"key": "properties.managementServicesVersion", "type": "str"},
        "network_fabric_id": {"key": "properties.networkFabricId", "type": "str"},
        "provisioning_state": {"key": "properties.provisioningState", "type": "str"},
        "ptp_configuration": {"key": "properties.ptpConfiguration", "type": "EdgeClusterPtpConfiguration"},
        "registration_hub_id": {"key": "properties.registrationHubId", "type": "str"},
        "required_endpoint_allow_list": {"key": "properties.requiredEndpointAllowList", "type": "[EndpointDependency]"},
        "runtime_version_id": {"key": "properties.runtimeVersionId", "type": "str"},
        "support_expiry_date": {"key": "properties.supportExpiryDate", "type": "str"},
        "workload_resource_ids": {"key": "properties.workloadResourceIds", "type": "[str]"},
    }
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        *,
        location: str,
        edge_cluster_sku_id: str,
        network_fabric_id: str,
        runtime_version_id: str,
        tags: Optional[Dict[str, str]] = None,
        identity: Optional["_models.ManagedServiceIdentity"] = None,
        description: Optional[str] = None,
        entra_configuration: Optional["_models.EdgeClusterEntraConfiguration"] = None,
        managed_resource_group_configuration: Optional["_models.ManagedResourceGroupConfiguration"] = None,
        registration_hub_id: Optional[str] = None,
        workload_resource_ids: Optional[List[str]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword tags: Resource tags.
        ...
        :keyword location: The geo-location where the resource lives. Required.
        :paramtype location: str
        :keyword identity: The identity of the edge cluster.
        :paramtype identity: ~azure.mgmt.networkcloud.models.ManagedServiceIdentity
        :keyword description: User provided description information about the edge cluster.
        :paramtype description: str
        :keyword edge_cluster_sku_id: The resource ID of the SKU of the edge cluster. Required.
        :paramtype edge_cluster_sku_id: str
        :keyword entra_configuration: The attributes used for Entra (Azure Active Directory)
         integration.
        :paramtype entra_configuration: ~azure.mgmt.networkcloud.models.EdgeClusterEntraConfiguration
        :keyword managed_resource_group_configuration: The configuration of the managed resource group
         associated with the resource.
        :paramtype managed_resource_group_configuration:
         ~azure.mgmt.networkcloud.models.ManagedResourceGroupConfiguration
        :keyword network_fabric_id: The resource ID of the network fabric that defines the network
         configuration for the edge cluster. Required.
        :paramtype network_fabric_id: str
        :keyword registration_hub_id: The resource ID of the registration hub that the edge cluster
         will use to register machines for edge cluster nodes.
        :paramtype registration_hub_id: str
        :keyword runtime_version_id: The resource ID of the edge cluster runtime version for the edge
         cluster. Required.
        :paramtype runtime_version_id: str
        :keyword workload_resource_ids: The list of user-managed workload resource IDs that are
         dependent upon the edge cluster. The presence of workload resource IDs inform lifecycle events
         for the edge cluster.
        :paramtype workload_resource_ids: list[str]
        """
        super().__init__(tags=tags, location=location, **kwargs)
        self.identity = identity
        self.available_upgrade_runtime_versions = None
        self.cluster_extended_location = None
        self.connected_cluster_id = None
        self.description = description
        self.edge_cluster_sku_id = edge_cluster_sku_id
        self.entra_configuration = entra_configuration
        self.infrastructure_resource_ids = None
        self.kubernetes_version = None
        self.lifecycle_status = None
        self.managed_resource_group_configuration = managed_resource_group_configuration
        self.management_services_version = None
        self.network_fabric_id = network_fabric_id
        self.provisioning_state = None
        self.ptp_configuration = None
        self.registration_hub_id = registration_hub_id
        self.required_endpoint_allow_list = None
        self.runtime_version_id = runtime_version_id
        self.support_expiry_date = None
        self.workload_resource_ids = workload_resource_ids


class EdgeClusterAvailableUpgradeRuntimeVersion(_serialization.Model):  # pylint: disable=name-too-long
    """EdgeClusterAvailableUpgradeRuntimeVersion represents the available edge cluster upgrades.

    Variables are only populated by the server, and will be ignored when sending a request.

    :ivar availability_lifecycle: The indicator if the upgrade runtime version is generally
     available or in a different lifecycle phase. Known values are: "Preview" and
     "GenerallyAvailable".
    :vartype availability_lifecycle: str or ~azure.mgmt.networkcloud.models.AvailabilityLifecycle
    :ivar description: The description of the upgrade.
    :vartype description: str
    :ivar support_expiry_date: The last date the version of the platform is supported.
    :vartype support_expiry_date: str
    :ivar target_runtime_version_id: The resource ID of the runtime version.
    :vartype target_runtime_version_id: str
    """
    ...
    _validation = {
        ...
        "support_expiry_date": {"readonly": True},
        "target_runtime_version_id": {"readonly": True},
    }
    ...
    _attribute_map = {
        ...
        "support_expiry_date": {"key": "supportExpiryDate", "type": "str"},
        "target_runtime_version_id": {"key": "targetRuntimeVersionId", "type": "str"},
    }
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.support_expiry_date = None
        self.target_runtime_version_id = None


class EdgeClusterEntraConfiguration(_serialization.Model):
    """EdgeClusterEntraConfiguration represents the Entra (Azure Active Directory) integration
    properties.

    All required parameters must be populated in order to send to server.

    :ivar admin_group_object_ids: The list of Entra (Azure Active Directory) group object IDs that
     will have an administrative role on the edge cluster. Required.
    :vartype admin_group_object_ids: list[str]
    """
    ...
    def __init__(self, *, admin_group_object_ids: List[str], **kwargs: Any) -> None:
        """
        :keyword admin_group_object_ids: The list of Entra (Azure Active Directory) group object IDs
         that will have an administrative role on the edge cluster. Required.
        :paramtype admin_group_object_ids: list[str]
        """
        super().__init__(**kwargs)
        self.admin_group_object_ids = admin_group_object_ids
...
class EdgeClusterList(_serialization.Model):
    """EdgeClusterList represents a list of edge cluster objects.

    :ivar next_link: The link used to get the next page of operations.
    :vartype next_link: str
    :ivar value: The list of edge clusters.
    :vartype value: list[~azure.mgmt.networkcloud.models.EdgeCluster]
    """

    _attribute_map = {
        "next_link": {"key": "nextLink", "type": "str"},
        "value": {"key": "value", "type": "[EdgeCluster]"},
    }

    def __init__(
        self, *, next_link: Optional[str] = None, value: Optional[List["_models.EdgeCluster"]] = None, **kwargs: Any
    ) -> None:
        """
        :keyword next_link: The link used to get the next page of operations.
        :paramtype next_link: str
        :keyword value: The list of edge clusters.
        :paramtype value: list[~azure.mgmt.networkcloud.models.EdgeCluster]
        """
        super().__init__(**kwargs)
        self.next_link = next_link
        self.value = value
...
class EdgeClusterMachineSku(ProxyResource):
    """EdgeClusterMachineSku represents a machine or server configuration that is supported by one or
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.networkcloud.models.SystemData
    :ivar cpus: The list of cpus for the machine.
    :vartype cpus: list[~azure.mgmt.networkcloud.models.EdgeClusterMachineSkuCpu]
    :ivar devices: The list of devices for the machine.
    :vartype devices: list[~azure.mgmt.networkcloud.models.EdgeClusterMachineSkuDevice]
    :ivar memory: The memory configuration for the machine.
    :vartype memory: ~azure.mgmt.networkcloud.models.EdgeClusterMachineSkuMemory
    :ivar system: The bios and top-level system related information.
    :vartype system: ~azure.mgmt.networkcloud.models.EdgeClusterMachineSkuSystem
    """
    ...
    _attribute_map = {
        ...
        "type": {"key": "type", "type": "str"},
        "system_data": {"key": "systemData", "type": "SystemData"},
        "cpus": {"key": "properties.cpus", "type": "[EdgeClusterMachineSkuCpu]"},
        "devices": {"key": "properties.devices", "type": "[EdgeClusterMachineSkuDevice]"},
        "memory": {"key": "properties.memory", "type": "EdgeClusterMachineSkuMemory"},
        "system": {"key": "properties.system", "type": "EdgeClusterMachineSkuSystem"},
    }

    def __init__(
        self,
        *,
        memory: Optional["_models.EdgeClusterMachineSkuMemory"] = None,
        system: Optional["_models.EdgeClusterMachineSkuSystem"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword memory: The memory configuration for the machine.
        :paramtype memory: ~azure.mgmt.networkcloud.models.EdgeClusterMachineSkuMemory
        :keyword system: The bios and top-level system related information.
        :paramtype system: ~azure.mgmt.networkcloud.models.EdgeClusterMachineSkuSystem
        """
        super().__init__(**kwargs)
        self.cpus = None
        self.devices = None
...
class EdgeClusterMachineSkuCpu(_serialization.Model):
    """EdgeClusterMachineSkuCpu represents the CPU configuration of an edge cluster machine.

    Variables are only populated by the server, and will be ignored when sending a request.

    :ivar model_name: The vendor supplied model name of the CPU reported by processor inspection.
...
class EdgeClusterMachineSkuDevice(_serialization.Model):
    """EdgeClusterMachineSkuDevice represents a device of an edge cluster machine.

    Variables are only populated by the server, and will be ignored when sending a request.

    :ivar address: The PCI or bus address of the device. If there are multiple addresses this value
     will be omitted.
    :vartype address: str
    :ivar addresses: The list of PCI or bus addresses associated with the device. When there is
     only one value, the first value will match the address field value.
    :vartype addresses: list[str]
    :ivar bus: The bus that connects this device.
    :vartype bus: str
    :ivar class_property: The class of the device.
    :vartype class_property: str
    :ivar extra: The information about a device that does not have a defined field. The information
     in this field is subject to move to a more appropriate field in future versions.
    :vartype extra: str
    :ivar memory: The amount of memory for a device measured in gibibytes. This value is specified
     for devices such as GPUs.
    :vartype memory: int
    :ivar model: The model of the device.
    :vartype model: str
    :ivar port_count: The number of ports on the device. This value is only specified for devices
     with ports.
    :vartype port_count: int
    :ivar size_gb: The advertised size of a storage device in gibibytes.
    :vartype size_gb: int
    :ivar vendor: The vendor for the device.
    :vartype vendor: str
    """
    ...
    _validation = {
        ...
        "bus": {"readonly": True},
        "class_property": {"readonly": True},
        "extra": {"readonly": True},
        "memory": {"readonly": True},
        "model": {"readonly": True},
        "port_count": {"readonly": True},
        "size_gb": {"readonly": True},
...
class EdgeClusterMachineSkuList(_serialization.Model):
    """EdgeClusterMachineSkuList represents a list of edge cluster machine SKUs.

    :ivar next_link: The link used to get the next page of operations.
    :vartype next_link: str
    :ivar value: The list of edge cluster machine SKUs.
    :vartype value: list[~azure.mgmt.networkcloud.models.EdgeClusterMachineSku]
    """

    _attribute_map = {
        "next_link": {"key": "nextLink", "type": "str"},
        "value": {"key": "value", "type": "[EdgeClusterMachineSku]"},
    }
    ...
    def __init__(
        ...
        *,
        next_link: Optional[str] = None,
        value: Optional[List["_models.EdgeClusterMachineSku"]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword next_link: The link used to get the next page of operations.
        :paramtype next_link: str
        :keyword value: The list of edge cluster machine SKUs.
        :paramtype value: list[~azure.mgmt.networkcloud.models.EdgeClusterMachineSku]
        """
        super().__init__(**kwargs)
        self.next_link = next_link
        self.value = value
...
class EdgeClusterMachineSkuMemory(_serialization.Model):
    """EdgeClusterMachineSkuMemory represents the memory configuration of an edge cluster machine.

    Variables are only populated by the server, and will be ignored when sending a request.

    :ivar size_gb: The size of the memory in gibibytes.
    :vartype size_gb: int
    """
...
class EdgeClusterMachineSkuSystem(_serialization.Model):
    """EdgeClusterMachineSkuSystem represents the BIOS and top-level system related information of an
    edge cluster machine.

    Variables are only populated by the server, and will be ignored when sending a request.

    :ivar product_name: The system product name.
    :vartype product_name: str
    :ivar vendor: The system vendor.
    :vartype vendor: str
    """
...
class EdgeClusterNode(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar location: The geo-location where the resource lives. Required.
    :vartype location: str
    :ivar infrastructure_resource_ids: The resource IDs of the resources that depend on the Edge
     Cluster. This includes both infrastructure resources added automatically and workload resources
     that are added through orchestration.
    :vartype infrastructure_resource_ids: list[str]
    :ivar kubernetes_version: The version of Kubernetes running on the node. This will typically
     match the Edge Cluster’s Kubernetes version, but may differ during upgrade activities.
    :vartype kubernetes_version: str
    :ivar lifecycle_status: The lifecycle status of the edge cluster node resource. Known values
     are: "Unassociated", "Registering", "Joined", "PlatformReady", "UpdatingRuntime", and "Failed".
    :vartype lifecycle_status: str or
     ~azure.mgmt.networkcloud.models.EdgeClusterNodeLifecycleStatus
    :ivar machine_sku_id: The resource ID of the SKU of the edge cluster node. Required.
    :vartype machine_sku_id: str
    :ivar network_interfaces: The network interfaces of the node.
    :vartype network_interfaces:
     list[~azure.mgmt.networkcloud.models.EdgeClusterNodeNetworkInterface]
    :ivar node_matching_identifiers: The identifiers used to match the node to a machine in the
     registration hub.
    :vartype node_matching_identifiers:
     list[~azure.mgmt.networkcloud.models.EdgeClusterNodeMatchingIdentifier]
    :ivar provisioning_state: The provisioning state of the edge cluster node. Known values are:
     "Succeeded", "Failed", "Canceled", and "Accepted".
    :vartype provisioning_state: str or
     ~azure.mgmt.networkcloud.models.EdgeClusterNodeProvisioningState
    :ivar registration_hub_machine_id: The resource ID of the machine in the registration hub that
     the node is registered against.
    :vartype registration_hub_machine_id: str
    :ivar runtime_version_id: The resource ID of the runtime version of the Nexus software running
     on the machine of the node. This will typically match the Edge Cluster’s runtime, but may
     differ during upgrade activities.
    :vartype runtime_version_id: str
    :ivar scheduling_labels: The labels used to schedule resources on this node.
    :vartype scheduling_labels: list[~azure.mgmt.networkcloud.models.KubernetesLabel]
    :ivar staged_runtime_version_id: The resource ID of the runtime version of the Nexus software
     that has been pre-staged to the machine, pending a cluster runtime update. If no runtime has
     been staged, this field will be omitted. During the process of staging a runtime, this field
     will be empty. It will only be populated when the staging has completed.
    :vartype staged_runtime_version_id: str
    """
    ...
    _validation = {
        ...
        "provisioning_state": {"readonly": True},
        "runtime_version_id": {"readonly": True},
        "staged_runtime_version_id": {"readonly": True},
    }
    ...
    _attribute_map = {
        ...
        "lifecycle_status": {"key": "properties.lifecycleStatus", "type": "str"},
        "machine_sku_id": {"key": "properties.machineSkuId", "type": "str"},
        "network_interfaces": {"key": "properties.networkInterfaces", "type": "[EdgeClusterNodeNetworkInterface]"},
        "node_matching_identifiers": {
            "key": "properties.nodeMatchingIdentifiers",
            "type": "[EdgeClusterNodeMatchingIdentifier]",
        },
        "provisioning_state": {"key": "properties.provisioningState", "type": "str"},
        "registration_hub_machine_id": {"key": "properties.registrationHubMachineId", "type": "str"},
        "runtime_version_id": {"key": "properties.runtimeVersionId", "type": "str"},
        "scheduling_labels": {"key": "properties.schedulingLabels", "type": "[KubernetesLabel]"},
        "staged_runtime_version_id": {"key": "properties.stagedRuntimeVersionId", "type": "str"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        machine_sku_id: str,
        tags: Optional[Dict[str, str]] = None,
        node_matching_identifiers: Optional[List["_models.EdgeClusterNodeMatchingIdentifier"]] = None,
        registration_hub_machine_id: Optional[str] = None,
        scheduling_labels: Optional[List["_models.KubernetesLabel"]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword tags: Resource tags.
        ...
        :keyword location: The geo-location where the resource lives. Required.
        :paramtype location: str
        :keyword machine_sku_id: The resource ID of the SKU of the edge cluster node. Required.
        :paramtype machine_sku_id: str
        :keyword node_matching_identifiers: The identifiers used to match the node to a machine in the
         registration hub.
        :paramtype node_matching_identifiers:
         list[~azure.mgmt.networkcloud.models.EdgeClusterNodeMatchingIdentifier]
        :keyword registration_hub_machine_id: The resource ID of the machine in the registration hub
         that the node is registered against.
        :paramtype registration_hub_machine_id: str
        :keyword scheduling_labels: The labels used to schedule resources on this node.
        :paramtype scheduling_labels: list[~azure.mgmt.networkcloud.models.KubernetesLabel]
        """
        super().__init__(tags=tags, location=location, **kwargs)
        self.infrastructure_resource_ids = None
        self.kubernetes_version = None
        ...
        self.node_matching_identifiers = node_matching_identifiers
        self.provisioning_state = None
        self.registration_hub_machine_id = registration_hub_machine_id
        self.runtime_version_id = None
        self.scheduling_labels = scheduling_labels
        self.staged_runtime_version_id = None


class EdgeClusterNodeList(_serialization.Model):
    """EdgeClusterNodeList represents the list of edge cluster node objects.

    :ivar next_link: The link used to get the next page of operations.
    :vartype next_link: str
    :ivar value: The list of edge cluster nodes.
    :vartype value: list[~azure.mgmt.networkcloud.models.EdgeClusterNode]
    """

    _attribute_map = {
        "next_link": {"key": "nextLink", "type": "str"},
        "value": {"key": "value", "type": "[EdgeClusterNode]"},
    }

    def __init__(
        self, *, next_link: Optional[str] = None, value: Optional[List["_models.EdgeClusterNode"]] = None, **kwargs: Any
    ) -> None:
        """
        :keyword next_link: The link used to get the next page of operations.
        :paramtype next_link: str
        :keyword value: The list of edge cluster nodes.
        :paramtype value: list[~azure.mgmt.networkcloud.models.EdgeClusterNode]
        """
        super().__init__(**kwargs)
        self.next_link = next_link
        self.value = value
...
class EdgeClusterNodeMatchingIdentifier(_serialization.Model):
    """EdgeClusterNodeMatchingIdentifier represents a field to match against a machine in the
    registration hub during association with an edge cluster node.

    All required parameters must be populated in order to send to server.

    :ivar name: Name is the name of the identifier. Required. Known values are:
     "ProductSerialNumber" and "AnyMacAddress".
    :vartype name: str or ~azure.mgmt.networkcloud.models.EdgeClusterNodeMatchingIdentifierName
    :ivar value: Value is the value of the identifier. Required.
    :vartype value: str
    """
    ...
    def __init__(
        self, *, name: Union[str, "_models.EdgeClusterNodeMatchingIdentifierName"], value: str, **kwargs: Any
    ) -> None:
        """
        :keyword name: Name is the name of the identifier. Required. Known values are:
         "ProductSerialNumber" and "AnyMacAddress".
        :paramtype name: str or ~azure.mgmt.networkcloud.models.EdgeClusterNodeMatchingIdentifierName
        :keyword value: Value is the value of the identifier. Required.
        :paramtype value: str
        """
        super().__init__(**kwargs)
        self.name = name
...
class EdgeClusterNodeNetworkInterface(_serialization.Model):
    """EdgeClusterNodeNetworkInterface represents the properties of the network interface of an edge
    cluster node.

    Variables are only populated by the server, and will be ignored when sending a request.

    :ivar ipv4_address: The IPv4 address of the network interface.
    :vartype ipv4_address: str
    :ivar ipv6_address: The IPv6 address of the network interface.
    :vartype ipv6_address: str
    :ivar mac_address: The MAC address of the network interface.
    :vartype mac_address: str
    :ivar name: The name of the network interface as represented on the host.
    :vartype name: str
    """
...
class EdgeClusterNodePatchParameters(_serialization.Model):
    """EdgeClusterNodePatchParameters represents the body of the request to patch the edge cluster
    node.

    :ivar tags: The Azure resource tags that will replace the existing ones.
    :vartype tags: dict[str, str]
    :ivar machine_sku_id: The resource ID of the SKU of the edge cluster node.
    :vartype machine_sku_id: str
    :ivar node_matching_identifiers: The identifiers used to match the node to a machine in the
     registration hub.
    :vartype node_matching_identifiers:
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword tags: The Azure resource tags that will replace the existing ones.
        :paramtype tags: dict[str, str]
        :keyword machine_sku_id: The resource ID of the SKU of the edge cluster node.
        :paramtype machine_sku_id: str
        :keyword node_matching_identifiers: The identifiers used to match the node to a machine in the
         registration hub.
        :paramtype node_matching_identifiers:
...
class EdgeClusterPatchParameters(_serialization.Model):
    """EdgeClusterPatchParameters represents the body of the request to patch the edge cluster
    properties.
    ...
    def __init__(
        ...
        *,
        ...
        entra_configuration: Optional["_models.EdgeClusterEntraConfiguration"] = None,
        registration_hub_id: Optional[str] = None,
        runtime_version_id: Optional[str] = None,
        workload_resource_ids: Optional[List[str]] = None,
        **kwargs: Any
    ) -> None:
        """
...
class EdgeClusterPtpConfiguration(_serialization.Model):
    """EdgeClusterPtpConfiguration represents the PTP clock configuration for the edge cluster, if
    applicable.

    All required parameters must be populated in order to send to server.

    :ivar domain_number: The IEEE 1588-2008 domain number. Required.
    :vartype domain_number: int
    :ivar l2_vlan_number: The L2 VLAN number.
    :vartype l2_vlan_number: int
    :ivar network_transport_type: The network transport type for PTP. Required. Known values are:
     "UDPv4", "UDPv6", and "L2".
    :vartype network_transport_type: str or
     ~azure.mgmt.networkcloud.models.EdgeClusterPtpConfigurationNetworkTransportType
    :ivar udp_address: The IPv4 or IPv6 address if the networkTransportType is set to UDPv4 or
     UDPv6 respectively.
    :vartype udp_address: str
    """

    _validation = {
        "domain_number": {"required": True},
        "network_transport_type": {"required": True},
    }

    _attribute_map = {
        "domain_number": {"key": "domainNumber", "type": "int"},
        "l2_vlan_number": {"key": "l2VlanNumber", "type": "int"},
        "network_transport_type": {"key": "networkTransportType", "type": "str"},
        "udp_address": {"key": "udpAddress", "type": "str"},
    }
    ...
    def __init__(
        ...
        *,
        domain_number: int,
        network_transport_type: Union[str, "_models.EdgeClusterPtpConfigurationNetworkTransportType"],
        l2_vlan_number: Optional[int] = None,
        udp_address: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword domain_number: The IEEE 1588-2008 domain number. Required.
        :paramtype domain_number: int
        :keyword l2_vlan_number: The L2 VLAN number.
        :paramtype l2_vlan_number: int
        :keyword network_transport_type: The network transport type for PTP. Required. Known values
         are: "UDPv4", "UDPv6", and "L2".
        :paramtype network_transport_type: str or
         ~azure.mgmt.networkcloud.models.EdgeClusterPtpConfigurationNetworkTransportType
        :keyword udp_address: The IPv4 or IPv6 address if the networkTransportType is set to UDPv4 or
         UDPv6 respectively.
        :paramtype udp_address: str
        """
        super().__init__(**kwargs)
        self.domain_number = domain_number
        self.l2_vlan_number = l2_vlan_number
        self.network_transport_type = network_transport_type
        self.udp_address = udp_address


class EdgeClusterRuntimeVersion(ProxyResource):  # pylint: disable=too-many-instance-attributes
    """EdgeClusterRuntimeVersion represents a version of the use case specific software that runs an
    Edge Cluster.
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.networkcloud.models.SystemData
    :ivar attributes: The key to value mapping of other descriptive information that is not
     represented in another field of this runtime version.
    :vartype attributes: list[~azure.mgmt.networkcloud.models.StringKeyValuePair]
    :ivar description: The description of the edge cluster runtime version.
    :vartype description: str
    :ivar host_image_name: The name of the host image that is used for this edge cluster runtime
     version.
    :vartype host_image_name: str
    :ivar kubernetes_version: The Kubernetes version associated with this edge cluster runtime
     version.
    :vartype kubernetes_version: str
    :ivar upgradable_from_version: The range of versions that can be upgraded to from this edge
     cluster runtime version.
    :vartype upgradable_from_version: ~azure.mgmt.networkcloud.models.VersionRange
    :ivar usage_domain: The domain of use of the edge cluster runtime version.
    :vartype usage_domain: ~azure.mgmt.networkcloud.models.UsageDomain
    :ivar version: The version number for this runtime version.
    :vartype version: str
    """
    ...
    _attribute_map = {
        ...
        "type": {"key": "type", "type": "str"},
        "system_data": {"key": "systemData", "type": "SystemData"},
        "attributes": {"key": "properties.attributes", "type": "[StringKeyValuePair]"},
        "description": {"key": "properties.description", "type": "str"},
        "host_image_name": {"key": "properties.hostImageName", "type": "str"},
        "kubernetes_version": {"key": "properties.kubernetesVersion", "type": "str"},
        "upgradable_from_version": {"key": "properties.upgradableFromVersion", "type": "VersionRange"},
        "usage_domain": {"key": "properties.usageDomain", "type": "UsageDomain"},
    ...
    def __init__(
        self,
        *,
        upgradable_from_version: Optional["_models.VersionRange"] = None,
        usage_domain: Optional["_models.UsageDomain"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword upgradable_from_version: The range of versions that can be upgraded to from this edge
         cluster runtime version.
        :paramtype upgradable_from_version: ~azure.mgmt.networkcloud.models.VersionRange
        :keyword usage_domain: The domain of use of the edge cluster runtime version.
        :paramtype usage_domain: ~azure.mgmt.networkcloud.models.UsageDomain
        """
        super().__init__(**kwargs)
        self.attributes = None
        self.description = None
        self.host_image_name = None
        self.kubernetes_version = None
        self.upgradable_from_version = upgradable_from_version
        self.usage_domain = usage_domain
        self.version = None


class EdgeClusterRuntimeVersionList(_serialization.Model):
    """EdgeClusterRuntimeVersionList represents a list of edge cluster runtime versions.

    :ivar next_link: The link used to get the next page of operations.
    :vartype next_link: str
    :ivar value: The list of edge cluster runtime versions.
    :vartype value: list[~azure.mgmt.networkcloud.models.EdgeClusterRuntimeVersion]
    """

    _attribute_map = {
        "next_link": {"key": "nextLink", "type": "str"},
        "value": {"key": "value", "type": "[EdgeClusterRuntimeVersion]"},
    }
    ...
    def __init__(
        ...
        *,
        next_link: Optional[str] = None,
        value: Optional[List["_models.EdgeClusterRuntimeVersion"]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword next_link: The link used to get the next page of operations.
        :paramtype next_link: str
        :keyword value: The list of edge cluster runtime versions.
        :paramtype value: list[~azure.mgmt.networkcloud.models.EdgeClusterRuntimeVersion]
        """
        super().__init__(**kwargs)
        self.next_link = next_link
        self.value = value
...
class EdgeClusterSku(ProxyResource):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.networkcloud.models.SystemData
    :ivar fabric_managed_by: Indicates if the network fabric is managed by the user or by the
     system. Known values are: "System" and "User".
    :vartype fabric_managed_by: str or
     ~azure.mgmt.networkcloud.models.EdgeClusterSkuFabricManagedBy
    :ivar machine_sku_support: The list of supported edge cluster machine SKUs that can be used for
     this edge cluster.
    :vartype machine_sku_support: list[~azure.mgmt.networkcloud.models.MachineSkuSupportRange]
    :ivar maximum_node_quantity: The largest number of nodes that can be created in this edge
     cluster.
    :vartype maximum_node_quantity: int
    :ivar minimum_node_quantity: The smallest number of nodes that can be created for this edge
     cluster.
    :vartype minimum_node_quantity: int
    :ivar ptp_required: Indicates if the edge cluster uses the Precision Time Protocol (PTP) for
     time synchronization. Known values are: "True" and "False".
    :vartype ptp_required: str or ~azure.mgmt.networkcloud.models.EdgeClusterSkuPtpRequired
    :ivar usage_domain: The use case of the edge cluster.
    :vartype usage_domain: ~azure.mgmt.networkcloud.models.UsageDomain
    """
    ...
    _validation = {
        ...
        "type": {"readonly": True},
        "system_data": {"readonly": True},
        "fabric_managed_by": {"readonly": True},
        "machine_sku_support": {"readonly": True},
        "maximum_node_quantity": {"readonly": True},
        "minimum_node_quantity": {"readonly": True},
        "ptp_required": {"readonly": True},
    }
    ...
    _attribute_map = {
        ...
        "type": {"key": "type", "type": "str"},
        "system_data": {"key": "systemData", "type": "SystemData"},
        "fabric_managed_by": {"key": "properties.fabricManagedBy", "type": "str"},
        "machine_sku_support": {"key": "properties.machineSkuSupport", "type": "[MachineSkuSupportRange]"},
        "maximum_node_quantity": {"key": "properties.maximumNodeQuantity", "type": "int"},
        "minimum_node_quantity": {"key": "properties.minimumNodeQuantity", "type": "int"},
        "ptp_required": {"key": "properties.ptpRequired", "type": "str"},
        "usage_domain": {"key": "properties.usageDomain", "type": "UsageDomain"},
    }

    def __init__(self, *, usage_domain: Optional["_models.UsageDomain"] = None, **kwargs: Any) -> None:
        """
        :keyword usage_domain: The use case of the edge cluster.
        :paramtype usage_domain: ~azure.mgmt.networkcloud.models.UsageDomain
        """
        super().__init__(**kwargs)
        self.fabric_managed_by = None
        self.machine_sku_support = None
        self.maximum_node_quantity = None
        self.minimum_node_quantity = None
        self.ptp_required = None
        self.usage_domain = usage_domain


class EdgeClusterSkuList(_serialization.Model):
    """EdgeClusterSkuList represents a list of edge cluster SKUs.

    :ivar next_link: The link used to get the next page of operations.
    :vartype next_link: str
    :ivar value: The list of edge cluster SKUs.
    :vartype value: list[~azure.mgmt.networkcloud.models.EdgeClusterSku]
    """

    _attribute_map = {
        "next_link": {"key": "nextLink", "type": "str"},
        "value": {"key": "value", "type": "[EdgeClusterSku]"},
    }

    def __init__(
        self, *, next_link: Optional[str] = None, value: Optional[List["_models.EdgeClusterSku"]] = None, **kwargs: Any
    ) -> None:
        """
        :keyword next_link: The link used to get the next page of operations.
        :paramtype next_link: str
        :keyword value: The list of edge cluster SKUs.
        :paramtype value: list[~azure.mgmt.networkcloud.models.EdgeClusterSku]
        """
        super().__init__(**kwargs)
        self.next_link = next_link
        self.value = value
...
class EdgeClusterStageRuntimeParameters(_serialization.Model):
    """EdgeClusterStageRuntimeParameters represents the body of the request to stage a runtime version
    for an edge cluster.

    All required parameters must be populated in order to send to server.

    :ivar target_runtime_version_id: TargetRuntimeVersionId represents the resource ID of the
     runtime to stage. This runtime must be a valid upgrade for the Edge Cluster. Required.
    :vartype target_runtime_version_id: str
    """

    _validation = {
        "target_runtime_version_id": {"required": True},
    }
    ...
    def __init__(self, *, target_runtime_version_id: str, **kwargs: Any) -> None:
        """
        :keyword target_runtime_version_id: TargetRuntimeVersionId represents the resource ID of the
         runtime to stage. This runtime must be a valid upgrade for the Edge Cluster. Required.
        :paramtype target_runtime_version_id: str
        """
        super().__init__(**kwargs)
        self.target_runtime_version_id = target_runtime_version_id
...
class HybridConnectionConfig(_serialization.Model):
    ...
    :ivar expiration_time: ExpirationTime the the timestamp when the token will be expired.
    :vartype expiration_time: int
    :ivar hybrid_connection_name: HybridConnectionName is the name of the hybrid connection.
    :vartype hybrid_connection_name: str
    :ivar relay: Relay is the name of the relay.
    :vartype relay: str
    :ivar token: Token is the sender access token.
    :vartype token: str
    """
...
class KubernetesClusterNode(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar bare_metal_machine_id: The resource ID of the bare metal machine or edge cluster node
     that hosts this node.
...
class ListUserCredentialParameters(_serialization.Model):
    """ListUserCredentialParameters represents the options for listing the cluster user credentials.

    All required parameters must be populated in order to send to server.

    :ivar access_mechanism: The indicator of which credential to return based on the access
     mechanism specified. Utilize Local for access from the same subnet as the edge cluster, and
     Relay for remote access across a relay. Known values are: "Relay" and "Local".
    :vartype access_mechanism: str or
     ~azure.mgmt.networkcloud.models.ListEdgeClusterUserCredentialAccessMechanism
    ...
    :vartype authentication_method: str or
     ~azure.mgmt.networkcloud.models.UserCredentialAuthenticationMethod
    :ivar client_proxy: Client proxy indicates if the returned credentials are for the client-side
     proxy. Required. Known values are: "True" and "False".
    :vartype client_proxy: str or
     ~azure.mgmt.networkcloud.models.ListEdgeClusterUserCredentialClientProxy
    """
    ...
    _attribute_map = {
        "access_mechanism": {"key": "accessMechanism", "type": "str"},
        "authentication_method": {"key": "authenticationMethod", "type": "str"},
        "client_proxy": {"key": "clientProxy", "type": "str"},
    }

    def __init__(
        self,
        *,
        authentication_method: Union[str, "_models.UserCredentialAuthenticationMethod"],
        client_proxy: Union[str, "_models.ListEdgeClusterUserCredentialClientProxy"],
        access_mechanism: Union[str, "_models.ListEdgeClusterUserCredentialAccessMechanism"] = "Relay",
        **kwargs: Any
    ) -> None:
        """
        :keyword access_mechanism: The indicator of which credential to return based on the access
         mechanism specified. Utilize Local for access from the same subnet as the edge cluster, and
         Relay for remote access across a relay. Known values are: "Relay" and "Local".
        :paramtype access_mechanism: str or
         ~azure.mgmt.networkcloud.models.ListEdgeClusterUserCredentialAccessMechanism
        ...
        :paramtype authentication_method: str or
         ~azure.mgmt.networkcloud.models.UserCredentialAuthenticationMethod
        :keyword client_proxy: Client proxy indicates if the returned credentials are for the
         client-side proxy. Required. Known values are: "True" and "False".
        :paramtype client_proxy: str or
         ~azure.mgmt.networkcloud.models.ListEdgeClusterUserCredentialClientProxy
        """
        super().__init__(**kwargs)
...
class MachineSkuSupportRange(_serialization.Model):
    """MachineSkuSupportRange represents a range of supported machine SKUs for an edge cluster.

    Variables are only populated by the server, and will be ignored when sending a request.

    :ivar machine_sku_id: The resource ID of the edge cluster machine SKU supported.
    :vartype machine_sku_id: str
    :ivar version_range: The range of versions supported for the edge cluster machine SKU.
    :vartype version_range: ~azure.mgmt.networkcloud.models.VersionRange
    """

    _validation = {
        "machine_sku_id": {"readonly": True},
    }

    _attribute_map = {
        "machine_sku_id": {"key": "machineSkuId", "type": "str"},
        "version_range": {"key": "versionRange", "type": "VersionRange"},
    }

    def __init__(self, *, version_range: Optional["_models.VersionRange"] = None, **kwargs: Any) -> None:
        """
        :keyword version_range: The range of versions supported for the edge cluster machine SKU.
        :paramtype version_range: ~azure.mgmt.networkcloud.models.VersionRange
        """
        super().__init__(**kwargs)
        self.machine_sku_id = None
...
class RegistrationHub(TrackedResource):
    """RegistrationHub represents the resource responsible for onboarding and bootstrapping of
    machines that are used in Edge Clusters.
    ...
    :ivar location: The geo-location where the resource lives. Required.
    :vartype location: str
    :ivar azure_relay_endpoint: The URL to access the azure relay for the registration hub.
    :vartype azure_relay_endpoint: str
    :ivar azure_relay_id: The resource ID of the relay that has been set up to serve the
     registration hub.
    :vartype azure_relay_id: str
    :ivar description: The user-provided information about the registration hub.
    :vartype description: str
    :ivar provisioning_state: The provisioning state of the registration hub resource. Known values
     are: "Succeeded", "Failed", "Canceled", and "Accepted".
    :vartype provisioning_state: str or
     ~azure.mgmt.networkcloud.models.RegistrationHubProvisioningState
    """
    ...
    _validation = {
        ...
        "system_data": {"readonly": True},
        "location": {"required": True},
        "azure_relay_endpoint": {"readonly": True},
        "azure_relay_id": {"readonly": True},
    ...
    _attribute_map = {
        ...
        "tags": {"key": "tags", "type": "{str}"},
        "location": {"key": "location", "type": "str"},
        "azure_relay_endpoint": {"key": "properties.azureRelayEndpoint", "type": "str"},
        "azure_relay_id": {"key": "properties.azureRelayId", "type": "str"},
        "description": {"key": "properties.description", "type": "str"},
        "provisioning_state": {"key": "properties.provisioningState", "type": "str"},
    }
    ...
    def __init__(
        ...
        :keyword location: The geo-location where the resource lives. Required.
        :paramtype location: str
        :keyword description: The user-provided information about the registration hub.
        :paramtype description: str
        """
        super().__init__(tags=tags, location=location, **kwargs)
        self.azure_relay_endpoint = None
        self.azure_relay_id = None
        self.description = description
        self.provisioning_state = None


class RegistrationHubImage(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar location: The geo-location where the resource lives. Required.
    :vartype location: str
    :ivar allow_registration: The indicator of whether the image can be used to register machines.
     Known values are: "True" and "False".
    :vartype allow_registration: str or ~azure.mgmt.networkcloud.models.AllowRegistration
    :ivar client_configuration: The base64 encoded client configuration that contains the system
     provided information for the bootstrap process.
    :vartype client_configuration: str
    :ivar custom_configuration: The base64 encoded configuration that can be modified with custom
     settings for the bootstrap process.
    :vartype custom_configuration: str
    :ivar description: The user provided information about the registration hub image.
    :vartype description: str
    :ivar image_download_uri: The URI where the bootstrap image can be downloaded from.
    :vartype image_download_uri: str
    :ivar image_unique_id: The unique identifier that represents this image.
    :vartype image_unique_id: str
    :ivar provisioning_state: The provisioning state of the registration hub image resource. Known
     values are: "Succeeded", "Failed", "Canceled", and "Accepted".
    :vartype provisioning_state: str or
     ~azure.mgmt.networkcloud.models.RegistrationHubImageProvisioningState
    """
    ...
    _validation = {
        ...
        "system_data": {"readonly": True},
        "location": {"required": True},
        "client_configuration": {"readonly": True},
        "custom_configuration": {"readonly": True},
        "description": {"max_length": 4000},
        "image_download_uri": {"readonly": True},
        "provisioning_state": {"readonly": True},
    }
    ...
    _attribute_map = {
        ...
        "tags": {"key": "tags", "type": "{str}"},
        "location": {"key": "location", "type": "str"},
        "allow_registration": {"key": "properties.allowRegistration", "type": "str"},
        "client_configuration": {"key": "properties.clientConfiguration", "type": "str"},
        "custom_configuration": {"key": "properties.customConfiguration", "type": "str"},
        "description": {"key": "properties.description", "type": "str"},
        "image_download_uri": {"key": "properties.imageDownloadUri", "type": "str"},
        "image_unique_id": {"key": "properties.imageUniqueId", "type": "str"},
        "provisioning_state": {"key": "properties.provisioningState", "type": "str"},
    }
    ...
    def __init__(
        ...
        *,
        location: str,
        tags: Optional[Dict[str, str]] = None,
        allow_registration: Optional[Union[str, "_models.AllowRegistration"]] = None,
        description: Optional[str] = None,
        ...
        **kwargs: Any
        ...
        :keyword location: The geo-location where the resource lives. Required.
        :paramtype location: str
        :keyword allow_registration: The indicator of whether the image can be used to register
         machines. Known values are: "True" and "False".
        :paramtype allow_registration: str or ~azure.mgmt.networkcloud.models.AllowRegistration
        :keyword description: The user provided information about the registration hub image.
        :paramtype description: str
        :keyword image_unique_id: The unique identifier that represents this image.
        :paramtype image_unique_id: str
        """
        super().__init__(tags=tags, location=location, **kwargs)
        self.allow_registration = allow_registration
        self.client_configuration = None
        self.custom_configuration = None
        self.description = description
        self.image_download_uri = None
        self.image_unique_id = image_unique_id
        self.provisioning_state = None


class RegistrationHubImageList(_serialization.Model):
    """RegistrationHubImageList represents a list of registration hub images.

    :ivar next_link: The link used to get the next page of operations.
    :vartype next_link: str
    :ivar value: The list of registration hub images.
    :vartype value: list[~azure.mgmt.networkcloud.models.RegistrationHubImage]
    """

    _attribute_map = {
        "next_link": {"key": "nextLink", "type": "str"},
        "value": {"key": "value", "type": "[RegistrationHubImage]"},
    }
    ...
    def __init__(
        ...
        *,
        next_link: Optional[str] = None,
        value: Optional[List["_models.RegistrationHubImage"]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword next_link: The link used to get the next page of operations.
        :paramtype next_link: str
        :keyword value: The list of registration hub images.
        :paramtype value: list[~azure.mgmt.networkcloud.models.RegistrationHubImage]
        """
        super().__init__(**kwargs)
        self.next_link = next_link
        self.value = value
...
class RegistrationHubImagePatchParameters(_serialization.Model):
    """RegistrationHubImagePatchParameters represents the body of the request to patch the
    registration hub image properties.
    ...
    :ivar allow_registration: The indicator of whether the image can be used to register machines.
     Known values are: "True" and "False".
    :vartype allow_registration: str or ~azure.mgmt.networkcloud.models.AllowRegistration
    :ivar description: User provided information about the registration hub image.
    :vartype description: str
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword allow_registration: The indicator of whether the image can be used to register
         machines. Known values are: "True" and "False".
        :paramtype allow_registration: str or ~azure.mgmt.networkcloud.models.AllowRegistration
        :keyword description: User provided information about the registration hub image.
        :paramtype description: str
        """
        super().__init__(**kwargs)
        self.tags = tags
...
class RegistrationHubList(_serialization.Model):
    """RegistrationHubList represents a list of registration hubs.

    :ivar next_link: The link used to get the next page of operations.
    :vartype next_link: str
    :ivar value: The list of registration hubs.
    :vartype value: list[~azure.mgmt.networkcloud.models.RegistrationHub]
    """

    _attribute_map = {
        "next_link": {"key": "nextLink", "type": "str"},
        "value": {"key": "value", "type": "[RegistrationHub]"},
    }

    def __init__(
        self, *, next_link: Optional[str] = None, value: Optional[List["_models.RegistrationHub"]] = None, **kwargs: Any
    ) -> None:
        """
        :keyword next_link: The link used to get the next page of operations.
        :paramtype next_link: str
        :keyword value: The list of registration hubs.
        :paramtype value: list[~azure.mgmt.networkcloud.models.RegistrationHub]
        """
        super().__init__(**kwargs)
        self.next_link = next_link
        self.value = value
...
class RegistrationHubMachine(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar location: The geo-location where the resource lives. Required.
    :vartype location: str
    :ivar associated_resource_id: The resource ID of the edge cluster node that has been associated
     with this machine.
    :vartype associated_resource_id: str
    :ivar description: The user-provided freeform description for the machine.
    :vartype description: str
    :ivar last_registration_poll_time: The timestamp of the last polling request from a machine
     that is undergoing registration.
    :vartype last_registration_poll_time: ~datetime.datetime
    :ivar machine_configuration: The hardware configuration of the machine supplied during the
     registration process. Required.
    :vartype machine_configuration:
     ~azure.mgmt.networkcloud.models.RegistrationHubMachineConfiguration
    :ivar machine_sku_id: The resource ID of the machine SKU that is identified by the hardware
     information provided for the machine.
    :vartype machine_sku_id: str
    :ivar provisioning_state: The provisioning state of the registration hub machine resource.
     Known values are: "Succeeded", "Failed", "Canceled", and "Accepted".
    :vartype provisioning_state: str or
     ~azure.mgmt.networkcloud.models.RegistrationHubMachineProvisioningState
    :ivar registration_hub_image_id: The resource ID of the registration hub image that was used to
     bootstrap the machine.
    :vartype registration_hub_image_id: str
    :ivar registration_state: The stage and disposition of the registration for the machine. Known
     values are: "Unapproved", "Approved", "Declined", and "Complete".
    :vartype registration_state: str or
     ~azure.mgmt.networkcloud.models.RegistrationHubMachineRegistrationState
    """
    ...
    _validation = {
        ...
        "last_registration_poll_time": {"readonly": True},
        "machine_configuration": {"required": True},
        "machine_sku_id": {"readonly": True},
        "provisioning_state": {"readonly": True},
        "registration_hub_image_id": {"readonly": True},
    ...
    _attribute_map = {
        ...
        "tags": {"key": "tags", "type": "{str}"},
        "location": {"key": "location", "type": "str"},
        "associated_resource_id": {"key": "properties.associatedResourceId", "type": "str"},
        "description": {"key": "properties.description", "type": "str"},
        "last_registration_poll_time": {"key": "properties.lastRegistrationPollTime", "type": "iso-8601"},
        "machine_configuration": {
            "key": "properties.machineConfiguration",
            "type": "RegistrationHubMachineConfiguration",
        },
        "machine_sku_id": {"key": "properties.machineSkuId", "type": "str"},
        "provisioning_state": {"key": "properties.provisioningState", "type": "str"},
        "registration_hub_image_id": {"key": "properties.registrationHubImageId", "type": "str"},
    ...
    def __init__(
        ...
        *,
        location: str,
        machine_configuration: "_models.RegistrationHubMachineConfiguration",
        tags: Optional[Dict[str, str]] = None,
        description: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        ...
        :keyword location: The geo-location where the resource lives. Required.
        :paramtype location: str
        :keyword description: The user-provided freeform description for the machine.
        :paramtype description: str
        :keyword machine_configuration: The hardware configuration of the machine supplied during the
         registration process. Required.
        :paramtype machine_configuration:
         ~azure.mgmt.networkcloud.models.RegistrationHubMachineConfiguration
        """
        super().__init__(tags=tags, location=location, **kwargs)
        self.associated_resource_id = None
        self.description = description
        self.last_registration_poll_time = None
        self.machine_configuration = machine_configuration
        self.machine_sku_id = None
        self.provisioning_state = None
        self.registration_hub_image_id = None
        self.registration_state = None


class RegistrationHubMachineConfiguration(_serialization.Model):
    """RegistrationHubMachineConfiguration represents details of the hardware configuration of the
    machine supplied during the registration process.

    All required parameters must be populated in order to send to server.

    :ivar cpus: The CPU information. Required.
    :vartype cpus: list[~azure.mgmt.networkcloud.models.RegistrationHubMachineCpu]
    :ivar devices: The inventory of devices detected on the machine’s buses. Required.
    :vartype devices: list[~azure.mgmt.networkcloud.models.RegistrationHubMachineDevice]
    :ivar memory: System memory information. Required.
    :vartype memory: ~azure.mgmt.networkcloud.models.RegistrationHubMachineMemory
    :ivar system: The bios and system board related information. Required.
    :vartype system: ~azure.mgmt.networkcloud.models.RegistrationHubMachineSystem
    """
    ...
    _attribute_map = {
        "cpus": {"key": "cpus", "type": "[RegistrationHubMachineCpu]"},
        "devices": {"key": "devices", "type": "[RegistrationHubMachineDevice]"},
        "memory": {"key": "memory", "type": "RegistrationHubMachineMemory"},
        "system": {"key": "system", "type": "RegistrationHubMachineSystem"},
    }

    def __init__(
        self,
        *,
        cpus: List["_models.RegistrationHubMachineCpu"],
        devices: List["_models.RegistrationHubMachineDevice"],
        memory: "_models.RegistrationHubMachineMemory",
        system: "_models.RegistrationHubMachineSystem",
        **kwargs: Any
    ) -> None:
        """
        :keyword cpus: The CPU information. Required.
        :paramtype cpus: list[~azure.mgmt.networkcloud.models.RegistrationHubMachineCpu]
        :keyword devices: The inventory of devices detected on the machine’s buses. Required.
        :paramtype devices: list[~azure.mgmt.networkcloud.models.RegistrationHubMachineDevice]
        :keyword memory: System memory information. Required.
        :paramtype memory: ~azure.mgmt.networkcloud.models.RegistrationHubMachineMemory
        :keyword system: The bios and system board related information. Required.
        :paramtype system: ~azure.mgmt.networkcloud.models.RegistrationHubMachineSystem
        """
        super().__init__(**kwargs)
        self.cpus = cpus
...
class RegistrationHubMachineCpu(_serialization.Model):
    """RegistrationHubMachineCpu represents CPU properties of a registration hub machine.

    All required parameters must be populated in order to send to server.

    :ivar architecture: The architecture of the CPU. Required.
    :vartype architecture: str
    :ivar family: The CPU family. Required.
    :vartype family: str
    :ivar model: The model of the CPU. Required.
    :vartype model: str
    :ivar model_name: The model name of the CPU. Required.
    :vartype model_name: str
    :ivar physical_cores_per_socket: The number of physical CPU cores per socket. Required.
    :vartype physical_cores_per_socket: int
    :ivar vendor: The vendor of the CPU. Required.
    :vartype vendor: str
    """
    ...
    _validation = {
        ...
        "physical_cores_per_socket": {"required": True},
    ...
    _attribute_map = {
        ...
        "model": {"key": "model", "type": "str"},
        "model_name": {"key": "modelName", "type": "str"},
        "physical_cores_per_socket": {"key": "physicalCoresPerSocket", "type": "int"},
        "vendor": {"key": "vendor", "type": "str"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        model: str,
        model_name: str,
        physical_cores_per_socket: int,
        vendor: str,
        **kwargs: Any
    ) -> None:
        """
        :keyword architecture: The architecture of the CPU. Required.
        :paramtype architecture: str
        :keyword family: The CPU family. Required.
        :paramtype family: str
        :keyword model: The model of the CPU. Required.
        :paramtype model: str
        :keyword model_name: The model name of the CPU. Required.
        :paramtype model_name: str
        :keyword physical_cores_per_socket: The number of physical CPU cores per socket. Required.
        :paramtype physical_cores_per_socket: int
        :keyword vendor: The vendor of the CPU. Required.
        ...
        self.physical_cores_per_socket = physical_cores_per_socket
        self.vendor = vendor


class RegistrationHubMachineDevice(_serialization.Model):
    """RegistrationHubMachineDevice represents the inventory of devices detected on the machine’s
    buses.

    All required parameters must be populated in order to send to server.

    :ivar address: The PCI/bus address of the device. Required.
    :vartype address: str
    :ivar bus: The bus that connects this device. Required.
    :vartype bus: str
    :ivar class_property: The device class. Required.
    :vartype class_property: str
    :ivar mac_address: The MAC address of a network device. Required.
    :vartype mac_address: str
    :ivar model: The model of the device. Required.
    :vartype model: str
    :ivar serial_number: The serial number of the device. Required.
    :vartype serial_number: str
    :ivar size_gb: The reported capacity of a storage device. Measured in gibibytes. Required.
    :vartype size_gb: int
    :ivar vendor: The vendor for the device. Required.
    :vartype vendor: str
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword address: The PCI/bus address of the device. Required.
        :paramtype address: str
        :keyword bus: The bus that connects this device. Required.
        :paramtype bus: str
        :keyword class_property: The device class. Required.
        :paramtype class_property: str
        :keyword mac_address: The MAC address of a network device. Required.
        :paramtype mac_address: str
        :keyword model: The model of the device. Required.
        :paramtype model: str
        :keyword serial_number: The serial number of the device. Required.
        :paramtype serial_number: str
        :keyword size_gb: The reported capacity of a storage device. Measured in gibibytes. Required.
        :paramtype size_gb: int
        :keyword vendor: The vendor for the device. Required.
        :paramtype vendor: str
        """
        super().__init__(**kwargs)
...
class RegistrationHubMachineList(_serialization.Model):
    """RegistrationHubMachineList represents a list of registration hub machines.

    :ivar next_link: The link used to get the next page of operations.
    :vartype next_link: str
    :ivar value: The list of registration hub machines.
    :vartype value: list[~azure.mgmt.networkcloud.models.RegistrationHubMachine]
    """

    _attribute_map = {
        "next_link": {"key": "nextLink", "type": "str"},
        "value": {"key": "value", "type": "[RegistrationHubMachine]"},
    }
    ...
    def __init__(
        ...
        *,
        next_link: Optional[str] = None,
        value: Optional[List["_models.RegistrationHubMachine"]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword next_link: The link used to get the next page of operations.
        :paramtype next_link: str
        :keyword value: The list of registration hub machines.
        :paramtype value: list[~azure.mgmt.networkcloud.models.RegistrationHubMachine]
        """
        super().__init__(**kwargs)
        self.next_link = next_link
        self.value = value
...
class RegistrationHubMachineMemory(_serialization.Model):
    """RegistrationHubMachineMemory represents the system memory information of a registration hub
    machine.

    All required parameters must be populated in order to send to server.

    :ivar size_gb: The size of the memory. Measured in gibibytes. Required.
    :vartype size_gb: int
    """
    ...
    def __init__(self, *, size_gb: int, **kwargs: Any) -> None:
        """
        :keyword size_gb: The size of the memory. Measured in gibibytes. Required.
        :paramtype size_gb: int
        """
        super().__init__(**kwargs)
        self.size_gb = size_gb
...
class RegistrationHubMachinePatchParameters(_serialization.Model):
    """RegistrationHubMachinePatchParameters represents the body of the request to patch the
    registration hub machine properties.
...
class RegistrationHubMachineSystem(_serialization.Model):
    """RegistrationHubMachineSystem represents the bios and system board related information.

    All required parameters must be populated in order to send to server.

    :ivar bios_vendor: The vendor for the BIOS. Required.
    :vartype bios_vendor: str
    :ivar bios_version: The version of the BIOS. Required.
    :vartype bios_version: str
    :ivar board_serial_number: The serial number of the main board. Required.
    :vartype board_serial_number: str
    :ivar chassis_serial_number: The serial number of the chassis. Required.
    :vartype chassis_serial_number: str
    :ivar product_name: The product name. Required.
    :vartype product_name: str
    :ivar product_serial_number: The product serial number. Required.
    :vartype product_serial_number: str
    :ivar tpm_endorsement_key: The tpm endorsement key. Required.
    :vartype tpm_endorsement_key: str
    :ivar vendor: The system vendor. Required.
    :vartype vendor: str
    """

    _validation = {
        "bios_vendor": {"required": True},
        "bios_version": {"required": True},
        "board_serial_number": {"required": True},
        "chassis_serial_number": {"required": True},
        "product_name": {"required": True},
        "product_serial_number": {"required": True},
        "tpm_endorsement_key": {"required": True},
        "vendor": {"required": True},
    }

    _attribute_map = {
        "bios_vendor": {"key": "biosVendor", "type": "str"},
        "bios_version": {"key": "biosVersion", "type": "str"},
        "board_serial_number": {"key": "boardSerialNumber", "type": "str"},
        "chassis_serial_number": {"key": "chassisSerialNumber", "type": "str"},
        "product_name": {"key": "productName", "type": "str"},
        "product_serial_number": {"key": "productSerialNumber", "type": "str"},
        "tpm_endorsement_key": {"key": "tpmEndorsementKey", "type": "str"},
        "vendor": {"key": "vendor", "type": "str"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        tpm_endorsement_key: str,
        vendor: str,
        **kwargs: Any
    ) -> None:
        """
        :keyword bios_vendor: The vendor for the BIOS. Required.
        :paramtype bios_vendor: str
        :keyword bios_version: The version of the BIOS. Required.
        :paramtype bios_version: str
        :keyword board_serial_number: The serial number of the main board. Required.
        :paramtype board_serial_number: str
        :keyword chassis_serial_number: The serial number of the chassis. Required.
        :paramtype chassis_serial_number: str
        :keyword product_name: The product name. Required.
        :paramtype product_name: str
        :keyword product_serial_number: The product serial number. Required.
        :paramtype product_serial_number: str
        :keyword tpm_endorsement_key: The tpm endorsement key. Required.
        :paramtype tpm_endorsement_key: str
        :keyword vendor: The system vendor. Required.
        :paramtype vendor: str
        """
        super().__init__(**kwargs)
        ...
        self.tpm_endorsement_key = tpm_endorsement_key
        self.vendor = vendor


class RegistrationHubPatchParameters(_serialization.Model):
    """RegistrationHubPatchParameters represents the body of the request to patch the registration hub
    properties.
...
class UsageDomain(_serialization.Model):
    """UsageDomain represents the usage domain that is associated with a solution.

    Variables are only populated by the server, and will be ignored when sending a request.

    :ivar platform: The infrastructure category for the domain. Known values are: "Edge" and
     "FarEdge".
    :vartype platform: str or ~azure.mgmt.networkcloud.models.UsageDomainPlatform
    :ivar purpose: The more specific use case for the domain.
    :vartype purpose: str
    :ivar variant: Variant is a qualifying term that differentiates between similar use cases.
    :vartype variant: str
    """
...
class VersionRange(_serialization.Model):
    """VersionRange represents a range of versions.

    Variables are only populated by the server, and will be ignored when sending a request.

    :ivar excluded: The versions that are not included in the range.
    :vartype excluded: list[str]
    :ivar supported_begin: The first version that is included in the range.
    :vartype supported_begin: str
    :ivar unsupported_begin: The first version that is no longer included in the range.
    :vartype unsupported_begin: str
    """

    _validation = {
        "excluded": {"readonly": True},
        "supported_begin": {"readonly": True},
        "unsupported_begin": {"readonly": True},
    }

    _attribute_map = {
        "excluded": {"key": "excluded", "type": "[str]"},
        "supported_begin": {"key": "supportedBegin", "type": "str"},
        "unsupported_begin": {"key": "unsupportedBegin", "type": "str"},
    }
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        super().__init__(**kwargs)
        self.excluded = None
        self.supported_begin = None
        self.unsupported_begin = None
