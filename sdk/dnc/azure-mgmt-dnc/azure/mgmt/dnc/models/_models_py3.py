...
class DelegatedSubnet(DelegatedSubnetResource):
    ...
    :ivar allocation_block_prefix_size: Defines size of CIDR blocks allocated to nodes in VnetBlock
     Mode.
    ...
    _validation = {
        ...
        "resource_guid": {"readonly": True},
        "provisioning_state": {"readonly": True},
        "allocation_block_prefix_size": {"maximum": 32, "minimum": 12},
    }
    ...
    def __init__(
        ...
        *,
        ...
        allocation_block_prefix_size: int = 32,
        **kwargs: Any
    ) -> None:
        """
        :keyword location: Location of the resource.
        ...
        :keyword allocation_block_prefix_size: Defines size of CIDR blocks allocated to nodes in
         VnetBlock Mode.
