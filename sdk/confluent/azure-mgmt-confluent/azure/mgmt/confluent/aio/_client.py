...
class ConfluentClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype marketplace_agreements:
     azure.mgmt.confluent.aio.operations.MarketplaceAgreementsOperations
    ...
    :keyword api_version: The API version to use for this operation. Known values are "2024-07-01"
     and None. Default value is "2024-07-01". Note that overriding this default value may result in
