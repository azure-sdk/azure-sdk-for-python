...
# USAGE
    python validations_validate_organization_maximum_set_gen.py
...
def main():
    ...
    response = client.validations.validate_organization(
        ...
        organization_name="bqmqthdyixbkhlgw",
        body={
...
# x-ms-original-file: specification/confluent/resource-manager/Microsoft.Confluent/preview/2025-08-18-preview/examples/Validations_ValidateOrganization_MaximumSet_Gen.json
