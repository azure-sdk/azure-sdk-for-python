...
# USAGE
    python organization_delete_maximum_set_gen.py
...
def main():
    ...
    client.organization.begin_delete(
        ...
        organization_name="zqp",
    ).result()


# x-ms-original-file: specification/confluent/resource-manager/Microsoft.Confluent/preview/2025-08-18-preview/examples/Organization_Delete_MaximumSet_Gen.json
