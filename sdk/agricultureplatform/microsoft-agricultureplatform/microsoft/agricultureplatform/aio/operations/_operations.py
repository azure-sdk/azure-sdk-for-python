...
from ...operations._operations import (
    build_catalogs_operations_create_or_update_request,
    build_catalogs_operations_delete_request,
    build_catalogs_operations_get_request,
    build_catalogs_operations_list_request,
    build_collections_operations_create_or_update_request,
    build_collections_operations_delete_request,
    build_collections_operations_get_request,
    build_collections_operations_list_request,
    build_file_operations_delete_request,
    build_file_operations_download_request,
    build_file_operations_upload_request,
    build_items_operations_create_or_update_request,
    build_items_operations_create_request,
    build_items_operations_delete_request,
    build_items_operations_get_all_under_collection_request,
    build_items_operations_get_request,
    build_items_operations_search_across_collection_request,
    build_satellite_operations_fetch_items_request,
    build_satellite_operations_search_items_request,
    build_schemas_operations_create_or_update_request,
    build_schemas_operations_delete_request,
    build_schemas_operations_get_request,
    build_schemas_operations_list_request,
    build_solutions_operations_cancel_job_request,
    build_solutions_operations_create_job_request,
    build_solutions_operations_get_data_request,
    build_solutions_operations_get_job_request,
    build_weather_operations_get_request,
)
...
class CatalogsOperationsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~microsoft.agricultureplatform.aio.AgriculturePlatformClient`'s
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~microsoft.agricultureplatform.models.Catalog]
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                path_format_arguments = {
                    "$host": self._serialize.url("self._config.host", self._config.host, "str"),
                }
    ...
    async def get(self, catalog_id: str, **kwargs: Any) -> _models.Catalog:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~microsoft.agricultureplatform.models.Catalog
    ...
    @overload
    async def create_or_update(
        self, catalog_id: str, resource: JSON, *, content_type: str = "application/merge-patch+json", **kwargs: Any
    ) -> _models.Catalog:
        """Creates or updates a Catalog resource.
    ...
    @overload
    async def create_or_update(
        self, catalog_id: str, resource: IO[bytes], *, content_type: str = "application/merge-patch+json", **kwargs: Any
    ) -> _models.Catalog:
        """Creates or updates a Catalog resource.
    ...
    @distributed_trace_async
    async def create_or_update(
        self, catalog_id: str, resource: Union[_models.Catalog, JSON, IO[bytes]], **kwargs: Any
    ) -> _models.Catalog:
        """Creates or updates a Catalog resource.

        :param catalog_id: Id of the Catalog. Required.
        :type catalog_id: str
        :param resource: The resource instance. Is one of the following types: Catalog, JSON, IO[bytes]
         Required.
        :type resource: ~microsoft.agricultureplatform.models.Catalog or JSON or IO[bytes]
        :return: Catalog. The Catalog is compatible with MutableMapping
        :rtype: ~microsoft.agricultureplatform.models.Catalog
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace_async
    async def delete(self, catalog_id: str, **kwargs: Any) -> None:
...
class CollectionsOperationsOperations:
    ...
    def list(
        ...
        *,
        ...
        skip_token: Optional[str] = None,
        **kwargs: Any
    ) -> AsyncIterable["_models.Collection"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~microsoft.agricultureplatform.models.Collection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    @distributed_trace_async
    async def get(self, catalog_id: str, collection_id: str, **kwargs: Any) -> _models.Collection:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type collection_id: str
        :param resource: The resource instance. Required.
        :type resource: ~microsoft.agricultureplatform.models.Collection
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/merge-patch+json".
        :paramtype content_type: str
        :return: Collection. The Collection is compatible with MutableMapping
    ...
    @distributed_trace_async
    async def create_or_update(
        self, catalog_id: str, collection_id: str, resource: Union[_models.Collection, JSON, IO[bytes]], **kwargs: Any
    ) -> _models.Collection:
        """Creates or updates a Collection resource.
        ...
        :param collection_id: Id of the Collection. Required.
        :type collection_id: str
        :param resource: The resource instance. Is one of the following types: Collection, JSON,
         IO[bytes] Required.
        :type resource: ~microsoft.agricultureplatform.models.Collection or JSON or IO[bytes]
        :return: Collection. The Collection is compatible with MutableMapping
        :rtype: ~microsoft.agricultureplatform.models.Collection
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace_async
    async def delete(self, catalog_id: str, collection_id: str, **kwargs: Any) -> None:
...
class FileOperationsOperations:
    ...
    @overload
    async def delete(self, *, file_path: str, content_type: str = "application/json", **kwargs: Any) -> None:
        """Deletes file.
    ...
    @overload
    async def delete(self, body: JSON, *, content_type: str = "application/json", **kwargs: Any) -> None:
        """Deletes file.
    ...
    @overload
    async def delete(self, body: IO[bytes], *, content_type: str = "application/json", **kwargs: Any) -> None:
        """Deletes file.
    ...
    @distributed_trace_async
    async def delete(self, body: Union[JSON, IO[bytes]] = _Unset, *, file_path: str = _Unset, **kwargs: Any) -> None:
        """Deletes file.
    ...
    @overload
    async def download(self, *, file_path: str, content_type: str = "application/json", **kwargs: Any) -> None:
    ...
    @overload
    async def download(self, body: JSON, *, content_type: str = "application/json", **kwargs: Any) -> None:
        """Downloads and returns file Stream as response for the given input filePath.
    ...
    @overload
    async def download(self, body: IO[bytes], *, content_type: str = "application/json", **kwargs: Any) -> None:
        """Downloads and returns file Stream as response for the given input filePath.
    ...
    @distributed_trace_async
    async def download(self, body: Union[JSON, IO[bytes]] = _Unset, *, file_path: str = _Unset, **kwargs: Any) -> None:
        """Downloads and returns file Stream as response for the given input filePath.
        ...
        accept: Literal["application/json, application/octet-stream"] = kwargs.pop(
    ...
    @distributed_trace_async
    async def upload(self, **kwargs: Any) -> _models.File:
        """Uploads a file.

        :return: File. The File is compatible with MutableMapping
        :rtype: ~microsoft.agricultureplatform.models.File
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
...
class ItemsOperationsOperations:
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword links: Links. Default value is None.
        ...
        :keyword assets: CatalogId.CollectionId.Assets. Default value is None.
    ...
    @distributed_trace_async
    async def get(self, catalog_id: str, collection_id: str, item_id: str, **kwargs: Any) -> _models.Item:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type item_id: str
        :param resource: The resource instance. Required.
        :type resource: ~microsoft.agricultureplatform.models.Item
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/merge-patch+json".
        :paramtype content_type: str
        :return: Item. The Item is compatible with MutableMapping
    ...
    async def create_or_update(
        ...
        collection_id: str,
        item_id: str,
        resource: Union[_models.Item, JSON, IO[bytes]],
        **kwargs: Any
    ) -> _models.Item:
        """Creates or updates a Item resource.
        ...
        :param item_id: Id of the Item. Required.
        :type item_id: str
        :param resource: The resource instance. Is one of the following types: Item, JSON, IO[bytes]
         Required.
        :type resource: ~microsoft.agricultureplatform.models.Item or JSON or IO[bytes]
        :return: Item. The Item is compatible with MutableMapping
        :rtype: ~microsoft.agricultureplatform.models.Item
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace_async
    async def delete(self, catalog_id: str, collection_id: str, item_id: str, **kwargs: Any) -> None:
    ...
    @overload
    async def get_all_under_collection(
        self,
        catalog_id: str,
        collection_id: str,
        *,
        ...
        **kwargs: Any
        ...
        :keyword intersects_with_geometry: GeoJSON (For more details: https://geojson.org/). Note:
         Coordinates are
    ...
    @overload
    async def search_across_collection(
        self,
        catalog_id: str,
        *,
        maximum_page_size: Optional[int] = None,
    ...
    async def search_items(
        ...
        **kwargs: Any
        ...
        :keyword end_date_time: End datetime of the time interval in which to search for Items. Default
         value is None.
        :paramtype end_date_time: ~datetime.datetime
        :keyword intersects: GeoJSON (For more details: https://geojson.org/). Note: Coordinates are
         expected in [Longitude, Latitude] format. Default value is None.
...
class SchemasOperationsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~microsoft.agricultureplatform.models.Schema]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    @distributed_trace_async
    async def get(self, schema_id: str, **kwargs: Any) -> _models.Schema:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type schema_id: str
        :param resource: The resource instance. Required.
        :type resource: ~microsoft.agricultureplatform.models.Schema
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/merge-patch+json".
        :paramtype content_type: str
        :return: Schema. The Schema is compatible with MutableMapping
    ...
    @overload
    async def create_or_update(
        self, schema_id: str, resource: JSON, *, content_type: str = "application/merge-patch+json", **kwargs: Any
    ) -> _models.Schema:
        """Creates or updates a Schema resource.
    ...
    @overload
    async def create_or_update(
        self, schema_id: str, resource: IO[bytes], *, content_type: str = "application/merge-patch+json", **kwargs: Any
    ) -> _models.Schema:
        """Creates or updates a Schema resource.
    ...
    @distributed_trace_async
    async def create_or_update(
        self, schema_id: str, resource: Union[_models.Schema, JSON, IO[bytes]], **kwargs: Any
    ) -> _models.Schema:
        """Creates or updates a Schema resource.

        :param schema_id: Id of the Schema. Required.
        :type schema_id: str
        :param resource: The resource instance. Is one of the following types: Schema, JSON, IO[bytes]
         Required.
        :type resource: ~microsoft.agricultureplatform.models.Schema or JSON or IO[bytes]
        :return: Schema. The Schema is compatible with MutableMapping
        :rtype: ~microsoft.agricultureplatform.models.Schema
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace_async
    async def delete(self, schema_id: str, **kwargs: Any) -> None:
