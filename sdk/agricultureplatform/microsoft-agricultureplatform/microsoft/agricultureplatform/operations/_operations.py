...
def build_file_operations_download_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class FileOperationsOperations:
    ...
    @overload
    def download(self, *, file_path: str, content_type: str = "application/json", **kwargs: Any) -> None:
    ...
    @overload
    def download(self, body: JSON, *, content_type: str = "application/json", **kwargs: Any) -> None:
        """Downloads and returns file Stream as response for the given input filePath.
    ...
    @overload
    def download(self, body: IO[bytes], *, content_type: str = "application/json", **kwargs: Any) -> None:
        """Downloads and returns file Stream as response for the given input filePath.
    ...
    @distributed_trace
    def download(  # pylint: disable=inconsistent-return-statements
        self, body: Union[JSON, IO[bytes]] = _Unset, *, file_path: str = _Unset, **kwargs: Any
    ) -> None:
        """Downloads and returns file Stream as response for the given input filePath.
    ...
    @distributed_trace
    def upload(self, **kwargs: Any) -> _models.File:
        """Uploads a file.
