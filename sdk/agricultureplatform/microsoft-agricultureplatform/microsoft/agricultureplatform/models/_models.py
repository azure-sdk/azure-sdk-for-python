...
class AuthCredentials(_model_base.Model):
    ...
    :vartype kind: str or ~microsoft.agricultureplatform.models.AuthCredentialsKind
    """
...
class ApiKeyAuthCredentials(AuthCredentials, discriminator="ApiKeyAuthCredentials"):
    ...
    :vartype api_key: ~microsoft.agricultureplatform.models.KeyVaultProperties
    :ivar kind: Enum for different types of AuthCredentials. Required. ApiKeyAuthCredentials.
    :vartype kind: str or ~microsoft.agricultureplatform.models.API_KEY_AUTH_CREDENTIALS
    """
...
class Asset(_model_base.Model):
    ...
    :vartype type: str or ~microsoft.agricultureplatform.models.DataFormat
    :ivar name: Name.
    :vartype name: str
    :ivar href: Href.
    :vartype href: str
...
class Catalog(_model_base.Model):
    ...
    :vartype links: list[~microsoft.agricultureplatform.models.Link]
...
class Collection(_model_base.Model):
    ...
    :ivar collection_id: Id of the Collection. Required.
    :vartype collection_id: str
    :ivar links: Links for referencing other objects.
    :vartype links: list[~microsoft.agricultureplatform.models.Link]
    ...
    collection_id: str = rest_field(name="collectionId", visibility=["read"])
    """Id of the Collection. Required."""
    links: Optional[List["_models.Link"]] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Links for referencing other objects."""
...
class ErrorForLocation(_model_base.Model):
    ...
    :vartype location: ~microsoft.agricultureplatform.models.WeatherLocation
...
class ErrorResponse(_model_base.Model):
    ...
    :vartype error: ~microsoft.agricultureplatform.models.Error
...
class GeoJsonObject(_model_base.Model):
    ...
    :ivar type: Type of GeoJSON object. Required. Known values are: "Point", "Polygon", and
     "MultiPolygon".
    :vartype type: str or ~microsoft.agricultureplatform.models.GeoJsonObjectType
    """
...
class ImageFile(_model_base.Model):
    ...
    :vartype image_format: str or ~microsoft.agricultureplatform.models.ImageFormat
...
class Item(_model_base.Model):
    ...
    :vartype collection_id: str
    :ivar assets: Assets.
    :vartype assets: list[~microsoft.agricultureplatform.models.Asset]
...
class ItemListResponse(_model_base.Model):
    ...
    :vartype value: list[~microsoft.agricultureplatform.models.Item]
...
class Link(_model_base.Model):
    ...
    :vartype rel: str or ~microsoft.agricultureplatform.models.RelationshipType
    :ivar href: Href.
    :vartype href: str
    :ivar type: DestinationType. Known values are: "Catalog", "Collection", "Item", and "Asset".
    :vartype type: str or ~microsoft.agricultureplatform.models.DestinationType
    """
...
class MultiPolygon(GeoJsonObject, discriminator="MultiPolygon"):
    ...
    :vartype type: str or ~microsoft.agricultureplatform.models.MULTI_POLYGON
    """
...
class OauthClientCredentials(AuthCredentials, discriminator="OAuthClientCredentials"):
    ...
    :vartype client_secret: ~microsoft.agricultureplatform.models.KeyVaultProperties
    :ivar kind: Type of AuthCredentials. Required. OAuthClientCredentials.
    :vartype kind: str or ~microsoft.agricultureplatform.models.O_AUTH_CLIENT_CREDENTIALS
    """
...
class Point(GeoJsonObject, discriminator="Point"):
    ...
    :vartype type: str or ~microsoft.agricultureplatform.models.POINT
    """
...
class Polygon(GeoJsonObject, discriminator="Polygon"):
    ...
    :vartype type: str or ~microsoft.agricultureplatform.models.POLYGON
    """
...
class SamplePartnerResponse(_model_base.Model):
    ...
    :vartype partner_request_body: ~microsoft.agricultureplatform.models.SamplePartnerRequestBody
    """
...
class SatelliteFetchData(_model_base.Model):
    ...
    :vartype image_files: list[~microsoft.agricultureplatform.models.ImageFile]
...
class SatelliteFetchResponse(_model_base.Model):
    ...
    :ivar value: Value.
    :vartype value: list[~microsoft.agricultureplatform.models.SatelliteFetchData]
    """
...
class Schema(_model_base.Model):
    ...
    :vartype dependent_collections: list[~microsoft.agricultureplatform.models.CatalogCollection]
...
class SearchFeaturesResponse(_model_base.Model):
    ...
    :vartype features: list[~microsoft.agricultureplatform.models.StacItem]
    :ivar next_link: URL to do the POST request with same filters,
     to get next set of items.
    :vartype next_link: str
    """
...
class StacItem(_model_base.Model):
    ...
    :vartype links: list[~microsoft.agricultureplatform.models.StacLink]
    :ivar assets: Dictionary of asset objects, each with a unique key. Required.
    :vartype assets: dict[str, ~microsoft.agricultureplatform.models.StacAsset]
...
class WeatherData(_model_base.Model):
    ...
    :vartype wet_bulb_temperature: ~microsoft.agricultureplatform.models.Measures
    :ivar cloud_cover: Schema for storing measurement readings and unit.
    :vartype cloud_cover: ~microsoft.agricultureplatform.models.Measures
    ...
    :vartype pressure_mean_sea_level: ~microsoft.agricultureplatform.models.Measures
    :ivar relative_humidity: Schema for storing measurement readings and unit.
    :vartype relative_humidity: ~microsoft.agricultureplatform.models.Measures
    :ivar temperature: Schema for storing measurement readings and unit.
    :vartype temperature: ~microsoft.agricultureplatform.models.Measures
    :ivar temperature_dew_point: Schema for storing measurement readings and unit.
    :vartype temperature_dew_point: ~microsoft.agricultureplatform.models.Measures
    :ivar temperature_feels_like: Schema for storing measurement readings and unit.
    :vartype temperature_feels_like: ~microsoft.agricultureplatform.models.Measures
    :ivar temperature_heat_index: Schema for storing measurement readings and unit.
    :vartype temperature_heat_index: ~microsoft.agricultureplatform.models.Measures
    :ivar temperature_wind_chill: Schema for storing measurement readings and unit.
    :vartype temperature_wind_chill: ~microsoft.agricultureplatform.models.Measures
    ...
    :vartype visibility: ~microsoft.agricultureplatform.models.Measures
    :ivar wind_direction: Schema for storing measurement readings and unit.
    :vartype wind_direction: ~microsoft.agricultureplatform.models.Measures
    :ivar wind_gust: Schema for storing measurement readings and unit.
    :vartype wind_gust: ~microsoft.agricultureplatform.models.Measures
    :ivar wind_speed: Schema for storing measurement readings and unit.
    :vartype wind_speed: ~microsoft.agricultureplatform.models.Measures
...
class WeatherDataErrors(_model_base.Model):
    ...
    :vartype locations: list[~microsoft.agricultureplatform.models.ErrorForLocation]
    """
...
class WeatherLocationData(_model_base.Model):
    ...
    :vartype data: ~microsoft.agricultureplatform.models.WeatherData
    """
...
class WeatherResponse(_model_base.Model):
    ...
    :vartype weather_metadata: ~microsoft.agricultureplatform.models.WeatherMetadata
    ...
    :vartype locations: list[~microsoft.agricultureplatform.models.WeatherLocationData]
    :ivar errors: Model for errors encountered for all failed locations.
    :vartype errors: ~microsoft.agricultureplatform.models.WeatherDataErrors
    """
