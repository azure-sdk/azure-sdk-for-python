...
# --------------------------------------------------------------------------
import pytest
from azure.mgmt.agricultureplatform.aio import MicrosoftAgriculturePlatform
...
class TestMicrosoftAgriculturePlatformAgriServiceOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(MicrosoftAgriculturePlatform, is_async=True)
    ...
    async def test_begin_create_or_update(self, resource_group):
        response = await (
            await self.client.agri_service.begin_create_or_update(
                ...
                resource={
                    "location": "str",
                    "config": {"instanceUri": "str", "version": "str"},
                    "id": "str",
                    "identity": {
                        "type": "str",
                        "principalId": "str",
