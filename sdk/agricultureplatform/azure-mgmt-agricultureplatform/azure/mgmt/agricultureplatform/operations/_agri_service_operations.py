...
from .._configuration import MicrosoftAgriculturePlatformConfiguration
...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.AgriculturePlatform/agriServices"
    )
...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "agriServiceResourceName": _SERIALIZER.url(
            "agri_service_resource_name", agri_service_resource_name, "str", pattern=r"^[a-zA-Z0-9-]{3,24}$"
        ),
    }
...
def build_list_available_solutions_request(
    resource_group_name: str, agri_service_resource_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class AgriServiceOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.agricultureplatform.MicrosoftAgriculturePlatform`'s
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._config: MicrosoftAgriculturePlatformConfiguration = (
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.AgriServiceResource"]:
        """List AgriServiceResource resources by subscription ID.

        :return: An iterator like instance of either AgriServiceResource or the result of cls(response)
        :rtype:
        ...
        cls: ClsType[_models.AgriServiceResourceListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("AgriServiceResourceListResult", pipeline_response)
    ...
    ) -> Iterable["_models.AgriServiceResource"]:
    ...
    def get(
        ...
        :return: AgriServiceResource or the result of cls(response)
        ...
        deserialized = self._deserialize("AgriServiceResource", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        resource: Union[_models.AgriServiceResource, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "AgriServiceResource")
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either AgriServiceResource or the result of
         cls(response)
        :rtype:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param agri_service_resource_name: The name of the AgriService resource. Required.
        :type agri_service_resource_name: str
        :param resource: Resource create parameters. Is either a AgriServiceResource type or a
         IO[bytes] type. Required.
        :type resource: ~azure.mgmt.agricultureplatform.models.AgriServiceResource or IO[bytes]
        :return: An instance of LROPoller that returns either AgriServiceResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.agricultureplatform.models.AgriServiceResource]
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        agri_service_resource_name: str,
        properties: Union[_models.AgriServiceResourceUpdate, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "AgriServiceResourceUpdate")
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param agri_service_resource_name: The name of the AgriService resource. Required.
        :type agri_service_resource_name: str
        :param properties: The resource properties to be updated. Is either a AgriServiceResourceUpdate
         type or a IO[bytes] type. Required.
        :type properties: ~azure.mgmt.agricultureplatform.models.AgriServiceResourceUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either AgriServiceResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.agricultureplatform.models.AgriServiceResource]
    ...
    def list_available_solutions(
        ...
        :param agri_service_resource_name: The name of the AgriService resource. Required.
        :type agri_service_resource_name: str
        :return: AvailableAgriSolutionListResult or the result of cls(response)
        ...
        _request = build_list_available_solutions_request(
            resource_group_name=resource_group_name,
            agri_service_resource_name=agri_service_resource_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
        ...
        deserialized = self._deserialize("AvailableAgriSolutionListResult", pipeline_response.http_response)
