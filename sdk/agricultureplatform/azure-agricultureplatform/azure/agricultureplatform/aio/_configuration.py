...
class AgriculturePlatformClientConfiguration:  # pylint: disable=too-many-instance-attributes
    """Configuration for AgriculturePlatformClient.
    ...
    def __init__(self, endpoint: str, credential: AzureKeyCredential, **kwargs: Any) -> None:
        ...
        kwargs.setdefault("sdk_moniker", "agricultureplatform/{}".format(VERSION))
