...
class CatalogsOperationsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.agricultureplatform.aio.AgriculturePlatformClient`'s
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.agricultureplatform.models.Catalog]
    ...
    async def get(self, catalog_id: str, **kwargs: Any) -> _models.Catalog:
        ...
        :rtype: ~azure.agricultureplatform.models.Catalog
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.agricultureplatform.models.Catalog
    ...
    async def create_or_update(
        ...
        :param body: The resource instance. Is one of the following types: Catalog, JSON, IO[bytes]
         Required.
        :type body: ~azure.agricultureplatform.models.Catalog or JSON or IO[bytes]
        :return: Catalog. The Catalog is compatible with MutableMapping
        :rtype: ~azure.agricultureplatform.models.Catalog
        :raises ~azure.core.exceptions.HttpResponseError:
        """
...
class CollectionsOperationsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.agricultureplatform.models.Collection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def get(self, catalog_id: str, collection_id: str, **kwargs: Any) -> _models.Collection:
        ...
        :rtype: ~azure.agricultureplatform.models.Collection
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type collection_id: str
        :param body: The resource instance. Required.
        :type body: ~azure.agricultureplatform.models.Collection
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/merge-patch+json".
        :paramtype content_type: str
        :return: Collection. The Collection is compatible with MutableMapping
    ...
    async def create_or_update(
        ...
        :param body: The resource instance. Is one of the following types: Collection, JSON, IO[bytes]
         Required.
        :type body: ~azure.agricultureplatform.models.Collection or JSON or IO[bytes]
        :return: Collection. The Collection is compatible with MutableMapping
        :rtype: ~azure.agricultureplatform.models.Collection
        :raises ~azure.core.exceptions.HttpResponseError:
        """
...
class FileOperationsOperations:
    ...
    async def download(
        ...
        **kwargs: Any
        ...
        :paramtype accept: str or ~azure.agricultureplatform.models.AcceptHeaderEnum
        :keyword file_path: FilePath. Required.
        :paramtype file_path: str
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
    ...
    @distributed_trace_async
    async def upload(self, **kwargs: Any) -> _models.FileModel:
        """Uploads a file.

        :return: FileModel. The FileModel is compatible with MutableMapping
        :rtype: ~azure.agricultureplatform.models.FileModel
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
...
class ItemsOperationsOperations:
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :paramtype links: list[~azure.agricultureplatform.models.Link]
        ...
        :paramtype assets: list[~azure.agricultureplatform.models.Asset]
        :return: ItemResponse. The ItemResponse is compatible with MutableMapping
        :rtype: ~azure.agricultureplatform.models.ItemResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get(self, catalog_id: str, collection_id: str, item_id: str, **kwargs: Any) -> _models.Item:
        ...
        :rtype: ~azure.agricultureplatform.models.Item
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type item_id: str
        :param body: The resource instance. Required.
        :type body: ~azure.agricultureplatform.models.Item
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/merge-patch+json".
        :paramtype content_type: str
        :return: Item. The Item is compatible with MutableMapping
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :param body: The resource instance. Is one of the following types: Item, JSON, IO[bytes]
         Required.
        :type body: ~azure.agricultureplatform.models.Item or JSON or IO[bytes]
        :return: Item. The Item is compatible with MutableMapping
        :rtype: ~azure.agricultureplatform.models.Item
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get_all_under_collection(
        ...
        **kwargs: Any
        ...
        :paramtype intersects_with_geometry: ~azure.agricultureplatform.models.GeoJsonObject
        :keyword ids: Ids of the resource. Default value is None.
        :paramtype ids: list[str]
        :keyword min_created_date_time: Minimum creation date of resource (inclusive). Default value is
         None.
        ...
        :rtype: ~azure.agricultureplatform.models.ItemListResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
...
class SatelliteOperationsOperations:
    ...
    async def fetch_items(
        ...
        **kwargs: Any
        ...
        :paramtype credentials: ~azure.agricultureplatform.models.OauthClientCredentials
        ...
        :paramtype data: ~azure.agricultureplatform.models.SatelliteData
        ...
        :rtype: ~azure.agricultureplatform.models.SatelliteFetchResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def search_items(
        ...
        **kwargs: Any
        ...
        :keyword intersects: GeoJSON (For more details: `https://geojson.org/
         <https://geojson.org/>`_). Note: Coordinates are
         expected in [Longitude, Latitude] format. Default value is None.
        :paramtype intersects: ~azure.agricultureplatform.models.GeoJsonObject
        ...
        :rtype: ~azure.agricultureplatform.models.SearchFeaturesResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
...
class SchemasOperationsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.agricultureplatform.models.Schema]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def get(self, schema_id: str, **kwargs: Any) -> _models.Schema:
        ...
        :rtype: ~azure.agricultureplatform.models.Schema
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def create_or_update(
        ...
        :type schema_id: str
        :param body: The resource instance. Required.
        :type body: ~azure.agricultureplatform.models.Schema
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/merge-patch+json".
        :paramtype content_type: str
        :return: Schema. The Schema is compatible with MutableMapping
    ...
    async def create_or_update(
        ...
        :param body: The resource instance. Is one of the following types: Schema, JSON, IO[bytes]
         Required.
        :type body: ~azure.agricultureplatform.models.Schema or JSON or IO[bytes]
        :return: Schema. The Schema is compatible with MutableMapping
        :rtype: ~azure.agricultureplatform.models.Schema
        :raises ~azure.core.exceptions.HttpResponseError:
        """
...
class SolutionsOperationsOperations:
    ...
    async def cancel_job(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.agricultureplatform.models.SamplePartnerResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :keyword credentials: Api Key Auth Credentials class for API Key based Auth. Default value is
         None.
        :paramtype credentials: ~azure.agricultureplatform.models.ApiKeyAuthCredentials
        :keyword locations: List of locations for which weather data need to be fetched from the
         provider. Default value is None.
        :paramtype locations: list[~azure.agricultureplatform.models.WeatherLocation]
        :return: WeatherResponse. The WeatherResponse is compatible with MutableMapping
        :rtype: ~azure.agricultureplatform.models.WeatherResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
