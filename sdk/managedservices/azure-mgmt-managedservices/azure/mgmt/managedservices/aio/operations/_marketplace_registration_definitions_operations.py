...
class MarketplaceRegistrationDefinitionsOperations:
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.MarketplaceRegistrationDefinition"]:
        ...
        :return: An iterator like instance of either MarketplaceRegistrationDefinition or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.managedservices.models.MarketplaceRegistrationDefinition]
    ...
    get.metadata = {
        "url": "/{scope}/providers/Microsoft.ManagedServices/marketplaceRegistrationDefinitions/{marketplaceIdentifier}"
    }
