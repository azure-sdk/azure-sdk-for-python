...
class AzureStorageFileShareEndpointBaseProperties(_serialization.Model):
    ...
    def __init__(self, *, storage_account_resource_id: str, file_share_name: str, **kwargs: Any) -> None:
        """
...
class AzureStorageSmbFileShareEndpointProperties(EndpointBaseProperties, AzureStorageFileShareEndpointBaseProperties):
