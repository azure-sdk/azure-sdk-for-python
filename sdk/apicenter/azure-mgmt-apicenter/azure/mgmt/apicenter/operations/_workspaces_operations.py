...
def build_get_request(
    resource_group_name: str, service_name: str, workspace_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_import_api_source_request(
    resource_group_name: str, service_name: str, workspace_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class WorkspacesOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, service_name: str, workspace_name: str, **kwargs: Any) -> _models.Workspace:
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a Workspace type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.apicenter.models.Workspace or IO[bytes]
        :return: Workspace or the result of cls(response)
        :rtype: ~azure.mgmt.apicenter.models.Workspace
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace
    def head(self, resource_group_name: str, service_name: str, workspace_name: str, **kwargs: Any) -> bool:
    ...
    def _import_api_source_initial(
        self,
        resource_group_name: str,
        service_name: str,
        workspace_name: str,
        body: Union[_models.ImportApiSourceRequest, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "ImportApiSourceRequest")

        _request = build_import_api_source_request(
            resource_group_name=resource_group_name,
            service_name=service_name,
            workspace_name=workspace_name,
            subscription_id=self._config.subscription_id,
    ...
    @overload
    def begin_import_api_source(
        self,
        resource_group_name: str,
        service_name: str,
        workspace_name: str,
        body: _models.ImportApiSourceRequest,
        *,
        content_type: str = "application/json",
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.apicenter.models.ImportApiSourceRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    def begin_import_api_source(
        ...
        **kwargs: Any
        ...
        :param workspace_name: The name of the workspace. Required.
        :type workspace_name: str
        :param body: The content of the action request. Is either a ImportApiSourceRequest type or a
         IO[bytes] type. Required.
        :type body: ~azure.mgmt.apicenter.models.ImportApiSourceRequest or IO[bytes]
        :return: An instance of LROPoller that returns either OperationStatusResult or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.apicenter.models.OperationStatusResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token is None:
            raw_result = self._import_api_source_initial(
                resource_group_name=resource_group_name,
                service_name=service_name,
                workspace_name=workspace_name,
                body=body,
