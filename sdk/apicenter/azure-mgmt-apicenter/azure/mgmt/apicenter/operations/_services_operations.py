...
def build_export_metadata_schema_request(
    ...
    subscription_id: str,
    *,
    assigned_to: Union[str, _models.MetadataAssignmentEntity],
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct parameters
    _params["api-version"] = _SERIALIZER.query("api_version", api_version, "str")
    _params["assignedTo"] = _SERIALIZER.query("assigned_to", assigned_to, "str")
...
class ServicesOperations:
    ...
    def export_metadata_schema(
        ...
        **kwargs: Any
        ...
        :param service_name: Service name. Required.
        :type service_name: str
        :param assigned_to: An entity the metadata schema is requested for. Known values are: "api",
         "deployment", and "environment". Required.
        :type assigned_to: str or ~azure.mgmt.apicenter.models.MetadataAssignmentEntity
        :keyword callable cls: A custom type or function that will be passed the direct response
