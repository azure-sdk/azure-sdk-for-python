...
def build_get_request(resource_group_name: str, subscription_id: str, service_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "serviceName": _SERIALIZER.url("service_name", service_name, "str", pattern=r"^[a-zA-Z0-9\-]{1,64}$"),
    }
...
def build_create_or_update_request(
    resource_group_name: str, subscription_id: str, service_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ServicesOperations:
    ...
    list_by_subscription.metadata = {"url": "/subscriptions/{subscriptionId}/providers/Microsoft.ApiCenter/services"}
    ...
    list_by_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiCenter/services"
    }

    @distributed_trace
    def get(self, resource_group_name: str, **kwargs: Any) -> _models.Service:
        """Get service.
    ...
    @distributed_trace
    def create_or_update(
        self, resource_group_name: str, resource: Optional[Union[_models.Service, IO]] = None, **kwargs: Any
    ) -> _models.Service:
        """Create or update service.
    ...
    @distributed_trace
    def update(
        self, resource_group_name: str, parameters: Optional[Union[_models.ServiceUpdate, IO]] = None, **kwargs: Any
    ) -> _models.Service:
        """Update service.
    ...
    @distributed_trace
    def delete(self, resource_group_name: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        """Delete service.
