...
class Api(Resource):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype title: str
    :ivar type_properties_type: Kind of API. For example, REST or GraphQL. Known values are:
     "rest", "graphql", "grpc", "soap", "webhook", and "websocket".
    :vartype type_properties_type: str or ~azure.mgmt.apicenter.models.ApiType
    ...
    def __init__(
        ...
        *,
        ...
        type_properties_type: Optional[Union[str, "_models.ApiType"]] = None,
        ...
        **kwargs: Any
        ...
        :paramtype title: str
        :keyword type_properties_type: Kind of API. For example, REST or GraphQL. Known values are:
         "rest", "graphql", "grpc", "soap", "webhook", and "websocket".
        :paramtype type_properties_type: str or ~azure.mgmt.apicenter.models.ApiType
...
class ApiSpecImportSource(_serialization.Model):
    ...
    :ivar specification:
    :vartype specification: ~azure.mgmt.apicenter.models.ApiSpecImportSourceSpecification
    """

    _attribute_map = {
        "value": {"key": "value", "type": "str"},
        "format": {"key": "format", "type": "str"},
        "specification": {"key": "specification", "type": "ApiSpecImportSourceSpecification"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        specification: Optional["_models.ApiSpecImportSourceSpecification"] = None,
        **kwargs: Any
    ) -> None:
        """
        ...
        :paramtype specification: ~azure.mgmt.apicenter.models.ApiSpecImportSourceSpecification
        """
        super().__init__(**kwargs)
        self.value = value
        self.format = format
...
class ApiSpecImportSourceSpecification(_serialization.Model):
...
class Deployment(Resource):  # pylint: disable=too-many-instance-attributes
    ...
    _attribute_map = {
        ...
        "system_data": {"key": "systemData", "type": "SystemData"},
        "title": {"key": "properties.title", "type": "str"},
        "description": {"key": "properties.description", "type": "object"},
...
class Environment(Resource):
    ...
    :vartype description: str
    :ivar type_properties_type: Environment type. Known values are: "development", "testing",
     "staging", and "production".
    :vartype type_properties_type: str or ~azure.mgmt.apicenter.models.EnvironmentType
    ...
    def __init__(
        ...
        *,
        title: Optional[str] = None,
        description: Optional[str] = None,
        type_properties_type: Optional[Union[str, "_models.EnvironmentType"]] = None,
        ...
        **kwargs: Any
        ...
        :paramtype description: str
        :keyword type_properties_type: Environment type. Known values are: "development", "testing",
         "staging", and "production".
        :paramtype type_properties_type: str or ~azure.mgmt.apicenter.models.EnvironmentType
...
class MetadataAssignment(_serialization.Model):
    ...
    :ivar entity: The entities this metadata schema component gets applied to. Known values are:
     "api", "deployment", and "environment".
...
class MetadataSchema(Resource):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.apicenter.models.SystemData
    :ivar schema: YAML schema defining the type.
    :vartype schema: str
    :ivar assigned_to:
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword schema: YAML schema defining the type.
...
class Workspace(Resource):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.apicenter.models.SystemData
    :ivar title: Workspace display name.
    :vartype title: str
    ...
    def __init__(self, *, title: Optional[str] = None, description: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword title: Workspace display name.
        :paramtype title: str
