...
class Address(_serialization.Model):
    ...
    def __init__(self, *, street: str, city: str, state: str, zip: str, **kwargs: Any) -> None:
        """
        :keyword street: Required.
        :paramtype street: str
        :keyword city: Required.
        :paramtype city: str
        :keyword state: Required.
        :paramtype state: str
        :keyword zip: Required.
        :paramtype zip: str
        """
...
class MyModel(_serialization.Model):
    """MyModel.
    ...
    :ivar age: Required.
    :vartype age: float
    :ivar is_alive: Required.
    :vartype is_alive: bool
    :ivar address: Required.
    :vartype address: ~azure.mgmt.apicenter.models.Address
    """

    _validation = {
        "name": {"required": True},
        "age": {"required": True},
        "is_alive": {"required": True},
    ...
    _attribute_map = {
        ...
        "is_alive": {"key": "isAlive", "type": "bool"},
        "address": {"key": "address", "type": "Address"},
    }

    def __init__(self, *, name: str, age: float, is_alive: bool, address: "_models.Address", **kwargs: Any) -> None:
        """
        :keyword name: Required.
        :paramtype name: str
        :keyword age: Required.
        :paramtype age: float
        :keyword is_alive: Required.
        :paramtype is_alive: bool
        :keyword address: Required.
        :paramtype address: ~azure.mgmt.apicenter.models.Address
        """
        super().__init__(**kwargs)
        self.name = name
        self.age = age
