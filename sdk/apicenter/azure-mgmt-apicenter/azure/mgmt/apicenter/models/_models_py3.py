...
class Api(Resource):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.apicenter.models.SystemData
    :ivar properties: API properties.
    ...
    def __init__(self, *, properties: Optional["_models.ApiProperties"] = None, **kwargs: Any) -> None:
        """
        :keyword properties: API properties.
...
class ApiDefinition(Resource):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.apicenter.models.SystemData
    :ivar properties: API definition properties entity.
    ...
    def __init__(self, *, properties: Optional["_models.ApiDefinitionProperties"] = None, **kwargs: Any) -> None:
        """
        :keyword properties: API definition properties entity.
...
class ApiVersion(Resource):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.apicenter.models.SystemData
    :ivar properties: API version properties entity.
    ...
    def __init__(self, *, properties: Optional["_models.ApiVersionProperties"] = None, **kwargs: Any) -> None:
        """
        :keyword properties: API version properties entity.
...
class Deployment(Resource):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.apicenter.models.SystemData
    :ivar properties: API deployment entity properties.
    ...
    def __init__(self, *, properties: Optional["_models.DeploymentProperties"] = None, **kwargs: Any) -> None:
        """
        :keyword properties: API deployment entity properties.
...
class Environment(Resource):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.apicenter.models.SystemData
    :ivar properties: Environment properties entity.
    ...
    def __init__(self, *, properties: Optional["_models.EnvironmentProperties"] = None, **kwargs: Any) -> None:
        """
        :keyword properties: Environment properties entity.
...
class MetadataSchema(Resource):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.apicenter.models.SystemData
    :ivar properties: Metadata schema properties.
    ...
    def __init__(self, *, properties: Optional["_models.MetadataSchemaProperties"] = None, **kwargs: Any) -> None:
        """
        :keyword properties: Metadata schema properties.
...
class Service(TrackedResource):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword location: The geo-location where the resource lives. Required.
        :paramtype location: str
        :keyword properties: The properties of the service.
...
class ServiceUpdate(_serialization.Model):
    ...
    def __init__(self, *, properties: Optional["_models.ServiceProperties"] = None, **kwargs: Any) -> None:
        """
        :keyword properties: The properties of the service.
        :paramtype properties: ~azure.mgmt.apicenter.models.ServiceProperties
        """
