...
class ApiCenterMgmtClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype deleted_services: azure.mgmt.apicenter.aio.operations.DeletedServicesOperations
    ...
    :ivar analyzer_configs: AnalyzerConfigsOperations operations
    :vartype analyzer_configs: azure.mgmt.apicenter.aio.operations.AnalyzerConfigsOperations
    :ivar api_sources: ApiSourcesOperations operations
    :vartype api_sources: azure.mgmt.apicenter.aio.operations.ApiSourcesOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.analyzer_configs = AnalyzerConfigsOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
