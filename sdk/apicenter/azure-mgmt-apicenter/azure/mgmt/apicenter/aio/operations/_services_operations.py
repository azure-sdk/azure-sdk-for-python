...
from ...operations._services_operations import (
    ...
    build_get_request,
    build_import_from_apim_request,
...
class ServicesOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.Service"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.apicenter.models.Service]
    ...
    async def begin_export_metadata_schema(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.MetadataSchemaExportResult].from_continuation_token(
    ...
    async def _import_from_apim_initial(
        self,
        resource_group_name: str,
        service_name: str,
    ...
    @overload
    async def begin_import_from_apim(
        self,
        resource_group_name: str,
        service_name: str,
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.ImportFromApimSuccessResult]:
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either ImportFromApimSuccessResult or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.apicenter.models.ImportFromApimSuccessResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_import_from_apim(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._import_from_apim_initial(
                resource_group_name=resource_group_name,
                service_name=service_name,
                body=body,
                api_version=api_version,
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.ImportFromApimSuccessResult].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ImportFromApimSuccessResult](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
