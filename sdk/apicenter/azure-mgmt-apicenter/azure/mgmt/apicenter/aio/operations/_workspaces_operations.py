...
from ...operations._workspaces_operations import (
    ...
    build_get_request,
    build_head_request,
    build_import_api_source_request,
    build_list_request,
)
...
class WorkspacesOperations:
    ...
    @distributed_trace_async
    async def delete(self, resource_group_name: str, service_name: str, workspace_name: str, **kwargs: Any) -> None:
    ...
    async def _import_api_source_initial(
        self,
        resource_group_name: str,
        service_name: str,
        workspace_name: str,
    ...
    @overload
    async def begin_import_api_source(
        self,
        resource_group_name: str,
        service_name: str,
        workspace_name: str,
    ...
    async def begin_import_api_source(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = await self._import_api_source_initial(
                resource_group_name=resource_group_name,
                service_name=service_name,
                workspace_name=workspace_name,
                body=body,
