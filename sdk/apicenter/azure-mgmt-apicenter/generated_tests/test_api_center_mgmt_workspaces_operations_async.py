...
class TestApiCenterMgmtWorkspacesOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_workspaces_begin_import_api_source(self, resource_group):
        response = await (
            await self.client.workspaces.begin_import_api_source(
                resource_group_name=resource_group.name,
                service_name="str",
                workspace_name="str",
                body={
                    ...
                    "azureApiManagementSource": {"sourceResourceIds": ["str"], "msiResourceId": "str"},
