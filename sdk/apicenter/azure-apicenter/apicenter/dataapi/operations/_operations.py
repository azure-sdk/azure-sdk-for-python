...
def build_api_definitions_get_export_specification_operation_status_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/workspaces/{workspaceName}/apis/{apiName}/versions/{versionName}/definitions/{definitionName}/operations/{operationId}"
    path_format_arguments = {
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, "str"),
        "apiName": _SERIALIZER.url("api_name", api_name, "str"),
        "versionName": _SERIALIZER.url("version_name", version_name, "str"),
...
def build_api_definitions_export_specification_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/workspaces/{workspaceName}/apis/{apiName}/versions/{versionName}/definitions/{definitionName}:exportSpecification"
    path_format_arguments = {
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, "str"),
        "apiName": _SERIALIZER.url("api_name", api_name, "str"),
        "versionName": _SERIALIZER.url("version_name", version_name, "str"),
...
class ApisOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~apicenter.dataapi.DataApiClient`'s
        :attr:`apis` attribute.
    """
    ...
    def list(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~apicenter.dataapi.models.Api]
    ...
    def list_all(self, *, top: Optional[int] = None, skip: Optional[int] = None, **kwargs: Any) -> _models.PagedApiAll:
        ...
        :rtype: ~apicenter.dataapi.models.PagedApiAll
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def get(self, workspace_name: str, api_name: str, **kwargs: Any) -> _models.Api:
        ...
        :rtype: ~apicenter.dataapi.models.Api
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
...
class ApiDefinitionsOperations:
    ...
    def list_definitions(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~apicenter.dataapi.models.ApiDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def get_definition(
        ...
        :rtype: ~apicenter.dataapi.models.ApiDefinition
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    @distributed_trace
    def get_export_specification_operation_status(  # pylint: disable=name-too-long
        self,
        workspace_name: str,
        api_name: str,
        version_name: str,
        ...
        **kwargs: Any
        ...
        :return: ResourceOperationStatusApiSpecExportResultApiSpecExportResultError. The
         ...
         MutableMapping
        :rtype:
         ~apicenter.dataapi.models.ResourceOperationStatusApiSpecExportResultApiSpecExportResultError
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_export_specification(
        ...
        :rtype: ~azure.core.polling.LROPoller[~apicenter.dataapi.models.ApiSpecExportResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class ApiDeploymentsOperations:
    ...
    def list_deployments(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~apicenter.dataapi.models.ApiDeployment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def get_deployment(
        ...
        :rtype: ~apicenter.dataapi.models.ApiDeployment
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
...
class EnvironmentsOperations:
    ...
    def list(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~apicenter.dataapi.models.Environment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_all(
        ...
        :rtype: ~apicenter.dataapi.models.PagedEnvironmentAll
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def get(self, workspace_name: str, environment_name: str, **kwargs: Any) -> _models.Environment:
        ...
        :rtype: ~apicenter.dataapi.models.Environment
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
...
class ApiVersionsOperations:
    ...
    def list_versions(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~apicenter.dataapi.models.ApiVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def get_version(self, workspace_name: str, api_name: str, version_name: str, **kwargs: Any) -> _models.ApiVersion:
        ...
        :rtype: ~apicenter.dataapi.models.ApiVersion
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
