...
class DataApiClient:
    ...
    :vartype apis: apicenter.dataapi.operations.ApisOperations
    :ivar api_definitions: ApiDefinitionsOperations operations
    :vartype api_definitions: apicenter.dataapi.operations.ApiDefinitionsOperations
    :ivar api_deployments: ApiDeploymentsOperations operations
    :vartype api_deployments: apicenter.dataapi.operations.ApiDeploymentsOperations
    :ivar environments: EnvironmentsOperations operations
    :vartype environments: apicenter.dataapi.operations.EnvironmentsOperations
    :ivar api_versions: ApiVersionsOperations operations
    :vartype api_versions: apicenter.dataapi.operations.ApiVersionsOperations
