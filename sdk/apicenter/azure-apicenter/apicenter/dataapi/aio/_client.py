...
class DataApiClient:
    ...
    :vartype apis: apicenter.dataapi.aio.operations.ApisOperations
    :ivar api_definitions: ApiDefinitionsOperations operations
    :vartype api_definitions: apicenter.dataapi.aio.operations.ApiDefinitionsOperations
    :ivar api_deployments: ApiDeploymentsOperations operations
    :vartype api_deployments: apicenter.dataapi.aio.operations.ApiDeploymentsOperations
    :ivar environments: EnvironmentsOperations operations
    :vartype environments: apicenter.dataapi.aio.operations.EnvironmentsOperations
    :ivar api_versions: ApiVersionsOperations operations
    :vartype api_versions: apicenter.dataapi.aio.operations.ApiVersionsOperations
    ...
    def __init__(self, service_name: str, region: str, credential: "AsyncTokenCredential", **kwargs: Any) -> None:
        _endpoint = "https://{serviceName}.data.{region}.azure-apicenter.ms"
        self._config = DataApiClientConfiguration(
            service_name=service_name, region=region, credential=credential, **kwargs
        )
