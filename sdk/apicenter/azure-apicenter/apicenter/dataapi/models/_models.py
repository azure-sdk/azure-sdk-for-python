...
class Api(_model_base.Model):
    ...
    :vartype kind: str or ~apicenter.dataapi.models.ApiKind
    ...
    :vartype lifecycle_stage: str or ~apicenter.dataapi.models.LifecycleStage
    :ivar terms_of_service: Terms of service for the API.
    :vartype terms_of_service: ~apicenter.dataapi.models.TermsOfService
    :ivar license: The license information for the API.
    :vartype license: ~apicenter.dataapi.models.License
    :ivar external_documentation: External documentation.
    :vartype external_documentation: list[~apicenter.dataapi.models.ExternalDocumentation]
    :ivar contacts: Points of contact for the API.
    :vartype contacts: list[~apicenter.dataapi.models.Contact]
...
class ApiDefinition(_model_base.Model):
    ...
    :vartype specification: ~apicenter.dataapi.models.ApiSpecification
    """
...
class ApiDeployment(_model_base.Model):
    ...
    :vartype server: ~apicenter.dataapi.models.ApiDeploymentServer
...
class ApiSpecExportResult(_model_base.Model):
    ...
    :vartype format: str or ~apicenter.dataapi.models.ApiSpecExportResultFormat
    """
...
class Environment(_model_base.Model):
    ...
    :vartype kind: str or ~apicenter.dataapi.models.EnvironmentKind
    :ivar description: Description of the environment.
    :vartype description: str
    :ivar server: Server information of the environment.
    :vartype server: ~apicenter.dataapi.models.EnvironmentServer
    :ivar onboarding: Onboarding information for this environment.
    :vartype onboarding: ~apicenter.dataapi.models.EnvironmentOnboardingModel
...
class PagedApiAll(_model_base.Model):
    ...
    :vartype value: list[~apicenter.dataapi.models.Api]
...
class PagedEnvironmentAll(_model_base.Model):
    ...
    :vartype value: list[~apicenter.dataapi.models.Environment]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
...
class ResourceOperationStatusApiSpecExportResultApiSpecExportResultError(
    _model_base.Model
    ...
    :vartype status: str or ~apicenter.dataapi.models.OperationState
    ...
    :vartype result: ~apicenter.dataapi.models.ApiSpecExportResult
    """
