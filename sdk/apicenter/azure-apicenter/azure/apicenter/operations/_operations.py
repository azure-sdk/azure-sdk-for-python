...
# --------------------------------------------------------------------------
import sys
from typing import Any, Callable, Dict, Iterable, Iterator, List, Optional, Type, TypeVar, Union, cast
import urllib.parse
...
class ApisOperations:
    ...
    @distributed_trace
    def get(self, workspace_name: str, api_name: str, **kwargs: Any) -> _models.GetResponse1:
        """Get an API.
...
class EnvironmentsOperations:
    ...
    @distributed_trace
    def get(self, workspace_name: str, environment_name: str, **kwargs: Any) -> _models.GetResponse:
        """Get an environment.
