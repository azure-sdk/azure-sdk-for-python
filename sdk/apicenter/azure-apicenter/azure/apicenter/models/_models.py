...
class ApiDefinition(_model_base.Model):
    ...
    :vartype name: str
    :ivar title: The naasdasdme of the API definition. Required.
    :vartype title: str
    :ivar description: The deasdasdscription of the API definition.
    :vartype description: str
    ...
    title: str = rest_field()
    """The naasdasdme of the API definition. Required."""
    description: Optional[str] = rest_field()
...
class ApiSpecExportResult(_model_base.Model):
    ...
    :ivar value: The rasdasdesult of the specification export. Required.
    :vartype value: str
    :ivar format: The forasdasdmat of the specification export result. Required. "link"
    ...
    """The rasdasdesult of the specification export. Required."""
    format: Union[str, "_models.ApiSpecExportResultFormat"] = rest_field()
    """The forasdasdmat of the specification export result. Required. \"link\""""
...
class GetDefinitionResponse(_model_base.Model):
...
class GetResponse1(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    """GetResponse1.
...
class GetVersionResponse(_model_base.Model):
    """GetVersionResponse.
