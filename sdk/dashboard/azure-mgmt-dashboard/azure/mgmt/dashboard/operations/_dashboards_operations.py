...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Dashboard/dashboards")
...
class DashboardsOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.ManagedDashboard"]:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.ManagedDashboard"]:
