...
class DashboardClient:
    ...
    :vartype managed_grafanas: azure.mgmt.dashboard.operations.ManagedGrafanasOperations
    ...
    :vartype managed_private_endpoint_models:
     azure.mgmt.dashboard.operations.ManagedPrivateEndpointModelsOperations
