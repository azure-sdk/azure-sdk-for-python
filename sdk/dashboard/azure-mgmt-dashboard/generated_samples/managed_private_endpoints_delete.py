...
def main():
    ...
    client.managed_private_endpoints.begin_delete(
...
# x-ms-original-file: specification/dashboard/resource-manager/Microsoft.Dashboard/preview/2023-10-01-preview/examples/ManagedPrivateEndpoints_Delete.json
