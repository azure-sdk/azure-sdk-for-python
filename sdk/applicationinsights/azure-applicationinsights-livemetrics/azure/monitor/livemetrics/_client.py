...
from ._operations import LiveMetricsClientOperationsMixin
...
class LiveMetricsClient(LiveMetricsClientOperationsMixin):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        _endpoint = "{endpoint}"
        self._config = LiveMetricsClientConfiguration(credential=credential, endpoint=endpoint, **kwargs)
