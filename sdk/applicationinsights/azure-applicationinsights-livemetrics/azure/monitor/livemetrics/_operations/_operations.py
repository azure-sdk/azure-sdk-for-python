...
class LiveMetricsClientOperationsMixin(LiveMetricsClientMixinABC):
    ...
    def is_subscribed(
        ...
        **kwargs: Any
        ...
        :type monitoring_data_point: ~azure.monitor.livemetrics.models.MonitoringDataPoint
        ...
        :return: CollectionConfigurationInfo. The CollectionConfigurationInfo is compatible with
         MutableMapping
        :rtype: ~azure.monitor.livemetrics.models.CollectionConfigurationInfo
    ...
    def is_subscribed(
        ...
        **kwargs: Any
        ...
        :type monitoring_data_point: ~azure.monitor.livemetrics.models.MonitoringDataPoint or JSON or
         IO[bytes]
        :keyword ikey: The instrumentation key of the target Application Insights component for which
         the client checks whether there's any subscription to it. Required.
        :paramtype ikey: str
    ...
    def publish(
        ...
        **kwargs: Any
        ...
        :type monitoring_data_points: list[~azure.monitor.livemetrics.models.MonitoringDataPoint]
        :keyword ikey: The instrumentation key of the target Application Insights component for which
         the client checks whether there's any subscription to it. Required.
        :paramtype ikey: str
        :keyword configuration_etag: An encoded string that indicates whether the collection
    ...
    def publish(
        ...
        **kwargs: Any
        ...
        :param monitoring_data_points: Data contract between the client and Live Metrics.
         ...
         None.
        :type monitoring_data_points: list[~azure.monitor.livemetrics.models.MonitoringDataPoint] or
         IO[bytes]
        :keyword ikey: The instrumentation key of the target Application Insights component for which
         the client checks whether there's any subscription to it. Required.
        :paramtype ikey: str
