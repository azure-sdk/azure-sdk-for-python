...
class CollectionConfigurationError(_model_base.Model):
    ...
    :vartype collection_configuration_error_type: str or
     ~azure.monitor.livemetrics.models.CollectionConfigurationErrorType
    ...
    :vartype data: list[~azure.monitor.livemetrics.models.KeyValuePairStringString]
    """
...
class CollectionConfigurationInfo(_model_base.Model):
    ...
    :vartype metrics: list[~azure.monitor.livemetrics.models.DerivedMetricInfo]
    :ivar document_streams: An array of document stream configuration info. Required.
    :vartype document_streams: list[~azure.monitor.livemetrics.models.DocumentStreamInfo]
    :ivar quota_info: Controls document quotas to be sent to Live Metrics.
    :vartype quota_info: ~azure.monitor.livemetrics.models.QuotaConfigurationInfo
    """
...
class DerivedMetricInfo(_model_base.Model):
    ...
    :vartype filter_groups: list[~azure.monitor.livemetrics.models.FilterConjunctionGroupInfo]
    ...
    :vartype aggregation: str or ~azure.monitor.livemetrics.models.AggregationType
    ...
    :vartype back_end_aggregation: str or ~azure.monitor.livemetrics.models.AggregationType
    """
...
class DocumentFilterConjunctionGroupInfo(_model_base.Model):
    ...
    :vartype telemetry_type: str or ~azure.monitor.livemetrics.models.TelemetryType
    :ivar filters: An array of filter groups. Required.
    :vartype filters: ~azure.monitor.livemetrics.models.FilterConjunctionGroupInfo
    """
...
class DocumentIngress(_model_base.Model):
    ...
    :vartype document_type: str or ~azure.monitor.livemetrics.models.DocumentType
    ...
    :vartype properties: list[~azure.monitor.livemetrics.models.KeyValuePairStringString]
    """
...
class DocumentStreamInfo(_model_base.Model):
    ...
    :vartype document_filter_groups:
     list[~azure.monitor.livemetrics.models.DocumentFilterConjunctionGroupInfo]
    """
...
class Event(DocumentIngress, discriminator="Event"):
    ...
    :vartype document_type: str or ~azure.monitor.livemetrics.models.EVENT
...
class Exception(DocumentIngress, discriminator="Exception"):
    ...
    :ivar document_type: Telemetry type for Exception. Required. Represents an exception telemetry
     type.
    :vartype document_type: str or ~azure.monitor.livemetrics.models.EXCEPTION
...
class FilterConjunctionGroupInfo(_model_base.Model):
    ...
    :vartype filters: list[~azure.monitor.livemetrics.models.FilterInfo]
    """
...
class FilterInfo(_model_base.Model):
    ...
    :ivar predicate: Operator of the filter. Required. Known values are: "Equal", "NotEqual",
     ...
     "DoesNotContain".
    :vartype predicate: str or ~azure.monitor.livemetrics.models.PredicateType
...
class MonitoringDataPoint(_model_base.Model):
    ...
    :vartype metrics: list[~azure.monitor.livemetrics.models.MetricPoint]
    :ivar documents: An array of documents of a specific type {Request}, {RemoteDependency},
     {Exception}, {Event}, or {Trace}.
    :vartype documents: list[~azure.monitor.livemetrics.models.DocumentIngress]
    :ivar top_cpu_processes: An array of top cpu consumption data point.
    :vartype top_cpu_processes: list[~azure.monitor.livemetrics.models.ProcessCpuData]
    ...
    :vartype collection_configuration_errors:
     list[~azure.monitor.livemetrics.models.CollectionConfigurationError]
    """
...
class RemoteDependency(DocumentIngress, discriminator="RemoteDependency"):
    ...
    :vartype document_type: str or ~azure.monitor.livemetrics.models.REMOTE_DEPENDENCY
...
class Request(DocumentIngress, discriminator="Request"):
    ...
    :vartype document_type: str or ~azure.monitor.livemetrics.models.REQUEST
...
class Trace(DocumentIngress, discriminator="Trace"):
    ...
    :vartype document_type: str or ~azure.monitor.livemetrics.models.TRACE
