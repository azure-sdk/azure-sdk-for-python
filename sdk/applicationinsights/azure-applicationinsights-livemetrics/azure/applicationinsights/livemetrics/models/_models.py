...
class CollectionConfigurationError(_model_base.Model):
    ...
    :vartype collection_configuration_error_type: str or
     ~azure.applicationinsights.livemetrics.models.CollectionConfigurationErrorType
    ...
    :vartype data: list[~azure.applicationinsights.livemetrics.models.KeyValuePairStringString]
    """
...
class CollectionConfigurationInfo(_model_base.Model):
    ...
    :vartype metrics: list[~azure.applicationinsights.livemetrics.models.DerivedMetricInfo]
    :ivar document_streams: An array of document stream configuration info. Required.
    :vartype document_streams:
     list[~azure.applicationinsights.livemetrics.models.DocumentStreamInfo]
    :ivar quota_info: Controls document quotas to be sent to Live Metrics.
    :vartype quota_info: ~azure.applicationinsights.livemetrics.models.QuotaConfigurationInfo
    """
...
class DerivedMetricInfo(_model_base.Model):
    ...
    :vartype filter_groups:
     list[~azure.applicationinsights.livemetrics.models.FilterConjunctionGroupInfo]
    ...
    :vartype aggregation: str or ~azure.applicationinsights.livemetrics.models.AggregationType
    ...
    :vartype back_end_aggregation: str or
     ~azure.applicationinsights.livemetrics.models.AggregationType
    """
...
class DocumentFilterConjunctionGroupInfo(_model_base.Model):
    ...
    :vartype telemetry_type: str or ~azure.applicationinsights.livemetrics.models.TelemetryType
    :ivar filters: An array of filter groups. Required.
    :vartype filters: ~azure.applicationinsights.livemetrics.models.FilterConjunctionGroupInfo
    """
...
class DocumentIngress(_model_base.Model):
    ...
    :vartype document_type: str or ~azure.applicationinsights.livemetrics.models.DocumentType
    ...
    :vartype properties:
     list[~azure.applicationinsights.livemetrics.models.KeyValuePairStringString]
    """
...
class DocumentStreamInfo(_model_base.Model):
    ...
    :vartype document_filter_groups:
     list[~azure.applicationinsights.livemetrics.models.DocumentFilterConjunctionGroupInfo]
    """
...
class Event(DocumentIngress, discriminator="Event"):
    ...
    :vartype document_type: str or ~azure.applicationinsights.livemetrics.models.EVENT
...
class Exception(DocumentIngress, discriminator="Exception"):
    ...
    :ivar document_type: Telemetry type for Exception. Required. Represents an exception telemetry
     type.
    :vartype document_type: str or ~azure.applicationinsights.livemetrics.models.EXCEPTION
...
class FilterConjunctionGroupInfo(_model_base.Model):
    ...
    :vartype filters: list[~azure.applicationinsights.livemetrics.models.FilterInfo]
    """
...
class FilterInfo(_model_base.Model):
    ...
    :ivar predicate: Operator of the filter. Required. Known values are: "Equal", "NotEqual",
     ...
     "DoesNotContain".
    :vartype predicate: str or ~azure.applicationinsights.livemetrics.models.PredicateType
...
class MonitoringDataPoint(_model_base.Model):
    ...
    :vartype metrics: list[~azure.applicationinsights.livemetrics.models.MetricPoint]
    :ivar documents: An array of documents of a specific type {Request}, {RemoteDependency},
     {Exception}, {Event}, or {Trace}.
    :vartype documents: list[~azure.applicationinsights.livemetrics.models.DocumentIngress]
    :ivar top_cpu_processes: An array of top cpu consumption data point.
    :vartype top_cpu_processes: list[~azure.applicationinsights.livemetrics.models.ProcessCpuData]
    ...
    :vartype collection_configuration_errors:
     list[~azure.applicationinsights.livemetrics.models.CollectionConfigurationError]
    """
...
class RemoteDependency(DocumentIngress, discriminator="RemoteDependency"):
    ...
    :vartype document_type: str or ~azure.applicationinsights.livemetrics.models.REMOTE_DEPENDENCY
...
class Request(DocumentIngress, discriminator="Request"):
    ...
    :vartype document_type: str or ~azure.applicationinsights.livemetrics.models.REQUEST
...
class Trace(DocumentIngress, discriminator="Trace"):
    ...
    :vartype document_type: str or ~azure.applicationinsights.livemetrics.models.TRACE
