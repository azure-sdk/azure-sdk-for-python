...
class StorageProperties(_Model):
    ...
    :ivar iops: The IOPs of the storage assigned to each server. Only applicable if the type is
     'PremiumSSDv2'.
    :vartype iops: int
    :ivar throughput: The througput of the storage assigned to each server. Only applicable if the
    ...
    """The througput of the storage assigned to each server. Only applicable if the type is
     'PremiumSSDv2'."""
