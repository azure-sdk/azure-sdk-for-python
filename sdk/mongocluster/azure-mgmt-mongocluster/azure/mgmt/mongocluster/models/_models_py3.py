...
class HighAvailabilityProperties(_serialization.Model):
    ...
    :ivar target_mode: The target high availability mode requested for the cluster. Known values
     are: "Disabled", "SameZone", "ZoneRedundant", and "ZoneRedundantPreferred".
    :vartype target_mode: str or ~azure.mgmt.mongocluster.models.HighAvailabilityMode
    :ivar mode: The current high availability mode the cluster is deployed with. Known values are:
     "Disabled", "SameZone", "ZoneRedundant", and "ZoneRedundantPreferred".
    :vartype mode: str or ~azure.mgmt.mongocluster.models.HighAvailabilityMode
    :ivar state: The state of the high availability configuration for the cluster.
    :vartype state: str
    """
