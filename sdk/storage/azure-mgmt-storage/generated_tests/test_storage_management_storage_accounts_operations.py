...
class TestStorageManagementStorageAccountsOperations(AzureMgmtRecordedTestCase):
    ...
    @recorded_by_proxy
    def test_storage_accounts_check_storage_account_name_availability(self, resource_group):
        response = self.client.storage_accounts.check_storage_account_name_availability(
