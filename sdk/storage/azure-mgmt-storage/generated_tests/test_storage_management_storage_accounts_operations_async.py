...
class TestStorageManagementStorageAccountsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_storage_accounts_check_storage_account_name_availability(self, resource_group):
        response = await self.client.storage_accounts.check_storage_account_name_availability(
