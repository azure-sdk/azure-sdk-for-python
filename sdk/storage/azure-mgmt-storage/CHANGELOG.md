...
### Features Added
  ...
  - Model BlobContainer has a new parameter e_tag
  ...
  - Model FileShare has a new parameter e_tag
  - Model FileShare has a new parameter system_data
  - Model ImmutabilityPolicy has a new parameter e_tag
...
### Breaking Changes
  ...
  - Model BlobContainer no longer has parameter etag
  - Model FileShare no longer has parameter etag
  - Model ImmutabilityPolicy no longer has parameter etag
