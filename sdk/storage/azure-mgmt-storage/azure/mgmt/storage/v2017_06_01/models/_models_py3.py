...
class AccountSasParameters(_serialization.Model):
    ...
    :vartype services: str or ~azure.mgmt.storage.v2017_06_01.models.Services
    ...
    :vartype resource_types: str or ~azure.mgmt.storage.v2017_06_01.models.SignedResourceTypes
    ...
    :vartype permissions: str or ~azure.mgmt.storage.v2017_06_01.models.Permissions
    ...
    :vartype protocols: str or ~azure.mgmt.storage.v2017_06_01.models.HttpProtocol
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword services: The signed services accessible with the account SAS. Possible values
         ...
         and "f".
        :paramtype services: str or ~azure.mgmt.storage.v2017_06_01.models.Services
        :keyword resource_types: The signed resource types that are accessible with the account SAS.
         Service (s): Access to service-level APIs; Container (c): Access to container-level APIs;
         Object (o): Access to object-level APIs for blobs, queue messages, table entities, and files.
         Required. Known values are: "s", "c", and "o".
        :paramtype resource_types: str or ~azure.mgmt.storage.v2017_06_01.models.SignedResourceTypes
        :keyword permissions: The signed permissions for the account SAS. Possible values include: Read
         (r), Write (w), Delete (d), List (l), Add (a), Create (c), Update (u) and Process (p).
         Required. Known values are: "r", "d", "w", "l", "a", "c", "u", and "p".
        :paramtype permissions: str or ~azure.mgmt.storage.v2017_06_01.models.Permissions
        ...
        :paramtype protocols: str or ~azure.mgmt.storage.v2017_06_01.models.HttpProtocol
...
class Encryption(_serialization.Model):
    ...
    :vartype services: ~azure.mgmt.storage.v2017_06_01.models.EncryptionServices
    :ivar key_source: The encryption keySource (provider). Possible values (case-insensitive):
     ...
     "Microsoft.Keyvault".
    :vartype key_source: str or ~azure.mgmt.storage.v2017_06_01.models.KeySource
    :ivar key_vault_properties: Properties provided by key vault.
    :vartype key_vault_properties: ~azure.mgmt.storage.v2017_06_01.models.KeyVaultProperties
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword key_source: The encryption keySource (provider). Possible values (case-insensitive):
         Microsoft.Storage, Microsoft.Keyvault. Known values are: "Microsoft.Storage" and
         "Microsoft.Keyvault".
        :paramtype key_source: str or ~azure.mgmt.storage.v2017_06_01.models.KeySource
        :keyword key_vault_properties: Properties provided by key vault.
        :paramtype key_vault_properties: ~azure.mgmt.storage.v2017_06_01.models.KeyVaultProperties
        """
        super().__init__(**kwargs)
        self.services = services
...
class EncryptionServices(_serialization.Model):
    ...
    :vartype blob: ~azure.mgmt.storage.v2017_06_01.models.EncryptionService
    :ivar file: The encryption function of the file storage service.
    :vartype file: ~azure.mgmt.storage.v2017_06_01.models.EncryptionService
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype file: ~azure.mgmt.storage.v2017_06_01.models.EncryptionService
        """
        super().__init__(**kwargs)
        self.blob = blob
        self.file = file
...
class MetricSpecification(_serialization.Model):
    ...
    :vartype dimensions: list[~azure.mgmt.storage.v2017_06_01.models.Dimension]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype dimensions: list[~azure.mgmt.storage.v2017_06_01.models.Dimension]
...
class NetworkRuleSet(_serialization.Model):
    ...
    :ivar bypass: Specifies whether traffic is bypassed for Logging/Metrics/AzureServices. Possible
     ...
     "AzureServices".
    :vartype bypass: str or ~azure.mgmt.storage.v2017_06_01.models.Bypass
    :ivar virtual_network_rules: Sets the virtual network rules.
    :vartype virtual_network_rules: list[~azure.mgmt.storage.v2017_06_01.models.VirtualNetworkRule]
    :ivar ip_rules: Sets the IP ACL rules.
    :vartype ip_rules: list[~azure.mgmt.storage.v2017_06_01.models.IPRule]
    ...
    :vartype default_action: str or ~azure.mgmt.storage.v2017_06_01.models.DefaultAction
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype bypass: str or ~azure.mgmt.storage.v2017_06_01.models.Bypass
        ...
        :paramtype ip_rules: list[~azure.mgmt.storage.v2017_06_01.models.IPRule]
        ...
        :paramtype default_action: str or ~azure.mgmt.storage.v2017_06_01.models.DefaultAction
        """
        super().__init__(**kwargs)
        self.bypass = bypass
...
class Operation(_serialization.Model):
    ...
    :vartype display: ~azure.mgmt.storage.v2017_06_01.models.OperationDisplay
    :ivar origin: The origin of operations.
    :vartype origin: str
    :ivar service_specification: One property of operation, include metric specifications.
    :vartype service_specification: ~azure.mgmt.storage.v2017_06_01.models.ServiceSpecification
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype display: ~azure.mgmt.storage.v2017_06_01.models.OperationDisplay
        ...
        :paramtype service_specification: ~azure.mgmt.storage.v2017_06_01.models.ServiceSpecification
        """
        super().__init__(**kwargs)
        self.name = name
...
class Restriction(_serialization.Model):
    ...
    :vartype reason_code: str or ~azure.mgmt.storage.v2017_06_01.models.ReasonCode
    """
    ...
    def __init__(self, *, reason_code: Optional[Union[str, "_models.ReasonCode"]] = None, **kwargs: Any) -> None:
        ...
        :keyword reason_code: The reason for the restriction. As of now this can be "QuotaId" or
         ...
         subscription does not belong to that quota. The "NotAvailableForSubscription" is related to
         capacity at DC. Known values are: "QuotaId" and "NotAvailableForSubscription".
        :paramtype reason_code: str or ~azure.mgmt.storage.v2017_06_01.models.ReasonCode
        """
        super().__init__(**kwargs)
        self.type = None
        self.values = None
...
class ServiceSasParameters(_serialization.Model):
    ...
    :ivar resource: The signed services accessible with the service SAS. Possible values include:
     ...
     "s".
    :vartype resource: str or ~azure.mgmt.storage.v2017_06_01.models.SignedResource
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword resource: The signed services accessible with the service SAS. Possible values
         ...
         "f", and "s".
        :paramtype resource: str or ~azure.mgmt.storage.v2017_06_01.models.SignedResource
...
class Sku(_serialization.Model):
    ...
    :vartype name: str or ~azure.mgmt.storage.v2017_06_01.models.SkuName
    ...
    :ivar kind: Indicates the type of storage account. Known values are: "Storage" and
     "BlobStorage".
    ...
    :vartype restrictions: list[~azure.mgmt.storage.v2017_06_01.models.Restriction]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword name: Gets or sets the sku name. Required for account creation; optional for update.
         ...
         "Standard_LRS", "Standard_GRS", "Standard_RAGRS", "Standard_ZRS", and "Premium_LRS".
        :paramtype name: str or ~azure.mgmt.storage.v2017_06_01.models.SkuName
        :keyword restrictions: The restrictions because of which SKU cannot be used. This is empty if
         there are no restrictions.
        :paramtype restrictions: list[~azure.mgmt.storage.v2017_06_01.models.Restriction]
        """
        super().__init__(**kwargs)
        self.name = name
        self.tier = None
...
class StorageAccount(Resource):
    ...
    :vartype identity: ~azure.mgmt.storage.v2017_06_01.models.Identity
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype identity: ~azure.mgmt.storage.v2017_06_01.models.Identity
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword kind: Required. Indicates the type of storage account. Required. Known values are:
         "Storage" and "BlobStorage".
        :paramtype kind: str or ~azure.mgmt.storage.v2017_06_01.models.Kind
        ...
        :keyword custom_domain: User domain assigned to the storage account. Name is the CNAME source.
         Only one custom domain is supported per storage account at this time. To clear the existing
         custom domain, use an empty string for the custom domain name property.
        :paramtype custom_domain: ~azure.mgmt.storage.v2017_06_01.models.CustomDomain
        :keyword encryption: Provides the encryption settings on the account. If left unspecified the
         account encryption settings will remain the same. The default setting is unencrypted.
        :paramtype encryption: ~azure.mgmt.storage.v2017_06_01.models.Encryption
        :keyword network_rule_set: Network rule set.
        :paramtype network_rule_set: ~azure.mgmt.storage.v2017_06_01.models.NetworkRuleSet
        ...
        :paramtype access_tier: str or ~azure.mgmt.storage.v2017_06_01.models.AccessTier
        :keyword enable_https_traffic_only: Allows https traffic only to storage service if sets to
         true.
        :paramtype enable_https_traffic_only: bool
        """
...
class UsageListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.storage.v2017_06_01.models.Usage]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword state: Gets the state of virtual network rule. Known values are: "provisioning",
         "deprovisioning", "succeeded", "failed", and "networkSourceDeleted".
        :paramtype state: str or ~azure.mgmt.storage.v2017_06_01.models.State
        """
        super().__init__(**kwargs)
