...
class StorageAccountsOperations:
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either StorageAccount or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.storage.v2017_06_01.models.StorageAccount]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.StorageAccount"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.storage.v2017_06_01.models.StorageAccount]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
