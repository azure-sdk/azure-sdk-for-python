    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either StorageAccount or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.storage.v2020_08_01_preview.models.StorageAccount]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_restore_blob_ranges(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either BlobRestoreStatus or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.storage.v2020_08_01_preview.models.BlobRestoreStatus]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
