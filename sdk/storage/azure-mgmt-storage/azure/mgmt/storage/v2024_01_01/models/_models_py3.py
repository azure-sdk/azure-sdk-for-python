...
class AzureResourceManagerArmResponseBlobRestoreStatus(_serialization.Model):  # pylint: disable=name-too-long
    """Azure operation completed successfully.

    All required parameters must be populated in order to send to server.

    :ivar body: The body type of the operation request or response. Required.
    :vartype body: ~azure.mgmt.storage.v2024_01_01.models.BlobRestoreStatus
    """
    ...
    _attribute_map = {
        "body": {"key": "body", "type": "BlobRestoreStatus"},
    }

    def __init__(self, *, body: "_models.BlobRestoreStatus", **kwargs: Any) -> None:
        """
        :keyword body: The body type of the operation request or response. Required.
        :paramtype body: ~azure.mgmt.storage.v2024_01_01.models.BlobRestoreStatus
        """
        super().__init__(**kwargs)
        self.body = body
...
class DeletedAccountListResult(_serialization.Model):
    ...
    def __init__(
        self, *, value: Optional[List["_models.DeletedAccount"]] = None, next_link: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: Gets the list of deleted accounts and their properties.
        :paramtype value: list[~azure.mgmt.storage.v2024_01_01.models.DeletedAccount]
        :keyword next_link: Request URL that can be used to query next page of deleted accounts.
         Returned when total number of requested deleted accounts exceed maximum page size.
...
class EncryptionScopeListResult(_serialization.Model):
    ...
    def __init__(
        self, *, value: Optional[List["_models.EncryptionScope"]] = None, next_link: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: List of encryption scopes requested.
        :paramtype value: list[~azure.mgmt.storage.v2024_01_01.models.EncryptionScope]
        :keyword next_link: Request URL that can be used to query next page of encryption scopes.
         Returned when total number of requested encryption scopes exceeds the maximum page size.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
        self.value = value
...
class FileServiceUsages(_serialization.Model):
    ...
    :ivar value: List of file service usages returned. Required.
    ...
    def __init__(
        self, *, value: List["_models.FileServiceUsage"], next_link: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: List of file service usages returned. Required.
        :paramtype value: list[~azure.mgmt.storage.v2024_01_01.models.FileServiceUsage]
        :keyword next_link: Request URL that can be used to query next page of file service usages.
         Returned when total number of requested file service usages exceed maximum page size.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class FileShareItems(_serialization.Model):
    ...
    :ivar value: List of file shares returned. Required.
    ...
    def __init__(self, *, value: List["_models.FileShareItem"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword value: List of file shares returned. Required.
        :paramtype value: list[~azure.mgmt.storage.v2024_01_01.models.FileShareItem]
        :keyword next_link: Request URL that can be used to query next page of shares. Returned when
...
class LeaseContainerRequest(_serialization.Model):
    ...
    :vartype action: str or ~azure.mgmt.storage.v2024_01_01.models.LeaseContainerRequestAction
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype action: str or ~azure.mgmt.storage.v2024_01_01.models.LeaseContainerRequestAction
...
class ListContainerItems(_serialization.Model):
    ...
    :ivar value: List of blobs containers returned. Required.
    ...
    def __init__(
        self, *, value: List["_models.ListContainerItem"], next_link: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: List of blobs containers returned. Required.
        :paramtype value: list[~azure.mgmt.storage.v2024_01_01.models.ListContainerItem]
        :keyword next_link: Request URL that can be used to query next page of containers. Returned
...
class ListQueueResource(_serialization.Model):
    ...
    :ivar value: List of queues returned. Required.
    ...
    def __init__(self, *, value: List["_models.ListQueue"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword value: List of queues returned. Required.
        :paramtype value: list[~azure.mgmt.storage.v2024_01_01.models.ListQueue]
        :keyword next_link: Request URL that can be used to list next page of queues.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
        self.value = value
...
class ListTableResource(_serialization.Model):
    ...
    def __init__(self, *, value: List["_models.Table"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword value: The Table items on this page. Required.
        :paramtype value: list[~azure.mgmt.storage.v2024_01_01.models.Table]
        :keyword next_link: Request URL that can be used to query next page of tables.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
        self.value = value
...
class LocalUsers(_serialization.Model):
    ...
    :ivar value: The list of local users associated with the storage account. Required.
    ...
    def __init__(self, *, value: List["_models.LocalUser"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword value: The list of local users associated with the storage account. Required.
        :paramtype value: list[~azure.mgmt.storage.v2024_01_01.models.LocalUser]
        :keyword next_link: Request URL that can be used to query next page of local users. Returned
         when total number of requested local users exceeds the maximum page size.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
        self.value = value
...
class NetworkSecurityPerimeterConfigurationList(_serialization.Model):  # pylint: disable=name-too-long
    ...
    :ivar value: A collection of Network Security Perimeter configurations. Required.
    :vartype value:
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword value: A collection of Network Security Perimeter configurations. Required.
        :paramtype value:
         list[~azure.mgmt.storage.v2024_01_01.models.NetworkSecurityPerimeterConfiguration]
...
class Operation(_serialization.Model):
    ...
    :ivar origin: The intended executor of the operation; as in Resource Based Access Control
     ...
     and "user,system".
    :vartype origin: str or ~azure.mgmt.storage.v2024_01_01.models.Origin
    :ivar action_type: Enum. Indicates the action type. "Internal" refers to actions that are for
     internal only APIs. "Internal"
    :vartype action_type: str or ~azure.mgmt.storage.v2024_01_01.models.ActionType
    """
...
class StorageAccountCheckNameAvailabilityParameters(_serialization.Model):  # pylint: disable=name-too-long
    ...
    :vartype name: str
    :ivar type: The type of resource, Microsoft.Storage/storageAccounts. Default value is
     "Microsoft.Storage/storageAccounts".
    :vartype type: str
    """
...
class StorageAccountListResult(_serialization.Model):
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.storage.v2024_01_01.models.StorageAccount]
...
class StorageTaskAssignmentsList(_serialization.Model):
    ...
    :ivar value: Gets the list of storage task assignments and their properties. Required.
    ...
    def __init__(
        ...
        """
        :keyword value: Gets the list of storage task assignments and their properties. Required.
        :paramtype value: list[~azure.mgmt.storage.v2024_01_01.models.StorageTaskAssignment]
        :keyword next_link: Request URL that can be used to query next page of storage task
         assignments. Returned when total number of requested storage task assignments exceed maximum
         page size.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class StorageTaskReportSummary(_serialization.Model):
    ...
    def __init__(
        ...
        """
        :keyword value: Gets storage tasks run result summary. Required.
        :paramtype value: list[~azure.mgmt.storage.v2024_01_01.models.StorageTaskReportInstance]
        :keyword next_link: Request URL that can be used to query next page of storage task run results
         summary. Returned when the number of run instances and summary reports exceed maximum page
         size.
        :paramtype next_link: str
        """
...
class TriggerParameters(_serialization.Model):
    ...
    :vartype interval_unit: str or ~azure.mgmt.storage.v2024_01_01.models.IntervalUnit
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword interval_unit: Run interval unit of task execution. This is a required field when
         ExecutionTrigger.properties.type is 'OnSchedule'; this property should not be present when
         ExecutionTrigger.properties.type is 'RunOnce'. "Days"
        :paramtype interval_unit: str or ~azure.mgmt.storage.v2024_01_01.models.IntervalUnit
