...
def build_get_service_properties_request(
    resource_group_name: str, account_name: str, blob_services_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class BlobServicesOperations:
    ...
    def get_service_properties(
        self, resource_group_name: str, account_name: str, blob_services_name: str, **kwargs: Any
