...
class FileSharesOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.FileShare"]:
        """Lists all shares.
        ...
        :param expand: Optional, used to expand the properties within share's properties. Valid values
         ...
         None.
        :type expand: str
        :return: An iterator like instance of either FileShare or the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storage.v2024_01_01.models.FileShare]
        ...
        cls: ClsType[_models.FileShareListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("FileShareListResult", pipeline_response)
