...
class BlobInventoryPoliciesOperations:
    ...
    async def list(self, resource_group_name: str, account_name: str, **kwargs: Any) -> _models.ListBlobInventoryPolicy:
        ...
        :return: ListBlobInventoryPolicy or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2024_01_01.models.ListBlobInventoryPolicy
        ...
        deserialized = self._deserialize("ListBlobInventoryPolicy", pipeline_response.http_response)
