...
class DualStackEndpointPreference(_serialization.Model):
    """Dual-stack endpoint preference defines the type of network, either dualstack/ipv4/ipv6
    endpoints are going to be published.

    :ivar default_dual_stack_endpoints: A boolean flag which indicates whether dual-stack storage
     endpoints are to be published.
    :vartype default_dual_stack_endpoints: bool
    :ivar publish_ipv4_endpoint: A boolean flag which indicates whether IPv4 storage endpoints are
     to be published.
    :vartype publish_ipv4_endpoint: bool
    ...
    _attribute_map = {
        "default_dual_stack_endpoints": {"key": "defaultDualStackEndpoints", "type": "bool"},
        "publish_ipv4_endpoint": {"key": "publishIpv4Endpoint", "type": "bool"},
    ...
    def __init__(
        self,
        *,
        default_dual_stack_endpoints: Optional[bool] = None,
        publish_ipv4_endpoint: Optional[bool] = None,
        publish_ipv6_endpoint: Optional[bool] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword default_dual_stack_endpoints: A boolean flag which indicates whether dual-stack
         storage endpoints are to be published.
        :paramtype default_dual_stack_endpoints: bool
        :keyword publish_ipv4_endpoint: A boolean flag which indicates whether IPv4 storage endpoints
         are to be published.
        :paramtype publish_ipv4_endpoint: bool
        ...
        """
        super().__init__(**kwargs)
        self.default_dual_stack_endpoints = default_dual_stack_endpoints
        self.publish_ipv4_endpoint = publish_ipv4_endpoint
...
class Endpoints(_serialization.Model):
    ...
    :ivar ipv4_endpoints: Gets the ipv4 storage endpoints.
    :vartype ipv4_endpoints: ~azure.mgmt.storage.v2023_01_01.models.StorageAccountIpv4Endpoints
    :ivar ipv6_endpoints: Gets the ipv6 storage endpoints.
    :vartype ipv6_endpoints: ~azure.mgmt.storage.v2023_01_01.models.StorageAccountIpv6Endpoints
    """
    ...
    _attribute_map = {
        ...
        "ipv4_endpoints": {"key": "ipv4Endpoints", "type": "StorageAccountIpv4Endpoints"},
    ...
    def __init__(
        ...
        *,
        ...
        ipv4_endpoints: Optional["_models.StorageAccountIpv4Endpoints"] = None,
        ...
        **kwargs: Any
        ...
        :paramtype internet_endpoints:
         ~azure.mgmt.storage.v2023_01_01.models.StorageAccountInternetEndpoints
        :keyword ipv4_endpoints: Gets the ipv4 storage endpoints.
        :paramtype ipv4_endpoints: ~azure.mgmt.storage.v2023_01_01.models.StorageAccountIpv4Endpoints
        :keyword ipv6_endpoints: Gets the ipv6 storage endpoints.
        :paramtype ipv6_endpoints: ~azure.mgmt.storage.v2023_01_01.models.StorageAccountIpv6Endpoints
        """
        super().__init__(**kwargs)
        self.blob = None
        self.queue = None
        ...
        self.ipv4_endpoints = ipv4_endpoints
...
class IPRule(_serialization.Model):
    ...
    :ivar ip_address_or_range: Specifies the IP or IP range in CIDR format. Only IPv4 or IPv6
     address is allowed. Required.
    :vartype ip_address_or_range: str
    ...
    def __init__(self, *, ip_address_or_range: str, action: Optional[Literal["Allow"]] = None, **kwargs: Any) -> None:
        """
        :keyword ip_address_or_range: Specifies the IP or IP range in CIDR format. Only IPv4 or IPv6
         address is allowed. Required.
        :paramtype ip_address_or_range: str
...
class NetworkRuleSet(_serialization.Model):
    ...
    :ivar ip_rules: Sets the IPv4 ACL rules.
    :vartype ip_rules: list[~azure.mgmt.storage.v2023_01_01.models.IPRule]
    :ivar ipv6_rules: Sets the IPv6 ACL rules.
    :vartype ipv6_rules: list[~azure.mgmt.storage.v2023_01_01.models.IPRule]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword ip_rules: Sets the IPv4 ACL rules.
        :paramtype ip_rules: list[~azure.mgmt.storage.v2023_01_01.models.IPRule]
        :keyword ipv6_rules: Sets the IPv6 ACL rules.
        :paramtype ipv6_rules: list[~azure.mgmt.storage.v2023_01_01.models.IPRule]
...
class StorageAccount(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar dual_stack_endpoint_preference: Maintains information about the Internet protocol opted
     by the user.
    :vartype dual_stack_endpoint_preference:
     ~azure.mgmt.storage.v2023_01_01.models.DualStackEndpointPreference
...
class StorageAccountIpv4Endpoints(_serialization.Model):
