...
class ExecutionTarget(_serialization.Model):
    ...
    :ivar prefix: Required list of object prefixes to be included for task execution. Required.
    ...
    def __init__(self, *, prefix: List[str], exclude_prefix: Optional[List[str]] = None, **kwargs: Any) -> None:
        """
        :keyword prefix: Required list of object prefixes to be included for task execution. Required.
...
class ExecutionTargetUpdate(_serialization.Model):
    """Target helps provide filter parameters for the objects in the storage account and forms the
    execution context for the storage task.
...
class StorageTaskAssignment(ResourceAutoGenerated):
    ...
    def __init__(
        self, *, properties: Optional["_models.StorageTaskAssignmentProperties"] = None, **kwargs: Any
    ) -> None:
        """
...
class StorageTaskAssignmentExecutionContext(_serialization.Model):
    ...
    :ivar target: Execution target of the storage task assignment. Required.
    ...
    def __init__(
        self, *, target: "_models.ExecutionTarget", trigger: "_models.ExecutionTrigger", **kwargs: Any
    ) -> None:
        """
        :keyword target: Execution target of the storage task assignment. Required.
...
class StorageTaskAssignmentUpdateExecutionContext(_serialization.Model):  # pylint: disable=name-too-long
    ...
    def __init__(
        self,
        *,
        target: Optional["_models.ExecutionTargetUpdate"] = None,
