...
class EncryptionScopesOperations:
    ...
    def put(
        ...
        **kwargs: Any
        ...
        :type encryption_scope: ~azure.mgmt.storage.v2021_08_01.models.EncryptionScope or IO[bytes]
        :return: EncryptionScope or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2021_08_01.models.EncryptionScope
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(self, resource_group_name: str, account_name: str, **kwargs: Any) -> Iterable["_models.EncryptionScope"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.storage.v2021_08_01.models.EncryptionScope]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
