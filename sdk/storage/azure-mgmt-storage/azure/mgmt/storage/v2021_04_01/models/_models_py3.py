...
class AzureFilesIdentityBasedAuthentication(_serialization.Model):
    ...
    :ivar default_share_permission: Default share permission for users using Kerberos
     ...
     "StorageFileDataSmbShareElevatedContributor", and "StorageFileDataSmbShareOwner".
...
class CloudErrorAutoGenerated(_serialization.Model):
    ...
    def __init__(self, *, error: Optional["_models.CloudErrorBodyAutoGenerated"] = None, **kwargs: Any) -> None:
        """
