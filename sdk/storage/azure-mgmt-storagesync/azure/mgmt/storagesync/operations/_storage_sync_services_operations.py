...
class StorageSyncServicesOperations:
    ...
    def _create_initial(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.StorageSyncService]] = kwargs.pop("cls", None)
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param parameters: Storage Sync Service resource name. Is either a
         StorageSyncServiceCreateParameters type or a IO type. Required.
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param parameters: Storage Sync Service resource. Is either a
         StorageSyncServiceUpdateParameters type or a IO type. Default value is None.
