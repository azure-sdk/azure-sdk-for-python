...
class RegisteredServersOperations:
    ...
    def _create_initial(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.RegisteredServer]] = kwargs.pop("cls", None)
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param parameters: Body of Registered Server object. Is either a
         RegisteredServerCreateParameters type or a IO type. Required.
    ...
    def _update_initial(
        ...
        storage_sync_service_name: str,
        server_id: str,
        parameters: Union[_models.RegisteredServerUpdateParameters, IO],
        **kwargs: Any
    ) -> Optional[_models.RegisteredServer]:
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type server_id: str
        :param parameters: Body of Registered Server object. Is either a
         RegisteredServerUpdateParameters type or a IO type. Required.
        :type parameters: ~azure.mgmt.storagesync.models.RegisteredServerUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    _trigger_rollover_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/storageSyncServices/{storageSyncServiceName}/registeredServers/{serverId}/triggerRollover"
    }
    ...
    begin_trigger_rollover.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/storageSyncServices/{storageSyncServiceName}/registeredServers/{serverId}/triggerRollover"
    }
