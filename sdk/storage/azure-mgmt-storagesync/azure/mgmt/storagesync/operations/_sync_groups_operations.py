...
class SyncGroupsOperations:
    ...
    list_by_storage_sync_service.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/storageSyncServices/{storageSyncServiceName}/syncGroups"
    }
    ...
    def create(
        ...
        **kwargs: Any
        ...
        :param sync_group_name: Name of Sync Group resource. Required.
        :type sync_group_name: str
        :param parameters: Sync Group Body. Is either a SyncGroupCreateParameters type or a IO type.
         Required.
