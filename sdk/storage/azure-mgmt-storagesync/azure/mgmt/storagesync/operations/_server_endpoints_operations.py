...
class ServerEndpointsOperations:
    ...
    def _create_initial(
        ...
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.ServerEndpoint]] = kwargs.pop("cls", None)
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param parameters: Any of the properties applicable in PUT request. Is either a
         ServerEndpointUpdateParameters type or a IO type. Default value is None.
    ...
    list_by_sync_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/storageSyncServices/{storageSyncServiceName}/syncGroups/{syncGroupName}/serverEndpoints"
    }
    ...
    _recall_action_initial.metadata = {
