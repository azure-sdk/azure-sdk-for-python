...
class TestStorageCacheManagementAutoImportJobsOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(StorageCacheManagementClient, is_async=True)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_auto_import_jobs_begin_delete(self, resource_group):
        response = await (
            await self.client.auto_import_jobs.begin_delete(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_auto_import_jobs_get(self, resource_group):
        response = await self.client.auto_import_jobs.get(
            resource_group_name=resource_group.name,
            aml_filesystem_name="str",
            auto_import_job_name="str",
            api_version="2025-07-01",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_auto_import_jobs_begin_create_or_update(self, resource_group):
        response = await (
            await self.client.auto_import_jobs.begin_create_or_update(
                resource_group_name=resource_group.name,
                aml_filesystem_name="str",
                auto_import_job_name="str",
                auto_import_job={
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_auto_import_jobs_begin_update(self, resource_group):
        response = await (
            await self.client.auto_import_jobs.begin_update(
                resource_group_name=resource_group.name,
                aml_filesystem_name="str",
                auto_import_job_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_auto_import_jobs_list_by_aml_filesystem(self, resource_group):
