...
class AutoExportJob(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar current_iteration_files_exported: Number of files that have been exported in current
     iteration.
    ...
    :ivar current_iteration_files_failed: Number of files failed to export in current iteration.
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        *,
        location: str,
        tags: Optional[Dict[str, str]] = None,
        admin_status: Union[str, "_models.AutoExportJobAdminStatus"] = "Enable",
...
class ImportJob(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar imported_files: Number of new or modified files that have been imported into the
     filesystem.
    :vartype imported_files: int
    :ivar imported_directories: Number of new or modified directories that have been imported into
     the filesystem.
    :vartype imported_directories: int
    :ivar imported_symlinks: Number of newly added symbolic links into the filesystem.
    :vartype imported_symlinks: int
    :ivar preexisting_files: Number of files that already exist in the filesystem and have not been
     modified.
    :vartype preexisting_files: int
    :ivar preexisting_directories: Number of directories that already exist in the filesystem and
     have not been modified.
    :vartype preexisting_directories: int
    :ivar preexisting_symlinks: Number of symbolic links that already exist in the filesystem and
     have not been modified.
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        *,
        location: str,
        tags: Optional[Dict[str, str]] = None,
        admin_status: Union[str, "_models.ImportJobAdminStatus"] = "Enable",
