    ...
    def __init__(self, arguments):
        ...
        if not _ServiceTest.service_client or self.args.no_client_share:
            if self.args.use_entra_id:
                ...
                async_token_credential = AsyncClientSecretCredential(tenant_id, client_id, client_secret)
                ...
                _ServiceTest.service_client = SyncBlobServiceClient(
                    account_url=url, credential=sync_token_credential, **self._client_kwargs
                )
                _ServiceTest.async_service_client = AsyncBlobServiceClient(
                    account_url=url, credential=async_token_credential, **self._client_kwargs
                )
            else:
