...
class BlobClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        self, version: str, url: str, credential: Union[AzureKeyCredential, "AsyncTokenCredential"], **kwargs: Any
    ) -> None:
        _endpoint = "{url}"
        self._config = BlobClientConfiguration(version=version, url=url, credential=credential, **kwargs)
