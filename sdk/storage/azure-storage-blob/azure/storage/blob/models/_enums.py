...
class ArchiveStatus(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    REHYDRATE_PENDING_TO_ARCHIVE = "rehydrate-pending-to-archive"
    """The archive status is rehydrating pending to archive."""
    REHYDRATE_PENDING_TO_EXPIRED = "rehydrate-pending-to-expired"
...
class FilterBlobsIncludes(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class ListBlobsIncludes(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class QueryRequestTypeSqlOnly(str, Enum, metaclass=CaseInsensitiveEnumMeta):
