...
class AccessPolicy(_model_base.Model):
    ...
    start: datetime.datetime = rest_field(
        format="rfc3339", xml={"attribute": False, "name": "Start", "text": False, "unwrapped": False}
    )
    """The date-time the policy is active. Required."""
    expiry: datetime.datetime = rest_field(
        format="rfc3339", xml={"attribute": False, "name": "Expiry", "text": False, "unwrapped": False}
    )
    """The date-time the policy expires. Required."""
    permission: str = rest_field(xml={"attribute": False, "name": "Permission", "text": False, "unwrapped": False})
...
class ArrowField(_model_base.Model):
    ...
    type: str = rest_field(xml={"attribute": False, "name": "Type", "text": False, "unwrapped": False})
    """The arrow field type. Required."""
    name: Optional[str] = rest_field(xml={"attribute": False, "name": "Name", "text": False, "unwrapped": False})
    ...
    scale: Optional[int] = rest_field(xml={"attribute": False, "name": "Scale", "text": False, "unwrapped": False})
...
class BlobFlatListSegment(_model_base.Model):
    ...
    :vartype blob_items: ~azure.storage.blob.models.BlobItemInternal
    """

    blob_items: List["_models.BlobItemInternal"] = rest_field(
        name="blobItems",
        xml={"attribute": False, "itemsName": "Blob", "name": "BlobItems", "text": False, "unwrapped": False},
    )
...
class BlobHierarchyListSegment(_model_base.Model):
    ...
    :vartype blob_prefixes: ~azure.storage.blob.models.BlobPrefix
    """
    ...
    blob_prefixes: Optional[List["_models.BlobPrefix"]] = rest_field(
        name="blobPrefixes",
        xml={"attribute": False, "itemsName": "BlobPrefix", "name": "BlobPrefixes", "text": False, "unwrapped": False},
    )
    """The blob prefixes."""
...
class BlobItemInternal(_model_base.Model):
    ...
    name: "_models.BlobName" = rest_field(xml={"attribute": False, "name": "Name", "text": False, "unwrapped": False})
    """The name of the blob. Required."""
    deleted: bool = rest_field(xml={"attribute": False, "name": "Deleted", "text": False, "unwrapped": False})
    """Whether the blob is deleted. Required."""
    snapshot: str = rest_field(xml={"attribute": False, "name": "Snapshot", "text": False, "unwrapped": False})
    """The snapshot of the blob. Required."""
    version_id: Optional[str] = rest_field(
        name="versionId", xml={"attribute": False, "name": "VersionId", "text": False, "unwrapped": False}
    )
    """The version id of the blob."""
    is_current_version: Optional[bool] = rest_field(
        name="isCurrentVersion", xml={"attribute": False, "name": "IsCurrentVersion", "text": False, "unwrapped": False}
    )
    ...
    blob_tags: Optional["_models.BlobTags"] = rest_field(
        name="blobTags", xml={"attribute": False, "name": "BlobTags", "text": False, "unwrapped": False}
    )
    ...
    object_replication_metadata: Optional["_models.ObjectReplicationMetadata"] = rest_field(
        ...
        xml={"attribute": False, "name": "ObjectReplicationMetadata", "text": False, "unwrapped": False},
    )
    """The object replication metadata of the blob."""
    has_versions_only: Optional[bool] = rest_field(
        name="hasVersionsOnly", xml={"attribute": False, "name": "HasVersionsOnly", "text": False, "unwrapped": False}
    )
...
class BlobName(_model_base.Model):
    ...
    encoded: bool = rest_field(xml={"attribute": True, "name": "Encoded", "text": False, "unwrapped": False})
...
class BlobPropertiesInternal(_model_base.Model):
    ...
    creation_time: Optional[str] = rest_field(
        name="creationTime", xml={"attribute": False, "name": "Creation-Time", "text": False, "unwrapped": False}
    )
    """The date-time the blob was created in RFC1123 format."""
    last_modified: str = rest_field(
        name="lastModified", xml={"attribute": False, "name": "Last-Modified", "text": False, "unwrapped": False}
    )
    """The date-time the blob was last modified in RFC1123 format. Required."""
    e_tag: str = rest_field(name="eTag", xml={"attribute": False, "name": "ETag", "text": False, "unwrapped": False})
    """The blog ETag. Required."""
    content_length: Optional[int] = rest_field(
        name="contentLength", xml={"attribute": False, "name": "Content-Length", "text": False, "unwrapped": False}
    )
    """The content length of the blob."""
    content_type: Optional[str] = rest_field(
        name="contentType", xml={"attribute": False, "name": "Content-Type", "text": False, "unwrapped": False}
    )
    """The content type of the blob."""
    content_encoding: Optional[str] = rest_field(
        name="contentEncoding", xml={"attribute": False, "name": "Content-Encoding", "text": False, "unwrapped": False}
    )
    """The content encoding of the blob."""
    content_language: Optional[str] = rest_field(
        name="contentLanguage", xml={"attribute": False, "name": "Content-Language", "text": False, "unwrapped": False}
    )
    ...
    cache_control: Optional[str] = rest_field(
        name="cacheControl", xml={"attribute": False, "name": "Cache-Control", "text": False, "unwrapped": False}
    )
    ...
    blob_type: Optional[Union[str, "_models.BlobType"]] = rest_field(
        name="blobType", xml={"attribute": False, "name": "BlobType", "text": False, "unwrapped": False}
    )
    ...
    lease_status: Optional[Union[str, "_models.LeaseStatus"]] = rest_field(
        name="leaseStatus", xml={"attribute": False, "name": "LeaseStatus", "text": False, "unwrapped": False}
    )
    ...
    lease_state: Optional[Union[str, "_models.LeaseState"]] = rest_field(
        name="leaseState", xml={"attribute": False, "name": "LeaseState", "text": False, "unwrapped": False}
    )
    ...
    lease_duration: Optional[Union[str, "_models.LeaseDuration"]] = rest_field(
        name="leaseDuration", xml={"attribute": False, "name": "LeaseDuration", "text": False, "unwrapped": False}
    )
    """The lease duration of the blob. Known values are: \"infinite\" and \"fixed\"."""
    copy_id: Optional[str] = rest_field(
        name="copyId", xml={"attribute": False, "name": "CopyId", "text": False, "unwrapped": False}
    )
    """The copy ID of the blob."""
    copy_status: Optional[Union[str, "_models.CopyStatus"]] = rest_field(
        name="copyStatus", xml={"attribute": False, "name": "CopyStatus", "text": False, "unwrapped": False}
    )
    """The copy status of the blob. Known values are: \"pending\", \"success\", \"failed\", and
     \"aborted\"."""
    copy_source: Optional[str] = rest_field(
        name="copySource", xml={"attribute": False, "name": "CopySource", "text": False, "unwrapped": False}
    )
    """The copy source of the blob."""
    copy_progress: Optional[str] = rest_field(
        name="copyProgress", xml={"attribute": False, "name": "CopyProgress", "text": False, "unwrapped": False}
    )
    """The copy progress of the blob."""
    copy_completion_time: Optional[str] = rest_field(
    ...
    server_encrypted: Optional[bool] = rest_field(
        name="serverEncrypted", xml={"attribute": False, "name": "ServerEncrypted", "text": False, "unwrapped": False}
    )
    """Whether the blog is encrypted on the server."""
    incremental_copy: Optional[bool] = rest_field(
        name="incrementalCopy", xml={"attribute": False, "name": "IncrementalCopy", "text": False, "unwrapped": False}
    )
    ...
    deleted_time: Optional[str] = rest_field(
        name="deletedTime", xml={"attribute": False, "name": "DeletedTime", "text": False, "unwrapped": False}
    )
    ...
    access_tier: Optional[Union[str, "_models.AccessTier"]] = rest_field(
        name="accessTier", xml={"attribute": False, "name": "AccessTier", "text": False, "unwrapped": False}
    )
    ...
    archive_status: Optional[Union[str, "_models.ArchiveStatus"]] = rest_field(
        name="archiveStatus", xml={"attribute": False, "name": "ArchiveStatus", "text": False, "unwrapped": False}
    )
    ...
    encryption_scope: Optional[str] = rest_field(
        name="encryptionScope", xml={"attribute": False, "name": "EncryptionScope", "text": False, "unwrapped": False}
    )
    """The encryption scope of the blob."""
    access_tier_change_time: Optional[str] = rest_field(
    ...
    tag_count: Optional[int] = rest_field(
        name="tagCount", xml={"attribute": False, "name": "TagCount", "text": False, "unwrapped": False}
    )
    """The number of tags for the blob."""
    expires_on: Optional[str] = rest_field(
        name="ExpiresOn", xml={"attribute": False, "name": "Expiry-Time", "text": False, "unwrapped": False}
    )
    """The expire time of the blob."""
    is_sealed: Optional[bool] = rest_field(
        name="IsSealed", xml={"attribute": False, "name": "Sealed", "text": False, "unwrapped": False}
    )
    ...
    last_accessed_on: Optional[str] = rest_field(
        name="LastAccessedOn", xml={"attribute": False, "name": "LastAccessTime", "text": False, "unwrapped": False}
    )
    """The last access time of the blob."""
    immutability_policy_expires_on: Optional[str] = rest_field(
    ...
    legal_hold: Optional[bool] = rest_field(
        name="legalHold", xml={"attribute": False, "name": "LegalHold", "text": False, "unwrapped": False}
    )
...
class BlobTag(_model_base.Model):
    ...
    key: str = rest_field(xml={"attribute": False, "name": "Key", "text": False, "unwrapped": False})
    """The key of the tag. Required."""
    value: str = rest_field(xml={"attribute": False, "name": "Value", "text": False, "unwrapped": False})
...
class ClearRange(_model_base.Model):
    ...
    start: int = rest_field(xml={"attribute": False, "name": "Start", "text": False, "unwrapped": False})
    """The start of the byte range. Required."""
    end: int = rest_field(xml={"attribute": False, "name": "End", "text": False, "unwrapped": False})
...
class ContainerItem(_model_base.Model):
    ...
    delete: Optional[bool] = rest_field(xml={"attribute": False, "name": "Deleted", "text": False, "unwrapped": False})
    """Whether the container is deleted."""
    version: Optional[str] = rest_field(xml={"attribute": False, "name": "Version", "text": False, "unwrapped": False})
...
class ContainerProperties(_model_base.Model):
    ...
    public_access: Optional[Union[str, "_models.PublicAccessType"]] = rest_field(
        name="publicAccess", xml={"attribute": False, "name": "PublicAccess", "text": False, "unwrapped": False}
    )
    ...
    has_legal_hold: Optional[bool] = rest_field(
        name="hasLegalHold", xml={"attribute": False, "name": "HasLegalHold", "text": False, "unwrapped": False}
    )
...
class CorsRule(_model_base.Model):
    ...
    allowed_origins: str = rest_field(
        name="allowedOrigins", xml={"attribute": False, "name": "AllowedOrigins", "text": False, "unwrapped": False}
    )
    """The allowed origins. Required."""
    allowed_methods: str = rest_field(
        name="allowedMethods", xml={"attribute": False, "name": "AllowedMethods", "text": False, "unwrapped": False}
    )
    """The allowed methods. Required."""
    allowed_headers: str = rest_field(
        name="allowedHeaders", xml={"attribute": False, "name": "AllowedHeaders", "text": False, "unwrapped": False}
    )
    """The allowed headers. Required."""
    exposed_headers: str = rest_field(
        name="exposedHeaders", xml={"attribute": False, "name": "ExposedHeaders", "text": False, "unwrapped": False}
    )
    """The exposed headers. Required."""
    max_age_in_seconds: int = rest_field(
        name="maxAgeInSeconds", xml={"attribute": False, "name": "MaxAgeInSeconds", "text": False, "unwrapped": False}
    )
...
class DelimitedTextConfiguration(_model_base.Model):
    ...
    column_separator: Optional[str] = rest_field(
        name="columnSeparator", xml={"attribute": False, "name": "ColumnSeparator", "text": False, "unwrapped": False}
    )
    """The string used to separate columns."""
    field_quote: Optional[str] = rest_field(
        name="fieldQuote", xml={"attribute": False, "name": "FieldQuote", "text": False, "unwrapped": False}
    )
    """The string used to quote a specific field."""
    record_separator: Optional[str] = rest_field(
        name="recordSeparator", xml={"attribute": False, "name": "RecordSeparator", "text": False, "unwrapped": False}
    )
    """The string used to separate records."""
    escape_char: Optional[str] = rest_field(
        name="escapeChar", xml={"attribute": False, "name": "EscapeChar", "text": False, "unwrapped": False}
    )
    """The string used to escape a quote character in a field."""
    headers_present: Optional[bool] = rest_field(
        name="headersPresent", xml={"attribute": False, "name": "HasHeaders", "text": False, "unwrapped": False}
    )
...
class FilterBlobItem(_model_base.Model):
    ...
    container_name: str = rest_field(
        name="containerName", xml={"attribute": False, "name": "ContainerName", "text": False, "unwrapped": False}
    )
    """The properties of the blob. Required."""
...
class FilterBlobSegment(_model_base.Model):
    ...
    :vartype blobs: ~azure.storage.blob.models.FilterBlobItem
    :ivar next_marker: The next marker of the blobs.
    :vartype next_marker: str
    """

    service_endpoint: str = rest_field(
        name="serviceEndpoint", xml={"attribute": True, "name": "ServiceEndpoint", "text": False, "unwrapped": False}
    )
    """The service endpoint. Required."""
    where: str = rest_field(xml={"attribute": False, "name": "Where", "text": False, "unwrapped": False})
    ...
    next_marker: Optional[str] = rest_field(
        name="nextMarker", xml={"attribute": False, "name": "NextMarker", "text": False, "unwrapped": False}
    )
...
class GeoReplication(_model_base.Model):
    ...
    """The status of the secondary location. Required. Known values are: \"live\", \"bootstrap\", and
     \"unavailable\"."""
    last_sync_time: str = rest_field(
        name="lastSyncTime", xml={"attribute": False, "name": "LastSyncTime", "text": False, "unwrapped": False}
    )
...
class ListBlobsFlatSegmentResponse(_model_base.Model):
    ...
    """The service endpoint. Required."""
    container_name: str = rest_field(
        name="containerName", xml={"attribute": True, "name": "ContainerName", "text": False, "unwrapped": False}
    )
    """The container name. Required."""
    prefix: Optional[str] = rest_field(xml={"attribute": False, "name": "Prefix", "text": False, "unwrapped": False})
    """The prefix of the blobs."""
    marker: Optional[str] = rest_field(xml={"attribute": False, "name": "Marker", "text": False, "unwrapped": False})
    """The marker of the blobs."""
    max_results: Optional[int] = rest_field(
        name="maxResults", xml={"attribute": False, "name": "MaxResults", "text": False, "unwrapped": False}
    )
    """The max results of the blobs."""
    segment: "_models.BlobFlatListSegment" = rest_field(
        xml={"attribute": False, "name": "segment", "text": False, "unwrapped": False}
    )
    """The blob segment. Required."""
    next_marker: Optional[str] = rest_field(
        name="nextMarker", xml={"attribute": False, "name": "NextMarker", "text": False, "unwrapped": False}
...
class ListContainersSegmentResponse(_model_base.Model):
    ...
    :vartype container_items: ~azure.storage.blob.models.ContainerItem
...
class Logging(_model_base.Model):
    ...
    version: str = rest_field(xml={"attribute": False, "name": "Version", "text": False, "unwrapped": False})
    """The version of the logging properties. Required."""
    delete: bool = rest_field(xml={"attribute": False, "name": "Delete", "text": False, "unwrapped": False})
    """Whether delete operation is logged. Required."""
    read: bool = rest_field(xml={"attribute": False, "name": "Read", "text": False, "unwrapped": False})
    """Whether read operation is logged. Required."""
    write: bool = rest_field(xml={"attribute": False, "name": "Write", "text": False, "unwrapped": False})
    """Whether write operation is logged. Required."""
    retention_policy: "_models.RetentionPolicy" = rest_field(
        name="retentionPolicy", xml={"attribute": False, "name": "RetentionPolicy", "text": False, "unwrapped": False}
    )
...
class Metrics(_model_base.Model):
    ...
    include_apis: Optional[bool] = rest_field(
        name="includeApis", xml={"attribute": False, "name": "IncludeAPIs", "text": False, "unwrapped": False}
    )
...
class PageList(_model_base.Model):
    ...
    :vartype page_range: ~azure.storage.blob.models.PageRange
    :ivar clear_range: The clear ranges.
    :vartype clear_range: ~azure.storage.blob.models.ClearRange
    ...
    page_range: Optional[List["_models.PageRange"]] = rest_field(
        name="pageRange",
        xml={"attribute": False, "itemsName": "PageRange", "name": "PageRange", "text": False, "unwrapped": False},
    )
    """The page ranges."""
    clear_range: Optional[List["_models.ClearRange"]] = rest_field(
        name="clearRange",
        xml={"attribute": False, "itemsName": "ClearRange", "name": "ClearRange", "text": False, "unwrapped": False},
    )
    """The clear ranges."""
    next_marker: Optional[str] = rest_field(
        name="nextMarker", xml={"attribute": False, "name": "NextMarker", "text": False, "unwrapped": False}
...
class QueryRequest(_model_base.Model):
    ...
    query_type: Union[str, "_models.QueryRequestType"] = rest_field(
        name="queryType", xml={"attribute": False, "name": "QueryType", "text": False, "unwrapped": False}
    )
    """Required. The type of the provided query expression. Required. \"SQL\""""
    expression: str = rest_field(xml={"attribute": False, "name": "Expression", "text": False, "unwrapped": False})
...
class RetentionPolicy(_model_base.Model):
    ...
    days: Optional[int] = rest_field(xml={"attribute": False, "name": "Days", "text": False, "unwrapped": False})
...
class SignedIdentifier(_model_base.Model):
    ...
    id: str = rest_field(xml={"attribute": False, "name": "Id", "text": False, "unwrapped": False})
    """The unique ID for the signed identifier. Required."""
    access_policy: "_models.AccessPolicy" = rest_field(
        name="accessPolicy", xml={"attribute": False, "name": "AccessPolicy", "text": False, "unwrapped": False}
    )
...
class StaticWebsite(_model_base.Model):
    ...
    index_document: Optional[str] = rest_field(
        name="indexDocument", xml={"attribute": False, "name": "IndexDocument", "text": False, "unwrapped": False}
    )
    """The index document."""
...
class StorageServiceProperties(_model_base.Model):
    ...
    :vartype cors: ~azure.storage.blob.models.CorsRule
    ...
    hour_metrics: Optional["_models.Metrics"] = rest_field(
        name="hourMetrics", xml={"attribute": False, "name": "HourMetrics", "text": False, "unwrapped": False}
    )
    """The hour metrics properties."""
    minute_metrics: Optional["_models.Metrics"] = rest_field(
        name="minuteMetrics", xml={"attribute": False, "name": "MinuteMetrics", "text": False, "unwrapped": False}
    )
    ...
    static_website: Optional["_models.StaticWebsite"] = rest_field(
        name="staticWebsite", xml={"attribute": False, "name": "StaticWebsite", "text": False, "unwrapped": False}
    )
...
class StorageServiceStats(_model_base.Model):
    ...
    geo_replication: Optional["_models.GeoReplication"] = rest_field(
        name="geoReplication", xml={"attribute": False, "name": "GeoReplication", "text": False, "unwrapped": False}
    )
...
class UserDelegationKey(_model_base.Model):
    ...
    signed_oid: str = rest_field(
        name="signedOid", xml={"attribute": False, "name": "SignedOid", "text": False, "unwrapped": False}
    )
    """The Azure Active Directory object ID in GUID format. Required."""
    signed_tid: str = rest_field(
        name="signedTid", xml={"attribute": False, "name": "SignedTid", "text": False, "unwrapped": False}
    )
    """The Azure Active Directory tenant ID in GUID format. Required."""
    signed_start: str = rest_field(
        name="signedStart", xml={"attribute": False, "name": "SignedStart", "text": False, "unwrapped": False}
    )
    """The date-time the key is active. Required."""
    signed_expiry: str = rest_field(
        name="signedExpiry", xml={"attribute": False, "name": "SignedExpiry", "text": False, "unwrapped": False}
    )
    """The date-time the key expires. Required."""
    signed_service: str = rest_field(
        name="signedService", xml={"attribute": False, "name": "SignedService", "text": False, "unwrapped": False}
    )
    """Abbreviation of the Azure Storage service that accepts the key. Required."""
    signed_version: str = rest_field(
        name="signedVersion", xml={"attribute": False, "name": "SignedVersion", "text": False, "unwrapped": False}
    )
