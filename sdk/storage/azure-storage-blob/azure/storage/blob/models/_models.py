...
class BlobItemInternal(_model_base.Model):
    ...
    :vartype blob_tags: ~azure.storage.blob.models.BlobTag
...
class BlobPropertiesInternal(_model_base.Model):  # pylint: disable=too-many-instance-attributes
...
class BlockLookupList(_model_base.Model):
    ...
    committed: List[str] = rest_field(xml={"name": "Committed", "unwrapped": True})
    """The committed blocks. Required."""
    uncommitted: List[str] = rest_field(xml={"name": "Uncommitted", "unwrapped": True})
    """The uncommitted blocks. Required."""
    latest: List[str] = rest_field(xml={"name": "Latest", "unwrapped": True})
...
class ContainerProperties(_model_base.Model):  # pylint: disable=too-many-instance-attributes
...
class DelimitedTextConfiguration(_model_base.Model):
    ...
    _xml = {"name": "DelimitedTextConfiguration"}
...
class JsonTextConfiguration(_model_base.Model):
    ...
    _xml = {"name": "JsonTextConfiguration"}
...
class Metrics(_model_base.Model):
    ...
    service_properties: Optional["_models.MetricsServiceProperties"] = rest_field(
        name="serviceProperties", xml={"name": "ServiceProperties"}
    )
...
class MetricsServiceProperties(_model_base.Model):
    ...
    hour_metrics: "_models.MetricsProperties" = rest_field(name="hourMetrics", xml={"name": "HourMetrics"})
    """The hour metrics properties. Required."""
    minute_metrics: "_models.MetricsProperties" = rest_field(name="minuteMetrics", xml={"name": "MinuteMetrics"})
...
class ParquetConfiguration(_model_base.Model):
    ...
    _xml = {"name": "ParquetConfiguration"}
...
class QueryFormat(_model_base.Model):
    ...
    parquet_configuration: Optional["_models.ParquetConfiguration"] = rest_field(
        name="parquetConfiguration", xml={"name": "ParquetConfiguration"}
    )
...
class QueryRequest(_model_base.Model):
    ...
    query_type: Union[str, "_models.QueryRequestTypeSqlOnly"] = rest_field(name="queryType", xml={"name": "QueryType"})
...
class RetentionPolicy(_model_base.Model):
    ...
    days: int = rest_field(xml={"name": "Days"})
    """The number of days to retain the logs. Required."""
    allow_permanent_delete: bool = rest_field(name="allowPermanentDelete", xml={"name": "AllowPermanentDelete"})
...
class StaticWebsite(_model_base.Model):
    ...
    """The index document."""
    error_document: Optional[str] = rest_field(name="errorDocument", xml={"name": "ErrorDocument"})
    """The error document."""
