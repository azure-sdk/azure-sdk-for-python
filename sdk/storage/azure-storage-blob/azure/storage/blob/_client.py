...
class BlobClient:
    ...
    def __init__(
        self, container_name: str, url: str, credential: Union[AzureKeyCredential, "TokenCredential"], **kwargs: Any
    ) -> None:
        _endpoint = "{url}"
        self._config = BlobClientConfiguration(container_name=container_name, url=url, credential=credential, **kwargs)
