...
from .._model_base import _deserialize_xml, _failsafe_deserialize, _get_element
...
def build_container_get_properties_request(
    container_name: str, *, timeout: Optional[int] = None, lease_id: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_container_submit_batch_request(
    container_name: str, *, content_length: int, timeout: Optional[int] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_container_get_account_info_request(
    container_name: str, *, timeout: Optional[int] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_blob_undelete_request(
    container_name: str, blob: str, *, timeout: Optional[int] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    **kwargs: Any
    ...
    if source_if_modified_since is not None:
        _headers["x-ms-source-if-modified-since"] = _SERIALIZER.header(
            "source_if_modified_since", source_if_modified_since, "str"
        )
    if source_if_unmodified_since is not None:
        _headers["x-ms-source-if-unmodified-since"] = _SERIALIZER.header(
            "source_if_unmodified_since", source_if_unmodified_since, "str"
        )
...
def build_blob_get_account_info_request(
    container_name: str, blob: str, *, timeout: Optional[int] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/{containerName}/{blob}?restype=account&comp=properties&blob"
    path_format_arguments = {
        "containerName": _SERIALIZER.url("container_name", container_name, "str"),
        "blob": _SERIALIZER.url("blob", blob, "str"),
    }
...
def build_blob_query_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/{containerName}/{blob}?comp=query"
    path_format_arguments = {
        "containerName": _SERIALIZER.url("container_name", container_name, "str"),
        "blob": _SERIALIZER.url("blob", blob, "str"),
    }
...
def build_blob_get_tags_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/{containerName}/{blob}?comp=tags"
    path_format_arguments = {
        "containerName": _SERIALIZER.url("container_name", container_name, "str"),
        "blob": _SERIALIZER.url("blob", blob, "str"),
    }
...
def build_page_blob_create_request(
    ...
    **kwargs: Any
    ...
    content_type: str = kwargs.pop("content_type")
    blob_type: Literal["PageBlob"] = kwargs.pop("blob_type")
    version: str = kwargs.pop("version", _headers.pop("x-ms-version", "2025-01-05"))
    accept = _headers.pop("Accept", "application/json")
...
def build_append_blob_create_request(
    ...
    **kwargs: Any
    ...
    content_type: str = kwargs.pop("content_type")
    blob_type: Literal["AppendBlob"] = kwargs.pop("blob_type")
    version: str = kwargs.pop("version", _headers.pop("x-ms-version", "2025-01-05"))
    accept = _headers.pop("Accept", "application/json")
...
def build_append_blob_append_block_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/{containerName}/{blob}?comp=appendblock"
    path_format_arguments = {
        "containerName": _SERIALIZER.url("container_name", container_name, "str"),
        "blob": _SERIALIZER.url("blob", blob, "str"),
    }
...
def build_append_blob_append_block_from_url_request(  # pylint: disable=name-too-long
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/{containerName}/{blob}?comp=appendblock&fromUrl"
    path_format_arguments = {
        "containerName": _SERIALIZER.url("container_name", container_name, "str"),
        "blob": _SERIALIZER.url("blob", blob, "str"),
    }
...
def build_append_blob_seal_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/{containerName}/{blob}?comp=seal"
    path_format_arguments = {
        "containerName": _SERIALIZER.url("container_name", container_name, "str"),
        "blob": _SERIALIZER.url("blob", blob, "str"),
    }
...
def build_block_blob_upload_request(
    ...
    **kwargs: Any
    ...
    content_type: str = kwargs.pop("content_type")
    blob_type: Literal["BlockBlob"] = kwargs.pop("blob_type")
    version: str = kwargs.pop("version", _headers.pop("x-ms-version", "2025-01-05"))
    accept = _headers.pop("Accept", "application/json")
...
def build_block_blob_stage_block_from_url_request(  # pylint: disable=name-too-long
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/{containerName}/{blob}?comp=block&fromURL"
    path_format_arguments = {
        "containerName": _SERIALIZER.url("container_name", container_name, "str"),
        "blob": _SERIALIZER.url("blob", blob, "str"),
    }
...
def build_block_blob_commit_block_list_request(  # pylint: disable=name-too-long
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/{containerName}/{blob}?comp=blocklist"
    path_format_arguments = {
        "containerName": _SERIALIZER.url("container_name", container_name, "str"),
        "blob": _SERIALIZER.url("blob", blob, "str"),
    }
...
class ServiceOperations:
    ...
    def set_properties(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :paramtype cors: ~azure.storage.blob.models.CorsRule
