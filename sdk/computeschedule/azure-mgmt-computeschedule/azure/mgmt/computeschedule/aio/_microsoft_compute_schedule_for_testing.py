...
from ._configuration import MicrosoftComputeScheduleForTestingConfiguration
...
class MicrosoftComputeScheduleForTesting:  # pylint: disable=client-accepts-api-version-keyword
    """Microsoft.ComputeSchedule Resource Provider management API.

    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.computeschedule.aio.operations.Operations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = MicrosoftComputeScheduleForTestingConfiguration(
