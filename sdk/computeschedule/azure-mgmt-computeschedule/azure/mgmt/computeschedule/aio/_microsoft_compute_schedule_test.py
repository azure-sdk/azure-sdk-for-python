...
from ._configuration import MicrosoftComputeScheduleTestConfiguration
...
class MicrosoftComputeScheduleTest:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = MicrosoftComputeScheduleTestConfiguration(
