...
def build_scheduled_actions_virtual_machines_submit_create_request(  # pylint: disable=name-too-long
    locationparameter: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/providers/Microsoft.ComputeSchedule/locations/{locationparameter}/virtualMachinesSubmitCreate"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "locationparameter": _SERIALIZER.url("locationparameter", locationparameter, "str"),
    }
...
def build_scheduled_actions_virtual_machines_submit_delete_request(  # pylint: disable=name-too-long
    locationparameter: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/providers/Microsoft.ComputeSchedule/locations/{locationparameter}/virtualMachinesSubmitDelete"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "locationparameter": _SERIALIZER.url("locationparameter", locationparameter, "str"),
    }
...
class ScheduledActionsOperations:
    ...
    @overload
    def virtual_machines_submit_create(
        self,
        locationparameter: str,
        request_body: _models.SubmitCreateRequest,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.CreateResourceOperationResponse:
        """VirtualMachinesSubmitCreate: submit create operation for a batch of virtual machines, at
        datetime in future.

        :param locationparameter: The location name. Required.
        :type locationparameter: str
        :param request_body: The request body. Required.
        :type request_body: ~azure.mgmt.computeschedule.models.SubmitCreateRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: CreateResourceOperationResponse. The CreateResourceOperationResponse is compatible
    ...
    def virtual_machines_submit_create(
        self, locationparameter: str, request_body: Union[_models.SubmitCreateRequest, JSON, IO[bytes]], **kwargs: Any
    ) -> _models.CreateResourceOperationResponse:
        """VirtualMachinesSubmitCreate: submit create operation for a batch of virtual machines, at
        datetime in future.
        ...
        :param locationparameter: The location name. Required.
        :type locationparameter: str
        :param request_body: The request body. Is one of the following types: SubmitCreateRequest,
         JSON, IO[bytes] Required.
        :type request_body: ~azure.mgmt.computeschedule.models.SubmitCreateRequest or JSON or IO[bytes]
        :return: CreateResourceOperationResponse. The CreateResourceOperationResponse is compatible
         with MutableMapping
        :rtype: ~azure.mgmt.computeschedule.models.CreateResourceOperationResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        _request = build_scheduled_actions_virtual_machines_submit_create_request(
            locationparameter=locationparameter,
            subscription_id=self._config.subscription_id,
            content_type=content_type,
            api_version=self._config.api_version,
    ...
    @overload
    def virtual_machines_submit_delete(
        self,
        locationparameter: str,
        request_body: _models.SubmitDeleteRequest,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.DeleteResourceOperationResponse:
        """VirtualMachinesSubmitDelete: submit delete operation for a batch of virtual machines, at
        datetime in future.

        :param locationparameter: The location name. Required.
        :type locationparameter: str
        :param request_body: The request body. Required.
        :type request_body: ~azure.mgmt.computeschedule.models.SubmitDeleteRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: DeleteResourceOperationResponse. The DeleteResourceOperationResponse is compatible
    ...
    def virtual_machines_submit_delete(
        self, locationparameter: str, request_body: Union[_models.SubmitDeleteRequest, JSON, IO[bytes]], **kwargs: Any
    ) -> _models.DeleteResourceOperationResponse:
        """VirtualMachinesSubmitDelete: submit delete operation for a batch of virtual machines, at
        datetime in future.
        ...
        :param locationparameter: The location name. Required.
        :type locationparameter: str
        :param request_body: The request body. Is one of the following types: SubmitDeleteRequest,
         JSON, IO[bytes] Required.
        :type request_body: ~azure.mgmt.computeschedule.models.SubmitDeleteRequest or JSON or IO[bytes]
        :return: DeleteResourceOperationResponse. The DeleteResourceOperationResponse is compatible
         with MutableMapping
        :rtype: ~azure.mgmt.computeschedule.models.DeleteResourceOperationResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        _request = build_scheduled_actions_virtual_machines_submit_delete_request(
            locationparameter=locationparameter,
            subscription_id=self._config.subscription_id,
            content_type=content_type,
            api_version=self._config.api_version,
