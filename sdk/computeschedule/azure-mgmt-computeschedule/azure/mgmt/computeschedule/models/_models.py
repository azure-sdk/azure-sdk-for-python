...
class OperationErrorDetails(_model_base.Model):
    ...
    :ivar timestamp: The timestamp of the error occurence. Required.
    ...
    azure_operation_name: str = rest_field(name="azureOperationName")
    """The compute operationid of the Start/Deallocate/Hibernate request. Required."""
...
class Schedule(_model_base.Model):
    ...
    :ivar deadline: The deadline for the operation. Required.
    :vartype deadline: ~datetime.datetime
    :ivar timezone: The timezone for the operation. Required.
    :vartype timezone: str
