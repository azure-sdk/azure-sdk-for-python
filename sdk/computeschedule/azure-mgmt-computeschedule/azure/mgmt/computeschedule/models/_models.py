...
class ResourceProvisionPayload(_Model):
    ...
    base_profile: Optional[bytes] = rest_field(
        name="baseProfile", visibility=["read", "create", "update", "delete", "query"], format="base64"
    )
    """baseProfile, Resource properties that common across all resources."""
    resource_overrides: Optional[List[bytes]] = rest_field(
        name="resourceOverrides", visibility=["read", "create", "update", "delete", "query"], format="base64"
    )
    ...
    def __init__(
        ...
        *,
        resource_count: int,
        base_profile: Optional[bytes] = None,
        resource_overrides: Optional[List[bytes]] = None,
