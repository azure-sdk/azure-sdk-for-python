...
# USAGE
    python scheduled_actions_virtual_machines_submit_delete_minimum_set_gen.py
...
def main():
    ...
    response = client.scheduled_actions.virtual_machines_submit_delete(
        locationparameter="qtxgqgslyhbqmxbncupmychhpvur",
        request_body={
            "executionParameters": {},
            "resources": {
                "ids": [
