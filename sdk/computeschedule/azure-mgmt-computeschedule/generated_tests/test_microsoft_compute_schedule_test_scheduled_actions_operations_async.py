...
# --------------------------------------------------------------------------
import pytest
from azure.mgmt.computeschedule.aio import MicrosoftComputeScheduleTest
...
class TestMicrosoftComputeScheduleTestScheduledActionsOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(MicrosoftComputeScheduleTest, is_async=True)
