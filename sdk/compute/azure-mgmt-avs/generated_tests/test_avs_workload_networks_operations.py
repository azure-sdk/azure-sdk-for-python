...
class TestAVSWorkloadNetworksOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_begin_create_segment(self, resource_group):
        response = self.client.workload_networks.begin_create_segment(
            resource_group_name=resource_group.name,
            private_cloud_name="str",
            workload_network_name="str",
            segment_id="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_begin_update_segment(self, resource_group):
        response = self.client.workload_networks.begin_update_segment(
            resource_group_name=resource_group.name,
            private_cloud_name="str",
            workload_network_name="str",
            segment_id="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_list_v_m_groups(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_get_v_m_group(self, resource_group):
        response = self.client.workload_networks.get_v_m_group(
            resource_group_name=resource_group.name,
            private_cloud_name="str",
            workload_network_name="str",
            vm_group_id="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_begin_create_v_m_group(self, resource_group):
        response = self.client.workload_networks.begin_create_v_m_group(
            resource_group_name=resource_group.name,
            private_cloud_name="str",
            workload_network_name="str",
            vm_group_id="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_begin_update_v_m_group(self, resource_group):
        response = self.client.workload_networks.begin_update_v_m_group(
            resource_group_name=resource_group.name,
            private_cloud_name="str",
            workload_network_name="str",
            vm_group_id="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_begin_delete_v_m_group(self, resource_group):
        response = self.client.workload_networks.begin_delete_v_m_group(
            resource_group_name=resource_group.name,
            vm_group_id="str",
            private_cloud_name="str",
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_list_public_i_ps(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_get_public_i_p(self, resource_group):
        response = self.client.workload_networks.get_public_i_p(
            resource_group_name=resource_group.name,
            private_cloud_name="str",
            workload_network_name="str",
            public_i_p_id="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_begin_create_public_i_p(self, resource_group):
        response = self.client.workload_networks.begin_create_public_i_p(
            resource_group_name=resource_group.name,
            private_cloud_name="str",
            workload_network_name="str",
            public_i_p_id="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_begin_delete_public_i_p(self, resource_group):
        response = self.client.workload_networks.begin_delete_public_i_p(
            resource_group_name=resource_group.name,
            public_i_p_id="str",
            private_cloud_name="str",
        ).result()  # call '.result()' to poll until service return final result
