...
class AVSClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype workload_network_segments:
     azure.mgmt.avs.aio.operations.WorkloadNetworkSegmentsOperations
    ...
    :vartype workload_network_dhcp_configurations:
     azure.mgmt.avs.aio.operations.WorkloadNetworkDhcpConfigurationsOperations
    :ivar workload_network_gateways: WorkloadNetworkGatewaysOperations operations
    :vartype workload_network_gateways:
     azure.mgmt.avs.aio.operations.WorkloadNetworkGatewaysOperations
    ...
    :vartype workload_network_port_mirroring_profiles:
     azure.mgmt.avs.aio.operations.WorkloadNetworkPortMirroringProfilesOperations
    :ivar workload_network_vm_groups: WorkloadNetworkVmGroupsOperations operations
    :vartype workload_network_vm_groups:
     azure.mgmt.avs.aio.operations.WorkloadNetworkVmGroupsOperations
