...
from ...operations._pure_storage_policies_operations import (
...
class PureStoragePoliciesOperations:
    ...
    ) -> AsyncIterable["_models.PureStoragePolicy"]:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either PureStoragePolicy or the result of
         cls(response)
