...
from ...operations._hosts_operations import build_get_request, build_list_request
...
class HostsOperations:
    ...
    def list(
        ...
        cls: ClsType[_models.HostListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("HostListResult", pipeline_response)
    ...
    async def get(
        ...
        deserialized = self._deserialize("Host", pipeline_response.http_response)
