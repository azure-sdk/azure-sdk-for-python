...
from ._models_py3 import AzureResourceManagerCommonTypesSku
from ._models_py3 import AzureResourceManagerCommonTypesSystemAssignedServiceIdentity
...
__all__ = [
    ...
    "AzureResourceManagerCommonTypesSku",
