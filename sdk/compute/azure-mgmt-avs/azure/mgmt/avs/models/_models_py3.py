...
class Cluster(ProxyResource):  # pylint: disable=too-many-instance-attributes
    """A cluster resource.
...
class PrivateCloudUpdate(_serialization.Model):  # pylint: disable=too-many-instance-attributes
