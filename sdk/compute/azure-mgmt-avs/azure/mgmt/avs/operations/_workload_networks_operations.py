...
class WorkloadNetworksOperations:  # pylint: disable=too-many-public-methods
    ...
    def _update_dhcp_initial(
        ...
        private_cloud_name: str,
        dhcp_id: str,
        workload_network_dhcp: Union[_models.WorkloadNetworkDhcpUpdate, IO[bytes]],
        **kwargs: Any
    ...
    def begin_update_dhcp(
        ...
        **kwargs: Any
        ...
        :param workload_network_dhcp: The resource properties to be updated. Is either a
         WorkloadNetworkDhcpUpdate type or a IO[bytes] type. Required.
        :type workload_network_dhcp: ~azure.mgmt.avs.models.WorkloadNetworkDhcpUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either WorkloadNetworkDhcp or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.avs.models.WorkloadNetworkDhcp]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _update_dns_service_initial(
        ...
        private_cloud_name: str,
        dns_service_id: str,
        workload_network_dns_service: Union[_models.WorkloadNetworkDnsServiceUpdate, IO[bytes]],
        **kwargs: Any
    ...
    def begin_update_dns_service(
        ...
        **kwargs: Any
        ...
        :param workload_network_dns_service: The resource properties to be updated. Is either a
         WorkloadNetworkDnsServiceUpdate type or a IO[bytes] type. Required.
    ...
    def _update_dns_zone_initial(
        ...
        private_cloud_name: str,
        dns_zone_id: str,
        workload_network_dns_zone: Union[_models.WorkloadNetworkDnsZoneUpdate, IO[bytes]],
        **kwargs: Any
    ...
    def begin_update_dns_zone(
        ...
        **kwargs: Any
        ...
        :param workload_network_dns_zone: The resource properties to be updated. Is either a
         WorkloadNetworkDnsZoneUpdate type or a IO[bytes] type. Required.
        :type workload_network_dns_zone: ~azure.mgmt.avs.models.WorkloadNetworkDnsZoneUpdate or
         IO[bytes]
        :return: An instance of LROPoller that returns either WorkloadNetworkDnsZone or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.avs.models.WorkloadNetworkDnsZone]
    ...
    def _update_port_mirroring_initial(
        ...
        private_cloud_name: str,
        port_mirroring_id: str,
        workload_network_port_mirroring: Union[_models.WorkloadNetworkPortMirroringUpdate, IO[bytes]],
        **kwargs: Any
    ...
    def begin_update_port_mirroring(
        ...
        **kwargs: Any
        ...
        :param workload_network_port_mirroring: The resource properties to be updated. Is either a
         WorkloadNetworkPortMirroringUpdate type or a IO[bytes] type. Required.
        :type workload_network_port_mirroring:
         ~azure.mgmt.avs.models.WorkloadNetworkPortMirroringUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either WorkloadNetworkPortMirroring or the
         result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.avs.models.WorkloadNetworkPortMirroring]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _update_segments_initial(
        ...
        private_cloud_name: str,
        segment_id: str,
        workload_network_segment: Union[_models.WorkloadNetworkSegmentUpdate, IO[bytes]],
        **kwargs: Any
    ...
    def begin_update_segments(
        ...
        **kwargs: Any
        ...
        :param workload_network_segment: The resource properties to be updated. Is either a
         WorkloadNetworkSegmentUpdate type or a IO[bytes] type. Required.
        :type workload_network_segment: ~azure.mgmt.avs.models.WorkloadNetworkSegmentUpdate or
         IO[bytes]
        :return: An instance of LROPoller that returns either WorkloadNetworkSegment or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.avs.models.WorkloadNetworkSegment]
    ...
    def _update_vm_group_initial(
        ...
        private_cloud_name: str,
        vm_group_id: str,
        workload_network_vm_group: Union[_models.WorkloadNetworkVMGroupUpdate, IO[bytes]],
        **kwargs: Any
    ...
    def begin_update_vm_group(
        ...
        **kwargs: Any
        ...
        :param workload_network_vm_group: The resource properties to be updated. Is either a
         WorkloadNetworkVMGroupUpdate type or a IO[bytes] type. Required.
        :type workload_network_vm_group: ~azure.mgmt.avs.models.WorkloadNetworkVMGroupUpdate or
         IO[bytes]
        :return: An instance of LROPoller that returns either WorkloadNetworkVMGroup or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.avs.models.WorkloadNetworkVMGroup]
