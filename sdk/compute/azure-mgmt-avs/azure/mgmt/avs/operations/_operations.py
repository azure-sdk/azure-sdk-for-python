...
def build_locations_check_trial_availability_request(  # pylint: disable=name-too-long
    location: str, subscription_id: str, *, api_version: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_private_clouds_list_request(
...
def build_private_clouds_get_request(
    resource_group_name: str, private_cloud_name: str, subscription_id: str, *, api_version: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_workload_networks_list_v_m_groups_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    private_cloud_name: str,
    workload_network_name: str,
    subscription_id: str,
...
def build_workload_networks_get_v_m_group_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    private_cloud_name: str,
    workload_network_name: str,
    vm_group_id: str,
...
def build_workload_networks_create_v_m_group_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    private_cloud_name: str,
    workload_network_name: str,
    vm_group_id: str,
...
def build_workload_networks_update_v_m_group_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    private_cloud_name: str,
    workload_network_name: str,
    vm_group_id: str,
...
def build_workload_networks_delete_v_m_group_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    vm_group_id: str,
    private_cloud_name: str,
    subscription_id: str,
...
def build_workload_networks_get_public_i_p_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    private_cloud_name: str,
    workload_network_name: str,
    public_i_p_id: str,
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "privateCloudName": _SERIALIZER.url("private_cloud_name", private_cloud_name, "str"),
        "workloadNetworkName": _SERIALIZER.url("workload_network_name", workload_network_name, "str"),
        "publicIPId": _SERIALIZER.url("public_i_p_id", public_i_p_id, "str"),
    }
...
def build_workload_networks_create_public_i_p_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    private_cloud_name: str,
    workload_network_name: str,
    public_i_p_id: str,
...
def build_workload_networks_delete_public_i_p_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    public_i_p_id: str,
    private_cloud_name: str,
    subscription_id: str,
...
class WorkloadNetworksOperations:  # pylint: disable=too-many-public-methods
    ...
    def begin_create_v_m_group(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._create_v_m_group_initial(
                resource_group_name=resource_group_name,
                private_cloud_name=private_cloud_name,
                workload_network_name=workload_network_name,
                vm_group_id=vm_group_id,
    ...
    def begin_update_v_m_group(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._update_v_m_group_initial(
                resource_group_name=resource_group_name,
                private_cloud_name=private_cloud_name,
                workload_network_name=workload_network_name,
                vm_group_id=vm_group_id,
    ...
    def begin_delete_v_m_group(
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._delete_v_m_group_initial(
                resource_group_name=resource_group_name,
                vm_group_id=vm_group_id,
                private_cloud_name=private_cloud_name,
                cls=lambda x, y, z: x,
    ...
    def _create_public_i_p_initial(
        self,
        resource_group_name: str,
        private_cloud_name: str,
        workload_network_name: str,
    ...
    def begin_create_public_i_p(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._create_public_i_p_initial(
                resource_group_name=resource_group_name,
                private_cloud_name=private_cloud_name,
                workload_network_name=workload_network_name,
                public_i_p_id=public_i_p_id,
    ...
    def _delete_public_i_p_initial(
    ...
    def begin_delete_public_i_p(
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._delete_public_i_p_initial(
                resource_group_name=resource_group_name,
                public_i_p_id=public_i_p_id,
                private_cloud_name=private_cloud_name,
                cls=lambda x, y, z: x,
