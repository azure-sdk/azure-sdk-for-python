...
class TestComputeManagementDiskEncryptionSetsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_begin_create_or_update(self, resource_group):
        response = await (await self.client.disk_encryption_sets.begin_create_or_update(
...
,
    ...
    async def test_begin_update(self, resource_group):
        response = await (await self.client.disk_encryption_sets.begin_update(
            resource_group_name=resource_group.name,
            disk_encryption_set_name="str"
,
            disk_encryption_set={
...
,
    ...
    async def test_begin_delete(self, resource_group):
        response = await (await self.client.disk_encryption_sets.begin_delete(
            resource_group_name=resource_group.name,
            disk_encryption_set_name="str"
,
            api_version="2024-03-02"
