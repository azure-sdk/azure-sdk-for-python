...
class TestComputeManagementDisksOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_begin_create_or_update(self, resource_group):
        response = await (await self.client.disks.begin_create_or_update(
...
,
    ...
    async def test_begin_update(self, resource_group):
        response = await (await self.client.disks.begin_update(
            resource_group_name=resource_group.name,
            disk_name="str"
,
            disk={
...
,
    ...
    async def test_begin_delete(self, resource_group):
        response = await (await self.client.disks.begin_delete(
            resource_group_name=resource_group.name,
            disk_name="str"
,
            api_version="2024-03-02"
...
,
    ...
    async def test_begin_grant_access(self, resource_group):
        response = await (await self.client.disks.begin_grant_access(
            resource_group_name=resource_group.name,
            disk_name="str"
,
            grant_access_data={
...
,
    ...
    async def test_begin_revoke_access(self, resource_group):
        response = await (await self.client.disks.begin_revoke_access(
            resource_group_name=resource_group.name,
            disk_name="str"
,
            api_version="2024-03-02"
