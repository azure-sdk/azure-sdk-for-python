...
class AttachDataDisk(_serialization.Model):
...
class AttachDetachDataDisksRequest(_serialization.Model):
    ...
    :ivar attach_data_disks: The list of managed data disks to be attached.
    :vartype attach_data_disks: list[~azure.mgmt.compute.v2023_07_01.models.AttachDataDisk]
    :ivar detach_data_disks: The list of managed data disks to be detached.
    :vartype detach_data_disks: list[~azure.mgmt.compute.v2023_07_01.models.DetachDataDisk]
    """

    _validation = {
        "attach_data_disks": {"min_items": 1},
        "detach_data_disks": {"min_items": 1},
    }

    _attribute_map = {
        "attach_data_disks": {"key": "attachDataDisks", "type": "[AttachDataDisk]"},
        "detach_data_disks": {"key": "detachDataDisks", "type": "[DetachDataDisk]"},
    }

    def __init__(
        self,
        *,
        attach_data_disks: Optional[List["_models.AttachDataDisk"]] = None,
        detach_data_disks: Optional[List["_models.DetachDataDisk"]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword attach_data_disks: The list of managed data disks to be attached.
        :paramtype attach_data_disks: list[~azure.mgmt.compute.v2023_07_01.models.AttachDataDisk]
        :keyword detach_data_disks: The list of managed data disks to be detached.
        :paramtype detach_data_disks: list[~azure.mgmt.compute.v2023_07_01.models.DetachDataDisk]
        """
        super().__init__(**kwargs)
        self.attach_data_disks = attach_data_disks
        self.detach_data_disks = detach_data_disks
...
class DetachDataDisk(_serialization.Model):
