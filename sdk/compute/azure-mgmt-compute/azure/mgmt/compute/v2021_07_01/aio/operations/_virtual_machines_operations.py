...
class VirtualMachinesOperations:  # pylint: disable=too-many-public-methods
    ...
    def list_by_location(self, location: str, **kwargs: Any) -> AsyncIterable["_models.VirtualMachine"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2021_07_01.models.VirtualMachine]
    ...
    async def begin_capture(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.compute.v2021_07_01.models.VirtualMachineCaptureParameters or IO
    ...
    async def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.compute.v2021_07_01.models.VirtualMachine or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_update(
        ...
        :type parameters: ~azure.mgmt.compute.v2021_07_01.models.VirtualMachineUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_available_sizes(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2021_07_01.models.VirtualMachineSize]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def begin_reimage(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.compute.v2021_07_01.models.VirtualMachineReimageParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_install_patches(
        ...
        **kwargs: Any
        ...
        :type install_patches_input:
         ~azure.mgmt.compute.v2021_07_01.models.VirtualMachineInstallPatchesParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_run_command(
        ...
        :type parameters: ~azure.mgmt.compute.v2021_07_01.models.RunCommandInput or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json',
