...
class GalleryApplication(Resource):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.provisioning_state: Optional[Union[str, "_models.GalleryApplicationPropertiesProvisioningState"]] = None
...
class SharingProfile(_serialization.Model):
    ...
    def __init__(
        self, *, permissions: Optional[Union[str, "_models.GallerySharingPermissionTypes"]] = None, **kwargs: Any
    ) -> None:
        """
...
class SharingUpdate(_serialization.Model):
    ...
    :ivar operation_type: This property allows you to specify the operation type of gallery sharing
     ...
     values are: "Add", "Remove", and "Reset".
    ...
    def __init__(
        ...
        **kwargs: Any
         ...
         **Add** :code:`<br>`\\ :code:`<br>` **Remove** :code:`<br>`\\ :code:`<br>` **Reset**. Required.
         Known values are: "Add", "Remove", and "Reset".
