...
class LifecycleHook(_serialization.Model):
    """Describes a lifecycle hook.

    :ivar type: Specifies the type of the lifecycle hook.
    :vartype type: str
    :ivar wait_duration: Specifies the wait duration for the lifecycle hook.
    :vartype wait_duration: str
    :ivar default_action: Specifies the default action for the lifecycle hook. "Approve"
    :vartype default_action: str or ~azure.mgmt.compute.v2024_11_01.models.LifecycleHookAction
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword type: Specifies the type of the lifecycle hook.
        :paramtype type: str
        :keyword wait_duration: Specifies the wait duration for the lifecycle hook.
        :paramtype wait_duration: str
        :keyword default_action: Specifies the default action for the lifecycle hook. "Approve"
        :paramtype default_action: str or ~azure.mgmt.compute.v2024_11_01.models.LifecycleHookAction
        """
        super().__init__(**kwargs)
        self.type = type
...
class LifecycleHooksProfile(_serialization.Model):
    """Specifies the lifecycle hooks profile for the virtual machine scale set.

    :ivar lifecycle_hooks: Specifies the lifecycle hooks for the virtual machine scale set.
    :vartype lifecycle_hooks: list[~azure.mgmt.compute.v2024_11_01.models.LifecycleHook]
    """

    _attribute_map = {
        "lifecycle_hooks": {"key": "lifecycleHooks", "type": "[LifecycleHook]"},
    }

    def __init__(self, *, lifecycle_hooks: Optional[List["_models.LifecycleHook"]] = None, **kwargs: Any) -> None:
        """
        :keyword lifecycle_hooks: Specifies the lifecycle hooks for the virtual machine scale set.
        :paramtype lifecycle_hooks: list[~azure.mgmt.compute.v2024_11_01.models.LifecycleHook]
        """
        super().__init__(**kwargs)
...
class VirtualMachineScaleSet(Resource):
    ...
    :ivar lifecycle_hooks_profile: Specifies the lifecycle hooks profile for the virtual machine
     scale set.
    :vartype lifecycle_hooks_profile: ~azure.mgmt.compute.v2024_11_01.models.LifecycleHooksProfile
    """
    ...
    _attribute_map = {
        ...
        "lifecycle_hooks_profile": {"key": "properties.lifecycleHooksProfile", "type": "LifecycleHooksProfile"},
    }
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :keyword lifecycle_hooks_profile: Specifies the lifecycle hooks profile for the virtual machine
         scale set.
        :paramtype lifecycle_hooks_profile:
         ~azure.mgmt.compute.v2024_11_01.models.LifecycleHooksProfile
        """
        super().__init__(location=location, tags=tags, **kwargs)
        self.sku = sku
        self.plan = plan
        ...
        self.lifecycle_hooks_profile = lifecycle_hooks_profile
