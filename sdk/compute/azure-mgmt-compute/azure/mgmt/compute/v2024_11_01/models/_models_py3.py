...
class ErrorDetail(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.compute.v2024_11_01.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info: list[~azure.mgmt.compute.v2024_11_01.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(_serialization.Model):
    ...
    :vartype error: ~azure.mgmt.compute.v2024_11_01.models.ErrorDetail
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetail"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~azure.mgmt.compute.v2024_11_01.models.ErrorDetail
        """
        super().__init__(**kwargs)
        self.error = error
...
class VirtualMachineImagesWithPropertiesListResult(_serialization.Model):  # pylint: disable=name-too-long
    ...
    :ivar value: The VirtualMachineImage items on this page.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword value: The VirtualMachineImage items on this page.
...
class VirtualMachineScaleSetExtension(SubResourceReadOnly):
    ...
    _attribute_map = {
        "id": {"key": "id", "type": "str"},
        "vm_type": {"key": "type", "type": "str"},
        "vm_name": {"key": "name", "type": "str"},
        "force_update_tag": {"key": "properties.forceUpdateTag", "type": "str"},
        "publisher": {"key": "properties.publisher", "type": "str"},
        "type": {"key": "properties.type", "type": "str"},
        "type_handler_version": {"key": "properties.typeHandlerVersion", "type": "str"},
...
class VirtualMachineScaleSetStorageProfile(_serialization.Model):
    ...
    :ivar disk_controller_type: Specifies the disk controller type configured for the VM and
     VirtualMachineScaleSet. This property is only supported for virtual machines whose operating
     system disk and VM sku supports Generation 2
     (https://docs.microsoft.com/en-us/azure/virtual-machines/generation-2), please check the
     ...
     Disk Controller Types supported please refer to https://aka.ms/azure-diskcontrollertypes. Known
     values are: "SCSI" and "NVMe".
    :vartype disk_controller_type: str or
     ~azure.mgmt.compute.v2024_11_01.models.DiskControllerTypes
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype data_disks:
         list[~azure.mgmt.compute.v2024_11_01.models.VirtualMachineScaleSetDataDisk]
        :keyword disk_controller_type: Specifies the disk controller type configured for the VM and
         VirtualMachineScaleSet. This property is only supported for virtual machines whose operating
         system disk and VM sku supports Generation 2
         (https://docs.microsoft.com/en-us/azure/virtual-machines/generation-2), please check the
         HyperVGenerations capability returned as part of VM sku capabilities in the response of
