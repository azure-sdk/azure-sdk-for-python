...
class ApiError(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.compute.v2021_12_01.models.ApiErrorBase]
    :ivar innererror: The Api inner error.
    :vartype innererror: ~azure.mgmt.compute.v2021_12_01.models.InnerError
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype details: list[~azure.mgmt.compute.v2021_12_01.models.ApiErrorBase]
        :keyword innererror: The Api inner error.
        :paramtype innererror: ~azure.mgmt.compute.v2021_12_01.models.InnerError
...
class CreationData(_serialization.Model):
    ...
    :vartype image_reference: ~azure.mgmt.compute.v2021_12_01.models.ImageDiskReference
    :ivar gallery_image_reference: Required if creating from a Gallery Image. The id of the
     ...
     disk.
    :vartype gallery_image_reference: ~azure.mgmt.compute.v2021_12_01.models.ImageDiskReference
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype image_reference: ~azure.mgmt.compute.v2021_12_01.models.ImageDiskReference
        :keyword gallery_image_reference: Required if creating from a Gallery Image. The id of the
         ImageDiskReference will be the ARM id of the shared galley image version from which to create a
         disk.
        :paramtype gallery_image_reference: ~azure.mgmt.compute.v2021_12_01.models.ImageDiskReference
...
class Disk(Resource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar purchase_plan: Purchase plan information for the the image from which the OS disk was
     ...
     WindowsServer}.
    :vartype purchase_plan: ~azure.mgmt.compute.v2021_12_01.models.PurchasePlan
    :ivar supported_capabilities: List of supported capabilities for the image from which the OS
     disk was created.
    :vartype supported_capabilities: ~azure.mgmt.compute.v2021_12_01.models.SupportedCapabilities
    :ivar creation_data: Disk source information. CreationData information cannot be changed after
     the disk has been created.
    :vartype creation_data: ~azure.mgmt.compute.v2021_12_01.models.CreationData
    ...
    :vartype encryption_settings_collection:
     ~azure.mgmt.compute.v2021_12_01.models.EncryptionSettingsCollection
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :keyword purchase_plan: Purchase plan information for the the image from which the OS disk was
         created. E.g. - {name: 2019-Datacenter, publisher: MicrosoftWindowsServer, product:
         WindowsServer}.
        :paramtype purchase_plan: ~azure.mgmt.compute.v2021_12_01.models.PurchasePlan
        ...
        :paramtype creation_data: ~azure.mgmt.compute.v2021_12_01.models.CreationData
...
class DiskAccess(Resource):
    ...
    :vartype private_endpoint_connections:
     list[~azure.mgmt.compute.v2021_12_01.models.PrivateEndpointConnection]
...
class DiskAccessList(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.compute.v2021_12_01.models.DiskAccess]
    ...
    def __init__(self, *, value: List["_models.DiskAccess"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.compute.v2021_12_01.models.DiskAccess]
...
class DiskEncryptionSet(Resource):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype active_key: ~azure.mgmt.compute.v2021_12_01.models.KeyForDiskEncryptionSet
    :ivar previous_keys: A readonly collection of key vault keys previously used by this disk
     ...
     rotation.
    :vartype previous_keys: list[~azure.mgmt.compute.v2021_12_01.models.KeyForDiskEncryptionSet]
    ...
    :vartype auto_key_rotation_error: ~azure.mgmt.compute.v2021_12_01.models.ApiError
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype active_key: ~azure.mgmt.compute.v2021_12_01.models.KeyForDiskEncryptionSet
...
class DiskEncryptionSetList(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.compute.v2021_12_01.models.DiskEncryptionSet]
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.compute.v2021_12_01.models.DiskEncryptionSet]
...
class DiskList(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.compute.v2021_12_01.models.Disk]
    ...
    def __init__(self, *, value: List["_models.Disk"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.compute.v2021_12_01.models.Disk]
...
class DiskRestorePointList(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.compute.v2021_12_01.models.DiskRestorePoint]
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.compute.v2021_12_01.models.DiskRestorePoint]
...
class EncryptionSettingsCollection(_serialization.Model):
    ...
    :vartype encryption_settings:
     list[~azure.mgmt.compute.v2021_12_01.models.EncryptionSettingsElement]
...
class EncryptionSettingsElement(_serialization.Model):
    ...
    :vartype disk_encryption_key: ~azure.mgmt.compute.v2021_12_01.models.KeyVaultAndSecretReference
    ...
    :vartype key_encryption_key: ~azure.mgmt.compute.v2021_12_01.models.KeyVaultAndKeyReference
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype disk_encryption_key:
         ~azure.mgmt.compute.v2021_12_01.models.KeyVaultAndSecretReference
        :keyword key_encryption_key: Key Vault Key Url and vault id of the key encryption key.
         KeyEncryptionKey is optional and when provided is used to unwrap the disk encryption key.
        :paramtype key_encryption_key: ~azure.mgmt.compute.v2021_12_01.models.KeyVaultAndKeyReference
        """
        super().__init__(**kwargs)
...
class KeyForDiskEncryptionSet(_serialization.Model):
    ...
    :ivar source_vault: Resource id of the KeyVault containing the key or secret. This property is
     ...
     Set subscription.
    :vartype source_vault: ~azure.mgmt.compute.v2021_12_01.models.SourceVault
    ...
    def __init__(self, *, key_url: str, source_vault: Optional["_models.SourceVault"] = None, **kwargs: Any) -> None:
        ...
        :paramtype source_vault: ~azure.mgmt.compute.v2021_12_01.models.SourceVault
...
class PrivateEndpointConnection(_serialization.Model):
    ...
    :vartype private_endpoint: ~azure.mgmt.compute.v2021_12_01.models.PrivateEndpoint
...
class PrivateEndpointConnectionListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.compute.v2021_12_01.models.PrivateEndpointConnection]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype value: list[~azure.mgmt.compute.v2021_12_01.models.PrivateEndpointConnection]
...
class PrivateLinkResourceListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.compute.v2021_12_01.models.PrivateLinkResource]
    """
    ...
    def __init__(self, *, value: Optional[List["_models.PrivateLinkResource"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.compute.v2021_12_01.models.PrivateLinkResource]
        """
        super().__init__(**kwargs)
        self.value = value
...
class SnapshotList(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.compute.v2021_12_01.models.Snapshot]
    :ivar next_link: The uri to fetch the next page of snapshots. Call ListNext() with this to
     fetch the next page of snapshots.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: List["_models.Snapshot"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.compute.v2021_12_01.models.Snapshot]
        :keyword next_link: The uri to fetch the next page of snapshots. Call ListNext() with this to
         fetch the next page of snapshots.
        :paramtype next_link: str
        """
