...
# USAGE
    python gallery_in_vm_access_control_profile_version_list_by_gallery_in_vm_access_control_profile.py
...
def main():
    ...
    response = client.gallery_in_vm_access_control_profile_versions.list_by_gallery_in_vm_access_control_profile(
