...
class PatchSchedulesOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
    ) -> AsyncLROPoller[_models.RedisPatchSchedule]:
        ...
        :return: An instance of AsyncLROPoller that returns either RedisPatchSchedule or An instance of
         AsyncLROPoller that returns either RedisPatchScheduleWithProvisioningState or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.redis.models.RedisPatchSchedule] or
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.redis.models.RedisPatchScheduleWithProvisioningState]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
