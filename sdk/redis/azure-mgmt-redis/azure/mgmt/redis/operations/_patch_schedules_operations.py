...
class PatchSchedulesOperations:
    ...
    ) -> Iterable["_models.RedisPatchSchedule"]:
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
    ) -> Union[_models.RedisPatchSchedule, _models.RedisPatchScheduleWithProvisioningState]:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Union[_models.RedisPatchSchedule, _models.RedisPatchScheduleWithProvisioningState]] = kwargs.pop(
            "cls", None
        )
        ...
        if response.status_code == 201:
            ...
            deserialized = self._deserialize("RedisPatchScheduleWithProvisioningState", pipeline_response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
    ) -> LROPoller[_models.RedisPatchSchedule]:
        ...
        :return: An instance of LROPoller that returns either RedisPatchSchedule or An instance of
         LROPoller that returns either RedisPatchScheduleWithProvisioningState or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.redis.models.RedisPatchSchedule] or
         ~azure.core.polling.LROPoller[~azure.mgmt.redis.models.RedisPatchScheduleWithProvisioningState]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
