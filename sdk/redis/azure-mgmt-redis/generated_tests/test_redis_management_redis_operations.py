...
class TestRedisManagementRedisOperations(AzureMgmtRecordedTestCase):
    ...
    def test_check_name_availability(self, resource_group):
        response = self.client.redis.check_name_availability(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_list_upgrade_notifications(self, resource_group):
    ...
    def test_begin_create(self, resource_group):
        response = self.client.redis.begin_create(
            resource_group_name=resource_group.name,
            name="str",
            parameters={
                "location": "str",
    ...
    def test_begin_update(self, resource_group):
        response = self.client.redis.begin_update(
            resource_group_name=resource_group.name,
            name="str",
            parameters={
                "disableAccessKeyAuthentication": False,
    ...
    def test_begin_delete(self, resource_group):
        response = self.client.redis.begin_delete(
            resource_group_name=resource_group.name,
            name="str",
            api_version="2024-08-01",
        ).result()  # call '.result()' to poll until service return final result
    ...
    def test_get(self, resource_group):
        response = self.client.redis.get(
            resource_group_name=resource_group.name,
            name="str",
            api_version="2024-08-01",
        )
    ...
    def test_list_keys(self, resource_group):
        response = self.client.redis.list_keys(
            resource_group_name=resource_group.name,
            name="str",
            api_version="2024-08-01",
        )
    ...
    def test_regenerate_key(self, resource_group):
        response = self.client.redis.regenerate_key(
            resource_group_name=resource_group.name,
            name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_force_reboot(self, resource_group):
        response = self.client.redis.force_reboot(
            resource_group_name=resource_group.name,
            name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_begin_import_data(self, resource_group):
        response = self.client.redis.begin_import_data(
            resource_group_name=resource_group.name,
            name="str",
            parameters={
                "files": ["str"],
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_begin_export_data(self, resource_group):
        response = self.client.redis.begin_export_data(
            resource_group_name=resource_group.name,
            name="str",
            parameters={
                "container": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_begin_flush_cache(self, resource_group):
        response = self.client.redis.begin_flush_cache(
            resource_group_name=resource_group.name,
            cache_name="str",
            api_version="2024-08-01",
        ).result()  # call '.result()' to poll until service return final result
