...
from ...operations._operations import (
    ...
    build_models_get_chat_completions_request,
    build_models_get_embeddings_request,
    build_models_get_image_embeddings_request,
)
...
class AgentsOperations:  # pylint: disable=too-many-public-methods
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.ai.projects.1dp.aio.UnifiedClient`'s
...
class ConnectionsOperations:
    ...
    @distributed_trace_async
    async def get_with_credentials(self, connection_name: str, **kwargs: Any) -> _models.Connection:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :paramtype connection_category: str or ~azure.ai.projects.1dp.models.ConnectionCategory
        :keyword top: The number of result items to return. Default value is None.
        :paramtype top: int
        :keyword skip: The number of result items to skip. Default value is None.
        :paramtype skip: int
        :return: An iterator like instance of Connection
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.ai.projects.1dp.models.Connection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class EvaluationsOperations:
    ...
    def list(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.ai.projects.1dp.models.Evaluation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class DatasetsOperations:
    ...
    def list_latest_datasets(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.ai.projects.1dp.models.DatasetVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class ModelsOperations:
    ...
    async def get_chat_completions(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.ai.projects.1dp.models.ChatCompletionsOptions
        ...
        :paramtype extra_params: str or ~azure.ai.projects.1dp.models.ExtraParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ChatCompletions. The ChatCompletions is compatible with MutableMapping
        :rtype: ~azure.ai.projects.1dp.models.ChatCompletions
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get_chat_completions(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.ai.projects.1dp.models.ChatCompletionsOptions or JSON or IO[bytes]
        :keyword extra_params: Controls what happens if extra parameters, undefined by the REST API,
         are passed in the JSON request payload.
         This sets the HTTP request header ``extra-parameters``. Known values are: "error", "drop", and
         "pass-through". Default value is None.
    ...
    async def get_embeddings(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.ai.projects.1dp.models.EmbeddingsOptions
        :keyword extra_params: Controls what happens if extra parameters, undefined by the REST API,
         are passed in the JSON request payload.
         This sets the HTTP request header ``extra-parameters``. Known values are: "error", "drop", and
         "pass-through". Default value is None.
        ...
        :rtype: ~azure.ai.projects.1dp.models.EmbeddingsResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get_embeddings(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.ai.projects.1dp.models.EmbeddingsOptions or JSON or IO[bytes]
        :keyword extra_params: Controls what happens if extra parameters, undefined by the REST API,
         are passed in the JSON request payload.
         This sets the HTTP request header ``extra-parameters``. Known values are: "error", "drop", and
         "pass-through". Default value is None.
    ...
    async def get_image_embeddings(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.ai.projects.1dp.models.ImageEmbeddingsOptions
        :keyword extra_params: Controls what happens if extra parameters, undefined by the REST API,
         are passed in the JSON request payload.
         This sets the HTTP request header ``extra-parameters``. Known values are: "error", "drop", and
         "pass-through". Default value is None.
    ...
    async def get_image_embeddings(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.ai.projects.1dp.models.ImageEmbeddingsOptions or JSON or IO[bytes]
        :keyword extra_params: Controls what happens if extra parameters, undefined by the REST API,
         are passed in the JSON request payload.
         This sets the HTTP request header ``extra-parameters``. Known values are: "error", "drop", and
         "pass-through". Default value is None.
...
class IndexesOperations:
    ...
    def list_index_versions(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.ai.projects.1dp.models.Index]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class DeploymentsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.ai.projects.1dp.models.Deployment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
