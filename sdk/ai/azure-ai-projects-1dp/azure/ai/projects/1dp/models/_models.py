...
class AadCredential(BaseCredential, discriminator="AAD"):
    ...
    :ivar type: Required.
    :vartype type: str or ~azure.ai.projects.1dp.models.AAD
    """
...
class ApiKeyCredential(BaseCredential, discriminator="ApiKey"):
    ...
    :vartype api_key: str
    :ivar type: Required.
    :vartype type: str or ~azure.ai.projects.1dp.models.API_KEY
    """
...
class ChatChoice(_model_base.Model):
    ...
    :vartype finish_reason: str or ~azure.ai.projects.1dp.models.CompletionsFinishReason
    :ivar message: The chat message for a given chat completions prompt. Required.
    :vartype message: ~azure.ai.projects.1dp.models.ChatResponseMessage
    """
...
class ChatCompletions(_model_base.Model):
    ...
    :vartype choices: list[~azure.ai.projects.1dp.models.ChatChoice]
    :ivar usage:   Usage information for tokens processed and generated as part of this completions
     operation. Required.
    :vartype usage: ~azure.ai.projects.1dp.models.CompletionsUsage
    """
...
class ChatCompletionsAudio(_model_base.Model):
    ...
    :vartype format: str or ~azure.ai.projects.1dp.models.AudioContentFormat
...
class ChatCompletionsNamedToolChoice(_model_base.Model):
    ...
    :vartype function: ~azure.ai.projects.1dp.models.ChatCompletionsNamedToolChoiceFunction
    """
...
class ChatCompletionsOptions(_model_base.Model):
    ...
    :vartype messages: list[~azure.ai.projects.1dp.models.ChatRequestMessage]
    ...
    :vartype response_format: ~azure.ai.projects.1dp.models.ChatCompletionsResponseFormat
    ...
    :ivar tools: A list of tools the model may request to call. Currently, only functions are
     ...
     that function.
    :vartype tools: list[~azure.ai.projects.1dp.models.ChatCompletionsToolDefinition]
    ...
    :vartype tool_choice: str or ~azure.ai.projects.1dp.models.ChatCompletionsToolChoicePreset or
     ~azure.ai.projects.1dp.models.ChatCompletionsNamedToolChoice
    ...
    :vartype modalities: list[str or ~azure.ai.projects.1dp.models.ChatCompletionsModality]
    """
...
class ChatCompletionsResponseFormatJsonSchema(ChatCompletionsResponseFormat, discriminator="json_schema"):
    ...
    :ivar json_schema: The definition of the required JSON schema in the response, and associated
     metadata. Required.
    :vartype json_schema:
     ~azure.ai.projects.1dp.models.ChatCompletionsResponseFormatJsonSchemaDefinition
    """
...
class ChatCompletionsToolCall(_model_base.Model):
    ...
    :vartype function: ~azure.ai.projects.1dp.models.FunctionCall
    """
...
class ChatMessageAudioContentItem(ChatMessageContentItem, discriminator="audio_url"):
    ...
    :vartype audio_url: ~azure.ai.projects.1dp.models.ChatMessageAudioUrl
    """
...
class ChatMessageImageContentItem(ChatMessageContentItem, discriminator="image_url"):
    ...
    :vartype image_url: ~azure.ai.projects.1dp.models.ChatMessageImageUrl
    """
...
class ChatMessageImageUrl(_model_base.Model):
    ...
    :vartype detail: str or ~azure.ai.projects.1dp.models.ChatMessageImageDetailLevel
    """
...
class ChatRequestMessage(_model_base.Model):
    ...
    :vartype role: str or ~azure.ai.projects.1dp.models.ChatRole
    """
...
class ChatRequestAssistantMessage(ChatRequestMessage, discriminator="assistant"):
    ...
    :ivar role: The chat role associated with this message, which is always 'assistant' for
     ...
     user-prompted input.
    :vartype role: str or ~azure.ai.projects.1dp.models.ASSISTANT
    ...
    :vartype tool_calls: list[~azure.ai.projects.1dp.models.ChatCompletionsToolCall]
    :ivar audio:   The audio generated by a previous response in a multi-turn conversation.
    :vartype audio: ~azure.ai.projects.1dp.models.ChatRequestAudioReference
    """
...
class ChatRequestAudioReference(_model_base.Model):
    ...
    id: str = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """  Unique identifier for the audio response. This value corresponds to the id of a previous
     audio completion. Required."""
...
class ChatRequestSystemMessage(ChatRequestMessage, discriminator="system"):
    ...
    :vartype role: str or ~azure.ai.projects.1dp.models.SYSTEM
...
class ChatRequestToolMessage(ChatRequestMessage, discriminator="tool"):
    ...
    :ivar role: The chat role associated with this message, which is always 'tool' for tool
     ...
     operation.
    :vartype role: str or ~azure.ai.projects.1dp.models.TOOL
    :ivar content: The content of the message.
    :vartype content: str
...
class ChatRequestUserMessage(ChatRequestMessage, discriminator="user"):
    ...
    :vartype role: str or ~azure.ai.projects.1dp.models.USER
    ...
    :vartype content: str or list[~azure.ai.projects.1dp.models.ChatMessageContentItem]
    """
...
class ChatResponseMessage(_model_base.Model):
    ...
    :vartype audio: ~azure.ai.projects.1dp.models.ChatCompletionsAudio
    """
...
class CompletionsUsage(_model_base.Model):
    ...
    :vartype completion_tokens_details: ~azure.ai.projects.1dp.models.CompletionsUsageDetails
    :ivar prompt_tokens_details: Breakdown of tokens used in the prompt/chat history.
    :vartype prompt_tokens_details: ~azure.ai.projects.1dp.models.PromptUsageDetails
    """
...
class Connection(_model_base.Model):
    ...
    :vartype credentials: ~azure.ai.projects.1dp.models.BaseCredential
    ...
    :vartype category: str or ~azure.ai.projects.1dp.models.ConnectionCategory
...
class EmbeddingsOptions(_model_base.Model):
    ...
    :vartype encoding_format: str or ~azure.ai.projects.1dp.models.EmbeddingEncodingFormat
    ...
    :vartype input_type: str or ~azure.ai.projects.1dp.models.EmbeddingInputType
    :ivar model: ID of the specific AI model to use, if more than one model is available on the
     endpoint.
    :vartype model: str
    """
...
class EmbeddingsResult(_model_base.Model):
    ...
    :vartype data: list[~azure.ai.projects.1dp.models.EmbeddingItem]
    :ivar usage: Usage counts for tokens input using the embeddings API. Required.
    :vartype usage: ~azure.ai.projects.1dp.models.EmbeddingsUsage
...
class ImageEmbeddingsOptions(_model_base.Model):
    ...
    :vartype input: list[~azure.ai.projects.1dp.models.ImageEmbeddingInput]
    :ivar dimensions: Optional. The number of dimensions the resulting output embeddings should
     have.
     Passing null causes the model to use its default value.
     Returns a 422 error if the model doesn't support the value or parameter.
