...
class AITelemetryClientConfiguration:  # pylint: disable=too-many-instance-attributes
    """Configuration for AITelemetryClient.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        kwargs.setdefault("sdk_moniker", "ai-telemetry/{}".format(VERSION))
