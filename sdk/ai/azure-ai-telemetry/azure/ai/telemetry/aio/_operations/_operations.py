...
from ..._operations._operations import build_ai_telemetry_get_app_insights_request
from .._vendor import AITelemetryClientMixinABC
...
class AITelemetryClientOperationsMixin(AITelemetryClientMixinABC):
    ...
    async def _get_app_insights(
        ...
        :rtype: ~azure.ai.telemetry.models._models.GetAppInsightsResponse
        ...
        _request = build_ai_telemetry_get_app_insights_request(
