...
from ._configuration import AITelemetryClientConfiguration
from ._operations import AITelemetryClientOperationsMixin

if TYPE_CHECKING:
    from azure.core.credentials_async import AsyncTokenCredential


class AITelemetryClient(AITelemetryClientOperationsMixin):
    """AITelemetryClient.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = AITelemetryClientConfiguration(
            endpoint=endpoint,
