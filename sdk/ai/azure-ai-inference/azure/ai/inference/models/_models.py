...
class ContentItem(_model_base.Model):
    ...
    You probably want to use the sub-classes and not this class directly. Known sub-classes are:
    ChatMessageAudioUrlContentItem, ImageContentItem, ChatMessageAudioDataContentItem,
    TextContentItem
...
class ChatMessageAudioUrlContentItem(ContentItem, discriminator="audio_url"):
