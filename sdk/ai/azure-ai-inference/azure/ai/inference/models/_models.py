...
class CompletionsUsage(_model_base.Model):
    ...
    :vartype completion_tokens_details: ~azure.ai.inference.models.CompletionsUsageDetails
    :ivar prompt_tokens_details: Breakdown of tokens used in the prompt/chat history.
    :vartype prompt_tokens_details: ~azure.ai.inference.models.PromptUsageDetails
    """
    ...
    def __init__(
        ...
        *,
        ...
        prompt_tokens: int,
        total_tokens: int,
        completion_tokens_details: Optional["_models.CompletionsUsageDetails"] = None,
        prompt_tokens_details: Optional["_models.PromptUsageDetails"] = None,
    ) -> None: ...
...
class CompletionsUsageDetails(_model_base.Model):
...
class PromptUsageDetails(_model_base.Model):
