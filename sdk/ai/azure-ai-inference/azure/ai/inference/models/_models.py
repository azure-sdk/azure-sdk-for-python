...
class ChatCompletionsResponseFormatJsonSchema(ChatCompletionsResponseFormat, discriminator="json_schema"):
    ...
    :vartype json_schema:
     ~azure.ai.inference.models.ChatCompletionsResponseFormatJsonSchemaJsonSchema
    """
    ...
    """The type of response format being defined: ``json_schema``. Required. Default value is
     \"json_schema\"."""
    json_schema: "_models.ChatCompletionsResponseFormatJsonSchemaJsonSchema" = rest_field()
    """Required."""
    ...
    def __init__(
        self,
        *,
        json_schema: "_models.ChatCompletionsResponseFormatJsonSchemaJsonSchema",
    ) -> None: ...
...
class ChatCompletionsResponseFormatJsonSchemaJsonSchema(_model_base.Model):  # pylint: disable=name-too-long
    """ChatCompletionsResponseFormatJsonSchemaJsonSchema.
    ...
    schema: Optional[Dict[str, Any]] = rest_field()
