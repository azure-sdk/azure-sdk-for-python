...
class EmbeddingsClientOperationsMixin(EmbeddingsClientMixinABC):
    ...
    async def _embed(
        self,
        *,
        embeddings_options: _models._models.EmbeddingsOptions,
        extra_params: Optional[Union[str, _models._enums.ExtraParameters]] = None,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.EmbeddingsResult: ...
    ...
    async def _embed(
        ...
        body: Union[JSON, IO[bytes]] = _Unset,
        *,
        embeddings_options: _models._models.EmbeddingsOptions = _Unset,
        extra_params: Optional[Union[str, _models._enums.ExtraParameters]] = None,
        **kwargs: Any
    ) -> _models.EmbeddingsResult:
        ...
        :param body: Is either a JSON type or a IO[bytes] type. Required.
        :type body: JSON or IO[bytes]
        :keyword embeddings_options: Required.
        :paramtype embeddings_options: ~azure.ai.inference.models._models.EmbeddingsOptions
        ...
        if body is _Unset:
            if embeddings_options is _Unset:
                raise TypeError("missing required argument: embeddings_options")
            body = {"embeddingsOptions": embeddings_options}
            body = {k: v for k, v in body.items() if v is not None}
        content_type = content_type or "application/json"
        _content = None
        if isinstance(body, (IOBase, bytes)):
...
class ImageEmbeddingsClientOperationsMixin(ImageEmbeddingsClientMixinABC):
    ...
    async def _embed(
        self,
        *,
        image_embeddings_options: _models._models.ImageEmbeddingsOptions,
        extra_params: Optional[Union[str, _models._enums.ExtraParameters]] = None,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.EmbeddingsResult: ...
    ...
    async def _embed(
        ...
        body: Union[JSON, IO[bytes]] = _Unset,
        *,
        image_embeddings_options: _models._models.ImageEmbeddingsOptions = _Unset,
        extra_params: Optional[Union[str, _models._enums.ExtraParameters]] = None,
        **kwargs: Any
    ) -> _models.EmbeddingsResult:
        ...
        :param body: Is either a JSON type or a IO[bytes] type. Required.
        :type body: JSON or IO[bytes]
        :keyword image_embeddings_options: Required.
        :paramtype image_embeddings_options: ~azure.ai.inference.models._models.ImageEmbeddingsOptions
        :keyword extra_params: Controls what happens if extra parameters, undefined by the REST API,
         are passed in the JSON request payload.
         This sets the HTTP request header ``extra-parameters``. Known values are: "error", "drop", and
         "pass-through". Default value is None.
        ...
        if body is _Unset:
            if image_embeddings_options is _Unset:
                raise TypeError("missing required argument: image_embeddings_options")
            body = {"imageEmbeddingsOptions": image_embeddings_options}
            body = {k: v for k, v in body.items() if v is not None}
        content_type = content_type or "application/json"
        _content = None
        if isinstance(body, (IOBase, bytes)):
