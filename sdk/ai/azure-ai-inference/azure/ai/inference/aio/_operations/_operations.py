...
class EmbeddingsClientOperationsMixin(EmbeddingsClientMixinABC):
    ...
    async def _embed(
        ...
        **kwargs: Any
        ...
        :param body: Is one of the following types: EmbeddingsOptions, JSON, IO[bytes] Required.
...
class ImageEmbeddingsClientOperationsMixin(ImageEmbeddingsClientMixinABC):
    ...
    async def _embed(
        ...
        **kwargs: Any
        ...
        :param body: Is one of the following types: ImageEmbeddingsOptions, JSON, IO[bytes] Required.
