...
class ChatCompletionsClientOperationsMixin(ChatCompletionsClientMixinABC):
    ...
    @api_version_validation(
        params_added_on={"2025-04-01": ["model"]},
    )
    async def _get_model_info(self, *, model: Optional[str] = None, **kwargs: Any) -> _models.ModelInfo:
        """Returns information about the AI model.
        The method makes a REST API call to the ``/info`` route on the given endpoint.
        This method will only work when using Serverless API or Managed Compute endpoint.
        It will not work for Azure OpenAI endpoints.

        :keyword model: The model deployment name you want information from. Default value is None.
        :paramtype model: str
