...
class ChatCompletionsClientOperationsMixin(ChatCompletionsClientMixinABC):
    ...
    async def _complete(
        ...
        **kwargs: Any
        ...
        :param body: Is one of the following types: ChatCompletionsOptions, JSON, IO[bytes] Required.
...
class EmbeddingsClientOperationsMixin(EmbeddingsClientMixinABC):
    ...
    async def _embed(
        self,
        body: _models._models.EmbedRequest,
        *,
        extra_params: Optional[Union[str, _models._enums.ExtraParameters]] = None,
        content_type: str = "application/json",
        **kwargs: Any
    ...
    async def _embed(
        self,
        body: Union[_models._models.EmbedRequest, JSON, IO[bytes]],
        *,
        extra_params: Optional[Union[str, _models._enums.ExtraParameters]] = None,
        **kwargs: Any
    ) -> _models.EmbeddingsResult:
        ...
        :param body: Is one of the following types: EmbedRequest, JSON, IO[bytes] Required.
        :type body: ~azure.ai.inference.models._models.EmbedRequest or JSON or IO[bytes]
        :keyword extra_params: Controls what happens if extra parameters, undefined by the REST API,
         are passed in the JSON request payload.
         This sets the HTTP request header ``extra-parameters``. Known values are: "error", "drop", and
         "pass-through". Default value is None.
...
class ImageEmbeddingsClientOperationsMixin(ImageEmbeddingsClientMixinABC):
    ...
    async def _embed(
        self,
        body: _models._models.EmbedRequest1,
        *,
        extra_params: Optional[Union[str, _models._enums.ExtraParameters]] = None,
        content_type: str = "application/json",
        **kwargs: Any
    ...
    async def _embed(
        self,
        body: Union[_models._models.EmbedRequest1, JSON, IO[bytes]],
        *,
        extra_params: Optional[Union[str, _models._enums.ExtraParameters]] = None,
        **kwargs: Any
    ) -> _models.EmbeddingsResult:
        ...
        :param body: Is one of the following types: EmbedRequest1, JSON, IO[bytes] Required.
        :type body: ~azure.ai.inference.models._models.EmbedRequest1 or JSON or IO[bytes]
        :keyword extra_params: Controls what happens if extra parameters, undefined by the REST API,
         are passed in the JSON request payload.
         This sets the HTTP request header ``extra-parameters``. Known values are: "error", "drop", and
         "pass-through". Default value is None.
