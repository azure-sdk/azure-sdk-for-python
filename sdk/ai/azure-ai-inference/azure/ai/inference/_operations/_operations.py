...
def build_chat_completions_get_model_info_request(  # pylint: disable=name-too-long
...
def build_embeddings_get_model_info_request(*, model: Optional[str] = None, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_image_embeddings_get_model_info_request(  # pylint: disable=name-too-long
    *, model: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ChatCompletionsClientOperationsMixin(ChatCompletionsClientMixinABC):
    ...
    def _get_model_info(self, *, model: Optional[str] = None, **kwargs: Any) -> _models.ModelInfo:
