...
class AssistantDeletionStatus(_Model):
...
class AssistantsApiResponseFormat(_Model):
...
class AssistantsNamedToolChoice(_Model):
...
class AssistantThreadCreationOptions(_Model):
...
class OpenAIPageableListOfAssistant(_Model):
...
class OpenAIPageableListOfAssistantThread(_Model):
    """The response data for a requested list of items.
...
class UploadFileRequest(_Model):
    ...
    :vartype file: ~azure.ai.assistants._utils.utils.FileType
