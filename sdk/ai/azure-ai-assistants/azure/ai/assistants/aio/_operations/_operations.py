...
from ..._operations._operations import (
    build_ai_assistant_cancel_run_request,
    build_ai_assistant_cancel_vector_store_file_batch_request,
    build_ai_assistant_create_agent_request,
    build_ai_assistant_create_message_request,
    build_ai_assistant_create_run_request,
    build_ai_assistant_create_thread_and_run_request,
    build_ai_assistant_create_thread_request,
    build_ai_assistant_create_vector_store_file_batch_request,
    build_ai_assistant_create_vector_store_file_request,
    build_ai_assistant_create_vector_store_request,
    build_ai_assistant_delete_agent_request,
    build_ai_assistant_delete_file_request,
    build_ai_assistant_delete_thread_request,
    build_ai_assistant_delete_vector_store_file_request,
    build_ai_assistant_delete_vector_store_request,
    build_ai_assistant_get_agent_request,
    build_ai_assistant_get_file_content_request,
    build_ai_assistant_get_file_request,
    build_ai_assistant_get_message_request,
    build_ai_assistant_get_run_request,
    build_ai_assistant_get_run_step_request,
    build_ai_assistant_get_thread_request,
    build_ai_assistant_get_vector_store_file_batch_request,
    build_ai_assistant_get_vector_store_file_request,
    build_ai_assistant_get_vector_store_request,
    build_ai_assistant_list_agents_request,
    build_ai_assistant_list_files_request,
    build_ai_assistant_list_messages_request,
    build_ai_assistant_list_run_steps_request,
    build_ai_assistant_list_runs_request,
    build_ai_assistant_list_vector_store_file_batch_files_request,
    build_ai_assistant_list_vector_store_files_request,
    build_ai_assistant_list_vector_stores_request,
    build_ai_assistant_modify_vector_store_request,
    build_ai_assistant_submit_tool_outputs_to_run_request,
    build_ai_assistant_update_agent_request,
    build_ai_assistant_update_message_request,
    build_ai_assistant_update_run_request,
    build_ai_assistant_update_thread_request,
    build_ai_assistant_upload_file_request,
)
from ..._vendor import prepare_multipart_form_data
from .._vendor import AIAssistantClientMixinABC
...
class AIAssistantClientOperationsMixin(AIAssistantClientMixinABC):  # pylint: disable=too-many-public-methods
    ...
    async def delete_thread(self, thread_id: str, **kwargs: Any) -> _models.ThreadDeletionStatus:
        ...
        :rtype: ~azure.ai.assistants.models.ThreadDeletionStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def create_message(
        ...
        **kwargs: Any
        ...
        :paramtype attachments: list[~azure.ai.assistants.models.MessageAttachment]
        :keyword metadata: A set of up to 16 key/value pairs that can be attached to an object, used
         for storing additional information about that object in a structured format. Keys may be up to
         64 characters in length and values may be up to 512 characters in length. Default value is
         None.
    ...
    async def list_messages(
        ...
        **kwargs: Any
        ...
        :return: OpenAIPageableListOfThreadMessage. The OpenAIPageableListOfThreadMessage is compatible
         with MutableMapping
        :rtype: ~azure.ai.assistants.models.OpenAIPageableListOfThreadMessage
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def list_runs(
        ...
        **kwargs: Any
        ...
        :return: OpenAIPageableListOfThreadRun. The OpenAIPageableListOfThreadRun is compatible with
         MutableMapping
        :rtype: ~azure.ai.assistants.models.OpenAIPageableListOfThreadRun
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def list_run_steps(
        ...
        **kwargs: Any
        ...
        :return: OpenAIPageableListOfRunStep. The OpenAIPageableListOfRunStep is compatible with
         MutableMapping
        :rtype: ~azure.ai.assistants.models.OpenAIPageableListOfRunStep
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def list_files(
        ...
        :rtype: ~azure.ai.assistants.models.FileListResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def upload_file(self, body: Union[_models.UploadFileRequest, JSON], **kwargs: Any) -> _models.OpenAIFile:
        ...
        :type body: ~azure.ai.assistants.models.UploadFileRequest or JSON
        :return: OpenAIFile. The OpenAIFile is compatible with MutableMapping
        :rtype: ~azure.ai.assistants.models.OpenAIFile
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def delete_file(self, file_id: str, **kwargs: Any) -> _models.FileDeletionStatus:
        ...
        :rtype: ~azure.ai.assistants.models.FileDeletionStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def list_vector_stores(
        ...
        **kwargs: Any
        ...
        :return: OpenAIPageableListOfVectorStore. The OpenAIPageableListOfVectorStore is compatible
         with MutableMapping
        :rtype: ~azure.ai.assistants.models.OpenAIPageableListOfVectorStore
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def create_vector_store(
        ...
        **kwargs: Any
        ...
        :paramtype store_configuration: ~azure.ai.assistants.models.VectorStoreConfiguration
    ...
    async def delete_vector_store(self, vector_store_id: str, **kwargs: Any) -> _models.VectorStoreDeletionStatus:
        ...
        :return: VectorStoreDeletionStatus. The VectorStoreDeletionStatus is compatible with
         MutableMapping
        :rtype: ~azure.ai.assistants.models.VectorStoreDeletionStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def list_vector_store_files(
        ...
        **kwargs: Any
        ...
        :paramtype filter: str or ~azure.ai.assistants.models.VectorStoreFileStatusFilter
        :keyword limit: A limit on the number of objects to be returned. Limit can range between 1 and
         100, and the default is 20. Default value is None.
        :paramtype limit: int
        :keyword order: Sort order by the created_at timestamp of the objects. asc for ascending order
        ...
        :rtype: ~azure.ai.assistants.models.OpenAIPageableListOfVectorStoreFile
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def delete_vector_store_file(
        ...
        :return: VectorStoreFileDeletionStatus. The VectorStoreFileDeletionStatus is compatible with
         MutableMapping
        :rtype: ~azure.ai.assistants.models.VectorStoreFileDeletionStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
