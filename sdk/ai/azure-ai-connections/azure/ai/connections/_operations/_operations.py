...
def build_ai_connections_get_workspace_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
...
def build_ai_connections_list_connections_request(  # pylint: disable=name-too-long
    *,
...
def build_ai_connections_get_connection_request(  # pylint: disable=name-too-long
...
def build_ai_connections_get_connection_with_secrets_request(  # pylint: disable=name-too-long
    connection_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
