...
from ._configuration import AIConnectionsClientConfiguration
from ._operations import AIConnectionsClientOperationsMixin
...
class AIConnectionsClient(AIConnectionsClientOperationsMixin):
    """AIConnectionsClient.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = AIConnectionsClientConfiguration(
            endpoint=endpoint,
