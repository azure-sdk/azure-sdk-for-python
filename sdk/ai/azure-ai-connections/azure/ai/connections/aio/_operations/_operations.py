...
from ..._operations._operations import (
    build_ai_connections_get_connection_request,
    build_ai_connections_get_connection_with_secrets_request,
    build_ai_connections_get_workspace_request,
    build_ai_connections_list_connections_request,
)
from .._vendor import AIConnectionsClientMixinABC
...
class AIConnectionsClientOperationsMixin(AIConnectionsClientMixinABC):
    ...
    async def _get_workspace(self, **kwargs: Any) -> _models._models.GetWorkspaceResponse:
        ...
        :rtype: ~azure.ai.connections.models._models.GetWorkspaceResponse
        ...
        _request = build_ai_connections_get_workspace_request(
    ...
    async def _list_connections(
        ...
        **kwargs: Any
        ...
        :paramtype category: str or ~azure.ai.connections.models.ConnectionType
        ...
        :rtype: ~azure.ai.connections.models._models.ListConnectionsResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        _request = build_ai_connections_list_connections_request(
            category=category,
    ...
    async def _get_connection(self, connection_name: str, **kwargs: Any) -> _models._models.GetConnectionResponse:
        ...
        :rtype: ~azure.ai.connections.models._models.GetConnectionResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        _request = build_ai_connections_get_connection_request(
    ...
    async def _get_connection_with_secrets(
        ...
        _request = build_ai_connections_get_connection_with_secrets_request(
            connection_name=connection_name,
