...
class AIConnectionsClientConfiguration:  # pylint: disable=too-many-instance-attributes
    """Configuration for AIConnectionsClient.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        kwargs.setdefault("sdk_moniker", "ai-connections/{}".format(VERSION))
