...
class DatasetsOperations:
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type version: str
        :param dataset_version: The definition of the DatasetVersion to create or update. Required.
    ...
    def create_or_update(
        ...
        :param version: The specific version id of the DatasetVersion to create or replace. Required.
        :type version: str
        :param dataset_version: The definition of the DatasetVersion to create or update. Is one of the
         following types: DatasetVersion, JSON, IO[bytes] Required.
...
class IndexesOperations:
    ...
    def create_or_update(
        ...
        name: str,
        version: str,
        pending_upload_request: _models.Index,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.Index:
        ...
        :type version: str
        :param pending_upload_request: The definition of the Index to create or update. Required.
        :type pending_upload_request: ~azure.ai.projects.models.Index
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: Index. The Index is compatible with MutableMapping
    ...
    @distributed_trace
    def create_or_update(
        self, name: str, version: str, pending_upload_request: Union[_models.Index, JSON, IO[bytes]], **kwargs: Any
    ) -> _models.Index:
        """Create a new or update an existing Index with the given version id.
        ...
        :param version: The specific version id of the Index to create or replace. Required.
        :type version: str
        :param pending_upload_request: The definition of the Index to create or update. Is one of the
         following types: Index, JSON, IO[bytes] Required.
        :type pending_upload_request: ~azure.ai.projects.models.Index or JSON or IO[bytes]
        :return: Index. The Index is compatible with MutableMapping
        :rtype: ~azure.ai.projects.models.Index
        :raises ~azure.core.exceptions.HttpResponseError:
        """
