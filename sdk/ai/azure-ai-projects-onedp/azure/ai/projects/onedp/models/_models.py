...
class AgentEvaluationRequest(_model_base.Model):
    ...
    def __init__(
        ...
        *,
        ...
        sampling_configuration: Optional["_models.SamplingConfiguration"] = None,
...
class AgentLongRunningOperationResponse(_model_base.Model):
    ...
    operation_result: Optional[Any] = rest_field(
...
class SamplingConfiguration(_model_base.Model):
    ...
    :ivar max_request_rate: Maximum request rate per hour (0 to 10,000). Required.
    ...
    """Maximum request rate per hour (0 to 10,000). Required."""
