...
class AgentEvaluation(_model_base.Model):
    ...
    :vartype sampling_configuration: ~azure.ai.projects.onedp.models.SamplingConfiguration
    ...
    sampling_configuration: Optional["_models.SamplingConfiguration"] = rest_field(
        name="samplingConfiguration", visibility=["read"]
    )
...
class AgentLongRunningOperationResponse(_model_base.Model):
    """Long running operation response for agent evaluation.

    :ivar location: URI for the long running operation. Required.
    :vartype location: str
    :ivar operation_result: Result of the long running operation.
    :vartype operation_result: any
    """

    location: str = rest_field(visibility=["read"])
    """URI for the long running operation. Required."""
    operation_result: Optional[Any] = rest_field(name="operationResult", visibility=["read"])
...
class SamplingConfiguration(_model_base.Model):
    """Definition for sampling strategy.

    :ivar name: Name of the sampling strategy. Required.
    :vartype name: str
    :ivar sampling_percent: Percentage of sampling per hour. Required.
    :vartype sampling_percent: float
    :ivar max_request_rate: Maximum request rate per hour. Required.
    :vartype max_request_rate: float
    """

    name: str = rest_field(visibility=["read"])
    """Name of the sampling strategy. Required."""
    sampling_percent: float = rest_field(name="samplingPercent", visibility=["read"])
    """Percentage of sampling per hour. Required."""
    max_request_rate: float = rest_field(name="maxRequestRate", visibility=["read"])
    """Maximum request rate per hour. Required."""
