...
class AgentEvaluation(_model_base.Model):
    ...
    :ivar thread_id: Identifier of the agent thread.
    :vartype thread_id: str
    :ivar run_id: Identifier of the agent run.
    :vartype run_id: str
    :ivar completion_id: Identifier of the agent completion, which is the combination of Thread ID
     and Run ID.
    :vartype completion_id: str
    ...
    :ivar query: Conversation history passed to the agent, including all previous messages in the
     chat, including all agents' tool calls and tool results, and with the system message. The
     actual query that an evaluation will trigger for is the last message in the conversation.
     Required.
    :vartype query: list[~azure.ai.projects.onedp.models.CompletionsMessage]
    :ivar response: Agent's direct response to the query from the conversation, including all tool
     calls, results, and agent's formatted responses. Required.
    :vartype response: list[~azure.ai.projects.onedp.models.CompletionsMessage]
    :ivar tool_definitions: Tools that were used in the conversation. Required.
    :vartype tool_definitions: list[~azure.ai.projects.onedp.models.AgentToolDefinition]
    :ivar app_insights_connection_string: Optional and temporary way to pass the app insights
     connection string to the evaluator.
    :vartype app_insights_connection_string: str
    """

    thread_id: Optional[str] = rest_field(name="threadId", visibility=["read"])
    """Identifier of the agent thread."""
    run_id: Optional[str] = rest_field(name="runId", visibility=["read"])
    """Identifier of the agent run."""
    completion_id: Optional[str] = rest_field(name="completionId", visibility=["read"])
    """Identifier of the agent completion, which is the combination of Thread ID and Run ID."""
    evaluators: Dict[str, "_models.EvaluatorConfiguration"] = rest_field(visibility=["read"])
    """Evaluators to be used for the evaluation. Required."""
    query: List["_models.CompletionsMessage"] = rest_field(visibility=["read"])
    """Conversation history passed to the agent, including all previous messages in the chat,
     including all agents' tool calls and tool results, and with the system message. The actual
     query that an evaluation will trigger for is the last message in the conversation. Required."""
    response: List["_models.CompletionsMessage"] = rest_field(visibility=["read"])
    """Agent's direct response to the query from the conversation, including all tool calls, results,
     and agent's formatted responses. Required."""
    tool_definitions: List["_models.AgentToolDefinition"] = rest_field(name="toolDefinitions", visibility=["read"])
    """Tools that were used in the conversation. Required."""
    app_insights_connection_string: Optional[str] = rest_field(name="appInsightsConnectionString", visibility=["read"])
    """Optional and temporary way to pass the app insights connection string to the evaluator."""
...
class AgentEvaluationResult(_model_base.Model):
    ...
    :vartype score: float
    :ivar status: Status of the evaluation result. Options: Success, Failure, NotApplicable.
     Required.
    :vartype status: str
    ...
    :vartype version: str
    :ivar response_id: The unique identifier for the completion.
    :vartype response_id: str
    :ivar message_id: Identifies message sent to or received from Generative AI model or agent.
    :vartype message_id: str
    :ivar thread_id: The unique identifier of the thread.
    :vartype thread_id: str
    :ivar run_id: The unique identifier of the run.
    :vartype run_id: str
    ...
    response_id: Optional[str] = rest_field(name="responseId", visibility=["read"])
    """The unique identifier for the completion."""
    message_id: Optional[str] = rest_field(name="messageId", visibility=["read"])
...
class CompletionsMessage(_model_base.Model):
    """Agent API v2, completion message for agent run.

    :ivar user_id: Identifier of user.
    :vartype user_id: str
    :ivar agent_id: Identifier of agent.
    :vartype agent_id: str
    :ivar message_id: Identifier of message.
    :vartype message_id: str
    :ivar completion_id: Identifier of completion.
    :vartype completion_id: str
    :ivar thread_id: Identifier of thread.
    :vartype thread_id: str
    :ivar run_id: Identifier of run.
    :vartype run_id: str
    :ivar role: Role of the author. Required. Known values are: "user", "agent", "system", "tool",
     "developer", and "unknown".
    :vartype role: str or ~azure.ai.projects.onedp.models.AuthorRoleEnum
    :ivar content: Content of the message. Required.
    :vartype content: list[~azure.ai.projects.onedp.models.TextContent]
    :ivar author_name: Name of the author.
    :vartype author_name: str
    :ivar created_at: Timestamp of when the message was created.
    :vartype created_at: ~datetime.datetime
    :ivar completed_at: Timestamp of when the message was completed.
    ...
    completion_id: Optional[str] = rest_field(name="completionId", visibility=["read"])
    """Identifier of completion."""
    thread_id: Optional[str] = rest_field(name="threadId", visibility=["read"])
    """Identifier of thread."""
    run_id: Optional[str] = rest_field(name="runId", visibility=["read"])
    """Identifier of run."""
    role: Union[str, "_models.AuthorRoleEnum"] = rest_field(visibility=["read"])
    """Role of the author. Required. Known values are: \"user\", \"agent\", \"system\", \"tool\",
     \"developer\", and \"unknown\"."""
    content: List["_models.TextContent"] = rest_field(visibility=["read"])
    """Content of the message. Required."""
    author_name: Optional[str] = rest_field(name="authorName", visibility=["read"])
    """Name of the author."""
    ...
    """Timestamp of when the message was completed."""
...
class TextContent(_model_base.Model):
    """Text content for completion message.

    :ivar type: Type of the content. Required. Default value is "text".
    :vartype type: str
    :ivar text: Text content. Required.
    :vartype text: str
    """

    type: Literal["text"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Type of the content. Required. Default value is \"text\"."""
