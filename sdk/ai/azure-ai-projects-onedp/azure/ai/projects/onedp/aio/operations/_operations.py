...
from ...operations._operations import (
    ...
    build_evaluation_results_get_agent_evaluation_results_request,
    ...
    build_evaluations_create_agent_run_async_request,
    build_evaluations_create_agent_run_request,
...
class EvaluationResultsOperations:
    ...
    async def get_agent_evaluation_results(self, run_id: str, **kwargs: Any) -> List[_models.AgentEvaluationResult]:
