...
def build_evaluations_create_agent_run_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_evaluations_create_agent_run_async_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/evaluations/runs:agents/submit"
...
def build_evaluations_operation_results_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/evaluations/operations/{operationId}"
    path_format_arguments = {
...
def build_evaluation_results_get_credentials_request(  # pylint: disable=name-too-long
    name: str, version: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/evaluationResults/{name}/versions/{version}/credentials"
    path_format_arguments = {
        "name": _SERIALIZER.url("name", name, "str"),
        "version": _SERIALIZER.url("version", version, "str"),
    }
...
def build_evaluation_results_get_agent_evaluation_results_request(  # pylint: disable=name-too-long
...
class EvaluationsOperations:
    ...
    def create_agent_run(
        self, evaluation: _models.AgentEvaluation, *, content_type: str = "application/json", **kwargs: Any
    ) -> List[_models.AgentEvaluationResult]:
        """Creates an evaluation run for agent continuous evaluation.

        :param evaluation: Agent evaluation with synchronous run. Required.
        :type evaluation: ~azure.ai.projects.onedp.models.AgentEvaluation
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: list of AgentEvaluationResult
        :rtype: list[~azure.ai.projects.onedp.models.AgentEvaluationResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def create_agent_run(
        self, evaluation: Union[_models.AgentEvaluation, JSON, IO[bytes]], **kwargs: Any
    ) -> List[_models.AgentEvaluationResult]:
        """Creates an evaluation run for agent continuous evaluation.

        :param evaluation: Agent evaluation with synchronous run. Is one of the following types:
         AgentEvaluation, JSON, IO[bytes] Required.
        :type evaluation: ~azure.ai.projects.onedp.models.AgentEvaluation or JSON or IO[bytes]
        :return: list of AgentEvaluationResult
        :rtype: list[~azure.ai.projects.onedp.models.AgentEvaluationResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[List[_models.AgentEvaluationResult]] = kwargs.pop("cls", None)
        ...
        _request = build_evaluations_create_agent_run_request(
            content_type=content_type,
            api_version=self._config.api_version,
            content=_content,
            headers=_headers,
        ...
        if _stream:
            ...
            deserialized = _deserialize(List[_models.AgentEvaluationResult], response.json())
    ...
    def create_agent_run_async(
        self, evaluation: _models.AgentEvaluation, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.AgentLongRunningOperationResponse:
        """Creates an evaluation run for agent continuous evaluation.

        :param evaluation: Agent evaluation with asynchronous run. Required.
        :type evaluation: ~azure.ai.projects.onedp.models.AgentEvaluation
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: AgentLongRunningOperationResponse. The AgentLongRunningOperationResponse is compatible
         with MutableMapping
        :rtype: ~azure.ai.projects.onedp.models.AgentLongRunningOperationResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def create_agent_run_async(
        ...
        :param evaluation: Agent evaluation with asynchronous run. Is one of the following types:
         AgentEvaluation, JSON, IO[bytes] Required.
        :type evaluation: ~azure.ai.projects.onedp.models.AgentEvaluation or JSON or IO[bytes]
        :return: AgentLongRunningOperationResponse. The AgentLongRunningOperationResponse is compatible
         with MutableMapping
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.AgentLongRunningOperationResponse] = kwargs.pop("cls", None)
        ...
        _request = build_evaluations_create_agent_run_async_request(
            content_type=content_type,
            api_version=self._config.api_version,
            content=_content,
            headers=_headers,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.AgentLongRunningOperationResponse, response.json())
    ...
    def operation_results(self, operation_id: str, **kwargs: Any) -> Dict[str, Any]:
...
class EvaluationResultsOperations:
    ...
    @api_version_validation(
        method_added_on="2025-05-15-preview",
        params_added_on={"2025-05-15-preview": ["api_version", "run_id", "accept"]},
    )
    def get_agent_evaluation_results(self, run_id: str, **kwargs: Any) -> List[_models.AgentEvaluationResult]:
        ...
        _request = build_evaluation_results_get_agent_evaluation_results_request(
            run_id=run_id,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
