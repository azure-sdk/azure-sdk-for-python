...
def build_evaluation_results_get_agent_evaluation_results_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/runs:agents/{completionId}"
    path_format_arguments = {
        "completionId": _SERIALIZER.url("completion_id", completion_id, "str"),
    }
...
class EvaluationsOperations:
    ...
    def create_agent_run(
        ...
        :param evaluation: Agent evaluation to be run. Is one of the following types: AgentEvaluation,
...
class EvaluationResultsOperations:
    ...
    @api_version_validation(
        method_added_on="2025-05-15-preview",
        params_added_on={"2025-05-15-preview": ["api_version", "completion_id", "accept"]},
    )
    def get_agent_evaluation_results(self, completion_id: str, **kwargs: Any) -> List[_models.AgentEvaluationResult]:
        """Get agent evaluation results.

        :param completion_id: Agent run completion id. Required.
