...
def build_red_teams_jailbreak_request(*, type: Optional[str] = None, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_red_teams_template_parameters_request(  # pylint: disable=name-too-long
...
def build_red_teams_template_parameters_image_request(  # pylint: disable=name-too-long
    *, path: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_red_teams_chat_completions_submit_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class RedTeamsOperations:
    ...
    @api_version_validation(
        method_added_on="2025-05-15-preview",
        params_added_on={"2025-05-15-preview": ["type", "api_version", "accept"]},
    )
    def jailbreak(self, *, type: Optional[str] = None, **kwargs: Any) -> str:
        """Simulation jailbreak.

        :keyword type: Type of parameter. Default value is None.
        :paramtype type: str
        :return: str
        :rtype: str
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        _request = build_red_teams_jailbreak_request(
            type=type,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    def template_parameters(self, *, type: Optional[str] = None, **kwargs: Any) -> str:
        ...
        _request = build_red_teams_template_parameters_request(
            type=type,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    @api_version_validation(
        method_added_on="2025-05-15-preview",
        params_added_on={"2025-05-15-preview": ["path", "api_version", "accept"]},
    )
    def template_parameters_image(self, *, path: str, **kwargs: Any) -> str:
        """Simulation template parameters for image.

        :keyword path: Path for image. Required.
        :paramtype path: str
        :return: str
        :rtype: str
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        _request = build_red_teams_template_parameters_image_request(
            path=path,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    @overload
    def chat_completions_submit(
        self, simulation_dto: _models.SimulationDTO, *, content_type: str = "application/json", **kwargs: Any
    ) -> str:
        """Simulation chat completion.

        :param simulation_dto: Simulation request. Required.
        :type simulation_dto: ~azure.ai.projects.onedp.models.SimulationDTO
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: str
    ...
    @overload
    def chat_completions_submit(
        self, simulation_dto: JSON, *, content_type: str = "application/json", **kwargs: Any
    ) -> str:
        """Simulation chat completion.

        :param simulation_dto: Simulation request. Required.
        :type simulation_dto: JSON
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: str
    ...
    @overload
    def chat_completions_submit(
        self, simulation_dto: IO[bytes], *, content_type: str = "application/json", **kwargs: Any
    ) -> str:
        """Simulation chat completion.

        :param simulation_dto: Simulation request. Required.
        :type simulation_dto: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: str
    ...
    def chat_completions_submit(
        self, simulation_dto: Union[_models.SimulationDTO, JSON, IO[bytes]], **kwargs: Any
    ) -> str:
        """Simulation chat completion.

        :param simulation_dto: Simulation request. Is one of the following types: SimulationDTO, JSON,
         IO[bytes] Required.
        :type simulation_dto: ~azure.ai.projects.onedp.models.SimulationDTO or JSON or IO[bytes]
        :return: str
        :rtype: str
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        content_type = content_type or "application/json"
        _content = None
        if isinstance(simulation_dto, (IOBase, bytes)):
            _content = simulation_dto
        else:
            _content = json.dumps(simulation_dto, cls=SdkJSONEncoder, exclude_readonly=True)  # type: ignore

        _request = build_red_teams_chat_completions_submit_request(
            content_type=content_type,
            api_version=self._config.api_version,
            content=_content,
            headers=_headers,
