...
class TestAIProjectRedTeamsOperations(AIProjectClientTestBase):
    ...
    @AIProjectPreparer()
    @recorded_by_proxy
    def test_red_teams_jailbreak(self, aiproject_endpoint):
        client = self.create_client(endpoint=aiproject_endpoint)
        response = client.red_teams.jailbreak()
    ...
    @AIProjectPreparer()
    @recorded_by_proxy
    def test_red_teams_template_parameters(self, aiproject_endpoint):
        client = self.create_client(endpoint=aiproject_endpoint)
        response = client.red_teams.template_parameters()
    ...
    @AIProjectPreparer()
    @recorded_by_proxy
    def test_red_teams_template_parameters_image(self, aiproject_endpoint):
        client = self.create_client(endpoint=aiproject_endpoint)
        response = client.red_teams.template_parameters_image(
            path="str",
        )
    ...
    @AIProjectPreparer()
    @recorded_by_proxy
    def test_red_teams_chat_completions_submit(self, aiproject_endpoint):
        client = self.create_client(endpoint=aiproject_endpoint)
        response = client.red_teams.chat_completions_submit(
            simulation_dto={
