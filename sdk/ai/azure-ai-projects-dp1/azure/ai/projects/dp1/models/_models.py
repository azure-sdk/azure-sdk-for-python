...
class ChatCompletions(_model_base.Model):
    ...
    :ivar messages: The collection of context messages associated with this chat completions that
     need to be evaluated. Required.
    :vartype messages: list[~azure.ai.projects.dp1.models.ChatRequestMessage]
    """

    messages: List["_models.ChatRequestMessage"] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    """The collection of context messages associated with this chat completions that need to be
     evaluated. Required."""
...
class ChatRequestMessage(_model_base.Model):
    ...
    :ivar role: The chat role associated with this message. Required. Known values are: "system",
     "user", and "assistant".
    :vartype role: str or ~azure.ai.projects.dp1.models.ChatRole
    """
...
class Metric(_model_base.Model):
    ...
    :ivar name: The metric name. Required.
    :vartype name: str
    :ivar label: The label. Required.
    :vartype label: str
    :ivar reason: The reason. Required.
    :vartype reason: str
    """
...
class RawDataset(InputData, discriminator="raw"):
    """Dataset as source for evaluation.

    :ivar type: Required. Default value is "raw".
    :vartype type: str
    :ivar value: The collection of context messages associated with this chat completions that need
     to be evaluated. Required.
    :vartype value: list[~azure.ai.projects.dp1.models.ChatCompletions]
    :ivar metric: Required.
    :vartype metric: list[~azure.ai.projects.dp1.models.Metric]
    :ivar properties: Raw Data's properties. Unlike tags, properties are add-only. Once added, a
     property cannot be removed.
    :vartype properties: dict[str, str]
    """

    type: Literal["raw"] = rest_discriminator(name="type", visibility=["read", "create", "update", "delete", "query"])  # type: ignore
    """Required. Default value is \"raw\"."""
    value: List["_models.ChatCompletions"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """The collection of context messages associated with this chat completions that need to be
     evaluated. Required."""
    metric: List["_models.Metric"] = rest_field(visibility=["read"])
    """Required."""
    properties: Optional[Dict[str, str]] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Raw Data's properties. Unlike tags, properties are add-only. Once added, a property cannot be
     removed."""
    ...
    def __init__(
        self,
        *,
        value: List["_models.ChatCompletions"],
        properties: Optional[Dict[str, str]] = None,
    ) -> None: ...
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, type="raw", **kwargs)
