...
class Evaluation(_model_base.Model):
    ...
    :ivar evaluation_result_id: EvaluationResult Uri: output asset type. Uploaded for local runs.
     Example: azureml://registries/azureml/evaluationresults/name/{name}/version/{version}.
     Required.
    :vartype evaluation_result_id: str
    :ivar outputs: Outputs of the evaluation as a dictionary of IDs. Example: {
     'evaluationResultId': 'azureml://project/azureml/evaluationresults/myevaluationresult1',
     'logId': 'azureml://project/azureml/datasets/joblogs' }. Required.
    ...
    evaluation_result_id: str = rest_field(
        name="evaluationResultId", visibility=["read", "create", "update", "delete", "query"]
    )
    """EvaluationResult Uri: output asset type. Uploaded for local runs. Example:
     azureml://registries/azureml/evaluationresults/name/{name}/version/{version}. Required."""
    outputs: Dict[str, str] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Outputs of the evaluation as a dictionary of IDs. Example: { 'evaluationResultId':
     'azureml://project/azureml/evaluationresults/myevaluationresult1', 'logId':
     'azureml://project/azureml/datasets/joblogs' }. Required."""
