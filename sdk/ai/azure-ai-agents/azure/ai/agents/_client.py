...
class AgentsClient(AgentsClientOperationsMixin):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype steps: azure.ai.agents.operations.stepsOperations
    ...
    :vartype vector_stores: azure.ai.agents.operations.vector_storesOperations
    :ivar vector_store_files: vector_store_filesOperations operations
    :vartype vector_store_files: azure.ai.agents.operations.vector_store_filesOperations
    :ivar file_batches: file_batchesOperations operations
    :vartype file_batches: azure.ai.agents.operations.file_batchesOperations
