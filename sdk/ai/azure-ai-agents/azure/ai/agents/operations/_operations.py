...
def build_messages_create_request(thread_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = "/threads/{threadId}/messages/messages"
    path_format_arguments = {
        "threadId": _SERIALIZER.url("thread_id", thread_id, "str"),
    }
...
def build_messages_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/threads/{threadId}/messages/threads/{threadId}/messages"
    path_format_arguments = {
        "threadId": _SERIALIZER.url("thread_id", thread_id, "str"),
    }
...
def build_messages_get_request(thread_id: str, message_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = "/threads/{threadId}/messages/messages/{messageId}"
    path_format_arguments = {
        "threadId": _SERIALIZER.url("thread_id", thread_id, "str"),
...
def build_runs_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/threads/{threadId}/threads/{threadId}/runs"
    path_format_arguments = {
        "threadId": _SERIALIZER.url("thread_id", thread_id, "str"),
    }
...
def build_run_steps_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/threads/{threadId}/runs/{runId}/threads/{threadId}/threads/{runId}/steps"
    path_format_arguments = {
        "threadId": _SERIALIZER.url("thread_id", thread_id, "str"),
        "runId": _SERIALIZER.url("run_id", run_id, "str"),
    }
    ...
    def list(
        ...
        **kwargs: Any
        ...
        def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(List[_models.AgentThread], deserialized.get("value", []))
            if cls:
...
class MessagesOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.ThreadMessage], deserialized.get("value", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, iter(list_of_elem)
...
class RunsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.ThreadRun], deserialized.get("value", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, iter(list_of_elem)
...
class RunStepsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.RunStep], deserialized.get("value", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, iter(list_of_elem)
