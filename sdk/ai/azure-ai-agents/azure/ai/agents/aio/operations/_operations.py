...
from ...operations._operations import (
    ...
    build_file_batches_cancel_request,
    build_file_batches_create_request,
    build_file_batches_get_request,
    build_file_batches_list_files_request,
    ...
    build_steps_get_request,
    build_steps_list_request,
...
class agentsOperations:
    ...
    @overload
    async def create(self, body: JSON, *, content_type: str = "application/json", **kwargs: Any) -> _models.Agent:
        """Creates a new agent.
    ...
    @overload
    async def create(self, body: IO[bytes], *, content_type: str = "application/json", **kwargs: Any) -> _models.Agent:
        """Creates a new agent.
    ...
    @distributed_trace_async
    async def get(self, agent_id: str, **kwargs: Any) -> _models.Agent:
    ...
    @distributed_trace_async
    async def delete(self, agent_id: str, **kwargs: Any) -> _models.AgentDeletionStatus:
