...
class AgentsClient(AgentsClientOperationsMixin):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar file_batches: FileBatchesOperations operations
    :vartype file_batches: azure.ai.agents.aio.operations.FileBatchesOperations
    ...
    def __init__(
        ...
        self.file_batches = FileBatchesOperations(self._client, self._config, self._serialize, self._deserialize)
