...
class AgentsClient(AgentsClientOperationsMixin):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype steps: azure.ai.agents.aio.operations.stepsOperations
    :ivar files: filesOperations operations
    :vartype files: azure.ai.agents.aio.operations.filesOperations
    :ivar vector_stores: vector_storesOperations operations
    :vartype vector_stores: azure.ai.agents.aio.operations.vector_storesOperations
    :ivar vector_store_files: vector_store_filesOperations operations
    :vartype vector_store_files: azure.ai.agents.aio.operations.vector_store_filesOperations
    :ivar file_batches: file_batchesOperations operations
    :vartype file_batches: azure.ai.agents.aio.operations.file_batchesOperations
    ...
    def __init__(
        ...
        self.vector_stores = vector_storesOperations(self._client, self._config, self._serialize, self._deserialize)
        self.vector_store_files = vector_store_filesOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
        self.file_batches = file_batchesOperations(self._client, self._config, self._serialize, self._deserialize)
