...
def build_connections_get_with_credentials_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/connections/{name}:getWithCredentials"
    path_format_arguments = {
        "name": _SERIALIZER.url("name", name, "str"),
    }
...
def build_datasets_list_datasets_request(
    *, skip: Optional[str] = None, list_view_type: Optional[Union[str, _models.ListViewType]] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_datasets_delete_request(workspace_name: str, name: str, **kwargs: Any) -> HttpRequest:
    # Construct URL
    _url = "/datasets/{name}/{workspaceName}"
    path_format_arguments = {
...
def build_datasets_delete_version_request(name: str, version: str, **kwargs: Any) -> HttpRequest:
    # Construct URL
    _url = "/data/{name}/versions/{version}"
    path_format_arguments = {
        "name": _SERIALIZER.url("name", name, "str"),
...
def build_models_get_request(name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_models_list_request(
    ...
    **kwargs: Any
    ...
    _params["$includeConnectionModels"] = _SERIALIZER.query(
        "include_connection_models", include_connection_models, "str"
    )
    if top is not None:
        _params["top"] = _SERIALIZER.query("top", top, "int")
    if skip is not None:
...
class ConnectionsOperations:
    ...
    @distributed_trace
    def list(
        self, *, connection_type: str, top: Optional[int] = None, skip: Optional[int] = None, **kwargs: Any
    ) -> Iterable["_models.Connection"]:
        """List all connections in the project.

        :keyword connection_type: Specific type of connection to return in list. Required.
...
class DatasetsOperations:
    ...
    def list_datasets(
        ...
        *,
        ...
        list_view_type: Optional[Union[str, _models.ListViewType]] = None,
        **kwargs: Any
    ) -> Iterable["_models.DatasetContainer"]:
        ...
        :return: An iterator like instance of DatasetContainer
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.unified.autogen.models.DatasetContainer]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

        cls: ClsType[List[_models.DatasetContainer]] = kwargs.pop("cls", None)
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_datasets_list_datasets_request(
                    skip=skip,
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.DatasetContainer], deserialized["value"])
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, iter(list_of_elem)
    ...
    def delete(  # pylint: disable=inconsistent-return-statements
        self, workspace_name: str, name: str, **kwargs: Any
    ) -> None:
        """Delete container.
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.ai.unified.autogen.models.DatasetVersion
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: DatasetVersion. The DatasetVersion is compatible with MutableMapping
    ...
    def create_or_update(
        ...
        :param version: Version identifier. Required.
        :type version: str
        :param body: Version entity to create or update. Is one of the following types: DatasetVersion,
         JSON, IO[bytes] Required.
        :type body: ~azure.ai.unified.autogen.models.DatasetVersion or JSON or IO[bytes]
        :return: DatasetVersion. The DatasetVersion is compatible with MutableMapping
        :rtype: ~azure.ai.unified.autogen.models.DatasetVersion
        :raises ~azure.core.exceptions.HttpResponseError:
        """
...
class ModelsOperations:
    ...
    @distributed_trace
    def get(self, name: str, **kwargs: Any) -> _models.Model:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :keyword model_publisher: Model publisher to filter models by. Required.
        :paramtype model_publisher: str
        :keyword model_name: Model name (the publisher specific name) to filter models by. Required.
        :paramtype model_name: str
        :keyword include_connection_models: Flag to include models from connections in response.
         Accepted values are 'true' and 'false'. Required.
        :paramtype include_connection_models: str
        :keyword top: The number of result items to return. Default value is None.
        :paramtype top: int
        :keyword skip: The number of result items to skip. Default value is None.
        :paramtype skip: int
