...
from ...operations._operations import (
    ...
    build_datasets_list_datasets_request,
...
class DatasetsOperations:
    ...
    def list_datasets(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.DatasetContainer"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.unified.autogen.models.DatasetContainer]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class ModelsOperations:
    ...
    @distributed_trace_async
    async def get(self, name: str, **kwargs: Any) -> _models.Model:
