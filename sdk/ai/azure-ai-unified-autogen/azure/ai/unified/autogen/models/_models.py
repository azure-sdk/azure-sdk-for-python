...
class AadCredential(BaseCredential, discriminator="AAD"):
    ...
    type: Literal[CredentialType.AAD] = rest_discriminator(name="type", visibility=["read", "create", "update", "delete", "query"])  # type: ignore
    """Required."""
...
class ApiKeyCredential(BaseCredential, discriminator="ApiKey"):
    ...
    """API Key. Required."""
    type: Literal[CredentialType.API_KEY] = rest_discriminator(name="type", visibility=["read", "create", "update", "delete", "query"])  # type: ignore
    """Required."""
...
class ResourceBase(_model_base.Model):
    ...
    :ivar id: A unique identifier for the asset.
    :vartype id: str
...
class Connection(_model_base.Model):
    ...
    :vartype category: str or ~azure.ai.unified.autogen.models.ConnectionType
    ...
    category: Union[str, "_models.ConnectionType"] = rest_field(visibility=["read"])
...
class DatasetContainer(AssetContainer):
...
class Model(_model_base.Model):
    ...
    :ivar name: Name of the deployment for the model. Required.
    :vartype name: str
...
class SasCredential(BaseCredential, discriminator="SAS"):
    ...
    """SAS Token. Required."""
    type: Literal[CredentialType.SAS] = rest_discriminator(name="type", visibility=["read", "create", "update", "delete", "query"])  # type: ignore
    """Required."""
