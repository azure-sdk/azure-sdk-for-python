...
class AIEvaluationsClientConfiguration:  # pylint: disable=too-many-instance-attributes
    """Configuration for AIEvaluationsClient.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        kwargs.setdefault("sdk_moniker", "ai-evaluations/{}".format(VERSION))
