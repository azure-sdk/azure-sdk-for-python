...
class EvaluationsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.ai.evaluations.AIEvaluationsClient`'s
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._config: AIEvaluationsClientConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
    ...
    def get(self, id: str, **kwargs: Any) -> _models.Evaluation:
        ...
        :rtype: ~azure.ai.evaluations.models.Evaluation
    ...
    def create(
        ...
        :type evaluation: ~azure.ai.evaluations.models.Evaluation
    ...
    def create(self, evaluation: Union[_models.Evaluation, JSON, IO[bytes]], **kwargs: Any) -> _models.Evaluation:
        ...
        :param evaluation: Evaluation to run. Is one of the following types: Evaluation, JSON,
         IO[bytes] Required.
        :type evaluation: ~azure.ai.evaluations.models.Evaluation or JSON or IO[bytes]
        :return: Evaluation. The Evaluation is compatible with MutableMapping
        :rtype: ~azure.ai.evaluations.models.Evaluation
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.evaluations.models.Evaluation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.ai.evaluations.models.Evaluation
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
    ...
    def update(
        ...
        :param resource: The resource instance. Is one of the following types: Evaluation, JSON,
         IO[bytes] Required.
        :type resource: ~azure.ai.evaluations.models.Evaluation or JSON or IO[bytes]
        :return: Evaluation. The Evaluation is compatible with MutableMapping
        :rtype: ~azure.ai.evaluations.models.Evaluation
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def get_schedule(self, name: str, **kwargs: Any) -> _models.EvaluationSchedule:
        ...
        :rtype: ~azure.ai.evaluations.models.EvaluationSchedule
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def create_or_replace_schedule(
        ...
        :type name: str
        :param resource: The resource instance. Required.
        :type resource: ~azure.ai.evaluations.models.EvaluationSchedule
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: EvaluationSchedule. The EvaluationSchedule is compatible with MutableMapping
    ...
    def create_or_replace_schedule(
        ...
        :type resource: ~azure.ai.evaluations.models.EvaluationSchedule or JSON or IO[bytes]
        :return: EvaluationSchedule. The EvaluationSchedule is compatible with MutableMapping
        :rtype: ~azure.ai.evaluations.models.EvaluationSchedule
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_schedule(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.evaluations.models.EvaluationSchedule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
