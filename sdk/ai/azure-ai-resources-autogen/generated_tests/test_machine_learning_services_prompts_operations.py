...
class TestMachineLearningServicesPromptsOperations(MachineLearningServicesClientTestBase):
    ...
    @recorded_by_proxy
    def test_get(self, machinelearningservices_endpoint):
    ...
    @MachineLearningServicesPreparer()
    @recorded_by_proxy
    def test_create_or_update(self, machinelearningservices_endpoint):
        client = self.create_client(endpoint=machinelearningservices_endpoint)
    ...
    @MachineLearningServicesPreparer()
    @recorded_by_proxy
    def test_list(self, machinelearningservices_endpoint):
        client = self.create_client(endpoint=machinelearningservices_endpoint)
    ...
    @MachineLearningServicesPreparer()
    @recorded_by_proxy
    def test_get_latest(self, machinelearningservices_endpoint):
        client = self.create_client(endpoint=machinelearningservices_endpoint)
    ...
    @MachineLearningServicesPreparer()
    @recorded_by_proxy
    def test_get_next_version(self, machinelearningservices_endpoint):
        client = self.create_client(endpoint=machinelearningservices_endpoint)
    ...
    @MachineLearningServicesPreparer()
    @recorded_by_proxy
    def test_list_latest(self, machinelearningservices_endpoint):
        client = self.create_client(endpoint=machinelearningservices_endpoint)
