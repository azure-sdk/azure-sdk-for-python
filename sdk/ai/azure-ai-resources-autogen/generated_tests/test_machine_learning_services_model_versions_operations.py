...
class TestMachineLearningServicesModelVersionsOperations(MachineLearningServicesClientTestBase):
    @MachineLearningServicesPreparer()
    @recorded_by_proxy
    def test_model_versions_list(self, machinelearningservices_endpoint):
