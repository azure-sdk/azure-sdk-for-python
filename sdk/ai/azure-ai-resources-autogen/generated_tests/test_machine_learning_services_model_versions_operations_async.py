...
class TestMachineLearningServicesModelVersionsOperationsAsync(MachineLearningServicesClientTestBaseAsync):
    @MachineLearningServicesPreparer()
    @recorded_by_proxy_async
    async def test_model_versions_list(self, machinelearningservices_endpoint):
