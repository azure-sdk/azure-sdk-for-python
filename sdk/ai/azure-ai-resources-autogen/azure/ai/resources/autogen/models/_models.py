...
class Index(_model_base.Model):
    ...
    :ivar stage: Update stage to 'Archive' to archive the asset. Default is Development, which
     means the asset is under development. Required.
    :vartype stage: str
...
class PagedIndex(_model_base.Model):
    ...
    :vartype value: list[~azure.ai.resources.autogen.models.Index]
...
class PagedPrompt(_model_base.Model):
    """Paged collection of PromptVersion items.

    All required parameters must be populated in order to send to server.

    :ivar value: The list of Prompts. Required.
    :vartype value: list[~azure.ai.resources.autogen.models.Prompt]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """

    value: List["_models.Prompt"] = rest_field()
    """The list of Prompts. Required."""
    next_link: Optional[str] = rest_field(name="nextLink")
    """The link to the next page of items."""
