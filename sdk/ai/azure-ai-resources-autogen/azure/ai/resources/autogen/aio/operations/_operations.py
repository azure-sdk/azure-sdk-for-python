            ...
            .. code-block:: python
                ...
                response == {
                    "id": "str",  # Fully qualified resource Id:
                      ...
                      index. Required.
                    "stage": "str",  # Update stage to 'Archive' to archive the asset. Default is
                    ...
                    "properties": {
                        "str": "str"  # Optional. Asset's properties. Unlike tags, properties
                          are add-only. Once added, a property cannot be removed.
                    },
                    "systemData": {
                    ...
                    "tags": {
                        "str": "str"  # Optional. Asset's tags. Unlike properties, tags are
                          fully mutable.
                    }
                }
        """
        ...
        Example:
            .. code-block:: python
                ...
                response == {
                    ...
                    "nextVersion": 0  # Optional. Next version as defined by the server. The
                      server keeps track of all versions that are string-representations of integers.
                      If one exists, the nextVersion will be a string representation of the highest
                      integer value + 1. Otherwise, the nextVersion will default to '1'.
                }
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def get(self, name: str, version: str, **kwargs: Any) -> _models.Prompt:
        ...
        Example:
            .. code-block:: python
                ...
                # response body for status code(s): 200
                response == {
                    "dataUri": "str",  # Default workspace blob storage Ui. Should work across
                      storage types and auth scenarios. Required.
                    "id": "str",  # Fully qualified resource Id:
                      azureml://workspace/{workspaceName}/indexes/{name}/versions/{version} of the
                      index. Required.
                    "stage": "str",  # Update stage to 'Archive' to archive the asset. Default is
                      Development, which means the asset is under development. Required.
                    "templatePath": "str",  # Relative path of the prompt data file at the
                      dataUri location. Required.
                    "description": "str",  # Optional. Description information of the asset.
                    "properties": {
                        "str": "str"  # Optional. Asset's properties. Unlike tags, properties
                          are add-only. Once added, a property cannot be removed.
