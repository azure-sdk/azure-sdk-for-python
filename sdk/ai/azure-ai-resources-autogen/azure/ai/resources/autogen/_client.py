...
class MachineLearningServicesClient(
    ...
    :vartype connections: azure.ai.resources.autogen.operations.ConnectionsOperations
    :ivar data: DataOperations operations
    :vartype data: azure.ai.resources.autogen.operations.DataOperations
    :ivar data_versions_base: DataVersionsBaseOperations operations
    :vartype data_versions_base: azure.ai.resources.autogen.operations.DataVersionsBaseOperations
    :ivar evaluations: EvaluationsOperations operations
    :vartype evaluations: azure.ai.resources.autogen.operations.EvaluationsOperations
    ...
    :vartype model_containers: azure.ai.resources.autogen.operations.ModelContainersOperations
    :ivar model_versions: ModelVersionsOperations operations
    :vartype model_versions: azure.ai.resources.autogen.operations.ModelVersionsOperations
    ...
    def __init__(self, endpoint: str, project_name: str, credential: "TokenCredential", **kwargs: Any) -> None:
