...
from ._configuration import MyClientNameClientConfiguration
...
class MyClientNameClient:  # pylint: disable=client-accepts-api-version-keyword
    """MyClientNameClient.
    ...
    def __init__(self, endpoint: str, credential: "TokenCredential", **kwargs: Any) -> None:
        _endpoint = "{endpoint}"
        self._config = MyClientNameClientConfiguration(endpoint=endpoint, credential=credential, **kwargs)
