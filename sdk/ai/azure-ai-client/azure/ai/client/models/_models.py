...
class AppInsightsConfiguration(InputData, discriminator="app_insights"):
    ...
    :ivar connection_string: Connection String to connect to AppInsights.
...
class EvaluationSchedule(_model_base.Model):
    ...
    :ivar id: Unique identifier for the evaluation, which also serves as the name for the schedule.
     Required.
    :vartype id: str
    :ivar data: Data for evaluation. Required.
    :vartype data: ~azure.ai.client.models.AppInsightsConfiguration
    :ivar description: Description of the evaluation. It can be used to store additional
     information about the evaluation and is mutable.
    :vartype description: str
    :ivar system_data: Metadata containing createdBy and modifiedBy information.
    ...
    id: str = rest_field(visibility=["read"])
    """Unique identifier for the evaluation, which also serves as the name for the schedule. Required."""
    data: "_models.AppInsightsConfiguration" = rest_field(visibility=["read", "create"])
    """Data for evaluation. Required."""
    description: Optional[str] = rest_field()
    """Description of the evaluation. It can be used to store additional information about the
     evaluation and is mutable."""
    ...
    def __init__(
        self,
        *,
        data: "_models.AppInsightsConfiguration",
        evaluators: Dict[str, "_models.EvaluatorConfiguration"],
