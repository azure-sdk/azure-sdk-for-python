...
def build_evaluation_schedules_create_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_evaluation_schedules_get_request(id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_evaluation_schedules_list_request(
    *, top: Optional[int] = None, skip: Optional[int] = None, maxpagesize: Optional[int] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_evaluation_schedules_list_schedule_evaluations_request(  # pylint: disable=name-too-long
...
def build_evaluation_schedules_delete_request(id: str, **kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class EvaluationsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.ai.evaluation.autogen.MachineLearningServicesClient`'s
    ...
    def get(self, id: str, **kwargs: Any) -> _models.Evaluation:
        ...
        :rtype: ~azure.ai.evaluation.autogen.models.Evaluation
    ...
    def create(
        ...
        :type body: ~azure.ai.evaluation.autogen.models.Evaluation
    ...
    def create(self, body: Union[_models.Evaluation, JSON, IO[bytes]], **kwargs: Any) -> _models.Evaluation:
        ...
        :param body: Properties of Evaluation. Is one of the following types: Evaluation, JSON,
         IO[bytes] Required.
        :type body: ~azure.ai.evaluation.autogen.models.Evaluation or JSON or IO[bytes]
        :return: Evaluation. The Evaluation is compatible with MutableMapping
        :rtype: ~azure.ai.evaluation.autogen.models.Evaluation
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.evaluation.autogen.models.Evaluation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def update(
        ...
        :type body: ~azure.ai.evaluation.autogen.models.UpdateEvaluationRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: Evaluation. The Evaluation is compatible with MutableMapping
    ...
    def update(
        ...
        :type body: ~azure.ai.evaluation.autogen.models.UpdateEvaluationRequest or JSON or IO[bytes]
        :return: Evaluation. The Evaluation is compatible with MutableMapping
        :rtype: ~azure.ai.evaluation.autogen.models.Evaluation
        :raises ~azure.core.exceptions.HttpResponseError:
        """
...
class EvaluationSchedulesOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through
        :class:`~azure.ai.evaluation.autogen.MachineLearningServicesClient`'s
        :attr:`evaluation_schedules` attribute.
    """
    ...
    def create(
        ...
        :type body: ~azure.ai.evaluation.autogen.models.EvaluationSchedule
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: EvaluationSchedule. The EvaluationSchedule is compatible with MutableMapping
        :rtype: ~azure.ai.evaluation.autogen.models.EvaluationSchedule
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def create(
        ...
        :type body: ~azure.ai.evaluation.autogen.models.EvaluationSchedule or JSON or IO[bytes]
        :return: EvaluationSchedule. The EvaluationSchedule is compatible with MutableMapping
        :rtype: ~azure.ai.evaluation.autogen.models.EvaluationSchedule
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        _request = build_evaluation_schedules_create_request(
            content_type=content_type,
            api_version=self._config.api_version,
            content=_content,
            headers=_headers,
    ...
    @distributed_trace
    def get(self, id: str, **kwargs: Any) -> _models.EvaluationSchedule:
        ...
        _request = build_evaluation_schedules_get_request(
            id=id,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    def list(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.evaluation.autogen.models.EvaluationSchedule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_evaluation_schedules_list_request(
                    top=top,
                    skip=skip,
                    maxpagesize=maxpagesize,
                    api_version=self._config.api_version,
    ...
    def list_schedule_evaluations(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_evaluation_schedules_list_schedule_evaluations_request(
                    id=id,
                    top=top,
                    skip=skip,
                    maxpagesize=maxpagesize,
    ...
    def delete(self, id: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_evaluation_schedules_delete_request(
            id=id,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
