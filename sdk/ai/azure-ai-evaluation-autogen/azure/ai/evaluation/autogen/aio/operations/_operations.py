...
from ...operations._operations import (
    build_evaluation_schedules_create_request,
    build_evaluation_schedules_delete_request,
    build_evaluation_schedules_get_request,
    build_evaluation_schedules_list_request,
    build_evaluation_schedules_list_schedule_evaluations_request,
...
class EvaluationsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.ai.evaluation.autogen.aio.MachineLearningServicesClient`'s
    ...
    def list(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.ai.evaluation.autogen.models.Evaluation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class EvaluationSchedulesOperations:
    ...
    @distributed_trace_async
    async def get(self, id: str, **kwargs: Any) -> _models.EvaluationSchedule:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.evaluation.autogen.models.EvaluationSchedule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
