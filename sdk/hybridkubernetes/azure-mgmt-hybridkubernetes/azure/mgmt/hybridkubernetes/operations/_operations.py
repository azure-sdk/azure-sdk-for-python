...
def build_connected_clusters_get_request(
...
def build_connected_clusters_create_or_replace_request(  # pylint: disable=name-too-long
    resource_group_name: str, cluster_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_connected_clusters_update_request(
    resource_group_name: str, cluster_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_connected_clusters_delete_request(
    resource_group_name: str, cluster_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_connected_clusters_list_by_resource_group_request(  # pylint: disable=name-too-long
...
def build_connected_clusters_list_by_subscription_request(  # pylint: disable=name-too-long
...
def build_connected_clusters_list_cluster_user_credential_request(  # pylint: disable=name-too-long
    resource_group_name: str, cluster_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ConnectedClustersOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through
        :class:`~azure.mgmt.hybridkubernetes.KubernetesClient`'s
        :attr:`connected_clusters` attribute.
    """
    ...
    def get(self, resource_group_name: str, cluster_name: str, **kwargs: Any) -> _models.ConnectedCluster:
        ...
        _request = build_connected_clusters_get_request(
    ...
    def _create_or_replace_initial(
        ...
        **kwargs: Any
        ...
        _request = build_connected_clusters_create_or_replace_request(
            resource_group_name=resource_group_name,
            cluster_name=cluster_name,
            subscription_id=self._config.subscription_id,
    ...
    def update(
        ...
        **kwargs: Any
        ...
        _request = build_connected_clusters_update_request(
            resource_group_name=resource_group_name,
            cluster_name=cluster_name,
            subscription_id=self._config.subscription_id,
            content_type=content_type,
    ...
    def _delete_initial(self, resource_group_name: str, cluster_name: str, **kwargs: Any) -> Iterator[bytes]:
        ...
        _request = build_connected_clusters_delete_request(
            resource_group_name=resource_group_name,
            cluster_name=cluster_name,
            subscription_id=self._config.subscription_id,
            api_version=self._config.api_version,
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.ConnectedCluster"]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_connected_clusters_list_by_resource_group_request(
                    resource_group_name=resource_group_name,
                    subscription_id=self._config.subscription_id,
                    api_version=self._config.api_version,
                    headers=_headers,
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.ConnectedCluster"]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_connected_clusters_list_by_subscription_request(
                    subscription_id=self._config.subscription_id,
                    api_version=self._config.api_version,
                    headers=_headers,
                    params=_params,
    ...
    def list_cluster_user_credential(
        ...
        **kwargs: Any
        ...
        _request = build_connected_clusters_list_cluster_user_credential_request(
            resource_group_name=resource_group_name,
            cluster_name=cluster_name,
            subscription_id=self._config.subscription_id,
            content_type=content_type,
