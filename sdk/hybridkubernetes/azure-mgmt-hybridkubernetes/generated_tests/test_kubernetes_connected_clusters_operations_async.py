...
class TestKubernetesConnectedClustersOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(KubernetesClient, is_async=True)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_connected_clusters_get(self, resource_group):
        response = await self.client.connected_clusters.get(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_connected_clusters_begin_create_or_replace(self, resource_group):
        response = await (
            await self.client.connected_clusters.begin_create_or_replace(
                resource_group_name=resource_group.name,
                cluster_name="str",
                connected_cluster={
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_connected_clusters_update(self, resource_group):
        response = await self.client.connected_clusters.update(
            resource_group_name=resource_group.name,
            cluster_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_connected_clusters_begin_delete(self, resource_group):
        response = await (
            await self.client.connected_clusters.begin_delete(
                resource_group_name=resource_group.name,
                cluster_name="str",
            )
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_connected_clusters_list_by_resource_group(self, resource_group):
        response = self.client.connected_clusters.list_by_resource_group(
            resource_group_name=resource_group.name,
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_connected_clusters_list_by_subscription(self, resource_group):
        response = self.client.connected_clusters.list_by_subscription()
        result = [r async for r in response]
        # please add some check logic here by yourself
        # ...
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_connected_clusters_list_cluster_user_credential(self, resource_group):
        response = await self.client.connected_clusters.list_cluster_user_credential(
            resource_group_name=resource_group.name,
            cluster_name="str",
