...
class TestConnectedKubernetesConnectedClusterOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_begin_create_or_update(self, resource_group):
        response = await (
            await self.client.connected_cluster.begin_create_or_update(
                ...
                api_version="2024-07-15-preview",
            )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_list_cluster_user_credential(self, resource_group):
