...
class TestKustoManagementDatabasesOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_check_name_availability(self, resource_group):
        response = await self.client.databases.check_name_availability(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_list_principals(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_add_principals(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_remove_principals(self, resource_group):
        response = await self.client.databases.remove_principals(
            resource_group_name=resource_group.name,
            cluster_name="str",
            database_name="str",
