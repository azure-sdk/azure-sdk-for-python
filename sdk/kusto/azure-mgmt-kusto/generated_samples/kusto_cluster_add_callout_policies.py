...
# USAGE
    python kusto_cluster_add_callout_policies.py
...
def main():
    ...
    client.clusters.begin_add_callout_policies(
        resource_group_name="kustorptest",
        cluster_name="kustoCluster",
        callout_policies={"value": [{"calloutType": "kusto", "calloutUriRegex": "*", "outboundAccess": "Allow"}]},
    ).result()
