...
# USAGE
    python kusto_data_connections_check_name_availability.py
...
def main():
    ...
    response = client.data_connections.check_name_availability(
        resource_group_name="kustorptest",
        cluster_name="kustoCluster",
        database_name="KustoDatabase8",
        data_connection_name={"name": "DataConnections8", "type": "Microsoft.Kusto/clusters/databases/dataConnections"},
    )
    print(response)
