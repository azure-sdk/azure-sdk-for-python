...
# USAGE
    python kusto_sandbox_custom_images_create_or_update_with_managed_base_image.py
...
def main():
    ...
    response = client.sandbox_custom_images.begin_create_or_update(
        resource_group_name="kustorptest",
        cluster_name="kustoCluster",
        sandbox_custom_image_name="customImage2",
        parameters={
            "properties": {"baseImageName": "Python3_10_8", "language": "Python", "requirementsFileContent": "Requests"}
        },
    ).result()
    print(response)
