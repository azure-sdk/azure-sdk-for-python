...
class UeInfo4G(ExtendedUeInfoProperties):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar mcc: Mobile country code (MCC).
    :vartype mcc: str
    :ivar mnc: Mobile network code (MNC).
    :vartype mnc: str
    :ivar location_type: Location Type.
    :vartype location_type: str
    :ivar tac: Type Allocation Code of UE.
    :vartype tac: str
    :ivar plmn_info_connection_info_location_info_plmn: PLMN Identifier.
    :vartype plmn_info_connection_info_location_info_plmn: ~azure.mgmt.mobilenetwork.models.PlmnId
    :ivar plmn_info_guti_plmn: Public land mobile network (PLMN) ID. This is made up of the mobile
     country code and mobile network code, as defined in https://www.itu.int/rec/T-REC-E.212. The
     values 001-01 and 001-001 can be used for testing and the values 999-99 and 999-999 can be used
     on internal private networks. Required.
    :vartype plmn_info_guti_plmn: ~azure.mgmt.mobilenetwork.models.PlmnId
    ...
    _validation = {
        ...
        "plmn_info_guti_plmn": {"required": True},
    ...
    _attribute_map = {
        ...
        "mcc": {"key": "info.connectionInfo.globalRanNodeId.plmnId.mcc", "type": "str"},
        "mnc": {"key": "info.connectionInfo.globalRanNodeId.plmnId.mnc", "type": "str"},
        ...
        "plmn_info_connection_info_location_info_plmn": {
            "key": "info.connectionInfo.locationInfo.plmn",
            "type": "PlmnId",
        },
        "plmn_info_guti_plmn": {"key": "info.guti.plmn", "type": "PlmnId"},
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        *,
        imsi: str,
        plmn_info_guti_plmn: "_models.PlmnId",
        m_tmsi: int,
        group_id: int,
        code: int,
        last_read_at: Optional[datetime.datetime] = None,
        ...
        plmn_info_connection_info_location_info_plmn: Optional["_models.PlmnId"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword last_read_at: The timestamp of last UE info read from the packet core (UTC).
        ...
        :keyword mcc: Mobile country code (MCC).
        :paramtype mcc: str
        :keyword mnc: Mobile network code (MNC).
        :paramtype mnc: str
        :keyword location_type: Location Type.
        :paramtype location_type: str
        :keyword tac: Type Allocation Code of UE.
        :paramtype tac: str
        :keyword plmn_info_connection_info_location_info_plmn: PLMN Identifier.
        :paramtype plmn_info_connection_info_location_info_plmn:
         ~azure.mgmt.mobilenetwork.models.PlmnId
        :keyword plmn_info_guti_plmn: Public land mobile network (PLMN) ID. This is made up of the
         mobile country code and mobile network code, as defined in https://www.itu.int/rec/T-REC-E.212.
         The values 001-01 and 001-001 can be used for testing and the values 999-99 and 999-999 can be
         used on internal private networks. Required.
        :paramtype plmn_info_guti_plmn: ~azure.mgmt.mobilenetwork.models.PlmnId
        ...
        self.tac = tac
        self.plmn_info_connection_info_location_info_plmn = plmn_info_connection_info_location_info_plmn
        self.plmn_info_guti_plmn = plmn_info_guti_plmn
        self.m_tmsi = m_tmsi
...
class UeInfo5G(ExtendedUeInfoProperties):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar plmn_info_connection_info_location_info_plmn: PLMN Identifier.
    :vartype plmn_info_connection_info_location_info_plmn: ~azure.mgmt.mobilenetwork.models.PlmnId
    :ivar plmn_info_fiveg_guti_plmn: Public land mobile network (PLMN) ID. This is made up of the
     mobile country code and mobile network code, as defined in https://www.itu.int/rec/T-REC-E.212.
     The values 001-01 and 001-001 can be used for testing and the values 999-99 and 999-999 can be
     used on internal private networks. Required.
    :vartype plmn_info_fiveg_guti_plmn: ~azure.mgmt.mobilenetwork.models.PlmnId
    ...
    _validation = {
        ...
        "mnc": {"pattern": r"^\d{2,3}$"},
        "tac": {"pattern": r"(^[A-Fa-f0-9]{4}$)|(^[A-Fa-f0-9]{6}$)"},
        "plmn_info_fiveg_guti_plmn": {"required": True},
    ...
    _attribute_map = {
        ...
        "plmn_info_fiveg_guti_plmn": {"key": "info.fivegGuti.plmn", "type": "PlmnId"},
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        *,
        supi: str,
        plmn_info_fiveg_guti_plmn: "_models.PlmnId",
        fiveg_tmsi: int,
        region_id: int,
        set_id: int,
        pointer: int,
        ...
        **kwargs: Any
        ...
        :paramtype plmn_info_connection_info_location_info_plmn:
         ~azure.mgmt.mobilenetwork.models.PlmnId
        :keyword plmn_info_fiveg_guti_plmn: Public land mobile network (PLMN) ID. This is made up of
         the mobile country code and mobile network code, as defined in
         https://www.itu.int/rec/T-REC-E.212. The values 001-01 and 001-001 can be used for testing and
         the values 999-99 and 999-999 can be used on internal private networks. Required.
        :paramtype plmn_info_fiveg_guti_plmn: ~azure.mgmt.mobilenetwork.models.PlmnId
        ...
        self.tac = tac
        self.plmn_info_connection_info_location_info_plmn = plmn_info_connection_info_location_info_plmn
        self.plmn_info_fiveg_guti_plmn = plmn_info_fiveg_guti_plmn
