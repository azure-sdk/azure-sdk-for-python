...
class AttachedDataNetworksOperations:
    ...
    async def _create_or_update_initial(
        ...
        packet_core_data_plane_name: str,
        attached_data_network_name: str,
        resource: Union[_models.AttachedDataNetwork, IO[bytes]],
        **kwargs: Any
    ) -> _models.AttachedDataNetwork:
        error_map = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "AttachedDataNetwork")
    ...
    async def begin_create_or_update(
        ...
        packet_core_data_plane_name: str,
        attached_data_network_name: str,
        resource: _models.AttachedDataNetwork,
        *,
        ...
        **kwargs: Any
        ...
        :param resource: Parameters supplied to the create or update attached data network operation.
         Required.
        :type resource: ~azure.mgmt.mobilenetwork.models.AttachedDataNetwork
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.mobilenetwork.models.AttachedDataNetwork or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either AttachedDataNetwork or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.mobilenetwork.models.AttachedDataNetwork]
    ...
    async def update_tags(
        ...
        **kwargs: Any
        ...
        :param attached_data_network_name: The name of the attached data network. Required.
        :type attached_data_network_name: str
        :param properties: Parameters supplied to update attached data network tags. Required.
    ...
    async def update_tags(
        ...
        **kwargs: Any
        ...
        :param attached_data_network_name: The name of the attached data network. Required.
        :type attached_data_network_name: str
        :param properties: Parameters supplied to update attached data network tags. Is either a
