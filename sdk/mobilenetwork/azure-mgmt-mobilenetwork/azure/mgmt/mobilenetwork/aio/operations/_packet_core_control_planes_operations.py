...
class PacketCoreControlPlanesOperations:
    ...
    async def _create_or_update_initial(
        ...
        resource: Union[_models.PacketCoreControlPlane, IO[bytes]],
        **kwargs: Any
    ) -> _models.PacketCoreControlPlane:
        error_map = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "PacketCoreControlPlane")
    ...
    async def begin_create_or_update(
        ...
        resource_group_name: str,
        packet_core_control_plane_name: str,
        resource: _models.PacketCoreControlPlane,
        *,
        ...
        **kwargs: Any
        ...
        :param packet_core_control_plane_name: The name of the packet core control plane. Required.
        :type packet_core_control_plane_name: str
        :param resource: Parameters supplied to the create or update packet core control plane
         operation. Required.
        :type resource: ~azure.mgmt.mobilenetwork.models.PacketCoreControlPlane
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.mobilenetwork.models.PacketCoreControlPlane or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either PacketCoreControlPlane or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.mobilenetwork.models.PacketCoreControlPlane]
    ...
    async def update_tags(
        ...
        **kwargs: Any
        ...
        :param packet_core_control_plane_name: The name of the packet core control plane. Required.
        :type packet_core_control_plane_name: str
        :param properties: Parameters supplied to patch packet core control plane resource. Required.
    ...
    async def update_tags(
        ...
        **kwargs: Any
        ...
        :param packet_core_control_plane_name: The name of the packet core control plane. Required.
        :type packet_core_control_plane_name: str
        :param properties: Parameters supplied to patch packet core control plane resource. Is either a
    ...
    async def _collect_diagnostics_package_initial(
        ...
        resource_group_name: str,
        packet_core_control_plane_name: str,
        body: Union[_models.PacketCoreControlPlaneCollectDiagnosticsPackage, IO[bytes]],
        **kwargs: Any
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "PacketCoreControlPlaneCollectDiagnosticsPackage")
    ...
    async def begin_collect_diagnostics_package(
        ...
        resource_group_name: str,
        packet_core_control_plane_name: str,
        body: _models.PacketCoreControlPlaneCollectDiagnosticsPackage,
        *,
        content_type: str = "application/json",
        **kwargs: Any
        ...
        :param body: Parameters supplied to the packet core control plane collect diagnostics package
         operation. Required.
        :type body: ~azure.mgmt.mobilenetwork.models.PacketCoreControlPlaneCollectDiagnosticsPackage
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    async def begin_collect_diagnostics_package(
        ...
        **kwargs: Any
        ...
        :type packet_core_control_plane_name: str
        :param body: Parameters supplied to the packet core control plane collect diagnostics package
         operation. Is either a PacketCoreControlPlaneCollectDiagnosticsPackage type or a IO[bytes]
         type. Required.
        :type body: ~azure.mgmt.mobilenetwork.models.PacketCoreControlPlaneCollectDiagnosticsPackage or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either AsyncOperationStatus or the result
         of cls(response)
        :rtype:
