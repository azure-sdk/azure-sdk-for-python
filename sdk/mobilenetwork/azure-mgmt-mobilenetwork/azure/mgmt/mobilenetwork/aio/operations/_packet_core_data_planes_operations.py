...
class PacketCoreDataPlanesOperations:
    ...
    async def _create_or_update_initial(
        ...
        packet_core_control_plane_name: str,
        packet_core_data_plane_name: str,
        resource: Union[_models.PacketCoreDataPlane, IO[bytes]],
        **kwargs: Any
    ) -> _models.PacketCoreDataPlane:
        error_map = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "PacketCoreDataPlane")
    ...
    async def begin_create_or_update(
        ...
        packet_core_control_plane_name: str,
        packet_core_data_plane_name: str,
        resource: _models.PacketCoreDataPlane,
        *,
        ...
        **kwargs: Any
        ...
        :param resource: Parameters supplied to the create or update packet core data plane operation.
         Required.
        :type resource: ~azure.mgmt.mobilenetwork.models.PacketCoreDataPlane
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type packet_core_data_plane_name: str
        :param resource: Parameters supplied to the create or update packet core data plane operation.
         Is either a PacketCoreDataPlane type or a IO[bytes] type. Required.
        :type resource: ~azure.mgmt.mobilenetwork.models.PacketCoreDataPlane or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either PacketCoreDataPlane or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.mobilenetwork.models.PacketCoreDataPlane]
    ...
    async def update_tags(
        ...
        **kwargs: Any
        ...
        :param packet_core_data_plane_name: The name of the packet core data plane. Required.
        :type packet_core_data_plane_name: str
        :param properties: Parameters supplied to update packet core data plane tags. Required.
    ...
    async def update_tags(
        ...
        **kwargs: Any
        ...
        :param packet_core_data_plane_name: The name of the packet core data plane. Required.
        :type packet_core_data_plane_name: str
        :param properties: Parameters supplied to update packet core data plane tags. Is either a
