...
class MobileNetworksOperations:
    ...
    async def _create_or_update_initial(
        ...
        resource: Union[_models.MobileNetwork, IO[bytes]],
        **kwargs: Any
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "MobileNetwork")
    ...
    async def begin_create_or_update(
        ...
        resource_group_name: str,
        mobile_network_name: str,
        resource: _models.MobileNetwork,
        *,
        ...
        **kwargs: Any
        ...
        :param resource: Parameters supplied to the create or update mobile network operation.
         Required.
        :type resource: ~azure.mgmt.mobilenetwork.models.MobileNetwork
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param mobile_network_name: The name of the mobile network. Required.
        :type mobile_network_name: str
        :param resource: Parameters supplied to the create or update mobile network operation. Is
         either a MobileNetwork type or a IO[bytes] type. Required.
        :type resource: ~azure.mgmt.mobilenetwork.models.MobileNetwork or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either MobileNetwork or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.mobilenetwork.models.MobileNetwork]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def update_tags(
        ...
        **kwargs: Any
        ...
        :param mobile_network_name: The name of the mobile network. Required.
        :type mobile_network_name: str
        :param properties: Parameters supplied to update mobile network tags and/or identity. Required.
    ...
    async def update_tags(
        ...
        **kwargs: Any
        ...
        :param mobile_network_name: The name of the mobile network. Required.
        :type mobile_network_name: str
        :param properties: Parameters supplied to update mobile network tags and/or identity. Is either
