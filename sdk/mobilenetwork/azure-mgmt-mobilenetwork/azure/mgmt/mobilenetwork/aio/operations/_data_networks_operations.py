...
class DataNetworksOperations:
    ...
    async def _create_or_update_initial(
        ...
        resource: Union[_models.DataNetwork, IO[bytes]],
        **kwargs: Any
    ) -> _models.DataNetwork:
        error_map = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "DataNetwork")
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param data_network_name: The name of the data network. Required.
        :type data_network_name: str
        :param resource: Parameters supplied to the create or update data network operation. Required.
        :type resource: ~azure.mgmt.mobilenetwork.models.DataNetwork
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param data_network_name: The name of the data network. Required.
        :type data_network_name: str
        :param resource: Parameters supplied to the create or update data network operation. Is either
         a DataNetwork type or a IO[bytes] type. Required.
        :type resource: ~azure.mgmt.mobilenetwork.models.DataNetwork or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either DataNetwork or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.mobilenetwork.models.DataNetwork]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def update_tags(
        ...
        **kwargs: Any
        ...
        :param data_network_name: The name of the data network. Required.
        :type data_network_name: str
        :param properties: Parameters supplied to update data network tags. Required.
    ...
    async def update_tags(
        ...
        **kwargs: Any
        ...
        :param data_network_name: The name of the data network. Required.
        :type data_network_name: str
        :param properties: Parameters supplied to update data network tags. Is either a TagsObject type
