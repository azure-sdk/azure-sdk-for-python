...
class SitesOperations:
    ...
    async def _create_or_update_initial(
        ...
        site_name: str,
        resource: Union[_models.Site, IO[bytes]],
        **kwargs: Any
    ) -> _models.Site:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Parameters supplied to the create or update mobile network site operation.
         Required.
        :type resource: ~azure.mgmt.mobilenetwork.models.Site
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param site_name: The name of the mobile network site. Required.
        :type site_name: str
        :param resource: Parameters supplied to the create or update mobile network site operation. Is
         either a Site type or a IO[bytes] type. Required.
        :type resource: ~azure.mgmt.mobilenetwork.models.Site or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Site or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.mobilenetwork.models.Site]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update_tags(
        ...
        **kwargs: Any
        ...
        :param site_name: The name of the mobile network site. Required.
        :type site_name: str
        :param properties: Parameters supplied to update network site tags. Required.
    ...
    async def update_tags(
        ...
        **kwargs: Any
        ...
        :param site_name: The name of the mobile network site. Required.
        :type site_name: str
        :param properties: Parameters supplied to update network site tags. Is either a TagsObject type
    ...
    async def _delete_packet_core_initial(
        self,
        resource_group_name: str,
        mobile_network_name: str,
        site_name: str,
        body: Union[_models.SiteDeletePacketCore, IO[bytes]],
        **kwargs: Any
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "SiteDeletePacketCore")
    ...
    async def begin_delete_packet_core(
        ...
        mobile_network_name: str,
        site_name: str,
        body: _models.SiteDeletePacketCore,
        *,
        content_type: str = "application/json",
        **kwargs: Any
        ...
        :param site_name: The name of the mobile network site. Required.
        :type site_name: str
        :param body: Parameters supplied to delete a packet core under a site. Required.
        :type body: ~azure.mgmt.mobilenetwork.models.SiteDeletePacketCore
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    async def begin_delete_packet_core(
        ...
        **kwargs: Any
        ...
        :param site_name: The name of the mobile network site. Required.
        :type site_name: str
        :param body: Parameters supplied to delete a packet core under a site. Is either a
         SiteDeletePacketCore type or a IO[bytes] type. Required.
        :type body: ~azure.mgmt.mobilenetwork.models.SiteDeletePacketCore or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either AsyncOperationStatus or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.mobilenetwork.models.AsyncOperationStatus]
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._delete_packet_core_initial(
                resource_group_name=resource_group_name,
                mobile_network_name=mobile_network_name,
                site_name=site_name,
                body=body,
