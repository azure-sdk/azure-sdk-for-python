...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "packetCaptureName": _SERIALIZER.url(
            "packet_capture_name", packet_capture_name, "str", max_length=64, pattern=r"^[a-zA-Z0-9][a-zA-Z0-9_-]*$"
        ),
    }
...
class PacketCapturesOperations:
    ...
    def list_by_packet_core_control_plane(
    ...
    ) -> Iterable["_models.PacketCapture"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.mobilenetwork.models.PacketCapture]
    ...
    def _create_or_update_initial(
        ...
        packet_core_control_plane_name: str,
        packet_capture_name: str,
        resource: Union[_models.PacketCapture, IO[bytes]],
        **kwargs: Any
    ) -> _models.PacketCapture:
        error_map = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "PacketCapture")
    ...
    def begin_create_or_update(
        ...
        packet_core_control_plane_name: str,
        packet_capture_name: str,
        resource: _models.PacketCapture,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.PacketCapture]:
        ...
        :param resource: Parameters supplied to the create or update packet capture operation.
         Required.
        :type resource: ~azure.mgmt.mobilenetwork.models.PacketCapture
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either PacketCapture or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.mobilenetwork.models.PacketCapture]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param packet_capture_name: The name of the packet capture session. Required.
        :type packet_capture_name: str
        :param resource: Parameters supplied to the create or update packet capture operation. Is
         either a PacketCapture type or a IO[bytes] type. Required.
        :type resource: ~azure.mgmt.mobilenetwork.models.PacketCapture or IO[bytes]
        :return: An instance of LROPoller that returns either PacketCapture or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.mobilenetwork.models.PacketCapture]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return LROPoller[_models.PacketCapture].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.PacketCapture](
