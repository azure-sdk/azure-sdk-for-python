...
class ServicesOperations:
    ...
    def _create_or_update_initial(
        ...
        service_name: str,
        resource: Union[_models.Service, IO[bytes]],
        **kwargs: Any
    ) -> _models.Service:
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param service_name: The name of the service. You must not use any of the following reserved
         strings - ``default``\ , ``requested`` or ``service``. Required.
        :type service_name: str
        :param resource: Parameters supplied to the create or update service operation. Required.
        :type resource: ~azure.mgmt.mobilenetwork.models.Service
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param service_name: The name of the service. You must not use any of the following reserved
         strings - ``default``\ , ``requested`` or ``service``. Required.
        :type service_name: str
        :param resource: Parameters supplied to the create or update service operation. Is either a
         Service type or a IO[bytes] type. Required.
        :type resource: ~azure.mgmt.mobilenetwork.models.Service or IO[bytes]
        :return: An instance of LROPoller that returns either Service or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.mobilenetwork.models.Service]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update_tags(
        ...
        **kwargs: Any
        ...
        :param service_name: The name of the service. You must not use any of the following reserved
         strings - ``default``\ , ``requested`` or ``service``. Required.
        :type service_name: str
        :param properties: Parameters supplied to update service tags. Required.
    ...
    def update_tags(
        ...
        **kwargs: Any
        ...
        :param service_name: The name of the service. You must not use any of the following reserved
         strings - ``default``\ , ``requested`` or ``service``. Required.
        :type service_name: str
        :param properties: Parameters supplied to update service tags. Is either a TagsObject type or a
