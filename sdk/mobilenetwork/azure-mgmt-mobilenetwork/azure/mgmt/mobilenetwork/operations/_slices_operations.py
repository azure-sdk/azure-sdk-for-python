...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "sliceName": _SERIALIZER.url(
            "slice_name", slice_name, "str", max_length=64, pattern=r"^[a-zA-Z0-9][a-zA-Z0-9_-]*$"
        ),
    }
...
class SlicesOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, mobile_network_name: str, slice_name: str, **kwargs: Any) -> _models.Slice:
    ...
    def _create_or_update_initial(
        ...
        slice_name: str,
        resource: Union[_models.Slice, IO[bytes]],
        **kwargs: Any
    ) -> _models.Slice:
        error_map = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "Slice")
    ...
    def begin_create_or_update(
        ...
        mobile_network_name: str,
        slice_name: str,
        resource: _models.Slice,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.Slice]:
        ...
        :param slice_name: The name of the network slice. Required.
        :type slice_name: str
        :param resource: Parameters supplied to the create or update network slice operation. Required.
        :type resource: ~azure.mgmt.mobilenetwork.models.Slice
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param slice_name: The name of the network slice. Required.
        :type slice_name: str
        :param resource: Parameters supplied to the create or update network slice operation. Is either
         a Slice type or a IO[bytes] type. Required.
        :type resource: ~azure.mgmt.mobilenetwork.models.Slice or IO[bytes]
        :return: An instance of LROPoller that returns either Slice or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.mobilenetwork.models.Slice]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if cont_token:
            return LROPoller[_models.Slice].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.Slice](
    ...
    def update_tags(
        ...
        **kwargs: Any
        ...
        :param slice_name: The name of the network slice. Required.
        :type slice_name: str
        :param properties: Parameters supplied to update network slice tags. Required.
        :type properties: ~azure.mgmt.mobilenetwork.models.TagsObject
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: Slice or the result of cls(response)
    ...
    def update_tags(
        ...
        mobile_network_name: str,
        slice_name: str,
        properties: Union[_models.TagsObject, IO[bytes]],
        **kwargs: Any
    ) -> _models.Slice:
        """Updates slice tags.
        ...
        :param slice_name: The name of the network slice. Required.
        :type slice_name: str
        :param properties: Parameters supplied to update network slice tags. Is either a TagsObject
         type or a IO[bytes] type. Required.
        :type properties: ~azure.mgmt.mobilenetwork.models.TagsObject or IO[bytes]
        :return: Slice or the result of cls(response)
        :rtype: ~azure.mgmt.mobilenetwork.models.Slice
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "TagsObject")
