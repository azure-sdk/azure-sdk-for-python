...
class SimPoliciesOperations:
    ...
    def _create_or_update_initial(
        ...
        sim_policy_name: str,
        resource: Union[_models.SimPolicy, IO[bytes]],
        **kwargs: Any
    ) -> _models.SimPolicy:
        error_map = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "SimPolicy")
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param sim_policy_name: The name of the SIM policy. Required.
        :type sim_policy_name: str
        :param resource: Parameters supplied to the create or update SIM policy operation. Required.
        :type resource: ~azure.mgmt.mobilenetwork.models.SimPolicy
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param sim_policy_name: The name of the SIM policy. Required.
        :type sim_policy_name: str
        :param resource: Parameters supplied to the create or update SIM policy operation. Is either a
         SimPolicy type or a IO[bytes] type. Required.
        :type resource: ~azure.mgmt.mobilenetwork.models.SimPolicy or IO[bytes]
        :return: An instance of LROPoller that returns either SimPolicy or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.mobilenetwork.models.SimPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update_tags(
        ...
        **kwargs: Any
        ...
        :param sim_policy_name: The name of the SIM policy. Required.
        :type sim_policy_name: str
        :param properties: Parameters supplied to update SIM policy tags. Required.
    ...
    def update_tags(
        ...
        **kwargs: Any
        ...
        :param sim_policy_name: The name of the SIM policy. Required.
        :type sim_policy_name: str
        :param properties: Parameters supplied to update SIM policy tags. Is either a TagsObject type
