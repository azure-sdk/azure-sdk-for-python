...
def build_analyze_conversation_authoring_get_model_evaluation_summary_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/authoring/analyze-conversations/projects/{projectName}/models/{trainedModelLabel}/evaluation/summary-result"  # pylint: disable=line-too-long
    path_format_arguments = {
        "projectName": _SERIALIZER.url("project_name", project_name, "str"),
        "trainedModelLabel": _SERIALIZER.url("trained_model_label", trained_model_label, "str"),
    }
...
def build_analyze_conversation_authoring_get_load_snapshot_status_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/authoring/analyze-conversations/projects/{projectName}/models/{trainedModelLabel}/load-snapshot/jobs/{jobId}"  # pylint: disable=line-too-long
    path_format_arguments = {
        "projectName": _SERIALIZER.url("project_name", project_name, "str"),
        "trainedModelLabel": _SERIALIZER.url("trained_model_label", trained_model_label, "str"),
        "jobId": _SERIALIZER.url("job_id", job_id, "str"),
