...
class TextAnalysisAuthoringOperations:  # pylint: disable=too-many-public-methods
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.ai.language.authoring.analyzetext.aio.TextClient`'s
    ...
    def list_projects(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringProjectMetadata]
    ...
    async def get_project(self, project_name: str, **kwargs: Any) -> _models.GetProjectResponse:
        """Gets the details of a project.

        :param project_name: The new project name. Required.
        :type project_name: str
        :return: GetProjectResponse. The GetProjectResponse is compatible with MutableMapping
        :rtype: ~azure.ai.language.authoring.analyzetext.models.GetProjectResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models.GetProjectResponse] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.GetProjectResponse, response.json())
    ...
    async def create_project(
        ...
        **kwargs: Any
    ) -> Union[_models.CreateProjectResponse, _models.CreateProjectResponse1]:
        """The most basic operation that applies to a resource.

        :param project_name: The new project name. Required.
        :type project_name: str
        :param body: The request body. Required.
        :type body: ~azure.ai.language.authoring.analyzetext.models.CreateProjectOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/merge-patch+json".
        :paramtype content_type: str
        :return: CreateProjectResponse or CreateProjectResponse1. The CreateProjectResponse is
         compatible with MutableMapping
        :rtype: ~azure.ai.language.authoring.analyzetext.models.CreateProjectResponse or
         ~azure.ai.language.authoring.analyzetext.models.CreateProjectResponse1
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def create_project(
        ...
        :param body: The request body. Is one of the following types: CreateProjectOptions, JSON,
         IO[bytes] Required.
        :type body: ~azure.ai.language.authoring.analyzetext.models.CreateProjectOptions or JSON or
         IO[bytes]
        :return: CreateProjectResponse or CreateProjectResponse1. The CreateProjectResponse is
         compatible with MutableMapping
        :rtype: ~azure.ai.language.authoring.analyzetext.models.CreateProjectResponse or
        ...
        cls: ClsType[Union[_models.CreateProjectResponse, _models.CreateProjectResponse1]] = kwargs.pop("cls", None)
        ...
        if response.status_code == 200:
            if _stream:
                ...
                deserialized = _deserialize(_models.CreateProjectResponse1, response.json())

        if response.status_code == 201:
            if _stream:
                deserialized = response.iter_bytes()
            else:
                deserialized = _deserialize(_models.CreateProjectResponse, response.json())
    ...
    async def copy_project_authorization(
        ...
        :paramtype content_type: str
        :return: CopyProjectOptions. The CopyProjectOptions is compatible with MutableMapping
        :rtype: ~azure.ai.language.authoring.analyzetext.models.CopyProjectOptions
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def copy_project_authorization(
        ...
        **kwargs: Any
        ...
        :paramtype project_kind: str or ~azure.ai.language.authoring.analyzetext.models.ProjectKind
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        ...
        :keyword allow_overwrite: Whether to allow an existing project to be overwritten using the
         resulting copy
         authorization. Default value is None.
    ...
    async def copy_project_authorization(
        ...
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.CopyProjectOptions] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.CopyProjectOptions, response.json())
    ...
    async def _copy_project_initial(
        self, project_name: str, body: Union[_models.CopyProjectOptions, JSON, IO[bytes]], **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    async def begin_copy_project(
        self,
        project_name: str,
        body: _models.CopyProjectOptions,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[None]:
        ...
        :type body: ~azure.ai.language.authoring.analyzetext.models.CopyProjectOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns None
    ...
    async def begin_copy_project(
        ...
        :param project_name: The name of the project to use. Required.
        :type project_name: str
        :param body: The copy project info. Is one of the following types: CopyProjectOptions, JSON,
         IO[bytes] Required.
        :type body: ~azure.ai.language.authoring.analyzetext.models.CopyProjectOptions or JSON or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns None
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def begin_export(
        ...
        **kwargs: Any
        ...
        :keyword trained_model_label: Trained model label to export. If the trainedModelLabel is null,
         the default
         behavior is to export the current working copy. Default value is None.
    ...
    async def begin_import_method(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.ai.language.authoring.analyzetext.models.ExportedProject
    ...
    async def begin_import_method(
        ...
        **kwargs: Any
        ...
        :param body: The project data to import. Is one of the following types: ExportedProject, JSON,
         IO[bytes] Required.
        :type body: ~azure.ai.language.authoring.analyzetext.models.ExportedProject or JSON or
         IO[bytes]
        :keyword format: The format of the project to import. The currently supported formats are json
         and aml formats. If not provided, the default is set to json. Default value is None.
        :paramtype format: str
    ...
    async def _train_initial(
        self, project_name: str, body: Union[_models.TrainingJobOptions, JSON, IO[bytes]], **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    async def begin_train(
        self,
        project_name: str,
        body: _models.TrainingJobOptions,
        *,
        content_type: str = "application/json",
        **kwargs: Any
        ...
        :type body: ~azure.ai.language.authoring.analyzetext.models.TrainingJobOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringTrainingJobResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_train(
        ...
        :param project_name: The name of the project to use. Required.
        :type project_name: str
        :param body: The training input parameters. Is one of the following types: TrainingJobOptions,
         JSON, IO[bytes] Required.
        :type body: ~azure.ai.language.authoring.analyzetext.models.TrainingJobOptions or JSON or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns TextAnalysisAuthoringTrainingJobResult. The
         TextAnalysisAuthoringTrainingJobResult is compatible with MutableMapping
        :rtype:
    ...
    async def get_copy_project_status(
        ...
        :return: GetCopyProjectStatusResponse. The GetCopyProjectStatusResponse is compatible with
         MutableMapping
        :rtype: ~azure.ai.language.authoring.analyzetext.models.GetCopyProjectStatusResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_deployments(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringProjectDeployment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def get_deployment(
        ...
        :rtype: ~azure.ai.language.authoring.analyzetext.models.GetDeploymentResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_deploy_project(
        ...
        **kwargs: Any
        ...
        :type body:
         ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringCreateDeploymentOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns None
    ...
    async def begin_deploy_project(
        ...
        **kwargs: Any
        ...
        :type body:
         ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringCreateDeploymentOptions or
         JSON or IO[bytes]
        :return: An instance of AsyncLROPoller that returns None
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def begin_delete_deployment_from_resources(
        ...
        **kwargs: Any
        ...
        :type body:
         ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringDeleteDeploymentOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns None
    ...
    async def begin_delete_deployment_from_resources(
        ...
        **kwargs: Any
        ...
        :type body:
         ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringDeleteDeploymentOptions or
         JSON or IO[bytes]
        :return: An instance of AsyncLROPoller that returns None
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def get_deployment_delete_from_resources_status(  # pylint: disable=name-too-long
        ...
        :rtype:
         ~azure.ai.language.authoring.analyzetext.models.GetDeploymentDeleteFromResourcesStatusResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_deployment_status(
        ...
        :return: GetDeploymentStatusResponse. The GetDeploymentStatusResponse is compatible with
         MutableMapping
        :rtype: ~azure.ai.language.authoring.analyzetext.models.GetDeploymentStatusResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def _swap_deployments_initial(
        self, project_name: str, body: Union[_models.SwapDeploymentsOptions, JSON, IO[bytes]], **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    async def begin_swap_deployments(
        self,
        project_name: str,
        body: _models.SwapDeploymentsOptions,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[None]:
        ...
        :type body: ~azure.ai.language.authoring.analyzetext.models.SwapDeploymentsOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns None
    ...
    async def begin_swap_deployments(
        ...
        :param body: The job object to swap two deployments. Is one of the following types:
         SwapDeploymentsOptions, JSON, IO[bytes] Required.
        :type body: ~azure.ai.language.authoring.analyzetext.models.SwapDeploymentsOptions or JSON or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns None
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def get_swap_deployments_status(
        ...
        :return: GetSwapDeploymentsStatusResponse. The GetSwapDeploymentsStatusResponse is compatible
         with MutableMapping
        :rtype: ~azure.ai.language.authoring.analyzetext.models.GetSwapDeploymentsStatusResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_export_status(self, project_name: str, job_id: str, **kwargs: Any) -> _models.GetExportStatusResponse:
        ...
        :rtype: ~azure.ai.language.authoring.analyzetext.models.GetExportStatusResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_exported_models(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringExportedTrainedModel]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def get_exported_model(
        ...
        :return: GetExportedModelResponse. The GetExportedModelResponse is compatible with
         MutableMapping
        :rtype: ~azure.ai.language.authoring.analyzetext.models.GetExportedModelResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update_exported_model(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.ai.language.authoring.analyzetext.models.ExportedModelOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns None
    ...
    async def begin_create_or_update_exported_model(
        ...
        **kwargs: Any
        ...
        :param body: The exported model info. Is one of the following types: ExportedModelOptions,
         JSON, IO[bytes] Required.
        :type body: ~azure.ai.language.authoring.analyzetext.models.ExportedModelOptions or JSON or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns None
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def get_exported_model_job_status(
        ...
        :return: GetExportedModelJobStatusResponse. The GetExportedModelJobStatusResponse is compatible
         with MutableMapping
        :rtype: ~azure.ai.language.authoring.analyzetext.models.GetExportedModelJobStatusResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_exported_model_manifest(
        ...
        :rtype:
         ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringExportedModelManifest
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_import_status(self, project_name: str, job_id: str, **kwargs: Any) -> _models.GetImportStatusResponse:
        ...
        :rtype: ~azure.ai.language.authoring.analyzetext.models.GetImportStatusResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_trained_models(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringProjectTrainedModel]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def get_trained_model(
        ...
        :rtype: ~azure.ai.language.authoring.analyzetext.models.GetTrainedModelResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def _evaluate_model_initial(
        ...
        body: Union[_models.EvaluationOptions, JSON, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_evaluate_model(
        ...
        project_name: str,
        trained_model_label: str,
        body: _models.EvaluationOptions,
        *,
        content_type: str = "application/json",
        **kwargs: Any
        ...
        :type trained_model_label: str
        :param body: The training input parameters. Required.
        :type body: ~azure.ai.language.authoring.analyzetext.models.EvaluationOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringEvaluationJobResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_evaluate_model(
        ...
        **kwargs: Any
        ...
        :param trained_model_label: The trained model label. Required.
        :type trained_model_label: str
        :param body: The training input parameters. Is one of the following types: EvaluationOptions,
         JSON, IO[bytes] Required.
        :type body: ~azure.ai.language.authoring.analyzetext.models.EvaluationOptions or JSON or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns TextAnalysisAuthoringEvaluationJobResult.
         The TextAnalysisAuthoringEvaluationJobResult is compatible with MutableMapping
        :rtype:
    ...
    async def get_evaluation_status(
        ...
        :return: GetEvaluationStatusResponse. The GetEvaluationStatusResponse is compatible with
         MutableMapping
        :rtype: ~azure.ai.language.authoring.analyzetext.models.GetEvaluationStatusResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def get_model_evaluation_results(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringDocumentEvaluationResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def get_model_evaluation_summary(
        ...
        :return: TextAnalysisAuthoringEvaluationSummary. The TextAnalysisAuthoringEvaluationSummary is
         compatible with MutableMapping
        :rtype: ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringEvaluationSummary
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_load_snapshot_status(
        ...
        :return: GetLoadSnapshotStatusResponse. The GetLoadSnapshotStatusResponse is compatible with
         MutableMapping
        :rtype: ~azure.ai.language.authoring.analyzetext.models.GetLoadSnapshotStatusResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_deployment_resources(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringAssignedDeploymentResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def _assign_deployment_resources_initial(
        self, project_name: str, body: Union[_models.AssignDeploymentResourcesOptions, JSON, IO[bytes]], **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    async def begin_assign_deployment_resources(
        self,
        project_name: str,
        body: _models.AssignDeploymentResourcesOptions,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[None]:
        ...
        :type body: ~azure.ai.language.authoring.analyzetext.models.AssignDeploymentResourcesOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns None
    ...
    async def begin_assign_deployment_resources(
        ...
        :param body: The new project resources info. Is one of the following types:
         AssignDeploymentResourcesOptions, JSON, IO[bytes] Required.
        :type body: ~azure.ai.language.authoring.analyzetext.models.AssignDeploymentResourcesOptions or
         JSON or IO[bytes]
        :return: An instance of AsyncLROPoller that returns None
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def _unassign_deployment_resources_initial(
        self, project_name: str, body: Union[_models.UnassignDeploymentResourcesOptions, JSON, IO[bytes]], **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    async def begin_unassign_deployment_resources(
        self,
        project_name: str,
        body: _models.UnassignDeploymentResourcesOptions,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[None]:
        ...
        :type body: ~azure.ai.language.authoring.analyzetext.models.UnassignDeploymentResourcesOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns None
    ...
    async def begin_unassign_deployment_resources(
        ...
        :param body: The info for the deployment resources to be deleted. Is one of the following
         types: UnassignDeploymentResourcesOptions, JSON, IO[bytes] Required.
        :type body: ~azure.ai.language.authoring.analyzetext.models.UnassignDeploymentResourcesOptions
         or JSON or IO[bytes]
        :return: An instance of AsyncLROPoller that returns None
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
    ...
    async def get_assign_deployment_resources_status(
        ...
        :rtype:
         ~azure.ai.language.authoring.analyzetext.models.GetAssignDeploymentResourcesStatusResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_unassign_deployment_resources_status(
        ...
        :rtype:
         ~azure.ai.language.authoring.analyzetext.models.GetUnassignDeploymentResourcesStatusResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_training_jobs(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringTrainingJobState]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def get_training_status(
        ...
        :return: GetTrainingStatusResponse. The GetTrainingStatusResponse is compatible with
         MutableMapping
        :rtype: ~azure.ai.language.authoring.analyzetext.models.GetTrainingStatusResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_project_deletion_status(self, job_id: str, **kwargs: Any) -> _models.GetProjectDeletionStatusResponse:
        ...
        :return: GetProjectDeletionStatusResponse. The GetProjectDeletionStatusResponse is compatible
         with MutableMapping
        :rtype: ~azure.ai.language.authoring.analyzetext.models.GetProjectDeletionStatusResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_assigned_resource_deployments(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringAssignedProjectDeploymentsMetadata]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def get_supported_languages(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringSupportedLanguage]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def get_supported_prebuilt_entities(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringPrebuiltEntity]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_training_config_versions(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringTrainingConfigVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
