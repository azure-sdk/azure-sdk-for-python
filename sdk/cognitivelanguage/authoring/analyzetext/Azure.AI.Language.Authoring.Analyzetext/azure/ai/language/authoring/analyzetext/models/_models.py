...
class AssignDeploymentResourcesOptions(_model_base.Model):
    ...
    :vartype resources_metadata:
     list[~azure.ai.language.authoring.analyzetext.models.ResourceMetadata]
    """
...
class CopyProjectOptions(_model_base.Model):
    ...
    :vartype project_kind: str or ~azure.ai.language.authoring.analyzetext.models.ProjectKind
...
class CreateProjectOptions(_model_base.Model):
    ...
    :vartype settings: ~azure.ai.language.authoring.analyzetext.models.ProjectSettings
...
class CreateProjectResponse(_model_base.Model):
...
class CreateProjectResponse1(_model_base.Model):
...
class Error(_model_base.Model):
    ...
    :vartype code: str or ~azure.ai.language.authoring.analyzetext.models.ErrorCode
    :ivar message: A human-readable representation of the error. Required.
    :vartype message: str
    :ivar target: The target of the error.
    :vartype target: str
    :ivar details: An array of details about specific errors that led to this reported error.
    :vartype details: list[~azure.ai.language.authoring.analyzetext.models.Error]
    :ivar innererror: An object containing more specific information than the current object about
     the error.
    :vartype innererror: ~azure.ai.language.authoring.analyzetext.models.InnerErrorModel
    """
...
class ErrorResponse(_model_base.Model):
    ...
    :vartype error: ~azure.ai.language.authoring.analyzetext.models.Error
    """
...
class EvaluationOptions(_model_base.Model):
    ...
    :vartype kind: str or ~azure.ai.language.authoring.analyzetext.models.EvaluationKind
...
class ExportedProject(_model_base.Model):
    ...
    :vartype metadata: ~azure.ai.language.authoring.analyzetext.models.CreateProjectOptions
    :ivar assets: Represents the project assets.
    :vartype assets: ~azure.ai.language.authoring.analyzetext.models.ExportedProjectAssets
    """
    ...
    """Specifies the method used to interpret string offsets. For additional
     information see https://aka.ms/text-analytics-offsets. Required. \"Utf16CodeUnit\""""
    metadata: "_models.CreateProjectOptions" = rest_field()
...
class GetAssignDeploymentResourcesStatusResponse(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype status: str or ~azure.ai.language.authoring.analyzetext.models.JobStatus
    :ivar warnings: The warnings that were encountered while executing the job.
    :vartype warnings:
     list[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringWarning]
    :ivar errors: The errors encountered while executing the job.
    :vartype errors: list[~azure.ai.language.authoring.analyzetext.models.Error]
    """
...
class GetDeploymentResponse(_model_base.Model):
    ...
    :vartype assigned_resources:
     list[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringDeploymentResource]
    """
...
class GetEvaluationStatusResponse(_model_base.Model):
    ...
    :vartype result:
     ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringEvaluationJobResult
    """
...
class GetProjectResponse(_model_base.Model):
    """GetProjectResponse.
...
class GetTrainingStatusResponse(_model_base.Model):
    ...
    :vartype result:
     ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringTrainingJobResult
    """
...
class InnerErrorModel(_model_base.Model):
    ...
    :ivar code: One of a server-defined set of error codes. Required. Known values are:
     ...
     "InvalidCountryHint".
    :vartype code: str or ~azure.ai.language.authoring.analyzetext.models.InnerErrorCode
...
class TextAnalysisAuthoringAssignedProjectDeploymentsMetadata(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype deployments_metadata:
     list[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringAssignedProjectDeploymentMetadata]
    """
...
class TextAnalysisAuthoringCustomEntityRecognitionDocumentEvaluationResult(
    ...
    :vartype custom_entity_recognition_result:
     ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringDocumentEntityRecognitionEvaluationResult
    :ivar project_kind: Represents the project kind. Required. For building an extraction model to
     identify your domain categories using your
     own data.
    :vartype project_kind: str or
     ~azure.ai.language.authoring.analyzetext.models.CUSTOM_ENTITY_RECOGNITION
    """
...
class TextAnalysisAuthoringEvaluationSummary(_model_base.Model):
    ...
    :vartype evaluation_options: ~azure.ai.language.authoring.analyzetext.models.EvaluationOptions
    """
    ...
    """Represents the project type that the evaluation ran on. Required. Known values are:
     ...
     \"CustomEntityRecognition\", \"CustomAbstractiveSummarization\", \"CustomHealthcare\", and
     \"CustomTextSentiment\"."""
    evaluation_options: "_models.EvaluationOptions" = rest_field(name="evaluationOptions")
    ...
    def __init__(
        ...
        *,
        project_kind: str,
        evaluation_options: "_models.EvaluationOptions",
    ) -> None: ...
...
class TextAnalysisAuthoringCustomEntityRecognitionEvaluationSummary(
    ...
    :vartype custom_entity_recognition_evaluation:
     ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringEntityRecognitionEvaluationSummary
    :ivar project_kind: Represents the project type that the evaluation ran on. Required. For
     building an extraction model to identify your domain categories using your
     own data.
    :vartype project_kind: str or
     ~azure.ai.language.authoring.analyzetext.models.CUSTOM_ENTITY_RECOGNITION
    """
    ...
    """Represents the project type that the evaluation ran on. Required. For building an extraction
     model to identify your domain categories using your
     own data."""
...
class TextAnalysisAuthoringCustomHealthcareDocumentEvaluationResult(
    ...
    :vartype custom_healthcare_result:
     ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringDocumentHealthcareEvaluationResult
    :ivar project_kind: Represents the project kind. Required. For building an text analytics for
     health model to identify your health domain
     data.
    :vartype project_kind: str or ~azure.ai.language.authoring.analyzetext.models.CUSTOM_HEALTHCARE
    """
...
class TextAnalysisAuthoringCustomHealthcareEvaluationSummary(
    ...
    :vartype custom_healthcare_evaluation:
     ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringEntityRecognitionEvaluationSummary
    :ivar project_kind: Represents the project type that the evaluation ran on. Required. For
     building an text analytics for health model to identify your health domain
     data.
    :vartype project_kind: str or ~azure.ai.language.authoring.analyzetext.models.CUSTOM_HEALTHCARE
    """
    ...
    """Represents the project type that the evaluation ran on. Required. For building an text
     analytics for health model to identify your health domain
     data."""
...
class TextAnalysisAuthoringCustomMultiLabelClassificationDocumentEvaluationResult(
    ...
    :vartype custom_multi_label_classification_result:
     ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringDocumentMultiLabelClassificationEvaluationResult  # pylint: disable=line-too-long
    ...
    :vartype project_kind: str or
     ~azure.ai.language.authoring.analyzetext.models.CUSTOM_MULTI_LABEL_CLASSIFICATION
    """
...
class TextAnalysisAuthoringCustomMultiLabelClassificationEvaluationSummary(
    ...
    :vartype custom_multi_label_classification_evaluation:
     ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringMultiLabelClassificationEvaluationSummary
    :ivar project_kind: Represents the project type that the evaluation ran on. Required. For
     building a classification model to classify text using your own data. Each
     file can have one or many labels. For example, file 1 is classified as A, B,
     and C and file 2 is classified as B and C.
    :vartype project_kind: str or
     ~azure.ai.language.authoring.analyzetext.models.CUSTOM_MULTI_LABEL_CLASSIFICATION
    ...
    """Represents the project type that the evaluation ran on. Required. For building a classification
     model to classify text using your own data. Each
     file can have one or many labels. For example, file 1 is classified as A, B,
     and C and file 2 is classified as B and C."""
...
class TextAnalysisAuthoringCustomSingleLabelClassificationDocumentEvaluationResult(
    ...
    :vartype custom_single_label_classification_result:
     ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringDocumentSingleLabelClassificationEvaluationResult  # pylint: disable=line-too-long
    :ivar project_kind: Represents the project kind. Required. For building a classification model
     to classify text using your own data. Each
     file will have only one label. For example, file 1 is classified as A and file
     2 is classified as B.
    :vartype project_kind: str or
     ~azure.ai.language.authoring.analyzetext.models.CUSTOM_SINGLE_LABEL_CLASSIFICATION
    """
...
class TextAnalysisAuthoringCustomSingleLabelClassificationEvaluationSummary(
    ...
    :vartype custom_single_label_classification_evaluation:
     ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringSingleLabelClassificationEvaluationSummary
    :ivar project_kind: Represents the project type that the evaluation ran on. Required. For
     building a classification model to classify text using your own data. Each
     file will have only one label. For example, file 1 is classified as A and file
     2 is classified as B.
...
class TextAnalysisAuthoringCustomTextSentimentDocumentEvaluationResult(
    ...
    :vartype custom_text_sentiment_result:
     ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringDocumentTextSentimentEvaluationResult
    :ivar project_kind: Represents the project kind. Required. For building a sentiment models
     which are able to extract sentiment for long
     documents.
    :vartype project_kind: str or
     ~azure.ai.language.authoring.analyzetext.models.CUSTOM_TEXT_SENTIMENT
    """
...
class TextAnalysisAuthoringCustomTextSentimentEvaluationSummary(
    ...
    :vartype custom_text_sentiment_evaluation:
     ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringTextSentimentEvaluationSummary
    :ivar project_kind: Represents the project type that the evaluation ran on. Required. For
     building a sentiment models which are able to extract sentiment for long
     documents.
    :vartype project_kind: str or
     ~azure.ai.language.authoring.analyzetext.models.CUSTOM_TEXT_SENTIMENT
    """
    ...
    """Represents the project type that the evaluation ran on. Required. For building a sentiment
     models which are able to extract sentiment for long
     documents."""
...
class TextAnalysisAuthoringDocumentEntityRecognitionEvaluationResult(
    ...
    :vartype entities:
     list[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringDocumentEntityRegionEvaluationResult]
    """
...
class TextAnalysisAuthoringDocumentEntityRegionEvaluationResult(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype expected_entities:
     list[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringDocumentEntityLabelEvaluationResult]
...
class TextAnalysisAuthoringDocumentSentimentLabelEvaluationResult(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype category: str or ~azure.ai.language.authoring.analyzetext.models.Sentiment
...
class TextAnalysisAuthoringDocumentTextSentimentEvaluationResult(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype expected_sentiment_spans:
     list[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringDocumentSentimentLabelEvaluationResult]
...
class TextAnalysisAuthoringEntityRecognitionEvaluationSummary(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype confusion_matrix:
     ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringConfusionMatrix
    :ivar entities: Represents the entities evaluation. Required.
    :vartype entities: dict[str,
     ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringEntityEvaluationSummary]
...
class TextAnalysisAuthoringExportedCompositeEntity(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype composition_setting: str or
     ~azure.ai.language.authoring.analyzetext.models.CompositionSetting
    :ivar list: The list component of the entity.
    :vartype list:
     ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringExportedEntityList
    :ivar prebuilts: The prebuilt entities components.
    :vartype prebuilts:
     list[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringExportedPrebuiltEntity]
...
class TextAnalysisAuthoringExportedCustomAbstractiveSummarizationProjectAssets(
    ...
    :vartype documents:
     list[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringExportedCustomAbstractiveSummarizationDocument]  # pylint: disable=line-too-long
    :ivar project_kind: The type of the project the assets belong to. Required. For building an
     abstractive summarization models which are able to summarize
     long documents.
    :vartype project_kind: str or
     ~azure.ai.language.authoring.analyzetext.models.CUSTOM_ABSTRACTIVE_SUMMARIZATION
    """
    ...
    """The type of the project the assets belong to. Required. For building an abstractive
     summarization models which are able to summarize
     long documents."""
...
class TextAnalysisAuthoringExportedCustomEntityRecognitionDocument(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype entities:
     list[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringExportedDocumentEntityRegion]
    :ivar location: The location of the document in the storage.
    :vartype location: str
    :ivar language: Represents the document language. This is BCP-47 representation of a language.
     For example, use "en" for English, "en-gb" for English (UK), "es" for Spanish
...
class TextAnalysisAuthoringExportedCustomEntityRecognitionProjectAssets(
    ...
    :vartype entities:
     list[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringExportedEntity]
    :ivar documents: The list of documents belonging to the project.
    :vartype documents:
     list[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringExportedCustomEntityRecognitionDocument]
    :ivar project_kind: The type of the project the assets belong to. Required. For building an
     extraction model to identify your domain categories using your
     own data.
    :vartype project_kind: str or
     ~azure.ai.language.authoring.analyzetext.models.CUSTOM_ENTITY_RECOGNITION
    """
...
class TextAnalysisAuthoringExportedCustomHealthcareProjectAssets(
    ...
    :ivar entities: The list of entities belonging to the project.
    :vartype entities:
     list[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringExportedCompositeEntity]
    :ivar documents: The list of documents belonging to the project.
    :vartype documents:
     list[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringExportedCustomHealthcareDocument]
    :ivar project_kind: The type of the project the assets belong to. Required. For building an
     text analytics for health model to identify your health domain
     data.
    :vartype project_kind: str or ~azure.ai.language.authoring.analyzetext.models.CUSTOM_HEALTHCARE
    """
...
class TextAnalysisAuthoringExportedCustomMultiLabelClassificationDocument(
    ...
    :vartype classes:
     list[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringExportedDocumentClass]
    :ivar location: The location of the document in the storage.
    :vartype location: str
    :ivar language: Represents the document language. This is BCP-47 representation of a language.
     For example, use "en" for English, "en-gb" for English (UK), "es" for Spanish
...
class TextAnalysisAuthoringExportedCustomMultiLabelClassificationProjectAssets(
    ...
    :vartype classes:
     list[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringExportedClass]
    :ivar documents: The list of documents in the project.
    :vartype documents:
     list[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringExportedCustomMultiLabelClassificationDocument]  # pylint: disable=line-too-long
    :ivar project_kind: The type of the project the assets belong to. Required. For building a
     classification model to classify text using your own data. Each
     file can have one or many labels. For example, file 1 is classified as A, B,
     and C and file 2 is classified as B and C.
    :vartype project_kind: str or
     ~azure.ai.language.authoring.analyzetext.models.CUSTOM_MULTI_LABEL_CLASSIFICATION
    ...
    """The type of the project the assets belong to. Required. For building a classification model to
     classify text using your own data. Each
     file can have one or many labels. For example, file 1 is classified as A, B,
     and C and file 2 is classified as B and C."""
...
class TextAnalysisAuthoringExportedCustomSingleLabelClassificationDocument(
    ...
    :vartype class_property:
     ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringExportedDocumentClass
    :ivar location: The location of the document in the storage.
    :vartype location: str
    :ivar language: Represents the document language. This is BCP-47 representation of a language.
     For example, use "en" for English, "en-gb" for English (UK), "es" for Spanish
...
class TextAnalysisAuthoringExportedCustomSingleLabelClassificationProjectAssets(
    ...
    :ivar documents: The list of documents belonging to this project.
    :vartype documents:
     list[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringExportedCustomSingleLabelClassificationDocument]  # pylint: disable=line-too-long
    :ivar project_kind: The type of the project the assets belong to. Required. For building a
     classification model to classify text using your own data. Each
     file will have only one label. For example, file 1 is classified as A and file
     2 is classified as B.
...
class TextAnalysisAuthoringExportedCustomTextSentimentDocument(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype sentiment_spans:
     list[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringExportedDocumentSentimentLabel]
    :ivar location: The location of the document in the storage.
    :vartype location: str
    :ivar language: Represents the document language. This is BCP-47 representation of a language.
     For example, use "en" for English, "en-gb" for English (UK), "es" for Spanish
...
class TextAnalysisAuthoringExportedCustomTextSentimentProjectAssets(
    ...
    :ivar documents: The list of documents belonging to the project.
    :vartype documents:
     list[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringExportedCustomTextSentimentDocument]
    :ivar project_kind: The type of the project the assets belong to. Required. For building a
     sentiment models which are able to extract sentiment for long
     documents.
    :vartype project_kind: str or
     ~azure.ai.language.authoring.analyzetext.models.CUSTOM_TEXT_SENTIMENT
    """
    ...
    """The type of the project the assets belong to. Required. For building a sentiment models which
     are able to extract sentiment for long
     documents."""
...
class TextAnalysisAuthoringExportedDocumentEntityRegion(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype labels:
     list[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringExportedDocumentEntityLabel]
    """
...
class TextAnalysisAuthoringExportedEntityList(_model_base.Model):
    ...
    :vartype sublists:
     list[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringExportedEntitySublist]
    """
...
class TextAnalysisAuthoringExportedEntitySublist(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype synonyms:
     list[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringExportedEntityListSynonym]
    """
...
class TextAnalysisAuthoringExportedModelManifest(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype model_files:
     list[~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringModelFile]
    """
...
class TextAnalysisAuthoringMultiLabelClassificationEvaluationSummary(
    ...
    :vartype classes: dict[str,
     ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringMultiLabelClassEvaluationSummary]
    :ivar micro_f1: Represents the micro F1. Expected value is a float between 0 and 1 inclusive.
     Required.
    :vartype micro_f1: float
    :ivar micro_precision: Represents the micro precision. Expected value is a float between 0 and
...
class TextAnalysisAuthoringProjectMetadata(_model_base.Model):  # pylint: disable=too-many-instance-attributes
...
class TextAnalysisAuthoringSingleLabelClassificationEvaluationSummary(
    ...
    :ivar classes: Represents the classes evaluation. Required.
    :vartype classes: dict[str,
     ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringSingleLabelClassEvaluationSummary]
    :ivar micro_f1: Represents the micro F1. Expected value is a float between 0 and 1 inclusive.
     Required.
    :vartype micro_f1: float
    :ivar micro_precision: Represents the micro precision. Expected value is a float between 0 and
...
class TextAnalysisAuthoringSpanSentimentEvaluationSummary(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype sentiments: dict[str,
     ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringSentimentEvaluationSummary]
    :ivar micro_f1: Represents the micro F1. Expected value is a float between 0 and 1 inclusive.
     Required.
    :vartype micro_f1: float
    :ivar micro_precision: Represents the micro precision. Expected value is a float between 0 and
...
class TextAnalysisAuthoringTextSentimentEvaluationSummary(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype span_sentiments_evaluation:
     ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringSpanSentimentEvaluationSummary
    :ivar micro_f1: Represents the micro F1. Expected value is a float between 0 and 1 inclusive.
     Required.
    :vartype micro_f1: float
    :ivar micro_precision: Represents the micro precision. Expected value is a float between 0 and
...
class TextAnalysisAuthoringTrainingJobResult(_model_base.Model):
    ...
    :vartype training_status:
     ~azure.ai.language.authoring.analyzetext.models.TextAnalysisAuthoringSubTrainingJobState
...
class TrainingJobOptions(_model_base.Model):
    ...
    training_config_version: str = rest_field(name="trainingConfigVersion")
    """Represents training config version. Required."""
    evaluation_options: Optional["_models.EvaluationOptions"] = rest_field(name="evaluationOptions")
    ...
    def __init__(
        ...
        *,
        model_label: str,
        training_config_version: str,
        evaluation_options: Optional["_models.EvaluationOptions"] = None,
    ) -> None: ...
...
class UnassignDeploymentResourcesOptions(_model_base.Model):
