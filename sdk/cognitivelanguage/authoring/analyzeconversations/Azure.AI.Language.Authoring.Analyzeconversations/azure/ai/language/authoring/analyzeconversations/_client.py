...
class ConversationsClient:
    ...
    :vartype conversational_analysis_authoring:
     azure.ai.language.authoring.analyzeconversations.operations.ConversationalAnalysisAuthoringOperations
    ...
    :keyword api_version: The API version to use for this operation. Default value is
     "2023-04-15-preview". Note that overriding this default value may result in unsupported
     behavior.
