...
class ConversationalAnalysisAuthoringAssignDeploymentResourcesOptions(
    ...
    :vartype resources_metadata:
     list[~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringResourceMetadata]
    """
...
class ConversationalAnalysisAuthoringAssignedProjectDeploymentsMetadata(
    ...
    :vartype deployments_metadata:
     list[~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringAssignedProjectDeploymentMetadata]  # pylint: disable=line-too-long
    """
...
class ConversationalAnalysisAuthoringAssignedResourceDeploymentsMetadata(
    ...
    :vartype value:
     list[~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringAssignedProjectDeploymentsMetadata]  # pylint: disable=line-too-long
...
class ConversationalAnalysisAuthoringConversationExportedEntity(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype composition_setting: str or
     ~azure.ai.language.authoring.analyzeconversations.models.CompositionSetting
    :ivar list: The list component of the entity.
    :vartype list:
     ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringExportedEntityList
    :ivar prebuilts: The prebuilt entities components.
    :vartype prebuilts:
     list[~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringExportedPrebuiltEntity]  # pylint: disable=line-too-long
    :ivar regex: The regex component of the entity.
    :vartype regex:
     ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringExportedEntityRegex
...
class ConversationalAnalysisAuthoringExportedProjectAssets(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype project_kind: str or
     ~azure.ai.language.authoring.analyzeconversations.models.ProjectKind
    """
...
class ConversationalAnalysisAuthoringConversationExportedProjectAssets(
    ...
    :vartype intents:
     list[~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringConversationExportedIntent]  # pylint: disable=line-too-long
    :ivar entities: The entities defined in the project.
    :vartype entities:
     list[~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringConversationExportedEntity]  # pylint: disable=line-too-long
    :ivar utterances: The utterances defined in the project.
    :vartype utterances:
     list[~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringConversationExportedUtterance]  # pylint: disable=line-too-long
    ...
    :vartype project_kind: str or
     ~azure.ai.language.authoring.analyzeconversations.models.CONVERSATION
    """
...
class ConversationalAnalysisAuthoringConversationExportedUtterance(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype entities:
     list[~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringExportedUtteranceEntityLabel]  # pylint: disable=line-too-long
...
class ConversationalAnalysisAuthoringCreateProjectOptions(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype settings:
     ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringProjectSettings
...
class ConversationalAnalysisAuthoringEntitiesEvaluationSummary(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype confusion_matrix:
     ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringConfusionMatrix
    :ivar entities: Represents the entities evaluation summary. Required.
    :vartype entities: dict[str,
     ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringEntityEvaluationSummary]
...
class ConversationalAnalysisAuthoringEvaluationJobResult(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype evaluation_options:
     ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringEvaluationOptions
...
class ConversationalAnalysisAuthoringEvaluationJobState(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype status: str or ~azure.ai.language.authoring.analyzeconversations.models.JobStatus
    :ivar warnings: The warnings that were encountered while executing the job.
    :vartype warnings: list[~azure.ai.language.authoring.analyzeconversations.models.Warning]
    :ivar errors: The errors encountered while executing the job.
    :vartype errors: list[~azure.ai.language.authoring.analyzeconversations.models.Error]
    :ivar result: Represents evaluation task detailed result. Required.
    :vartype result:
     ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringEvaluationJobResult
    """
...
class ConversationalAnalysisAuthoringEvaluationOptions(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype kind: str or ~azure.ai.language.authoring.analyzeconversations.models.EvaluationKind
...
class ConversationalAnalysisAuthoringEvaluationSummary(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype entities_evaluation:
     ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringEntitiesEvaluationSummary
    :ivar intents_evaluation: Contains the data related to intents evaluation. Required.
    :vartype intents_evaluation:
     ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringIntentsEvaluationSummary
...
class ConversationalAnalysisAuthoringExportedOrchestrationOptions(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype target_project_kind: str or
     ~azure.ai.language.authoring.analyzeconversations.models.OrchestrationTargetProjectKind
    """
...
class ConversationalAnalysisAuthoringExportedConversationOrchestrationOptions(
    ...
    :vartype conversation_orchestration:
     ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringExportedConversationOrchestration  # pylint: disable=line-too-long
...
class ConversationalAnalysisAuthoringExportedEntityList(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype sublists:
     list[~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringExportedEntitySublist]
    """
...
class ConversationalAnalysisAuthoringExportedEntityRegex(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype expressions:
     list[~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringExportedEntityRegexExpression]  # pylint: disable=line-too-long
    """
...
class ConversationalAnalysisAuthoringExportedEntitySublist(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype synonyms:
     list[~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringExportedEntityListSynonym]  # pylint: disable=line-too-long
    """
...
class ConversationalAnalysisAuthoringExportedLuisOrchestrationOptions(
    ...
    :vartype luis_orchestration:
     ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringExportedLuisOrchestration
    :ivar target_project_kind: The kind of the target used in the orchestration flow. Required.
    :vartype target_project_kind: str or
     ~azure.ai.language.authoring.analyzeconversations.models.LUIS
    """
...
class ConversationalAnalysisAuthoringExportedProject(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype string_index_type: str or
     ~azure.ai.language.authoring.analyzeconversations.models.StringIndexType
    :ivar metadata: Represents the project metadata. Required.
    :vartype metadata:
     ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringCreateProjectOptions
    :ivar assets: Represents the project assets.
    :vartype assets:
     ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringExportedProjectAssets
    """
...
class ConversationalAnalysisAuthoringExportedQuestionAnsweringOrchestrationOptions(
    ...
    :vartype question_answering_orchestration:
     ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringExportedQuestionAnsweringOrchestration  # pylint: disable=line-too-long
    :ivar target_project_kind: The kind of the target used in the orchestration flow. Required.
    :vartype target_project_kind: str or
     ~azure.ai.language.authoring.analyzeconversations.models.QUESTION_ANSWERING
    """
...
class ConversationalAnalysisAuthoringIntentsEvaluationSummary(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype intents: dict[str,
     ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringIntentEvaluationSummary]
    :ivar micro_f1: Represents the micro F1. Expected value is a float between 0 and 1 inclusive.
     Required.
    :vartype micro_f1: float
    :ivar micro_precision: Represents the micro precision. Expected value is a float between 0 and
...
class ConversationalAnalysisAuthoringOrchestrationExportedIntent(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype orchestration:
     ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringExportedOrchestrationOptions  # pylint: disable=line-too-long
    :ivar category: The intent category. Required.
    :vartype category: str
    """
...
class ConversationalAnalysisAuthoringOrchestrationExportedProjectAssets(
    ...
    :vartype intents:
     list[~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringOrchestrationExportedIntent]  # pylint: disable=line-too-long
    :ivar utterances: Represents the utterances of the project.
    :vartype utterances:
     list[~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringOrchestrationExportedUtterance]  # pylint: disable=line-too-long
    :ivar project_kind: The type of project containing the assets. Required. A project to connect
     ...
     single project.
    :vartype project_kind: str or
     ~azure.ai.language.authoring.analyzeconversations.models.ORCHESTRATION
    """
...
class ConversationalAnalysisAuthoringPrebuiltEntities(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype value:
     list[~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringPrebuiltEntity]
    :ivar next_link: The next page link.
    :vartype next_link: str
    """
...
class ConversationalAnalysisAuthoringProjectDeployment(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype assigned_resources:
     list[~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringDeploymentResource]
    """
...
class ConversationalAnalysisAuthoringProjectMetadata(
    _model_base.Model
...
class ConversationalAnalysisAuthoringSupportedLanguages(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype value:
     list[~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringSupportedLanguage]
    :ivar next_link: The next page link.
    :vartype next_link: str
    """
...
class ConversationalAnalysisAuthoringTrainingConfigVersions(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype value:
     list[~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringTrainingConfigVersion]
    :ivar next_link: The next page link.
    :vartype next_link: str
    """
...
class ConversationalAnalysisAuthoringTrainingJobOptions(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype training_mode: str or
     ~azure.ai.language.authoring.analyzeconversations.models.TrainingMode
...
class ConversationalAnalysisAuthoringTrainingJobResult(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype training_status:
     ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringSubTrainingJobState
...
class ConversationalAnalysisAuthoringTrainingJobState(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype result:
     ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringTrainingJobResult
    """
...
class ConversationalAnalysisAuthoringUtteranceEntitiesEvaluationResult(
    ...
    :vartype expected_entities:
     list[~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringUtteranceEntityEvaluationResult]  # pylint: disable=line-too-long
...
class ConversationalAnalysisAuthoringUtteranceEvaluationResult(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype entities_result:
     ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringUtteranceEntitiesEvaluationResult  # pylint: disable=line-too-long
    :ivar intents_result: Represents the intents results for the utterance. Required.
    :vartype intents_result:
     ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringUtteranceIntentsEvaluationResult  # pylint: disable=line-too-long
    """
...
class Error(_model_base.Model):
    ...
    :vartype code: str or ~azure.ai.language.authoring.analyzeconversations.models.ErrorCode
    :ivar message: A human-readable representation of the error. Required.
    :vartype message: str
    :ivar target: The target of the error.
    :vartype target: str
    :ivar details: An array of details about specific errors that led to this reported error.
    :vartype details: list[~azure.ai.language.authoring.analyzeconversations.models.Error]
    :ivar innererror: An object containing more specific information than the current object about
     the error.
    :vartype innererror: ~azure.ai.language.authoring.analyzeconversations.models.InnerErrorModel
    """
...
class ErrorResponse(_model_base.Model):
    ...
    :vartype error: ~azure.ai.language.authoring.analyzeconversations.models.Error
    """
...
class InnerErrorModel(_model_base.Model):
    ...
    :ivar code: One of a server-defined set of error codes. Required. Known values are:
     ...
     "InvalidCountryHint".
    :vartype code: str or ~azure.ai.language.authoring.analyzeconversations.models.InnerErrorCode
