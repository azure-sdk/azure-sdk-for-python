...
class ConversationalAnalysisAuthoringOperations:  # pylint: disable=too-many-public-methods,name-too-long
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.ai.language.authoring.analyzeconversations.aio.ConversationsClient`'s
    ...
    def list_projects(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringProjectMetadata]
    ...
    async def get_project(
        ...
        :rtype:
         ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringProjectMetadata
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def copy_project_authorization(
        ...
        :rtype:
         ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringCopyProjectOptions
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_export(
        ...
        **kwargs: Any
        ...
        :paramtype exported_project_format: str or
         ~azure.ai.language.authoring.analyzeconversations.models.ExportedProjectFormat
    ...
    async def begin_import_method(
        ...
        **kwargs: Any
        ...
        :type body:
         ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringExportedProject
        :keyword exported_project_format: The format of the exported project file to use. Known values
         are: "Conversation" and "Luis". Default value is None.
        :paramtype exported_project_format: str or
         ~azure.ai.language.authoring.analyzeconversations.models.ExportedProjectFormat
    ...
    async def begin_train(
        ...
        **kwargs: Any
        ...
        :type body:
         ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringTrainingJobOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringTrainingJobResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get_copy_project_status(
        ...
        :return: GetCopyProjectStatusResponse. The GetCopyProjectStatusResponse is compatible with
         MutableMapping
        :rtype: ~azure.ai.language.authoring.analyzeconversations.models.GetCopyProjectStatusResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_deployments(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringProjectDeployment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def begin_swap_deployments(
        ...
        **kwargs: Any
        ...
        :type body:
         ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringSwapDeploymentsOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns None
    ...
    async def get_deployment(
        ...
        :rtype: ~azure.ai.language.authoring.analyzeconversations.models.GetDeploymentResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_deploy_project(
        ...
        **kwargs: Any
        ...
        :type body:
         ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringCreateDeploymentOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns None
    ...
    async def begin_delete_deployment_from_resources(
        ...
        **kwargs: Any
        ...
        :type body:
         ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringDeleteDeploymentOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns None
    ...
    async def get_deployment_delete_from_resources_status(  # pylint: disable=name-too-long
        ...
        :rtype:
         ~azure.ai.language.authoring.analyzeconversations.models.GetDeploymentDeleteFromResourcesStatusResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_deployment_status(
        ...
        :return: GetDeploymentStatusResponse. The GetDeploymentStatusResponse is compatible with
         MutableMapping
        :rtype: ~azure.ai.language.authoring.analyzeconversations.models.GetDeploymentStatusResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_swap_deployments_status(
        ...
        :return: GetSwapDeploymentsStatusResponse. The GetSwapDeploymentsStatusResponse is compatible
         with MutableMapping
        :rtype:
         ~azure.ai.language.authoring.analyzeconversations.models.GetSwapDeploymentsStatusResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_export_status(self, project_name: str, job_id: str, **kwargs: Any) -> _models.GetExportStatusResponse:
        ...
        :rtype: ~azure.ai.language.authoring.analyzeconversations.models.GetExportStatusResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_import_status(self, project_name: str, job_id: str, **kwargs: Any) -> _models.GetImportStatusResponse:
        ...
        :rtype: ~azure.ai.language.authoring.analyzeconversations.models.GetImportStatusResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_trained_models(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringProjectTrainedModel]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def get_trained_model(
        ...
        :rtype: ~azure.ai.language.authoring.analyzeconversations.models.GetTrainedModelResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_evaluate_model(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringEvaluationJobResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get_evaluation_status(
        ...
        :return: GetEvaluationStatusResponse. The GetEvaluationStatusResponse is compatible with
         MutableMapping
        :rtype: ~azure.ai.language.authoring.analyzeconversations.models.GetEvaluationStatusResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def get_model_evaluation_results(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringUtteranceEvaluationResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def get_model_evaluation_summary(
        ...
        :rtype:
         ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringEvaluationSummary
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_load_snapshot_status(
        ...
        :return: GetLoadSnapshotStatusResponse. The GetLoadSnapshotStatusResponse is compatible with
         MutableMapping
        :rtype: ~azure.ai.language.authoring.analyzeconversations.models.GetLoadSnapshotStatusResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_deployment_resources(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringAssignedDeploymentResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def begin_assign_deployment_resources(
        ...
        **kwargs: Any
        ...
        :type body:
         ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringAssignDeploymentResourcesOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns None
    ...
    async def begin_unassign_deployment_resources(
        ...
        **kwargs: Any
        ...
        :type body:
         ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringUnassignDeploymentResourcesOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns None
    ...
    async def get_assign_deployment_resources_status(
        ...
        :rtype:
         ~azure.ai.language.authoring.analyzeconversations.models.GetAssignDeploymentResourcesStatusResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_unassign_deployment_resources_status(
        ...
        :rtype:
         ~azure.ai.language.authoring.analyzeconversations.models.GetUnassignDeploymentResourcesStatusResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_training_jobs(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringTrainingJobState]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def get_training_status(
        ...
        :return: GetTrainingStatusResponse. The GetTrainingStatusResponse is compatible with
         MutableMapping
        :rtype: ~azure.ai.language.authoring.analyzeconversations.models.GetTrainingStatusResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_project_deletion_status(self, job_id: str, **kwargs: Any) -> _models.GetProjectDeletionStatusResponse:
        ...
        :return: GetProjectDeletionStatusResponse. The GetProjectDeletionStatusResponse is compatible
         with MutableMapping
        :rtype:
         ~azure.ai.language.authoring.analyzeconversations.models.GetProjectDeletionStatusResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def list_assigned_resource_deployments(
        ...
        :return: ConversationalAnalysisAuthoringAssignedResourceDeploymentsMetadata. The
         ...
         MutableMapping
        :rtype:
         ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringAssignedResourceDeploymentsMetadata
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_supported_languages(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringSupportedLanguages
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_supported_prebuilt_entities(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringPrebuiltEntities
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def list_training_config_versions(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.ai.language.authoring.analyzeconversations.models.ConversationalAnalysisAuthoringTrainingConfigVersions
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
