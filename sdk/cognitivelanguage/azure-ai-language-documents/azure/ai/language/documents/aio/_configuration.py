...
class AnalyzeDocumentsClientConfiguration:  # pylint: disable=too-many-instance-attributes
    """Configuration for AnalyzeDocumentsClient.
    ...
    def __init__(
        ...
        kwargs.setdefault("sdk_moniker", "ai-language-documents/{}".format(VERSION))
