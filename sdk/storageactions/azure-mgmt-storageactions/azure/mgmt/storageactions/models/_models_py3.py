...
class StorageTaskAssignment(_serialization.Model):
    ...
    :ivar id: Fully qualified ARM resource id of the Storage Task Assignment.
    :vartype id: str
    """
...
class StorageTaskProperties(_serialization.Model):
    ...
    def __init__(
        self, *, enabled: bool, action: "_models.StorageTaskAction", description: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
