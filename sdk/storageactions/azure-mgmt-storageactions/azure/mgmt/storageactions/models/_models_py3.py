...
class PagedStorageTaskAssignment(_serialization.Model):
    ...
    def __init__(
        self, *, value: List["_models.StorageTaskAssignment"], next_link: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: The StorageTaskAssignment items on this page. Required.
        :paramtype value: list[~azure.mgmt.storageactions.models.StorageTaskAssignment]
...
class StorageTaskListResult(_serialization.Model):
    """The response of a StorageTask list operation.

    All required parameters must be populated in order to send to Azure.

    :ivar value: The StorageTask items on this page. Required.
    ...
    def __init__(self, *, value: List["_models.StorageTask"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword value: The StorageTask items on this page. Required.
        :paramtype value: list[~azure.mgmt.storageactions.models.StorageTask]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class StorageTaskReportInstanceListResult(_serialization.Model):
    ...
    def __init__(
        self, *, value: List["_models.StorageTaskReportInstance"], next_link: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: The StorageTaskReportInstance items on this page. Required.
        :paramtype value: list[~azure.mgmt.storageactions.models.StorageTaskReportInstance]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
