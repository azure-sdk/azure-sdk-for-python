...
def build_storage_tasks_list_request(
...
def build_storage_tasks_storage_task_assignment_list_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    storage_task_name: str,
    subscription_id: str,
    *,
...
def build_storage_tasks_operation_group_preview_actions_request(  # pylint: disable=name-too-long
...
class Operations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.storageactions.StorageActionsClient`'s
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._config: StorageActionsClientConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
    ...
    def list(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_storage_tasks_list_request(
                    resource_group_name=resource_group_name,
                    storage_task_name=storage_task_name,
                    subscription_id=self._config.subscription_id,
    ...
    def storage_task_assignment_list(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_storage_tasks_storage_task_assignment_list_request(
                    resource_group_name=resource_group_name,
                    storage_task_name=storage_task_name,
                    subscription_id=self._config.subscription_id,
                    maxpagesize=maxpagesize,
...
class StorageTasksOperationGroupOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through
        :class:`~azure.mgmt.storageactions.StorageActionsClient`'s
        :attr:`storage_tasks_operation_group` attribute.
    """
