...
class StorageTasksReportOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        cls: ClsType[_models.StorageTaskReportInstanceListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("StorageTaskReportInstanceListResult", pipeline_response)
