...
from ...operations._storage_task_assignment_operations import build_list_request
...
class StorageTaskAssignmentOperations:
    ...
    def list(
        ...
        cls: ClsType[_models.PagedStorageTaskAssignment] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("PagedStorageTaskAssignment", pipeline_response)
