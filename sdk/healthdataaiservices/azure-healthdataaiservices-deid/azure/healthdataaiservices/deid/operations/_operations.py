...
class DeidentificationOperations:
    ...
    def begin_create_job(
    ...
    ) -> LROPoller[_models.DeidentifyJob]:
        ...
        :type resource: ~azure.healthdataaiservices.deid.models.DeidentifyJob
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns DeidentifyJob. The DeidentifyJob is compatible
         with MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.healthdataaiservices.deid.models.DeidentifyJob]
    ...
    def begin_create_job(
        ...
        :param resource: The resource instance. Is one of the following types: DeidentifyJob, JSON,
         IO[bytes] Required.
        :type resource: ~azure.healthdataaiservices.deid.models.DeidentifyJob or JSON or IO[bytes]
        :return: An instance of LROPoller that returns DeidentifyJob. The DeidentifyJob is compatible
         with MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.healthdataaiservices.deid.models.DeidentifyJob]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return LROPoller[_models.DeidentifyJob].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.DeidentifyJob](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )

    @distributed_trace
    def get_job(self, name: str, **kwargs: Any) -> _models.DeidentifyJob:
        # pylint: disable=line-too-long
        ...
        :rtype: ~azure.healthdataaiservices.deid.models.DeidentifyJob
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_jobs(
    ...
    ) -> Iterable["_models.DeidentifyJob"]:
        # pylint: disable=line-too-long
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.healthdataaiservices.deid.models.DeidentifyJob]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_job_files(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.healthdataaiservices.deid.models.HealthFileDetails]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    @distributed_trace
    def cancel_job(self, name: str, **kwargs: Any) -> _models.DeidentifyJob:
        # pylint: disable=line-too-long
    ...
    def deidentify(
        ...
        :type body: ~azure.healthdataaiservices.deid.models.DeidentifyOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: DeidentifyResult. The DeidentifyResult is compatible with MutableMapping
        :rtype: ~azure.healthdataaiservices.deid.models.DeidentifyResult
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def deidentify(
        ...
        :type body: ~azure.healthdataaiservices.deid.models.DeidentifyOptions or JSON or IO[bytes]
        :return: DeidentifyResult. The DeidentifyResult is compatible with MutableMapping
        :rtype: ~azure.healthdataaiservices.deid.models.DeidentifyResult
        :raises ~azure.core.exceptions.HttpResponseError:
