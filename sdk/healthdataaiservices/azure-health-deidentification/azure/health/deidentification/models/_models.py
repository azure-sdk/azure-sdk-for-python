...
class DeidentifyJob(_model_base.Model):  # pylint: disable=too-many-instance-attributes
...
class DeidentifyOptions(_model_base.Model):
...
class DeidentifyResult(_model_base.Model):
