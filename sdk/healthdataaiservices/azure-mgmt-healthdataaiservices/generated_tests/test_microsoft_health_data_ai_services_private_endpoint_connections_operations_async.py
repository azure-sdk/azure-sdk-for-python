...
# --------------------------------------------------------------------------
import pytest
from azure.mgmt.healthdataaiservices.aio import MicrosoftHealthDataAIServices
...
class TestMicrosoftHealthDataAIServicesPrivateEndpointConnectionsOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(MicrosoftHealthDataAIServices, is_async=True)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_private_endpoint_connections_list_by_deid_service(self, resource_group):
        response = self.client.private_endpoint_connections.list_by_deid_service(
            resource_group_name=resource_group.name,
            deid_service_name="str",
            api_version="2024-09-20",
        )
