...
# --------------------------------------------------------------------------
import pytest
from azure.mgmt.healthdataaiservices.aio import MicrosoftHealthDataAIServicesForTesting
...
class TestMicrosoftHealthDataAIServicesForTestingPrivateEndpointConnectionsOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(MicrosoftHealthDataAIServicesForTesting, is_async=True)
    ...
    async def test_list_by_deid_service(self, resource_group):
        response = self.client.private_endpoint_connections.list_by_deid_service(
            ...
            api_version="2024-02-28-preview",
        )
