...
from ._configuration import MicrosoftHealthDataAIServicesForTestingConfiguration
...
class MicrosoftHealthDataAIServicesForTesting:  # pylint: disable=client-accepts-api-version-keyword
    """MicrosoftHealthDataAIServicesForTesting.
    ...
    :type base_url: str
    :keyword api_version: Api Version. Default value is "2024-02-28-preview". Note that overriding
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = MicrosoftHealthDataAIServicesForTestingConfiguration(
