...
class SupportTicketsOperations:
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._config: MicrosoftSupportConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        and your contact information in the support ticket.\\ :code:`<br/>`\\ :code:`<br/>`Note: The
        severity levels cannot be changed if a support ticket is actively being worked upon by an Azure
        support engineer. In such a case, contact your support engineer to request severity update by
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        <https://aka.ms/supportAPI>`_ required to create a support ticket.\\ :code:`<br/>`\\
        :code:`<br/>`Always call the Services and ProblemClassifications API to get the most recent set
        of services and problem categories required for support ticket creation.\\ :code:`<br/>`\\
        :code:`<br/>`Adding attachments is not currently supported via the API. To add a file to an
        existing support ticket, visit the `Manage support ticket
        ...
        information from your Azure resources.\\ :code:`<br/>`\\ :code:`<br/>`\\ **Creating a support
        ticket for on-behalf-of**\\ : Include *x-ms-authorization-auxiliary* header to provide an
        auxiliary token as per `documentation
