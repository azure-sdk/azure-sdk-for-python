...
from ...operations._file_workspaces_no_subscription_operations import build_create_request, build_get_request
...
class FileWorkspacesNoSubscriptionOperations:
    ...
    async def get(self, file_workspace_name: str, **kwargs: Any) -> _models.FileWorkspaceDetails:
        ...
        deserialized = self._deserialize("FileWorkspaceDetails", pipeline_response.http_response)
