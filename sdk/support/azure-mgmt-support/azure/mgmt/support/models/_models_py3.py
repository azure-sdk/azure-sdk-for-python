...
class CommunicationDetails(_serialization.Model):
    ...
    def __init__(
        ...
        self.name: Optional[str] = None
        self.type: Optional[str] = None
        self.communication_type: Optional[Union[str, "_models.CommunicationType"]] = None
        self.communication_direction: Optional[Union[str, "_models.CommunicationDirection"]] = None
        self.sender = sender
...
class ContactProfile(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword phone_number: Phone number. This is required if preferred contact method is phone. It
         is also required when submitting 'critical' or 'highestcriticalimpact' severity cases.
...
class MessageProperties(_serialization.Model):
    ...
    def __init__(self, *, body: str, sender: Optional[str] = None, **kwargs: Any) -> None:
        ...
        """
        super().__init__(**kwargs)
        self.content_type: Optional[Union[str, "_models.TranscriptContentType"]] = None
        self.communication_direction: Optional[Union[str, "_models.CommunicationDirection"]] = None
        self.sender = sender
        self.body = body
        self.created_date: Optional[datetime.datetime] = None
...
class ProblemClassificationsClassificationResult(_serialization.Model):  # pylint: disable=name-too-long
    ...
    def __init__(self, *, resource_types: Optional[List[str]] = None, **kwargs: Any) -> None:
        ...
        self.description: Optional[str] = None
        self.service_id: Optional[str] = None
        self.problem_classification_id: Optional[str] = None
        self.service_id_related_service_id: Optional[str] = None
        self.display_name: Optional[str] = None
        self.resource_types = resource_types
...
class ServiceLevelAgreement(_serialization.Model):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.start_time: Optional[datetime.datetime] = None
        self.expiration_time: Optional[datetime.datetime] = None
        self.sla_minutes: Optional[int] = None
...
class SupportTicketDetails(_serialization.Model):
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        self.problem_classification_display_name: Optional[str] = None
        ...
        self.support_plan_type: Optional[str] = None
        self.support_plan_display_name: Optional[str] = None
        self.title = title
        self.problem_start_time = problem_start_time
        self.service_id = service_id
        self.service_display_name: Optional[str] = None
        self.status: Optional[str] = None
        self.created_date: Optional[datetime.datetime] = None
        self.modified_date: Optional[datetime.datetime] = None
        self.file_workspace_name = file_workspace_name
        self.is_temporary_ticket: Optional[Union[str, "_models.IsTemporaryTicket"]] = None
