...
def build_classify_problems_request(problem_service_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
...
class ProblemClassificationsOperations:
    ...
    def classify_problems(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("ProblemClassificationsClassificationOutput", pipeline_response.http_response)
    ...
    def get(self, service_name: str, problem_classification_name: str, **kwargs: Any) -> _models.ProblemClassification:
        ...
        deserialized = self._deserialize("ProblemClassification", pipeline_response.http_response)
