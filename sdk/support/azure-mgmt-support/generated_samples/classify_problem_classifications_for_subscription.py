...
# USAGE
    python classify_problem_classifications_for_subscription.py
...
def main():
    ...
    response = client.problem_classifications.classify_problems(
        problem_service_name="serviceId1",
        problem_classifications_classification_input={
