...
class ProgrammableConnectivityClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype device_location:
     azure.communication.programmableconnectivity.aio.operations.DeviceLocationOperations
    :ivar device_network: DeviceNetworkOperations operations
    :vartype device_network:
     azure.communication.programmableconnectivity.aio.operations.DeviceNetworkOperations
    :ivar number_verification: NumberVerificationOperations operations
    :vartype number_verification:
     azure.communication.programmableconnectivity.aio.operations.NumberVerificationOperations
    :ivar sim_swap: SimSwapOperations operations
    :vartype sim_swap:
     azure.communication.programmableconnectivity.aio.operations.SimSwapOperations
