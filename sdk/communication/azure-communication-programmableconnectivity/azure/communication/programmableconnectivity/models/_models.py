...
class DeviceLocationVerificationContent(_model_base.Model):
    ...
    :vartype network_identifier:
     ~azure.communication.programmableconnectivity.models.NetworkIdentifier
    ...
    :vartype device: ~azure.communication.programmableconnectivity.models.LocationDevice
    """
...
class LocationDevice(_model_base.Model):
    ...
    :vartype ipv4_address: ~azure.communication.programmableconnectivity.models.Ipv4Address
    :ivar ipv6_address: The Ipv6 address.
    :vartype ipv6_address: ~azure.communication.programmableconnectivity.models.Ipv6Address
    """
