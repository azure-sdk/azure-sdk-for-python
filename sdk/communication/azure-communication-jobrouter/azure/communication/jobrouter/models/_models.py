...
class AcceptJobOfferResult(_Model):
...
class CancelJobResult(_Model):
    """Response payload from cancelling a job."""


class ClassificationPolicy(_Model):
...
class CloseJobResult(_Model):
    """Response payload from closing a job."""


class CompleteJobOptions(_Model):
...
class CompleteJobResult(_Model):
    """Response payload from completing a job."""


class QueueSelectorAttachment(_Model):
...
class WorkerSelectorAttachment(_Model):
...
class DeclineJobOfferOptions(_Model):
...
class DeclineJobOfferResult(_Model):
    """Response payload from declining a job."""


class RouterRule(_Model):
...
class DistributionPolicy(_Model):
...
class FunctionRouterRuleCredential(_Model):
    """Credentials used to access Azure function rule.
...
class OAuth2WebhookClientCredential(_Model):
...
class QueueWeightedAllocation(_Model):
...
class ReclassifyJobOptions(_Model):
    """Request payload for reclassifying jobs."""


class ReclassifyJobResult(_Model):
...
class RouterJobAssignment(_Model):
...
class RouterJobPositionDetails(_Model):
...
class RouterQueueSelector(_Model):
...
class RouterQueueStatistics(_Model):
...
class RouterWorkerAssignment(_Model):
...
class RouterWorkerSelector(_Model):
...
class ScoringRuleOptions(_Model):
...
class UnassignJobOptions(_Model):
...
class UnassignJobResult(_Model):
...
class WorkerWeightedAllocation(_Model):
