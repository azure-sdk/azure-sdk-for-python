...
class JobRouterAdministrationClientOperationsMixin(  # pylint: disable=name-too-long
    ClientMixinABC[AsyncPipelineClient, JobRouterAdministrationClientConfiguration]
):
...
class JobRouterClientOperationsMixin(ClientMixinABC[AsyncPipelineClient, JobRouterClientConfiguration]):
