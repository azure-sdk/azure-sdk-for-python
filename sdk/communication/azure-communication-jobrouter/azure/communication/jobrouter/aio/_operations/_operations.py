...
class JobRouterAdministrationClientOperationsMixin(  # pylint: disable=name-too-long
    ClientMixinABC[AsyncPipelineClient[HttpRequest, AsyncHttpResponse], JobRouterAdministrationClientConfiguration]
):
...
class JobRouterClientOperationsMixin(
    ClientMixinABC[AsyncPipelineClient[HttpRequest, AsyncHttpResponse], JobRouterClientConfiguration]
):
