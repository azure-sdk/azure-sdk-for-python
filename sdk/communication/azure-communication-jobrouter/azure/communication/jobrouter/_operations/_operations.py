...
class JobRouterAdministrationClientOperationsMixin(  # pylint: disable=name-too-long
    ClientMixinABC[PipelineClient[HttpRequest, HttpResponse], JobRouterAdministrationClientConfiguration]
):
...
class JobRouterClientOperationsMixin(
    ClientMixinABC[PipelineClient[HttpRequest, HttpResponse], JobRouterClientConfiguration]
):
