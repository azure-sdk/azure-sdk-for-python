...
class JobRouterAdministrationClientOperationsMixin(  # pylint: disable=name-too-long
    ClientMixinABC[PipelineClient, JobRouterAdministrationClientConfiguration]
):
...
class JobRouterClientOperationsMixin(ClientMixinABC[PipelineClient, JobRouterClientConfiguration]):
