...
class DistributionMode(_model_base.Model):
    ...
    :vartype kind: str or ~azurecommunicationroutingservice.models.DistributionModeKind
    """
...
class BestWorkerMode(DistributionMode, discriminator="bestWorker"):
    ...
    :vartype scoring_rule: ~azurecommunicationroutingservice.models.RouterRule
    :ivar scoring_rule_options: Options to configure 'scoringRule'. If not set, default values are
     used.
    :vartype scoring_rule_options: ~azurecommunicationroutingservice.models.ScoringRuleOptions
    :ivar kind: The type discriminator describing a sub-type of Mode. Required. Discriminator value
     for BestWorkerMode.
    :vartype kind: str or ~azurecommunicationroutingservice.models.BEST_WORKER
    """
...
class ExceptionAction(_model_base.Model):
    ...
    :vartype kind: str or ~azurecommunicationroutingservice.models.ExceptionActionKind
    """
...
class CancelExceptionAction(ExceptionAction, discriminator="cancel"):
    ...
    :vartype kind: str or ~azurecommunicationroutingservice.models.CANCEL
    """
...
class ClassificationPolicy(_model_base.Model):
    ...
    :vartype queue_selector_attachments:
     list[~azurecommunicationroutingservice.models.QueueSelectorAttachment]
    :ivar prioritization_rule: A rule to determine a priority score for a job.
    :vartype prioritization_rule: ~azurecommunicationroutingservice.models.RouterRule
    ...
    :vartype worker_selector_attachments:
     list[~azurecommunicationroutingservice.models.WorkerSelectorAttachment]
    """
...
class QueueSelectorAttachment(_model_base.Model):
    ...
    :ivar kind: The type discriminator describing a sub-type of QueueSelectorAttachment. Required.
     ...
     "weightedAllocation".
    :vartype kind: str or ~azurecommunicationroutingservice.models.QueueSelectorAttachmentKind
    """
...
class ConditionalQueueSelectorAttachment(QueueSelectorAttachment, discriminator="conditional"):
    ...
    :ivar condition: The condition that must be true for the queue selectors to be attached.
     Required.
    :vartype condition: ~azurecommunicationroutingservice.models.RouterRule
    :ivar queue_selectors: The queue selectors to attach. Required.
    :vartype queue_selectors: list[~azurecommunicationroutingservice.models.RouterQueueSelector]
    ...
    :vartype kind: str or ~azurecommunicationroutingservice.models.CONDITIONAL
    """
...
class WorkerSelectorAttachment(_model_base.Model):
    ...
    :ivar kind: The type discriminator describing a sub-type of WorkerSelectorAttachment. Required.
     Known values are: "conditional", "passThrough", "ruleEngine", "static", and
     "weightedAllocation".
    :vartype kind: str or ~azurecommunicationroutingservice.models.WorkerSelectorAttachmentKind
    """
...
class ConditionalWorkerSelectorAttachment(WorkerSelectorAttachment, discriminator="conditional"):
    ...
    :vartype worker_selectors: list[~azurecommunicationroutingservice.models.RouterWorkerSelector]
...
class RouterRule(_model_base.Model):
    ...
    :vartype kind: str or ~azurecommunicationroutingservice.models.RouterRuleKind
    """
...
class DirectMapRouterRule(RouterRule, discriminator="directMap"):
    ...
    :vartype kind: str or ~azurecommunicationroutingservice.models.DIRECT_MAP
    """
...
class DistributionPolicy(_model_base.Model):
    ...
    :vartype mode: ~azurecommunicationroutingservice.models.DistributionMode
    """
...
class ExceptionPolicy(_model_base.Model):
    ...
    :vartype exception_rules: list[~azurecommunicationroutingservice.models.ExceptionRule]
    """
...
class ExceptionRule(_model_base.Model):
    ...
    :vartype trigger: ~azurecommunicationroutingservice.models.ExceptionTrigger
    :ivar actions: A collection of actions to perform once the exception is triggered. Required.
    :vartype actions: list[~azurecommunicationroutingservice.models.ExceptionAction]
    """
...
class ExceptionTrigger(_model_base.Model):
    ...
    :vartype kind: str or ~azurecommunicationroutingservice.models.ExceptionTriggerKind
    """
...
class ExpressionRouterRule(RouterRule, discriminator="expression"):
    ...
    :vartype language: str or ~azurecommunicationroutingservice.models.ExpressionRouterRuleLanguage
    :ivar expression: An expression to evaluate. Should contain return statement with calculated
     values. Required.
    :vartype expression: str
    :ivar kind: The type discriminator describing a sub-type of Rule. Required. Discriminator value
     for ExpressionRouterRule.
    :vartype kind: str or ~azurecommunicationroutingservice.models.EXPRESSION
    """
...
class FunctionRouterRule(RouterRule, discriminator="function"):
    ...
    :vartype credential: ~azurecommunicationroutingservice.models.FunctionRouterRuleCredential
    :ivar kind: The type discriminator describing a sub-type of Rule. Required. Discriminator value
     for FunctionRouterRule.
    :vartype kind: str or ~azurecommunicationroutingservice.models.FUNCTION
    """
...
class JobMatchingMode(_model_base.Model):
    ...
    :vartype kind: str or ~azurecommunicationroutingservice.models.JobMatchingModeKind
    """
...
class LongestIdleMode(DistributionMode, discriminator="longestIdle"):
    ...
    :ivar kind: The type discriminator describing a sub-type of Mode. Required. Discriminator value
     for LongestIdleMode.
    :vartype kind: str or ~azurecommunicationroutingservice.models.LONGEST_IDLE
    """
...
class ManualReclassifyExceptionAction(ExceptionAction, discriminator="manualReclassify"):
    ...
    :vartype kind: str or ~azurecommunicationroutingservice.models.MANUAL_RECLASSIFY
    """
...
class PassThroughQueueSelectorAttachment(QueueSelectorAttachment, discriminator="passThrough"):
    ...
    :vartype label_operator: str or ~azurecommunicationroutingservice.models.LabelOperator
    :ivar kind: The type discriminator describing the type of queue selector attachment. Required.
     Discriminator value for PassThroughQueueSelectorAttachment.
    :vartype kind: str or ~azurecommunicationroutingservice.models.PASS_THROUGH
    """
...
class QueueAndMatchMode(JobMatchingMode, discriminator="queueAndMatch"):
    ...
    :vartype kind: str or ~azurecommunicationroutingservice.models.QUEUE_AND_MATCH
    """
...
class QueueLengthExceptionTrigger(ExceptionTrigger, discriminator="queueLength"):
    ...
    :vartype kind: str or ~azurecommunicationroutingservice.models.QUEUE_LENGTH
    """
...
class ReclassifyExceptionAction(ExceptionAction, discriminator="reclassify"):
    ...
    :vartype kind: str or ~azurecommunicationroutingservice.models.RECLASSIFY
    """
...
class RoundRobinMode(DistributionMode, discriminator="roundRobin"):
    ...
    :ivar kind: The type discriminator describing a sub-type of Mode. Required. Discriminator value
     for RoundRobinMode.
    :vartype kind: str or ~azurecommunicationroutingservice.models.ROUND_ROBIN
    """
...
class RouterJob(_model_base.Model):
    ...
    :vartype status: str or ~azurecommunicationroutingservice.models.RouterJobStatus
    ...
    :vartype requested_worker_selectors:
     list[~azurecommunicationroutingservice.models.RouterWorkerSelector]
    ...
    :vartype assignments: dict[str, ~azurecommunicationroutingservice.models.RouterJobAssignment]
    ...
    :vartype notes: list[~azurecommunicationroutingservice.models.RouterJobNote]
    ...
    :vartype matching_mode: ~azurecommunicationroutingservice.models.JobMatchingMode
    """
...
class RouterWorker(_model_base.Model):
    ...
    :vartype state: str or ~azurecommunicationroutingservice.models.RouterWorkerState
    ...
    :ivar channels: Collection of channel(s) this worker can handle and their impact on the workers
     capacity.
    :vartype channels: list[~azurecommunicationroutingservice.models.RouterChannel]
    :ivar offers: A list of active offers issued to this worker.
    :vartype offers: list[~azurecommunicationroutingservice.models.RouterJobOffer]
    :ivar assigned_jobs: A list of assigned jobs attached to this worker.
    :vartype assigned_jobs: list[~azurecommunicationroutingservice.models.RouterWorkerAssignment]
...
class RouterWorkerSelector(_model_base.Model):
    ...
    :vartype status: str or ~azurecommunicationroutingservice.models.RouterWorkerSelectorStatus
...
class RuleEngineQueueSelectorAttachment(QueueSelectorAttachment, discriminator="ruleEngine"):
    ...
    :vartype rule: ~azurecommunicationroutingservice.models.RouterRule
    :ivar kind: The type discriminator describing the type of queue selector attachment. Required.
     Discriminator value for RuleEngineQueueSelectorAttachment.
    :vartype kind: str or ~azurecommunicationroutingservice.models.RULE_ENGINE
    """
...
class ScheduleAndSuspendMode(JobMatchingMode, discriminator="scheduleAndSuspend"):
    ...
    :vartype kind: str or ~azurecommunicationroutingservice.models.SCHEDULE_AND_SUSPEND
    """
...
class ScoringRuleOptions(_model_base.Model):
    ...
    :vartype scoring_parameters: list[str or
     ~azurecommunicationroutingservice.models.ScoringRuleParameterSelector]
...
class StaticQueueSelectorAttachment(QueueSelectorAttachment, discriminator="static"):
    ...
    :vartype queue_selector: ~azurecommunicationroutingservice.models.RouterQueueSelector
    :ivar kind: The type discriminator describing the type of queue selector attachment. Required.
     Discriminator value for StaticQueueSelectorAttachment.
    :vartype kind: str or ~azurecommunicationroutingservice.models.STATIC
    """
...
class StaticWorkerSelectorAttachment(WorkerSelectorAttachment, discriminator="static"):
    ...
    :vartype worker_selector: ~azurecommunicationroutingservice.models.RouterWorkerSelector
    :ivar kind: The type discriminator describing the type of worker selector attachment. Required.
...
class SuspendMode(JobMatchingMode, discriminator="suspend"):
    ...
    :ivar kind: The type discriminator describing SuspendMode. Required. Discriminator value for
     SuspendMode.
    :vartype kind: str or ~azurecommunicationroutingservice.models.SUSPEND
    """
...
class WaitTimeExceptionTrigger(ExceptionTrigger, discriminator="waitTime"):
    ...
    :vartype kind: str or ~azurecommunicationroutingservice.models.WAIT_TIME
    """
...
class WebhookRouterRule(RouterRule, discriminator="webhook"):
    ...
    :ivar client_credential: OAuth2.0 Credentials used to Contoso's Authorization server.
     ...
     <https://www.oauth.com/oauth2-servers/access-tokens/client-credentials/>`_.
    :vartype client_credential:
     ~azurecommunicationroutingservice.models.OAuth2WebhookClientCredential
    :ivar webhook_uri: Uri for Contoso's Web Server.
    :vartype webhook_uri: str
    :ivar kind: The type discriminator describing a sub-type of Rule. Required. Discriminator value
     for WebhookRouterRule.
    :vartype kind: str or ~azurecommunicationroutingservice.models.WEBHOOK
    """
...
class WeightedAllocationQueueSelectorAttachment(
    ...
    :vartype allocations: list[~azurecommunicationroutingservice.models.QueueWeightedAllocation]
    :ivar kind: The type discriminator describing the type of queue selector attachment. Required.
     Discriminator value for WeightedAllocationQueueSelectorAttachment.
    :vartype kind: str or ~azurecommunicationroutingservice.models.WEIGHTED_ALLOCATION
    """
...
class WeightedAllocationWorkerSelectorAttachment(
    ...
    :ivar allocations: A collection of percentage based weighted allocations. Required.
    :vartype allocations: list[~azurecommunicationroutingservice.models.WorkerWeightedAllocation]
    :ivar kind: The type discriminator describing the type of worker selector attachment. Required.
