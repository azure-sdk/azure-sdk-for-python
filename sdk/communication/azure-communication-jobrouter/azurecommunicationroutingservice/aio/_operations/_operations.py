...
class JobRouterAdministrationClientOperationsMixin(  # pylint: disable=name-too-long
    ...
    def list_distribution_policies(self, **kwargs: Any) -> AsyncIterable["_models.DistributionPolicy"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azurecommunicationroutingservice.models.DistributionPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_classification_policies(self, **kwargs: Any) -> AsyncIterable["_models.ClassificationPolicy"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azurecommunicationroutingservice.models.ClassificationPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_exception_policies(self, **kwargs: Any) -> AsyncIterable["_models.ExceptionPolicy"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azurecommunicationroutingservice.models.ExceptionPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_queues(self, **kwargs: Any) -> AsyncIterable["_models.RouterQueue"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azurecommunicationroutingservice.models.RouterQueue]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class JobRouterClientOperationsMixin(JobRouterClientMixinABC):
    ...
    def list_jobs(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azurecommunicationroutingservice.models.RouterJob]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_workers(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azurecommunicationroutingservice.models.RouterWorker]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
