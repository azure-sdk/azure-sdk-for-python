...
class DeviceLocationVerificationContent(_Model):
    ...
    network_identifier: "_models.NetworkIdentifier" = rest_field(
    ...
    accuracy: int = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Accuracy expected for location verification in kilometers. Required."""
    device: "_models.LocationDevice" = rest_field(visibility=["read", "create", "update", "delete", "query"])
...
class DeviceLocationVerificationResult(_Model):
    ...
    verification_result: bool = rest_field(
        name="verificationResult", visibility=["read", "create", "update", "delete", "query"]
    )
...
class Ipv4Address(_Model):
    ...
    ipv4: str = rest_field(visibility=["read", "create", "update", "delete", "query"])
...
class Ipv6Address(_Model):
    ...
    ipv6: str = rest_field(visibility=["read", "create", "update", "delete", "query"])
...
class LocationDevice(_Model):
    ...
    network_access_identifier: Optional[str] = rest_field(
        name="networkAccessIdentifier", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    ipv4_address: Optional["_models.Ipv4Address"] = rest_field(
        name="ipv4Address", visibility=["read", "create", "update", "delete", "query"]
    )
    """The Ipv4 address."""
    ipv6_address: Optional["_models.Ipv6Address"] = rest_field(
...
class NetworkIdentifier(_Model):
    """Identifier for the network to be queried.

    :ivar identifier_type: The type of identifier for the network. one of: 'IPv4', 'IPv6',
     'MSISDN', 'NetworkCode'. Required.
    :vartype identifier_type: str
    :ivar identifier: The network identifier, based on the identifierType: an IPv4 address, an IPv6
    ...
    identifier_type: str = rest_field(name="identifierType", visibility=["read", "create", "update", "delete", "query"])
    ...
    """The network identifier, based on the identifierType: an IPv4 address, an IPv6 address, an
     MSISDN, or a Network Code.
     A Network Code may be obtained from APC documentation or from the APC /Network:retrieve
     endpoint. Required."""
...
class NetworkRetrievalResult(_Model):
    ...
    network_code: str = rest_field(name="networkCode", visibility=["read", "create", "update", "delete", "query"])
...
class NumberVerificationResult(_Model):
...
class NumberVerificationWithCodeContent(_Model):
    ...
    apc_code: str = rest_field(name="apcCode", visibility=["read", "create", "update", "delete", "query"])
...
class NumberVerificationWithoutCodeContent(_Model):
    ...
    """Phone number in E.164 format (starting with country code), and optionally prefixed with '+'."""
    hashed_phone_number: Optional[str] = rest_field(
        name="hashedPhoneNumber", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    redirect_uri: str = rest_field(name="redirectUri", visibility=["read", "create", "update", "delete", "query"])
...
class SimSwapRetrievalContent(_Model):
...
class SimSwapRetrievalResult(_Model):
...
class SimSwapVerificationContent(_Model):
    ...
    """Phone number in E.164 format (starting with country code), and optionally prefixed with '+'."""
    max_age_hours: Optional[int] = rest_field(
        name="maxAgeHours", visibility=["read", "create", "update", "delete", "query"]
    )
...
class SimSwapVerificationResult(_Model):
