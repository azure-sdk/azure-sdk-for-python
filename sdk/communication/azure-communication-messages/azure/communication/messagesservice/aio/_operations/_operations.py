...
class NotificationMessagesClientOperationsMixin(NotificationMessagesClientMixinABC):  # pylint: disable=name-too-long
    ...
    async def send(
        ...
        :type body: ~azure.communication.messagesservice.models.NotificationContent
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: SendMessageResult. The SendMessageResult is compatible with MutableMapping
        :rtype: ~azure.communication.messagesservice.models.SendMessageResult
    ...
    async def send(
        ...
        :type body: ~azure.communication.messagesservice.models.NotificationContent or JSON or
         IO[bytes]
        :return: SendMessageResult. The SendMessageResult is compatible with MutableMapping
        :rtype: ~azure.communication.messagesservice.models.SendMessageResult
        :raises ~azure.core.exceptions.HttpResponseError:
...
class MessageTemplateClientOperationsMixin(MessageTemplateClientMixinABC):
    ...
    def list_templates(self, channel_id: str, **kwargs: Any) -> AsyncIterable["_models.MessageTemplateItem"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.communication.messagesservice.models.MessageTemplateItem]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
