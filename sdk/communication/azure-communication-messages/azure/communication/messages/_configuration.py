...
class ConversationAdministrationClientConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long
    """Configuration for ConversationAdministrationClient.
...
class ConversationThreadClientConfiguration:  # pylint: disable=too-many-instance-attributes
    """Configuration for ConversationThreadClient.
