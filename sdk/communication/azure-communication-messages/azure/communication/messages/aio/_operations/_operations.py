...
class NotificationMessagesClientOperationsMixin(  # pylint: disable=name-too-long
    ClientMixinABC[AsyncPipelineClient, NotificationMessagesClientConfiguration]
):
...
class MessageTemplateClientOperationsMixin(ClientMixinABC[AsyncPipelineClient, MessageTemplateClientConfiguration]):
...
class ConversationAdministrationClientOperationsMixin(  # pylint: disable=name-too-long
    ClientMixinABC[AsyncPipelineClient, ConversationAdministrationClientConfiguration]
):
...
class ConversationThreadClientOperationsMixin(
    ClientMixinABC[AsyncPipelineClient, ConversationThreadClientConfiguration]
):
