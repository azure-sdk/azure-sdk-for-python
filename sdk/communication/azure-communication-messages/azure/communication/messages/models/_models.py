...
from ._enums import CommunicationMessageType, MessageTemplateType, TemplateParameterType
...
class MessageTemplateBindings(_model_base.Model):
    ...
    :vartype kind: str or ~azure.communication.messages.models.MessageTemplateType
    """
...
class MessageTemplateValue(_model_base.Model):
    ...
    :vartype kind: str or ~azure.communication.messages.models.TemplateParameterType
    """
...
class MessageTemplateDocument(MessageTemplateValue, discriminator="document"):
    ...
    kind: Literal[TemplateParameterType.DOCUMENT] = rest_discriminator(name="kind")  # type: ignore
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.kind: Literal[TemplateParameterType.DOCUMENT] = TemplateParameterType.DOCUMENT
...
class MessageTemplateImage(MessageTemplateValue, discriminator="image"):
    ...
    kind: Literal[TemplateParameterType.IMAGE] = rest_discriminator(name="kind")  # type: ignore
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.kind: Literal[TemplateParameterType.IMAGE] = TemplateParameterType.IMAGE
...
class MessageTemplateLocation(MessageTemplateValue, discriminator="location"):
    ...
    kind: Literal[TemplateParameterType.LOCATION] = rest_discriminator(name="kind")  # type: ignore
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.kind: Literal[TemplateParameterType.LOCATION] = TemplateParameterType.LOCATION
...
class MessageTemplateQuickAction(MessageTemplateValue, discriminator="quickAction"):
    ...
    kind: Literal[TemplateParameterType.QUICK_ACTION] = rest_discriminator(name="kind")  # type: ignore
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.kind: Literal[TemplateParameterType.QUICK_ACTION] = TemplateParameterType.QUICK_ACTION
...
class MessageTemplateText(MessageTemplateValue, discriminator="text"):
    ...
    kind: Literal[TemplateParameterType.TEXT] = rest_discriminator(name="kind")  # type: ignore
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.kind: Literal[TemplateParameterType.TEXT] = TemplateParameterType.TEXT
...
class MessageTemplateVideo(MessageTemplateValue, discriminator="video"):
    ...
    kind: Literal[TemplateParameterType.VIDEO] = rest_discriminator(name="kind")  # type: ignore
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.kind: Literal[TemplateParameterType.VIDEO] = TemplateParameterType.VIDEO
...
class WhatsAppMessageTemplateBindings(MessageTemplateBindings, discriminator="whatsApp"):
    ...
    kind: Literal[MessageTemplateType.WHATS_APP] = rest_discriminator(name="kind")  # type: ignore
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.kind: Literal[MessageTemplateType.WHATS_APP] = MessageTemplateType.WHATS_APP
