...
class NotificationContent(_model_base.Model):
    ...
    MediaNotificationContent, ReactionNotificationContent, StickerNotificationContent,
    TemplateNotificationContent, TextNotificationContent, VideoNotificationContent
    ...
    :ivar kind: The type discriminator describing a notification type. Required. Known values are:
     "text", "image", "image_v0", "document", "video", "audio", "sticker", "reaction", and
     "template".
    ...
    """The type discriminator describing a notification type. Required. Known values are: \"text\",
     \"image\", \"image_v0\", \"document\", \"video\", \"audio\", \"sticker\", \"reaction\", and
     \"template\"."""
...
class ReactionNotificationContent(NotificationContent, discriminator="reaction"):
    ...
    :ivar emoji: emoji content like \\uD83D\\uDE00.
    :vartype emoji: str
    :ivar message_id: ID of the previous message you want to reply to.
    :vartype message_id: str
    """
