...
def build_notification_messages_send_message_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/messages/notifications:sendMessage"
...
class NotificationMessagesClientOperationsMixin(NotificationMessagesClientMixinABC):  # pylint: disable=name-too-long
    ...
    def send_message(
        ...
        _request = build_notification_messages_send_message_request(
