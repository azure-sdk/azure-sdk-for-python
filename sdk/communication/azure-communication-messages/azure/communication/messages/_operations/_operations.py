...
class NotificationMessagesClientOperationsMixin(  # pylint: disable=name-too-long
    ClientMixinABC[PipelineClient, NotificationMessagesClientConfiguration]
):
...
class MessageTemplateClientOperationsMixin(ClientMixinABC[PipelineClient, MessageTemplateClientConfiguration]):
...
class ConversationAdministrationClientOperationsMixin(  # pylint: disable=name-too-long
    ClientMixinABC[PipelineClient, ConversationAdministrationClientConfiguration]
):
...
class ConversationThreadClientOperationsMixin(ClientMixinABC[PipelineClient, ConversationThreadClientConfiguration]):
