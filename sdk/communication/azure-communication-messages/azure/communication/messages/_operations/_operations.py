...
class NotificationMessagesClientOperationsMixin(  # pylint: disable=name-too-long
    ClientMixinABC[PipelineClient[HttpRequest, HttpResponse], NotificationMessagesClientConfiguration]
):
...
class MessageTemplateClientOperationsMixin(
    ClientMixinABC[PipelineClient[HttpRequest, HttpResponse], MessageTemplateClientConfiguration]
):
...
class ConversationAdministrationClientOperationsMixin(  # pylint: disable=name-too-long
    ClientMixinABC[PipelineClient[HttpRequest, HttpResponse], ConversationAdministrationClientConfiguration]
):
...
class ConversationThreadClientOperationsMixin(
    ClientMixinABC[PipelineClient[HttpRequest, HttpResponse], ConversationThreadClientConfiguration]
):
