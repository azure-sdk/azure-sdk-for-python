...
class Capacity(_model_base.Model):
...
class EncryptionIdentityProperties(_model_base.Model):
    ...
    :vartype identity_type: str or ~azure.mgmt.dell.models.EncryptionIdentityType
...
class EncryptionIdentityUpdateProperties(_model_base.Model):
...
class EncryptionProperties(_model_base.Model):
    ...
    :ivar encryption_type: Encryption Type - MMK/CMK. Required. Known values are:
     "ENCRYPTION_AT_REST_WITH_MICROSOFT_KEY" and "ENCRYPTION_AT_REST_WITH_CUSTOMER_KEY".
    :vartype encryption_type: str or ~azure.mgmt.dell.models.ResourceEncryptionType
    ...
    :ivar encryption_identity_properties: Identity configuration for Customer-managed key settings
     ...
     hence optional.
    :vartype encryption_identity_properties: ~azure.mgmt.dell.models.EncryptionIdentityProperties
    """
    ...
    """Encryption Type - MMK/CMK. Required. Known values are:
     \"ENCRYPTION_AT_REST_WITH_MICROSOFT_KEY\" and \"ENCRYPTION_AT_REST_WITH_CUSTOMER_KEY\"."""
...
class EncryptionUpdateProperties(_model_base.Model):
    """EncryptionUpdateProperties of Dell FileSystem resource.

    :ivar encryption_type: Encryption Type - MMK/CMK. Known values are:
     "ENCRYPTION_AT_REST_WITH_MICROSOFT_KEY" and "ENCRYPTION_AT_REST_WITH_CUSTOMER_KEY".
    :vartype encryption_type: str or ~azure.mgmt.dell.models.ResourceEncryptionType
    :ivar key_url: Versioned Encryption Key Url - Only when user opts for CMK and hence optional.
    :vartype key_url: str
    ...
    :vartype encryption_identity_properties:
     ~azure.mgmt.dell.models.EncryptionIdentityUpdateProperties
    """

    encryption_type: Optional[Union[str, "_models.ResourceEncryptionType"]] = rest_field(
        name="encryptionType", visibility=["read", "create", "update", "delete", "query"]
    )
    """Encryption Type - MMK/CMK. Known values are: \"ENCRYPTION_AT_REST_WITH_MICROSOFT_KEY\" and
...
class ErrorDetail(_model_base.Model):
    ...
    :vartype details: list[~azure.mgmt.dell.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info: list[~azure.mgmt.dell.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(_model_base.Model):
    ...
    :vartype error: ~azure.mgmt.dell.models.ErrorDetail
    """
...
class Resource(_model_base.Model):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.dell.models.SystemData
    """
...
class FileSystemResource(TrackedResource):
    ...
    :vartype properties: ~azure.mgmt.dell.models.FileSystemResourceProperties
    :ivar identity: The managed service identities assigned to this resource.
    :vartype identity: ~azure.mgmt.dell.models.ManagedServiceIdentity
    """
...
class FileSystemResourceProperties(_model_base.Model):
    ...
    :vartype capacity: ~azure.mgmt.dell.models.Capacity
    :ivar marketplace: Marketplace details. Required.
    :vartype marketplace: ~azure.mgmt.dell.models.MarketplaceDetails
    :ivar provisioning_state: Provisioning State of the resource. Known values are: "Accepted",
     ...
     "NotSpecified".
    :vartype provisioning_state: str or ~azure.mgmt.dell.models.ProvisioningState
    ...
    :vartype user: ~azure.mgmt.dell.models.UserDetails
    ...
    :vartype encryption: ~azure.mgmt.dell.models.EncryptionProperties
    """
...
class FileSystemResourceUpdate(_model_base.Model):
    ...
    :ivar identity: The managed service identities assigned to this resource.
    :vartype identity: ~azure.mgmt.dell.models.ManagedServiceIdentityUpdate
    :ivar tags: Resource tags.
    :vartype tags: dict[str, str]
    :ivar properties: The updatable properties of the FileSystemResource.
    :vartype properties: ~azure.mgmt.dell.models.FileSystemResourceUpdateProperties
    """
...
class FileSystemResourceUpdateProperties(_model_base.Model):
    ...
    :vartype encryption: ~azure.mgmt.dell.models.EncryptionUpdateProperties
    """
...
class ManagedServiceIdentity(_model_base.Model):
    ...
    :vartype type: str or ~azure.mgmt.dell.models.ManagedServiceIdentityType
    :ivar user_assigned_identities: The identities assigned to this resource by the user.
    :vartype user_assigned_identities: dict[str, ~azure.mgmt.dell.models.UserAssignedIdentity]
    """
...
class MarketplaceDetails(_model_base.Model):
    ...
    :vartype marketplace_subscription_status: str or
     ~azure.mgmt.dell.models.MarketplaceSubscriptionStatus
...
class Operation(_model_base.Model):
    ...
    :vartype display: ~azure.mgmt.dell.models.OperationDisplay
    :ivar origin: The intended executor of the operation; as in Resource Based Access Control
     (RBAC) and audit logs UX. Default value is "user,system". Known values are: "user", "system",
     and "user,system".
    :vartype origin: str or ~azure.mgmt.dell.models.Origin
    :ivar action_type: Extensible enum. Indicates the action type. "Internal" refers to actions
     that are for internal only APIs. "Internal"
    :vartype action_type: str or ~azure.mgmt.dell.models.ActionType
    """
...
class SystemData(_model_base.Model):
    ...
    :vartype created_by_type: str or ~azure.mgmt.dell.models.CreatedByType
    ...
    :vartype last_modified_by_type: str or ~azure.mgmt.dell.models.CreatedByType
