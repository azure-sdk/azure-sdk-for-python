...
class StorageClient:
    ...
    :vartype operations: azure.mgmt.dell.aio.operations.Operations
    :ivar file_systems: FileSystemsOperations operations
    :vartype file_systems: azure.mgmt.dell.aio.operations.FileSystemsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        _endpoint = "{endpoint}"
        self._config = StorageClientConfiguration(
