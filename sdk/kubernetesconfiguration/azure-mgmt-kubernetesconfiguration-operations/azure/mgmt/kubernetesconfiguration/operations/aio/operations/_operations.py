...
class Operations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.kubernetesconfiguration.operations.aio.OperationsClient`'s
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.ResourceProviderOperation"]:
        ...
        :return: An iterator like instance of either ResourceProviderOperation or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.kubernetesconfiguration.operations.models.ResourceProviderOperation]
