...
class Operations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.kubernetesconfiguration.operations.OperationsClient`'s
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.ResourceProviderOperation"]:
        ...
        :return: An iterator like instance of either ResourceProviderOperation or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.kubernetesconfiguration.operations.models.ResourceProviderOperation]
