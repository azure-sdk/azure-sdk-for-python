...
class FluxConfigurationsOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.FluxConfiguration
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type flux_configuration:
         ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.FluxConfiguration
        ...
        :return: An instance of AsyncLROPoller that returns either FluxConfiguration or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.FluxConfiguration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type flux_configuration:
         ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.FluxConfiguration or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either FluxConfiguration or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.FluxConfiguration]
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type flux_configuration_patch:
         ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.FluxConfigurationPatch
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either FluxConfiguration or the result of
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type flux_configuration_patch:
         ~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.FluxConfigurationPatch or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either FluxConfiguration or the result of
         cls(response)
        :rtype:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.kubernetesconfiguration.v2024_04_01_preview.models.FluxConfiguration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
