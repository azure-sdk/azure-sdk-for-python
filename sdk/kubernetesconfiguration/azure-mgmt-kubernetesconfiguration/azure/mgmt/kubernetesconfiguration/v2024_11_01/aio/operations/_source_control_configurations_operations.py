...
class SourceControlConfigurationsOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.kubernetesconfiguration.v2024_11_01.models.SourceControlConfiguration
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type source_control_configuration:
         ~azure.mgmt.kubernetesconfiguration.v2024_11_01.models.SourceControlConfiguration
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type source_control_configuration:
         ~azure.mgmt.kubernetesconfiguration.v2024_11_01.models.SourceControlConfiguration or IO[bytes]
        :return: SourceControlConfiguration or the result of cls(response)
        :rtype: ~azure.mgmt.kubernetesconfiguration.v2024_11_01.models.SourceControlConfiguration
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(
        ...
        :return: An iterator like instance of either SourceControlConfiguration or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.kubernetesconfiguration.v2024_11_01.models.SourceControlConfiguration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
