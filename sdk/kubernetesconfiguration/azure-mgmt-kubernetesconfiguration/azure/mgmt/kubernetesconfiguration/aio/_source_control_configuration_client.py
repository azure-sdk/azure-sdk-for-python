...
class SourceControlConfigurationClient(MultiApiClientMixin, _SDKClient):
    ...
    def extension_types(self):
        """Instance depends on the API version:
           ...
           * 2023-05-01-preview: :class:`ExtensionTypesOperations<azure.mgmt.kubernetesconfiguration.v2023_05_01_preview.aio.operations.ExtensionTypesOperations>`
        """
        api_version = self._get_api_version('extension_types')
        if api_version == '2023-05-01-preview':
            from ..v2023_05_01_preview.aio.operations import ExtensionTypesOperations as OperationClass
        else:
