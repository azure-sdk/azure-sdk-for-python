...
# --------------------------------------------------------------------------
import pytest
from azure.mgmt.kubernetesconfiguration.privatelinkscopes import PrivateLinkScopesClient
...
class TestPrivateLinkScopesPrivateEndpointConnectionsOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(PrivateLinkScopesClient)
