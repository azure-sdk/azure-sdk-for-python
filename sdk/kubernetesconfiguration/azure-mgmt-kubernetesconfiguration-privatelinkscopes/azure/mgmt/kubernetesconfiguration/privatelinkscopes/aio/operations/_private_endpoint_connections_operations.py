...
from .._configuration import PrivateLinkScopesClientConfiguration
...
class PrivateEndpointConnectionsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.kubernetesconfiguration.privatelinkscopes.aio.PrivateLinkScopesClient`'s
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._config: PrivateLinkScopesClientConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type properties:
         ~azure.mgmt.kubernetesconfiguration.privatelinkscopes.models.PrivateEndpointConnection or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either PrivateEndpointConnection or the
         result of cls(response)
        :rtype:
