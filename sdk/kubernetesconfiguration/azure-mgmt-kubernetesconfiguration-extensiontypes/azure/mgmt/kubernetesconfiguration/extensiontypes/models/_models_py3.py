...
class ExtensionTypeVersionForReleaseTrainProperties(_serialization.Model):  # pylint: disable=name-too-long
    ...
    :vartype unsupported_kubernetes_versions:
     ~azure.mgmt.kubernetesconfiguration.extensiontypes.models.ExtensionTypeVersionForReleaseTrainPropertiesUnsupportedKubernetesVersions  # pylint: disable=line-too-long
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype connected_cluster:
         list[~azure.mgmt.kubernetesconfiguration.extensiontypes.models.ExtensionTypeVersionUnsupportedKubernetesMatrixItem]  # pylint: disable=line-too-long
        :keyword appliances:
