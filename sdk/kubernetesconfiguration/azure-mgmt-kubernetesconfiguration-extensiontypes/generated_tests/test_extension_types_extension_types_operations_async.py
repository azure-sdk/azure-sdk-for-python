...
# --------------------------------------------------------------------------
import pytest
from azure.mgmt.kubernetesconfiguration.extensiontypes.aio import ExtensionTypesClient
...
class TestExtensionTypesExtensionTypesOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(ExtensionTypesClient, is_async=True)
