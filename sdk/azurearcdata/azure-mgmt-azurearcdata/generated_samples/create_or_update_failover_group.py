...
# USAGE
    python create_or_update_failover_group.py
...
def main():
    ...
    response = client.failover_groups.begin_create(
...
# x-ms-original-file: specification/azurearcdata/resource-manager/Microsoft.AzureArcData/preview/2025-03-01-preview/examples/CreateOrUpdateFailoverGroup.json
