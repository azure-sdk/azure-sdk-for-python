...
# USAGE
    python get_sql_server_instance_managed_instance_link_assessment.py
...
# x-ms-original-file: specification/azurearcdata/resource-manager/Microsoft.AzureArcData/preview/2025-03-01-preview/examples/GetSqlServerInstanceManagedInstanceLinkAssessment.json
