...
class SqlServerAvailabilityGroupsOperations:
    ...
    def create(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(sql_server_availability_group_resource, (IO, bytes)):
    ...
    create.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureArcData/sqlServerInstances/{sqlServerInstanceName}/sqlAvailabilityGroups/{sqlAvailabilityGroupName}"
    }
    ...
    def update(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(sql_server_availability_group_update, (IO, bytes)):
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureArcData/sqlServerInstances/{sqlServerInstanceName}/sqlAvailabilityGroups"
    }
