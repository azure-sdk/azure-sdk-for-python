...
class SqlServerAvailabilityGroupsOperations:
    ...
    def create(
        ...
        sql_server_instance_name: str,
        availability_group_name: str,
        sql_server_availability_group_resource: IO,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.SqlServerAvailabilityGroupResource:
        ...
        :param sql_server_availability_group_resource: The request body for availability group
         resource. Required.
        :type sql_server_availability_group_resource: IO
    ...
    def create(
        ...
        sql_server_instance_name: str,
        availability_group_name: str,
        sql_server_availability_group_resource: Union[_models.SqlServerAvailabilityGroupResource, IO],
        **kwargs: Any
    ) -> _models.SqlServerAvailabilityGroupResource:
        """Creates or replaces an Arc Sql Server Availability Group.
        ...
        :type availability_group_name: str
        :param sql_server_availability_group_resource: The request body for availability group
         resource. Is either a SqlServerAvailabilityGroupResource type or a IO type. Required.
        :type sql_server_availability_group_resource:
         ~azure.mgmt.azurearcdata.models.SqlServerAvailabilityGroupResource or IO
    ...
    create.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureArcData/sqlServerInstances/{sqlServerInstanceName}/availabilityGroups/{availabilityGroupName}"
    }
    ...
    def update(
        ...
        sql_server_instance_name: str,
        availability_group_name: str,
        sql_server_availability_group_update: IO,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.SqlServerAvailabilityGroupResource:
        ...
        :param sql_server_availability_group_update: The requested server availability group resource
         state. Required.
        :type sql_server_availability_group_update: IO
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def update(
        ...
        sql_server_instance_name: str,
        availability_group_name: str,
        sql_server_availability_group_update: Union[_models.SqlServerAvailabilityGroupUpdate, IO],
        **kwargs: Any
    ) -> _models.SqlServerAvailabilityGroupResource:
        """Updates an existing Availability Group.
        ...
        :type availability_group_name: str
        :param sql_server_availability_group_update: The requested server availability group resource
         state. Is either a SqlServerAvailabilityGroupUpdate type or a IO type. Required.
        :type sql_server_availability_group_update:
         ~azure.mgmt.azurearcdata.models.SqlServerAvailabilityGroupUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    detail_view.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureArcData/sqlServerInstances/{sqlServerInstanceName}/availabilityGroups/{availabilityGroupName}/getDetailView"
    }
    ...
    failover.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureArcData/sqlServerInstances/{sqlServerInstanceName}/availabilityGroups/{availabilityGroupName}/failover"
    }
    ...
    force_failover_allow_data_loss.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureArcData/sqlServerInstances/{sqlServerInstanceName}/availabilityGroups/{availabilityGroupName}/forceFailoverAllowDataLoss"
    }
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureArcData/sqlServerInstances/{sqlServerInstanceName}/availabilityGroups"
    }
