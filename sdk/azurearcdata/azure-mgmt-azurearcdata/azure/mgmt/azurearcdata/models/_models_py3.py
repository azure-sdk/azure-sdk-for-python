...
class FailoverCluster(_serialization.Model):
    ...
    :ivar id: The GUID of the SQL Server's underlying Failover Cluster. Required.
    :vartype id: str
    :ivar network_name: The network name to connect to the SQL FCI. Required.
    ...
    def __init__(
        ...
        *,
        ...
        network_name: str,
        sql_instance_ids: Optional[List[str]] = None,
        host_names: Optional[List[str]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword id: The GUID of the SQL Server's underlying Failover Cluster. Required.
        :paramtype id: str
        :keyword network_name: The network name to connect to the SQL FCI. Required.
        :paramtype network_name: str
        :keyword sql_instance_ids: The ARM IDs of the Arc SQL Server resources, belonging to the
         current server's Failover cluster.
        :paramtype sql_instance_ids: list[str]
        :keyword host_names: The host names which are part of the SQL FCI resource group.
        :paramtype host_names: list[str]
        """
        super().__init__(**kwargs)
        self.id = id
        self.network_name = network_name
        self.sql_instance_ids = sql_instance_ids
...
class SqlServerInstanceProperties(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        *,
        ...
        always_on_role: Optional[Union[str, "_models.AlwaysOnRole"]] = None,
        ...
        **kwargs: Any
        ...
        :keyword always_on_role: The role of the SQL Server, based on availability. Known values are:
         "None", "FailoverClusterInstance", "FailoverClusterNode", and "AvailabilityGroupReplica".
        :paramtype always_on_role: str or ~azure.mgmt.azurearcdata.models.AlwaysOnRole
        ...
        self.always_on_role = always_on_role
