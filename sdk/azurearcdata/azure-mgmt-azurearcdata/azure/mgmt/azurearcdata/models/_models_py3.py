...
class AvailabilityGroupConfigure(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar failover_mode: Property to set the failover mode of the availability group replica. Known
     values are: "AUTOMATIC", "MANUAL", and "EXTERNAL".
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword failover_mode: Property to set the failover mode of the availability group replica.
         Known values are: "AUTOMATIC", "MANUAL", and "EXTERNAL".
...
class AvailabilityGroupCreateUpdateConfiguration(
