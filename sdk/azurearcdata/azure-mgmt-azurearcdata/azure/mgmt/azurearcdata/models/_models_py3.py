...
class DataBaseMigrationAssessment(_serialization.Model):
    ...
    def __init__(self, **kwargs: Any) -> None:
        """ """
        super().__init__(**kwargs)
        self.assessment_upload_time = None
        self.database_assessments = None
...
class DBMEndpoint(_serialization.Model):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.role = None
        self.is_encryption_enabled = None
        self.encryption_algorithm = None
        self.connection_auth = None
        self.port = None
        self.is_dynamic_port = None
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype certificate_configuration:
         ~azure.mgmt.azurearcdata.models.DistributedAvailabilityGroupCreateUpdateAvailabilityGroupCertificateConfiguration  # pylint: disable=line-too-long
        """
        super().__init__(**kwargs)
...
class FailoverMiLinkResourceId(_serialization.Model):
    ...
    def __init__(self, *, managed_instance_id: Optional[str] = None, **kwargs: Any) -> None:
        """
...
class MigrationAssessment(_serialization.Model):
    ...
    def __init__(self, *, enabled: Optional[bool] = None, **kwargs: Any) -> None:
        ...
        self.enabled = enabled
        self.assessment_upload_time = None
        self.server_assessments = None
        self.sku_recommendation_results = None
...
class SkuRecommendationResultsAzureSqlDatabase(_serialization.Model):
    ...
    :ivar recommendation_status: The target recommendation Status for this database. Known values
     are: "NotReady", "Ready", and "Unknown".
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword recommendation_status: The target recommendation Status for this database. Known
         values are: "NotReady", "Ready", and "Unknown".
...
class SqlServerInstanceManagedInstanceLinkAssessment(_serialization.Model):  # pylint: disable=name-too-long
    ...
    :vartype name: str
    :ivar category: The category of the requirement. Known values are: "SQLServer",
     "ManagedInstance", "ManagedInstanceCrossValidation", "Dag", and "Certificates".
    :vartype category: str or ~azure.mgmt.azurearcdata.models.AssessmentCategory
    ...
    def __init__(
        ...
        *,
        name: Optional[str] = None,
        category: Optional[Union[str, "_models.AssessmentCategory"]] = None,
        ...
        **kwargs: Any
        ...
        :paramtype name: str
        :keyword category: The category of the requirement. Known values are: "SQLServer",
         "ManagedInstance", "ManagedInstanceCrossValidation", "Dag", and "Certificates".
        :paramtype category: str or ~azure.mgmt.azurearcdata.models.AssessmentCategory
...
class SqlServerInstanceManagedInstanceLinkAssessmentRequest(_serialization.Model):  # pylint: disable=name-too-long
    ...
    :ivar database_name: The name of the database to be replicated to the Azure SQL Managed
     Instance. Required.
    :vartype database_name: str
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype azure_managed_instance_role: str or
         ~azure.mgmt.azurearcdata.models.AzureManagedInstanceRole
        :keyword database_name: The name of the database to be replicated to the Azure SQL Managed
         Instance. Required.
        :paramtype database_name: str
...
class SqlServerInstanceProperties(_serialization.Model):
    ...
    :ivar max_server_memory_mb: max server memory (MB) value configured for this instance.
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        self.collation = None
        self.db_master_key_exists = None
        self.is_hadr_enabled = None
        ...
        self.is_microsoft_pki_cert_trust_configured = None
        self.is_digi_cert_pki_cert_trust_configured = None
...
class SqlServerInstanceTelemetryColumn(_serialization.Model):
    ...
    :ivar type: The type of the telemetry column. Known values are: "bool", "datetime", "int",
     "long", "double", "string", "guid", "timespan", and "int".
