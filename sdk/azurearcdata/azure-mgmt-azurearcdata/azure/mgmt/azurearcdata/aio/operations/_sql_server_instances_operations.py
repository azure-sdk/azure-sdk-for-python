...
class SqlServerInstancesOperations:
    ...
    async def _get_telemetry_initial(
        ...
        resource_group_name: str,
        sql_server_instance_name: str,
        sql_server_instance_telemetry_request: Union[_models.SqlServerInstanceTelemetryRequest, IO],
        **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.SqlServerInstanceTelemetryResponse]] = kwargs.pop("cls", None)
        ...
        request = build_get_telemetry_request(
            resource_group_name=resource_group_name,
            sql_server_instance_name=sql_server_instance_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
        ...
        response_headers = {}
        if response.status_code == 200:
            deserialized = self._deserialize("SqlServerInstanceTelemetryResponse", pipeline_response)
    ...
    _get_telemetry_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureArcData/sqlServerInstances/{sqlServerInstanceName}/getTelemetry"
    }
    ...
    async def begin_get_telemetry(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[AsyncIterable[List[str]]]:
    ...
    async def begin_get_telemetry(
        ...
        resource_group_name: str,
        sql_server_instance_name: str,
        sql_server_instance_telemetry_request: IO,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[AsyncIterable[List[str]]]:
        ...
        :param sql_server_instance_telemetry_request: Contains the parameters to get SQL Server
         instance telemetry. Required.
        :type sql_server_instance_telemetry_request: IO
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_get_telemetry(
        ...
        **kwargs: Any
        ...
        :type sql_server_instance_name: str
        :param sql_server_instance_telemetry_request: Contains the parameters to get SQL Server
         instance telemetry. Is either a SqlServerInstanceTelemetryRequest type or a IO type. Required.
        :type sql_server_instance_telemetry_request:
         ~azure.mgmt.azurearcdata.models.SqlServerInstanceTelemetryRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        _json = None
        if isinstance(sql_server_instance_telemetry_request, (IOBase, bytes)):
            _json = sql_server_instance_telemetry_request
        else:
            _json = self._serialize.body(sql_server_instance_telemetry_request, "SqlServerInstanceTelemetryRequest")
