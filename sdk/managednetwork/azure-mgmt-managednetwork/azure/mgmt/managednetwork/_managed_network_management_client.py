...
class ManagedNetworkManagementClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype managed_networks: azure.mgmt.managednetwork.operations.ManagedNetworksOperations
    :ivar scope_assignments: ScopeAssignmentsOperations operations
    :vartype scope_assignments: azure.mgmt.managednetwork.operations.ScopeAssignmentsOperations
    ...
    :vartype managed_network_peering_policies:
     azure.mgmt.managednetwork.operations.ManagedNetworkPeeringPoliciesOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.managednetwork.operations.Operations
    ...
    def __enter__(self) -> "ManagedNetworkManagementClient":
