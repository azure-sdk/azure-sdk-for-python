...
class ApplicationDefinitionsOperations:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.managedapplication.v2018_09_01_preview.models.ApplicationDefinition or IO
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.managedapplication.v2018_09_01_preview.models.ApplicationDefinitionPatchable or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
