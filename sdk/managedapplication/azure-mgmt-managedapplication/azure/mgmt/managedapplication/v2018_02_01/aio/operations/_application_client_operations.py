...
class ApplicationClientOperationsMixin(ApplicationClientMixinABC):
    ...
    def list_operations(self, **kwargs: Any) -> AsyncIterable["_models.Operation"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.managedapplication.v2018_02_01.models.Operation]
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("list_operations") or "2018-02-01")
        )
