...
class GenericResource(Resource):
    ...
    :vartype sku: ~azure.mgmt.managedapplication.v2018_02_01.models.Sku
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype sku: ~azure.mgmt.managedapplication.v2018_02_01.models.Sku
        """
...
class Application(GenericResource):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype plan: ~azure.mgmt.managedapplication.v2018_02_01.models.Plan
    :ivar kind: The kind of the managed application. Allowed values are MarketPlace and
     ServiceCatalog. Required.
    :vartype kind: str
    :ivar identity: The identity of the resource.
    :vartype identity: ~azure.mgmt.managedapplication.v2018_02_01.models.Identity
    ...
    :vartype provisioning_state: str or
     ~azure.mgmt.managedapplication.v2018_02_01.models.ProvisioningState
    :ivar billing_details: The managed application billing details.
    :vartype billing_details:
     ~azure.mgmt.managedapplication.v2018_02_01.models.ApplicationBillingDetailsDefinition
    ...
    :vartype authorizations:
     list[~azure.mgmt.managedapplication.v2018_02_01.models.ApplicationAuthorization]
    :ivar customer_support: The read-only customer support property that is retrieved from the
     application package.
    :vartype customer_support:
     ~azure.mgmt.managedapplication.v2018_02_01.models.ApplicationPackageContact
    :ivar support_urls: The read-only support URLs property that is retrieved from the application
     package.
    :vartype support_urls:
     ~azure.mgmt.managedapplication.v2018_02_01.models.ApplicationPackageSupportUrls
    :ivar artifacts: The collection of managed application artifacts.
    :vartype artifacts: list[~azure.mgmt.managedapplication.v2018_02_01.models.ApplicationArtifact]
    :ivar created_by: The client entity that created the JIT request.
    :vartype created_by: ~azure.mgmt.managedapplication.v2018_02_01.models.ApplicationClientDetails
    :ivar updated_by: The client entity that last updated the JIT request.
    :vartype updated_by: ~azure.mgmt.managedapplication.v2018_02_01.models.ApplicationClientDetails
    """
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :paramtype plan: ~azure.mgmt.managedapplication.v2018_02_01.models.Plan
        :keyword kind: The kind of the managed application. Allowed values are MarketPlace and
         ServiceCatalog. Required.
        :paramtype kind: str
        :keyword identity: The identity of the resource.
        :paramtype identity: ~azure.mgmt.managedapplication.v2018_02_01.models.Identity
...
class ApplicationArtifact(_serialization.Model):
    ...
    :vartype name: str or ~azure.mgmt.managedapplication.v2018_02_01.models.ApplicationArtifactName
    ...
    :ivar type: The managed application artifact type. Required. Known values are: "NotSpecified",
     "Template", and "Custom".
    :vartype type: str or ~azure.mgmt.managedapplication.v2018_02_01.models.ApplicationArtifactType
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype name: str or
         ~azure.mgmt.managedapplication.v2018_02_01.models.ApplicationArtifactName
        ...
        :paramtype type: str or
         ~azure.mgmt.managedapplication.v2018_02_01.models.ApplicationArtifactType
        """
        super().__init__(**kwargs)
        self.name = name
        self.uri = uri
...
class ApplicationDefinition(GenericResource):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype lock_level: str or
     ~azure.mgmt.managedapplication.v2018_02_01.models.ApplicationLockLevel
    ...
    :vartype artifacts:
     list[~azure.mgmt.managedapplication.v2018_02_01.models.ApplicationDefinitionArtifact]
    ...
    :vartype policies: list[~azure.mgmt.managedapplication.v2018_02_01.models.ApplicationPolicy]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype policies: list[~azure.mgmt.managedapplication.v2018_02_01.models.ApplicationPolicy]
        """
        super().__init__(location=location, tags=tags, managed_by=managed_by, sku=sku, **kwargs)
...
class ApplicationDefinitionArtifact(_serialization.Model):
    ...
    :vartype name: str or
     ~azure.mgmt.managedapplication.v2018_02_01.models.ApplicationDefinitionArtifactName
...
class ApplicationDefinitionListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.managedapplication.v2018_02_01.models.ApplicationDefinition]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype value: list[~azure.mgmt.managedapplication.v2018_02_01.models.ApplicationDefinition]
...
class ApplicationListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.managedapplication.v2018_02_01.models.Application]
    :ivar next_link: The URL to use for getting the next set of results.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.managedapplication.v2018_02_01.models.Application]
        :keyword next_link: The URL to use for getting the next set of results.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class ApplicationPatchable(GenericResource):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype sku: ~azure.mgmt.managedapplication.v2018_02_01.models.Sku
    :ivar plan: The plan information.
    :vartype plan: ~azure.mgmt.managedapplication.v2018_02_01.models.PlanPatchable
    :ivar kind: The kind of the managed application. Allowed values are MarketPlace and
     ServiceCatalog.
    :vartype kind: str
    :ivar identity: The identity of the resource.
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :paramtype sku: ~azure.mgmt.managedapplication.v2018_02_01.models.Sku
        :keyword plan: The plan information.
        :paramtype plan: ~azure.mgmt.managedapplication.v2018_02_01.models.PlanPatchable
        :keyword kind: The kind of the managed application. Allowed values are MarketPlace and
         ServiceCatalog.
        :paramtype kind: str
        :keyword identity: The identity of the resource.
...
class ErrorDetail(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.managedapplication.v2018_02_01.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info:
     list[~azure.mgmt.managedapplication.v2018_02_01.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(_serialization.Model):
    ...
    :vartype error: ~azure.mgmt.managedapplication.v2018_02_01.models.ErrorDetail
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetail"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~azure.mgmt.managedapplication.v2018_02_01.models.ErrorDetail
        """
        super().__init__(**kwargs)
        self.error = error
...
class Identity(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.managedapplication.v2018_02_01.models.ResourceIdentityType
    ...
    :vartype user_assigned_identities: dict[str,
     ~azure.mgmt.managedapplication.v2018_02_01.models.UserAssignedResourceIdentity]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: The identity type. Known values are: "SystemAssigned", "UserAssigned",
         "SystemAssigned, UserAssigned", and "None".
        :paramtype type: str or ~azure.mgmt.managedapplication.v2018_02_01.models.ResourceIdentityType
...
class Operation(_serialization.Model):
    ...
    :vartype display: ~azure.mgmt.managedapplication.v2018_02_01.models.OperationDisplay
    :ivar origin: The intended executor of the operation; as in Resource Based Access Control
     (RBAC) and audit logs UX. Default value is "user,system". Known values are: "user", "system",
     and "user,system".
    :vartype origin: str or ~azure.mgmt.managedapplication.v2018_02_01.models.Origin
    :ivar action_type: Enum. Indicates the action type. "Internal" refers to actions that are for
     internal only APIs. "Internal"
    :vartype action_type: str or ~azure.mgmt.managedapplication.v2018_02_01.models.ActionType
    """
    ...
    def __init__(self, *, display: Optional["_models.OperationDisplay"] = None, **kwargs: Any) -> None:
        ...
        :paramtype display: ~azure.mgmt.managedapplication.v2018_02_01.models.OperationDisplay
        """
        super().__init__(**kwargs)
        self.name = None
...
class OperationAutoGenerated(_serialization.Model):
    ...
    :vartype display:
     ~azure.mgmt.managedapplication.v2018_02_01.models.OperationDisplayAutoGenerated
    """
...
class OperationListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.managedapplication.v2018_02_01.models.Operation]
