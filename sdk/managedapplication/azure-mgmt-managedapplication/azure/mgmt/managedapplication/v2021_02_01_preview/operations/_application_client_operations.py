...
class ApplicationClientOperationsMixin(ApplicationClientMixinABC):
    ...
    def list_operations(self, **kwargs: Any) -> Iterable["_models.Operation"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.managedapplication.v2021_02_01_preview.models.Operation]
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("list_operations") or "2021-02-01-preview")
        )
