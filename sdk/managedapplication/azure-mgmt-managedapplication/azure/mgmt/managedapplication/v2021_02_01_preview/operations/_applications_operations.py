...
from .._vendor import ApplicationClientMixinABC, _convert_request
...
class ApplicationsOperations:  # pylint: disable=too-many-public-methods
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either Application or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managedapplication.v2021_02_01_preview.models.Application]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.managedapplication.v2021_02_01_preview.models.Application or IO
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either ApplicationPatchable or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managedapplication.v2021_02_01_preview.models.ApplicationPatchable]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.managedapplication.v2021_02_01_preview.models.ApplicationPatchable or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.Application"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.managedapplication.v2021_02_01_preview.models.Application]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_refresh_permissions(
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._refresh_permissions_initial(  # type: ignore
                resource_group_name=resource_group_name,
                application_name=application_name,
                api_version=api_version,
                cls=lambda x, y, z: x,
    ...
    def begin_update_access(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either UpdateAccessDefinition or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managedapplication.v2021_02_01_preview.models.UpdateAccessDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update_access(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.managedapplication.v2021_02_01_preview.models.UpdateAccessDefinition or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
