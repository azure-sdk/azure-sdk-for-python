...
class ApplicationClient(ApplicationClientOperationsMixin):  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype applications:
     azure.mgmt.managedapplication.v2020_08_21_preview.operations.ApplicationsOperations
    :ivar application_definitions: ApplicationDefinitionsOperations operations
    :vartype application_definitions:
     azure.mgmt.managedapplication.v2020_08_21_preview.operations.ApplicationDefinitionsOperations
    :ivar jit_requests: JitRequestsOperations operations
    :vartype jit_requests:
     azure.mgmt.managedapplication.v2020_08_21_preview.operations.JitRequestsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.applications = ApplicationsOperations(
            self._client, self._config, self._serialize, self._deserialize, "2020-08-21-preview"
        )
