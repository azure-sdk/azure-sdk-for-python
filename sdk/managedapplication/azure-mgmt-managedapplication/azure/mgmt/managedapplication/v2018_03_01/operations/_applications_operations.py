...
class ApplicationsOperations:  # pylint: disable=too-many-public-methods
    ...
    def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.managedapplication.v2018_03_01.models.Application or IO
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either ApplicationPatchable or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managedapplication.v2018_03_01.models.ApplicationPatchable]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.managedapplication.v2018_03_01.models.ApplicationPatchable or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_tokens(
        ...
        **kwargs: Any
        ...
        :param parameters: Request body parameters to list tokens. Is either a ListTokenRequest type or
         a IO type. Required.
        :type parameters: ~azure.mgmt.managedapplication.v2018_03_01.models.ListTokenRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
