...
class ApplicationDefinitionsOperations:
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.managedapplication.v2021_07_01.models.ApplicationDefinition or IO
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.managedapplication.v2021_07_01.models.ApplicationDefinitionPatchable or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_by_resource_group(
        ...
        :return: An iterator like instance of either ApplicationDefinition or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.managedapplication.v2021_07_01.models.ApplicationDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
