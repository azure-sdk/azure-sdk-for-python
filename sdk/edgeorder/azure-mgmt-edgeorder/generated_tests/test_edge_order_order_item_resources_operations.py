...
class TestEdgeOrderOrderItemResourcesOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(EdgeOrderClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_order_item_resources_get(self, resource_group):
        response = self.client.order_item_resources.get(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_order_item_resources_begin_create(self, resource_group):
        response = self.client.order_item_resources.begin_create(
            resource_group_name=resource_group.name,
            order_item_name="str",
            order_item_resource={
                "location": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_order_item_resources_begin_update(self, resource_group):
        response = self.client.order_item_resources.begin_update(
            resource_group_name=resource_group.name,
            order_item_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_order_item_resources_begin_delete(self, resource_group):
        response = self.client.order_item_resources.begin_delete(
            resource_group_name=resource_group.name,
            order_item_name="str",
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_order_item_resources_list_by_resource_group(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_order_item_resources_list_by_subscription(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_order_item_resources_cancel(self, resource_group):
        response = self.client.order_item_resources.cancel(
            resource_group_name=resource_group.name,
            order_item_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_order_item_resources_begin_return_order_item(self, resource_group):
        response = self.client.order_item_resources.begin_return_order_item(
            resource_group_name=resource_group.name,
            order_item_name="str",
