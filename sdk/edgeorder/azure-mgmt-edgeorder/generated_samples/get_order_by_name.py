...
def main():
    ...
    response = client.orders.get(
        ...
        location="eastus",
        order_name="TestOrderName3",
    )
    print(response)


# x-ms-original-file: specification/edgeorder/resource-manager/Microsoft.EdgeOrder/stable/2024-02-01/examples/GetOrderByName.json
