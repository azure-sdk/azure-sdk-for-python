...
class AddressesOperations:
    ...
    def list_by_subscription(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.edgeorder.v2023_07_01_preview.models.AddressResource]
    ...
    async def get(self, resource_group_name: str, address_name: str, **kwargs: Any) -> _models.AddressResource:
        ...
        :rtype: ~azure.mgmt.edgeorder.v2023_07_01_preview.models.AddressResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type address_resource: ~azure.mgmt.edgeorder.v2023_07_01_preview.models.AddressResource
        ...
        :return: An instance of AsyncLROPoller that returns either AddressResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.edgeorder.v2023_07_01_preview.models.AddressResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param address_resource: Address details from request body. Is either a AddressResource type or
         a IO type. Required.
        :type address_resource: ~azure.mgmt.edgeorder.v2023_07_01_preview.models.AddressResource or IO
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type address_update_parameter:
         ~azure.mgmt.edgeorder.v2023_07_01_preview.models.AddressUpdateParameter
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type address_update_parameter:
         ~azure.mgmt.edgeorder.v2023_07_01_preview.models.AddressUpdateParameter or IO
        :param if_match: Defines the If-Match condition. The patch will be performed only if the ETag
         of the job on the server matches this value. Default value is None.
        :type if_match: str
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
