...
class OrderItemsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.edgeorder.v2023_07_01_preview.aio.EdgeOrderManagementClient`'s
    ...
    def list_by_subscription(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.edgeorder.v2023_07_01_preview.models.OrderItemResource]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.edgeorder.v2023_07_01_preview.models.OrderItemResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type order_item_resource: ~azure.mgmt.edgeorder.v2023_07_01_preview.models.OrderItemResource
        ...
        :return: An instance of AsyncLROPoller that returns either OrderItemResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.edgeorder.v2023_07_01_preview.models.OrderItemResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type order_item_update_parameter:
         ~azure.mgmt.edgeorder.v2023_07_01_preview.models.OrderItemUpdateParameter
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type order_item_update_parameter:
         ~azure.mgmt.edgeorder.v2023_07_01_preview.models.OrderItemUpdateParameter or IO
        :param if_match: Defines the If-Match condition. The patch will be performed only if the ETag
         of the order on the server matches this value. Default value is None.
        :type if_match: str
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
    ...
    async def cancel(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type cancellation_reason: ~azure.mgmt.edgeorder.v2023_07_01_preview.models.CancellationReason
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def _return_initial(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        order_item_name: str,
        ...
        **kwargs: Any
        ...
        request = build_return_request(
            ...
            json=_json,
            content=_content,
            template_url=self._return_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    async def begin_return_method(
        ...
        **kwargs: Any
        ...
        :type return_order_item_details:
         ~azure.mgmt.edgeorder.v2023_07_01_preview.models.ReturnOrderItemDetails
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_return_method(
        ...
        **kwargs: Any
        ...
        :param return_order_item_details: Return order item details. Is either a ReturnOrderItemDetails
         type or a IO type. Required.
        :type return_order_item_details:
         ~azure.mgmt.edgeorder.v2023_07_01_preview.models.ReturnOrderItemDetails or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._return_initial(  # type: ignore
                resource_group_name=resource_group_name,
                order_item_name=order_item_name,
