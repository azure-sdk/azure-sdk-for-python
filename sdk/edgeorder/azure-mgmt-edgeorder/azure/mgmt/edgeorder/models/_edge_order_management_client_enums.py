...
class AddressClassification(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class AutoProvisioningStatus(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Auto Provisioning Details."""

    ENABLED = "Enabled"
    """Provisioning Enabled. Will act as pre-approved, and arc extension will be enabled as soon as
    the device is verified to be at the right edge location."""
    DISABLED = "Disabled"
...
class DevicePresenceVerificationStatus(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Proof of possession status."""

    NOT_INITIATED = "NotInitiated"
    """The device has not yet been verified to be with the right edge operator or at the right
    location."""
    COMPLETED = "Completed"
    """Confirms that the device is verified to be with the right edge operator or at the right
    location."""
...
class ProvisioningSupport(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class TermCommitmentType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
