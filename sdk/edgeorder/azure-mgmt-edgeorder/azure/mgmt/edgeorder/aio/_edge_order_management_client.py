...
class EdgeOrderManagementClient(EdgeOrderManagementClientOperationsMixin, MultiApiClientMixin, _SDKClient):
    ...
    def models(cls, api_version=DEFAULT_API_VERSION):
        """Module depends on the API version:
           ...
           * 2023-07-01-preview: :mod:`v2023_07_01_preview.models<azure.mgmt.edgeorder.v2023_07_01_preview.models>`
        """
    ...
    def addresses(self):
        """Instance depends on the API version:
           ...
           * 2023-07-01-preview: :class:`AddressesOperations<azure.mgmt.edgeorder.v2023_07_01_preview.aio.operations.AddressesOperations>`
        """
        ...
        if api_version == '2022-05-01-preview':
            ...
            from ..v2023_07_01_preview.aio.operations import AddressesOperations as OperationClass
        else:
    ...
    def operations(self):
        """Instance depends on the API version:
           ...
           * 2023-07-01-preview: :class:`Operations<azure.mgmt.edgeorder.v2023_07_01_preview.aio.operations.Operations>`
        """
    ...
    def order_items(self):
        """Instance depends on the API version:
           ...
           * 2023-07-01-preview: :class:`OrderItemsOperations<azure.mgmt.edgeorder.v2023_07_01_preview.aio.operations.OrderItemsOperations>`
        """
        ...
        if api_version == '2022-05-01-preview':
            ...
            from ..v2023_07_01_preview.aio.operations import OrderItemsOperations as OperationClass
        else:
    ...
    def orders(self):
        """Instance depends on the API version:
           ...
           * 2023-07-01-preview: :class:`OrdersOperations<azure.mgmt.edgeorder.v2023_07_01_preview.aio.operations.OrdersOperations>`
        """
        ...
        if api_version == '2022-05-01-preview':
            ...
            from ..v2023_07_01_preview.aio.operations import OrdersOperations as OperationClass
        else:
    ...
    def products_and_configurations(self):
        """Instance depends on the API version:
           ...
           * 2023-07-01-preview: :class:`ProductsAndConfigurationsOperations<azure.mgmt.edgeorder.v2023_07_01_preview.aio.operations.ProductsAndConfigurationsOperations>`
        """
        ...
        if api_version == '2022-05-01-preview':
            ...
            from ..v2023_07_01_preview.aio.operations import ProductsAndConfigurationsOperations as OperationClass
        else:
