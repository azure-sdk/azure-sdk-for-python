...
def build_address_resources_get_request(
...
def build_address_resources_create_request(
    resource_group_name: str, address_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_address_resources_update_request(
...
def build_address_resources_delete_request(
    resource_group_name: str, address_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_address_resources_list_by_resource_group_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    subscription_id: str,
    *,
...
def build_address_resources_list_by_subscription_request(  # pylint: disable=name-too-long
    subscription_id: str,
    *,
    filter: Optional[str] = None,
    skip_token: Optional[str] = None,
...
def build_order_item_resources_get_request(
...
def build_order_item_resources_create_request(  # pylint: disable=name-too-long
...
def build_order_item_resources_update_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    order_item_name: str,
    subscription_id: str,
    *,
...
def build_order_item_resources_delete_request(  # pylint: disable=name-too-long
    resource_group_name: str, order_item_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_order_item_resources_list_by_resource_group_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    subscription_id: str,
    *,
    filter: Optional[str] = None,
...
def build_order_item_resources_list_by_subscription_request(  # pylint: disable=name-too-long
    subscription_id: str,
    *,
    filter: Optional[str] = None,
    expand: Optional[str] = None,
...
def build_order_item_resources_cancel_request(  # pylint: disable=name-too-long
    resource_group_name: str, order_item_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_order_item_resources_return_order_item_request(  # pylint: disable=name-too-long
    resource_group_name: str, order_item_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_order_resources_get_request(
...
def build_products_and_configurations_operation_group_list_configurations_request(  # pylint: disable=name-too-long
...
def build_products_and_configurations_operation_group_list_product_families_request(  # pylint: disable=name-too-long
...
def build_products_and_configurations_operation_group_list_product_families_metadata_request(  # pylint: disable=name-too-long
    subscription_id: str, *, skip_token: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_orders_operation_group_list_by_subscription_request(  # pylint: disable=name-too-long
...
def build_orders_operation_group_list_by_resource_group_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    subscription_id: str,
    *,
    skip_token: Optional[str] = None,
...
class Operations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.edgeorder.EdgeOrderClient`'s
    ...
    def begin_return_order_item(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns OkResponse. The OkResponse is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.edgeorder.models.OkResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
