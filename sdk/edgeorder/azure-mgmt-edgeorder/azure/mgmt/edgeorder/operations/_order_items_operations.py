...
class OrderItemsOperations:
    ...
    def list_by_subscription(
        ...
        **kwargs: Any
        ...
        :param filter: $filter is supported to filter based on order id and order Item Type. Filter
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type order_item_resource: ~azure.mgmt.edgeorder.models.OrderItemResource or IO[bytes]
        :return: An instance of LROPoller that returns either OrderItemResource or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.edgeorder.models.OrderItemResource]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def cancel(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type cancellation_reason: ~azure.mgmt.edgeorder.models.CancellationReason or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
