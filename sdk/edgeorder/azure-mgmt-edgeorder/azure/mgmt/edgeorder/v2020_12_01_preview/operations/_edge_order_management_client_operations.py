...
def build_list_operations_request(**kwargs: Any) -> HttpRequest:
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2020-12-01-preview"))
...
def build_list_addresses_at_subscription_level_request(  # pylint: disable=name-too-long
...
def build_list_product_families_metadata_request(  # pylint: disable=name-too-long
    subscription_id: str, *, skip_token: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_order_at_subscription_level_request(  # pylint: disable=name-too-long
    subscription_id: str, *, skip_token: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_order_items_at_subscription_level_request(  # pylint: disable=name-too-long
    subscription_id: str,
    *,
...
def build_list_addresses_at_resource_group_level_request(  # pylint: disable=name-too-long
...
def build_list_order_at_resource_group_level_request(  # pylint: disable=name-too-long
...
def build_list_order_items_at_resource_group_level_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    subscription_id: str,
    *,
    filter: Optional[str] = None,
...
class EdgeOrderManagementClientOperationsMixin(  # pylint: disable=too-many-public-methods
    ...
    def list_operations(self, **kwargs: Any) -> Iterable["_models.Operation"]:
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("list_operations") or "2020-12-01-preview")
        )
    ...
    def list_addresses_at_subscription_level(
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop(
                "api-version", self._api_version("list_addresses_at_subscription_level") or "2020-12-01-preview"
            ),
        )
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_addresses_at_subscription_level_request(
    ...
    def list_product_families(
        ...
        **kwargs: Any
        ...
        :type product_families_request:
         ~azure.mgmt.edgeorder.v2020_12_01_preview.models.ProductFamiliesRequest or IO[bytes]
        :param expand: $expand is supported on configurations parameter for product, which provides
         details on the configurations for the product. Default value is None.
        :type expand: str
        :param skip_token: $skipToken is supported on list of product families, which provides the next
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop("api-version", self._api_version("list_product_families") or "2020-12-01-preview"),
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
    ...
    def list_configurations(
        ...
        **kwargs: Any
        ...
        :type configurations_request:
         ~azure.mgmt.edgeorder.v2020_12_01_preview.models.ConfigurationsRequest or IO[bytes]
        :param skip_token: $skipToken is supported on list of configurations, which provides the next
         page in the list of configurations. Default value is None.
        :type skip_token: str
        :return: An iterator like instance of either Configuration or the result of cls(response)
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("list_configurations") or "2020-12-01-preview")
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
    ...
    def list_product_families_metadata(
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop("api-version", self._api_version("list_product_families_metadata") or "2020-12-01-preview"),
        )
    ...
    def list_order_at_subscription_level(
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop("api-version", self._api_version("list_order_at_subscription_level") or "2020-12-01-preview"),
        )
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_order_at_subscription_level_request(
                    subscription_id=self._config.subscription_id,
                    skip_token=skip_token,
                    api_version=api_version,
                    headers=_headers,
    ...
    def list_order_items_at_subscription_level(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop(
                "api-version", self._api_version("list_order_items_at_subscription_level") or "2020-12-01-preview"
            ),
        )
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_order_items_at_subscription_level_request(
                    subscription_id=self._config.subscription_id,
                    filter=filter,
                    expand=expand,
                    skip_token=skip_token,
    ...
    def list_addresses_at_resource_group_level(
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop(
                "api-version", self._api_version("list_addresses_at_resource_group_level") or "2020-12-01-preview"
            ),
        )
        cls: ClsType[_models.AddressResourceList] = kwargs.pop("cls", None)
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_addresses_at_resource_group_level_request(
    ...
    def get_address_by_name(
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("get_address_by_name") or "2020-12-01-preview")
        )
        ...
        deserialized = self._deserialize("AddressResource", pipeline_response.http_response)
    ...
    def _create_address_initial(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop("api-version", self._api_version("_create_address_initial") or "2020-12-01-preview"),
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        ...
        _request = build_create_address_request(
            address_name=address_name,
            resource_group_name=resource_group_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def begin_create_address(
        ...
        **kwargs: Any
        ...
        :type address_resource: ~azure.mgmt.edgeorder.v2020_12_01_preview.models.AddressResource or
         IO[bytes]
        :return: An instance of LROPoller that returns either AddressResource or the result of
         cls(response)
        :rtype:
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("begin_create_address") or "2020-12-01-preview")
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.AddressResource] = kwargs.pop("cls", None)
    ...
    def _delete_address_by_name_initial(
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop("api-version", self._api_version("_delete_address_by_name_initial") or "2020-12-01-preview"),
        )
        cls: ClsType[Iterator[bytes]] = kwargs.pop("cls", None)

        _request = build_delete_address_by_name_request(
            address_name=address_name,
            resource_group_name=resource_group_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def begin_delete_address_by_name(
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop("api-version", self._api_version("begin_delete_address_by_name") or "2020-12-01-preview"),
        )
    ...
    def _update_address_initial(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop("api-version", self._api_version("_update_address_initial") or "2020-12-01-preview"),
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Iterator[bytes]] = kwargs.pop("cls", None)
        ...
        _request = build_update_address_request(
            address_name=address_name,
            resource_group_name=resource_group_name,
            subscription_id=self._config.subscription_id,
            if_match=if_match,
    ...
    def begin_update_address(
        ...
        **kwargs: Any
        ...
        :type address_update_parameter:
         ~azure.mgmt.edgeorder.v2020_12_01_preview.models.AddressUpdateParameter or IO[bytes]
        :param if_match: Defines the If-Match condition. The patch will be performed only if the ETag
         of the job on the server matches this value. Default value is None.
        :type if_match: str
        :return: An instance of LROPoller that returns either AddressResource or the result of
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("begin_update_address") or "2020-12-01-preview")
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.AddressResource] = kwargs.pop("cls", None)
        polling: Union[bool, PollingMethod] = kwargs.pop("polling", True)
    ...
    def list_order_at_resource_group_level(
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop("api-version", self._api_version("list_order_at_resource_group_level") or "2020-12-01-preview"),
        )
        cls: ClsType[_models.OrderResourceList] = kwargs.pop("cls", None)
    ...
    def get_order_by_name(
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("get_order_by_name") or "2020-12-01-preview")
        )
        cls: ClsType[_models.OrderResource] = kwargs.pop("cls", None)

        _request = build_get_order_by_name_request(
        ...
        deserialized = self._deserialize("OrderResource", pipeline_response.http_response)
    ...
    def list_order_items_at_resource_group_level(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop(
                "api-version", self._api_version("list_order_items_at_resource_group_level") or "2020-12-01-preview"
            ),
        )
        cls: ClsType[_models.OrderItemResourceList] = kwargs.pop("cls", None)
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_order_items_at_resource_group_level_request(
                    resource_group_name=resource_group_name,
                    subscription_id=self._config.subscription_id,
                    filter=filter,
                    expand=expand,
    ...
    def get_order_item_by_name(
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop("api-version", self._api_version("get_order_item_by_name") or "2020-12-01-preview"),
        )
        cls: ClsType[_models.OrderItemResource] = kwargs.pop("cls", None)

        _request = build_get_order_item_by_name_request(
        ...
        deserialized = self._deserialize("OrderItemResource", pipeline_response.http_response)
    ...
    def _create_order_item_initial(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop("api-version", self._api_version("_create_order_item_initial") or "2020-12-01-preview"),
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Iterator[bytes]] = kwargs.pop("cls", None)
        ...
        _request = build_create_order_item_request(
            order_item_name=order_item_name,
            resource_group_name=resource_group_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def begin_create_order_item(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop("api-version", self._api_version("begin_create_order_item") or "2020-12-01-preview"),
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.OrderItemResource] = kwargs.pop("cls", None)
        polling: Union[bool, PollingMethod] = kwargs.pop("polling", True)
    ...
    def _delete_order_item_by_name_initial(
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop("api-version", self._api_version("_delete_order_item_by_name_initial") or "2020-12-01-preview"),
        )
        cls: ClsType[Iterator[bytes]] = kwargs.pop("cls", None)

        _request = build_delete_order_item_by_name_request(
            order_item_name=order_item_name,
            resource_group_name=resource_group_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def begin_delete_order_item_by_name(
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop("api-version", self._api_version("begin_delete_order_item_by_name") or "2020-12-01-preview"),
        )
        cls: ClsType[None] = kwargs.pop("cls", None)
        polling: Union[bool, PollingMethod] = kwargs.pop("polling", True)
        lro_delay = kwargs.pop("polling_interval", self._config.polling_interval)
    ...
    def _update_order_item_initial(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop("api-version", self._api_version("_update_order_item_initial") or "2020-12-01-preview"),
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Iterator[bytes]] = kwargs.pop("cls", None)
        ...
        _request = build_update_order_item_request(
            order_item_name=order_item_name,
            resource_group_name=resource_group_name,
            subscription_id=self._config.subscription_id,
            if_match=if_match,
    ...
    def begin_update_order_item(
        ...
        **kwargs: Any
        ...
        :type order_item_update_parameter:
         ~azure.mgmt.edgeorder.v2020_12_01_preview.models.OrderItemUpdateParameter or IO[bytes]
        :param if_match: Defines the If-Match condition. The patch will be performed only if the ETag
         of the order on the server matches this value. Default value is None.
        :type if_match: str
        :return: An instance of LROPoller that returns either OrderItemResource or the result of
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop("api-version", self._api_version("begin_update_order_item") or "2020-12-01-preview"),
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.OrderItemResource] = kwargs.pop("cls", None)
        polling: Union[bool, PollingMethod] = kwargs.pop("polling", True)
    ...
    def cancel_order_item(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("cancel_order_item") or "2020-12-01-preview")
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[None] = kwargs.pop("cls", None)
        ...
        _request = build_cancel_order_item_request(
            order_item_name=order_item_name,
            resource_group_name=resource_group_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def _return_order_item_initial(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop("api-version", self._api_version("_return_order_item_initial") or "2020-12-01-preview"),
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Iterator[bytes]] = kwargs.pop("cls", None)
    ...
    def begin_return_order_item(
        ...
        **kwargs: Any
        ...
        :type return_order_item_details:
         ~azure.mgmt.edgeorder.v2020_12_01_preview.models.ReturnOrderItemDetails or IO[bytes]
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop("api-version", self._api_version("begin_return_order_item") or "2020-12-01-preview"),
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[None] = kwargs.pop("cls", None)
        polling: Union[bool, PollingMethod] = kwargs.pop("polling", True)
