...
def build_return_method_request(
    resource_group_name: str, order_item_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class OrderItemsOperations:
    ...
    def list_by_subscription(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.edgeorder.v2022_05_01_preview.models.OrderItemResource]
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either OrderItemResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.edgeorder.v2022_05_01_preview.models.OrderItemResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type order_item_update_parameter:
         ~azure.mgmt.edgeorder.v2022_05_01_preview.models.OrderItemUpdateParameter or IO[bytes]
        :param if_match: Defines the If-Match condition. The patch will be performed only if the ETag
         of the order on the server matches this value. Default value is None.
        :type if_match: str
        :return: An instance of LROPoller that returns either OrderItemResource or the result of
    ...
    def _return_method_initial(
        ...
        **kwargs: Any
        ...
        _request = build_return_method_request(
            resource_group_name=resource_group_name,
            order_item_name=order_item_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def begin_return_method(
        ...
        **kwargs: Any
        ...
        :param return_order_item_details: Return order item details. Is either a ReturnOrderItemDetails
         type or a IO[bytes] type. Required.
        :type return_order_item_details:
         ~azure.mgmt.edgeorder.v2022_05_01_preview.models.ReturnOrderItemDetails or IO[bytes]
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
