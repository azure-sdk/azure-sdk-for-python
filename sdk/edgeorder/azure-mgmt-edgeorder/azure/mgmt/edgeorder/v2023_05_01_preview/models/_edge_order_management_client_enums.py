...
class ByteSizeByteUnit(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Type of byte unit."""
...
class ByteUnitType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Byte unit types."""
...
class HciCatalogSearchRequestResourceType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class HciCatalogSearchResourceType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Support resource types for HCI catalog search."""

    PLATFORMS = "Platforms"
    """Platforms."""


class HciCatalogSearchResponseResourceType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Search resource type."""
...
class SortOptionsSortDirection(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Sort direction."""
...
class WorkloadCategory(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Type of workload."""
...
class WorkloadDetailsWorkloadType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Workload type, general, AVD, etc."""
