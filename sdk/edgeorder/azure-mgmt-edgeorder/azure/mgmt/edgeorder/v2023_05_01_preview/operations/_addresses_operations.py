...
class AddressesOperations:
    ...
    def list_by_subscription(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.edgeorder.v2023_05_01_preview.models.AddressResource]
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either AddressResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.edgeorder.v2023_05_01_preview.models.AddressResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
