...
def build_get_request(catalog_name: str, location: str, project_name: str, **kwargs: Any) -> HttpRequest:
    ...
    path_format_arguments = {
        ...
        "projectName": _SERIALIZER.url(
            "project_name", project_name, "str", max_length=72, min_length=3, pattern=r"^[-\w\.]+$"
        ),
    }
...
def build_create_request(catalog_name: str, location: str, project_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_update_request(
    catalog_name: str, location: str, project_name: str, *, if_match: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_delete_request(catalog_name: str, location: str, project_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_solution_recommendations_request(
    catalog_name: str, location: str, project_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class HciFlightCatalogProjectOperations:
    ...
    @distributed_trace
    def get(self, catalog_name: str, location: str, project_name: str, **kwargs: Any) -> _models.ProjectResource:
        """Get a project.
