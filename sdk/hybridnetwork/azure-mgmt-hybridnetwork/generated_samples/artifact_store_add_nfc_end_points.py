...
# USAGE
    python artifact_store_add_nfc_end_points.py
...
def main():
    ...
    client.artifact_stores.begin_add_network_fabric_controller_end_points(
...
# x-ms-original-file: specification/hybridnetwork/resource-manager/Microsoft.HybridNetwork/stable/2024-04-15/examples/ArtifactStoreAddNFCEndPoints.json
