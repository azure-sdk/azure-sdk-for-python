...
# USAGE
    python artifact_store_approve_private_end_points.py
...
def main():
    ...
    client.artifact_stores.begin_approve_private_end_points(
...
# x-ms-original-file: specification/hybridnetwork/resource-manager/Microsoft.HybridNetwork/stable/2024-04-15/examples/ArtifactStoreApprovePrivateEndPoints.json
