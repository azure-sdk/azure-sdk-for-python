...
from ...operations._artifact_stores_operations import (
    build_add_network_fabric_controller_end_points_request,
    build_approve_private_end_points_request,
    build_create_or_update_request,
    build_delete_network_fabric_controller_end_points_request,
    build_delete_request,
    build_get_request,
    build_list_by_publisher_request,
    build_list_network_fabric_controller_private_end_points_request,
    build_list_private_end_points_request,
    build_remove_private_end_points_request,
...
class ArtifactStoresOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.hybridnetwork.models.ArtifactStore or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ArtifactStore or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.hybridnetwork.models.ArtifactStore]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def _add_network_fabric_controller_end_points_initial(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        _request = build_add_network_fabric_controller_end_points_request(
            resource_group_name=resource_group_name,
            publisher_name=publisher_name,
            artifact_store_name=artifact_store_name,
            subscription_id=self._config.subscription_id,
    ...
    async def begin_add_network_fabric_controller_end_points(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.hybridnetwork.models.ArtifactStoreNetworkFabricControllerEndPoints or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def _delete_network_fabric_controller_end_points_initial(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        _request = build_delete_network_fabric_controller_end_points_request(
            resource_group_name=resource_group_name,
            publisher_name=publisher_name,
            artifact_store_name=artifact_store_name,
            subscription_id=self._config.subscription_id,
    ...
    async def _list_network_fabric_controller_private_end_points_initial(  # pylint: disable=name-too-long
        ...
        _request = build_list_network_fabric_controller_private_end_points_request(
            resource_group_name=resource_group_name,
            publisher_name=publisher_name,
            artifact_store_name=artifact_store_name,
            subscription_id=self._config.subscription_id,
    ...
    async def begin_list_network_fabric_controller_private_end_points(  # pylint: disable=name-too-long
        ...
        :return: An instance of LROPoller that returns an iterator like instance of either
         ArtifactStoreNetworkFabricControllerEndPointsList or the result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.hybridnetwork.models.ArtifactStoreNetworkFabricControllerEndPoints]]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.ArtifactStoreNetworkFabricControllerEndPointsList] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize(
                "ArtifactStoreNetworkFabricControllerEndPointsList", pipeline_response.http_response
            )
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
    ...
    async def _approve_private_end_points_initial(
        ...
        **kwargs: Any
        ...
        _request = build_approve_private_end_points_request(
            resource_group_name=resource_group_name,
            publisher_name=publisher_name,
            artifact_store_name=artifact_store_name,
            subscription_id=self._config.subscription_id,
    ...
    async def begin_approve_private_end_points(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.hybridnetwork.models.ArtifactStorePrivateEndPointsFormat or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def _remove_private_end_points_initial(
        ...
        **kwargs: Any
        ...
        _request = build_remove_private_end_points_request(
            resource_group_name=resource_group_name,
            publisher_name=publisher_name,
            artifact_store_name=artifact_store_name,
            subscription_id=self._config.subscription_id,
    ...
    async def _list_private_end_points_initial(
        ...
        _request = build_list_private_end_points_request(
            resource_group_name=resource_group_name,
            publisher_name=publisher_name,
            artifact_store_name=artifact_store_name,
            subscription_id=self._config.subscription_id,
    ...
    async def begin_list_private_end_points(
        ...
        :type artifact_store_name: str
        :return: An instance of LROPoller that returns an iterator like instance of either
         ArtifactStorePrivateEndPointsListResult or the result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.hybridnetwork.models.ArtifactStorePrivateEndPointsFormat]]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.ArtifactStorePrivateEndPointsListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("ArtifactStorePrivateEndPointsListResult", pipeline_response.http_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.next_link or None, AsyncList(list_of_elem)
