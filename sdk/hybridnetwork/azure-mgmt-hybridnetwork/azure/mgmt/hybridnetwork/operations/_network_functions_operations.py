...
class NetworkFunctionsOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.hybridnetwork.models.NetworkFunction or IO[bytes]
        :return: An instance of LROPoller that returns either NetworkFunction or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.hybridnetwork.models.NetworkFunction]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _execute_request_initial(
        ...
        **kwargs: Any
        ...
        _request = build_execute_request_request(
            resource_group_name=resource_group_name,
            network_function_name=network_function_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def begin_execute_request(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.hybridnetwork.models.ExecuteRequestParameters or IO[bytes]
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
