...
class ErrorDefinition(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.iotoperationsmq.models.ErrorDefinition]
    """
...
class ErrorResponse(_serialization.Model):
    ...
    :vartype error: ~azure.mgmt.iotoperationsmq.models.ErrorDefinition
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDefinition"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~azure.mgmt.iotoperationsmq.models.ErrorDefinition
        """
        super().__init__(**kwargs)
        self.error = error
