...
def build_get_elastic_to_azure_subscription_mapping_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class OrganizationsOperations:
    ...
    @distributed_trace
    def get_elastic_to_azure_subscription_mapping(
        self, **kwargs: Any
        ...
        request = build_get_elastic_to_azure_subscription_mapping_request(
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self.get_elastic_to_azure_subscription_mapping.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
        ...
        deserialized = self._deserialize("ElasticOrganizationToAzureSubscriptionMappingResponse", pipeline_response)
    ...
    get_elastic_to_azure_subscription_mapping.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.Elastic/getElasticOrganizationToAzureSubscriptionMapping"
    }
