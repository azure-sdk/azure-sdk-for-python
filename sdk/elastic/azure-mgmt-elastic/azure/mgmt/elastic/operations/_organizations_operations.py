...
def build_get_elastic_to_azure_subscription_mapping_request(  # pylint: disable=name-too-long
...
class OrganizationsOperations:
    ...
    def begin_resubscribe(
        ...
        **kwargs: Any
    ) -> LROPoller[_models.ResubscribeResponse]:
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either ResubscribeResponse or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.elastic.models.ResubscribeResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_resubscribe(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.ResubscribeResponse] = kwargs.pop("cls", None)
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("ResubscribeResponse", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
        ...
        if cont_token:
            return LROPoller[_models.ResubscribeResponse].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ResubscribeResponse](
