...
class OpenAIOperations:
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Elastic/monitors/{monitorName}/openAIIntegrations"
    }
    ...
    def get(
        ...
        deserialized = self._deserialize("OpenAIIntegrationRPModel", pipeline_response)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Elastic/monitors/{monitorName}/openAIIntegrations/{integrationName}"
    }
    ...
    def create_or_update(
        ...
        monitor_name: str,
        integration_name: str,
        body: Optional[Union[_models.OpenAIIntegrationRPModel, IO]] = None,
        **kwargs: Any
    ) -> _models.OpenAIIntegrationRPModel:
        """Create or update a OpenAI integration rule for a given monitor resource.
        ...
        :param integration_name: OpenAI Integration name. Required.
        :type integration_name: str
        :param body: Is either a OpenAIIntegrationRPModel type or a IO type. Default value is None.
        :type body: ~azure.mgmt.elastic.models.OpenAIIntegrationRPModel or IO
    ...
    def get_status(
        ...
        deserialized = self._deserialize("OpenAIIntegrationStatusResponse", pipeline_response)
    ...
    get_status.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Elastic/monitors/{monitorName}/openAIIntegrations/{integrationName}/getStatus"
    }
