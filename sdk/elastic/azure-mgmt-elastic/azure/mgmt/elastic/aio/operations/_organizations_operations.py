...
class OrganizationsOperations:
    ...
    async def begin_resubscribe(
        ...
        **kwargs: Any
    ) -> AsyncLROPoller[_models.ResubscribeResponse]:
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either ResubscribeResponse or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.elastic.models.ResubscribeResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_resubscribe(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.ResubscribeResponse].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ResubscribeResponse](
