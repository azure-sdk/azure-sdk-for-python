...
from ...operations._operations import (
    build_elastic_monitor_resources_all_traffic_filters_list_request,
    build_elastic_monitor_resources_associate_request,
    build_elastic_monitor_resources_billing_info_get_request,
    build_elastic_monitor_resources_connected_partner_resources_list_request,
    build_elastic_monitor_resources_create_and_associate_ip_filter_create_request,
    build_elastic_monitor_resources_create_and_associate_pl_filter_create_request,
    build_elastic_monitor_resources_create_or_update_request,
    build_elastic_monitor_resources_create_request,
    build_elastic_monitor_resources_delete_request,
    build_elastic_monitor_resources_deployment_info_list_request,
    build_elastic_monitor_resources_detach_and_delete_traffic_filter_delete_request,
    build_elastic_monitor_resources_detach_traffic_filter_update_request,
    build_elastic_monitor_resources_details_request,
    build_elastic_monitor_resources_get_request,
    build_elastic_monitor_resources_list_associated_traffic_filters_list_request,
    build_elastic_monitor_resources_list_by_resource_group_request,
    build_elastic_monitor_resources_list_request,
    build_elastic_monitor_resources_monitored_resources_list_request,
    build_elastic_monitor_resources_resubscribe_request,
    build_elastic_monitor_resources_traffic_filters_delete_request,
    build_elastic_monitor_resources_update_request,
    build_elastic_monitor_resources_upgradable_versions_details_request,
    build_elastic_monitor_resources_upgrade_request,
    build_elastic_monitor_resources_v_m_collection_update_request,
    build_elastic_monitor_resources_v_m_host_list_request,
    build_elastic_versions_operation_group_list_request,
    ...
    build_open_ai_integration_rp_models_create_or_update_request,
    build_open_ai_integration_rp_models_delete_request,
    build_open_ai_integration_rp_models_get_request,
    build_open_ai_integration_rp_models_get_status_request,
    build_open_ai_integration_rp_models_list_request,
    build_operations_list_request,
    build_organizations_operation_group_get_api_key_request,
    build_organizations_operation_group_get_elastic_to_azure_subscription_mapping_request,
...
class Operations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.elastic.aio.ElasticClient`'s
...
class ElasticMonitorResourcesOperations:  # pylint: disable=too-many-public-methods
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns ElasticMonitorResource. The
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncIterable["_models.ElasticMonitorResource"]:
    ...
    @distributed_trace_async
    async def deployment_info_list(
        self, resource_group_name: str, monitor_name: str, **kwargs: Any
    ...
    @overload
    async def v_m_collection_update(
        self,
        resource_group_name: str,
        monitor_name: str,
    ...
    @distributed_trace_async
    async def upgradable_versions_details(
        self, resource_group_name: str, monitor_name: str, **kwargs: Any
    ...
    @distributed_trace_async
    async def all_traffic_filters_list(
        self, resource_group_name: str, monitor_name: str, **kwargs: Any
    ...
    @distributed_trace_async
    async def list_associated_traffic_filters_list(
        self, resource_group_name: str, monitor_name: str, **kwargs: Any
    ) -> _models.ElasticTrafficFilterResponse:
    ...
    async def _create_and_associate_ip_filter_create_initial(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        monitor_name: str,
        *,
    ...
    @distributed_trace_async
    async def begin_create_and_associate_ip_filter_create(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        monitor_name: str,
        *,
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns OkResponse. The OkResponse is compatible
         with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.elastic.models.OkResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._create_and_associate_ip_filter_create_initial(
                resource_group_name=resource_group_name,
                monitor_name=monitor_name,
                ips=ips,
                name=name,
    ...
    async def _create_and_associate_pl_filter_create_initial(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        monitor_name: str,
        *,
    ...
    @distributed_trace_async
    async def begin_create_and_associate_pl_filter_create(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        monitor_name: str,
        *,
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._create_and_associate_pl_filter_create_initial(
                resource_group_name=resource_group_name,
                monitor_name=monitor_name,
                name=name,
                private_endpoint_guid=private_endpoint_guid,
    ...
    @distributed_trace_async
    async def detach_and_delete_traffic_filter_delete(
        self, resource_group_name: str, monitor_name: str, *, ruleset_id: Optional[str] = None, **kwargs: Any
    ) -> None:
    ...
    async def _detach_traffic_filter_update_initial(
        self, resource_group_name: str, monitor_name: str, *, ruleset_id: Optional[str] = None, **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    @distributed_trace_async
    async def begin_detach_traffic_filter_update(
        self, resource_group_name: str, monitor_name: str, *, ruleset_id: Optional[str] = None, **kwargs: Any
    ) -> AsyncLROPoller[None]:
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._detach_traffic_filter_update_initial(
                resource_group_name=resource_group_name,
                monitor_name=monitor_name,
                ruleset_id=ruleset_id,
                cls=lambda x, y, z: x,
    ...
    @distributed_trace_async
    async def traffic_filters_delete(
        self, resource_group_name: str, monitor_name: str, *, ruleset_id: Optional[str] = None, **kwargs: Any
    ) -> None:
    ...
    async def begin_resubscribe(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.ArmResponseElasticMonitorResource]:
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns ArmResponseElasticMonitorResource. The
         ArmResponseElasticMonitorResource is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.elastic.models.ArmResponseElasticMonitorResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_resubscribe(
        ...
        **kwargs: Any
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.ArmResponseElasticMonitorResource].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ArmResponseElasticMonitorResource](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
...
class ElasticVersionsOperationGroupOperations:
    ...
    @distributed_trace
    def list(self, *, region: str, **kwargs: Any) -> AsyncIterable["_models.ElasticVersionListFormat"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.elastic.models.ElasticVersionListFormat]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
