...
class OpenAIIntegrationProperties(_serialization.Model):
    ...
    _validation = {
        "open_ai_resource_id": {"readonly": True},
        "open_ai_resource_endpoint": {"readonly": True},
    ...
    def __init__(self, *, key: Optional[str] = None, **kwargs: Any) -> None:
        ...
        """
        super().__init__(**kwargs)
        self.open_ai_resource_id = None
        self.open_ai_resource_endpoint = None
        self.key = key
...
class OpenAIIntegrationStatusResponseProperties(_serialization.Model):
    """Status of the OpenAI Integration.
