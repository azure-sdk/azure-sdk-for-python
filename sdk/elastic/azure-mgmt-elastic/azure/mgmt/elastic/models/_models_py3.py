...
class ElasticMonitorResourceUpdateParameters(_serialization.Model):
    ...
    :vartype tags: dict[str, str]
    :ivar resubscribe_properties: Resubscribe Properties.
    :vartype resubscribe_properties: ~azure.mgmt.elastic.models.ResubscribeProperties
    """

    _attribute_map = {
        "tags": {"key": "tags", "type": "{str}"},
        "resubscribe_properties": {"key": "resubscribeProperties", "type": "ResubscribeProperties"},
    }
    ...
    def __init__(
        ...
        *,
        tags: Optional[Dict[str, str]] = None,
        resubscribe_properties: Optional["_models.ResubscribeProperties"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword tags: elastic monitor resource tags.
        :paramtype tags: dict[str, str]
        :keyword resubscribe_properties: Resubscribe Properties.
        :paramtype resubscribe_properties: ~azure.mgmt.elastic.models.ResubscribeProperties
        """
        super().__init__(**kwargs)
        self.tags = tags
        self.resubscribe_properties = resubscribe_properties
