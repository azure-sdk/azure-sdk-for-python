...
class OpenAIIntegrationProperties(_serialization.Model):
    ...
    :ivar open_ai_resource_id: The resource id of Open AI resource.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword open_ai_resource_id: The resource id of Open AI resource.
...
class ResubscribeResponse(_serialization.Model):
    """The properties of Resubscribe response object.

    :ivar properties:
    :vartype properties: ~azure.mgmt.elastic.models.ResubscribeResponseProperties
    """

    _attribute_map = {
        "properties": {"key": "properties", "type": "ResubscribeResponseProperties"},
    }

    def __init__(self, *, properties: Optional["_models.ResubscribeResponseProperties"] = None, **kwargs: Any) -> None:
        """
        :keyword properties:
        :paramtype properties: ~azure.mgmt.elastic.models.ResubscribeResponseProperties
        """
        super().__init__(**kwargs)
        self.properties = properties


class ResubscribeResponseProperties(_serialization.Model):
    """ResubscribeResponseProperties.

    :ivar marketplace_subscription_id: The new Marketplace Subscription Id that is generated as the
     result of Resubscribe.
    ...
    def __init__(self, *, marketplace_subscription_id: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword marketplace_subscription_id: The new Marketplace Subscription Id that is generated as
         the result of Resubscribe.
