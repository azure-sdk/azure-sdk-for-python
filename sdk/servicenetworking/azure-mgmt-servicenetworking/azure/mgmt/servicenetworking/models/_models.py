...
class IpAccessRule(_model_base.Model):
    ...
    :ivar priority: Priority of the Ip Access Rule. Required.
    :vartype priority: int
    :ivar source_address_prefixes: Source Address Prefixed Applied by the Rule. Required.
    ...
    """Priority of the Ip Access Rule. Required."""
    source_address_prefixes: List[str] = rest_field(name="sourceAddressPrefixes")
    """Source Address Prefixed Applied by the Rule. Required."""
...
class SecurityPolicyProperties(_model_base.Model):
    ...
    ip_access_rules_policy: Optional["_models.IpAccessRulesPolicy"] = rest_field(name="ipAccessRulesPolicy")
