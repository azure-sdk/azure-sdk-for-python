...
class FrontendProperties(_model_base.Model):
    ...
    :vartype security_policy_configurations:
     ~azure.mgmt.servicenetworking.models.FrontendSecurityPolicyConfigurations
    ...
    security_policy_configurations: Optional["_models.FrontendSecurityPolicyConfigurations"] = rest_field(
    ...
    def __init__(
        self,
        *,
        security_policy_configurations: Optional["_models.FrontendSecurityPolicyConfigurations"] = None,
    ) -> None: ...
...
class FrontendSecurityPolicyConfigurations(_model_base.Model):
    ...
    :ivar ip_access_rules_security_policy: Contains reference to a IpAccessRules-type security
     policy that is applied at the Traffic Controller level.
    ...
    """Contains reference to a IpAccessRules-type security policy that is applied at the Traffic
     Controller level."""
...
class IpAccessRule(_model_base.Model):
    ...
    :vartype name: str
    :ivar priority: The priority of the rule. The value can be between 1 and 400. The priority
    ...
    """The priority of the rule. The value can be between 1 and 400. The priority number must be
...
class SecurityPolicyProperties(_model_base.Model):
    ...
    :ivar waf_policy: Web Application Firewall Policy of the Traffic Controller Security Policy. If
     this property is set then ipAccessRulesPolicy property cannot be set.
    :vartype waf_policy: ~azure.mgmt.servicenetworking.models.WafPolicy
    :ivar ip_access_rules_policy: Ip Access Policy of the Traffic Controller Security Policy. If
     this property is set then wafPolicy property cannot be set.
    ...
    """Web Application Firewall Policy of the Traffic Controller Security Policy. If this property is
     set then ipAccessRulesPolicy property cannot be set."""
    ...
    """Ip Access Policy of the Traffic Controller Security Policy. If this property is set then
     wafPolicy property cannot be set."""
    provisioning_state: Optional[Union[str, "_models.ProvisioningState"]] = rest_field(
        name="provisioningState", visibility=["read"]
    )
