...
class TestRedisEnterpriseManagementAccessPolicyAssignmentsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_list(self, resource_group):
        response = self.client.access_policy_assignments.list(
