...
def build_check_name_availability_request(location: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/providers/Microsoft.Cache/locations/{location}/checkNameAvailability",
    )  # pylint: disable=line-too-long
    path_format_arguments = {
...
class RedisEnterpriseOperations:
    ...
    def check_name_availability(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters supplied to the CheckNameAvailability Redis operation. The only
         supported resource type is 'Microsoft.Cache/redisenterprise'. Required.
        :type parameters: ~azure.mgmt.redisenterprise.models.CheckNameAvailabilityParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    def check_name_availability(  # pylint: disable=inconsistent-return-statements
        ...
        :type location: str
        :param parameters: Parameters supplied to the CheckNameAvailability Redis operation. The only
         supported resource type is 'Microsoft.Cache/redisenterprise'. Is either a
         CheckNameAvailabilityParameters type or a IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.redisenterprise.models.CheckNameAvailabilityParameters or
         IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
