...
def build_list_dryrun_request(providers: str, resource_uri: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/{resourceUri}/{providers}/{resourceUri}/dryruns")
...
def build_get_dryrun_request(
    providers: str, dryruns: str, resource_uri: str, dryrun_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/{resourceUri}/{providers}/Microsoft.ServiceLinker/{dryruns}/{resourceUri}/{dryrunName}"
    )
    path_format_arguments = {
        "providers": _SERIALIZER.url("providers", providers, "str"),
        "dryruns": _SERIALIZER.url("dryruns", dryruns, "str"),
        "resourceUri": _SERIALIZER.url("resource_uri", resource_uri, "str"),
...
def build_generate_configurations_request(
    ...
    _url = kwargs.pop(
        "template_url",
        "/{resourceUri}/{providers}/Microsoft.ServiceLinker/{linkers}/{resourceUri}/{linkerName}/generateConfigurations",
    )
    path_format_arguments = {
        "providers": _SERIALIZER.url("providers", providers, "str"),
...
class LinkersOperations:
    ...
    @distributed_trace
    def list_dryrun(self, providers: str, resource_uri: str, **kwargs: Any) -> Iterable["_models.DryrunResource"]:
        """list dryrun jobs.
