...
class LinkerOperations:
    ...
    def _validate_initial(self, resource_uri: str, linker_name: str, **kwargs: Any) -> Optional[_models.ValidateResult]:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    @distributed_trace
    def begin_validate(self, resource_uri: str, linker_name: str, **kwargs: Any) -> LROPoller[_models.ValidateResult]:
        """Validate a link.
