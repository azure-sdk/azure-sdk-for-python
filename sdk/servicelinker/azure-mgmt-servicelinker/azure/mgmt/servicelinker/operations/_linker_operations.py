...
def build_list_request(providers: str, resource_uri: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/{resourceUri}/{providers}/{resourceUri}/connectors")
    path_format_arguments = {
        "providers": _SERIALIZER.url("providers", providers, "str"),
...
def build_get_request(providers: str, linkers: str, resource_uri: str, linker_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/{resourceUri}/{providers}/Microsoft.ServiceLinker/{linkers}/{resourceUri}/{linkerName}"
    )
    path_format_arguments = {
        "providers": _SERIALIZER.url("providers", providers, "str"),
        "linkers": _SERIALIZER.url("linkers", linkers, "str"),
        "resourceUri": _SERIALIZER.url("resource_uri", resource_uri, "str"),
...
def build_create_or_update_request(
    providers: str, linkers: str, resource_uri: str, linker_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_configurations_request(
    ...
    _url = kwargs.pop(
        "template_url",
        "/{resourceUri}/{providers}/Microsoft.ServiceLinker/{linkers}/{resourceUri}/{linkerName}/listConfigurations",
    )
    path_format_arguments = {
        "providers": _SERIALIZER.url("providers", providers, "str"),
        "linkers": _SERIALIZER.url("linkers", linkers, "str"),
...
def build_validate_request(
    ...
    _url = kwargs.pop(
        "template_url",
        "/{resourceUri}/{providers}/Microsoft.ServiceLinker/{linkers}/{resourceUri}/{linkerName}/validateLinker",
    )
    path_format_arguments = {
        "providers": _SERIALIZER.url("providers", providers, "str"),
        "linkers": _SERIALIZER.url("linkers", linkers, "str"),
...
class LinkerOperations:
    ...
    @distributed_trace
    def list(self, providers: str, resource_uri: str, **kwargs: Any) -> Iterable["_models.LinkerResource"]:
