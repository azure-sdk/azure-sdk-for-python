...
def build_get_request(
    resource_group_name: str, location: str, connector_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_get_dryrun_request(
    resource_group_name: str, location: str, dryrun_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ConnectorOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, location: str, **kwargs: Any) -> Iterable["_models.LinkerResource"]:
    ...
    def get(
        ...
        :param location: The name of Azure region. Required.
        :type location: str
        :param connector_name: The name of the LinkerResource. Required.
    ...
    @distributed_trace
    def list_dryrun(self, resource_group_name: str, location: str, **kwargs: Any) -> Iterable["_models.DryrunResource"]:
        """list dryrun jobs.
    ...
    def get_dryrun(
        ...
        :param location: The name of Azure region. Required.
        :type location: str
        :param dryrun_name: The name of the DryrunResource. Required.
