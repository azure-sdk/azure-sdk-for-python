...
from ...operations._linkers_operations import (
    ...
    build_list_dapr_configurations_request,
...
class LinkersOperations:
    ...
    @distributed_trace
    def list_dryrun(self, providers: str, resource_uri: str, **kwargs: Any) -> AsyncIterable["_models.DryrunResource"]:
        """list dryrun jobs.

        :param providers: {resourceUri}. Required.
        :type providers: str
    ...
    async def get_dryrun(
        self, providers: str, dryruns: str, resource_uri: str, dryrun_name: str, **kwargs: Any
    ) -> _models.DryrunResource:
        """get a dryrun job.

        :param providers: {resourceUri}. Required.
        :type providers: str
        :param dryruns: The name of the DryrunResource. Required.
        :type dryruns: str
        :param resource_uri: The fully qualified Azure Resource manager identifier of the resource to
         be connected. Required.
        :type resource_uri: str
    ...
    async def generate_configurations(
        ...
        **kwargs: Any
        ...
        :param providers: {resourceUri}. Required.
        :type providers: str
        :param linkers: The name of the LinkerResource. Required.
        :type linkers: str
        :param resource_uri: The fully qualified Azure Resource manager identifier of the resource to
         be connected. Required.
        :type resource_uri: str
    ...
    def list_dapr_configurations(
    ...
    ) -> AsyncIterable["_models.DaprConfigurationResource"]:
        ...
        :return: An iterator like instance of either DaprConfigurationResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.servicelinker.models.DaprConfigurationResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
