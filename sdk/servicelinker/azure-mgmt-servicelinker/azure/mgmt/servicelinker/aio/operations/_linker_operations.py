...
class LinkerOperations:
    ...
    @distributed_trace
    def list(self, providers: str, resource_uri: str, **kwargs: Any) -> AsyncIterable["_models.LinkerResource"]:
    ...
    async def get(
        self, providers: str, linkers: str, resource_uri: str, linker_name: str, **kwargs: Any
