...
from ...operations._sites_by_subscription_operations import (
...
class SitesBySubscriptionOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.Site"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.edgesites.models.Site]
    ...
    async def begin_create_or_update(
        ...
        :param resource: Resource create parameters. Is either a Site type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.edgesites.models.Site or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Site or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.edgesites.models.Site]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        :type properties: ~azure.mgmt.edgesites.models.SiteUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: Site or the result of cls(response)
    ...
    @distributed_trace_async
    async def update(
        self, site_name: str, properties: Union[_models.SiteUpdate, IO[bytes]], **kwargs: Any
    ) -> _models.Site:
        """Update a Site.
        ...
        :type properties: ~azure.mgmt.edgesites.models.SiteUpdate or IO[bytes]
        :return: Site or the result of cls(response)
        :rtype: ~azure.mgmt.edgesites.models.Site
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace_async
    async def delete(self, site_name: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        """Delete a Site.
