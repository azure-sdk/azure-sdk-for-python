...
class Site(ProxyResource):
    ...
    :vartype properties: ~azure.mgmt.edgesites.models.SiteProperties
    """
    ...
    def __init__(self, *, properties: Optional["_models.SiteProperties"] = None, **kwargs: Any) -> None:
        ...
        :paramtype properties: ~azure.mgmt.edgesites.models.SiteProperties
        """
        super().__init__(**kwargs)
...
class SiteProperties(_serialization.Model):
    ...
    :ivar provisioning_state: Provisioning state of last operation. Known values are: "Succeeded",
     "Failed", and "Canceled".
    :vartype provisioning_state: str or ~azure.mgmt.edgesites.models.ResourceProvisioningState
    """
...
class SiteUpdate(_serialization.Model):
    ...
    :vartype properties: ~azure.mgmt.edgesites.models.SiteUpdateProperties
    """
    ...
    def __init__(self, *, properties: Optional["_models.SiteUpdateProperties"] = None, **kwargs: Any) -> None:
        ...
        :paramtype properties: ~azure.mgmt.edgesites.models.SiteUpdateProperties
        """
        super().__init__(**kwargs)
        self.properties = properties
