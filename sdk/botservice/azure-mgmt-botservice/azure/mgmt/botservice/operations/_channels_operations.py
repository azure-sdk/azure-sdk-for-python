...
class ChannelsOperations:
    ...
    def create(
        ...
        resource_name: str,
        channel_name: Union[str, _models.ChannelName],
        parameters: Union[_models.BotChannel, IO[bytes]],
        **kwargs: Any
    ) -> _models.BotChannel:
        """Creates a Channel registration for a Bot Service.
        ...
        :type parameters: ~azure.mgmt.botservice.models.BotChannel or IO[bytes]
        :return: BotChannel or the result of cls(response)
        :rtype: ~azure.mgmt.botservice.models.BotChannel
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_with_keys(
        ...
        _request = build_list_with_keys_request(
            resource_group_name=resource_group_name,
            resource_name=resource_name,
            channel_name=channel_name,
            subscription_id=self._config.subscription_id,
        ...
        deserialized = self._deserialize("ListChannelWithKeysResponse", pipeline_response.http_response)
