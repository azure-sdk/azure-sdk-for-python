...
def build_regenerate_keys_request(
    ...
    **kwargs: Any
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2022-09-15"))
...
class DirectLineOperations:
    ...
    def regenerate_keys(
        ...
        resource_name: str,
        channel_name: Union[str, _models.RegenerateKeysChannelName],
        parameters: Union[_models.SiteInfo, IO],
        **kwargs: Any
    ) -> _models.BotChannel:
        """Regenerates secret keys and returns them for the DirectLine Channel of a particular BotService
        resource.
    ...
    regenerate_keys.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BotService/botServices/{resourceName}/channels/{channelName}/regeneratekeys"
    }
