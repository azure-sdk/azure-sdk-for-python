...
class DirectLineOperations:
    ...
    def regenerate_keys(
        ...
        resource_name: str,
        channel_name: Union[str, _models.RegenerateKeysChannelName],
        parameters: Union[_models.SiteInfo, IO[bytes]],
        **kwargs: Any
    ) -> _models.BotChannel:
        """Regenerates secret keys and returns them for the DirectLine Channel of a particular BotService
        resource.
        ...
        :type parameters: ~azure.mgmt.botservice.models.SiteInfo or IO[bytes]
        :return: BotChannel or the result of cls(response)
        :rtype: ~azure.mgmt.botservice.models.BotChannel
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        deserialized = self._deserialize("BotChannel", pipeline_response.http_response)
