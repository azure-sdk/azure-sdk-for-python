...
def build_get_check_name_availability_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class BotsOperations:
    ...
    @distributed_trace
    def create(
        self, resource_group_name: str, resource_name: str, parameters: Union[_models.Bot, IO[bytes]], **kwargs: Any
    ) -> _models.Bot:
        """Creates a Bot Service. Bot Service is a resource group wide resource type.
        ...
        :type parameters: ~azure.mgmt.botservice.models.Bot or IO[bytes]
        :return: Bot or the result of cls(response)
        :rtype: ~azure.mgmt.botservice.models.Bot
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if response.status_code == 200:
            deserialized = self._deserialize("Bot", pipeline_response.http_response)
    ...
    @distributed_trace
    def get_check_name_availability(
        self, parameters: Union[_models.CheckNameAvailabilityRequestBody, IO[bytes]], **kwargs: Any
    ) -> _models.CheckNameAvailabilityResponseBody:
        """Check whether a bot name is available.

        :param parameters: The request body parameters to provide for the check name availability
         request. Is either a CheckNameAvailabilityRequestBody type or a IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.botservice.models.CheckNameAvailabilityRequestBody or IO[bytes]
        :return: CheckNameAvailabilityResponseBody or the result of cls(response)
        :rtype: ~azure.mgmt.botservice.models.CheckNameAvailabilityResponseBody
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        _request = build_get_check_name_availability_request(
            api_version=api_version,
            content_type=content_type,
            json=_json,
            content=_content,
        ...
        deserialized = self._deserialize("CheckNameAvailabilityResponseBody", pipeline_response.http_response)
