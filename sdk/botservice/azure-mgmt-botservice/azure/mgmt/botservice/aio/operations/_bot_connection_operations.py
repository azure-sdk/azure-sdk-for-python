...
from ...operations._bot_connection_operations import (
    build_create_request,
    build_delete_request,
    build_get_request,
    build_list_by_bot_service_request,
    build_list_service_providers_request,
    build_list_with_secrets_request,
...
class BotConnectionOperations:
    ...
    async def list_service_providers(self, **kwargs: Any) -> _models.ServiceProviderResponseList:
        ...
        _request = build_list_service_providers_request(
        ...
        deserialized = self._deserialize("ServiceProviderResponseList", pipeline_response.http_response)
    ...
    async def list_with_secrets(
        ...
        _request = build_list_with_secrets_request(
        ...
        deserialized = self._deserialize("ConnectionSetting", pipeline_response.http_response)
    ...
    async def create(
        ...
        resource_name: str,
        connection_name: str,
        parameters: Union[_models.ConnectionSetting, IO[bytes]],
        **kwargs: Any
    ) -> _models.ConnectionSetting:
        """Register a new Auth Connection for a Bot Service.
        ...
        :type parameters: ~azure.mgmt.botservice.models.ConnectionSetting or IO[bytes]
        :return: ConnectionSetting or the result of cls(response)
        :rtype: ~azure.mgmt.botservice.models.ConnectionSetting
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_bot_service(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_bot_service_request(
                    resource_group_name=resource_group_name,
                    resource_name=resource_name,
                    subscription_id=self._config.subscription_id,
                    api_version=api_version,
