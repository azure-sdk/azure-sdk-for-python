...
class QnAMakerEndpointKeysOperations:
    ...
    async def get(
        self, parameters: Union[_models.QnAMakerEndpointKeysRequestBody, IO[bytes]], **kwargs: Any
    ) -> _models.QnAMakerEndpointKeysResponse:
        """Lists the QnA Maker endpoint keys.

        :param parameters: The request body parameters to provide for the check name availability
         request. Is either a QnAMakerEndpointKeysRequestBody type or a IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.botservice.models.QnAMakerEndpointKeysRequestBody or IO[bytes]
        :return: QnAMakerEndpointKeysResponse or the result of cls(response)
        :rtype: ~azure.mgmt.botservice.models.QnAMakerEndpointKeysResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        deserialized = self._deserialize("QnAMakerEndpointKeysResponse", pipeline_response.http_response)
