...
def build_code_signing_get_code_signing_status_request(  # pylint: disable=name-too-long
    code_signing_account_name: str, certificate_profile_name: str, operation_id: str, **kwargs: Any
) -> HttpRequest:
...
def build_code_signing_get_sign_root_certificate_request(  # pylint: disable=name-too-long
...
def build_code_signing_list_sign_ekus_request(  # pylint: disable=name-too-long
    code_signing_account_name: str, certificate_profile_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class CodeSigningClientOperationsMixin(CodeSigningClientMixinABC):
    @distributed_trace
    def get_code_signing_status(  # pylint: disable=inconsistent-return-statements
        self, code_signing_account_name: str, certificate_profile_name: str, operation_id: str, **kwargs: Any
    ) -> None:
        ...
        _request = build_code_signing_get_code_signing_status_request(
    ...
    def get_sign_root_certificate(
        ...
        _request = build_code_signing_get_sign_root_certificate_request(
            code_signing_account_name=code_signing_account_name,
            certificate_profile_name=certificate_profile_name,
            api_version=self._config.api_version,
            headers=_headers,
    ...
    def list_sign_ekus(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_code_signing_list_sign_ekus_request(
                    code_signing_account_name=code_signing_account_name,
                    certificate_profile_name=certificate_profile_name,
                    api_version=self._config.api_version,
                    headers=_headers,
    ...
    def _sign_initial(
        ...
        **kwargs: Any
        ...
        _request = build_code_signing_sign_request(
            code_signing_account_name=code_signing_account_name,
            certificate_profile_name=certificate_profile_name,
    ...
    def begin_sign(
        ...
        **kwargs: Any
    ) -> LROPoller[_models.CodeSignResult]:
        ...
        :return: An instance of LROPoller that returns CodeSignResult. The CodeSignResult is compatible
         with MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.codesigning.models.CodeSignResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_sign(
        ...
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.CodeSignResult] = kwargs.pop("cls", None)
        ...
        def get_long_running_output(pipeline_response):
            ...
            deserialized = _deserialize(_models.CodeSignResult, response.json().get("result"))
            if cls:
                return cls(pipeline_response, deserialized, response_headers)  # type: ignore
            return deserialized
        ...
        if cont_token:
            return LROPoller[_models.CodeSignResult].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.CodeSignResult](
