...
class CodeSigningClientOperationsMixin(CodeSigningClientMixinABC):
    ...
    async def get_code_signing_status(  # pylint: disable=inconsistent-return-statements
    ...
    async def begin_sign(
        ...
        **kwargs: Any
    ) -> AsyncLROPoller[_models.CodeSignResult]:
        ...
        :return: An instance of AsyncLROPoller that returns CodeSignResult. The CodeSignResult is
         compatible with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.codesigning.models.CodeSignResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_sign(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.CodeSignResult].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.CodeSignResult](
