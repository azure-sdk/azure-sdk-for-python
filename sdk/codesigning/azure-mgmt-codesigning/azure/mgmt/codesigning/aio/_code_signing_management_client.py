...
class CodeSigningManagementClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype code_signing_account:
     azure.mgmt.codesigning.aio.operations.CodeSigningAccountOperations
    :ivar certificate_profile: CertificateProfileOperations operations
    :vartype certificate_profile:
     azure.mgmt.codesigning.aio.operations.CertificateProfileOperations
