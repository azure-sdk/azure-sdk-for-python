...
from .operations import CertificateProfileOperations, CodeSigningAccountOperations, Operations
...
class CodeSigningManagementClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :type base_url: str
    :keyword api_version: Api Version. Default value is "2023-04-30-preview". Note that overriding
