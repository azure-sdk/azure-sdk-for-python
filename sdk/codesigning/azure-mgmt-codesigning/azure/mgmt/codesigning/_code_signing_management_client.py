...
class CodeSigningManagementClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype code_signing_accounts: azure.mgmt.codesigning.operations.CodeSigningAccountsOperations
    :ivar certificate_profiles: CertificateProfilesOperations operations
    :vartype certificate_profiles: azure.mgmt.codesigning.operations.CertificateProfilesOperations
    ...
    def __enter__(self) -> "CodeSigningManagementClient":
