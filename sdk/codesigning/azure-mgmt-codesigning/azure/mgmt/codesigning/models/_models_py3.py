...
class AccountSku(_serialization.Model):
    ...
    :vartype name: str or ~azure.mgmt.codesigning.models.SkuName
    """
    ...
    def __init__(self, *, name: Union[str, "_models.SkuName"], **kwargs: Any) -> None:
        ...
        :paramtype name: str or ~azure.mgmt.codesigning.models.SkuName
        """
...
class Certificate(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype status_revocation_status: str or ~azure.mgmt.codesigning.models.RevocationStatus
...
class CheckNameAvailabilityResult(_serialization.Model):
    ...
    :ivar reason: The reason that a trusted signing account name could not be used. The Reason
     ...
     "AlreadyExists".
    :vartype reason: str or ~azure.mgmt.codesigning.models.NameUnavailabilityReason
...
class CodeSigningAccount(TrackedResource):
    ...
    :vartype sku: ~azure.mgmt.codesigning.models.AccountSku
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype sku: ~azure.mgmt.codesigning.models.AccountSku
        """
