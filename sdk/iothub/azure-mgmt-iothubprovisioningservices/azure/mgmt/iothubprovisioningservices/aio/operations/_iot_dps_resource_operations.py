...
class IotDpsResourceOperations:  # pylint: disable=too-many-public-methods
    ...
    @overload
    async def failover(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        provisioning_service_name: str,
        dps_failover_description: _models.CustomerInitiatedFailoverInput,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> None:
        ...
        :param resource_group_name: The name of the resource group that contains the provisioning
         service. Required.
        :type resource_group_name: str
        :param provisioning_service_name: The provisioning service name to start customer initiated
         failover. Required.
        :type provisioning_service_name: str
        :param dps_failover_description: Failover description. Required.
        :type dps_failover_description:
         ~azure.mgmt.iothubprovisioningservices.models.CustomerInitiatedFailoverInput
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def failover(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type provisioning_service_name: str
        :param dps_failover_description: Failover description. Required.
        :type dps_failover_description: IO
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def failover(  # pylint: disable=inconsistent-return-statements
        ...
        resource_group_name: str,
        provisioning_service_name: str,
        dps_failover_description: Union[_models.CustomerInitiatedFailoverInput, IO],
        **kwargs: Any
    ) -> None:
        """Customer Initiated Failover for DPS.
        ...
        :param provisioning_service_name: The provisioning service name to start customer initiated
         failover. Required.
        :type provisioning_service_name: str
        :param dps_failover_description: Failover description. Is either a
         CustomerInitiatedFailoverInput type or a IO type. Required.
        :type dps_failover_description:
         ~azure.mgmt.iothubprovisioningservices.models.CustomerInitiatedFailoverInput or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        _json = None
        _content = None
        if isinstance(dps_failover_description, (IO, bytes)):
            _content = dps_failover_description
        else:
            _json = self._serialize.body(dps_failover_description, "CustomerInitiatedFailoverInput")
    ...
    failover.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Devices/provisioningServices/{provisioningServiceName}/failover"
    }
