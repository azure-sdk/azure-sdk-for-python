...
def build_failover_request(
    ...
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "provisioningServiceName": _SERIALIZER.url(
            "provisioning_service_name", provisioning_service_name, "str", pattern=r"^[a-zA-Z0-9-]+$"
        ),
    }
...
class IotDpsResourceOperations:  # pylint: disable=too-many-public-methods
    ...
    @overload
    def failover(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        provisioning_service_name: str,
