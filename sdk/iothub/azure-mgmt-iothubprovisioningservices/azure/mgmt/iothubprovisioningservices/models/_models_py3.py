...
class OperationListResult(_serialization.Model):
    ...
    :ivar value: [Placeholder] Discription for value property. Required.
    :vartype value: list[~azure.mgmt.iothubprovisioningservices.models.Operation]
    :ivar next_link: [Placeholder] Discription for nextLink property.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, next_link: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword next_link: [Placeholder] Discription for nextLink property.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
