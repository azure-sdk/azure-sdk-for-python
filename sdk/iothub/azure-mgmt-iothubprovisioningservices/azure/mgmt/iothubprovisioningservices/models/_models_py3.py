...
class CustomerInitiatedFailoverInput(_serialization.Model):
    """The DPS failover input.

    All required parameters must be populated in order to send to Azure.

    :ivar failover_region: Region that failover is porting to. Required.
    ...
    def __init__(self, *, failover_region: str, **kwargs: Any) -> None:
        """
        :keyword failover_region: Region that failover is porting to. Required.
...
class IotDpsPropertiesDescription(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar enable_customer_initiated_failover: Indicates if the DPS instance has Customer Enabled
     Failover enabled.
    :vartype enable_customer_initiated_failover: bool
    :ivar dps_failover_description: The DPS failover input.
    :vartype dps_failover_description:
     ~azure.mgmt.iothubprovisioningservices.models.IotDpsPropertiesDescriptionDpsFailoverDescription
    ...
    _attribute_map = {
        ...
        "enable_customer_initiated_failover": {"key": "enableCustomerInitiatedFailover", "type": "bool"},
        "dps_failover_description": {
            "key": "dpsFailoverDescription",
            "type": "IotDpsPropertiesDescriptionDpsFailoverDescription",
        },
    ...
    def __init__(
        ...
        *,
        ...
        enable_customer_initiated_failover: Optional[bool] = None,
        dps_failover_description: Optional["_models.IotDpsPropertiesDescriptionDpsFailoverDescription"] = None,
        ...
        **kwargs: Any
        ...
        :paramtype authorization_policies:
         list[~azure.mgmt.iothubprovisioningservices.models.SharedAccessSignatureAuthorizationRuleAccessRightsDescription]
        :keyword enable_customer_initiated_failover: Indicates if the DPS instance has Customer Enabled
         Failover enabled.
        :paramtype enable_customer_initiated_failover: bool
        :keyword dps_failover_description: The DPS failover input.
        :paramtype dps_failover_description:
         ~azure.mgmt.iothubprovisioningservices.models.IotDpsPropertiesDescriptionDpsFailoverDescription
        ...
        self.enable_customer_initiated_failover = enable_customer_initiated_failover
        self.dps_failover_description = dps_failover_description
        self.portal_operations_host_name = portal_operations_host_name


class IotDpsPropertiesDescriptionDpsFailoverDescription(_serialization.Model):
    """The DPS failover input.
