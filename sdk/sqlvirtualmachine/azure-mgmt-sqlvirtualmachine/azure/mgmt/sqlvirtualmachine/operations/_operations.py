...
def build_sql_virtual_machine_groups_list_by_sql_vm_group_request(  # pylint: disable=name-too-long
    resource_group_name: str, sql_virtual_machine_group_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_sql_virtual_machines_troubleshoot_request(  # pylint: disable=name-too-long
    resource_group_name: str, sql_virtual_machine_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class Operations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.sqlvirtualmachine.SqlVirtualMachineClient`'s
