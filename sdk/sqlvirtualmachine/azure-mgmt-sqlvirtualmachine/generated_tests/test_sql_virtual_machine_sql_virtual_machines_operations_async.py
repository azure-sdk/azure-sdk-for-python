...
class TestSqlVirtualMachineSqlVirtualMachinesOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(SqlVirtualMachineClient, is_async=True)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_sql_virtual_machines_get(self, resource_group):
        response = await self.client.sql_virtual_machines.get(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_sql_virtual_machines_begin_create_or_update(self, resource_group):
        response = await (
            await self.client.sql_virtual_machines.begin_create_or_update(
                resource_group_name=resource_group.name,
                sql_virtual_machine_name="str",
                parameters={
                    "location": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_sql_virtual_machines_begin_update(self, resource_group):
        response = await (
            await self.client.sql_virtual_machines.begin_update(
                resource_group_name=resource_group.name,
                sql_virtual_machine_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_sql_virtual_machines_begin_delete(self, resource_group):
        response = await (
            await self.client.sql_virtual_machines.begin_delete(
                resource_group_name=resource_group.name,
                sql_virtual_machine_name="str",
            )
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_sql_virtual_machines_list_by_resource_group(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_sql_virtual_machines_begin_start_assessment(self, resource_group):
        response = await (
            await self.client.sql_virtual_machines.begin_start_assessment(
                resource_group_name=resource_group.name,
                sql_virtual_machine_name="str",
            )
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_sql_virtual_machines_begin_fetch_dc_assessment(self, resource_group):
        response = await (
            await self.client.sql_virtual_machines.begin_fetch_dc_assessment(
                resource_group_name=resource_group.name,
                sql_virtual_machine_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_sql_virtual_machines_begin_redeploy(self, resource_group):
        response = await (
            await self.client.sql_virtual_machines.begin_redeploy(
                resource_group_name=resource_group.name,
                sql_virtual_machine_name="str",
            )
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_sql_virtual_machines_begin_troubleshoot(self, resource_group):
        response = await (
            await self.client.sql_virtual_machines.begin_troubleshoot(
                resource_group_name=resource_group.name,
                sql_virtual_machine_name="str",
                parameters={
                    "endTimeUtc": "2020-02-20 00:00:00",
