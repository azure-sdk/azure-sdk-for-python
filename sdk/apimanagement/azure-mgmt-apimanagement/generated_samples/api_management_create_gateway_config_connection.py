...
def main():
    ...
    response = client.api_management_gateway_config_connection.begin_create_or_update(
...
# x-ms-original-file: specification/apimanagement/resource-manager/Microsoft.ApiManagement/preview/2023-09-01-preview/examples/ApiManagementCreateGatewayConfigConnection.json
