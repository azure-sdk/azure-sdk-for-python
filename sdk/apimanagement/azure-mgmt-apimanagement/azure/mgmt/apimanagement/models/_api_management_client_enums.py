...
class IdentityProviderContractPropertiesSecretType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Type of the secret used for the Identity Provider. Possible values are 'client-secret' and
    'client-certificate'.
    """
...
class IdentityProviderCreateContractPropertiesSecretType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Type of the secret used for the Identity Provider. Possible values are 'client-secret' and
    'client-certificate'.
    """
...
class IdentityProviderUpdatePropertiesSecretType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Type of the secret used for the Identity Provider. Possible values are 'client-secret' and
    'client-certificate'.
    """
