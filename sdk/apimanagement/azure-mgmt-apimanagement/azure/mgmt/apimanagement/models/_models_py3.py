...
class PolicyStatusCollection(_serialization.Model):
    """The response of the list policy status.

    :ivar value: Policy Status Contract value.
    :vartype value: list[~azure.mgmt.apimanagement.models.PolicyStatusContract]
    :ivar next_link: Next page link if any.
    :vartype next_link: str
    """

    _attribute_map = {
        "value": {"key": "value", "type": "[PolicyStatusContract]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.PolicyStatusContract"]] = None,
        next_link: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword value: Policy Status Contract value.
        :paramtype value: list[~azure.mgmt.apimanagement.models.PolicyStatusContract]
        :keyword next_link: Next page link if any.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class PolicyStatusContract(ProxyResource):
    ...
    def __init__(
        ...
        *,
        ...
        compliance_state: Union[str, "_models.PolicyComplianceState"] = "Pending",
        **kwargs: Any
    ) -> None:
        """
