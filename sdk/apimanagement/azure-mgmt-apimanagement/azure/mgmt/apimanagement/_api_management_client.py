...
from .operations import (
    ...
    ApiManagementGatewayConfigConnectionOperations,
    ApiManagementGatewayOperations,
...
class ApiManagementClient(
    ...
    :ivar api_management_gateway: ApiManagementGatewayOperations operations
    :vartype api_management_gateway:
     azure.mgmt.apimanagement.operations.ApiManagementGatewayOperations
    ...
    :ivar api_management_gateway_config_connection: ApiManagementGatewayConfigConnectionOperations
     operations
    :vartype api_management_gateway_config_connection:
     azure.mgmt.apimanagement.operations.ApiManagementGatewayConfigConnectionOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.api_management_gateway = ApiManagementGatewayOperations(
        ...
        self.api_management_gateway_config_connection = ApiManagementGatewayConfigConnectionOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
