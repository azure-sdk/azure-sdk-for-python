...
from ...operations._api_management_gateway_operations import (
...
class ApiManagementGatewayOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`api_management_gateway` attribute.
    """
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        if response.status_code == 200:
            deserialized = self._deserialize("ApiManagementGatewayResource", pipeline_response)
    ...
    async def _update_initial(
        ...
        **kwargs: Any
    ) -> Optional[_models.ApiManagementGatewayResource]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.ApiManagementGatewayResource]] = kwargs.pop("cls", None)
