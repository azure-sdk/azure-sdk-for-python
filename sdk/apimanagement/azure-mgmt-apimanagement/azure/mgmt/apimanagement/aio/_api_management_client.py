...
class ApiManagementClient(
    ...
    :vartype api_management_gateway:
     azure.mgmt.apimanagement.aio.operations.ApiManagementGatewayOperations
    ...
    :vartype api_management_gateway_config_connection:
     azure.mgmt.apimanagement.aio.operations.ApiManagementGatewayConfigConnectionOperations
