...
def build_get_entity_tag_request(
    resource_group_name: str, service_name: str, cache_id: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_update_request(
    resource_group_name: str, service_name: str, cache_id: str, subscription_id: str, *, if_match: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class CacheOperations:
    ...
    def list_by_service(
        ...
        skip: Optional[int] = None,
        **kwargs: Any
    ) -> Iterable["_models.CacheContract"]:
    ...
    list_by_service.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/caches"
    }
    ...
    get_entity_tag.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/caches/{cacheId}"
    }
    ...
    def create_or_update(
        ...
        service_name: str,
        cache_id: str,
        parameters: Union[_models.CacheContract, IO],
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> _models.CacheContract:
        """Creates or updates an External Cache to be used in Api Management instance.
    ...
    def update(
        ...
        cache_id: str,
        if_match: str,
        parameters: Union[_models.CacheUpdateParameters, IO],
        **kwargs: Any
    ) -> _models.CacheContract:
        """Updates the details of the cache specified by its identifier.
