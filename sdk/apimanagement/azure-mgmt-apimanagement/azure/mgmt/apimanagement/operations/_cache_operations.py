...
class CacheOperations:
    ...
    def create_or_update(
        ...
        service_name: str,
        cache_id: str,
        parameters: Union[_models.CacheContract, IO[bytes]],
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> _models.CacheContract:
        """Creates or updates an External Cache to be used in Api Management instance.
        ...
        :param parameters: Create or Update parameters. Is either a CacheContract type or a IO[bytes]
         type. Required.
        :type parameters: ~azure.mgmt.apimanagement.models.CacheContract or IO[bytes]
        :param if_match: ETag of the Entity. Not required when creating an entity, but required when
         updating an entity. Default value is None.
        :type if_match: str
        :return: CacheContract or the result of cls(response)
    ...
    def update(
        ...
        cache_id: str,
        if_match: str,
        parameters: Union[_models.CacheUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.CacheContract:
        """Updates the details of the cache specified by its identifier.
        ...
        :param parameters: Update parameters. Is either a CacheUpdateParameters type or a IO[bytes]
         type. Required.
        :type parameters: ~azure.mgmt.apimanagement.models.CacheUpdateParameters or IO[bytes]
        :return: CacheContract or the result of cls(response)
        :rtype: ~azure.mgmt.apimanagement.models.CacheContract
        :raises ~azure.core.exceptions.HttpResponseError:
        """
