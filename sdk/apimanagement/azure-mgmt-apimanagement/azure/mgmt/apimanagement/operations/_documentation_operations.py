...
class DocumentationOperations:
    ...
    def create_or_update(
        ...
        service_name: str,
        documentation_id: str,
        parameters: Union[_models.DocumentationContract, IO[bytes]],
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> _models.DocumentationContract:
        """Creates a new Documentation or updates an existing one.
        ...
        :param parameters: Create parameters. Is either a DocumentationContract type or a IO[bytes]
         type. Required.
        :type parameters: ~azure.mgmt.apimanagement.models.DocumentationContract or IO[bytes]
        :param if_match: ETag of the Entity. Not required when creating an entity, but required when
         updating an entity. Default value is None.
        :type if_match: str
        :return: DocumentationContract or the result of cls(response)
    ...
    def update(
        ...
        documentation_id: str,
        if_match: str,
        parameters: Union[_models.DocumentationUpdateContract, IO[bytes]],
        **kwargs: Any
    ) -> _models.DocumentationContract:
        """Updates the details of the Documentation for an API specified by its identifier.
        ...
        :type parameters: ~azure.mgmt.apimanagement.models.DocumentationUpdateContract or IO[bytes]
        :return: DocumentationContract or the result of cls(response)
        :rtype: ~azure.mgmt.apimanagement.models.DocumentationContract
        :raises ~azure.core.exceptions.HttpResponseError:
        """
