...
def build_get_entity_tag_request(
    resource_group_name: str, service_name: str, documentation_id: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class DocumentationOperations:
    ...
    def list_by_service(
        ...
        skip: Optional[int] = None,
        **kwargs: Any
    ) -> Iterable["_models.DocumentationContract"]:
    ...
    list_by_service.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/documentations"
    }
    ...
    get_entity_tag.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/documentations/{documentationId}"
    }
    ...
    def create_or_update(
        ...
        service_name: str,
        documentation_id: str,
        parameters: Union[_models.DocumentationContract, IO],
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> _models.DocumentationContract:
        """Creates a new Documentation or updates an existing one.
    ...
    def update(
        ...
        documentation_id: str,
        if_match: str,
        parameters: Union[_models.DocumentationUpdateContract, IO],
        **kwargs: Any
    ) -> _models.DocumentationContract:
        """Updates the details of the Documentation for an API specified by its identifier.
