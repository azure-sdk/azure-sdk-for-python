...
def build_get_entity_tag_request(
    resource_group_name: str, service_name: str, logger_id: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_update_request(
    resource_group_name: str, service_name: str, logger_id: str, subscription_id: str, *, if_match: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class LoggerOperations:
    ...
    list_by_service.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/loggers"
    }
    ...
    def create_or_update(
        ...
        service_name: str,
        logger_id: str,
        parameters: Union[_models.LoggerContract, IO],
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> _models.LoggerContract:
        """Creates or Updates a logger.
    ...
    def update(
        ...
        logger_id: str,
        if_match: str,
        parameters: Union[_models.LoggerUpdateContract, IO],
        **kwargs: Any
    ) -> _models.LoggerContract:
        """Updates an existing logger.
