...
class EncryptionCustomerManagedKeyEncryptionKeyIdentity(_serialization.Model):
...
class LocationsItem(_serialization.Model):
    ...
    :ivar location_name: The locations name. Required.
    ...
    def __init__(self, *, location_name: str, **kwargs: Any) -> None:
        """
        :keyword location_name: The locations name. Required.
...
class MapsAccountProperties(_serialization.Model):
    ...
    :ivar locations: List of data processing locations for the Maps Account. If no locations are
     set, Azure REST APIs will only enable features available in the Maps Account's location.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword locations: List of data processing locations for the Maps Account. If no locations are
         set, Azure REST APIs will only enable features available in the Maps Account's location.
