...
class SolutionOperations:
    ...
    async def get(self, scope: str, solution_resource_name: str, **kwargs: Any) -> _models.SolutionResource:
        ...
        deserialized = self._deserialize("SolutionResource", pipeline_response.http_response)
    ...
    async def _create_initial(
        ...
        solution_request_body: Union[_models.SolutionResource, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param solution_request_body: The required request body for this solution resource creation. Is
         either a SolutionResource type or a IO[bytes] type. Required.
    ...
    async def _update_initial(
        ...
        scope: str,
        solution_resource_name: str,
        solution_patch_request_body: Union[_models.SolutionPatchRequestBody, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type solution_resource_name: str
        :param solution_patch_request_body: The required request body for updating a solution resource.
         Is either a SolutionPatchRequestBody type or a IO[bytes] type. Required.
