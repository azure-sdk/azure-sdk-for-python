...
class DiagnosticsOperations:
    ...
    async def get(self, scope: str, diagnostics_resource_name: str, **kwargs: Any) -> _models.DiagnosticResource:
        ...
        deserialized = self._deserialize("DiagnosticResource", pipeline_response.http_response)
    ...
    async def _create_initial(
        ...
        diagnostic_resource_request: Union[_models.DiagnosticResource, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        data and provide the root cause of the issue and the steps to address the issue.\\
        :code:`<br/>`\\ :code:`<br/>`.
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type diagnostics_resource_name: str
        :param diagnostic_resource_request: The required request body for this insightResource
         invocation. Is either a DiagnosticResource type or a IO[bytes] type. Required.
