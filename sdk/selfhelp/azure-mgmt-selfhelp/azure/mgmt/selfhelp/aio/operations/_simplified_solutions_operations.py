...
class SimplifiedSolutionsOperations:
    ...
    async def get(
        ...
        deserialized = self._deserialize("SimplifiedSolutionsResource", pipeline_response.http_response)
    ...
    async def _create_initial(
        ...
        simplified_solutions_request_body: Union[_models.SimplifiedSolutionsResource, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type simplified_solutions_resource_name: str
        :param simplified_solutions_request_body: The required request body for simplified Solutions
         resource creation. Is either a SimplifiedSolutionsResource type or a IO[bytes] type. Required.
        :type simplified_solutions_request_body:
