...
class TroubleshootersOperations:
    ...
    def get(self, scope: str, troubleshooter_name: str, **kwargs: Any) -> _models.TroubleshooterResource:
        ...
        resource name that is being executed.\\ :code:`<br/>` Get API is used to retrieve the result of
        a Troubleshooter instance, which includes the status and result of each step in the
        ...
        deserialized = self._deserialize("TroubleshooterResource", pipeline_response.http_response)
    ...
    def create(
        ...
        scope: str,
        troubleshooter_name: str,
        create_troubleshooter_request_body: Union[_models.TroubleshooterResource, IO[bytes]],
        **kwargs: Any
    ) -> _models.TroubleshooterResource:
        """Creates the specific troubleshooter action under a resource or subscription using the
        ‘solutionId’ and  ‘properties.parameters’ as the trigger. :code:`<br/>` Azure Troubleshooters
        ...
        :type troubleshooter_name: str
        :param create_troubleshooter_request_body: The required request body for this Troubleshooter
         resource creation. Is either a TroubleshooterResource type or a IO[bytes] type. Required.
    ...
    def restart(self, scope: str, troubleshooter_name: str, **kwargs: Any) -> _models.RestartTroubleshooterResponse:
        ...
        :code:`<br/>` It returns new resource name which should be used in subsequent request. The old
        ...
        deserialized = self._deserialize("RestartTroubleshooterResponse", pipeline_response.http_response)
