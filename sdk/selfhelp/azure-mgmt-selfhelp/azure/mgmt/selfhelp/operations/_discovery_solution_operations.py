...
class DiscoverySolutionOperations:
    ...
    def list(
        ...
        resourceUri or resourceType.\\ :code:`<br/>` Discovery Solutions is the initial entry point
        within Help API, which identifies relevant Azure diagnostics and solutions. :code:`<br/>`\\
        :code:`<br/>` Required Input :  problemClassificationId (Use the `problemClassification API
