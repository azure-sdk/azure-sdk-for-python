...
class TestSelfHelpMgmtDiagnosticsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_diagnostics_begin_create(self, resource_group):
        response = await (
            await self.client.diagnostics.begin_create(
                scope="str",
                diagnostics_resource_name="str",
