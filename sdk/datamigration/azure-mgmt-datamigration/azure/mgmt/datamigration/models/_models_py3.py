...
class DatabaseMigrationCosmosDbMongo(ProxyResource):  # pylint: disable=too-many-instance-attributes
...
class DatabaseMigrationProperties(DatabaseMigrationBaseProperties):  # pylint: disable=too-many-instance-attributes
...
class DatabaseMigrationPropertiesCosmosDbMongo(
...
class DataMigrationService(TrackedResourceAutoGenerated):  # pylint: disable=too-many-instance-attributes
...
class Project(TrackedResourceAutoGenerated):  # pylint: disable=too-many-instance-attributes
    """A project resource.
