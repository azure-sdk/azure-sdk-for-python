...
def build_get_request(
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2023-07-15-preview"))
...
class DatabaseMigrationsMongoToCosmosDbRUMongoOperations:
    """
    .. warning::
    ...
    def get(
        ...
        deserialized = self._deserialize("DatabaseMigrationCosmosDbMongo", pipeline_response)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{targetResourceName}/providers/Microsoft.DataMigration/databaseMigrations/{migrationName}"
    }
    ...
    def _create_initial(
        ...
        target_resource_name: str,
        migration_name: str,
        parameters: Union[_models.DatabaseMigrationCosmosDbMongo, IO],
        **kwargs: Any
    ) -> _models.DatabaseMigrationCosmosDbMongo:
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param parameters: Details of CosmosDB for Mongo API Migration resource. Is either a
         DatabaseMigrationCosmosDbMongo type or a IO type. Required.
        :type parameters: ~azure.mgmt.datamigration.models.DatabaseMigrationCosmosDbMongo or IO
    ...
    def get_for_scope(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_get_for_scope_request(
                    resource_group_name=resource_group_name,
                    target_resource_name=target_resource_name,
                    subscription_id=self._config.subscription_id,
                    api_version=api_version,
                    template_url=self.get_for_scope.metadata["url"],
                    headers=_headers,
                    params=_params,
                )
                request = _convert_request(request)
    ...
    get_for_scope.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{targetResourceName}/providers/Microsoft.DataMigration/databaseMigrations"
    }
