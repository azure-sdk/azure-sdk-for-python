...
class MigrationServicesOperations:
    ...
    async def get(
        ...
        deserialized = self._deserialize("MigrationService", pipeline_response)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataMigration/migrationServices/{migrationServiceName}"
    }
    ...
    async def _create_or_update_initial(
        ...
        parameters: Union[_models.MigrationService, IO],
        **kwargs: Any
    ) -> _models.MigrationService:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: Details of MigrationService resource. Is either a MigrationService type or a
         IO type. Required.
        :type parameters: ~azure.mgmt.datamigration.models.MigrationService or IO
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        migration_service_name: str,
        parameters: Union[_models.MigrationServiceUpdate, IO],
        **kwargs: Any
    ) -> Optional[_models.MigrationService]:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.MigrationService]] = kwargs.pop("cls", None)
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.datamigration.models.MigrationServiceUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    list_by_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataMigration/migrationServices"
    }
    ...
    list_by_subscription.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.DataMigration/migrationServices"
    }
    ...
    list_migrations.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataMigration/migrationServices/{migrationServiceName}/listMigrations"
    }
