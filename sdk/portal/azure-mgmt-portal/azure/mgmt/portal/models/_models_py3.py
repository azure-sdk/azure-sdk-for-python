...
class DashboardPartMetadata(_serialization.Model):
    ...
    :ivar type: Required. "Extension/HubsExtension/PartType/MarkdownPart"
...
class PagedViolation(_serialization.Model):
...
class TenantConfiguration(ProxyResource):
...
class TenantConfigurationListResult(_serialization.Model):
    """The response of a TenantConfiguration list operation.

    All required parameters must be populated in order to send to server.

    :ivar value: The TenantConfiguration items on this page. Required.
    :vartype value: list[~azure.mgmt.portal.models.TenantConfiguration]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    _attribute_map = {
        "value": {"key": "value", "type": "[TenantConfiguration]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }

    def __init__(
        self, *, value: List["_models.TenantConfiguration"], next_link: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: The TenantConfiguration items on this page. Required.
        :paramtype value: list[~azure.mgmt.portal.models.TenantConfiguration]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
