...
from ._configuration import PortalForTestingConfiguration
...
class PortalForTesting:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = PortalForTestingConfiguration(credential=credential, subscription_id=subscription_id, **kwargs)
