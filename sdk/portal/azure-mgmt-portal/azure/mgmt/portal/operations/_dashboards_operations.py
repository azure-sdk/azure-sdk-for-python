...
class DashboardsOperations:
    ...
    def create_or_update(
        ...
        resource_group_name: str,
        dashboard_name: str,
        dashboard: Union[_models.Dashboard, IO[bytes]],
        **kwargs: Any
    ) -> _models.Dashboard:
        """Creates or updates a Dashboard.
        ...
        :param dashboard_name: The name of the dashboard. Required.
        :type dashboard_name: str
        :param dashboard: The parameters required to create or update a dashboard. Is either a
         Dashboard type or a IO[bytes] type. Required.
        :type dashboard: ~azure.mgmt.portal.models.Dashboard or IO[bytes]
        :return: Dashboard or the result of cls(response)
        :rtype: ~azure.mgmt.portal.models.Dashboard
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        _json = None
        _content = None
        if isinstance(dashboard, (IOBase, bytes)):
            _content = dashboard
        else:
    ...
    def get(self, resource_group_name: str, dashboard_name: str, **kwargs: Any) -> Optional[_models.Dashboard]:
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[Optional[_models.Dashboard]] = kwargs.pop("cls", None)
    ...
    def update(
        ...
        resource_group_name: str,
        dashboard_name: str,
        dashboard: Union[_models.PatchableDashboard, IO[bytes]],
        **kwargs: Any
    ) -> Optional[_models.Dashboard]:
        """Updates an existing Dashboard.
        ...
        :param dashboard_name: The name of the dashboard. Required.
        :type dashboard_name: str
        :param dashboard: The updatable fields of a Dashboard. Is either a PatchableDashboard type or a
         IO[bytes] type. Required.
        :type dashboard: ~azure.mgmt.portal.models.PatchableDashboard or IO[bytes]
        :return: Dashboard or None or the result of cls(response)
        :rtype: ~azure.mgmt.portal.models.Dashboard or None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
