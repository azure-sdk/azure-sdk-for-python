...
class Portal:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :ivar list_tenant_configuration_violations_operations:
     ListTenantConfigurationViolationsOperationsOperations operations
    :vartype list_tenant_configuration_violations_operations:
     azure.mgmt.portal.aio.operations.ListTenantConfigurationViolationsOperationsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.list_tenant_configuration_violations_operations = ListTenantConfigurationViolationsOperationsOperations(
