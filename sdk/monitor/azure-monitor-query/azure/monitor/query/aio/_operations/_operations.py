...
from ..._operations._operations import build_monitor_query_logs_batch_request, build_monitor_query_logs_execute_request, build_monitor_query_logs_execute_with_resource_id_request
...
class _MonitorQueryLogsClientOperationsMixin( 
    ...
    async def _execute(
        ...
        **kwargs: Any
        ...
        cls: ClsType[_models._models.QueryResults] = kwargs.pop(
            'cls', None
        )
        ...
        if _stream:
            ...
            deserialized = _deserialize(
                _models._models.QueryResults,  # pylint: disable=protected-access
                response.json()
            )
    ...
    async def _batch(
        self,
        body: _models._models.BatchRequest,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ...
    async def _batch(
        self,
        body: Union[_models._models.BatchRequest, JSON, IO[bytes]],
        **kwargs: Any
    ) -> _models._models.BatchResponse:
        ...
        content_type: Optional[str] = kwargs.pop('content_type', _headers.pop('content-type', None))
        cls: ClsType[_models._models.BatchResponse] = kwargs.pop(
            'cls', None
        )
        ...
        if _stream:
            ...
            deserialized = _deserialize(
                _models._models.BatchResponse,  # pylint: disable=protected-access
                response.json()
            )
