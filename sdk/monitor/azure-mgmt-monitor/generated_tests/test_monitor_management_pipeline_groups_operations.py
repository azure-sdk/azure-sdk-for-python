...
class TestMonitorManagementPipelineGroupsOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(MonitorManagementClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_pipeline_groups_get(self, resource_group):
        response = self.client.pipeline_groups.get(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_pipeline_groups_begin_create_or_update(self, resource_group):
        response = self.client.pipeline_groups.begin_create_or_update(
            resource_group_name=resource_group.name,
            pipeline_group_name="str",
            resource={
                "location": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_pipeline_groups_begin_delete(self, resource_group):
        response = self.client.pipeline_groups.begin_delete(
            resource_group_name=resource_group.name,
            pipeline_group_name="str",
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_pipeline_groups_begin_update(self, resource_group):
        response = self.client.pipeline_groups.begin_update(
            resource_group_name=resource_group.name,
            pipeline_group_name="str",
            properties={
                "properties": {
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_pipeline_groups_list_by_resource_group(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_pipeline_groups_list_by_subscription(self, resource_group):
