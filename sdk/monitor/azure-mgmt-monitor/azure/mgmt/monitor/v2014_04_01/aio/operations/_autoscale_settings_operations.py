...
class AutoscaleSettingsOperations:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.monitor.v2014_04_01.models.AutoscaleSettingResource or IO
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type autoscale_setting_resource:
         ~azure.mgmt.monitor.v2014_04_01.models.AutoscaleSettingResourcePatch or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
