...
class AzureMonitorWorkspaceLogsApiConfig(_model_base.Model):
    ...
    data_collection_endpoint_url: str = rest_field(name="dataCollectionEndpointUrl")
    """Data collection endpoint ingestion url. Required."""
    stream: str = rest_field()
    """Stream name in destination. Azure Monitor stream is related to the destination table. Required."""
    data_collection_rule: str = rest_field(name="dataCollectionRule")
    """Data Collection Rule (DCR) immutable id. Required."""
    schema: "_models.SchemaMap" = rest_field()
...
class BatchProcessor(_model_base.Model):
    ...
    """Size of the batch."""
    timeout: Optional[int] = rest_field()
...
class CacheConfiguration(_model_base.Model):
    ...
    max_storage_usage: Optional[int] = rest_field(name="maxStorageUsage")
    """Max storage usage in megabytes."""
    retention_period: Optional[int] = rest_field(name="retentionPeriod")
...
class ConcurrencyConfiguration(_model_base.Model):
    ...
    worker_count: Optional[int] = rest_field(name="workerCount")
    """Number of parallel workers processing the log queues."""
    batch_queue_size: Optional[int] = rest_field(name="batchQueueSize")
...
class Exporter(_model_base.Model):
    ...
    type: Union[str, "_models.ExporterType"] = rest_field()
    ...
    """Azure Monitor Workspace Logs specific configurations."""
    tcp: Optional["_models.TcpExporter"] = rest_field()
...
class NetworkingConfiguration(_model_base.Model):
    ...
    external_networking_mode: Union[str, "_models.ExternalNetworkingMode"] = rest_field(name="externalNetworkingMode")
    ...
    routes: List["_models.NetworkingRoute"] = rest_field()
...
class NetworkingRoute(_model_base.Model):
    ...
    """Route path."""
    subdomain: Optional[str] = rest_field()
    """Route subdomain."""
...
class OtlpReceiver(_model_base.Model):
    ...
    :ivar endpoint: OTLP GRPC endpoint definition. Example: 0.0.0.0::code:`<port>`. Required.
    :vartype endpoint: str
    """

    endpoint: str = rest_field()
    """OTLP GRPC endpoint definition. Example: 0.0.0.0::code:`<port>`. Required."""
...
class PersistenceConfigurations(_model_base.Model):
    ...
    persistent_volume_name: str = rest_field(name="persistentVolumeName")
...
class Pipeline(_model_base.Model):
    ...
    type: Union[str, "_models.PipelineType"] = rest_field()
    """The type of pipeline. Required. \"logs\""""
    receivers: List[str] = rest_field()
    """Reference to receivers configured for the pipeline. Required."""
    processors: Optional[List[str]] = rest_field()
    """Reference to processors configured for the pipeline."""
    exporters: List[str] = rest_field()
...
class PipelineGroupUpdateProperties(_model_base.Model):
    ...
    service: Optional["_models.Service"] = rest_field()
...
class Processor(_model_base.Model):
    ...
    type: Union[str, "_models.ProcessorType"] = rest_field()
    """The type of processor. Required. \"Batch\""""
    name: str = rest_field()
    """The name of processor. Required."""
    batch: Optional["_models.BatchProcessor"] = rest_field()
...
class SchemaMap(_model_base.Model):
    ...
    record_map: List["_models.RecordMap"] = rest_field(name="recordMap")
    """Record Map. Required."""
    resource_map: Optional[List["_models.ResourceMap"]] = rest_field(name="resourceMap")
    ...
    scope_map: Optional[List["_models.ScopeMap"]] = rest_field(name="scopeMap")
...
class Service(_model_base.Model):
    ...
    pipelines: List["_models.Pipeline"] = rest_field()
...
class SyslogReceiver(_model_base.Model):
    ...
    :ivar endpoint: Syslog receiver endpoint definition. Example: 0.0.0.0::code:`<port>`. Required.
    :vartype endpoint: str
    ...
    endpoint: str = rest_field()
    """Syslog receiver endpoint definition. Example: 0.0.0.0::code:`<port>`. Required."""
...
class UdpReceiver(_model_base.Model):
    ...
    :ivar endpoint: TCP endpoint definition. Example: 0.0.0.0::code:`<port>`. Required.
    :vartype endpoint: str
    ...
    endpoint: str = rest_field()
    """TCP endpoint definition. Example: 0.0.0.0::code:`<port>`. Required."""
    ...
    read_queue_length: Optional[int] = rest_field(name="readQueueLength")
