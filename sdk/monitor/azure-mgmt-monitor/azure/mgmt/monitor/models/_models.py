...
class AzureMonitorWorkspaceLogsApiConfig(_Model):
...
class AzureMonitorWorkspaceLogsExporter(_Model):
...
class AzureMonitorWorkspaceProperties(_Model):
...
class AzureMonitorWorkspaceUpdate(_Model):
...
class AzureMonitorWorkspaceUpdateProperties(_Model):
...
class ConcurrencyConfiguration(_Model):
...
class IngestionSettings(_Model):
...
class NetworkingConfiguration(_Model):
...
class PersistenceConfigurations(_Model):
...
class PipelineGroupProperties(_Model):
...
class PipelineGroupUpdate(_Model):
...
class PipelineGroupUpdateProperties(_Model):
