...
class MetricAlertResourceKind(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class MetricAlertRuleCriteriaOperator(str, Enum, metaclass=CaseInsensitiveEnumMeta):
