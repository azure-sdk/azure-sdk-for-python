...
class Certificate(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.status_revocation_status: Optional[Union[str, "_models.RevocationStatus"]] = None
...
class CertificateProfile(ProxyResource):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.status: Optional[Union[str, "_models.CertificateProfileStatus"]] = None
        self.certificates: Optional[List["_models.Certificate"]] = None
...
class CheckNameAvailabilityResult(_serialization.Model):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.reason: Optional[Union[str, "_models.NameUnavailabilityReason"]] = None
