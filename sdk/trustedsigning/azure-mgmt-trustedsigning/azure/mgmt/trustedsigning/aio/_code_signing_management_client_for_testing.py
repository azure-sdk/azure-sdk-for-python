...
from ._configuration import CodeSigningManagementClientForTestingConfiguration
...
class CodeSigningManagementClientForTesting:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :type base_url: str
    :keyword api_version: Api Version. Default value is "2024-02-05-preview". Note that overriding
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = CodeSigningManagementClientForTestingConfiguration(
