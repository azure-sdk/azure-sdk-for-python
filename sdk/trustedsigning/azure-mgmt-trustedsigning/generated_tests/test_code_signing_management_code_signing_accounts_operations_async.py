...
# --------------------------------------------------------------------------
import pytest
from azure.mgmt.trustedsigning.aio import CodeSigningManagementClient
...
class TestCodeSigningManagementCodeSigningAccountsOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(CodeSigningManagementClient, is_async=True)
