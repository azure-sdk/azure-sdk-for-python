...
class ErrorResponseAutoGenerated(_serialization.Model):
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetail"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~azure.mgmt.automation.models.ErrorDetail
        """
        super().__init__(**kwargs)
        self.error = error
...
class UsageAutoGenerated(_serialization.Model):
    """Definition of Usage.
    ...
    :ivar limit: Gets or sets max limit. -1 for unlimited.
    :vartype limit: int
    :ivar throttle_status: Gets throttling status of subscription. Known values are: "NotThrottled"
     and "ThrottledAtSubscriptionLevel".
    :vartype throttle_status: str or ~azure.mgmt.automation.models.ThrottlingState
    """

    _validation = {
        "throttle_status": {"readonly": True},
    }
...
class UsageListResultAutoGenerated(_serialization.Model):
    """The response model for the get usage operation.

    All required parameters must be populated in order to send to server.

    :ivar value: Gets or sets usage. Required.
    :vartype value: list[~azure.mgmt.automation.models.UsageAutoGenerated]
    :ivar next_link: Gets or sets the next link.
    :vartype next_link: str
    """
    ...
    _attribute_map = {
        "value": {"key": "value", "type": "[UsageAutoGenerated]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }

    def __init__(
        self, *, value: List["_models.UsageAutoGenerated"], next_link: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: Gets or sets usage. Required.
        :paramtype value: list[~azure.mgmt.automation.models.UsageAutoGenerated]
        :keyword next_link: Gets or sets the next link.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
