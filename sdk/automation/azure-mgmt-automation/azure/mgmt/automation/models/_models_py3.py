...
class Module(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar provisioning_state: Gets or sets the provisioning state of the module. Known values are:
     ...
     "Succeeded", "Failed", "Cancelled", "Updating", and "Canceled".
...
class ModuleAutoGenerated(TrackedResource):  # pylint: disable=too-many-instance-attributes
    """Definition of the module type.
...
class ModuleListResultAutoGenerated(_serialization.Model):
    """The response model for the list module operation.

    :ivar value: Gets or sets a list of modules.
    :vartype value: list[~azure.mgmt.automation.models.ModuleAutoGenerated]
    :ivar next_link: Gets or sets the next link.
    :vartype next_link: str
    """

    _attribute_map = {
        "value": {"key": "value", "type": "[ModuleAutoGenerated]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.ModuleAutoGenerated"]] = None,
        next_link: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword value: Gets or sets a list of modules.
        :paramtype value: list[~azure.mgmt.automation.models.ModuleAutoGenerated]
        :keyword next_link: Gets or sets the next link.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
