...
def build_list_by_location_request(location: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Automation/locations/{location}/usages"
    )  # pylint: disable=line-too-long
    path_format_arguments = {
...
class UsagesOperations:
    ...
    @distributed_trace
    def list_by_location(self, location: str, **kwargs: Any) -> Iterable["_models.UsageAutoGenerated"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.automation.models.UsageAutoGenerated]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
