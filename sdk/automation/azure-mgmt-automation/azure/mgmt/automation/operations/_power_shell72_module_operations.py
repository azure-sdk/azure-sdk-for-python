...
class PowerShell72ModuleOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, automation_account_name: str, **kwargs: Any) -> _models.ModuleAutoGenerated:
        ...
        :type automation_account_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ModuleAutoGenerated or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.ModuleAutoGenerated
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2023-11-01"))
        cls: ClsType[_models.ModuleAutoGenerated] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("ModuleAutoGenerated", pipeline_response)
    ...
    def list_by_automation_account(
        self, resource_group_name: str, automation_account_name: str, **kwargs: Any
    ) -> Iterable["_models.ModuleAutoGenerated"]:
        ...
        :type automation_account_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ModuleAutoGenerated or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.automation.models.ModuleAutoGenerated]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2023-11-01"))
        cls: ClsType[_models.ModuleListResultAutoGenerated] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("ModuleListResultAutoGenerated", pipeline_response)
