...
from ...operations._usages_operations import build_list_by_automation_account_request, build_list_by_location_request
...
class UsagesOperations:
    ...
    @distributed_trace
    def list_by_location(self, location: str, **kwargs: Any) -> AsyncIterable["_models.UsageAutoGenerated"]:
        """Retrieve the usage for the location.

        .. seealso::
           - http://aka.ms/azureautomationsdk/getUsagesOfLocation

        :param location: The name of the Azure region. Required.
        :type location: str
        :return: An iterator like instance of either UsageAutoGenerated or the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.automation.models.UsageAutoGenerated]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        cls: ClsType[_models.UsageListResultAutoGenerated] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("UsageListResultAutoGenerated", pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return None, AsyncList(list_of_elem)
