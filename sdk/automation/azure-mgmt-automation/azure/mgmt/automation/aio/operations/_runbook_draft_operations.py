...
from ...operations._runbook_draft_operations import (
    build_get_content_request,
    build_get_request,
    build_replace_content_request,
    build_undo_edit_request,
)
...
class RunbookDraftOperations:
    ...
    async def begin_replace_content(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either AsyncIterator[bytes] or the result
         of cls(response)
        ...
        if cont_token:
            return AsyncLROPoller[AsyncIterator[bytes]].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[AsyncIterator[bytes]](
