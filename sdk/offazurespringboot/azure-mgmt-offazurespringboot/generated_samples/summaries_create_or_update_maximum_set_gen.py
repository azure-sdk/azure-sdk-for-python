...
# USAGE
    python summaries_create_or_update_maximum_set_gen.py
...
def main():
    ...
    response = client.summaries.create_or_update(
        resource_group_name="rgspringbootdiscovery",
        body={"properties": {"discoveredApps": 24, "discoveredServers": 22}, "tags": {"key9287": "utoxkd"}},
    )
    print(response)
