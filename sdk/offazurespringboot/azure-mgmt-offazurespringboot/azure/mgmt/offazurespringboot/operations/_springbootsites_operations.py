...
def build_get_request(
    resource_group_name: str, subscription_id: str, springbootsites_name: str, **kwargs: Any
) -> HttpRequest:
    ...
    path_format_arguments = {
        ...
        "springbootsitesName": _SERIALIZER.url(
            "springbootsites_name", springbootsites_name, "str", max_length=64, min_length=3
        ),
    }
...
class SpringbootsitesOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, **kwargs: Any) -> _models.SpringbootsitesModel:
        ...
        :rtype: ~azure.mgmt.offazurespringboot.models.SpringbootsitesModel
        ...
        request = build_get_request(
            ...
            springbootsites_name=self._config.springbootsites_name,
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type springbootsites: ~azure.mgmt.offazurespringboot.models.SpringbootsitesModel
    ...
    @overload
    def create_or_update(
        self, resource_group_name: str, springbootsites: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.SpringbootsitesModel:
        """Create a springbootsites resource.
    ...
    @distributed_trace
    def create_or_update(
        self, resource_group_name: str, springbootsites: Union[_models.SpringbootsitesModel, IO], **kwargs: Any
    ) -> _models.SpringbootsitesModel:
        """Create a springbootsites resource.
        ...
        :type springbootsites: ~azure.mgmt.offazurespringboot.models.SpringbootsitesModel or IO
    ...
    @distributed_trace
    def delete(self, resource_group_name: str, **kwargs: Any) -> Optional[_models.SpringbootsitesModel]:
        ...
        :type resource_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SpringbootsitesModel or None or the result of cls(response)
        :rtype: ~azure.mgmt.offazurespringboot.models.SpringbootsitesModel or None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[Optional[_models.SpringbootsitesModel]] = kwargs.pop("cls", None)
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type springbootsites: ~azure.mgmt.offazurespringboot.models.SpringbootsitesPatch
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    @distributed_trace
    def update(
        self, resource_group_name: str, springbootsites: Union[_models.SpringbootsitesPatch, IO], **kwargs: Any
    ) -> _models.SpringbootsitesModel:
        """Update a springbootsites resource.
        ...
        :param springbootsites: Update a springbootsites payload. Is either a SpringbootsitesPatch type
         or a IO type. Required.
        :type springbootsites: ~azure.mgmt.offazurespringboot.models.SpringbootsitesPatch or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    @distributed_trace
    def begin_trigger_refresh_site(self, resource_group_name: str, **kwargs: Any) -> LROPoller[None]:
    ...
    def list_by_resource_group(
        ...
        :return: An iterator like instance of either SpringbootsitesModel or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.offazurespringboot.models.SpringbootsitesModel]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
