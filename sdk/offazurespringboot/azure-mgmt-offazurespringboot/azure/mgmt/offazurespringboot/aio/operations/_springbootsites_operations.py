...
class SpringbootsitesOperations:
    ...
    async def get(self, resource_group_name: str, **kwargs: Any) -> _models.SpringbootsitesModel:
    ...
    @distributed_trace_async
    async def delete(self, resource_group_name: str, **kwargs: Any) -> Optional[_models.SpringbootsitesModel]:
    ...
    @distributed_trace_async
    async def begin_trigger_refresh_site(self, resource_group_name: str, **kwargs: Any) -> AsyncLROPoller[None]:
    ...
    def list_by_resource_group(
        ...
        :return: An iterator like instance of either SpringbootsitesModel or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.offazurespringboot.models.SpringbootsitesModel]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
