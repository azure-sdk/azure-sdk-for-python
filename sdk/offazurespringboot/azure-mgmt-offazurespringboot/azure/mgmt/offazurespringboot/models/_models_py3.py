...
class ErrorDetail(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.offazurespringboot.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info: list[~azure.mgmt.offazurespringboot.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(_serialization.Model):
    ...
    :vartype error: ~azure.mgmt.offazurespringboot.models.ErrorDetail
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetail"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~azure.mgmt.offazurespringboot.models.ErrorDetail
        """
        super().__init__(**kwargs)
        self.error = error
...
class ErrorSummariesProperties(_serialization.Model):
    ...
    :vartype discovery_scope_error_summaries:
     list[~azure.mgmt.offazurespringboot.models.ErrorSummaryModel]
    :ivar errors: The list of errors.
    :vartype errors: list[~azure.mgmt.offazurespringboot.models.Error]
    ...
    :vartype provisioning_state: str or ~azure.mgmt.offazurespringboot.models.ProvisioningState
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype errors: list[~azure.mgmt.offazurespringboot.models.Error]
        :keyword provisioning_state: The resource provisioning state. Known values are: "Unknown",
         "Succeeded", "Failed", "Canceled", "Accepted", "Provisioning", and "Deleting".
        :paramtype provisioning_state: str or ~azure.mgmt.offazurespringboot.models.ProvisioningState
        """
        super().__init__(**kwargs)
...
class ErrorSummariesResourcePatch(_serialization.Model):
    ...
    :vartype properties: ~azure.mgmt.offazurespringboot.models.ErrorSummariesProperties
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype properties: ~azure.mgmt.offazurespringboot.models.ErrorSummariesProperties
        """
        super().__init__(**kwargs)
        self.tags = tags
...
class Resource(_serialization.Model):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.offazurespringboot.models.SystemData
    """
...
class ErrorSummaryList(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.offazurespringboot.models.ErrorSummary]
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.offazurespringboot.models.ErrorSummary]
...
class ResourceProviderOperation(_serialization.Model):
    ...
    :vartype display: ~azure.mgmt.offazurespringboot.models.ResourceProviderOperationDisplay
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype display: ~azure.mgmt.offazurespringboot.models.ResourceProviderOperationDisplay
        """
        super().__init__(**kwargs)
...
class ResourceProviderOperationList(_serialization.Model):
    ...
    :ivar value: The resource provider operation list.
    :vartype value: list[~azure.mgmt.offazurespringboot.models.ResourceProviderOperation]
    :ivar next_link: The link used to get the next page of resource operation list.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword value: The resource provider operation list.
        :paramtype value: list[~azure.mgmt.offazurespringboot.models.ResourceProviderOperation]
        :keyword next_link: The link used to get the next page of resource operation list.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
        self.value = value
...
class SpringbootappsListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.offazurespringboot.models.SpringbootappsModel]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype value: list[~azure.mgmt.offazurespringboot.models.SpringbootappsModel]
...
class SpringbootappsModel(ProxyResource):
    ...
    :vartype properties: ~azure.mgmt.offazurespringboot.models.SpringbootappsProperties
    """
    ...
    def __init__(self, *, properties: Optional["_models.SpringbootappsProperties"] = None, **kwargs: Any) -> None:
        ...
        :paramtype properties: ~azure.mgmt.offazurespringboot.models.SpringbootappsProperties
        """
        super().__init__(**kwargs)
        self.properties = properties
...
class SpringbootappsProperties(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype application_configurations:
     list[~azure.mgmt.offazurespringboot.models.SpringbootappsPropertiesApplicationConfigurationsItem]
    ...
    :vartype miscs: list[~azure.mgmt.offazurespringboot.models.SpringbootappsPropertiesMiscsItem]
    :ivar instances: The breakdown info for app instances on all the servers.
    :vartype instances:
     list[~azure.mgmt.offazurespringboot.models.SpringbootappsPropertiesInstancesItem]
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :paramtype miscs: list[~azure.mgmt.offazurespringboot.models.SpringbootappsPropertiesMiscsItem]
...
class SpringbootserversListResult(_serialization.Model):
    ...
    :ivar value: The springbootsites list.
    :vartype value: list[~azure.mgmt.offazurespringboot.models.SpringbootserversModel]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword value: The springbootsites list.
        :paramtype value: list[~azure.mgmt.offazurespringboot.models.SpringbootserversModel]
...
class SpringbootserversModel(ProxyResource):
    ...
    :vartype properties: ~azure.mgmt.offazurespringboot.models.SpringbootserversProperties
    """
    ...
    def __init__(self, *, properties: Optional["_models.SpringbootserversProperties"] = None, **kwargs: Any) -> None:
        ...
        :paramtype properties: ~azure.mgmt.offazurespringboot.models.SpringbootserversProperties
        """
        super().__init__(**kwargs)
        self.properties = properties
...
class SpringbootsitesListResult(_serialization.Model):
    ...
    :ivar value: The springbootsites list.
    :vartype value: list[~azure.mgmt.offazurespringboot.models.SpringbootsitesModel]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword value: The springbootsites list.
        :paramtype value: list[~azure.mgmt.offazurespringboot.models.SpringbootsitesModel]
...
class SpringbootsitesModel(TrackedResource):
    ...
    :vartype location: str
    :ivar properties: The springbootsites resource definition.
    :vartype properties: ~azure.mgmt.offazurespringboot.models.SpringbootsitesProperties
    :ivar extended_location: The extended location definition.
    :vartype extended_location:
     ~azure.mgmt.offazurespringboot.models.SpringbootsitesModelExtendedLocation
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype location: str
        :keyword properties: The springbootsites resource definition.
        :paramtype properties: ~azure.mgmt.offazurespringboot.models.SpringbootsitesProperties
...
class SummariesResourcePatch(_serialization.Model):
    ...
    :vartype properties: ~azure.mgmt.offazurespringboot.models.SummariesProperties
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype properties: ~azure.mgmt.offazurespringboot.models.SummariesProperties
        """
        super().__init__(**kwargs)
        self.tags = tags
        self.properties = properties
...
class SummaryList(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.offazurespringboot.models.Summary]
    :ivar next_link: Url to follow for getting next page of resources.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.offazurespringboot.models.Summary]
        :keyword next_link: Url to follow for getting next page of resources.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class SystemData(_serialization.Model):
    ...
    :vartype created_by_type: str or ~azure.mgmt.offazurespringboot.models.CreatedByType
    ...
    :vartype last_modified_by_type: str or ~azure.mgmt.offazurespringboot.models.CreatedByType
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword created_by_type: The type of identity that created the resource. Known values are:
         "User", "Application", "ManagedIdentity", and "Key".
        :paramtype created_by_type: str or ~azure.mgmt.offazurespringboot.models.CreatedByType
        ...
        :paramtype last_modified_by_type: str or ~azure.mgmt.offazurespringboot.models.CreatedByType
