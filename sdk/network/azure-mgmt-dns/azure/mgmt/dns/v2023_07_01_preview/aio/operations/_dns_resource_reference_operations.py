...
class DnsResourceReferenceOperations:
    ...
    async def get_by_target_resources(
        self, body: _models.DnsResourceReferenceRequest, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.DnsResourceReferenceResult:
        """Returns the DNS records specified by the referencing targetResourceIds.

        :param body: The request body. Required.
        :type body: ~azure.mgmt.dns.v2023_07_01_preview.models.DnsResourceReferenceRequest
    ...
    async def get_by_target_resources(
        self, body: Union[_models.DnsResourceReferenceRequest, IO[bytes]], **kwargs: Any
    ) -> _models.DnsResourceReferenceResult:
        """Returns the DNS records specified by the referencing targetResourceIds.

        :param body: The request body. Is either a DnsResourceReferenceRequest type or a IO[bytes]
         type. Required.
        :type body: ~azure.mgmt.dns.v2023_07_01_preview.models.DnsResourceReferenceRequest or IO[bytes]
        :return: DnsResourceReferenceResult or the result of cls(response)
        :rtype: ~azure.mgmt.dns.v2023_07_01_preview.models.DnsResourceReferenceResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "DnsResourceReferenceRequest")
