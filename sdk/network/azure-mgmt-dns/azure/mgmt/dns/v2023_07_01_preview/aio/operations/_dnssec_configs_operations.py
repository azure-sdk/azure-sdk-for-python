...
class DnssecConfigsOperations:
    ...
    async def _create_or_update_initial(
        ...
        zone_name: str,
        resource: Union[_models.DnssecConfig, IO[bytes]],
        ...
        **kwargs: Any
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "DnssecConfig")
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.dns.v2023_07_01_preview.models.DnssecConfig
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param zone_name: The name of the DNS zone (without a terminating dot). Required.
        :type zone_name: str
        :param resource: Resource create parameters. Is either a DnssecConfig type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.dns.v2023_07_01_preview.models.DnssecConfig or IO[bytes]
        :param if_match: The etag of the DNSSEC configuration. Omit this value to always overwrite the
         DNSSEC configuration. Specify the last-seen etag value to prevent accidentally overwriting any
         concurrent changes. Default value is None.
        :type if_match: str
