...
def build_list_by_type_request(
    ...
    **kwargs: Any
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}/{recordType}/{recordType}",
    )
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}/{recordType}/{relativeRecordSetName}/{recordType}",
    )
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
        "resourceGroupName": _SERIALIZER.url(
        ...
        "privateZoneName": _SERIALIZER.url("private_zone_name", private_zone_name, "str"),
        "relativeRecordSetName": _SERIALIZER.url("relative_record_set_name", relative_record_set_name, "str"),
        "recordType": _SERIALIZER.url("record_type", record_type, "str"),
    }
