...
class TestNetworkManagementLoadBalancersOperations(AzureMgmtRecordedTestCase):
                ...
                "outboundRules": [
                    {
                        ...
                        "enableTcpReset": bool,
                        "etag": "str",
                        "frontendIPConfigurations": [{"id": "str"}],
                        "id": "str",
                        "idleTimeoutInMinutes": 0,
                        "name": "str",
                        "protocol": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_load_balancers_update_tags(self, resource_group):
        response = self.client.load_balancers.update_tags(
            resource_group_name=resource_group.name,
            load_balancer_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_load_balancers_begin_swap_public_ip_addresses(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_load_balancers_begin_list_inbound_nat_rule_port_mappings(self, resource_group):
        response = self.client.load_balancers.begin_list_inbound_nat_rule_port_mappings(
            group_name="str",
            load_balancer_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_load_balancers_migrate_to_ip_based(self, resource_group):
