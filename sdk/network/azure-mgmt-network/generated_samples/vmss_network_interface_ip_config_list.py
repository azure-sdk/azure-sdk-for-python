...
# USAGE
    python vmss_network_interface_ip_config_list.py
...
def main():
    ...
    response = client.network_interfaces.list_virtual_machine_scale_set_ip_configurations(
        resource_group_name="rg1",
        virtual_machine_scale_set_name="vmss1",
        virtualmachine_index="2",
