...
class LiveMetricsClientConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long
    """Configuration for LiveMetricsClient.

    Note that all parameters used to create this instance are saved as instance
    attributes.

    :param endpoint: The endpoint of the Live Metrics service. Required.
    :type endpoint: str
    ...
    def __init__(self, endpoint: str, credential: "TokenCredential", **kwargs: Any) -> None:
        ...
        kwargs.setdefault("sdk_moniker", "livemetrics/{}".format(VERSION))
