...
from azure.mgmt.informaticadatamanagement import InformaticaDataManagement
...
def main():
    client = InformaticaDataManagement(
    ...
    client.serverless_runtimes.begin_delete(
        ...
        serverless_runtime_name="serverlessRuntimeName",
    ).result()
