...
from ._configuration import InformaticaDataManagementConfiguration
...
class InformaticaDataManagement:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = InformaticaDataManagementConfiguration(
    ...
    async def __aenter__(self) -> "InformaticaDataManagement":
