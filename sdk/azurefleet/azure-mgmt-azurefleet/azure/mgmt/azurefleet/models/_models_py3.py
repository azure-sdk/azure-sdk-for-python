...
class AdditionalUnattendContent(_serialization.Model):
    ...
    :ivar setting_name: Specifies the name of the setting to which the content applies. Possible
     ...
     "FirstLogonCommands".
    :vartype setting_name: str or ~azure.mgmt.azurefleet.models.SettingNames
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword setting_name: Specifies the name of the setting to which the content applies. Possible
         values are: FirstLogonCommands and AutoLogon. Known values are: "AutoLogon" and
         "FirstLogonCommands".
        :paramtype setting_name: str or ~azure.mgmt.azurefleet.models.SettingNames
...
class ApiError(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.azurefleet.models.ApiErrorBase]
    :ivar innererror: The Api inner error.
    :vartype innererror: ~azure.mgmt.azurefleet.models.InnerError
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype details: list[~azure.mgmt.azurefleet.models.ApiErrorBase]
        :keyword innererror: The Api inner error.
        :paramtype innererror: ~azure.mgmt.azurefleet.models.InnerError
...
class ApplicationProfile(_serialization.Model):
    ...
    :ivar gallery_applications: Specifies the gallery applications that should be made available to
     the VM/VMSS.
    :vartype gallery_applications: list[~azure.mgmt.azurefleet.models.VMGalleryApplication]
    """
    ...
    def __init__(
        ...
        :keyword gallery_applications: Specifies the gallery applications that should be made available
         to the VM/VMSS.
        :paramtype gallery_applications: list[~azure.mgmt.azurefleet.models.VMGalleryApplication]
        """
        super().__init__(**kwargs)
        self.gallery_applications = gallery_applications


class AzureResourceManagerFoundationsUserAssignedIdentity(_serialization.Model):  # pylint: disable=name-too-long
...
class CapacityReservationProfile(_serialization.Model):
    ...
    :ivar capacity_reservation_group: Specifies the capacity reservation group resource id that
     ...
     details.
    :vartype capacity_reservation_group: ~azure.mgmt.azurefleet.models.SubResource
    """
    ...
    def __init__(self, *, capacity_reservation_group: Optional["_models.SubResource"] = None, **kwargs: Any) -> None:
        ...
        :keyword capacity_reservation_group: Specifies the capacity reservation group resource id that
         ...
         capacity has been reserved. Please refer to https://aka.ms/CapacityReservation for more
         details.
        :paramtype capacity_reservation_group: ~azure.mgmt.azurefleet.models.SubResource
        """
        super().__init__(**kwargs)
...
class ComputeProfile(_serialization.Model):
    ...
    :vartype base_virtual_machine_profile:
     ~azure.mgmt.azurefleet.models.VirtualMachineScaleSetVMProfile
...
class DiagnosticsProfile(_serialization.Model):
    ...
    :vartype boot_diagnostics: ~azure.mgmt.azurefleet.models.BootDiagnostics
    """
    ...
    def __init__(self, *, boot_diagnostics: Optional["_models.BootDiagnostics"] = None, **kwargs: Any) -> None:
        ...
        :keyword boot_diagnostics: Boot Diagnostics is a debugging feature which allows you to view
         ...
         VM. You can easily view the output of your console log. Azure also enables you to see a
         screenshot of the VM from the hypervisor.
        :paramtype boot_diagnostics: ~azure.mgmt.azurefleet.models.BootDiagnostics
        """
        super().__init__(**kwargs)
...
class DiffDiskSettings(_serialization.Model):
    ...
    :vartype option: str or ~azure.mgmt.azurefleet.models.DiffDiskOptions
    ...
    :vartype placement: str or ~azure.mgmt.azurefleet.models.DiffDiskPlacement
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype option: str or ~azure.mgmt.azurefleet.models.DiffDiskOptions
        :keyword placement: Specifies the ephemeral disk placement for operating system disk. Possible
         ...
         and Linux VM at https://docs.microsoft.com/azure/virtual-machines/linux/sizes to check which VM
         sizes exposes a cache disk. Known values are: "CacheDisk" and "ResourceDisk".
        :paramtype placement: str or ~azure.mgmt.azurefleet.models.DiffDiskPlacement
        """
        super().__init__(**kwargs)
        self.option = option
...
class ErrorDetail(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.azurefleet.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info: list[~azure.mgmt.azurefleet.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(_serialization.Model):
    ...
    :vartype error: ~azure.mgmt.azurefleet.models.ErrorDetail
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetail"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~azure.mgmt.azurefleet.models.ErrorDetail
        """
        super().__init__(**kwargs)
        self.error = error
...
class Resource(_serialization.Model):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.azurefleet.models.SystemData
    """
...
class Fleet(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype identity: ~azure.mgmt.azurefleet.models.ManagedServiceIdentity
    :ivar plan: Details of the resource plan.
    :vartype plan: ~azure.mgmt.azurefleet.models.Plan
    :ivar provisioning_state: The status of the last operation. Known values are: "Succeeded",
     "Failed", "Canceled", "Creating", "Updating", "Deleting", and "Migrating".
    :vartype provisioning_state: str or ~azure.mgmt.azurefleet.models.ProvisioningState
    :ivar spot_priority_profile: Configuration Options for Spot instances in Compute Fleet.
    :vartype spot_priority_profile: ~azure.mgmt.azurefleet.models.SpotPriorityProfile
    :ivar regular_priority_profile: Configuration Options for Regular instances in Compute Fleet.
    :vartype regular_priority_profile: ~azure.mgmt.azurefleet.models.RegularPriorityProfile
    :ivar vm_sizes_profile: List of VM sizes supported for Compute Fleet.
    :vartype vm_sizes_profile: list[~azure.mgmt.azurefleet.models.VmSizeProfile]
    :ivar compute_profile: Compute Profile to use for running user's workloads.
    :vartype compute_profile: ~azure.mgmt.azurefleet.models.ComputeProfile
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype identity: ~azure.mgmt.azurefleet.models.ManagedServiceIdentity
        :keyword plan: Details of the resource plan.
        :paramtype plan: ~azure.mgmt.azurefleet.models.Plan
        :keyword spot_priority_profile: Configuration Options for Spot instances in Compute Fleet.
        :paramtype spot_priority_profile: ~azure.mgmt.azurefleet.models.SpotPriorityProfile
        :keyword regular_priority_profile: Configuration Options for Regular instances in Compute
         Fleet.
        :paramtype regular_priority_profile: ~azure.mgmt.azurefleet.models.RegularPriorityProfile
        :keyword vm_sizes_profile: List of VM sizes supported for Compute Fleet.
        :paramtype vm_sizes_profile: list[~azure.mgmt.azurefleet.models.VmSizeProfile]
        :keyword compute_profile: Compute Profile to use for running user's workloads.
        :paramtype compute_profile: ~azure.mgmt.azurefleet.models.ComputeProfile
        """
...
class FleetListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.azurefleet.models.Fleet]
    ...
    def __init__(self, *, value: List["_models.Fleet"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.azurefleet.models.Fleet]
...
class FleetPropertiesUpdate(_serialization.Model):
    ...
    :vartype vm_sizes_profile: list[~azure.mgmt.azurefleet.models.VmSizeProfile]
    :ivar compute_profile: Compute Profile to use for running user's workloads.
    :vartype compute_profile: ~azure.mgmt.azurefleet.models.ComputeProfileUpdate
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype vm_sizes_profile: list[~azure.mgmt.azurefleet.models.VmSizeProfile]
        :keyword compute_profile: Compute Profile to use for running user's workloads.
        :paramtype compute_profile: ~azure.mgmt.azurefleet.models.ComputeProfileUpdate
        """
        super().__init__(**kwargs)
        self.spot_priority_profile = spot_priority_profile
        self.regular_priority_profile = regular_priority_profile
...
class FleetUpdate(_serialization.Model):
    ...
    :vartype identity: ~azure.mgmt.azurefleet.models.ManagedServiceIdentityUpdate
    :ivar plan: Updatable resource plan.
    :vartype plan: ~azure.mgmt.azurefleet.models.ResourcePlanUpdate
    :ivar properties: RP-specific updatable properties.
    :vartype properties: ~azure.mgmt.azurefleet.models.FleetPropertiesUpdate
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype identity: ~azure.mgmt.azurefleet.models.ManagedServiceIdentityUpdate
        :keyword plan: Updatable resource plan.
        :paramtype plan: ~azure.mgmt.azurefleet.models.ResourcePlanUpdate
        :keyword properties: RP-specific updatable properties.
        :paramtype properties: ~azure.mgmt.azurefleet.models.FleetPropertiesUpdate
        """
        super().__init__(**kwargs)
        self.tags = tags
        self.identity = identity
...
class InstanceViewStatus(_serialization.Model):
    ...
    :vartype level: str or ~azure.mgmt.azurefleet.models.StatusLevelTypes
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype level: str or ~azure.mgmt.azurefleet.models.StatusLevelTypes
...
class KeyVaultSecretReference(_serialization.Model):
    ...
    :vartype source_vault: ~azure.mgmt.azurefleet.models.SubResource
    """
    ...
    def __init__(self, *, secret_url: str, source_vault: "_models.SubResource", **kwargs: Any) -> None:
        ...
        :paramtype source_vault: ~azure.mgmt.azurefleet.models.SubResource
        """
        super().__init__(**kwargs)
...
class LinuxConfiguration(_serialization.Model):
    ...
    :vartype ssh: ~azure.mgmt.azurefleet.models.SshConfiguration
    ...
    :ivar patch_settings: [Preview Feature] Specifies settings related to VM Guest Patching on
     Linux.
    :vartype patch_settings: ~azure.mgmt.azurefleet.models.LinuxPatchSettings
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype ssh: ~azure.mgmt.azurefleet.models.SshConfiguration
        ...
        :keyword patch_settings: [Preview Feature] Specifies settings related to VM Guest Patching on
         Linux.
        :paramtype patch_settings: ~azure.mgmt.azurefleet.models.LinuxPatchSettings
...
class LinuxPatchSettings(_serialization.Model):
     ...
     **AutomaticByPlatform** - The virtual machine will be automatically updated by the platform.
     ...
     "AutomaticByPlatform".
    :vartype patch_mode: str or ~azure.mgmt.azurefleet.models.LinuxVMGuestPatchMode
     ...
     **ImageDefault** - You control the timing of patch assessments on a virtual machine. :code:`<br
     ...
     "AutomaticByPlatform".
    :vartype assessment_mode: str or ~azure.mgmt.azurefleet.models.LinuxPatchAssessmentMode
    ...
    :vartype automatic_by_platform_settings:
     ~azure.mgmt.azurefleet.models.LinuxVMGuestPatchAutomaticByPlatformSettings
    """
    ...
    def __init__(
        ...
        **kwargs: Any
         ...
         **AutomaticByPlatform** - The virtual machine will be automatically updated by the platform.
         The property provisionVMAgent must be true. Known values are: "ImageDefault" and
         "AutomaticByPlatform".
        :paramtype patch_mode: str or ~azure.mgmt.azurefleet.models.LinuxVMGuestPatchMode
         ...
         **ImageDefault** - You control the timing of patch assessments on a virtual machine. :code:`<br
         ...
         assessments. The property provisionVMAgent must be true. Known values are: "ImageDefault" and
         "AutomaticByPlatform".
        :paramtype assessment_mode: str or ~azure.mgmt.azurefleet.models.LinuxPatchAssessmentMode
...
class LinuxVMGuestPatchAutomaticByPlatformSettings(_serialization.Model):  # pylint: disable=name-too-long
    ...
    :vartype reboot_setting: str or
     ~azure.mgmt.azurefleet.models.LinuxVMGuestPatchAutomaticByPlatformRebootSetting
...
class ManagedServiceIdentity(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.azurefleet.models.ManagedServiceIdentityType
    :ivar user_assigned_identities: The set of user assigned identities associated with the
     resource. The userAssignedIdentities dictionary keys will be ARM resource ids in the form:
     '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}.  # pylint: disable=line-too-long
     The dictionary values can be empty objects ({}) in requests.
    :vartype user_assigned_identities: dict[str,
     ~azure.mgmt.azurefleet.models.UserAssignedIdentity]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: Type of managed service identity (where both SystemAssigned and UserAssigned
         ...
         "SystemAssigned,UserAssigned", and "SystemAssigned, UserAssigned".
        :paramtype type: str or ~azure.mgmt.azurefleet.models.ManagedServiceIdentityType
...
class ManagedServiceIdentityUpdate(_serialization.Model):
    ...
    :vartype user_assigned_identities: dict[str,
     ~azure.mgmt.azurefleet.models.AzureResourceManagerFoundationsUserAssignedIdentity]
    """
    ...
    _attribute_map = {
        ...
        "user_assigned_identities": {
            ...
            "type": "{AzureResourceManagerFoundationsUserAssignedIdentity}",
        },
    }
    ...
    def __init__(
        ...
        *,
        ...
        user_assigned_identities: Optional[
            Dict[str, "_models.AzureResourceManagerFoundationsUserAssignedIdentity"]
        ] = None,
        **kwargs: Any
    ) -> None:
        """
...
class Operation(_serialization.Model):
    ...
    :vartype display: ~azure.mgmt.azurefleet.models.OperationDisplay
    :ivar origin: The intended executor of the operation; as in Resource Based Access Control
     (RBAC) and audit logs UX. Default value is "user,system". Known values are: "user", "system",
     and "user,system".
    :vartype origin: str or ~azure.mgmt.azurefleet.models.Origin
    :ivar action_type: Enum. Indicates the action type. "Internal" refers to actions that are for
     internal only APIs. "Internal"
    :vartype action_type: str or ~azure.mgmt.azurefleet.models.ActionType
    """
    ...
    def __init__(self, *, display: Optional["_models.OperationDisplay"] = None, **kwargs: Any) -> None:
        ...
        :paramtype display: ~azure.mgmt.azurefleet.models.OperationDisplay
        """
        super().__init__(**kwargs)
        self.name = None
...
class OperationListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.azurefleet.models.Operation]
...
class PatchSettings(_serialization.Model):
    ...
    :vartype patch_mode: str or ~azure.mgmt.azurefleet.models.WindowsVMGuestPatchMode
     ...
     **ImageDefault** - You control the timing of patch assessments on a virtual machine.:code:`<br
     ...
     assessments. The property provisionVMAgent must be true. Known values are: "ImageDefault" and
     "AutomaticByPlatform".
    :vartype assessment_mode: str or ~azure.mgmt.azurefleet.models.WindowsPatchAssessmentMode
    :ivar automatic_by_platform_settings: Specifies additional settings for patch mode
     AutomaticByPlatform in VM Guest Patching on Windows.
    :vartype automatic_by_platform_settings:
     ~azure.mgmt.azurefleet.models.WindowsVMGuestPatchAutomaticByPlatformSettings
    """
    ...
    def __init__(
        ...
        **kwargs: Any
         ...
         **AutomaticByPlatform** - the virtual machine will automatically updated by the platform. The
         properties provisionVMAgent and WindowsConfiguration.enableAutomaticUpdates must be true. Known
         values are: "Manual", "AutomaticByOS", and "AutomaticByPlatform".
        :paramtype patch_mode: str or ~azure.mgmt.azurefleet.models.WindowsVMGuestPatchMode
         ...
         **ImageDefault** - You control the timing of patch assessments on a virtual machine.:code:`<br
         ...
         assessments. The property provisionVMAgent must be true. Known values are: "ImageDefault" and
         "AutomaticByPlatform".
        :paramtype assessment_mode: str or ~azure.mgmt.azurefleet.models.WindowsPatchAssessmentMode
        :keyword automatic_by_platform_settings: Specifies additional settings for patch mode
         AutomaticByPlatform in VM Guest Patching on Windows.
        :paramtype automatic_by_platform_settings:
         ~azure.mgmt.azurefleet.models.WindowsVMGuestPatchAutomaticByPlatformSettings
...
class ProxyAgentSettings(_serialization.Model):
    ...
    :vartype mode: str or ~azure.mgmt.azurefleet.models.Mode
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword mode: Specifies the mode that ProxyAgent will execute on if the feature is enabled.
         ...
         endpoints in Audit mode, while in Enforce mode it will enforce access control. The default
         value is Enforce mode. Known values are: "Audit" and "Enforce".
        :paramtype mode: str or ~azure.mgmt.azurefleet.models.Mode
...
class PublicIPAddressSku(_serialization.Model):
    ...
    :vartype name: str or ~azure.mgmt.azurefleet.models.PublicIPAddressSkuName
    :ivar tier: Specify public IP sku tier. Known values are: "Regional" and "Global".
    :vartype tier: str or ~azure.mgmt.azurefleet.models.PublicIPAddressSkuTier
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype name: str or ~azure.mgmt.azurefleet.models.PublicIPAddressSkuName
        :keyword tier: Specify public IP sku tier. Known values are: "Regional" and "Global".
        :paramtype tier: str or ~azure.mgmt.azurefleet.models.PublicIPAddressSkuTier
        """
        super().__init__(**kwargs)
        self.name = name
        self.tier = tier
...
class RegularPriorityProfile(_serialization.Model):
    ...
    :vartype allocation_strategy: str or
     ~azure.mgmt.azurefleet.models.RegularPriorityAllocationStrategy
    """
...
class ScheduledEventsProfile(_serialization.Model):
    ...
    :vartype terminate_notification_profile:
     ~azure.mgmt.azurefleet.models.TerminateNotificationProfile
    ...
    :vartype os_image_notification_profile:
     ~azure.mgmt.azurefleet.models.OSImageNotificationProfile
    """
...
class SecurityPostureReference(_serialization.Model):
    ...
    :ivar exclude_extensions: List of virtual machine extensions to exclude when applying the
     Security Posture.
    :vartype exclude_extensions: list[~azure.mgmt.azurefleet.models.VirtualMachineExtension]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword exclude_extensions: List of virtual machine extensions to exclude when applying the
         Security Posture.
        :paramtype exclude_extensions: list[~azure.mgmt.azurefleet.models.VirtualMachineExtension]
        """
        super().__init__(**kwargs)
        self.id = id
...
class SecurityProfile(_serialization.Model):
    ...
    :vartype uefi_settings: ~azure.mgmt.azurefleet.models.UefiSettings
    ...
    :vartype security_type: str or ~azure.mgmt.azurefleet.models.SecurityTypes
    :ivar encryption_identity: Specifies the Managed Identity used by ADE to get access token for
     keyvault operations.
    :vartype encryption_identity: ~azure.mgmt.azurefleet.models.EncryptionIdentity
    :ivar proxy_agent_settings: Specifies ProxyAgent settings while creating the virtual machine.
     Minimum api-version: 2023-09-01.
    :vartype proxy_agent_settings: ~azure.mgmt.azurefleet.models.ProxyAgentSettings
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword uefi_settings: Specifies the security settings like secure boot and vTPM used while
         creating the virtual machine. Minimum api-version: 2020-12-01.
        :paramtype uefi_settings: ~azure.mgmt.azurefleet.models.UefiSettings
        ...
        :keyword security_type: Specifies the SecurityType of the virtual machine. It has to be set to
         ...
         enabled unless this property is set. Known values are: "TrustedLaunch" and "ConfidentialVM".
        :paramtype security_type: str or ~azure.mgmt.azurefleet.models.SecurityTypes
        :keyword encryption_identity: Specifies the Managed Identity used by ADE to get access token
         for keyvault operations.
        :paramtype encryption_identity: ~azure.mgmt.azurefleet.models.EncryptionIdentity
        ...
        :paramtype proxy_agent_settings: ~azure.mgmt.azurefleet.models.ProxyAgentSettings
        """
        super().__init__(**kwargs)
...
class SpotPriorityProfile(_serialization.Model):
    ...
    :vartype eviction_policy: str or ~azure.mgmt.azurefleet.models.EvictionPolicy
    :ivar allocation_strategy: Allocation strategy to follow when determining the VM sizes
     distribution for Spot VMs. Known values are: "PriceCapacityOptimized", "LowestPrice", and
     "CapacityOptimized".
    :vartype allocation_strategy: str or ~azure.mgmt.azurefleet.models.SpotAllocationStrategy
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword eviction_policy: Eviction Policy to follow when evicting Spot VMs. Known values are:
         "Delete" and "Deallocate".
        :paramtype eviction_policy: str or ~azure.mgmt.azurefleet.models.EvictionPolicy
        :keyword allocation_strategy: Allocation strategy to follow when determining the VM sizes
         distribution for Spot VMs. Known values are: "PriceCapacityOptimized", "LowestPrice", and
         "CapacityOptimized".
        :paramtype allocation_strategy: str or ~azure.mgmt.azurefleet.models.SpotAllocationStrategy
...
class SshConfiguration(_serialization.Model):
    ...
    :vartype public_keys: list[~azure.mgmt.azurefleet.models.SshPublicKey]
    """
    ...
    def __init__(self, *, public_keys: Optional[List["_models.SshPublicKey"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype public_keys: list[~azure.mgmt.azurefleet.models.SshPublicKey]
        """
        super().__init__(**kwargs)
...
class SystemData(_serialization.Model):
    ...
    :vartype created_by_type: str or ~azure.mgmt.azurefleet.models.CreatedByType
    ...
    :vartype last_modified_by_type: str or ~azure.mgmt.azurefleet.models.CreatedByType
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword created_by_type: The type of identity that created the resource. Known values are:
         "User", "Application", "ManagedIdentity", and "Key".
        :paramtype created_by_type: str or ~azure.mgmt.azurefleet.models.CreatedByType
        ...
        :paramtype last_modified_by_type: str or ~azure.mgmt.azurefleet.models.CreatedByType
...
class VaultSecretGroup(_serialization.Model):
    ...
    :ivar vault_certificates: The list of key vault references in SourceVault which contain
     certificates.
    :vartype vault_certificates: list[~azure.mgmt.azurefleet.models.VaultCertificate]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword vault_certificates: The list of key vault references in SourceVault which contain
         certificates.
        :paramtype vault_certificates: list[~azure.mgmt.azurefleet.models.VaultCertificate]
        """
        super().__init__(**kwargs)
        self.source_vault = source_vault
...
class VirtualMachineExtension(ResourceWithOptionalLocation):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype instance_view: ~azure.mgmt.azurefleet.models.VirtualMachineExtensionInstanceView
    ...
    :vartype protected_settings_from_key_vault:
     ~azure.mgmt.azurefleet.models.KeyVaultSecretReference
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype instance_view: ~azure.mgmt.azurefleet.models.VirtualMachineExtensionInstanceView
...
class VirtualMachineExtensionInstanceView(_serialization.Model):
    ...
    :vartype substatuses: list[~azure.mgmt.azurefleet.models.InstanceViewStatus]
    :ivar statuses: The resource status information.
    :vartype statuses: list[~azure.mgmt.azurefleet.models.InstanceViewStatus]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype substatuses: list[~azure.mgmt.azurefleet.models.InstanceViewStatus]
        :keyword statuses: The resource status information.
        :paramtype statuses: list[~azure.mgmt.azurefleet.models.InstanceViewStatus]
        """
        super().__init__(**kwargs)
        self.name = name
        self.type = type
...
class VirtualMachineScaleSet(_serialization.Model):
    ...
    :vartype operation_status: str or ~azure.mgmt.azurefleet.models.ProvisioningState
    :ivar error: Error Information when ``operationStatus`` is ``Failed``.
    :vartype error: ~azure.mgmt.azurefleet.models.ApiError
    """
...
class VirtualMachineScaleSetDataDisk(_serialization.Model):
    ...
    :vartype caching: str or ~azure.mgmt.azurefleet.models.CachingTypes
    ...
    :ivar create_option: The create option. Required. Known values are: "FromImage", "Empty", and
     "Attach".
    :vartype create_option: str or ~azure.mgmt.azurefleet.models.DiskCreateOptionTypes
    ...
    :vartype managed_disk:
     ~azure.mgmt.azurefleet.models.VirtualMachineScaleSetManagedDiskParameters
    ...
    :vartype delete_option: str or ~azure.mgmt.azurefleet.models.DiskDeleteOptionTypes
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype caching: str or ~azure.mgmt.azurefleet.models.CachingTypes
        ...
        :keyword create_option: The create option. Required. Known values are: "FromImage", "Empty",
         and "Attach".
        :paramtype create_option: str or ~azure.mgmt.azurefleet.models.DiskCreateOptionTypes
        ...
        :keyword delete_option: Specifies whether data disk should be deleted or detached upon VMSS
         ...
         after VMSS Flex VM is deleted.:code:`<br>`:code:`<br>` The default value is set to **Delete**.
         Known values are: "Delete" and "Detach".
        :paramtype delete_option: str or ~azure.mgmt.azurefleet.models.DiskDeleteOptionTypes
        """
        super().__init__(**kwargs)
        self.name = name
        self.lun = lun
...
class VirtualMachineScaleSetExtensionProfile(_serialization.Model):
    ...
    :vartype extensions: list[~azure.mgmt.azurefleet.models.VirtualMachineScaleSetExtension]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype extensions: list[~azure.mgmt.azurefleet.models.VirtualMachineScaleSetExtension]
...
class VirtualMachineScaleSetHardwareProfile(_serialization.Model):
    ...
    :vartype vm_size_properties: ~azure.mgmt.azurefleet.models.VMSizeProperties
    """
    ...
    def __init__(self, *, vm_size_properties: Optional["_models.VMSizeProperties"] = None, **kwargs: Any) -> None:
        ...
        :keyword vm_size_properties: Specifies the properties for customizing the size of the virtual
         machine. Minimum api-version: 2021-11-01. Please follow the instructions in `VM Customization
         <https://aka.ms/vmcustomization>`_ for more details.
        :paramtype vm_size_properties: ~azure.mgmt.azurefleet.models.VMSizeProperties
        """
        super().__init__(**kwargs)
...
class VirtualMachineScaleSetIPConfiguration(_serialization.Model):
    ...
    :vartype subnet: ~azure.mgmt.azurefleet.models.ApiEntityReference
    ...
    :vartype public_ip_address_configuration:
     ~azure.mgmt.azurefleet.models.VirtualMachineScaleSetPublicIPAddressConfiguration
    ...
    :vartype private_ip_address_version: str or ~azure.mgmt.azurefleet.models.IPVersion
    ...
    :vartype application_gateway_backend_address_pools:
     list[~azure.mgmt.azurefleet.models.SubResource]
    :ivar application_security_groups: Specifies an array of references to application security
     group.
    :vartype application_security_groups: list[~azure.mgmt.azurefleet.models.SubResource]
    ...
    :vartype load_balancer_backend_address_pools: list[~azure.mgmt.azurefleet.models.SubResource]
    ...
    :vartype load_balancer_inbound_nat_pools: list[~azure.mgmt.azurefleet.models.SubResource]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype subnet: ~azure.mgmt.azurefleet.models.ApiEntityReference
        ...
        :paramtype private_ip_address_version: str or ~azure.mgmt.azurefleet.models.IPVersion
        ...
        :keyword application_security_groups: Specifies an array of references to application security
         group.
        :paramtype application_security_groups: list[~azure.mgmt.azurefleet.models.SubResource]
        :keyword load_balancer_backend_address_pools: Specifies an array of references to backend
         ...
         balancer.
        :paramtype load_balancer_backend_address_pools: list[~azure.mgmt.azurefleet.models.SubResource]
        :keyword load_balancer_inbound_nat_pools: Specifies an array of references to inbound Nat pools
         ...
         internal load balancer. Multiple scale sets cannot use the same basic sku load balancer.
        :paramtype load_balancer_inbound_nat_pools: list[~azure.mgmt.azurefleet.models.SubResource]
        """
        super().__init__(**kwargs)
        self.name = name
        self.subnet = subnet
...
class VirtualMachineScaleSetListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.azurefleet.models.VirtualMachineScaleSet]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.azurefleet.models.VirtualMachineScaleSet]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class VirtualMachineScaleSetManagedDiskParameters(_serialization.Model):  # pylint: disable=name-too-long
    ...
    :vartype storage_account_type: str or ~azure.mgmt.azurefleet.models.StorageAccountTypes
    :ivar disk_encryption_set: Specifies the customer managed disk encryption set resource id for
     the managed disk.
    :vartype disk_encryption_set: ~azure.mgmt.azurefleet.models.DiskEncryptionSetParameters
    :ivar security_profile: Specifies the security profile for the managed disk.
    :vartype security_profile: ~azure.mgmt.azurefleet.models.VMDiskSecurityProfile
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword storage_account_type: Specifies the storage account type for the managed disk. NOTE:
         ...
         are: "Standard_LRS", "Premium_LRS", "StandardSSD_LRS", "UltraSSD_LRS", "Premium_ZRS",
         "StandardSSD_ZRS", and "PremiumV2_LRS".
        :paramtype storage_account_type: str or ~azure.mgmt.azurefleet.models.StorageAccountTypes
        :keyword disk_encryption_set: Specifies the customer managed disk encryption set resource id
         for the managed disk.
        :paramtype disk_encryption_set: ~azure.mgmt.azurefleet.models.DiskEncryptionSetParameters
        :keyword security_profile: Specifies the security profile for the managed disk.
        :paramtype security_profile: ~azure.mgmt.azurefleet.models.VMDiskSecurityProfile
        """
        super().__init__(**kwargs)
...
class VirtualMachineScaleSetNetworkConfiguration(
    ...
    :vartype network_security_group: ~azure.mgmt.azurefleet.models.SubResource
    :ivar dns_settings: The dns settings to be applied on the network interfaces.
    :vartype dns_settings:
     ~azure.mgmt.azurefleet.models.VirtualMachineScaleSetNetworkConfigurationDnsSettings
    :ivar ip_configurations: Specifies the IP configurations of the network interface.
    :vartype ip_configurations:
     list[~azure.mgmt.azurefleet.models.VirtualMachineScaleSetIPConfiguration]
    ...
    :ivar delete_option: Specify what happens to the network interface when the VM is deleted.
     Known values are: "Delete" and "Detach".
    :vartype delete_option: str or ~azure.mgmt.azurefleet.models.DeleteOptions
    ...
    :vartype auxiliary_mode: str or ~azure.mgmt.azurefleet.models.NetworkInterfaceAuxiliaryMode
    ...
    :vartype auxiliary_sku: str or ~azure.mgmt.azurefleet.models.NetworkInterfaceAuxiliarySku
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype network_security_group: ~azure.mgmt.azurefleet.models.SubResource
        ...
        :keyword delete_option: Specify what happens to the network interface when the VM is deleted.
         Known values are: "Delete" and "Detach".
        :paramtype delete_option: str or ~azure.mgmt.azurefleet.models.DeleteOptions
        ...
        :paramtype auxiliary_mode: str or ~azure.mgmt.azurefleet.models.NetworkInterfaceAuxiliaryMode
        ...
        :paramtype auxiliary_sku: str or ~azure.mgmt.azurefleet.models.NetworkInterfaceAuxiliarySku
        """
        super().__init__(**kwargs)
        self.name = name
        self.primary = primary
...
class VirtualMachineScaleSetNetworkProfile(_serialization.Model):
    ...
    :vartype health_probe: ~azure.mgmt.azurefleet.models.ApiEntityReference
    :ivar network_interface_configurations: The list of network configurations.
    :vartype network_interface_configurations:
     list[~azure.mgmt.azurefleet.models.VirtualMachineScaleSetNetworkConfiguration]
    ...
    :vartype network_api_version: str or ~azure.mgmt.azurefleet.models.NetworkApiVersion
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword health_probe: A reference to a load balancer probe used to determine the health of an
         instance in the virtual machine scale set. The reference will be in the form:
         '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/probes/{probeName}'.  # pylint: disable=line-too-long
        :paramtype health_probe: ~azure.mgmt.azurefleet.models.ApiEntityReference
        ...
        :keyword network_api_version: specifies the Microsoft.Network API version used when creating
         networking resources in the Network Interface Configurations for Virtual Machine Scale Set with
         orchestration mode 'Flexible'. "2020-11-01"
        :paramtype network_api_version: str or ~azure.mgmt.azurefleet.models.NetworkApiVersion
        """
        super().__init__(**kwargs)
...
class VirtualMachineScaleSetOSDisk(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype diff_disk_settings: ~azure.mgmt.azurefleet.models.DiffDiskSettings
    :ivar disk_size_gb: Specifies the size of an empty data disk in gigabytes. This element can be
     used to overwrite the size of the disk in a virtual machine image. The property 'diskSizeGB' is
     the number of bytes x 1024^3 for the disk and the value cannot be larger than 1023.
    :vartype disk_size_gb: int
    ...
    :vartype os_type: str or ~azure.mgmt.azurefleet.models.OperatingSystemTypes
    :ivar image: Specifies information about the unmanaged user image to base the scale set on.
    :vartype image: ~azure.mgmt.azurefleet.models.VirtualHardDisk
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype diff_disk_settings: ~azure.mgmt.azurefleet.models.DiffDiskSettings
        :keyword disk_size_gb: Specifies the size of an empty data disk in gigabytes. This element can
         be used to overwrite the size of the disk in a virtual machine image. The property 'diskSizeGB'
         is the number of bytes x 1024^3 for the disk and the value cannot be larger than 1023.
        :paramtype disk_size_gb: int
        ...
        :paramtype os_type: str or ~azure.mgmt.azurefleet.models.OperatingSystemTypes
        :keyword image: Specifies information about the unmanaged user image to base the scale set on.
        :paramtype image: ~azure.mgmt.azurefleet.models.VirtualHardDisk
...
class VirtualMachineScaleSetOSProfile(_serialization.Model):
    ...
    :ivar windows_configuration: Specifies Windows operating system settings on the virtual
     machine.
    :vartype windows_configuration: ~azure.mgmt.azurefleet.models.WindowsConfiguration
    ...
    :vartype linux_configuration: ~azure.mgmt.azurefleet.models.LinuxConfiguration
    :ivar secrets: Specifies set of certificates that should be installed onto the virtual machines
     ...
     <https://docs.microsoft.com/azure/virtual-machines/extensions/key-vault-windows>`_.
    :vartype secrets: list[~azure.mgmt.azurefleet.models.VaultSecretGroup]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword windows_configuration: Specifies Windows operating system settings on the virtual
         machine.
        :paramtype windows_configuration: ~azure.mgmt.azurefleet.models.WindowsConfiguration
        :keyword linux_configuration: Specifies the Linux operating system settings on the virtual
         machine. For a list of supported Linux distributions, see `Linux on Azure-Endorsed
         Distributions <https://docs.microsoft.com/azure/virtual-machines/linux/endorsed-distros>`_.
        :paramtype linux_configuration: ~azure.mgmt.azurefleet.models.LinuxConfiguration
        :keyword secrets: Specifies set of certificates that should be installed onto the virtual
         ...
         Key Vault virtual machine extension for Windows
         <https://docs.microsoft.com/azure/virtual-machines/extensions/key-vault-windows>`_.
        :paramtype secrets: list[~azure.mgmt.azurefleet.models.VaultSecretGroup]
...
class VirtualMachineScaleSetPublicIPAddressConfiguration(_serialization.Model):  # pylint: disable=name-too-long
    ...
    :vartype sku: ~azure.mgmt.azurefleet.models.PublicIPAddressSku
    ...
    :vartype dns_settings:
     ~azure.mgmt.azurefleet.models.VirtualMachineScaleSetPublicIPAddressConfigurationDnsSettings
    :ivar ip_tags: The list of IP tags associated with the public IP address.
    :vartype ip_tags: list[~azure.mgmt.azurefleet.models.VirtualMachineScaleSetIpTag]
    :ivar public_ip_prefix: The PublicIPPrefix from which to allocate publicIP addresses.
    :vartype public_ip_prefix: ~azure.mgmt.azurefleet.models.SubResource
    ...
    :vartype public_ip_address_version: str or ~azure.mgmt.azurefleet.models.IPVersion
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword sku: Describes the public IP Sku. It can only be set with OrchestrationMode as
         Flexible.
        :paramtype sku: ~azure.mgmt.azurefleet.models.PublicIPAddressSku
        ...
        :paramtype ip_tags: list[~azure.mgmt.azurefleet.models.VirtualMachineScaleSetIpTag]
        :keyword public_ip_prefix: The PublicIPPrefix from which to allocate publicIP addresses.
        :paramtype public_ip_prefix: ~azure.mgmt.azurefleet.models.SubResource
        :keyword public_ip_address_version: Available from Api-Version 2019-07-01 onwards, it
         represents whether the specific ipconfiguration is IPv4 or IPv6. Default is taken as IPv4.
         Possible values are: 'IPv4' and 'IPv6'. Known values are: "IPv4" and "IPv6".
        :paramtype public_ip_address_version: str or ~azure.mgmt.azurefleet.models.IPVersion
...
class VirtualMachineScaleSetPublicIPAddressConfigurationDnsSettings(
    ...
    :vartype domain_name_label_scope: str or
     ~azure.mgmt.azurefleet.models.DomainNameLabelScopeTypes
    """
...
class VirtualMachineScaleSetStorageProfile(_serialization.Model):
    ...
    :vartype image_reference: ~azure.mgmt.azurefleet.models.ImageReference
    ...
    :vartype os_disk: ~azure.mgmt.azurefleet.models.VirtualMachineScaleSetOSDisk
    :ivar data_disks: Specifies the parameters that are used to add data disks to the virtual
     machines in the scale set. For more information about disks, see `About disks and VHDs for
     Azure virtual machines
     <https://docs.microsoft.com/azure/virtual-machines/managed-disks-overview>`_.
    :vartype data_disks: list[~azure.mgmt.azurefleet.models.VirtualMachineScaleSetDataDisk]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword image_reference: Specifies information about the image to use. You can specify
         ...
         is required when you want to use a platform image, marketplace image, or virtual machine image,
         but is not used in other creation operations.
        :paramtype image_reference: ~azure.mgmt.azurefleet.models.ImageReference
        :keyword os_disk: Specifies information about the operating system disk used by the virtual
         machines in the scale set. For more information about disks, see `About disks and VHDs for
         Azure virtual machines
         <https://docs.microsoft.com/azure/virtual-machines/managed-disks-overview>`_.
        :paramtype os_disk: ~azure.mgmt.azurefleet.models.VirtualMachineScaleSetOSDisk
        :keyword data_disks: Specifies the parameters that are used to add data disks to the virtual
         machines in the scale set. For more information about disks, see `About disks and VHDs for
         Azure virtual machines
         <https://docs.microsoft.com/azure/virtual-machines/managed-disks-overview>`_.
        :paramtype data_disks: list[~azure.mgmt.azurefleet.models.VirtualMachineScaleSetDataDisk]
...
class VirtualMachineScaleSetVMProfile(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype priority: str or ~azure.mgmt.azurefleet.models.VirtualMachinePriorityTypes
    ...
    :vartype eviction_policy: str or
     ~azure.mgmt.azurefleet.models.VirtualMachineEvictionPolicyTypes
    :ivar billing_profile: Specifies the billing related details of a Azure Spot VMSS. Minimum
     api-version: 2019-03-01.
    :vartype billing_profile: ~azure.mgmt.azurefleet.models.BillingProfile
    :ivar scheduled_events_profile: Specifies Scheduled Event related configurations.
    :vartype scheduled_events_profile: ~azure.mgmt.azurefleet.models.ScheduledEventsProfile
    ...
    :vartype capacity_reservation: ~azure.mgmt.azurefleet.models.CapacityReservationProfile
    :ivar application_profile: Specifies the gallery applications that should be made available to
     the VM/VMSS.
    :vartype application_profile: ~azure.mgmt.azurefleet.models.ApplicationProfile
    :ivar hardware_profile: Specifies the hardware profile related details of a scale set. Minimum
     api-version: 2021-11-01.
    :vartype hardware_profile: ~azure.mgmt.azurefleet.models.VirtualMachineScaleSetHardwareProfile
    ...
    :vartype service_artifact_reference: ~azure.mgmt.azurefleet.models.ServiceArtifactReference
    ...
    :vartype security_posture_reference: ~azure.mgmt.azurefleet.models.SecurityPostureReference
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword os_profile: Specifies the operating system settings for the virtual machines in the
         scale set.
        :paramtype os_profile: ~azure.mgmt.azurefleet.models.VirtualMachineScaleSetOSProfile
        :keyword storage_profile: Specifies the storage settings for the virtual machine disks.
        :paramtype storage_profile: ~azure.mgmt.azurefleet.models.VirtualMachineScaleSetStorageProfile
        :keyword network_profile: Specifies properties of the network interfaces of the virtual
         machines in the scale set.
        :paramtype network_profile: ~azure.mgmt.azurefleet.models.VirtualMachineScaleSetNetworkProfile
        :keyword security_profile: Specifies the Security related profile settings for the virtual
         machines in the scale set.
        :paramtype security_profile: ~azure.mgmt.azurefleet.models.SecurityProfile
        :keyword diagnostics_profile: Specifies the boot diagnostic settings state. Minimum
         api-version: 2015-06-15.
        :paramtype diagnostics_profile: ~azure.mgmt.azurefleet.models.DiagnosticsProfile
        ...
        :keyword priority: Specifies the priority for the virtual machines in the scale set. Minimum
         api-version: 2017-10-30-preview. Known values are: "Regular", "Low", and "Spot".
        :paramtype priority: str or ~azure.mgmt.azurefleet.models.VirtualMachinePriorityTypes
        ...
        :keyword billing_profile: Specifies the billing related details of a Azure Spot VMSS. Minimum
         api-version: 2019-03-01.
        :paramtype billing_profile: ~azure.mgmt.azurefleet.models.BillingProfile
        :keyword scheduled_events_profile: Specifies Scheduled Event related configurations.
        :paramtype scheduled_events_profile: ~azure.mgmt.azurefleet.models.ScheduledEventsProfile
        ...
        :paramtype capacity_reservation: ~azure.mgmt.azurefleet.models.CapacityReservationProfile
        :keyword application_profile: Specifies the gallery applications that should be made available
         to the VM/VMSS.
        :paramtype application_profile: ~azure.mgmt.azurefleet.models.ApplicationProfile
        :keyword hardware_profile: Specifies the hardware profile related details of a scale set.
         Minimum api-version: 2021-11-01.
        :paramtype hardware_profile:
         ~azure.mgmt.azurefleet.models.VirtualMachineScaleSetHardwareProfile
        :keyword service_artifact_reference: Specifies the service artifact reference id used to set
         ...
         Minimum api-version: 2022-11-01.
        :paramtype service_artifact_reference: ~azure.mgmt.azurefleet.models.ServiceArtifactReference
        :keyword security_posture_reference: Specifies the security posture to be used for all virtual
         machines in the scale set. Minimum api-version: 2023-03-01.
        :paramtype security_posture_reference: ~azure.mgmt.azurefleet.models.SecurityPostureReference
        """
        super().__init__(**kwargs)
...
class VMDiskSecurityProfile(_serialization.Model):
    ...
    :ivar security_encryption_type: Specifies the EncryptionType of the managed disk. It is set to
     ...
     "NonPersistedTPM".
    :vartype security_encryption_type: str or ~azure.mgmt.azurefleet.models.SecurityEncryptionTypes
    :ivar disk_encryption_set: Specifies the customer managed disk encryption set resource id for
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype security_encryption_type: str or
         ~azure.mgmt.azurefleet.models.SecurityEncryptionTypes
        :keyword disk_encryption_set: Specifies the customer managed disk encryption set resource id
...
class WindowsConfiguration(_serialization.Model):
    ...
    :vartype additional_unattend_content:
     list[~azure.mgmt.azurefleet.models.AdditionalUnattendContent]
    :ivar patch_settings: [Preview Feature] Specifies settings related to VM Guest Patching on
     Windows.
    :vartype patch_settings: ~azure.mgmt.azurefleet.models.PatchSettings
    :ivar win_rm: Specifies the Windows Remote Management listeners. This enables remote Windows
     PowerShell.
    :vartype win_rm: ~azure.mgmt.azurefleet.models.WinRMConfiguration
    :ivar enable_vm_agent_platform_updates: Indicates whether VMAgent Platform Updates is enabled
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword patch_settings: [Preview Feature] Specifies settings related to VM Guest Patching on
         Windows.
        :paramtype patch_settings: ~azure.mgmt.azurefleet.models.PatchSettings
        :keyword win_rm: Specifies the Windows Remote Management listeners. This enables remote Windows
         PowerShell.
        :paramtype win_rm: ~azure.mgmt.azurefleet.models.WinRMConfiguration
        :keyword enable_vm_agent_platform_updates: Indicates whether VMAgent Platform Updates is
...
class WindowsVMGuestPatchAutomaticByPlatformSettings(_serialization.Model):  # pylint: disable=name-too-long
    ...
    :ivar reboot_setting: Specifies the reboot setting for all AutomaticByPlatform patch
     installation operations. Known values are: "Unknown", "IfRequired", "Never", and "Always".
    :vartype reboot_setting: str or
     ~azure.mgmt.azurefleet.models.WindowsVMGuestPatchAutomaticByPlatformRebootSetting
    :ivar bypass_platform_safety_checks_on_user_schedule: Enables customer to schedule patching
     without accidental upgrades.
    :vartype bypass_platform_safety_checks_on_user_schedule: bool
    """
...
class WinRMConfiguration(_serialization.Model):
    ...
    :vartype listeners: list[~azure.mgmt.azurefleet.models.WinRMListener]
    """
    ...
    def __init__(self, *, listeners: Optional[List["_models.WinRMListener"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype listeners: list[~azure.mgmt.azurefleet.models.WinRMListener]
        """
        super().__init__(**kwargs)
...
class WinRMListener(_serialization.Model):
    ...
    :vartype protocol: str or ~azure.mgmt.azurefleet.models.ProtocolTypes
    :ivar certificate_url: This is the URL of a certificate that has been uploaded to Key Vault as
     a secret. For adding a secret to the Key Vault, see `Add a key or secret to the key vault
     <https://docs.microsoft.com/azure/key-vault/key-vault-get-started/#add>`_. In this case, your
    ...
    def __init__(
        ...
        **kwargs: Any
         ...
         **https.**. Known values are: "Http" and "Https".
        :paramtype protocol: str or ~azure.mgmt.azurefleet.models.ProtocolTypes
        :keyword certificate_url: This is the URL of a certificate that has been uploaded to Key Vault
         as a secret. For adding a secret to the Key Vault, see `Add a key or secret to the key vault
         <https://docs.microsoft.com/azure/key-vault/key-vault-get-started/#add>`_. In this case, your
         certificate needs to be the Base64 encoding of the following JSON Object which is encoded in
