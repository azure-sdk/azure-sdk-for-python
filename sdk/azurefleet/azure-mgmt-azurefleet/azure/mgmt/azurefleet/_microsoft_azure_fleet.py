...
from .operations import FleetsOperations, Operations, VirtualMachineScaleSetsOperations
...
class MicrosoftAzureFleet:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype operations: azure.mgmt.azurefleet.operations.Operations
    :ivar fleets: FleetsOperations operations
    :vartype fleets: azure.mgmt.azurefleet.operations.FleetsOperations
    :ivar virtual_machine_scale_sets: VirtualMachineScaleSetsOperations operations
    :vartype virtual_machine_scale_sets:
     azure.mgmt.azurefleet.operations.VirtualMachineScaleSetsOperations
    ...
    def __enter__(self) -> "MicrosoftAzureFleet":
