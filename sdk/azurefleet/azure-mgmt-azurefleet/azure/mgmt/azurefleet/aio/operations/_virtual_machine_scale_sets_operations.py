...
from ...operations._virtual_machine_scale_sets_operations import build_list_by_fleet_request
...
class VirtualMachineScaleSetsOperations:
    ...
    def list_by_fleet(
        ...
        :return: An iterator like instance of either VirtualMachineScaleSet or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.azurefleet.models.VirtualMachineScaleSet]
