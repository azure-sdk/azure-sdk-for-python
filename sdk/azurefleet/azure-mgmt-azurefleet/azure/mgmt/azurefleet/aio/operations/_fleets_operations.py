...
class FleetsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.azurefleet.aio.MicrosoftAzureFleet`'s
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.Fleet"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.azurefleet.models.Fleet]
    ...
    async def get(self, resource_group_name: str, fleet_name: str, **kwargs: Any) -> _models.Fleet:
        ...
        :rtype: ~azure.mgmt.azurefleet.models.Fleet
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.azurefleet.models.Fleet
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either Fleet or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurefleet.models.Fleet]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        :param resource: Resource create parameters. Is either a Fleet type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.azurefleet.models.Fleet or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Fleet or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurefleet.models.Fleet]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.azurefleet.models.FleetUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either Fleet or the result of cls(response)
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.azurefleet.models.FleetUpdate or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Fleet or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurefleet.models.Fleet]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
