    ...
    response = client.communications_gateways.begin_create_or_update(
        ...
        resource={
            ...
            "properties": {
                ...
                "customSipHeaders": {"headers": [{"name": "x-contoso-commsgw-identifier"}]},
                "dnsDelegations": {"delegations": [{"domain": "commsgw.contoso.com"}]},
                "e911Type": "Standard",
                "platforms": ["OperatorConnect", "TeamsDirectRouting"],
                "serviceLocations": [
                    {
                        "name": "useast",
