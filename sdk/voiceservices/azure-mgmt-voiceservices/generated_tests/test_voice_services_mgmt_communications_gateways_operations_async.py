...
class TestVoiceServicesMgmtCommunicationsGatewaysOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_get(self, resource_group):
        response = await self.client.communications_gateways.get(
            resource_group_name=resource_group.name,
    ...
    async def test_begin_create_or_update(self, resource_group):
        response = await (
            await self.client.communications_gateways.begin_create_or_update(
                resource_group_name=resource_group.name,
                communications_gateway_name="str",
                resource={
                    "location": "str",
                    ...
                    "apiBridge": {
                        "allowedAddressPrefixes": ["str"],
                        "configureApiBridge": "str",
                        "endpointFqdns": ["str"],
                    },
    ...
    async def test_update(self, resource_group):
        response = await self.client.communications_gateways.update(
            resource_group_name=resource_group.name,
            communications_gateway_name="str",
            properties={
                "identity": {
    ...
    async def test_begin_delete(self, resource_group):
        response = await (
            await self.client.communications_gateways.begin_delete(
                resource_group_name=resource_group.name,
                communications_gateway_name="str",
                api_version="2023-09-01",
            )
