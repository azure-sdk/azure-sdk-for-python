...
class Contact(TrackedResource):  # pylint: disable=too-many-instance-attributes
    """A Contact resource.
    ...
    :ivar provisioning_state: Resource provisioning state. Known values are: "Succeeded", "Failed",
     and "Canceled".
    :vartype provisioning_state: str or ~azure.mgmt.voiceservices.models.ProvisioningState
    :ivar contact_name: Full name of contact.
    :vartype contact_name: str
    :ivar phone_number: Telephone number of contact.
    :vartype phone_number: str
    :ivar email: Email address of contact.
    :vartype email: str
    :ivar role: Job title of contact.
    :vartype role: str
    """
    ...
    _attribute_map = {
        ...
        "location": {"key": "location", "type": "str"},
        "provisioning_state": {"key": "properties.provisioningState", "type": "str"},
        "contact_name": {"key": "properties.contactName", "type": "str"},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword location: The geo-location where the resource lives. Required.
        :paramtype location: str
        :keyword contact_name: Full name of contact.
        :paramtype contact_name: str
        :keyword phone_number: Telephone number of contact.
        :paramtype phone_number: str
        :keyword email: Email address of contact.
        :paramtype email: str
        :keyword role: Job title of contact.
        :paramtype role: str
        """
        super().__init__(tags=tags, location=location, **kwargs)
        self.provisioning_state = None
