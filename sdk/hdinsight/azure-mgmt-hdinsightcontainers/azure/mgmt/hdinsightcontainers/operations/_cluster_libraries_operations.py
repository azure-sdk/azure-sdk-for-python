...
class ClusterLibrariesOperations:
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HDInsight/clusterpools/{clusterPoolName}/clusters/{clusterName}/libraries"
    }

    def _manage_libraries_initial(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        cluster_pool_name: str,
        cluster_name: str,
        operation: Union[_models.ClusterLibraryManagementOperation, IO],
        **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
        ...
        request = build_manage_libraries_request(
            resource_group_name=resource_group_name,
            cluster_pool_name=cluster_pool_name,
            cluster_name=cluster_name,
            subscription_id=self._config.subscription_id,
            ...
            json=_json,
            content=_content,
            template_url=self._manage_libraries_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    _manage_libraries_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HDInsight/clusterpools/{clusterPoolName}/clusters/{clusterName}/manageLibraries"
    }
    ...
    def begin_manage_libraries(
        ...
        **kwargs: Any
        ...
        :param operation: The library management operation. Is either a
         ClusterLibraryManagementOperation type or a IO type. Required.
        :type operation: ~azure.mgmt.hdinsightcontainers.models.ClusterLibraryManagementOperation or IO
        ...
        if cont_token is None:
            raw_result = self._manage_libraries_initial(  # type: ignore
                resource_group_name=resource_group_name,
                cluster_pool_name=cluster_pool_name,
                cluster_name=cluster_name,
                operation=operation,
    ...
    begin_manage_libraries.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HDInsight/clusterpools/{clusterPoolName}/clusters/{clusterName}/manageLibraries"
    }
