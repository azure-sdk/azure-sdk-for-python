...
class ClustersOperations:
    ...
    async def _upgrade_manual_rollback_initial(
        ...
        cluster_pool_name: str,
        cluster_name: str,
        cluster_rollback_upgrade_request: Union[_models.ClusterUpgradeRollback, IO],
        **kwargs: Any
    ) -> Optional[_models.Cluster]:
        error_map = {
            401: ClientAuthenticationError,
        ...
        request = build_upgrade_manual_rollback_request(
            resource_group_name=resource_group_name,
            cluster_pool_name=cluster_pool_name,
            cluster_name=cluster_name,
            subscription_id=self._config.subscription_id,
            ...
            json=_json,
            content=_content,
            template_url=self._upgrade_manual_rollback_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    _upgrade_manual_rollback_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HDInsight/clusterpools/{clusterPoolName}/clusters/{clusterName}/rollback"
    }
    ...
    async def begin_upgrade_manual_rollback(
        ...
        cluster_pool_name: str,
        cluster_name: str,
        cluster_rollback_upgrade_request: IO,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.Cluster]:
        ...
        :type cluster_name: str
        :param cluster_rollback_upgrade_request: Manual rollback upgrade for a cluster. Required.
        :type cluster_rollback_upgrade_request: IO
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_upgrade_manual_rollback(
        ...
        **kwargs: Any
        ...
        :param cluster_rollback_upgrade_request: Manual rollback upgrade for a cluster. Is either a
         ClusterUpgradeRollback type or a IO type. Required.
        :type cluster_rollback_upgrade_request:
         ~azure.mgmt.hdinsightcontainers.models.ClusterUpgradeRollback or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    begin_upgrade_manual_rollback.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HDInsight/clusterpools/{clusterPoolName}/clusters/{clusterName}/rollback"
    }
