...
class ClustersOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.hdinsight.containers.aio.HDinsightContainersMgmtClient`'s
    ...
    def list_by_cluster_pool_name(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.hdinsight.containers.models.Cluster]
    ...
    async def begin_resize(
        ...
        **kwargs: Any
        ...
        :type cluster_resize_request: ~azure.mgmt.hdinsight.containers.models.ClusterResizeData
        ...
        :return: An instance of AsyncLROPoller that returns either Cluster or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.hdinsight.containers.models.Cluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_resize(
        ...
        **kwargs: Any
        ...
        :param cluster_resize_request: Resize a cluster. Is either a ClusterResizeData type or a IO
         type. Required.
        :type cluster_resize_request: ~azure.mgmt.hdinsight.containers.models.ClusterResizeData or IO
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.hdinsight.containers.models.Cluster
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type hd_insight_cluster: ~azure.mgmt.hdinsight.containers.models.Cluster
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param hd_insight_cluster: The cluster to create. Is either a Cluster type or a IO type.
         Required.
        :type hd_insight_cluster: ~azure.mgmt.hdinsight.containers.models.Cluster or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type cluster_patch_request: ~azure.mgmt.hdinsight.containers.models.ClusterPatch
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param cluster_patch_request: Patch a cluster. Is either a ClusterPatch type or a IO type.
         Required.
        :type cluster_patch_request: ~azure.mgmt.hdinsight.containers.models.ClusterPatch or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_service_configs(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.hdinsight.containers.models.ServiceConfigResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_instance_views(
        ...
        :return: An iterator like instance of either ClusterInstanceViewResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.hdinsight.containers.models.ClusterInstanceViewResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def get_instance_view(
        ...
        :rtype: ~azure.mgmt.hdinsight.containers.models.ClusterInstanceViewResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
