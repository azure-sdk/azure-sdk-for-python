...
class HDinsightContainersMgmtClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype cluster_pools: azure.mgmt.hdinsight.containers.aio.operations.ClusterPoolsOperations
    :ivar clusters: ClustersOperations operations
    :vartype clusters: azure.mgmt.hdinsight.containers.aio.operations.ClustersOperations
    :ivar cluster_jobs: ClusterJobsOperations operations
    :vartype cluster_jobs: azure.mgmt.hdinsight.containers.aio.operations.ClusterJobsOperations
    :ivar locations: LocationsOperations operations
    :vartype locations: azure.mgmt.hdinsight.containers.aio.operations.LocationsOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.hdinsight.containers.aio.operations.Operations
    ...
    :vartype available_cluster_pool_versions:
     azure.mgmt.hdinsight.containers.aio.operations.AvailableClusterPoolVersionsOperations
    :ivar available_cluster_versions: AvailableClusterVersionsOperations operations
    :vartype available_cluster_versions:
     azure.mgmt.hdinsight.containers.aio.operations.AvailableClusterVersionsOperations
