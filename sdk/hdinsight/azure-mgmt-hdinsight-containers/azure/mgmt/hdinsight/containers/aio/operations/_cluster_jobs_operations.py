...
class ClusterJobsOperations:
    ...
    async def begin_run_job(
        ...
        **kwargs: Any
        ...
        :type cluster_job: ~azure.mgmt.hdinsight.containers.models.ClusterJob
        ...
        :return: An instance of AsyncLROPoller that returns either ClusterJob or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.hdinsight.containers.models.ClusterJob]
    ...
    async def begin_run_job(
        ...
        **kwargs: Any
        ...
        :type cluster_job: ~azure.mgmt.hdinsight.containers.models.ClusterJob or IO
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.hdinsight.containers.models.ClusterJob]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
