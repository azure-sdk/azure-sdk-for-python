...
class ClusterPoolsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.hdinsight.containers.HDinsightContainersMgmtClient`'s
    ...
    @distributed_trace
    def get(self, resource_group_name: str, cluster_pool_name: str, **kwargs: Any) -> _models.ClusterPool:
        """Gets a cluster pool.
        ...
        :rtype: ~azure.mgmt.hdinsight.containers.models.ClusterPool
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type cluster_pool: ~azure.mgmt.hdinsight.containers.models.ClusterPool
        ...
        :return: An instance of LROPoller that returns either ClusterPool or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.hdinsight.containers.models.ClusterPool]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param cluster_pool: The Cluster Pool to create. Is either a ClusterPool type or a IO type.
         Required.
        :type cluster_pool: ~azure.mgmt.hdinsight.containers.models.ClusterPool or IO
    ...
    def begin_update_tags(
        ...
        **kwargs: Any
        ...
        :type cluster_pool_tags: ~azure.mgmt.hdinsight.containers.models.TagsObject
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_update_tags(
        ...
        **kwargs: Any
        ...
        :param cluster_pool_tags: Parameters supplied to update tags. Is either a TagsObject type or a
         IO type. Required.
        :type cluster_pool_tags: ~azure.mgmt.hdinsight.containers.models.TagsObject or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.ClusterPool"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.hdinsight.containers.models.ClusterPool]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
