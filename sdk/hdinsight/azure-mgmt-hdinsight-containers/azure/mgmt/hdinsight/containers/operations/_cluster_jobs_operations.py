...
class ClusterJobsOperations:
    ...
    def begin_run_job(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.hdinsight.containers.models.ClusterJob]
    ...
    def list(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.hdinsight.containers.models.ClusterJob]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
