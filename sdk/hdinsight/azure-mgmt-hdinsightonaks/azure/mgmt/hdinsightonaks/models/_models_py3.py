...
class ClusterPoolComputeProfile(_serialization.Model):
    ...
    def __init__(self, *, vm_size: str, count: int = 3, **kwargs: Any) -> None:
        """
        :keyword vm_size: The virtual machine SKU. Required.
        :paramtype vm_size: str
        :keyword count: The number of virtual machines.
        :paramtype count: int
        """
        super().__init__(**kwargs)
...
class ClusterPoolResourcePropertiesComputeProfile(ClusterPoolComputeProfile):
    ...
    def __init__(self, *, vm_size: str, count: int = 3, **kwargs: Any) -> None:
        ...
        :paramtype count: int
        """
        super().__init__(vm_size=vm_size, count=count, **kwargs)
