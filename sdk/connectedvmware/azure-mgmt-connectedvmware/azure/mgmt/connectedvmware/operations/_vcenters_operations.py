...
def build_list_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.ConnectedVMwarevSphere/vcenters"
    )
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
class VCentersOperations:
    ...
    def _create_initial(
        ...
        vcenter_name: str,
        body: Optional[Union[_models.VCenter, IO[bytes]]] = None,
        **kwargs: Any
    ) -> _models.VCenter:
        error_map = {
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param vcenter_name: Name of the vCenter. Required.
        :type vcenter_name: str
        :param body: Request payload. Is either a VCenter type or a IO[bytes] type. Default value is
         None.
        :type body: ~azure.mgmt.connectedvmware.models.VCenter or IO[bytes]
        :return: An instance of LROPoller that returns either VCenter or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.connectedvmware.models.VCenter]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
