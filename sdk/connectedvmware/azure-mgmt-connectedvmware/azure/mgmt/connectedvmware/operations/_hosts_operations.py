...
class HostsOperations:
    ...
    def _create_initial(
        ...
        host_name: str,
        body: Optional[Union[_models.Host, IO[bytes]]] = None,
        **kwargs: Any
    ) -> _models.Host:
        error_map = {
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param host_name: Name of the host. Required.
        :type host_name: str
        :param body: Request payload. Is either a Host type or a IO[bytes] type. Default value is None.
        :type body: ~azure.mgmt.connectedvmware.models.Host or IO[bytes]
        :return: An instance of LROPoller that returns either Host or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.connectedvmware.models.Host]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if cont_token:
            return LROPoller[_models.Host].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.Host](
