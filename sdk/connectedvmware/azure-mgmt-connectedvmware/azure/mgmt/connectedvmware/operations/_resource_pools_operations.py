...
def build_list_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.ConnectedVMwarevSphere/resourcePools"
    )  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
class ResourcePoolsOperations:
    ...
    def _create_initial(
        ...
        resource_group_name: str,
        resource_pool_name: str,
        body: Optional[Union[_models.ResourcePool, IO[bytes]]] = None,
        **kwargs: Any
    ...
    def begin_create(
        ...
        **kwargs: Any
    ) -> LROPoller[_models.ResourcePool]:
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param resource_pool_name: Name of the resourcePool. Required.
        :type resource_pool_name: str
        :param body: Request payload. Is either a ResourcePool type or a IO[bytes] type. Default value
         is None.
        :type body: ~azure.mgmt.connectedvmware.models.ResourcePool or IO[bytes]
        :return: An instance of LROPoller that returns either ResourcePool or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.connectedvmware.models.ResourcePool]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return LROPoller[_models.ResourcePool].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ResourcePool](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )

    @distributed_trace
    def get(self, resource_group_name: str, resource_pool_name: str, **kwargs: Any) -> _models.ResourcePool:
        """Gets a resourcePool.
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> Iterable["_models.ResourcePool"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.connectedvmware.models.ResourcePool]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.ResourcePool"]:
