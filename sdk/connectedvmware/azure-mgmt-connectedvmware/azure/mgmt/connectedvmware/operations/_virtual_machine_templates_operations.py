...
class VirtualMachineTemplatesOperations:
    ...
    def _create_initial(
        ...
        resource_group_name: str,
        virtual_machine_template_name: str,
        body: Optional[Union[_models.VirtualMachineTemplate, IO[bytes]]] = None,
        **kwargs: Any
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param virtual_machine_template_name: Name of the virtual machine template resource. Required.
        :type virtual_machine_template_name: str
        :param body: Request payload. Is either a VirtualMachineTemplate type or a IO[bytes] type.
         Default value is None.
        :type body: ~azure.mgmt.connectedvmware.models.VirtualMachineTemplate or IO[bytes]
        :return: An instance of LROPoller that returns either VirtualMachineTemplate or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.connectedvmware.models.VirtualMachineTemplate]
