...
class VirtualMachineTemplatesOperations:
    ...
    def _create_initial(
        ...
        resource_group_name: str,
        virtual_machine_template_name: str,
        body: Optional[Union[_models.VirtualMachineTemplate, IO]] = None,
        **kwargs: Any
    ...
    _create_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ConnectedVMwarevSphere/virtualMachineTemplates/{virtualMachineTemplateName}"
    }
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param virtual_machine_template_name: Name of the virtual machine template resource. Required.
        :type virtual_machine_template_name: str
        :param body: Request payload. Is either a VirtualMachineTemplate type or a IO type. Default
         value is None.
        :type body: ~azure.mgmt.connectedvmware.models.VirtualMachineTemplate or IO
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> Iterable["_models.VirtualMachineTemplate"]:
        ...
        :return: An iterator like instance of either VirtualMachineTemplate or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.connectedvmware.models.VirtualMachineTemplate]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.VirtualMachineTemplatesList] = kwargs.pop("cls", None)
    ...
    list_by_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ConnectedVMwarevSphere/virtualMachineTemplates"
    }
