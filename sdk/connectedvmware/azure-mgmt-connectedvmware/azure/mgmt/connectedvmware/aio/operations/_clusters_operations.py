...
class ClustersOperations:
    ...
    async def _create_initial(
        ...
        cluster_name: str,
        body: Optional[Union[_models.Cluster, IO[bytes]]] = None,
        **kwargs: Any
    ) -> _models.Cluster:
        error_map = {
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param cluster_name: Name of the cluster. Required.
        :type cluster_name: str
        :param body: Request payload. Is either a Cluster type or a IO[bytes] type. Default value is
         None.
        :type body: ~azure.mgmt.connectedvmware.models.Cluster or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Cluster or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.connectedvmware.models.Cluster]
        :raises ~azure.core.exceptions.HttpResponseError:
