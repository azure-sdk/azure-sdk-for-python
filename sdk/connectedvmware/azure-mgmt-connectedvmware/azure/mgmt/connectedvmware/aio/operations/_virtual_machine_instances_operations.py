...
class VirtualMachineInstancesOperations:
    ...
    async def _create_or_update_initial(
        self, resource_uri: str, body: Optional[Union[_models.VirtualMachineInstance, IO[bytes]]] = None, **kwargs: Any
    ...
    async def begin_create_or_update(
        ...
        :param resource_uri: The fully qualified Azure Resource manager identifier of the Hybrid
         Compute machine resource to be extended. Required.
        :type resource_uri: str
        :param body: Request payload. Is either a VirtualMachineInstance type or a IO[bytes] type.
         Default value is None.
        :type body: ~azure.mgmt.connectedvmware.models.VirtualMachineInstance or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either VirtualMachineInstance or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.connectedvmware.models.VirtualMachineInstance]
    ...
    async def _update_initial(
        self,
        resource_uri: str,
        body: Optional[Union[_models.VirtualMachineInstanceUpdate, IO[bytes]]] = None,
        **kwargs: Any
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.connectedvmware.models.VirtualMachineInstanceUpdate or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either VirtualMachineInstance or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.connectedvmware.models.VirtualMachineInstance]
    ...
    async def begin_stop(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.connectedvmware.models.StopVirtualMachineOptions or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
