...
class TestResourceManagementResourceGroupsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_list_resources(self, resource_group):
    ...
    async def test_patch(self, resource_group):
        response = await self.client.resource_groups.patch(
            resource_group_name=resource_group.name,
            parameters={
                "location": "str",
                "id": "str",
    ...
    async def test_export_template(self, resource_group):
        response = await self.client.resource_groups.export_template(
            resource_group_name=resource_group.name,
