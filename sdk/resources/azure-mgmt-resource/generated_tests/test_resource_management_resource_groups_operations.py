...
class TestResourceManagementResourceGroupsOperations(AzureMgmtRecordedTestCase):
    ...
    @recorded_by_proxy
    def test_list_resources(self, resource_group):
        response = self.client.resource_groups.list_resources(
    ...
    def test_patch(self, resource_group):
        response = self.client.resource_groups.patch(
            resource_group_name=resource_group.name,
            parameters={
                "location": "str",
                "id": "str",
    ...
    def test_export_template(self, resource_group):
        response = self.client.resource_groups.export_template(
            resource_group_name=resource_group.name,
