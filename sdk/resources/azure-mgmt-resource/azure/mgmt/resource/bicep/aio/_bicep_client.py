...
class BicepClient(MultiApiClientMixin, _SDKClient):
    ...
    def decompile(self):
        """Instance depends on the API version:
           ...
           * 2023-11-01: :class:`DecompileOperations<azure.mgmt.resource.bicep.v2023_11_01.aio.operations.DecompileOperations>`
        """
        api_version = self._get_api_version('decompile')
        if api_version == '2023-11-01':
            from ..v2023_11_01.aio.operations import DecompileOperations as OperationClass
        else:
