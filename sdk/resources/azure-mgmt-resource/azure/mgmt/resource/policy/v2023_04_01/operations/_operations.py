...
def build_policy_set_definition_versions_create_or_update_request(  # pylint: disable=name-too-long
    policy_set_definition_name: str, subscription_id: str, policy_definition_version: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PolicySetDefinitionVersionsOperations:
    ...
    @distributed_trace
    def get(self, policy_set_definition_name: str, **kwargs: Any) -> _models.PolicySetDefinitionVersion:
    ...
    @distributed_trace
    def get_built_in(self, policy_set_definition_name: str, **kwargs: Any) -> _models.PolicySetDefinitionVersion:
