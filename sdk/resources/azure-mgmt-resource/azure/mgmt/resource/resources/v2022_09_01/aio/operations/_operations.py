...
from ...operations._operations import (
    ...
    build_tags_operation_result_request,
...
class TagsOperations:
    ...
    async def _operation_result_initial(self, **kwargs: Any) -> Optional[_models.TagsResource]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    @distributed_trace_async
    async def begin_operation_result(self, **kwargs: Any) -> AsyncLROPoller[_models.TagsResource]:
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._operation_result_initial(
