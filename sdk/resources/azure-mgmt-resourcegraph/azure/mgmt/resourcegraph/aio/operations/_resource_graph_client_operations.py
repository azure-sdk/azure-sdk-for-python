...
class ResourceGraphClientOperationsMixin(ResourceGraphClientMixinABC):
    ...
    async def resources(self, query: Union[_models.QueryRequest, IO], **kwargs: Any) -> _models.QueryResponse:
        ...
        :param query: Request specifying query and its options. Is either a QueryRequest type or a IO
         type. Required.
    ...
    async def resources_history(
        ...
        :param request: Request specifying the query and its options. Is either a
         ResourcesHistoryRequest type or a IO type. Required.
    ...
    async def resource_changes(
        ...
        :param parameters: the parameters for this request for changes. Is either a
         ResourceChangesRequestParameters type or a IO type. Required.
    ...
    async def resource_change_details(
        ...
        :param parameters: The parameters for this request for resource change details. Is either a
         ResourceChangeDetailsRequestParameters type or a IO type. Required.
