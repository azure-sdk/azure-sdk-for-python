...
class AssociatedResourcesListResult(_serialization.Model):
    ...
    :ivar value: The collection of Azure resources returned by the resource action to get a list of
     assigned resources.
    :vartype value: list[~azure.mgmt.msi.v2022_01_31_preview.models.AzureResource]
...
class CloudErrorBody(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.msi.v2022_01_31_preview.models.CloudErrorBody]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype details: list[~azure.mgmt.msi.v2022_01_31_preview.models.CloudErrorBody]
        """
        super().__init__(**kwargs)
        self.code = code
...
class FederatedIdentityCredentialsListResult(_serialization.Model):
    ...
    :ivar value: The collection of federated identity credentials returned by the listing
     operation.
    :vartype value: list[~azure.mgmt.msi.v2022_01_31_preview.models.FederatedIdentityCredential]
    :ivar next_link: The url to get the next page of results, if any.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword value: The collection of federated identity credentials returned by the listing
         operation.
        :paramtype value: list[~azure.mgmt.msi.v2022_01_31_preview.models.FederatedIdentityCredential]
...
class Operation(_serialization.Model):
    ...
    :vartype display: ~azure.mgmt.msi.v2022_01_31_preview.models.OperationDisplay
    """
    ...
    def __init__(
        ...
        :paramtype display: ~azure.mgmt.msi.v2022_01_31_preview.models.OperationDisplay
        """
        super().__init__(**kwargs)
        self.name = name
...
class OperationListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.msi.v2022_01_31_preview.models.Operation]
    :ivar next_link: The url to get the next page of results, if any.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.msi.v2022_01_31_preview.models.Operation]
        :keyword next_link: The url to get the next page of results, if any.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class UserAssignedIdentitiesListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.msi.v2022_01_31_preview.models.Identity]
    :ivar next_link: The url to get the next page of results, if any.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.msi.v2022_01_31_preview.models.Identity]
        :keyword next_link: The url to get the next page of results, if any.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
