...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2021-09-30-preview"))
...
class UserAssignedIdentitiesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.msi.v2021_09_30_preview.ManagedServiceIdentityClient`'s
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.Identity"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.msi.v2021_09_30_preview.models.Identity]
    ...
    def list_associated_resources(
        ...
        skiptoken: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.AzureResource"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.msi.v2021_09_30_preview.models.AzureResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
