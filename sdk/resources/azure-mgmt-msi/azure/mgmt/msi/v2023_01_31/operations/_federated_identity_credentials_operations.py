...
class FederatedIdentityCredentialsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either FederatedIdentityCredential or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.msi.v2023_01_31.models.FederatedIdentityCredential]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})

        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._api_version or "2023-01-31"))
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.msi.v2023_01_31.models.FederatedIdentityCredential or IO[bytes]
        :return: FederatedIdentityCredential or the result of cls(response)
        :rtype: ~azure.mgmt.msi.v2023_01_31.models.FederatedIdentityCredential
        :raises ~azure.core.exceptions.HttpResponseError:
        """
