    ...
    response = client.data_connectors.create_or_update(
        ...
        data_connector={
            ...
            "properties": {
                ...
                "taxiiLookbackPeriod": "2023-01-01T13:00:30.123Z",
...
# x-ms-original-file: specification/securityinsights/resource-manager/Microsoft.SecurityInsights/stable/2024-03-01/examples/dataConnectors/CreateThreatIntelligenceTaxiiDataConnector.json
