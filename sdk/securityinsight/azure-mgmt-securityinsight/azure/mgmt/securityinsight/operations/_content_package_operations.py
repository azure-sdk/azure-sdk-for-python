...
class ContentPackageOperations:
    ...
    def install(
        ...
        workspace_name: str,
        package_id: str,
        package_installation_properties: Union[_models.PackageModel, IO],
        **kwargs: Any
    ) -> _models.PackageModel:
        """Install a package to the workspace.
        ...
        :param package_installation_properties: Package installation properties. Is either a
         PackageModel type or a IO type. Required.
        :type package_installation_properties: ~azure.mgmt.securityinsight.models.PackageModel or IO
