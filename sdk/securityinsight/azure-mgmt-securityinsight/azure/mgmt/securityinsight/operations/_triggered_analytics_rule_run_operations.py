...
class TriggeredAnalyticsRuleRunOperations:
    ...
    def get(
        ...
        deserialized = self._deserialize("TriggeredAnalyticsRuleRun", pipeline_response)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/triggeredAnalyticsRuleRuns/{ruleRunId}"
    }
