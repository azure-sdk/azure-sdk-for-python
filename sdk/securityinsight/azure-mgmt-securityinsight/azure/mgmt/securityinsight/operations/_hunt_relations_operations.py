...
class HuntRelationsOperations:
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/hunts/{huntId}/relations"
    }
    ...
    def get(
        ...
        deserialized = self._deserialize("HuntRelation", pipeline_response)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/hunts/{huntId}/relations/{huntRelationId}"
    }
    ...
    def create_or_update(
        ...
        hunt_id: str,
        hunt_relation_id: str,
        hunt_relation: Union[_models.HuntRelation, IO],
        **kwargs: Any
    ) -> _models.HuntRelation:
        """Creates or updates a hunt relation.
        ...
        :param hunt_relation_id: The hunt relation id (GUID). Required.
        :type hunt_relation_id: str
        :param hunt_relation: The hunt relation. Is either a HuntRelation type or a IO type. Required.
        :type hunt_relation: ~azure.mgmt.securityinsight.models.HuntRelation or IO
