...
class ContentTemplatesOperations:
    ...
    def list(
        ...
        skip_token: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.TemplateModelAutoGenerated"]:
        ...
        :return: An iterator like instance of either TemplateModelAutoGenerated or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.securityinsight.models.TemplateModelAutoGenerated]
        ...
        cls: ClsType[_models.TemplateListAutoGenerated] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("TemplateListAutoGenerated", pipeline_response)
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/contentTemplates"
    }
