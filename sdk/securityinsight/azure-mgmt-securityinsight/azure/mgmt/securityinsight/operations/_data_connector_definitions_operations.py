...
class DataConnectorDefinitionsOperations:
    ...
    def list(
    ...
    ) -> _models.DataConnectorDefinitionArmCollectionWrapper:
        ...
        :return: DataConnectorDefinitionArmCollectionWrapper or the result of cls(response)
        :rtype: ~azure.mgmt.securityinsight.models.DataConnectorDefinitionArmCollectionWrapper
    ...
    def get(
        ...
        deserialized = self._deserialize("DataConnectorDefinition", pipeline_response)
    ...
    def create_or_update(
        ...
        workspace_name: str,
        data_connector_definition_name: str,
        connector_definition_input: Union[_models.DataConnectorDefinition, IO],
        **kwargs: Any
    ) -> _models.DataConnectorDefinition:
        """Creates or updates the data connector definition.
        ...
        :param connector_definition_input: The data connector definition. Is either a
         DataConnectorDefinition type or a IO type. Required.
