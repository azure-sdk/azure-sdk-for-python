...
class SourceControlsOperations:
    ...
    def delete(
        ...
        workspace_name: str,
        source_control_id: str,
        repository_access: _models.Paths1J3Lu7WSubscriptionsSubscriptionidResourcegroupsResourcegroupnameProvidersMicrosoftOperationalinsightsWorkspacesWorkspacenameProvidersMicrosoftSecurityinsightsSourcecontrolsSourcecontrolidDeletePostRequestbodyContentApplicationJsonSchema,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.Warning:
