...
class HuntsOperations:
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/hunts"
    }
    ...
    def get(self, resource_group_name: str, workspace_name: str, hunt_id: str, **kwargs: Any) -> _models.Hunt:
        ...
        deserialized = self._deserialize("Hunt", pipeline_response)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/hunts/{huntId}"
    }
    ...
    @distributed_trace
    def create_or_update(
        self, resource_group_name: str, workspace_name: str, hunt_id: str, hunt: Union[_models.Hunt, IO], **kwargs: Any
    ) -> _models.Hunt:
        """Create or update a hunt.
        ...
        :param hunt_id: The hunt id (GUID). Required.
        :type hunt_id: str
        :param hunt: The hunt. Is either a Hunt type or a IO type. Required.
        :type hunt: ~azure.mgmt.securityinsight.models.Hunt or IO
