...
class ProductPackageOperations:
    ...
    def get(
    ...
    ) -> _models.PackageModelAutoGenerated:
        ...
        :return: PackageModelAutoGenerated or the result of cls(response)
        :rtype: ~azure.mgmt.securityinsight.models.PackageModelAutoGenerated
        ...
        cls: ClsType[_models.PackageModelAutoGenerated] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("PackageModelAutoGenerated", pipeline_response)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/contentProductPackages/{packageId}"
    }
