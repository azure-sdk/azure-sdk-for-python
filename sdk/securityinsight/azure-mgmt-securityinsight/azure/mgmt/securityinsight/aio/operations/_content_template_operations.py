...
class ContentTemplateOperations:
    ...
    async def install(
        ...
        workspace_name: str,
        template_id: str,
        template_installation_properties: Union[_models.TemplateModel, IO],
        **kwargs: Any
    ) -> _models.TemplateModel:
        """Install a template.
        ...
        :param template_installation_properties: Template installation properties. Is either a
         TemplateModel type or a IO type. Required.
        :type template_installation_properties: ~azure.mgmt.securityinsight.models.TemplateModel or IO
        ...
        if response.status_code == 200:
            deserialized = self._deserialize("TemplateModel", pipeline_response)
