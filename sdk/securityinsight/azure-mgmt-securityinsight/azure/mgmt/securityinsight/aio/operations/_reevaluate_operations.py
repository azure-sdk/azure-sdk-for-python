...
class ReevaluateOperations:
    ...
    async def begin_recommendation(
        self, resource_group_name: str, workspace_name: str, recommendation_id: str, **kwargs: Any
    ) -> AsyncLROPoller[_models.ReevaluateResponse]:
        ...
        :return: An instance of AsyncLROPoller that returns either ReevaluateResponse or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.securityinsight.models.ReevaluateResponse]
