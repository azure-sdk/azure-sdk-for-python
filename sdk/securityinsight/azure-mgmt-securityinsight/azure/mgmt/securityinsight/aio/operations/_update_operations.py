...
class UpdateOperations:
    ...
    async def _recommendation_initial(
        ...
        recommendation_patch: Union[List[_models.RecommendationPatch], IO[bytes]],
        **kwargs: Any
    ...
    async def begin_recommendation(
        ...
        **kwargs: Any
        ...
        :type recommendation_patch: list[~azure.mgmt.securityinsight.models.RecommendationPatch] or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Recommendation or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.securityinsight.models.Recommendation]
        ...
        if cont_token:
            return AsyncLROPoller[_models.Recommendation].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.Recommendation](
