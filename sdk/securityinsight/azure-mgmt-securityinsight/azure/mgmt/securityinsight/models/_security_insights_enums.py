...
class LastUpdateMethod(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """The name of the method/application that initiated the last write to this TI object."""

    TAXII_CONNECTOR = "TAXII Connector"
    ISG_CONNECTOR = "ISG Connector"
    SENTINEL_REST_API = "Sentinel REST API"
    TI_MATCHING_CONNECTOR = "TI Matching Connector"
    MICROSOFT_TI_CONNECTOR = "Microsoft TI Connector"
    FILE_IMPORT = "File Import"
    INDICATOR_REFRESHER = "Indicator Refresher"
    TI_MANAGER = "TI Manager"
    THREAT_INTELLIGENCE_UPLOAD_INDICATORS_API = "Threat Intelligence Upload Indicators API"
    UPLOAD_STIX_OBJECTS_API = "UploadStixObjectsAPI"
    THREAT_INTELLIGENCE_BULK_ACTIONS = "Threat Intelligence Bulk Actions"
