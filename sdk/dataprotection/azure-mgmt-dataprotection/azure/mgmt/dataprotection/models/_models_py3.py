...
class KubernetesClusterRestoreCriteria(ItemLevelRestoreCriteria):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype restore_hook_references:
     list[~azure.mgmt.dataprotection.models.NamespacedNameResource]
    :ivar resource_modifier_template: Gets or sets the resource modifier template. This property
     sets the template for resource modifier during restore.
    :vartype resource_modifier_template: ~azure.mgmt.dataprotection.models.NamespacedNameResource
    """
    ...
    _attribute_map = {
        ...
        "resource_modifier_template": {"key": "resourceModifierTemplate", "type": "NamespacedNameResource"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        resource_modifier_template: Optional["_models.NamespacedNameResource"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword include_cluster_scope_resources: Gets or sets the include cluster resources property.
        ...
        :paramtype restore_hook_references:
         list[~azure.mgmt.dataprotection.models.NamespacedNameResource]
        :keyword resource_modifier_template: Gets or sets the resource modifier template. This property
         sets the template for resource modifier during restore.
        :paramtype resource_modifier_template: ~azure.mgmt.dataprotection.models.NamespacedNameResource
        """
        super().__init__(**kwargs)
        ...
        self.resource_modifier_template = resource_modifier_template
