...
from ...operations._secondary_rps_operations import build_fetch_request

T = TypeVar("T")
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]


class SecondaryRPsOperations:
    """
    .. warning::
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_fetch_request(
                    ...
                    json=_json,
                    content=_content,
                    template_url=self.fetch.metadata["url"],
                    headers=_headers,
                    params=_params,
                )
