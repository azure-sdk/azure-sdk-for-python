...
class BackupInstancesOperations:  # pylint: disable=too-many-public-methods
    ...
    async def _validate_for_modify_backup_initial(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        vault_name: str,
        backup_instance_name: str,
    ...
    async def begin_validate_for_modify_backup(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._validate_for_modify_backup_initial(  # type: ignore
                resource_group_name=resource_group_name,
                vault_name=vault_name,
                backup_instance_name=backup_instance_name,
                parameters=parameters,
