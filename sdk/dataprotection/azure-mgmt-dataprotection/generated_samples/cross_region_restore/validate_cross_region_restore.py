...
# USAGE
    python validate_cross_region_restore.py
...
def main():
    ...
    response = client.backup_instances.begin_validate_cross_region_restore(
...
# x-ms-original-file: specification/dataprotection/resource-manager/Microsoft.DataProtection/stable/2025-01-01/examples/CrossRegionRestore/ValidateCrossRegionRestore.json
