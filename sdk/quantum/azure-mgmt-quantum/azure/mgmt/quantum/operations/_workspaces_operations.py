...
class WorkspacesOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.QuantumWorkspace"]:
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.QuantumWorkspaceListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("QuantumWorkspaceListResult", pipeline_response)
    ...
    def update_tags(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.quantum.models.TagsObject
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: QuantumWorkspace or the result of cls(response)
    ...
    def update_tags(
        ...
        **kwargs: Any
        ...
        :param workspace_name: The name of the quantum workspace resource. Required.
        :type workspace_name: str
        :param properties: Parameters supplied to update tags. Is either a TagsObject type or a
         IO[bytes] type. Required.
        :type properties: ~azure.mgmt.quantum.models.TagsObject or IO[bytes]
        :return: QuantumWorkspace or the result of cls(response)
        :rtype: ~azure.mgmt.quantum.models.QuantumWorkspace
        :raises ~azure.core.exceptions.HttpResponseError:
        """
