...
def build_sessions_listv2_request(
    subscription_id: str,
    resource_group_name: str,
    workspace_name: str,
    *,
...
def build_top_level_items_listv2_request(
    subscription_id: str,
    resource_group_name: str,
    workspace_name: str,
    *,
...
class JobsOperations:
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._config: ServicesClientConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
        ...
        **kwargs: Any
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_sessions_listv2_request(
                    subscription_id=subscription_id,
                    resource_group_name=resource_group_name,
                    workspace_name=workspace_name,
                    filter=filter,
        ...
        **kwargs: Any
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_top_level_items_listv2_request(
                    subscription_id=subscription_id,
                    resource_group_name=resource_group_name,
                    workspace_name=workspace_name,
                    filter=filter,
