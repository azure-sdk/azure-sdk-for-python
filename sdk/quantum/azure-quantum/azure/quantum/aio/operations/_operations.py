...
class JobsOperations:
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :param resource: The resource instance. Is either a JobDetails type or a IO[bytes] type.
         Required.
        :type resource: ~azure.quantum.models.JobDetails or IO[bytes]
        :return: JobDetails
        :rtype: ~azure.quantum.models.JobDetails
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        path_format_arguments = {
            ...
            "serviceBaseUrl": self._serialize.url(
                "self._config.service_base_url", self._config.service_base_url, "str", skip_quote=True
            ),
        }
    ...
    def list(
        ...
        cls: ClsType[_models.PagedJobDetails] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("PagedJobDetails", pipeline_response)
...
class SessionsOperations:
    ...
    async def open(
        ...
        **kwargs: Any
        ...
        :param resource: The resource instance. Is either a SessionDetails type or a IO[bytes] type.
         Required.
        :type resource: ~azure.quantum.models.SessionDetails or IO[bytes]
        :return: SessionDetails
        :rtype: ~azure.quantum.models.SessionDetails
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def jobs_list(
        self, subscription_id: str, resource_group_name: str, workspace_name: str, session_id: str, **kwargs: Any
    ) -> AsyncIterable["_models.SessionJobDetails"]:
        ...
        :param session_id: Id of the session. Required.
        :type session_id: str
        :return: An iterator like instance of SessionJobDetails
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.quantum.models.SessionJobDetails]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

        cls: ClsType[_models.PagedSessionJobDetails] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("PagedSessionJobDetails", pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.next_link or None, AsyncList(list_of_elem)
    ...
    def list(
        ...
        cls: ClsType[_models.PagedSessionDetails] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("PagedSessionDetails", pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.next_link or None, AsyncList(list_of_elem)
...
class ProvidersOperations:
    ...
    def list(
        ...
        cls: ClsType[_models.PagedProviderStatus] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("PagedProviderStatus", pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.next_link or None, AsyncList(list_of_elem)
...
class StorageOperations:
    ...
    async def get_sas_uri(
        ...
        **kwargs: Any
        ...
        :type blob_details: ~azure.quantum.models.BlobDetails or IO[bytes]
        :return: SasUriResponse
        :rtype: ~azure.quantum.models.SasUriResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
...
class TopLevelItemsOperations:
    ...
    def list(
        ...
        cls: ClsType[_models.PagedItemDetails] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("PagedItemDetails", pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.next_link or None, AsyncList(list_of_elem)
