...
class ServicesClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = ServicesClientConfiguration(
            region=region, service_base_url=service_base_url, credential=credential, **kwargs
        )
    ...
    async def __aenter__(self) -> "ServicesClient":
