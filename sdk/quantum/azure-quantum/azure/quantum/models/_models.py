...
class BlobDetails(_serialization.Model):
    ...
    :ivar blob_name: The blob name. Required.
    :vartype blob_name: str
    """

    _validation = {
        "container_name": {"required": True},
        "blob_name": {"required": True},
    }
    ...
    def __init__(self, *, container_name: str, blob_name: str, **kwargs: Any) -> None:
        """
        :keyword container_name: The container name. Required.
        :paramtype container_name: str
        :keyword blob_name: The blob name. Required.
...
class Error(_serialization.Model):
    ...
    :vartype details: list[~azure.quantum.models.Error]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype details: list[~azure.quantum.models.Error]
        :keyword innererror: An object containing more specific information than the current object
         about the error.
        :paramtype innererror: ~azure.quantum.models.InnerError
        """
        super().__init__(**kwargs)
        self.code = code
...
class ItemDetails(_serialization.Model):
    ...
    _attribute_map = {
        ...
        "error_data": {"key": "errorData", "type": "WorkspaceItemError"},
    }

    _subtype_map = {"item_type": {"Job": "JobDetails"}}
    ...
    def __init__(
        ...
        *,
        ...
        begin_execution_time: Optional[datetime.datetime] = None,
        end_execution_time: Optional[datetime.datetime] = None,
        cost_estimate: Optional["_models.CostEstimate"] = None,
        error_data: Optional["_models.WorkspaceItemError"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword id: Id of the item. Required.
        :paramtype id: str
        ...
        :paramtype target: str
        :keyword creation_time: The creation time of the item.
        :paramtype creation_time: ~datetime.datetime
        :keyword begin_execution_time: The time when the item began execution.
        :paramtype begin_execution_time: ~datetime.datetime
        :keyword end_execution_time: The time when the item finished execution.
        :paramtype end_execution_time: ~datetime.datetime
        :keyword cost_estimate: Cost estimate.
        :paramtype cost_estimate: ~azure.quantum.models.CostEstimate
        :keyword error_data: Error information.
        :paramtype error_data: ~azure.quantum.models.WorkspaceItemError
        """
        super().__init__(**kwargs)
        self.id = id
        self.name = name
...
class JobDetails(ItemDetails):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        *,
        ...
        quantum_computing_data: Optional["_models.QuantumComputingData"] = None,
        ...
        **kwargs: Any
        ...
        :keyword error_data: Error information.
        :paramtype error_data: ~azure.quantum.models.WorkspaceItemError
        :keyword id: Id of the job. Required.
        :paramtype id: str
        :keyword job_type: The type of job. Known values are: "Unknown", "QuantumComputing", and
         "Optimization".
        :paramtype job_type: str or ~azure.quantum.models.JobType
        ...
        :keyword status: The status of the job. Known values are: "Waiting", "Executing", "Succeeded",
         "Failed", and "Cancelled".
        :paramtype status: str or ~azure.quantum.models.JobStatus
        :keyword metadata: The job metadata. Metadata provides client the ability to store
         client-specific information.
        :paramtype metadata: any
        :keyword cancellation_time: The time when a job was successfully cancelled.
        :paramtype cancellation_time: ~datetime.datetime
        :keyword tags: List of user-supplied tags associated with the job.
        :paramtype tags: list[str]
        :keyword quantum_computing_data: Quantum computing data.
        :paramtype quantum_computing_data: ~azure.quantum.models.QuantumComputingData
        ...
        self.tags = tags
        self.quantum_computing_data = quantum_computing_data
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword operation: The operation to be performed. Required. Known values are: "add", "remove",
         "replace", "move", "copy", and "test".
        :paramtype operation: str or ~azure.quantum.models.JsonPatchOperation
...
class PagedItemDetails(_serialization.Model):
    ...
    :vartype value: list[~azure.quantum.models.ItemDetails]
    ...
    def __init__(self, *, value: List["_models.ItemDetails"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.quantum.models.ItemDetails]
...
class PagedJobDetails(_serialization.Model):
    ...
    def __init__(self, *, value: List["_models.JobDetails"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.quantum.models.JobDetails]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class PagedProviderStatus(_serialization.Model):
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.quantum.models.ProviderStatus]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class PagedQuota(_serialization.Model):
    ...
    def __init__(self, *, value: List["_models.Quota"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.quantum.models.Quota]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class PagedSessionDetails(_serialization.Model):
    ...
    :vartype value: list[~azure.quantum.models.SessionDetails]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.quantum.models.SessionDetails]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class PagedSessionJobDetails(_serialization.Model):
    """Paged collection of SessionJobDetails items.

    Variables are only populated by the server, and will be ignored when sending a request.

    All required parameters must be populated in order to send to server.

    :ivar value: The SessionJobDetails items on this page. Required.
    :vartype value: list[~azure.quantum.models.SessionJobDetails]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    _attribute_map = {
        "value": {"key": "value", "type": "[SessionJobDetails]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }

    def __init__(
        self, *, value: List["_models.SessionJobDetails"], next_link: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: The SessionJobDetails items on this page. Required.
        :paramtype value: list[~azure.quantum.models.SessionJobDetails]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class ProviderStatus(_serialization.Model):
    ...
    _validation = {
        "id": {"required": True},
        "current_availability": {"required": True},
    ...
    def __init__(
        ...
        *,
        id: str,  # pylint: disable=redefined-builtin
        current_availability: Union[str, "_models.ProviderAvailability"],
        targets: List["_models.TargetStatus"],
        **kwargs: Any
    ) -> None:
        """
        :keyword id: Provider id. Required.
        :paramtype id: str
        :keyword current_availability: Current provider availability. Required. Known values are:
         "Available", "Degraded", and "Unavailable".
        :paramtype current_availability: str or ~azure.quantum.models.ProviderAvailability
        :keyword targets: Current target statuses. Required.
        :paramtype targets: list[~azure.quantum.models.TargetStatus]
        """
        super().__init__(**kwargs)
        self.id = id
...
class QuantumComputingData(_serialization.Model):
    ...
    def __init__(self, *, count: int, **kwargs: Any) -> None:
        """
        :keyword count: The number of quantum computing items in the job. Required.
        :paramtype count: int
        """
        super().__init__(**kwargs)
        self.count = count
...
class Quota(_serialization.Model):
    ...
    def __init__(
        ...
        *,
        dimension: str,
        scope: Union[str, "_models.DimensionScope"],
        provider_id: str,
        utilization: float,
        holds: float,
        limit: float,
        period: Union[str, "_models.MeterPeriod"],
        **kwargs: Any
    ) -> None:
        """
        :keyword dimension: The name of the dimension associated with the quota. Required.
        :paramtype dimension: str
        :keyword scope: The scope at which the quota is applied. Required. Known values are:
        ...
        :keyword limit: The maximum amount of usage allowed for the current period. Required.
...
class SessionDetails(ItemDetails):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        *,
        ...
        target: str,
        id: str,  # pylint: disable=redefined-builtin
        item_type: Literal[ItemType.SESSION],
        ...
        cost_estimate: Optional["_models.CostEstimate"] = None,
        error_data: Optional["_models.WorkspaceItemError"] = None,
        status: Optional[Union[str, "_models.SessionStatus"]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword name: The name of the item. It is not required for the name to be unique and it's only
        ...
        :keyword error_data: Error information.
        :paramtype error_data: ~azure.quantum.models.WorkspaceItemError
        :keyword id: Id of the session. Required.
        :paramtype id: str
        :keyword item_type: Type of the Quantum Workspace item is Session. Required. A logical grouping
         of jobs.
        :paramtype item_type: str or ~azure.quantum.models.SESSION
        :keyword job_failure_policy: Policy controlling the behavior of the Session when a job in the
         session fails. Required. Known values are: "Abort" and "Continue".
        :paramtype job_failure_policy: str or ~azure.quantum.models.SessionJobFailurePolicy
        :keyword status: The status of the session. Known values are: "Waiting", "Executing",
         "Succeeded", "Failed", "Failure(s)", and "TimedOut".
        :paramtype status: str or ~azure.quantum.models.SessionStatus
        """
        super().__init__(
            name=name,
            provider_id=provider_id,
...
class SessionJobDetails(JobDetails):  # pylint: disable=too-many-instance-attributes
    """A Session Job.
...
class TargetStatus(_serialization.Model):
    ...
    _validation = {
        "id": {"required": True},
        "current_availability": {"required": True},
        "average_queue_time": {"required": True},
    }
    ...
    def __init__(
        ...
        *,
        id: str,  # pylint: disable=redefined-builtin
        current_availability: Union[str, "_models.TargetAvailability"],
        average_queue_time: int,
        status_page: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword id: Target id. Required.
        :paramtype id: str
        :keyword current_availability: Current target availability. Required. Known values are:
         "Available", "Degraded", and "Unavailable".
        :paramtype current_availability: str or ~azure.quantum.models.TargetAvailability
        :keyword average_queue_time: Average queue time in seconds. Required.
...
class WorkspaceItemError(_serialization.Model):
    """The error object.
