...
class ProvisionedClusterUpgradeProfileList(_serialization.Model):
    """List of upgradeProfiles for the provisioned cluster.

    :ivar next_link: Url to follow for getting next page of upgradeProfiles.
    :vartype next_link: str
    :ivar value: Array of upgradeProfiles.
    :vartype value:
     list[~azure.mgmt.hybridcontainerservice.models.ProvisionedClusterUpgradeProfile]
    """

    _attribute_map = {
        "next_link": {"key": "nextLink", "type": "str"},
        "value": {"key": "value", "type": "[ProvisionedClusterUpgradeProfile]"},
    }
    ...
    def __init__(
        ...
        *,
        next_link: Optional[str] = None,
        value: Optional[List["_models.ProvisionedClusterUpgradeProfile"]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword next_link: Url to follow for getting next page of upgradeProfiles.
        :paramtype next_link: str
        :keyword value: Array of upgradeProfiles.
        :paramtype value:
         list[~azure.mgmt.hybridcontainerservice.models.ProvisionedClusterUpgradeProfile]
        """
        super().__init__(**kwargs)
