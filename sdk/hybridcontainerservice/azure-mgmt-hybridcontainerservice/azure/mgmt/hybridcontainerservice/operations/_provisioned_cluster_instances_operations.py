...
def build_list_upgrade_profile_request(connected_cluster_resource_uri: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ProvisionedClusterInstancesOperations:
    ...
    @distributed_trace
    def list_upgrade_profile(
        self, connected_cluster_resource_uri: str, **kwargs: Any
    ) -> _models.ProvisionedClusterUpgradeProfileList:
        ...
        :type connected_cluster_resource_uri: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ProvisionedClusterUpgradeProfileList or the result of cls(response)
        :rtype: ~azure.mgmt.hybridcontainerservice.models.ProvisionedClusterUpgradeProfileList
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.ProvisionedClusterUpgradeProfileList] = kwargs.pop("cls", None)

        request = build_list_upgrade_profile_request(
            connected_cluster_resource_uri=connected_cluster_resource_uri,
            api_version=api_version,
            template_url=self.list_upgrade_profile.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
        ...
        deserialized = self._deserialize("ProvisionedClusterUpgradeProfileList", pipeline_response)
    ...
    list_upgrade_profile.metadata = {
        "url": "/{connectedClusterResourceUri}/providers/Microsoft.HybridContainerService/provisionedClusterInstances/default/upgradeProfiles"
    }
