...
# USAGE
    python transformation_create.py
...
def main():
    ...
    response = client.transformations.create_or_replace(
        resource_group_name="sjrg4423",
        job_name="sj8374",
        transformation_name="transformation952",
        transformation={"properties": {"query": "Select Id, Name from inputtest", "streamingUnits": 6}},
    )
    print(response)
