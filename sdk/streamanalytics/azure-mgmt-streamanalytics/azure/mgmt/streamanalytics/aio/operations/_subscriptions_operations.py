...
class SubscriptionsOperations:
    ...
    async def list_quotas(self, location: str, **kwargs: Any) -> _models.SubscriptionQuotasListResult:
        ...
        :param location: The region in which to retrieve the subscription's quota information. You can
         ...
         https://azure.microsoft.com/en-us/regions/. Required.
        :type location: str
        ...
        _request = build_list_quotas_request(
            location=location,
        ...
        deserialized = self._deserialize("SubscriptionQuotasListResult", pipeline_response.http_response)
