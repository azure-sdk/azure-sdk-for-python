...
class AzureDataLakeStoreOutputDataSourceProperties(OAuthBasedDataSourceProperties):  # pylint: disable=name-too-long
...
class AzureMachineLearningWebServiceFunctionBinding(FunctionBinding):  # pylint: disable=name-too-long
    ...
    :ivar endpoint: The Request-Response execute endpoint of the Azure Machine Learning web
     ...
     https://docs.microsoft.com/en-us/azure/machine-learning/machine-learning-consume-web-services#request-response-service-rrs.  # pylint: disable=line-too-long
...
class FunctionRetrieveDefaultDefinitionParameters(_serialization.Model):  # pylint: disable=name-too-long
...
class AzureMachineLearningWebServiceInputColumn(_serialization.Model):  # pylint: disable=name-too-long
...
class AzureMachineLearningWebServiceOutputColumn(_serialization.Model):  # pylint: disable=name-too-long
...
class AzureSqlDatabaseOutputDataSourceProperties(AzureSqlDatabaseDataSourceProperties):  # pylint: disable=name-too-long
...
class GatewayMessageBusOutputDataSourceProperties(GatewayMessageBusSourceProperties):  # pylint: disable=name-too-long
...
class GatewayMessageBusStreamInputDataSourceProperties(
...
class ServiceBusQueueOutputDataSourceProperties(ServiceBusDataSourceProperties):  # pylint: disable=name-too-long
...
class ServiceBusTopicOutputDataSourceProperties(ServiceBusDataSourceProperties):  # pylint: disable=name-too-long
