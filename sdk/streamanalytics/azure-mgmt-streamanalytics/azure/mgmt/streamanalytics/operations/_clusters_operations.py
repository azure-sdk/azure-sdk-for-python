...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.StreamAnalytics/clusters")
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
    }
...
def build_list_streaming_jobs_request(
    resource_group_name: str, cluster_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ClustersOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type cluster_name: str
        :param cluster: The definition of the cluster that will be used to create a new cluster or
         replace the existing one. Is either a Cluster type or a IO[bytes] type. Required.
        :type cluster: ~azure.mgmt.streamanalytics.models.Cluster or IO[bytes]
        :param if_match: The ETag of the resource. Omit this value to always overwrite the current
         record set. Specify the last-seen ETag value to prevent accidentally overwriting concurrent
         changes. Default value is None.
        :type if_match: str
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type cluster_name: str
        :param cluster: The properties specified here will overwrite the corresponding properties in
         the existing cluster (ie. Those properties will be updated). Is either a Cluster type or a
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.Cluster"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.streamanalytics.models.Cluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_streaming_jobs(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.streamanalytics.models.ClusterJob]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
