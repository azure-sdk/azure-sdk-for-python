...
class TestStreamAnalyticsManagementStreamingJobsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_begin_create_or_replace(self, resource_group):
        response = await (
            await self.client.streaming_jobs.begin_create_or_replace(
    ...
    async def test_update(self, resource_group):
        response = await self.client.streaming_jobs.update(
            resource_group_name=resource_group.name,
            job_name="str",
            streaming_job={
                "cluster": {"id": "str"},
    ...
    async def test_begin_delete(self, resource_group):
        response = await (
            await self.client.streaming_jobs.begin_delete(
                resource_group_name=resource_group.name,
                job_name="str",
                api_version="2020-03-01",
            )
    ...
    async def test_get(self, resource_group):
        response = await self.client.streaming_jobs.get(
            resource_group_name=resource_group.name,
            job_name="str",
            api_version="2020-03-01",
        )
    ...
    async def test_begin_start(self, resource_group):
        response = await (
            await self.client.streaming_jobs.begin_start(
                resource_group_name=resource_group.name,
                job_name="str",
                api_version="2020-03-01",
            )
    ...
    async def test_begin_stop(self, resource_group):
        response = await (
            await self.client.streaming_jobs.begin_stop(
                resource_group_name=resource_group.name,
                job_name="str",
                api_version="2020-03-01",
            )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_begin_scale(self, resource_group):
        response = await (
            await self.client.streaming_jobs.begin_scale(
                resource_group_name=resource_group.name,
                job_name="str",
                api_version="2020-03-01",
            )
