...
def build_list_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.NetworkFunction/azureTrafficCollectors"
...
class AzureTrafficCollectorsBySubscriptionOperations:  # pylint: disable=name-too-long
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> Iterable["_models.AzureTrafficCollector"]:
