...
from ...operations._azure_traffic_collectors_operations import (
...
class AzureTrafficCollectorsOperations:
    ...
    async def _create_or_update_initial(
        ...
        data_subnet: Optional[_models.ResourceReference] = None,
        management_subnet: Optional[_models.ResourceReference] = None,
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
        ...
        _parameters = _models.AzureTrafficCollector(
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param data_subnet: Reference to the data subnet resource. This resource must be named
         'atcDataSubnet'. Default value is None.
        :type data_subnet: ~azure.mgmt.networkfunction.models.ResourceReference
        :param management_subnet: Reference to the management subnet resource. This resource must be
         named 'atcManagementSubnet'. Default value is None.
        :type management_subnet: ~azure.mgmt.networkfunction.models.ResourceReference
        :return: An instance of AsyncLROPoller that returns either AzureTrafficCollector or the result
         of cls(response)
        :rtype:
