...
def build_registrations_get_registration_request(  # pylint: disable=name-too-long
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/registrations/{registrationName}"
...
def build_registrations_create_or_update_registration_request(  # pylint: disable=name-too-long
    registration_name: str,
    *,
    if_unmodified_since: Optional[datetime.datetime] = None,
    if_modified_since: Optional[datetime.datetime] = None,
...
def build_registrations_list_registration_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class RegistrationsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~vdiregistration.VdiBatchRegistrationClient`'s
    ...
    def get_registration(
        ...
        *,
        ...
        match_condition: Optional[MatchConditions] = None,
        **kwargs: Any
    ) -> _models.GetRegistrationResponse:
        """Fetch a registration by name.

        :param registration_name: The registration name. Required.
        ...
        :return: GetRegistrationResponse. The GetRegistrationResponse is compatible with MutableMapping
        :rtype: ~vdiregistration.models.GetRegistrationResponse
        ...
        cls: ClsType[_models.GetRegistrationResponse] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.GetRegistrationResponse, response.json())
    ...
    def create_or_update_registration(
        ...
        *,
        ...
        match_condition: Optional[MatchConditions] = None,
        **kwargs: Any
    ) -> Union[_models.CreateOrUpdateRegistrationResponse, _models.CreateOrUpdateRegistrationResponse1]:
        """Create or update registration.

        :param registration_name: The registration name. Required.
        :type registration_name: str
        :param resource: The resource instance. Required.
        :type resource: ~vdiregistration.models.Registration
        ...
        :keyword match_condition: The match condition to use upon the etag. Default value is None.
        :paramtype match_condition: ~azure.core.MatchConditions
        :return: CreateOrUpdateRegistrationResponse or CreateOrUpdateRegistrationResponse1. The
         CreateOrUpdateRegistrationResponse is compatible with MutableMapping
        :rtype: ~vdiregistration.models.CreateOrUpdateRegistrationResponse or
         ~vdiregistration.models.CreateOrUpdateRegistrationResponse1
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def create_or_update_registration(
        self,
        registration_name: str,
        resource: Union[_models.Registration, JSON, IO[bytes]],
        *,
        if_unmodified_since: Optional[datetime.datetime] = None,
        if_modified_since: Optional[datetime.datetime] = None,
        etag: Optional[str] = None,
        ...
        **kwargs: Any
        ...
        :param resource: The resource instance. Is one of the following types: Registration, JSON,
         IO[bytes] Required.
        :type resource: ~vdiregistration.models.Registration or JSON or IO[bytes]
        :keyword if_unmodified_since: The request should only proceed if the entity was not modified
         after this time. Default value is None.
        :paramtype if_unmodified_since: ~datetime.datetime
        :keyword if_modified_since: The request should only proceed if the entity was modified after
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Union[_models.CreateOrUpdateRegistrationResponse, _models.CreateOrUpdateRegistrationResponse1]] = (
            kwargs.pop("cls", None)
        )
        ...
        _request = build_registrations_create_or_update_registration_request(
            registration_name=registration_name,
            if_unmodified_since=if_unmodified_since,
            if_modified_since=if_modified_since,
            etag=etag,
        ...
        if response.status_code == 200:
            ...
            if _stream:
                ...
                deserialized = _deserialize(_models.CreateOrUpdateRegistrationResponse1, response.json())
        ...
        if response.status_code == 201:
            ...
            if _stream:
                ...
                deserialized = _deserialize(_models.CreateOrUpdateRegistrationResponse, response.json())
    ...
    @distributed_trace
    def delete_registration(  # pylint: disable=inconsistent-return-statements
        self,
        registration_name: str,
        *,
        if_unmodified_since: Optional[datetime.datetime] = None,
    ...
    @distributed_trace
    def list_registration(self, **kwargs: Any) -> Iterable["_models.Registration"]:
        """List registration resources.

        :return: An iterator like instance of Registration
        :rtype: ~azure.core.paging.ItemPaged[~vdiregistration.models.Registration]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_registrations_list_registration_request(
                    api_version=self._config.api_version,
                    headers=_headers,
                    params=_params,
                )
