...
class VdiBatchRegistrationClientConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long
    """Configuration for VdiBatchRegistrationClient.
    ...
    def __init__(
        ...
        kwargs.setdefault("sdk_moniker", "vdiregistration/{}".format(VERSION))
