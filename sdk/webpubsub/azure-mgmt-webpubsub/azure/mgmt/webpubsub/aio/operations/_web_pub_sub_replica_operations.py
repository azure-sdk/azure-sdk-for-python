...
class WebPubSubReplicaOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`web_pub_sub_replica` attribute.
    """
    ...
    shared_private_link_resources_list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SignalRService/webPubSub/{resourceName}/replicas/{replicaName}/sharedPrivateLinkResources"
    }

    @distributed_trace_async
    async def shared_private_link_resources_get(
        self,
    ...
    shared_private_link_resources_get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SignalRService/webPubSub/{resourceName}/replicas/{replicaName}/sharedPrivateLinkResources/{sharedPrivateLinkResourceName}"
    }

    async def _shared_private_link_resources_create_or_update_initial(
        self,
        resource_group_name: str,
        resource_name: str,
        replica_name: str,
    ...
    @overload
    async def begin_shared_private_link_resources_create_or_update(
        self,
        resource_group_name: str,
        resource_name: str,
        replica_name: str,
    ...
    async def begin_shared_private_link_resources_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = await self._shared_private_link_resources_create_or_update_initial(
                resource_group_name=resource_group_name,
                resource_name=resource_name,
                replica_name=replica_name,
                shared_private_link_resource_name=shared_private_link_resource_name,
