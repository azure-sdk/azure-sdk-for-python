...
# USAGE
    python web_pub_sub_custom_certificates_create_or_update.py
...
def main():
    ...
    response = client.web_pub_sub_custom_certificates.begin_create_or_update(
...
# x-ms-original-file: specification/webpubsub/resource-manager/Microsoft.SignalRService/preview/2024-04-01-preview/examples/WebPubSubCustomCertificates_CreateOrUpdate.json
