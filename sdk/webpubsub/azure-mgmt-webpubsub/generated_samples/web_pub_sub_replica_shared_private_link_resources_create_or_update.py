...
# USAGE
    python web_pub_sub_replica_shared_private_link_resources_create_or_update.py
...
def main():
    ...
    response = client.web_pub_sub_replica.begin_shared_private_link_resources_create_or_update(
...
# x-ms-original-file: specification/webpubsub/resource-manager/Microsoft.SignalRService/preview/2024-01-01-preview/examples/WebPubSubReplica_SharedPrivateLinkResources_CreateOrUpdate.json
