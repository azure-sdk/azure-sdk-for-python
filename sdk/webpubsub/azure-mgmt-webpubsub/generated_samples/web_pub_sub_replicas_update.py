...
# USAGE
    python web_pub_sub_replicas_update.py
...
def main():
    ...
    response = client.web_pub_sub_replicas.begin_update(
...
# x-ms-original-file: specification/webpubsub/resource-manager/Microsoft.SignalRService/preview/2024-04-01-preview/examples/WebPubSubReplicas_Update.json
