...
def build_get_request(resource_scope: str, *, filter: str, **kwargs: Any) -> HttpRequest:
...
class ReservationRecommendationDetailsOperations:
    ...
    @distributed_trace
    def get(
        self, resource_scope: str, filter: str, **kwargs: Any
        ...
        :param filter: Used to filter reservation recommendation details by: properties/scope with
         allowed values ['Single', 'Shared']; properties/savings/lookBackPeriod with allowed values [7,
         30, 60]; properties/savings/reservationOrderTerm with allowed values ['P1Y', 'P3Y'];
