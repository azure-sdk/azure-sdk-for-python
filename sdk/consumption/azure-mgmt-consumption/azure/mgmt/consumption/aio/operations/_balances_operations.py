...
from ...operations._balances_operations import (
    build_get_by_billing_account_request,
    build_get_for_billing_period_by_billing_account_request,
)
...
class BalancesOperations:
    ...
    @distributed_trace_async
    async def get_for_billing_period_by_billing_account(  # pylint: disable=name-too-long
