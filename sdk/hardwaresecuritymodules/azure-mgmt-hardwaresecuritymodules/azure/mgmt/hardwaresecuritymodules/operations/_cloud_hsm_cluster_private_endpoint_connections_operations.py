...
def build_create_request(
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2022-08-31-preview"))
    ...
    path_format_arguments = {
        ...
        "peConnectionName": _SERIALIZER.url(
            "pe_connection_name",
            pe_connection_name,
            "str",
            max_length=24,
...
class CloudHsmClusterPrivateEndpointConnectionsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.hardwaresecuritymodules.AzureHSMResourceProvider`'s
