...
def build_cloud_hsm_clusters_list_by_cloud_hsm_cluster_request(  # pylint: disable=name-too-long
    resource_group_name: str, cloud_hsm_cluster_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_cloud_hsm_clusters_cloud_hsm_cluster_backup_status_get_request(  # pylint: disable=name-too-long
...
def build_cloud_hsm_clusters_cloud_hsm_cluster_restore_status_get_request(  # pylint: disable=name-too-long
    resource_group_name: str, cloud_hsm_cluster_name: str, job_id: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_dedicated_hsms_get_request(
...
def build_dedicated_hsms_create_or_update_request(  # pylint: disable=name-too-long
    resource_group_name: str, name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_dedicated_hsms_update_request(
    resource_group_name: str, name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_dedicated_hsms_delete_request(
    resource_group_name: str, name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_dedicated_hsms_list_by_resource_group_request(  # pylint: disable=name-too-long
...
def build_dedicated_hsms_list_by_subscription_request(  # pylint: disable=name-too-long
...
def build_dedicated_hsms_list_outbound_network_dependencies_endpoints_request(  # pylint: disable=name-too-long
    resource_group_name: str, name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class CloudHsmClustersOperations:
    ...
    def list_by_cloud_hsm_cluster(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_cloud_hsm_clusters_list_by_cloud_hsm_cluster_request(
                    resource_group_name=resource_group_name,
                    cloud_hsm_cluster_name=cloud_hsm_cluster_name,
                    subscription_id=self._config.subscription_id,
                    api_version=self._config.api_version,
    ...
    @distributed_trace
    def cloud_hsm_cluster_backup_status_get(
        ...
        _request = build_cloud_hsm_clusters_cloud_hsm_cluster_backup_status_get_request(
            resource_group_name=resource_group_name,
            cloud_hsm_cluster_name=cloud_hsm_cluster_name,
            job_id=job_id,
            subscription_id=self._config.subscription_id,
    ...
    @distributed_trace
    def cloud_hsm_cluster_restore_status_get(
        self, resource_group_name: str, cloud_hsm_cluster_name: str, job_id: str, **kwargs: Any
        ...
        _request = build_cloud_hsm_clusters_cloud_hsm_cluster_restore_status_get_request(
            resource_group_name=resource_group_name,
            cloud_hsm_cluster_name=cloud_hsm_cluster_name,
            job_id=job_id,
            subscription_id=self._config.subscription_id,
...
class DedicatedHsmsOperations:
    ...
    def get(self, resource_group_name: str, name: str, **kwargs: Any) -> _models.DedicatedHsm:
        ...
        _request = build_dedicated_hsms_get_request(
            resource_group_name=resource_group_name,
            name=name,
            subscription_id=self._config.subscription_id,
            api_version=self._config.api_version,
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _request = build_dedicated_hsms_create_or_update_request(
            resource_group_name=resource_group_name,
            name=name,
            subscription_id=self._config.subscription_id,
            content_type=content_type,
    ...
    def _update_initial(
        ...
        **kwargs: Any
        ...
        _request = build_dedicated_hsms_update_request(
            resource_group_name=resource_group_name,
            name=name,
            subscription_id=self._config.subscription_id,
            content_type=content_type,
    ...
    def _delete_initial(self, resource_group_name: str, name: str, **kwargs: Any) -> Iterator[bytes]:
        ...
        _request = build_dedicated_hsms_delete_request(
            resource_group_name=resource_group_name,
            name=name,
            subscription_id=self._config.subscription_id,
            api_version=self._config.api_version,
    ...
    def list_by_resource_group(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_dedicated_hsms_list_by_resource_group_request(
                    resource_group_name=resource_group_name,
                    subscription_id=self._config.subscription_id,
                    top=top,
                    api_version=self._config.api_version,
    ...
    def list_by_subscription(self, *, top: Optional[int] = None, **kwargs: Any) -> Iterable["_models.DedicatedHsm"]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_dedicated_hsms_list_by_subscription_request(
                    subscription_id=self._config.subscription_id,
                    top=top,
                    api_version=self._config.api_version,
                    headers=_headers,
    ...
    def list_outbound_network_dependencies_endpoints(  # pylint: disable=name-too-long
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_dedicated_hsms_list_outbound_network_dependencies_endpoints_request(
                    resource_group_name=resource_group_name,
                    name=name,
                    subscription_id=self._config.subscription_id,
                    api_version=self._config.api_version,
