...
def build_create_or_update_request(
    resource_group_name: str, dedicated_hsm_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})

    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2024-06-30"))
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HardwareSecurityModules/dedicatedHSMs/{dedicatedHsmName}",
    )  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url(
            "resource_group_name", resource_group_name, "str", max_length=90, min_length=1
        ),
        "dedicatedHsmName": _SERIALIZER.url(
            "dedicated_hsm_name", dedicated_hsm_name, "str", pattern=r"^[a-zA-Z0-9-]{3,24}$"
        ),
...
def build_list_outbound_network_dependencies_endpoints_request(  # pylint: disable=name-too-long
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HardwareSecurityModules/dedicatedHSMs/{dedicatedHsmName}/outboundNetworkDependenciesEndpoints",
    )  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url(
            "resource_group_name", resource_group_name, "str", max_length=90, min_length=1
...
class DedicatedHsmOperations:
    ...
    def _create_or_update_initial(
        ...
        dedicated_hsm_name: str,
        parameters: Union[_models.DedicatedHsm, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        ...
        _request = build_create_or_update_request(
            ...
            dedicated_hsm_name=dedicated_hsm_name,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param dedicated_hsm_name: Name of the dedicated Hsm. Required.
        :type dedicated_hsm_name: str
    ...
    def _update_initial(
        self, resource_group_name: str, dedicated_hsm_name: str, tags: Optional[Dict[str, str]] = None, **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def _delete_initial(self, resource_group_name: str, dedicated_hsm_name: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    @distributed_trace
    def begin_delete(self, resource_group_name: str, dedicated_hsm_name: str, **kwargs: Any) -> LROPoller[None]:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, dedicated_hsm_name: str, **kwargs: Any) -> _models.DedicatedHsm:
    ...
    def list_outbound_network_dependencies_endpoints(  # pylint: disable=name-too-long
        self, resource_group_name: str, dedicated_hsm_name: str, **kwargs: Any
