...
class DedicatedHsmOperations:
    ...
    def _create_or_update_initial(
        self, resource_group_name: str, parameters: Union[_models.DedicatedHsm, IO[bytes]], **kwargs: Any
    ...
    def _update_initial(
        self, resource_group_name: str, tags: Optional[Dict[str, str]] = None, **kwargs: Any
    ) -> _models.DedicatedHsm:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    @distributed_trace
    def get(self, resource_group_name: str, **kwargs: Any) -> _models.DedicatedHsm:
