...
def build_pre_backup_request(
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HardwareSecurityModules/cloudHsmClusters/{cloudHsmClusterName}/prebackup",
    )  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url(
...
def build_pre_restore_request(
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HardwareSecurityModules/cloudHsmClusters/{cloudHsmClusterName}/prerestore",
    )  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url(
    ...
    def _pre_backup_initial(
        ...
        **kwargs: Any
        ...
        if response.status_code == 200:
            ...
            deserialized = self._deserialize("BackupResult", pipeline_response)
    ...
    def begin_pre_backup(
        ...
        **kwargs: Any
        ...
        :param cloud_hsm_cluster_name: The name of the Cloud HSM Cluster within the specified resource
         group. Cloud HSM Cluster names must be between 3 and 24 characters in length. Required.
        :type cloud_hsm_cluster_name: str
        :param backup_request_properties: Azure Storage blob container URI. Default value is None.
    ...
    def begin_pre_backup(
        ...
        **kwargs: Any
        ...
        :param cloud_hsm_cluster_name: The name of the Cloud HSM Cluster within the specified resource
         group. Cloud HSM Cluster names must be between 3 and 24 characters in length. Required.
        :type cloud_hsm_cluster_name: str
        :param backup_request_properties: Azure Storage blob container URI. Is either a
    ...
    def begin_restore(
        ...
        **kwargs: Any
        ...
        :param cloud_hsm_cluster_name: The name of the Cloud HSM Cluster within the specified resource
         group. Cloud HSM Cluster names must be between 3 and 24 characters in length. Required.
        :type cloud_hsm_cluster_name: str
        :param restore_request_properties: Backup Operation Required properties. Required.
        :type restore_request_properties:
         ~azure.mgmt.hardwaresecuritymodules.models.RestoreRequestProperties
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
    ...
    def begin_restore(
        ...
        **kwargs: Any
        ...
        :param cloud_hsm_cluster_name: The name of the Cloud HSM Cluster within the specified resource
         group. Cloud HSM Cluster names must be between 3 and 24 characters in length. Required.
        :type cloud_hsm_cluster_name: str
        :param restore_request_properties: Backup Operation Required properties. Is either a
