...
class CloudHsmCluster(CloudHsmClusterResource):  # pylint: disable=too-many-instance-attributes
    ...
    _attribute_map = {
        ...
        "security_domain": {"key": "properties.securityDomain", "type": "CloudHsmClusterSecurityDomainProperties"},
        "hsms": {"key": "properties.hsms", "type": "[CloudHsmProperties]"},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype private_endpoint_connections:
         list[~azure.mgmt.hardwaresecuritymodules.models.PrivateEndpointConnection]
        """
        super().__init__(tags=tags, location=location, sku=sku, **kwargs)
...
class DedicatedHsm(DedicatedHsmResource):  # pylint: disable=too-many-instance-attributes
    """Resource information with extended details.
