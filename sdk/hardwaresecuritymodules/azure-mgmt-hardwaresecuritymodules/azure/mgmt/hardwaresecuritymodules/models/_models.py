...
class BackupParameterBody(_Model):
    """BackupParameterBody.

    :ivar backup_request_properties: Azure storage Resource Uri.
    :vartype backup_request_properties:
     ~azure.mgmt.hardwaresecuritymodules.models.BackupRequestProperties
    """

    backup_request_properties: Optional["_models.BackupRequestProperties"] = rest_field(
        name="backupRequestProperties", visibility=["read", "create", "update", "delete", "query"]
    )
...
class RestoreResult(_Model):
    ...
    __flattened_items = ["status", "status_details", "error", "start_time", "end_time", "job_id"]
...
class ValidateBackupPropertiesParameterBody(_Model):
    """ValidateBackupPropertiesParameterBody.

    :ivar backup_request_properties: Backup Operation Required properties.
    :vartype backup_request_properties:
     ~azure.mgmt.hardwaresecuritymodules.models.BackupRequestProperties
    """
...
class ValidateRestorePropertiesParameterBody(_Model):
    """ValidateRestorePropertiesParameterBody.

    :ivar restore_request_properties: Optional Parameters to validate prior performing a restore
     operation.
    :vartype restore_request_properties:
     ~azure.mgmt.hardwaresecuritymodules.models.RestoreRequestProperties
    """

    restore_request_properties: Optional["_models.RestoreRequestProperties"] = rest_field(
        name="restoreRequestProperties", visibility=["read", "create", "update", "delete", "query"]
    )
