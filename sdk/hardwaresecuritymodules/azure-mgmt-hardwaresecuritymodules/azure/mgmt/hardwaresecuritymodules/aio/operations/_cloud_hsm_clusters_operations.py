...
from ...operations._cloud_hsm_clusters_operations import (
    ...
    build_validate_backup_request,
    build_validate_restore_request,
)
...
class CloudHsmClustersOperations:
    ...
    async def _validate_backup_initial(
        self,
        resource_group_name: str,
        cloud_hsm_cluster_name: str,
    ...
    @overload
    async def begin_validate_backup(
        self,
        resource_group_name: str,
        cloud_hsm_cluster_name: str,
    ...
    async def begin_validate_backup(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._validate_backup_initial(
                resource_group_name=resource_group_name,
                cloud_hsm_cluster_name=cloud_hsm_cluster_name,
    ...
    async def _validate_restore_initial(
        ...
        **kwargs: Any
        ...
        _request = build_validate_restore_request(
            resource_group_name=resource_group_name,
            cloud_hsm_cluster_name=cloud_hsm_cluster_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
