...
from ...operations._cloud_hsm_cluster_backup_status_operations import build_get_request
...
class CloudHsmClusterBackupStatusOperations:
    ...
    async def get(
        ...
        :type job_id: str
        :return: BackupResult or the result of cls(response)
        :rtype: ~azure.mgmt.hardwaresecuritymodules.models.BackupResult
