...
from ._configuration import AzureHSMResourceProviderConfiguration
...
class AzureHSMResourceProvider:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = AzureHSMResourceProviderConfiguration(
    ...
    def __enter__(self) -> "AzureHSMResourceProvider":
