...
def main():
    ...
    response = client.cloud_hsm_clusters.begin_validate_backup(
...
# x-ms-original-file: specification/hardwaresecuritymodules/resource-manager/Microsoft.HardwareSecurityModules/stable/2024-06-30/examples/CloudHsmCluster_CreateOrValidate_Backup_MaximumSet_Gen.json
