...
def main():
    ...
    response = client.cloud_hsm_clusters_backup_status.get(
...
# x-ms-original-file: specification/hardwaresecuritymodules/resource-manager/Microsoft.HardwareSecurityModules/stable/2024-06-30/examples/CloudHsmCluster_Backup_Pending_MaximumSet_Gen.json
