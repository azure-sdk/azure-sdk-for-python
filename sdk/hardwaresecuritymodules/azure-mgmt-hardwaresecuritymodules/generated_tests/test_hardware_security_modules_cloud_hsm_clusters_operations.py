...
class TestHardwareSecurityModulesCloudHsmClustersOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_cloud_hsm_clusters_list_by_cloud_hsm_cluster(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_cloud_hsm_clusters_cloud_hsm_cluster_backup_status_get(self, resource_group):
        response = self.client.cloud_hsm_clusters.cloud_hsm_cluster_backup_status_get(
            resource_group_name=resource_group.name,
            cloud_hsm_cluster_name="str",
            job_id="str",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_cloud_hsm_clusters_cloud_hsm_cluster_restore_status_get(self, resource_group):
        response = self.client.cloud_hsm_clusters.cloud_hsm_cluster_restore_status_get(
            resource_group_name=resource_group.name,
            cloud_hsm_cluster_name="str",
            job_id="str",
        )
