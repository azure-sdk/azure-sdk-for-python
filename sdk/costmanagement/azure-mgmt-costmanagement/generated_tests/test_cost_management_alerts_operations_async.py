...
class TestCostManagementAlertsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_alerts_list(self, resource_group):
        response = await self.client.alerts.list(
            scope="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_alerts_dismiss(self, resource_group):
        response = await self.client.alerts.dismiss(
            scope="str",
            alert_id="str",
            parameters={
                "closeTime": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_alerts_list_external(self, resource_group):
        response = await self.client.alerts.list_external(
