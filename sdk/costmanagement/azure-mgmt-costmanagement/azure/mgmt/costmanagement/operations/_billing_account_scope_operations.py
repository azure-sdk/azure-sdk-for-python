...
def build_generate_benefit_utilization_summaries_report_request(billing_account_id: str, **kwargs: Any) -> HttpRequest:
...
class BillingAccountScopeOperations:
    ...
    def _generate_benefit_utilization_summaries_report_initial(
        self,
    ...
    @overload
    def begin_generate_benefit_utilization_summaries_report(
        self,
        billing_account_id: str,
