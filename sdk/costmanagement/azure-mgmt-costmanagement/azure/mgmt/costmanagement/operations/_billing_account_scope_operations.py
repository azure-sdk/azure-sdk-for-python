...
def build_generate_benefit_utilization_summaries_report_request(  # pylint: disable=name-too-long
...
class BillingAccountScopeOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`billing_account_scope` attribute.
    """
    ...
    def _generate_benefit_utilization_summaries_report_initial(  # pylint: disable=name-too-long
        self,
    ...
    @overload
    def begin_generate_benefit_utilization_summaries_report(  # pylint: disable=name-too-long
        self,
        billing_account_id: str,
    ...
    def begin_generate_benefit_utilization_summaries_report(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = self._generate_benefit_utilization_summaries_report_initial(
                billing_account_id=billing_account_id,
