...
def build_download_by_billing_account_request(
...
class PriceSheetOperations:
    ...
    def begin_download_by_billing_profile(
        ...
        Customer Agreement.
         ...
         You can use the new 2023-09-01 API version for billing periods December 2022 onwards. Azure
    ...
    def begin_download_by_billing_account(
        ...
        '/providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingPeriods/{billingPeriodName}/providers/Microsoft.CostManagement/pricesheets/default/download'
        for billing periods December 2022 onwards. With a new schema detailed below, the new price
        sheet provides more information and includes prices for Azure Reserved Instances (RI) for the
