...
class CompressionModeType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Allow customers to select compress data(gzip) for exports. This setting will enable destination
...
class DestinationType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """The export delivery destination type. Currently only 'AzureBlob' and 'MicrosoftFabric' is
    supported.  If no value is provided it will default to 'AzureBlob'.
    """
...
class StatusType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    'SystemSuspended' can only be set by export service.
    """
