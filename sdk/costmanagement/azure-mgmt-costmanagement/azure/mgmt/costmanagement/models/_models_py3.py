...
class CommonExportProperties(_serialization.Model):
    ...
    :ivar format: The format of the export being delivered. Known values are: "Csv", "Parquet", and
     "Delta".
    ...
    :ivar compression_mode: Allow customers to select compress data(gzip) for exports. This setting
     will enable destination file compression scheme at runtime. By default set to None. Known
     values are: "gzip" and "None".
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword format: The format of the export being delivered. Known values are: "Csv", "Parquet",
         and "Delta".
        ...
        :paramtype data_overwrite_behavior: str or
         ~azure.mgmt.costmanagement.models.DataOverwriteBehaviorType
        :keyword compression_mode: Allow customers to select compress data(gzip) for exports. This
         setting will enable destination file compression scheme at runtime. By default set to None.
         Known values are: "gzip" and "None".
        ...
        self.system_suspension_context = None
...
class EAPriceSheetProperties(_serialization.Model):
    """The properties of the EA price sheet. Properties supported with version 2024-10-01-preview are
    as below.
...
class ExportDatasetConfiguration(_serialization.Model):
    ...
    :ivar columns: This is on path to deprecation and will not be supported going forward.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword columns: This is on path to deprecation and will not be supported going forward.
...
class ExportDeliveryDestination(_serialization.Model):
    ...
    :ivar type: The export delivery destination type. Currently only 'AzureBlob' and
     'MicrosoftFabric' is supported.  If no value is provided it will default to 'AzureBlob'. Known
     values are: "AzureBlob" and "MicrosoftFabric".
    ...
    :ivar microsoft_fabric_settings: The settings for the Microsoft Fabric destination.  This is
     only applicable when destination.type == 'MicrosoftFabric'.
    :vartype microsoft_fabric_settings:
     ~azure.mgmt.costmanagement.models.MicrosoftFabricDestinationSettings
    """
    ...
    _attribute_map = {
        ...
        "microsoft_fabric_settings": {"key": "microsoftFabricSettings", "type": "MicrosoftFabricDestinationSettings"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        microsoft_fabric_settings: Optional["_models.MicrosoftFabricDestinationSettings"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword type: The export delivery destination type. Currently only 'AzureBlob' and
         'MicrosoftFabric' is supported.  If no value is provided it will default to 'AzureBlob'. Known
         values are: "AzureBlob" and "MicrosoftFabric".
        ...
        :keyword microsoft_fabric_settings: The settings for the Microsoft Fabric destination.  This is
         only applicable when destination.type == 'MicrosoftFabric'.
        :paramtype microsoft_fabric_settings:
         ~azure.mgmt.costmanagement.models.MicrosoftFabricDestinationSettings
        """
        super().__init__(**kwargs)
        self.type = type
        ...
        self.microsoft_fabric_settings = microsoft_fabric_settings
...
class ExportSchedule(_serialization.Model):
    ...
    :ivar status: The status of the export's schedule. If 'Inactive', the export's schedule is
     paused. 'SystemSuspended' can only be set by export service. Known values are: "Active",
     "Inactive", and "SystemSuspended".
...
class ExportTimePeriod(_serialization.Model):
    ...
    'Custom'. The maximum date range is 1 month.
...
class FabricLakehouse(_serialization.Model):
    """This represents the fabric lakehouse identifier.

    :ivar id: The identifier of the fabric lakehouse.
    :vartype id: str
    :ivar display_name: The display name of the fabric lakehouse.  This is only returned in Get
     operations.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword id: The identifier of the fabric lakehouse.
        :paramtype id: str
        :keyword display_name: The display name of the fabric lakehouse.  This is only returned in Get
         operations.
...
class FabricWorkspace(_serialization.Model):
    """This represents the fabric workspace identifier.

    :ivar id: The identifier of the fabric workspace.
    :vartype id: str
    :ivar display_name: The display name of the fabric workspace.  This is only returned in Get
     operations.
    :vartype display_name: str
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword id: The identifier of the fabric workspace.
        :paramtype id: str
        :keyword display_name: The display name of the fabric workspace.  This is only returned in Get
         operations.
        :paramtype display_name: str
        """
        super().__init__(**kwargs)
...
class MicrosoftFabricDestinationSettings(_serialization.Model):
    """This represents the fabric specific settings for export destination when delivery info type is
    'MicrosoftFabric'.

    :ivar workspace: The Microsoft Fabric Workspace Identifier.
    :vartype workspace: ~azure.mgmt.costmanagement.models.FabricWorkspace
    :ivar lakehouse: The Microsoft Fabric Lakehouse Identifier.
    :vartype lakehouse: ~azure.mgmt.costmanagement.models.FabricLakehouse
    :ivar table_name: The name of the Microsoft Fabric Lakehouse Delta table where export data will
     be ingested to.
    :vartype table_name: str
    """

    _attribute_map = {
        "workspace": {"key": "workspace", "type": "FabricWorkspace"},
        "lakehouse": {"key": "lakehouse", "type": "FabricLakehouse"},
    ...
    def __init__(
        self,
        *,
        workspace: Optional["_models.FabricWorkspace"] = None,
        lakehouse: Optional["_models.FabricLakehouse"] = None,
        table_name: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword workspace: The Microsoft Fabric Workspace Identifier.
        :paramtype workspace: ~azure.mgmt.costmanagement.models.FabricWorkspace
        :keyword lakehouse: The Microsoft Fabric Lakehouse Identifier.
        :paramtype lakehouse: ~azure.mgmt.costmanagement.models.FabricLakehouse
        :keyword table_name: The name of the Microsoft Fabric Lakehouse Delta table where export data
         will be ingested to.
...
class SavingsPlanUtilizationSummary(BenefitUtilizationSummary):
    ...
    :ivar avg_utilization_percentage: This is the average hourly utilization for each date range
     ...
     2024-10-01-preview and usageDate < 2022-10-31 at a daily granularity. There will be one record
