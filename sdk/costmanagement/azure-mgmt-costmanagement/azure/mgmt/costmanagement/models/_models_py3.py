...
class QueryDataset(_serialization.Model):
    ...
    :ivar include: Array of extra properties in the query. currently use for tag data for resource.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword include: Array of extra properties in the query. currently use for tag data for
         resource.
