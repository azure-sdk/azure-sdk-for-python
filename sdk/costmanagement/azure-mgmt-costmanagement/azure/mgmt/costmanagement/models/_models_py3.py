...
class CommonExportProperties(_serialization.Model):
    ...
    :ivar compression_mode: Allow customers to select compress data(gzip, snappy) for exports. This
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype data_overwrite_behavior: str or
         ~azure.mgmt.costmanagement.models.DataOverwriteBehaviorType
        :keyword compression_mode: Allow customers to select compress data(gzip, snappy) for exports.
         This setting will enable destination file compression scheme at runtime. By default set to
         None. Known values are: "gzip", "snappy", and "None".
...
class ExportSuspensionContext(_serialization.Model):
    """The properties of the export suspension context. This is not populated currently.
