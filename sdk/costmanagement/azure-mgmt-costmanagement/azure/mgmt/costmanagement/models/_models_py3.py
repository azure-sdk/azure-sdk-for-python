...
class EAPriceSheetProperties(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    """The properties of the EA price sheet. Properties added with version 2023-11-01 are marked with
    *.
    ...
    :vartype sku_id: str
    :ivar unit_of_measure: How usage is measured for the service. [1] The field “Unit” has been
    ...
    :ivar base_price: The unit price at the time the customer signs on or the unit price at the
     time of service meter GA launch if it is after sign-on. May appear as null or 0 where not
     applicable. Base price is unavailable for ReservedInstance meters.
...
class OperationStatusAutoGenerated(_serialization.Model):
    ...
    :vartype download_url: str
    :ivar valid_till: Download link validity. The URI is available for use for 1 hour.
    :vartype valid_till: ~datetime.datetime
...
class SavingsPlanUtilizationSummary(BenefitUtilizationSummary):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar avg_utilization_percentage: This is the average hourly utilization for each date range
     ...
     2023-11-01 and usageDate < 2022-10-31 at a daily granularity. There will be one record per
