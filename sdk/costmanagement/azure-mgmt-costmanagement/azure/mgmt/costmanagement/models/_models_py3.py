...
class CostDetailsOperationResults(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype error: ~azure.mgmt.costmanagement.models.ErrorDetailsWithIntegerCode
    ...
    _attribute_map = {
        ...
        "error": {"key": "error", "type": "ErrorDetailsWithIntegerCode"},
    ...
    def __init__(
        ...
        *,
        ...
        error: Optional["_models.ErrorDetailsWithIntegerCode"] = None,
        ...
        **kwargs: Any
        ...
        :paramtype error: ~azure.mgmt.costmanagement.models.ErrorDetailsWithIntegerCode
...
class ErrorDetailsWithIntegerCode(_serialization.Model):
    """The details of the error.
...
class GenerateCostDetailsReportErrorResponse(_serialization.Model):
    ...
    *
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetailsWithIntegerCode"] = None, **kwargs: Any) -> None:
        """
        :keyword error: The details of the error.
        :paramtype error: ~azure.mgmt.costmanagement.models.ErrorDetailsWithIntegerCode
        """
