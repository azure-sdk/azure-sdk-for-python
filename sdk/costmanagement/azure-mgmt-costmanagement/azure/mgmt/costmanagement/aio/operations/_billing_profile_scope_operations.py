...
from ...operations._billing_profile_scope_operations import build_generate_benefit_utilization_summaries_report_request

T = TypeVar("T")
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]


class BillingProfileScopeOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`billing_profile_scope` attribute.
    """
    ...
    async def _generate_benefit_utilization_summaries_report_initial(  # pylint: disable=name-too-long
        self,
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(benefit_utilization_summaries_request, (IO, bytes)):
        ...
        request = build_generate_benefit_utilization_summaries_report_request(
            ...
            json=_json,
            content=_content,
            template_url=self._generate_benefit_utilization_summaries_report_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
    ...
    _generate_benefit_utilization_summaries_report_initial.metadata = {
    ...
    @overload
    async def begin_generate_benefit_utilization_summaries_report(  # pylint: disable=name-too-long
        self,
        billing_account_id: str,
        billing_profile_id: str,
    ...
    async def begin_generate_benefit_utilization_summaries_report(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = await self._generate_benefit_utilization_summaries_report_initial(
                billing_account_id=billing_account_id,
                billing_profile_id=billing_profile_id,
    ...
    begin_generate_benefit_utilization_summaries_report.metadata = {
        "url": "/providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingProfiles/{billingProfileId}/providers/Microsoft.CostManagement/generateBenefitUtilizationSummariesReport"
    }
