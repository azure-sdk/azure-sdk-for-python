...
class BenefitUtilizationSummariesAsyncOperations:
    ...
    async def get_operation_status_billing_account_scope(  # pylint: disable=name-too-long
    ...
    @distributed_trace_async
    async def get_operation_status_billing_profile_scope(  # pylint: disable=name-too-long
    ...
    @distributed_trace_async
    async def get_operation_status_reservation_order_scope(  # pylint: disable=name-too-long
    ...
    @distributed_trace_async
    async def get_operation_status_savings_plan_order_scope(  # pylint: disable=name-too-long
