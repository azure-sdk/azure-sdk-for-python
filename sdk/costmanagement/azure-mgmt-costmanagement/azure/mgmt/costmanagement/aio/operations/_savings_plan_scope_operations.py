...
class SavingsPlanScopeOperations:
    ...
    async def _generate_benefit_utilization_summaries_report_async_initial(  # pylint: disable=name-too-long
        self,
    ...
    @overload
    async def begin_generate_benefit_utilization_summaries_report_async(  # pylint: disable=name-too-long
        self,
        savings_plan_order_id: str,
        savings_plan_id: str,
