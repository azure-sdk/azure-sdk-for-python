...
class ExtendedZone(ProxyResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar display_name: Display name of the Azure Extended Zone.
    :vartype display_name: str
    :ivar regional_display_name: Regional display name of the Azure Extended Zone.
    :vartype regional_display_name: str
    :ivar region_type: Type of region for the Azure Extended Zone.
    :vartype region_type: str
    :ivar region_category: Category of region for the Azure Extended Zone.
    :vartype region_category: str
    :ivar geography: Geography of the Azure Extended Zone.
    :vartype geography: str
    :ivar geography_group: The Geography Group of the Azure Extended Zone.
    :vartype geography_group: str
    :ivar longitude: The Longitude of the Azure Extended Zone.
    :vartype longitude: str
    :ivar latitude: The Latitude of the Azure Extended Zone.
    :vartype latitude: str
    :ivar home_location: The Home Location of the Azure Extended Zone.
