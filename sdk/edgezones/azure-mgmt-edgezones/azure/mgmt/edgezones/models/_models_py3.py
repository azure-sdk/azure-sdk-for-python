...
class ExtendedZoneProperties(_serialization.Model):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.registration_state: Optional[Union[str, "_models.RegistrationState"]] = None
        self.display_name: Optional[str] = None
        self.regional_display_name: Optional[str] = None
        self.region_type: Optional[str] = None
        self.region_category: Optional[str] = None
