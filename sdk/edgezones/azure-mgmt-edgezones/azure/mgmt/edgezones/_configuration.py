...
class MicrosoftEdgeZonesConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    """Configuration for MicrosoftEdgeZones.
    ...
    def __init__(self, credential: "TokenCredential", subscription_id: str, **kwargs: Any) -> None:
        super(MicrosoftEdgeZonesConfiguration, self).__init__(**kwargs)
