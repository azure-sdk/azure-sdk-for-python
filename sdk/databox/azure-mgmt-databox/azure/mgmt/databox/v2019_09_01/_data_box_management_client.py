...
class DataBoxManagementClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.jobs = JobsOperations(self._client, self._config, self._serialize, self._deserialize, "2019-09-01")
        self.service = ServiceOperations(self._client, self._config, self._serialize, self._deserialize, "2019-09-01")
