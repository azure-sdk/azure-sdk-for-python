...
class DataBoxManagementClientOperationsMixin(DataBoxManagementClientMixinABC):
    ...
    def mitigate(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type mitigate_job_request: ~azure.mgmt.databox.v2022_10_01.models.MitigateJobRequest or
         IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("mitigate") or "2022-10-01")
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
