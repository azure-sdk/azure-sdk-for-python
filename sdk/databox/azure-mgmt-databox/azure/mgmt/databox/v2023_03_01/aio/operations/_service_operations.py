...
class ServiceOperations:
    ...
    def list_available_skus_by_resource_group(
        ...
        **kwargs: Any
        ...
        :type available_sku_request: ~azure.mgmt.databox.v2023_03_01.models.AvailableSkuRequest or IO
    ...
    async def validate_address(
        ...
        :param validate_address: Shipping address of the customer. Is either a ValidateAddress type or
         a IO type. Required.
        :type validate_address: ~azure.mgmt.databox.v2023_03_01.models.ValidateAddress or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def validate_inputs_by_resource_group(
        ...
        **kwargs: Any
        ...
        :param validation_request: Inputs of the customer. Is either a ValidationRequest type or a IO
         type. Required.
        :type validation_request: ~azure.mgmt.databox.v2023_03_01.models.ValidationRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def region_configuration(
        ...
        :type region_configuration_request:
         ~azure.mgmt.databox.v2023_03_01.models.RegionConfigurationRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
