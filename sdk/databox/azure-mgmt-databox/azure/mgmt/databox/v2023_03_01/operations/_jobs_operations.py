...
class JobsOperations:
    ...
    def list(self, skip_token: Optional[str] = None, **kwargs: Any) -> Iterable["_models.JobResource"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.databox.v2023_03_01.models.JobResource]
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either JobResource or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.databox.v2023_03_01.models.JobResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_credentials(
        ...
        :return: An iterator like instance of either UnencryptedCredentials or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.databox.v2023_03_01.models.UnencryptedCredentials]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
