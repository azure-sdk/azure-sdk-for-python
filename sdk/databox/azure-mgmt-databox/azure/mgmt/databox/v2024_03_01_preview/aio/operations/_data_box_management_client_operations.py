...
class DataBoxManagementClientOperationsMixin(DataBoxManagementClientMixinABC):
    ...
    async def mitigate(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type mitigate_job_request: ~azure.mgmt.databox.v2024_03_01_preview.models.MitigateJobRequest
    ...
    async def mitigate(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("mitigate") or "2024-03-01-preview")
        )
