...
class JobsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.databox.v2024_03_01_preview.aio.DataBoxManagementClient`'s
        :attr:`jobs` attribute.
    """
    ...
    def list(self, skip_token: Optional[str] = None, **kwargs: Any) -> AsyncIterable["_models.JobResource"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.databox.v2024_03_01_preview.models.JobResource]
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version or "2024-03-01-preview")
        )
    ...
    async def mark_devices_shipped(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type mark_devices_shipped_request:
         ~azure.mgmt.databox.v2024_03_01_preview.models.MarkDevicesShippedRequest
    ...
    async def mark_devices_shipped(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type mark_devices_shipped_request:
         ~azure.mgmt.databox.v2024_03_01_preview.models.MarkDevicesShippedRequest or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.databox.v2024_03_01_preview.models.JobResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type job_resource: ~azure.mgmt.databox.v2024_03_01_preview.models.JobResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either JobResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databox.v2024_03_01_preview.models.JobResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param job_resource: Job details from request body. Is either a JobResource type or a IO[bytes]
         type. Required.
        :type job_resource: ~azure.mgmt.databox.v2024_03_01_preview.models.JobResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either JobResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databox.v2024_03_01_preview.models.JobResource]
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type job_resource_update_parameter:
         ~azure.mgmt.databox.v2024_03_01_preview.models.JobResourceUpdateParameter
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type job_resource_update_parameter:
         ~azure.mgmt.databox.v2024_03_01_preview.models.JobResourceUpdateParameter or IO[bytes]
        :param if_match: Defines the If-Match condition. The patch will be performed only if the ETag
         of the job on the server matches this value. Default value is None.
        :type if_match: str
        :return: An instance of AsyncLROPoller that returns either JobResource or the result of
    ...
    async def book_shipment_pick_up(
        ...
        **kwargs: Any
        ...
        :type shipment_pick_up_request:
         ~azure.mgmt.databox.v2024_03_01_preview.models.ShipmentPickUpRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ShipmentPickUpResponse or the result of cls(response)
        :rtype: ~azure.mgmt.databox.v2024_03_01_preview.models.ShipmentPickUpResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def book_shipment_pick_up(
        ...
        **kwargs: Any
        ...
        :type shipment_pick_up_request:
         ~azure.mgmt.databox.v2024_03_01_preview.models.ShipmentPickUpRequest or IO[bytes]
        :return: ShipmentPickUpResponse or the result of cls(response)
        :rtype: ~azure.mgmt.databox.v2024_03_01_preview.models.ShipmentPickUpResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def cancel(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type cancellation_reason: ~azure.mgmt.databox.v2024_03_01_preview.models.CancellationReason
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None or the result of cls(response)
    ...
    async def cancel(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type cancellation_reason: ~azure.mgmt.databox.v2024_03_01_preview.models.CancellationReason or
         IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_credentials(
        ...
        :return: An iterator like instance of either UnencryptedCredentials or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.databox.v2024_03_01_preview.models.UnencryptedCredentials]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
