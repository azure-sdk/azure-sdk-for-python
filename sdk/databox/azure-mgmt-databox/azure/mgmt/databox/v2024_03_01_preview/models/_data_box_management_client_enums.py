...
class ModelName(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    is necessary only at the time of ordering the newer generation device i.e. DataBoxV2x100 and
    ...
    DATA_BOX_V2_X100 = "DataBoxV2x100"
    """Data Box V2 100TB."""
    DATA_BOX_V2_X500 = "DataBoxV2x500"
    """Data Box V2 500TB."""
