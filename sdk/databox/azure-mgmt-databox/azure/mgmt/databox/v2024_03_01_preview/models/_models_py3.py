...
class CreateOrderLimitForSubscriptionValidationRequest(ValidationInputRequest):  # pylint: disable=name-too-long
    ...
    :ivar model: Error, if any, in the stage. Known values are: "DataBox", "DataBoxDisk",
     "DataBoxHeavy", "DataBoxCustomerDisk", "DataBoxV2x100", and "DataBoxV2x500".
    :vartype model: str or ~azure.mgmt.databox.v2024_03_01_preview.models.ModelName
    """
...
class ScheduleAvailabilityRequest(_serialization.Model):
    ...
    :vartype country: str
    :ivar model: The model name. Known values are: "DataBox", "DataBoxDisk", "DataBoxHeavy",
     "DataBoxCustomerDisk", "DataBoxV2x100", and "DataBoxV2x500".
    :vartype model: str or ~azure.mgmt.databox.v2024_03_01_preview.models.ModelName
    """
...
class JobResource(Resource):  # pylint: disable=too-many-instance-attributes
    ...
    _validation = {
        ...
        "transfer_type": {"required": True, "readonly": True},
