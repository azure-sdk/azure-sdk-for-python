...
class DataBoxManagementClient(
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.jobs = JobsOperations(self._client, self._config, self._serialize, self._deserialize, "2021-03-01")
        self.service = ServiceOperations(self._client, self._config, self._serialize, self._deserialize, "2021-03-01")
