...
class JobsOperations:
    ...
    async def mark_devices_shipped(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type mark_devices_shipped_request:
         ~azure.mgmt.databox.v2022_02_01.models.MarkDevicesShippedRequest
    ...
    async def mark_devices_shipped(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type mark_devices_shipped_request:
         ~azure.mgmt.databox.v2022_02_01.models.MarkDevicesShippedRequest or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.databox.v2022_02_01.models.JobResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type job_resource: ~azure.mgmt.databox.v2022_02_01.models.JobResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param job_resource: Job details from request body. Is either a JobResource type or a IO[bytes]
         type. Required.
        :type job_resource: ~azure.mgmt.databox.v2022_02_01.models.JobResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either JobResource or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databox.v2022_02_01.models.JobResource]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type job_resource_update_parameter:
         ~azure.mgmt.databox.v2022_02_01.models.JobResourceUpdateParameter
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type job_resource_update_parameter:
         ~azure.mgmt.databox.v2022_02_01.models.JobResourceUpdateParameter or IO[bytes]
        :param if_match: Defines the If-Match condition. The patch will be performed only if the ETag
         of the job on the server matches this value. Default value is None.
        :type if_match: str
        :return: An instance of AsyncLROPoller that returns either JobResource or the result of
    ...
    async def book_shipment_pick_up(
        ...
        **kwargs: Any
        ...
        :type shipment_pick_up_request: ~azure.mgmt.databox.v2022_02_01.models.ShipmentPickUpRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ShipmentPickUpResponse or the result of cls(response)
        :rtype: ~azure.mgmt.databox.v2022_02_01.models.ShipmentPickUpResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def book_shipment_pick_up(
        ...
        **kwargs: Any
        ...
        :type shipment_pick_up_request: ~azure.mgmt.databox.v2022_02_01.models.ShipmentPickUpRequest or
         IO[bytes]
        :return: ShipmentPickUpResponse or the result of cls(response)
        :rtype: ~azure.mgmt.databox.v2022_02_01.models.ShipmentPickUpResponse
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def cancel(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type cancellation_reason: ~azure.mgmt.databox.v2022_02_01.models.CancellationReason
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None or the result of cls(response)
    ...
    async def cancel(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type cancellation_reason: ~azure.mgmt.databox.v2022_02_01.models.CancellationReason or
         IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
