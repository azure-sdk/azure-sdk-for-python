...
class DataBoxManagementClient(
    ...
    :vartype operations: azure.mgmt.databox.v2023_12_01.operations.Operations
    :ivar jobs: JobsOperations operations
    :vartype jobs: azure.mgmt.databox.v2023_12_01.operations.JobsOperations
    :ivar service: ServiceOperations operations
    :vartype service: azure.mgmt.databox.v2023_12_01.operations.ServiceOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.jobs = JobsOperations(self._client, self._config, self._serialize, self._deserialize, "2023-12-01")
        self.service = ServiceOperations(self._client, self._config, self._serialize, self._deserialize, "2023-12-01")
