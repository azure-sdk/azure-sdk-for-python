...
from .operations import Operations, SharedPrivateLinkResourcesOperations, TargetsOperations, WatchersOperations
...
class MicrosoftDatabaseWatcher:  # pylint: disable=client-accepts-api-version-keyword
    ...
    async def __aenter__(self) -> "MicrosoftDatabaseWatcher":
