...
class WatchersOperations:
    ...
    async def _start_initial(self, resource_group_name: str, watcher_name: str, **kwargs: Any) -> Optional[JSON]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    async def _stop_initial(self, resource_group_name: str, watcher_name: str, **kwargs: Any) -> Optional[JSON]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
