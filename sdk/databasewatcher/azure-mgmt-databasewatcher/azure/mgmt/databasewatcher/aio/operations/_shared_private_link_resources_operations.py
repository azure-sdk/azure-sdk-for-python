...
class SharedPrivateLinkResourcesOperations:
    ...
    def list_by_watcher(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_by_watcher_request(
                    resource_group_name=resource_group_name,
                    watcher_name=watcher_name,
                    subscription_id=self._config.subscription_id,
                    api_version=api_version,
                    template_url=self.list_by_watcher.metadata["url"],
                    headers=_headers,
                    params=_params,
                )
    ...
    list_by_watcher.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DatabaseWatcher/watchers/{watcherName}/sharedPrivateLinkResources"
    }
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DatabaseWatcher/watchers/{watcherName}/sharedPrivateLinkResources/{sharedPrivateLinkResourceName}"
    }
    ...
    async def _create_initial(
        ...
        resource: Union[_models.SharedPrivateLinkResource, IO],
        **kwargs: Any
    ) -> _models.SharedPrivateLinkResource:
        error_map = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "SharedPrivateLinkResource")
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param shared_private_link_resource_name: The Shared Private Link resource name. Required.
        :type shared_private_link_resource_name: str
        :param resource: Resource create parameters. Is either a SharedPrivateLinkResource type or a IO
         type. Required.
        :type resource: ~azure.mgmt.databasewatcher.models.SharedPrivateLinkResource or IO
