...
class SharedPrivateLinkResourcesOperations:
    ...
    def list_by_watcher(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_watcher_request(
    ...
    async def _create_initial(
        ...
        resource: Union[_models.SharedPrivateLinkResource, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param shared_private_link_resource_name: The Shared Private Link resource name. Required.
        :type shared_private_link_resource_name: str
        :param resource: Resource create parameters. Is either a SharedPrivateLinkResource type or a
         IO[bytes] type. Required.
        :type resource: ~azure.mgmt.databasewatcher.models.SharedPrivateLinkResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either SharedPrivateLinkResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databasewatcher.models.SharedPrivateLinkResource]
