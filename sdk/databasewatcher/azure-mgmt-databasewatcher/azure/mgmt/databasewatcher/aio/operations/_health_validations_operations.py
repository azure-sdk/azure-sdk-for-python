...
from ...operations._health_validations_operations import (
    build_get_request,
    build_list_by_parent_request,
    build_start_validation_request,
)
...
class HealthValidationsOperations:
    ...
    def list_by_parent(
        ...
        :return: An iterator like instance of either HealthValidation or the result of cls(response)
        :rtype:
        ...
        cls: ClsType[_models.HealthValidationListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("HealthValidationListResult", pipeline_response)
    ...
    async def get(
        ...
        :return: HealthValidation or the result of cls(response)
        ...
        deserialized = self._deserialize("HealthValidation", pipeline_response.http_response)
    ...
    async def _start_validation_initial(
        ...
        _request = build_start_validation_request(
            resource_group_name=resource_group_name,
            watcher_name=watcher_name,
            health_validation_name=health_validation_name,
            subscription_id=self._config.subscription_id,
    ...
    async def begin_start_validation(
        ...
        :param health_validation_name: The health validation resource name. Required.
        :type health_validation_name: str
        :return: An instance of AsyncLROPoller that returns either HealthValidation or the result of
         cls(response)
