...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.DatabaseWatcher/watchers")
...
def build_get_request(resource_group_name: str, watcher_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "watcherName": _SERIALIZER.url(
            "watcher_name", watcher_name, "str", pattern=r"^[a-zA-Z0-9]{1}[a-zA-Z0-9-_]{3,60}$"
        ),
    }
...
def build_stop_request(resource_group_name: str, watcher_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class WatchersOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.databasewatcher.MicrosoftDatabaseWatcher`'s
    ...
    list_by_subscription.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.DatabaseWatcher/watchers"
    }
    ...
    list_by_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DatabaseWatcher/watchers"
    }
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DatabaseWatcher/watchers/{watcherName}"
    }

    def _create_or_update_initial(
        self, resource_group_name: str, watcher_name: str, resource: Union[_models.Watcher, IO], **kwargs: Any
    ) -> _models.Watcher:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "Watcher")
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either Watcher or the result of cls(response)
    ...
    def begin_create_or_update(
        ...
        :param watcher_name: The database watcher name. Required.
        :type watcher_name: str
        :param resource: Resource create parameters. Is either a Watcher type or a IO type. Required.
        :type resource: ~azure.mgmt.databasewatcher.models.Watcher or IO
    ...
    def _update_initial(
        self, resource_group_name: str, watcher_name: str, properties: Union[_models.WatcherUpdate, IO], **kwargs: Any
    ) -> Optional[_models.Watcher]:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.Watcher]] = kwargs.pop("cls", None)
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "WatcherUpdate")
    ...
    def begin_update(
        ...
        :param watcher_name: The database watcher name. Required.
        :type watcher_name: str
        :param properties: The resource properties to be updated. Is either a WatcherUpdate type or a
         IO type. Required.
        :type properties: ~azure.mgmt.databasewatcher.models.WatcherUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def _start_initial(self, resource_group_name: str, watcher_name: str, **kwargs: Any) -> Optional[_models.Watcher]:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    _start_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DatabaseWatcher/watchers/{watcherName}/start"
    }
    ...
    def _stop_initial(self, resource_group_name: str, watcher_name: str, **kwargs: Any) -> Optional[_models.Watcher]:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    _stop_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DatabaseWatcher/watchers/{watcherName}/stop"
    }
