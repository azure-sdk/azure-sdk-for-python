...
class WatchersOperations:
    ...
    def _create_or_update_initial(
        self, resource_group_name: str, watcher_name: str, resource: Union[_models.Watcher, IO[bytes]], **kwargs: Any
    ) -> _models.Watcher:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def begin_create_or_update(
        ...
        :param watcher_name: The database watcher name. Required.
        :type watcher_name: str
        :param resource: Resource create parameters. Is either a Watcher type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.databasewatcher.models.Watcher or IO[bytes]
        :return: An instance of LROPoller that returns either Watcher or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.databasewatcher.models.Watcher]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        watcher_name: str,
        properties: Union[_models.WatcherUpdate, IO[bytes]],
        **kwargs: Any
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.databasewatcher.models.WatcherUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either Watcher or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.databasewatcher.models.Watcher]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
