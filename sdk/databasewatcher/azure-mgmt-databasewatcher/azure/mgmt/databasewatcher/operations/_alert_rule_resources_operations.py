...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "alertRuleResourceName": _SERIALIZER.url(
            "alert_rule_resource_name",
            alert_rule_resource_name,
            "str",
            pattern=r"^[a-zA-Z0-9]{1}[a-zA-Z0-9-_.]{0,62}[a-zA-Z0-9_]{1}$",
        ),
    }
...
class AlertRuleResourcesOperations:
    ...
    def list_by_parent(
        ...
        cls: ClsType[_models.AlertRuleResourceListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("AlertRuleResourceListResult", pipeline_response)
    ...
    def create_or_update(
        ...
        watcher_name: str,
        alert_rule_resource_name: str,
        resource: Union[_models.AlertRuleResource, IO[bytes]],
        **kwargs: Any
    ) -> _models.AlertRuleResource:
        """Create a AlertRuleResource.
        ...
        :param alert_rule_resource_name: The alert rule proxy resource name. Required.
        :type alert_rule_resource_name: str
        :param resource: Resource create parameters. Is either a AlertRuleResource type or a IO[bytes]
         type. Required.
        :type resource: ~azure.mgmt.databasewatcher.models.AlertRuleResource or IO[bytes]
        :return: AlertRuleResource or the result of cls(response)
        :rtype: ~azure.mgmt.databasewatcher.models.AlertRuleResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "AlertRuleResource")
