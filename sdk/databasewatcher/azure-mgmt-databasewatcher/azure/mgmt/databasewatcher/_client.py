...
class DatabaseWatcherClient:  # pylint: disable=client-accepts-api-version-keyword
    """DatabaseWatcherClient.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = DatabaseWatcherClientConfiguration(
    ...
    def __enter__(self) -> "DatabaseWatcherClient":
