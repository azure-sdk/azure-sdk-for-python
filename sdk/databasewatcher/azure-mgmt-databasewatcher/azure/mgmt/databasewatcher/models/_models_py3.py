...
class Datastore(_serialization.Model):
    ...
    :ivar adx_cluster_resource_id: The ARM ResourceId of an Azure Data Explorer cluster.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword adx_cluster_resource_id: The ARM ResourceId of an Azure Data Explorer cluster.
...
class SharedPrivateLinkResource(ProxyResource):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword dns_zone: The DNS zone to be included in the DNS name of the shared private link.
...
class TargetProperties(_serialization.Model):
    ...
    :ivar target_collection_status: The target collection status. Known values are: "Enabled" and
     "Disabled".
    :vartype target_collection_status: str or ~azure.mgmt.databasewatcher.models.String
    :ivar provisioning_state: The provisioning state of the resource. Known values are:
     "Succeeded", "Failed", and "Canceled".
    :vartype provisioning_state: str or
     ~azure.mgmt.databasewatcher.models.ResourceProvisioningState
    ...
    _attribute_map = {
        ...
        "target_collection_status": {"key": "targetCollectionStatus", "type": "str"},
    ...
    def __init__(
        ...
        *,
        ...
        target_collection_status: Optional[Union[str, "_models.String"]] = None,
        **kwargs: Any
    ) -> None:
        """
        ...
        :keyword connection_server_name: The server name to use in the connection string when
         connecting to a target. Port number and instance name must be specified separately. Required.
        :paramtype connection_server_name: str
        :keyword target_collection_status: The target collection status. Known values are: "Enabled"
         and "Disabled".
        :paramtype target_collection_status: str or ~azure.mgmt.databasewatcher.models.String
        """
        super().__init__(**kwargs)
        ...
        self.target_collection_status = target_collection_status
        self.provisioning_state = None
...
class SqlDbElasticPoolTargetProperties(TargetProperties):
    ...
    :vartype provisioning_state: str or
     ~azure.mgmt.databasewatcher.models.ResourceProvisioningState
    :ivar sql_ep_resource_id: The ARM ResourceId of an Azure SQL DB elastic pool target. Required.
    :vartype sql_ep_resource_id: str
    :ivar anchor_database_resource_id: The ARM ResourceId of the anchor database used to connect to
     an elastic pool. Required.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword target_collection_status: The target collection status. Known values are: "Enabled"
         and "Disabled".
        :paramtype target_collection_status: str or ~azure.mgmt.databasewatcher.models.String
        :keyword sql_ep_resource_id: The ARM ResourceId of an Azure SQL DB elastic pool target.
         Required.
        :paramtype sql_ep_resource_id: str
        :keyword anchor_database_resource_id: The ARM ResourceId of the anchor database used to connect
...
class SqlDbSingleDatabaseTargetProperties(TargetProperties):
    ...
    :vartype provisioning_state: str or
     ~azure.mgmt.databasewatcher.models.ResourceProvisioningState
    :ivar sql_db_resource_id: The ARM ResourceId of an Azure SQL DB single database target.
     Required.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword target_collection_status: The target collection status. Known values are: "Enabled"
         and "Disabled".
        :paramtype target_collection_status: str or ~azure.mgmt.databasewatcher.models.String
        :keyword sql_db_resource_id: The ARM ResourceId of an Azure SQL DB single database target.
         Required.
...
class SqlMiTargetProperties(TargetProperties):
    ...
    :vartype provisioning_state: str or
     ~azure.mgmt.databasewatcher.models.ResourceProvisioningState
    :ivar sql_mi_resource_id: The ARM ResourceId of an Azure SQL Managed Instance target. Required.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword target_collection_status: The target collection status. Known values are: "Enabled"
         and "Disabled".
        :paramtype target_collection_status: str or ~azure.mgmt.databasewatcher.models.String
        :keyword sql_mi_resource_id: The ARM ResourceId of an Azure SQL Managed Instance target.
         Required.
...
class SqlVmTargetProperties(TargetProperties):
    ...
    :vartype provisioning_state: str or
     ~azure.mgmt.databasewatcher.models.ResourceProvisioningState
    :ivar sql_vm_resource_id: The ARM ResourceId of an Azure SQL VM target. Required.
    ...
    _validation = {
        ...
        "connection_server_name": {"required": True, "max_length": 200},
        "provisioning_state": {"readonly": True},
        "sql_vm_resource_id": {"required": True},
    }
    ...
    _attribute_map = {
        ...
        "target_collection_status": {"key": "targetCollectionStatus", "type": "str"},
        "provisioning_state": {"key": "provisioningState", "type": "str"},
        "sql_vm_resource_id": {"key": "sqlVmResourceId", "type": "str"},
        "connection_tcp_port": {"key": "connectionTcpPort", "type": "int"},
        "sql_named_instance_name": {"key": "sqlNamedInstanceName", "type": "str"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword target_collection_status: The target collection status. Known values are: "Enabled"
         and "Disabled".
        :paramtype target_collection_status: str or ~azure.mgmt.databasewatcher.models.String
        :keyword sql_vm_resource_id: The ARM ResourceId of an Azure SQL VM target. Required.
        :paramtype sql_vm_resource_id: str
        :keyword connection_tcp_port: The TCP port number to optionally use in the connection string
         when connecting to an Azure SQL VM target.
        :paramtype connection_tcp_port: int
        :keyword sql_named_instance_name: The SQL instance name to optionally use in the connection
         string when connecting to an Azure SQL VM target.
        :paramtype sql_named_instance_name: str
        """
        super().__init__(
            target_authentication_type=target_authentication_type,
            target_vault=target_vault,
        ...
        self.target_type: str = "SqlVm"
        self.sql_vm_resource_id = sql_vm_resource_id
        self.connection_tcp_port = connection_tcp_port
        self.sql_named_instance_name = sql_named_instance_name
...
class Target(ProxyResource):
    ...
    :vartype target_vault: ~azure.mgmt.databasewatcher.models.VaultSecret
    :ivar connection_server_name: The server name to use in the connection string when connecting
     to a target. Port number and instance name must be specified separately.
    :vartype connection_server_name: str
    :ivar target_collection_status: The target collection status. Known values are: "Enabled" and
     "Disabled".
    :vartype target_collection_status: str or ~azure.mgmt.databasewatcher.models.String
    ...
    _attribute_map = {
        ...
        "target_collection_status": {"key": "properties.targetCollectionStatus", "type": "str"},
        "provisioning_state": {"key": "properties.provisioningState", "type": "str"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype target_vault: ~azure.mgmt.databasewatcher.models.VaultSecret
        :keyword connection_server_name: The server name to use in the connection string when
         connecting to a target. Port number and instance name must be specified separately.
        :paramtype connection_server_name: str
        :keyword target_collection_status: The target collection status. Known values are: "Enabled"
         and "Disabled".
        :paramtype target_collection_status: str or ~azure.mgmt.databasewatcher.models.String
...
class VaultSecret(_serialization.Model):
    ...
    :ivar akv_resource_id: The ARM ResourceId of the Key Vault instance storing database
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword akv_resource_id: The ARM ResourceId of the Key Vault instance storing database
         authentication secrets.
