...
class Datastore(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword adx_cluster_resource_id: The Azure ResourceId of an Azure Data Explorer cluster.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword dns_zone: The DNS zone to be included in the DNS name of the shared private link.
         Value is required for Azure Data Explorer clusters and SQL managed instances. The value to use
         is the second segment of the host FQDN name of the resource that the shared private link
         resource is for.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword connection_server_name: The server name to use in the connection string when
         connecting to a target. Port number and instance name must be specified separately. Required.
        :paramtype connection_server_name: str
        :keyword sql_ep_resource_id: The Azure ResourceId of an Azure SQL DB elastic pool target.
         Required.
        :paramtype sql_ep_resource_id: str
        :keyword anchor_database_resource_id: The Azure ResourceId of the anchor database used to
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword connection_server_name: The server name to use in the connection string when
         connecting to a target. Port number and instance name must be specified separately. Required.
        :paramtype connection_server_name: str
        :keyword sql_db_resource_id: The Azure ResourceId of an Azure SQL DB single database target.
         Required.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword connection_server_name: The server name to use in the connection string when
         connecting to a target. Port number and instance name must be specified separately. Required.
        :paramtype connection_server_name: str
        :keyword sql_mi_resource_id: The Azure ResourceId of an Azure SQL Managed Instance target.
         Required.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword connection_server_name: The server name to use in the connection string when
         connecting to a target. Port number and instance name must be specified separately. Required.
        :paramtype connection_server_name: str
        :keyword sql_vm_resource_id: The Azure ResourceId of an Azure SQL VM target. Required.
...
class ValidationIssue(_serialization.Model):
    ...
    :ivar validation_resource_id: The resource ID of the Azure resource related to the issue.
    :vartype validation_resource_id: str
    :ivar validation_resource_type: The type of the Azure resource related to the issue.
    :vartype validation_resource_type: str
    """
    ...
    _validation = {
        ...
        "validation_resource_id": {"readonly": True},
        "validation_resource_type": {"readonly": True},
    }
    ...
    _attribute_map = {
        ...
        "validation_resource_id": {"key": "validationResourceId", "type": "str"},
        "validation_resource_type": {"key": "validationResourceType", "type": "str"},
    }
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.recommendation_message = None
        self.recommendation_url = None
        self.validation_resource_id = None
        self.validation_resource_type = None
...
class VaultSecret(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword akv_resource_id: The Azure ResourceId of the Key Vault instance storing database
         authentication secrets.
...
class Watcher(TrackedResource):  # pylint: disable=too-many-instance-attributes
