...
class WorkspaceCustomParameters(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar enable_no_public_ip: Boolean indicating whether the public IP should be disabled. Default
     value is true.
    :vartype enable_no_public_ip: ~azure.mgmt.databricks.models.WorkspaceNPIPParameter
    ...
    _attribute_map = {
        ...
        "enable_no_public_ip": {"key": "enableNoPublicIp", "type": "WorkspaceNPIPParameter"},
    ...
    def __init__(
        ...
        *,
        ...
        enable_no_public_ip: Optional["_models.WorkspaceNPIPParameter"] = None,
        ...
        **kwargs: Any
        ...
        :paramtype enable_no_public_ip: ~azure.mgmt.databricks.models.WorkspaceNPIPParameter
...
class WorkspaceNPIPParameter(_serialization.Model):
    """The value which should be used for this field.
