...
def main():
    ...
    response = client.workspaces.begin_create_or_update(
        ...
        parameters={
            ...
            "properties": {
                "accessConnector": {
                    "id": "/subscriptions/subid/resourceGroups/rg/providers/accessConnectors/myAccessConnector",
...
# x-ms-original-file: specification/databricks/resource-manager/Microsoft.Databricks/preview/2024-02-01-preview/examples/WorkspaceCreateWithParameters.json
