...
class ScopeMapsOperations:
    ...
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> AsyncIterable["_models.ScopeMap"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2025_04_01.models.ScopeMap]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2025_04_01.models.ScopeMap
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type scope_map_create_parameters: ~azure.mgmt.containerregistry.v2025_04_01.models.ScopeMap
        ...
        :return: An instance of AsyncLROPoller that returns either ScopeMap or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2025_04_01.models.ScopeMap]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type scope_map_create_parameters: ~azure.mgmt.containerregistry.v2025_04_01.models.ScopeMap or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ScopeMap or the result of
         cls(response)
        :rtype:
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type scope_map_update_parameters:
         ~azure.mgmt.containerregistry.v2025_04_01.models.ScopeMapUpdateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either ScopeMap or the result of
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type scope_map_update_parameters:
         ~azure.mgmt.containerregistry.v2025_04_01.models.ScopeMapUpdateParameters or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ScopeMap or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2025_04_01.models.ScopeMap]
