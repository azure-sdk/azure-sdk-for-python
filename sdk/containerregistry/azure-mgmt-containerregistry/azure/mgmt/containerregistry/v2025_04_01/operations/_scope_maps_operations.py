...
class ScopeMapsOperations:
    ...
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> Iterable["_models.ScopeMap"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2025_04_01.models.ScopeMap]
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2025_04_01.models.ScopeMap]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
