...
class ScopeMapsOperations:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type scope_map_create_parameters:
         ~azure.mgmt.containerregistry.v2019_05_01_preview.models.ScopeMap
        ...
        :return: An instance of AsyncLROPoller that returns either ScopeMap or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2019_05_01_preview.models.ScopeMap]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type scope_map_create_parameters:
         ~azure.mgmt.containerregistry.v2019_05_01_preview.models.ScopeMap or IO
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type scope_map_update_parameters:
         ~azure.mgmt.containerregistry.v2019_05_01_preview.models.ScopeMapUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> AsyncIterable["_models.ScopeMap"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2019_05_01_preview.models.ScopeMap]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
