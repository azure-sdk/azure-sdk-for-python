...
class RegistriesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.containerregistry.v2025_05_01_preview.aio.ContainerRegistryManagementClient`'s
    ...
    async def _import_image_initial(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version or "2025-05-01-preview")
        )
    ...
    async def begin_import_image(
        ...
        **kwargs: Any
        ...
        :param parameters: The parameters specifying the image to copy and the source container
         registry. Required.
        :type parameters:
         ~azure.mgmt.containerregistry.v2025_05_01_preview.models.ImportImageParameters
    ...
    async def begin_import_image(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.containerregistry.v2025_05_01_preview.models.ImportImageParameters or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def check_name_availability(
        ...
        **kwargs: Any
        ...
        :type registry_name_check_request:
         ~azure.mgmt.containerregistry.v2025_05_01_preview.models.RegistryNameCheckRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: RegistryNameStatus or the result of cls(response)
        :rtype: ~azure.mgmt.containerregistry.v2025_05_01_preview.models.RegistryNameStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def check_name_availability(
        ...
        :type registry_name_check_request:
         ~azure.mgmt.containerregistry.v2025_05_01_preview.models.RegistryNameCheckRequest or IO[bytes]
        :return: RegistryNameStatus or the result of cls(response)
        :rtype: ~azure.mgmt.containerregistry.v2025_05_01_preview.models.RegistryNameStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.Registry"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2025_05_01_preview.models.Registry]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> _models.Registry:
        ...
        :rtype: ~azure.mgmt.containerregistry.v2025_05_01_preview.models.Registry
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type registry: ~azure.mgmt.containerregistry.v2025_05_01_preview.models.Registry
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either Registry or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2025_05_01_preview.models.Registry]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create(
        ...
        :type registry: ~azure.mgmt.containerregistry.v2025_05_01_preview.models.Registry or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Registry or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2025_05_01_preview.models.Registry]
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type registry_update_parameters:
         ~azure.mgmt.containerregistry.v2025_05_01_preview.models.RegistryUpdateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either Registry or the result of
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type registry_update_parameters:
         ~azure.mgmt.containerregistry.v2025_05_01_preview.models.RegistryUpdateParameters or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Registry or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2025_05_01_preview.models.Registry]
    ...
    async def list_usages(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2025_05_01_preview.models.RegistryUsageListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_private_link_resources(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2025_05_01_preview.models.PrivateLinkResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def get_private_link_resource(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2025_05_01_preview.models.PrivateLinkResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def list_credentials(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2025_05_01_preview.models.RegistryListCredentialsResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def regenerate_credential(
        ...
        **kwargs: Any
        ...
        :type regenerate_credential_parameters:
         ~azure.mgmt.containerregistry.v2025_05_01_preview.models.RegenerateCredentialParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: RegistryListCredentialsResult or the result of cls(response)
    ...
    async def regenerate_credential(
        ...
        **kwargs: Any
        ...
        :type regenerate_credential_parameters:
         ~azure.mgmt.containerregistry.v2025_05_01_preview.models.RegenerateCredentialParameters or
         IO[bytes]
        :return: RegistryListCredentialsResult or the result of cls(response)
        :rtype: ~azure.mgmt.containerregistry.v2025_05_01_preview.models.RegistryListCredentialsResult
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def begin_generate_credentials(
        ...
        **kwargs: Any
        ...
        :type generate_credentials_parameters:
         ~azure.mgmt.containerregistry.v2025_05_01_preview.models.GenerateCredentialsParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2025_05_01_preview.models.GenerateCredentialsResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_generate_credentials(
        ...
        **kwargs: Any
        ...
        :type generate_credentials_parameters:
         ~azure.mgmt.containerregistry.v2025_05_01_preview.models.GenerateCredentialsParameters or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either GenerateCredentialsResult or the
         result of cls(response)
        :rtype:
