...
class WebhooksOperations:
    ...
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> AsyncIterable["_models.Webhook"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2025_05_01_preview.models.Webhook]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2025_05_01_preview.models.Webhook
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type webhook_create_parameters:
         ~azure.mgmt.containerregistry.v2025_05_01_preview.models.WebhookCreateParameters
        ...
        :return: An instance of AsyncLROPoller that returns either Webhook or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2025_05_01_preview.models.Webhook]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type webhook_create_parameters:
         ~azure.mgmt.containerregistry.v2025_05_01_preview.models.WebhookCreateParameters or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Webhook or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2025_05_01_preview.models.Webhook]
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type webhook_update_parameters:
         ~azure.mgmt.containerregistry.v2025_05_01_preview.models.WebhookUpdateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either Webhook or the result of
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type webhook_update_parameters:
         ~azure.mgmt.containerregistry.v2025_05_01_preview.models.WebhookUpdateParameters or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Webhook or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2025_05_01_preview.models.Webhook]
    ...
    async def ping(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2025_05_01_preview.models.EventInfo
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_events(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2025_05_01_preview.models.Event]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def get_callback_config(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2025_05_01_preview.models.CallbackConfig
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
