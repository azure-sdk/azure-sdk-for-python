...
class ImportPipelinesOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2023_07_01_preview.models.ImportPipeline]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2023_07_01_preview.models.ImportPipeline
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type import_pipeline_create_parameters:
         ~azure.mgmt.containerregistry.v2023_07_01_preview.models.ImportPipeline
        ...
        :return: An instance of AsyncLROPoller that returns either ImportPipeline or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2023_07_01_preview.models.ImportPipeline]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type import_pipeline_create_parameters:
         ~azure.mgmt.containerregistry.v2023_07_01_preview.models.ImportPipeline or IO
