...
class ContainerRegistryManagementClient(MultiApiClientMixin, _SDKClient):
    ...
    LATEST_PROFILE = ProfileDefinition({
        _PROFILE_TAG: {
            ...
            'archive_versions': '2024-11-01-preview',
            'archives': '2024-11-01-preview',
            'export_pipelines': '2024-11-01-preview',
            'import_pipelines': '2024-11-01-preview',
            'pipeline_runs': '2024-11-01-preview',
