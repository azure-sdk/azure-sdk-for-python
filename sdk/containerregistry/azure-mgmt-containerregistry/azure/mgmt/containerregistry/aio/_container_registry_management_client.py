...
class ContainerRegistryManagementClient(MultiApiClientMixin, _SDKClient):
    ...
    def models(cls, api_version=DEFAULT_API_VERSION):
        """Module depends on the API version:
           ...
           * 2023-07-01-preview: :mod:`v2023_07_01_preview.models<azure.mgmt.containerregistry.v2023_07_01_preview.models>`
        """
    ...
    def archive_versions(self):
        """Instance depends on the API version:
           ...
           * 2023-07-01-preview: :class:`ArchiveVersionsOperations<azure.mgmt.containerregistry.v2023_07_01_preview.aio.operations.ArchiveVersionsOperations>`
        """
        api_version = self._get_api_version('archive_versions')
        if api_version == '2023-07-01-preview':
            from ..v2023_07_01_preview.aio.operations import ArchiveVersionsOperations as OperationClass
        else:
    ...
    def archives(self):
        """Instance depends on the API version:
           ...
           * 2023-07-01-preview: :class:`ArchivesOperations<azure.mgmt.containerregistry.v2023_07_01_preview.aio.operations.ArchivesOperations>`
        """
        api_version = self._get_api_version('archives')
        if api_version == '2023-07-01-preview':
            from ..v2023_07_01_preview.aio.operations import ArchivesOperations as OperationClass
        else:
    ...
    def cache_rules(self):
        """Instance depends on the API version:
           ...
           * 2023-07-01-preview: :class:`CacheRulesOperations<azure.mgmt.containerregistry.v2023_07_01_preview.aio.operations.CacheRulesOperations>`
        """
        ...
        if api_version == '2023-01-01-preview':
            ...
            from ..v2023_07_01_preview.aio.operations import CacheRulesOperations as OperationClass
        else:
    ...
    def connected_registries(self):
        """Instance depends on the API version:
           ...
           * 2023-07-01-preview: :class:`ConnectedRegistriesOperations<azure.mgmt.containerregistry.v2023_07_01_preview.aio.operations.ConnectedRegistriesOperations>`
        """
        ...
        if api_version == '2020-11-01-preview':
            ...
            from ..v2023_07_01_preview.aio.operations import ConnectedRegistriesOperations as OperationClass
        else:
    ...
    def credential_sets(self):
        """Instance depends on the API version:
           ...
           * 2023-07-01-preview: :class:`CredentialSetsOperations<azure.mgmt.containerregistry.v2023_07_01_preview.aio.operations.CredentialSetsOperations>`
        """
        ...
        if api_version == '2023-01-01-preview':
            ...
            from ..v2023_07_01_preview.aio.operations import CredentialSetsOperations as OperationClass
        else:
    ...
    def export_pipelines(self):
        """Instance depends on the API version:
           ...
           * 2023-07-01-preview: :class:`ExportPipelinesOperations<azure.mgmt.containerregistry.v2023_07_01_preview.aio.operations.ExportPipelinesOperations>`
        """
        ...
        if api_version == '2019-12-01-preview':
            ...
            from ..v2023_07_01_preview.aio.operations import ExportPipelinesOperations as OperationClass
        else:
    ...
    def import_pipelines(self):
        """Instance depends on the API version:
           ...
           * 2023-07-01-preview: :class:`ImportPipelinesOperations<azure.mgmt.containerregistry.v2023_07_01_preview.aio.operations.ImportPipelinesOperations>`
        """
        ...
        if api_version == '2019-12-01-preview':
            ...
            from ..v2023_07_01_preview.aio.operations import ImportPipelinesOperations as OperationClass
        else:
    ...
    def operations(self):
        """Instance depends on the API version:
           ...
           * 2023-07-01-preview: :class:`Operations<azure.mgmt.containerregistry.v2023_07_01_preview.aio.operations.Operations>`
        """
    ...
    def pipeline_runs(self):
        """Instance depends on the API version:
           ...
           * 2023-07-01-preview: :class:`PipelineRunsOperations<azure.mgmt.containerregistry.v2023_07_01_preview.aio.operations.PipelineRunsOperations>`
        """
        ...
        if api_version == '2019-12-01-preview':
            ...
            from ..v2023_07_01_preview.aio.operations import PipelineRunsOperations as OperationClass
        else:
    ...
    def private_endpoint_connections(self):
        """Instance depends on the API version:
           ...
           * 2023-07-01-preview: :class:`PrivateEndpointConnectionsOperations<azure.mgmt.containerregistry.v2023_07_01_preview.aio.operations.PrivateEndpointConnectionsOperations>`
        """
        ...
        if api_version == '2019-12-01-preview':
            ...
            from ..v2023_07_01_preview.aio.operations import PrivateEndpointConnectionsOperations as OperationClass
        else:
    ...
    def registries(self):
        """Instance depends on the API version:
           ...
           * 2023-07-01-preview: :class:`RegistriesOperations<azure.mgmt.containerregistry.v2023_07_01_preview.aio.operations.RegistriesOperations>`
        """
        ...
        if api_version == '2017-03-01':
            ...
            from ..v2023_07_01_preview.aio.operations import RegistriesOperations as OperationClass
        else:
    ...
    def replications(self):
        """Instance depends on the API version:
           ...
           * 2023-07-01-preview: :class:`ReplicationsOperations<azure.mgmt.containerregistry.v2023_07_01_preview.aio.operations.ReplicationsOperations>`
        """
        ...
        if api_version == '2017-10-01':
            ...
            from ..v2023_07_01_preview.aio.operations import ReplicationsOperations as OperationClass
        else:
    ...
    def scope_maps(self):
        """Instance depends on the API version:
           ...
           * 2023-07-01-preview: :class:`ScopeMapsOperations<azure.mgmt.containerregistry.v2023_07_01_preview.aio.operations.ScopeMapsOperations>`
        """
        ...
        if api_version == '2019-05-01-preview':
            ...
            from ..v2023_07_01_preview.aio.operations import ScopeMapsOperations as OperationClass
        else:
    ...
    def tokens(self):
        """Instance depends on the API version:
           ...
           * 2023-07-01-preview: :class:`TokensOperations<azure.mgmt.containerregistry.v2023_07_01_preview.aio.operations.TokensOperations>`
        """
        ...
        if api_version == '2019-05-01-preview':
            ...
            from ..v2023_07_01_preview.aio.operations import TokensOperations as OperationClass
        else:
    ...
    def webhooks(self):
        """Instance depends on the API version:
           ...
           * 2023-07-01-preview: :class:`WebhooksOperations<azure.mgmt.containerregistry.v2023_07_01_preview.aio.operations.WebhooksOperations>`
        """
        ...
        if api_version == '2017-10-01':
            ...
            from ..v2023_07_01_preview.aio.operations import WebhooksOperations as OperationClass
        else:
