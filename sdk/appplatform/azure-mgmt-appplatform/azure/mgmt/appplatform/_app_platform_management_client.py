...
class AppPlatformManagementClient(MultiApiClientMixin, _SDKClient):
    ...
    def build_setting(self):
        """Instance depends on the API version:
           ...
           * 2024-05-01-preview: :class:`BuildSettingOperations<azure.mgmt.appplatform.v2024_05_01_preview.operations.BuildSettingOperations>`
        """
        api_version = self._get_api_version('build_setting')
        if api_version == '2024-05-01-preview':
            from .v2024_05_01_preview.operations import BuildSettingOperations as OperationClass
        else:
    ...
    def build_settings(self):
        """Instance depends on the API version:
           ...
           * 2024-05-01-preview: :class:`BuildSettingsOperations<azure.mgmt.appplatform.v2024_05_01_preview.operations.BuildSettingsOperations>`
        """
        api_version = self._get_api_version('build_settings')
        if api_version == '2024-05-01-preview':
            from .v2024_05_01_preview.operations import BuildSettingsOperations as OperationClass
        else:
