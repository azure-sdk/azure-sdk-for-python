...
from .operations import (
    ...
    BuildSettingOperations,
    BuildSettingsOperations,
...
class AppPlatformManagementClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :ivar build_settings: BuildSettingsOperations operations
    :vartype build_settings:
     azure.mgmt.appplatform.v2024_05_01_preview.aio.operations.BuildSettingsOperations
    :ivar build_setting: BuildSettingOperations operations
    :vartype build_setting:
     azure.mgmt.appplatform.v2024_05_01_preview.aio.operations.BuildSettingOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.build_settings = BuildSettingsOperations(
            self._client, self._config, self._serialize, self._deserialize, "2024-05-01-preview"
        )
        self.build_setting = BuildSettingOperations(
            self._client, self._config, self._serialize, self._deserialize, "2024-05-01-preview"
        )
