    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param build_service: Parameters for the create operation. Is either a BuildService type or a
         IO type. Required.
        :type build_service: ~azure.mgmt.appplatform.v2024_05_01_preview.models.BuildService or IO
    ...
    def create_or_update_build(
        ...
        **kwargs: Any
        ...
        :param build: Parameters for the create or update operation. Is either a Build type or a IO
         type. Required.
        :type build: ~azure.mgmt.appplatform.v2024_05_01_preview.models.Build or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
