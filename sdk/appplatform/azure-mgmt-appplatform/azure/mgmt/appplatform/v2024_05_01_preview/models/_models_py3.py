...
class BuildProperties(_serialization.Model):
    ...
    :ivar build_settings: The build settings for this build.
    :vartype build_settings:
     list[~azure.mgmt.appplatform.v2024_05_01_preview.models.BuildSettingReference]
    ...
    _attribute_map = {
        ...
        "build_settings": {"key": "buildSettings", "type": "[BuildSettingReference]"},
    ...
    def __init__(
        ...
        *,
        ...
        build_settings: Optional[List["_models.BuildSettingReference"]] = None,
        ...
        **kwargs: Any
        ...
        :paramtype certificates:
         list[~azure.mgmt.appplatform.v2024_05_01_preview.models.CertificateReference]
        :keyword build_settings: The build settings for this build.
        :paramtype build_settings:
         list[~azure.mgmt.appplatform.v2024_05_01_preview.models.BuildSettingReference]
...
class BuildSettingProperties(_serialization.Model):
    ...
    :ivar type: build setting type. Required.
    :vartype type: str
    :ivar provisioning_state: State of the build setting. Known values are: "Creating", "Updating",
     "Succeeded", "Failed", "Deleting", and "Canceled".
    :vartype provisioning_state: str or
     ~azure.mgmt.appplatform.v2024_05_01_preview.models.BuildSettingProvisioningState
    :ivar secrets: Sensitive properties for the APM.
    :vartype secrets:
     ~azure.mgmt.appplatform.v2024_05_01_preview.models.BuildSettingPropertiesSecrets
    """
    ...
    _attribute_map = {
        "type": {"key": "type", "type": "str"},
        "provisioning_state": {"key": "provisioningState", "type": "str"},
        "secrets": {"key": "secrets", "type": "BuildSettingPropertiesSecrets"},
    }

    def __init__(
        self, *, type: str, secrets: Optional["_models.BuildSettingPropertiesSecrets"] = None, **kwargs: Any
    ) -> None:
        """
        :keyword type: build setting type. Required.
        :paramtype type: str
        :keyword secrets: Sensitive properties for the APM.
        :paramtype secrets:
         ~azure.mgmt.appplatform.v2024_05_01_preview.models.BuildSettingPropertiesSecrets
...
class BuildSettingPropertiesSecrets(_serialization.Model):
    """Sensitive properties for the APM.

    :ivar settings_xml: the context of settings.xml encoded by base64.
    :vartype settings_xml: str
    :ivar settings_security_xml: the context of settings-security.xml encoded by base64.
    :vartype settings_security_xml: str
    :ivar gradle_properties: the context of gradle.properties encoded by base64.
    :vartype gradle_properties: str
    """

    _attribute_map = {
        "settings_xml": {"key": "settingsXml", "type": "str"},
        "settings_security_xml": {"key": "settingsSecurityXml", "type": "str"},
        "gradle_properties": {"key": "gradleProperties", "type": "str"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        settings_security_xml: Optional[str] = None,
        gradle_properties: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword settings_xml: the context of settings.xml encoded by base64.
        :paramtype settings_xml: str
        :keyword settings_security_xml: the context of settings-security.xml encoded by base64.
        :paramtype settings_security_xml: str
        :keyword gradle_properties: the context of gradle.properties encoded by base64.
        :paramtype gradle_properties: str
        """
        super().__init__(**kwargs)
        self.settings_xml = settings_xml
        self.settings_security_xml = settings_security_xml
        self.gradle_properties = gradle_properties


class BuildSettingReference(_serialization.Model):
    """A reference to the build setting.

    All required parameters must be populated in order to send to server.

    :ivar resource_id: Resource id of the build setting. Required.
    :vartype resource_id: str
    """
    ...
    def __init__(self, *, resource_id: str, **kwargs: Any) -> None:
        """
        :keyword resource_id: Resource id of the build setting. Required.
        :paramtype resource_id: str
        """
        super().__init__(**kwargs)
        self.resource_id = resource_id
...
class BuildSettingResource(ProxyResource):
    ...
    :ivar system_data: Metadata pertaining to creation and last modification of the resource.
    :vartype system_data: ~azure.mgmt.appplatform.v2024_05_01_preview.models.SystemData
    :ivar properties: Properties of a build setting.
    :vartype properties: ~azure.mgmt.appplatform.v2024_05_01_preview.models.BuildSettingProperties
    """
    ...
    _attribute_map = {
        ...
        "type": {"key": "type", "type": "str"},
        "system_data": {"key": "systemData", "type": "SystemData"},
        "properties": {"key": "properties", "type": "BuildSettingProperties"},
    }

    def __init__(self, *, properties: Optional["_models.BuildSettingProperties"] = None, **kwargs: Any) -> None:
        """
        :keyword properties: Properties of a build setting.
        :paramtype properties:
         ~azure.mgmt.appplatform.v2024_05_01_preview.models.BuildSettingProperties
        """
        super().__init__(**kwargs)
        self.properties = properties


class BuildSettingResourceCollection(_serialization.Model):
    """Object that includes an array of build setting resources and a possible link for next set.

    :ivar value: Collection of build setting resources.
    :vartype value: list[~azure.mgmt.appplatform.v2024_05_01_preview.models.BuildSettingResource]
    :ivar next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :vartype next_link: str
    """
    ...
    _attribute_map = {
        "value": {"key": "value", "type": "[BuildSettingResource]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.BuildSettingResource"]] = None,
        next_link: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword value: Collection of build setting resources.
        :paramtype value: list[~azure.mgmt.appplatform.v2024_05_01_preview.models.BuildSettingResource]
        :keyword next_link: URL client should use to fetch the next page (per server side paging).
         It's null for now, added for future use.
        :paramtype next_link: str
        """
...
class JobExecution(_serialization.Model):
    ...
    :vartype properties: ~azure.mgmt.appplatform.v2024_05_01_preview.models.JobExecutionProperties
    :ivar job_snapshot: The properties of job configuration.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype properties:
         ~azure.mgmt.appplatform.v2024_05_01_preview.models.JobExecutionProperties
        :keyword job_snapshot: The properties of job configuration.
...
class ManualJobTriggerConfig(JobTriggerConfig):
    ...
    :ivar replica_retry_limit: Maximum number of retries for each replica before failing the job.
    ...
    def __init__(
        self, *, timeout_in_seconds: Optional[int] = None, replica_retry_limit: Optional[int] = None, **kwargs: Any
    ) -> None:
        """
        :keyword timeout_in_seconds: Maximum number of seconds an execution is allowed to run.
        :paramtype timeout_in_seconds: int
        :keyword replica_retry_limit: Maximum number of retries for each replica before failing the
         job.
...
class SupportedBuildSettingType(_serialization.Model):
    """Supported build setting type.

    :ivar name: The name of the supported build setting type.
    :vartype name: str
    """
    ...
    def __init__(self, *, name: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword name: The name of the supported build setting type.
        :paramtype name: str
        """
        super().__init__(**kwargs)
        self.name = name
...
class SupportedBuildSettingTypes(_serialization.Model):
    """Supported build setting types payload.

    :ivar value: Collection of the supported build setting type.
    :vartype value:
     list[~azure.mgmt.appplatform.v2024_05_01_preview.models.SupportedBuildSettingType]
    :ivar next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :vartype next_link: str
    """
    ...
    _attribute_map = {
        "value": {"key": "value", "type": "[SupportedBuildSettingType]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.SupportedBuildSettingType"]] = None,
        next_link: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword value: Collection of the supported build setting type.
        :paramtype value:
         list[~azure.mgmt.appplatform.v2024_05_01_preview.models.SupportedBuildSettingType]
        :keyword next_link: URL client should use to fetch the next page (per server side paging).
         It's null for now, added for future use.
