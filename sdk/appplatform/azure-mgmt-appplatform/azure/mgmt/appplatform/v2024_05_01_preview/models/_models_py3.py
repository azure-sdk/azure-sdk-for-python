...
class ServiceVNetAddons(_serialization.Model):
    ...
    :ivar private_link_state: Indicates whether the vnet injection service enables private links
     for backend storage account and container registry. Known values are: "Enabled" and "Disabled".
    :vartype private_link_state: str or
     ~azure.mgmt.appplatform.v2024_05_01_preview.models.PrivateLinkState
    ...
    _attribute_map = {
        ...
        "private_link_state": {"key": "privateLinkState", "type": "str"},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword private_link_state: Indicates whether the vnet injection service enables private links
         for backend storage account and container registry. Known values are: "Enabled" and "Disabled".
        :paramtype private_link_state: str or
         ~azure.mgmt.appplatform.v2024_05_01_preview.models.PrivateLinkState
