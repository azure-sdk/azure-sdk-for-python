...
class AppPlatformManagementClient(MultiApiClientMixin, _SDKClient):
    ...
    def build_setting(self):
        """Instance depends on the API version:
           ...
           * 2024-05-01-preview: :class:`BuildSettingOperations<azure.mgmt.appplatform.v2024_05_01_preview.aio.operations.BuildSettingOperations>`
        """
        api_version = self._get_api_version('build_setting')
        if api_version == '2024-05-01-preview':
            from ..v2024_05_01_preview.aio.operations import BuildSettingOperations as OperationClass
        else:
            raise ValueError("API version {} does not have operation group 'build_setting'".format(api_version))
        self._config.api_version = api_version
        return OperationClass(self._client, self._config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)), api_version)
    ...
    def build_settings(self):
        """Instance depends on the API version:
           ...
           * 2024-05-01-preview: :class:`BuildSettingsOperations<azure.mgmt.appplatform.v2024_05_01_preview.aio.operations.BuildSettingsOperations>`
        """
        api_version = self._get_api_version('build_settings')
        if api_version == '2024-05-01-preview':
            from ..v2024_05_01_preview.aio.operations import BuildSettingsOperations as OperationClass
        else:
            raise ValueError("API version {} does not have operation group 'build_settings'".format(api_version))
        self._config.api_version = api_version
        return OperationClass(self._client, self._config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)), api_version)
