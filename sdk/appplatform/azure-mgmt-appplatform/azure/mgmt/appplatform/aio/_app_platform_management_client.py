...
class AppPlatformManagementClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype configuration_services:
     azure.mgmt.appplatform.aio.operations.ConfigurationServicesOperations
    :ivar service_registries: ServiceRegistriesOperations operations
    :vartype service_registries: azure.mgmt.appplatform.aio.operations.ServiceRegistriesOperations
    :ivar application_live_views: ApplicationLiveViewsOperations operations
    :vartype application_live_views:
     azure.mgmt.appplatform.aio.operations.ApplicationLiveViewsOperations
    :ivar dev_tool_portals: DevToolPortalsOperations operations
    :vartype dev_tool_portals: azure.mgmt.appplatform.aio.operations.DevToolPortalsOperations
    :ivar container_registries: ContainerRegistriesOperations operations
    :vartype container_registries:
     azure.mgmt.appplatform.aio.operations.ContainerRegistriesOperations
    :ivar build_service: BuildServiceOperations operations
    :vartype build_service: azure.mgmt.appplatform.aio.operations.BuildServiceOperations
    :ivar buildpack_binding: BuildpackBindingOperations operations
    :vartype buildpack_binding: azure.mgmt.appplatform.aio.operations.BuildpackBindingOperations
    :ivar build_service_builder: BuildServiceBuilderOperations operations
    :vartype build_service_builder:
     azure.mgmt.appplatform.aio.operations.BuildServiceBuilderOperations
    :ivar build_service_agent_pool: BuildServiceAgentPoolOperations operations
    :vartype build_service_agent_pool:
     azure.mgmt.appplatform.aio.operations.BuildServiceAgentPoolOperations
    :ivar monitoring_settings: MonitoringSettingsOperations operations
    :vartype monitoring_settings:
     azure.mgmt.appplatform.aio.operations.MonitoringSettingsOperations
    :ivar apps: AppsOperations operations
    :vartype apps: azure.mgmt.appplatform.aio.operations.AppsOperations
    :ivar bindings: BindingsOperations operations
    :vartype bindings: azure.mgmt.appplatform.aio.operations.BindingsOperations
    :ivar storages: StoragesOperations operations
    :vartype storages: azure.mgmt.appplatform.aio.operations.StoragesOperations
    :ivar certificates: CertificatesOperations operations
    :vartype certificates: azure.mgmt.appplatform.aio.operations.CertificatesOperations
    :ivar custom_domains: CustomDomainsOperations operations
    :vartype custom_domains: azure.mgmt.appplatform.aio.operations.CustomDomainsOperations
    :ivar deployments: DeploymentsOperations operations
    :vartype deployments: azure.mgmt.appplatform.aio.operations.DeploymentsOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.appplatform.aio.operations.Operations
    :ivar runtime_versions: RuntimeVersionsOperations operations
    :vartype runtime_versions: azure.mgmt.appplatform.aio.operations.RuntimeVersionsOperations
    :ivar skus: SkusOperations operations
    :vartype skus: azure.mgmt.appplatform.aio.operations.SkusOperations
    :ivar gateways: GatewaysOperations operations
    :vartype gateways: azure.mgmt.appplatform.aio.operations.GatewaysOperations
    :ivar gateway_route_configs: GatewayRouteConfigsOperations operations
    :vartype gateway_route_configs:
     azure.mgmt.appplatform.aio.operations.GatewayRouteConfigsOperations
    :ivar gateway_custom_domains: GatewayCustomDomainsOperations operations
    :vartype gateway_custom_domains:
     azure.mgmt.appplatform.aio.operations.GatewayCustomDomainsOperations
    :ivar api_portals: ApiPortalsOperations operations
    :vartype api_portals: azure.mgmt.appplatform.aio.operations.ApiPortalsOperations
    :ivar api_portal_custom_domains: ApiPortalCustomDomainsOperations operations
    :vartype api_portal_custom_domains:
     azure.mgmt.appplatform.aio.operations.ApiPortalCustomDomainsOperations
    :ivar application_accelerators: ApplicationAcceleratorsOperations operations
    :vartype application_accelerators:
     azure.mgmt.appplatform.aio.operations.ApplicationAcceleratorsOperations
    :ivar customized_accelerators: CustomizedAcceleratorsOperations operations
    :vartype customized_accelerators:
     azure.mgmt.appplatform.aio.operations.CustomizedAcceleratorsOperations
