...
class AppPlatformManagementClient(MultiApiClientMixin, _SDKClient):
    ...
    def job_execution(self):
        """Instance depends on the API version:
           ...
           * 2024-01-01-preview: :class:`JobExecutionOperations<azure.mgmt.appplatform.v2024_01_01_preview.aio.operations.JobExecutionOperations>`
        """
        api_version = self._get_api_version('job_execution')
        if api_version == '2024-01-01-preview':
            from ..v2024_01_01_preview.aio.operations import JobExecutionOperations as OperationClass
        else:
    ...
    def job_executions(self):
        """Instance depends on the API version:
           ...
           * 2024-01-01-preview: :class:`JobExecutionsOperations<azure.mgmt.appplatform.v2024_01_01_preview.aio.operations.JobExecutionsOperations>`
        """
        api_version = self._get_api_version('job_executions')
        if api_version == '2024-01-01-preview':
            from ..v2024_01_01_preview.aio.operations import JobExecutionsOperations as OperationClass
        else:
    ...
    def jobs(self):
        """Instance depends on the API version:
           ...
           * 2024-01-01-preview: :class:`JobsOperations<azure.mgmt.appplatform.v2024_01_01_preview.aio.operations.JobsOperations>`
        """
        api_version = self._get_api_version('jobs')
        if api_version == '2024-01-01-preview':
            from ..v2024_01_01_preview.aio.operations import JobsOperations as OperationClass
        else:
