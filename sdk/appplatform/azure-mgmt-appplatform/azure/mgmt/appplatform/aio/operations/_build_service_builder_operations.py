...
class BuildServiceBuilderOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type builder_resource: ~azure.mgmt.appplatform.models.BuilderResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either BuilderResource or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.models.BuilderResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type builder_resource: ~azure.mgmt.appplatform.models.BuilderResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either BuilderResource or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.models.BuilderResource]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.models.BuilderResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
