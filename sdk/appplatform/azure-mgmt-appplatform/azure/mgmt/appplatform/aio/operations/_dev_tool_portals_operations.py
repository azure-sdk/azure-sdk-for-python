...
class DevToolPortalsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either DevToolPortalResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.models.DevToolPortalResource]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either DevToolPortalResource or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.models.DevToolPortalResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
