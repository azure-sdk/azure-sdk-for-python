...
class ApplicationAcceleratorsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either ApplicationAcceleratorResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.models.ApplicationAcceleratorResource]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type application_accelerator_resource:
         ~azure.mgmt.appplatform.models.ApplicationAcceleratorResource
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.models.ApplicationAcceleratorResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type application_accelerator_resource:
         ~azure.mgmt.appplatform.models.ApplicationAcceleratorResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ApplicationAcceleratorResource or
         the result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.models.ApplicationAcceleratorResource]
