...
class BuildpackBindingOperations:
    ...
    def list_for_cluster(
        ...
        :return: An iterator like instance of either BuildpackBindingResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.models.BuildpackBindingResource]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.models.BuildpackBindingResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
