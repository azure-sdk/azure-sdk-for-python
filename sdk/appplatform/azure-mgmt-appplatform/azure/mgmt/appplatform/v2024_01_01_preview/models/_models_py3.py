...
class JobConfiguration(_serialization.Model):
    ...
    :ivar trigger_config: Configuration for different trigger types.
    ...
    def __init__(self, *, trigger_config: Optional["_models.JobTriggerConfig"] = None, **kwargs: Any) -> None:
        """
        :keyword trigger_config: Configuration for different trigger types.
...
class JobExecution(_serialization.Model):
    ...
    :ivar template: Job's execution template.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword template: Job's execution template.
...
class JobResourceProperties(_serialization.Model):
    ...
    :vartype source: ~azure.mgmt.appplatform.v2024_01_01_preview.models.UserSourceInfo
    :ivar configuration: The Job specific configuration.
    :vartype configuration: ~azure.mgmt.appplatform.v2024_01_01_preview.models.JobConfiguration
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype source: ~azure.mgmt.appplatform.v2024_01_01_preview.models.UserSourceInfo
        :keyword configuration: The Job specific configuration.
        :paramtype configuration: ~azure.mgmt.appplatform.v2024_01_01_preview.models.JobConfiguration
        """
        super().__init__(**kwargs)
        self.provisioning_state = None
        self.template = template
...
class JobTriggerConfig(_serialization.Model):
    ...
    _subtype_map = {"trigger_type": {"ManualJobTriggerConfig": "ManualJobTriggerConfig"}}
...
class ManualJobTriggerConfig(JobTriggerConfig):
    ...
    def __init__(self, **kwargs: Any) -> None:
        """ """
        super().__init__(**kwargs)
        self.trigger_type: str = "ManualJobTriggerConfig"
