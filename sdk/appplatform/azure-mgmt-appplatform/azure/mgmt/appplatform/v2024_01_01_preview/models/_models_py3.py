...
class AppResourceProperties(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar kind: The type of App, whether it's long running app or short lived app. Known values
     are: "Application" and "Task".
    :vartype kind: str or ~azure.mgmt.appplatform.v2024_01_01_preview.models.AppResourceType
    ...
    def __init__(
        self,
        *,
        kind: Union[str, "_models.AppResourceType"] = "Application",
        ...
        **kwargs: Any
        ...
        """
        :keyword kind: The type of App, whether it's long running app or short lived app. Known values
         are: "Application" and "Task".
        :paramtype kind: str or ~azure.mgmt.appplatform.v2024_01_01_preview.models.AppResourceType
...
class DeploymentInstance(_serialization.Model):
    ...
    :ivar end_time: End time of the deployment instance.
