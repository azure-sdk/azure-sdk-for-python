...
class JobsOperations:
    ...
    def list(self, resource_group_name: str, service_name: str, **kwargs: Any) -> Iterable["_models.JobResource"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2024_01_01_preview.models.JobResource]
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/jobs"
    }
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either JobResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2024_01_01_preview.models.JobResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_start(
        ...
        **kwargs: Any
        ...
        :type template: ~azure.mgmt.appplatform.v2024_01_01_preview.models.JobExecutionTemplate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of LROPoller that returns either JobExecution or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2024_01_01_preview.models.JobExecution]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_start(
        ...
        **kwargs: Any
        ...
        :type template: ~azure.mgmt.appplatform.v2024_01_01_preview.models.JobExecutionTemplate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
