...
class BuildpackBindingOperations:
    ...
    def list_for_cluster(
        ...
        :return: An iterator like instance of either BuildpackBindingResource or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.models.BuildpackBindingResource]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param buildpack_binding: The target buildpack binding for the create or update operation.
         Required.
        :type buildpack_binding: ~azure.mgmt.appplatform.models.BuildpackBindingResource
        ...
        :return: An instance of LROPoller that returns either BuildpackBindingResource or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.models.BuildpackBindingResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type buildpack_binding: ~azure.mgmt.appplatform.models.BuildpackBindingResource or IO[bytes]
        :return: An instance of LROPoller that returns either BuildpackBindingResource or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.models.BuildpackBindingResource]
        :raises ~azure.core.exceptions.HttpResponseError:
