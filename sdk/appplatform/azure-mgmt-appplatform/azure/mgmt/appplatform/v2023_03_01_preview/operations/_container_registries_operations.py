...
class ContainerRegistriesOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either ContainerRegistryResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2023_03_01_preview.models.ContainerRegistryResource]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either ContainerRegistryResource or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_03_01_preview.models.ContainerRegistryResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
