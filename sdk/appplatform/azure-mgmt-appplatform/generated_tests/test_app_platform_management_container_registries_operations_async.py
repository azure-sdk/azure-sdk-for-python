...
class TestAppPlatformManagementContainerRegistriesOperationsAsync(AzureMgmtRecordedTestCase):
        ...
        response = await (
            await self.client.container_registries.begin_create_or_update(
                ...
                container_registry_resource={
                    "id": "str",
                    "name": "str",
                    "properties": {"credentials": "container_registry_credentials", "provisioningState": "str"},
                    "systemData": {
