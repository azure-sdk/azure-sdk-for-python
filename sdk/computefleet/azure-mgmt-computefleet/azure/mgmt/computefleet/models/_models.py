...
class LocationProfile(_model_base.Model):
    ...
    :ivar location: The ARM location name of the additional region.
    :vartype location: str
...
class VMAttributes(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar local_storage_in_gi_b: The range of local storage in GB specified from Min to Max.
    ...
    :ivar accelerator_support: Specifies whether the VMSize supporting accelerator should be used
     to build Fleet or not. Known values are: "Excluded", "Included", and "Required".
    ...
    """Specifies whether the VMSize supporting accelerator should be used to build Fleet or not. Known
    ...
    """The accelerator manufacturers specified as a list. acceleratorSupport should be set to Included
     or Required to use this VMAttribute."""
    ...
    """The range of accelerator count specified from min to max.. Optional parameter. Either Min or
