...
class FleetProperties(_model_base.Model):
    ...
    :vartype vm_sizes_profile: ~azure.mgmt.computefleet.models.VmSizeProfile
    ...
    vm_sizes_profile: "_models.VmSizeProfile" = rest_field(name="vmSizesProfile")
    ...
    time_created: Optional[datetime.datetime] = rest_field(name="timeCreated", visibility=["update"], format="rfc3339")
    ...
    def __init__(
        self,
        *,
        vm_sizes_profile: "_models.VmSizeProfile",
