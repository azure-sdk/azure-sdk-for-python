...
class VirtualMachineScaleSetDataDisk(_model_base.Model):
    ...
    :ivar delete_option: Specifies whether data disk should be deleted or detached upon VMSS Flex
     ...
     only).\\ :code:`<br>`\\ :code:`<br>` Possible values: :code:`<br>`\\ :code:`<br>` **Delete**
     If this value is used, the
     data disk is deleted when the VMSS Flex VM is deleted.\\ :code:`<br>`\\ :code:`<br>`
     **Detach** If
...
class VirtualMachineScaleSetOSDisk(_model_base.Model):
    ...
    :ivar delete_option: Specifies whether OS Disk should be deleted or detached upon VMSS Flex
     ...
     value
     is used, the OS disk is retained after VMSS Flex VM is deleted. :code:`<br>`\\ :code:`<br>`
     The
    ...
    """Specifies whether OS Disk should be deleted or detached upon VMSS Flex deletion
     (This feature is available for VMSS with Flexible OrchestrationMode only).
     :code:`<br>`\ :code:`<br>` Possible values: :code:`<br>`\ :code:`<br>` **Delete** If this value
     is used, the OS
     disk is deleted when VMSS Flex VM is deleted.\ :code:`<br>`\ :code:`<br>` **Detach** If this
     value
...
class VirtualMachineScaleSetOSProfile(_model_base.Model):
     ...
     **Max-length
     ...
     :code:`<br>`\ :code:`<br>` **Disallowed values:** \"abc@123\", \"P@$$w0rd\", \"P@ssw0rd\",
     \"P@ssword123\", \"Pa$$word\", \"pass@word1\", \"Password!\", \"Password1\",
     \"Password22\", \"iloveyou!\" :code:`<br>`\ :code:`<br>` For resetting the password, see `How
     to
     reset the Remote Desktop service or its login password in a Windows
     VM <https://learn.microsoft.com/troubleshoot/azure/virtual-machines/reset-rdp>`_
     :code:`<br>`\ :code:`<br>` For resetting root password, see `Manage users, SSH, and check or
