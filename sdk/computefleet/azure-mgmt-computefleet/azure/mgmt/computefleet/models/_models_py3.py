...
class BaseVirtualMachineProfile(_serialization.Model):  # pylint: disable=too-many-instance-attributes
...
class LocationProfile(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword location: The ARM location name of the additional region.
        :paramtype location: str
...
class VMAttributes(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword local_storage_in_gi_b: The range of local storage in GB specified from Min to Max.
