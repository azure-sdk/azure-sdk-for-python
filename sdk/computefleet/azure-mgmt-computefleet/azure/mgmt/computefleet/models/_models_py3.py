...
class ManagedServiceIdentityUpdate(_serialization.Model):
    ...
    :vartype user_assigned_identities: dict[str,
     ~azure.mgmt.computefleet.models.ComponentsQjfoe3SchemasManagedserviceidentityupdatePropertiesUserassignedidentitiesAdditionalproperties]  # pylint: disable=line-too-long
    """
