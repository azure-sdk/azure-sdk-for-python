...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.AzureFleet/fleets")
...
def build_get_request(resource_group_name: str, fleet_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    path_format_arguments = {
        ...
        "fleetName": _SERIALIZER.url("fleet_name", fleet_name, "str", pattern=r"^[^_\W][\w\-._]{0,79}(?<![-.])$"),
    }
...
def build_list_virtual_machine_scale_sets_request(  # pylint: disable=name-too-long
    ...
    path_format_arguments = {
        ...
        "name": _SERIALIZER.url("name", name, "str", pattern=r"^[^_\W][\w\-._]{0,79}(?<![-.])$"),
    }
...
class FleetsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.computefleet.MicrosoftAzureFleet`'s
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._config: MicrosoftAzureFleetConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
    ...
    def begin_create_or_update(
        ...
        :param resource: Resource create parameters. Is either a Fleet type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.computefleet.models.Fleet or IO[bytes]
        :return: An instance of LROPoller that returns either Fleet or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.computefleet.models.Fleet]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.computefleet.models.FleetUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either Fleet or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.computefleet.models.Fleet]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_virtual_machine_scale_sets(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_virtual_machine_scale_sets_request(
                    resource_group_name=resource_group_name,
                    name=name,
                    subscription_id=self._config.subscription_id,
                    api_version=api_version,
