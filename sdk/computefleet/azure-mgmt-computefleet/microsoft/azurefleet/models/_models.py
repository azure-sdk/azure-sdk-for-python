...
class AdditionalLocationsProfile(_model_base.Model):
    ...
    :vartype location_profiles: list[~microsoft.azurefleet.models.LocationProfile]
    """

    location_profiles: List["_models.LocationProfile"] = rest_field(
        name="locationProfiles", visibility=["read", "create", "update", "delete", "query"]
    )
...
class AdditionalUnattendContent(_model_base.Model):
    ...
    :vartype setting_name: str or ~microsoft.azurefleet.models.SettingNames
...
class ApiError(_model_base.Model):
    ...
    :vartype details: list[~microsoft.azurefleet.models.ApiErrorBase]
    :ivar innererror: The API inner error.
    :vartype innererror: ~microsoft.azurefleet.models.InnerError
    """
...
class ApplicationProfile(_model_base.Model):
    ...
    :ivar gallery_applications: Specifies the gallery applications that should be made available to
     the VM/VMSS.
    :vartype gallery_applications: list[~microsoft.azurefleet.models.VMGalleryApplication]
    """
...
class BaseVirtualMachineProfile(_model_base.Model):
    ...
    :ivar os_profile: Specifies the operating system settings for the virtual machines in the scale
     set.
    :vartype os_profile: ~microsoft.azurefleet.models.VirtualMachineScaleSetOSProfile
    :ivar storage_profile: Specifies the storage settings for the virtual machine disks.
    :vartype storage_profile: ~microsoft.azurefleet.models.VirtualMachineScaleSetStorageProfile
    :ivar network_profile: Specifies properties of the network interfaces of the virtual machines
     in the
     scale set.
    :vartype network_profile: ~microsoft.azurefleet.models.VirtualMachineScaleSetNetworkProfile
    :ivar security_profile: Specifies the Security related profile settings for the virtual
     machines in the
     scale set.
    :vartype security_profile: ~microsoft.azurefleet.models.SecurityProfile
    :ivar diagnostics_profile: Specifies the boot diagnostic settings state.
    :vartype diagnostics_profile: ~microsoft.azurefleet.models.DiagnosticsProfile
    :ivar extension_profile: Specifies a collection of settings for extensions installed on virtual
     machines
     in the scale set.
    :vartype extension_profile: ~microsoft.azurefleet.models.VirtualMachineScaleSetExtensionProfile
    ...
    :vartype scheduled_events_profile: ~microsoft.azurefleet.models.ScheduledEventsProfile
    ...
    :vartype capacity_reservation: ~microsoft.azurefleet.models.CapacityReservationProfile
    :ivar application_profile: Specifies the gallery applications that should be made available to
     the VM/VMSS.
    :vartype application_profile: ~microsoft.azurefleet.models.ApplicationProfile
    :ivar hardware_profile: Specifies the hardware profile related details of a scale set. Minimum
     api-version: 2021-11-01.
    :vartype hardware_profile: ~microsoft.azurefleet.models.VirtualMachineScaleSetHardwareProfile
    ...
    :vartype service_artifact_reference: ~microsoft.azurefleet.models.ServiceArtifactReference
    ...
    :vartype security_posture_reference: ~microsoft.azurefleet.models.SecurityPostureReference
    ...
    os_profile: Optional["_models.VirtualMachineScaleSetOSProfile"] = rest_field(
    ...
    """Specifies the operating system settings for the virtual machines in the scale
     set."""
    storage_profile: Optional["_models.VirtualMachineScaleSetStorageProfile"] = rest_field(
        name="storageProfile", visibility=["read", "create", "update", "delete", "query"]
    )
    """Specifies the storage settings for the virtual machine disks."""
    network_profile: Optional["_models.VirtualMachineScaleSetNetworkProfile"] = rest_field(
    ...
    extension_profile: Optional["_models.VirtualMachineScaleSetExtensionProfile"] = rest_field(
        name="extensionProfile", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    """Specifies the gallery applications that should be made available to the VM/VMSS."""
    hardware_profile: Optional["_models.VirtualMachineScaleSetHardwareProfile"] = rest_field(
    ...
    security_posture_reference: Optional["_models.SecurityPostureReference"] = rest_field(
        name="securityPostureReference", visibility=["read", "create", "update", "delete", "query"]
    )
...
class CapacityReservationProfile(_model_base.Model):
    ...
    :ivar capacity_reservation_group: Specifies the capacity reservation group resource id that
     ...
     <https://aka.ms/CapacityReservation>`_
     for more details.
    :vartype capacity_reservation_group: ~microsoft.azurefleet.models.SubResource
    """
...
class ComputeProfile(_model_base.Model):
    ...
    :ivar base_virtual_machine_profile: Base Virtual Machine Profile Properties to be specified
     ...
     Required.
    :vartype base_virtual_machine_profile: ~microsoft.azurefleet.models.BaseVirtualMachineProfile
    ...
    :vartype additional_virtual_machine_capabilities:
     ~microsoft.azurefleet.models.AdditionalCapabilities
    """

    base_virtual_machine_profile: "_models.BaseVirtualMachineProfile" = rest_field(
        name="baseVirtualMachineProfile", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    """Specifies the Microsoft.Compute API version to use when creating underlying Virtual Machine
     ...
     The default value will be the latest supported computeApiVersion by Compute Fleet."""
    platform_fault_domain_count: Optional[int] = rest_field(
        name="platformFaultDomainCount", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    additional_virtual_machine_capabilities: Optional["_models.AdditionalCapabilities"] = rest_field(
        name="additionalVirtualMachineCapabilities", visibility=["read", "create", "update", "delete", "query"]
    )
...
class DiagnosticsProfile(_model_base.Model):
    ...
    :vartype boot_diagnostics: ~microsoft.azurefleet.models.BootDiagnostics
    """
...
class DiffDiskSettings(_model_base.Model):
    ...
    :vartype option: str or ~microsoft.azurefleet.models.DiffDiskOptions
     ...
     **CacheDisk** if one is configured for the VM size otherwise **ResourceDisk**
     ...
     <https://learn.microsoft.com/azure/virtual-machines/linux/sizes>`_ to check which VM
     sizes exposes a cache disk. Known values are: "CacheDisk", "ResourceDisk", and "NvmeDisk".
    :vartype placement: str or ~microsoft.azurefleet.models.DiffDiskPlacement
    """
...
class DiskEncryptionSetParameters(_model_base.Model):
    ...
    `https://aka.ms/mdssewithcmkoverview <https://aka.ms/mdssewithcmkoverview>`_ for more details.
...
class ErrorDetail(_model_base.Model):
    ...
    :vartype details: list[~microsoft.azurefleet.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info: list[~microsoft.azurefleet.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(_model_base.Model):
    ...
    :vartype error: ~microsoft.azurefleet.models.ErrorDetail
    """
...
class Resource(_model_base.Model):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~microsoft.azurefleet.models.SystemData
    """
...
class Fleet(TrackedResource):
    ...
    :vartype properties: ~microsoft.azurefleet.models.FleetProperties
    :ivar zones: Zones in which the Compute Fleet is available.
    :vartype zones: list[str]
    :ivar identity: The managed service identities assigned to this resource.
    :vartype identity: ~microsoft.azurefleet.models.ManagedServiceIdentity
    :ivar plan: Details of the resource plan.
    :vartype plan: ~microsoft.azurefleet.models.Plan
    """
...
class FleetProperties(_model_base.Model):
    ...
    :vartype provisioning_state: str or ~microsoft.azurefleet.models.ProvisioningState
    :ivar spot_priority_profile: Configuration Options for Spot instances in Compute Fleet.
    :vartype spot_priority_profile: ~microsoft.azurefleet.models.SpotPriorityProfile
    :ivar regular_priority_profile: Configuration Options for Regular instances in Compute Fleet.
    :vartype regular_priority_profile: ~microsoft.azurefleet.models.RegularPriorityProfile
    :ivar vm_sizes_profile: List of VM sizes supported for Compute Fleet. Required.
    :vartype vm_sizes_profile: list[~microsoft.azurefleet.models.VmSizeProfile]
    :ivar vm_attributes: Attribute based Fleet.
    :vartype vm_attributes: ~microsoft.azurefleet.models.VMAttributes
    ...
    :vartype additional_locations_profile: ~microsoft.azurefleet.models.AdditionalLocationsProfile
    :ivar compute_profile: Compute Profile to use for running user's workloads. Required.
    :vartype compute_profile: ~microsoft.azurefleet.models.ComputeProfile
    ...
    spot_priority_profile: Optional["_models.SpotPriorityProfile"] = rest_field(
        name="spotPriorityProfile", visibility=["read", "create", "update", "delete", "query"]
    )
    """Configuration Options for Spot instances in Compute Fleet."""
    regular_priority_profile: Optional["_models.RegularPriorityProfile"] = rest_field(
        name="regularPriorityProfile", visibility=["read", "create", "update", "delete", "query"]
    )
    """Configuration Options for Regular instances in Compute Fleet."""
    vm_sizes_profile: List["_models.VmSizeProfile"] = rest_field(
    ...
    additional_locations_profile: Optional["_models.AdditionalLocationsProfile"] = rest_field(
        name="additionalLocationsProfile", visibility=["read", "create", "update", "delete", "query"]
    )
    """Represents the configuration for additional locations where Fleet resources may be deployed."""
...
class FleetUpdate(_model_base.Model):
    ...
    :vartype identity: ~microsoft.azurefleet.models.ManagedServiceIdentityUpdate
    :ivar plan: Updatable resource plan.
    :vartype plan: ~microsoft.azurefleet.models.ResourcePlanUpdate
...
class KeyVaultSecretReference(_model_base.Model):
    ...
    :vartype source_vault: ~microsoft.azurefleet.models.SubResource
    """
...
class LinuxConfiguration(_model_base.Model):
    ...
    :vartype ssh: ~microsoft.azurefleet.models.SshConfiguration
    ...
    :ivar patch_settings: [Preview Feature] Specifies settings related to VM Guest Patching on
     Linux.
    :vartype patch_settings: ~microsoft.azurefleet.models.LinuxPatchSettings
...
class LinuxPatchSettings(_model_base.Model):
     ...
     **AutomaticByPlatform** - The virtual machine will be automatically updated by
     ...
     "AutomaticByPlatform".
    :vartype patch_mode: str or ~microsoft.azurefleet.models.LinuxVMGuestPatchMode
     ...
     **AutomaticByPlatform** - The platform will trigger periodic patch assessments.
     ...
     "AutomaticByPlatform".
    :vartype assessment_mode: str or ~microsoft.azurefleet.models.LinuxPatchAssessmentMode
    ...
    :vartype automatic_by_platform_settings:
     ~microsoft.azurefleet.models.LinuxVMGuestPatchAutomaticByPlatformSettings
    """
...
class LinuxVMGuestPatchAutomaticByPlatformSettings(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype reboot_setting: str or
     ~microsoft.azurefleet.models.LinuxVMGuestPatchAutomaticByPlatformRebootSetting
...
class LocationProfile(_model_base.Model):
    ...
    :vartype virtual_machine_profile_override:
     ~microsoft.azurefleet.models.BaseVirtualMachineProfile
    """
    ...
    virtual_machine_profile_override: Optional["_models.BaseVirtualMachineProfile"] = rest_field(
        name="virtualMachineProfileOverride", visibility=["read", "create", "update", "delete", "query"]
    )
...
class ManagedServiceIdentity(_model_base.Model):
    ...
    :vartype type: str or ~microsoft.azurefleet.models.ManagedServiceIdentityType
    :ivar user_assigned_identities: The identities assigned to this resource by the user.
    :vartype user_assigned_identities: dict[str, ~microsoft.azurefleet.models.UserAssignedIdentity]
    """
...
class Operation(_model_base.Model):
    ...
    :vartype display: ~microsoft.azurefleet.models.OperationDisplay
    :ivar origin: The intended executor of the operation; as in Resource Based Access Control
     (RBAC) and audit logs UX. Default value is "user,system". Known values are: "user", "system",
     and "user,system".
    :vartype origin: str or ~microsoft.azurefleet.models.Origin
    :ivar action_type: Extensible enum. Indicates the action type. "Internal" refers to actions
     that are for internal only APIs. "Internal"
    :vartype action_type: str or ~microsoft.azurefleet.models.ActionType
    """
...
class PatchSettings(_model_base.Model):
    ...
    :vartype patch_mode: str or ~microsoft.azurefleet.models.WindowsVMGuestPatchMode
     ...
     **AutomaticByPlatform** - The platform will trigger periodic patch assessments.
     The property provisionVMAgent must be true. Known values are: "ImageDefault" and
     "AutomaticByPlatform".
    :vartype assessment_mode: str or ~microsoft.azurefleet.models.WindowsPatchAssessmentMode
    :ivar automatic_by_platform_settings: Specifies additional settings for patch mode
     AutomaticByPlatform in VM Guest
     Patching on Windows.
    :vartype automatic_by_platform_settings:
     ~microsoft.azurefleet.models.WindowsVMGuestPatchAutomaticByPlatformSettings
    """
...
class ProxyAgentSettings(_model_base.Model):
    ...
    :vartype mode: str or ~microsoft.azurefleet.models.Mode
...
class PublicIPAddressSku(_model_base.Model):
    ...
    :vartype name: str or ~microsoft.azurefleet.models.PublicIPAddressSkuName
    :ivar tier: Specify public IP sku tier. Known values are: "Regional" and "Global".
    :vartype tier: str or ~microsoft.azurefleet.models.PublicIPAddressSkuTier
    """
...
class RegularPriorityProfile(_model_base.Model):
    ...
    :vartype allocation_strategy: str or
     ~microsoft.azurefleet.models.RegularPriorityAllocationStrategy
    """
...
class ScheduledEventsProfile(_model_base.Model):
    ...
    :vartype terminate_notification_profile:
     ~microsoft.azurefleet.models.TerminateNotificationProfile
    :ivar os_image_notification_profile: Specifies OS Image Scheduled Event related configurations.
    :vartype os_image_notification_profile: ~microsoft.azurefleet.models.OSImageNotificationProfile
    """
...
class SecurityPostureReference(_model_base.Model):
    ...
    """The security posture reference id in the form of
     /CommunityGalleries/{communityGalleryName}/securityPostures/{securityPostureName}/versions/{major.minor.patch}|{major.*}|latest."""
    exclude_extensions: Optional[List[str]] = rest_field(
        name="excludeExtensions", visibility=["read", "create", "update", "delete", "query"]
    )
    """List of virtual machine extension names to exclude when applying the security
     posture."""
    is_overridable: Optional[bool] = rest_field(
        name="isOverridable", visibility=["read", "create", "update", "delete", "query"]
    )
...
class SecurityProfile(_model_base.Model):
    ...
    :vartype uefi_settings: ~microsoft.azurefleet.models.UefiSettings
    ...
    :ivar security_type: Specifies the SecurityType of the virtual machine. It has to be set to any
     ...
     "ConfidentialVM".
    :vartype security_type: str or ~microsoft.azurefleet.models.SecurityTypes
    :ivar encryption_identity: Specifies the Managed Identity used by ADE to get access token for
     keyvault
     operations.
    :vartype encryption_identity: ~microsoft.azurefleet.models.EncryptionIdentity
    :ivar proxy_agent_settings: Specifies ProxyAgent settings while creating the virtual machine.
     Minimum
     api-version: 2023-09-01.
    :vartype proxy_agent_settings: ~microsoft.azurefleet.models.ProxyAgentSettings
    """
...
class SpotPriorityProfile(_model_base.Model):
    ...
    :vartype eviction_policy: str or ~microsoft.azurefleet.models.EvictionPolicy
    :ivar allocation_strategy: Allocation strategy to follow when determining the VM sizes
     distribution for Spot VMs. Known values are: "PriceCapacityOptimized", "LowestPrice", and
     "CapacityOptimized".
    :vartype allocation_strategy: str or ~microsoft.azurefleet.models.SpotAllocationStrategy
    ...
    """Eviction Policy to follow when evicting Spot VMs. Known values are: \"Delete\" and
     \"Deallocate\"."""
    allocation_strategy: Optional[Union[str, "_models.SpotAllocationStrategy"]] = rest_field(
        name="allocationStrategy", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    maintain: Optional[bool] = rest_field(visibility=["read", "create", "update", "delete", "query"])
...
class SshConfiguration(_model_base.Model):
    ...
    :vartype public_keys: list[~microsoft.azurefleet.models.SshPublicKey]
    """
...
class SystemData(_model_base.Model):
    ...
    :vartype created_by_type: str or ~microsoft.azurefleet.models.CreatedByType
    ...
    :vartype last_modified_by_type: str or ~microsoft.azurefleet.models.CreatedByType
...
class VaultSecretGroup(_model_base.Model):
    ...
    :ivar vault_certificates: The list of key vault references in SourceVault which contain
     certificates.
    :vartype vault_certificates: list[~microsoft.azurefleet.models.VaultCertificate]
    """
...
class VirtualMachineScaleSet(_model_base.Model):
    ...
    :vartype operation_status: str or ~microsoft.azurefleet.models.ProvisioningState
    :ivar error: Error Information when ``operationStatus`` is ``Failed``.
    :vartype error: ~microsoft.azurefleet.models.ApiError
    """
...
class VirtualMachineScaleSetDataDisk(_model_base.Model):
     ...
     **ReadOnly,** **ReadWrite.** The default values are: **None for Standard
     ...
     "ReadWrite".
    :vartype caching: str or ~microsoft.azurefleet.models.CachingTypes
    ...
    :vartype create_option: str or ~microsoft.azurefleet.models.DiskCreateOptionTypes
    ...
    :vartype managed_disk: ~microsoft.azurefleet.models.VirtualMachineScaleSetManagedDiskParameters
    ...
    :ivar delete_option: Specifies whether data disk should be deleted or detached upon VMSS Flex
     ...
     deleted.<br><br> The default value is set to **Delete**. Known values are: "Delete" and
     "Detach".
    :vartype delete_option: str or ~microsoft.azurefleet.models.DiskDeleteOptionTypes
    """
    ...
    disk_iops_read_write: Optional[int] = rest_field(
        name="diskIOPSReadWrite", visibility=["read", "create", "update", "delete", "query"]
    )
    """Specifies the Read-Write IOPS for the managed disk. Should be used only when
     StorageAccountType is UltraSSD_LRS. If not specified, a default value would be
     assigned based on diskSizeGB."""
    disk_m_bps_read_write: Optional[int] = rest_field(
        name="diskMBpsReadWrite", visibility=["read", "create", "update", "delete", "query"]
    )
...
class VirtualMachineScaleSetExtension(_model_base.Model):
    ...
    :vartype properties: ~microsoft.azurefleet.models.VirtualMachineScaleSetExtensionProperties
    """
...
class VirtualMachineScaleSetExtensionProfile(_model_base.Model):
    ...
    :vartype extensions: list[~microsoft.azurefleet.models.VirtualMachineScaleSetExtension]
...
class VirtualMachineScaleSetExtensionProperties(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype protected_settings_from_key_vault:
     ~microsoft.azurefleet.models.KeyVaultSecretReference
    """
...
class VirtualMachineScaleSetHardwareProfile(_model_base.Model):
    ...
    :vartype vm_size_properties: ~microsoft.azurefleet.models.VMSizeProperties
    """
...
class VirtualMachineScaleSetIPConfiguration(_model_base.Model):
    ...
    :ivar properties: Describes a virtual machine scale set network profile's IP configuration
     properties.
    :vartype properties:
     ~microsoft.azurefleet.models.VirtualMachineScaleSetIPConfigurationProperties
    """
...
class VirtualMachineScaleSetIPConfigurationProperties(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype subnet: ~microsoft.azurefleet.models.ApiEntityReference
    ...
    :vartype public_ip_address_configuration:
     ~microsoft.azurefleet.models.VirtualMachineScaleSetPublicIPAddressConfiguration
    ...
    :vartype private_ip_address_version: str or ~microsoft.azurefleet.models.IPVersion
    ...
    :vartype application_gateway_backend_address_pools:
     list[~microsoft.azurefleet.models.SubResource]
    :ivar application_security_groups: Specifies an array of references to application security
     group.
    :vartype application_security_groups: list[~microsoft.azurefleet.models.SubResource]
    ...
    :vartype load_balancer_backend_address_pools: list[~microsoft.azurefleet.models.SubResource]
    ...
    :vartype load_balancer_inbound_nat_pools: list[~microsoft.azurefleet.models.SubResource]
    """
    ...
    public_ip_address_configuration: Optional["_models.VirtualMachineScaleSetPublicIPAddressConfiguration"] = (
        rest_field(name="publicIPAddressConfiguration", visibility=["read", "create", "update", "delete", "query"])
    )
...
class VirtualMachineScaleSetManagedDiskParameters(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :ivar storage_account_type: Specifies the storage account type for the managed disk. NOTE:
     ...
     "PremiumV2_LRS".
    :vartype storage_account_type: str or ~microsoft.azurefleet.models.StorageAccountTypes
    :ivar disk_encryption_set: Specifies the customer managed disk encryption set resource id for
     the managed
     disk.
    :vartype disk_encryption_set: ~microsoft.azurefleet.models.DiskEncryptionSetParameters
    :ivar security_profile: Specifies the security profile for the managed disk.
    :vartype security_profile: ~microsoft.azurefleet.models.VMDiskSecurityProfile
    """
...
class VirtualMachineScaleSetNetworkConfiguration(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :ivar properties: Describes a virtual machine scale set network profile's IP configuration.
    :vartype properties:
     ~microsoft.azurefleet.models.VirtualMachineScaleSetNetworkConfigurationProperties
    """
...
class VirtualMachineScaleSetNetworkConfigurationProperties(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype network_security_group: ~microsoft.azurefleet.models.SubResource
    :ivar dns_settings: The dns settings to be applied on the network interfaces.
    :vartype dns_settings:
     ~microsoft.azurefleet.models.VirtualMachineScaleSetNetworkConfigurationDnsSettings
    :ivar ip_configurations: Specifies the IP configurations of the network interface. Required.
    :vartype ip_configurations:
     list[~microsoft.azurefleet.models.VirtualMachineScaleSetIPConfiguration]
    ...
    :vartype delete_option: str or ~microsoft.azurefleet.models.DeleteOptions
    ...
    :vartype auxiliary_mode: str or ~microsoft.azurefleet.models.NetworkInterfaceAuxiliaryMode
    ...
    :vartype auxiliary_sku: str or ~microsoft.azurefleet.models.NetworkInterfaceAuxiliarySku
    """
    ...
    ip_configurations: List["_models.VirtualMachineScaleSetIPConfiguration"] = rest_field(
...
class VirtualMachineScaleSetNetworkProfile(_model_base.Model):
    ...
    :vartype health_probe: ~microsoft.azurefleet.models.ApiEntityReference
    :ivar network_interface_configurations: The list of network configurations.
    :vartype network_interface_configurations:
     list[~microsoft.azurefleet.models.VirtualMachineScaleSetNetworkConfiguration]
    ...
    :vartype network_api_version: str or ~microsoft.azurefleet.models.NetworkApiVersion
    """

    health_probe: Optional["_models.ApiEntityReference"] = rest_field(
        name="healthProbe", visibility=["read", "create", "update", "delete", "query"]
    )
...
class VirtualMachineScaleSetOSDisk(_model_base.Model):
    ...
    :vartype diff_disk_settings: ~microsoft.azurefleet.models.DiffDiskSettings
    :ivar disk_size_gb: Specifies the size of an empty data disk in gigabytes. This element can be
     used
    ...
    :vartype os_type: str or ~microsoft.azurefleet.models.OperatingSystemTypes
    :ivar image: Specifies information about the unmanaged user image to base the scale set on.
    :vartype image: ~microsoft.azurefleet.models.VirtualHardDisk
    ...
    vhd_containers: Optional[List[str]] = rest_field(
        name="vhdContainers", visibility=["read", "create", "update", "delete", "query"]
    )
...
class VirtualMachineScaleSetOSProfile(_model_base.Model):
    ...
    :ivar windows_configuration: Specifies Windows operating system settings on the virtual
     machine.
    :vartype windows_configuration: ~microsoft.azurefleet.models.WindowsConfiguration
    :ivar linux_configuration: Specifies the Linux operating system settings on the virtual
     machine. For a
     list of supported Linux distributions, see `Linux on Azure-Endorsed
     Distributions <https://learn.microsoft.com/azure/virtual-machines/linux/endorsed-distros>`_.
    :vartype linux_configuration: ~microsoft.azurefleet.models.LinuxConfiguration
    :ivar secrets: Specifies set of certificates that should be installed onto the virtual
     ...
     or the `Azure Key Vault virtual machine extension for
     Windows <https://learn.microsoft.com/azure/virtual-machines/extensions/key-vault-windows>`_.
    :vartype secrets: list[~microsoft.azurefleet.models.VaultSecretGroup]
...
class VirtualMachineScaleSetPublicIPAddressConfiguration(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :ivar properties: Describes a virtual machines scale set IP Configuration's PublicIPAddress
     configuration.
    :vartype properties:
     ~microsoft.azurefleet.models.VirtualMachineScaleSetPublicIPAddressConfigurationProperties
    :ivar sku: Describes the public IP Sku. It can only be set with OrchestrationMode as
     Flexible.
    :vartype sku: ~microsoft.azurefleet.models.PublicIPAddressSku
    """
...
class VirtualMachineScaleSetPublicIPAddressConfigurationDnsSettings(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :ivar domain_name_label_scope: The Domain name label scope.The concatenation of the hashed
     ...
     "NoReuse".
    :vartype domain_name_label_scope: str or ~microsoft.azurefleet.models.DomainNameLabelScopeTypes
    """
...
class VirtualMachineScaleSetPublicIPAddressConfigurationProperties(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype dns_settings:
     ~microsoft.azurefleet.models.VirtualMachineScaleSetPublicIPAddressConfigurationDnsSettings
    :ivar ip_tags: The list of IP tags associated with the public IP address.
    :vartype ip_tags: list[~microsoft.azurefleet.models.VirtualMachineScaleSetIpTag]
    :ivar public_ip_prefix: The PublicIPPrefix from which to allocate publicIP addresses.
    :vartype public_ip_prefix: ~microsoft.azurefleet.models.SubResource
    :ivar public_ip_address_version: Available from Api-Version 2019-07-01 onwards, it represents
     whether the
     specific ipconfiguration is IPv4 or IPv6. Default is taken as IPv4. Possible
     values are: 'IPv4' and 'IPv6'. Known values are: "IPv4" and "IPv6".
    :vartype public_ip_address_version: str or ~microsoft.azurefleet.models.IPVersion
    ...
    ip_tags: Optional[List["_models.VirtualMachineScaleSetIpTag"]] = rest_field(
...
class VirtualMachineScaleSetStorageProfile(_model_base.Model):
    ...
    :vartype image_reference: ~microsoft.azurefleet.models.ImageReference
    ...
    :vartype os_disk: ~microsoft.azurefleet.models.VirtualMachineScaleSetOSDisk
    :ivar data_disks: Specifies the parameters that are used to add data disks to the virtual
     machines in the scale set. For more information about disks, see `About disks
     and VHDs for Azure virtual
     machines <https://learn.microsoft.com/azure/virtual-machines/managed-disks-overview>`_.
    :vartype data_disks: list[~microsoft.azurefleet.models.VirtualMachineScaleSetDataDisk]
    :ivar disk_controller_type: Specifies the disk controller type configured for the virtual
     ...
     "NVMe".
    :vartype disk_controller_type: str or ~microsoft.azurefleet.models.DiskControllerTypes
    """
    ...
    """Specifies information about the image to use. You can specify information about
     ...
     required when you want to use a platform image, marketplace image, or virtual
     machine image, but is not used in other creation operations."""
    os_disk: Optional["_models.VirtualMachineScaleSetOSDisk"] = rest_field(
    ...
    """Specifies information about the operating system disk used by the virtual
     ...
     and VHDs for Azure virtual
     machines <https://learn.microsoft.com/azure/virtual-machines/managed-disks-overview>`_."""
    data_disks: Optional[List["_models.VirtualMachineScaleSetDataDisk"]] = rest_field(
...
class VMAttributes(_model_base.Model):
    ...
    :vartype v_cpu_count: ~microsoft.azurefleet.models.VMAttributeMinMaxInteger
    :ivar memory_in_gi_b: The range of memory specified from Min to Max. Must be specified if
     VMAttributes are specified, either Min or Max is required if specified. Required.
    :vartype memory_in_gi_b: ~microsoft.azurefleet.models.VMAttributeMinMaxDouble
    ...
    :vartype memory_in_gi_b_per_v_cpu: ~microsoft.azurefleet.models.VMAttributeMinMaxDouble
    ...
    :vartype local_storage_support: str or ~microsoft.azurefleet.models.VMAttributeSupport
    ...
    :vartype local_storage_in_gi_b: ~microsoft.azurefleet.models.VMAttributeMinMaxDouble
    ...
    :vartype local_storage_disk_types: list[str or
     ~microsoft.azurefleet.models.LocalStorageDiskType]
    ...
    :vartype data_disk_count: ~microsoft.azurefleet.models.VMAttributeMinMaxInteger
    :ivar network_interface_count: The range of network interface count specified from Min to Max.
     Optional parameter. Either Min or Max is required if specified.
    :vartype network_interface_count: ~microsoft.azurefleet.models.VMAttributeMinMaxInteger
    ...
    :vartype network_bandwidth_in_mbps: ~microsoft.azurefleet.models.VMAttributeMinMaxDouble
    ...
    :vartype rdma_support: str or ~microsoft.azurefleet.models.VMAttributeSupport
    ...
    :vartype rdma_network_interface_count: ~microsoft.azurefleet.models.VMAttributeMinMaxInteger
    :ivar accelerator_support: Specifies whether the VMSize supporting accelerator should be used
     ...
     "Excluded", "Included", and "Required".
    :vartype accelerator_support: str or ~microsoft.azurefleet.models.VMAttributeSupport
    ...
    :vartype accelerator_manufacturers: list[str or
     ~microsoft.azurefleet.models.AcceleratorManufacturer]
    :ivar accelerator_types: The accelerator types specified as a list. acceleratorSupport should
     ...
     If acceleratorSupport is "Excluded", this VMAttribute can not be used.
    :vartype accelerator_types: list[str or ~microsoft.azurefleet.models.AcceleratorType]
    :ivar accelerator_count: The range of accelerator count specified from min to max. Optional
     parameter. Either Min or Max is required if specified.
     acceleratorSupport should be set to "Included" or "Required" to use this VMAttribute.
     If acceleratorSupport is "Excluded", this VMAttribute can not be used.
    :vartype accelerator_count: ~microsoft.azurefleet.models.VMAttributeMinMaxInteger
    :ivar vm_categories: The VM category specified as a list. Optional parameter.
    :vartype vm_categories: list[str or ~microsoft.azurefleet.models.VMCategory]
    :ivar architecture_types: The VM architecture types specified as a list. Optional parameter.
    :vartype architecture_types: list[str or ~microsoft.azurefleet.models.ArchitectureType]
    :ivar cpu_manufacturers: The VM CPU manufacturers specified as a list. Optional parameter.
    :vartype cpu_manufacturers: list[str or ~microsoft.azurefleet.models.CpuManufacturer]
    ...
    :vartype burstable_support: str or ~microsoft.azurefleet.models.VMAttributeSupport
    ...
    architecture_types: Optional[List[Union[str, "_models.ArchitectureType"]]] = rest_field(
...
class VMDiskSecurityProfile(_model_base.Model):
    ...
    :vartype security_encryption_type: str or ~microsoft.azurefleet.models.SecurityEncryptionTypes
    :ivar disk_encryption_set: Specifies the customer managed disk encryption set resource id for
     the managed
...
class WindowsConfiguration(_model_base.Model):
    ...
    :vartype additional_unattend_content:
     list[~microsoft.azurefleet.models.AdditionalUnattendContent]
    :ivar patch_settings: [Preview Feature] Specifies settings related to VM Guest Patching on
     Windows.
    :vartype patch_settings: ~microsoft.azurefleet.models.PatchSettings
    :ivar win_rm: Specifies the Windows Remote Management listeners. This enables remote Windows
     PowerShell.
    :vartype win_rm: ~microsoft.azurefleet.models.WinRMConfiguration
    :ivar enable_vm_agent_platform_updates: Indicates whether VMAgent Platform Updates is enabled
...
class WindowsVMGuestPatchAutomaticByPlatformSettings(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :ivar reboot_setting: Specifies the reboot setting for all AutomaticByPlatform patch
     ...
     operations. Known values are: "Unknown", "IfRequired", "Never", and "Always".
    :vartype reboot_setting: str or
     ~microsoft.azurefleet.models.WindowsVMGuestPatchAutomaticByPlatformRebootSetting
    :ivar bypass_platform_safety_checks_on_user_schedule: Enables customer to schedule patching
     without accidental upgrades.
    :vartype bypass_platform_safety_checks_on_user_schedule: bool
    """
...
class WinRMConfiguration(_model_base.Model):
    ...
    :vartype listeners: list[~microsoft.azurefleet.models.WinRMListener]
    """
...
class WinRMListener(_model_base.Model):
    ...
    :vartype protocol: str or ~microsoft.azurefleet.models.ProtocolTypes
    :ivar certificate_url: This is the URL of a certificate that has been uploaded to Key Vault as
     a
     secret. For adding a secret to the Key Vault, see `Add a key or secret to the
     key
