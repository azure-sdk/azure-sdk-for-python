...
# --------------------------------------------------------------------------
import pytest
from azure.mgmt.computefleet.aio import MicrosoftAzureFleet
...
class TestMicrosoftAzureFleetFleetsOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(MicrosoftAzureFleet, is_async=True)
