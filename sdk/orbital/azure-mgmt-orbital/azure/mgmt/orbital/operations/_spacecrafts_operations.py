...
class SpacecraftsOperations:
    ...
    def get(self, resource_group_name: str, spacecraft_name: str, **kwargs: Any) -> _models.Spacecraft:
        ...
        deserialized = self._deserialize("Spacecraft", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        spacecraft_name: str,
        parameters: Union[_models.Spacecraft, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "Spacecraft")
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param spacecraft_name: Spacecraft ID. Required.
        :type spacecraft_name: str
        :param parameters: The parameters to provide for the created spacecraft. Required.
        :type parameters: ~azure.mgmt.orbital.models.Spacecraft
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param spacecraft_name: Spacecraft ID. Required.
        :type spacecraft_name: str
        :param parameters: The parameters to provide for the created spacecraft. Is either a Spacecraft
         type or a IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.orbital.models.Spacecraft or IO[bytes]
        :return: An instance of LROPoller that returns either Spacecraft or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.orbital.models.Spacecraft]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if cont_token:
            return LROPoller[_models.Spacecraft].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.Spacecraft](
    ...
    def _delete_initial(self, resource_group_name: str, spacecraft_name: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def _list_available_contacts_initial(
        ...
        resource_group_name: str,
        spacecraft_name: str,
        parameters: Union[_models.ContactParameters, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "ContactParameters")

        _request = build_list_available_contacts_request(
            resource_group_name=resource_group_name,
            spacecraft_name=spacecraft_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def begin_list_available_contacts(
        ...
        resource_group_name: str,
        spacecraft_name: str,
        parameters: _models.ContactParameters,
        *,
        content_type: str = "application/json",
        **kwargs: Any
        ...
        :param spacecraft_name: Spacecraft ID. Required.
        :type spacecraft_name: str
        :param parameters: The parameters to provide for the contacts. Required.
        :type parameters: ~azure.mgmt.orbital.models.ContactParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    def begin_list_available_contacts(
        ...
        **kwargs: Any
        ...
        :param spacecraft_name: Spacecraft ID. Required.
        :type spacecraft_name: str
        :param parameters: The parameters to provide for the contacts. Is either a ContactParameters
         type or a IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.orbital.models.ContactParameters or IO[bytes]
        :return: An instance of LROPoller that returns an iterator like instance of either
         AvailableContactsListResult or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.core.paging.ItemPaged[~azure.mgmt.orbital.models.AvailableContacts]]
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("AvailableContactsListResult", pipeline_response.http_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.next_link or None, iter(list_of_elem)
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[Iterable["_models.AvailableContacts"]].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[Iterable["_models.AvailableContacts"]](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
