...
class PineconeVectorDbMgmtClient:
    ...
    :vartype operations: azure.mgmt.pineconevectordb.aio.operations.Operations
    :ivar organizations: OrganizationsOperations operations
    :vartype organizations: azure.mgmt.pineconevectordb.aio.operations.OrganizationsOperations
