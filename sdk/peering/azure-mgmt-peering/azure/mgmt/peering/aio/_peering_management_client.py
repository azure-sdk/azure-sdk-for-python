...
class PeeringManagementClient(
    ...
    :ivar resource_move: ResourceMoveOperations operations
    :vartype resource_move: azure.mgmt.peering.aio.operations.ResourceMoveOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.resource_move = ResourceMoveOperations(self._client, self._config, self._serialize, self._deserialize)
