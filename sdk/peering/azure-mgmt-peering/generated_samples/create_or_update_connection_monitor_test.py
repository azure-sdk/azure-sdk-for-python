...
# USAGE
    python create_or_update_connection_monitor_test.py
...
def main():
    ...
    response = client.connection_monitor_tests.create_or_update(
...
# x-ms-original-file: specification/peering/resource-manager/Microsoft.Peering/stable/2025-05-01/examples/CreateOrUpdateConnectionMonitorTest.json
