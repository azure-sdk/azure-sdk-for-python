...
class MicrosoftMobilePacketCoreMobilePacketCoreService:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes,name-too-long
    ...
    :vartype operations: azure.mgmt.mobileCore.aio.operations.Operations
    :ivar amf_deployments: AmfDeploymentsOperations operations
    :vartype amf_deployments: azure.mgmt.mobileCore.aio.operations.AmfDeploymentsOperations
    :ivar cluster_services: ClusterServicesOperations operations
    :vartype cluster_services: azure.mgmt.mobileCore.aio.operations.ClusterServicesOperations
    :ivar nrf_deployments: NrfDeploymentsOperations operations
    :vartype nrf_deployments: azure.mgmt.mobileCore.aio.operations.NrfDeploymentsOperations
    :ivar nssf_deployments: NssfDeploymentsOperations operations
    :vartype nssf_deployments: azure.mgmt.mobileCore.aio.operations.NssfDeploymentsOperations
    :ivar observability_services: ObservabilityServicesOperations operations
    :vartype observability_services:
     azure.mgmt.mobileCore.aio.operations.ObservabilityServicesOperations
    :ivar smf_deployments: SmfDeploymentsOperations operations
    :vartype smf_deployments: azure.mgmt.mobileCore.aio.operations.SmfDeploymentsOperations
    :ivar upf_deployments: UpfDeploymentsOperations operations
    :vartype upf_deployments: azure.mgmt.mobileCore.aio.operations.UpfDeploymentsOperations
