...
from .._vendor import CosmosDBMongoClusterManagementClientMixinABC, _convert_request
...
class MongoClustersOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.cosmosdb.mongocluster.CosmosDBMongoClusterManagementClient`'s
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.MongoCluster"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.cosmosdb.mongocluster.models.MongoCluster]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.cosmosdb.mongocluster.models.MongoCluster
        ...
        :return: An instance of LROPoller that returns either MongoCluster or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.cosmosdb.mongocluster.models.MongoCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.cosmosdb.mongocluster.models.MongoCluster or IO
    ...
    def get(self, resource_group_name: str, mongo_cluster_name: str, **kwargs: Any) -> _models.MongoCluster:
        ...
        :rtype: ~azure.mgmt.cosmosdb.mongocluster.models.MongoCluster
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.cosmosdb.mongocluster.models.MongoClusterUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.cosmosdb.mongocluster.models.MongoClusterUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_create_or_update_firewall_rule(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.cosmosdb.mongocluster.models.FirewallRule
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of LROPoller that returns either FirewallRule or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.cosmosdb.mongocluster.models.FirewallRule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update_firewall_rule(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.cosmosdb.mongocluster.models.FirewallRule or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get_firewall_rule(
        ...
        :rtype: ~azure.mgmt.cosmosdb.mongocluster.models.FirewallRule
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def list_firewall_rules(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.cosmosdb.mongocluster.models.FirewallRule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def check_name_availability(
        ...
        **kwargs: Any
        ...
        :param parameters: The required parameters for checking if resource name is available.
         Required.
        :type parameters: ~azure.mgmt.cosmosdb.mongocluster.models.CheckNameAvailabilityRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CheckNameAvailabilityResponse or the result of cls(response)
        :rtype: ~azure.mgmt.cosmosdb.mongocluster.models.CheckNameAvailabilityResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def check_name_availability(
        ...
        :type parameters: ~azure.mgmt.cosmosdb.mongocluster.models.CheckNameAvailabilityRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_connection_strings(
        ...
        :rtype: ~azure.mgmt.cosmosdb.mongocluster.models.ListConnectionStringsResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
