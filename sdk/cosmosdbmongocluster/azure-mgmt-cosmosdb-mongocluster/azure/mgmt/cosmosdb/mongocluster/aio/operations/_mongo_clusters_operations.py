...
from .._vendor import CosmosDBMongoClusterManagementClientMixinABC
...
class MongoClustersOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.cosmosdb.mongocluster.aio.CosmosDBMongoClusterManagementClient`'s
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.MongoCluster"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.cosmosdb.mongocluster.models.MongoCluster]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either MongoCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.cosmosdb.mongocluster.models.MongoCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update_firewall_rule(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either FirewallRule or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.cosmosdb.mongocluster.models.FirewallRule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_firewall_rules(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.cosmosdb.mongocluster.models.FirewallRule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
