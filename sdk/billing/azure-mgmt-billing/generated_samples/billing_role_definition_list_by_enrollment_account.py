...
# USAGE
    python billing_role_definition_list_by_enrollment_account.py
...
def main():
    ...
    response = client.billing_role_definition.list_by_enrollment_account(
        billing_account_name="123456",
        enrollment_account_name="4568789",
    )
