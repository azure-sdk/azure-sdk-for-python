...
# USAGE
    python policies_put_by_customer_at_billing_account.py
...
def main():
    ...
    response = client.policies.begin_create_or_update_by_customer_at_billing_account(
        ...
        parameters={"properties": {"viewCharges": "Allowed"}},
    ).result()
    print(response)
