...
class InstructionsOperations:
    ...
    def list_by_billing_profile(
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2020-05-01"))
        cls: ClsType[_models.InstructionListResult] = kwargs.pop("cls", None)
    ...
    list_by_billing_profile.metadata = {
        "url": "/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/instructions"
    }
    ...
    get.metadata = {
        "url": "/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/instructions/{instructionName}"
    }
    ...
    def put(
        ...
        **kwargs: Any
        ...
        :param instruction_name: Instruction Name. Required.
        :type instruction_name: str
        :param parameters: The new instruction. Is either a Instruction type or a IO type. Required.
