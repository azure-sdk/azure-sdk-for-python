...
def build_update_request(billing_account_name: str, billing_profile_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_get_by_customer_request(billing_account_name: str, customer_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_update_customer_request(billing_account_name: str, customer_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PoliciesOperations:
    ...
    get_by_billing_profile.metadata = {
        "url": "/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/policies/default"
    }
    ...
    @distributed_trace
    def update(
        self, billing_account_name: str, billing_profile_name: str, parameters: Union[_models.Policy, IO], **kwargs: Any
    ) -> _models.Policy:
        """Updates the policies for a billing profile. This operation is supported only for billing
        accounts with agreement type Microsoft Customer Agreement.
        ...
        :param billing_profile_name: The ID that uniquely identifies a billing profile. Required.
        :type billing_profile_name: str
        :param parameters: Request parameters that are provided to the update policies operation. Is
         either a Policy type or a IO type. Required.
        :type parameters: ~azure.mgmt.billing.models.Policy or IO
    ...
    @distributed_trace
    def get_by_customer(self, billing_account_name: str, customer_name: str, **kwargs: Any) -> _models.CustomerPolicy:
    ...
    get_by_customer.metadata = {
        "url": "/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/customers/{customerName}/policies/default"
    }
    ...
    def update_customer(
        ...
        billing_account_name: str,
        customer_name: str,
        parameters: Union[_models.CustomerPolicy, IO],
        **kwargs: Any
    ) -> _models.CustomerPolicy:
        """Updates the policies for a customer. This operation is supported only for billing accounts with
        agreement type Microsoft Partner Agreement.
        ...
        :type customer_name: str
        :param parameters: Request parameters that are provided to the update policies operation. Is
         either a CustomerPolicy type or a IO type. Required.
        :type parameters: ~azure.mgmt.billing.models.CustomerPolicy or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
