...
def build_get_by_billing_account_request(
    billing_account_name: str, reservation_order_id: str, *, expand: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
...
def build_list_by_billing_account_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/reservationOrders"
    )
    path_format_arguments = {
        "billingAccountName": _SERIALIZER.url(
            "billing_account_name",
...
class ReservationOrdersOperations:
    ...
    def list_by_billing_account(
        ...
        skiptoken: Optional[float] = None,
        **kwargs: Any
    ) -> Iterable["_models.ReservationOrder"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.billing.models.ReservationOrder]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
