...
def build_download_multiple_billing_profile_invoices_request(  # pylint: disable=name-too-long
...
def build_get_by_subscription_and_invoice_id_request(  # pylint: disable=name-too-long
...
def build_download_billing_subscription_invoice_request(  # pylint: disable=name-too-long
...
def build_download_multiple_billing_subscription_invoices_request(  # pylint: disable=name-too-long
...
class InvoicesOperations:
    ...
    def _download_multiple_billing_profile_invoices_initial(  # pylint: disable=name-too-long
    ...
    @overload
    def begin_download_multiple_billing_profile_invoices(  # pylint: disable=name-too-long
        self,
        billing_account_name: str,
    ...
    def _download_billing_subscription_invoice_initial(  # pylint: disable=name-too-long
    ...
    @distributed_trace
    def begin_download_billing_subscription_invoice(  # pylint: disable=name-too-long
        self, invoice_name: str, download_token: str, **kwargs: Any
    ) -> LROPoller[_models.DownloadUrl]:
    ...
    def _download_multiple_billing_subscription_invoices_initial(  # pylint: disable=name-too-long
    ...
    @overload
    def begin_download_multiple_billing_subscription_invoices(  # pylint: disable=name-too-long
