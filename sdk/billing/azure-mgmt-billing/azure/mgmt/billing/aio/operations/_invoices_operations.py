...
class InvoicesOperations:
    ...
    async def _download_multiple_billing_profile_invoices_initial(  # pylint: disable=name-too-long
    ...
    @overload
    async def begin_download_multiple_billing_profile_invoices(  # pylint: disable=name-too-long
        self,
        billing_account_name: str,
    ...
    async def _download_billing_subscription_invoice_initial(  # pylint: disable=name-too-long
    ...
    @distributed_trace_async
    async def begin_download_billing_subscription_invoice(  # pylint: disable=name-too-long
        self, invoice_name: str, download_token: str, **kwargs: Any
    ) -> AsyncLROPoller[_models.DownloadUrl]:
    ...
    async def _download_multiple_billing_subscription_invoices_initial(  # pylint: disable=name-too-long
    ...
    @overload
    async def begin_download_multiple_billing_subscription_invoices(  # pylint: disable=name-too-long
