...
class EntityOperations:  # pylint: disable=too-many-public-methods
    ...
    def create_or_update(
        self,
        entity: Union[_models.AtlasEntityWithExtInfo, JSON, IO],
        *,
        business_attribute_update_behavior: Optional[Union[str, _models.BusinessAttributeUpdateBehavior]] = None,
        collection_id: Optional[str] = None,
        **kwargs: Any,
        ...
        :param entity: Atlas entity with extended information. Is one of the following types:
         AtlasEntityWithExtInfo, JSON, IO Required.
        :type entity: ~azure.analytics.purview.datamap.models.AtlasEntityWithExtInfo or JSON or IO
        :keyword business_attribute_update_behavior: Used to define the update behavior for business
         attributes when updating
         entities. Known values are: "ignore", "replace", and "merge". Default value is None.
        :paramtype business_attribute_update_behavior: str or
    ...
    def bulk_create_or_update(
        self,
        entities: Union[_models.AtlasEntitiesWithExtInfo, JSON, IO],
        *,
        collection_id: Optional[str] = None,
        business_attribute_update_behavior: Optional[Union[str, _models.BusinessAttributeUpdateBehavior]] = None,
        **kwargs: Any,
        ...
        :param entities: An array of entities to create or update. Is one of the following types:
         AtlasEntitiesWithExtInfo, JSON, IO Required.
        :type entities: ~azure.analytics.purview.datamap.models.AtlasEntitiesWithExtInfo or JSON or IO
        :keyword collection_id: The collection where entities will be moved to. Only specify a value if
         you
         need to move an entity to another collection. Default value is None.
        :paramtype collection_id: str
    ...
    @distributed_trace
    def add_classification(  # pylint: disable=inconsistent-return-statements
        self, request: Union[_models.ClassificationAssociateRequest, JSON, IO], **kwargs: Any
    ) -> None:
        """Associate a classification to multiple entities in bulk.

        :param request: The request to associate a classification to multiple entities. Is one of the
         following types: ClassificationAssociateRequest, JSON, IO Required.
    ...
    @overload
    def add_classifications(  # pylint: disable=inconsistent-return-statements
        self, guid: str, classifications: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        """Add classifications to an existing entity represented by a GUID.
    ...
    @distributed_trace
    def add_classifications(  # pylint: disable=inconsistent-return-statements
        self, guid: str, classifications: Union[List[_models.AtlasClassification], IO], **kwargs: Any
    ) -> None:
        """Add classifications to an existing entity represented by a GUID.
        ...
        :param classifications: An array of classifications to be added. Is either a
         [AtlasClassification] type or a IO type. Required.
        :type classifications: list[~azure.analytics.purview.datamap.models.AtlasClassification] or IO
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
        :paramtype content_type: str
        :return: None
    ...
    def partial_update_by_unique_attributes(
        self,
        type_name: str,
        atlas_entity_with_ext_info: Union[_models.AtlasEntityWithExtInfo, JSON, IO],
        *,
        attr: Optional[str] = None,
        **kwargs: Any,
    ) -> _models.EntityMutationResponse:
        ...
        :param atlas_entity_with_ext_info: Atlas entity with extended information. Is one of the
         following types: AtlasEntityWithExtInfo, JSON, IO Required.
        :type atlas_entity_with_ext_info:
         ~azure.analytics.purview.datamap.models.AtlasEntityWithExtInfo or JSON or IO
        :keyword attr: The qualified name of the entity. (This is only an example. qualifiedName can
         be changed to other unique attributes). Default value is None.
        :paramtype attr: str
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
    ...
    def add_classifications_by_unique_attribute(  # pylint: disable=inconsistent-return-statements
        self,
        type_name: str,
        atlas_classification_array: Union[List[_models.AtlasClassification], IO],
        *,
        attr: Optional[str] = None,
        **kwargs: Any,
    ) -> None:
        ...
        :param atlas_classification_array: An array of classification to be added. Is either a
         [AtlasClassification] type or a IO type. Required.
        :type atlas_classification_array:
         list[~azure.analytics.purview.datamap.models.AtlasClassification] or IO
        :keyword attr: The qualified name of the entity. (This is only an example. qualifiedName can
         be changed to other unique attributes). Default value is None.
        :paramtype attr: str
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
    ...
    @overload
    def bulk_set_classifications(
        self, entity_headers: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> List[str]:
        """Set classifications on entities in bulk.
    ...
    @distributed_trace
    def bulk_set_classifications(
        self, entity_headers: Union[_models.AtlasEntityHeaders, JSON, IO], **kwargs: Any
    ) -> List[str]:
        """Set classifications on entities in bulk.

        :param entity_headers: Atlas entity headers. Is one of the following types: AtlasEntityHeaders,
         JSON, IO Required.
        :type entity_headers: ~azure.analytics.purview.datamap.models.AtlasEntityHeaders or JSON or IO
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
    ...
    @overload
    def remove_business_metadata(  # pylint: disable=inconsistent-return-statements
        self, guid: str, business_metadata: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        """Remove business metadata from an entity.
    ...
    @distributed_trace
    def remove_business_metadata(  # pylint: disable=inconsistent-return-statements
        self, guid: str, business_metadata: Union[Dict[str, Dict[str, Any]], IO], **kwargs: Any
    ) -> None:
        """Remove business metadata from an entity.

        :param guid: The globally unique identifier of the entity. Required.
        :type guid: str
        :param business_metadata: Business metadata payload. Is either a {str: {str: Any}} type or a IO
         type. Required.
        :type business_metadata: dict[str, dict[str, any]] or IO
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
        :paramtype content_type: str
        :return: None
    ...
    def add_or_update_business_metadata(  # pylint: disable=inconsistent-return-statements
        self,
        guid: str,
        business_metadata: Union[Dict[str, Dict[str, Any]], IO],
        *,
        is_overwrite: Optional[bool] = None,
        **kwargs: Any,
    ) -> None:
        ...
        :param guid: The globally unique identifier of the entity. Required.
        :type guid: str
        :param business_metadata: BusinessMetadata payload. Is either a {str: {str: Any}} type or a IO
         type. Required.
        :type business_metadata: dict[str, dict[str, any]] or IO
        :keyword is_overwrite: Whether to overwrite the existing business metadata on the entity or
         not,
    ...
    def remove_business_metadata_attributes(  # pylint: disable=inconsistent-return-statements
        ...
        bm_name: str,
        guid: str,
        business_metadata_attributes: IO,
        *,
        content_type: str = "application/json",
        **kwargs: Any,
    ) -> None:
        ...
        :type guid: str
        :param business_metadata_attributes: Business metadata attribute payload. Required.
        :type business_metadata_attributes: IO
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None
    ...
    @distributed_trace
    def remove_business_metadata_attributes(  # pylint: disable=inconsistent-return-statements
        self, bm_name: str, guid: str, business_metadata_attributes: Union[Dict[str, Any], IO], **kwargs: Any
    ) -> None:
        """Delete business metadata attributes from an entity.
        ...
        :param business_metadata_attributes: Business metadata attribute payload. Is either a {str:
         Any} type or a IO type. Required.
        :type business_metadata_attributes: dict[str, any] or IO
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
        :paramtype content_type: str
        :return: None
    ...
    @overload
    def remove_labels(  # pylint: disable=inconsistent-return-statements
        self, guid: str, body: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        """Delete given labels to a given entity.
    ...
    @distributed_trace
    def remove_labels(  # pylint: disable=inconsistent-return-statements
        self, guid: str, body: Union[List[str], IO], **kwargs: Any
    ) -> None:
        """Delete given labels to a given entity.

        :param guid: The globally unique identifier of the entity. Required.
        :type guid: str
        :param body: set of labels to be deleted. Is either a [str] type or a IO type. Required.
    ...
    def set_labels(  # pylint: disable=inconsistent-return-statements
        ...
        :param guid: The globally unique identifier of the entity. Required.
        :type guid: str
        :param body: set of labels to be set to the entity. Is either a [str] type or a IO type.
         Required.
        :type body: list[str] or IO
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
    ...
    def add_label(  # pylint: disable=inconsistent-return-statements
        ...
        :param guid: The globally unique identifier of the entity. Required.
        :type guid: str
        :param body: set of labels to be added. Is either a [str] type or a IO type. Required.
        :type body: list[str] or IO
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
        :paramtype content_type: str
    ...
    @distributed_trace
    def remove_labels_by_unique_attribute(  # pylint: disable=inconsistent-return-statements
        self, type_name: str, body: Union[List[str], IO], *, attr: Optional[str] = None, **kwargs: Any
    ) -> None:
        """Delete given labels to a given entity identified by its type and unique
        attribute.
    ...
    def set_labels_by_unique_attribute(  # pylint: disable=inconsistent-return-statements
        ...
        :param type_name: The name of the type. Required.
        :type type_name: str
        :param body: set of labels to be set. Is either a [str] type or a IO type. Required.
        :type body: list[str] or IO
        :keyword attr: The qualified name of the entity. (This is only an example. qualifiedName can
         be changed to other unique attributes). Default value is None.
        :paramtype attr: str
    ...
    @overload
    def move_entities_to_collection(
        self, move_entities_request: IO, *, collection_id: str, content_type: str = "application/json", **kwargs: Any
    ) -> _models.EntityMutationResponse:
        """Move existing entities to the target collection.
    ...
    @distributed_trace
    def move_entities_to_collection(
        self, move_entities_request: Union[_models.MoveEntitiesRequest, JSON, IO], *, collection_id: str, **kwargs: Any
    ) -> _models.EntityMutationResponse:
        """Move existing entities to the target collection.

        :param move_entities_request: Entity guids to be moved to target collection. Is one of the
         following types: MoveEntitiesRequest, JSON, IO Required.
...
class GlossaryOperations:  # pylint: disable=too-many-public-methods
    ...
    @overload
    def create(
        self, atlas_glossary: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.AtlasGlossary:
        """Create a glossary.
    ...
    @distributed_trace
    def create(self, atlas_glossary: Union[_models.AtlasGlossary, JSON, IO], **kwargs: Any) -> _models.AtlasGlossary:
        """Create a glossary.

        :param atlas_glossary: Glossary definition, terms & categories can be anchored to a glossary.
         Using
         the anchor attribute when creating the Term/Category. Is one of the following types:
         AtlasGlossary, JSON, IO Required.
        :type atlas_glossary: ~azure.analytics.purview.datamap.models.AtlasGlossary or JSON or IO
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
    ...
    @overload
    def create_categories(
        self, glossary_category: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> List[_models.AtlasGlossaryCategory]:
        """Create glossary category in bulk.
    ...
    @distributed_trace
    def create_categories(
        self, glossary_category: Union[List[_models.AtlasGlossaryCategory], IO], **kwargs: Any
    ) -> List[_models.AtlasGlossaryCategory]:
        """Create glossary category in bulk.

        :param glossary_category: An array of glossary category definitions to be created. Is either a
         [AtlasGlossaryCategory] type or a IO type. Required.
    ...
    @distributed_trace
    def create_category(
        self, glossary_category: Union[_models.AtlasGlossaryCategory, JSON, IO], **kwargs: Any
    ) -> _models.AtlasGlossaryCategory:
        """Create a glossary category.
    ...
    @overload
    def update_category(
        self, category_guid: str, glossary_category: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.AtlasGlossaryCategory:
        """Update the given glossary category by its GUID.
    ...
    @distributed_trace
    def update_category(
        self, category_guid: str, glossary_category: Union[_models.AtlasGlossaryCategory, JSON, IO], **kwargs: Any
    ) -> _models.AtlasGlossaryCategory:
        """Update the given glossary category by its GUID.
        ...
        :param glossary_category: The glossary category to be updated. Is one of the following types:
         AtlasGlossaryCategory, JSON, IO Required.
        :type glossary_category: ~azure.analytics.purview.datamap.models.AtlasGlossaryCategory or JSON
         or IO
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
    ...
    def create_term(
        self,
        glossary_term: Union[_models.AtlasGlossaryTerm, JSON, IO],
        *,
        include_term_hierarchy: Optional[bool] = None,
        **kwargs: Any,
    ) -> _models.AtlasGlossaryTerm:
        ...
        :param glossary_term: The glossary term definition. A term must be anchored to a Glossary at
         ...
         JSON, IO Required.
        :type glossary_term: ~azure.analytics.purview.datamap.models.AtlasGlossaryTerm or JSON or IO
        :keyword include_term_hierarchy: Whether include term hierarchy. Default value is None.
        :paramtype include_term_hierarchy: bool
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
    ...
    def update_term(
        ...
        **kwargs: Any,
        ...
        :param glossary_term: The glossary term to be updated. Is one of the following types:
         AtlasGlossaryTerm, JSON, IO Required.
        :type glossary_term: ~azure.analytics.purview.datamap.models.AtlasGlossaryTerm or JSON or IO
        :keyword include_term_hierarchy: Whether include term hierarchy. Default value is None.
        :paramtype include_term_hierarchy: bool
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
    ...
    def create_terms(
        self,
        glossary_term: Union[List[_models.AtlasGlossaryTerm], IO],
        *,
        include_term_hierarchy: Optional[bool] = None,
        **kwargs: Any,
    ) -> List[_models.AtlasGlossaryTerm]:
        ...
        :param glossary_term: An array of glossary term definitions to be created in bulk. Is either a
         [AtlasGlossaryTerm] type or a IO type. Required.
        :type glossary_term: list[~azure.analytics.purview.datamap.models.AtlasGlossaryTerm] or IO
        :keyword include_term_hierarchy: Whether include term hierarchy. Default value is None.
        :paramtype include_term_hierarchy: bool
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
    ...
    @overload
    def assign_term_to_entities(  # pylint: disable=inconsistent-return-statements
        self, term_guid: str, related_object_ids: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        """Assign the given term to the provided list of related objects. Recommend using
        small batches with multiple API calls.
    ...
    @distributed_trace
    def assign_term_to_entities(  # pylint: disable=inconsistent-return-statements
        self, term_guid: str, related_object_ids: Union[List[_models.AtlasRelatedObjectId], IO], **kwargs: Any
    ) -> None:
        """Assign the given term to the provided list of related objects. Recommend using
        small batches with multiple API calls.
        ...
        :type term_guid: str
        :param related_object_ids: An array of related object IDs to which the term has to be
         associated. Is either a [AtlasRelatedObjectId] type or a IO type. Required.
    ...
    def delete_term_assignment_from_entities(  # pylint: disable=inconsistent-return-statements
        ...
        :type term_guid: str
        :param related_object_ids: An array of related object IDs from which the term has to be
         dissociated. Is either a [AtlasRelatedObjectId] type or a IO type. Required.
        :type related_object_ids: list[~azure.analytics.purview.datamap.models.AtlasRelatedObjectId] or
         IO
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
    ...
    def update(
        self,
        glossary_guid: str,
        updated_glossary: Union[_models.AtlasGlossary, JSON, IO],
        *,
        ignore_terms_and_categories: Optional[bool] = None,
        **kwargs: Any,
    ) -> _models.AtlasGlossary:
        ...
        :param updated_glossary: The glossary definition to be updated. Is one of the following types:
         AtlasGlossary, JSON, IO Required.
        :type updated_glossary: ~azure.analytics.purview.datamap.models.AtlasGlossary or JSON or IO
        :keyword ignore_terms_and_categories: Whether ignore terms and categories. Default value is
         None.
        :paramtype ignore_terms_and_categories: bool
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
...
class DiscoveryOperations:
    ...
    @overload
    def query(
        self, search_request: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.SearchResult:
        """Get data using search.
    ...
    @distributed_trace
    def query(self, search_request: Union[_models.SearchRequest, JSON, IO], **kwargs: Any) -> _models.SearchResult:
        """Get data using search.

        :param search_request: An object specifying the search criteria. Is one of the following types:
         SearchRequest, JSON, IO Required.
        :type search_request: ~azure.analytics.purview.datamap.models.SearchRequest or JSON or IO
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
    ...
    @overload
    def suggest(
        self, suggest_request: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.SuggestResult:
        """Get search suggestions by query criteria.
    ...
    @distributed_trace
    def suggest(self, suggest_request: Union[_models.SuggestRequest, JSON, IO], **kwargs: Any) -> _models.SuggestResult:
        """Get search suggestions by query criteria.

        :param suggest_request: An object specifying the suggest criteria. Is one of the following
         types: SuggestRequest, JSON, IO Required.
        :type suggest_request: ~azure.analytics.purview.datamap.models.SuggestRequest or JSON or IO
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
    ...
    @overload
    def auto_complete(
        self, auto_complete_request: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.AutoCompleteResult:
        """Get auto complete options.
    ...
    @distributed_trace
    def auto_complete(
        self, auto_complete_request: Union[_models.AutoCompleteRequest, JSON, IO], **kwargs: Any
    ) -> _models.AutoCompleteResult:
        """Get auto complete options.

        :param auto_complete_request: An object specifying the autocomplete criteria. Is one of the
         following types: AutoCompleteRequest, JSON, IO Required.
...
class RelationshipOperations:
    ...
    @overload
    def create(
        self, relationship: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.AtlasRelationship:
        """Create a new relationship between entities.
    ...
    @distributed_trace
    def create(
        self, relationship: Union[_models.AtlasRelationship, JSON, IO], **kwargs: Any
    ) -> _models.AtlasRelationship:
        """Create a new relationship between entities.

        :param relationship: The AtlasRelationship object containing the information for the
         relationship to
         be created. Is one of the following types: AtlasRelationship, JSON, IO Required.
        :type relationship: ~azure.analytics.purview.datamap.models.AtlasRelationship or JSON or IO
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
...
class TypeOperations:  # pylint: disable=too-many-public-methods
    ...
    @overload
    def bulk_create(
        self, types_def: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.AtlasTypesDef:
        """Create all atlas type definitions in bulk, only new definitions will be
        created.
        Any changes to the existing definitions will be discarded.
    ...
    @distributed_trace
    def bulk_create(self, types_def: Union[_models.AtlasTypesDef, JSON, IO], **kwargs: Any) -> _models.AtlasTypesDef:
        """Create all atlas type definitions in bulk, only new definitions will be
        created.
        Any changes to the existing definitions will be discarded.

        :param types_def: A composite wrapper object with corresponding lists of the type definition.
         Is one of the following types: AtlasTypesDef, JSON, IO Required.
        :type types_def: ~azure.analytics.purview.datamap.models.AtlasTypesDef or JSON or IO
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
    ...
    @distributed_trace
    def bulk_update(self, types_def: Union[_models.AtlasTypesDef, JSON, IO], **kwargs: Any) -> _models.AtlasTypesDef:
        """Update all types in bulk, changes detected in the type definitions would be
        persisted.

        :param types_def: A composite object that captures all type definition changes. Is one of the
         following types: AtlasTypesDef, JSON, IO Required.
        :type types_def: ~azure.analytics.purview.datamap.models.AtlasTypesDef or JSON or IO
        :keyword content_type: Body parameter Content-Type. Known values are: application/json. Default
         value is None.
        :paramtype content_type: str
    ...
    @distributed_trace
    def bulk_delete(  # pylint: disable=inconsistent-return-statements
        self, types_def: Union[_models.AtlasTypesDef, JSON, IO], **kwargs: Any
    ) -> None:
        """Delete API for all types in bulk.
