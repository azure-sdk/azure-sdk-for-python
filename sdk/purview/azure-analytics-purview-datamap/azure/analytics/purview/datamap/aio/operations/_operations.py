...
class GlossaryOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace_async
    async def create(
        self, atlas_glossary: Union[_models.AtlasGlossary, JSON, IO], **kwargs: Any
    ) -> _models.AtlasGlossary:
        """Create a glossary.
...
class DiscoveryOperations:
    ...
    @distributed_trace_async
    async def query(
        self, search_request: Union[_models.SearchRequest, JSON, IO], **kwargs: Any
    ) -> _models.SearchResult:
        """Get data using search.
    ...
    @distributed_trace_async
    async def suggest(
        self, suggest_request: Union[_models.SuggestRequest, JSON, IO], **kwargs: Any
    ) -> _models.SuggestResult:
        """Get search suggestions by query criteria.
