...
class TestDataMapEntityOperations(DataMapClientTestBase):
    @DataMapPreparer()
    @recorded_by_proxy
    def test_create_or_update(self, datamap_endpoint):
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_get_by_ids(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_batch_create_or_update(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_add_classification(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_update_attribute_by_id(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_get_classification(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_remove_classification(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_get_classifications(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_add_classifications(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_update_classifications(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_update_by_unique_attribute(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_delete_by_unique_attribute(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_remove_classification_by_unique_attribute(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_add_classifications_by_unique_attribute(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_update_classifications_unique_by_attribute(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_batch_set_classifications(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_batch_get_by_unique_attributes(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_get_header(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_remove_business_metadata(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_add_or_update_business_metadata(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_remove_business_metadata_attributes(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_add_or_update_business_metadata_attributes(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_get_business_metadata_template(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_import_business_metadata(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_remove_labels(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_set_labels(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_add_label(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_remove_labels_by_unique_attribute(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_set_labels_by_unique_attribute(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_add_labels_by_unique_attribute(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_move_entities_to_collection(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
