...
class TestDataMapGlossaryOperations(DataMapClientTestBase):
    @DataMapPreparer()
    @recorded_by_proxy
    def test_batch_get(self, datamap_endpoint):
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_create_categories(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_create_category(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_get_category(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_update_category(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_delete_category(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_partial_update_category(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_get_related_categories(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_get_category_terms(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_create_term(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_get_term(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_update_term(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_delete_term(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_partial_update_term(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_create_terms(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_get_entities_assigned_with_term(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_assign_term_to_entities(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_delete_term_assignment_from_entities(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_get_related_terms(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_get_categories(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_get_categories_headers(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_get_detailed(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_partial_update(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_get_terms(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
    ...
    @DataMapPreparer()
    @recorded_by_proxy
    def test_get_term_headers(self, datamap_endpoint):
        client = self.create_client(endpoint=datamap_endpoint)
