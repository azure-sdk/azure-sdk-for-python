...
class AtlasBusinessMetadataDef(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    """The enum of type category. Known values are: \"PRIMITIVE\", \"OBJECT_ID_TYPE\", \"ENUM\",
     ...
     \"TERM_TEMPLATE\"."""
    create_time: Optional[datetime.datetime] = rest_field(name="createTime", format="unix-timestamp")
    ...
    update_time: Optional[datetime.datetime] = rest_field(name="updateTime", format="unix-timestamp")
