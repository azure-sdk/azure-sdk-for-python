...
class ErrorDetail(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.qumulostorage.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info: list[~azure.mgmt.qumulostorage.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(_serialization.Model):
    ...
    :vartype error: ~azure.mgmt.qumulostorage.models.ErrorDetail
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetail"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~azure.mgmt.qumulostorage.models.ErrorDetail
        """
        super().__init__(**kwargs)
        self.error = error
...
class Resource(_serialization.Model):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.qumulostorage.models.SystemData
    """
...
class FileSystemResource(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype identity: ~azure.mgmt.qumulostorage.models.ManagedServiceIdentity
    :ivar marketplace_details: Marketplace details. Required.
    :vartype marketplace_details: ~azure.mgmt.qumulostorage.models.MarketplaceDetails
    :ivar provisioning_state: Provisioning State of the resource. Known values are: "Accepted",
     ...
     "NotSpecified".
    :vartype provisioning_state: str or ~azure.mgmt.qumulostorage.models.ProvisioningState
    :ivar storage_sku: Storage Sku. Required. Known values are: "Standard" and "Performance".
    :vartype storage_sku: str or ~azure.mgmt.qumulostorage.models.StorageSku
    :ivar user_details: User Details. Required.
    :vartype user_details: ~azure.mgmt.qumulostorage.models.UserDetails
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype identity: ~azure.mgmt.qumulostorage.models.ManagedServiceIdentity
        :keyword marketplace_details: Marketplace details. Required.
        :paramtype marketplace_details: ~azure.mgmt.qumulostorage.models.MarketplaceDetails
        :keyword storage_sku: Storage Sku. Required. Known values are: "Standard" and "Performance".
        :paramtype storage_sku: str or ~azure.mgmt.qumulostorage.models.StorageSku
        :keyword user_details: User Details. Required.
        :paramtype user_details: ~azure.mgmt.qumulostorage.models.UserDetails
...
class FileSystemResourceListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.qumulostorage.models.FileSystemResource]
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.qumulostorage.models.FileSystemResource]
...
class FileSystemResourceUpdate(_serialization.Model):
    ...
    :vartype properties: ~azure.mgmt.qumulostorage.models.FileSystemResourceUpdateProperties
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype properties: ~azure.mgmt.qumulostorage.models.FileSystemResourceUpdateProperties
        """
        super().__init__(**kwargs)
        self.identity = identity
        self.tags = tags
...
class ManagedServiceIdentity(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.qumulostorage.models.ManagedServiceIdentityType
    :ivar user_assigned_identities: The set of user assigned identities associated with the
     resource. The userAssignedIdentities dictionary keys will be ARM resource ids in the form:
     '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}.
     The dictionary values can be empty objects ({}) in requests.
    :vartype user_assigned_identities: dict[str,
     ~azure.mgmt.qumulostorage.models.UserAssignedIdentity]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: Type of managed service identity (where both SystemAssigned and UserAssigned
         ...
         "SystemAssigned, UserAssigned".
        :paramtype type: str or ~azure.mgmt.qumulostorage.models.ManagedServiceIdentityType
...
class MarketplaceDetails(_serialization.Model):
    ...
    :vartype marketplace_subscription_status: str or
     ~azure.mgmt.qumulostorage.models.MarketplaceSubscriptionStatus
    """
...
class Operation(_serialization.Model):
    ...
    :vartype display: ~azure.mgmt.qumulostorage.models.OperationDisplay
    :ivar origin: The intended executor of the operation; as in Resource Based Access Control
     (RBAC) and audit logs UX. Default value is "user,system". Known values are: "user", "system",
     and "user,system".
    :vartype origin: str or ~azure.mgmt.qumulostorage.models.Origin
    :ivar action_type: Enum. Indicates the action type. "Internal" refers to actions that are for
     internal only APIs. "Internal"
    :vartype action_type: str or ~azure.mgmt.qumulostorage.models.ActionType
    """
    ...
    def __init__(self, *, display: Optional["_models.OperationDisplay"] = None, **kwargs: Any) -> None:
        ...
        :paramtype display: ~azure.mgmt.qumulostorage.models.OperationDisplay
        """
        super().__init__(**kwargs)
        self.name = None
...
class OperationListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.qumulostorage.models.Operation]
...
class SystemData(_serialization.Model):
    ...
    :vartype created_by_type: str or ~azure.mgmt.qumulostorage.models.CreatedByType
    ...
    :vartype last_modified_by_type: str or ~azure.mgmt.qumulostorage.models.CreatedByType
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword created_by_type: The type of identity that created the resource. Known values are:
         "User", "Application", "ManagedIdentity", and "Key".
        :paramtype created_by_type: str or ~azure.mgmt.qumulostorage.models.CreatedByType
        ...
        :paramtype last_modified_by_type: str or ~azure.mgmt.qumulostorage.models.CreatedByType
