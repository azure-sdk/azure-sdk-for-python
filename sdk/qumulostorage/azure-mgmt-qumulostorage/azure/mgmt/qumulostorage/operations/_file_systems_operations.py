...
class FileSystemsOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.FileSystemResource"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.qumulostorage.models.FileSystemResource]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either FileSystemResource or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.qumulostorage.models.FileSystemResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
