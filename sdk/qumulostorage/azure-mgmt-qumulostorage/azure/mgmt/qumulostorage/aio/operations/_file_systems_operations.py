...
class FileSystemsOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.FileSystemResource"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.qumulostorage.models.FileSystemResource]
    ...
    async def get(self, resource_group_name: str, file_system_name: str, **kwargs: Any) -> _models.FileSystemResource:
        ...
        :rtype: ~azure.mgmt.qumulostorage.models.FileSystemResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.qumulostorage.models.FileSystemResource
        ...
        :return: An instance of AsyncLROPoller that returns either FileSystemResource or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.qumulostorage.models.FileSystemResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a FileSystemResource type or a IO type.
         Required.
        :type resource: ~azure.mgmt.qumulostorage.models.FileSystemResource or IO
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.qumulostorage.models.FileSystemResourceUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.qumulostorage.models.FileSystemResourceUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
