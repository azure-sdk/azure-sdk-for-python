...
class DeidResponse(_model_base.Model):
    ...
    :ivar output_text: Output text after deidentification. Not available for Tag Operation.
...
class Error(_model_base.Model):
    ...
    :vartype details: list[~azure.healthdataaiservices.deid.models.Error]
    :ivar innererror: An object containing more specific information than the current object about
     the error.
    :vartype innererror: ~azure.healthdataaiservices.deid.models.InnerError
    """
...
class File(_model_base.Model):
    ...
    :vartype error: ~azure.healthdataaiservices.deid.models.Error
...
class Job(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar status: Current status of a job. Required. Known values are: "NotStarted", "Running",
     "Succeeded", "Failed", "Canceled", and "PartialFailed".
...
class PhiEntity(_model_base.Model):
    ...
    :vartype category: str or ~azure.healthdataaiservices.deid.models.PhiCategory
