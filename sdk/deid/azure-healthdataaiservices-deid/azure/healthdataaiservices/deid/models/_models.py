...
class DeidRequest(_model_base.Model):
    ...
    :ivar data_type: Data type of the input. Required. Known values are: "Unknown" and "PlainText".
    :vartype data_type: str or ~azure.healthdataaiservices.deid.models.DocumentDataType
    :ivar operation: Operation to perform on the input. Required. Known values are: "Redact",
     "Surrogate", and "Tag".
    :vartype operation: str or ~azure.healthdataaiservices.deid.models.OperationType
    ...
    :vartype string_index_type: str or ~azure.healthdataaiservices.deid.models.StringIndexType
    ...
    """Data type of the input. Required. Known values are: \"Unknown\" and \"PlainText\"."""
...
class DeidResponse(_model_base.Model):
    """Response for synchronous DeID operation.

    All required parameters must be populated in order to send to server.

    :ivar output_text: Output text after deidentification. Required.
    :vartype output_text: str
    :ivar tagger_result: Result of the tag operation.
    :vartype tagger_result: ~azure.healthdataaiservices.deid.models.PhiTaggerResult
    """

    output_text: str = rest_field(name="outputText")
    """Output text after deidentification. Required."""
...
class File(_model_base.Model):
    ...
    :ivar path: Relative path to file from location prefix. Required.
    :vartype path: str
    :ivar status: Status of the file. Required. Known values are: "NotStarted", "Running",
     "Succeeded", "Failed", and "Canceled".
    :vartype status: str or ~azure.healthdataaiservices.deid.models.OperationState
    :ivar explanation: Explanation of current status. If needed.
    :vartype explanation: str
    :ivar etag: The entity tag for this resource. Required.
    :vartype etag: str
    """

    path: str = rest_field(visibility=["read"])
    """Relative path to file from location prefix. Required."""
    ...
    """Status of the file. Required. Known values are: \"NotStarted\", \"Running\", \"Succeeded\",
     \"Failed\", and \"Canceled\"."""
    explanation: Optional[str] = rest_field()
...
class Job(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype name: str
    :ivar status: Current status of a job. Known values are: "NotStarted", "Running", "Succeeded",
     "Failed", "Canceled", and "PartialFailed".
    :vartype status: str or ~azure.healthdataaiservices.deid.models.JobStatus
    :ivar summary: Summary of a job. Exists only when the job is completed.
    :vartype summary: ~azure.healthdataaiservices.deid.models.JobSummary
    :ivar created_at: Date and time when the job was created.
    :vartype created_at: ~datetime.datetime
    :ivar started_at: Date and time when the job was started.
    :vartype started_at: ~datetime.datetime
    :ivar completed_at: Date and time when the job was completed.
    ...
    :vartype source_location: ~azure.healthdataaiservices.deid.models.SourceStorageLocation
    :ivar target_location: Target location to store output of operation. Required.
    :vartype target_location: ~azure.healthdataaiservices.deid.models.TargetStorageLocation
    :ivar data_type: Data type of the input documents. Required. Known values are: "Unknown" and
     "PlainText".
    :vartype data_type: str or ~azure.healthdataaiservices.deid.models.DocumentDataType
    ...
    """Current status of a job. Known values are: \"NotStarted\", \"Running\", \"Succeeded\",
     \"Failed\", \"Canceled\", and \"PartialFailed\"."""
    ...
    data_type: Union[str, "_models.DocumentDataType"] = rest_field(name="dataType")
    """Data type of the input documents. Required. Known values are: \"Unknown\" and \"PlainText\"."""
    operation: Union[str, "_models.OperationType"] = rest_field()
...
class PhiEntity(_model_base.Model):
    ...
    :vartype category: str or ~azure.healthdataaiservices.deid.models.PhiCategories
    ...
    category: Union[str, "_models.PhiCategories"] = rest_field()
    ...
    def __init__(
        self,
        *,
        category: Union[str, "_models.PhiCategories"],
        offset: int,
        length: int,
...
class PhiTaggerResult(_model_base.Model):
    ...
    :vartype entities: list[~azure.healthdataaiservices.deid.models.PhiEntity]
    ...
    :vartype path: str
    :ivar checksum: Checksum of the file.
    ...
    checksum: Optional[str] = rest_field()
...
class SourceStorageLocation(_model_base.Model):
    ...
    :vartype prefix: str
    :ivar extensions: List of extensions to filter blobs by.
