...
from ...operations._operations import (
    ...
    build_jobs_list_files_request,
    build_jobs_list_request,
    build_realtime_operations_deid_request,
)
...
class JobsOperations:
    ...
    async def _create_initial(self, name: str, resource: Union[_models.Job, JSON, IO[bytes]], **kwargs: Any) -> JSON:
    ...
    async def begin_create(
        ...
        :return: An instance of AsyncLROPoller that returns Job. The Job is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.healthdataaiservices.deid.models.Job]
    ...
    def list(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.healthdataaiservices.deid.models.Job]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_files(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.healthdataaiservices.deid.models.File]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    @distributed_trace_async
    async def cancel(self, name: str, **kwargs: Any) -> _models.Job:
        # pylint: disable=line-too-long
        """Cancel a DeID Job.
...
class RealtimeOperationsOperations:
    ...
    @distributed_trace_async
    async def deid(self, options: Union[_models.DeidRequest, JSON, IO[bytes]], **kwargs: Any) -> _models.DeidResponse:
        # pylint: disable=line-too-long
        """Realtime Synchronous Deidentification.
