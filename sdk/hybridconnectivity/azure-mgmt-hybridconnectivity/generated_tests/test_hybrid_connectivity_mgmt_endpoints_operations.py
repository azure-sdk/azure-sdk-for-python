...
class TestHybridConnectivityMgmtEndpointsOperations(AzureMgmtRecordedTestCase):
    ...
    def test_list_credentials(self, resource_group):
        response = self.client.endpoints.list_credentials(
            resource_uri="str",
            endpoint_name="str",
            api_version="2024-12-01",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_list_ingress_gateway_credentials(self, resource_group):
        response = self.client.endpoints.list_ingress_gateway_credentials(
            resource_uri="str",
            endpoint_name="str",
            api_version="2024-12-01",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_list_managed_proxy_details(self, resource_group):
        response = self.client.endpoints.list_managed_proxy_details(
            resource_uri="str",
            endpoint_name="str",
