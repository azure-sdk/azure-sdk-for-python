...
def build_endpoints_list_ingress_gateway_credentials_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/{resourceUri}/providers/Microsoft.HybridConnectivity/endpoints/{endpointName}/listIngressGatewayCredentials"  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceUri": _SERIALIZER.url("resource_uri", resource_uri, "str", skip_quote=True),
        "endpointName": _SERIALIZER.url("endpoint_name", endpoint_name, "str", skip_quote=True),
    }
...
def build_service_configurations_get_request(
    ...
    # Construct URL
    _url = "/{resourceUri}/providers/Microsoft.HybridConnectivity/endpoints/{endpointName}/serviceConfigurations/{serviceConfigurationName}"  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceUri": _SERIALIZER.url("resource_uri", resource_uri, "str", skip_quote=True),
        "endpointName": _SERIALIZER.url("endpoint_name", endpoint_name, "str", skip_quote=True),
...
def build_solution_configurations_sync_now_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/{resourceUri}/providers/Microsoft.HybridConnectivity/solutionConfigurations/{solutionConfiguration}/syncNow"  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceUri": _SERIALIZER.url("resource_uri", resource_uri, "str", skip_quote=True),
        "solutionConfiguration": _SERIALIZER.url("solution_configuration", solution_configuration, "str"),
    }
...
def build_inventory_list_by_solution_configuration_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/{resourceUri}/providers/Microsoft.HybridConnectivity/solutionConfigurations/{solutionConfiguration}/inventory"  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceUri": _SERIALIZER.url("resource_uri", resource_uri, "str", skip_quote=True),
        "solutionConfiguration": _SERIALIZER.url("solution_configuration", solution_configuration, "str"),
    }
