...
def build_list_by_widget_request(resource_uri: str, solution_configuration: str, **kwargs: Any) -> HttpRequest:
...
def build_get_request(resource_uri: str, solution_configuration: str, inventory_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_by_widget(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_widget_request(
