...
class AADProfileProperties(_model_base.Model):
    ...
    server_id: str = rest_field(name="serverId")
...
class EndpointProperties(_model_base.Model):
    ...
    type: Union[str, "_models.Type"] = rest_field()
...
class IngressProfileProperties(_model_base.Model):
    ...
    hostname: str = rest_field()
    """The ingress hostname. Required."""
    aad_profile: "_models.AADProfileProperties" = rest_field(name="aadProfile")
...
class ListCredentialsRequest(_model_base.Model):
    ...
    service_name: Optional[Union[str, "_models.ServiceName"]] = rest_field(name="serviceName")
...
class ManagedProxyResource(_model_base.Model):
    ...
    proxy: str = rest_field()
    """The short lived proxy name. Required."""
    expires_on: int = rest_field(name="expiresOn")
...
class RelayNamespaceAccessProperties(_model_base.Model):
    ...
    namespace_name_suffix: str = rest_field(name="namespaceNameSuffix")
    """The suffix domain name of relay namespace. Required."""
    hybrid_connection_name: str = rest_field(name="hybridConnectionName")
    ...
    expires_on: Optional[int] = rest_field(name="expiresOn")
    """The expiration of access key in unix time."""
    service_configuration_token: Optional[str] = rest_field(name="serviceConfigurationToken")
...
class ServiceConfigurationProperties(_model_base.Model):
    ...
    service_name: Union[str, "_models.ServiceName"] = rest_field(name="serviceName")
