...
from ...operations._generate_aws_template_operations import build_post_request
...
class GenerateAwsTemplateOperations:
    ...
    async def post(
        self, generate_aws_template_request: Union[_models.GenerateAwsTemplateRequest, IO[bytes]], **kwargs: Any
    ) -> JSON:
        """Retrieve AWS Cloud Formation template.
        ...
        :param generate_aws_template_request: ConnectorId and SolutionTypes and their properties to
         ...
         Required.
        :type generate_aws_template_request:
         ~azure.mgmt.hybridconnectivity.models.GenerateAwsTemplateRequest or IO[bytes]
        :return: JSON or the result of cls(response)
        :rtype: JSON
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(generate_aws_template_request, (IOBase, bytes)):
            ...
            _json = self._serialize.body(generate_aws_template_request, "GenerateAwsTemplateRequest")
